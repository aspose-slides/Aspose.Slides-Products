...
title: JasperReports'u PowerPoint'e Aktarın | Aspose.Slides
weight: 8320
url: /tr/jasperreports/ 
description: Raporları Jasper Reports ve JasperServer'dan PowerPoint formatlarına aktarmak için JaspreReport için Aspose.Slides PowerPoint API. Hesaplar oluşturun ve grafik görüntüleri metinlerini ve satır raporlarını PPT sunumuna aktarın
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="JasperServer Raporlarını PowerPoint Sunumlarına Aktarın" h2="JasperReports ve JasperServer raporlarını PPT(X), PPS(X) ve diğer PowerPoint biçimlerine aktarmak için PowerPoint API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-jasperreports.svg" pfName="Aspose.Slides" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/slides/jasperreport" >}}
...
<p>
 Aspose.Slides for JasperReports, JasperReports ve JasperServer raporlarının PowerPoint'e esnek ve kullanımı kolay dışa aktarımı için bir PowerPoint API'sidir. JasperServer, raporları PowerPoint sunumları olarak dışa aktarmak için yerleşik bir yeteneğe sahip değildir. Ancak bu PowerPoint API ile JasperServer raporları Microsoft PowerPoint kullanılmadan PPT, PPS, PPTX ve PPSX sunum formatlarına aktarılabilir.
</p>
...
17.5 ve önceki sürümler
   ...
   <header style="padding-left: 0px;">
    ...
    JasperReports 3.7.2 veya üzeri.
   </header>
   <ul>
    <li>
17.6 ve daha yeni sürümler
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Gelişmiş JasperReports - Sunum Dışa Aktarma Özellikleri</h2>

<p> </p>

<div class="col-lg-4"><em class="fa fa-file-powerpoint-o  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Hesap raporları oluşturun ve bunları Microsoft PowerPoint sunumlarına aktarın</p>

</div>

<div class="col-lg-4"><em class="fa fa-bar-chart   ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Grafik raporları oluşturun ve bunları Microsoft PowerPoint sunumlarına aktarın</p>

</div>

<div class="col-lg-4"><em class="fa fa-pie-chart ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Çoklu eksen grafiği raporları oluşturun ve Microsoft PowerPoint sunumlarına aktarın</p>

</div>

<div class="col-lg-4"><em class="fa fa-file-text ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Görüntüler, metinler, çizgiler oluşturun ve bu raporları Microsoft PowerPoint sunumuna aktarın</p>

</div>-->
   <h2 class="pr-ft">
    Gelişmiş JasperReports PowerPoint API Özellikleri
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     MSO 2016 çizelgeleri için destek
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Birden çok eksen grafiği raporu oluşturun
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Raporlara resim, metin, satır ekleyin
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-file-text ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Raporları PowerPoint sunumlarına aktarma
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-file-text ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Yorum yanıtları, Office 365 ve harici Excel çalışma kitapları için destek
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Metinsiz Şekillerin Rasterleştirilmesi
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Oluşturulan PPT'de sol slayt küçük resim bölmesini gizle
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-area-chart ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Kabarcık grafiği için huni, 2B harita çizelgeleri ve Boyut özelliği
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-cog ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Metin İşaretleyici, OpenDocument Şifreleme ve Şekil Oluşturma
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Gölge efektleri ve Dönüşüm Geçişi için Şeffaflık özelliğini ayarlayın
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Seri veri etiketi için uygulamada yerel ayarı ve çağrı şeklini ayarlayın
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Strict Open XML formatı için destek ekleyin
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Metin kutusu paragraflarıyla efektler alın
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Özet Tabloda ChartData SetRange
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Strict Open XML formatı uyumluluğu ile serileştirme uygulayın
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     HTML'ye kaydederken kodlama meta etiketi ekleyin
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     FIPS uyumlu algoritmalarla uyumluluk
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Çoklu Eksen Tablosu Raporu Desteği
    </h2>
    <p>
     Aspose.Slides for JasperReports, aşağıdakileri içeren karmaşık raporların dışa aktarılmasını destekler:
     <strong>
      Çoklu Eksen Grafik Raporu
     </strong>
     Microsoft PowerPoint sunumlarına. Çıktı, JasperViewer aracılığıyla görüntülendiğinde nasıl göründüğüyle tamamen aynıdır.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Raporları Sunum Formatlarına Aktarın
    </h2>
    <p>
     JasperReports ve JasperServer, raporları Microsoft PowerPoint sunumlarına aktarmak için yerleşik desteğe sahip değildir, ancak Aspose.Slides for JasperReports ile entegrasyon, raporlarınızı Microsoft PowerPoint sunumlarına (PPT, PPTX) ve Microsoft PowerPoint slayt gösterilerine (PPS, PPSX).
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="belgeler" href="https://docs.aspose.com/slides/jasperreports/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Neden JasperReports için Aspose.Slides?" tabId="success-stories" >}}
