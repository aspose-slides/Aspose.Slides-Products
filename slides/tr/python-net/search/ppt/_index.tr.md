...
{{% blocks/products/pf/agp/code-block title="Arama metni PPT Python kullanarak sunum" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Python Aracılığıyla PPT Metninde Nasıl Arama Yapılır?" >}}
