---
title: Python kullanarak OTP Dosya Meta Verilerini Görüntüleyin veya Düzenleyin
url: /tr/python-net/metadata/otp/
...
{{% blocks/products/pf/agp/code-block title="OTP Yerleşik Özelliklerini Değiştirin - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="OTP - Python ürününe Özel Özellikler ekleyin" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Python Aracılığıyla OTP Meta Verilerini Çıkarma" >}}
