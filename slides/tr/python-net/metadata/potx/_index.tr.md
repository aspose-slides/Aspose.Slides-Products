---
title: Python kullanarak POTX Dosya Meta Verilerini Görüntüleyin veya Düzenleyin
url: /tr/python-net/metadata/potx/
...
{{% blocks/products/pf/agp/code-block title="POTX Yerleşik Özelliklerini Değiştirin - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="POTX - Python ürününe Özel Özellikler ekleyin" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Python Aracılığıyla POTX Meta Verilerini Çıkarma" >}}
