---
title: Python kullanarak PPT Dosya Meta Verilerini Görüntüleyin veya Düzenleyin
url: /tr/python-net/metadata/ppt/
...
description: PPT biçim meta verilerini düzenlemek veya görüntülemek için Python kaynak kodu.
---
...
{{% blocks/products/pf/feature-page-section  h2="Python aracılığıyla PPT Özelliklerini değiştirin" %}}
...
{{% blocks/products/pf/agp/code-block title="PPT Yerleşik Özelliklerini Değiştirin - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="PPT - Python ürününe Özel Özellikler ekleyin" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Python Aracılığıyla PPT Meta Verilerini Çıkarma" >}}
