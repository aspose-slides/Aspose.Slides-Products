---
title: Python kullanarak FODP Dosya Meta Verilerini Görüntüleyin veya Düzenleyin
url: /tr/python-net/metadata/fodp/
...
{{% blocks/products/pf/agp/code-block title="FODP Yerleşik Özelliklerini Değiştirin - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="FODP - Python ürününe Özel Özellikler ekleyin" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Python Aracılığıyla FODP Meta Verilerini Çıkarma" >}}
