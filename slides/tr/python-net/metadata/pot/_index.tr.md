---
title: Python kullanarak POT Dosya Meta Verilerini Görüntüleyin veya Düzenleyin
url: /tr/python-net/metadata/pot/
...
{{% blocks/products/pf/agp/code-block title="POT Yerleşik Özelliklerini Değiştirin - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="POT - Python ürününe Özel Özellikler ekleyin" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Python Aracılığıyla POT Meta Verilerini Çıkarma" >}}
