---
title: Python kullanarak PPSM Dosya Meta Verilerini Görüntüleyin veya Düzenleyin
url: /tr/python-net/metadata/ppsm/
...
{{% blocks/products/pf/agp/code-block title="PPSM Yerleşik Özelliklerini Değiştirin - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="PPSM - Python ürününe Özel Özellikler ekleyin" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Python Aracılığıyla PPSM Meta Verilerini Çıkarma" >}}
