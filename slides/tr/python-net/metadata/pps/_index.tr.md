---
title: Python kullanarak PPS Dosya Meta Verilerini Görüntüleyin veya Düzenleyin
url: /tr/python-net/metadata/pps/
...
{{% blocks/products/pf/agp/code-block title="PPS Yerleşik Özelliklerini Değiştirin - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="PPS - Python ürününe Özel Özellikler ekleyin" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Python Aracılığıyla PPS Meta Verilerini Çıkarma" >}}
