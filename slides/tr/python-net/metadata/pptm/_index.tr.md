---
title: Python kullanarak PPTM Dosya Meta Verilerini Görüntüleyin veya Düzenleyin
url: /tr/python-net/metadata/pptm/
...
{{% blocks/products/pf/agp/code-block title="PPTM Yerleşik Özelliklerini Değiştirin - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="PPTM - Python ürününe Özel Özellikler ekleyin" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Python Aracılığıyla PPTM Meta Verilerini Çıkarma" >}}
