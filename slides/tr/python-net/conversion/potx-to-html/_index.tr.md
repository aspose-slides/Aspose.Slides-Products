---
title: Python'da POTX'i HTML'ye Dönüştür
weight: 1370
url: /tr/python-net/conversion/potx-to-html/ 
keywords: "Convert, PowerPoint, POTX, HTML, Presentation, Python"
description: POTX'ten HTML Python'a dönüştürme için örnek kod. POTX dosyalarını HTML dosyalarına toplu olarak dönüştürmek için PowerPoint Python API'sini kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Python'da POTX'i HTML'ye Dönüştür" h2="POTX'i HTML'ye dönüştürmek için güçlü PowerPoint Python kitaplığı" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Python'da POTX'i HTML'ye Dönüştür" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Python'da POTX'i HTML'ye Dönüştürme" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Bunlar, Python kullanarak bir POTX dosyasını HTML'ye dönüştürme adımlarıdır." >}}
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, POTX'ten HTML'ye Python Dönüşümünü gösterir" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="POTX'i Python'da HTML olarak kaydedin" %}}
