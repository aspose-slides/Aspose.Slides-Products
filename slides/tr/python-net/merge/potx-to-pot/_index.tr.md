...
{{< blocks/products/pf/feature-page-header h1="Python'da POTX dosyalarını POT ile birleştirin" h2="Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım kullanmadan Microsoft PowerPoint ve OpenOffice sunum dosyalarını oluşturma, birleştirme, inceleme veya dönüştürme becerisine sahip uygulamaların geliştirilmesine yardımcı olan yüksek hızlı ve platformlar arası Python API." >}}

{{% blocks/products/pf/feature-page-section h2="Python'da POTX öğesini POT ile birleştir" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Python kullanarak POTX dosyalarını POT ile birleştirin" %}}
PowerPoint sunumlarını birleştirmek için slaytları bir sunumdan diğerine kopyalamanız gerekir.

{{% blocks/products/pf/agp/code-block title="Birden çok POTX dosyasını tek bir POT dosyasına birleştirmek için Python kodu" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Aspose.Slides for Python API kullanılarak POTX ile POT arasında nasıl birleştirilir" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Bunlar, iki POTX dosyasını birleştirme ve sonucu Python'da POT olarak kaydetme adımlarıdır." >}}
