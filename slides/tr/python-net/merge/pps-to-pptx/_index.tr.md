---
title: Python Kullanarak PPS Dosyalarını PPTX İle Birleştirin
url: /tr/python-net/merge/pps-to-pptx/
keywords: PPS'ı PPTX ile birleştir, PPS ile PPTX'a katıl, PPS'ı PPTX ile birleştir, PowerPoint, Presentation, PPTX, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Python'da PPS dosyalarını PPTX ile birleştirin" h2="Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım kullanmadan Microsoft PowerPoint ve OpenOffice sunum dosyalarını oluşturma, birleştirme, inceleme veya dönüştürme becerisine sahip uygulamaların geliştirilmesine yardımcı olan yüksek hızlı ve platformlar arası Python API." >}}

{{% blocks/products/pf/feature-page-section h2="Python'da PPS öğesini PPTX ile birleştir" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Python kullanarak PPS dosyalarını PPTX ile birleştirin" %}}
PowerPoint sunumlarını birleştirmek için slaytları bir sunumdan diğerine kopyalamanız gerekir.

{{% blocks/products/pf/agp/code-block title="Birden çok PPS dosyasını tek bir PPTX dosyasına birleştirmek için Python kodu" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Aspose.Slides for Python API kullanılarak PPS ile PPTX arasında nasıl birleştirilir" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Bunlar, iki PPS dosyasını birleştirme ve sonucu Python'da PPTX olarak kaydetme adımlarıdır." >}}
