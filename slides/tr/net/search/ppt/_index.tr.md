---
title: C# ile açmadan PPT belgesini arayın
weight: 6250
url: /tr/net/search/ppt/ 
description: .NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında PPT dosyasında kalıplı kelimeleri aramak için C# kaynak kodu.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C# ile PPT Formatlarını Arayın" h2="Sunucu tarafı Aspose.Slides for .NET API'lerini kullanarak, Microsoft veya Adobe PDF gibi herhangi bir yazılım kullanmadan yerel ve yüksek performanslı PPT belge arama." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak PPT Dosyası Nasıl Aranır" %}}

 PPT dosyasını aramak için kullanacağız
 [Aspose.Slides for .NET](https://products.aspose.com/slides/tr/net)
 C# platformu için API arayan, zengin özelliklere sahip, güçlü ve kullanımı kolay Microsoft PowerPoint belgeleri olan API. Açık
...
{{< blocks/products/pf/agp/feature-section-col title="C# ile PPT Dosyalarını Arama Adımları" >}}
...
{{% blocks/products/pf/agp/code-block title="PPT Dosyalarında Ara - C#" offSpacer="" %}}
