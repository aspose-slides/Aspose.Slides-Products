---
title: HTML Dosyalarını C# ile Birleştirme
url: /tr/net/merger/html-to-html/
keywords: HTML'yi Birleştirme, HTML'den HTML'ye, HTML'ye Birleştirme, HTML'yi Birleştirme, C# API, .NET Kitaplığı
description: C# dilinde HTML'yi HTML ile birleştirin. HTML dosyalarını birleştirmek için .NET kitaplık API'sini kullanın
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="HTML'yi C# ile birleştirme" h2="NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında C# kodunu kullanarak HTML dosyalarını birleştirmek için güçlü platformlar arası .NET API'si" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides kullanarak HTML'yi HTML ile birleştirin" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/tr/net/), sunumları, HTML dosyalarını ve diğer belgeler. HTML'yi HTML'ye birleştirdiğinizde, tek bir HTML dosyası elde etmek için 2 belgenin içeriğini etkili bir şekilde birleştirmiş olursunuz. Aspose.Slides, HTML belgelerini farklı şekillerde birleştirmenizi sağlar. HTML'yi tüm metinleri, biçimlendirmeleri, stilleri vb. ile birleştirebilirsiniz.
...
{{% blocks/products/pf/feature-page-section  h2="C# dilinde HTML'yi HTML ile birleştirme" %}}
[**Aspose.Slides for .NET**](https://products.aspose.com/slides/tr/net/) kullanarak, HTML dosyalarını yalnızca birkaç satır kodla hızla birleştirebilirsiniz

{{% blocks/products/pf/agp/code-block title="HTML'yi HTML'ye birleştirmek için C# kodu" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="HTML'yi C# ile birleştirme" >}}
