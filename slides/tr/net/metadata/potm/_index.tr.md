---
title: .NET kullanarak POTM Dosya Meta Verilerini Görüntüleyin veya Düzenleyin
url: /tr/net/metadata/potm/
...
{{% blocks/products/pf/agp/code-block title="POTM Yerleşik Özelliklerini Değiştirin - C#" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="POTM - C# ürününe Özel Özellikler ekleyin" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="C# Aracılığıyla POTM Meta Verilerini Çıkarma" >}}
