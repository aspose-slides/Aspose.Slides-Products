---
title: .NET kullanarak OTP Dosya Meta Verilerini Görüntüleyin veya Düzenleyin
...
{{% blocks/products/pf/agp/code-block title="OTP Yerleşik Özelliklerini Değiştirin - C#" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="OTP - C# ürününe Özel Özellikler ekleyin" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="C# Aracılığıyla OTP Meta Verilerini Çıkarma" >}}
