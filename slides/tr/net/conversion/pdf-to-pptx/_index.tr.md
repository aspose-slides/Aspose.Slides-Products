...
description: C# dilinde PDF'yi PPTX'e dönüştürün. PDF'yi PowerPoint'e dönüştürmek için .NET kitaplık API'sini kullanın
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="C# ile PDF'yi PPTX'e dönüştürün" h2="NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında C# kodunu kullanarak PDF'yi PPTX'e dönüştürmek için güçlü çapraz platform .NET API'si" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides kullanarak PDF'yi PPTX'e dönüştürün" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/tr/net/), PowerPoint sunumları, PDF'ler, HTML belgeleri, ve diğer dosyalar. PDF'yi PPTX'e dönüştürdüğünüzde, aslında PDF sayfalarındaki içeriği bir PowerPoint sunumundaki slaytlara taşıyorsunuz.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="C# ile PDF'yi PPTX'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/code-block title="PDF'yi PPTX'e dönüştürmek için C# kodu" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="C# dilinde PDF'yi PPTX'e dönüştürme" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
PPTX'e dönüştürmek istediğiniz PDF dosyasını yükleyin.
{{< /blocks/products/pf/agp/step-autogen >}}
