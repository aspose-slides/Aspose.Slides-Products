...
title: PDF'yi C# ile Görüntüye Dönüştür
weight: 80
url: /tr/net/conversion/pdf-to-image/ 
keywords: PDF'den Görüntüye, PDF'den Görüntüye Dönüştürme, C# API, .NET Kitaplığı, PDF, Görüntü
description: C# ile PDF'yi Görüntüye Dönüştür. PDF sayfalarını Görüntülere dönüştürmek için .NET kitaplık API'sini kullanın
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="PDF'yi C# ile Görüntüye Dönüştür" h2="PDF belgelerini NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında Görüntülere dönüştürmek için PowerPoint .NET API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="C# ile PDF'yi Görüntüye Dönüştürme" %}}

Kodda PDF'yi Görüntüye nasıl dönüştürebilirim?

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/tr/net/) kullanarak herhangi bir geliştirici veya uygulama, yalnızca birkaç satırlık C# koduyla PDF'yi görüntü dosyalarına dönüştürebilir.

Modern bir belge işleme API'si olan Aspose.Slides for .NET, PDF sayfalarını hızla Görüntü formatlarına aktarır. Aspose PowerPoint kitaplığı, PDF'yi Görüntüye ve diğer birçok dosya biçimine dönüştürmenize olanak tanır.
...
{{< blocks/products/pf/agp/feature-section-col title="C# ile PDF'yi Görüntüye Dönüştürme" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Geliştiriciler ve uygulamalar, PDF'yi Görüntüye şu şekilde dönüştürebilir:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Slaytları görüntü olarak kaydetmek için kaydetme yöntemini çağırın.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 PDF'den Görüntüye dönüştürme C# kodunu çalıştırmadan önce, makinenizin şu önkoşullara sahip olması gerekir:
...
{{% blocks/products/pf/agp/code-block title="PDF'yi Görüntüye dönüştürmek için C# kodu" offSpacer="" %}}
