...
title: PNG'yi C# ile SVG'ye dönüştürün
weight: 240
url: /tr/net/conversion/png-to-svg/ 
keywords: PNG'den SVG'ye, PNG'yi SVG'ye Dönüştürme, C# API, .NET Kitaplığı
description: PNG'yi C# ile SVG'ye dönüştürün. PNG'yi SVG dosyalarına dönüştürmek için .NET kitaplık API'sini kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="PNG'yi C# ile SVG'ye dönüştürün" h2="NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında PNG'yi SVG görüntü dosyalarına dönüştürmek için PowerPoint .NET API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="PNG'yi C# ile SVG'ye dönüştürün" %}}

PNG'yi kodda SVG'ye nasıl dönüştürebilirim?

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/tr/net/) kullanarak herhangi bir geliştirici veya uygulama, yalnızca birkaç satır C# koduyla PNG'yi SVG'ye dönüştürebilir.

Modern bir belge işleme API'si olan Aspose.Slides for .NET, PNG dosyalarını hızlı bir şekilde SVG'ye aktarır. Aspose PowerPoint kitaplığı, PNG'yi SVG'ye ve diğer formatlardaki görüntüleri dönüştürmenize olanak tanır.
...
{{< blocks/products/pf/agp/feature-section-col title="PNG'yi C#'da SVG'ye Dönüştürme" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Geliştiriciler ve uygulamalar PNG'yi SVG'ye şu şekilde dönüştürebilir:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Dosyayı bir SVG görüntüsü olarak kaydedin.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 PNG'den SVG'ye dönüştürme C# kodunu çalıştırmadan önce, makinenizin şu önkoşullara sahip olması gerekir:
...
{{% blocks/products/pf/agp/code-block title="PNG'yi SVG'ye dönüştürmek için C# kodu" offSpacer="" %}}
