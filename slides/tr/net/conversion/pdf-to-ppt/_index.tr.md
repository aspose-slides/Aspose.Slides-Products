...
description: C# dilinde PDF'yi PPT'ye dönüştürün. PDF'yi PowerPoint'e dönüştürmek için .NET kitaplık API'sini kullanın
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="C# dilinde PDF'yi PPT'ye dönüştürün" h2="NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında C# kodunu kullanarak PDF'yi PPT'ye dönüştürmek için güçlü çapraz platform .NET API'si" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides kullanarak PDF'yi PPT'ye dönüştürün" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/tr/net/), PowerPoint sunumları, PDF'ler, HTML belgeleri, ve diğer dosyalar. PDF'yi PPT'ye dönüştürdüğünüzde, aslında PDF sayfalarındaki içeriği bir PowerPoint sunumundaki slaytlara taşıyorsunuz.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="C# dilinde PDF'yi PPT'ye dönüştürün" %}}
[**Aspose.Slides for .NET**](https://products.aspose.com/slides/tr/net/) kullanarak, yalnızca birkaç satır kodla PDF'yi PowerPoint sunumuna dönüştürebilirsiniz:

{{% blocks/products/pf/agp/code-block title="PDF'yi PPT'ye dönüştürmek için C# kodu" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="C# dilinde PDF'yi PPT'ye dönüştürme" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
PPT'ye dönüştürmek istediğiniz PDF dosyasını yükleyin.
{{< /blocks/products/pf/agp/step-autogen >}}
