...
title: JPG'yi C# ile PDF'ye dönüştürün
weight: 10
url: /tr/net/conversion/jpg-to-pdf/ 
keywords: JPG'den PDF'ye, JPG'den PDF'ye Dönüştürme, C# API, .NET Kitaplığı
description: JPG'yi C# ile PDF'ye dönüştürün. JPG JPEG görüntülerini PDF belgelerine dönüştürmek için .NET kitaplık API'sini kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="JPG'yi C# ile PDF'ye dönüştürün" h2="NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında JPG görüntülerini PDF belgelerine dönüştürmek için PowerPoint .NET API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="C# ile JPG'yi PDF'ye Dönüştürme" %}}

JPG'yi programlı olarak PDF'ye nasıl dönüştürebilirim?

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/tr/net/) kullanarak herhangi bir geliştirici veya uygulama, yalnızca birkaç satır C# koduyla JPG'yi PDF formatına dönüştürebilir.

Modern bir belge işleme API'si olan Aspose.Slides for .NET, JPG görüntülerinden hızlı bir şekilde PDF'ler oluşturur. Aspose PowerPoint kitaplığı, JPG'yi PDF'ye ve diğer birçok dosya formatına dönüştürmenize olanak tanır
...
{{< blocks/products/pf/agp/feature-section-col title="C# ile JPG'yi PDF'ye Dönüştürme Adımları" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Geliştiriciler ve uygulamalar JPG'yi PDF'ye şu şekilde dönüştürebilir:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 JPG'den PDF'ye dönüştürme C# kodunu çalıştırmadan önce, makinenizin şu önkoşullara sahip olması gerekir:
...
{{% blocks/products/pf/agp/code-block title="JPG'yi PDF'ye dönüştürmek için C# kodu" offSpacer="" %}}
