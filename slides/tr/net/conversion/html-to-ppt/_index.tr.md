---
title: C# dilinde HTML'yi PPT'ye dönüştürün
url: /tr/net/conversion/html-to-ppt/
keywords: HTML'yi PPT'ye, HTML'yi PPT'ye, PowerPoint, HTML, PPT, C# API, .NET Library'ye dönüştürün
description: C# dilinde HTML'yi PPT'ye dönüştürün. HTML'yi PowerPoint'e dönüştürmek için .NET kitaplık API'sini kullanın
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="C# dilinde HTML'yi PPT'ye dönüştürün" h2="NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında C# kodunu kullanarak HTML'yi PPT'ye dönüştürmek için güçlü çapraz platform .NET API'si" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides kullanarak HTML'yi PPT'ye dönüştürün" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/tr/net/), PowerPoint sunumları, PDF'ler, HTML belgeleri, ve diğer dosyalar. HTML'yi PPT'ye dönüştürdüğünüzde, aslında bir HTML belgesindeki içeriği bir PowerPoint sunumundaki slaytlara taşıyorsunuz.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="C# dilinde HTML'yi PPT'ye dönüştürün" %}}
...
{{< blocks/products/pf/feature-page-section  h2="C# dilinde HTML'yi PPT'ye dönüştürme" >}}
