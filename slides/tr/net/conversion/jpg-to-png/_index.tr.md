---
title: C# ile JPG'yi PNG'ye Dönüştür
weight: 220
url: /tr/net/conversion/jpg-to-png/ 
keywords: JPG'den PNG'ye, JPG'den PNG'ye Dönüştürme, C# API, .NET Kitaplığı
description: C# ile JPG'yi PNG'ye dönüştürün. JPG'yi PNG dosyalarına dönüştürmek için .NET kitaplık API'sini kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C# ile JPG'yi PNG'ye Dönüştür" h2="NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında JPG'yi PNG'ye dönüştürmek için PowerPoint .NET API'si" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="C# ile JPG'yi PNG'ye Dönüştür" %}}

Kodda JPG'yi PNG'ye nasıl dönüştürebilirim?

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/tr/net/) kullanarak herhangi bir geliştirici veya uygulama, yalnızca birkaç satırlık C# koduyla JPG'yi PNG'ye dönüştürebilir.

Modern bir belge işleme API'si olan Aspose.Slides for .NET, JPG dosyalarını hızlı bir şekilde PNG'ye aktarır. Aspose PowerPoint kitaplığı, JPG'yi PNG'ye ve diğer formatlardaki görüntüleri dönüştürmenize olanak tanır.
...
{{< blocks/products/pf/agp/feature-section-col title="C# ile JPG'yi PNG'ye Dönüştürme" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Geliştiriciler ve uygulamalar JPG'yi PNG'ye şu şekilde dönüştürebilir:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Dosyayı PNG görüntüsü olarak kaydedin.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 JPG'den PNG'ye dönüştürme C# kodunu çalıştırmadan önce, makinenizin şu önkoşullara sahip olması gerekir:
...
{{% blocks/products/pf/agp/code-block title="JPG'yi PNG'ye dönüştürmek için C# kodu" offSpacer="" %}}
