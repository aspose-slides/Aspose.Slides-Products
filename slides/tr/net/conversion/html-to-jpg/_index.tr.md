---
title: C# ile HTML'yi JPG'ye Dönüştür
weight: 150
url: /tr/net/conversion/html-to-jpg/ 
keywords: HTML'den JPG'ye, HTML'yi JPG'ye Dönüştürme, C# API, .NET Kitaplığı, HTML, JPG
description: C# ile HTML'yi JPG'ye dönüştürün. HTML dosyalarını JPG görüntülerine dönüştürmek için .NET kitaplık API'sini kullanın
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C# ile HTML'yi JPG'ye Dönüştür" h2="NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında HTML dosyalarını JPG görüntülerine dönüştürmek için PowerPoint .NET API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="C# ile HTML'yi JPG'ye Dönüştürme" %}}

Kodda HTML'yi JPG'ye nasıl dönüştürebilirim?

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/tr/net/) kullanarak herhangi bir geliştirici veya uygulama, yalnızca birkaç satırlık C# koduyla HTML'yi JPG formatına dönüştürebilir.

Modern bir belge işleme API'si olan Aspose.Slides for .NET, HTML dosyalarını hızlı bir şekilde JPG'ye aktarır. Aspose PowerPoint kitaplığı, HTML'yi JPG'ye ve diğer birçok dosya biçimine dönüştürmenize olanak tanır
...
{{< blocks/products/pf/agp/feature-section-col title="C# ile HTML'yi JPG'ye Dönüştürme" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Geliştiriciler ve uygulamalar HTML'yi JPG'ye şu şekilde dönüştürebilir:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
HTML belgesindeki içeriğe dayalı olarak slaytlar ekleyin.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Slaytları JPG görüntüleri olarak kaydedin.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 HTML'den JPG'ye dönüştürme C# kodunu çalıştırmadan önce, makinenizin şu önkoşullara sahip olması gerekir:
...
{{% blocks/products/pf/agp/code-block title="HTML'yi JPG'ye dönüştürmek için C# kodu" offSpacer="" %}}
