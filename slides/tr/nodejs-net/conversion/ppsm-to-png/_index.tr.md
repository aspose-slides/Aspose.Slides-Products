---
title: JavaScript'te PPSM'ı PNG'a dönüştürün
url: /tr/nodejs-net/conversion/ppsm-to-png/
keywords: PPSM'tan PNG'a, PPSM'ı PNG'a dönüştürün, Node.js API, JavaScript Kitaplığı, PPSM, PNG
description: JavaScript'te PPSM'ı PNG'a dönüştürün. PPSM dosyalarını PNG biçimine dönüştürmek için Node.js kitaplık API'sini kullanın
---
...
[**Aspose.Slides for Node.js via .NET**](https://products.aspose.com/slides/tr/nodejs-net/), sunum dosyalarını oluşturmaya ve düzenlemeye yönelik güçlü bir Node.js kitaplığıdır. Ayrıca, PPSM biçimini PNG biçimine dönüştürmek için esnek yollar sağlar. **Aspose.Slides for Node.js for Node.js**'yi kullanan herhangi bir geliştirici veya uygulama, yalnızca birkaç satır kodla PPSM dosyalarını PNG dosyalara dönüştürebilir.

Modern bir belge işleme API'si olarak Aspose.Slides for Node.js, .NET aracılığıyla PPSM dosyaları hızlı bir şekilde PNG dosya formatlarına aktarır. Aspose PowerPoint kütüphanesi, PPSM'ı PNG'lara ve diğer birçok dosya formatına dönüştürmenize olanak tanır

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="JavaScript kullanarak PPSM biçimini PNG biçimine dönüştürün" %}}
PPSM dosyasını PNG biçimine dönüştürmek için, PPSM dosyasından Sunum oluşturmanız ve bunu PNG olarak kaydetmeniz gerekir.

{{% blocks/products/pf/agp/code-block title="PPSM biçimini PNG biçimine dönüştürmek için JavaScript kodu" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2=".NET API aracılığıyla Aspose.Slides for Node.js kullanarak PPSM'ı PNG'a dönüştürme" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Aspose.Slides for Node.js'yi .NET aracılığıyla kullanarak PPSM'ı PNG'a dönüştürmek için, paketi JavaScript dosyanıza aktarmanız ve Sunum sınıfının bir örneğini oluşturmanız gerekir. Sunum sınıfı bir PowerPoint belgesini temsil eder ve öğelerine erişmeye ve bunları yönetmeye yönelik yöntemler sağlar." >}}
