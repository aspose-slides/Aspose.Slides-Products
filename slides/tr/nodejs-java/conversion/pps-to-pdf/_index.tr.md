...
title: Node.js'de PPS'ı PDF'a dönüştürün
url: /tr/nodejs-java/conversion/pps-to-pdf/
keywords: PPS'tan PDF'a, PPS'ı PDF'a dönüştürün, Node.js API'si, Node.js Kitaplığı, PPS, PDF
description: Node.js'de PPS'ı PDF'a dönüştürün. PPS dosyalarını PDF dosyalara dönüştürmek için Node.js kitaplık API'sini kullanın
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Node.js'de PPS'ı PDF'a dönüştürün" h2="Aspose.Slides for Node.js Java aracılığıyla, PowerPoint sunumlarını Node.js'deki çeşitli formatlara dönüştürmenize olanak tanıyan güçlü ve kullanımı kolay bir kitaplıktır. Tüm sunum öğelerini ve formatlarını destekler ve bunlara erişmek ve bunları değiştirmek için zengin bir API sağlar. Ayrıca daha fazla işlem yapmak veya paylaşmak için slaytlarınızı çeşitli formatlara aktarmanıza da olanak tanır." >}}

{{% blocks/products/pf/feature-page-section h2="Node.js'de PPS'ı PDF'a dönüştürün" %}}

[**Aspose.Slides for Node.js via Java**](https://products.aspose.com/slides/tr/nodejs-java/), sunum dosyalarını oluşturmaya ve düzenlemeye yönelik güçlü bir Node.js kitaplığıdır. Ayrıca, PPS biçimini PDF biçimine dönüştürmek için esnek yollar sağlar. Herhangi bir geliştirici veya uygulama **Java aracılığıyla Aspose.Slides for Node.js** kullanarak yalnızca birkaç satır kodla PPS dosyalarını PDF dosyalarına dönüştürebilir.

Modern bir belge işleme API'si olan Aspose.Slides for Node.js, PPS dosyaları hızlı bir şekilde PDF dosya formatlarına aktarır. Aspose PowerPoint kitaplığı, PPS biçimini PDF biçimine ve diğer birçok dosya biçimine dönüştürmenize olanak tanır

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Node.js'yi kullanarak PPS biçimini PDF biçimine dönüştürün" %}}
PPS dosyasını PDF biçimine dönüştürmek için, PPS dosyasından Sunum oluşturmanız ve bunu PDF olarak kaydetmeniz gerekir.

{{% blocks/products/pf/agp/code-block title="PPS biçimini PDF biçimine dönüştürmek için Node.js kodu" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Java API aracılığıyla Aspose.Slides for Node.js kullanarak PPS'ı PDF'a dönüştürme" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Java aracılığıyla Aspose.Slides for Node.js kullanarak PPS dosyasını PDF biçimine dönüştürmek için, paketi JavaScript dosyanıza aktarmanız ve Sunum sınıfının bir örneğini oluşturmanız gerekir. Sunum sınıfı bir PowerPoint belgesini temsil eder ve öğelerine erişmeye ve bunları yönetmeye yönelik yöntemler sağlar." >}}
