---
title: ODP dosyasını PHP'de düzenleyin
url: /tr/php-java/editor/odp/
keywords: ODP Düzenle, PowerPoint'i Düzenle, ODP, PowerPoint, PHP API, PHP Kitaplığı
description: ODP dosyasını PHP'de düzenleyin. ODP dosyalarını düzenlemek için PHP kitaplık API'sini kullanın
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="ODP dosyasını PHP'de düzenleyin" h2="PHP kodunu kullanarak ODP düzenlemek için yüksek hızlı ve platformlar arası PHP kitaplığı" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides kullanarak ODP dosyasını düzenleyin" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/tr/php-java/), sunumları işlemek ve düzenlemek için kullanılan güçlü bir PHP kitaplığıdır. ODP sunumunu yeni bir metin satırı ekleyerek düzenleyebilirsiniz. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="ODP dosyasını PHP'de düzenleyin" %}}
[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/tr/php-java/) kullanarak, ODP belgesine yalnızca bir metin satırıyla yeni bir metin satırı ekleyebilirsiniz. birkaç kod satırı.

{{% blocks/products/pf/agp/code-block title="ODP düzenlemesi için PHP kodu" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="PHP'de ODP nasıl düzenlenir" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Düzenlemek istediğiniz ODP sunumunu yükleyin.
{{< /blocks/products/pf/agp/step-autogen >}}
