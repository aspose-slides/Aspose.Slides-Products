---
title: PPTM dosyasını PHP'de düzenleyin
url: /tr/php-java/editor/pptm/
keywords: PPTM Düzenle, PowerPoint'i Düzenle, PPTM, PowerPoint, PHP API, PHP Kitaplığı
description: PPTM dosyasını PHP'de düzenleyin. PPTM dosyalarını düzenlemek için PHP kitaplık API'sini kullanın
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="PPTM dosyasını PHP'de düzenleyin" h2="PHP kodunu kullanarak PPTM düzenlemek için yüksek hızlı ve platformlar arası PHP kitaplığı" >}}
...
{{% blocks/products/pf/feature-page-section  h2="PPTM dosyasını PHP'de düzenleyin" %}}
[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/tr/php-java/) kullanarak, PPTM belgesine yalnızca bir metin satırıyla yeni bir metin satırı ekleyebilirsiniz. birkaç kod satırı.

{{% blocks/products/pf/agp/code-block title="PPTM düzenlemesi için PHP kodu" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="PHP'de PPTM nasıl düzenlenir" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Düzenlemek istediğiniz PPTM sunumunu yükleyin.
{{< /blocks/products/pf/agp/step-autogen >}}
