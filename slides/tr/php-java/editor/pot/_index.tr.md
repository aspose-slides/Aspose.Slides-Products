---
title: POT dosyasını PHP'de düzenleyin
url: /tr/php-java/editor/pot/
keywords: POT Düzenle, PowerPoint'i Düzenle, POT, PowerPoint, PHP API, PHP Kitaplığı
description: POT dosyasını PHP'de düzenleyin. POT dosyalarını düzenlemek için PHP kitaplık API'sini kullanın
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="POT dosyasını PHP'de düzenleyin" h2="PHP kodunu kullanarak POT düzenlemek için yüksek hızlı ve platformlar arası PHP kitaplığı" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides kullanarak POT dosyasını düzenleyin" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/tr/php-java/), sunumları işlemek ve düzenlemek için kullanılan güçlü bir PHP kitaplığıdır. POT sunumunu yeni bir metin satırı ekleyerek düzenleyebilirsiniz. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="POT dosyasını PHP'de düzenleyin" %}}
[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/tr/php-java/) kullanarak, POT belgesine yalnızca bir metin satırıyla yeni bir metin satırı ekleyebilirsiniz. birkaç kod satırı.

{{% blocks/products/pf/agp/code-block title="POT düzenlemesi için PHP kodu" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="PHP'de POT nasıl düzenlenir" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Düzenlemek istediğiniz POT sunumunu yükleyin.
{{< /blocks/products/pf/agp/step-autogen >}}
