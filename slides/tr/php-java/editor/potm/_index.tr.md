---
title: POTM dosyasını PHP'de düzenleyin
url: /tr/php-java/editor/potm/
keywords: POTM Düzenle, PowerPoint'i Düzenle, POTM, PowerPoint, PHP API, PHP Kitaplığı
description: POTM dosyasını PHP'de düzenleyin. POTM dosyalarını düzenlemek için PHP kitaplık API'sini kullanın
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="POTM dosyasını PHP'de düzenleyin" h2="PHP kodunu kullanarak POTM düzenlemek için yüksek hızlı ve platformlar arası PHP kitaplığı" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides kullanarak POTM dosyasını düzenleyin" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/tr/php-java/), sunumları işlemek ve düzenlemek için kullanılan güçlü bir PHP kitaplığıdır. POTM sunumunu yeni bir metin satırı ekleyerek düzenleyebilirsiniz. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="POTM dosyasını PHP'de düzenleyin" %}}
[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/tr/php-java/) kullanarak, POTM belgesine yalnızca bir metin satırıyla yeni bir metin satırı ekleyebilirsiniz. birkaç kod satırı.

{{% blocks/products/pf/agp/code-block title="POTM düzenlemesi için PHP kodu" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="PHP'de POTM nasıl düzenlenir" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Düzenlemek istediğiniz POTM sunumunu yükleyin.
{{< /blocks/products/pf/agp/step-autogen >}}
