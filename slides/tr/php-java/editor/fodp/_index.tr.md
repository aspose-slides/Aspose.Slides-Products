---
title: FODP dosyasını PHP'de düzenleyin
url: /tr/php-java/editor/fodp/
keywords: FODP Düzenle, PowerPoint'i Düzenle, FODP, PowerPoint, PHP API, PHP Kitaplığı
description: FODP dosyasını PHP'de düzenleyin. FODP dosyalarını düzenlemek için PHP kitaplık API'sini kullanın
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="FODP dosyasını PHP'de düzenleyin" h2="PHP kodunu kullanarak FODP düzenlemek için yüksek hızlı ve platformlar arası PHP kitaplığı" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides kullanarak FODP dosyasını düzenleyin" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/tr/php-java/), sunumları işlemek ve düzenlemek için kullanılan güçlü bir PHP kitaplığıdır. FODP sunumunu yeni bir metin satırı ekleyerek düzenleyebilirsiniz. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="FODP dosyasını PHP'de düzenleyin" %}}
[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/tr/php-java/) kullanarak, FODP belgesine yalnızca bir metin satırıyla yeni bir metin satırı ekleyebilirsiniz. birkaç kod satırı.

{{% blocks/products/pf/agp/code-block title="FODP düzenlemesi için PHP kodu" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="PHP'de FODP nasıl düzenlenir" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Düzenlemek istediğiniz FODP sunumunu yükleyin.
{{< /blocks/products/pf/agp/step-autogen >}}
