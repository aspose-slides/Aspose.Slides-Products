...
{{< blocks/products/pf/feature-page-section  h2="Aspose.Slides for PHP API kullanarak PPT nasıl birleştirilir" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="PHP'de iki PPT dosyasını birleştirme ve sonucu PPT olarak kaydetme adımları bunlardır." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Birleştirmek istediğiniz PPT dosyalarını yükleyin.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Ortaya çıkan PPT belgesini kaydedin.
{{< /blocks/products/pf/agp/step-autogen >}}
