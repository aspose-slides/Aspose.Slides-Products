---
title: PHP'de JPG'yi PDF'ye birleştirme
url: /tr/php-java/merger/jpg-to-pdf/
keywords: JPG'den PDF'e, JPG'den PDF'e Birleştirme, JPG'den PDF'e Birleştirme, PDF, JPG, PHP API, PHP Kitaplığı
description: PHP'de JPG'yi PDF'ye birleştirin. JPG ve PDF'yi birleştirmek için PHP kitaplık API'sini kullanın
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="PHP'de JPG'yi PDF'ye birleştirme" h2="PHP kodunu kullanarak JPG'yi PDF dosyalarına birleştirmek için yüksek hızlı ve platformlar arası PHP kitaplığı" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides kullanarak JPG'yi PDF'ye birleştirin" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/tr/php-java/), sunumlar, PDF'ler oluşturmak, dönüştürmek, birleştirmek ve değiştirmek için kullanılan güçlü bir PHP kitaplığıdır. görüntüler ve diğer dosyalar. JPG'yi PDF'ye birleştirdiğinizde, tek bir PDF dosyası elde etmek için JPG görüntülerini etkili bir şekilde birleştiriyorsunuz.
...
{{% blocks/products/pf/feature-page-section  h2="PHP'de JPG'yi PDF'ye birleştirme" %}}
[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/tr/php-java/) kullanarak, yalnızca birkaç satır kodla JPG'yi PDF'ye hızlı bir şekilde birleştirebilirsiniz

{{% blocks/products/pf/agp/code-block title="JPG'yi PDF'ye birleştirmek için PHP kodu" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="PHP'de JPG'yi PDF'ye nasıl birleştirirsiniz?" >}}
