---
title: FODP Dosyalarını PHP Kullanarak Birleştirin
url: /tr/php-java/merger/fodp/
keywords: Birleştirme FODP, Birleştirme FODP, Birleştirme FODP, PowerPoint, Sunum, PHP, Aspose
description: PHP'de birden çok FODP dosyasını birleştirin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="PHP'de FODP dosyalarını birleştirme" h2="Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım kullanmadan Microsoft PowerPoint ve OpenOffice sunum dosyalarını oluşturma, birleştirme, inceleme veya dönüştürme becerisine sahip uygulamaların geliştirilmesine yardımcı olan yüksek hızlı ve platformlar arası PHP API." >}}

{{% blocks/products/pf/feature-page-section h2="PHP'de FODP ile birleştirme" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/tr/php-java/), sunum dosyalarını oluşturmak ve değiştirmek için güçlü bir PHP kitaplığıdır. Ayrıca, birden çok FODP sunumunu birleştirmenin esnek yollarını sunar. Bir sunumu diğerine birleştirdiğinizde, tek bir dosya elde etmek için slaytlarını tek bir sunumda etkili bir şekilde birleştirmiş olursunuz. Aspose.Slides, iki sunumu farklı şekillerde birleştirmenizi sağlar. Kalite veya veri kaybı konusunda endişelenmenize gerek kalmadan sunumları tüm şekilleri, stilleri, metinleri, biçimlendirmeleri, yorumları, animasyonları vb. ile birleştirebilirsiniz.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="FODP dosyalarını PHP kullanarak birleştirme" %}}
PowerPoint sunumlarını birleştirmek için slaytları bir sunumdan diğerine kopyalamanız gerekir.

{{% blocks/products/pf/agp/code-block title="Birden çok FODP dosyasını tek dosyada birleştirmek için PHP kodu" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Aspose.Slides for PHP API kullanarak FODP nasıl birleştirilir" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="PHP'de iki FODP dosyasını birleştirme ve sonucu FODP olarak kaydetme adımları bunlardır." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Birleştirmek istediğiniz FODP dosyalarını yükleyin.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Ortaya çıkan FODP belgesini kaydedin.
{{< /blocks/products/pf/agp/step-autogen >}}
