---
title: PHP'de Image öğesini PDF biçimine dönüştürün
url: /tr/php-java/conversion/image-to-pdf/
keywords: Image'tan PDF'a, Image'tan PDF'a Dönüştürme, PHP API, PHP Kitaplığı, Image, PDF
description: PHP'de Image öğesini PDF biçimine dönüştürün. Image dosyalarını PDF biçimine dönüştürmek için PowerPoint PHP API kullanın
---
...
{{% blocks/products/pf/feature-page-section h2="PHP'de Image öğesini PDF biçimine dönüştürün" %}}
...
{{% blocks/products/pf/feature-page-section  h2="PHP kullanarak Image biçimini PDF biçimine dönüştürün" %}}
Image dosyasını PDF biçimine dönüştürmek için, Image dosyasından Sunu oluşturmanız ve onu PDF olarak kaydetmeniz gerekir.

{{% blocks/products/pf/agp/code-block title="Image biçimini PDF biçimine dönüştürmek için PHP kodu" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Aspose.Slides for PHP API kullanarak Image biçimini PDF biçimine dönüştürme" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Bunlar, PHP'de Image biçimini PDF biçimine dönüştürme adımlarıdır." >}}
