...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ geliştiricileri, yalnızca birkaç kod satırıyla PPTM dosyasını kolayca XPS'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="PPTM'den XPS'ye C++ Dönüştürme Kaynak Kodu" offSpacer="" %}}
