---
title: C++ ile PNG'yi PPTX'e dönüştürme
url: /tr/cpp/conversion/png-to-pptx/
keywords: PNG'yi PPTX'e, PNG'yi PPTX'e, PowerPoint, PNG, PPTX, C++ API, C++ Kitaplığı'na dönüştürün
description: PNG'yi C++ ile PPTX'e dönüştürün. PNG resimlerini PowerPoint'e dönüştürmek için C++ kitaplık API'sini kullanın
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="C++ ile PNG'yi PPTX'e dönüştürme" h2="C++ kodunu kullanarak PNG'yi PPTX'e dönüştürmek için güçlü platformlar arası C++ API" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides kullanarak PNG'yi PPTX'e dönüştürün" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/tr/cpp/), PowerPoint sunumları, PDF'ler, HTML belgeleri ve diğerlerini oluşturmak, dönüştürmek ve değiştirmek için kullanılan güçlü bir C++ kitaplığıdır. Dosyalar. PNG'yi PPTX'e dönüştürdüğünüzde, aslında PNG görüntülerini temel alan slaytlar içeren bir PowerPoint sunusu oluşturmuş olursunuz.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="C++ ile PNG'yi PPTX'e dönüştürme" %}}
...
{{% blocks/products/pf/agp/code-block title="PNG'yi PPTX'e dönüştürmek için C++ kodu" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="PNG'yi C++ ile PPTX'e dönüştürme" >}}
