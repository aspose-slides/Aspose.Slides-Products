---
title: C++ ile HTML'yi PPT'ye dönüştürün
url: /tr/cpp/conversion/html-to-ppt/
keywords: HTML'yi PPT'ye, HTML'yi PPT'ye, PowerPoint, HTML, PPT, C++ API, C++ Kitaplığına dönüştürün
description: C++'da HTML'yi PPT'ye dönüştürün. HTML'yi PowerPoint'e dönüştürmek için C++ kitaplık API'sini kullanın
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="C++ ile HTML'yi PPT'ye dönüştürün" h2="C++ kodunu kullanarak HTML'yi PPT'ye dönüştürmek için güçlü platformlar arası C++ API" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides kullanarak HTML'yi PPT'ye dönüştürün" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/tr/cpp/), PowerPoint sunumları, PDF'ler, HTML belgeleri ve diğerlerini oluşturmak, dönüştürmek ve değiştirmek için kullanılan güçlü bir C++ kitaplığıdır. Dosyalar. HTML'yi PPT'ye dönüştürdüğünüzde, aslında bir HTML belgesindeki içeriği bir PowerPoint sunumundaki slaytlara taşıyorsunuz.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="C++ ile HTML'yi PPT'ye dönüştürün" %}}
[**Aspose.Slides for C++**](https://products.aspose.com/slides/tr/cpp/) kullanarak, HTML belgesini yalnızca birkaç satır kodla PowerPoint sunumuna dönüştürebilirsiniz:

{{% blocks/products/pf/agp/code-block title="HTML'yi PPT'ye dönüştürmek için C++ kodu" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="C++'da HTML'yi PPT'ye dönüştürme" >}}
