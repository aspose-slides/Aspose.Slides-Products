---
title: POTX Belge Meta Verilerini C++ ile Düzenleyin veya Görüntüleyin
weight: 4270
url: /tr/cpp/metadata/potx/ 
description: Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Runtime Environment'da POTX dosya meta verilerini düzenlemek veya görüntülemek için C++ örnek kodu.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="POTX Meta Verilerini C++ ile Çıkarın" h2="Sunucu tarafı API'lerini kullanarak POTX dosyalarına meta veri eklemek, düzenlemek, kaldırmak veya çıkarmak için kendi C++ uygulamalarınızı oluşturun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTX" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="C++ Kullanarak POTX Meta Verileri Nasıl Elde Edilir" %}}
