---
title: Java'da HTML Dosyalarını Birleştirme
url: /tr/java/merger/html-to-html/
keywords: HTML'yi Birleştirme, HTML'den HTML'ye, HTML'ye Birleştirme, HTML'yi Birleştirme, Java API, Java Kitaplığı
description: Java'da HTML'yi HTML ile birleştirin. HTML dosyalarını birleştirmek için Java kitaplığı API'sini kullanın
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Java'da HTML'yi Birleştirme" h2="Java kodunu kullanarak HTML dosyalarını birleştirmek için yüksek hızlı ve platformlar arası Java kitaplığı" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides kullanarak HTML'yi HTML ile birleştirin" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/tr/java/), sunumlar, HTML dosyaları ve diğer belgeleri oluşturmak, dönüştürmek, birleştirmek ve değiştirmek için kullanılan güçlü bir Java kitaplığıdır. . HTML'yi HTML'ye birleştirdiğinizde, tek bir HTML dosyası elde etmek için 2 belgenin içeriğini etkili bir şekilde birleştirmiş olursunuz. Aspose.Slides, HTML belgelerini farklı şekillerde birleştirmenizi sağlar. HTML'yi tüm metinleri, biçimlendirmeleri, stilleri vb. ile birleştirebilirsiniz.
...
{{% blocks/products/pf/feature-page-section  h2="Java'da HTML'yi HTML ile birleştirme" %}}
[**Aspose.Slides for Java**](https://products.aspose.com/slides/tr/java/) kullanarak, HTML dosyalarını yalnızca birkaç satır kodla hızla birleştirebilirsiniz

{{% blocks/products/pf/agp/code-block title="HTML'yi HTML'ye birleştirmek için Java kodu" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Java'da HTML nasıl birleştirilir" >}}
