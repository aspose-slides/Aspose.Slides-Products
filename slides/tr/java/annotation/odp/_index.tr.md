---
title: Java ile ODP Açıklamasını Kaldır
weight: 1790
url: /tr/java/annotation/odp/ 
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Runtime Environment'daki ODP biçimi ek açıklamalarını silmek için Java örnek kodu.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla ODP'den Yorumları ve Yorum Yazarlarını Kaldırma" h2="Sunucu tarafı API'lerini kullanarak belge dosyalarındaki yorumları ve yazarları değiştirmek için kendi Java uygulamalarınızı oluşturun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak ODP Dosyasına Açıklama Ekleme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile ODP'den Yorumları Kaldırma Adımları" %}}
...
1. ODP formatında kaydedin
1. Belirli bir konumdaki yorumu kaldırın
1. ODP dosyasını tekrar kaydedin ve karşılaştırın
...
{{% blocks/products/pf/agp/code-block title="ODP'den Açıklamaları Sil - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/tr/java/annotation/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
