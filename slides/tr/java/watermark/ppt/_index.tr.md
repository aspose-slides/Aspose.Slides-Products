---
title: Java aracılığıyla filigran PPT belgesi
weight: 6020
url: /tr/java/watermark/ppt/ 
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Runtime Environment'daki PPT dosyasına filigran eklemek veya kaldırmak için Java örnek kodu.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla PPT'ye Metin Filigranı ekleyin" h2="Sunucu tarafı API'lerini kullanarak PPT dosyalarına filigran eklemek için kendi Java uygulamalarınızı oluşturun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak PPT Dosyasını Filigran Etme" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Java ile PPT'ye Filigran Ekleme Adımları" >}}
...
{{% blocks/products/pf/agp/code-block title="PPT'ye Filigran Ekleme - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/tr/java/watermark/pptx/" name="PPTX" description="Açık XML sunum Formatı" >}}
