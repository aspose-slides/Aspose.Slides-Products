---
title: Java ile PPS'yi POT'a dönüştürün
weight: 2790
url: /tr/java/conversion/pps-to-pot/ 
description: PPS formatı için POT dosyasına örnek Java dönüştürme kodu. PowerPoint ve OpenOffice sunumlarını herhangi bir Web veya Masaüstü Java tabanlı Uygulama içinde POT'a aktarmak için bu örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java ile PPS'yi POT'a dönüştürün" h2="Yerinde Java kitaplığını kullanarak tek veya birden çok sayfayı POT'a dönüştürmek için PPS'den POT'a Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="POT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPS" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak PPS'yi POT'a Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile PPS'yi POT'a Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç satır kodla PPS dosyasını kolayca POT'a dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="PPS'den POT'a Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
