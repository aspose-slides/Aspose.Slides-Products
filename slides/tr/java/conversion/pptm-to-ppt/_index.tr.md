...
{{% blocks/products/pf/agp/content h2="Java Kullanarak PPTM'yi PPT'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile PPTM'yi PPT'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, PPTM dosyasını yalnızca birkaç satır kodla kolayca PPT'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="PPTM'den PPT'ye Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
