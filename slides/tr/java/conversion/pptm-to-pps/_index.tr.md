...
{{% blocks/products/pf/agp/content h2="Java Kullanarak PPTM'yi PPS'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile PPTM'yi PPS'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, PPTM dosyasını yalnızca birkaç kod satırıyla kolayca PPS'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="PPTM'den PPS'ye Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
