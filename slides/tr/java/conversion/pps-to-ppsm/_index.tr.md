...
{{% blocks/products/pf/agp/content h2="Java Kullanarak PPS'yi PPSM'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile PPS'yi PPSM'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç kod satırıyla PPS dosyasını kolayca PPSM'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="PPS'den PPSM'ye Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
