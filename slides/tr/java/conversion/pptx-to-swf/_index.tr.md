...
{{% blocks/products/pf/agp/content h2="Java Kullanarak PPTX'i SWF'ye Dönüştürme" %}}

 PPTX'i SWF'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla PPTX'i SWF'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, PPTX dosyasını yalnızca birkaç kod satırıyla kolayca SWF'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="PPTX'ten SWF'ye Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
