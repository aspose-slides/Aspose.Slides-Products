...
title: Java ile PPTM'yi JPEG'e dönüştürün
weight: 6810
url: /tr/java/conversion/pptm-to-jpeg/ 
description: PPTM formatı için JPEG dosyasına örnek Java dönüştürme kodu. PowerPoint ve OpenOffice sunumlarını herhangi bir Web veya Masaüstü Java tabanlı Uygulama içinde JPEG'e aktarmak için bu örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java ile PPTM'yi JPEG'e dönüştürün" h2="Yerinde Java kitaplığını kullanarak tekli veya çoklu sayfaları JPEG'e dönüştürmek için PPTM'den JPEG'e Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTM" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak PPTM'yi JPEG'e Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile PPTM'yi JPEG'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, PPTM dosyasını yalnızca birkaç satır kodla kolayca JPEG'e dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="PPTM'den JPEG'e Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
