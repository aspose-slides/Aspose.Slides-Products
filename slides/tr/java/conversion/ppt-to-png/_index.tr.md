---
title: Java aracılığıyla PPT'yi PNG'ye dönüştürün
weight: 5790
url: /tr/java/conversion/ppt-to-png/ 
description: PPT formatı için PNG dosyasına örnek Java dönüştürme kodu. PowerPoint ve OpenOffice sunumlarını herhangi bir Web veya Masaüstü Java tabanlı Uygulama içinde PNG'ye aktarmak için bu örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla PPT'yi PNG'ye dönüştürün" h2="Şirket içi Java kitaplığını kullanarak tek veya birden çok sayfayı PNG'ye dönüştürmek için PPT'den PNG'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak PPT'yi PNG'ye Dönüştürme" %}}

 PPT'yi PNG'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile PPT'yi PNG'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç kod satırıyla PPT dosyasını PNG'ye kolayca dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="PPT'den PNG'ye Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
