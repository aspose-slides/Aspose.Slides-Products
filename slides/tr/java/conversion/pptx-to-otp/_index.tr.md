...
{{% blocks/products/pf/agp/content h2="Java Kullanarak PPTX'i OTP'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile PPTX'i OTP'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, PPTX dosyasını yalnızca birkaç satır kodla kolayca OTP'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="PPTX'ten OTP'ye Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
