---
title: Java aracılığıyla PPTM'yi ODP'ye dönüştürün
weight: 4740
url: /tr/java/conversion/pptm-to-odp/ 
description: PPTM formatı için ODP dosyasına örnek Java dönüştürme kodu. PowerPoint ve OpenOffice sunumlarını herhangi bir Web veya Masaüstü Java tabanlı Uygulama içinde ODP'ye aktarmak için bu örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla PPTM'yi ODP'ye dönüştürün" h2="Yerinde Java kitaplığı kullanarak tek veya birden çok sayfayı ODP'ye dönüştürmek için PPTM'den ODP'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTM" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak PPTM'yi ODP'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile PPTM'yi ODP'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, PPTM dosyasını yalnızca birkaç satır kodla kolayca ODP'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="PPTM'den ODP'ye Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
