---
title: 在 JavaScript 中將 POTX 轉換為 PPSM
url: /zh-hant/nodejs-net/conversion/potx-to-ppsm/
keywords: POTX 到 PPSM、將 POTX 轉換成 PPSM、Node.js API、JavaScript 函式庫、POTX、PPSM
description: 在 JavaScript 中將 POTX 轉換為 PPSM。使用 Node.js 函式庫 API 將 POTX 檔案轉換為 PPSM
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 JavaScript 中將 POTX 轉換為 PPSM" h2="Aspose.Slides for Node.js via .NET 是一個功能強大且易於使用的函式庫，可讓您將 PowerPoint 簡報轉換為 JavaScript 中的各種格式。它支援所有演示元素和格式，並提供豐富的 API 來存取和修改它們。它還允許您將幻燈片匯出為各種格式以進行進一步處理或共用。" >}}

{{% blocks/products/pf/feature-page-section h2="在 Node.js 中將 POTX 轉換為 PPSM" %}}

[**Aspose.Slides for Node.js via .NET**](https://products.aspose.com/slides/zh-hant/nodejs-net/) 是一個強大的Node.js 函式庫，用於建立和操作示範文件。此外，它還提供了將 POTX 轉換為 PPSM 的靈活方法。透過 .NET 使用 **Aspose.Slides for Node.js**，任何開發人員或應用程式只需幾行程式碼即可將 POTX 轉換為 PPSM 檔案。

作為現代文件處理 API，Aspose.Slides for Node.js 透過 .NET 將 POTX 檔案快速匯出為 PPSM 檔案格式。 Aspose PowerPoint 函式庫可讓您將 POTX 轉換為 PPSM 以及許多其他檔案格式

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="使用 JavaScript 將 POTX 轉換為 PPSM" %}}
要將 POTX 轉換為 PPSM，您需要從 POTX 文件創建演示文稿並將其另存為 PPSM。

{{% blocks/products/pf/agp/code-block title="用於將 POTX 轉換為 PPSM 的 JavaScript 程式碼" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="如何透過 .NET API 使用 Aspose.Slides for Node.js 將 POTX 轉換為 PPSM" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="要透過 .NET 使用 Aspose.Slides for Node.js 將 POTX 轉換為 PPSM，您需要在 JavaScript 檔案中匯入該套件並建立 Presenter 類別的實例。 Presentation 類別表示 PowerPoint 文件並提供存取和操作其元素的方法。" >}}
