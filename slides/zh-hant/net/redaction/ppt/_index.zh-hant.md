---
title: 通過 .NET 搜索和替換 PPT 文檔中的文本
weight: 1410
url: /zh-hant/net/redaction/ppt/ 
description: 用於在 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上編輯 PPT 文件中的敏感信息的 C# 源代碼。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="在 C# 中編輯 PPT 格式" h2="使用用於 .NET API 的服務器端 Aspose.Slides 本機和高性能 PPT 文檔敏感的編輯信息，無需使用 Microsoft 或 Adob​​e PDF 等任何軟件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPT" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="只需幾行代碼即可使用 [Aspose.Slides for .NET](https://products.aspose.com/slides/zh-hant/net) API 進行基本文檔搜索和替換內容、評論或元數據中的文本。在 PowerPoint 和 OpenOffice 中查找和替換文本。通過正則表達式數據匹配編輯演示文稿中的文本、評論、元數據。" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/zh-hant/net/redaction/odp/" name="ODP" description="OpenDocument 演示格式" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/zh-hant/net/redaction/pptx/" name="PPTX" description="打開 XML 表示格式" >}}
