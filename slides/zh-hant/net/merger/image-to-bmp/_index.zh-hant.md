...
description: 在 C# 中將圖像合併為 BMP。使用 .NET 庫 API 組合圖像
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 C# 中將圖像合併為 BMP" h2="強大的跨平台 .NET API，用於在 NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上使用 C# 代碼將圖像合併為 BMP 文件" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 將圖像合併為 BMP" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh-hant/net/) 是一個功能強大的 .NET 庫，用於創建、轉換、合併和操作演示文稿、PDF、圖像、和其他文件。當您將圖像合併為 BMP 時，您實際上是在組合圖像以獲得單個 BMP 文件。
...
{{% blocks/products/pf/feature-page-section  h2="在 C# 中將圖像合併為 BMP" %}}
使用[**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh-hant/net/)，只需幾行代碼即可快速將圖像合併為BMP

{{% blocks/products/pf/agp/code-block title="用於將圖像合併為 BMP 的 C# 代碼" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="如何在C#中將圖像合併到BMP" >}}
