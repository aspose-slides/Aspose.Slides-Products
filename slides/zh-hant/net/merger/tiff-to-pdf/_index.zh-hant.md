...
url: /zh-hant/net/merger/tiff-to-pdf/
keywords: TIFF 到 PDF、合併 TIFF 到 PDF、將 TIFF 合併到 PDF、PDF、TIFF、C# API、.NET 庫
description: 在 C# 中將 TIFF 合併為 PDF。使用 .NET 庫 API 合併 TIFF 和 PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 C# 中將 TIFF 合併為 PDF" h2="強大的跨平台 .NET API，用於在 NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上使用 C# 代碼將 TIFF 合併為 PDF 文件" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 將 TIFF 合併為 PDF" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh-hant/net/) 是一個功能強大的 .NET 庫，用於創建、轉換、合併和操作演示文稿、PDF、圖像、和其他文件。當您將 TIFF 合併為 PDF 時，您實際上是在組合圖像以獲得單個 PDF 文件。
...
使用 [**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh-hant/net/)，只需幾行代碼即可快速將 TIFF 合併為 PDF

{{% blocks/products/pf/agp/code-block title="用於將 TIFF 合併為 PDF 的 C# 代碼" offSpacer="true" %}}
```cs
