---
title: 通過 .NET 刪除 PPTX 註釋
weight: 6550
url: /zh-hant/net/annotation/pptx/ 
description: 用於刪除 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上的 PPTX 格式註釋的 C# 源代碼。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 從 PPTX 中刪除評論和評論作者" h2="構建您自己的 .NET 應用程序以使用服務器端 API 處理文檔文件中的評論和作者。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 註釋 PPTX 文件" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="通過 C# 從 PPTX 中刪除評論" >}}
...
{{% blocks/products/pf/agp/code-block title="從 PPTX 中刪除註釋 - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/zh-hant/net/annotation/ppt/" name="PPT" description="微軟PowerPoint 97-2003" >}}
