---
title: 在 C# 中將 JPG 轉換為 PNG
weight: 220
url: /zh-hant/net/conversion/jpg-to-png/ 
keywords: JPG 轉 PNG、將 JPG 轉為 PNG、C# API、.NET 庫
description: 在 C# 中將 JPG 轉換為 PNG。使用 .NET 庫 API 將 JPG 轉換為 PNG 文件。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 C# 中將 JPG 轉換為 PNG" h2="用於在 NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上將 JPG 轉換為 PNG 圖像文件的 PowerPoint .NET API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="在 C# 中將 JPG 轉換為 PNG" %}}

如何在代碼中將 JPG 轉換為 PNG？

使用 [**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh-hant/net/)，任何開發人員或應用程序只需幾行 C# 代碼即可將 JPG 轉換為 PNG。

作為現代文檔處理 API，Aspose.Slides for .NET 可以快速將 JPG 文件導出為 PNG。 Aspose PowerPoint 庫允許您將 JPG 轉換為 PNG 和其他格式的圖像。
...
{{< blocks/products/pf/agp/feature-section-col title="如何在 C# 中將 JPG 轉換為 PNG" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="開發人員和應用程序可以通過以下方式將 JPG 轉換為 PNG：" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 在運行 JPG 到 PNG 轉換 C# 代碼之前，您的機器必須具備以下先決條件：
...
{{% blocks/products/pf/agp/code-block title="將JPG轉換為PNG的C#代碼" offSpacer="" %}}
