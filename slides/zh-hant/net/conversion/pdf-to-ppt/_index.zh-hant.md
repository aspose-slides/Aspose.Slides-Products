...
url: /zh-hant/net/conversion/pdf-to-ppt/
keywords: 將 PDF 轉換為 PPT、將 PDF 轉換為 PPT、PowerPoint、PDF、PPT、C# API、.NET 庫
description: 在 C# 中將 PDF 轉換為 PPT。使用 .NET 庫 API 將 PDF 轉換為 PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 C# 中將 PDF 轉換為 PPT" h2="強大的跨平台 .NET API，用於在 NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上使用 C# 代碼將 PDF 轉換為 PPT" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 將 PDF 轉換為 PPT" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh-hant/net/) 是一個功能強大的 .NET 庫，用於創建、轉換和操作 PowerPoint 演示文稿、PDF、HTML 文檔、和其他文件。將 PDF 轉換為 PPT 時，實際上是將 PDF 頁面上的內容移動到 PowerPoint 演示文稿中的幻燈片。
...
{{% blocks/products/pf/agp/code-block title="PDF轉PPT的C#代碼" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="如何在C#中將PDF轉換為PPT" >}}
