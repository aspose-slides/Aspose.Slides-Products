...
title: 在 C# 中將圖像轉換為 JPG
weight: 200
url: /zh-hant/net/conversion/image-to-jpg/ 
keywords: 圖像轉 JPG、圖像轉 JPG、C# API、.NET 庫、圖像、JPG
description: 在 C# 中將圖像轉換為 JPG。使用 .NET 庫 API 將圖像轉換為 JPG 圖片。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 C# 中將圖像轉換為 JPG" h2="PowerPoint .NET API，用於在 NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上將圖像轉換為 JPG 圖片" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="在 C# 中將圖像轉換為 JPG" %}}

如何在代碼中將圖像轉換為 JPG？

使用 [**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh-hant/net/)，任何開發人員或應用程序只需幾行 C# 代碼即可將圖像轉換為 JPG 圖片.

作為現代文檔處理 API，Aspose.Slides for .NET 可以快速將流行格式的圖像導出為 JPG。 Aspose PowerPoint 庫允許您將圖像轉換為 JPG 和許多其他圖像格式。
...
{{< blocks/products/pf/agp/feature-section-col title="如何在 C# 中將圖像轉換為 JPG" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="開發人員和應用程序可以通過以下方式將 Image 轉換為 JPG：" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 在運行圖像到 JPG 轉換 C# 代碼之前，您的機器必須具備以下先決條件：
...
{{% blocks/products/pf/agp/code-block title="將圖像轉換為 JPG 的 C# 代碼" offSpacer="" %}}
