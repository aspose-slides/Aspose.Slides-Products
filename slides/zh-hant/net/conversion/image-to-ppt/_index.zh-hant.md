---
title: 在C#中將圖像轉換為PPT
url: /zh-hant/net/conversion/image-to-ppt/
keywords: 圖片轉PPT，圖片轉PPT，PowerPoint，圖片，PPT，C# API，.NET庫
description: 在C#中將圖像轉換為PPT。使用 .NET 庫 API 將圖像轉換為 PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在C#中將圖像轉換為PPT" h2="強大的跨平台 .NET API，用於在 NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上使用 C# 代碼將圖像轉換為 PPT" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 將圖像轉換為 PPT" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh-hant/net/) 是一個功能強大的 .NET 庫，用於創建、轉換和操作 PowerPoint 演示文稿、PDF、HTML 文檔、和其他文件。將圖像轉換為 PPT 時，實際上是在創建包含基於這些圖像的幻燈片的 PowerPoint 演示文稿。

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="在C#中將圖像轉換為PPT" %}}
使用 [**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh-hant/net/)，只需幾行代碼即可將圖像轉換為 PowerPoint 演示文稿：
...
{{< blocks/products/pf/feature-page-section  h2="如何在C#中將圖片轉換為PPT" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/zh-hant/net/conversion/image-to-pptx/" name="IMAGE TO PPTX" >}}
