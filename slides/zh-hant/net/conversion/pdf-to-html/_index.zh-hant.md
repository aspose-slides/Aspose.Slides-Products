...
keywords: PDF 到 HTML、將 PDF 轉換為 HTML、C# API、.NET 庫、PDF、HTML
description: 在 C# 中將 PDF 轉換為 HTML。使用 .NET 庫 API 將 PDF 頁面轉換為 HTML 文件
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 C# 中將 PDF 轉換為 HTML" h2="PowerPoint .NET API，用於在 NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上將 PDF 文檔轉換為 HTML 文件" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="如何在 C# 中將 PDF 轉換為 HTML" %}}

如何在代碼中將 PDF 轉換為 HTML？

使用 [**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh-hant/net/)，任何開發人員或應用程序只需幾行 C# 代碼即可將 PDF 轉換為 HTML 文件。

作為現代文檔處理 API，Aspose.Slides for .NET 可以快速將 PDF 頁面導出為 HTML。 Aspose PowerPoint 庫允許您將 PDF 轉換為 HTML 和許多其他文件格式。
...
{{< blocks/products/pf/agp/feature-section-col title="如何在 C# 中將 PDF 轉換為 HTML" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="開發人員和應用程序可以通過以下方式將 PDF 轉換為 HTML：" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 在運行 PDF 到 HTML 轉換 C# 代碼之前，您的機器必須具備以下先決條件：
...
{{% blocks/products/pf/agp/code-block title="將 PDF 轉換為 HTML 的 C# 代碼" offSpacer="" %}}
