...
title: 通過 C# 將 POTX 轉換為 XPS
weight: 6700
url: /zh-hant/net/conversion/potx-to-xps/ 
description: POTX 到 XPS C# 轉換的示例代碼。使用 API 示例代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中將 POTX 文件批量轉換為 XPS。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 將 POTX 轉換為 XPS" h2="將 PowerPoint® POTX 文件導出到 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上的 XPS" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 將 POTX 轉換為 XPS" %}}

 為了將 POTX 轉換為 XPS，我們將使用
...
{{< blocks/products/pf/agp/feature-section-col title="通過 C# 將 POTX 轉換為 XPS 的步驟" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET 開發人員只需幾行代碼即可輕鬆加載 POTX 文件並將其轉換為 XPS。" >}}
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 POTX 到 XPS C# 的轉換" offSpacer="" %}}
