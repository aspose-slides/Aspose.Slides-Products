...
title: 通過 C# 將 POTX 轉換為 PDF
weight: 2010
url: /zh-hant/net/conversion/potx-to-pdf/ 
description: POTX 到 PDF C# 轉換的示例代碼。使用 API 示例代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中將 POTX 文件批量轉換為 PDF。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 將 POTX 轉換為 PDF" h2="在 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上將 PowerPoint® POTX 文件導出為 PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 將 POTX 轉換為 PDF" %}}

 為了將 POTX 轉換為 PDF，我們將使用
...
{{< blocks/products/pf/agp/feature-section-col title="通過 C# 將 POTX 轉換為 PDF 的步驟" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET 開發人員只需幾行代碼即可輕鬆加載 POTX 文件並將其轉換為 PDF。" >}}
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 POTX 到 PDF C# 的轉換" offSpacer="" %}}
