---
title: 在 C# 中編輯 PDF
url: /zh-hant/net/editor/pdf/
keywords: 編輯 PDF、PDF、C# API、.NET 庫
description: 在 C# 中編輯 PDF。使用 .NET 庫 API 編輯 PDF 文檔
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 C# 中編輯 PDF" h2="強大的跨平台 .NET API，用於在 NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上使用 C# 代碼編輯 PDF" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 編輯 PDF" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh-hant/net/) 是一個功能強大的 .NET 庫，用於操作和編輯演示文稿、PDF 文檔和其他文件。您可以通過向其中添加新的文本行來編輯 PDF 文檔。 
...
使用 [**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh-hant/net/)，您只需幾行代碼即可向 PDF 文檔添加新的文本行。
