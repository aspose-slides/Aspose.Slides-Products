---
title: 使用 .NET 保護 ODP 演示文件
url: /zh-hant/net/protect/odp/
keywords: 寫保護 ODP，加密 ODP，鎖定 ODP 演示文稿，保護 ODP
description: C# 源代碼保護 ODP 演示。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="使用 C# 鎖定或密碼保護 ODP" h2="使用服務器端 API 構建您自己的 .NET 應用程序以保護演示文稿文件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" fileiconsmall4="POT" fileiconsmall5="ppsx" >}}
