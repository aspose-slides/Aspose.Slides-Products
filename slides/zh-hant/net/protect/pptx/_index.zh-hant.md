---
title: 通過 .NET 保護和鎖定 PPTX 文檔
weight: 5000
url: /zh-hant/net/protect/pptx/ 
description: 在 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上使用密碼鎖定 PPTX 文件的 C# 源代碼。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 加密 PPTX 文件" h2="使用 .NET 庫對包括 PPTX 格式的 PowerPoint 演示文稿進行密碼保護。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{< blocks/products/pf/agp/feature-section-col title="通過 C# 保護 PPTX" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/zh-hant/net/protect/ppt/" name="PPT" description="微軟PowerPoint 97-2003" >}}
