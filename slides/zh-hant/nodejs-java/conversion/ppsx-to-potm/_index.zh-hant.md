---
title: 在 Node.js 中將 PPSX 轉換為 POTM
url: /zh-hant/nodejs-java/conversion/ppsx-to-potm/
keywords: PPSX 到 POTM、將 PPSX 轉換為 POTM、Node.js API、Node.js 庫、PPSX、POTM
description: 在 Node.js 中將 PPSX 轉換為 POTM。使用 Node.js 庫 API 將 PPSX 文件轉換為 POTM
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 Node.js 中將 PPSX 轉換為 POTM" h2="Aspose.Slides for Node.js via Java 是一個功能強大且易於使用的庫，允許您將 PowerPoint 演示文稿轉換為 Node.js 中的各種格式。它支持所有演示元素和格式，並提供豐富的 API 來訪問和修改它們。它還允許您將幻燈片導出為各種格式以進行進一步處理或共享。" >}}

{{% blocks/products/pf/feature-page-section h2="在 Node.js 中將 PPSX 轉換為 POTM" %}}

[**Aspose.Slides for Node.js via Java**](https://products.aspose.com/slides/zh-hant/nodejs-java/) 是一個強大的Node.js 庫，用於創建和操作演示文稿文件。此外，它還提供了將 PPSX 轉換為 POTM 的靈活方法。使用 **Aspose.Slides for Node.js via Java**，任何開發人員或應用程序只需幾行代碼即可將 PPSX 轉換為 POTM 文件。

作為現代文檔處理 API，Aspose.Slides for Node.js 將 PPSX 文件快速導出為 POTM 文件格式。 Aspose PowerPoint 庫允許您將 PPSX 轉換為 POTM 以及許多其他文件格式

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="使用 Node.js 將 PPSX 轉換為 POTM" %}}
要將 PPSX 轉換為 POTM，您需要從 PPSX 文件創建演示文稿並將其另存為 POTM。

{{% blocks/products/pf/agp/code-block title="用於將 PPSX 轉換為 POTM 的 Node.js 代碼" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="如何通過 Java API 使用 Aspose.Slides for Node.js 將 PPSX 轉換為 POTM" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="要通過 Java 使用 Aspose.Slides for Node.js 將 PPSX 轉換為 POTM，您需要在 JavaScript 文件中導入該包並創建Presentation 類的實例。 Presentation 類表示 PowerPoint 文檔並提供訪問和操作其元素的方法。" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/zh-hant/nodejs-java/conversion/ppsx-to-jpg/" name="PPSX TO JPG" >}}
