...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">高級 Java PowerPoint 文檔處理 API 功能</h2>

<p>Aspose.Slides for Java 結合了許多高級功能，讓開發人員在 Java 環境中使用 Microsoft PowerPoint 演示文稿進行編程時可以完全控制。</p>-->
   <h2 class="pr-ft">
...
<h2 class="h2title">幻燈片內容格式</h2>

<p>可以使用 Aspose.Slides for Java API 對演示文稿中的幻燈片上的文本和形狀進行格式化。文本通過與形狀關聯的文本框架進行管理。因此，使用與文本框架相關聯的段落和部分來格式化文本。您還可以操作形狀元素的屬性，如位置、大小、線條、圖像、文本和填充。</p>
