---
title: 在 Java 中合併 PDF 文件
url: /zh-hant/java/merger/pdf-to-pdf/
keywords: 合併 PDF、PDF 到 PDF、合併 PDF、合併 PDF、Java API、Java 庫
description: 在 Java 中將 PDF 合併為 PDF。使用 Java 庫 API 合併 PDF 文件
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 Java 中合併 PDF" h2="用於使用 Java 代碼合併 PDF 文件的高速跨平台 Java 庫" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 將 PDF 合併為 PDF" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/zh-hant/java/) 是一個功能強大的 Java 庫，用於創建、轉換、合併和操作演示文稿、PDF 和其他文檔。將 PDF 合併為 PDF 時，實際上是將 2 個文檔的頁面合併為一個 PDF 文件。 Aspose.Slides 允許您以不同的方式合併 PDF。您可以合併 PDF 及其所有形狀、樣式、文本、格式等。
...
{{% blocks/products/pf/feature-page-section  h2="在 Java 中將 PDF 合併為 PDF" %}}
使用[**Aspose.Slides for Java**](https://products.aspose.com/slides/zh-hant/java/)，只需幾行代碼即可快速合併PDF文件

{{% blocks/products/pf/agp/code-block title="將 PDF 合併為 PDF 的 Java 代碼" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="如何在 Java 中合併 PDF" >}}
