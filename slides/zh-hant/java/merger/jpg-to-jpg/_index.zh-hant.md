---
title: 在 Java 中合併 JPG 圖像
url: /zh-hant/java/merger/jpg-to-jpg/
keywords: 合併 JPG、JPEG 到 JPG、加入 JPG、合併 JPG、Java API、Java 庫
description: 在 Java 中將 JPG 合併為 JPG。使用 Java 庫 API 合併 JPG 文件
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 Java 中合併 JPG" h2="用於使用 Java 代碼合併 JPG 圖像的高速跨平台 Java 庫" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 將 JPG 合併為 JPG" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/zh-hant/java/) 是一個功能強大的 Java 庫，用於合併和操作演示文稿、圖像和其他文件。當您將 JPG 合併為 JPG 時，實際上是將兩張圖像組合成一張圖片。
...
{{% blocks/products/pf/feature-page-section  h2="在 Java 中將 JPG 合併為 JPG" %}}
使用[**Aspose.Slides for Java**](https://products.aspose.com/slides/zh-hant/java/)，只需幾行代碼即可快速合併JPG文件

{{% blocks/products/pf/agp/code-block title="將 JPG 合併為 JPG 的 Java 代碼" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="如何在 Java 中合併 JPG" >}}
