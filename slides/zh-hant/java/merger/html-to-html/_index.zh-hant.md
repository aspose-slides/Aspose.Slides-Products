---
title: 在 Java 中合併 HTML 文件
url: /zh-hant/java/merger/html-to-html/
keywords: 合併 HTML、HTML 到 HTML、加入 HTML、合併 HTML、Java API、Java 庫
description: 在 Java 中將 HTML 合併到 HTML。使用 Java 庫 API 組合 HTML 文件
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 Java 中合併 HTML" h2="用於使用 Java 代碼合併 HTML 文件的高速跨平台 Java 庫" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 將 HTML 合併為 HTML" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/zh-hant/java/) 是一個功能強大的 Java 庫，用於創建、轉換、合併和操作演示文稿、HTML 文件和其他文檔.將 HTML 合併到 HTML 時，實際上是將 2 個文檔的內容合併為一個 HTML 文件。 Aspose.Slides 允許您以不同的方式合併 HTML 文檔。您可以將 HTML 與其所有文本、格式、樣式等合併。
...
{{% blocks/products/pf/feature-page-section  h2="在 Java 中將 HTML 合併為 HTML" %}}
使用[**Aspose.Slides for Java**](https://products.aspose.com/slides/zh-hant/java/)，只需幾行代碼即可快速合併HTML文件

{{% blocks/products/pf/agp/code-block title="將 HTML 合併到 HTML 的 Java 代碼" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="如何在 Java 中合併 HTML" >}}
