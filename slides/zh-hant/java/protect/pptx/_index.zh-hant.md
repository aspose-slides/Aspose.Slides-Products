---
title: 通過 Java 保護和鎖定 PPTX 文檔
weight: 6710
url: /zh-hant/java/protect/pptx/ 
description: Java 示例代碼，用於在 JSP/JSF 應用程序和桌面應用程序的 Java 運行時環境中使用密碼鎖定 PPTX 文件。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 加密 PPTX 文件" h2="使用 .NET 庫對包括 PPTX 格式的 PowerPoint 演示文稿進行密碼保護。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 保護 PPTX 文件" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="通過 Java 保護 PPTX 文件的步驟" >}}
