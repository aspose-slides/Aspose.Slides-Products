...
title: 通過 Java 將 PPSX 轉換為 PDF
weight: 5390
url: /zh-hant/java/conversion/ppsx-to-pdf/ 
description: PPSX 格式到 PDF 文件的示例 Java 轉換代碼。使用此示例代碼在任何基於 Web 或桌面 Java 的應用程序中將 PowerPoint 和 OpenOffice 演示文稿導出為 PDF。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 將 PPSX 轉換為 PDF" h2="PPSX 到 PDF Java 轉換使用本地 Java 庫將單個或多個頁面轉換為 PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將 PPSX 轉換為 PDF" %}}

 為了將 PPSX 渲染為 PDF，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 將 PPSX 轉換為 PDF 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 Java 開發人員只需幾行代碼即可輕鬆地將 PPSX 文件轉換為 PDF。
...
{{% blocks/products/pf/agp/code-block title="PPSX 到 PDF Java 轉換源代碼" offSpacer="" %}}
