...
{{% blocks/products/pf/agp/code-block title="修改 PPSM 內置屬性 - Java" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="將自定義屬性添加到 PPSM - Java" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="如何通過 Java 提取 PPSM 的元數據" >}}
