---
title: 使用 Python 將 PPSX 文件合併到 TIFF
url: /zh-hant/python-net/merge/ppsx-to-tiff/
keywords: 將 PPSX 合併到 TIFF，將 PPSX 連接到 TIFF，將 PPSX 合併到 TIFF，PowerPoint，演示文稿，TIFF，Python，Aspose
...
{{< blocks/products/pf/feature-page-header h1="在 Python 中將 PPSX 文件合併到 TIFF" h2="高速和跨平台的 Python API，有助於開發應用程序，無需使用 Microsoft 或 Open Office、Adobe PDF 等任何軟件即可創建、合併、檢查或轉換 Microsoft PowerPoint 和 OpenOffice 演示文件。" >}}

{{% blocks/products/pf/feature-page-section h2="在 Python 中將 PPSX 合併到 TIFF" %}}
...
{{% blocks/products/pf/feature-page-section  h2="使用 Python 將 PPSX 文件合併到 TIFF" %}}
要合併 PowerPoint 演示文稿，您需要將幻燈片從一個演示文稿克隆到另一個演示文稿。

{{% blocks/products/pf/agp/code-block title="用於將多個 PPSX 合併為單個 TIFF 文件的 Python 代碼" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="如何使用 Aspose.Slides for Python API 將 PPSX 合併到 TIFF" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="這些是在 Python 中合併兩個 PPSX 文件並將結果保存為 TIFF 的步驟。" >}}
