...
description: 在 Python 中將 PNG 合併為 PNG。使用 Python 庫 API 合併 PNG 文件
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 Python 中合併 PNG" h2="用於使用 Python 代碼合併 PNG 圖像的高速跨平台 Python 庫" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 將 PNG 合併為 PNG" %}}

[**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/zh-hant/python-net/) 是一個功能強大的 Python 庫，用於合併和操作演示文稿、圖像和其他文件。將 PNG 合併為 PNG 時，實際上是將兩張圖像組合成一張圖片。
...
{{% blocks/products/pf/feature-page-section  h2="在 Python 中將 PNG 合併為 PNG" %}}
使用 [**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/zh-hant/python-net/)，只需幾行代碼即可快速合併 PNG 文件

{{% blocks/products/pf/agp/code-block title="將 PNG 合併為 PNG 的 Python 代碼" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="如何在 Python 中合併 PNG" >}}
