---
title: 在 Python 中將 PNG 轉換為 PPTX
url: /zh-hant/python-net/conversion/png-to-pptx/
keywords: 將 PNG 轉換為 PPTX、將 PNG 轉換為 PPTX、PowerPoint、PNG、PPTX、Python API、Python 庫
description: 在 Python 中將 PNG 轉換為 PPTX。使用 Python 庫 API 將 PNG 圖像轉換為 PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 Python 中將 PNG 轉換為 PPTX" h2="強大的跨平台 Python API，用於使用 Python 代碼將 PNG 轉換為 PPTX" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 將 PNG 轉換為 PPTX" %}}

[**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/zh-hant/python-net/) 是一個功能強大的 Python 庫，用於創建、轉換和操作 PowerPoint 演示文稿、PDF、 HTML 文檔和其他文件。將 PNG 轉換為 PPTX 時，實際上是在創建包含基於 PNG 圖像的幻燈片的 PowerPoint 演示文稿。

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="在 Python 中將 PNG 轉換為 PPTX" %}}
使用 [**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/zh-hant/python-net/)，只需幾行代碼即可將 PNG 圖像轉換為 PowerPoint 演示文稿：

{{% blocks/products/pf/agp/code-block title="將PNG轉換為PPTX的Python代碼" offSpacer="true" %}}
```py
...
{{< blocks/products/pf/feature-page-section  h2="如何在 Python 中將 PNG 轉換為 PPTX" >}}
