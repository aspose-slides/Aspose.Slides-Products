---
title: 在 Python 中將 HTML 轉換為 PPT
url: /zh-hant/python-net/conversion/html-to-ppt/
keywords: 將 HTML 轉換為 PPT、將 HTML 轉換為 PPT、PowerPoint、HTML、PPT、Python API、Python 庫
description: 在 Python 中將 HTML 轉換為 PPT。使用 Python 庫 API 將 HTML 轉換為 PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 Python 中將 HTML 轉換為 PPT" h2="強大的跨平台 Python API，用於使用 Python 代碼將 HTML 轉換為 PPT" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 將 HTML 轉換為 PPT" %}}

[**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/zh-hant/python-net/) 是一個功能強大的 Python 庫，用於創建、轉換和操作 PowerPoint 演示文稿、PDF、 HTML 文檔和其他文件。將 HTML 轉換為 PPT 時，實際上是將 HTML 文檔中的內容移動到 PowerPoint 演示文稿中的幻燈片。

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="在 Python 中將 HTML 轉換為 PPT" %}}
...
{{% blocks/products/pf/agp/code-block title="HTML轉PPT的Python代碼" offSpacer="true" %}}
```py
...
{{< blocks/products/pf/feature-page-section  h2="如何在 Python 中將 HTML 轉換為 PPT" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/zh-hant/python-net/conversion/jpg-to-ppt/" name="JPG TO PPTX" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/zh-hant/python-net/conversion/jpg-to-pptx/" name="JPG TO PPT" >}}
