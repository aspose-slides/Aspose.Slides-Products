---
title: 在 Python 中將 POTX 轉換為 XPS
weight: 1540
url: /zh-hant/python-net/conversion/potx-to-xps/ 
keywords: "Convert, PowerPoint, POTX, XPS, Presentation, Python"
description: POTX 到 XPS Python 轉換的示例代碼。使用 PowerPoint Python API 將 POTX 文件批量轉換為 XPS 文件。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="在 Python 中將 POTX 轉換為 XPS" h2="用於將 POTX 轉換為 XPS 的強大 PowerPoint Python 庫" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{< blocks/products/pf/agp/feature-section-col title="如何在 Python 中將 POTX 轉換為 XPS" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="這些是使用 Python 將 POTX 文件轉換為 XPS 的步驟。" >}}
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 POTX 到 XPS Python 的轉換" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="在 Python 中將 POTX 保存為 XPS" %}}
使用免費應用程序查看 POTX 到 XPS 轉換過程的演示。 
{{% /blocks/products/pf/agp/content %}}
