...
{{% blocks/products/pf/agp/code-block title="修改 POTM 內置屬性 - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="將自定義屬性添加到 POTM - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="如何通過 Python 提取 POTM 的元數據" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="這些是從 POTM 文件中提取元數據的步驟。" >}}

{{< blocks/products/pf/agp/step-autogen >}}
使用 POTM 文件的路徑實例化 Presentation 類
{{< /blocks/products/pf/agp/step-autogen >}}
