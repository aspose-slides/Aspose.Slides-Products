...
{{% blocks/products/pf/agp/code-block title="修改 PPTM 內置屬性 - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="將自定義屬性添加到 PPTM - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="如何通過 Python 提取 PPTM 的元數據" >}}
