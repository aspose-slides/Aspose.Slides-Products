...
{{% blocks/products/pf/agp/code-block title="修改 PPSX 內置屬性 - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="將自定義屬性添加到 PPSX - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="如何通過 Python 提取 PPSX 的元數據" >}}
