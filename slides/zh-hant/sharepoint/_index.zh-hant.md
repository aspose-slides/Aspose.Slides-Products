...
description: SharePoint PowerPoint 是一個 Aspose.Slides SharePoint，用於創建和轉換 SharePoint PPT、SharePoint 幻燈片、SharePoint 演示文稿。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="SharePoint PowerPoint 解決方案" h2="在 SharePoint 中管理和轉換 PowerPoint 演示文稿。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-sharepoint.svg" pfName="Aspose.Slides" subTitlepfName="for SharePoint" downloadUrl="https://downloads.aspose.com/slides/sharepoint" >}}
...
<p>
 Aspose.Slides for SharePoint 用於管理和轉換 SharePoint 中的 PowerPoint 文件。 Aspose.Slides 作為 SharePoint PowerPoint 解決方案，可以輕鬆導入常見的 Microsoft 演示格式，包括 PPT、POT、PPS、PPTX、POTX 和 PPSX，並且可以將這些格式導出為 PDF、TIFF 和 XPS 文件。無需 Microsoft PowerPoint 自動化即可使用所有 SharePoint PPT 功能。
</p>

<p>
 Aspose.Slides for SharePoint 適用於 Windows SharePoint Services WSS 3.0 和 Microsoft Office SharePoint Server 2007、2010 和 2013。
</p>
...
{{< blocks/products/pf/carousel-item h3="乍看上去" description="Aspose.Slides for SharePoint 概述" >}}
...
{{< blocks/products/pf/carousel-item h3="平台獨立性" description="Aspose.Slides for SharePoint 可與 Microsoft Office SharePoint Server 和 Windows SharePoint Services 一起使用。" >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Aspose.Slides for SharePoint 支持最常見的演示文稿 [文件格式](https://docs.aspose.com/slides/sharepoint/supported-file-formats/)。" >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     從 SharePoint 文檔庫轉換 PowerPoint 文件
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     將 PowerPoint 演示文稿轉換為多種格式
    </h2>
    <p>
     Aspose.Slides for SharePoint 將您的 SharePoint 文檔庫中的演示文稿轉換為許多流行的文檔交換格式。 Aspose.Slides for SharePoint 支持常見的演示格式作為輸入格式，並且可以導出為演示格式以及 PDF、TIFF 和 XPS。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for SharePoint 以 ZIP 存檔的形式提供。將ZIP文件解壓到MOSS 7.0或WSS 3.0服務器的本地驅動器，運行setup.exe安裝使用。就這麼簡單！
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for SharePoint 使用託管代碼構建，無需在機器上安裝 Microsoft PowerPoint 即可處理 PowerPoint 文檔格式轉換。在支持的功能、安全性、穩定性、可擴展性、速度和價格方面，它是一個完美的 Microsoft PowerPoint 自動化替代方案。
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="文檔" href="https://docs.aspose.com/slides/sharepoint/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="為什麼選擇 Aspose.Slides for SharePoint？" tabId="success-stories" >}}
