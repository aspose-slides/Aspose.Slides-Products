...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 將 XML 轉換為 XPS" %}}

 為了將 XML 轉換為 XPS，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 C++ 將 XML 轉換為 XPS 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 C++ 開發人員只需幾行代碼即可輕鬆地將 XML 文件轉換為 XPS。
...
{{% blocks/products/pf/agp/code-block title="XML 到 XPS C++ 轉換源代碼" offSpacer="" %}}
