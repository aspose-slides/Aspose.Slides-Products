...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ 開發人員只需幾行代碼即可輕鬆地將 XML 文件轉換為 PDF。
...
{{% blocks/products/pf/agp/code-block title="XML 到 PDF C++ 轉換源代碼" offSpacer="" %}}
