---
title: 在 C++ 中將 PDF 轉換為 Image
url: /zh-hant/cpp/conversion/pdf-to-image/
keywords: PDF 到 Image，將 PDF 轉換為 Image，C++ API，C++ 庫，PDF，Image
description: 在 C++ 中將 PDF 轉換為 Image。使用 C++ 庫 API 將 PDF 文件轉換為 Image
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 C++ 中將 PDF 轉換為 Image" h2="高速和跨平台的 C++ 庫，有助於開發能夠創建、合併、檢查或轉換 Microsoft PowerPoint 和 OpenOffice 演示文稿文件的應用程序，而無需使用 Microsoft 或 Open Office、Adobe PDF 等任何軟件。" >}}

{{% blocks/products/pf/feature-page-section h2="在 C++ 中將 PDF 轉換為 Image" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/zh-hant/cpp/) 是一個強大的 C++ 庫，用於創建和操作演示文稿文件。此外，它提供了將 PDF 轉換為 Image 的靈活方法。使用**Aspose.Slides for C++**，任何開發人員或應用程序只需幾行 C++ 代碼即可將 PDF 轉換為 Image 文件。

作為現代文檔處理 API，Aspose.Slides for C++ 可快速將 PDF 文件導出為 Image 文件格式。 Aspose PowerPoint 庫允許您將 PDF 轉換為 Image 和許多其他文件格式

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="使用 C++ 將 PDF 轉換為 Image" %}}
要將 PDF 轉換為 Image，您需要從 PDF 文件創建演示文稿並將其另存為 Image。

{{% blocks/products/pf/agp/code-block title="將 PDF 轉換為 Image 的 C++ 代碼" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="如何使用 Aspose.Slides for C++ API 將 PDF 轉換為 Image" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="這些是在 C++ 中將 PDF 轉換為 Image 的步驟。" >}}
