---
title: 在 C++ 中將 HTML 轉換為 PPTX
url: /zh-hant/cpp/conversion/html-to-pptx/
keywords: 將 HTML 轉換為 PPTX、將 HTML 轉換為 PPTX、PowerPoint、HTML、PPTX、C++ API、C++ 庫
description: 在 C++ 中將 HTML 轉換為 PPTX。使用 C++ 庫 API 將 HTML 轉換為 PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 C++ 中將 HTML 轉換為 PPTX" h2="強大的跨平台 C++ API，用於使用 C++ 代碼將 HTML 轉換為 PPTX" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 將 HTML 轉換為 PPTX" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/zh-hant/cpp/) 是一個強大的 C++ 庫，用於創建、轉換和操作 PowerPoint 演示文稿、PDF、HTML 文檔和其他文件。將 HTML 轉換為 PPTX 時，實際上是將 HTML 文檔中的內容移動到 PowerPoint 演示文稿中的幻燈片。

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="在 C++ 中將 HTML 轉換為 PPTX" %}}
...
{{< blocks/products/pf/feature-page-section  h2="如何在 C++ 中將 HTML 轉換為 PPTX" >}}
