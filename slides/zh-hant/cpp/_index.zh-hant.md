...
<p class="col-lg-10">將 Excel 圖表作為 OLE 對象嵌入到幻燈片中</p>

</div>

<div class="col-lg-4"><em class="fa fa-print  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">管理鏈接的 Ole 對象</p>
...
<h2 class="h2title">新功能的持續集成</h2>

<p>您永遠不會局限於現有功能。我們的產品團隊不斷添加越來越多的功能，並且與舊版本相比，每個新版本都提供了更多功能。如果您發現缺少任何所需的功能，您也可以發送新功能請求。以下是最新功能的一些精選列表。</p>

<ul>

<li>沒有文本的形狀的光柵化或矢量化。</li>

<li>將 SVG 圖像轉換為形狀。</li>

<li>獲取默認的表格背景。</li>

<li>打開文檔時限製本地文件系統訪問。</li>

<li>保存到 HTML 時添加編碼元標記。</li>

<li>保存為 HTML 時刪除 SVG 標籤的寬度和高度屬性的設置。</li>

<li>Support for

<ul>

<li>評論回复、Office 365 和外部 Excel 工作簿。</li>

<li>大小代表氣泡圖的屬性。</li>

<li>在生成的 PPT 中隱藏左側幻燈片縮略圖窗格。</li>

<li>漏斗圖、2D 地圖圖表和設置圖表外部數據源工作簿路徑。</li>

<li>OpenDocument 加密、變形轉換和文本熒光筆功能。</li>
...
<li>渲染形狀軟邊緣（EffectFormat）效果。</li>

<li>數據透視表上的 ChartData SetRange。</li>

</ul>

</li>

<li>實現多頁 Tiff 格式、Metafile Format Plus Extensions (EMF+) 和 Strict Open XML 格式。</li>

<li>以 ODP 格式呈現沒有作者的評論。</li>

<li>使用嚴格的 Open XML 格式合規性實施序列化。</li>
...
<h2 class="h2title">SmartArt 形狀處理</h2>

<p>Aspose.Slides for C++ 有助於從頭開始創建 SmartArt 形狀，並提供從幻燈片中訪問、操作或刪除現有 SmartArt 形狀的能力。此外，還可以格式化 SmartArt 形狀，例如設置樣式、顏色和佈局。</p>
...
{{< blocks/products/pf/slr-element name="發行說明" href="https://docs.aspose.com/slides/cpp/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
