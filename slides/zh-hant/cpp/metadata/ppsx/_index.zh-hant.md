...
{{% blocks/products/pf/agp/code-block title="修改 PPSX 內置屬性 - C++" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="將自定義屬性添加到 PPSX - C++" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="如何通過 C++ 提取 PPSX 的元數據" >}}
