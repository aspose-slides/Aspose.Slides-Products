---
title: 在 C++ 中將 PNG 合併為 PDF
url: /zh-hant/cpp/merger/png-to-pdf/
keywords: PNG 到 PDF，將 PNG 合併到 PDF，將 PNG 合併到 PDF，PDF，PNG，C++ API，C++ 庫
description: 在 C++ 中將 PNG 合併為 PDF。使用 C++ 庫 API 合併 PNG 和 PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 C++ 中將 PNG 合併為 PDF" h2="用於使用 C++ 代碼將 PNG 合併為 PDF 文件的高速跨平台 C++ 庫" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 將 PNG 合併為 PDF" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/zh-hant/cpp/) 是一個功能強大的 C++ 庫，用於創建、轉換、合併和操作演示文稿、圖像和其他文件。當您將 PNG 合併為 PDF 時，您實際上是在組合 PNG 圖像以獲得單個 PDF 文件。
...
{{% blocks/products/pf/feature-page-section  h2="在 C++ 中將 PNG 合併為 PDF" %}}
使用 [**Aspose.Slides for C++**](https://products.aspose.com/slides/zh-hant/cpp/)，只需幾行代碼即可快速將 PNG 合併為 PDF

{{% blocks/products/pf/agp/code-block title="將 PNG 合併為 PDF 的 C++ 代碼" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="如何在 C++ 中將 PNG 合併為 PDF" >}}
