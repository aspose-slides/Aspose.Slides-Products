...
title: 將 JasperReports 導出到 PowerPoint | Aspose.Slides
weight: 8320
url: /zh-hant/jasperreports/ 
description: Aspose.Slides PowerPoint API for JaspreReport 將報告從 Jasper Reports 和 JasperServer 導出為 PowerPoint 格式。創建和導出帳戶圖表圖像文本和行報告到 PPT 演示文稿
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="將 JasperServer 報告導出到 PowerPoint 演示文稿" h2="用於將 JasperReports 和 JasperServer 報告導出為 PPT(X)、PPS(X) 和其他 PowerPoint 格式的 PowerPoint API。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-jasperreports.svg" pfName="Aspose.Slides" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/slides/jasperreport" >}}
...
<p>
 Aspose.Slides for JasperReports 是一個 PowerPoint API，用於靈活且易於使用地將 JasperReports 和 JasperServer 報告導出到 PowerPoint。 JasperServer 沒有將報告導出為 PowerPoint 演示文稿的內置功能。但是，使用此 PowerPoint API，JasperServer 報告可以導出為 PPT、PPS、PPTX 和 PPSX 演示格式，而無需使用 Microsoft PowerPoint。
</p>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">高級 JasperReports 到演示文稿導出功能</h2>

<p> </p>

<div class="col-lg-4"><em class="fa fa-file-powerpoint-o  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">創建帳戶報告並將其導出到 Microsoft PowerPoint 演示文稿</p>

</div>

<div class="col-lg-4"><em class="fa fa-bar-chart   ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">創建圖表報告並將其導出到 Microsoft PowerPoint 演示文稿</p>

</div>

<div class="col-lg-4"><em class="fa fa-pie-chart ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">創建多軸圖表報告並導出到 Microsoft PowerPoint 演示文稿</p>

</div>

<div class="col-lg-4"><em class="fa fa-file-text ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">創建圖像、文本、線條並將這些報告導出到 Microsoft PowerPoint 演示文稿</p>

</div>-->
   <h2 class="pr-ft">
    高級 JasperReports PowerPoint API 功能
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     支持評論回复、Office 365 和外部 Excel 工作簿
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Slides for JasperReports 支持導出包含
     <強>
      多軸圖表報告
     </strong>
     到 Microsoft PowerPoint 演示文稿。輸出與通過 JasperViewer 查看時的顯示完全相同。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     JasperReports 和 JasperServer 沒有內置支持將報告導出到 Microsoft PowerPoint 演示文稿，但是，與 JasperReports 的 Aspose.Slides 集成允許您將報告導出到 Microsoft PowerPoint 演示文稿（PPT、PPTX）和 Microsoft PowerPoint 幻燈片（PPS、 PPSX）。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Microsoft PowerPoint 自動化 - 不需要
    </h2>
    <p>
     Aspose.Slides for JasperReports 使用託管代碼構建，無需在機器上安裝 Microsoft PowerPoint 即可處理 PowerPoint 文檔。在支持的功能、安全性、穩定性、可擴展性、速度和價格方面，它是一個完美的 Microsoft PowerPoint 自動化替代方案。
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="文檔" href="https://docs.aspose.com/slides/jasperreports/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="為什麼為 JasperReports 使用 Aspose.Slides？" tabId="success-stories" >}}
