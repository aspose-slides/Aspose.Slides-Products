---
title: 在 PHP 中將 PNG 合併為 PDF
url: /zh-hant/php-java/merger/png-to-pdf/
keywords: PNG 到 PDF，將 PNG 合併到 PDF，將 PNG 合併到 PDF，PDF，PNG，PHP API，PHP 庫
description: 在 PHP 中將 PNG 合併為 PDF。使用 PHP 庫 API 合併 PNG 和 PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 PHP 中將 PNG 合併為 PDF" h2="高速和跨平台的 PHP 庫，用於使用 PHP 代碼將 PNG 合併為 PDF 文件" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 將 PNG 合併為 PDF" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/zh-hant/php-java/) 是一個功能強大的 PHP 庫，用於創建、轉換、合併和操作演示文稿、圖像、和其他文件。當您將 PNG 合併為 PDF 時，您實際上是在組合 PNG 圖像以獲得單個 PDF 文件。
...
{{% blocks/products/pf/feature-page-section  h2="在 PHP 中將 PNG 合併為 PDF" %}}
使用 [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/zh-hant/php-java/)，只需幾行代碼即可快速將 PNG 合併為 PDF

{{% blocks/products/pf/agp/code-block title="將 PNG 合併為 PDF 的 PHP 代碼" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="如何在 PHP 中將 PNG 合併為 PDF" >}}
