---
title: 在 PHP 中合併圖像
url: /zh-hant/php-java/merger/image-to-image/
keywords: 合併圖像、圖像到圖像、連接圖像、組合圖像、PHP API、PHP 庫
description: 在 PHP 中將圖像合併到圖像。使用 PHP 庫 API 組合圖像
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 PHP 中合併圖像" h2="用於使用 PHP 代碼合併圖像的高速跨平台 PHP 庫" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 將圖像合併到圖像" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/zh-hant/php-java/) 是一個功能強大的 PHP 庫，用於合併和操作演示文稿、圖像和其他文件。將圖像合併到圖像時，實際上是將兩幅圖像組合成一張照片。
...
{{% blocks/products/pf/feature-page-section  h2="在 PHP 中將圖像合併到圖像" %}}
使用 [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/zh-hant/php-java/)，只需幾行代碼即可快速合併圖像文件

{{% blocks/products/pf/agp/code-block title="用於將圖像合併到圖像的 PHP 代碼" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="如何在 PHP 中合併圖像" >}}
