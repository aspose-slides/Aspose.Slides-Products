---
title: 在 PHP 中將 FODP 轉換為 SVG
weight: 180
url: /zh-hant/php-java/conversion/fodp-to-svg/ 
keywords: "Convert, PowerPoint, FODP, SVG, Presentation, PHP"
description: FODP 到 SVG PHP 轉換的示例代碼。使用 PowerPoint PHP API 將 FODP 文件批量轉換為 SVG 文件。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="在 PHP 中將 FODP 轉換為 SVG" h2="用於將 FODP 轉換為 SVG 的強大 PowerPoint PHP 庫" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="在 PHP 中將 FODP 轉換為 SVG" %}}

需要以編程方式將 FODP 文件轉換為 SVG？使用 [*Aspose.Slides for PHP via Java*](https://products.aspose.com/slides/zh-hant/php-java/) 任何開發人員只需幾行 PHP 代碼即可將 FODP 轉換為 SVG 格式.

作為一個現代的演示處理 API，Aspose.Slides for PHP 從 FODP 快速創建 SVG。直接在您的 [瀏覽器](https://products.aspose.app/slides/conversion) 中測試 FODP 到 SVG 轉換的質量。 Aspose PowerPoint PPTX 庫允許您將 FODP 文件轉換為許多流行的格式。
...
{{< blocks/products/pf/agp/feature-section-col title="如何在 PHP 中將 FODP 轉換為 SVG" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="這些是使用 PHP 將 FODP 文件轉換為 SVG 的步驟。" >}}
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 FODP 到 SVG PHP 轉換" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="在 PHP 中將 FODP 保存為 SVG" %}}
使用免費應用查看 FODP 到 SVG 轉換過程的演示。 
{{% /blocks/products/pf/agp/content %}}
