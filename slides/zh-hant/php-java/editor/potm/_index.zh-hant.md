...
description: 在 PHP 中編輯 POTM。使用 PHP 庫 API 編輯 POTM 文件
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 PHP 中編輯 POTM" h2="用於使用 PHP 代碼編輯 POTM 的高速跨平台 PHP 庫" >}}
...
{{% blocks/products/pf/feature-page-section  h2="在 PHP 中編輯 POTM" %}}
使用 [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/zh-hant/php-java/)，您可以向 POTM 文檔添加一行新文本，只需幾行代碼。

{{% blocks/products/pf/agp/code-block title="用於編輯 POTM 的 PHP 代碼" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="如何在 PHP 中編輯 POTM" >}}
