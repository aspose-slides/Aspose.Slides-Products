---
title: C# で HTML を PDF に変換する
weight: 40
url: /ja/net/conversion/html-to-pdf/ 
keywords: HTML から PDF、HTML から PDF への変換、C# API、.NET ライブラリ、HTML、PDF
description: C# で HTML を PDF に変換します。 .NET ライブラリ API を使用して、HTML ページを PDF ドキュメントに変換します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C# で HTML を PDF に変換する" h2="NET Framework、.NET Core、Windows Azure、Mono、または Xamarin プラットフォームで HTML ページを PDF ドキュメントに変換するための PowerPoint .NET API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="C# で HTML を PDF に変換する方法" %}}

プログラムで HTML を PDF に変換するにはどうすればよいですか?

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/ja/net/) を使用すると、開発者やアプリケーションはわずか数行の C# コードで HTML を PDF 形式に変換できます。

最新のドキュメント処理 API である Aspose.Slides for .NET は、HTML ページから PDF をすばやく作成します。 Aspose PowerPoint ライブラリを使用すると、HTML を PDF やその他の多くのファイル形式に変換できます
...
{{< blocks/products/pf/agp/feature-section-col title="C# で HTML を PDF に変換する手順" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="開発者とアプリケーションは、次の方法で HTML を PDF に変換できます。" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
save メソッドを呼び出して、ファイルを PDF として保存します。
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 HTML から PDF への変換 C# コードを実行する前に、マシンに次の前提条件が必要です。
...
{{% blocks/products/pf/agp/code-block title="HTML を PDF に変換する C# コード" offSpacer="" %}}
