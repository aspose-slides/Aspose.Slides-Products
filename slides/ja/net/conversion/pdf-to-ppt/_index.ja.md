...
description: C# で PDF を PPT に変換します。 .NET ライブラリ API を使用して PDF を PowerPoint に変換する
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="C#でPDFをPPTに変換" h2="NET Framework、.NET Core、Windows Azure、Mono、または Xamarin プラットフォームで C# コードを使用して PDF を PPT に変換するための強力なクロスプラットフォーム .NET API" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides を使用して PDF を PPT に変換" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/ja/net/) は、PowerPoint プレゼンテーション、PDF、HTML ドキュメント、およびその他のファイル。 PDF を PPT に変換すると、基本的に PDF ページの内容が PowerPoint プレゼンテーションのスライドに移動されます。

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="C#でPDFをPPTに変換" %}}
[**Aspose.Slides for .NET**](https://products.aspose.com/slides/ja/net/) を使用すると、わずか数行のコードで PDF を PowerPoint プレゼンテーションに変換できます。

{{% blocks/products/pf/agp/code-block title="PDF を PPT に変換するための C# コード" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="C#でPDFをPPTに変換する方法" >}}
