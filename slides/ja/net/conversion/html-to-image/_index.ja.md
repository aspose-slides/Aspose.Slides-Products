---
title: C# で HTML を画像に変換する
weight: 160
url: /ja/net/conversion/html-to-image/ 
keywords: HTML から画像, HTML から画像への変換, C# API, .NET ライブラリ, HTML, 画像
description: C# で HTML を画像に変換します。 .NET ライブラリ API を使用して HTML ファイルを画像に変換する
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C# で HTML を画像に変換する" h2="NET Framework、.NET Core、Windows Azure、Mono、または Xamarin プラットフォームで HTML ファイルを画像に変換するための PowerPoint .NET API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="C# で HTML を画像に変換する方法" %}}

コードで HTML を画像に変換するにはどうすればよいですか?

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/ja/net/) を使用すると、開発者やアプリケーションは、わずか数行の C# コードで HTML を画像ファイルに変換できます。

最新のドキュメント処理 API である Aspose.Slides for .NET は、HTML ファイルを画像ファイル フォーマットにすばやくエクスポートします。 Aspose PowerPoint ライブラリを使用すると、HTML を画像やその他の多くのファイル形式に変換できます
...
{{< blocks/products/pf/agp/feature-section-col title="C# で HTML を画像に変換する方法" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="開発者とアプリケーションは、次の方法で HTML を画像に変換できます。" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 HTML から画像への変換 C# コードを実行する前に、コンピューターに次の前提条件が必要です。
...
{{% blocks/products/pf/agp/code-block title="HTML を画像に変換する C# コード" offSpacer="" %}}
