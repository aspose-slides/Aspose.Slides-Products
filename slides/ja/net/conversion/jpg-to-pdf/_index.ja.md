...
title: C# で JPG を PDF に変換する
weight: 10
url: /ja/net/conversion/jpg-to-pdf/ 
keywords: JPG から PDF、JPG から PDF への変換、C# API、.NET ライブラリ
description: C# で JPG を PDF に変換します。 .NET ライブラリ API を使用して、JPG JPEG 画像を PDF ドキュメントに変換します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C# で JPG を PDF に変換する" h2="NET Framework、.NET Core、Windows Azure、Mono、または Xamarin プラットフォームで JPG 画像を PDF ドキュメントに変換するための PowerPoint .NET API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="C# で JPG を PDF に変換する方法" %}}

プログラムで JPG を PDF に変換するにはどうすればよいですか?

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/ja/net/) を使用すると、開発者やアプリケーションは数行の C# コードで JPG を PDF 形式に変換できます。

最新のドキュメント処理 API である Aspose.Slides for .NET は、JPG 画像から PDF をすばやく作成します。 Aspose PowerPoint ライブラリを使用すると、JPG を PDF やその他の多くのファイル形式に変換できます
...
{{< blocks/products/pf/agp/feature-section-col title="C# で JPG を PDF に変換する手順" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="開発者とアプリケーションは、次の方法で JPG を PDF に変換できます。" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 JPG から PDF への変換 C# コードを実行する前に、コンピューターに次の前提条件が必要です。
...
{{% blocks/products/pf/agp/code-block title="JPG を PDF に変換する C# コード" offSpacer="" %}}
