...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET開発者は、わずか数行のコードでPOTXファイルを簡単にロードしてPOTに変換できます。" >}}
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードは、POTXからPOTC＃への変換を示しています" offSpacer="" %}}
