---
title: C＃を介してPPTMをPOTXに変換する
weight: 540
url: /ja/net/conversion/pptm-to-potx/ 
description: PPTMからPOTXC＃への変換のサンプルコード。 VB.NET、Asp.NET、または任意の.NETベースのアプリケーション内でのバッチPPTMファイルからPOTXへの変換にAPIサンプルコードを使用します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C＃を介してPPTMをPOTXに変換する" h2="PowerPoint®PPTMファイルを.NETFramework、.NET Core、Windows Azure、Mono、またはXamarinプラットフォーム上のPOTXにエクスポートします" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTM" >}}
...
{{% blocks/products/pf/agp/content h2="C＃を使用してPPTMをPOTXに変換する方法" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="C＃を介してPPTMをPOTXに変換する手順" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET開発者は、わずか数行のコードでPPTMファイルを簡単にロードしてPOTXに変換できます。" >}}
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードは、PPTMからPOTXへのC＃変換を示しています" offSpacer="" %}}
