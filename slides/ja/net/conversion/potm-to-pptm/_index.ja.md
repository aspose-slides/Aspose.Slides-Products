...
{{< blocks/products/pf/agp/feature-section-col title="C＃を介してPOTMをPPTMに変換する手順" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET開発者は、わずか数行のコードでPOTMファイルを簡単にロードしてPPTMに変換できます。" >}}
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードは、POTMからPPTMへのC＃変換を示しています" offSpacer="" %}}
