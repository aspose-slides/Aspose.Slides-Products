...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET開発者は、わずか数行のコードでPOTXファイルを簡単にロードしてSWFに変換できます。" >}}
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードは、POTXからSWFへのC＃変換を示しています" offSpacer="" %}}
