...
keywords: SVG から PNG、SVG から PNG への変換、C# API、.NET ライブラリ
description: C# で SVG を PNG に変換します。 .NET ライブラリ API を使用して、SVG を PNG ファイルに変換します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C# で SVG を PNG に変換する" h2="NET Framework、.NET Core、Windows Azure、Mono、または Xamarin プラットフォームで SVG を PNG 画像ファイルに変換するための PowerPoint .NET API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="C# で SVG を PNG に変換する" %}}

コードで SVG を PNG に変換するにはどうすればよいですか?

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/ja/net/) を使用すると、開発者やアプリケーションはわずか数行の C# コードで SVG を PNG に変換できます。

最新のドキュメント処理 API である Aspose.Slides for .NET は、SVG ファイルを PNG にすばやくエクスポートします。 Aspose PowerPoint ライブラリを使用すると、SVG を PNG や他の形式の画像に変換できます。
...
{{< blocks/products/pf/agp/feature-section-col title="C# で SVG を PNG に変換する方法" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="開発者とアプリケーションは、次の方法で SVG を PNG に変換できます。" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 SVG から PNG への変換 C# コードを実行する前に、マシンに次の前提条件が必要です。
...
{{% blocks/products/pf/agp/code-block title="SVG を PNG に変換する C# コード" offSpacer="" %}}
