...
url: /ja/net/conversion/pdf-to-pptx/
keywords: PDF を PPTX に、PDF を PPTX に、PowerPoint、PDF、PPTX、C# API、.NET ライブラリに変換
description: C# で PDF を PPTX に変換します。 .NET ライブラリ API を使用して PDF を PowerPoint に変換する
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="C# で PDF を PPTX に変換する" h2="NET Framework、.NET Core、Windows Azure、Mono、または Xamarin プラットフォームで C# コードを使用して PDF を PPTX に変換するための強力なクロスプラットフォーム .NET API" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides を使用して PDF を PPTX に変換" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/ja/net/) は、PowerPoint プレゼンテーション、PDF、HTML ドキュメント、およびその他のファイル。 PDF を PPTX に変換すると、基本的に PDF ページのコンテンツが PowerPoint プレゼンテーションのスライドに移動されます。
...
{{% blocks/products/pf/agp/code-block title="PDF を PPTX に変換するための C# コード" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="C#でPDFをPPTXに変換する方法" >}}
