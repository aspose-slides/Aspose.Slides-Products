...
title: C# で画像を JPG に変換する
weight: 200
url: /ja/net/conversion/image-to-jpg/ 
keywords: 画像から JPG、画像から JPG への変換、C# API、.NET ライブラリ、画像、JPG
description: C# で画像を JPG に変換します。 .NET ライブラリ API を使用して、画像を JPG 画像に変換します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C# で画像を JPG に変換する" h2="NET Framework、.NET Core、Windows Azure、Mono、または Xamarin プラットフォームで画像を JPG 画像に変換するための PowerPoint .NET API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="C# で画像を JPG に変換する" %}}

コードで画像を JPG に変換するにはどうすればよいですか?

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/ja/net/) を使用すると、開発者やアプリケーションは、わずか数行の C# コードで画像を JPG 画像に変換できます。 .

最新のドキュメント処理 API である Aspose.Slides for .NET は、一般的な形式の画像を JPG にすばやくエクスポートします。 Aspose PowerPoint ライブラリを使用すると、画像を JPG やその他の多くの画像フォーマットに変換できます。
...
{{< blocks/products/pf/agp/feature-section-col title="C# で画像を JPG に変換する方法" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="開発者とアプリケーションは、次の方法で Image を JPG に変換できます。" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 画像から JPG への変換 C# コードを実行する前に、コンピューターに次の前提条件が必要です。
...
{{% blocks/products/pf/agp/code-block title="Image を JPG に変換する C# コード" offSpacer="" %}}
