---
title: .NETを介してPPTドキュメントのロックを解除する
weight: 8650
url: /ja/net/unlock/ppt/ 
description: .NET Framework、.NET Core、Windows Azure、Mono、またはXamarinプラットフォームでパスワードで保護されたPPTファイルのロックを解除するためのC＃ソースコード。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C＃を介してPPTプレゼンテーションのロックを解除する" h2=".NETライブラリを使用してPPTから保護を削除します。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="C＃を使用してPPTファイルのロックを解除する方法" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="C＃経由でPPTのロックを解除する" >}}
