---
title: .NETを介してPPTドキュメントを保護およびロックする
weight: 1330
url: /ja/net/protect/ppt/ 
description: .NET Framework、.NET Core、Windows Azure、Mono、またはXamarinプラットフォームでパスワードを使用してPPTファイルをロックするためのC＃ソースコード。
---
...
{{< blocks/products/pf/agp/feature-section-col title="C＃を介してPPTを保護する" >}}
...
プレゼンテーションのインスタンスを使用してPPTをロードします
{{< /blocks/products/pf/agp/step-autogen >}}
