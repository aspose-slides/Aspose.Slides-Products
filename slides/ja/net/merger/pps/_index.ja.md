...
title: .NETを介してPPSファイルをマージする
weight: 5830
url: /ja/net/merger/pps/ 
description: .NET Framework、.NET Core、Windows Azure、Mono、またはXamarinプラットフォームでPPSドキュメントを組み合わせるためのC＃ソースコード。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C＃でPPS形式をマージする" h2="MicrosoftやOpenOffice、Adobe PDFなどのソフトウェアを使用せずに、サーバー側のAspose.Slides for.NETAPIを使用したネイティブで高性能なPPSドキュメントのマージ。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPS" >}}
...
{{% blocks/products/pf/agp/content h2="C＃を使用してPPSファイルをマージする方法" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="C＃でPPSファイルをマージする手順" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Save（）メソッドを呼び出し、ファイル名（フルパス）とフォーマット（PPS）をパラメーターとして渡します。
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
これで、Microsoft Office、Adobe PDF、またはその他の互換性のあるプログラムでPPSファイルを開いて使用できます。
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="PPSファイルのマージ-C＃" offSpacer="" %}}
