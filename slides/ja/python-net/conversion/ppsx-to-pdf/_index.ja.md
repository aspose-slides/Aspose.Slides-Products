...
title: PythonでPPSXをPDFに変換する
weight: 2070
url: /ja/python-net/conversion/ppsx-to-pdf/ 
keywords: "Convert, PowerPoint, PPSX, PDF, Presentation, Python"
description: PPSXからPDFPythonへの変換のサンプルコード。 PowerPoint Python APIを使用して、PPSXファイルをPDFファイルにバッチ変換します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="PythonでPPSXをPDFに変換する" h2="PPSXをPDFに変換するための強力なPowerPointPythonライブラリ" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="PythonでPPSXをPDFに変換する" %}}

プログラムでPPSXファイルをPDFに変換する必要がありますか？ [* Aspose.Slides for Python via .NET *]（https://products.aspose.com/slides/ja/python-net/）を使用すると、開発者は数行のPythonコードでPPSXをPDF形式に変換できます。

最新のプレゼンテーション処理APIとして、Aspose.SlidesforPythonはPPSXからPDFをすばやく作成します。 [ブラウザ]（https://products.aspose.app/slides/conversion）でPPSXからPDFへの変換の品質をテストします。 Aspose PowerPoint PPTXライブラリを使用すると、PPSXファイルを多くの一般的な形式に変換できます。
...
{{< blocks/products/pf/agp/feature-section-col title="PythonでPPSXをPDFに変換する方法" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="これらは、Pythonを使用してPPSXファイルをPDFに変換する手順です。" >}}
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードは、PPSXからPDFへのPython変換を示しています" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="PythonでPPSXをPDFとして保存" %}}
無料アプリを使用して、PPSXからPDFへの変換プロセスのデモンストレーションをご覧ください。 
{{% /blocks/products/pf/agp/content %}}
