---
title: Python を使用して PPT ファイルを PPTM にマージ
url: /ja/python-net/merge/ppt-to-pptm/
keywords: PPT を PPTM に結合、PPT を PPTM に結合、PPT を PPTM に結合、PowerPoint、プレゼンテーション、PPTM、Python、Aspose
...
{{< blocks/products/pf/feature-page-header h1="PythonでPPTファイルをPPTMにマージします" h2="MicrosoftやOpen Office、Adobe PDFなどのソフトウェアを使用せずに、Microsoft PowerPointおよびOpenOfficeプレゼンテーションファイルを作成、マージ、検査、または変換する機能を備えたアプリケーションの開発に役立つ、高速でクロスプラットフォームのPython API。" >}}

{{% blocks/products/pf/feature-page-section h2="Python で PPT を PPTM にマージする" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Python を使用して PPT ファイルを PPTM にマージします" %}}
PowerPoint プレゼンテーションを結合するには、あるプレゼンテーションから別のプレゼンテーションにスライドを複製する必要があります。

{{% blocks/products/pf/agp/code-block title="複数の PPT を単一の PPTM ファイルにマージするための Python コード" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Aspose.Slides for Python API を使用して PPT を PPTM にマージする方法" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="これらは、Python で 2 つの PPT ファイルをマージし、結果を PPTM として保存する手順です。" >}}
