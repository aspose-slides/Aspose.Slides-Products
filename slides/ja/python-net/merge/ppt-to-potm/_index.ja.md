---
title: Python を使用して PPT ファイルを POTM にマージ
url: /ja/python-net/merge/ppt-to-potm/
keywords: PPT を POTM に結合、PPT を POTM に結合、PPT を POTM に結合、PowerPoint、プレゼンテーション、POTM、Python、Aspose
...
{{< blocks/products/pf/feature-page-header h1="PythonでPPTファイルをPOTMにマージします" h2="MicrosoftやOpen Office、Adobe PDFなどのソフトウェアを使用せずに、Microsoft PowerPointおよびOpenOfficeプレゼンテーションファイルを作成、マージ、検査、または変換する機能を備えたアプリケーションの開発に役立つ、高速でクロスプラットフォームのPython API。" >}}

{{% blocks/products/pf/feature-page-section h2="Python で PPT を POTM にマージする" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Python を使用して PPT ファイルを POTM にマージします" %}}
PowerPoint プレゼンテーションを結合するには、あるプレゼンテーションから別のプレゼンテーションにスライドを複製する必要があります。

{{% blocks/products/pf/agp/code-block title="複数の PPT を単一の POTM ファイルにマージするための Python コード" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Aspose.Slides for Python API を使用して PPT を POTM にマージする方法" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="これらは、Python で 2 つの PPT ファイルをマージし、結果を POTM として保存する手順です。" >}}
