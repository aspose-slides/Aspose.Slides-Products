---
title: Python を使用して POTX ファイルを PNG にマージ
url: /ja/python-net/merge/potx-to-png/
keywords: POTX を PNG に結合、POTX を PNG に結合、POTX を PNG に結合、PowerPoint、プレゼンテーション、PNG、Python、Aspose
...
{{< blocks/products/pf/feature-page-header h1="PythonでPOTXファイルをPNGにマージします" h2="MicrosoftやOpen Office、Adobe PDFなどのソフトウェアを使用せずに、Microsoft PowerPointおよびOpenOfficeプレゼンテーションファイルを作成、マージ、検査、または変換する機能を備えたアプリケーションの開発に役立つ、高速でクロスプラットフォームのPython API。" >}}

{{% blocks/products/pf/feature-page-section h2="Python で POTX を PNG にマージする" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Python を使用して POTX ファイルを PNG にマージします" %}}
PowerPoint プレゼンテーションを結合するには、あるプレゼンテーションから別のプレゼンテーションにスライドを複製する必要があります。

{{% blocks/products/pf/agp/code-block title="複数の POTX を単一の PNG ファイルにマージするための Python コード" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Aspose.Slides for Python API を使用して POTX を PNG にマージする方法" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="これらは、Python で 2 つの POTX ファイルをマージし、結果を PNG として保存する手順です。" >}}
