---
title: PHP で画像を BMP にマージ
url: /ja/php-java/merger/image-to-bmp/
keywords: BMP への画像、BMP への画像の結合、BMP への画像の結合、画像の結合、画像、BMP、PHP API、PHP ライブラリ
description: PHP でイメージを BMP にマージします。 PHP ライブラリ API を使用して画像を結合する
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="PHP で画像を BMP にマージ" h2="PHP コードを使用してイメージを BMP ファイルにマージするための高速でクロスプラットフォームの PHP ライブラリ" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides を使用して画像を BMP にマージ" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/ja/php-java/) は、プレゼンテーション、PDF、画像、その他のファイル。画像を BMP にマージすると、効果的に画像を組み合わせて 1 つの BMP ファイルを取得します。
...
{{% blocks/products/pf/feature-page-section  h2="PHP で画像を BMP にマージ" %}}
[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/ja/php-java/) を使用すると、わずか数行のコードで画像を BMP にすばやくマージできます。

{{% blocks/products/pf/agp/code-block title="Image を BMP にマージするための PHP コード" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="PHPで画像をBMPにマージする方法" >}}
