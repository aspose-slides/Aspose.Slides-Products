---
title: PHP で PNG 画像をマージする
url: /ja/php-java/merger/png-to-png/
keywords: PNG のマージ、PNG から PNG、PNG の結合、PNG の結合、PHP API、PHP ライブラリ
description: PHP で PNG を PNG にマージします。 PHP ライブラリ API を使用して PNG ファイルを結合する
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="PHP で PNG をマージする" h2="PHP コードを使用して PNG 画像をマージするための高速でクロスプラットフォームの PHP ライブラリ" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides を使用して PNG を PNG にマージ" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/ja/php-java/) は、プレゼンテーション、画像、およびその他のファイルをマージおよび操作するために使用される強力な PHP ライブラリです。 PNG を PNG にマージすると、効果的に 2 つの画像を組み合わせて 1 つの画像を取得できます。
...
{{% blocks/products/pf/feature-page-section  h2="PHP で PNG を PNG にマージする" %}}
[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/ja/php-java/) を使用すると、わずか数行のコードで PNG ファイルをすばやくマージできます。

{{% blocks/products/pf/agp/code-block title="PNG を PNG にマージするための PHP コード" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="PHPでPNGをマージする方法" >}}
