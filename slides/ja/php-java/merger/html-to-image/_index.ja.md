---
title: PHP で HTML を画像にマージする
url: /ja/php-java/merger/html-to-image/
keywords: HTML を画像に結合、HTML を画像に結合、HTML を結合、HTML を結合、画像、PHP API、PHP ライブラリ
description: PHP で HTML を画像にマージします。 PHP ライブラリ API を使用して HTML を画像に結合する
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="PHPで画像をマージする" h2="PHP コードを使用して HTML を画像にマージするための高速でクロスプラットフォームの PHP ライブラリ" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides を使用して HTML を画像にマージ" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/ja/php-java/) は、プレゼンテーション、HTML ドキュメント、およびその他のファイルをマージおよび操作するために使用される強力な PHP ライブラリです。 HTML を画像にマージすると、HTML ドキュメントのコンテンツを効果的に組み合わせて 1 つの画像を取得できます。 
...
{{% blocks/products/pf/feature-page-section  h2="PHPでHTMLを画像にマージする" %}}
[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/ja/php-java/) を使用すると、わずか数行のコードで画像ファイルをすばやくマージできます。

{{% blocks/products/pf/agp/code-block title="HTML を画像にマージするための PHP コード" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="PHPでHTMLを画像にマージする方法" >}}
