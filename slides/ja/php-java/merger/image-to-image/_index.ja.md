---
title: PHP で画像をマージする
url: /ja/php-java/merger/image-to-image/
keywords: 画像のマージ、画像から画像へ、画像の結合、画像の結合、PHP API、PHP ライブラリ
description: PHPで画像を画像にマージします。 PHP ライブラリ API を使用して画像を結合する
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="PHPで画像をマージする" h2="PHP コードを使用して画像をマージするための高速でクロスプラットフォームの PHP ライブラリ" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides を使用して画像を画像にマージ" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/ja/php-java/) は、プレゼンテーション、画像、およびその他のファイルをマージおよび操作するために使用される強力な PHP ライブラリです。画像を画像に結合すると、効果的に 2 つの画像を組み合わせて 1 つの画像が得られます。
...
{{% blocks/products/pf/feature-page-section  h2="PHPで画像を画像にマージする" %}}
[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/ja/php-java/) を使用すると、わずか数行のコードで画像ファイルをすばやくマージできます。

{{% blocks/products/pf/agp/code-block title="画像を画像にマージするための PHP コード" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="PHPで画像をマージする方法" >}}
