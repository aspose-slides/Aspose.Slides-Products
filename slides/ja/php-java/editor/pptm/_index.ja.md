---
title: PHP で PPTM を編集
url: /ja/php-java/editor/pptm/
keywords: PPTM の編集、PowerPoint の編集、PPTM、PowerPoint、PHP API、PHP ライブラリ
description: PHP で PPTM を編集します。 PHP ライブラリ API を使用して PPTM ファイルを編集する
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="PHP で PPTM を編集" h2="PHP コードを使用して PPTM を編集するための高速でクロスプラットフォームの PHP ライブラリ" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides を使用して PPTM を編集" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/ja/php-java/) は、プレゼンテーションの操作と編集に使用される強力な PHP ライブラリです。新しいテキスト行を追加することで、PPTM プレゼンテーションを編集できます。 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="PHP で PPTM を編集" %}}
[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/ja/php-java/) を使用すると、新しいテキスト行を PPTM ドキュメントに追加できます。数行のコード。

{{% blocks/products/pf/agp/code-block title="PPTM を編集するための PHP コード" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="PHP で PPTM を編集する方法" >}}
