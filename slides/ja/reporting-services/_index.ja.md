...
description: Reporting Services PowerPoint APIは、SQLPPTのAspose.Slidesです。 SQLPowerPoint用のPowerPointプレゼンテーションサービス。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Reporting Services PowerPoint API" h2="RDLレポートをPowerPointPPT、PPTX、PPS、およびPPSX形式にエクスポートします。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-reporting-services.svg" pfName="Aspose.Slides" subTitlepfName="for Reporting Services" downloadUrl="https://downloads.aspose.com/slides/reportingservices" >}}
...
<p>
 Aspose.Slides for Reporting Servicesは、Microsoft SQL ServerReportingServices内からPowerPointのネイティブ形式でプレゼンテーションを生成できるようにする市場で唯一のソリューションです。
</p>

<p>
 Aspose.Slides for Reporting Servicesは、テーブル、マトリックス、チャート、画像、リスト、サブレポート、ヘッダー/フッターなどのほぼすべてのRDL機能をサポートしているため、元のレポートと同じように表示されるように、PowerPointプレゼンテーション形式でレポートをエクスポートできます。レポートのデザイン。 MicrosoftPowerPointAutomationを使用せずにReportingServicesSQLPPTを実行します。
</p>
...
{{< blocks/products/pf/carousel-item h3="一目で" description="レポートサービスのAspose.Slidesの概要。" >}}
...
{{< blocks/products/pf/carousel-item h3="プラットフォームの独立性" description="製品はMicrosoftSQLServerReportingServicesをサポートしています。" >}}
<div class="diagram1 d1-rs">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Advanced ReportingServicesAPIの機能
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     RDLレポートで比較チャートを作成し、プレゼンテーションとしてエクスポートします
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     複雑なRDLレポートを作成し、プレゼンテーションファイルにエクスポートする
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     サブレポートを含むデータ中心のRDLレポートをエクスポートする
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     埋め込みオーディオとビデオをPowerPointファイルにエクスポート
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     サブレポートを含むRDLレポートをPowerPointにエクスポートする
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     プレゼンテーション全体でハイパーリンクテキストの色を変更する
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     オープンドキュメント暗号化、テキストハイライター、モーフトランジションのサポート
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     ファンネルチャートと2Dマップチャートがサポートされています
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     コメントの返信とOffice365のサポート
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     プレゼンテーションおよびスライドショー形式へのエクスポート
    </h2>
    <p>
     SQL Server Reporting Services（SSRS）は、RDLレポートをPowerPointプレゼンテーションまたはスライドショーにエクスポートするための組み込みのサポートを提供していません。レポートサービスにAspose.Slidesを使用しているときに、追加のエクスポート形式のサポートを簡単に追加できます。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for Reporting Servicesは完全なRDL仕様をサポートしており、この拡張機能を使用して既存のレポートをカスタマイズできます。選択したRDLレポートデザイナを選択し、設計したのとまったく同じ方法でレポートをエクスポートするのは非常に簡単です。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     MicrosoftPowerPointAutomation-不要
    </h2>
    <p>
     Aspose.Slides for Reporting Servicesは、PowerPointプレゼンテーションを操作するためにMicrosoftPowerPointをマシンにインストールする必要のないマネージコードを使用して構築されています。これは、サポートされている機能、セキュリティ、安定性、スケーラビリティ、速度、および価格の点で、MicrosoftPowerPointの自動化に最適な代替手段です。
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="ドキュメンテーション" href="https://docs.aspose.com/slides/reportingservices/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="なぜAspose.SlidesforReporting Services？" tabId="success-stories" >}}
