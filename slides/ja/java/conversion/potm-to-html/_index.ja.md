---
title: Javaを介してPOTMをHTMLに変換する
weight: 5820
url: /ja/java/conversion/potm-to-html/ 
description: POTM形式からHTMLファイルへのサンプルJava変換コード。このサンプルコードを使用して、PowerPointおよびOpenOfficeプレゼンテーションをWebまたはデスクトップJavaベースのアプリケーション内のHTMLにエクスポートします。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Javaを介してPOTMをHTMLに変換する" h2="オンプレミスJavaライブラリを使用して単一または複数のページをHTMLに変換するPOTMからHTMLへのJava変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してPOTMをHTMLに変換する方法" %}}

 POTMをHTMLにレンダリングするために、
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してPOTMをHTMLに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Java開発者は、わずか数行のコードでPOTMファイルをHTMLに簡単に変換できます。
...
{{% blocks/products/pf/agp/code-block title="POTMからHTMLへのJava変換ソースコード" offSpacer="" %}}
