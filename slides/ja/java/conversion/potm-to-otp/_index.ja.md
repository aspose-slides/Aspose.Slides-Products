---
title: Java経由でPOTMをOTPに変換する
weight: 6610
url: /ja/java/conversion/potm-to-otp/ 
description: POTM形式からOTPファイルへのサンプルJava変換コード。このサンプルコードを使用して、PowerPointおよびOpenOfficeプレゼンテーションをWebまたはデスクトップJavaベースのアプリケーション内のOTPにエクスポートします。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java経由でPOTMをOTPに変換する" h2="オンプレミスJavaライブラリを使用して単一または複数のページをOTPに変換するPOTMからOTPへのJava変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してPOTMをOTPに変換する方法" %}}

 POTMをOTPにレンダリングするために、
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してPOTMをOTPに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Java開発者は、わずか数行のコードでPOTMファイルをOTPに簡単に変換できます。
...
{{% blocks/products/pf/agp/code-block title="POTMからOTPへのJava変換ソースコード" offSpacer="" %}}
