---
title: Java経由でPPSMをSVGに変換する
weight: 7830
url: /ja/java/conversion/ppsm-to-svg/ 
description: PPSM形式からSVGファイルへのサンプルJava変換コード。このサンプルコードを使用して、PowerPointおよびOpenOfficeプレゼンテーションをWebまたはデスクトップJavaベースのアプリケーション内のSVGにエクスポートします。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java経由でPPSMをSVGに変換する" h2="オンプレミスJavaライブラリを使用して単一または複数のページをSVGに変換するためのPPSMからSVGへのJava変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSM" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してPPSMをSVGに変換する方法" %}}

 PPSMをSVGにレンダリングするために、
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してPPSMをSVGに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Java開発者は、わずか数行のコードでPPSMファイルをSVGに簡単に変換できます。
...
{{% blocks/products/pf/agp/code-block title="PPSMからSVGへのJava変換ソースコード" offSpacer="" %}}
