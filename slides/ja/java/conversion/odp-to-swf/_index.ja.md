---
title: Javaを介してODPをSWFに変換する
weight: 8250
url: /ja/java/conversion/odp-to-swf/ 
description: ODP形式からSWFファイルへのサンプルJava変換コード。このサンプルコードを使用して、PowerPointおよびOpenOfficeプレゼンテーションをWebまたはデスクトップJavaベースのアプリケーション内のSWFにエクスポートします。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Javaを介してODPをSWFに変換する" h2="オンプレミスJavaライブラリを使用して単一または複数のページをSWFに変換するためのODPからSWFへのJava変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してODPをSWFに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してODPをSWFに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Java開発者は、わずか数行のコードでODPファイルをSWFに簡単に変換できます。
...
{{% blocks/products/pf/agp/code-block title="ODPからSWFへのJava変換ソースコード" offSpacer="" %}}
