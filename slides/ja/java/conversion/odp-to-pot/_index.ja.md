...
title: Javaを介してODPをPOTに変換する
weight: 3350
url: /ja/java/conversion/odp-to-pot/ 
description: ODP形式からPOTファイルへのサンプルJava変換コード。このサンプルコードを使用して、PowerPointおよびOpenOfficeプレゼンテーションをWebまたはデスクトップJavaベースのアプリケーション内のPOTにエクスポートします。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Javaを介してODPをPOTに変換する" h2="オンプレミスJavaライブラリを使用して単一または複数のページをPOTに変換するためのODPからPOTへのJava変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="POT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してODPをPOTに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してODPをPOTに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Java開発者は、わずか数行のコードでODPファイルをPOTに簡単に変換できます。
...
{{% blocks/products/pf/agp/code-block title="ODPからPOTへのJava変換ソースコード" offSpacer="" %}}
