---
title: Javaを介してODPをPDFに変換する
weight: 450
url: /ja/java/conversion/odp-to-pdf/ 
description: ODP形式からPDFファイルへのサンプルJava変換コード。このサンプルコードを使用して、WebまたはデスクトップJavaベースのアプリケーション内でPowerPointおよびOpenOfficeプレゼンテーションをPDFにエクスポートします。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Javaを介してODPをPDFに変換する" h2="オンプレミスJavaライブラリを使用して単一または複数のページをPDFに変換するためのODPからPDFへのJava変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してODPをPDFに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してODPをPDFに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Java開発者は、わずか数行のコードでODPファイルをPDFに簡単に変換できます。
...
{{% blocks/products/pf/agp/code-block title="ODPからPDFへのJava変換ソースコード" offSpacer="" %}}
