---
title: Java経由でPOTをODPに変換する
weight: 1050
url: /ja/java/conversion/pot-to-odp/ 
description: POT形式からODPファイルへのサンプルJava変換コード。このサンプルコードを使用して、PowerPointおよびOpenOfficeプレゼンテーションをWebまたはデスクトップJavaベースのアプリケーション内のODPにエクスポートします。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java経由でPOTをODPに変換する" h2="オンプレミスJavaライブラリを使用して単一または複数のページをODPに変換するためのPOTからODPへのJava変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POT" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してPOTをODPに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してPOTをODPに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Java開発者は、わずか数行のコードでPOTフ​​ァイルをODPに簡単に変換できます。
...
{{% blocks/products/pf/agp/code-block title="POTからODPへのJava変換ソースコード" offSpacer="" %}}
