---
title: Javaを介してPPTXドキュメントのテキストを検索して置換する
weight: 3610
url: /ja/java/redaction/pptx/ 
description: JSP/JSFアプリケーションおよびデスクトップアプリケーション用のJavaランタイム環境でPPTXファイル内の機密情報を編集するためのJavaサンプルコード。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="JavaでPPTX形式を編集する" h2="ネイティブで高性能のPPTXは、MicrosoftやAdobe PDFなどのソフトウェアを使用せずに、サーバー側のAspose.Slides forJavaAPIを使用して機密性の高い編集情報を文書化します。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してPPTXファイルを編集する方法" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="JavaでPPTXファイルを編集する手順" >}}
...
{{% blocks/products/pf/agp/code-block title="PPTXファイルの編集-Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ja/java/redaction/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
