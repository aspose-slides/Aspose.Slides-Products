...
{{% blocks/products/pf/agp/code-block title="PPS 組み込みプロパティの変更 - Java" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="カスタム プロパティを PPS - Java に追加" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Java 経由で PPS のメタデータを抽出する方法" >}}
