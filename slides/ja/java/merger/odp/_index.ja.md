...
title: Javaを介してODPファイルをマージする
weight: 2500
url: /ja/java/merger/odp/ 
description: JSP/JSFアプリケーションおよびデスクトップアプリケーション用のJavaランタイム環境でODPドキュメントを組み合わせるためのJavaサンプルコード。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="JavaでODPフォーマットをマージする" h2="サーバー側のJavaAPIを使用したネイティブODPドキュメントのマージ。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してODPファイルをマージする方法" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="JavaでODPファイルをマージする手順" >}}
...
Presentationクラスのインスタンスを含む最初のODPファイルをロードします。
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Presentationクラスのインスタンスを含む2番目のODPドキュメントをロードします。
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
2番目のODPファイルの各スライドをループします。
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="ODPファイルのマージ-Java" offSpacer="" %}}
