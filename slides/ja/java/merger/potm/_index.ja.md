---
title: Javaを介してPOTMファイルをマージする
weight: 6620
url: /ja/java/merger/potm/ 
description: JSP/JSFアプリケーションおよびデスクトップアプリケーション用のJavaランタイム環境でPOTMドキュメントを組み合わせるためのJavaサンプルコード。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="JavaでPOTM形式をマージする" h2="サーバー側のJavaAPIを使用したネイティブPOTMドキュメントのマージ。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="POTM" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Presentationクラスのインスタンスを含む2番目のPOTMドキュメントをロードします。
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
2番目のPOTMファイルの各スライドをループします。
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="POTMファイルのマージ-Java" offSpacer="" %}}
