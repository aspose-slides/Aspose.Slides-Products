---
title: JavaでSVGをPNGにマージ
url: /ja/java/merger/svg-to-png/
keywords: SVG を PNG に結合、SVG を PNG に結合、SVG を PNG に結合、SVG を PNG に結合、Java API、Java ライブラリ
description: Java で SVG を PNG にマージします。 Java ライブラリ API を使用して SVG ファイルと PNG ファイルを結合する
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="JavaでSVGをPNGにマージ" h2="Java コードを使用して SVG を PNG 画像にマージするための高速でクロスプラットフォームの Java ライブラリ" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides を使用して SVG を PNG にマージ" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/ja/java/) は、プレゼンテーション、画像、およびその他のファイルをマージおよび操作するために使用される強力な Java ライブラリです。 SVG を PNG にマージすると、効果的に SVG 画像を組み合わせて PNG 画像を取得できます。
...
{{% blocks/products/pf/feature-page-section  h2="JavaでSVGをPNGにマージ" %}}
[**Aspose.Slides for Java**](https://products.aspose.com/slides/ja/java/) を使用すると、わずか数行のコードで SVG を PNG ファイルにすばやくマージできます。

{{% blocks/products/pf/agp/code-block title="SVG を PNG にマージするための Java コード" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="JavaでSVGをPNGにマージする方法" >}}
