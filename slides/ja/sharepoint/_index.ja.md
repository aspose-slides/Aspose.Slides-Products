...
weight: 910
url: /ja/sharepoint/ 
description: SharePoint PowerPointは、SharePoint PPT、SharePointスライドショー、SharePointプレゼンテーションを作成および変換するためのAspose.SlidesSharePointです。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="SharePointPowerPointソリューション" h2="SharePointでPowerPointプレゼンテーションを管理および変換します。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-sharepoint.svg" pfName="Aspose.Slides" subTitlepfName="for SharePoint" downloadUrl="https://downloads.aspose.com/slides/sharepoint" >}}
...
<p>
 Aspose.Slides for SharePointは、SharePointでPowerPointファイルを管理および変換します。 Aspose.Slidesは、SharePoint PowerPointソリューションとして、PPT、POT、PPS、PPTX、POTX、PPSXなどの一般的なMicrosoftプレゼンテーション形式を簡単にインポートでき、これらの形式をPDF、TIFF、XPSファイルにエクスポートできます。 Microsoft PowerPoint Automationを必要とせずに、すべてのSharePointPPT機能を使用します。
</p>

<p>
 Aspose.Slides for SharePointは、Windows SharePoint ServicesWSS3.0およびMicrosoftOfficeSharePoint Server 2007、2010、および2013で動作します。
</p>
...
{{< blocks/products/pf/carousel-item h3="一目で" description="Aspose.SlidesforSharePointの概要" >}}
...
{{< blocks/products/pf/carousel-item h3="プラットフォームの独立性" description="Aspose.Slides for SharePointは、Microsoft OfficeSharePointServerおよびWindowsSharePointServicesで動作します。" >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     SharePointドキュメントライブラリからPowerPointファイルを変換する
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     生成されたPPTで左側のスライドのサムネイルペインを非表示にする
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     ドキュメントを開くときにローカルファイルシステムへのアクセスを制限する
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     PowerPointプレゼンテーションをいくつかの形式に変換する
    </h2>
    <p>
     Aspose.Slides for SharePointは、プレゼンテーションをSharePointドキュメントライブラリから多くの一般的なドキュメント交換形式に変換します。 Aspose.Slides for SharePointは、一般的なプレゼンテーション形式を入力形式としてサポートし、PDF、TIFF、XPSだけでなくプレゼンテーション形式にもエクスポートできます。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.SlidesforSharePointはZIPアーカイブとして利用できます。 ZIPファイルをMOSS7.0またはWSS3.0サーバーのローカルドライブに解凍し、setup.exeを実行してインストールして使用します。とても簡単です！
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Microsoft PowerPoint Automation –不要
    </h2>
    <p>
     Aspose.Slides for SharePointは、PowerPointドキュメント形式の変換を行うためにMicrosoftPowerPointをマシンにインストールする必要のないマネージコードを使用して構築されています。これは、サポートされている機能、セキュリティ、安定性、スケーラビリティ、速度、および価格の点で、MicrosoftPowerPointの自動化に最適な代替手段です。
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="ドキュメンテーション" href="https://docs.aspose.com/slides/sharepoint/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="なぜAspose.SlidesforSharePointなのか？" tabId="success-stories" >}}
