...
<p class="col-lg-10">ExcelチャートをOLEオブジェクトとしてスライドに埋め込む</p>

</div>

<div class="col-lg-4"><em class="fa fa-print  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">リンクされたOleオブジェクトを管理する</p>
...
<p class="col-lg-10">プレゼンテーションのカスタマイズされた印刷</p>
...
<h2 class="h2title">新機能の継続的インテグレーション</h2>

<p>既存の機能に制限されることはありません。当社の製品チームは継続的に多くの機能を追加しており、すべての新しいバージョンは古いバージョンと比較してより多くの機能を提供しています。必要な機能のいずれかが不足している場合は、新しい機能リクエストを送信することもできます。これが最新機能からのいくつかのピックのリストです。</p>

<ul>

<li>テキストなしのシェイプのラスタライズまたはベクトル化。</li>

<li>SVG画像を形状に変換します。</li>

<li>デフォルトのテーブル背景を取得します。</li>

<li>ドキュメントを開くときにローカルファイルシステムへのアクセスを制限する。</li>

<li>HTMLに保存するときにエンコーディングメタタグを追加します。</li>

<li>HTMLとして保存するときにSVGタグの幅と高さの属性を削除するための設定。</li>

<li>Support for

<ul>

<li>コメントの返信、Office365および外部のExcelブック。</li>

<li>サイズはバブルチャートのプロパティを表します。</li>

<li>生成されたPPTで左側のスライドのサムネイルペインを非表示にします。</li>

<li>ファンネルチャート、2Dマップチャート、およびセットチャートの外部データソースワークブックパス。</li>

<li>OpenDocument暗号化、モーフトランジションおよびテキストハイライター機能。</li>

<li>シャドウ効果の透明度プロパティを設定します。</li>

<li>シリーズデータラベルのコールアウト形状を設定します。</li>

<li>テキストボックスの段落で効果を取得します。</li>

<li>レンダリングシェイプのソフトエッジ（EffectFormat）効果。</li>

<li>ピボットテーブルのChartDataSetRange。</li>

</ul>

</li>

<li>マルチページTiff形式、Metafile Format Plus Extensions（EMF +）、およびStrictOpenXML形式を実装します。</li>

<li>作成者がいないODP形式からのコメントのレンダリング。</li>

<li>StrictOpenXML形式に準拠したシリアル化を実装します。</li>
...
<h2 class="h2title">SmartArtシェイプ処理</h2>

<p>Aspose.Slides for C ++は、SmartArt図形を最初から作成するのを容易にするだけでなく、スライドから既存のSmartArt図形にアクセス、操作、または削除する機能を提供します。さらに、設定スタイル、色、レイアウトなどのSmartArtシェイプをフォーマットすることもできます。</p>
...
{{< blocks/products/pf/slr-element name="リリースノート" href="https://docs.aspose.com/slides/cpp/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
