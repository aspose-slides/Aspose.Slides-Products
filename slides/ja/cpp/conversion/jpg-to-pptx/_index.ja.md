...
url: /ja/cpp/conversion/jpg-to-pptx/
keywords: JPG を PPTX に、JPG を PPTX に、PowerPoint、JPG、PPTX、C++ API、C++ ライブラリに変換
description: C++ で JPG を PPTX に変換します。 C++ ライブラリ API を使用して JPG 画像を PowerPoint に変換する
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="C++ で JPG を PPTX に変換する" h2="C++ コードを使用して JPG を PPTX に変換するための強力なクロスプラットフォーム C++ API" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides を使用して JPG を PPTX に変換する" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/ja/cpp/) は、PowerPoint プレゼンテーション、PDF、HTML ドキュメントなどの作成、変換、操作に使用される強力な C++ ライブラリです。ファイル。 JPG を PPTX に変換すると、基本的に JPG 画像に基づくスライドを含む PowerPoint プレゼンテーションが作成されます。
...
{{% blocks/products/pf/agp/code-block title="JPG を PPTX に変換するための C++ コード" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="C++ で JPG を PPTX に変換する方法" >}}
