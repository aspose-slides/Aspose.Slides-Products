...
description: C++ で HTML を画像にマージします。 C++ ライブラリ API を使用して HTML を画像に結合する
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="C++ で画像をマージする" h2="C++ コードを使用して HTML を画像にマージするための高速でクロスプラットフォームの C++ ライブラリ" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides を使用して HTML を画像にマージ" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/ja/cpp/) は、プレゼンテーション、HTML ドキュメント、およびその他のファイルをマージおよび操作するために使用される強力な C++ ライブラリです。 HTML を画像にマージすると、HTML ドキュメントのコンテンツを効果的に組み合わせて 1 つの画像を取得できます。 
...
{{% blocks/products/pf/feature-page-section  h2="C++ で HTML を画像にマージする" %}}
[**Aspose.Slides for C++**](https://products.aspose.com/slides/ja/cpp/) を使用すると、わずか数行のコードで画像ファイルをすばやくマージできます。
