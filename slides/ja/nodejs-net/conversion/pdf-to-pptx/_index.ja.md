---
title: JavaScript で PDF を PPTX に変換します
url: /ja/nodejs-net/conversion/pdf-to-pptx/
keywords: PDF から PPTX、PDF から PPTX への変換、Node.js API、JavaScript ライブラリ、PDF、PPTX
description: JavaScript で PDF を PPTX に変換します。 Node.js ライブラリ API を使用して、PDF ファイルを PPTX に変換します
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="JavaScript で PDF を PPTX に変換します" h2="Aspose.Slides for Node.js via .NET は、PowerPoint プレゼンテーションを JavaScript のさまざまな形式に変換できる強力で使いやすいライブラリです。すべてのプレゼンテーション要素と形式をサポートし、それらにアクセスして変更するための豊富な API を提供します。また、スライドをさまざまな形式にエクスポートして、さらに処理したり共有したりすることもできます。" >}}

{{% blocks/products/pf/feature-page-section h2="Node.js で PDF を PPTX に変換します" %}}

[**Aspose.Slides for Node.js via .NET**](https://products.aspose.com/slides/ja/nodejs-net/) は、プレゼンテーション ファイルを作成および操作するための強力な Node.js ライブラリです。さらに、PDF を PPTX に変換する柔軟な方法を提供します。 **Aspose.Slides for Node.js via .NET** を使用すると、開発者やアプリケーションはわずか数行のコードで PDF ファイルを PPTX ファイルに変換できます。

最新のドキュメント処理 API として、.NET 経由の Aspose.Slides for Node.js は、PDF ファイルを PPTX ファイル形式にすばやくエクスポートします。 Aspose PowerPoint ライブラリを使用すると、PDF を PPTX やその他の多くのファイル形式に変換できます

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="JavaScript を使用して PDF を PPTX に変換します" %}}
PDF を PPTX に変換するには、PDF ファイルからプレゼンテーションを作成し、それを PPTX として保存する必要があります。

{{% blocks/products/pf/agp/code-block title="PDF を PPTX に変換するための JavaScript コード" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2=".NET API 経由で Aspose.Slides for Node.js を使用して PDF を PPTX に変換する方法" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET 経由で Aspose.Slides for Node.js を使用して PDF を PPTX に変換するには、JavaScript ファイルにパッケージをインポートし、Presentation クラスのインスタンスを作成する必要があります。 Presentation クラスは PowerPoint ドキュメントを表し、その要素にアクセスして操作するためのメソッドを提供します。" >}}
