---
title: JasperReportsをPowerPointにエクスポートする| Aspose.Slides
weight: 8320
url: /ja/jasperreports/ 
description: Aspose.Slides PowerPoint API for JaspreReportは、レポートをJasperReportsおよびJasperServerからPowerPoint形式にエクスポートします。アカウントチャート画像のテキストとラインレポートを作成してPPTプレゼンテーションにエクスポートします
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="JasperServerレポートをPowerPointプレゼンテーションにエクスポートする" h2="JasperReportsおよびJasperServerレポートをPPT（X）、PPS（X）およびその他のPowerPoint形式にエクスポートするためのPowerPointAPI。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-jasperreports.svg" pfName="Aspose.Slides" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/slides/jasperreport" >}}
...
<p>
 Aspose.Slides for JasperReportsは、JasperReportsおよびJasperServerレポートをPowerPointに柔軟かつ使いやすくエクスポートするためのPowerPointAPIです。 JasperServerには、レポートをPowerPointプレゼンテーションとしてエクスポートする機能が組み込まれていません。ただし、このPowerPoint APIを使用すると、Microsoft PowerPointを使用せずに、JasperServerレポートをPPT、PPS、PPTX、およびPPSXプレゼンテーション形式にエクスポートできます。
</p>
...
{{< blocks/products/pf/carousel-item h3="一目で" description="JasperReportsのAspose.Slidesの概要。" >}}
...
{{< blocks/products/pf/carousel-item h3="プラットフォームの独立性" description="Aspose.Slides PowerPoint APIは、J2SE、JasperReports、およびJasperServerをサポートしています。" >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">プレゼンテーションエクスポート機能への高度なJasperReports</h2>

<p> </p>

<div class="col-lg-4"><em class="fa fa-file-powerpoint-o  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">アカウントレポートを作成し、MicrosoftPowerPointプレゼンテーションにエクスポートします</p>

</div>

<div class="col-lg-4"><em class="fa fa-bar-chart   ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">グラフレポートを作成し、MicrosoftPowerPointプレゼンテーションにエクスポートします</p>

</div>

<div class="col-lg-4"><em class="fa fa-pie-chart ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">多軸チャートレポートを作成し、MicrosoftPowerPointプレゼンテーションにエクスポートします</p>

</div>

<div class="col-lg-4"><em class="fa fa-file-text ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">画像、テキスト、線を作成し、これらのレポートをMicrosoftPowerPointプレゼンテーションにエクスポートします</p>

</div>-->
   <h2 class="pr-ft">
    高度なJasperReportsPowerPointAPI機能
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     レポートをPowerPointプレゼンテーションにエクスポートする
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-file-text ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     コメントの返信、Office 365、および外部のExcelブックのサポート
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     作成したPPTの左側のスライドサムネイルペインを非表示にする
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-area-chart ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     じょうご、2Dマップチャート、バブルチャートのサイズプロパティ
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-cog ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     テキストハイライター、OpenDocument暗号化および形状レンダリング
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     シャドウ効果とモーフトランジションの透明度プロパティを設定します
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     アプリケーションのロケールとシリーズデータラベルの呼び出し形状を設定します
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Slides for JasperReportsは、以下を含む複雑なレポートのエクスポートをサポートしています
     <strong>
      MultipleAxisChartReport
     </ strong>
     MicrosoftPowerPointプレゼンテーションに。出力は、JasperViewerで表示したときの表示とまったく同じです。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     レポートをプレゼンテーション形式にエクスポートする
    </h2>
    <p>
     JasperReportsおよびJasperServerには、レポートをMicrosoft PowerPointプレゼンテーションにエクスポートするための組み込みサポートがありませんが、Asposeとの統合により、レポートをMicrosoft PowerPointプレゼンテーション（PPT、PPTX）およびMicrosoft PowerPointスライドショー（PPS、 PPSX）。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for JasperReportsは、PowerPointドキュメントを操作するためにMicrosoftPowerPointをマシンにインストールする必要のないマネージコードを使用して構築されています。これは、サポートされている機能、セキュリティ、安定性、スケーラビリティ、速度、および価格の点で、MicrosoftPowerPointの自動化に最適な代替手段です。
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="ドキュメンテーション" href="https://docs.aspose.com/slides/jasperreports/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="JasperReportsのAspose.Slidesを選ぶ理由" tabId="success-stories" >}}
