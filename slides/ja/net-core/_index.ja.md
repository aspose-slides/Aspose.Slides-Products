...
weight: 5190
url: /ja/net-core/ 
description: Aspose.Slides .NET Core APIを使用して、PowerPoint.NETCoreソリューションを構築します。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="プレゼンテーション用の.NETCoreAPI" h2="PowerPointやOfficeAutomationを使用せずにプレゼンテーションを処理するためのクロスプラットフォームの.NETCoreソリューションを構築します。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-net-core.svg" pfName="Aspose.Slides" subTitlepfName="for .NET Core" downloadUrl="https://downloads.aspose.com/slides/net" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="for .NET Core" >}}

{{< blocks/products/pf/i18n/sub-menu logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" liveDemosLink="https://products.aspose.app/slides/family" PricingLink="https://purchase.aspose.com/pricing/slides/net" buyLink="https://purchase.aspose.com/pricing/slides/net/" docsLink="https://docs.aspose.com/slides/net/getting-started/" installationsDocsLink="" nugetLink="https://www.nuget.org/packages/Aspose.Slides.NET/" nugetPackageName="Aspose.Slides.NET" mavenRepoLink="" directDownloadLink="https://downloads.aspose.com/slides/net" >}}

{{< blocks/products/pf/i18n/tab-content >}}
<p>
 Aspose.Slides for .NET Coreは、Windows、Linux、macOSなどのオペレーティングシステムでプレゼンテーション処理ソリューションを作成するために使用されます。プレゼンテーションとその要素（テキスト、表、グラフ、メディア、アニメーション、SmartArts、ActiveX要素）を作成および変更します。
</p>

<p>
 プレゼンテーションビューア、クリエーター、コンバーター、エディター、テンプレートコンストラクター、マネージャー、マージ、比較、スプリッター、プリンター、プロテクターなどでアプリケーションを拡張します。 C＃アプリケーションがプレゼンテーションコンテンツ（テキスト、表、グラフ、メディア、SmartArts、ActiveX）を変更できるようにします。
</p>

<p>
 Aspose.Slidesによる.NETCorePowerPoint APIは、コードの重複を回避し、.NETCoreプラットフォームのすべての機能を使用するユニークなチャンスです。 APIはPowerPointまたはOpenOfficeから独立して機能し、それらを必要としません。
</p>
...
{{< blocks/products/pf/carousel-item h3="一目で" description="Aspose.Slidesによる.NETCorePowerPointAPIの機能の概要。" >}}
...
{{< blocks/products/pf/carousel-item h3="プラットフォームの独立性" description="Aspose.Slides for .NET Core for Windows、Linux、macOS。" >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <!--/left-->
  <!--/right-->
...
{{< blocks/products/pf/carousel-item h3="サポートされているファイル形式" description="Aspose.Slides for .NET Coreは、一般的な[プレゼンテーション形式]（https://docs.aspose.com/slides/net/supported-file-formats/）および以下に示すエクスポート形式をサポートしています。" >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     .NETCoreでプレゼンテーションを変換する
    </h2>
    <p>
     Aspose.Slides for .NET Core APIは、PowerPointプレゼンテーション形式をドキュメント、画像、Web、またはファイル形式に変換できます。一般的な変換形式には、PDF、HTML、JPEG、XPSなどがあります。プレゼンテーション形式は、相互に変換することも（PPTからPPTX、PPTXからODPなど）、テンプレート形式（PPTXからPOTMなど）、スライドショー形式（PPTXからPPSXなど）に変換することも、その逆も可能です。変換されたファイルの品質は、PowerPoint .NETCoreAPI用のAspose.Slidesによって開発されたレンダリングエンジンのおかげで最高です。 Windows、Linux、macOSなど、どのOSでもプレゼンテーションを変換できます。
    </p>
...
prs.Save(dir + "output.tiff", Aspose.Slides.Export.SaveFormat.Tiff);</code></pre>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     .NETCoreでプレゼンテーションを変更する
    </h2>
    <p>
     Aspose.Slides for .NET Coreを使用すると、プレゼンテーションのロジックと外観を変更できます。すべてのテキストコンテンツは、テキスト、段落、部分、表、メモ、コメント、数学記号などの要素を介して編集できます。 2D、3D効果、およびアニメーションは、図形、グラフ、SmartArts、WordArtsで使用できます。プレゼンテーションのデザインは、テンプレート、テーマ、スライドマスター、スライドレイアウトを使用して作成できます。メディア、透かし、ActiveXには、Aspose.SlidesからPowerPoint .NETCoreAPIを介してアクセスすることもできます。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     .NET Coreでのプレゼンテーションのマージ、比較、分割、印刷
    </h2>
    <p>
     Aspose.Slides for .NET Coreは、PowerPointやその他のプレゼンテーション用のサードパーティソフトウェアでは提供されていない多くの追加機能をサポートしています。その中には、プレゼンテーションとテンプレートの比較、カスタムロジックに基づくプレゼンテーションの分割、さまざまな形式のプレゼンテーションのマージ、一連のプレゼンテーションへのテンプレートのマージ/適用、プレゼンテーションの印刷などがあります。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for .NET Coreでは、PowerPoint形式で動作するためにMicrosoftOfficeまたはMicrosoftPowerPointをマシンにインストールする必要はありません。これは、サポートされている機能、セキュリティ、安定性、拡張性、速度、および価格の点で、MicrosoftOfficeオートメーションの完璧な代替手段です。
    </p>
   </div>
   <!--<div class="col-lg-12">

<h2 class="h2title">OfficeOpenXMLのサポート</h2>

<p>Office OpenXML（OOXML）は、MicrosoftOffice2007に導入されたXMLベースの形式です。</p>

<p>PresentationML（OOXML、PPTX）は、Microsoft OfficePowerPoint2007でドキュメントを保存するために使用されるマークアップ言語です。 Aspose.Slides for .NETは、PresentationMLドキュメントの作成、読み取り、操作、および書き込みを幅広くサポートします。</p>
...
{{< blocks/products/pf/i18n/testimonials title="人々が言っ​​ていること" subTitle="私たちの言葉をそのまま受け入れるのではありません。 PowerPointAPIについてユーザーが何を言わなければならないかを確認してください。" caseStudiesLink="https://about.aspose.com/customers/success-stories/" >}}
...
{{< blocks/products/pf/slr-element name="APIリファレンス" href="https://reference.aspose.com/slides/net/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Aspose.Slides for .NETCoreを選ぶ理由" tabId="success-stories" >}}
