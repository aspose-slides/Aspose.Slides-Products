---
title: PPSM-Dateien mit Python in XPS zusammenführen
url: /de/python-net/merge/ppsm-to-xps/
keywords: PPSM mit XPS zusammenführen, PPSM mit XPS verbinden, PPSM mit XPS kombinieren, PowerPoint, Präsentation, XPS, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="PPSM-Dateien mit Python in XPS zusammenführen" %}}
Um die PowerPoint-Präsentationen zusammenzuführen, müssen Sie die Folien von einer Präsentation zur anderen klonen.

{{% blocks/products/pf/agp/code-block title="Python-Code zum Zusammenführen mehrerer PPSM in einer einzigen XPS-Datei" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So führen Sie PPSM mit XPS mithilfe von Aspose.Slides for Python API zusammen" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dies sind die Schritte, um zwei PPSM-Dateien zusammenzuführen und das Ergebnis als XPS in Python zu speichern." >}}
