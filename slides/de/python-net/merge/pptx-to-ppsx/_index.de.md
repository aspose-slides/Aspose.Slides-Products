---
title: PPTX-Dateien mit Python in PPSX zusammenführen
url: /de/python-net/merge/pptx-to-ppsx/
keywords: PPTX mit PPSX zusammenführen, PPTX mit PPSX verbinden, PPTX mit PPSX kombinieren, PowerPoint, Präsentation, PPSX, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Führen Sie PPTX-Dateien in PPSX in Python zusammen" h2="Hochgeschwindigkeits- und plattformübergreifende Python-API, die bei der Entwicklung von Anwendungen mit der Fähigkeit hilft, Microsoft PowerPoint- und OpenOffice-Präsentationsdateien ohne die Verwendung von Software wie Microsoft oder Open Office, Adobe PDF zu erstellen, zusammenzuführen, zu überprüfen oder zu konvertieren." >}}

{{% blocks/products/pf/feature-page-section h2="Führen Sie PPTX in PPSX in Python zusammen" %}}
...
{{% blocks/products/pf/feature-page-section  h2="PPTX-Dateien mit Python in PPSX zusammenführen" %}}
Um die PowerPoint-Präsentationen zusammenzuführen, müssen Sie die Folien von einer Präsentation zur anderen klonen.

{{% blocks/products/pf/agp/code-block title="Python-Code zum Zusammenführen mehrerer PPTX in einer einzigen PPSX-Datei" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So führen Sie PPTX mit PPSX mithilfe von Aspose.Slides for Python API zusammen" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dies sind die Schritte, um zwei PPTX-Dateien zusammenzuführen und das Ergebnis als PPSX in Python zu speichern." >}}
