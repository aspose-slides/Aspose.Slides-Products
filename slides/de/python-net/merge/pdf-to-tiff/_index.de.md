---
title: PDF-Dateien mit Python in TIFF zusammenführen
url: /de/python-net/merge/pdf-to-tiff/
keywords: PDF mit TIFF zusammenführen, PDF mit TIFF verbinden, PDF mit TIFF kombinieren, PowerPoint, Präsentation, TIFF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="PDF-Dateien mit Python in TIFF zusammenführen" %}}
Um die PowerPoint-Präsentationen zusammenzuführen, müssen Sie die Folien von einer Präsentation zur anderen klonen.

{{% blocks/products/pf/agp/code-block title="Python-Code zum Zusammenführen mehrerer PDF in einer einzigen TIFF-Datei" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So führen Sie PDF mit TIFF mithilfe von Aspose.Slides for Python API zusammen" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dies sind die Schritte, um zwei PDF-Dateien zusammenzuführen und das Ergebnis als TIFF in Python zu speichern." >}}
