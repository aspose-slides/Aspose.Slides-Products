---
title: PPSM-Dateien mit Python in TIFF zusammenführen
url: /de/python-net/merge/ppsm-to-tiff/
keywords: PPSM mit TIFF zusammenführen, PPSM mit TIFF verbinden, PPSM mit TIFF kombinieren, PowerPoint, Präsentation, TIFF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="PPSM-Dateien mit Python in TIFF zusammenführen" %}}
Um die PowerPoint-Präsentationen zusammenzuführen, müssen Sie die Folien von einer Präsentation zur anderen klonen.

{{% blocks/products/pf/agp/code-block title="Python-Code zum Zusammenführen mehrerer PPSM in einer einzigen TIFF-Datei" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So führen Sie PPSM mit TIFF mithilfe von Aspose.Slides for Python API zusammen" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dies sind die Schritte, um zwei PPSM-Dateien zusammenzuführen und das Ergebnis als TIFF in Python zu speichern." >}}
