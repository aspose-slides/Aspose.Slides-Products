---
title: PPTX-Dateien mit Python in PDF zusammenführen
url: /de/python-net/merge/pptx-to-pdf/
keywords: PPTX mit PDF zusammenführen, PPTX mit PDF verbinden, PPTX mit PDF kombinieren, PowerPoint, Präsentation, PDF, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Führen Sie PPTX-Dateien in PDF in Python zusammen" h2="Hochgeschwindigkeits- und plattformübergreifende Python-API, die bei der Entwicklung von Anwendungen mit der Fähigkeit hilft, Microsoft PowerPoint- und OpenOffice-Präsentationsdateien ohne die Verwendung von Software wie Microsoft oder Open Office, Adobe PDF zu erstellen, zusammenzuführen, zu überprüfen oder zu konvertieren." >}}

{{% blocks/products/pf/feature-page-section h2="Führen Sie PPTX in PDF in Python zusammen" %}}
...
{{% blocks/products/pf/feature-page-section  h2="PPTX-Dateien mit Python in PDF zusammenführen" %}}
Um die PowerPoint-Präsentationen zusammenzuführen, müssen Sie die Folien von einer Präsentation zur anderen klonen.

{{% blocks/products/pf/agp/code-block title="Python-Code zum Zusammenführen mehrerer PPTX in einer einzigen PDF-Datei" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So führen Sie PPTX mit PDF mithilfe von Aspose.Slides for Python API zusammen" >}}
