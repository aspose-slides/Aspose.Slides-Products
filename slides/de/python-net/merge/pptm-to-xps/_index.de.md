---
title: PPTM-Dateien mit Python in XPS zusammenführen
url: /de/python-net/merge/pptm-to-xps/
keywords: PPTM mit XPS zusammenführen, PPTM mit XPS verbinden, PPTM mit XPS kombinieren, PowerPoint, Präsentation, XPS, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="PPTM-Dateien mit Python in XPS zusammenführen" %}}
Um die PowerPoint-Präsentationen zusammenzuführen, müssen Sie die Folien von einer Präsentation zur anderen klonen.

{{% blocks/products/pf/agp/code-block title="Python-Code zum Zusammenführen mehrerer PPTM in einer einzigen XPS-Datei" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So führen Sie PPTM mit XPS mithilfe von Aspose.Slides for Python API zusammen" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dies sind die Schritte, um zwei PPTM-Dateien zusammenzuführen und das Ergebnis als XPS in Python zu speichern." >}}
