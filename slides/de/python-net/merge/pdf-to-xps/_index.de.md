...
{{% blocks/products/pf/feature-page-section  h2="PDF-Dateien mit Python in XPS zusammenführen" %}}
Um die PowerPoint-Präsentationen zusammenzuführen, müssen Sie die Folien von einer Präsentation zur anderen klonen.

{{% blocks/products/pf/agp/code-block title="Python-Code zum Zusammenführen mehrerer PDF in einer einzigen XPS-Datei" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So führen Sie PDF mit XPS mithilfe von Aspose.Slides for Python API zusammen" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dies sind die Schritte, um zwei PDF-Dateien zusammenzuführen und das Ergebnis als XPS in Python zu speichern." >}}
