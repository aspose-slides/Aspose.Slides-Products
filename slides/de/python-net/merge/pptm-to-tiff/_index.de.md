---
title: PPTM-Dateien mit Python in TIFF zusammenführen
url: /de/python-net/merge/pptm-to-tiff/
keywords: PPTM mit TIFF zusammenführen, PPTM mit TIFF verbinden, PPTM mit TIFF kombinieren, PowerPoint, Präsentation, TIFF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="PPTM-Dateien mit Python in TIFF zusammenführen" %}}
Um die PowerPoint-Präsentationen zusammenzuführen, müssen Sie die Folien von einer Präsentation zur anderen klonen.

{{% blocks/products/pf/agp/code-block title="Python-Code zum Zusammenführen mehrerer PPTM in einer einzigen TIFF-Datei" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So führen Sie PPTM mit TIFF mithilfe von Aspose.Slides for Python API zusammen" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dies sind die Schritte, um zwei PPTM-Dateien zusammenzuführen und das Ergebnis als TIFF in Python zu speichern." >}}
