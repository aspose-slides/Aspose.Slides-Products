---
title: ODP-Dateien mit Python in SVG zusammenführen
url: /de/python-net/merge/odp-to-svg/
keywords: ODP mit SVG zusammenführen, ODP mit SVG verbinden, ODP mit SVG kombinieren, PowerPoint, Präsentation, SVG, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Führen Sie ODP-Dateien in SVG in Python zusammen" h2="Hochgeschwindigkeits- und plattformübergreifende Python-API, die bei der Entwicklung von Anwendungen mit der Fähigkeit hilft, Microsoft PowerPoint- und OpenOffice-Präsentationsdateien ohne die Verwendung von Software wie Microsoft oder Open Office, Adobe PDF zu erstellen, zusammenzuführen, zu überprüfen oder zu konvertieren." >}}

{{% blocks/products/pf/feature-page-section h2="Führen Sie ODP in SVG in Python zusammen" %}}
...
{{% blocks/products/pf/feature-page-section  h2="ODP-Dateien mit Python in SVG zusammenführen" %}}
Um die PowerPoint-Präsentationen zusammenzuführen, müssen Sie die Folien von einer Präsentation zur anderen klonen.

{{% blocks/products/pf/agp/code-block title="Python-Code zum Zusammenführen mehrerer ODP in einer einzigen SVG-Datei" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So führen Sie ODP mit SVG mithilfe von Aspose.Slides for Python API zusammen" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dies sind die Schritte, um zwei ODP-Dateien zusammenzuführen und das Ergebnis als SVG in Python zu speichern." >}}
