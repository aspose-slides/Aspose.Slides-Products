---
title: PPTX-Dateien mit Python in XPS zusammenführen
url: /de/python-net/merge/pptx-to-xps/
keywords: PPTX mit XPS zusammenführen, PPTX mit XPS verbinden, PPTX mit XPS kombinieren, PowerPoint, Präsentation, XPS, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="PPTX-Dateien mit Python in XPS zusammenführen" %}}
Um die PowerPoint-Präsentationen zusammenzuführen, müssen Sie die Folien von einer Präsentation zur anderen klonen.

{{% blocks/products/pf/agp/code-block title="Python-Code zum Zusammenführen mehrerer PPTX in einer einzigen XPS-Datei" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So führen Sie PPTX mit XPS mithilfe von Aspose.Slides for Python API zusammen" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dies sind die Schritte, um zwei PPTX-Dateien zusammenzuführen und das Ergebnis als XPS in Python zu speichern." >}}
