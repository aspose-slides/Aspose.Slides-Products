---
title: Metadaten von POT-Dateien mit Python anzeigen oder bearbeiten
url: /de/python-net/metadata/pot/
keywords: POT-Metadaten bearbeiten, POT-Metadaten anzeigen, POT-Eigenschaften bearbeiten, POT-Eigenschaften anzeigen
description: Python-Quellcode zum Bearbeiten oder Anzeigen von Metadaten im POT-Format.
---
...
{{% blocks/products/pf/feature-page-section  h2="POT-Eigenschaften über Python ändern" %}}
...
{{% blocks/products/pf/agp/code-block title="POT integrierte Eigenschaften ändern – Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Benutzerdefinierte Eigenschaften zu POT hinzufügen – Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So extrahieren Sie Metadaten von POT über Python" >}}
