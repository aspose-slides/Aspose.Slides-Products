...
{{% blocks/products/pf/agp/code-block title="FODP integrierte Eigenschaften ändern – Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Benutzerdefinierte Eigenschaften zu FODP hinzufügen – Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So extrahieren Sie Metadaten von FODP über Python" >}}
