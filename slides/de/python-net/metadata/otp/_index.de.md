...
{{% blocks/products/pf/agp/code-block title="OTP integrierte Eigenschaften ändern – Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Benutzerdefinierte Eigenschaften zu OTP hinzufügen – Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So extrahieren Sie Metadaten von OTP über Python" >}}
