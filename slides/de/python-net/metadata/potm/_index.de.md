...
{{% blocks/products/pf/agp/code-block title="POTM integrierte Eigenschaften ändern – Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Benutzerdefinierte Eigenschaften zu POTM hinzufügen – Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So extrahieren Sie Metadaten von POTM über Python" >}}
