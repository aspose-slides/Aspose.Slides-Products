...
{{% blocks/products/pf/agp/code-block title="ODP integrierte Eigenschaften ändern – Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Benutzerdefinierte Eigenschaften zu ODP hinzufügen – Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So extrahieren Sie Metadaten von ODP über Python" >}}
