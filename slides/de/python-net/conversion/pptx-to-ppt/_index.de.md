...
weight: 2810
url: /de/python-net/conversion/pptx-to-ppt/ 
keywords: "Convert, PowerPoint, PPTX, PPT, Presentation, Python"
description: Beispielcode für die Umwandlung von PPTX in PPT Python. Verwenden Sie die PowerPoint-Python-API für die Stapelkonvertierung von PPTX-Dateien in PPT-Dateien.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie PPTX in PPT in Python" h2="Leistungsstarke PowerPoint-Python-Bibliothek zum Konvertieren von PPTX in PPT" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Konvertieren Sie PPTX in PPT in Python" %}}

Müssen Sie PPTX-Dateien programmgesteuert in PPT konvertieren? Mit [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/de/python-net/) kann jeder Entwickler mit nur wenigen Zeilen Python-Code PPTX in das PPT-Format konvertieren.

Als moderne Präsentationsverarbeitungs-API erstellt Aspose.Slides für Python schnell PPT aus PPTX. Testen Sie die Qualität der Umwandlung von PPTX in PPT direkt in Ihrem [Browser](https://products.aspose.app/slides/conversion). Mit der Aspose PowerPoint PPTX-Bibliothek können Sie PPTX-Dateien in viele gängige Formate konvertieren.
...
{{< blocks/products/pf/agp/feature-section-col title="So konvertieren Sie PPTX in PPT in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dies sind die Schritte zum Konvertieren einer PPTX-Datei in PPT mit Python." >}}
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die PPTX-zu-PPT-Python-Konvertierung" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Speichern Sie PPTX als PPT in Python" %}}
Verwenden Sie die kostenlose App, um eine Demonstration des PPTX-zu-PPT-Konvertierungsprozesses zu sehen. 
{{% /blocks/products/pf/agp/content %}}
