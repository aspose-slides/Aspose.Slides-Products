...
Müssen Sie PPTX-Dateien programmgesteuert in XPS konvertieren? Mit [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/de/python-net/) kann jeder Entwickler PPTX mit nur wenigen Zeilen Python-Code in das XPS-Format konvertieren.
