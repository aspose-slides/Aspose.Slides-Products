---
title: Konvertieren Sie JPG in PPT in Python
url: /de/python-net/conversion/jpg-to-ppt/
keywords: Konvertieren Sie JPG in PPT, JPG in PPT, PowerPoint, JPG, PPT, Python-API, Python-Bibliothek
description: Konvertieren Sie JPG in PPT in Python. Verwenden Sie die Python-Bibliotheks-API, um JPG-Bilder in PowerPoint zu konvertieren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie JPG in PPT in Python" h2="Leistungsstarke plattformübergreifende Python-API zum Konvertieren von JPG in PPT mithilfe von Python-Code" >}}

{{% blocks/products/pf/feature-page-section h2="Konvertieren Sie JPG mit Aspose.Slides in PPT" %}}

[**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/de/python-net/) ist eine leistungsstarke Python-Bibliothek zum Erstellen, Konvertieren und Bearbeiten von PowerPoint-Präsentationen, PDFs, HTML-Dokumente und andere Dateien. Wenn Sie JPG in PPT konvertieren, erstellen Sie im Wesentlichen eine PowerPoint-Präsentation, die Folien enthält, die auf JPG-Bildern basieren.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie JPG in PPT in Python" %}}
Mit [**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/de/python-net/) können Sie mit nur wenigen Codezeilen ein JPG-Bild in eine PowerPoint-Präsentation konvertieren:

{{% blocks/products/pf/agp/code-block title="Python-Code zum Konvertieren von JPG in PPT" offSpacer="true" %}}
```py
...
{{< blocks/products/pf/feature-page-section  h2="So konvertieren Sie JPG in PPT in Python" >}}
