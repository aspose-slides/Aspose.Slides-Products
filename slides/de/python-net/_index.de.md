---
title: Python-PowerPoint-API. Python PPTX, PPT von Aspose.Slides
weight: 5860
url: /de/python-net/ 
description: Python-Bibliothek zum Arbeiten mit Microsoft PowerPoint-Dateien. Python-PPTX, PPT. Erstellen Bearbeiten Konvertieren PPT PPTX PPS POT PPSX PPTM PPSM POTX POTM ODP PDF und viele weitere Formate.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python-PowerPoint-API für Präsentationen. Python-PPTX, PPT" h2="Erstellen, lesen, schreiben, ändern, zusammenführen, klonen, schützen und konvertieren Sie PowerPoint- und OpenOffice-Präsentationen in Python ohne externe Software." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-python.svg" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="https://downloads.aspose.com/slides/python-net" >}}
...
<p><strong>Aspose.Slides for Python via .NET</strong> ist eine leistungsstarke Klassenbibliothek zum Arbeiten mit oder Verarbeiten von Präsentationen. Mit diesem Produkt können Anwendungen und Entwickler PowerPoint-Präsentationen (PPT, PPTX) und Präsentationen in anderen Formaten (ODP) ohne Anwendungen oder Abhängigkeiten von Drittanbietern lesen, bearbeiten oder manipulieren und konvertieren. </p>

<p><strong>Aspose.Slides für Python via. NET</strong> bietet diese beliebten Funktionen:</p>
<ul>
...
<p>Python ist eine sehr beliebte Sprache, die häufig in regulären Anwendungen, Webentwicklung, Forschungs- und akademischen Aufgaben, Datenanalyse usw. verwendet wird. Aus diesem Grund ist das <strong>Aspose.Slides</strong>-Team stolz darauf, < strong>Aspose.Slides für Python über .NET</strong> an die Python-Community. </p>
...
{{< blocks/products/pf/carousel-item h3="Plattformunabhängigkeit" description="Die Python-Präsentations-API unterstützt alle wichtigen Plattformen, einschließlich der folgenden." >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="Unterstützte Dateiformate" description="Aspose.Slides for Python via .NET unterstützt gängige [Präsentationsformate](https://docs.aspose.com/slides/python-net/supported-file-formats/) und diese Exportformate." >}}
  ...
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <ul>
	  ...
	  <li>Falls Sie Python-Code unter Linux schreiben, sehen Sie sich die <a href="https://docs.aspose.com/slides/python-net/system-requirements/">zusätzlichen Anforderungen für Linux</a> an</li>
    </ul>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>Verwenden Sie <strong>pip</strong>, um unsere Python-Bibliothek für die Präsentationsverarbeitung aus dem <a href="https://pypi.org/project/aspose.slides/">PyPI-Repository</a> zu installieren</p>:
	<pre><code>pip install aspose.slides</code></pre>
   </div>
    <div class="col-lg-12">
        <h2 class="h2title">Erstellen Sie eine neue PowerPoint-Präsentation. Python PPTX, PPT oder ODP</h2>
...
with slides.Presentation() as presentation:
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Präsentationen zusammenführen: Python PPTX, PPT oder ODP</h2>
...
with slides.Presentation("Presentation1.pptx") as pres1:
    ...
    <div class="col-lg-12">
        <h2 class="h2title"> Präsentation aus PDF importieren: Python PPTX, PPT oder ODP</h2>
...
with slides.Presentation() as pres:
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Konvertieren Sie PowerPoint in PDF mit Standardoptionen: Python PPTX, PPT oder ODP in PDF</h2>
        <p>Dieser Python-Code zeigt Ihnen, wie Sie ein PowerPoint PPT-, PPTX- und OpenOffice ODP-Dokument mit den Standardoptionen in ein PDF-Dokument konvertieren. Die resultierende Datei ist ein PDF-Dokument mit den höchsten Qualitätsstufen</p>
        <pre>
            <code class="python">
import aspose.slides as slides
...
presentation.save("PPT-to-PDF.pdf", slides.export.SaveFormat.PDF)
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Konvertieren Sie PowerPoint in JPG: Python PPTX, PPT oder ODP in JPEG</h2>
...
{{< blocks/products/pf/slr-element name="API-Referenzen" href="https://docs.aspose.com/slides/python-net/api-reference/" >}}
