---
title: Bearbeiten Sie PPTM-Dateien über .NET
url: /de/net/editor/pptm/ 
description: C#-Quellcode zum Bearbeiten von PPTM-Dokumenten auf .NET Framework-, .NET Core-, Windows Azure-, Mono- oder Xamarin-Plattformen.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="PPTM-Formate in C# bearbeiten" h2="Native und leistungsstarke PPTM-Dokumentbearbeitung mit serverseitigen Aspose.Slides für .NET-APIs, ohne die Verwendung von Software wie Microsoft oder Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="So bearbeiten Sie eine PPTM-Datei mit C#" %}}

Um die PPTM-Datei zu bearbeiten, verwenden wir die API <a href="https://products.aspose.com/slides/de/net">Aspose.Slides for .NET</a>, die eine funktionsreiche und leistungsstarke API ist und benutzerfreundliche API für die C#-Plattform für jeden Editor. Öffnen Sie den <a href="https://www.nuget.org/packages/aspose.slides.net">NuGet</a>-Paketmanager, suchen Sie nach <b>Aspose.Slides</b> und installieren Sie es. Sie können auch den folgenden Befehl in der Paket-Manager-Konsole verwenden.
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Bearbeiten von PPTM-Dateien in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="PPTM-Dateien bearbeiten – C#" offSpacer="" %}}
