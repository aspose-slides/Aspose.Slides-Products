---
title: Konvertieren Sie JPG in C# in PDF
weight: 10
url: /de/net/conversion/jpg-to-pdf/ 
keywords: JPG in PDF, Konvertieren von JPG in PDF, C#-API, .NET-Bibliothek
description: Konvertieren Sie JPG in C# in PDF. Verwenden Sie die .NET-Bibliotheks-API, um JPG-JPEG-Bilder in PDF-Dokumente zu konvertieren.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konvertieren Sie JPG in C# in PDF" h2="PowerPoint .NET-API zum Konvertieren von JPG-Bildern in PDF-Dokumente auf NET Framework-, .NET Core-, Windows Azure-, Mono- oder Xamarin-Plattformen" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie JPG in PDF in C#" %}}

Wie konvertiere ich programmgesteuert JPG in PDF?

Mit [**Aspose.Slides for .NET**](https://products.aspose.com/slides/de/net/) kann jeder Entwickler oder jede Anwendung JPG mit nur wenigen Zeilen C#-Code in das PDF-Format konvertieren.

Als moderne Dokumentenverarbeitungs-API erstellt Aspose.Slides für .NET schnell PDFs aus JPG-Bildern. Mit der Aspose PowerPoint-Bibliothek können Sie JPG in PDF und viele andere Dateiformate konvertieren
...
{{< blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von JPG in PDF in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Entwickler und Anwendungen können JPG auf diese Weise in PDF konvertieren:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Bevor Sie den C#-Code für die JPG-zu-PDF-Konvertierung ausführen, muss Ihr Computer über die folgenden Voraussetzungen verfügen:
...
{{% blocks/products/pf/agp/code-block title="C#-Code zum Konvertieren von JPG in PDF" offSpacer="" %}}
