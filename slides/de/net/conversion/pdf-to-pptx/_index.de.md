---
title: Konvertieren Sie PDF in PPTX in C#
url: /de/net/conversion/pdf-to-pptx/
keywords: Konvertieren Sie PDF in PPTX, PDF in PPTX, PowerPoint, PDF, PPTX, C#-API, .NET-Bibliothek
description: Konvertieren Sie PDF in PPTX in C#. Verwenden Sie die .NET-Bibliotheks-API, um PDF in PowerPoint zu konvertieren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie PDF in PPTX in C#" h2="Leistungsstarke plattformübergreifende .NET-API zum Konvertieren von PDF in PPTX mithilfe von C#-Code auf NET Framework-, .NET Core-, Windows Azure-, Mono- oder Xamarin-Plattformen" >}}

{{% blocks/products/pf/feature-page-section h2="Konvertieren Sie PDF in PPTX mit Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/de/net/) ist eine leistungsstarke .NET-Bibliothek zum Erstellen, Konvertieren und Bearbeiten von PowerPoint-Präsentationen, PDFs, HTML-Dokumenten, und andere Dateien. Wenn Sie PDF in PPTX konvertieren, verschieben Sie im Wesentlichen die Inhalte auf den PDF-Seiten auf Folien in einer PowerPoint-Präsentation.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie PDF in PPTX in C#" %}}
Mit [**Aspose.Slides for .NET**](https://products.aspose.com/slides/de/net/) können Sie mit nur wenigen Codezeilen eine PDF- in eine PowerPoint-Präsentation konvertieren:

{{% blocks/products/pf/agp/code-block title="C#-Code zum Konvertieren von PDF in PPTX" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="So konvertieren Sie PDF in PPTX in C#" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Laden Sie die PDF-Datei, die Sie in PPTX konvertieren möchten.
{{< /blocks/products/pf/agp/step-autogen >}}
