---
title: Konvertieren Sie JPG in PNG in C#
weight: 220
url: /de/net/conversion/jpg-to-png/ 
keywords: JPG in PNG, Konvertieren von JPG in PNG, C#-API, .NET-Bibliothek
description: Konvertieren Sie JPG in PNG in C#. Verwenden Sie die .NET-Bibliotheks-API, um JPG- in PNG-Dateien zu konvertieren.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konvertieren Sie JPG in PNG in C#" h2="PowerPoint .NET-API zum Konvertieren von JPG- in PNG-Bilddateien auf NET Framework-, .NET Core-, Windows Azure-, Mono- oder Xamarin-Plattformen" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Konvertieren Sie JPG in PNG in C#" %}}

Wie konvertiere ich JPG im Code in PNG?

Mit [**Aspose.Slides for .NET**](https://products.aspose.com/slides/de/net/) kann jeder Entwickler oder jede Anwendung JPG mit nur wenigen Zeilen C#-Code in PNG konvertieren.

Als moderne Dokumentenverarbeitungs-API exportiert Aspose.Slides für .NET JPG-Dateien schnell in PNG. Mit der Aspose PowerPoint-Bibliothek können Sie JPG in PNG und Bilder in anderen Formaten konvertieren.
...
{{< blocks/products/pf/agp/feature-section-col title="So konvertieren Sie JPG in PNG in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Entwickler und Anwendungen können JPG auf folgende Weise in PNG konvertieren:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Speichern Sie die Datei als PNG-Bild.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Bevor Sie den C#-Code für die JPG-zu-PNG-Konvertierung ausführen, muss Ihr Computer über die folgenden Voraussetzungen verfügen:
...
{{% blocks/products/pf/agp/code-block title="C#-Code zum Konvertieren von JPG in PNG" offSpacer="" %}}
