...
url: /de/net/conversion/image-to-pptx/
keywords: Konvertieren Sie Bild in PPTX, Bild in PPTX, PowerPoint, Bild, PPTX, C#-API, .NET-Bibliothek
description: Konvertieren Sie das Bild in C# in PPTX. Verwenden Sie die .NET-Bibliotheks-API, um Bilder in PowerPoint zu konvertieren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Bild in PPTX in C# konvertieren" h2="Leistungsstarke plattformübergreifende .NET-API zum Konvertieren von Bildern in PPTX mithilfe von C#-Code auf NET Framework-, .NET Core-, Windows Azure-, Mono- oder Xamarin-Plattformen" >}}

{{% blocks/products/pf/feature-page-section h2="Konvertieren Sie das Bild mit Aspose.Slides in PPTX" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/de/net/) ist eine leistungsstarke .NET-Bibliothek zum Erstellen, Konvertieren und Bearbeiten von PowerPoint-Präsentationen, PDFs, HTML-Dokumenten, und andere Dateien. Wenn Sie Bilder in PPTX konvertieren, erstellen Sie im Wesentlichen eine PowerPoint-Präsentation, die Folien enthält, die auf diesen Bildern basieren.
...
{{% blocks/products/pf/agp/code-block title="C#-Code zum Konvertieren von Bildern in PPTX" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="So konvertieren Sie Bilder in PPTX in C#" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/de/net/conversion/image-to-ppt/" name="IMAGE TO PPT" >}}
