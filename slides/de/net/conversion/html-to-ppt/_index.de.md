...
url: /de/net/conversion/html-to-ppt/
keywords: Konvertieren Sie HTML in PPT, HTML in PPT, PowerPoint, HTML, PPT, C#-API, .NET-Bibliothek
description: Konvertieren Sie HTML in C# in PPT. Verwenden Sie die .NET-Bibliotheks-API, um HTML in PowerPoint zu konvertieren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie HTML in PPT in C#" h2="Leistungsstarke plattformübergreifende .NET-API zum Konvertieren von HTML in PPT mithilfe von C#-Code auf NET Framework-, .NET Core-, Windows Azure-, Mono- oder Xamarin-Plattformen" >}}

{{% blocks/products/pf/feature-page-section h2="Konvertieren Sie HTML mit Aspose.Slides in PPT" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/de/net/) ist eine leistungsstarke .NET-Bibliothek zum Erstellen, Konvertieren und Bearbeiten von PowerPoint-Präsentationen, PDFs, HTML-Dokumenten, und andere Dateien. Wenn Sie HTML in PPT konvertieren, verschieben Sie im Wesentlichen den Inhalt eines HTML-Dokuments auf Folien in einer PowerPoint-Präsentation.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie HTML in PPT in C#" %}}
Mit [**Aspose.Slides for .NET**](https://products.aspose.com/slides/de/net/) können Sie mit nur wenigen Codezeilen ein HTML-Dokument in eine PowerPoint-Präsentation konvertieren:

{{% blocks/products/pf/agp/code-block title="C#-Code zum Konvertieren von HTML in PPT" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="So konvertieren Sie HTML in PPT in C#" >}}
