...
keywords: PNG in JPG, Konvertieren von PNG in JPG, C#-API, .NET-Bibliothek
description: Konvertieren Sie PNG in JPG in C#. Verwenden Sie die .NET-Bibliotheks-API, um PNG-Dateien in JPG-Dateien zu konvertieren.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konvertieren Sie PNG in JPG in C#" h2="PowerPoint .NET-API zum Konvertieren von PNG- in JPG-Bilddateien auf NET Framework-, .NET Core-, Windows Azure-, Mono- oder Xamarin-Plattformen" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Konvertieren Sie PNG in JPG in C#" %}}

Wie konvertiere ich PNG in JPG im Code?

Mit [**Aspose.Slides for .NET**](https://products.aspose.com/slides/de/net/) kann jeder Entwickler oder jede Anwendung mit nur wenigen Zeilen C#-Code PNG in JPG konvertieren.

Als moderne Dokumentverarbeitungs-API exportiert Aspose.Slides für .NET schnell PNG-Dateien in JPG. Mit der Aspose PowerPoint-Bibliothek können Sie PNG in JPG und Bilder in anderen Formaten konvertieren.
...
{{< blocks/products/pf/agp/feature-section-col title="So konvertieren Sie PNG in JPG in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Entwickler und Anwendungen können auf diese Weise PNG in JPG konvertieren:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Speichern Sie die Datei als JPG-Bild.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Bevor Sie den C#-Code für die Umwandlung von PNG in JPG ausführen, muss Ihr Computer über die folgenden Voraussetzungen verfügen:
...
{{% blocks/products/pf/agp/code-block title="C#-Code zum Konvertieren von PNG in JPG" offSpacer="" %}}
