...
{{% blocks/products/pf/agp/code-block title="POTX integrierte Eigenschaften ändern – C#" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Benutzerdefinierte Eigenschaften zu POTX hinzufügen – C#" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So extrahieren Sie Metadaten von POTX über C#" >}}
