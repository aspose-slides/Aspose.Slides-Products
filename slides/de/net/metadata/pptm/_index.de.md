...
{{% blocks/products/pf/agp/code-block title="PPTM integrierte Eigenschaften ändern – C#" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Benutzerdefinierte Eigenschaften zu PPTM hinzufügen – C#" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So extrahieren Sie Metadaten von PPTM über C#" >}}
