---
title: Metadaten von POT-Dateien mit .NET anzeigen oder bearbeiten
...
description: C#-Quellcode zum Bearbeiten oder Anzeigen von Metadaten im POT-Format.
---
...
{{% blocks/products/pf/feature-page-section  h2="POT-Eigenschaften über C# ändern" %}}
...
{{% blocks/products/pf/agp/code-block title="POT integrierte Eigenschaften ändern – C#" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Benutzerdefinierte Eigenschaften zu POT hinzufügen – C#" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So extrahieren Sie Metadaten von POT über C#" >}}
