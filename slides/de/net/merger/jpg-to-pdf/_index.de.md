---
title: JPG mit PDF in C# zusammenführen
url: /de/net/merger/jpg-to-pdf/
keywords: JPG zu PDF, JPG zu PDF zusammenführen, JPG zu PDF verbinden, PDF, JPG, C#-API, .NET-Bibliothek
description: JPG mit PDF in C# zusammenführen. Verwenden Sie die .NET-Bibliotheks-API, um JPG und PDF zu kombinieren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="JPG mit PDF in C# zusammenführen" h2="Leistungsstarke plattformübergreifende .NET-API zum Zusammenführen von JPG- mit PDF-Dateien mithilfe von C#-Code auf NET Framework-, .NET Core-, Windows Azure-, Mono- oder Xamarin-Plattformen" >}}

{{% blocks/products/pf/feature-page-section h2="JPG mit Aspose.Slides in PDF zusammenführen" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/de/net/) ist eine leistungsstarke .NET-Bibliothek zum Erstellen, Konvertieren, Zusammenführen und Bearbeiten von Präsentationen, PDFs, Bildern, und andere Dateien. Wenn Sie JPG in PDF zusammenführen, kombinieren Sie effektiv JPG-Bilder, um eine einzige PDF-Datei zu erhalten.
...
{{% blocks/products/pf/feature-page-section  h2="JPG mit PDF in C# zusammenführen" %}}
Mit [**Aspose.Slides for .NET**](https://products.aspose.com/slides/de/net/) können Sie JPG mit nur wenigen Codezeilen schnell in PDF zusammenführen

{{% blocks/products/pf/agp/code-block title="C#-Code zum Zusammenführen von JPG in PDF" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="So führen Sie JPG mit PDF in C# zusammen" >}}
