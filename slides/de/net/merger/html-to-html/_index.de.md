---
title: HTML-Dateien in C# zusammenführen
url: /de/net/merger/html-to-html/
keywords: HTML zusammenführen, HTML mit HTML, HTML verbinden, HTML kombinieren, C#-API, .NET-Bibliothek
description: HTML mit HTML in C# zusammenführen. Verwenden Sie die .NET-Bibliotheks-API, um HTML-Dateien zu kombinieren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="HTML in C# zusammenführen" h2="Leistungsstarke plattformübergreifende .NET-API zum Zusammenführen von HTML-Dateien mit C#-Code auf NET Framework-, .NET Core-, Windows Azure-, Mono- oder Xamarin-Plattformen" >}}

{{% blocks/products/pf/feature-page-section h2="Zusammenführen von HTML zu HTML mit Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/de/net/) ist eine leistungsstarke .NET-Bibliothek zum Erstellen, Konvertieren, Zusammenführen und Bearbeiten von Präsentationen, HTML-Dateien und Sonstige Unterlagen. Wenn Sie HTML mit HTML zusammenführen, kombinieren Sie effektiv den Inhalt von 2 Dokumenten, um eine HTML-Datei zu erhalten. Mit Aspose.Slides können Sie HTML-Dokumente auf verschiedene Arten zusammenführen. Sie können HTML mit all seinen Texten, Formatierungen, Stilen usw. zusammenführen.
...
{{% blocks/products/pf/feature-page-section  h2="HTML mit HTML in C# zusammenführen" %}}
Mit [**Aspose.Slides for .NET**](https://products.aspose.com/slides/de/net/) können Sie HTML-Dateien schnell mit nur wenigen Codezeilen zusammenführen

{{% blocks/products/pf/agp/code-block title="C#-Code zum Zusammenführen von HTML mit HTML" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="So führen Sie HTML in C# zusammen" >}}
