...
<h2 class="h2title">Unterstützung für Office Open XML</h2>

<p>Office OpenXML (OOXML) ist das XML-basierte Format, das in Microsoft Office 2007 eingeführt wurde.</p>

<p>PresentationML (OOXML, PPTX) ist die Auszeichnungssprache, die von Microsoft Office PowerPoint 2007 zum Speichern seiner Dokumente verwendet wird. Aspose.Slides für .NET unterstützt umfassend das Erstellen, Lesen, Bearbeiten und Schreiben von PresentationML-Dokumenten.</p>
...
{{< blocks/products/pf/slr-element name="API-Referenzen" href="https://reference.aspose.com/slides/net/" >}}
...
{{< blocks/products/pf/slr-element name="Versionshinweise" href="https://releases.aspose.com/slides/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
