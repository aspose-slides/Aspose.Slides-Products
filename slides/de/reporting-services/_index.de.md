...
description: Die PowerPoint-API von Reporting Services ist Aspose.Slides für SQL PPT. PowerPoint-Präsentationsdienste für SQL PowerPoint.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Reporting Services PowerPoint-API" h2="Exportieren Sie RDL-Berichte in die Formate PowerPoint PPT, PPTX, PPS und PPSX." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-reporting-services.svg" pfName="Aspose.Slides" subTitlepfName="for Reporting Services" downloadUrl="https://downloads.aspose.com/slides/reportingservices" >}}
...
<p>
 Aspose.Slides for Reporting Services ist die einzige Lösung auf dem Markt, die es ermöglicht, Präsentationen in den nativen Formaten von PowerPoint aus den Microsoft SQL Server Reporting Services heraus zu erstellen.
</p>

<p>
 Aspose.Slides for Reporting Services unterstützt fast alle RDL-Funktionen wie Tabellen, Matrizen, Diagramme, Bilder, Listen, Unterberichte und Kopf-/Fußzeilen, sodass Berichte in PowerPoint-Präsentationsformaten so exportiert werden können, dass sie ähnlich wie das Original aussehen Berichtsdesign. Führen Sie Reporting Services SQL PPT ohne Microsoft PowerPoint-Automatisierung aus.
</p>
...
{{< blocks/products/pf/carousel-item h3="Auf einen Blick" description="Eine Übersicht über Aspose.Slides für Reporting Services." >}}
...
{{< blocks/products/pf/carousel-item h3="Plattformunabhängigkeit" description="Das Produkt unterstützt Microsoft SQL Server Reporting Services." >}}
<div class="diagram1 d1-rs">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Erweiterte Reporting Services-API-Funktionen
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Erstellen Sie Vergleichstabellen in RDL-Berichten und exportieren Sie sie als Präsentationen
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Erstellen Sie komplexe RDL-Berichte und exportieren Sie sie in Präsentationsdateien
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Exportieren Sie datenzentrische RDL-Berichte mit Unterberichten
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Exportieren Sie eingebettete Audio- und Videodateien in PowerPoint-Dateien
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Exportieren Sie RDL-Berichte mit Unterberichten nach PowerPoint
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Ändern Sie die Farbe der Serie und ihrer Kategorien
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Rasterung oder Vektorisierung von Shapes ohne Text
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-share ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Konvertieren Sie SVG-Bilder in Formen
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Ändern Sie die Textfarbe von Hyperlinks während einer Präsentation
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Unterstützung für Open-Document-Verschlüsselung, Text-Highlighter und Morph-Übergang
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Trichterdiagramme und 2D-Kartendiagramme werden unterstützt
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Unterstützung für Kommentarantworten und Office 365
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Export in Präsentations- und Diashow-Formate
    </h2>
    <p>
     SQL Server Reporting Services (SSRS) bietet keine integrierte Unterstützung für das Exportieren von RDL-Berichten in PowerPoint-Präsentationen oder Diashows. Während Sie Aspose.Slides for Reporting Services verwenden, können Sie ganz einfach Unterstützung für zusätzliche Exportformate hinzufügen.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for Reporting Services unterstützt die vollständige RDL-Spezifikation und man kann vorhandene Berichte mit dieser Erweiterung anpassen. Es ist ganz einfach, einen RDL-Berichtsdesigner Ihrer Wahl auszuwählen und die Berichte dann genau so zu exportieren, wie Sie sie entworfen haben.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for Reporting Services basiert auf verwaltetem Code, der nie die Installation von Microsoft PowerPoint auf dem Computer erfordert, um mit PowerPoint-Präsentationen zu arbeiten. Es ist eine perfekte Microsoft PowerPoint-Automatisierungsalternative in Bezug auf unterstützte Funktionen, Sicherheit, Stabilität, Skalierbarkeit, Geschwindigkeit und Preis.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="Warum Aspose.Slides für Reporting Services?" tabId="success-stories" >}}
