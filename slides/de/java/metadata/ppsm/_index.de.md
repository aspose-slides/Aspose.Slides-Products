...
{{% blocks/products/pf/agp/code-block title="PPSM integrierte Eigenschaften ändern – Java" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Benutzerdefinierte Eigenschaften zu PPSM hinzufügen – Java" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So extrahieren Sie Metadaten von PPSM über Java" >}}
