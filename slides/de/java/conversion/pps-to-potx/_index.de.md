...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie PPS in POTX mit Java" %}}

 Um PPS in POTX zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von PPS in POTX über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können PPS-Dateien in nur wenigen Codezeilen problemlos in POTX konvertieren.
...
{{% blocks/products/pf/agp/code-block title="PPS-zu-POTX-Java-Konvertierungsquellcode" offSpacer="" %}}
