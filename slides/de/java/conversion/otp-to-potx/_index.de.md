...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTP in POTX mit Java" %}}

 Um OTP in POTX zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von OTP in POTX über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können OTP-Dateien in nur wenigen Codezeilen problemlos in POTX konvertieren.
...
{{% blocks/products/pf/agp/code-block title="OTP-zu-POTX-Java-Konvertierungsquellcode" offSpacer="" %}}
