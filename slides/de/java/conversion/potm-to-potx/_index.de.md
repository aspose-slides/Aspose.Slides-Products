...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie POTM in POTX mit Java" %}}

 Um POTM in POTX zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von POTM in POTX über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können die POTM-Datei in nur wenigen Codezeilen problemlos in POTX konvertieren.
...
{{% blocks/products/pf/agp/code-block title="POTM-zu-POTX-Java-Konvertierungsquellcode" offSpacer="" %}}
