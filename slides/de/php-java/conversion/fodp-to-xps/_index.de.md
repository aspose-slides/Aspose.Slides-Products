...
title: Konvertieren Sie FODP in XPS in PHP
weight: 210
url: /de/php-java/conversion/fodp-to-xps/ 
keywords: "Convert, PowerPoint, FODP, XPS, Presentation, PHP"
description: Beispielcode für die PHP-Konvertierung von FODP nach XPS. Verwenden Sie die PowerPoint-PHP-API für die Stapelkonvertierung von FODP-Dateien in XPS-Dateien.
---
...
{{% blocks/products/pf/agp/content h2="Konvertieren Sie FODP in XPS in PHP" %}}

Müssen Sie FODP-Dateien programmgesteuert in XPS konvertieren? Mit [*Aspose.Slides for PHP via Java*](https://products.aspose.com/slides/de/php-java/) kann jeder Entwickler mit nur wenigen Zeilen PHP-Code das Format FODP in das Format XPS konvertieren .

Als moderne Präsentationsverarbeitungs-API erstellt Aspose.Slides für PHP schnell XPS aus FODP. Testen Sie die Qualität der Umwandlung von FODP in XPS direkt in Ihrem [Browser](https://products.aspose.app/slides/conversion). Mit der Aspose PowerPoint PPTX-Bibliothek können Sie FODP-Dateien in viele gängige Formate konvertieren.
...
{{< blocks/products/pf/agp/feature-section-col title="So konvertieren Sie FODP in XPS in PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dies sind die Schritte zum Konvertieren einer FODP-Datei in XPS mit PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die PHP-Konvertierung von FODP nach XPS" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Speichern Sie FODP als XPS in PHP" %}}
Verwenden Sie die kostenlose App, um eine Demonstration des Umwandlungsprozesses von FODP in XPS zu sehen. 
{{% /blocks/products/pf/agp/content %}}
