...
description: JPG mit PDF in PHP zusammenführen. Verwenden Sie die PHP-Bibliotheks-API, um JPG und PDF zu kombinieren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="JPG mit PDF in PHP zusammenführen" h2="Hochgeschwindigkeits- und plattformübergreifende PHP-Bibliothek zum Zusammenführen von JPG- mit PDF-Dateien mithilfe von PHP-Code" >}}

{{% blocks/products/pf/feature-page-section h2="JPG mit Aspose.Slides in PDF zusammenführen" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/de/php-java/) ist eine leistungsstarke PHP-Bibliothek zum Erstellen, Konvertieren, Zusammenführen und Bearbeiten von Präsentationen, PDFs, Bilder und andere Dateien. Wenn Sie JPG in PDF zusammenführen, kombinieren Sie effektiv JPG-Bilder, um eine einzige PDF-Datei zu erhalten.
...
{{% blocks/products/pf/feature-page-section  h2="JPG mit PDF in PHP zusammenführen" %}}
Mit [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/de/php-java/) können Sie JPG mit nur wenigen Codezeilen schnell in PDF zusammenführen

{{% blocks/products/pf/agp/code-block title="PHP-Code zum Zusammenführen von JPG in PDF" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Wie man JPG mit PDF in PHP zusammenführt" >}}
