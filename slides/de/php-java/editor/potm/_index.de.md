---
title: Bearbeiten Sie POTM in PHP
url: /de/php-java/editor/potm/
keywords: POTM bearbeiten, PowerPoint bearbeiten, POTM, PowerPoint, PHP-API, PHP-Bibliothek
description: Bearbeiten Sie POTM in PHP. Verwenden Sie die PHP-Bibliotheks-API, um POTM-Dateien zu bearbeiten
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Bearbeiten Sie POTM in PHP" h2="Hochgeschwindigkeits- und plattformübergreifende PHP-Bibliothek zum Bearbeiten von POTM mithilfe von PHP-Code" >}}

{{% blocks/products/pf/feature-page-section h2="Bearbeiten Sie POTM mit Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/de/php-java/) ist eine leistungsstarke PHP-Bibliothek zur Manipulation und Bearbeitung von Präsentationen. Sie können eine POTM-Präsentation bearbeiten, indem Sie ihr eine neue Textzeile hinzufügen. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Bearbeiten Sie POTM in PHP" %}}
Mit [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/de/php-java/) können Sie dem POTM-Dokument mit nur einem eine neue Textzeile hinzufügen paar Zeilen Code.

{{% blocks/products/pf/agp/code-block title="PHP-Code zum Bearbeiten von POTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So bearbeiten Sie POTM in PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Laden Sie die POTM-Präsentation, die Sie bearbeiten möchten.
{{< /blocks/products/pf/agp/step-autogen >}}
