---
title: Bearbeiten Sie PPSX in PHP
url: /de/php-java/editor/ppsx/
keywords: PPSX bearbeiten, PowerPoint bearbeiten, PPSX, PowerPoint, PHP-API, PHP-Bibliothek
description: Bearbeiten Sie PPSX in PHP. Verwenden Sie die PHP-Bibliotheks-API, um PPSX-Dateien zu bearbeiten
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Bearbeiten Sie PPSX in PHP" h2="Hochgeschwindigkeits- und plattformübergreifende PHP-Bibliothek zum Bearbeiten von PPSX mithilfe von PHP-Code" >}}

{{% blocks/products/pf/feature-page-section h2="Bearbeiten Sie PPSX mit Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/de/php-java/) ist eine leistungsstarke PHP-Bibliothek zur Manipulation und Bearbeitung von Präsentationen. Sie können eine PPSX-Präsentation bearbeiten, indem Sie ihr eine neue Textzeile hinzufügen. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Bearbeiten Sie PPSX in PHP" %}}
Mit [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/de/php-java/) können Sie dem PPSX-Dokument mit nur einem eine neue Textzeile hinzufügen paar Zeilen Code.

{{% blocks/products/pf/agp/code-block title="PHP-Code zum Bearbeiten von PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So bearbeiten Sie PPSX in PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Laden Sie die PPSX-Präsentation, die Sie bearbeiten möchten.
{{< /blocks/products/pf/agp/step-autogen >}}
