...
description: C++-Quellcode zum Löschen von Anmerkungen aus ODP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Kommentare und Kommentarautoren aus ODP in C++ entfernen" h2="Erstellen Sie Ihre eigenen C++-Apps, um Kommentare und Autoren in Dokumentdateien mithilfe serverseitiger APIs zu bearbeiten." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5="ODP" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for C++" >}}

{{% blocks/products/pf/feature-page-section  h2="Kommentare aus ODP über C++ entfernen" %}}
Um Anmerkungen aus der ODP-Datei zu entfernen, verwenden wir die API [Aspose.Slides for C++](https://products.aspose.com/slides/de/cpp/), die eine funktionsreiche, leistungsstarke und benutzerfreundliche API ist Dokumentbearbeitungs-API für die C++-Plattform.
{{% blocks/products/pf/agp/code-block title="Löschen Sie Anmerkungen aus ODP - C++" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So entfernen Sie Kommentare aus ODP über C++" >}}
