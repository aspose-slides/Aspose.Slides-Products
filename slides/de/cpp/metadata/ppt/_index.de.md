...
{{% blocks/products/pf/agp/code-block title="PPT integrierte Eigenschaften ändern – C++" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Benutzerdefinierte Eigenschaften zu PPT hinzufügen – C++" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So extrahieren Sie Metadaten von PPT über C++" >}}
