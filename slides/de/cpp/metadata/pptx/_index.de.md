...
{{% blocks/products/pf/agp/code-block title="PPTX integrierte Eigenschaften ändern – C++" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Benutzerdefinierte Eigenschaften zu PPTX hinzufügen – C++" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So extrahieren Sie Metadaten von PPTX über C++" >}}
