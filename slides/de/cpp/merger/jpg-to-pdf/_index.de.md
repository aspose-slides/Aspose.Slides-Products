...
url: /de/cpp/merger/jpg-to-pdf/
keywords: JPG zu PDF, JPG zu PDF zusammenführen, JPG zu PDF verbinden, PDF, JPG, C++ API, C++ Bibliothek
description: JPG mit PDF in C++ zusammenführen. Verwenden Sie die C++-Bibliotheks-API, um JPG und PDF zu kombinieren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="JPG mit PDF in C++ zusammenführen" h2="Hochgeschwindigkeits- und plattformübergreifende C++-Bibliothek zum Zusammenführen von JPG- mit PDF-Dateien unter Verwendung von C++-Code" >}}
...
Mit [**Aspose.Slides for C++**](https://products.aspose.com/slides/de/cpp/) können Sie JPG mit nur wenigen Codezeilen schnell in PDF zusammenführen
...
{{< blocks/products/pf/feature-page-section  h2="Wie man JPG mit PDF in C++ zusammenführt" >}}
