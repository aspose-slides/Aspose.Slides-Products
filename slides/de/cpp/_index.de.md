...
<p class="col-lg-10">Betten Sie Excel-Diagramme als OLE-Objekte in Folien ein</p>

</div>

<div class="col-lg-4"><em class="fa fa-print  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Verknüpfte Ole-Objekte verwalten</p>
...
<p class="col-lg-10">Kundenspezifischer Druck von Präsentationen</p>
...
<h2 class="h2title">Kontinuierliche Integration neuer Funktionen</h2>

<p>Sie sind nie auf vorhandene Funktionen beschränkt. Unsere Produktteams fügen kontinuierlich mehr und mehr Funktionen hinzu und jede neue Version bietet im Vergleich zu den älteren Versionen mehr Funktionen. Sie können auch neue Funktionsanfragen senden, wenn Sie feststellen, dass eine Ihrer gewünschten Funktionen fehlt. Hier ist die Liste mit einigen Auswahlmöglichkeiten der neuesten Funktionen.</p>

<ul>

<li>Rasterung oder Vektorisierung von Shapes ohne Text.</li>

<li>Konvertieren Sie SVG-Bilder in Formen.</li>

<li>Rufen Sie den Standardtabellenhintergrund ab.</li>

<li>Einschränken des Zugriffs auf das lokale Dateisystem beim Öffnen eines Dokuments.</li>

<li>Beim Speichern in HTML Codierungs-Meta-Tag hinzufügen.</li>

<li>Einstellung zum Entfernen von Breiten- und Höhenattributen des SVG-Tags beim Speichern als HTML.</li>

<li>Support for

<ul>

<li>Kommentarantworten, Office 365 und externe Excel-Arbeitsmappen.</li>

<li>Die Größe repräsentiert die Eigenschaft für das Blasendiagramm.</li>

<li>Ausblenden des linken Fensters mit Miniaturansichten der Folie in generierter PPT.</li>

<li>Trichterdiagramme, 2D-Kartendiagramme und Arbeitsmappenpfade für externe Datenquellen für Diagramme festlegen.</li>

<li>OpenDocument-Verschlüsselung, Morph-Übergang und Text-Highlighter-Funktion.</li>

<li>Festlegen der Transparenzeigenschaft für Schatteneffekte.</li>

<li>Legendenform für Seriendatenetikett festlegen.</li>

<li>Holen Sie sich Effekte durch Textfeldabsätze.</li>

<li>Effekt „Weiche Kanten“ (EffectFormat) für das Rendern von Formen.</li>

<li>ChartData SetRange in einer Pivot-Tabelle.</li>

</ul>

</li>

<li>Implementieren Sie das mehrseitige Tiff-Format, Metafile Format Plus Extensions (EMF+) und das Strict Open XML-Format.</li>

<li>Rendern von Kommentaren aus dem ODP-Format, die keinen Autor haben.</li>

<li>Implementieren Sie die Serialisierung mit strikter Einhaltung des Open XML-Formats.</li>
...
<h2 class="h2title">Verarbeitung von SmartArt-Formen</h2>

<p>Aspose.Slides für C++ erleichtert das Erstellen von SmartArt-Formen von Grund auf neu und bietet die Möglichkeit, auf vorhandene SmartArt-Formen zuzugreifen, sie zu bearbeiten oder von einer Folie zu entfernen. Darüber hinaus ist es auch möglich, die SmartArt-Formen zu formatieren, z. B. Stil, Farbe und Layout festzulegen.</p>
