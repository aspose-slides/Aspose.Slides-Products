---
title: JasperReports nach PowerPoint exportieren | Aspose.Folien
weight: 8320
url: /de/jasperreports/ 
description: Aspose.Slides PowerPoint API für JaspreReport zum Exportieren von Berichten aus Jasper Reports und JasperServer in PowerPoint-Formate. Erstellen und exportieren Sie Kontendiagrammbilder, Text- und Linienberichte in eine PPT-Präsentation
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Exportieren Sie JasperServer-Berichte in PowerPoint-Präsentationen" h2="PowerPoint-API zum Exportieren von JasperReports- und JasperServer-Berichten in PPT(X), PPS(X) und andere PowerPoint-Formate." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-jasperreports.svg" pfName="Aspose.Slides" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/slides/jasperreport" >}}
...
<p>
 Aspose.Slides for JasperReports ist eine PowerPoint-API für den flexiblen und benutzerfreundlichen Export von JasperReports- und JasperServer-Berichten nach PowerPoint. JasperServer verfügt nicht über die integrierte Funktion zum Exportieren von Berichten als PowerPoint-Präsentationen. Mit dieser PowerPoint-API können die JasperServer-Berichte jedoch in die Präsentationsformate PPT, PPS, PPTX und PPSX exportiert werden, ohne Microsoft PowerPoint zu verwenden.
</p>
...
{{< blocks/products/pf/carousel-item h3="Auf einen Blick" description="Eine Übersicht über Aspose.Slides für JasperReports." >}}
...
{{< blocks/products/pf/carousel-item h3="Plattformunabhängigkeit" description="Aspose.Slides PowerPoint API unterstützt J2SE, JasperReports und JasperServer." >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
...
{{< blocks/products/pf/carousel-item h3="Unterstützte Dateiformate" description="Aspose.Slides for JasperReports kann Berichte in Microsoft PowerPoint [Dateiformate](https://docs.aspose.com/slides/jasperreports/supported-file-formats/) exportieren." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Erweiterte Exportfunktionen von JasperReports zu Präsentationen</h2>

<p> </p>

<div class="col-lg-4"><em class="fa fa-file-powerpoint-o  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Erstellen Sie Kontenberichte und exportieren Sie sie in Microsoft PowerPoint-Präsentationen</p>

</div>

<div class="col-lg-4"><em class="fa fa-bar-chart   ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Erstellen Sie Diagrammberichte und exportieren Sie sie in Microsoft PowerPoint-Präsentationen</p>

</div>

<div class="col-lg-4"><em class="fa fa-pie-chart ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Erstellen Sie Diagrammberichte mit mehreren Achsen und exportieren Sie sie in Microsoft PowerPoint-Präsentationen</p>

</div>

<div class="col-lg-4"><em class="fa fa-file-text ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Erstellen Sie Bilder, Text, Linien und exportieren Sie diese Berichte in eine Microsoft PowerPoint-Präsentation</p>

</div>-->
   <h2 class="pr-ft">
    Erweiterte JasperReports PowerPoint-API-Funktionen
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Erstellen Sie Diagrammberichte mit mehreren Achsen
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Fügen Sie Bilder, Text und Zeilen zu Berichten hinzu
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-file-text ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Exportieren Sie Berichte in PowerPoint-Präsentationen
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-file-text ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Wandeln Sie SVG-Bilder in Formen um
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Unterstützung für Kommentarantworten, Office 365 und externe Excel-Arbeitsmappen
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Rasterung von Formen ohne Text
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Blenden Sie den linken Bereich mit den Miniaturansichten der Folie in der erstellten PPT aus
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-area-chart ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Trichter, 2D-Kartendiagramme und Größeneigenschaft für Blasendiagramme
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-cog ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Texthervorhebung, OpenDocument-Verschlüsselung und Formwiedergabe
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Legen Sie die Eigenschaft „Transparenz“ für Schatteneffekte und Morph-Übergänge fest
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Legen Sie das Gebietsschema in der Anwendung und die Beschriftungsform für das Seriendatenetikett fest
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Unterstützung für das Strict Open XML-Format hinzugefügt
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Holen Sie sich Effekte durch Textfeldabsätze
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     ChartData SetRange in einer Pivot-Tabelle
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Implementieren Sie die Serialisierung mit strikter Einhaltung des Open XML-Formats
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Beim Speichern in HTML Codierungs-Meta-Tag hinzufügen
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Einhaltung von FIPS-konformen Algorithmen
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Unterstützung für Diagrammberichte mit mehreren Achsen
    </h2>
    <p>
     Aspose.Slides for JasperReports unterstützt den Export komplexer Berichte mit
     <stark>
      MultipleAxisChartReport
     </strong>
     zu Microsoft PowerPoint-Präsentationen. Die Ausgabe ist genau so, wie sie bei der Anzeige über JasperViewer angezeigt wird.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Berichte in Präsentationsformate exportieren
    </h2>
    <p>
     JasperReports und JasperServer verfügen nicht über die integrierte Unterstützung für den Export von Berichten in Microsoft PowerPoint-Präsentationen. Die Integration mit Aspose.Slides für JasperReports ermöglicht Ihnen jedoch den Export Ihrer Berichte in Microsoft PowerPoint-Präsentationen (PPT, PPTX) und Microsoft PowerPoint-Diashows (PPS, PPSX).
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for JasperReports basiert auf verwaltetem Code, für den Microsoft PowerPoint nicht auf dem Computer installiert sein muss, um mit PowerPoint-Dokumenten zu arbeiten. Es ist eine perfekte Microsoft PowerPoint-Automatisierungsalternative in Bezug auf unterstützte Funktionen, Sicherheit, Stabilität, Skalierbarkeit, Geschwindigkeit und Preis.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="Warum Aspose.Slides für JasperReports?" tabId="success-stories" >}}
