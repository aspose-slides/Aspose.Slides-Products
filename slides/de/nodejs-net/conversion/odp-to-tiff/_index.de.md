---
title: Konvertieren Sie ODP in TIFF in JavaScript
url: /de/nodejs-net/conversion/odp-to-tiff/
keywords: ODP zu TIFF, Konvertieren von ODP zu TIFF, Node.js API, JavaScript-Bibliothek, ODP, TIFF
description: Konvertieren Sie ODP in TIFF in JavaScript. Verwenden Sie die Node.js-Bibliotheks-API, um ODP-Dateien in TIFF zu konvertieren
---
...
[**Aspose.Slides für Node.js über .NET**](https://products.aspose.com/slides/de/nodejs-net/) ist eine leistungsstarke Node.js-Bibliothek zum Erstellen und Bearbeiten von Präsentationsdateien. Darüber hinaus bietet es flexible Möglichkeiten zur Konvertierung von ODP in TIFF. Mit **Aspose.Slides für Node.js über .NET** kann jeder Entwickler oder jede Anwendung mit nur wenigen Codezeilen ODP-Dateien in TIFF-Dateien konvertieren.

Als moderne API zur Dokumentenverarbeitung exportiert Aspose.Slides für Node.js über .NET schnell ODP-Dateien in TIFF-Dateiformate. Mit der Aspose PowerPoint-Bibliothek können Sie ODP in TIFFs und viele andere Dateiformate konvertieren

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie ODP mit JavaScript in TIFF" %}}
Um das ODP in TIFF zu konvertieren, müssen Sie eine Präsentation aus der ODP-Datei erstellen und diese als TIFF speichern.

{{% blocks/products/pf/agp/code-block title="JavaScript-Code zum Konvertieren von ODP in TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So konvertieren Sie ODP in TIFF mit Aspose.Slides für Node.js über die .NET-API" >}}
