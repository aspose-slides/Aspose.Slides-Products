---
title: Konvertieren Sie PPTX in PPT in JavaScript
url: /de/nodejs-net/conversion/pptx-to-ppt/
keywords: PPTX zu PPT, Konvertieren von PPTX zu PPT, Node.js API, JavaScript-Bibliothek, PPTX, PPT
description: Konvertieren Sie PPTX in PPT in JavaScript. Verwenden Sie die Node.js-Bibliotheks-API, um PPTX-Dateien in PPT zu konvertieren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie PPTX in PPT in JavaScript" h2="Aspose.Slides für Node.js über .NET ist eine leistungsstarke und benutzerfreundliche Bibliothek, mit der Sie PowerPoint-Präsentationen in verschiedene Formate in JavaScript konvertieren können. Es unterstützt alle Präsentationselemente und -formate und bietet eine umfangreiche API für den Zugriff und die Änderung dieser. Außerdem können Sie Ihre Folien zur weiteren Verarbeitung oder Weitergabe in verschiedene Formate exportieren." >}}

{{% blocks/products/pf/feature-page-section h2="Konvertieren Sie PPTX in PPT in Node.js" %}}

[**Aspose.Slides für Node.js über .NET**](https://products.aspose.com/slides/de/nodejs-net/) ist eine leistungsstarke Node.js-Bibliothek zum Erstellen und Bearbeiten von Präsentationsdateien. Darüber hinaus bietet es flexible Möglichkeiten zur Konvertierung von PPTX in PPT. Mit **Aspose.Slides für Node.js über .NET** kann jeder Entwickler oder jede Anwendung mit nur wenigen Codezeilen PPTX-Dateien in PPT-Dateien konvertieren.

Als moderne API zur Dokumentenverarbeitung exportiert Aspose.Slides für Node.js über .NET schnell PPTX-Dateien in PPT-Dateiformate. Mit der Aspose PowerPoint-Bibliothek können Sie PPTX in PPTs und viele andere Dateiformate konvertieren

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie PPTX mit JavaScript in PPT" %}}
Um das PPTX in PPT zu konvertieren, müssen Sie eine Präsentation aus der PPTX-Datei erstellen und diese als PPT speichern.

{{% blocks/products/pf/agp/code-block title="JavaScript-Code zum Konvertieren von PPTX in PPT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="So konvertieren Sie PPTX in PPT mit Aspose.Slides für Node.js über die .NET-API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Um PPTX in PPT mit Aspose.Slides für Node.js über .NET zu konvertieren, müssen Sie das Paket in Ihre JavaScript-Datei importieren und eine Instanz der Presentation-Klasse erstellen. Die Presentation-Klasse stellt ein PowerPoint-Dokument dar und stellt Methoden für den Zugriff und die Bearbeitung seiner Elemente bereit." >}}
