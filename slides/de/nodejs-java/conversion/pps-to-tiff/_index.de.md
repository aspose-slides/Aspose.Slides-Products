---
title: Konvertieren Sie PPS in TIFF in Node.js
url: /de/nodejs-java/conversion/pps-to-tiff/
keywords: PPS zu TIFF, Konvertieren von PPS zu TIFF, Node.js API, Node.js-Bibliothek, PPS, TIFF
description: Konvertieren Sie PPS in TIFF in Node.js. Verwenden Sie die Node.js-Bibliotheks-API, um PPS-Dateien in TIFFs zu konvertieren
---
...
[**Aspose.Slides für Node.js über Java**](https://products.aspose.com/slides/de/nodejs-java/) ist eine leistungsstarke Node.js-Bibliothek zum Erstellen und Bearbeiten von Präsentationsdateien. Darüber hinaus bietet es flexible Möglichkeiten zur Konvertierung von PPS in TIFF. Mit **Aspose.Slides für Node.js über Java** kann jeder Entwickler oder jede Anwendung mit nur wenigen Codezeilen PPS-Dateien in TIFF-Dateien konvertieren.

Als moderne API zur Dokumentenverarbeitung exportiert Aspose.Slides für Node.js schnell PPS-Dateien in TIFF-Dateiformate. Mit der Aspose PowerPoint-Bibliothek können Sie PPS in TIFFs und viele andere Dateiformate konvertieren

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie PPS in TIFF mit Node.js" %}}
Um das PPS in TIFF zu konvertieren, müssen Sie eine Präsentation aus der PPS-Datei erstellen und diese als TIFF speichern.

{{% blocks/products/pf/agp/code-block title="Node.js-Code zum Konvertieren von PPS in TIFF" offSpacer="true" %}}
