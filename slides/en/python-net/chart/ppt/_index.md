...
{{% blocks/products/pf/agp/code-block title="Create a Pie Chart in a PPT Presentation with Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Create and Customize a Pie Chart in PPT with Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to add a pie chart to a PPT presentation." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `save` with `SaveFormat.PPT` to write the presentation in PPT format.
{{% /blocks/products/pf/agp/step-autogen %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Create Charts in PPT Online" sectionDescription="Try the online chart creation demos." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/slides/python-net/chart/pptx/" name="PPTX" >}}
