...
title: Redact Text in PowerPoint and OpenDocument Presentations with Python
url: /python-net/redaction/
description: Find and replace sensitive text in PowerPoint and OpenDocument presentations with Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Redact Text in PowerPoint and OpenDocument Presentations with Python" h2="Build Python applications that find and replace sensitive text in presentations with Aspose.Slides." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" >}}

{{< blocks/products/pf/main-container >}}

{{< blocks/products/pf/product-card-row title="Presentation Redaction Code Samples" >}}
...
Learn how to find and replace sensitive text in an ODP presentation with Aspose.Slides for Python via .NET.
...
Learn how to find and replace sensitive text in a PPT presentation with Aspose.Slides for Python via .NET.
{{< /blocks/products/pf/product >}}
...
Learn how to find and replace sensitive text in a PPTX presentation with Aspose.Slides for Python via .NET.
{{< /blocks/products/pf/product >}}
