---
title: Merge PDF Files and Save as TIFF Using Python
url: /python-net/merge/pdf-to-tiff/
keywords: Merge PDF to TIFF, Join PDF to TIFF, Combine PDF to TIFF, PowerPoint, Presentation, TIFF, Python, Aspose
description: Merge multiple PDF files in Python and save the combined pages as a single multipage TIFF image.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PDF Files and Save as TIFF in Python" h2="Import pages from multiple PDF files and save the combined content as a multipage TIFF image with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PDF to TIFF in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you combine PDF files by importing their pages into a `Presentation`. `SlideCollection.add_from_pdf` converts each PDF page into a slide and appends it to the presentation. After importing all source files, call `Presentation.save` with `SaveFormat.TIFF` to save the combined content as a single multipage TIFF image.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PDF Files to TIFF Using Python" %}}
Create a presentation without its default blank slide, import the source PDF files in the required order, and save the combined slides as a single multipage TIFF image.

{{% blocks/products/pf/agp/code-block title="Python code for merging PDF files into a single multipage TIFF image" offSpacer="true" %}}
...
with slides.Presentation() as presentation:
    ...
    presentation.save("merged.tiff", slides.export.SaveFormat.TIFF)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PDF Files and Save as TIFF with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PDF files and save the combined pages as a single multipage TIFF image." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.TIFF` to save the combined presentation as a single multipage TIFF file.
{{% /blocks/products/pf/agp/step-autogen %}}
