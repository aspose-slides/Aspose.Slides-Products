...
title: Merge PPSM Files into PPSX Using Python
...
description: Merge multiple PPSM slide shows in Python and save the result as a single PPSX file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPSM Files into PPSX in Python" h2="Combine PowerPoint Macro-Enabled Show files and save the merged slides as a PPSX slide show with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPSM to PPSX in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge PowerPoint Macro-Enabled Show (PPSM) files by cloning slides from one `Presentation` into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.PPSX` to save the merged slides as a PowerPoint Show (PPSX) file. The PPSX format does not store VBA macros, so this workflow merges slide content rather than VBA projects.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPSM Files into PPSX Using Python" %}}
Open the destination and source PPSM slide shows, append a clone of each source slide, and save the merged slides as a PPSX file.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPSM files into a single PPSX slide show" offSpacer="true" %}}
...
with slides.Presentation("destination.ppsm") as destination_presentation:
    ...
    destination_presentation.save("merged-slide-show.ppsx", slides.export.SaveFormat.PPSX)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PPSM Files into PPSX with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPSM files and save the result as a single PPSX slide show." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.PPSX` to save the merged slides as a single PPSX slide show.
{{% /blocks/products/pf/agp/step-autogen %}}
