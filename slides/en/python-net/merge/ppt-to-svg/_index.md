...
title: Merge PPT Files and Export to SVG Using Python
url: /python-net/merge/ppt-to-svg/
keywords: Merge PPT to SVG, Join PPT to SVG, Combine PPT to SVG, PowerPoint, Presentation, SVG, Python, Aspose
description: Merge multiple PPT presentations in Python and export each slide as a separate SVG image.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPT Files and Export to SVG in Python" h2="Combine PowerPoint presentations and render the merged slides as SVG images with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPT to SVG in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge PowerPoint 97–2003 Presentation (PPT) files by cloning slides from one presentation into another. After combining the slides with `SlideCollection.add_clone`, call `Slide.write_as_svg` to export each merged slide as a separate SVG image.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPT files to SVG using Python" %}}
Open the destination and source PPT presentations, append a clone of each source slide, and render every slide in the merged presentation as a separate SVG image.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPT files and exporting the slides as SVG images" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPT files and export to SVG with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPT files and export the merged slides as SVG images." >}}
