...
description: Merge multiple PPTM presentations in Python and save the combined slides as a single PDF document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPTM files and export to PDF in Python" h2="Combine macro-enabled PowerPoint presentations and save the merged slides as a PDF document with Aspose.Slides for Python via .NET. Microsoft PowerPoint and OpenOffice are not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPTM to PDF in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) lets you merge PPTM presentations by cloning slides from a source `Presentation` into a destination `Presentation`. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.PDF` to create a single PDF document.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPTM files to PDF using Python" %}}
Clone each source slide with `SlideCollection.add_clone`, then call `Presentation.save` with `SaveFormat.PDF`.

{{% blocks/products/pf/agp/code-block title="Python code to merge PPTM files into a single PDF document" offSpacer="true" %}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPTM files and save the result as a single PDF document in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Save the merged presentation with `Presentation.save` and `SaveFormat.PDF`.
{{% /blocks/products/pf/agp/step-autogen %}}
