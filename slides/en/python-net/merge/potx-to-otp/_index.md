---
title: Merge POTX Files and Save as OTP Using Python
url: /python-net/merge/potx-to-otp/
keywords: Merge POTX to OTP, Join POTX to OTP, Combine POTX to OTP, PowerPoint, Presentation, OTP, Python, Aspose
description: Merge multiple POTX presentation files in Python and save the combined presentation as an OTP file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POTX Files and Save as OTP in Python" h2="Combine PowerPoint template files and save the merged presentation as an OpenDocument Presentation Template with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge POTX to OTP in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge POTX Files to OTP Using Python" %}}
Open the destination and source POTX files, append a clone of each source slide, and save the merged presentation as an OTP file.

{{% blocks/products/pf/agp/code-block title="Python code for merging POTX files and saving the result as OTP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POTX Files and Save as OTP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POTX files and save the combined presentation as an OTP file." >}}
