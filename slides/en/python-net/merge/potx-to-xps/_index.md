...
description: Merge multiple POTX presentation templates in Python and export the combined presentation as a single XPS document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POTX Files and Export to XPS in Python" h2="Combine PowerPoint Open XML template files and export the merged presentation as XPS with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge POTX to XPS in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge POTX Files to XPS Using Python" %}}
Open the destination and source POTX files, append a clone of each source slide, and export the merged presentation as an XPS document.

{{% blocks/products/pf/agp/code-block title="Python code for merging POTX files and exporting the result to XPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POTX Files and Export to XPS with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POTX files and export the combined presentation as a single XPS document." >}}
