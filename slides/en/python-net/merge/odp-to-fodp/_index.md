---
title: Merge ODP Files and Save as FODP Using Python
url: /python-net/merge/odp-to-fodp/
keywords: Merge ODP to FODP, Join ODP to FODP, Combine ODP to FODP, PowerPoint, Presentation, FODP, Python, Aspose
description: Merge multiple ODP presentations in Python and save the combined result as an FODP file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge ODP Files and Save as FODP in Python" h2="Combine OpenDocument Presentation files and save the result as FODP with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge ODP to FODP in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge OpenDocument Presentation (ODP) files by cloning slides from a source presentation into a destination presentation. `SlideCollection.add_clone` appends a copy of each source slide, including its content and associated formatting. You can then save the combined presentation in Flat OpenDocument Presentation format with `SaveFormat.FODP`.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge ODP Files to FODP Using Python" %}}
Open the destination and source ODP presentations, append a clone of each source slide, and save the combined presentation as an FODP file.

{{% blocks/products/pf/agp/code-block title="Python code for merging multiple ODP files into one FODP presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge ODP Files and Save as FODP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two ODP files and save the result as a single FODP presentation." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.FODP` to write the merged presentation.
{{% /blocks/products/pf/agp/step-autogen %}}
