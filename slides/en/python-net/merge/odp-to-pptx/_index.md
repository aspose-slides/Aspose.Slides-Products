---
title: Merge ODP Files into PPTX Using Python
url: /python-net/merge/odp-to-pptx/
keywords: Merge ODP to PPTX, Join ODP to PPTX, Combine ODP to PPTX, PowerPoint, Presentation, PPTX, Python, Aspose
description: Merge multiple ODP presentations in Python and save the result as a single PPTX file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge ODP Files into PPTX in Python" h2="Combine OpenDocument Presentation files and save the merged slides as a PPTX presentation with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge ODP to PPTX in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge ODP files to PPTX using Python" %}}
Open the destination and source ODP presentations, append a clone of each source slide, and save the merged presentation as a PPTX file.

{{% blocks/products/pf/agp/code-block title="Python code for merging ODP files into a single PPTX presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge ODP files into PPTX with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two ODP files and save the result as a single PPTX presentation." >}}
