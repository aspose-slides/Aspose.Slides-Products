...
title: Merge PDF Files into XPS Using Python
url: /python-net/merge/pdf-to-xps/
keywords: Merge PDF to XPS, Join PDF to XPS, Combine PDF to XPS, PowerPoint, Presentation, XPS, Python, Aspose
description: Merge multiple PDF files in Python and export their pages as a single XPS document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PDF Files into XPS in Python" h2="Combine PDF files and export their pages as a single XPS document with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PDF to XPS in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) can import the pages from multiple PDF files into one `Presentation`. Call `SlideCollection.add_from_pdf` for each source file, then use `Presentation.save` with `SaveFormat.XPS` to export all imported pages as a single XPS document.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PDF Files into XPS Using Python" %}}
Create an empty `Presentation`, import the pages from each PDF file, and export the result as an XPS document.

{{% blocks/products/pf/agp/code-block title="Python code for merging PDF files into a single XPS document" offSpacer="true" %}}
...
with slides.Presentation() as presentation:
    ...
    presentation.save("merged.xps", slides.export.SaveFormat.XPS)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PDF Files into XPS with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PDF files and export their pages as a single XPS document." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Create a `Presentation` and remove its default slide with `SlideCollection.remove_at`.
{{% /blocks/products/pf/agp/step-autogen %}}

{{% blocks/products/pf/agp/step-autogen %}}
Call [`SlideCollection.add_from_pdf`](https://reference.aspose.com/slides/python-net/aspose.slides/slidecollection/add_from_pdf/) for each source PDF file.
{{% /blocks/products/pf/agp/step-autogen %}}

{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.XPS` to export the imported pages as a single XPS document.
{{% /blocks/products/pf/agp/step-autogen %}}
...
{{< blocks/products/pf/agp/other-supported-section title="Export PDF to Other Supported Formats" subTitle="You can also combine PDF files and export their pages to other supported formats." >}}
