...
title: Merge PPT Files to POTM Using Python
url: /python-net/merge/ppt-to-potm/
keywords: Merge PPT to POTM, Join PPT to POTM, Combine PPT to POTM, PowerPoint, Presentation, POTM, Python, Aspose
description: Merge multiple PPT files and save the combined presentation as a POTM file in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPT files and save as POTM in Python" h2="Combine PPT presentations and export the result to POTM with Aspose.Slides for Python via .NET. Microsoft PowerPoint and OpenOffice are not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPT to POTM in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) lets you merge PPT presentations by cloning slides from a source `Presentation` into a destination `Presentation`. The cloned slides retain their layouts, shapes, styles, text, formatting, comments, and animations. Save the destination presentation with `SaveFormat.POTM` to create a single POTM file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPT files to POTM using Python" %}}
Clone each source slide with `add_clone`, then call `save` with `SaveFormat.POTM`. If the source and destination presentations use different slide sizes, resize the source presentation before cloning its slides.

{{% blocks/products/pf/agp/code-block title="Python code to merge PPT files into a POTM file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPT to POTM using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPT files and save the result as a POTM file in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Save the merged presentation by calling `Presentation.save` with `SaveFormat.POTM`.
