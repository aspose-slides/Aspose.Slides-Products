...
description: Merge multiple PPSX files and save the combined presentation as FODP in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPSX files to FODP in Python" h2="Combine PPSX slide shows and save the merged presentation as FODP with Aspose.Slides for Python via .NET. Microsoft PowerPoint and OpenOffice are not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPSX to FODP in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge PPSX files to FODP using Python" %}}
Clone each source slide with `add_clone`, then call `save` with `SaveFormat.FODP`.

{{% blocks/products/pf/agp/code-block title="Python code to merge PPSX files into one FODP presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPSX to FODP using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPSX files and save the result as FODP in Python." >}}
