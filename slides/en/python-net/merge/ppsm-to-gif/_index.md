...
title: Merge PPSM Files and Export to GIF Using Python
...
description: Merge multiple PPSM presentations in Python and export the combined slides as an animated GIF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPSM Files and Export to GIF in Python" h2="Combine PowerPoint Macro-Enabled Slide Show files and export the merged slides as an animated GIF with Aspose.Slides for Python via .NET. Microsoft PowerPoint is not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPSM to GIF in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) lets you merge PowerPoint Macro-Enabled Slide Show (PPSM) files by cloning slides from one `Presentation` into another. The `SlideCollection.add_clone` method preserves the content and formatting of each cloned slide. After combining the slides, call `Presentation.save` with `SaveFormat.GIF` to export the merged presentation as an animated GIF.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPSM Files to GIF Using Python" %}}
Open the destination and source PPSM files, append a clone of each source slide, and save the merged presentation as an animated GIF.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPSM files into an animated GIF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PPSM Files and Export to GIF with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPSM files and export the result as an animated GIF." >}}
