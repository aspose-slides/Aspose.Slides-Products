---
title: Merge PPSM Files and Export to PNG Using Python
...
description: Merge multiple PPSM presentation files in Python and export each slide as a PNG image.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPSM Files and Export to PNG in Python" h2="Combine macro-enabled PowerPoint Slide Show files and render the merged slides as PNG images with a cross-platform Python API" >}}
...
Open the destination and source PPSM files, append a clone of each source slide, and render every slide in the merged presentation as a separate PNG image.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPSM files and exporting the slides as PNG images" offSpacer="true" %}}
...
with slides.Presentation("destination.ppsm") as destination_presentation:
    ...
    for merged_slide in destination_presentation.slides:
        file_path = f"merged_slide_{merged_slide.slide_number}.png"
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PPSM Files and Export to PNG with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPSM files and export the merged slides as PNG images." >}}
