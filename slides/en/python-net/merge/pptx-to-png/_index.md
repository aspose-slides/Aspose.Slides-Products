---
title: Merge PPTX Files to PNG in Python
url: /python-net/merge/pptx-to-png/
keywords: Merge PPTX to PNG, Join PPTX to PNG, Combine PPTX to PNG, PowerPoint, Presentation, PNG, Python, Aspose
description: Merge multiple PPTX files and export the combined slides as PNG images using Python and Aspose.Slides.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPTX Files and Export Slides to PNG in Python" h2="Combine PowerPoint presentations and render each merged slide as a PNG image with a fast, cross-platform Python API. Microsoft PowerPoint is not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPTX to PNG in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) is a Python library for creating, editing, and converting presentation files. To merge `PPTX` presentations, clone each slide from a source `Presentation` into a destination presentation by calling [`add_clone`](https://reference.aspose.com/slides/python-net/aspose.slides/slidecollection/add_clone/) on its `slides` collection. Cloned slides retain their shapes, styles, text, formatting, comments, and animations. The combined slides can then be rendered as separate `PNG` images.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPTX files to PNG using Python" %}}
Clone each slide from the source presentation into the destination presentation, then render every slide in the combined presentation as a separate `PNG` image.

{{% blocks/products/pf/agp/code-block title="Python code to merge multiple PPTX files and export the slides as PNG images" offSpacer="true" %}}
...
with slides.Presentation("presentation1.pptx") as destination_presentation:
    ...
    for slide in destination_presentation.slides:
        output_file_path = f"slide_{slide.slide_number}.png"
        with slide.get_image(2, 2) as slide_image:
            slide_image.save(output_file_path, slides.ImageFormat.PNG)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPTX to PNG using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPTX files and export the combined slides as PNG images in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Render each destination `Slide` by calling `get_image`, then call `IImage.save` to create a separate `PNG` file for every slide.
{{% /blocks/products/pf/agp/step-autogen %}}
