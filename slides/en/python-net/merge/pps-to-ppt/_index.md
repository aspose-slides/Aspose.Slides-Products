...
title: Merge PPS Files into PPT Using Python
url: /python-net/merge/pps-to-ppt/
keywords: Merge PPS to PPT, Join PPS to PPT, Combine PPS to PPT, PowerPoint, Presentation, PPT, Python, Aspose
description: Merge multiple PPS presentations in Python and save the result as a single PPT file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPS Files into PPT in Python" h2="Combine PowerPoint Slide Show files and save the merged slides as a PPT presentation with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPS to PPT in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge PowerPoint Slide Show (PPS) files by cloning slides from one presentation into another. After combining the slides with `ISlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.PPT` to save the merged slides as a single PPT presentation.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPS files to PPT using Python" %}}
Open the destination and source PPS presentations, append a clone of each source slide, and save the merged presentation as a PPT file.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPS files into a single PPT presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPS files into PPT with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPS files and save the result as a single PPT presentation." >}}
