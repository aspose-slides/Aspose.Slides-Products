---
title: Merge PPSM Files to HTML with Python
url: /python-net/merge/ppsm-to-html/
keywords: Merge PPSM to HTML, Join PPSM to HTML, Combine PPSM to HTML, PowerPoint, Presentation, HTML, Python, Aspose
description: Merge multiple PPSM presentations and export the combined slides to an HTML5 file in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPSM Files and Export to HTML in Python" h2="Combine PowerPoint Macro-Enabled Slide Show files and export the merged slides to HTML5 with Aspose.Slides for Python via .NET. Microsoft PowerPoint is not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPSM to HTML in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) lets you combine multiple PPSM presentations by cloning slides from one `Presentation` into another. The `SlideCollection.add_clone` method preserves the content and formatting of each cloned slide. After merging the slides, call `Presentation.save` with `SaveFormat.HTML5` to export the destination `Presentation` as an HTML5 document.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPSM Files to HTML Using Python" %}}
Load one PPSM file as the destination presentation, clone the slides from another PPSM file into it, and export the merged result to HTML5.

{{% blocks/products/pf/agp/code-block title="Python code to merge PPSM files and export to HTML" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PPSM Files and Export to HTML with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPSM files and export the result to HTML in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.HTML5` to export the merged presentation as an HTML5 document.
{{% /blocks/products/pf/agp/step-autogen %}}
