...
title: Merge ODP Files and Export to GIF Using Python
url: /python-net/merge/odp-to-gif/
keywords: Merge ODP to GIF, Join ODP to GIF, Combine ODP to GIF, PowerPoint, Presentation, GIF, Python, Aspose
description: Merge multiple ODP presentations in Python and export the result as an animated GIF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge ODP Files and Export to GIF in Python" h2="Combine OpenDocument Presentation files and export the merged slides as an animated GIF with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge ODP to GIF in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge OpenDocument Presentation (ODP) files by cloning slides from one presentation into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.GIF` to export the merged slides as animation frames in a single GIF file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge ODP Files to GIF Using Python" %}}
Open the destination and source ODP presentations, append a clone of each source slide, and save the merged presentation as an animated GIF.

{{% blocks/products/pf/agp/code-block title="Python code for merging ODP files into an animated GIF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge ODP Files and Export to GIF with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two ODP files and export the result as an animated GIF." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.GIF` to write the merged slides as animation frames in a single GIF file.
{{% /blocks/products/pf/agp/step-autogen %}}
