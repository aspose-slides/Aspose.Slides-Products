...
title: Merge PPSX Files to HTML Using Python
url: /python-net/merge/ppsx-to-html/
keywords: Merge PPSX to HTML, Join PPSX to HTML, Combine PPSX to HTML, PowerPoint, Presentation, HTML, Python, Aspose
description: Merge multiple PPSX files and export the combined presentation as an HTML5 document in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPSX files and export to HTML in Python" h2="Combine PPSX slide shows and export the merged presentation as an HTML5 document with Aspose.Slides for Python via .NET. Microsoft PowerPoint and OpenOffice are not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPSX to HTML in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) lets you merge PPSX slide shows by cloning slides from a source `Presentation` into a destination `Presentation`. The cloned slides retain their layouts, shapes, styles, text, formatting, comments, and animations. Save the destination presentation with `SaveFormat.HTML5` to create an HTML5 document.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPSX files to HTML using Python" %}}
Clone each source slide with `add_clone`, then call `save` with `SaveFormat.HTML5`.

{{% blocks/products/pf/agp/code-block title="Python code to merge PPSX files into an HTML5 document" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPSX to HTML using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPSX files and export the result as an HTML5 document in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Save the merged presentation as an HTML5 document by using `SaveFormat.HTML5`.
{{% /blocks/products/pf/agp/step-autogen %}}
