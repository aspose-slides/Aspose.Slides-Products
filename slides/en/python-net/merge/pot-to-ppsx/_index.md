---
title: Merge POT Files to PPSX with Python
url: /python-net/merge/pot-to-ppsx/
keywords: Merge POT to PPSX, Join POT to PPSX, Combine POT to PPSX, PowerPoint, Presentation, PPSX, Python, Aspose
description: Merge multiple POT files in Python and save the combined presentation as a PPSX file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POT Files to PPSX in Python" h2="Combine POT presentations and save the result as PPSX with Aspose.Slides for Python via .NET—no Microsoft PowerPoint or OpenOffice installation required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge POT to PPSX in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge POT files to PPSX using Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Python code to merge multiple POT files into one PPSX file" offSpacer="true" %}}
...
with slides.Presentation("first.pot") as destination_presentation:
    ...
    destination_presentation.save("merged.ppsx", slides.export.SaveFormat.PPSX)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POT Files to PPSX with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POT files and save the result as PPSX in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `save` with `SaveFormat.PPSX` to write the merged presentation to a PPSX file.
{{% /blocks/products/pf/agp/step-autogen %}}
