...
description: Merge multiple PPS presentations and save the combined slides as an OTP file in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPS files and save as OTP in Python" h2="Combine PPS presentations and save the merged slides as an OpenDocument Presentation Template with Aspose.Slides for Python via .NET. Microsoft PowerPoint is not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPS to OTP in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) lets you combine multiple PPS presentations by cloning slides from one presentation into another. The `SlideCollection.add_clone` method preserves the content and formatting of each cloned slide, including shapes, text, styles, comments, and animations. After merging the slides, you can save the destination `Presentation` as an OTP file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPS files to OTP using Python" %}}
Load one PPS file as the destination presentation, clone the slides from the other PPS file into it, and save the merged result in OTP format.

{{% blocks/products/pf/agp/code-block title="Python code to merge PPS files and save as OTP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPS files and save as OTP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPS files and save the result as OTP in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.OTP` to save the merged presentation as an OTP file.
{{% /blocks/products/pf/agp/step-autogen %}}
