...
{{% blocks/products/pf/agp/code-block title="Python code for merge multiple PPTX into single GIF file" offSpacer="true" %}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to merge two PPTX files and save result as GIF in Python." >}}
