...
description: Merge multiple PPTX files and export the combined presentation to GIF in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPTX Files and Export Them to GIF in Python" h2="Build cross-platform Python applications that merge, inspect, create, and convert Microsoft PowerPoint and OpenDocument presentations without installing Microsoft PowerPoint or OpenOffice." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPTX to GIF in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge PPTX files to GIF using Python" %}}
Open the destination and source presentations, clone each source slide into the destination presentation, and save the merged result as an animated GIF.

{{% blocks/products/pf/agp/code-block title="Python code to merge multiple PPTX files into one GIF" offSpacer="true" %}}
...
with slides.Presentation("presentation1.pptx") as destination_presentation:
    ...
    destination_presentation.save("merged.gif", slides.export.SaveFormat.GIF)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPTX to GIF using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPTX files and export the result to GIF in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `save` with `SaveFormat.GIF` to export the merged presentation as one animated GIF.
{{% /blocks/products/pf/agp/step-autogen %}}
