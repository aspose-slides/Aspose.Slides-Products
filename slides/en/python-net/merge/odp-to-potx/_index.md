...
title: Merge ODP Files and Save as POTX Using Python
url: /python-net/merge/odp-to-potx/
keywords: Merge ODP to POTX, Join ODP to POTX, Combine ODP to POTX, PowerPoint, Presentation, POTX, Python, Aspose
description: Merge multiple ODP presentations in Python and save the result as a single POTX file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge ODP Files and Save as POTX in Python" h2="Combine OpenDocument Presentation files and save the merged presentation as POTX with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge ODP to POTX in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge ODP Files to POTX Using Python" %}}
Open the destination and source ODP presentations, append a clone of each source slide, and save the merged presentation as a single POTX file.

{{% blocks/products/pf/agp/code-block title="Python code for merging ODP files into a single POTX presentation template" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge ODP Files and Save as POTX with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two ODP files and save the result as a single POTX presentation template." >}}
