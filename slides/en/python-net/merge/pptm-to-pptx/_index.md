---
title: Merge PPTM Files into PPTX Using Python
url: /python-net/merge/pptm-to-pptx/
keywords: Merge PPTM to PPTX, Join PPTM to PPTX, Combine PPTM to PPTX, PowerPoint, Presentation, PPTX, Python, Aspose
description: Merge multiple PPTM presentations in Python and save the result as a single PPTX file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPTM Files into PPTX in Python" h2="Combine macro-enabled PowerPoint presentations and save the merged slides as a PPTX presentation with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPTM to PPTX in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge macro-enabled PowerPoint (PPTM) presentations by cloning slides from one presentation into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.PPTX` to save the merged slides as a single PowerPoint Open XML presentation.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPTM files to PPTX using Python" %}}
Open the destination and source PPTM presentations, append a clone of each source slide, and save the merged presentation as a PPTX file.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPTM files into a single PPTX presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPTM files into PPTX with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPTM files and save the result as a single PPTX presentation." >}}
