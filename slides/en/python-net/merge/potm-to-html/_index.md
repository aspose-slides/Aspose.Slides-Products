---
title: Merge POTM Files and Export to HTML Using Python
url: /python-net/merge/potm-to-html/
keywords: Merge POTM to HTML, Join POTM to HTML, Combine POTM to HTML, PowerPoint, Presentation, HTML, Python, Aspose
description: Merge multiple POTM presentation files in Python and export the result as an HTML5 document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POTM Files and Export to HTML in Python" h2="Combine macro-enabled PowerPoint template files and export the merged slides as an HTML5 document with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge POTM to HTML in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge POTM Files to HTML Using Python" %}}
Open the destination and source POTM files, append a clone of each source slide, and save the merged presentation as an HTML5 document.

{{% blocks/products/pf/agp/code-block title="Python code for merging POTM files into an HTML5 document" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POTM Files and Export to HTML with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POTM files and export the result as an HTML5 document." >}}
