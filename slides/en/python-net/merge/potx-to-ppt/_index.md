---
title: Merge POTX Files to PPT with Python
url: /python-net/merge/potx-to-ppt/
keywords: Merge POTX to PPT, Join POTX to PPT, Combine POTX to PPT, PowerPoint, Presentation, PPT, Python, Aspose
description: Merge multiple POTX files in Python and save the combined presentation as a PPT file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POTX Files to PPT in Python" h2="Combine PowerPoint template files and save the merged presentation as PPT with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge POTX to PPT in Python" %}}

[Aspose.Slides for Python via .NET](/slides/python-net/) lets you merge Microsoft PowerPoint Open XML Presentation Template (POTX) files by cloning slides from a source `Presentation` into a destination `Presentation`. The `SlideCollection.add_clone` method appends a copy of each slide, including its content and formatting. Then call `Presentation.save` with `SaveFormat.PPT` to write the combined presentation as a legacy PowerPoint Presentation (PPT) file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge POTX Files to PPT Using Python" %}}
Open the destination and source POTX files, append a clone of each source slide, and save the merged presentation as a single PPT file.

{{% blocks/products/pf/agp/code-block title="Python code for merging POTX files into a single PPT presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POTX Files to PPT with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POTX files and save the result as a single PPT presentation." >}}
