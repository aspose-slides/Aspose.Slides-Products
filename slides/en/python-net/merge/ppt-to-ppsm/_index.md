---
title: Merge PPT Files to PPSM Using Python
url: /python-net/merge/ppt-to-ppsm/
keywords: Merge PPT to PPSM, Join PPT to PPSM, Combine PPT to PPSM, PowerPoint, Presentation, PPSM, Python, Aspose
description: Merge multiple PPT files and save the combined presentation as a PPSM file in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPT files and save as PPSM in Python" h2="Combine PPT presentations and export the result to PPSM with Aspose.Slides for Python via .NET. Microsoft PowerPoint and OpenOffice are not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPT to PPSM in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) lets you merge PPT presentations by cloning slides from a source `Presentation` into a destination `Presentation`. The cloned slides retain their layouts, shapes, styles, text, formatting, comments, and animations. Save the destination presentation with `SaveFormat.PPSM` to create a single PPSM file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPT files to PPSM using Python" %}}
Clone each source slide with `add_clone`, then call `save` with `SaveFormat.PPSM`. If the source and destination presentations use different slide sizes, resize the source presentation before cloning its slides.

{{% blocks/products/pf/agp/code-block title="Python code to merge PPT files into a PPSM file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPT to PPSM using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPT files and save the result as a PPSM file in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Save the merged presentation by calling `Presentation.save` with `SaveFormat.PPSM`.
