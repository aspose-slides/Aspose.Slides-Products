---
title: Merge POT Files and Export Slides to SVG Using Python
url: /python-net/merge/pot-to-svg/
keywords: Merge POT to SVG, Join POT to SVG, Combine POT to SVG, PowerPoint, Presentation, SVG, Python, Aspose
description: Merge multiple POT presentation templates in Python and export the combined slides to SVG files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POT Files and Export Slides to SVG in Python" h2="Combine PowerPoint template files and export each merged slide to SVG with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge POT to SVG in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge Microsoft PowerPoint 97–2003 Template (POT) files by cloning slides from a source `Presentation` into a destination `Presentation`. Append each source slide with `SlideCollection.add_clone`, then call `Slide.write_as_svg` to export every slide in the combined presentation to a separate SVG file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge POT Files and Export Slides to SVG Using Python" %}}
Open the destination and source POT files, append a clone of each source slide, and export every slide in the merged presentation as a separate SVG file.

{{% blocks/products/pf/agp/code-block title="Python code for merging POT files and exporting the slides to SVG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POT Files and Export Slides to SVG with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POT files and export the combined slides to SVG." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Iterate through the merged slides and call `Slide.write_as_svg` to write each slide to a separate SVG file.
{{% /blocks/products/pf/agp/step-autogen %}}
