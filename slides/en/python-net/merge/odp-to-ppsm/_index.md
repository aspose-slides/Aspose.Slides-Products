...
title: Merge ODP Files into PPSM Using Python
url: /python-net/merge/odp-to-ppsm/
keywords: Merge ODP to PPSM, Join ODP to PPSM, Combine ODP to PPSM, PowerPoint, Presentation, PPSM, Python, Aspose
description: Merge multiple ODP presentations in Python and save the result as a single PPSM file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge ODP Files into PPSM in Python" h2="Combine OpenDocument Presentation files and save the merged slides as a PPSM slide show with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge ODP to PPSM in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge OpenDocument Presentation (ODP) files by cloning slides from one presentation into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.PPSM` to save the merged slides as a single macro-enabled PowerPoint slide show.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge ODP files to PPSM using Python" %}}
Open the destination and source ODP presentations, append a clone of each source slide, and save the merged presentation as a PPSM file.

{{% blocks/products/pf/agp/code-block title="Python code for merging ODP files into a single PPSM presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge ODP files into PPSM with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two ODP files and save the result as a single PPSM presentation." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.PPSM` to save the merged slides as a single PPSM presentation.
{{% /blocks/products/pf/agp/step-autogen %}}
