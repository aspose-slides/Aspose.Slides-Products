...
title: Merge PPT Files and Export to XPS Using Python
url: /python-net/merge/ppt-to-xps/
keywords: Merge PPT to XPS, Join PPT to XPS, Combine PPT to XPS, PowerPoint, Presentation, XPS, Python, Aspose
description: Merge multiple PPT presentations in Python and export the result as a single XPS document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPT Files and Export to XPS in Python" h2="Combine PowerPoint presentations and export the merged slides as an XPS document with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPT to XPS in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge PPT files to XPS using Python" %}}
Open the destination and source PPT presentations, append a clone of each source slide, and export the merged presentation as an XPS document.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPT files into a single XPS document" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPT files and export to XPS with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPT files and export the result as a single XPS document." >}}
