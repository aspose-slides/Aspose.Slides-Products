---
title: Merge PPTX Files to PPS in Python
url: /python-net/merge/pptx-to-pps/
keywords: Merge PPTX to PPS, Join PPTX to PPS, Combine PPTX to PPS, PowerPoint, Presentation, PPS, Python, Aspose
description: Merge multiple PPTX files into one PPS file using Python and Aspose.Slides.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPTX Files into PPS in Python" h2="Combine PowerPoint presentations and save the result as a PPS slide show with a fast, cross-platform Python API. Microsoft PowerPoint is not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPTX to PPS in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge PPTX files to PPS using Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Python code to merge multiple PPTX files into one PPS file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPTX to PPS using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPTX files and save the result as PPS in Python." >}}
