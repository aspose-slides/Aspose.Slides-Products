...
title: Merge POTM Files and Export to ODP Using Python
...
description: Merge multiple POTM presentation files in Python and export the result as an ODP document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POTM Files and Export to ODP in Python" h2="Combine macro-enabled PowerPoint files and export the merged presentation as an OpenDocument Presentation with a cross-platform Python API" >}}
...
Open the destination and source POTM files, append a clone of each source slide, and save the merged presentation as an ODP document.

{{% blocks/products/pf/agp/code-block title="Python code for merging POTM files into an ODP document" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POTM Files and Export to ODP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POTM files and export the result as an ODP document." >}}
