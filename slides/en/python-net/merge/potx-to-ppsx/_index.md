...
title: Merge POTX Files and Save as PPSX Using Python
url: /python-net/merge/potx-to-ppsx/
keywords: Merge POTX to PPSX, Join POTX to PPSX, Combine POTX to PPSX, PowerPoint, Presentation, PPSX, Python, Aspose
description: Merge multiple POTX presentation files in Python and save the combined presentation as a PPSX file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POTX Files and Save as PPSX in Python" h2="Combine PowerPoint template files and save the merged presentation as an Open XML slide show with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge POTX to PPSX in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge Microsoft PowerPoint Open XML Presentation Template (POTX) files by cloning slides from one `Presentation` into another. After combining the slides with `SlideCollection.add_clone`, save the destination presentation in PowerPoint Open XML Slide Show (PPSX) format by passing `SaveFormat.PPSX` to `Presentation.save`.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge POTX Files to PPSX Using Python" %}}
Open the destination and source POTX files, append a clone of each source slide, and save the merged presentation as a PPSX file.

{{% blocks/products/pf/agp/code-block title="Python code for merging POTX files and saving the result as PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POTX Files and Save as PPSX with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POTX files and save the combined presentation as a PPSX file." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.PPSX` to write the merged presentation to a PPSX file.
{{% /blocks/products/pf/agp/step-autogen %}}
