...
title: Merge PDF Files and Export to GIF Using Python
url: /python-net/merge/pdf-to-gif/
keywords: Merge PDF to GIF, Join PDF to GIF, Combine PDF to GIF, PowerPoint, Presentation, GIF, Python, Aspose
description: Merge multiple PDF files in Python and export the combined pages as a single animated GIF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PDF Files and Export to GIF in Python" h2="Import pages from multiple PDF files and export the combined content as an animated GIF with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PDF to GIF in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you combine PDF files by importing their pages into a `Presentation`. `SlideCollection.add_from_pdf` converts each PDF page into a slide and appends it to the presentation. After importing all source files, call `Presentation.save` with `SaveFormat.GIF` to export the combined pages as animation frames in a single GIF file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PDF Files to GIF Using Python" %}}
Create a presentation without its default blank slide, import the source PDF files in the required order, and export the combined slides as a single animated GIF.

{{% blocks/products/pf/agp/code-block title="Python code for merging PDF files into a single animated GIF" offSpacer="true" %}}
...
with slides.Presentation() as presentation:
    ...
    presentation.save("merged-presentation.gif", slides.export.SaveFormat.GIF)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PDF Files and Export to GIF with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PDF files and export the combined pages as a single animated GIF." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.GIF` to export the combined slides as animation frames in a single GIF file.
{{% /blocks/products/pf/agp/step-autogen %}}
