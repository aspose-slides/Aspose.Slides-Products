...
title: Merge PPSX Files to GIF Using Python
url: /python-net/merge/ppsx-to-gif/
keywords: Merge PPSX to GIF, Join PPSX to GIF, Combine PPSX to GIF, PowerPoint, Presentation, GIF, Python, Aspose
description: Merge multiple PPSX files and export the combined slides as an animated GIF in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPSX files and export to GIF in Python" h2="Combine PPSX slide shows and export the merged slides as an animated GIF with Aspose.Slides for Python via .NET. Microsoft PowerPoint and OpenOffice are not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPSX to GIF in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge PPSX files to GIF using Python" %}}
Clone each source slide with `add_clone`, then call `save` with `SaveFormat.GIF`.

{{% blocks/products/pf/agp/code-block title="Python code to merge PPSX files into an animated GIF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPSX to GIF using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPSX files and export the result as an animated GIF in Python." >}}
