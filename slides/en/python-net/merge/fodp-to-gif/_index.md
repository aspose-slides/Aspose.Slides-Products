---
title:  Merge FODP Files To GIF Using Python
...
{{% blocks/products/pf/agp/code-block title="Python code for merge multiple FODP into single GIF file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge FODP to GIF using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to merge two FODP files and save result as GIF in Python." >}}
