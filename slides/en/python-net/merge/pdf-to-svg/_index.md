---
title: Merge PDF Files and Export to SVG Using Python
url: /python-net/merge/pdf-to-svg/
keywords: Merge PDF to SVG, Join PDF to SVG, Combine PDF to SVG, PowerPoint, Presentation, SVG, Python, Aspose
description: Merge multiple PDF files in Python and export each imported page as an SVG image.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PDF Files and Export to SVG in Python" h2="Import pages from multiple PDF files and export the combined content as SVG images with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PDF to SVG in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you combine PDF files by importing their pages into a `Presentation`. `SlideCollection.add_from_pdf` converts each PDF page into a slide and appends it to the presentation. After importing all source files, call `Slide.write_as_svg` for each slide to export the combined pages as separate SVG images.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PDF Files to SVG Using Python" %}}
Create a presentation without its default blank slide, import the source PDF files in the required order, and export every imported page as a separate SVG image.

{{% blocks/products/pf/agp/code-block title="Python code for merging PDF files and exporting the pages as SVG images" offSpacer="true" %}}
...
with slides.Presentation() as presentation:
    ...
    for slide in presentation.slides:
        file_path = f"merged_page_{slide.slide_number}.svg"
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PDF Files and Export to SVG with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PDF files and export the imported pages as SVG images." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
For each imported `Slide`, open an output stream and pass it to [`Slide.write_as_svg`](https://reference.aspose.com/slides/python-net/aspose.slides/slide/write_as_svg/) to create a separate SVG file.
{{% /blocks/products/pf/agp/step-autogen %}}
