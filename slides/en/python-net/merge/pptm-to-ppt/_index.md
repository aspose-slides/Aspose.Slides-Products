---
title: Merge PPTM Files and Save as PPT Using Python
...
description: Merge multiple PPTM presentations in Python and save the result as a single PPT file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPTM Files and Save as PPT in Python" h2="Combine macro-enabled PowerPoint presentations and save the merged slides as a PPT file with a cross-platform Python API" >}}
...
Open the destination and source PPTM presentations, append a clone of each source slide, and save the merged presentation as a single PPT file.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPTM files into a single PPT presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPTM files and save as PPT with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPTM files and save the result as a single PPT presentation." >}}
