...
title: Merge PDF Files and Save as ODP Using Python
url: /python-net/merge/pdf-to-odp/
keywords: Merge PDF to ODP, Join PDF to ODP, Combine PDF to ODP, PowerPoint, Presentation, ODP, Python, Aspose
description: Merge multiple PDF files in Python and save the combined pages as a single ODP presentation.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PDF Files and Save as ODP in Python" h2="Import pages from multiple PDF files and save the combined content as an ODP presentation with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PDF to ODP in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you combine PDF files by importing their pages into a `Presentation`. `SlideCollection.add_from_pdf` converts each PDF page into a slide and appends it to the presentation. After importing all source files, call `Presentation.save` with `SaveFormat.ODP` to write the combined content as an OpenDocument Presentation.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PDF Files to ODP Using Python" %}}
Create a presentation without its default blank slide, import the source PDF files in the required order, and save the combined slides as a single ODP presentation.

{{% blocks/products/pf/agp/code-block title="Python code for merging PDF files into a single ODP presentation" offSpacer="true" %}}
...
with slides.Presentation() as presentation:
    ...
    presentation.save("merged-presentation.odp", slides.export.SaveFormat.ODP)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PDF Files and Save as ODP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PDF files and save the combined pages as a single ODP presentation." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.ODP` to create the merged ODP presentation.
{{% /blocks/products/pf/agp/step-autogen %}}
