...
description: Merge multiple PPTX presentations in Python and export the result as a single XPS document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPTX Files and Export to XPS in Python" h2="Combine PowerPoint presentations and export the merged slides as an XPS document with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPTX to XPS in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) lets you merge PowerPoint Presentation (`PPTX`) files by cloning slides from one presentation into another. After combining the slides with [`SlideCollection.add_clone`](https://reference.aspose.com/slides/python-net/aspose.slides/slidecollection/add_clone/), call `Presentation.save` with `SaveFormat.XPS` to export the merged slides as a single XPS document.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPTX files to XPS using Python" %}}
Open the destination and source PPTX presentations, append a clone of each source slide, and export the merged presentation as an XPS document.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPTX files into a single XPS document" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPTX files and export to XPS with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPTX files and export the result as a single XPS document." >}}
