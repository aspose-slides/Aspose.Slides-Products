---
title: Merge PPS Files into PPTX Using Python
url: /python-net/merge/pps-to-pptx/
keywords: Merge PPS to PPTX, Join PPS to PPTX, Combine PPS to PPTX, PowerPoint, Presentation, PPTX, Python, Aspose
description: Merge multiple PPS presentations in Python and save the result as a single PPTX file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPS Files into PPTX in Python" h2="Combine PowerPoint Slide Show files and save the merged slides as a PPTX presentation with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPS to PPTX in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge PowerPoint Slide Show (PPS) files by cloning slides from one presentation into another. After combining the slides with `ISlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.PPTX` to save the merged slides as a single PPTX presentation.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPS files to PPTX using Python" %}}
Open the destination and source PPS presentations, append a clone of each source slide, and save the merged presentation as a PPTX file.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPS files into a single PPTX presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPS files into PPTX with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPS files and save the result as a single PPTX presentation." >}}
