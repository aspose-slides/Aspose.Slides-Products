...
description: Merge multiple OTP presentation templates in Python and export the result as a single PDF document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge OTP Files and Export to PDF in Python" h2="Combine OpenDocument Presentation Template files and export the merged slides as a PDF document with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge OTP to PDF in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge OTP Files to PDF Using Python" %}}
Open the destination and source OTP presentation templates, append a clone of each source slide, and export the merged presentation as a single PDF document.

{{% blocks/products/pf/agp/code-block title="Python code for merging OTP files into a single PDF document" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge OTP Files and Export to PDF with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two OTP files and export the result as a single PDF document." >}}
