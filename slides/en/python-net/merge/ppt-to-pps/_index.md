---
title: Merge PPT Files to PPS Using Python
url: /python-net/merge/ppt-to-pps/
keywords: Merge PPT to PPS, Join PPT to PPS, Combine PPT to PPS, PowerPoint, Presentation, PPS, Python, Aspose
description: Merge multiple PPT files and save the combined presentation as a PPS file in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPT files and save as PPS in Python" h2="Combine PPT presentations and export the result to PPS with Aspose.Slides for Python via .NET. Microsoft PowerPoint and OpenOffice are not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPT to PPS in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge PPT files to PPS using Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Python code to merge PPT files into a PPS file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPT to PPS using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPT files and save the result as a PPS file in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Save the merged presentation by calling `Presentation.save` with `SaveFormat.PPS`.
