---
title: Merge OTP Files and Save as HTML Using Python
url: /python-net/merge/otp-to-html/
keywords: Merge OTP to HTML, Join OTP to HTML, Combine OTP to HTML, PowerPoint, Presentation, HTML, Python, Aspose
description: Merge multiple OTP presentation templates in Python and export the result as a single HTML5 document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge OTP Files and Save as HTML in Python" h2="Combine OpenDocument Presentation Template files and export the merged presentation as HTML5 with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge OTP to HTML in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge OpenDocument Presentation Template (OTP) files by cloning slides from one template into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.HTML5` to export the merged presentation as a single HTML5 document.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge OTP Files to HTML Using Python" %}}
Open the destination and source OTP templates, append a clone of each source slide, and export the merged presentation as a single HTML5 document.

{{% blocks/products/pf/agp/code-block title="Python code for merging OTP files into a single HTML5 document" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge OTP Files and Save as HTML with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two OTP files and export the result as a single HTML5 document." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.HTML5` to export the merged presentation as a single HTML file.
{{% /blocks/products/pf/agp/step-autogen %}}
