...
title: Merge OTP Files and Save as ODP Using Python
url: /python-net/merge/otp-to-odp/
keywords: Merge OTP to ODP, Join OTP to ODP, Combine OTP to ODP, PowerPoint, Presentation, ODP, Python, Aspose
description: Merge multiple OTP presentation templates in Python and save the result as a single ODP file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge OTP Files and Save as ODP in Python" h2="Combine OpenDocument Presentation Template files and save the merged presentation as ODP with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge OTP to ODP in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge OpenDocument Presentation Template (OTP) files by cloning slides from one template into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.ODP` to write the merged presentation as a packaged OpenDocument Presentation file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge OTP Files to ODP Using Python" %}}
Open the destination and source OTP templates, append a clone of each source slide, and save the merged presentation as a single ODP file.

{{% blocks/products/pf/agp/code-block title="Python code for merging OTP files into a single ODP presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge OTP Files and Save as ODP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two OTP files and save the result as a single ODP presentation." >}}
