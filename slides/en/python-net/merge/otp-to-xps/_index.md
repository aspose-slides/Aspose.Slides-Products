---
title:  Merge OTP Files To XPS Using Python
url: /python-net/merge/otp-to-xps/
keywords: Merge OTP to XPS, Join OTP to XPS, Combine OTP to XPS, PowerPoint, Presentation, XPS, Python, Aspose
...
{{% blocks/products/pf/agp/code-block title="Python code for merge multiple OTP into single XPS file" offSpacer="true" %}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to merge two OTP files and save result as XPS in Python." >}}
