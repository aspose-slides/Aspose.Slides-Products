---
title: Merge PDF Files and Save as PPTX Using Python
url: /python-net/merge/pdf-to-pptx/
keywords: Merge PDF to PPTX, Join PDF to PPTX, Combine PDF to PPTX, PowerPoint, Presentation, PPTX, Python, Aspose
description: Merge multiple PDF files in Python and save the combined pages as a single PPTX presentation.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PDF Files and Save as PPTX in Python" h2="Import pages from multiple PDF files and save the combined content as a PPTX presentation with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PDF to PPTX in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge PDF Files to PPTX Using Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Python code for merging PDF files into a single PPTX presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PDF Files and Save as PPTX with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PDF files and save the combined pages as a single PPTX presentation." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.PPTX` to save the combined presentation as a single PPTX file.
{{% /blocks/products/pf/agp/step-autogen %}}
