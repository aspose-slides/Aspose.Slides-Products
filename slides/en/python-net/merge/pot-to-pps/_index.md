---
title: Merge POT Files to PPS with Python
...
description: Merge multiple POT files in Python and save the combined presentation as a PPS file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POT Files to PPS in Python" h2="Combine POT presentations and save the result as PPS with Aspose.Slides for Python via .NET—no Microsoft PowerPoint or OpenOffice installation required." >}}
...
{{% blocks/products/pf/agp/code-block title="Python code to merge multiple POT files into one PPS file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POT Files to PPS with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POT files and save the result as PPS in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `save` with `SaveFormat.PPS` to write the merged presentation to a PPS file.
{{% /blocks/products/pf/agp/step-autogen %}}
