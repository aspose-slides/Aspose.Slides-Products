...
title: Merge PPTM Files and Export to TIFF Using Python
...
description: Merge multiple PPTM presentations in Python and export the result as a multi-page TIFF image.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPTM Files and Export to TIFF in Python" h2="Combine macro-enabled PowerPoint presentations and export the merged slides as a multi-page TIFF image with a cross-platform Python API" >}}
...
Open the destination and source PPTM presentations, append a clone of each source slide, and export the merged presentation as a multi-page TIFF image.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPTM files into a multi-page TIFF image" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPTM files and export to TIFF with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPTM files and export the result as a multi-page TIFF image." >}}
