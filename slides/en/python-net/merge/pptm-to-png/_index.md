---
title: Merge PPTM Files and Export Slides to PNG Using Python
url: /python-net/merge/pptm-to-png/
keywords: Merge PPTM to PNG, Join PPTM to PNG, Combine PPTM to PNG, PowerPoint, Presentation, PNG, Python, Aspose
description: Merge multiple PPTM files and export each slide from the combined presentation as a PNG image in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPTM files and export slides to PNG in Python" h2="Combine macro-enabled PowerPoint presentations and render the merged slides as PNG images with Aspose.Slides for Python via .NET. Microsoft PowerPoint and OpenOffice are not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPTM to PNG in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) lets you merge PPTM presentations by cloning slides from a source `Presentation` into a destination `Presentation`. After the merge, call `Slide.get_image` for each slide and save the rendered image with `ImageFormat.PNG`. The result is one static PNG file per slide.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPTM files to PNG using Python" %}}
Clone each source slide with `SlideCollection.add_clone`, then render every merged slide with `Slide.get_image`.

{{% blocks/products/pf/agp/code-block title="Python code to merge PPTM files and export slides as PNG images" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPTM to PNG using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPTM files and export the combined slides as PNG images in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Render each merged slide with [`Slide.get_image`](https://reference.aspose.com/slides/python-net/aspose.slides/slide/get_image/) and save it with `ImageFormat.PNG`.
{{% /blocks/products/pf/agp/step-autogen %}}
