---
title: Merge PPS Files to PNG with Python
url: /python-net/merge/pps-to-png/
keywords: Merge PPS to PNG, Join PPS to PNG, Combine PPS to PNG, PowerPoint, Presentation, PNG, Python, Aspose
description: Merge multiple PPS presentations and render the combined slides as PNG images in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPS files and export to PNG in Python" h2="Combine PPS presentations and render the merged slides as PNG images with Aspose.Slides for Python via .NET. Microsoft PowerPoint is not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPS to PNG in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge PPS files to PNG using Python" %}}
Load one PPS file as the destination presentation, clone the slides from the other PPS file into it, and render the merged slides as PNG images.

{{% blocks/products/pf/agp/code-block title="Python code to merge PPS files and export to PNG" offSpacer="true" %}}
...
with slides.Presentation("presentation1.pps") as destination_presentation:
    ...
    for slide in destination_presentation.slides:
        file_path = f"merged_presentation_slide_{slide.slide_number}.png"
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPS files and export to PNG with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPS files and render the result as PNG images in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Slide.get_image` for each merged `Slide`, then call `IImage.save` with `ImageFormat.PNG` to create the PNG files.
{{% /blocks/products/pf/agp/step-autogen %}}
