...
title: Merge PDF Files and Save as PPS Using Python
url: /python-net/merge/pdf-to-pps/
keywords: Merge PDF to PPS, Join PDF to PPS, Combine PDF to PPS, PowerPoint, Presentation, PPS, Python, Aspose
description: Merge multiple PDF files in Python and save the combined pages as a single PPS slide show.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PDF Files and Save as PPS in Python" h2="Import pages from multiple PDF files and save the combined content as a PPS slide show with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PDF to PPS in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you combine PDF files by importing their pages into a `Presentation`. `SlideCollection.add_from_pdf` converts each PDF page into a slide and appends it to the presentation. After importing all source files, call `Presentation.save` with `SaveFormat.PPS` to write the combined content as a PowerPoint 97-2003 slide show.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PDF Files to PPS Using Python" %}}
Create a presentation without its default blank slide, import the source PDF files in the required order, and save the combined slides as a single PPS file.

{{% blocks/products/pf/agp/code-block title="Python code for merging PDF files into a single PPS file" offSpacer="true" %}}
...
with slides.Presentation() as presentation:
    ...
    presentation.save("merged-presentation.pps", slides.export.SaveFormat.PPS)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PDF Files and Save as PPS with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PDF files and save the combined pages as a single PPS file." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.PPS` to create the merged PPS file.
{{% /blocks/products/pf/agp/step-autogen %}}
