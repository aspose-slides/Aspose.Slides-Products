---
title:  Merge PDF Files To OTP Using Python
...
{{% blocks/products/pf/agp/code-block title="Python code for merge multiple PDF into single OTP file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PDF to OTP using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to merge two PDF files and save result as OTP in Python." >}}
