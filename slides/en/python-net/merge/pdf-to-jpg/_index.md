---
title: Merge PDF Files and Export to JPG Using Python
url: /python-net/merge/pdf-to-jpg/
keywords: Merge PDF to JPG, Join PDF to JPG, Combine PDF to JPG, PowerPoint, Presentation, JPG, Python, Aspose
description: Merge multiple PDF files in Python and export each imported page as a JPEG image.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PDF Files and Export to JPG in Python" h2="Import pages from multiple PDF files and render the combined content as JPEG images with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PDF to JPG in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you combine PDF files by importing their pages into a `Presentation`. `SlideCollection.add_from_pdf` converts each PDF page into a slide and appends it to the presentation. After importing all source files, render each slide with `Slide.get_image` and save the resulting `IImage` object in JPEG format.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PDF Files to JPG Using Python" %}}
Create a presentation without its default blank slide, import the source PDF files in the required order, and render every imported page as a separate JPEG image.

{{% blocks/products/pf/agp/code-block title="Python code for merging PDF files and exporting the pages as JPG images" offSpacer="true" %}}
...
with slides.Presentation() as presentation:
    ...
    for slide in presentation.slides:
        file_path = f"merged_page_{slide.slide_number}.jpg"
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PDF Files and Export to JPG with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PDF files and export the imported pages as JPG images." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Render each imported `Slide` with `Slide.get_image`, then call `IImage.save` with `ImageFormat.JPEG` to create a separate JPG file for that page.
{{% /blocks/products/pf/agp/step-autogen %}}
