---
title: Merge FODP Files and Save as ODP Using Python
url: /python-net/merge/fodp-to-odp/
keywords: Merge FODP to ODP, Join FODP to ODP, Combine FODP to ODP, PowerPoint, Presentation, ODP, Python, Aspose
description: Merge multiple FODP presentations in Python and save the result as a single ODP file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge FODP Files and Save as ODP in Python" h2="Combine Flat OpenDocument Presentation files and save the merged presentation as ODP with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge FODP to ODP in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge Flat OpenDocument Presentation (FODP) files by cloning slides from one presentation into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.ODP` to write the merged presentation as a packaged OpenDocument Presentation file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge FODP files to ODP using Python" %}}
Open the destination and source FODP presentations, append a clone of each source slide, and save the merged presentation as a single ODP file.

{{% blocks/products/pf/agp/code-block title="Python code for merging FODP files into a single ODP presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge FODP files and save as ODP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two FODP files and save the result as a single ODP presentation." >}}
