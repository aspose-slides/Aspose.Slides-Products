...
title: Merge OTP Files and Save as POTM Using Python
url: /python-net/merge/otp-to-potm/
keywords: Merge OTP to POTM, Join OTP to POTM, Combine OTP to POTM, PowerPoint, Presentation, POTM, Python, Aspose
description: Merge multiple OTP presentation templates in Python and save the result as a single POTM file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge OTP Files and Save as POTM in Python" h2="Combine OpenDocument Presentation Template files and save the merged presentation as POTM with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge OTP to POTM in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge OpenDocument Presentation Template (OTP) files by cloning slides from one presentation into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.POTM` to write the merged presentation as a macro-enabled PowerPoint presentation template.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge OTP Files to POTM Using Python" %}}
Open the destination and source OTP presentation templates, append a clone of each source slide, and save the merged presentation as a single POTM file.

{{% blocks/products/pf/agp/code-block title="Python code for merging OTP files into a single POTM presentation template" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge OTP Files and Save as POTM with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two OTP files and save the result as a single POTM presentation template." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.POTM` to write the merged presentation as a single POTM file.
{{% /blocks/products/pf/agp/step-autogen %}}
