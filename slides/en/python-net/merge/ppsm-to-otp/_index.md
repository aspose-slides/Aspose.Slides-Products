...
title: Merge PPSM Files to OTP with Python
...
description: Merge multiple PPSM presentations and save the combined slides as an OTP file in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPSM Files and Save as OTP in Python" h2="Combine PowerPoint Macro-Enabled Slide Show files and save the merged slides as an OpenDocument Presentation Template with Aspose.Slides for Python via .NET. Microsoft PowerPoint is not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPSM to OTP in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) lets you combine multiple PPSM presentations by cloning slides from one `Presentation` into another. The `SlideCollection.add_clone` method preserves the content and formatting of each cloned slide. After merging the slides, call `Presentation.save` with `SaveFormat.OTP` to save the destination `Presentation` as an OTP template.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPSM Files to OTP Using Python" %}}
Load one PPSM file as the destination presentation, clone the slides from another PPSM file into it, and save the merged result in OTP format.

{{% blocks/products/pf/agp/code-block title="Python code to merge PPSM files and save as OTP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PPSM Files and Save as OTP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPSM files and save the result as OTP in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.OTP` to save the merged presentation as an OTP template.
{{% /blocks/products/pf/agp/step-autogen %}}
