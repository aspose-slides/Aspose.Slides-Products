...
title: Merge ODP Files in Python
url: /python-net/merge/odp/
keywords: Merge ODP, Join ODP, Combine ODP, PowerPoint, Presentation, Python, Aspose
description: Merge multiple ODP presentations into one file with Aspose.Slides for Python via .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge ODP Files in Python" h2="Combine OpenDocument Presentation files with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge ODP in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge ODP Files Using Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Python code for merging multiple ODP files into one presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge ODP Files with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two ODP files and save the result as a single ODP presentation." >}}
