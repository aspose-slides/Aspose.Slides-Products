...
title: Merge PPSM Files to ODP with Python
...
description: Merge multiple PPSM presentations and save the combined slides as an ODP file in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPSM Files and Save as ODP in Python" h2="Combine PowerPoint Macro-Enabled Slide Show files and save the merged slides as an OpenDocument Presentation with Aspose.Slides for Python via .NET. Microsoft PowerPoint is not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPSM to ODP in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) lets you combine multiple PPSM presentations by cloning slides from one `Presentation` into another. The `SlideCollection.add_clone` method preserves the content and formatting of each cloned slide. After merging the slides, call `Presentation.save` with `SaveFormat.ODP` to save the destination `Presentation` as an ODP file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPSM Files to ODP Using Python" %}}
Load one PPSM file as the destination presentation, clone the slides from another PPSM file into it, and save the merged result in ODP format.

{{% blocks/products/pf/agp/code-block title="Python code to merge PPSM files and save as ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PPSM Files and Save as ODP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPSM files and save the result as ODP in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.ODP` to save the merged presentation as an ODP file.
{{% /blocks/products/pf/agp/step-autogen %}}
