---
title: Merge PPSX Files and Save as POT Using Python
url: /python-net/merge/ppsx-to-pot/
keywords: Merge PPSX to POT, Join PPSX to POT, Combine PPSX to POT, PowerPoint, Presentation, POT, Python, Aspose
description: Merge multiple PPSX presentations in Python and save the result as a single POT file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPSX Files and Save as POT in Python" h2="Combine PowerPoint Show files and save the merged presentation as POT with a cross-platform Python API. Microsoft PowerPoint is not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPSX to POT in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) lets you merge PPSX files by cloning slides from a source `Presentation` into a destination `Presentation`. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.POT` to write the merged content as a PowerPoint 97-2003 presentation template.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPSX files to POT using Python" %}}
Open the destination and source PPSX presentations, append a clone of each source slide, and save the merged presentation as a single POT file.

{{% blocks/products/pf/agp/code-block title="Python code to merge PPSX files and save as POT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PPSX Files and Save as POT with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPSX files and save the result as a single POT presentation template." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call [`Presentation.save`](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/save/) with `SaveFormat.POT` to write the merged presentation as a single POT file.
{{% /blocks/products/pf/agp/step-autogen %}}
