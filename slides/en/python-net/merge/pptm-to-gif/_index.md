...
title: Merge PPTM Files to GIF Using Python
url: /python-net/merge/pptm-to-gif/
keywords: Merge PPTM to GIF, Join PPTM to GIF, Combine PPTM to GIF, PowerPoint, Presentation, GIF, Python, Aspose
description: Merge multiple PPTM files and export the combined slides as an animated GIF in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPTM files and export to GIF in Python" h2="Combine macro-enabled PowerPoint presentations and export the merged slides as an animated GIF with Aspose.Slides for Python via .NET. Microsoft PowerPoint and OpenOffice are not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPTM to GIF in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) lets you merge PPTM presentations by cloning slides from a source `Presentation` into a destination `Presentation`. Save the destination presentation with `SaveFormat.GIF` to render its slides as frames in one animated GIF file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPTM files to GIF using Python" %}}
Clone each source slide with `SlideCollection.add_clone`, then call `Presentation.save` with `SaveFormat.GIF`.

{{% blocks/products/pf/agp/code-block title="Python code to merge PPTM files into an animated GIF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPTM to GIF using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPTM files and export the result as an animated GIF in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Save the merged slides as an animated GIF with `Presentation.save` and `SaveFormat.GIF`.
{{% /blocks/products/pf/agp/step-autogen %}}
