...
description: Merge multiple POT files in Python and save the combined presentation as a PPSM file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POT Files to PPSM in Python" h2="Combine POT presentations and save the result as PPSM with Aspose.Slides for Python via .NET—no Microsoft PowerPoint or OpenOffice installation required." >}}
...
{{% blocks/products/pf/agp/code-block title="Python code to merge multiple POT files into one PPSM file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POT Files to PPSM with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POT files and save the result as PPSM in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `save` with `SaveFormat.PPSM` to write the merged presentation to a PPSM file.
{{% /blocks/products/pf/agp/step-autogen %}}
