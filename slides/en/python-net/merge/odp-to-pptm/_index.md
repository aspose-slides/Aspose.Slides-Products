...
title: Merge ODP Files into PPTM Using Python
...
description: Merge multiple ODP presentations in Python and save the result as a single PPTM file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge ODP Files into PPTM in Python" h2="Combine OpenDocument Presentation files and save the merged slides as a PPTM presentation with a cross-platform Python API" >}}
...
Open the destination and source ODP presentations, append a clone of each source slide, and save the merged presentation as a PPTM file.

{{% blocks/products/pf/agp/code-block title="Python code for merging ODP files into a single PPTM presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge ODP files into PPTM with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two ODP files and save the result as a single PPTM presentation." >}}
