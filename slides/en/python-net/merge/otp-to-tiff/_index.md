---
title: Merge OTP to TIFF in Python
url: /python-net/merge/otp-to-tiff/
keywords: Merge OTP to TIFF, Join OTP to TIFF, Combine OTP to TIFF, PowerPoint, Presentation, Python
description: Merge OTP presentations and save the combined slides as a multipage TIFF image with Aspose.Slides for Python via .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge OTP to TIFF in Python" h2="Combine OpenDocument presentation templates and save the merged slides as a multipage TIFF image with Python" >}}

{{% blocks/products/pf/feature-page-section h2="Merge OTP to TIFF in Python" %}}
...
After the slides are combined, call `Presentation.save` with `SaveFormat.TIFF` to create one multipage TIFF image. Each slide becomes a separate frame. Microsoft PowerPoint and OpenOffice are not required.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge OTP files to TIFF using Python" %}}
Load the destination and source OTP files, clone each source slide into the destination presentation, and save the combined slides as a multipage TIFF image.

{{% blocks/products/pf/agp/code-block title="Python code for merging OTP files into TIFF" offSpacer="true" %}}
...
with slides.Presentation("presentation1.otp") as destination_presentation:
    ...
    destination_presentation.save("merged.tiff", slides.export.SaveFormat.TIFF)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to merge OTP to TIFF using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to merge OTP files and save the result as TIFF in Python." >}}
