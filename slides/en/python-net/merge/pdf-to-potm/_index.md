...
title: Merge PDF Files and Save as POTM Using Python
url: /python-net/merge/pdf-to-potm/
keywords: Merge PDF to POTM, Join PDF to POTM, Combine PDF to POTM, PowerPoint, Presentation, POTM, Python, Aspose
description: Merge multiple PDF files in Python and save the combined pages as a single POTM presentation template.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PDF Files and Save as POTM in Python" h2="Import pages from multiple PDF files and save the combined content as a POTM file with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PDF to POTM in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you combine PDF files by importing their pages into a `Presentation`. `SlideCollection.add_from_pdf` converts each PDF page into a slide and appends it to the presentation. After importing all source files, call `Presentation.save` with `SaveFormat.POTM` to write the combined content as a macro-enabled PowerPoint presentation template.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PDF Files to POTM Using Python" %}}
Create a presentation without its default blank slide, import the source PDF files in the required order, and save the combined slides as a single POTM file.

{{% blocks/products/pf/agp/code-block title="Python code for merging PDF files into a single POTM file" offSpacer="true" %}}
...
with slides.Presentation() as presentation:
    ...
    presentation.save("merged-presentation.potm", slides.export.SaveFormat.POTM)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PDF Files and Save as POTM with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PDF files and save the combined pages as a single POTM file." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.POTM` to create the merged POTM file.
{{% /blocks/products/pf/agp/step-autogen %}}
