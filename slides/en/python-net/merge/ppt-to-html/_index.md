...
title: Merge PPT Files to HTML Using Python
url: /python-net/merge/ppt-to-html/
keywords: Merge PPT to HTML, Join PPT to HTML, Combine PPT to HTML, PowerPoint, Presentation, HTML, Python, Aspose
description: Merge multiple PPT files and export the combined presentation as an HTML5 document in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPT files and export to HTML in Python" h2="Combine PPT presentations and export the merged presentation as an HTML5 document with Aspose.Slides for Python via .NET. Microsoft PowerPoint and OpenOffice are not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPT to HTML in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge PPT files to HTML using Python" %}}
Clone each source slide with `add_clone`, then call `save` with `SaveFormat.HTML5`.

{{% blocks/products/pf/agp/code-block title="Python code to merge PPT files into an HTML5 document" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPT to HTML using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPT files and export the result as an HTML5 document in Python." >}}
