---
title: Merge POTX Files to PPTM with Python
url: /python-net/merge/potx-to-pptm/
keywords: Merge POTX to PPTM, Join POTX to PPTM, Combine POTX to PPTM, PowerPoint, Presentation, PPTM, Python, Aspose
description: Merge multiple POTX files in Python and save the combined presentation as a PPTM file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POTX Files to PPTM in Python" h2="Combine PowerPoint template files and save the merged presentation as PPTM with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge POTX to PPTM in Python" %}}

[Aspose.Slides for Python via .NET](/slides/python-net/) lets you merge Microsoft PowerPoint Open XML Presentation Template (POTX) files by cloning slides from a source `Presentation` into a destination `Presentation`. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.PPTM` to write the merged content as a PowerPoint Macro-Enabled Presentation (PPTM) file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge POTX Files to PPTM Using Python" %}}
Open the destination and source POTX files, append a clone of each source slide, and save the merged presentation as a single PPTM file.

{{% blocks/products/pf/agp/code-block title="Python code for merging POTX files into a single PPTM presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POTX Files to PPTM with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POTX files and save the result as a single PPTM presentation." >}}
