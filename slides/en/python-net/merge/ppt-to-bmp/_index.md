---
title: Merge PPT Files to BMP Using Python
url: /python-net/merge/ppt-to-bmp/
keywords: Merge PPT to BMP, Join PPT to BMP, Combine PPT to BMP, PowerPoint, Presentation, BMP, Python, Aspose
description: Merge multiple PPT files and export the combined slides to BMP images in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPT files and export slides to BMP in Python" h2="Combine PPT presentations and export every slide to a separate BMP image with Aspose.Slides for Python via .NET. Microsoft PowerPoint and OpenOffice are not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPT to BMP in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge PPT files to BMP using Python" %}}
Clone each source slide with `add_clone`, then render and save every slide in the merged presentation as a BMP image.

{{% blocks/products/pf/agp/code-block title="Python code to merge PPT files and export slides to BMP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPT to BMP using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPT files and export the combined slides to BMP in Python." >}}
