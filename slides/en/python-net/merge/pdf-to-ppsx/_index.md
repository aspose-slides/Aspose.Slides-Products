...
description: Merge multiple PDF files in Python and save the combined pages as a single PPSX slide show.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PDF Files and Save as PPSX in Python" h2="Import pages from multiple PDF files and save the combined content as a PPSX slide show with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PDF to PPSX in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you combine PDF files by importing their pages into a `Presentation`. `SlideCollection.add_from_pdf` converts each PDF page into a slide and appends it to the presentation. After importing all source files, call `Presentation.save` with `SaveFormat.PPSX` to write the combined content as a PowerPoint Open XML slide show.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PDF Files to PPSX Using Python" %}}
Create a presentation without its default blank slide, import the source PDF files in the required order, and save the combined slides as a single PPSX file.

{{% blocks/products/pf/agp/code-block title="Python code for merging PDF files into a single PPSX file" offSpacer="true" %}}
...
with slides.Presentation() as presentation:
    ...
    presentation.save("merged-presentation.ppsx", slides.export.SaveFormat.PPSX)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PDF Files and Save as PPSX with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PDF files and save the combined pages as a single PPSX file." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.PPSX` to create the merged PPSX file.
{{% /blocks/products/pf/agp/step-autogen %}}
