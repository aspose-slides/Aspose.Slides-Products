...
title: Merge FODP Files into PPTM Using Python
url: /python-net/merge/fodp-to-pptm/
keywords: Merge FODP to PPTM, Join FODP to PPTM, Combine FODP to PPTM, PowerPoint, Presentation, PPTM, Python, Aspose
description: Merge multiple FODP presentations in Python and save the result as a single PPTM file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge FODP Files into PPTM in Python" h2="Combine Flat OpenDocument Presentation files and save the merged slides as a PPTM presentation with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge FODP to PPTM in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge Flat OpenDocument Presentation (FODP) files by cloning slides from one presentation into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.PPTM` to save the merged slides as a single PPTM presentation.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge FODP files to PPTM using Python" %}}
Open the destination and source FODP presentations, append a clone of each source slide, and save the merged presentation as a PPTM file.

{{% blocks/products/pf/agp/code-block title="Python code for merging FODP files into a single PPTM presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge FODP files into PPTM with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two FODP files and save the result as a single PPTM presentation." >}}
