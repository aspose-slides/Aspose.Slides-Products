...
description: Merge multiple PPTM presentations in Python and save the result as a single PPTM file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPTM files in Python" h2="Combine macro-enabled PowerPoint presentations with Aspose.Slides for Python via .NET. Microsoft PowerPoint and OpenOffice are not required." >}}
...
{{% blocks/products/pf/agp/code-block title="Python code to merge PPTM files into a single presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPTM files and save the result as a single PPTM presentation in Python." >}}
