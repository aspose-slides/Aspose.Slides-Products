...
title: Merge POT Files and Save as OTP Using Python
url: /python-net/merge/pot-to-otp/
keywords: Merge POT to OTP, Join POT to OTP, Combine POT to OTP, PowerPoint, Presentation, OTP, Python, Aspose
description: Merge multiple POT presentation files in Python and save the combined presentation as an OTP template.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POT Files and Save as OTP in Python" h2="Combine PowerPoint template files and save the merged presentation as an OpenDocument template with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge POT to OTP in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge POT Files to OTP Using Python" %}}
Open the destination and source POT files, append a clone of each source slide, and save the merged presentation as an OTP template.

{{% blocks/products/pf/agp/code-block title="Python code for merging POT files and saving the result as OTP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POT Files and Save as OTP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POT files and save the combined presentation as an OTP template." >}}
