---
title:  Merge POT Files To OTP Using Python
...
{{% blocks/products/pf/agp/code-block title="Python code for merge multiple POT into single OTP file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge POT to OTP using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to merge two POT files and save result as OTP in Python." >}}
