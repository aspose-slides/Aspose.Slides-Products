---
title: Merge OTP Files into PPSM Using Python
url: /python-net/merge/otp-to-ppsm/
keywords: Merge OTP to PPSM, Join OTP to PPSM, Combine OTP to PPSM, PowerPoint, Presentation, PPSM, Python, Aspose
description: Merge multiple OTP presentation templates in Python and save the result as a single PPSM slide show.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge OTP Files into PPSM in Python" h2="Combine OpenDocument Presentation Template files and save the merged slides as a PPSM slide show with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge OTP to PPSM in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge OpenDocument Presentation Template (OTP) files by cloning slides from one template into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.PPSM` to save the merged slides as a single PPSM slide show.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge OTP files to PPSM using Python" %}}
Open the destination and source OTP templates, append a clone of each source slide, and save the merged presentation as a PPSM file.

{{% blocks/products/pf/agp/code-block title="Python code for merging OTP files into a single PPSM slide show" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge OTP files into PPSM with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two OTP files and save the result as a single PPSM slide show." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.PPSM` to save the merged slides as a single PPSM slide show.
{{% /blocks/products/pf/agp/step-autogen %}}
