...
title: Merge POT Files and Export to PDF Using Python
url: /python-net/merge/pot-to-pdf/
keywords: Merge POT to PDF, Join POT to PDF, Combine POT to PDF, PowerPoint, Presentation, PDF, Python, Aspose
description: Merge multiple POT presentation files in Python and export the combined presentation to PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POT Files and Export to PDF in Python" h2="Combine PowerPoint template files and export the merged presentation to PDF with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge POT to PDF in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge POT Files to PDF Using Python" %}}
Open the destination and source POT files, append a clone of each source slide, and export the merged presentation as a PDF document.

{{% blocks/products/pf/agp/code-block title="Python code for merging POT files and exporting the result to PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POT Files and Export to PDF with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POT files and export the combined presentation to PDF." >}}
