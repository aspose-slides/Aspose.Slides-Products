...
title: Merge POTM Files and Save as OTP Using Python
url: /python-net/merge/potm-to-otp/
keywords: Merge POTM to OTP, Join POTM to OTP, Combine POTM to OTP, PowerPoint, Presentation, OTP, Python, Aspose
description: Merge multiple POTM presentation files in Python and save the combined presentation as an OTP file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POTM Files and Save as OTP in Python" h2="Combine macro-enabled PowerPoint files and save the merged presentation as an OpenDocument Presentation Template with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge POTM to OTP in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge Microsoft PowerPoint Macro-Enabled Template (POTM) files by cloning slides from one `Presentation` into another. After combining the slides with `SlideCollection.add_clone`, save the destination presentation in OpenDocument Presentation Template (OTP) format by passing `SaveFormat.OTP` to `Presentation.save`.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge POTM Files to OTP Using Python" %}}
Open the destination and source POTM files, append a clone of each source slide, and save the merged presentation as an OTP file.

{{% blocks/products/pf/agp/code-block title="Python code for merging POTM files and saving the result as OTP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POTM Files and Save as OTP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POTM files and save the combined presentation as an OTP file." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.OTP` to write the merged presentation to an OTP file.
{{% /blocks/products/pf/agp/step-autogen %}}
