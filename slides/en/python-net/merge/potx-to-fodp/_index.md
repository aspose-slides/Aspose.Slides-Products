---
title: Merge POTX Files and Export to FODP Using Python
url: /python-net/merge/potx-to-fodp/
keywords: Merge POTX to FODP, Join POTX to FODP, Combine POTX to FODP, PowerPoint, Presentation, FODP, Python, Aspose
description: Merge multiple POTX presentation files in Python and export the result as an FODP document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POTX Files and Export to FODP in Python" h2="Combine PowerPoint Open XML template files and export the merged presentation as a Flat OpenDocument Presentation with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge POTX to FODP in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge POTX Files to FODP Using Python" %}}
Open the destination and source POTX files, append a clone of each source slide, and save the merged presentation as an FODP document.

{{% blocks/products/pf/agp/code-block title="Python code for merging POTX files into an FODP document" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POTX Files and Export to FODP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POTX files and export the result as an FODP document." >}}
