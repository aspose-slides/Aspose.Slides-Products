---
title: Merge PDF Files and Save as HTML Using Python
...
description: Merge multiple PDF files in Python and export the combined pages as a single HTML5 document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PDF Files and Save as HTML in Python" h2="Import pages from multiple PDF files and export the combined content as HTML5 with a cross-platform Python API" >}}
...
{{% blocks/products/pf/agp/code-block title="Python code for merging PDF files into a single HTML5 document" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PDF Files and Save as HTML with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PDF files and export the combined pages as a single HTML5 document." >}}
