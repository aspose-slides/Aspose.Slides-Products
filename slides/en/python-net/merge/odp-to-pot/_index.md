---
title: Merge ODP Files and Save as POT Using Python
url: /python-net/merge/odp-to-pot/
keywords: Merge ODP to POT, Join ODP to POT, Combine ODP to POT, PowerPoint, Presentation, POT, Python, Aspose
description: Merge multiple ODP presentations in Python and save the result as a single POT file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge ODP Files and Save as POT in Python" h2="Combine OpenDocument Presentation files and save the merged presentation as POT with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge ODP to POT in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge OpenDocument Presentation (ODP) files by cloning slides from one presentation into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.POT` to write the merged presentation as a PowerPoint 97-2003 presentation template.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge ODP Files to POT Using Python" %}}
Open the destination and source ODP presentations, append a clone of each source slide, and save the merged presentation as a single POT file.

{{% blocks/products/pf/agp/code-block title="Python code for merging ODP files into a single POT presentation template" offSpacer="true" %}}
...
with slides.Presentation("destination.odp") as destination_presentation:
    ...
    destination_presentation.save("merged-presentation.pot", slides.export.SaveFormat.POT)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge ODP Files and Save as POT with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two ODP files and save the result as a single POT presentation template." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.POT` to write the merged presentation as a single POT file.
{{% /blocks/products/pf/agp/step-autogen %}}
