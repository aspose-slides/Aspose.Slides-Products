...
description: Merge multiple PDF files in Python and save the combined pages as a single FODP presentation.
---
...
[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you combine PDF files by importing their pages into a `Presentation`. `SlideCollection.add_from_pdf` converts each PDF page into a slide and appends it to the presentation. After importing all source files, call `Presentation.save` with `SaveFormat.FODP` to write the combined content as a flat OpenDocument Presentation.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PDF Files to FODP Using Python" %}}
Create a presentation without its default blank slide, import the source PDF files in the required order, and save the combined slides as a single FODP presentation.

{{% blocks/products/pf/agp/code-block title="Python code for merging PDF files into a single FODP presentation" offSpacer="true" %}}
...
with slides.Presentation() as presentation:
    ...
    presentation.save("merged-presentation.fodp", slides.export.SaveFormat.FODP)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PDF Files and Save as FODP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PDF files and save the combined pages as a single FODP presentation." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.FODP` to write the combined presentation as a single FODP file.
{{% /blocks/products/pf/agp/step-autogen %}}
