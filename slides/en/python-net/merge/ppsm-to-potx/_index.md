...
title: Merge PPSM Files and Export to POTX Using Python
...
description: Merge multiple PPSM presentation files in Python and export the result as a POTX file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPSM Files and Export to POTX in Python" h2="Combine macro-enabled PowerPoint Slide Show files and export the merged presentation in POTX format with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPSM to POTX in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge PowerPoint Macro-Enabled Slide Show (PPSM) files by cloning slides from one `Presentation` into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.POTX` to export the merged presentation as a POTX file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPSM Files to POTX Using Python" %}}
Open the destination and source PPSM files, append a clone of each source slide, and save the merged presentation as a POTX file.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPSM files into a POTX file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PPSM Files and Export to POTX with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPSM files and export the result as a POTX file." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.POTX` to write the merged presentation as a POTX file.
{{% /blocks/products/pf/agp/step-autogen %}}
