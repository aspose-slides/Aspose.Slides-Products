...
description: Merge multiple POTX presentation templates into a single POTX file using Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POTX Files in Python" h2="Combine PowerPoint Open XML template files with a cross-platform Python API" >}}
...
{{% blocks/products/pf/agp/code-block title="Python code for merging multiple POTX files into one file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POTX Files with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POTX files into a single POTX template." >}}
