...
title: Merge POTM Files and Export to XPS Using Python
url: /python-net/merge/potm-to-xps/
keywords: Merge POTM to XPS, Join POTM to XPS, Combine POTM to XPS, PowerPoint, Presentation, XPS, Python, Aspose
description: Merge multiple POTM presentation files in Python and export the combined presentation as a single XPS document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POTM Files and Export to XPS in Python" h2="Combine macro-enabled PowerPoint template files and export the merged presentation as XPS with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge POTM to XPS in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge PowerPoint Macro-Enabled Template (POTM) files by cloning slides from one `Presentation` into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.XPS` to export the merged presentation as an XML Paper Specification (XPS) document.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge POTM Files to XPS Using Python" %}}
Open the destination and source POTM files, append a clone of each source slide, and export the merged presentation as an XPS document.

{{% blocks/products/pf/agp/code-block title="Python code for merging POTM files and exporting the result to XPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POTM Files and Export to XPS with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POTM files and export the combined presentation as a single XPS document." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.XPS` to export the merged presentation as a single XPS document.
{{% /blocks/products/pf/agp/step-autogen %}}
