...
title: Merge POTM Files and Save as PPS Using Python
url: /python-net/merge/potm-to-pps/
keywords: Merge POTM to PPS, Join POTM to PPS, Combine POTM to PPS, PowerPoint, Presentation, PPS, Python, Aspose
description: Merge multiple POTM presentation files in Python and save the combined presentation as a single PPS file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POTM Files and Save as PPS in Python" h2="Combine macro-enabled PowerPoint template files and save the merged presentation as a PowerPoint slide show with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge POTM to PPS in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge PowerPoint Macro-Enabled Template (POTM) files by cloning slides from one `Presentation` into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.PPS` to write the merged presentation as a PowerPoint 97-2003 Slide Show (PPS) file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge POTM Files to PPS Using Python" %}}
Open the destination and source POTM files, append a clone of each source slide, and save the merged presentation as a PPS file.

{{% blocks/products/pf/agp/code-block title="Python code for merging POTM files and saving the result as PPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POTM Files and Save as PPS with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POTM files and save the result as a single PPS file." >}}
