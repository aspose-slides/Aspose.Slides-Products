...
title: Merge OTP Files and Save as POT Using Python
url: /python-net/merge/otp-to-pot/
keywords: Merge OTP to POT, Join OTP to POT, Combine OTP to POT, PowerPoint, Presentation, POT, Python, Aspose
description: Merge multiple OTP presentation templates in Python and save the result as a single POT file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge OTP Files and Save as POT in Python" h2="Combine OpenDocument Presentation Template files and save the merged presentation as POT with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge OTP to POT in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge OTP Files to POT Using Python" %}}
Open the destination and source OTP presentation templates, append a clone of each source slide, and save the merged presentation as a single POT file.

{{% blocks/products/pf/agp/code-block title="Python code for merging OTP files into a single POT presentation template" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge OTP Files and Save as POT with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two OTP files and save the result as a single POT presentation template." >}}
