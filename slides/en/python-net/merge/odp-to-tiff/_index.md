---
title: Merge ODP Files and Export to TIFF Using Python
url: /python-net/merge/odp-to-tiff/
keywords: Merge ODP to TIFF, Join ODP to TIFF, Combine ODP to TIFF, PowerPoint, Presentation, TIFF, Python, Aspose
description: Merge multiple ODP presentations in Python and export the result as a multi-page TIFF image.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge ODP Files and Export to TIFF in Python" h2="Combine OpenDocument Presentation files and save the merged slides as a multi-page TIFF image with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge ODP to TIFF in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge ODP Files to TIFF Using Python" %}}
Open the destination and source ODP presentations, append a clone of each source slide, and export the merged presentation as a multi-page TIFF image.

{{% blocks/products/pf/agp/code-block title="Python code for merging ODP files into a single multi-page TIFF image" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge ODP Files and Export to TIFF with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two ODP files and export the result as a multi-page TIFF image." >}}
