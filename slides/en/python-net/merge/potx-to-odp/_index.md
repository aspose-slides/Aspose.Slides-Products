---
title: Merge POTX Files and Export to ODP Using Python
url: /python-net/merge/potx-to-odp/
keywords: Merge POTX to ODP, Join POTX to ODP, Combine POTX to ODP, PowerPoint, Presentation, ODP, Python, Aspose
description: Merge multiple POTX presentation files in Python and export the result as an ODP document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POTX Files and Export to ODP in Python" h2="Combine PowerPoint template files and export the merged presentation as an OpenDocument Presentation with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge POTX to ODP in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge POTX Files to ODP Using Python" %}}
Open the destination and source POTX files, append a clone of each source slide, and save the merged presentation as an ODP document.

{{% blocks/products/pf/agp/code-block title="Python code for merging POTX files into an ODP document" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POTX Files and Export to ODP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POTX files and export the result as an ODP document." >}}
