---
title: Merge POTX Files and Save as POTM Using Python
url: /python-net/merge/potx-to-potm/
keywords: Merge POTX to POTM, Join POTX to POTM, Combine POTX to POTM, PowerPoint, Presentation, POTM, Python, Aspose
description: Merge multiple POTX presentation files in Python and save the combined presentation as a POTM file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POTX Files and Save as POTM in Python" h2="Combine PowerPoint template files and save the merged presentation as a macro-enabled PowerPoint template with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge POTX to POTM in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge Microsoft PowerPoint Open XML Presentation Template (POTX) files by cloning slides from one `Presentation` into another. After combining the slides with `SlideCollection.add_clone`, save the destination presentation in PowerPoint Macro-Enabled Presentation Template (POTM) format by passing `SaveFormat.POTM` to `Presentation.save`.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge POTX Files to POTM Using Python" %}}
Open the destination and source POTX files, append a clone of each source slide, and save the merged presentation as a POTM file.

{{% blocks/products/pf/agp/code-block title="Python code for merging POTX files and saving the result as POTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POTX Files and Save as POTM with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POTX files and save the combined presentation as a POTM file." >}}
