...
title: Merge PPTX Files into PPTM Using Python
url: /python-net/merge/pptx-to-pptm/
keywords: Merge PPTX to PPTM, Join PPTX to PPTM, Combine PPTX to PPTM, PowerPoint, Presentation, PPTM, Python, Aspose
description: Merge multiple PPTX presentations in Python and save the result as a single PPTM file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPTX Files into PPTM in Python" h2="Combine PowerPoint presentations and save the merged slides in a macro-enabled presentation format with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPTX to PPTM in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge PowerPoint Open XML Presentation (`PPTX`) files by cloning slides from one presentation into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.PPTM` to write the merged presentation in the macro-enabled PowerPoint presentation format.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPTX files to PPTM using Python" %}}
Open the destination and source `PPTX` presentations, append a clone of each source slide, and save the merged presentation as a single `PPTM` file.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPTX files into a single PPTM presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPTX files into PPTM with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPTX files and save the result as a single PPTM presentation." >}}
