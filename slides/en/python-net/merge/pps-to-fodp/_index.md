...
title: Merge PPS Files and Export to FODP Using Python
url: /python-net/merge/pps-to-fodp/
keywords: Merge PPS to FODP, Join PPS to FODP, Combine PPS to FODP, PowerPoint, Presentation, FODP, Python, Aspose
description: Merge multiple PPS presentation files in Python and export the result as an FODP document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPS Files and Export to FODP in Python" h2="Combine PowerPoint Slide Show files and export the merged presentation as a Flat OpenDocument Presentation with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPS to FODP in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge PPS Files to FODP Using Python" %}}
Open the destination and source PPS files, append a clone of each source slide, and save the merged presentation as an FODP document.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPS files into an FODP document" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PPS Files and Export to FODP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPS files and export the result as an FODP document." >}}
