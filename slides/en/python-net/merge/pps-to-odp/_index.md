...
title: Merge PPS Files to ODP with Python
url: /python-net/merge/pps-to-odp/
keywords: Merge PPS to ODP, Join PPS to ODP, Combine PPS to ODP, PowerPoint, Presentation, ODP, Python, Aspose
description: Merge multiple PPS presentations and save the combined slides as an ODP file in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPS files and save as ODP in Python" h2="Combine PPS presentations and save the merged slides as an OpenDocument Presentation with Aspose.Slides for Python via .NET. Microsoft PowerPoint is not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPS to ODP in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) lets you combine multiple PPS presentations by cloning slides from one presentation into another. The `SlideCollection.add_clone` method preserves the content and formatting of each cloned slide, including shapes, text, styles, comments, and animations. After merging the slides, you can save the destination `Presentation` as an ODP file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPS files to ODP using Python" %}}
Load one PPS file as the destination presentation, clone the slides from the other PPS file into it, and save the merged result in ODP format.

{{% blocks/products/pf/agp/code-block title="Python code to merge PPS files and save as ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPS files and save as ODP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPS files and save the result as ODP in Python." >}}
