---
title: Merge OTP to PPTX in Python
url: /python-net/merge/otp-to-pptx/
keywords: Merge OTP to PPTX, Join OTP to PPTX, Combine OTP to PPTX, PowerPoint, Presentation, Python
description: Merge OTP presentations and save the combined slides as a PPTX file with Aspose.Slides for Python via .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge OTP to PPTX in Python" h2="Combine OpenDocument presentation templates and save the merged slides as a PPTX file with Python" >}}

{{% blocks/products/pf/feature-page-section h2="Merge OTP to PPTX in Python" %}}
...
After the slides are combined, call `Presentation.save` with `SaveFormat.PPTX` to create a PowerPoint Open XML presentation. Microsoft PowerPoint and OpenOffice are not required.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge OTP files to PPTX using Python" %}}
Load the destination and source OTP files, clone each source slide into the destination presentation, and save the result as PPTX.

{{% blocks/products/pf/agp/code-block title="Python code for merging OTP files into PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge OTP to PPTX using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to merge OTP files and save the result as PPTX in Python." >}}
