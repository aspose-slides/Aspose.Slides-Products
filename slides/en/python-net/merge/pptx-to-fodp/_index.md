---
title: Merge PPTX Files to FODP Using Python
url: /python-net/merge/pptx-to-fodp/
keywords: Merge PPTX to FODP, Join PPTX to FODP, Combine PPTX to FODP, PowerPoint, Presentation, FODP, Python, Aspose
description: Merge multiple PPTX files and export the combined presentation to FODP in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPTX Files and Export Them to FODP in Python" h2="Build cross-platform Python applications that merge, inspect, create, and convert Microsoft PowerPoint and OpenDocument presentations without installing Microsoft PowerPoint or OpenOffice." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPTX to FODP in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) is a presentation-processing library that can combine multiple PPTX files. To merge presentations, clone each slide from a source presentation into a destination presentation. The cloned slides retain their content, layouts, formatting, shapes, comments, and animations. You can then export the combined presentation to the Flat OpenDocument Presentation (FODP) format.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPTX files to FODP using Python" %}}
Open the destination and source presentations, clone each source slide into the destination presentation, and save the merged result in FODP format.

{{% blocks/products/pf/agp/code-block title="Python code to merge multiple PPTX files into one FODP presentation" offSpacer="true" %}}
...
with slides.Presentation("presentation1.pptx") as destination_presentation:
    ...
    destination_presentation.save("merged.fodp", slides.export.SaveFormat.FODP)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPTX to FODP using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPTX files and export the result to FODP in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `save` with `SaveFormat.FODP` to export the merged presentation as one FODP file.
{{% /blocks/products/pf/agp/step-autogen %}}
