...
title: Merge FODP Files and Export to TIFF Using Python
url: /python-net/merge/fodp-to-tiff/
keywords: Merge FODP to TIFF, Join FODP to TIFF, Combine FODP to TIFF, PowerPoint, Presentation, TIFF, Python, Aspose
description: Merge multiple FODP presentations in Python and export the result as a multi-page TIFF image.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge FODP Files and Export to TIFF in Python" h2="Combine Flat OpenDocument Presentation files and export the merged slides as a multi-page TIFF image with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge FODP to TIFF in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge FODP files to TIFF using Python" %}}
Open the destination and source FODP presentations, append a clone of each source slide, and export the merged presentation as a multi-page TIFF image.

{{% blocks/products/pf/agp/code-block title="Python code for merging FODP files into a multi-page TIFF image" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge FODP files and export to TIFF with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two FODP files and export the result as a multi-page TIFF image." >}}
