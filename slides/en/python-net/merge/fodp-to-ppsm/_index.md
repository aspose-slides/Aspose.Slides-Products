---
title: Merge FODP Files and Save as PPSM Using Python
url: /python-net/merge/fodp-to-ppsm/
keywords: Merge FODP to PPSM, Join FODP to PPSM, Combine FODP to PPSM, PowerPoint, Presentation, PPSM, Python, Aspose
description: Merge multiple FODP presentations in Python and save the result as a single PPSM file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge FODP Files and Save as PPSM in Python" h2="Combine Flat OpenDocument Presentation files and save the merged presentation as PPSM with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge FODP to PPSM in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge Flat OpenDocument Presentation (FODP) files by cloning slides from one presentation into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.PPSM` to write the merged presentation as a macro-enabled PowerPoint slide show.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge FODP files to PPSM using Python" %}}
Open the destination and source FODP presentations, append a clone of each source slide, and save the merged presentation as a single PPSM file.

{{% blocks/products/pf/agp/code-block title="Python code for merging FODP files into a single PPSM slide show" offSpacer="true" %}}
...
with slides.Presentation("destination.fodp") as destination_presentation:
    ...
    destination_presentation.save("merged-presentation.ppsm", slides.export.SaveFormat.PPSM)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to merge FODP files and save as PPSM with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two FODP files and save the result as a single PPSM slide show." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.PPSM` to write the merged presentation as a single PPSM file.
{{% /blocks/products/pf/agp/step-autogen %}}
