...
{{% blocks/products/pf/agp/code-block title="Python code for merge multiple PPT into single file" offSpacer="true" %}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to merge two PPT files and save result as PPT in Python." >}}
