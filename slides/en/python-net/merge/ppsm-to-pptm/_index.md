...
title: Merge PPSM Files into PPTM Using Python
...
description: Merge multiple PPSM slide shows in Python and save the result as a single PPTM presentation.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPSM Files into PPTM in Python" h2="Combine PowerPoint Macro-Enabled Show files and save the merged slides as a PPTM presentation with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPSM to PPTM in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge PowerPoint Macro-Enabled Show (PPSM) files by cloning slides from one `Presentation` into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.PPTM` to save the merged slides as a PowerPoint Macro-Enabled Presentation (PPTM) file. Cloning slides does not merge VBA projects from the source files.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPSM Files into PPTM Using Python" %}}
Open the destination and source PPSM slide shows, append a clone of each source slide, and save the merged slides as a PPTM presentation.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPSM files into a single PPTM presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PPSM Files into PPTM with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPSM files and save the result as a single PPTM presentation." >}}
