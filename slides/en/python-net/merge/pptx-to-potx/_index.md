---
title: Merge PPTX Files to POTX in Python
url: /python-net/merge/pptx-to-potx/
keywords: Merge PPTX to POTX, Join PPTX to POTX, Combine PPTX to POTX, PowerPoint, Presentation, POTX, Python, Aspose
description: Merge multiple PPTX files into one POTX file using Python and Aspose.Slides.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPTX Files into POTX in Python" h2="Combine PowerPoint presentations and save the result as a POTX file with a fast, cross-platform Python API. Microsoft PowerPoint is not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPTX to POTX in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) is a Python library for creating, editing, and converting presentation files. To merge `PPTX` presentations, clone each slide from a source `Presentation` into a destination presentation by calling [`add_clone`](https://reference.aspose.com/slides/python-net/aspose.slides/slidecollection/add_clone/) on its `slides` collection. Cloned slides retain their shapes, styles, text, formatting, comments, and animations. The combined presentation can then be saved as a `POTX` file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPTX files to POTX using Python" %}}
Clone each slide from the source presentation into the destination presentation, then save the combined presentation in `POTX` format.

{{% blocks/products/pf/agp/code-block title="Python code to merge multiple PPTX files into one POTX file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPTX to POTX using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPTX files and save the result as POTX in Python." >}}
