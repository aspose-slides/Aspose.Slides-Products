---
title: Merge ODP Files into XPS Using Python
url: /python-net/merge/odp-to-xps/
keywords: Merge ODP to XPS, Join ODP to XPS, Combine ODP to XPS, PowerPoint, Presentation, XPS, Python, Aspose
description: Merge multiple ODP presentations in Python and export the result as a single XPS document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge ODP Files into XPS in Python" h2="Combine OpenDocument Presentation files and save the merged slides as an XPS document with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge ODP to XPS in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge ODP Files to XPS Using Python" %}}
Open the destination and source ODP presentations, append a clone of each source slide, and export the merged presentation as an XPS document.

{{% blocks/products/pf/agp/code-block title="Python code for merging ODP files into a single XPS document" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge ODP Files into XPS with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two ODP files and export the result as a single XPS document." >}}
