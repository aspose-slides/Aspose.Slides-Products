...
title: Merge POT Files and Export to TIFF Using Python
url: /python-net/merge/pot-to-tiff/
keywords: Merge POT to TIFF, Join POT to TIFF, Combine POT to TIFF, PowerPoint, Presentation, TIFF, Python, Aspose
description: Merge multiple POT presentation templates in Python and export the combined presentation to TIFF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POT Files and Export to TIFF in Python" h2="Combine PowerPoint template files and export the merged presentation to TIFF with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge POT to TIFF in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge Microsoft PowerPoint 97–2003 Template (POT) files by cloning slides from a source `Presentation` into a destination `Presentation`. Append each source slide with `SlideCollection.add_clone`, then call `Presentation.save` with `SaveFormat.TIFF` to render the combined presentation as a multipage TIFF image.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge POT Files to TIFF Using Python" %}}
Open the destination and source POT files, append a clone of each source slide, and render the merged presentation as a multipage TIFF image.

{{% blocks/products/pf/agp/code-block title="Python code for merging POT files and exporting the result to TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POT Files and Export to TIFF with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POT files and export the combined presentation to TIFF." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.TIFF` to render the merged presentation as a multipage TIFF image.
{{% /blocks/products/pf/agp/step-autogen %}}
