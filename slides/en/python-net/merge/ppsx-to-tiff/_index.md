---
title: Merge PPSX Files to TIFF Using Python
url: /python-net/merge/ppsx-to-tiff/
keywords: Merge PPSX to TIFF, Join PPSX to TIFF, Combine PPSX to TIFF, PowerPoint, Presentation, TIFF, Python, Aspose
description: Merge multiple PPSX files and save the combined presentation as TIFF in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPSX files into TIFF in Python" h2="Use a fast, cross-platform Python API to create, merge, inspect, and convert Microsoft PowerPoint and OpenDocument presentations without installing Microsoft PowerPoint or OpenOffice." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPSX to TIFF in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) is a Python library for creating, editing, and converting presentation files. To combine PPSX presentations, clone the slides from each source presentation into a destination presentation. The cloned slides retain their content and formatting, and the merged presentation can be saved as a multipage TIFF image.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPSX files to TIFF using Python" %}}
Clone the slides from the source PPSX presentation into the destination presentation, and then save the result as a multipage TIFF image.

{{% blocks/products/pf/agp/code-block title="Python code to merge multiple PPSX files into one TIFF file" offSpacer="true" %}}
...
with slides.Presentation("presentation1.ppsx") as destination_presentation:
    ...
    destination_presentation.save("presentation.tiff", slides.export.SaveFormat.TIFF)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPSX to TIFF using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPSX files and save the result as TIFF in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `save` with `SaveFormat.TIFF` to write the merged presentation to a multipage TIFF file.
{{% /blocks/products/pf/agp/step-autogen %}}
