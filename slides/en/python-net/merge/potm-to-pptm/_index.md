---
title: Merge POTM Files and Save as PPTM Using Python
url: /python-net/merge/potm-to-pptm/
keywords: Merge POTM to PPTM, Join POTM to PPTM, Combine POTM to PPTM, PowerPoint, Presentation, PPTM, Python, Aspose
description: Merge multiple POTM presentation files in Python and save the combined presentation as a single PPTM file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POTM Files and Save as PPTM in Python" h2="Combine macro-enabled PowerPoint template files and save the merged presentation as PPTM with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge POTM to PPTM in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge PowerPoint Macro-Enabled Template (POTM) files by cloning slides from one `Presentation` into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.PPTM` to write the merged presentation as a PowerPoint Macro-Enabled Presentation (PPTM) file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge POTM Files to PPTM Using Python" %}}
Open the destination and source POTM files, append a clone of each source slide, and save the merged presentation as a PPTM file.

{{% blocks/products/pf/agp/code-block title="Python code for merging POTM files and saving the result as PPTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POTM Files and Save as PPTM with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POTM files and save the result as a single PPTM file." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.PPTM` to write the merged presentation as a single PPTM file.
{{% /blocks/products/pf/agp/step-autogen %}}
