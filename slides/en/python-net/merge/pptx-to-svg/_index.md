---
title: Merge PPTX Files and Export to SVG Using Python
url: /python-net/merge/pptx-to-svg/
keywords: Merge PPTX to SVG, Join PPTX to SVG, Combine PPTX to SVG, PowerPoint, Presentation, SVG, Python, Aspose
description: Merge multiple PPTX presentations in Python and export each slide as a separate SVG image.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPTX Files and Export to SVG in Python" h2="Combine PowerPoint presentations and render the merged slides as SVG images with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPTX to SVG in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge PowerPoint Open XML Presentation (`PPTX`) files by cloning slides from one presentation into another. After combining the slides with `SlideCollection.add_clone`, call `Slide.write_as_svg` to export each merged slide as a separate `SVG` image.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPTX files to SVG using Python" %}}
Open the destination and source `PPTX` presentations, append a clone of each source slide, and render every slide in the merged presentation as a separate `SVG` image.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPTX files and exporting the slides as SVG images" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPTX files and export to SVG with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPTX files and export the merged slides as SVG images." >}}
