---
title: Merge PPSM Files and Export to PDF Using Python
...
description: Merge multiple PPSM presentation files in Python and export the result as a PDF document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPSM Files and Export to PDF in Python" h2="Combine macro-enabled PowerPoint Slide Show files and export the merged presentation as a PDF document with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPSM to PDF in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge PowerPoint Macro-Enabled Slide Show (PPSM) files by cloning slides from one `Presentation` into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.PDF` to export the merged presentation as a PDF document.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPSM Files to PDF Using Python" %}}
Open the destination and source PPSM files, append a clone of each source slide, and save the merged presentation as a PDF document.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPSM files into a PDF document" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PPSM Files and Export to PDF with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPSM files and export the result as a PDF document." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.PDF` to write the merged presentation as a PDF document.
{{% /blocks/products/pf/agp/step-autogen %}}
