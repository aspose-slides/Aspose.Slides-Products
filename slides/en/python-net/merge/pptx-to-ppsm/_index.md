...
title: Merge PPTX Files into PPSM Using Python
url: /python-net/merge/pptx-to-ppsm/
keywords: Merge PPTX to PPSM, Join PPTX to PPSM, Combine PPTX to PPSM, PowerPoint, Presentation, PPSM, Python, Aspose
description: Merge multiple PPTX presentations in Python and save the result as a single PPSM file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPTX Files into PPSM in Python" h2="Combine PowerPoint presentations and save the merged slides as a macro-enabled slide show with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPTX to PPSM in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge PowerPoint Open XML Presentation (`PPTX`) files by cloning slides from one presentation into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.PPSM` to write the merged presentation in the macro-enabled PowerPoint slide show format.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPTX files to PPSM using Python" %}}
Open the destination and source `PPTX` presentations, append a clone of each source slide, and save the merged presentation as a single `PPSM` file.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPTX files into a single PPSM presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPTX files into PPSM with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPTX files and save the result as a single PPSM presentation." >}}
