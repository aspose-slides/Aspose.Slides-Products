---
title: Merge PPTM Files and Export Slides to BMP Using Python
...
description: Merge multiple PPTM files and export each slide from the combined presentation as a BMP image in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPTM files and export slides to BMP in Python" h2="Combine macro-enabled PowerPoint presentations and render the merged slides as BMP images with Aspose.Slides for Python via .NET. Microsoft PowerPoint and OpenOffice are not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPTM to BMP in Python" %}}

[**Aspose.Slides for Python via .NET**](/slides/python-net/) lets you merge PPTM presentations by cloning slides from a source `Presentation` into a destination `Presentation`. After the merge, call `Slide.get_image` for each slide and save the rendered image with `ImageFormat.BMP`. The result is one static BMP file per slide.
...
{{% blocks/products/pf/agp/code-block title="Python code to merge PPTM files and export slides as BMP images" offSpacer="true" %}}
...
with slides.Presentation("presentation1.pptm") as destination_presentation:
    ...
    for slide in destination_presentation.slides:
        file_path = f"merged_presentation_slide_{slide.slide_number}.bmp"
...
{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPTM files and export the combined slides as BMP images in Python." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Render each merged slide with [`Slide.get_image`](https://reference.aspose.com/slides/python-net/aspose.slides/slide/get_image/) and save it with `ImageFormat.BMP`.
{{% /blocks/products/pf/agp/step-autogen %}}
