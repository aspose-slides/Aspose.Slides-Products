...
description: Merge multiple POTX presentation templates in Python and export the combined slides to SVG files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge POTX Files and Export Slides to SVG in Python" h2="Combine PowerPoint template files and export each merged slide to SVG with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge POTX to SVG in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge POTX Files and Export Slides to SVG Using Python" %}}
Open the destination and source POTX files, append a clone of each source slide, and export every slide in the merged presentation as a separate SVG file.

{{% blocks/products/pf/agp/code-block title="Python code for merging POTX files and exporting the slides to SVG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge POTX Files and Export Slides to SVG with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two POTX files and export the combined slides to SVG." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Iterate through the merged slides and call [`Slide.write_as_svg`](https://reference.aspose.com/slides/python-net/aspose.slides/islide/write_as_svg/) to write each slide to a separate SVG file.
{{% /blocks/products/pf/agp/step-autogen %}}
