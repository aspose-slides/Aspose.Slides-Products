---
title: Merge ODP Files and Export to PNG Using Python
url: /python-net/merge/odp-to-png/
keywords: Merge ODP to PNG, Join ODP to PNG, Combine ODP to PNG, PowerPoint, Presentation, PNG, Python, Aspose
description: Merge multiple ODP presentations in Python and export each slide as a PNG image.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge ODP Files and Export to PNG in Python" h2="Combine OpenDocument Presentation files and render the merged slides as PNG images with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge ODP to PNG in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge ODP Files to PNG Using Python" %}}
Open the destination and source ODP presentations, append a clone of each source slide, and render every slide in the merged presentation as a separate PNG image.

{{% blocks/products/pf/agp/code-block title="Python code for merging ODP files and exporting the slides as PNG images" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge ODP Files and Export to PNG with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two ODP files and export the merged slides as PNG images." >}}
