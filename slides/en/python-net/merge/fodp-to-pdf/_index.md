---
title: Merge FODP Files and Export to PDF Using Python
url: /python-net/merge/fodp-to-pdf/
keywords: Merge FODP to PDF, Join FODP to PDF, Combine FODP to PDF, PowerPoint, Presentation, PDF, Python, Aspose
description: Merge multiple FODP presentations in Python and export the result as a single PDF document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge FODP Files and Export to PDF in Python" h2="Combine Flat OpenDocument Presentation files and export the merged slides as a PDF document with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge FODP to PDF in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge Flat OpenDocument Presentation (FODP) files by cloning slides from one presentation into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.PDF` to export the merged slides as a single PDF document.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge FODP files to PDF using Python" %}}
Open the destination and source FODP presentations, append a clone of each source slide, and export the merged presentation as a single PDF document.

{{% blocks/products/pf/agp/code-block title="Python code for merging FODP files into a single PDF document" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge FODP files and export to PDF with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two FODP files and export the result as a single PDF document." >}}
