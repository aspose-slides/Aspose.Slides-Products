...
description: Merge multiple PPTX presentations in Python and save the result as a single ODP file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPTX Files and Save as ODP in Python" h2="Combine PowerPoint presentations and save the merged presentation as ODP with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPTX to ODP in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge PowerPoint PPTX files by cloning slides from one presentation into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.ODP` to write the merged presentation as an OpenDocument Presentation file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge PPTX files to ODP using Python" %}}
Open the destination and source PPTX presentations, append a clone of each source slide, and save the merged presentation as a single ODP file.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPTX files into a single ODP presentation" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPTX files and save as ODP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPTX files and save the result as a single ODP presentation." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.ODP` to write the merged presentation as a single ODP file.
{{% /blocks/products/pf/agp/step-autogen %}}
