...
title: Merge PPSX Files Using Python
url: /python-net/merge/ppsx/
keywords: Merge PPSX, Join PPSX, Combine PPSX, PowerPoint, Presentation, Python, Aspose
description: Merge multiple PPSX files into one PowerPoint slide show in Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPSX files in Python" h2="Combine multiple PPSX slide shows into one file with Aspose.Slides for Python via .NET. Microsoft PowerPoint and OpenOffice are not required." >}}

{{% blocks/products/pf/feature-page-section h2="Merge PPSX in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge PPSX files using Python" %}}
Clone each source slide with `add_clone`, then call `save` with `SaveFormat.PPSX`.

{{% blocks/products/pf/agp/code-block title="Python code to merge multiple PPSX files" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPSX using Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPSX files and save the result as PPSX in Python." >}}
