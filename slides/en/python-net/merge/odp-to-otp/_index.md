...
title: Merge ODP Files and Save as OTP Using Python
url: /python-net/merge/odp-to-otp/
keywords: Merge ODP to OTP, Join ODP to OTP, Combine ODP to OTP, PowerPoint, Presentation, OTP, Python, Aspose
description: Merge multiple ODP presentations in Python and save the result as a single OTP file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge ODP Files and Save as OTP in Python" h2="Combine OpenDocument Presentation files and save the merged presentation as OTP with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge ODP to OTP in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Merge ODP Files to OTP Using Python" %}}
Open the destination and source ODP presentations, append a clone of each source slide, and save the merged presentation as a single OTP file.

{{% blocks/products/pf/agp/code-block title="Python code for merging ODP files into a single OTP presentation template" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge ODP Files and Save as OTP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two ODP files and save the result as a single OTP presentation template." >}}
