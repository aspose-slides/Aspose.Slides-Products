...
title: Merge FODP Files and Export to XPS Using Python
url: /python-net/merge/fodp-to-xps/
keywords: Merge FODP to XPS, Join FODP to XPS, Combine FODP to XPS, PowerPoint, Presentation, XPS, Python, Aspose
description: Merge multiple FODP presentations in Python and export the result as a single XPS document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge FODP Files and Export to XPS in Python" h2="Combine Flat OpenDocument Presentation files and export the merged slides as an XPS document with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Merge FODP to XPS in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you merge Flat OpenDocument Presentation (FODP) files by cloning slides from one presentation into another. After combining the slides with `SlideCollection.add_clone`, call `Presentation.save` with `SaveFormat.XPS` to export the merged slides as a single XPS document.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Merge FODP files to XPS using Python" %}}
Open the destination and source FODP presentations, append a clone of each source slide, and export the merged presentation as an XPS document.

{{% blocks/products/pf/agp/code-block title="Python code for merging FODP files into a single XPS document" offSpacer="true" %}}
...
with slides.Presentation("destination.fodp") as destination_presentation:
    ...
    destination_presentation.save("merged-presentation.xps", slides.export.SaveFormat.XPS)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to merge FODP files and export to XPS with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two FODP files and export the result as a single XPS document." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save` with `SaveFormat.XPS` to export the merged slides as a single XPS document.
{{% /blocks/products/pf/agp/step-autogen %}}
