...
description: Merge multiple PPSM presentation files in Python and export the result as an FODP document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge PPSM Files and Export to FODP in Python" h2="Combine macro-enabled PowerPoint Slide Show files and export the merged presentation as a Flat OpenDocument Presentation with a cross-platform Python API" >}}
...
Open the destination and source PPSM files, append a clone of each source slide, and save the merged presentation as an FODP document.

{{% blocks/products/pf/agp/code-block title="Python code for merging PPSM files into an FODP document" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Merge PPSM Files and Export to FODP with Aspose.Slides for Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to merge two PPSM files and export the result as an FODP document." >}}
