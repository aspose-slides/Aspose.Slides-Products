...
{{< blocks/products/pf/feature-page-section  h2="How to Extract Text from PPTX with Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to extract text from a PPTX file." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/slides/python-net/parser/odp/" name="ODP" >}}
