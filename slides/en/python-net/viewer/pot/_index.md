...
description: Open a POT presentation template in Python and export it to responsive HTML for viewing in a browser.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View POT in Python" h2="Use a cross-platform Python API to open POT files and export them for viewing in a browser" >}}
...
With [Aspose.Slides for Python via .NET](/slides/python-net/), you can load a POT presentation template and export it to responsive HTML for viewing in a web browser.
...
{{< blocks/products/pf/agp/step-autogen >}}
Ensure that the source POT file is accessible to your application.
{{< /blocks/products/pf/agp/step-autogen >}}
