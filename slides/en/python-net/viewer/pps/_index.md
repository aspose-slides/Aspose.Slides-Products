...
description: View PPS in Python. Use Python library API to open and view PowerPoint Slideshow
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View PPS in Python" h2="Powerful cross-platform Python API for opening and viewing PPS using Python code" >}}
...
pres = slides.Presentation("presentation.pps")
