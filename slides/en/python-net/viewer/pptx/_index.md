...
description: Open a PPTX presentation in Python and export it to responsive HTML for viewing in a browser.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View PPTX in Python" h2="Use a cross-platform Python API to open PPTX files and export them for viewing in a browser" >}}
...
With [Aspose.Slides for Python via .NET](/slides/python-net/), you can load a PPTX presentation and export it to responsive HTML for viewing in a web browser.
