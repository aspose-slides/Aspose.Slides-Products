...
keywords: View PPSM, View Macro-enabled PowerPoint Template, Open PPSM, PPSM Viewer, PPSM, PowerPoint, Python API, Python Library
description: View PPSM in Python. Use Python library API to open and view Macro-enabled PowerPoint Template
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View PPSM in Python" h2="Powerful cross-platform Python API for opening and viewing PPSM using Python code" >}}
...
pres = slides.Presentation("presentation.ppsm")
