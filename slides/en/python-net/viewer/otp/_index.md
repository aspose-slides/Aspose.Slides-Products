...
description: View OTP in Python. Use Python library API to open and view OpenOffice presentation
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View OTP in Python" h2="Powerful cross-platform Python API for opening and viewing OTP using Python" >}}
...
pres = slides.Presentation("presentation.otp")
