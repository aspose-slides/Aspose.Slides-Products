...
description: View POTM in Python. Use Python library API to open and view Macro-enabled PowerPoint Template
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View POTM in Python" h2="Powerful cross-platform Python API for opening and viewing POTM using Python code" >}}
...
pres = slides.Presentation("presentation.potm")
