...
description: Open a macro-enabled POTM presentation template in Python and export it to responsive HTML for viewing in a browser.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View POTM in Python" h2="Use a cross-platform Python API to open POTM files and export them for viewing in a browser" >}}
...
{{% blocks/products/pf/feature-page-section  h2="View POTM in Python" %}}
With [Aspose.Slides for Python via .NET](/slides/python-net/), you can load a macro-enabled POTM presentation template and export it to responsive HTML for viewing in a web browser.

{{% blocks/products/pf/agp/code-block title="Python code for viewing POTM" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="How to view POTM in Python" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Ensure that the source POTM file is accessible to your application.
{{< /blocks/products/pf/agp/step-autogen >}}
