...
keywords: View PPTM, View Macro-enabled PowerPoint Template, Open PPTM, PPTM Viewer, PPTM, PowerPoint, Python API, Python Library
description: View PPTM in Python. Use Python library API to open and view Macro-enabled PowerPoint Template
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View PPTM in Python" h2="Powerful cross-platform Python API for opening and viewing PPTM using Python code" >}}
...
pres = slides.Presentation("presentation.pptm")
