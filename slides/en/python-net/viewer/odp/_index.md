...
{{< blocks/products/pf/feature-page-header h1="View ODP in Python" h2="Use a cross-platform Python API to open ODP files and export them for viewing in a browser" >}}
...
With [Aspose.Slides for Python via .NET](/slides/python-net/), you can load an ODP presentation and export it to responsive HTML for viewing in a web browser.
...
{{< blocks/products/pf/agp/step-autogen >}}
Ensure that the source ODP file is accessible to your application.
{{< /blocks/products/pf/agp/step-autogen >}}
