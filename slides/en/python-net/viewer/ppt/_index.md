...
description: Open a PPT presentation in Python and export it to responsive HTML for viewing in a browser.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View PPT in Python" h2="Use a cross-platform Python API to open PPT files and export them for viewing in a browser" >}}
...
With [Aspose.Slides for Python via .NET](/slides/python-net/), you can load a PPT presentation and export it to responsive HTML for viewing in a web browser.
...
{{< blocks/products/pf/agp/step-autogen >}}
Ensure that the source PPT file is accessible to your application.
{{< /blocks/products/pf/agp/step-autogen >}}
