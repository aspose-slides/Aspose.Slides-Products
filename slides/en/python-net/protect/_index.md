...
title: Protect PowerPoint and OpenDocument Presentations with Python
url: /python-net/protect/
description: Encrypt or set write protection on PowerPoint and OpenDocument presentations with Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Protect PowerPoint and OpenDocument Presentations with Python" h2="Build Python applications that encrypt presentations or set write protection with Aspose.Slides." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" >}}

{{< blocks/products/pf/main-container >}}

{{< blocks/products/pf/product-card-row title="Presentation Protection Code Samples" >}}
...
Learn how to encrypt an ODP presentation or set write protection with Aspose.Slides for Python via .NET.
...
Learn how to encrypt a PPT presentation or set write protection with Aspose.Slides for Python via .NET.
{{< /blocks/products/pf/product >}}
...
Learn how to encrypt a PPTX presentation or set write protection with Aspose.Slides for Python via .NET.
{{< /blocks/products/pf/product >}}
