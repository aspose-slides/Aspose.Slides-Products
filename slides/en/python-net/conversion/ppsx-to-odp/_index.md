...
[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you convert a PowerPoint Open XML Slide Show in PPSX format to an OpenDocument Presentation in ODP format. Load the PPSX file into a `Presentation` instance and save it by using `SaveFormat.ODP`.
...
{{% blocks/products/pf/agp/code-block title="Convert PPSX to ODP in Python" offSpacer="" %}}
...
Use the free [online conversion app](https://products.aspose.app/slides/conversion) to see the PPSX-to-ODP conversion process in action.
{{% /blocks/products/pf/agp/content %}}
