...
description: Convert PPS slide shows to PPTX presentations in Python. Use the Aspose.Slides Python API to save legacy slide shows as PowerPoint Open XML files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PPS to PPTX in Python" h2="Python API for converting PPS slide shows to PPTX presentations" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you convert PPS slide shows to PPTX presentations programmatically. Load the source file into a `Presentation` instance and export it by using `Presentation.save` with `SaveFormat.PPTX`.

PPTX is the modern PowerPoint Open XML presentation format and is suitable for editing and sharing. Microsoft PowerPoint is not required. You can also test the conversion in your [browser](https://products.aspose.app/slides/conversion).
...
{{< blocks/products/pf/agp/step-autogen >}}
The converted PPTX presentation is written to the specified path.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to convert PPS to PPTX in Python" offSpacer="" %}}
...
Use the [free online app](https://products.aspose.app/slides/conversion) to see the PPS-to-PPTX conversion process in action.
{{% /blocks/products/pf/agp/content %}}
