...
description: Convert POTM presentation templates to POTX files in Python. Use the Aspose.Slides Python API to save macro-free Open XML templates.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert POTM to POTX in Python" h2="Python API for converting POTM templates to POTX files" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you convert POTM presentation templates to POTX files programmatically. Load the template and call `Presentation.save` with `SaveFormat.POTX`.
...
{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to convert a POTM file to POTX using Python." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to convert POTM to POTX in Python" offSpacer="" %}}
...
Use the [free online app](https://products.aspose.app/slides/conversion) to see the POTM-to-POTX conversion process in action.
{{% /blocks/products/pf/agp/content %}}
