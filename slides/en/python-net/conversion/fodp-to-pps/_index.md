---
title: Convert FODP to PPS in Python
weight: 130
url: /python-net/conversion/fodp-to-pps/
keywords: "Convert, PowerPoint, FODP, PPS, Presentation, Python"
description: Convert FODP presentations to PPS files in Python. Use the Aspose.Slides Python API to save presentations as PowerPoint 97-2003 slide shows.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert FODP to PPS in Python" h2="Python API for converting FODP presentations to PPS files" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert FODP to PPS in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you convert FODP presentations to PPS files programmatically. Load the source file into a `Presentation` instance and save it by using `Presentation.save` with `SaveFormat.PPS`.

PPS is the binary PowerPoint 97-2003 slide show format. It opens directly in slide show mode in compatible presentation applications. You can test the conversion in your [browser](https://products.aspose.app/slides/conversion) or use the Python API in your application.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert FODP to PPS in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an FODP file to PPS using Python." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to convert FODP to PPS in Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save FODP as PPS in Python" %}}
Use the [free online app](https://products.aspose.app/slides/conversion) to see the FODP-to-PPS conversion process in action.
{{% /blocks/products/pf/agp/content %}}
