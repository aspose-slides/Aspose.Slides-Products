...
description: Convert PPSX slide shows to BMP images in Python. Use the Aspose.Slides Python API to render each slide as a BMP file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PPSX to BMP in Python" h2="Python API for converting PPSX slide shows to BMP images" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you convert PPSX slide shows to BMP images programmatically. Load the presentation, render each slide with `Slide.get_image`, and save the resulting `IImage` object in BMP format.

The API preserves slide content and formatting during rendering. You can test the conversion in your [browser](https://products.aspose.app/slides/conversion/ppsx-to-bmp) or use the Python API to process slide shows in your application.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to convert PPSX to BMP in Python" offSpacer="" %}}
...
Use the [free online app](https://products.aspose.app/slides/conversion/ppsx-to-bmp) to see the PPSX-to-BMP conversion process in action.
{{% /blocks/products/pf/agp/content %}}
