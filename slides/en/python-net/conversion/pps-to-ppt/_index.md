...
description: Convert PPS files to PPT in Python with Aspose.Slides. See a concise code example and the requirements for PowerPoint presentation conversion.
---
...
Convert PPS files to PPT programmatically with [*Aspose.Slides for Python via .NET*](/slides/python-net/). Load the source slide show and save it as a PowerPoint 97–2003 presentation with a few lines of Python code.

Aspose.Slides processes the presentation directly, so Microsoft PowerPoint is not required. You can also evaluate PPS-to-PPT conversion in your [browser](https://products.aspose.app/slides/conversion) or use the API to save PPS files in many other supported formats.
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save`, passing the output file path and `SaveFormat.PPT`.
{{% /blocks/products/pf/agp/step-autogen %}}

{{< blocks/products/pf/agp/step-autogen >}}
The converted PPT file is written to the specified path.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Python example: Convert PPS to PPT" offSpacer="" %}}
...
Try the free [Aspose.Slides Conversion app](https://products.aspose.app/slides/conversion) to see PPS-to-PPT conversion in action.
{{% /blocks/products/pf/agp/content %}}
