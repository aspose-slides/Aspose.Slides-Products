...
title: Convert FODP to SWF in Python
weight: 200
url: /python-net/conversion/fodp-to-swf/
keywords: "Convert, PowerPoint, FODP, SWF, Presentation, Python"
description: Convert FODP presentations to SWF files in Python. Use the Aspose.Slides Python API to export presentations to the legacy Flash format.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert FODP to SWF in Python" h2="Python API for converting FODP presentations to SWF files" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert FODP to SWF in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you convert FODP presentations to SWF files programmatically. Load the source file into a `Presentation` instance and export it by using `Presentation.save` with `SaveFormat.SWF`.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert FODP to SWF in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an FODP file to SWF using Python." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to convert FODP to SWF in Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save FODP as SWF in Python" %}}
Use the [free online app](https://products.aspose.app/slides/conversion) to see the FODP-to-SWF conversion process in action.
{{% /blocks/products/pf/agp/content %}}
