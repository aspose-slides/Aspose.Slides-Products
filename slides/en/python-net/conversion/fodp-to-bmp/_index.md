...
description: Convert FODP presentations to BMP images in Python. Use the Aspose.Slides Python API to render each slide as a BMP file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert FODP to BMP in Python" h2="Python API for converting FODP presentations to BMP images" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you convert FODP presentations to BMP images programmatically. Load the presentation, render each slide with `Slide.get_image`, and save the resulting `IImage` object in BMP format.
...
{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an FODP file to BMP using Python." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to convert FODP to BMP in Python" offSpacer="" %}}
...
Use Aspose.Slides for Python via .NET to perform FODP-to-BMP conversion in your application.
{{% /blocks/products/pf/agp/content %}}
