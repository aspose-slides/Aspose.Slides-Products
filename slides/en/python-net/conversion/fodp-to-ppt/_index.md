...
weight: 160
url: /python-net/conversion/fodp-to-ppt/
keywords: "Convert, PowerPoint, FODP, PPT, Presentation, Python"
description: Convert FODP presentations to PPT files in Python. Use the Aspose.Slides Python API to export presentations to the legacy PowerPoint format.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert FODP to PPT in Python" h2="Python API for converting FODP presentations to legacy PPT files" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert FODP to PPT in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you convert FODP presentations to PPT files programmatically. Load the source file into a `Presentation` instance and export it by using `Presentation.save` with `SaveFormat.PPT`.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert FODP to PPT in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an FODP file to PPT using Python." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to convert FODP to PPT in Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save FODP as PPT in Python" %}}
Use the [free online app](https://products.aspose.app/slides/conversion) to see the FODP-to-PPT conversion process in action.
{{% /blocks/products/pf/agp/content %}}
