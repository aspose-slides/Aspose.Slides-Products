...
description: Convert HTML content to JPG images in Python. Use the Aspose.Slides Python API to import HTML and render each generated slide as a JPEG image.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert HTML to JPG in Python" h2="Import HTML content and render it as JPG images with a cross-platform Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Convert HTML to JPG in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you import HTML content into a presentation and render the resulting slides as JPG images. The API provides `SlideCollection.add_from_html` for importing HTML and `Slide.get_image` for rendering each slide.

The example below writes one JPEG file for each slide created from the HTML document. This workflow does not require Microsoft PowerPoint or another presentation application.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert HTML to JPG using Python" %}}
Create a `Presentation`, remove its default blank slide, import the HTML file, and render each generated `Slide` as a JPEG image.
...
with slides.Presentation() as presentation:
    ...
    for slide in presentation.slides:
        file_path = "slide_{}.jpg".format(slide.slide_number)
        with slide.get_image() as image:
            image.save(file_path, slides.ImageFormat.JPEG)
```
...
{{% blocks/products/pf/agp/step-autogen %}}
Access each imported `Slide`, call `Slide.get_image`, and save the result with `ImageFormat.JPEG`.
{{% /blocks/products/pf/agp/step-autogen %}}
