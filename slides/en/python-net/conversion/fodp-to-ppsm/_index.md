...
weight: 140
url: /python-net/conversion/fodp-to-ppsm/
keywords: "Convert, PowerPoint, FODP, PPSM, Presentation, Python"
description: Convert FODP presentations to PPSM files in Python. Use the Aspose.Slides Python API to save presentations as macro-enabled PowerPoint slide shows.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert FODP to PPSM in Python" h2="Python API for converting FODP presentations to PPSM files" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert FODP to PPSM in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you convert FODP presentations to PPSM files programmatically. Load the source file into a `Presentation` instance and save it by using `Presentation.save` with `SaveFormat.PPSM`.

PPSM is the macro-enabled PowerPoint Open XML slide show format. The format supports VBA macros, but converting an FODP file does not create any macros. You can test the conversion in your [browser](https://products.aspose.app/slides/conversion) or use the Python API in your application.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert FODP to PPSM in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an FODP file to PPSM using Python." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to convert FODP to PPSM in Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save FODP as PPSM in Python" %}}
Use the [free online app](https://products.aspose.app/slides/conversion) to see the FODP-to-PPSM conversion process in action.
{{% /blocks/products/pf/agp/content %}}
