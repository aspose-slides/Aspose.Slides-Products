...
description: Convert PPSX slide shows to PPS files in Python. Use the Aspose.Slides Python API to save presentations as PowerPoint 97-2003 slide shows.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PPSX to PPS in Python" h2="Python API for converting PPSX slide shows to PPS files" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you convert PPSX slide shows to PPS files programmatically. Load the source file into a `Presentation` instance and save it by using `Presentation.save` with `SaveFormat.PPS`.

PPS is the legacy PowerPoint 97-2003 slide show format. You can test the conversion in your [browser](https://products.aspose.app/slides/conversion) or use the Python API in your application.
...
{{% blocks/products/pf/agp/step-autogen %}}
The slide show is written to the specified PPS file.
{{% /blocks/products/pf/agp/step-autogen %}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to convert PPSX to PPS in Python" offSpacer="" %}}
...
Use the [free online app](https://products.aspose.app/slides/conversion) to see the PPSX-to-PPS conversion process in action.
{{% /blocks/products/pf/agp/content %}}
