...
weight: 90
url: /python-net/conversion/fodp-to-png/
keywords: "Convert, PowerPoint, FODP, PNG, Presentation, Python"
description: Convert FODP presentations to PNG images in Python. Use the Aspose.Slides Python API to render each slide as a PNG file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert FODP to PNG in Python" h2="Python API for converting FODP presentations to PNG images" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert FODP to PNG in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you convert FODP presentations to PNG images programmatically. Load the presentation, render each slide by using `Slide.get_image`, and save the resulting `IImage` object in PNG format.

The API renders every slide as a separate raster image.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert FODP to PNG in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an FODP file to PNG using Python." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to convert FODP to PNG in Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save FODP as PNG in Python" %}}
Use Aspose.Slides for Python via .NET to perform FODP-to-PNG conversion in your application.
{{% /blocks/products/pf/agp/content %}}
