...
description: Convert POTM macro-enabled presentation templates to HTML5 documents in Python. Use the Aspose.Slides Python API to export a POTM file as HTML5.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert POTM to HTML in Python" h2="Python API for converting POTM templates to HTML5 documents" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you convert POTM macro-enabled presentation templates to HTML5 documents programmatically. Load the POTM file into a `Presentation` instance and call `Presentation.save` with `SaveFormat.HTML5`.

The HTML5 output renders slide content in a browser without requiring Microsoft PowerPoint. You can test the conversion in your [browser](https://products.aspose.app/slides/conversion/potm-to-html) or use the Python API in your application.
...
{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to convert a POTM file to HTML using Python." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to convert POTM to HTML in Python" offSpacer="" %}}
...
Use the [free online app](https://products.aspose.app/slides/conversion/potm-to-html) to see the POTM-to-HTML conversion process in action.
{{% /blocks/products/pf/agp/content %}}
