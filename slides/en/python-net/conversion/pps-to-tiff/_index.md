...
[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you convert PPS slide shows to multipage TIFF images programmatically. Load the source file into a `Presentation` instance and export it by using `Presentation.save` with `SaveFormat.TIFF`.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to convert PPS to TIFF in Python" offSpacer="" %}}
...
Use the [free online app](https://products.aspose.app/slides/conversion) to see the PPS-to-TIFF conversion process in action.
{{% /blocks/products/pf/agp/content %}}
