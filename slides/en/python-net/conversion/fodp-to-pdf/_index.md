...
title: Convert FODP to PDF in Python
weight: 80
url: /python-net/conversion/fodp-to-pdf/
keywords: "Convert, PowerPoint, FODP, PDF, Presentation, Python"
description: Convert FODP presentations to PDF documents in Python. Use the Aspose.Slides Python API to export presentations to fixed-layout PDF files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert FODP to PDF in Python" h2="Python API for converting FODP presentations to PDF documents" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert FODP to PDF in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you convert FODP presentations to PDF documents programmatically. Load the source file into a `Presentation` instance and export it by using `Presentation.save` with `SaveFormat.PDF`.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert FODP to PDF in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an FODP file to PDF using Python." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to convert FODP to PDF in Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save FODP as PDF in Python" %}}
Use the [free online app](https://products.aspose.app/slides/conversion) to see the FODP-to-PDF conversion process in action.
{{% /blocks/products/pf/agp/content %}}
