...
description: Convert POTM macro-enabled presentation templates to EMF files in Python. Use the Aspose.Slides Python API to export each slide as an EMF file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert POTM to EMF in Python" h2="Python API for converting POTM templates to EMF files" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you convert POTM macro-enabled presentation templates to EMF files programmatically. Load the template, access each slide, and write its content to a binary stream with `Slide.write_as_emf`.

The API exports slide content as vector graphics suitable for scaling and further processing. You can test the conversion in your [browser](https://products.aspose.app/slides/conversion/potm-to-emf) or use the Python API in your application.
...
{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to convert a POTM file to EMF using Python." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to convert POTM to EMF in Python" offSpacer="" %}}
...
Use the [free online app](https://products.aspose.app/slides/conversion/potm-to-emf) to see the POTM-to-EMF conversion process in action.
{{% /blocks/products/pf/agp/content %}}
