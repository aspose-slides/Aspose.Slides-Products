...
description: Convert PPS files to PPTM in Python with Aspose.Slides. See a concise code example and the requirements for PowerPoint presentation conversion.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PPS to PPTM in Python" h2="Powerful Python library for converting PPS to PPTM" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
Convert PPS files to PPTM programmatically with [*Aspose.Slides for Python via .NET*](/slides/python-net/). Load the source slide show and save it as a macro-enabled PowerPoint presentation with a few lines of Python code.

Aspose.Slides processes the presentation directly, so Microsoft PowerPoint is not required. You can also evaluate PPS-to-PPTM conversion in your [browser](https://products.aspose.app/slides/conversion) or use the API to save PPS files in many other supported formats.
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `Presentation.save`, passing the output file path and `SaveFormat.PPTM`.
{{% /blocks/products/pf/agp/step-autogen %}}

{{< blocks/products/pf/agp/step-autogen >}}
The converted PPTM file is written to the specified path.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Python example: Convert PPS to PPTM" offSpacer="" %}}
...
Try the free [Aspose.Slides Conversion app](https://products.aspose.app/slides/conversion) to see PPS-to-PPTM conversion in action.
{{% /blocks/products/pf/agp/content %}}
