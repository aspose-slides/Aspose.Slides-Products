...
description: Convert images to PDF in Python. Use the Aspose.Slides Python API to place an image on a slide and export it as a PDF document.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert Image to PDF in Python" h2="Place an image on a slide and export it as PDF with a cross-platform Python API" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert an Image to PDF Using Python" %}}
Create a `Presentation`, add the source image to its first `Slide`, and save the presentation as a PDF document.

{{% blocks/products/pf/agp/code-block title="Python code for converting an image to PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Convert an Image to PDF Using the Aspose.Slides Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to convert an image to PDF in Python." >}}
