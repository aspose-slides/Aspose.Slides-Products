...
description: Convert POTM presentation templates to PPTM presentations in Python. Use the Aspose.Slides Python API to create macro-enabled Open XML output.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert POTM to PPTM in Python" h2="Python API for converting POTM templates to PPTM presentations" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you convert POTM presentation templates to PPTM presentations programmatically. Load the template and call `Presentation.save` with `SaveFormat.PPTM`.

PPTM is the macro-enabled Open XML presentation format used by modern versions of Microsoft PowerPoint. You can test the conversion in your [browser](https://products.aspose.app/slides/conversion) or use the Python API in your application.
...
{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to convert a POTM file to PPTM using Python." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to convert POTM to PPTM in Python" offSpacer="" %}}
...
Use the [free online app](https://products.aspose.app/slides/conversion) to see the POTM-to-PPTM conversion process in action.
{{% /blocks/products/pf/agp/content %}}
