...
description: Convert PPSX slide shows to HTML in Python. Use the Aspose.Slides Python API to publish PPSX files as HTML documents in batch.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PPSX to HTML in Python" h2="Python API for publishing PPSX slide shows as HTML documents" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you publish PPSX slide shows as HTML documents programmatically. Load the PPSX file into a `Presentation` instance and save it by using `SaveFormat.HTML`.
...
{{% blocks/products/pf/agp/code-block title="Convert PPSX to HTML in Python" offSpacer="" %}}
...
Use the free [online conversion app](https://products.aspose.app/slides/conversion) to see the PPSX-to-HTML conversion process in action.
{{% /blocks/products/pf/agp/content %}}
