...
weight: 60
url: /python-net/conversion/fodp-to-odp/
keywords: "Convert, PowerPoint, FODP, ODP, Presentation, Python"
description: Convert FODP presentations to ODP files in Python. Use the Aspose.Slides Python API to save presentations in OpenDocument Presentation format.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert FODP to ODP in Python" h2="Python API for converting FODP presentations to ODP files" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert FODP to ODP in Python" %}}

[*Aspose.Slides for Python via .NET*](/slides/python-net/) lets you convert FODP presentations to ODP files programmatically. Load the source file into a `Presentation` instance and save it by using `Presentation.save` with `SaveFormat.ODP`.

FODP stores OpenDocument presentation content as flat XML, while ODP stores the same type of presentation in a packaged OpenDocument file. You can test the conversion in your [browser](https://products.aspose.app/slides/conversion) or use the Python API in your application.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert FODP to ODP in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an FODP file to ODP using Python." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to convert FODP to ODP in Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save FODP as ODP in Python" %}}
Use the [free online app](https://products.aspose.app/slides/conversion) to see the FODP-to-ODP conversion process in action.
{{% /blocks/products/pf/agp/content %}}
