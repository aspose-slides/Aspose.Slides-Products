...
description: Sample Python code for PPS-to-GIF conversion. Use the PowerPoint Python API to convert PPS files to animated GIFs in batch.
---
...
{{% blocks/products/pf/agp/code-block title="Convert PPS to GIF in Python" offSpacer="" %}}
