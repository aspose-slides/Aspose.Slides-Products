...
description: Sample code for ODP to SVG Python conversion. Use PowerPoint Python API for batch conversion ODP files to SVG files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert ODP to SVG in Python" h2="Powerful PowerPoint Python library for converting ODP to SVG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
Need to convert ODP files to SVG programmatically? Using [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/python-net/) any developer can convert ODP to SVG format with just a few lines of Python code.

As a modern presentation processing API, Aspose.Slides for Python creates SVG from ODP quickly. Test the quality of ODP to SVG conversion right in your [browser](https://products.aspose.app/slides/conversion). Aspose PowerPoint PPTX library allows you to convert ODP files to many popular formats.
...
{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert a ODP file to SVG using Python." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows ODP to SVG Python Conversion" offSpacer="" %}}
