...
{{% blocks/products/pf/agp/code-block title="Modify PPSX Built-in Properties - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Add Custom Properties to PPSX - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Extract Metadata of PPSX via Python" >}}
