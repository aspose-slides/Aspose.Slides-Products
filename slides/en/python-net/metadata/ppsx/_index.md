...
{{% blocks/products/pf/agp/code-block title="Update Built-in PPSX Properties - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Add and Remove Custom PPSX Properties - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Edit PPSX Metadata with Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to edit metadata in a PPSX file." >}}
