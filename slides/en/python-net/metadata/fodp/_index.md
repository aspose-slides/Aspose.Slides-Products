...
{{% blocks/products/pf/agp/code-block title="Modify FODP Built-in Properties - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Add Custom Properties to FODP - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Extract Metadata of FODP via Python" >}}
