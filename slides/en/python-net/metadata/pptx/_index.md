...
{{% blocks/products/pf/agp/code-block title="Modify PPTX Built-in Properties - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Add Custom Properties to PPTX - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Extract Metadata of PPTX via Python" >}}
