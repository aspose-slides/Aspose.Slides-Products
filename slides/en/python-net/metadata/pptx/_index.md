...
title: View or Edit PPTX Metadata with Python
url: /python-net/metadata/pptx/
keywords: Edit PPTX Metadata, View PPTX Metadata, Edit PPTX Properties, View PPTX Properties
description: View and edit built-in and custom metadata properties in PPTX files with Python.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="View and Edit PPTX Metadata with Python" h2="Build Python applications that read and modify built-in and custom presentation properties with Aspose.Slides." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" fileiconsmall4="POT" fileiconsmall5="PPSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="for Python via .NET" >}}

{{% blocks/products/pf/feature-page-section  h2="View and Modify PPTX Metadata with Python" %}}
[**Aspose.Slides for Python via .NET**](/slides/python-net/) lets you read and update built-in metadata and add, update, or remove custom document properties in PPTX presentations. Access an [`IDocumentProperties`](https://reference.aspose.com/slides/python-net/aspose.slides/idocumentproperties/) object through `Presentation.document_properties`, modify it, and save the presentation in PPTX format.
{{% blocks/products/pf/agp/code-block title="Update Built-in PPTX Properties - Python" offSpacer="true" %}}
...
with slides.Presentation("presentation.pptx") as presentation:
    ...
    presentation.save("presentation_with_updated_metadata.pptx", slides.export.SaveFormat.PPTX)
```

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Add and Remove Custom PPTX Properties - Python" offSpacer="true" %}}
...
with slides.Presentation("presentation.pptx") as presentation:
    ...
    presentation.save("presentation_with_custom_metadata.pptx", slides.export.SaveFormat.PPTX)
```
...
{{< blocks/products/pf/feature-page-section  h2="How to Edit PPTX Metadata with Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to edit metadata in a PPTX file." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Save the presentation with `Presentation.save` and `SaveFormat.PPTX`.
{{% /blocks/products/pf/agp/step-autogen %}}
