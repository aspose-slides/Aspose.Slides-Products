---
title:  View or Edit PPT Files Metadata using Python
url: /python-net/metadata/ppt/
keywords: Edit PPT Metadata, View PPT Metadata, Edit PPT properties, View PPT properties
description: Python source code to edit or view PPT format metadata.
---
...
{{% blocks/products/pf/feature-page-section  h2="Modify PPT Properties via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Modify PPT Built-in Properties - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Add Custom Properties to PPT - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to Extract Metadata of PPT via Python" >}}
