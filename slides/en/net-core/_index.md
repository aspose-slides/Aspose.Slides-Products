...
{{< blocks/products/pf/upper-banner h1=".NET Core API for Presentations" h2="Build cross-platform .NET Core solutions for processing presentations without Microsoft PowerPoint or Office automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-net-core.svg" pfName="Aspose.Slides" subTitlepfName="for .NET Core" downloadUrl="https://releases.aspose.com/slides/net/" >}}
...
{{< blocks/products/pf/carousel-item h3="At a Glance" description="Overview of key presentation-processing capabilities available in Aspose.Slides for .NET." >}}
...
{{< blocks/products/pf/carousel-item h3="Platform Independence" description="Aspose.Slides for .NET Core runs on Windows, Linux, and macOS." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <!--/left-->
  <!--/right-->
...
{{< blocks/products/pf/carousel-item h3="Supported File Formats" description="Aspose.Slides for .NET Core supports the popular [presentation formats](https://docs.aspose.com/slides/net/supported-file-formats/) and export formats listed below." >}}
