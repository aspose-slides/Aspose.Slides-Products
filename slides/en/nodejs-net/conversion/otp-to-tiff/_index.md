---
title: Convert OTP to TIFF in Node.js
url: /nodejs-net/conversion/otp-to-tiff/
keywords: OTP to TIFF, Convert OTP to TIFF, Node.js API, JavaScript Library, OTP, TIFF
description: Convert OTP to TIFF in Node.js. Use a Node.js library API to convert OTP files to TIFF files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert OTP to TIFF in Node.js" h2="Convert OpenDocument presentation template files to TIFF files with Aspose.Slides for Node.js via .NET." >}}

{{% blocks/products/pf/feature-page-section h2="Convert OTP to TIFF in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](/slides/nodejs-net/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load an `OTP` file with the `Presentation` class and export it to a `TIFF` file by using the presentation API.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section h2="Convert OTP to TIFF using Node.js" %}}
To convert `OTP` to `TIFF`, create a `Presentation` from the source file and export it to a `TIFF` file.

{{% blocks/products/pf/agp/code-block title="Node.js code to convert OTP to TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section h2="How to convert OTP to TIFF using Aspose.Slides for Node.js via .NET API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="To convert OTP to TIFF using Aspose.Slides for Node.js via .NET, import the package, load the source file, and export it in the required format." >}}
