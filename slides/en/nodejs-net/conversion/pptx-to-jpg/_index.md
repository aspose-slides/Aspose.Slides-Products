...
description: Convert PPTX to JPG in Node.js. Use a Node.js library API to convert PPTX slides to JPG images.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPTX to JPG in Node.js" h2="Convert PowerPoint presentation slides to JPG images with Aspose.Slides for Node.js via .NET." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPTX to JPG in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](/slides/nodejs-net/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load a `PPTX` file with the `Presentation` class and export each slide to a `JPG` image by using the presentation API.
...
{{% blocks/products/pf/agp/code-block title="JavaScript code to convert PPTX to JPG" offSpacer="true" %}}
