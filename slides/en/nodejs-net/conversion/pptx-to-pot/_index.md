...
{{< blocks/products/pf/feature-page-header h1="Convert PPTX to POT in Node.js" h2="Convert PowerPoint presentation files to POT files with Aspose.Slides for Node.js via .NET." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPTX to POT in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](/slides/nodejs-net/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load a `PPTX` file with the `Presentation` class and export it to a `POT` file by using the presentation API.
...
{{% blocks/products/pf/agp/code-block title="JavaScript code to convert PPTX to POT" offSpacer="true" %}}
