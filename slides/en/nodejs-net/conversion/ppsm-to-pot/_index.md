---
title: Convert PPSM to POT in Node.js
url: /nodejs-net/conversion/ppsm-to-pot/
keywords: PPSM to POT, Convert PPSM to POT, Node.js API, JavaScript Library, PPSM, POT
description: Convert PPSM to POT in Node.js. Use a Node.js library API to convert PPSM files to POT files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPSM to POT in Node.js" h2="Convert macro-enabled PowerPoint slideshow files to POT files with Aspose.Slides for Node.js via .NET." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPSM to POT in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](/slides/nodejs-net/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load a `PPSM` file with the `Presentation` class and export it to a `POT` file by using the presentation API.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert PPSM to POT in Node.js" %}}
To convert `PPSM` to `POT`, create a `Presentation` from the source file and export it to a `POT` file.
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `save` to export the presentation as a `POT` file with `SaveFormat.Pot`.
{{% /blocks/products/pf/agp/step-autogen %}}
