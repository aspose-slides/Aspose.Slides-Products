---
title: Convert PPSM to HTML in Node.js
url: /nodejs-net/conversion/ppsm-to-html/
keywords: PPSM to HTML, Convert PPSM to HTML, Node.js API, JavaScript Library, PPSM, HTML
description: Convert PPSM to HTML in Node.js. Use a Node.js library API to convert PPSM files to HTML files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPSM to HTML in Node.js" h2="Convert PowerPoint slideshow files to HTML files with Aspose.Slides for Node.js via .NET." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPSM to HTML in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](/slides/nodejs-net/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load a `PPSM` file with the `Presentation` class and export it to an `HTML` file by using the presentation API.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert PPSM to HTML in Node.js" %}}
To convert `PPSM` to `HTML`, create a `Presentation` from the source file and export it to an `HTML` file.

{{% blocks/products/pf/agp/code-block title="JavaScript code for convert PPSM into HTML" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PPSM to HTML using Aspose.Slides for Node.js via .NET API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="To convert PPSM to HTML using Aspose.Slides for Node.js via .NET, you need to import the package in your JavaScript file and create an instance of the Presentation class. The Presentation class represents a PowerPoint document and provides methods to access and manipulate its elements." >}}
