...
description: Convert ODP to FODP in Node.js. Use a Node.js library API to convert ODP files to FODP files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert ODP to FODP in Node.js" h2="Convert ODP presentation files to FODP files with Aspose.Slides for Node.js via .NET." >}}

{{% blocks/products/pf/feature-page-section h2="Convert ODP to FODP in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](/slides/nodejs-net/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load a `ODP` file with the `Presentation` class and export it to a `FODP` file by using the presentation API.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section h2="Convert ODP to FODP using Node.js" %}}
To convert `ODP` to `FODP`, create a `Presentation` from the source file and export it to a `FODP` file.
...
{{< blocks/products/pf/agp/steps-block-autogen name="To convert ODP to FODP using Aspose.Slides for Node.js via .NET, import the package, load the source file, and export it in the required format." >}}
