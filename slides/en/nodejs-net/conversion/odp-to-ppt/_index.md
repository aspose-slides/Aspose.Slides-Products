...
description: Convert ODP to PPT in Node.js. Use a Node.js library API to convert ODP files to PPT files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert ODP to PPT in Node.js" h2="Convert OpenDocument presentation files to PPT files with Aspose.Slides for Node.js via .NET." >}}

{{% blocks/products/pf/feature-page-section h2="Convert ODP to PPT in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](/slides/nodejs-net/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load an `ODP` file with the `Presentation` class and export it to a `PPT` file by using the presentation API.

Aspose.Slides supports high-quality presentation conversion and lets you save `ODP` files as `PPT` presentations for PowerPoint-compatible workflows.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert ODP to PPT using Node.js" %}}
To convert `ODP` to `PPT`, create a `Presentation` from the source file and export it to a `PPT` file.

{{% blocks/products/pf/agp/code-block title="Node.js code to convert ODP to PPT" offSpacer="true" %}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="To convert ODP to PPT using Aspose.Slides for Node.js via .NET, import the package, load the source file, and export it in the required format." >}}
