---
title: Convert POT to POTM in Node.js
url: /nodejs-net/conversion/pot-to-potm/
keywords: POT to POTM, Convert POT to POTM, Node.js API, JavaScript Library, POT, POTM
description: Convert POT to POTM in Node.js. Use a Node.js library API to convert POT files to POTM files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert POT to POTM in Node.js" h2="Convert PowerPoint template files to POTM files with Aspose.Slides for Node.js via .NET." >}}

{{% blocks/products/pf/feature-page-section h2="Convert POT to POTM in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](/slides/nodejs-net/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load a `POT` file with the `Presentation` class and export it to a `POTM` file by using the presentation API.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section h2="Convert POT to POTM using Node.js" %}}
To convert `POT` to `POTM`, create a `Presentation` from the source file and export it to a `POTM` file.

{{% blocks/products/pf/agp/code-block title="Node.js code to convert POT to POTM" offSpacer="true" %}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="To convert POT to POTM using Aspose.Slides for Node.js via .NET, import the package, load the source file, and export it in the required format." >}}
