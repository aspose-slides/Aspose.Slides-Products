---
title: Convert FODP to OTP in JavaScript
url: /nodejs-net/conversion/fodp-to-otp/
keywords: FODP to OTP, Convert FODP to OTP, Node.js API, JavaScript Library, FODP, OTP
description: Convert FODP to OTP in JavaScript. Use Node.js library API to convert FODP files to OTP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert FODP to OTP in JavaScript" h2="Aspose.Slides for Node.js via .NET is a powerful and easy-to-use library that allows you to convert PowerPoint presentations to various formats in JavaScript. It supports all presentation elements and formats and provides a rich API to access and modify them. It also allows you to export your slides to various formats for further processing or sharing." >}}

{{% blocks/products/pf/feature-page-section h2="Convert FODP to OTP in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](https://products.aspose.com/slides/nodejs-net/) is a powerful Node.js library for creating and manipulating presentation files. Moreover, it provides flexible ways to convert FODP to OTP. Using **Aspose.Slides for Node.js via .NET**, any developer or application can convert FODP to OTP files with just a few lines of code.

As a modern document processing API, Aspose.Slides for Node.js via .NET exports FODP files to OTP file formats quickly. Aspose PowerPoint library allows you to convert FODP to OTPs and many other file formats

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert FODP to OTP using JavaScript" %}}
To convert the FODP to OTP, you will need to create Presentation from FODP file and save it as OTP.

{{% blocks/products/pf/agp/code-block title="JavaScript code for convert FODP into OTP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert FODP to OTP using Aspose.Slides for Node.js via .NET API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="To convert FODP to OTP using Aspose.Slides for Node.js via .NET, you need to import the package in your JavaScript file and create an instance of the Presentation class. The Presentation class represents a PowerPoint document and provides methods to access and manipulate its elements." >}}
