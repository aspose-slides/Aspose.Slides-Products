...
description: Convert POT to JPG in Node.js. Use a Node.js library API to convert POT files to JPG files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert POT to JPG in Node.js" h2="Convert PowerPoint template files to JPG images with Aspose.Slides for Node.js via .NET." >}}

{{% blocks/products/pf/feature-page-section h2="Convert POT to JPG in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](/slides/nodejs-net/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load a `POT` file with the `Presentation` class and render each slide as a `JPG` image.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section h2="Convert POT to JPG using Node.js" %}}
To convert `POT` to `JPG`, create a `Presentation` from the source file and render each slide as a `JPG` image.
...
{{< blocks/products/pf/agp/steps-block-autogen name="To convert POT to JPG using Aspose.Slides for Node.js via .NET, import the package, load the source file, and export it in the required format." >}}
