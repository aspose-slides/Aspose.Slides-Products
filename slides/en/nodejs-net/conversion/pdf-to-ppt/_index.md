...
title: Convert PDF to PPT in Node.js
url: /nodejs-net/conversion/pdf-to-ppt/
keywords: PDF to PPT, Convert PDF to PPT, Node.js API, JavaScript Library, PDF, PPT
description: Convert PDF to PPT in Node.js. Use a Node.js library API to convert PDF files to PPT files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PDF to PPT in Node.js" h2="Convert PDF files to PPT files with Aspose.Slides for Node.js via .NET." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PDF to PPT in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](/slides/nodejs-net/) lets developers create, read, edit, and convert presentation files in Node.js applications. Create a `Presentation`, import a `PDF` file with the `addFromPdf` method, and export the presentation to a `PPT` file.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section h2="Convert PDF to PPT using Node.js" %}}
To convert `PDF` to `PPT`, create a `Presentation`, import the source file with `addFromPdf`, and export the presentation to a `PPT` file.

{{% blocks/products/pf/agp/code-block title="Node.js code to convert PDF to PPT" offSpacer="true" %}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="To convert PDF to PPT using Aspose.Slides for Node.js via .NET, import the package, load the source file, and export it in the required format." >}}
