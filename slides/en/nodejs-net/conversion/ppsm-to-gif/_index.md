---
title: Convert PPSM to GIF in Node.js
url: /nodejs-net/conversion/ppsm-to-gif/
keywords: PPSM to GIF, Convert PPSM to GIF, Node.js API, JavaScript Library, PPSM, GIF
description: Convert PPSM to GIF in Node.js. Use a Node.js library API to convert PPSM files to GIF files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPSM to GIF in Node.js" h2="Convert PowerPoint slideshow files to GIF files with Aspose.Slides for Node.js via .NET." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPSM to GIF in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](/slides/nodejs-net/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load a `PPSM` file with the `Presentation` class and export it to a `GIF` file by using the presentation API.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert PPSM to GIF in Node.js" %}}
To convert `PPSM` to `GIF`, create a `Presentation` from the source file and export it to a `GIF` file.
