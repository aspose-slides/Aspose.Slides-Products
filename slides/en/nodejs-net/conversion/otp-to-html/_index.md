...
description: Convert OTP to HTML in Node.js. Use a Node.js library API to convert OTP files to HTML files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert OTP to HTML in Node.js" h2="Convert OpenDocument template files to HTML files with Aspose.Slides for Node.js via .NET." >}}

{{% blocks/products/pf/feature-page-section h2="Convert OTP to HTML in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](/slides/nodejs-net/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load an `OTP` file with the `Presentation` class and export it to an `HTML` file by using the presentation API.

Aspose.Slides supports high-quality presentation conversion and lets you save `OTP` files as `HTML` documents for browser viewing, publishing, or other web workflows.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert OTP to HTML using Node.js" %}}
To convert `OTP` to `HTML`, create a `Presentation` from the source file and export it to an `HTML` file.

{{% blocks/products/pf/agp/code-block title="Node.js code to convert OTP to HTML" offSpacer="true" %}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="To convert OTP to HTML using Aspose.Slides for Node.js via .NET, import the package, load the source file, and export it in the required format." >}}
