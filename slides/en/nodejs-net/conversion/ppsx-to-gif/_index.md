...
url: /nodejs-net/conversion/ppsx-to-gif/
keywords: PPSX to GIF, Convert PPSX to GIF, Node.js API, JavaScript Library, PPSX, GIF
description: Convert PPSX to GIF in Node.js. Use a Node.js library API to convert PPSX files to GIF files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPSX to GIF in Node.js" h2="Convert PowerPoint slideshow files to GIF files with Aspose.Slides for Node.js via .NET." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPSX to GIF in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](/slides/nodejs-net/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load a `PPSX` file with the `Presentation` class and export it to a `GIF` file by using the presentation API.
...
{{% blocks/products/pf/agp/code-block title="JavaScript code for convert PPSX into GIF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PPSX to GIF using Aspose.Slides for Node.js via .NET API" >}}
