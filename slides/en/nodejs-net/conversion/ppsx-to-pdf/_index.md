---
title: Convert PPSX to PDF in JavaScript
url: /nodejs-net/conversion/ppsx-to-pdf/
keywords: PPSX to PDF, Convert PPSX to PDF, Node.js API, JavaScript Library, PPSX, PDF
description: Convert PPSX to PDF in JavaScript. Use Node.js library API to convert PPSX files to PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPSX to PDF in JavaScript" h2="Aspose.Slides for Node.js via .NET is a powerful and easy-to-use library that allows you to convert PowerPoint presentations to various formats in JavaScript. It supports all presentation elements and formats and provides a rich API to access and modify them. It also allows you to export your slides to various formats for further processing or sharing." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPSX to PDF in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](https://products.aspose.com/slides/nodejs-net/) is a powerful Node.js library for creating and manipulating presentation files. Moreover, it provides flexible ways to convert PPSX to PDF. Using **Aspose.Slides for Node.js via .NET**, any developer or application can convert PPSX to PDF files with just a few lines of code.

As a modern document processing API, Aspose.Slides for Node.js via .NET exports PPSX files to PDF file formats quickly. Aspose PowerPoint library allows you to convert PPSX to PDFs and many other file formats

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert PPSX to PDF using JavaScript" %}}
To convert the PPSX to PDF, you will need to create Presentation from PPSX file and save it as PDF.

{{% blocks/products/pf/agp/code-block title="JavaScript code for convert PPSX into PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PPSX to PDF using Aspose.Slides for Node.js via .NET API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="To convert PPSX to PDF using Aspose.Slides for Node.js via .NET, you need to import the package in your JavaScript file and create an instance of the Presentation class. The Presentation class represents a PowerPoint document and provides methods to access and manipulate its elements." >}}
