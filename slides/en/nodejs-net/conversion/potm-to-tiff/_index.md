...
description: Convert POTM to TIFF in Node.js. Use a Node.js library API to convert POTM files to TIFF files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert POTM to TIFF in Node.js" h2="Convert macro-enabled PowerPoint template files to TIFF images with Aspose.Slides for Node.js via .NET." >}}

{{% blocks/products/pf/feature-page-section h2="Convert POTM to TIFF in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](/slides/nodejs-net/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load a `POTM` file with the `Presentation` class and export it to a `TIFF` image by using the presentation API.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert POTM to TIFF in Node.js" %}}
To convert `POTM` to `TIFF`, create a `Presentation` from the source file and export it to a `TIFF` image.
...
{{< blocks/products/pf/agp/steps-block-autogen name="To convert POTM to TIFF using Aspose.Slides for Node.js via .NET:" >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `save` to export the presentation as a `TIFF` image with `SaveFormat.Tiff`.
{{% /blocks/products/pf/agp/step-autogen %}}
