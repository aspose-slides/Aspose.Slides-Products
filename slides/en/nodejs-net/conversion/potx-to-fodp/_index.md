---
title: Convert POTX to FODP in Node.js
...
description: Convert POTX to FODP in Node.js. Use a Node.js library API to convert POTX files to FODP files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert POTX to FODP in Node.js" h2="Convert PowerPoint template files to FODP files with Aspose.Slides for Node.js via .NET." >}}

{{% blocks/products/pf/feature-page-section h2="Convert POTX to FODP in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](/slides/nodejs-net/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load a `POTX` file with the `Presentation` class and export it to an `FODP` file by using the presentation API.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert POTX to FODP in Node.js" %}}
To convert `POTX` to `FODP`, create a `Presentation` from the source file and export it to an `FODP` file.
...
{{< blocks/products/pf/agp/steps-block-autogen name="To convert POTX to FODP using Aspose.Slides for Node.js via .NET:" >}}
