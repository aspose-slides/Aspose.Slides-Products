---
title: Convert PPTM to TIFF in JavaScript
url: /nodejs-net/conversion/pptm-to-tiff/
keywords: PPTM to TIFF, Convert PPTM to TIFF, Node.js API, JavaScript Library, PPTM, TIFF
description: Convert PPTM to TIFF in JavaScript. Use Node.js library API to convert PPTM files to TIFF
---
...
[**Aspose.Slides for Node.js via .NET**](https://products.aspose.com/slides/nodejs-net/) is a powerful Node.js library for creating and manipulating presentation files. Moreover, it provides flexible ways to convert PPTM to TIFF. Using **Aspose.Slides for Node.js via .NET**, any developer or application can convert PPTM to TIFF files with just a few lines of code.

As a modern document processing API, Aspose.Slides for Node.js via .NET exports PPTM files to TIFF file formats quickly. Aspose PowerPoint library allows you to convert PPTM to TIFFs and many other file formats

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert PPTM to TIFF using JavaScript" %}}
To convert the PPTM to TIFF, you will need to create Presentation from PPTM file and save it as TIFF.

{{% blocks/products/pf/agp/code-block title="JavaScript code for convert PPTM into TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PPTM to TIFF using Aspose.Slides for Node.js via .NET API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="To convert PPTM to TIFF using Aspose.Slides for Node.js via .NET, you need to import the package in your JavaScript file and create an instance of the Presentation class. The Presentation class represents a PowerPoint document and provides methods to access and manipulate its elements." >}}
