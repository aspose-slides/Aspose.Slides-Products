---
title: Convert PPT to SVG in JavaScript
url: /nodejs-net/conversion/ppt-to-svg/
keywords: PPT to SVG, Convert PPT to SVG, Node.js API, JavaScript Library, PPT, SVG
description: Convert PPT to SVG in JavaScript. Use Node.js library API to convert PPT files to SVG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPT to SVG in JavaScript" h2="Aspose.Slides for Node.js via .NET is a powerful and easy-to-use library that allows you to convert PowerPoint presentations to various formats in JavaScript. It supports all presentation elements and formats and provides a rich API to access and modify them. It also allows you to export your slides to various formats for further processing or sharing." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPT to SVG in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](https://products.aspose.com/slides/nodejs-net/) is a powerful Node.js library for creating and manipulating presentation files. Moreover, it provides flexible ways to convert PPT to SVG. Using **Aspose.Slides for Node.js via .NET**, any developer or application can convert PPT to SVG files with just a few lines of code.

As a modern document processing API, Aspose.Slides for Node.js via .NET exports PPT files to SVG file formats quickly. Aspose PowerPoint library allows you to convert PPT to SVGs and many other file formats

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert PPT to SVG using JavaScript" %}}
To convert the PPT to SVG, you will need to create Presentation from PPT file and save it as SVG.

{{% blocks/products/pf/agp/code-block title="JavaScript code for convert PPT into SVG" offSpacer="true" %}}
