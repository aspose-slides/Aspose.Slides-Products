...
description: Convert POTX to SVG in Node.js. Use a Node.js library API to convert POTX files to SVG files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert POTX to SVG in Node.js" h2="Convert PowerPoint template slides to SVG files with Aspose.Slides for Node.js via .NET." >}}
