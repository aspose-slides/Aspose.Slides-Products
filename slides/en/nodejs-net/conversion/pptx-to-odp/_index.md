...
title: Convert PPTX to ODP in Node.js
url: /nodejs-net/conversion/pptx-to-odp/
keywords: PPTX to ODP, Convert PPTX to ODP, Node.js API, JavaScript Library, PPTX, ODP
description: Convert PPTX to ODP in Node.js. Use a Node.js library API to convert PPTX files to ODP files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPTX to ODP in Node.js" h2="Convert PowerPoint presentation files to ODP files with Aspose.Slides for Node.js via .NET." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPTX to ODP in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](/slides/nodejs-net/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load a `PPTX` file with the `Presentation` class and export it to an `ODP` file by using the presentation API.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert PPTX to ODP in Node.js" %}}
To convert `PPTX` to `ODP`, create a `Presentation` from the source file and export it to an `ODP` file.

{{% blocks/products/pf/agp/code-block title="JavaScript code to convert PPTX to ODP" offSpacer="true" %}}
