---
title: Convert PPTM to PPT in Node.js
url: /nodejs-net/conversion/pptm-to-ppt/
keywords: PPTM to PPT, Convert PPTM to PPT, Node.js API, JavaScript Library, PPTM, PPT
description: Convert PPTM to PPT in Node.js. Use a Node.js library API to convert PPTM files to PPT files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPTM to PPT in Node.js" h2="Convert macro-enabled PowerPoint presentation files to PPT files with Aspose.Slides for Node.js via .NET." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPTM to PPT in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](/slides/nodejs-net/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load a `PPTM` file with the `Presentation` class and export it to a `PPT` file by using the presentation API.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert PPTM to PPT in Node.js" %}}
To convert `PPTM` to `PPT`, create a `Presentation` from the source file and export it to a `PPT` file.

{{% blocks/products/pf/agp/code-block title="JavaScript code to convert PPTM to PPT" offSpacer="true" %}}
