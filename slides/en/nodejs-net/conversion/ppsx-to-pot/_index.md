...
url: /nodejs-net/conversion/ppsx-to-pot/
keywords: PPSX to POT, Convert PPSX to POT, Node.js API, JavaScript Library, PPSX, POT
description: Convert PPSX to POT in Node.js. Use a Node.js library API to convert PPSX files to POT files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPSX to POT in Node.js" h2="Convert PowerPoint slideshow files to POT files with Aspose.Slides for Node.js via .NET." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPSX to POT in Node.js" %}}

[**Aspose.Slides for Node.js via .NET**](/slides/nodejs-net/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load a `PPSX` file with the `Presentation` class and export it to a `POT` file by using the presentation API.
...
{{% blocks/products/pf/agp/code-block title="JavaScript code for convert PPSX into POT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PPSX to POT using Aspose.Slides for Node.js via .NET API" >}}
