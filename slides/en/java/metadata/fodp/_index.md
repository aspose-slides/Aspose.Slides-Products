...
{{% blocks/products/pf/agp/code-block title="Modify FODP Built-in Properties - Java" offSpacer="true" %}}
...
try {
    ...
    presentation.save("DocProps.fodp", SaveFormat.Fodp);
} finally {
...
{{% blocks/products/pf/agp/code-block title="Add Custom Properties to FODP - Java" offSpacer="true" %}}
...
try {
    ...
    presentation.save("CustomDemo.fodp", SaveFormat.Fodp);
} finally {
    presentation.dispose();
}
```
...
{{< blocks/products/pf/feature-page-section  h2="How to Extract Metadata of FODP via Java" >}}
