...
try {
    ...
    presentation.save("DocProps.potm", SaveFormat.Potm);
} finally {
...
try {
    ...
    presentation.save("CustomDemo.potm", SaveFormat.Potm);
} finally {
    presentation.dispose();
}
```
