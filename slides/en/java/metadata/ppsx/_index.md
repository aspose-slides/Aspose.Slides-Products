...
try {
    ...
    presentation.save("DocProps.ppsx", SaveFormat.Ppsx);
} finally {
...
try {
    ...
    presentation.save("CustomDemo.ppsx", SaveFormat.Ppsx);
} finally {
    presentation.dispose();
}
```
