...
{{% blocks/products/pf/agp/code-block title="Modify PPTM Built-in Properties - Java" offSpacer="true" %}}
...
try {
    ...
    presentation.save("DocProps.pptm", SaveFormat.Pptm);
} finally {
...
{{% blocks/products/pf/agp/code-block title="Add Custom Properties to PPTM - Java" offSpacer="true" %}}
...
try {
    ...
    presentation.save("CustomDemo.pptm", SaveFormat.Pptm);
} finally {
    presentation.dispose();
}
```
...
{{< blocks/products/pf/feature-page-section  h2="How to Extract Metadata of PPTM via Java" >}}
