...
{{% blocks/products/pf/agp/code-block title="Modify POT Built-in Properties - Java" offSpacer="true" %}}
...
try {
    ...
    presentation.save("DocProps.pot", SaveFormat.Pot);
} finally {
...
{{% blocks/products/pf/agp/code-block title="Add Custom Properties to POT - Java" offSpacer="true" %}}
...
try {
    ...
    presentation.save("CustomDemo.pot", SaveFormat.Pot);
} finally {
    presentation.dispose();
}
```
...
{{< blocks/products/pf/feature-page-section  h2="How to Extract Metadata of POT via Java" >}}
