...
{{% blocks/products/pf/agp/code-block title="Modify OTP Built-in Properties - Java" offSpacer="true" %}}
...
try {
    ...
    presentation.save("DocProps.otp", SaveFormat.Otp);
} finally {
...
{{% blocks/products/pf/agp/code-block title="Add Custom Properties to OTP - Java" offSpacer="true" %}}
...
try {
    ...
    presentation.save("CustomDemo.otp", SaveFormat.Otp);
} finally {
    presentation.dispose();
}
```
...
{{< blocks/products/pf/feature-page-section  h2="How to Extract Metadata of OTP via Java" >}}
