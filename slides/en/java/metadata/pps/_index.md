...
{{% blocks/products/pf/agp/code-block title="Modify PPS Built-in Properties - Java" offSpacer="true" %}}
...
try {
    ...
    presentation.save("DocProps.pps", SaveFormat.Pps);
} finally {
...
{{% blocks/products/pf/agp/code-block title="Add Custom Properties to PPS - Java" offSpacer="true" %}}
...
try {
    ...
    presentation.save("CustomDemo.pps", SaveFormat.Pps);
} finally {
    presentation.dispose();
}
```
...
{{< blocks/products/pf/feature-page-section  h2="How to Extract Metadata of PPS via Java" >}}
