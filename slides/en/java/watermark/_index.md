...
Add text and image watermarks to ODP presentations using the Aspose.Slides for Java API.
...
Add text and image watermarks to PPT presentations using the Aspose.Slides for Java API.
{{< /blocks/products/pf/product >}}
...
Add text and image watermarks to PPTX presentations using the Aspose.Slides for Java API.
{{< /blocks/products/pf/product >}}
