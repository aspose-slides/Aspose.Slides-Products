...
description: View POTX files in Java. Use Aspose.Slides for Java to open PowerPoint template files and save them as HTML.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View POTX in Java" h2="Java API for opening POTX files and saving them as HTML." >}}

{{% blocks/products/pf/feature-page-section h2="View POTX using Aspose.Slides" %}}

[**Aspose.Slides for Java**](/slides/java/) is a Java library for opening, viewing, editing, and converting presentation files. You can load POTX files and save them as HTML for viewing in a browser.
...
{{% blocks/products/pf/feature-page-section  h2="View POTX in Java" %}}
Using [**Aspose.Slides for Java**](/slides/java/), you can load a POTX presentation and save it as responsive HTML with a few lines of code.

{{% blocks/products/pf/agp/code-block title="Java code for viewing POTX" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="How to view POTX in Java" >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Save the POTX presentation as HTML with `SaveFormat.Html`.
{{% /blocks/products/pf/agp/step-autogen %}}
