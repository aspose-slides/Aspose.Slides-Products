...
{{< blocks/products/pf/feature-page-header h1="View ODP in Java" h2="Java API for opening ODP files and saving them as HTML." >}}

{{% blocks/products/pf/feature-page-section h2="View ODP using Aspose.Slides" %}}

[**Aspose.Slides for Java**](/slides/java/) is a Java library for opening, viewing, editing, and converting presentation files. You can load ODP files and save them as HTML for viewing in a browser.
