...
description: View PPSX files in Java. Use Aspose.Slides for Java to open PowerPoint slide show files and save them as HTML.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View PPSX in Java" h2="Java API for opening PPSX files and saving them as HTML." >}}

{{% blocks/products/pf/feature-page-section h2="View PPSX using Aspose.Slides" %}}

[**Aspose.Slides for Java**](/slides/java/) is a Java library for opening, viewing, editing, and converting presentation files. You can load PPSX files and save them as HTML for viewing in a browser.
...
{{% blocks/products/pf/feature-page-section  h2="View PPSX in Java" %}}
Using [**Aspose.Slides for Java**](/slides/java/), you can load a PPSX presentation and save it as responsive HTML with a few lines of code.

{{% blocks/products/pf/agp/code-block title="Java code for viewing PPSX" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="How to view PPSX in Java" >}}
