...
{{% blocks/products/pf/agp/content h2="Merge PPSX Files Using Java" %}}

Use [Aspose.Slides for Java](/slides/java/) to load multiple `PPSX` presentations, clone slides from one presentation into another, and save the merged file. You can install the `aspose-slides` package in a Maven-based project by adding the repository and dependency below.
...
Load the destination `PPSX` file with the `Presentation` class.
{{% /blocks/products/pf/agp/step-autogen %}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call the `save` method with `SaveFormat.Ppsx`.
{{% /blocks/products/pf/agp/step-autogen %}}
...
{{% blocks/products/pf/agp/code-block title="Merge PPSX Files - Java" offSpacer="" %}}

```java
Presentation destinationPresentation = new Presentation("presentation1.ppsx");
try {
    Presentation sourcePresentation = new Presentation("presentation2.ppsx");
    try {
    ...
    destinationPresentation.save("merged-presentation.ppsx", SaveFormat.Ppsx);
} finally {
...
Aspose.Slides for Java can read, write, manipulate, merge, and convert Microsoft PowerPoint and OpenDocument presentations to formats such as `PDF`, `XPS`, `HTML`, `TIFF`, and `ODP`. It is a standalone API and does not require Microsoft PowerPoint or OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online PPSX Merger Live Demos" sectionDescription="Merge PPSX documents online with the Aspose.Slides merger app." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text="No need to download Aspose API." >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text="No need to write any code." >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Upload your PPSX files." >}}
...
Files with the `.PPSX` extension are PowerPoint Slide Show files created with Microsoft PowerPoint 2007 or later. A `PPSX` file opens directly as a slide show while preserving the presentation content.
