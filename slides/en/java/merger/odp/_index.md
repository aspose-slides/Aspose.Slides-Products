...
Use [Aspose.Slides for Java](/slides/java/) to load multiple `ODP` presentations, clone slides from one presentation into another, and save the merged file. You can install the `aspose-slides` package in a Maven-based project by adding the repository and dependency below.
...
Load the destination `ODP` file with the `Presentation` class.
{{% /blocks/products/pf/agp/step-autogen %}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call the `save` method with `SaveFormat.Odp`.
{{% /blocks/products/pf/agp/step-autogen %}}
...
```java
Presentation destinationPresentation = new Presentation("presentation1.odp");
try {
    Presentation sourcePresentation = new Presentation("presentation2.odp");
    try {
    ...
    destinationPresentation.save("merged-presentation.odp", SaveFormat.Odp);
} finally {
...
{{< blocks/slides-app-widget  appName="merger" extension="odp" sectionTitle="Merge ODP Files Online" sectionDescription="Merge presentations and slides online." >}}
...
Aspose.Slides for Java can read, write, manipulate, merge, and convert Microsoft PowerPoint and OpenDocument presentations to formats such as `PDF`, `XPS`, `HTML`, `TIFF`, and `ODP`. It is a standalone API and does not require Microsoft PowerPoint or OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online ODP Merger Live Demos" sectionDescription="Merge ODP documents online with the Aspose.Slides merger app." >}}
