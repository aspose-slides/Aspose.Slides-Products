...
weight: 730
url: /java/merger/ppt/
description: Merge PPT files in Java. Use Aspose.Slides for Java to combine PowerPoint 97-2003 presentations and save the merged file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge PPT Files in Java" h2="Merge PPT documents using Aspose.Slides for Java server-side APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPT" >}}
...
Use [Aspose.Slides for Java](/slides/java/) to load multiple `PPT` presentations, clone slides from one presentation into another, and save the merged file. You can install the `aspose-slides` package in a Maven-based project by adding the repository and dependency below.
...
Load the destination `PPT` file with the `Presentation` class.
{{% /blocks/products/pf/agp/step-autogen %}}
...
```java
Presentation destinationPresentation = new Presentation("presentation1.ppt");
try {
    Presentation sourcePresentation = new Presentation("presentation2.ppt");
    try {
    ...
    destinationPresentation.save("merged-presentation.ppt", SaveFormat.Ppt);
} finally {
...
{{< blocks/slides-app-widget  appName="merger" extension="ppt" sectionTitle="Merge PPT Files Online" sectionDescription="Merge presentations and slides online." >}}
...
Aspose.Slides for Java can read, write, manipulate, merge, and convert Microsoft PowerPoint and OpenDocument presentations to formats such as `PDF`, `XPS`, `HTML`, `TIFF`, and `ODP`. It is a standalone API and does not require Microsoft PowerPoint or OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online PPT Merger Live Demos" sectionDescription="Merge PPT documents online with the Aspose.Slides merger app." >}}
...
Files with the `.PPT` extension represent Microsoft PowerPoint 97-2003 presentation files. A `PPT` file can contain slides with text, images, multimedia, and other embedded objects.
