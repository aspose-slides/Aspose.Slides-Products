...
{{% blocks/products/pf/agp/content h2="How to Convert POT to PPSM Using Java" %}}

 In order to render POT to PPSM, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert POT to PPSM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert POT file to PPSM in just a few lines of code.
