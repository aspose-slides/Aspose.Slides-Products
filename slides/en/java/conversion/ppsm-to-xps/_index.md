...
Use [Aspose.Slides for Java](/slides/java/) to load a `PPSM` slide show and save it as an `XPS` file. You can install the `aspose-slides` package in a Maven-based project by adding the repository and dependency below.
