...
{{% blocks/products/pf/agp/content h2="Convert ODP to XPS Using Java" %}}
 ...
 It is a PowerPoint and OpenOffice presentation API that lets you load an `ODP` file and save it as a `XPS` file. You can get the latest `aspose-slides` package from
