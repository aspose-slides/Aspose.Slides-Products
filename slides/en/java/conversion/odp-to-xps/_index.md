...
title: Convert ODP to XPS using Java
weight: 4880
url: /java/conversion/odp-to-xps/
description: Convert ODP to XPS in Java. Use Aspose.Slides for Java to save ODP presentations as XPS files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert ODP to XPS in Java" h2="Save ODP presentations as XPS files with Aspose.Slides for Java without OpenOffice." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Convert ODP to XPS Using Java" %}}


 To convert `ODP` to `XPS`, use
 [Aspose.Slides for Java](/slides/java/).
 It is a PowerPoint and OpenDocument presentation API that lets you load an `ODP` file and save it as an `XPS` file. You can get the latest `aspose-slides` package from
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert ODP to XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can convert an `ODP` file to `XPS` in just a few lines of code.
