...
{{% blocks/products/pf/agp/content h2="Convert POTX to OTP Using Java" %}}

Use [Aspose.Slides for Java](/slides/java/) to load a `POTX` template and save it as an `OTP` file. You can install the `aspose-slides` package in a Maven-based project by adding the repository and dependency below.
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert POTX to OTP via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can convert a `POTX` file to `OTP` in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="POTX to OTP Java Conversion Source Code" offSpacer="" %}}
