---
title: Convert POTX to OTP via Java 
weight: 150
url: /java/conversion/potx-to-otp/ 
description: Sample Java conversion code for POTX format to OTP file. Use this example code to export PowerPoint & OpenOffice presentations to OTP within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert POTX to OTP via Java" h2="POTX to OTP Java conversion to convert single or multiple pages to OTP using On-premises Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert POTX to OTP Using Java" %}}

 In order to render POTX to OTP, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert POTX to OTP via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert POTX file to OTP in just a few lines of code.
