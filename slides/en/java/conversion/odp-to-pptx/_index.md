---
title: Convert ODP to PPTX using Java
weight: 5710
url: /java/conversion/odp-to-pptx/
description: Convert ODP to PPTX in Java. Use Aspose.Slides for Java to save ODP presentations as PPTX files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert ODP to PPTX in Java" h2="Save ODP presentations as PPTX files with Aspose.Slides for Java without OpenOffice." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Convert ODP to PPTX Using Java" %}}


 To convert `ODP` to `PPTX`, use
 [Aspose.Slides for Java](/slides/java/).
 It is a PowerPoint and OpenDocument presentation API that lets you load an `ODP` file and save it as a `PPTX` file. You can get the latest `aspose-slides` package from
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert ODP to PPTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can convert an `ODP` file to `PPTX` in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1.  Load the `ODP` file with the `Presentation` class.
1.  Call the `Presentation.save` method with the output file path and `SaveFormat.Pptx`.
...
{{% blocks/products/pf/agp/code-block title="ODP to PPTX Java Conversion Source Code" offSpacer="" %}}
