...
{{% blocks/products/pf/agp/content h2="Convert ODP to PPTX Using Java" %}}
 ...
 To convert <code>ODP</code> to <code>PPTX</code>, use
 [Aspose.Slides for Java](/slides/java/).
 It is a PowerPoint and OpenOffice presentation API that lets you load an <code>ODP</code> file and save it as a <code>PPTX</code> file. You can get the latest <code>aspose-slides</code> package from
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java developers can convert an <code>ODP</code> file to <code>PPTX</code> in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1.  Load the <code>ODP</code> file with the <code>Presentation</code> class.
1.  Call the <code>Presentation.save</code> method with the output file path and <code>SaveFormat.Pptx</code>.
1.  The <code>PPTX</code> file will be saved at the specified path.
