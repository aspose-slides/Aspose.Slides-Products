...
{{% blocks/products/pf/agp/content h2="How to Convert OTP to ODP Using Java" %}}

 In order to render OTP to ODP, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert OTP to ODP via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert OTP file to ODP in just a few lines of code.
