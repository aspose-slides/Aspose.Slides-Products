...
You can load an `HTML` file into a `Presentation`, render each `ISlide` as an `IImage`, and save the output with `ImageFormat.Png`.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert HTML to PNG using Java" %}}
To convert `HTML` to `PNG`, create a `Presentation` from the source file and render its slides.
