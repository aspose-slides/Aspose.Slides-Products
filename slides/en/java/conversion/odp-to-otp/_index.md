...
title: Convert ODP to OTP using Java
weight: 3460
url: /java/conversion/odp-to-otp/
description: Convert ODP to OTP in Java. Use Aspose.Slides for Java to save ODP presentations as OTP templates.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert ODP to OTP in Java" h2="Save ODP presentations as OTP templates using Aspose.Slides for Java without OpenOffice." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Convert ODP to OTP Using Java" %}}

Use [Aspose.Slides for Java](/slides/java/) to load an `ODP` presentation and save it as an `OTP` template. You can install the `aspose-slides` package in a Maven-based project by adding the repository and dependency below.
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert ODP to OTP via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can convert an `ODP` file to `OTP` in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="ODP to OTP Java Conversion Source Code" offSpacer="" %}}
