...
{{% blocks/products/pf/agp/content h2="How to Convert ODP to OTP Using Java" %}}

 In order to render ODP to OTP, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert ODP to OTP via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert ODP file to OTP in just a few lines of code.
