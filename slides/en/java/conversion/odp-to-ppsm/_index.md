...
{{% blocks/products/pf/agp/content h2="Convert ODP to PPSM Using Java" %}}
 ...
 It is a PowerPoint and OpenOffice presentation API that lets you load an `ODP` file and save it as a `PPSM` slide show. You can get the latest `aspose-slides` package from
