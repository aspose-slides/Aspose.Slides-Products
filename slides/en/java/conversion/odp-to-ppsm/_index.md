...
{{% blocks/products/pf/agp/content h2="How to Convert ODP to PPSM Using Java" %}}

 In order to render ODP to PPSM, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert ODP to PPSM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert ODP file to PPSM in just a few lines of code.
