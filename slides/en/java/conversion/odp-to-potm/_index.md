...
{{% blocks/products/pf/agp/content h2="How to Convert ODP to POTM Using Java" %}}

 In order to render ODP to POTM, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert ODP to POTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert ODP file to POTM in just a few lines of code.
