---
title: Convert ODP to POTM using Java
weight: 4220
url: /java/conversion/odp-to-potm/
description: Convert ODP to POTM in Java. Use Aspose.Slides for Java to save ODP presentations as POTM templates.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert ODP to POTM in Java" h2="Save ODP presentations as POTM templates with Aspose.Slides for Java without OpenOffice." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Convert ODP to POTM Using Java" %}}


 To convert `ODP` to `POTM`, use
 [Aspose.Slides for Java](/slides/java/).
 It is a PowerPoint and OpenDocument presentation API that lets you load an `ODP` file and save it as a `POTM` template. You can get the latest `aspose-slides` package from
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert ODP to POTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can convert an `ODP` file to `POTM` in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1.  Load the `ODP` file with the `Presentation` class.
1.  Call the `Presentation.save` method with the output file path and `SaveFormat.Potm`.
...
{{% blocks/products/pf/agp/code-block title="ODP to POTM Java Conversion Source Code" offSpacer="" %}}
