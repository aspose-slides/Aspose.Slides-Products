...
description: Convert JPG to Image in Java. Use Aspose.Slides for Java to add a JPG file to a slide and render it as an image.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert JPG to Image in Java" h2="Convert JPG files to image output using Aspose.Slides for Java without Microsoft PowerPoint." >}}

{{% blocks/products/pf/feature-page-section h2="Convert JPG to Image in Java" %}}

[**Aspose.Slides for Java**](/slides/java/) is a presentation processing API that can place a `JPG` file on a slide and render the slide as image output.
...
{{% blocks/products/pf/agp/step-autogen %}}
Render the slide as an `IImage` and save it as an image file.
{{% /blocks/products/pf/agp/step-autogen %}}
