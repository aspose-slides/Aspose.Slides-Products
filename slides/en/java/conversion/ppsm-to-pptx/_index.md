...
{{% blocks/products/pf/agp/content h2="Convert PPSM to PPTX Using Java" %}}

Use [Aspose.Slides for Java](/slides/java/) to load a `PPSM` slide show and save it as a `PPTX` file. You can install the `aspose-slides` package in a Maven-based project by adding the repository and dependency below.
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert PPSM to PPTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

Java developers can convert a `PPSM` file to `PPTX` in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="PPSM to PPTX Java Conversion Source Code" offSpacer="" %}}
