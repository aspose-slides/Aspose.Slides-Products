...
{{% blocks/products/pf/agp/content h2="Convert ODP to PPSX Using Java" %}}


 To convert `ODP` to `PPSX`, use
 [Aspose.Slides for Java](/slides/java/).
 It is a PowerPoint and OpenDocument presentation API that lets you load an `ODP` file and save it as a `PPSX` slide show. You can get the latest `aspose-slides` package from
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert ODP to PPSX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can convert an `ODP` file to `PPSX` in just a few lines of code.
