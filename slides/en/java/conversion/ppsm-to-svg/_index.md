...
title: Convert PPSM to SVG using Java
weight: 7830
url: /java/conversion/ppsm-to-svg/
description: Convert PPSM to SVG in Java. Use Aspose.Slides for Java to export PPSM slides as SVG files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PPSM to SVG in Java" h2="Export PPSM slides as SVG files using Aspose.Slides for Java without Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSM" >}}
...
{{% blocks/products/pf/agp/content h2="Convert PPSM to SVG Using Java" %}}

Use [Aspose.Slides for Java](/slides/java/) to load a `PPSM` slide show and export its slides as `SVG` files. You can install the `aspose-slides` package in a Maven-based project by adding the repository and dependency below.
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert PPSM to SVG via Java" %}}

{{% blocks/products/pf/agp/text %}}

Java developers can convert a `PPSM` file to `SVG` in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="PPSM to SVG Java Conversion Source Code" offSpacer="" %}}
