...
{{< blocks/products/pf/product-card-row title="Search Presentation Code Samples Online" >}}
...
Search text in ODP presentations using the Aspose.Slides for Java API.
...
Search text in PPT presentations using the Aspose.Slides for Java API.
{{< /blocks/products/pf/product >}}
...
Search text in PPTX presentations using the Aspose.Slides for Java API.
{{< /blocks/products/pf/product >}}
