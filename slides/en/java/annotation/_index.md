...
Use Aspose.Slides for Java to remove comments and comment authors from `ODP` presentations.
...
Use Aspose.Slides for Java to remove comments and comment authors from `PPT` presentations.
{{< /blocks/products/pf/product >}}
...
Use Aspose.Slides for Java to remove comments and comment authors from `PPTX` presentations.
{{< /blocks/products/pf/product >}}
