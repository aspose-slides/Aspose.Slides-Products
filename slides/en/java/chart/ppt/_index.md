...
{{% blocks/products/pf/agp/content h2="Create Charts in PPT Files Using Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="How to Create Charts in PPT Files in Java" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Create charts in PPT files with Aspose.Slides for Java." >}}
...
{{% blocks/products/pf/agp/code-block title="Create a PPT Chart - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/slides/java/chart/pptx/" name="PPTX" description="Open XML Presentation Format" >}}
