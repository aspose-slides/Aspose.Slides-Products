...
url: /nodejs-java/conversion/ppsm-to-pot/
keywords: PPSM to POT, Convert PPSM to POT, Node.js API, Node.js Library, PPSM, POT
description: Convert PPSM to POT in Node.js. Use the Node.js API to convert PPSM files to POT files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPSM to POT in Node.js" h2="Convert PowerPoint Macro-Enabled Slide Show files to POT with Aspose.Slides for Node.js via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPSM to POT in Node.js" %}}

[**Aspose.Slides for Node.js via Java**](/slides/nodejs-java/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load a `PPSM` file with the `Presentation` class and export it to a `POT` file by using the presentation API.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert PPSM to POT using Node.js" %}}
To convert `PPSM` to `POT`, create a `Presentation` from the source file and export it to a `POT` file.

{{% blocks/products/pf/agp/code-block title="Node.js code to convert PPSM to POT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PPSM to POT using Aspose.Slides for Node.js via Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="To convert PPSM to POT using Aspose.Slides for Node.js via Java, import the package, load the source file, and export it in the required format." >}}
