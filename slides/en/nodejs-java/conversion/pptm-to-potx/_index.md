...
{{< blocks/products/pf/feature-page-header h1="Convert PPTM to POTX in Node.js" h2="Convert PowerPoint macro-enabled presentation files to POTX files with Aspose.Slides for Node.js via Java." >}}
...
{{% blocks/products/pf/agp/code-block title="Node.js code to convert PPTM to POTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section h2="How to convert PPTM to POTX using Aspose.Slides for Node.js via Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="To convert PPTM to POTX using Aspose.Slides for Node.js via Java, import the package, load the source file, and export it in the required format." >}}
