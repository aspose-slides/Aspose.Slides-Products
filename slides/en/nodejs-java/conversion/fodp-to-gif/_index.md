...
description: Convert FODP to GIF in Node.js. Use Node.js library API to convert FODP files to GIFs
---
...
As a modern document processing API, Aspose.Slides for Node.js exports FODP files to GIF file formats quickly. Aspose PowerPoint library allows you to convert FODP to GIFs and many other file formats
...
{{% blocks/products/pf/agp/code-block title="Node.js code for convert FODP into GIF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert FODP to GIF using using Aspose.Slides for Node.js via Java API" >}}
