...
description: Convert PDF to JPG in Node.js. Use the Node.js API to convert PDF files to JPG images.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PDF to JPG in Node.js" h2="Convert PDF files to JPG with Aspose.Slides for Node.js via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PDF to JPG in Node.js" %}}

[**Aspose.Slides for Node.js via Java**](/slides/nodejs-java/) lets you import `PDF` files into a presentation and render the imported slides as `JPG` images. With this Node.js API, you can convert `PDF` content without Adobe Acrobat.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert PDF to JPG using Node.js" %}}
To convert `PDF` to `JPG`, create a `Presentation`, import the source file with `addFromPdf`, and render the imported slides as images.

{{% blocks/products/pf/agp/code-block title="Node.js code to convert PDF to JPG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PDF to JPG using Aspose.Slides for Node.js via Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="To convert PDF to JPG using Aspose.Slides for Node.js via Java, import the package, import the source file into a presentation, and export slides as images." >}}
