...
description: Convert POTX to POT in Node.js. Use Node.js library API to convert POTX files to POTs
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert POTX to POT in Node.js" h2="Aspose.Slides for Node.js via Java is a powerful and easy-to-use library that allows you to convert PowerPoint presentations to various formats in Node.js. It supports all presentation elements and formats and provides a rich API to access and modify them. It also allows you to export your slides to various formats for further processing or sharing." >}}
...
As a modern document processing API, Aspose.Slides for Node.js exports POTX files to POT file formats quickly. Aspose PowerPoint library allows you to convert POTX to POTs and many other file formats
...
{{% blocks/products/pf/agp/code-block title="Node.js code for convert POTX into POT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert POTX to POT using using Aspose.Slides for Node.js via Java API" >}}
