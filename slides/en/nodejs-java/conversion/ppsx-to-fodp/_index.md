...
description: Convert PPSX to FODP in Node.js. Use the Node.js API to convert PPSX files to FODP files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPSX to FODP in Node.js" h2="Convert PowerPoint Open XML Slide Show files to FODP with Aspose.Slides for Node.js via Java." >}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PPSX to FODP using Aspose.Slides for Node.js via Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="To convert PPSX to FODP using Aspose.Slides for Node.js via Java, import the package, load the source file, and export it in the required format." >}}
