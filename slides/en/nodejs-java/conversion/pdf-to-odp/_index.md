...
description: Convert PDF to ODP in Node.js. Use the Node.js API to convert PDF files to ODP files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PDF to ODP in Node.js" h2="Convert PDF files to ODP with Aspose.Slides for Node.js via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PDF to ODP in Node.js" %}}

[**Aspose.Slides for Node.js via Java**](/slides/nodejs-java/) lets you import `PDF` files into a presentation and save the result as `ODP`. With this Node.js API, you can convert `PDF` content without Adobe Acrobat.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert PDF to ODP using Node.js" %}}
To convert `PDF` to `ODP`, create a `Presentation`, import the source file with `addFromPdf`, and save the presentation with `SaveFormat.Odp`.
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PDF to ODP using Aspose.Slides for Node.js via Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="To convert PDF to ODP using Aspose.Slides for Node.js via Java, import the package, import the source file into a presentation, and export it in the required format." >}}
