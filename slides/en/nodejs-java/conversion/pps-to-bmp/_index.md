...
description: Convert PPS to BMP in Node.js. Use the Node.js API to convert PPS files to BMP images.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPS to BMP in Node.js" h2="Convert PowerPoint Slide Show files to BMP with Aspose.Slides for Node.js via Java." >}}
...
{{% blocks/products/pf/agp/code-block title="Node.js code to convert PPS to BMP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PPS to BMP using Aspose.Slides for Node.js via Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="To convert PPS to BMP using Aspose.Slides for Node.js via Java, import the package, load the source file with the Presentation class, and export slides as images." >}}
