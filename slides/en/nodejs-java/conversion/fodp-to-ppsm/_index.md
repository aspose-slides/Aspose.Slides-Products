...
description: Convert FODP to PPSM in Node.js. Use the Node.js API to convert FODP files to PPSM files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert FODP to PPSM in Node.js" h2="Convert Flat OpenDocument Presentation files to PPSM with Aspose.Slides for Node.js via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert FODP to PPSM in Node.js" %}}

[**Aspose.Slides for Node.js via Java**](/slides/nodejs-java/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load an `FODP` file with the `Presentation` class and export it to a `PPSM` file by using the presentation API.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert FODP to PPSM using Node.js" %}}
To convert `FODP` to `PPSM`, create a `Presentation` from the source file and export it to a `PPSM` file.

{{% blocks/products/pf/agp/code-block title="Node.js code to convert FODP to PPSM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert FODP to PPSM using Aspose.Slides for Node.js via Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="To convert FODP to PPSM using Aspose.Slides for Node.js via Java, import the package, load the source file with the Presentation class, and export it in the required format." >}}
