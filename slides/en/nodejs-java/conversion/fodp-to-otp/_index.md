...
description: Convert FODP to OTP in Node.js. Use the Node.js API to convert FODP files to OTP files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert FODP to OTP in Node.js" h2="Convert Flat OpenDocument Presentation files to OTP with Aspose.Slides for Node.js via Java." >}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert FODP to OTP using Aspose.Slides for Node.js via Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="To convert FODP to OTP using Aspose.Slides for Node.js via Java, import the package, load the source file with the Presentation class, and export it in the required format." >}}
