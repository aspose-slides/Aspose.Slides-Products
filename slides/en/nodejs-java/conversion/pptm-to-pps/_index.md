...
{{< blocks/products/pf/feature-page-header h1="Convert PPTM to PPS in Node.js" h2="Convert PowerPoint macro-enabled presentation files to PPS files with Aspose.Slides for Node.js via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPTM to PPS in Node.js" %}}

[**Aspose.Slides for Node.js via Java**](/slides/nodejs-java/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load a `PPTM` file with the `Presentation` class and export it to a `PPS` file by using the presentation API.
...
{{% blocks/products/pf/agp/code-block title="Node.js code to convert PPTM to PPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section h2="How to convert PPTM to PPS using Aspose.Slides for Node.js via Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="To convert PPTM to PPS using Aspose.Slides for Node.js via Java, import the package, load the source file, and export it in the required format." >}}
