...
[**Aspose.Slides for Node.js via Java**](/slides/nodejs-java/) lets developers create, read, edit, and convert presentation files in Node.js applications. You can load a `FODP` file with the `Presentation` class and export it to an `ODP` file by using the presentation API.
