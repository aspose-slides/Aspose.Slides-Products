...
title:  View ODP in C++
url: /cpp/viewer/odp/
keywords: View ODP, View OpenOffice Presentation, Open ODP, ODP Viewer, ODP, C++ API, C++ Library, CPP
description: View ODP in C++. Use C++ library API to open and view OpenOffice presentation
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View ODP in C++" h2="Powerful cross-platform C++ API for opening and viewing ODP using C++ code" >}}
...
auto presentation = System::MakeObject<Presentation>(u"presentation.odp");
