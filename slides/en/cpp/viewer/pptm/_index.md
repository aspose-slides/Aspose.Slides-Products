...
url: /cpp/viewer/pptm/
keywords: View PPTM, View Macro-enabled PowerPoint Template, Open PPTM, PPTM Viewer, PPTM, PowerPoint, C++ API, C++ Library, CPP
description: View PPTM in C++. Use C++ library API to open and view Macro-enabled PowerPoint Template
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View PPTM in C++" h2="Powerful cross-platform C++ API for opening and viewing PPTM using C++ code" >}}
