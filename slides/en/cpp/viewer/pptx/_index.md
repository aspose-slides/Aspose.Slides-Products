...
description: View PPTX presentations in C++. Use Aspose.Slides for C++ to open PowerPoint Open XML presentation files and save them as responsive HTML.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View PPTX in C++" h2="Use Aspose.Slides for C++ to open PPTX files and save them as responsive HTML." >}}

{{% blocks/products/pf/feature-page-section h2="View PPTX using Aspose.Slides" %}}

Aspose.Slides for C++ is a presentation processing library for opening, viewing, editing, and converting presentation files. You can load a PPTX file with the `Presentation` class and save it as HTML for browser-based viewing.
...
Use Aspose.Slides for C++ to load a PPTX file and export it to responsive HTML with `ResponsiveHtmlController`, `HtmlOptions`, `HtmlFormatter`, and `SaveFormat::Html`.
...
{{< blocks/products/pf/agp/step-autogen >}}
Save the PPTX presentation as HTML with `SaveFormat::Html`.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Open the generated HTML file in a browser to view the PPTX content.
{{< /blocks/products/pf/agp/step-autogen >}}
