...
url: /cpp/viewer/potx/
keywords: View POTX, Open POTX, POTX Viewer, POTX, C++ API, C++ Library, CPP
description: View POTX presentations in C++. Use Aspose.Slides for C++ to open PowerPoint Open XML template files and save them as responsive HTML.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View POTX in C++" h2="Use Aspose.Slides for C++ to open POTX files and save them as responsive HTML." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Open the generated HTML file in a browser to view the POTX content.
{{< /blocks/products/pf/agp/step-autogen >}}
