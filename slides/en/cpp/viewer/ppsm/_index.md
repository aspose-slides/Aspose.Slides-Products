...
url: /cpp/viewer/ppsm/
keywords: View PPSM, View Macro-enabled PowerPoint Template, Open PPSM, PPSM Viewer, PPSM, PowerPoint, C++ API, C++ Library, CPP
description: View PPSM in C++. Use C++ library API to open and view Macro-enabled PowerPoint Template
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View PPSM in C++" h2="Powerful cross-platform C++ API for opening and viewing PPSM using C++ code" >}}
...
auto presentation = System::MakeObject<Presentation>(u"presentation.ppsm");
