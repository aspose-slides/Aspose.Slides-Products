...
weight: 7970
url: /cpp/search/ppt/ 
description: C++ example code to search words with pattern in PPT file on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/cpp/search/odp/" name="ODP" description="OpenDocument Presentation Format" >}}
