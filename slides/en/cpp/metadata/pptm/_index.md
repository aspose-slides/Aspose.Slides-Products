...
presentation->Save(u"updated-presentation.pptm", SaveFormat::Pptm);
...
presentation->Save(u"updated-custom-properties.pptm", SaveFormat::Pptm);
presentation->Dispose();
```
