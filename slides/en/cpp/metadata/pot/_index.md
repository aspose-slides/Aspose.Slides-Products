...
presentation->Save(u"updated-presentation.pot", SaveFormat::Pot);
...
presentation->Save(u"updated-custom-properties.pot", SaveFormat::Pot);
presentation->Dispose();
```
