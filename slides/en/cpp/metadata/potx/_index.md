---
title: Edit or View POTX Document Metadata via C++ 
weight: 4270
url: /cpp/metadata/potx/ 
description: C++ example code to edit or view POTX file metadata on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Extract POTX Metadata in C++" h2="Build your own C++ apps to add, edit, remove or extract metadata from POTX files using server-side APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTX" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Get POTX Metadata Using C++" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="How to Extract Metadata of POTX via C++" >}}
