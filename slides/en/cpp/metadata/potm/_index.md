...
presentation->Save(u"updated-presentation.potm", SaveFormat::Potm);
...
presentation->Save(u"updated-custom-properties.potm", SaveFormat::Potm);
presentation->Dispose();
```
