...
presentation->Save(u"updated-custom-properties.fodp", SaveFormat::Fodp);
presentation->Dispose();
```
...
Load the FODP file with the `Presentation` class.
{{% /blocks/products/pf/agp/step-autogen %}}
