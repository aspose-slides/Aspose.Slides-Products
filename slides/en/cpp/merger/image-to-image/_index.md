...
url: /cpp/merger/image-to-image/
keywords: Merge image, image to image, Join images, Combine images, C++ API, C++ Library
description: Merge image to image in C++. Use C++ library API to combine images
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge image in C++" h2="High-speed and cross-platform C++ library for merging images using C++ code" >}}

{{% blocks/products/pf/feature-page-section h2="Merge image to image using Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/cpp/) is a powerful C++ library used to merge and manipulate presentations, images, and other files. When you merge image to image, you are effectively combining two images to get one picture.
