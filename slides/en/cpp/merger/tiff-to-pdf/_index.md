...
description: Merge TIFF to PDF in C++. Use C++ library API to combine TIFF and PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge TIFF to PDF in C++" h2="High-speed and cross-platform C++ library for merging TIFF to PDF files using C++ code" >}}

{{% blocks/products/pf/feature-page-section h2="Merge TIFF to PDF using Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/cpp/) is a powerful C++ library used to create, convert, merge, and manipulate presentations, PDFs, images, and other files. When you merge TIFF to PDF, you are effectively combining images to obtain a single PDF file.
...
Using [**Aspose.Slides for C++**](https://products.aspose.com/slides/cpp/), you can merge TIFF to PDF quickly with just a few lines of code
