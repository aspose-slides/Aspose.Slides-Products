...
description: Merge JPG images into a PDF file in C++. Use Aspose.Slides for C++ to place JPG images on a slide and save the result as PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge JPG to PDF in C++" h2="Use Aspose.Slides for C++ to combine JPG images and save the result as PDF." >}}
