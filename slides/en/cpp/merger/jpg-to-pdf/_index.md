...
url: /cpp/merger/jpg-to-pdf/
keywords: JPG to PDF, Merge JPG to PDF, Join JPG to PDF, PDF, JPG, C++ API, C++ Library
description: Merge JPG to PDF in C++. Use C++ library API to combine JPG and PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge JPG to PDF in C++" h2="High-speed and cross-platform C++ library for merging JPG to PDF files using C++ code" >}}

{{% blocks/products/pf/feature-page-section h2="Merge JPG to PDF using Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/cpp/) is a powerful C++ library used to create, convert, merge, and manipulate presentations, PDFs, images, and other files. When you merge JPG to PDF, you are effectively combining JPG images to get a single PDF file.
...
Using [**Aspose.Slides for C++**](https://products.aspose.com/slides/cpp/), you can merge JPG to PDF quickly with just a few lines of code
