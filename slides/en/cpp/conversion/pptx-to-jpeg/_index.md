...
description: C++ conversion code for PPTX to JPEG. Use the example code for batch PPTX to JPEG conversion in C++ applications.
---
...
Render a slide from a PPTX presentation to JPEG with a few lines of C++ code.
