...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert ODP to JPEG via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ developers can convert an ODP file to JPEG in just a few lines of code.
...
1.  Open the JPEG file in a compatible program.
...
{{% blocks/products/pf/agp/code-block title="ODP to JPEG C++ Conversion Source Code" offSpacer="" %}}
