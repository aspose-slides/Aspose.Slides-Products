...
[**Aspose.Slides for C++**](https://products.aspose.com/slides/cpp/) is a presentation processing API that can create slides from images and save the result in presentation or document formats. Using **Aspose.Slides for C++**, developers can convert PNG images to PDF with just a few lines of C++ code.
