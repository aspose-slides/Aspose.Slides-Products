...
[**Aspose.Slides for C++**](https://products.aspose.com/slides/cpp/) is a presentation processing API that can import images into slides and render the result as JPG images.
...
{{< blocks/products/pf/agp/other-supported-section-item href="/slides/cpp/conversion/image-to-pdf/" name="IMAGE TO PDF" >}}
