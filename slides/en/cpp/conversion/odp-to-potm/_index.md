...
description: C++ conversion code for ODP to POTM. Use the example code for batch ODP to POTM conversion in C++ applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert ODP to POTM in C++" h2="Convert ODP to POTM using Aspose.Slides for C++ without Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
To convert ODP to POTM, use [Aspose.Slides for C++](/slides/cpp/), a presentation processing API for C++ applications. You can download the latest version directly from [NuGet](https://www.nuget.org/packages/Aspose.Slides.Cpp/), search for **Aspose.Slides.Cpp**, and install it. You may also use the following command from the Package Manager Console.
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ developers can convert an ODP file to POTM in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1.  Create a `Presentation` instance from the source ODP file.
1.  Call the `Save` method and pass the output POTM file path with `SaveFormat::Potm`.
...
{{% blocks/products/pf/agp/code-block title="ODP to POTM C++ Conversion Source Code" offSpacer="" %}}

```cpp
auto presentation = MakeObject<Presentation>(u"presentation.odp");
presentation->Save(u"document.potm", SaveFormat::Potm);
