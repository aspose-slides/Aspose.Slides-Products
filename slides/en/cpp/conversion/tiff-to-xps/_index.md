---
title: Convert TIFF to XPS Using C++
weight: 1550
url: /cpp/conversion/tiff-to-xps/
description: C++ conversion code for TIFF to XPS. Use the example code for batch TIFF to XPS conversion in C++ applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert TIFF to XPS in C++" h2="Use C++ to convert TIFF file to XPS without Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TIFF" >}}
...
C++ developers can convert TIFF file to XPS by using Aspose.Slides for C++ to save the presentation as an XPS file.

{{% /blocks/products/pf/agp/text %}}

1.  Read the TIFF file bytes with `File::ReadAllBytes` and add the image to the first slide with `AddPictureFrame`.
...
presentation->Save(u"image.xps", SaveFormat::Xps);
