---
title: Convert TIFF to SVG Using C++
weight: 2970
url: /cpp/conversion/tiff-to-svg/
description: C++ conversion code for TIFF to SVG. Use the example code for batch TIFF to SVG conversion in C++ applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert TIFF to SVG in C++" h2="Use C++ to place a TIFF image on a slide and export it to SVG without Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TIFF" >}}
...
[Aspose.Slides for C++](https://products.aspose.com/slides/cpp/) is a PowerPoint processing API that lets you place TIFF images on slides and export them to SVG in C++ applications without Microsoft PowerPoint. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.Cpp/) or use the following Package Manager Console command.
...
C++ developers can convert a TIFF file to SVG by creating a presentation, adding the TIFF image to a slide, and then using Aspose.Slides for C++ to write the slide as an SVG file.
...
auto fileStream = MakeObject<FileStream>(u"image.svg", FileMode::Create, FileAccess::Write);
