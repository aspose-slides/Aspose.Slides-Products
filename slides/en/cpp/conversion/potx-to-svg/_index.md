...
description: C++ conversion code for POTX to SVG. Use the example code for batch POTX to SVG conversion in C++ applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert POTX to SVG in C++" h2="Convert POTX to SVG using Aspose.Slides for C++ without Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
To convert POTX to SVG, use [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/), a presentation processing API for C++ applications. You can download the latest version directly from [NuGet](https://www.nuget.org/packages/Aspose.Slides.Cpp/), search for **Aspose.Slides.Cpp**, and install it. You may also use the following command from the Package Manager Console.
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ developers can convert a POTX file to SVG in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1.  Create a `Presentation` instance from the source POTX file.
1.  Loop through the slides in the presentation.
1.  Create a file stream for each output SVG file.
...
{{< blocks/products/pf/agp/other-supported-section-item href="/slides/cpp/conversion/potx-to-pot/" name="POTX TO POT" description="Microsoft PowerPoint Template Files" >}}
