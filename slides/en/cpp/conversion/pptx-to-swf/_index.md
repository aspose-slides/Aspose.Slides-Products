---
title: Convert PPTX to SWF Using C++
url: /cpp/conversion/pptx-to-swf/
description: C++ conversion code for PPTX to SWF. Use the example code for batch PPTX to SWF conversion in C++ applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PPTX to SWF in C++" h2="Convert PPTX to SWF using Aspose.Slides for C++ without Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
Save a PPTX presentation as SWF with a direct C++ conversion call.

{{% /blocks/products/pf/agp/text %}}

1.  Create a `Presentation` instance from the source PPTX file.
1.  Call the `Save` method.
1.  Pass the output file path and `SaveFormat::Swf`.
