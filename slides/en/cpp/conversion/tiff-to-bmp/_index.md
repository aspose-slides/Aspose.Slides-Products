---
title: Convert TIFF to BMP Using C++
weight: 8780
url: /cpp/conversion/tiff-to-bmp/
description: C++ conversion code for TIFF to BMP. Use the example code for batch TIFF to BMP conversion in C++ applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert TIFF to BMP in C++" h2="Use C++ to place a TIFF image on a slide and export it to BMP without Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TIFF" >}}
...
{{% blocks/products/pf/agp/content h2="Convert TIFF to BMP Using C++" %}}

[Aspose.Slides for C++](/slides/cpp/) is a PowerPoint processing API that lets you place TIFF images on slides and export them to BMP in C++ applications without Microsoft PowerPoint. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.Cpp/) or use the following Package Manager Console command.
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert TIFF to BMP via C++" %}}

{{% blocks/products/pf/agp/text %}}

C++ developers can convert a TIFF file to BMP by creating a presentation, adding the TIFF image to a slide, and then using Aspose.Slides for C++ to render the slide as a BMP image.
...
image->Save(u"image.bmp", ImageFormat::Bmp);
image->Dispose();
