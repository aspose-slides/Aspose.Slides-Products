...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ developers can convert an ODP file to GIF in just a few lines of code.
...
1.  Save the rendered image in GIF format.
1.  Open the GIF file in a compatible program.
...
{{% blocks/products/pf/agp/code-block title="ODP to GIF C++ Conversion Source Code" offSpacer="" %}}
