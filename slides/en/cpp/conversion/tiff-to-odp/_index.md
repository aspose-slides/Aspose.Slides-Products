---
title: Convert TIFF to ODP Using C++
weight: 5220
url: /cpp/conversion/tiff-to-odp/
description: C++ conversion code for TIFF to ODP. Use the example code for batch TIFF to ODP conversion in C++ applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert TIFF to ODP in C++" h2="Use C++ to place a TIFF image on a slide and export it to ODP without Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TIFF" >}}
...
{{% blocks/products/pf/agp/content h2="Convert TIFF to ODP Using C++" %}}

[Aspose.Slides for C++](/slides/cpp/) is a PowerPoint processing API that lets you place TIFF images on slides and export them to ODP in C++ applications without Microsoft PowerPoint. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.Cpp/) or use the following Package Manager Console command.
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert TIFF to ODP via C++" %}}

{{% blocks/products/pf/agp/text %}}

C++ developers can convert a TIFF file to ODP by creating a presentation, adding the TIFF image to a slide, and then using Aspose.Slides for C++ to save the presentation as an ODP file.
...
presentation->Save(u"image.odp", SaveFormat::Odp);
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget
        ...
        sectionTitle="Free App to Convert TIFF to ODP"
