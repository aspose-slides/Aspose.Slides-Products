...
To convert JPG to another image format, create a new Presentation, add the JPG file to its image collection, place it on a slide with `AddPictureFrame`, and render the slide in the required image format.
