...
weight: 6110
url: /cpp/conversion/odp-to-emf/
description: C++ conversion code for ODP to EMF. Use the example code for batch ODP to EMF conversion in C++ applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert ODP to EMF in C++" h2="Convert ODP to EMF using Aspose.Slides for C++ without Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
To convert ODP to EMF, use [Aspose.Slides for C++](/slides/cpp/), a presentation processing API for C++ applications. You can download the latest version directly from [NuGet](https://www.nuget.org/packages/Aspose.Slides.Cpp/), search for **Aspose.Slides.Cpp**, and install it. You may also use the following command from the Package Manager Console.
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ developers can convert an ODP file to EMF in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1.  Load the ODP file with the Aspose.Slides for C++ Presentation class.
1.  Select the first slide.
1.  Create a file stream for the image.
1.  Save the slide to the file as an EMF image.
1.  Open the EMF file in a compatible program.
...
{{% blocks/products/pf/agp/code-block title="ODP to EMF C++ Conversion Source Code" offSpacer="" %}}
