...
title: PowerPoint APIs for .NET, Java, C++, Python, PHP, Node.js, and Android
weight: 10
url: /family/
description: PowerPoint APIs for .NET, Java, C++, Python, PHP, and Node.js. Create, write, edit, render, print, and convert PowerPoint PPT, PPTX, and ODP files. Export reports from SSRS and JasperReports to presentation formats.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1="PowerPoint APIs: .NET, Java, C++, Python, PHP, Node.js" h2="Native APIs for cross-platform development. Generate, manage, and convert PowerPoint presentations and slides in .NET, Java, C++, Python, PHP, Node.js, and Android." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides.svg" pfName="Aspose.Slides" downloadUrl="https://releases.aspose.com/slides/" tryOnlineUrl="https://products.aspose.app/slides/family" >}}

{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/product-card-row title="Aspose.Slides PowerPoint APIs" >}}
...
PowerPoint API for creating, editing, rendering, and converting presentations in .NET applications.
...
PowerPoint API for manipulating and rendering PowerPoint presentations and slides in C++ applications.
{{< /blocks/products/pf/product >}}
...
PowerPoint API for manipulating presentations in Android mobile applications.
{{< /blocks/products/pf/product >}}
...
PowerPoint API for generating and manipulating presentations in Node.js applications via .NET.
{{< /blocks/products/pf/product >}}
...
PowerPoint API for generating and manipulating presentations in Node.js applications via Java.
{{< /blocks/products/pf/product >}}
...
Compare PowerPoint documents with Aspose.Slides API.
{{< /blocks/products/pf/product >}}
...
Convert PowerPoint presentations with Aspose.Slides API.
{{< /blocks/products/pf/product >}}
...
Use charts in PowerPoint presentations with Aspose.Slides API.
{{< /blocks/products/pf/product >}}
...
Merge presentations with Aspose.Slides API.
{{< /blocks/products/pf/product >}}
...
Edit presentation properties with Aspose.Slides API.
{{< /blocks/products/pf/product >}}
...
Extract presentation text, images, and audio with Aspose.Slides API.
{{< /blocks/products/pf/product >}}
...
Password-protect PowerPoint presentations with Aspose.Slides API.
{{< /blocks/products/pf/product >}}
...
Search text in presentations with Aspose.Slides API.
{{< /blocks/products/pf/product >}}
...
Sign presentations with Aspose.Slides API.
{{< /blocks/products/pf/product >}}
...
Split PowerPoint presentations with Aspose.Slides API.
{{< /blocks/products/pf/product >}}
...
Remove passwords from PowerPoint presentations with Aspose.Slides API.
{{< /blocks/products/pf/product >}}
...
Add watermarks to presentations with Aspose.Slides API.
{{< /blocks/products/pf/product >}}
...
{{< blocks/products/pf/slr-element name="Sales Support" href="https://www.aspose.com/community/user/createuserquick.aspx?ReturnUrl=/products/slides" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Why Aspose.Slides?" tabId="success-stories" >}}
