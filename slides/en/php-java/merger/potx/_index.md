...
{{% blocks/products/pf/agp/code-block title="PHP code for merge multiple POTX into single file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge POTX using Aspose.Slides for PHP API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to merge two POTX files and save result as POTX in PHP." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Load the POTX files you want to merge.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Save the resulting POTX doc.
{{< /blocks/products/pf/agp/step-autogen >}}
