...
{{% blocks/products/pf/agp/code-block title="PHP code for merge multiple FODP into single file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge FODP using Aspose.Slides for PHP API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to merge two FODP files and save result as FODP in PHP." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Load the FODP files you want to merge.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Save the resulting FODP doc.
{{< /blocks/products/pf/agp/step-autogen >}}
