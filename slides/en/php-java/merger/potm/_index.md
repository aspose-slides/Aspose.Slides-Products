...
{{% blocks/products/pf/agp/code-block title="PHP code for merge multiple POTM into single file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge POTM using Aspose.Slides for PHP API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to merge two POTM files and save result as POTM in PHP." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Load the POTM files you want to merge.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Save the resulting POTM doc.
{{< /blocks/products/pf/agp/step-autogen >}}
