...
{{% blocks/products/pf/agp/code-block title="PHP code for merge multiple POT into single file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge POT using Aspose.Slides for PHP API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to merge two POT files and save result as POT in PHP." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Load the POT files you want to merge.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Save the resulting POT doc.
{{< /blocks/products/pf/agp/step-autogen >}}
