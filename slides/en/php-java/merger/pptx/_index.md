...
{{% blocks/products/pf/agp/code-block title="PHP code for merge multiple PPTX into single file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to merge PPTX using Aspose.Slides for PHP API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to merge two PPTX files and save result as PPTX in PHP." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Load the PPTX files you want to merge.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Save the resulting PPTX doc.
{{< /blocks/products/pf/agp/step-autogen >}}
