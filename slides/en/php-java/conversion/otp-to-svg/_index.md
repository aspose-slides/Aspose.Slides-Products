...
description: Sample code for OTP to SVG PHP conversion. Use PowerPoint PHP API for batch conversion OTP files to SVG files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert OTP to SVG in PHP" h2="Powerful PowerPoint PHP library for converting OTP to SVG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
Need to convert OTP files to SVG programmatically? Using [*Aspose.Slides for PHP via Java*](https://products.aspose.com/slides/php-java/) any developer can convert OTP to SVG format with just a few lines of PHP code.

As a modern presentation processing API, Aspose.Slides for PHP creates SVG from OTP quickly. Test the quality of OTP to SVG conversion right in your [browser](https://products.aspose.app/slides/conversion). Aspose PowerPoint PPTX library allows you to convert OTP files to many popular formats.
...
{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert a OTP file to SVG using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows OTP to SVG PHP Conversion" offSpacer="" %}}
