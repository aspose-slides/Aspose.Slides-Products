...
description: Sample PHP code for converting FODP presentations to multipage TIFF images with Aspose.Slides for PHP via Java.
---
...
{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an FODP file to TIFF using PHP." >}}
