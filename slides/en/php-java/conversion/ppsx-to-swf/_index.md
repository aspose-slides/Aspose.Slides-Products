...
description: Convert PPSX files to SWF in PHP with Aspose.Slides. Use the sample code to save a PowerPoint slide show as a Shockwave Flash file.
---
...
Convert PPSX files to SWF programmatically with [*Aspose.Slides for PHP via Java*](/slides/php-java/). Load a PowerPoint Open XML Slide Show and save it as a Shockwave Flash file with a few lines of PHP code.

Aspose.Slides performs the conversion through the `Presentation` class and its `save` method. You can also try the PPSX-to-SWF conversion in your [browser](https://products.aspose.app/slides/conversion) before integrating it into your application.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PPSX-to-SWF conversion in PHP" offSpacer="" %}}
