...
title: Convert FODP to PPT in PHP
weight: 150
url: /php-java/conversion/fodp-to-ppt/ 
keywords: "Convert, PowerPoint, FODP, PPT, Presentation, PHP"
description: Sample PHP code for converting FODP presentations to PowerPoint PPT files with Aspose.Slides for PHP via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert FODP to PPT in PHP" h2="Powerful PowerPoint PHP library for converting FODP to PPT" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert FODP to PPT in PHP" %}}

Need to convert FODP files to PPT programmatically? With [*Aspose.Slides for PHP via Java*](/slides/php-java/), you can export an FODP presentation as a PowerPoint 97–2003 PPT file with a few lines of PHP code.

Aspose.Slides provides a straightforward presentation-processing API for FODP-to-PPT conversion. You can also test presentation conversions in your [browser](https://products.aspose.app/slides/conversion) or export FODP files to many other supported formats.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert FODP to PPT in PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an FODP file to PPT using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows FODP to PPT PHP Conversion" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save FODP as PPT in PHP" %}}
Use the free app to see a demonstration of the FODP-to-PPT conversion process.
{{% /blocks/products/pf/agp/content %}}
