...
Need to convert FODP files to PPT programmatically? With [*Aspose.Slides for PHP via Java*](/slides/php-java/), you can export a FODP presentation as a PowerPoint 97–2003 PPT file with a few lines of PHP code.
