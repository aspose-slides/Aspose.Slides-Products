---
title: Convert PPT to GIF in PHP
weight: 2130
url: /php-java/conversion/ppt-to-gif/
keywords: "Convert, PowerPoint, PPT, GIF, Presentation, PHP"
description: Convert PPT files to animated GIFs in PHP with Aspose.Slides. Use the sample code to export a PowerPoint 97-2003 presentation as an animated GIF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PPT to GIF in PHP" h2="Powerful PowerPoint PHP library for converting PPT to GIF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert PPT to GIF in PHP" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert PPT to GIF in PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert a PPT file to GIF using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PPT-to-GIF conversion in PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save PPT as GIF in PHP" %}}
