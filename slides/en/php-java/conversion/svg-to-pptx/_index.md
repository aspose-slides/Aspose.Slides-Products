...
description: Convert SVG files to PowerPoint PPTX presentations in PHP with Aspose.Slides for PHP via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert SVG to PPTX in PHP" h2="Add an SVG image to a slide and save the presentation as a PowerPoint PPTX file with Aspose.Slides for PHP via Java." >}}
...
{{% blocks/products/pf/agp/code-block title="PHP code for converting SVG into PPTX" offSpacer="true" %}}
