...
title: Convert PPT to SVG in PHP
weight: 2280
url: /php-java/conversion/ppt-to-svg/
keywords: "Convert, PowerPoint, PPT, SVG, Presentation, PHP"
description: Convert PPT slides to SVG images in PHP with Aspose.Slides. Use the sample code to export each slide in a PowerPoint 97-2003 presentation as a separate SVG file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PPT to SVG in PHP" h2="Powerful PowerPoint PHP library for converting PPT to SVG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert PPT to SVG in PHP" %}}

Convert PPT slides to SVG programmatically with [*Aspose.Slides for PHP via Java*](/slides/php-java/). Load a PowerPoint 97-2003 presentation and export every slide as an individual scalable vector image with a few lines of PHP code.

Aspose.Slides exports a slide through its `writeAsSvg` method and a Java output stream. You can also try the PPT-to-SVG conversion in your [browser](https://products.aspose.app/slides/conversion) before integrating it into your application.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert PPT to SVG in PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert a PPT file to SVG using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PPT-to-SVG conversion in PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save PPT as SVG in PHP" %}}
