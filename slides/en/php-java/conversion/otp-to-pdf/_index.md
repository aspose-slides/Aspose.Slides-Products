...
Use [*Aspose.Slides for PHP via Java*](/slides/php-java/) to load an OTP presentation and export it as a PDF document.

Call `save` with `SaveFormat::Pdf` to create the output file. You can also test OTP conversion in your [browser](https://products.aspose.app/slides/conversion).
...
{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an OTP file to PDF using PHP." >}}
