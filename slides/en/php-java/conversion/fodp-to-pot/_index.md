...
description: Sample PHP code for converting FODP presentations to POT files with Aspose.Slides for PHP via Java.
---
...
Need to convert FODP files to POT programmatically? With [*Aspose.Slides for PHP via Java*](/slides/php-java/), you can export an FODP presentation as a POT file with a few lines of PHP code.

Aspose.Slides provides a straightforward presentation-processing API for FODP-to-POT conversion. You can also test presentation conversions in your [browser](https://products.aspose.app/slides/conversion) or export FODP files to many other supported formats.
...
{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an FODP file to POT using PHP." >}}
