...
description: Sample code for PPSM to PDF PHP conversion. Use PowerPoint PHP API for batch conversion PPSM files to PDF files.
---
...
Need to convert PPSM files to PDF programmatically? Using [*Aspose.Slides for PHP via Java*](https://products.aspose.com/slides/php-java/) any developer can convert PPSM to PDF format with just a few lines of PHP code.

As a modern presentation processing API, Aspose.Slides for PHP creates PDF from PPSM quickly. Test the quality of PPSM to PDF conversion right in your [browser](https://products.aspose.app/slides/conversion). Aspose PowerPoint PPTX library allows you to convert PPSM files to many popular formats.
