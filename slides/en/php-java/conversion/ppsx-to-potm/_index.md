...
title: Convert PPSX to POTM in PHP
weight: 2000
url: /php-java/conversion/ppsx-to-potm/
keywords: "Convert, PowerPoint, PPSX, POTM, Presentation, PHP"
description: Convert PPSX files to POTM in PHP with Aspose.Slides. Use the sample code to save a PowerPoint slide show as a macro-enabled PowerPoint template.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PPSX to POTM in PHP" h2="Powerful PowerPoint PHP library for converting PPSX to POTM" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert PPSX to POTM in PHP" %}}

Convert PPSX files to POTM programmatically with [*Aspose.Slides for PHP via Java*](/slides/php-java/). Load a PowerPoint Open XML Slide Show and save it as a macro-enabled PowerPoint template with a few lines of PHP code.

Aspose.Slides performs the conversion through the `Presentation` class and its `save` method. You can also try the PPSX-to-POTM conversion in your [browser](https://products.aspose.app/slides/conversion) before integrating it into your application.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert PPSX to POTM in PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert a PPSX file to POTM using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PPSX-to-POTM conversion in PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save PPSX as POTM in PHP" %}}
