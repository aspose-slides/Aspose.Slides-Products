...
title: Convert PPT to ODP in PHP
weight: 2160
url: /php-java/conversion/ppt-to-odp/
keywords: "Convert, PowerPoint, PPT, ODP, Presentation, PHP"
description: Convert PPT files to ODP in PHP with Aspose.Slides. Use the sample code to save a PowerPoint 97-2003 presentation in the OpenDocument Presentation format.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PPT to ODP in PHP" h2="Powerful PowerPoint PHP library for converting PPT to ODP" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert PPT to ODP in PHP" %}}

Convert PPT files to ODP programmatically with [*Aspose.Slides for PHP via Java*](/slides/php-java/). Load a PowerPoint 97-2003 presentation and save it as an OpenDocument Presentation with a few lines of PHP code.

Aspose.Slides performs the conversion through the `Presentation` class and its `save` method. You can also try the PPT-to-ODP conversion in your [browser](https://products.aspose.app/slides/conversion) before integrating it into your application.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert PPT to ODP in PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert a PPT file to ODP using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PPT-to-ODP conversion in PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save PPT as ODP in PHP" %}}
