---
title: Convert PPSX to FODP in PHP
weight: 1910
url: /php-java/conversion/ppsx-to-fodp/
keywords: "Convert, PowerPoint, PPSX, FODP, Presentation, PHP"
description: Sample PHP code for converting PPSX presentations to FODP files with Aspose.Slides for PHP via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PPSX to FODP in PHP" h2="Powerful PowerPoint PHP library for converting PPSX to FODP" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert PPSX to FODP in PHP" %}}

Need to convert PPSX files to FODP programmatically? With [*Aspose.Slides for PHP via Java*](/slides/php-java/), you can export a PPSX presentation as an FODP file with a few lines of PHP code.

Aspose.Slides provides a straightforward presentation-processing API for PPSX-to-FODP conversion. You can also test presentation conversions in your [browser](https://products.aspose.app/slides/conversion) or export PPSX files to many other supported formats.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert PPSX to FODP in PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert a PPSX file to FODP using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PPSX to FODP PHP Conversion" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save PPSX as FODP in PHP" %}}
