---
title: Convert OTP to JPG in PHP
weight: 470
url: /php-java/conversion/otp-to-jpg/
keywords: "Convert, PowerPoint, OTP, JPG, Presentation, PHP"
description: Convert OTP presentation slides to JPG images in PHP with Aspose.Slides for PHP via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert OTP to JPG in PHP" h2="Render OTP presentation slides as JPG images with Aspose.Slides for PHP via Java" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert OTP to JPG in PHP" %}}

Use [*Aspose.Slides for PHP via Java*](/slides/php-java/) to load an OTP presentation and render each slide as a JPG image.

Call `getImage` for each slide and save the rendered image with `ImageFormat::Jpeg`. You can also test presentation-to-JPG conversion in your [browser](https://products.aspose.app/slides/conversion/otp-to-jpeg).
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert OTP to JPG in PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an OTP file to JPG using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows OTP to JPG PHP Conversion" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save OTP as JPG in PHP" %}}
Use the free app to see a demonstration of the OTP to JPG conversion process.
{{% /blocks/products/pf/agp/content %}}
...
sectionDescription="[Try our free Conversion app](https://products.aspose.app/slides/conversion/otp-to-jpeg)"
>}}
