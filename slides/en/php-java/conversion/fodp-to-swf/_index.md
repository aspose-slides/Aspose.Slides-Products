...
Need to convert FODP files to SWF programmatically? With [*Aspose.Slides for PHP via Java*](/slides/php-java/), you can export a FODP presentation as an SWF file with a few lines of PHP code.
