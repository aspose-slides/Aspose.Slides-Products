...
title: Convert OTP to PNG in PHP
weight: 500
url: /php-java/conversion/otp-to-png/
keywords: "Convert, PowerPoint, OTP, PNG, Presentation, PHP"
description: Convert OTP presentation slides to PNG images in PHP with Aspose.Slides for PHP via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert OTP to PNG in PHP" h2="Render OTP presentation slides as PNG images with Aspose.Slides for PHP via Java" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert OTP to PNG in PHP" %}}

Use [*Aspose.Slides for PHP via Java*](/slides/php-java/) to load an OTP presentation and render each slide as a PNG image.

Call `getImage` for each slide and save the rendered image with `ImageFormat::Png`. You can also test presentation-to-PNG conversion in your [browser](https://products.aspose.app/slides/conversion/otp-to-png).
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert OTP to PNG in PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an OTP file to PNG using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows OTP to PNG PHP Conversion" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save OTP as PNG in PHP" %}}
Use the free app to see a demonstration of the OTP to PNG conversion process.
{{% /blocks/products/pf/agp/content %}}
...
sectionDescription="[Try our free Conversion app](https://products.aspose.app/slides/conversion/otp-to-png)"
>}}
