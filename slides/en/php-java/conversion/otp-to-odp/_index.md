...
{{% blocks/products/pf/agp/content h2="Convert OTP to ODP in PHP" %}}

Use [*Aspose.Slides for PHP via Java*](/slides/php-java/) to load an OTP presentation and save it as an OpenDocument Presentation file (ODP).

Call `save` with `SaveFormat::Odp` to create the output file. You can also test OTP conversion in your [browser](https://products.aspose.app/slides/conversion).
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert OTP to ODP in PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an OTP file to ODP using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows OTP to ODP PHP Conversion" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save OTP as ODP in PHP" %}}
Use the free app to see a demonstration of the OTP to ODP conversion process.
{{% /blocks/products/pf/agp/content %}}
