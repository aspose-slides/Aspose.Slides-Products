...
description: Convert PPSX slides to SVG images in PHP with Aspose.Slides. Use the sample code to export each slide in a PowerPoint slide show as a separate SVG file.
---
...
Convert PPSX slides to SVG programmatically with [*Aspose.Slides for PHP via Java*](/slides/php-java/). Load a PowerPoint Open XML Slide Show and export every slide as an individual scalable vector image with a few lines of PHP code.

Aspose.Slides exports a slide through its `writeAsSvg` method and a Java output stream. You can also try the PPSX-to-SVG conversion in your [browser](https://products.aspose.app/slides/conversion) before integrating it into your application.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PPSX-to-SVG conversion in PHP" offSpacer="" %}}
