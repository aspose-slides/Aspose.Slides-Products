...
description: Convert OTP presentations to PowerPoint macro-enabled slide show (PPSM) files in PHP with Aspose.Slides for PHP via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert OTP to PPSM in PHP" h2="Save OTP presentations as PowerPoint macro-enabled slide show (PPSM) files with Aspose.Slides for PHP via Java" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an OTP file to PPSM using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows OTP to PPSM conversion in PHP" offSpacer="" %}}
