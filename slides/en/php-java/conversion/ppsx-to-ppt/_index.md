...
description: Convert PPSX files to PPT in PHP with Aspose.Slides. Use the sample code to save a PowerPoint slide show as a PowerPoint 97-2003 presentation.
---
...
Convert PPSX files to PPT programmatically with [*Aspose.Slides for PHP via Java*](/slides/php-java/). Load a PowerPoint Open XML Slide Show and save it as a PowerPoint 97-2003 presentation with a few lines of PHP code.

Aspose.Slides performs the conversion through the `Presentation` class and its `save` method. You can also try the PPSX-to-PPT conversion in your [browser](https://products.aspose.app/slides/conversion) before integrating it into your application.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PPSX-to-PPT conversion in PHP" offSpacer="" %}}
