...
Need to convert FODP files to XPS programmatically? With [*Aspose.Slides for PHP via Java*](/slides/php-java/), you can export a FODP presentation as an XPS document with a few lines of PHP code.
