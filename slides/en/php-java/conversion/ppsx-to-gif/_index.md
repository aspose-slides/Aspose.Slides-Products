...
description: Sample PHP code for converting PPSX presentations to GIF files with Aspose.Slides for PHP via Java.
---
...
Need to convert PPSX files to GIF programmatically? With [*Aspose.Slides for PHP via Java*](/slides/php-java/), you can export a PPSX presentation as a GIF file with a few lines of PHP code.

Aspose.Slides provides a straightforward presentation-processing API for PPSX-to-GIF conversion. You can also test presentation conversions in your [browser](https://products.aspose.app/slides/conversion) or export PPSX files to many other supported formats.
