...
title: Convert PPSX to TIFF in PHP
weight: 2090
url: /php-java/conversion/ppsx-to-tiff/
keywords: "Convert, PowerPoint, PPSX, TIFF, Presentation, PHP"
description: Convert PPSX files to TIFF in PHP with Aspose.Slides. Use the sample code to save a PowerPoint slide show as a multi-page TIFF image.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PPSX to TIFF in PHP" h2="Powerful PowerPoint PHP library for converting PPSX to TIFF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert PPSX to TIFF in PHP" %}}

Convert PPSX files to TIFF programmatically with [*Aspose.Slides for PHP via Java*](/slides/php-java/). Load a PowerPoint Open XML Slide Show and save it as a multi-page TIFF image with a few lines of PHP code.

Aspose.Slides performs the conversion through the `Presentation` class and its `save` method. You can also try the PPSX-to-TIFF conversion in your [browser](https://products.aspose.app/slides/conversion) before integrating it into your application.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert PPSX to TIFF in PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert a PPSX file to TIFF using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PPSX-to-TIFF conversion in PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save PPSX as TIFF in PHP" %}}
