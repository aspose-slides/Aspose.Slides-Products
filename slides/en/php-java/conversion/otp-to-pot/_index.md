...
title: Convert OTP to POT in PHP
weight: 510
url: /php-java/conversion/otp-to-pot/
keywords: "Convert, PowerPoint, OTP, POT, Presentation, PHP"
description: Convert OTP presentations to PowerPoint POT files in PHP with Aspose.Slides for PHP via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert OTP to POT in PHP" h2="Save OTP presentations as PowerPoint POT files with Aspose.Slides for PHP via Java" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="POT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert OTP to POT in PHP" %}}

Use [*Aspose.Slides for PHP via Java*](/slides/php-java/) to load an OTP presentation and save it as a PowerPoint 97-2003 file (POT).

Call `save` with `SaveFormat::Pot` to create the output file. You can also test OTP conversion in your [browser](https://products.aspose.app/slides/conversion).
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert OTP to POT in PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an OTP file to POT using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows OTP to POT PHP Conversion" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save OTP as POT in PHP" %}}
