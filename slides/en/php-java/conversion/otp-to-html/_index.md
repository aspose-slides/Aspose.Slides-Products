...
title: Convert OTP to HTML in PHP
weight: 460
url: /php-java/conversion/otp-to-html/
keywords: "Convert, PowerPoint, OTP, HTML, Presentation, PHP"
description: Convert OTP presentations to HTML5 in PHP with Aspose.Slides for PHP via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert OTP to HTML in PHP" h2="Export OTP presentations as HTML5 with Aspose.Slides for PHP via Java" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert OTP to HTML in PHP" %}}

Use [*Aspose.Slides for PHP via Java*](/slides/php-java/) to load an OTP presentation and export it as HTML5.

Call `save` with `SaveFormat::Html5` to create the output file. You can also test OTP conversion in your [browser](https://products.aspose.app/slides/conversion).
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert OTP to HTML in PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an OTP file to HTML using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows OTP to HTML PHP Conversion" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save OTP as HTML in PHP" %}}
Use the free app to see a demonstration of the OTP to HTML conversion process.
{{% /blocks/products/pf/agp/content %}}
