...
description: Convert PPSX files to PPTX in PHP with Aspose.Slides. Use the sample code to save a PowerPoint slide show as an Open XML presentation.
---
...
Convert PPSX files to PPTX programmatically with [*Aspose.Slides for PHP via Java*](/slides/php-java/). Load a PowerPoint Open XML Slide Show and save it as an Open XML presentation with a few lines of PHP code.

Aspose.Slides performs the conversion through the `Presentation` class and its `save` method. You can also try the PPSX-to-PPTX conversion in your [browser](https://products.aspose.app/slides/conversion) before integrating it into your application.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PPSX-to-PPTX conversion in PHP" offSpacer="" %}}
