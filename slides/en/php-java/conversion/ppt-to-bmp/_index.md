...
title: Convert PPT to BMP in PHP
weight: 2110
url: /php-java/conversion/ppt-to-bmp/
keywords: "Convert, PowerPoint, PPT, BMP, Presentation, PHP"
description: Convert PPT slides to BMP images in PHP with Aspose.Slides. Use the sample code to render each slide in a PowerPoint 97-2003 presentation as a separate BMP file.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PPT to BMP in PHP" h2="Powerful PowerPoint PHP library for converting PPT to BMP" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert PPT to BMP in PHP" %}}

Convert PPT slides to BMP programmatically with [*Aspose.Slides for PHP via Java*](/slides/php-java/). Load a PowerPoint 97-2003 presentation and render every slide as an individual bitmap image with a few lines of PHP code.

Aspose.Slides renders a slide through its `getImage` method and saves the result through the image object's `save` method. You can also try the PPT-to-BMP conversion in your [browser](https://products.aspose.app/slides/conversion) before integrating it into your application.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert PPT to BMP in PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert a PPT file to BMP using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PPT-to-BMP conversion in PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save PPT as BMP in PHP" %}}
