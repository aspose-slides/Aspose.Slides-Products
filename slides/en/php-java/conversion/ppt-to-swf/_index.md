...
description: Convert PPT files to SWF in PHP with Aspose.Slides. Use the sample code to save a PowerPoint 97-2003 presentation in Small Web Format.
---
...
Convert PPT files to SWF programmatically with [*Aspose.Slides for PHP via Java*](/slides/php-java/). Load a PowerPoint 97-2003 presentation and save it in Small Web Format with a few lines of PHP code.

Aspose.Slides performs the conversion through the `Presentation` class and its `save` method. You can also try the PPT-to-SWF conversion in your [browser](https://products.aspose.app/slides/conversion) before integrating it into your application.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PPT-to-SWF conversion in PHP" offSpacer="" %}}
