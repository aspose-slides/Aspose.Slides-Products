---
title: Convert OTP to POTM in PHP
weight: 520
url: /php-java/conversion/otp-to-potm/
keywords: "Convert, PowerPoint, OTP, POTM, Presentation, PHP"
description: Convert OTP presentations to PowerPoint macro-enabled template (POTM) files in PHP with Aspose.Slides for PHP via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert OTP to POTM in PHP" h2="Save OTP presentations as PowerPoint macro-enabled template (POTM) files with Aspose.Slides for PHP via Java" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert OTP to POTM in PHP" %}}

Use [*Aspose.Slides for PHP via Java*](/slides/php-java/) to load an OTP presentation and save it as a PowerPoint macro-enabled template (POTM) file.

Call `save` with `SaveFormat::Potm` to create the output file. You can also test OTP conversion in your [browser](https://products.aspose.app/slides/conversion).
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert OTP to POTM in PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an OTP file to POTM using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows OTP to POTM conversion in PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save OTP as POTM in PHP" %}}
Use the free app to see a demonstration of the OTP to POTM conversion process.
{{% /blocks/products/pf/agp/content %}}
