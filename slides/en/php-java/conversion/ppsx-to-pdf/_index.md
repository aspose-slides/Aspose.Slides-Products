...
title: Convert PPSX to PDF in PHP
weight: 1970
url: /php-java/conversion/ppsx-to-pdf/
keywords: "Convert, PowerPoint, PPSX, PDF, Presentation, PHP"
description: Convert PPSX files to PDF in PHP with Aspose.Slides. Use the sample code to export a PowerPoint slide show to Portable Document Format.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PPSX to PDF in PHP" h2="Powerful PowerPoint PHP library for converting PPSX to PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert PPSX to PDF in PHP" %}}

Convert PPSX files to PDF programmatically with [*Aspose.Slides for PHP via Java*](/slides/php-java/). Load a PowerPoint Open XML Slide Show and export it to Portable Document Format with a few lines of PHP code.

Aspose.Slides performs the conversion through the `Presentation` class and its `save` method. You can also try the PPSX-to-PDF conversion in your [browser](https://products.aspose.app/slides/conversion) before integrating it into your application.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert PPSX to PDF in PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert a PPSX file to PDF using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PPSX-to-PDF conversion in PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save PPSX as PDF in PHP" %}}
