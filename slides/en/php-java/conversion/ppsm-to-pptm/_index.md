...
description: Sample code for PPSM to PPTM PHP conversion. Use PowerPoint PHP API for batch conversion PPSM files to PPTM files.
---
...
Need to convert PPSM files to PPTM programmatically? Using [*Aspose.Slides for PHP via Java*](https://products.aspose.com/slides/php-java/) any developer can convert PPSM to PPTM format with just a few lines of PHP code.

As a modern presentation processing API, Aspose.Slides for PHP creates PPTM from PPSM quickly. Test the quality of PPSM to PPTM conversion right in your [browser](https://products.aspose.app/slides/conversion). Aspose PowerPoint PPTX library allows you to convert PPSM files to many popular formats.
