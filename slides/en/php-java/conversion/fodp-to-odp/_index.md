...
description: Sample PHP code for converting FODP presentations to ODP with Aspose.Slides for PHP via Java.
---
...
Need to convert FODP files to ODP programmatically? With [*Aspose.Slides for PHP via Java*](/slides/php-java/), you can convert a flat XML OpenDocument presentation to a packaged ODP file with a few lines of PHP code.

Aspose.Slides provides a straightforward presentation-processing API for FODP-to-ODP conversion. You can also test presentation conversions in your [browser](https://products.aspose.app/slides/conversion) or export FODP files to many other supported formats.
...
{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an FODP file to ODP using PHP." >}}
