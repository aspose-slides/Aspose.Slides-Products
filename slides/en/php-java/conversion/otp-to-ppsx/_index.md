---
title: Convert OTP to PPSX in PHP
weight: 560
url: /php-java/conversion/otp-to-ppsx/
keywords: "Convert, PowerPoint, OTP, PPSX, Presentation, PHP"
description: Convert OTP presentations to PowerPoint Open XML slide show (PPSX) files in PHP with Aspose.Slides for PHP via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert OTP to PPSX in PHP" h2="Save OTP presentations as PowerPoint Open XML slide show (PPSX) files with Aspose.Slides for PHP via Java" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert OTP to PPSX in PHP" %}}

Use [*Aspose.Slides for PHP via Java*](/slides/php-java/) to load an OTP presentation and save it as a PowerPoint Open XML slide show (PPSX) file.

Call `save` with `SaveFormat::Ppsx` to create the output file. You can also test OTP conversion in your [browser](https://products.aspose.app/slides/conversion).
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert OTP to PPSX in PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an OTP file to PPSX using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows OTP to PPSX conversion in PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save OTP as PPSX in PHP" %}}
Use the free app to see a demonstration of the OTP to PPSX conversion process.
{{% /blocks/products/pf/agp/content %}}
