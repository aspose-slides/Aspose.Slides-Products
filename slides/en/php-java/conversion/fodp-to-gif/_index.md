---
title: Convert FODP to GIF in PHP
weight: 20
url: /php-java/conversion/fodp-to-gif/ 
keywords: "Convert, PowerPoint, FODP, GIF, Presentation, PHP"
description: Sample PHP code for converting FODP presentations to animated GIF files with Aspose.Slides for PHP via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert FODP to GIF in PHP" h2="Powerful PowerPoint PHP library for converting FODP to GIF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert FODP to GIF in PHP" %}}

Need to convert FODP files to GIF programmatically? With [*Aspose.Slides for PHP via Java*](/slides/php-java/), you can export an FODP presentation as an animated GIF with a few lines of PHP code.

Aspose.Slides provides a straightforward presentation-processing API for FODP-to-GIF conversion. You can also test presentation conversions in your [browser](https://products.aspose.app/slides/conversion) or export FODP files to many other supported formats.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert FODP to GIF in PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert an FODP file to GIF using PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows FODP to GIF PHP Conversion" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save FODP as GIF in PHP" %}}
Use the free app to see a demonstration of the FODP-to-GIF conversion process.
{{% /blocks/products/pf/agp/content %}}
