...
description: Convert PPSX files to ODP in PHP with Aspose.Slides. Use the sample code to save a PowerPoint slide show as an OpenDocument presentation.
---
...
Convert PPSX files to ODP programmatically with [*Aspose.Slides for PHP via Java*](/slides/php-java/). Load a PowerPoint Open XML Slide Show and save it as an OpenDocument Presentation with a few lines of PHP code.

Aspose.Slides performs the conversion through the `Presentation` class and its `save` method. You can also try the PPSX-to-ODP conversion in your [browser](https://products.aspose.app/slides/conversion) before integrating it into your application.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PPSX-to-ODP conversion in PHP" offSpacer="" %}}
