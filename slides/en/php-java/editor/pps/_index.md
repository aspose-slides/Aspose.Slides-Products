...
description: Edit PPS in PHP. Use PHP library API to edit PPS files
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edit PPS in PHP" h2="High-speed and cross-platform PHP library for editing PPS using PHP code" >}}

{{% blocks/products/pf/feature-page-section h2="Edit PPS using Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/php-java/) is a powerful PHP library used to manipulate and edit presentations. You can edit a PPS presentation by adding a new line of text to it. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edit PPS in PHP" %}}
Using [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/php-java/), you can add a new line of text to the PPS document with just a few lines of code.
...
{{< blocks/products/pf/agp/step-autogen >}}
Load the PPS presentation you want to edit.
{{< /blocks/products/pf/agp/step-autogen >}}
