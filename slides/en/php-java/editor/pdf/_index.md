...
description: Edit PDF in PHP. Use PHP library API to edit PDF files
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edit PDF in PHP" h2="High-speed and cross-platform PHP library for editing PDF using PHP code" >}}
...
Using [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/php-java/), you can add a new line of text to the PDF document with just a few lines of code.
...
{{< blocks/products/pf/agp/step-autogen >}}
Load the PDF presentation you want to edit.
{{< /blocks/products/pf/agp/step-autogen >}}
