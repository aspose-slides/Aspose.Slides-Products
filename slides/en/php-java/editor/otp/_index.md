...
description: Edit OTP in PHP. Use PHP library API to edit OTP files
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edit OTP in PHP" h2="High-speed and cross-platform PHP library for editing OTP using PHP code" >}}

{{% blocks/products/pf/feature-page-section h2="Edit OTP using Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/php-java/) is a powerful PHP library used to manipulate and edit presentations. You can edit a OTP presentation by adding a new line of text to it. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edit OTP in PHP" %}}
Using [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/php-java/), you can add a new line of text to the OTP document with just a few lines of code.
...
{{< blocks/products/pf/agp/step-autogen >}}
Load the OTP presentation you want to edit.
{{< /blocks/products/pf/agp/step-autogen >}}
