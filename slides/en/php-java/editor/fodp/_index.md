---
title: Edit FODP in PHP
url: /php-java/editor/fodp/
keywords: Edit FODP, Edit PowerPoint, FODP, PowerPoint, PHP API, PHP Library
description: Edit FODP in PHP. Use PHP library API to edit FODP files
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edit FODP in PHP" h2="High-speed and cross-platform PHP library for editing FODP using PHP code" >}}

{{% blocks/products/pf/feature-page-section h2="Edit FODP using Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/php-java/) is a powerful PHP library used to manipulate and edit presentations. You can edit a FODP presentation by adding a new line of text to it. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edit FODP in PHP" %}}
Using [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/php-java/), you can add a new line of text to the FODP document with just a few lines of code.
...
{{< blocks/products/pf/feature-page-section  h2="How to edit FODP in PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Load the FODP presentation you want to edit.
{{< /blocks/products/pf/agp/step-autogen >}}
