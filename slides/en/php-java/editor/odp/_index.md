...
description: Edit ODP in PHP. Use PHP library API to edit ODP files
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edit ODP in PHP" h2="High-speed and cross-platform PHP library for editing ODP using PHP code" >}}

{{% blocks/products/pf/feature-page-section h2="Edit ODP using Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/php-java/) is a powerful PHP library used to manipulate and edit presentations. You can edit a ODP presentation by adding a new line of text to it. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edit ODP in PHP" %}}
Using [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/php-java/), you can add a new line of text to the ODP document with just a few lines of code.
...
{{< blocks/products/pf/agp/step-autogen >}}
Load the ODP presentation you want to edit.
{{< /blocks/products/pf/agp/step-autogen >}}
