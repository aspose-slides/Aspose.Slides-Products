...
description: Edit PPTX in PHP. Use PHP library API to edit PPTX files
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edit PPTX in PHP" h2="High-speed and cross-platform PHP library for editing PPTX using PHP code" >}}

{{% blocks/products/pf/feature-page-section h2="Edit PPTX using Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/php-java/) is a powerful PHP library used to manipulate and edit presentations. You can edit a PPTX presentation by adding a new line of text to it. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edit PPTX in PHP" %}}
Using [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/php-java/), you can add a new line of text to the PPTX document with just a few lines of code.
...
{{< blocks/products/pf/agp/step-autogen >}}
Load the PPTX presentation you want to edit.
{{< /blocks/products/pf/agp/step-autogen >}}
