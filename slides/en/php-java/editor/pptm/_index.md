...
description: Edit PPTM presentations in PHP with Aspose.Slides for PHP via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edit PPTM in PHP" h2="Load, modify, and save PPTM presentations with Aspose.Slides for PHP via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Edit PPTM using Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](/slides/php-java/) can load, modify, and save macro-enabled PPTM presentations. You can edit slide text, add shapes and images, update formatting, and work with other presentation elements through the API.
...
Using [**Aspose.Slides for PHP via Java**](/slides/php-java/), you can add a text shape to a PPTM presentation with a few lines of PHP code.
