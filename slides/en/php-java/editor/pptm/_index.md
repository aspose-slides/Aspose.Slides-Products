...
description: Edit PPTM in PHP. Use PHP library API to edit PPTM files
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edit PPTM in PHP" h2="High-speed and cross-platform PHP library for editing PPTM using PHP code" >}}

{{% blocks/products/pf/feature-page-section h2="Edit PPTM using Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/php-java/) is a powerful PHP library used to manipulate and edit presentations. You can edit a PPTM presentation by adding a new line of text to it. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edit PPTM in PHP" %}}
Using [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/php-java/), you can add a new line of text to the PPTM document with just a few lines of code.

{{% blocks/products/pf/agp/code-block title="PHP code for editing PPTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to edit PPTM in PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Load the PPTM presentation you want to edit.
{{< /blocks/products/pf/agp/step-autogen >}}
