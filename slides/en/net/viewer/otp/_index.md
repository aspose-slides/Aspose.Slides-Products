...
title:  View OTP in C#
url: /net/viewer/otp/
keywords: View OTP, View OpenOffice Presentation, Open OTP, OTP Viewer, OTP, C# API, .NET Library
description: View OTP in C#. Use .NET library API to open and view OpenOffice presentation
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View OTP in C#" h2="Powerful cross-platform .NET API for opening and viewing OTP using C# code on NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms" >}}
...
using (var presentation = new Aspose.Slides.Presentation("sample.otp"))
{
