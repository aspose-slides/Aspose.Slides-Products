...
title:  View ODP in C#
url: /net/viewer/odp/
keywords: View ODP, View OpenOffice Presentation, Open ODP, ODP Viewer, ODP, C# API, .NET Library
description: View ODP in C#. Use .NET library API to open and view OpenOffice presentation
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View ODP in C#" h2="Powerful cross-platform .NET API for opening and viewing ODP using C# code on NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms" >}}
...
using (var presentation = new Aspose.Slides.Presentation("sample.odp"))
{
