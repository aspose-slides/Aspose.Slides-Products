...
title:  View PPT in C#
url: /net/viewer/ppt/
keywords: View PPT, View PowerPoint, Open PPT, PPT Viewer, PPT, PowerPoint, C# API, .NET Library
description: View PPT in C#. Use .NET library API to open and view PowerPoint presentation
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View PPT in C#" h2="Powerful cross-platform .NET API for opening and viewing PPT using C# code on NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms" >}}
