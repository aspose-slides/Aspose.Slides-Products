...
title: View POT in C#
url: /net/viewer/pot/
keywords: View POT, Open POT, POT Viewer, POT, PowerPoint, C# API, .NET Library
description: View POT files in C#. Use Aspose.Slides for .NET to open PowerPoint template files and save them as HTML.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View POT in C#" h2="C# API for opening POT files and saving them as responsive HTML." >}}

{{% blocks/products/pf/feature-page-section h2="View POT using Aspose.Slides" %}}

[**Aspose.Slides for .NET**](/slides/net/) is a .NET library for opening, viewing, editing, and converting presentation files. You can load POT files and save them as HTML for viewing in a browser.
...
Using [**Aspose.Slides for .NET**](/slides/net/), you can load a POT template and save it as responsive HTML with a few lines of code.
...
{{% blocks/products/pf/agp/step-autogen %}}
Save the POT file as HTML with `SaveFormat.Html`.
{{% /blocks/products/pf/agp/step-autogen %}}
