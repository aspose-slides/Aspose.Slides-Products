...
url: /net/viewer/potm/
keywords: View POTM, Open POTM, POTM Viewer, POTM, PowerPoint, C# API, .NET Library
description: View POTM files in C#. Use Aspose.Slides for .NET to open macro-enabled PowerPoint template files and save them as HTML.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View POTM in C#" h2="C# API for opening POTM files and saving them as responsive HTML." >}}

{{% blocks/products/pf/feature-page-section h2="View POTM using Aspose.Slides" %}}

[**Aspose.Slides for .NET**](/slides/net/) is a .NET library for opening, viewing, editing, and converting presentation files. You can load POTM files and save them as HTML for viewing in a browser.
...
Using [**Aspose.Slides for .NET**](/slides/net/), you can load a POTM template and save it as responsive HTML with a few lines of code.

{{% blocks/products/pf/agp/code-block title="C# code for viewing POTM" offSpacer="true" %}}
```cs
using var presentation = new Presentation("presentation.potm");
...
{{% blocks/products/pf/agp/step-autogen %}}
Save the POTM file as HTML with `SaveFormat.Html`.
{{% /blocks/products/pf/agp/step-autogen %}}
