...
{{% blocks/products/pf/agp/content h2="View PPTM File Using C#" %}}

 In order to view PPTM file, we’ll use
...
{{< blocks/products/pf/agp/feature-section-col title="How to View PPTM via C#" >}}
...
{{% blocks/products/pf/agp/code-block title="C# example code to view PPTM file" offSpacer="" %}}
