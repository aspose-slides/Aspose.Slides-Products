...
url: /net/viewer/pptm/
keywords: View PPTM, Open PPTM, PPTM Viewer, PPTM, PowerPoint, C# API, .NET Library
description: View PPTM files in C#. Use Aspose.Slides for .NET to open macro-enabled PowerPoint presentation files and save them as HTML.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="View PPTM in C#" h2="C# API for opening PPTM files and saving them as responsive HTML." >}}

{{% blocks/products/pf/feature-page-section h2="View PPTM using Aspose.Slides" %}}

[**Aspose.Slides for .NET**](/slides/net/) is a .NET library for opening, viewing, editing, and converting presentation files. You can load PPTM files and save them as HTML for viewing in a browser.
...
Using [**Aspose.Slides for .NET**](/slides/net/), you can load a PPTM presentation and save it as responsive HTML with a few lines of code.
...
{{% blocks/products/pf/agp/step-autogen %}}
Save the PPTM file as HTML with `SaveFormat.Html`.
{{% /blocks/products/pf/agp/step-autogen %}}
