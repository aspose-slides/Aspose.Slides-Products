...
{{< blocks/products/pf/agp/steps-block-autogen name="Aspose.Slides makes it easy for the developers to view the PPSM file with just few lines of code." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Save the PPSM presentation in HTML format
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Call Process.Start with path to resultant HTML to load PPSM content in default browser
{{< /blocks/products/pf/agp/step-autogen >}}
