---
title:  Create Pie Chart in C#
url: /net/conversion/create-piechart/
keywords: Create Pie Chart, Chart, PowerPoint, C# API, .NET Library
description: Create Pie Chart in C#. Use .NET library API to create Pie Chart
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Create Pie Chart in C#" h2="Powerful cross-platform .NET API for creating a pie chart based on presentation slides using C# code on NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms" >}}

{{% blocks/products/pf/feature-page-section h2="Create Pie Chart using Aspose.Slides" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Create Pie Chart in C#" %}}
Using [**Aspose.Slides for .NET**](https://products.aspose.com/slides/net/), you can create a pie chart by running some lines of code.

{{% blocks/products/pf/agp/code-block title="C# code for creating pie chart" offSpacer="true" %}}
```cs
xxx
```
...
{{< blocks/products/pf/feature-page-section  h2="How to create Pie Chart in C#" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Save the modified presentation containing the pie chart. 
{{< /blocks/products/pf/agp/step-autogen >}}
