...
title: Create PPT Charts using .NET
weight: 7050
url: /net/chart/ppt/
description: Create charts in PPT presentations in C# using Aspose.Slides for .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Create PPT Charts in C#" h2="Build .NET applications that create charts in presentation files using server-side Aspose.Slides APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPT" >}}
...
Use [Aspose.Slides for .NET](/slides/net/) to create charts in PPT presentations. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.NET/) or use the following Package Manager Console command.
...
{{< blocks/products/pf/agp/steps-block-autogen name="Create a chart in a PPT presentation with Aspose.Slides for .NET in a few lines of code." >}}
...
{{% blocks/products/pf/agp/code-block title="Create a Chart in PPT - C#" offSpacer="" %}}
...
Aspose.Slides for .NET can read, write, manipulate, and convert presentation documents to formats such as PDF, XPS, HTML, TIFF, and ODP. You can create charts and diagrams in presentation files or generate them from data.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online PPT Chart Creation Live Demos" sectionDescription="Generate charts in PPT documents by visiting the [Live Demos website](https://products.aspose.app/slides/chart). The live demo has the following benefits." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/slides/net/chart/pptx/" name="PPTX" description="Open XML Presentation Format" >}}
