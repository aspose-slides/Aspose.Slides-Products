...
[**Aspose.Slides for .NET**](https://products.aspose.com/slides/net/) is a powerful .NET library used to create, convert, merge, and manipulate presentations, PDFs, images, and other files. When you merge TIFF to PDF, you are effectively combining an image and a document to obtain a single file.
...
{{< blocks/products/pf/agp/step-autogen >}}
Load the TIFF and PDF files you want to merge together.
{{< /blocks/products/pf/agp/step-autogen >}}
