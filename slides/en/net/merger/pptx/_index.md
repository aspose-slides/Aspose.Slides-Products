...
weight: 3150
url: /net/merger/pptx/
description: C# source code to merge PPTX files with Aspose.Slides for .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge PPTX Files in C#" h2="Combine PPTX documents with server-side Aspose.Slides for .NET APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Merge PPTX File Using C#" %}}

To merge PPTX files, use [Aspose.Slides for .NET](/slides/net/), a C# API for creating, converting, and combining presentation documents. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.NET/) or run the following command in the Package Manager Console.
...
{{< blocks/products/pf/agp/feature-section-col title="Steps for Merging PPTX Files in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Merge PPTX files with Aspose.Slides for .NET in a few lines of C# code." >}}

{{% blocks/products/pf/agp/step-autogen %}}
Load the source PPTX files with `Presentation`.
{{% /blocks/products/pf/agp/step-autogen %}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Save the merged presentation with `SaveFormat.Pptx`.
{{% /blocks/products/pf/agp/step-autogen %}}

{{< blocks/products/pf/agp/step-autogen >}}
Open the merged PPTX file in a compatible program.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Merge PPTX Files - C#" offSpacer="" %}}
...
{{< blocks/slides-app-widget  appName="merger" extension="pptx" sectionTitle="Merge PPTX Files Online" sectionDescription="Combine files online with Aspose.Slides Merger." >}}
