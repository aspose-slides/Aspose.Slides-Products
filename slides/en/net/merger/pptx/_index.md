...
{{< blocks/products/pf/upper-banner h1="Merge PPTX Formats in C#" h2="Native and high performance PPTX document merger using server-side Aspose.Slides for .NET APIs, without the use of any software like Microsoft or Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge PPTX File Using C#" %}}
...
Load all the PPTX files with full path.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Call the Save() method and pass the file name (full path) and format (PPTX) as a parameter.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Now you can open and use the PPTX file in Microsoft Office, Adobe PDF or any other compatible program.
{{< /blocks/products/pf/agp/step-autogen >}}
