...
{{< blocks/products/pf/upper-banner h1="Merge PPSM Files in C#" h2="Combine PPSM documents with server-side Aspose.Slides for .NET APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPSM" >}}
...
To merge PPSM files, use [Aspose.Slides for .NET](/slides/net/), a C# API for creating, converting, and combining presentation documents. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.NET/) or run the following command in the Package Manager Console.
...
{{< blocks/products/pf/agp/steps-block-autogen name="Merge PPSM files with Aspose.Slides for .NET in a few lines of C# code." >}}

{{% blocks/products/pf/agp/step-autogen %}}
Load the source PPSM files with `Presentation`.
{{% /blocks/products/pf/agp/step-autogen %}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Save the merged presentation with `SaveFormat.Ppsm`.
{{% /blocks/products/pf/agp/step-autogen %}}

{{< blocks/products/pf/agp/step-autogen >}}
Open the merged PPSM file in a compatible program.
{{< /blocks/products/pf/agp/step-autogen >}}
