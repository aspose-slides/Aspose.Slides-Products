---
title: Watermark PPTX document using .NET 
weight: 5590
url: /net/watermark/pptx/ 
description: C# source code to add or remove watermark to PPTX file on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Add Text Watermark to PPTX in C#" h2="Build your own .NET apps to watermark PPTX files using server-side APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Watermark PPTX File Using C#" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="How to Add Watermark to PPTX via C#" >}}
