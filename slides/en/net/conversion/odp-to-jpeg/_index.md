...
description: Convert ODP to JPEG in C# using Aspose.Slides for .NET.
---
...
Use [Aspose.Slides for .NET](/slides/net/) to load an ODP presentation and render each slide as a JPEG image. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.NET/) or use the following Package Manager Console command.
...
Before you run the ODP to JPEG conversion C# code, make sure that your environment includes the following prerequisites:
