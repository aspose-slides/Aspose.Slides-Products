...
description: Convert PDF to SVG in C#. Use .NET library API to convert PDF pages to SVG images
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDF to SVG in C#" h2="PowerPoint .NET API for converting PDF documents to SVG images on NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PDF to SVG in C#" %}}

How do I convert PDF to SVG in code? 

Using [**Aspose.Slides for .NET**](https://products.aspose.com/slides/net/), any developer or application can convert PDF to SVG format with just a few lines of C# code.

As a modern document processing API, Aspose.Slides for .NET exports PDF pages to SVG quickly. Aspose PowerPoint library allows you to convert PDF to SVG and many other file formats
...
{{< blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to SVG in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Developers and applications can convert PDF to SVG this way:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Before you run the PDF to SVG conversion C# code, your machine must have these prerequisities:
