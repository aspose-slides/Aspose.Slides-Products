...
Use [Aspose.Slides for .NET](/slides/net/) to load a ODP presentation and save it as a TIFF file. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.NET/) or use the following Package Manager Console command.
