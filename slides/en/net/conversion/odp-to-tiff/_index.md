...
Use [Aspose.Slides for .NET](/slides/net/) to load an ODP presentation and save it as a TIFF file. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.NET/) or use the following Package Manager Console command.
...
Before you run the ODP to TIFF conversion C# code, make sure that your environment includes the following prerequisites:
