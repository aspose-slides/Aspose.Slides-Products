...
description: Convert image to PPTX in C#. Use .NET library API to convert image to PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert image to PPTX in C#" h2="Powerful cross-platform .NET API for converting image to PPTX using C# code on NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms" >}}
...
Using [**Aspose.Slides for .NET**](https://products.aspose.com/slides/net/), you can convert image to PowerPoint presentation with just a few lines of code:
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/net/conversion/image-to-ppt/" name="IMAGE TO PPT" >}}
