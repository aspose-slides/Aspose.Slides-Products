...
description: Convert JPG to PPT in C#. Use .NET library API to convert JPG images to PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert JPG to PPT in C#" h2="Powerful cross-platform .NET API for converting JPG to PPT using C# code on NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms" >}}
...
Using [**Aspose.Slides for .NET**](https://products.aspose.com/slides/net/), you can convert JPG image to PowerPoint presentation with just a few lines of code:
