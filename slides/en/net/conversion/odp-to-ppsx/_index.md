...
Use [Aspose.Slides for .NET](/slides/net/) to load an ODP presentation and save it as a PPSX file. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.NET/) or use the following Package Manager Console command.
