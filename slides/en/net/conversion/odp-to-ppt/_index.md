...
title: Convert ODP to PPT in C#
weight: 2000
url: /net/conversion/odp-to-ppt/
description: Convert ODP to PPT in C# using Aspose.Slides for .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert ODP to PPT in C#" h2="Convert ODP files to PPT in C# using server-side Aspose.Slides APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
Use [Aspose.Slides for .NET](/slides/net/) to load an ODP presentation and save it as a PPT file. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.NET/) or use the following Package Manager Console command.
...
Before you run the ODP to PPT conversion C# code, make sure that your environment includes the following prerequisites:
