...
keywords: PNG to SVG, Convert PNG to SVG, C# API, .NET Library, PNG, SVG
description: Convert PNG to SVG in C# using Aspose.Slides for .NET. Use the sample code in C# applications, including ASP.NET projects.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PNG to SVG in C#" h2="Convert PNG files to SVG in C# using server-side Aspose.Slides APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert PNG to SVG in C#" %}}

Use [Aspose.Slides for .NET](/slides/net/) to add a PNG image to a presentation and export the slide as an SVG file. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.NET/) or use the following Package Manager Console command.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert PNG to SVG in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET developers can convert PNG files to SVG in a few lines of code." >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Before you run the PNG to SVG conversion C# code, your machine must have these prerequisites:
...
{{% blocks/products/pf/agp/code-block title="C# code to convert PNG to SVG" offSpacer="" %}}
...
using var svgStream = File.Create("image.svg");
