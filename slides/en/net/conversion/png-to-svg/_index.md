...
keywords: PNG to SVG, Convert PNG to SVG, C# API, .NET Library
description: Convert PNG to SVG in C#. Use .NET library API to convert PNG to SVG files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PNG to SVG in C#" h2="PowerPoint .NET API for converting PNG to SVG image files on NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
How do I convert PNG to SVG in code? 

Using [**Aspose.Slides for .NET**](https://products.aspose.com/slides/net/), any developer or application can convert PNG to SVG with just a few lines of C# code.

As a modern document processing API, Aspose.Slides for .NET exports PNG files to SVG images in other formats quickly. Aspose PowerPoint library allows you to convert PNG to SVG and images in other formats.
...
{{< blocks/products/pf/agp/steps-block-autogen name="Developers and applications can convert PNG to SVG this way:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Before you run the PNG to SVG conversion C# code, your machine must have these prerequisities:
