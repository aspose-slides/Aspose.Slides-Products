---
title: Convert PPT to EMF in C#
weight: 2470
url: /net/conversion/ppt-to-emf/
description: Convert PPT to EMF in C# using Aspose.Slides for .NET. Use the sample code in C# applications, including ASP.NET projects.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PPT to EMF in C#" h2="Convert PPT files to EMF images in C# using server-side Aspose.Slides APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
Use [Aspose.Slides for .NET](/slides/net/) to load a PPT presentation and render each slide as an EMF image. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.NET/) or run the following command in the Package Manager Console.
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET developers can load and convert PPT files to EMF in a few lines of code." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call the image `Save` method with `ImageFormat.Emf`.
{{% /blocks/products/pf/agp/step-autogen %}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PPT to EMF C# conversion" offSpacer="" %}}
...
foreach (var slide in presentation.Slides)
{
    ...
    image.Save($"Slide_{slide.SlideNumber}.emf", ImageFormat.Emf);
}
```
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget
        ...
        sectionDescription="[Try our free app to convert PPT to EMF](https://products.aspose.app/slides/conversion/ppt-to-emf)"
    >}}
