...
description: Convert JPG to PNG in C#. Use .NET library API to convert JPG to PNG files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert JPG to PNG in C#" h2="PowerPoint .NET API for converting JPG to PNG image files on NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
How do I convert JPG to PNG in code? 

Using [**Aspose.Slides for .NET**](https://products.aspose.com/slides/net/), any developer or application can convert JPG to PNG with just a few lines of C# code.

As a modern document processing API, Aspose.Slides for .NET exports JPG files to PNG images in other formats quickly. Aspose PowerPoint library allows you to convert JPG to PNG and images in other formats.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Before you run the JPG to PNG conversion C# code, your machine must have these prerequisities:
