...
keywords: HTML to JPG, Convert HTML to JPG, C# API, .NET Library, HTML, JPG
description: Convert HTML to JPG images in C# using Aspose.Slides for .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert HTML to JPG in C#" h2="Convert HTML files to JPG images in C# using server-side Aspose.Slides APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert HTML to JPG in C#" %}}

Use [Aspose.Slides for .NET](/slides/net/) to convert HTML content to JPG images in C#. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.NET/) or use the following Package Manager Console command.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert HTML to JPG in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Developers and applications can convert HTML to JPG this way:" >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Render each slide with `GetImage` and save it as a JPG image.
{{% /blocks/products/pf/agp/step-autogen %}}
...
Before you run the HTML to JPG conversion C# code, make sure that your environment includes the following prerequisites:
...
{{% blocks/products/pf/agp/code-block title="C# code to convert HTML to JPG" offSpacer="" %}}
...
for (var slideIndex = 0; slideIndex < presentation.Slides.Count; slideIndex++)
{
    ...
    image.Save($"image-{slideIndex}.jpg", ImageFormat.Jpeg);
}
```
