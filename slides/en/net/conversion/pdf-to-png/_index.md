...
{{% blocks/products/pf/agp/content h2="Convert PDF to PNG in C#" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert PDF to PNG in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET developers can convert PDF files to PNG in a few lines of code." >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Before you run the PDF to PNG conversion C# code, your machine must have these prerequisites:
...
{{% blocks/products/pf/agp/code-block title="C# code to convert PDF to PNG" offSpacer="" %}}
