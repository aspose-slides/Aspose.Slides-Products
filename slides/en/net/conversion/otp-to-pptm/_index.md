...
Use [Aspose.Slides for .NET](/slides/net/) to load an OTP presentation and save it as a PPTM file. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.NET/) or use the following Package Manager Console command.
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET developers can load and convert OTP files to PPTM in a few lines of code." >}}
