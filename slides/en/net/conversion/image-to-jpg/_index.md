...
description: Convert Image to JPG in C#. Use .NET library API to convert Images to JPG pictures.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert Image to JPG in C#" h2="PowerPoint .NET API for converting Images to JPG pictures on NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
How do I convert Image to JPG in code? 

Using [**Aspose.Slides for .NET**](https://products.aspose.com/slides/net/), any developer or application can convert an image to a JPG picture with just a few lines of C# code.

As a modern document processing API, Aspose.Slides for .NET exports images in popular formats to JPG quickly. Aspose PowerPoint library allows you to convert images to JPG and many other image formats.
...
{{< blocks/products/pf/agp/steps-block-autogen name="Developers and applications can convert Image to JPG this way:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Before you run the Image to JPG conversion C# code, your machine must have these prerequisities:
