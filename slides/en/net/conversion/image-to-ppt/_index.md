...
description: Convert image to PPT in C#. Use .NET library API to convert image to PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert image to PPT in C#" h2="Powerful cross-platform .NET API for converting image to PPT using C# code on NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/net/conversion/image-to-pptx/" name="IMAGE TO PPTX" >}}
