...
{{% blocks/products/pf/agp/content h2="Convert OTP to HTML Using C#" %}}

Use [Aspose.Slides for .NET](/slides/net/) to load an OTP presentation and save it as an HTML file. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.NET/) or use the following Package Manager Console command.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert OTP to HTML via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET developers can load and convert OTP files to HTML in a few lines of code." >}}
