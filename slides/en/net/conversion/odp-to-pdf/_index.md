...
Use [Aspose.Slides for .NET](/slides/net/) to load an ODP presentation and save it as a PDF file. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.NET/) or use the following Package Manager Console command.
...
Before you run the ODP to PDF conversion C# code, make sure that your environment includes the following prerequisites:
...
sectionDescription="[Try our free app to convert ODP to PDF](https://products.aspose.app/slides/conversion/odp-to-pdf)"
    >}}
