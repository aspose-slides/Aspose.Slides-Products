...
keywords: PDF to Image, Convert PDF to Image, C# API, .NET Library, PDF, Image
description: Convert PDF to image files in C# using Aspose.Slides for .NET. Use the sample code in VB.NET, ASP.NET, or any .NET-based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDF to Image in C#" h2="Convert PDF documents to images in C# using server-side Aspose.Slides APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert PDF to Image in C#" %}}

Use [Aspose.Slides for .NET](/slides/net/) to import PDF pages into a presentation and render each slide as a PNG image. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.NET/) or use the following Package Manager Console command.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert PDF to Image in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET developers can convert PDF files to Image in a few lines of code." >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Before you run the PDF to Image conversion C# code, your machine must have these prerequisites:
...
{{% blocks/products/pf/agp/code-block title="C# code to convert PDF to Image" offSpacer="" %}}
