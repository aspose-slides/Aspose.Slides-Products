...
description: Convert PDF to Image in C#. Use .NET library API to convert PDF pages to Images
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDF to Image in C#" h2="PowerPoint .NET API for converting PDF documents to Images on NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PDF to Image in C#" %}}

How do I convert PDF to Image in code? 

Using [**Aspose.Slides for .NET**](https://products.aspose.com/slides/net/), any developer or application can convert PDF to image files with just a few lines of C# code.

As a modern document processing API, Aspose.Slides for .NET exports PDF pages to Image formats quickly. Aspose PowerPoint library allows you to convert PDF to Image and many other file formats.
...
{{< blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to Image in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Developers and applications can convert PDF to Image this way:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Call the save method to save the slides as images.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Before you run the PDF to Image conversion C# code, your machine must have these prerequisities:
