...
weight: 210
url: /net/conversion/jpg-to-image/
keywords: JPG to Image, Convert JPG to Image, C# API, .NET Library
description: Convert JPG to image files in C# using Aspose.Slides for .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert JPG to Image in C#" h2="Convert JPG pictures to image files in C# using server-side Aspose.Slides APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert JPG to Image in C#" %}}

Use [Aspose.Slides for .NET](/slides/net/) to place a JPG image on a slide and export it as another image file. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.NET/) or use the following Package Manager Console command.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert JPG to Image in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Developers and applications can convert JPG to Image this way:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Render the slide with `GetImage` and save it as an image file.
{{< /blocks/products/pf/agp/step-autogen >}}
...
Before you run the JPG to image conversion C# code, make sure that your environment includes the following prerequisites:
...
{{% blocks/products/pf/agp/code-block title="C# code to convert JPG to Image" offSpacer="" %}}
