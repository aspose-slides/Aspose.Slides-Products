...
description: Convert JPG to Image in C#. Use .NET library API to convert JPG to images in different formats.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert JPG to Image in C#" h2="PowerPoint .NET API for converting JPG pictures to Image files on NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
How do I convert JPG to Image in code? 

Using [**Aspose.Slides for .NET**](https://products.aspose.com/slides/net/), any developer or application can convert JPG to Image with just a few lines of C# code.

As a modern document processing API, Aspose.Slides for .NET exports JPG files to images in other formats quickly. Aspose PowerPoint library allows you to convert JPG to Image and many other file formats
...
{{% blocks/products/pf/agp/text %}}
 ...
 Before you run the JPG to Image conversion C# code, your machine must have these prerequisities:
