...
description: Convert POTM to OTP in C# using Aspose.Slides for .NET. Use the sample code in C# applications, including ASP.NET projects.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert POTM to OTP in C#" h2="Convert POTM files to OTP in C# using server-side Aspose.Slides APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="Convert POTM to OTP Using C#" %}}

Use [Aspose.Slides for .NET](/slides/net/) to load a POTM presentation and save it as an OTP file. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.NET/) or use the following Package Manager Console command.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert POTM to OTP via C#" >}}
{{< blocks/products/pf/agp/steps-block-autogen name=".NET developers can convert POTM files to OTP in a few lines of code." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows POTM to OTP C# Conversion" offSpacer="" %}}
