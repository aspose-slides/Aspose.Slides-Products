...
description: Convert OTP to JPEG in C# using Aspose.Slides for .NET. Use the sample code in C# applications, including ASP.NET projects.
---
...
Use [Aspose.Slides for .NET](/slides/net/) to load an OTP presentation and render each slide as a JPEG image. Install the package from [NuGet](https://www.nuget.org/packages/Aspose.Slides.NET/) or use the following Package Manager Console command.
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET developers can load and convert OTP files to JPEG in a few lines of code." >}}
...
sectionDescription="[Try our free app to convert OTP to JPEG](https://products.aspose.app/slides/conversion/otp-to-jpeg)"
    >}}
