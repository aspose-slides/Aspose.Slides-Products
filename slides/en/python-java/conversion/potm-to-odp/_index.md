...
description: Convert POTM files to ODP presentations in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert POTM Files to ODP in Python" h2="Export a macro-enabled PowerPoint template as an OpenDocument Presentation with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert POTM to ODP in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load a macro-enabled POTM file and export it as an OpenDocument Presentation (ODP). The conversion preserves the presentation content in an open format; macros are not retained in ODP. Microsoft PowerPoint, LibreOffice, and OpenOffice are not required.
...
{{% blocks/products/pf/agp/code-block title="Python code for converting POTM to ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert POTM to ODP in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to export a POTM file as an OpenDocument Presentation." >}}
