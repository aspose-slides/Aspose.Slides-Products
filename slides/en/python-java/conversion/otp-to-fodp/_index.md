...
description: Convert OTP presentation templates to FODP format in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert OTP to FODP in Python" h2="Save an OTP presentation template in the flat XML-based FODP format with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert OTP to FODP in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load an OTP presentation template and save it as an FODP file. FODP stores an OpenDocument presentation as a single flat XML document, which can simplify inspection, version control, and automated processing.
...
{{% blocks/products/pf/agp/code-block title="Python code for converting OTP to FODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert OTP to FODP in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to convert an OTP presentation template to flat XML-based FODP format." >}}
