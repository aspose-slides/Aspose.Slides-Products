...
keywords: Python PPSX conversion, PPSX to PDF, PowerPoint to PDF, slide show to PDF, Aspose.Slides for Python via Java
description: Convert PPSX files to PDF documents in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPSX Files to PDF in Python" h2="Export a PowerPoint slide show as a portable PDF document with consistent slide rendering." >}}
...
{{% blocks/products/pf/feature-page-section  h2="How to Convert PPSX to PDF in Python" %}}
Load the source PPSX file into a `Presentation`, then save it with `SaveFormat.Pdf`.

{{% blocks/products/pf/agp/code-block title="Python code for converting PPSX to PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Steps to Convert PPSX to PDF in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="The conversion loads the PowerPoint slide show and renders its slides as pages in a PDF document." >}}
