...
url: /python-java/conversion/potm-to-ppsm/
keywords: Python POTM conversion, POTM to PPSM, PowerPoint slide show conversion, macro-enabled slide show, Aspose.Slides for Python via Java
description: Convert POTM files to PPSM slide shows in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert POTM Files to PPSM in Python" h2="Save a macro-enabled POTM file as a macro-enabled PowerPoint slide show with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert POTM to PPSM in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load a macro-enabled POTM file and save it as a PPSM slide show. PPSM is the Open XML macro-enabled PowerPoint Show format, so the output can retain supported VBA macros and open directly in Slide Show view. Microsoft PowerPoint is not required.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert POTM to PPSM using Python" %}}
Create a `Presentation` from the POTM file, then call `save` with `SaveFormat.Ppsm`.

{{% blocks/products/pf/agp/code-block title="Python code for converting POTM to PPSM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert POTM to PPSM in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to save a POTM file as a PPSM slide show." >}}
