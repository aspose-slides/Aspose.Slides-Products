...
description: Convert FODP presentations to macro-enabled PowerPoint PPTM files in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert FODP Presentations to PPTM in Python" h2="Save an FODP presentation in the macro-enabled PowerPoint PPTM format with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert FODP to PPTM in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load an FODP presentation and save it in the macro-enabled PowerPoint PPTM format. PPTM supports VBA projects, but converting an FODP file does not add macros to the presentation. The conversion does not require Microsoft PowerPoint, LibreOffice, or OpenOffice.
...
{{% blocks/products/pf/agp/code-block title="Python code for converting FODP to PPTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert FODP to PPTM in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to save a flat XML OpenDocument presentation in the macro-enabled PowerPoint PPTM format." >}}
