...
description: Convert ODP presentations to PDF documents in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert ODP Presentations to PDF in Python" h2="Export an ODP presentation as a fixed-layout PDF document with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert ODP to PDF in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load an ODP presentation and export it as a PDF document. The PDF output retains the presentation's visual layout in a format suitable for sharing, printing, and archiving. The conversion does not require Microsoft PowerPoint, LibreOffice, or OpenOffice.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert ODP to PDF using Python" %}}
Create a `Presentation` from the ODP file and call `save` with `SaveFormat.Pdf` to generate the PDF document.

{{% blocks/products/pf/agp/code-block title="Python code for converting ODP to PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert ODP to PDF in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to export an ODP presentation as a PDF document." >}}
