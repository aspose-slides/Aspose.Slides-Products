...
description: Convert PPSM slide shows to macro-enabled PowerPoint PPTM files in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPSM Slide Shows to PPTM in Python" h2="Save a macro-enabled PowerPoint slide show as an editable macro-enabled presentation with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPSM to PPTM in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load a macro-enabled PowerPoint PPSM slide show and save it in the editable PPTM presentation format. Both PPSM and PPTM support VBA projects, so the output remains macro-enabled. The conversion does not require Microsoft PowerPoint.
...
{{% blocks/products/pf/agp/code-block title="Python code for converting PPSM to PPTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PPSM to PPTM in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to convert a macro-enabled PowerPoint slide show to an editable macro-enabled PPTM presentation." >}}
