...
keywords: Python POTX conversion, POTX to POTM, PowerPoint template conversion, macro-enabled template, Aspose.Slides for Python via Java
description: Convert POTX files to macro-enabled POTM templates in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert POTX Files to POTM in Python" h2="Save a PowerPoint Open XML template in the macro-enabled POTM format with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert POTX to POTM in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load a PowerPoint Open XML template (`POTX`) and save it in the macro-enabled template format (`POTM`). The conversion changes the file format but does not add VBA macros to the source content. Microsoft PowerPoint is not required.
...
{{% blocks/products/pf/agp/code-block title="Python code for converting POTX to POTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert POTX to POTM in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to save a POTX file as a macro-enabled POTM template." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `save` with `SaveFormat.Potm` to create the POTM template.
{{% /blocks/products/pf/agp/step-autogen %}}
