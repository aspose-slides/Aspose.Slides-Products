...
description: Convert PDF documents to FODP presentations in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PDF to FODP in Python" h2="Import PDF pages and save them as a flat XML-based FODP presentation with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PDF to FODP in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can import PDF pages as slides and save the resulting presentation as an FODP file. FODP stores the presentation as a single flat XML document, which can simplify inspection, version control, and automated processing.
...
{{% blocks/products/pf/agp/code-block title="Python code for converting PDF to FODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PDF to FODP in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to import a PDF document and save its pages as an FODP presentation." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `save` with `SaveFormat.Fodp` to create the FODP presentation.
{{% /blocks/products/pf/agp/step-autogen %}}
