...
description: Convert PPS files to macro-enabled POTM files in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPS to POTM in Python" h2="Save a PowerPoint Show in the macro-enabled Open XML POTM format." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPS to POTM in Python" %}}

[Aspose.Slides for Python via Java](/slides/python-java/) can load a PowerPoint Show (`.pps`) file and save it in the macro-enabled POTM format without Microsoft PowerPoint. POTM is an Open XML format that can store VBA macros.
...
{{% blocks/products/pf/feature-page-section  h2="How to Convert PPS to POTM in Python" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Steps to Convert PPS to POTM in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="The conversion loads the PowerPoint Show and writes its content in the macro-enabled POTM format." >}}
