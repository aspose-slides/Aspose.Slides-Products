...
keywords: Python PPS conversion, PPS to FODP, PowerPoint to FODP, slide show to FODP, Aspose.Slides for Python via Java
description: Convert PPS files to FODP presentations in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPS Files to FODP in Python" h2="Export a PowerPoint 97–2003 slide show as a Flat OpenDocument Presentation with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPS to FODP in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load a PowerPoint 97–2003 slide show (`PPS`) and export it as a Flat OpenDocument Presentation (`FODP`). The conversion stores the presentation in a flat XML-based format and does not require Microsoft PowerPoint, LibreOffice, or OpenOffice.
...
{{% blocks/products/pf/agp/code-block title="Python code for converting PPS to FODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PPS to FODP in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to export a PowerPoint 97–2003 slide show as a Flat OpenDocument Presentation." >}}
