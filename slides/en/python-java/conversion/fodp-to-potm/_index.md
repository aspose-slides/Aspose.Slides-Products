...
description: Convert FODP presentations to POTM files in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert FODP Presentations to POTM in Python" h2="Save an FODP presentation in the macro-enabled PowerPoint POTM format with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert FODP to POTM in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load an FODP presentation and save it in the macro-enabled POTM presentation format. POTM supports VBA projects, but converting an FODP file does not add macros to the presentation. The conversion does not require Microsoft PowerPoint, LibreOffice, or OpenOffice.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert FODP to POTM using Python" %}}
Create a `Presentation` from the FODP file and call `save` with `SaveFormat.Potm` to create the POTM file.

{{% blocks/products/pf/agp/code-block title="Python code for converting FODP to POTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert FODP to POTM in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to save an FODP presentation in the macro-enabled POTM format." >}}
