...
description: Convert OTP presentation templates to macro-enabled PowerPoint PPTM files in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert OTP Templates to PPTM in Python" h2="Save an OTP presentation template in the macro-enabled PowerPoint PPTM format with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert OTP to PPTM in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load an OpenDocument Presentation Template (OTP) and save it in the macro-enabled PowerPoint PPTM format. PPTM supports VBA projects, but converting an OTP file does not add macros to the presentation. The conversion does not require Microsoft PowerPoint, LibreOffice, or OpenOffice.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert OTP to PPTM using Python" %}}
Create a `Presentation` from the OTP file and call `save` with `SaveFormat.Pptm` to create the PPTM file.

{{% blocks/products/pf/agp/code-block title="Python code for converting OTP to PPTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert OTP to PPTM in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to save an OpenDocument presentation template in the macro-enabled PowerPoint PPTM format." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `save` with `SaveFormat.Pptm` to write the PPTM file.
{{% /blocks/products/pf/agp/step-autogen %}}
...
{{< blocks/products/pf/agp/other-supported-section title="Convert OTP to Other Supported Formats" subTitle="You can also convert OTP templates to other supported file formats." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="/slides/python-java/conversion/otp-to-bmp/" name="OTP TO BMP" >}}
