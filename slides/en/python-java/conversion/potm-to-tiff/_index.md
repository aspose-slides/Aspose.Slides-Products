...
description: Convert POTM presentation templates to multipage TIFF images in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert POTM to TIFF in Python" h2="Render a macro-enabled POTM presentation template as a multipage TIFF image with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert POTM to TIFF in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load a macro-enabled PowerPoint template (`POTM`) and render all of its slides to a multipage `TIFF` image. The conversion does not require Microsoft PowerPoint.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert POTM to TIFF using Python" %}}
Create a `Presentation` from the POTM file, then call `save` with `SaveFormat.Tiff`.

{{% blocks/products/pf/agp/code-block title="Python code for converting POTM to TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert POTM to TIFF in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to render a macro-enabled PowerPoint presentation template as a multipage TIFF image." >}}
