...
keywords: Python PPSM conversion, PPSM to POTM, macro-enabled PowerPoint file conversion, PowerPoint Open XML, Aspose.Slides for Python via Java
description: Convert PPSM slide shows to macro-enabled POTM files in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPSM to POTM in Python" h2="Save a macro-enabled PowerPoint slide show in the macro-enabled Open XML POTM format." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPSM to POTM in Python" %}}

[Aspose.Slides for Python via Java](/slides/python-java/) can load a macro-enabled PowerPoint slide show (`.ppsm`) and save it in the macro-enabled Open XML POTM format without Microsoft PowerPoint. Both formats can store VBA projects, while POTM identifies the output as a PowerPoint template file.
...
{{% blocks/products/pf/feature-page-section  h2="How to Convert PPSM to POTM in Python" %}}
Load the source PPSM file into a `Presentation`, then save it with `SaveFormat.Potm`.

{{% blocks/products/pf/agp/code-block title="Python code for converting PPSM to POTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Steps to Convert PPSM to POTM in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="The conversion loads the macro-enabled PowerPoint slide show and writes its content in the macro-enabled Open XML POTM format." >}}
