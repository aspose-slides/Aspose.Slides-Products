...
keywords: Python PPTM conversion, PPTM to PPS, PowerPoint slide show conversion, legacy PowerPoint format, Aspose.Slides for Python via Java
description: Convert PPTM files to PPS slide shows in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPTM Files to PPS in Python" h2="Save a macro-enabled PPTM file as a legacy PowerPoint slide show with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPTM to PPS in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load a macro-enabled PPTM presentation and save it as a PPS slide show. PPS is the legacy binary PowerPoint Show format and normally opens directly in Slide Show view. Microsoft PowerPoint is not required.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert PPTM to PPS using Python" %}}
Create a `Presentation` from the PPTM file, then call `save` with `SaveFormat.Pps`.

{{% blocks/products/pf/agp/code-block title="Python code for converting PPTM to PPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PPTM to PPS in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to save a PPTM presentation as a PPS slide show." >}}
