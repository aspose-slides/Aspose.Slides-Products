...
keywords: Python PPS conversion, PPS to PPT, PowerPoint slide show to presentation, PowerPoint 97-2003, Aspose.Slides for Python via Java
description: Convert PPS slide shows to editable PowerPoint PPT presentations in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPS Slide Shows to PPT in Python" h2="Save a PowerPoint slide show as an editable PPT presentation with Aspose.Slides for Python via Java." >}}
...
{{% blocks/products/pf/agp/code-block title="Python code for converting PPS to PPT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PPS to PPT in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to convert a PowerPoint slide show to an editable PPT presentation." >}}
