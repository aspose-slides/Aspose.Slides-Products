...
description: Convert PPSM slide shows to legacy PowerPoint PPT files in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPSM Slide Shows to PPT in Python" h2="Save a macro-enabled PowerPoint slide show in the legacy PPT format with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPSM to PPT in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load a macro-enabled PowerPoint PPSM slide show and save it in the PowerPoint 97–2003 PPT format. PPT is a legacy binary presentation format supported by Microsoft PowerPoint and other compatible applications. The conversion does not require Microsoft PowerPoint.
...
{{% blocks/products/pf/agp/code-block title="Python code for converting PPSM to PPT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PPSM to PPT in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to convert a macro-enabled PowerPoint slide show to a legacy PPT file." >}}
