...
description: Convert POTM files to POTX templates in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert POTM Files to POTX in Python" h2="Save a macro-enabled PowerPoint template as a macro-free POTX template with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert POTM to POTX in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load a macro-enabled POTM file and save it as a POTX template. The output retains the reusable presentation design in the Open XML template format; VBA macros are not retained. Microsoft PowerPoint is not required.
...
{{% blocks/products/pf/agp/code-block title="Python code for converting POTM to POTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert POTM to POTX in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to save a POTM file as a POTX template." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `save` with `SaveFormat.Potx` to create the POTX template.
{{% /blocks/products/pf/agp/step-autogen %}}
