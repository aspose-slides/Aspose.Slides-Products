...
description: Convert flat XML FODP presentations to packaged ODP files in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert FODP Presentations to ODP in Python" h2="Package a flat XML OpenDocument presentation as an ODP file with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert FODP to ODP in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load an FODP file, which stores an OpenDocument presentation as flat XML, and save it as a packaged ODP presentation. The conversion preserves the presentation structure and does not require Microsoft PowerPoint, LibreOffice, or OpenOffice.
...
{{% blocks/products/pf/agp/code-block title="Python code for converting FODP to ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert FODP to ODP in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to convert a flat XML OpenDocument presentation to a packaged ODP file." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `save` with `SaveFormat.Odp` to write the packaged ODP file.
{{% /blocks/products/pf/agp/step-autogen %}}
