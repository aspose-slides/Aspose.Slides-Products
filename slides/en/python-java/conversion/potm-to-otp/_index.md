...
keywords: Python POTM conversion, POTM to OTP, PowerPoint to OTP, macro-enabled template to OpenDocument, Aspose.Slides for Python via Java
description: Convert POTM files to OTP presentation templates in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert POTM Files to OTP in Python" h2="Export a macro-enabled PowerPoint template as an OpenDocument presentation template with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert POTM to OTP in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load a macro-enabled POTM file and save it as an OTP presentation template. The OTP output can be used as the basis for new OpenDocument presentations; VBA macros are not retained. Microsoft PowerPoint, LibreOffice, and OpenOffice are not required.
...
{{% blocks/products/pf/agp/code-block title="Python code for converting POTM to OTP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert POTM to OTP in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to save a POTM file as an OTP presentation template." >}}
