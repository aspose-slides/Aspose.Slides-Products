...
description: Convert flat XML FODP presentations to legacy PowerPoint PPS slide shows in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert FODP Presentations to PPS in Python" h2="Save an FODP presentation as a legacy PowerPoint PPS slide show with Aspose.Slides for Python via Java." >}}
...
{{% blocks/products/pf/agp/code-block title="Python code for converting FODP to PPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert FODP to PPS in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to convert a flat XML OpenDocument presentation to a legacy PowerPoint PPS slide show." >}}
