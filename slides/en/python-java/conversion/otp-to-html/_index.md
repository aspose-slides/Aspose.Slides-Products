...
description: Convert OTP presentation templates to HTML documents in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert OTP Presentation Templates to HTML in Python" h2="Publish an OTP presentation template as an HTML document with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert OTP to HTML in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load an OTP presentation template and export its slides and visual content to HTML. The generated document can be opened in a web browser, and the conversion does not require Microsoft PowerPoint, LibreOffice, or OpenOffice.
...
{{% blocks/products/pf/agp/code-block title="Python code for converting OTP to HTML" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert OTP to HTML in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to export an OTP presentation template as an HTML document." >}}
