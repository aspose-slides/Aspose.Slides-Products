...
keywords: Python PPSX conversion, PPSX to HTML, PowerPoint to HTML, slide show to HTML, Aspose.Slides for Python via Java
description: Convert PPSX files to HTML documents in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPSX Files to HTML in Python" h2="Publish a PowerPoint slide show as an HTML document with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPSX to HTML in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load a PowerPoint Slide Show (`.ppsx`) and export its slides and visual content to HTML. The generated document can be opened in a web browser, and Microsoft PowerPoint is not required.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert PPSX to HTML using Python" %}}
Create a `Presentation` from the PPSX file and call `save` with `SaveFormat.Html` to generate an HTML document.

{{% blocks/products/pf/agp/code-block title="Python code for converting PPSX to HTML" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PPSX to HTML in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to export a PPSX file as an HTML document." >}}
