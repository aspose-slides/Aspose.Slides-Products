...
description: Convert OTP presentation templates to ODP presentations in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert OTP Presentation Templates to ODP in Python" h2="Save an OTP presentation template as an editable ODP presentation with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert OTP to ODP in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load an OTP presentation template and save it as an editable ODP presentation. The conversion preserves the presentation content in the OpenDocument presentation format and does not require Microsoft PowerPoint, LibreOffice, or OpenOffice.
...
{{% blocks/products/pf/agp/code-block title="Python code for converting OTP to ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert OTP to ODP in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to save an OTP presentation template as an ODP presentation." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `save` with `SaveFormat.Odp` to write the ODP presentation.
{{% /blocks/products/pf/agp/step-autogen %}}
