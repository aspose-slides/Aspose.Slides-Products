...
keywords: Python PPTM conversion, PPTM to PPT, PowerPoint presentation conversion, legacy PowerPoint format, Aspose.Slides for Python via Java
description: Convert PPTM files to PPT presentations in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPTM Files to PPT in Python" h2="Save a macro-enabled PPTM file as a legacy PowerPoint presentation with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPTM to PPT in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load a macro-enabled PPTM presentation and save it as a PPT presentation. PPT is the legacy binary PowerPoint format and is suitable when compatibility with older PowerPoint versions is required. Microsoft PowerPoint is not required.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert PPTM to PPT using Python" %}}
Create a `Presentation` from the PPTM file, then call `save` with `SaveFormat.Ppt`.

{{% blocks/products/pf/agp/code-block title="Python code for converting PPTM to PPT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PPTM to PPT in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to save a PPTM file as a PPT presentation." >}}
