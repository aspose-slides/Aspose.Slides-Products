...
keywords: Python PPT conversion, PPT to PPTX, PowerPoint to PPTX, legacy presentation conversion, Aspose.Slides for Python via Java
description: Convert PPT files to PPTX format in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPT to PPTX in Python" h2="Save a legacy PowerPoint presentation in the modern Open XML PPTX format with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPT to PPTX in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load a legacy PowerPoint presentation (`.ppt`) and save it in the Open XML PPTX format. PPTX files are widely supported by current presentation applications, and the conversion does not require Microsoft PowerPoint.
...
{{% blocks/products/pf/agp/code-block title="Python code for converting PPT to PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PPT to PPTX in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to save a legacy PowerPoint PPT presentation in the Open XML PPTX format." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `save` with `SaveFormat.Pptx` and a `.pptx` output path.
{{% /blocks/products/pf/agp/step-autogen %}}
