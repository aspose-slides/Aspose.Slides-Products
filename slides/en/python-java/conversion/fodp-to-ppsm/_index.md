...
description: Convert FODP presentations to macro-enabled PowerPoint PPSM slide shows in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert FODP Presentations to PPSM in Python" h2="Save an FODP presentation in the macro-enabled PowerPoint PPSM slide show format with Aspose.Slides for Python via Java." >}}
...
{{% blocks/products/pf/agp/code-block title="Python code for converting FODP to PPSM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert FODP to PPSM in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to save a flat XML OpenDocument presentation as a macro-enabled PowerPoint PPSM slide show." >}}
