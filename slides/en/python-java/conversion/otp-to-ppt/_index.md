...
description: Convert OTP presentation templates to legacy PowerPoint PPT files in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert OTP Templates to PPT in Python" h2="Save an OTP presentation template in the legacy PowerPoint PPT format with Aspose.Slides for Python via Java." >}}
...
{{% blocks/products/pf/agp/code-block title="Python code for converting OTP to PPT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert OTP to PPT in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to convert an OpenDocument presentation template to a legacy PowerPoint PPT file." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `save` with `SaveFormat.Ppt` to write the PPT file.
{{% /blocks/products/pf/agp/step-autogen %}}
