...
description: Convert PPTX presentations to ODP files in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPTX Presentations to ODP in Python" h2="Save a PowerPoint presentation in the OpenDocument Presentation format with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert PPTX to ODP in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load a PPTX presentation and save it as an ODP file. The conversion preserves the presentation structure and visual content while producing an OpenDocument presentation that can be opened by compatible applications. Microsoft PowerPoint, LibreOffice, and OpenOffice are not required.
...
{{% blocks/products/pf/agp/code-block title="Python code for converting PPTX to ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PPTX to ODP in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to convert a PPTX presentation to an ODP file." >}}
