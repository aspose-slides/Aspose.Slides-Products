...
description: Convert ODP presentations to legacy PowerPoint PPS slide shows in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert ODP Presentations to PPS in Python" h2="Save an ODP presentation as a legacy PowerPoint PPS slide show with Aspose.Slides for Python via Java." >}}
...
Create a `Presentation` from the ODP file and call `save` with `SaveFormat.Pps` to create the PPS slide show.

{{% blocks/products/pf/agp/code-block title="Python code for converting ODP to PPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert ODP to PPS in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to convert an OpenDocument presentation to a legacy PowerPoint PPS slide show." >}}
