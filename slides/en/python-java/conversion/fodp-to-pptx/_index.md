...
description: Convert FODP presentations to PPTX format in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert FODP to PPTX in Python" h2="Transform an FODP presentation into an editable PPTX file with Aspose.Slides for Python via Java." >}}

{{% blocks/products/pf/feature-page-section h2="Convert FODP to PPTX in Python" %}}

[**Aspose.Slides for Python via Java**](/slides/python-java/) can load an FODP presentation and save it as a PPTX file while preserving its slides and content. The conversion does not require Microsoft PowerPoint, LibreOffice, or OpenOffice.
...
{{% blocks/products/pf/agp/code-block title="Python code for converting FODP to PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert FODP to PPTX in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to convert an FODP presentation to PPTX format." >}}
...
{{% blocks/products/pf/agp/step-autogen %}}
Call `save` with `SaveFormat.Pptx` to create the PPTX file.
{{% /blocks/products/pf/agp/step-autogen %}}
