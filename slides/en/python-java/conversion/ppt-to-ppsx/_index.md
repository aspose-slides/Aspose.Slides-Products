...
keywords: Python PPT conversion, PPT to PPSX, PowerPoint to PPSX, Open XML slide show, Aspose.Slides for Python via Java
description: Convert PPT files to PPSX format in Python with Aspose.Slides for Python via Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convert PPT to PPSX in Python" h2="Save a legacy PowerPoint presentation as an Open XML PPSX slide show with Aspose.Slides for Python via Java." >}}
...
{{% blocks/products/pf/agp/code-block title="Python code for converting PPT to PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="How to convert PPT to PPSX in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Follow these steps to save a PowerPoint PPT presentation as an Open XML PPSX slide show." >}}
