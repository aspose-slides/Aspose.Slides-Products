---
title: Konversi ODP ke BMP melalui aplikasi C++
weight: 4570
url: /id/cpp/conversion/odp-to-bmp/ 
description: Contoh kode konversi C++ untuk dokumen ODP ke format BMP. Gunakan kode contoh untuk konversi batch ODP ke BMP dalam Aplikasi C++ apa pun.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi ODP ke BMP melalui C++" h2="Konversi ODP ke BMP berperforma tinggi menggunakan pustaka C++ tanpa perlu instalasi Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi ODP ke BMP Menggunakan C++" %}}

 Untuk mengonversi ODP ke BMP, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengkonversi ODP ke BMP melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

 Pengembang C++ dapat dengan mudah mengonversi file ODP ke BMP hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/code-block title="Kode Sumber Konversi ODP ke BMP C++" offSpacer="" %}}
