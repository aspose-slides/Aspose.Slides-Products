---
title: Konversi FODP ke PNG dengan Python
weight: 90
url: /id/python-net/conversion/fodp-to-png/ 
keywords: "Convert, PowerPoint, FODP, PNG, Presentation, Python"
description: Contoh kode untuk konversi FODP ke PNG Python. Gunakan PowerPoint Python API untuk konversi batch file FODP ke file PNG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi FODP ke PNG dengan Python" h2="Pustaka Python PowerPoint yang kuat untuk mengonversi FODP ke PNG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Konversi FODP ke PNG dengan Python" %}}

Perlu mengonversi file FODP ke PNG secara terprogram? Menggunakan [*Aspose.Slides untuk Python melalui .NET*](https://products.aspose.com/slides/id/python-net/) pengembang mana pun dapat mengonversi FODP ke format PNG hanya dengan beberapa baris kode Python.

Sebagai API pemrosesan presentasi modern, Aspose.Slides untuk Python membuat PNG dari FODP dengan cepat. Uji kualitas konversi FODP ke PNG langsung di [browser](https://products.aspose.app/slides/conversion/ppt-to-png) Anda. Perpustakaan Aspose PowerPoint PPTX memungkinkan Anda untuk mengonversi file FODP ke banyak format populer.
...
{{< blocks/products/pf/agp/feature-section-col title="Bagaimana Mengonversi FODP ke PNG dengan Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk mengonversi file FODP ke PNG menggunakan Python." >}}
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan Konversi FODP ke PNG Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan FODP sebagai PNG dengan Python" %}}
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        appName="conversion"
        extension=""
        sectionTitle="Aplikasi gratis untuk mengonversi FODP ke PNG" 
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/id/python-net/conversion/fodp-to-potx/" name="FODP TO POTX" description="Presentasi Template Microsoft PowerPoint" >}}  
