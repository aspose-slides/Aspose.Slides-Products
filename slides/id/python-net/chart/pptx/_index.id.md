---
title: Buat Bagan di File Presentasi PPTX menggunakan Python
url: /id/python-net/chart/pptx/
...
{{% blocks/products/pf/agp/code-block title="Contoh kode berikut menunjukkan cara membuat diagram lingkaran di PowerPoint PPTX di Python." offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara Membuat dan menyesuaikan Bagan pai dalam PPTX melalui Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menambahkan diagram Pai ke file PPTX." >}}

{{< blocks/products/pf/agp/step-autogen >}}
Pertama, buat instance kelas Presentasi PPTX.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/id/python-net/chart/ppt/" name="PPT" >}}
