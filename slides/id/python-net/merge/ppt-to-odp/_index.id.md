---
title: Gabungkan File PPT Ke ODP Menggunakan Python
url: /id/python-net/merge/ppt-to-odp/
keywords: Gabungkan PPT ke ODP, Gabungkan PPT ke ODP, Gabungkan PPT ke ODP, PowerPoint, Presentasi, ODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file PPT ke ODP menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa PPT menjadi satu file ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan PPT ke ODP menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file PPT dan menyimpan hasilnya sebagai ODP dengan Python." >}}
