---
title: Gabungkan File ODP Ke TIFF Menggunakan Python
url: /id/python-net/merge/odp-to-tiff/
keywords: Gabungkan ODP ke TIFF, Gabungkan ODP ke TIFF, Gabungkan ODP ke TIFF, PowerPoint, Presentasi, TIFF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file ODP ke TIFF menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa ODP menjadi satu file TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan ODP ke TIFF menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file ODP dan menyimpan hasilnya sebagai TIFF dengan Python." >}}
