---
title: Gabungkan File PPS Ke OTP Menggunakan Python
url: /id/python-net/merge/pps-to-otp/
keywords: Gabungkan PPS ke OTP, Gabungkan PPS ke OTP, Gabungkan PPS ke OTP, PowerPoint, Presentasi, OTP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file PPS ke OTP menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa PPS menjadi satu file OTP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan PPS ke OTP menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file PPS dan menyimpan hasilnya sebagai OTP dengan Python." >}}
