---
title: Gabungkan File PPTX Ke POTM Menggunakan Python
url: /id/python-net/merge/pptx-to-potm/
keywords: Gabungkan PPTX ke POTM, Gabungkan PPTX ke POTM, Gabungkan PPTX ke POTM, PowerPoint, Presentasi, POTM, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file PPTX ke POTM menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa PPTX menjadi satu file POTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan PPTX ke POTM menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file PPTX dan menyimpan hasilnya sebagai POTM dengan Python." >}}
