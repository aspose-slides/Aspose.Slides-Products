---
title: Gabungkan PPT File Menggunakan Python
url: /id/python-net/merge/ppt/
keywords: Gabungkan PPT, Gabung PPT, Gabungkan PPT, PowerPoint, Presentasi, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file PPT menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa PPT menjadi satu file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan PPT menggunakan Aspose.Slides untuk Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file PPT dan menyimpan hasilnya sebagai PPT dengan Python." >}}
