---
title: Gabungkan File PPTX Ke FODP Menggunakan Python
url: /id/python-net/merge/pptx-to-fodp/
keywords: Gabungkan PPTX ke FODP, Gabungkan PPTX ke FODP, Gabungkan PPTX ke FODP, PowerPoint, Presentasi, FODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file PPTX ke FODP menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa PPTX menjadi satu file FODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan PPTX ke FODP menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file PPTX dan menyimpan hasilnya sebagai FODP dengan Python." >}}
