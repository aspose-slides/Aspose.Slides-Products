---
title: Gabungkan File PPS Ke POTX Menggunakan Python
url: /id/python-net/merge/pps-to-potx/
keywords: Gabungkan PPS ke POTX, Gabungkan PPS ke POTX, Gabungkan PPS ke POTX, PowerPoint, Presentasi, POTX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file PPS ke POTX menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa PPS menjadi satu file POTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan PPS ke POTX menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file PPS dan menyimpan hasilnya sebagai POTX dengan Python." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/id/python-net/merge/pps-to-ppt/" name="PPS TO PPT" >}}  
