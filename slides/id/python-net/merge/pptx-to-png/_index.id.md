---
title: Gabungkan File PPTX Ke PNG Menggunakan Python
url: /id/python-net/merge/pptx-to-png/
keywords: Gabungkan PPTX ke PNG, Gabungkan PPTX ke PNG, Gabungkan PPTX ke PNG, PowerPoint, Presentasi, PNG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file PPTX ke PNG menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa PPTX menjadi satu file PNG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan PPTX ke PNG menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file PPTX dan menyimpan hasilnya sebagai PNG dengan Python." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Simpan presentasi dan dapatkan hasilnya sebagai file PNG tunggal.
```
for slide in pres1.slides:
    slide.get_thumbnail(2, 2).save("presentation_slide_{0}.png".format(str(slide.slide_number)), drawing.imaging.ImageFormat.png)
```
