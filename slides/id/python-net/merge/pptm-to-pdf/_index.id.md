---
title: Gabungkan File PPTM Ke PDF Menggunakan Python
url: /id/python-net/merge/pptm-to-pdf/
keywords: Gabungkan PPTM ke PDF, Gabungkan PPTM ke PDF, Gabungkan PPTM ke PDF, PowerPoint, Presentasi, PDF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file PPTM ke PDF menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa PPTM menjadi satu file PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan PPTM ke PDF menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file PPTM dan menyimpan hasilnya sebagai PDF dengan Python." >}}
