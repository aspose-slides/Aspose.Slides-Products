---
title: Gabungkan File PDF Ke PPTX Menggunakan Python
url: /id/python-net/merge/pdf-to-pptx/
keywords: Gabungkan PDF ke PPTX, Gabungkan PDF ke PPTX, Gabungkan PDF ke PPTX, PowerPoint, Presentasi, PPTX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file PDF ke PPTX menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa PDF menjadi satu file PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan PDF ke PPTX menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file PDF dan menyimpan hasilnya sebagai PPTX dengan Python." >}}
