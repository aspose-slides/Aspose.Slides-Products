---
title: Gabungkan File PPSX Ke TIFF Menggunakan Python
url: /id/python-net/merge/ppsx-to-tiff/
keywords: Gabungkan PPSX ke TIFF, Gabungkan PPSX ke TIFF, Gabungkan PPSX ke TIFF, PowerPoint, Presentasi, TIFF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file PPSX ke TIFF menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa PPSX menjadi satu file TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan PPSX ke TIFF menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file PPSX dan menyimpan hasilnya sebagai TIFF dengan Python." >}}
