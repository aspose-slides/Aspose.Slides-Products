---
title: Gabungkan File ODP Ke PPTX Menggunakan Python
url: /id/python-net/merge/odp-to-pptx/
keywords: Gabungkan ODP ke PPTX, Gabungkan ODP ke PPTX, Gabungkan ODP ke PPTX, PowerPoint, Presentasi, PPTX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file ODP ke PPTX menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa ODP menjadi satu file PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan ODP ke PPTX menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file ODP dan menyimpan hasilnya sebagai PPTX dengan Python." >}}
