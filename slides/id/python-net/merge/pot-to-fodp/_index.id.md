---
title: Gabungkan File POT Ke FODP Menggunakan Python
url: /id/python-net/merge/pot-to-fodp/
keywords: Gabungkan POT ke FODP, Gabungkan POT ke FODP, Gabungkan POT ke FODP, PowerPoint, Presentasi, FODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file POT ke FODP menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa POT menjadi satu file FODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan POT ke FODP menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file POT dan menyimpan hasilnya sebagai FODP dengan Python." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/id/python-net/merge/pot-to-otp/" name="POT TO OTP" >}}  
