---
title: Gabungkan File PPTM Ke BMP Menggunakan Python
url: /id/python-net/merge/pptm-to-bmp/
keywords: Gabungkan PPTM ke BMP, Gabungkan PPTM ke BMP, Gabungkan PPTM ke BMP, PowerPoint, Presentasi, BMP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file PPTM ke BMP menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa PPTM menjadi satu file BMP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan PPTM ke BMP menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file PPTM dan menyimpan hasilnya sebagai BMP dengan Python." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Simpan presentasi dan dapatkan hasilnya sebagai file BMP tunggal.
```
for slide in pres1.slides:
    slide.get_thumbnail(2, 2).save("presentation_slide_{0}.bmp".format(str(slide.slide_number)), drawing.imaging.ImageFormat.bmp)
```
