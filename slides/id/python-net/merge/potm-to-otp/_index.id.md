---
title: Gabungkan File POTM Ke OTP Menggunakan Python
url: /id/python-net/merge/potm-to-otp/
keywords: Gabungkan POTM ke OTP, Gabungkan POTM ke OTP, Gabungkan POTM ke OTP, PowerPoint, Presentasi, OTP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file POTM ke OTP menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa POTM menjadi satu file OTP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan POTM ke OTP menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file POTM dan menyimpan hasilnya sebagai OTP dengan Python." >}}
