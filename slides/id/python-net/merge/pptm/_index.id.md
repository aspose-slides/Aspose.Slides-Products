---
title: Gabungkan PPTM File Menggunakan Python
url: /id/python-net/merge/pptm/
keywords: Gabungkan PPTM, Gabung PPTM, Gabungkan PPTM, PowerPoint, Presentasi, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file PPTM menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa PPTM menjadi satu file" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan PPTM menggunakan Aspose.Slides untuk Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file PPTM dan menyimpan hasilnya sebagai PPTM dengan Python." >}}
