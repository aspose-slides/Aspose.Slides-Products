---
title: Gabungkan File PPTX Ke TIFF Menggunakan Python
url: /id/python-net/merge/pptx-to-tiff/
keywords: Gabungkan PPTX ke TIFF, Gabungkan PPTX ke TIFF, Gabungkan PPTX ke TIFF, PowerPoint, Presentasi, TIFF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file PPTX ke TIFF menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa PPTX menjadi satu file TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan PPTX ke TIFF menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file PPTX dan menyimpan hasilnya sebagai TIFF dengan Python." >}}
