---
title: Gabungkan File POT Ke HTML Menggunakan Python
url: /id/python-net/merge/pot-to-html/
keywords: Gabungkan POT ke HTML, Gabungkan POT ke HTML, Gabungkan POT ke HTML, PowerPoint, Presentasi, HTML, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file POT ke HTML menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa POT menjadi satu file HTML" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan POT ke HTML menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file POT dan menyimpan hasilnya sebagai HTML dengan Python." >}}
