---
title: Gabungkan File ODP Ke PDF Menggunakan Python
url: /id/python-net/merge/odp-to-pdf/
keywords: Gabungkan ODP ke PDF, Gabungkan ODP ke PDF, Gabungkan ODP ke PDF, PowerPoint, Presentasi, PDF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file ODP ke PDF menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa ODP menjadi satu file PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan ODP ke PDF menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file ODP dan menyimpan hasilnya sebagai PDF dengan Python." >}}
