---
title: Gabungkan File PPT Ke POTX Menggunakan Python
url: /id/python-net/merge/ppt-to-potx/
keywords: Gabungkan PPT ke POTX, Gabungkan PPT ke POTX, Gabungkan PPT ke POTX, PowerPoint, Presentasi, POTX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file PPT ke POTX menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa PPT menjadi satu file POTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan PPT ke POTX menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file PPT dan menyimpan hasilnya sebagai POTX dengan Python." >}}
