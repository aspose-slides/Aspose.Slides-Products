---
title: Gabungkan File PPT Ke OTP Menggunakan Python
url: /id/python-net/merge/ppt-to-otp/
keywords: Gabungkan PPT ke OTP, Gabungkan PPT ke OTP, Gabungkan PPT ke OTP, PowerPoint, Presentasi, OTP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Gabungkan file PPT ke OTP menggunakan Python" %}}
Untuk menggabungkan presentasi PowerPoint, Anda perlu mengkloning slide dari satu presentasi ke presentasi lainnya.

{{% blocks/products/pf/agp/code-block title="Kode python untuk menggabungkan beberapa PPT menjadi satu file OTP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan PPT ke OTP menggunakan Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file PPT dan menyimpan hasilnya sebagai OTP dengan Python." >}}
