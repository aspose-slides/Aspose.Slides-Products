...
title: Konversi ODP ke PDF di PHP
weight: 280
url: /id/php-java/conversion/odp-to-pdf/ 
keywords: "Convert, PowerPoint, ODP, PDF, Presentation, PHP"
description: Contoh kode untuk ODP ke PDF konversi PHP. Gunakan PowerPoint PHP API untuk konversi batch file ODP ke file PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi ODP ke PDF di PHP" h2="Pustaka PowerPoint PHP yang andal untuk mengonversi ODP ke PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Konversi ODP ke PDF di PHP" %}}

Perlu mengonversi file ODP ke PDF secara terprogram? Menggunakan [*Aspose.Slides for PHP via Java*](https://products.aspose.com/slides/id/php-java/) pengembang mana pun dapat mengonversi format ODP ke PDF hanya dengan beberapa baris kode PHP .

Sebagai API pemrosesan presentasi modern, Aspose.Slides untuk PHP membuat PDF dari ODP dengan cepat. Uji kualitas konversi ODP ke PDF langsung di [browser](https://products.aspose.app/slides/conversion) Anda. Pustaka Aspose PowerPoint PPTX memungkinkan Anda mengonversi file ODP ke banyak format populer.
...
{{< blocks/products/pf/agp/feature-section-col title="Cara Mengonversi ODP ke PDF di PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Berikut adalah langkah-langkah untuk mengonversi file ODP ke PDF menggunakan PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan ODP ke PDF Konversi PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan ODP sebagai PDF di PHP" %}}
