...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan PPT menggunakan Aspose.Slides untuk PHP API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ini adalah langkah-langkah untuk menggabungkan dua file PPT dan menyimpan hasilnya sebagai PPT di PHP." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Muat file PPT yang ingin Anda gabungkan.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Simpan dokumen PPT yang dihasilkan.
{{< /blocks/products/pf/agp/step-autogen >}}
