...
description: Edit PPS di PHP. Gunakan PHP library API untuk mengedit file PPS
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edit PPS di PHP" h2="Pustaka PHP lintas platform dan berkecepatan tinggi untuk mengedit PPS menggunakan kode PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edit PPS menggunakan Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/id/php-java/) adalah library PHP canggih yang digunakan untuk memanipulasi dan mengedit presentasi. Anda dapat mengedit presentasi PPS dengan menambahkan baris teks baru ke dalamnya. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edit PPS di PHP" %}}
Menggunakan [**Aspose.Slides untuk PHP via Java**](https://products.aspose.com/slides/id/php-java/), Anda dapat menambahkan baris teks baru ke dokumen PPS hanya dengan beberapa baris kode.

{{% blocks/products/pf/agp/code-block title="Kode PHP untuk mengedit PPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara mengedit PPS di PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Muat presentasi PPS yang ingin Anda edit.
{{< /blocks/products/pf/agp/step-autogen >}}
