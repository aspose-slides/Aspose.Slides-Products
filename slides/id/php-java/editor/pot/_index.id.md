---
title: Edit POT di PHP
url: /id/php-java/editor/pot/
keywords: Edit POT, Edit PowerPoint, POT, PowerPoint, API PHP, Perpustakaan PHP
description: Edit POT di PHP. Gunakan PHP library API untuk mengedit file POT
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edit POT di PHP" h2="Pustaka PHP lintas platform dan berkecepatan tinggi untuk mengedit POT menggunakan kode PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edit POT menggunakan Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/id/php-java/) adalah library PHP canggih yang digunakan untuk memanipulasi dan mengedit presentasi. Anda dapat mengedit presentasi POT dengan menambahkan baris teks baru ke dalamnya. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edit POT di PHP" %}}
Menggunakan [**Aspose.Slides untuk PHP via Java**](https://products.aspose.com/slides/id/php-java/), Anda dapat menambahkan baris teks baru ke dokumen POT hanya dengan beberapa baris kode.

{{% blocks/products/pf/agp/code-block title="Kode PHP untuk mengedit POT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara mengedit POT di PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Muat presentasi POT yang ingin Anda edit.
{{< /blocks/products/pf/agp/step-autogen >}}
