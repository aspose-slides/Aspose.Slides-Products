---
title: Edit PPSM di PHP
url: /id/php-java/editor/ppsm/
keywords: Edit PPSM, Edit PowerPoint, PPSM, PowerPoint, API PHP, Perpustakaan PHP
description: Edit PPSM di PHP. Gunakan PHP library API untuk mengedit file PPSM
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edit PPSM di PHP" h2="Pustaka PHP lintas platform dan berkecepatan tinggi untuk mengedit PPSM menggunakan kode PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edit PPSM menggunakan Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/id/php-java/) adalah library PHP canggih yang digunakan untuk memanipulasi dan mengedit presentasi. Anda dapat mengedit presentasi PPSM dengan menambahkan baris teks baru ke dalamnya. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edit PPSM di PHP" %}}
Menggunakan [**Aspose.Slides untuk PHP via Java**](https://products.aspose.com/slides/id/php-java/), Anda dapat menambahkan baris teks baru ke dokumen PPSM hanya dengan beberapa baris kode.

{{% blocks/products/pf/agp/code-block title="Kode PHP untuk mengedit PPSM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara mengedit PPSM di PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Muat presentasi PPSM yang ingin Anda edit.
{{< /blocks/products/pf/agp/step-autogen >}}
