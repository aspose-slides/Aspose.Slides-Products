---
title: Edit PPTM di PHP
url: /id/php-java/editor/pptm/
keywords: Edit PPTM, Edit PowerPoint, PPTM, PowerPoint, API PHP, Perpustakaan PHP
description: Edit PPTM di PHP. Gunakan PHP library API untuk mengedit file PPTM
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edit PPTM di PHP" h2="Pustaka PHP lintas platform dan berkecepatan tinggi untuk mengedit PPTM menggunakan kode PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edit PPTM menggunakan Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/id/php-java/) adalah library PHP canggih yang digunakan untuk memanipulasi dan mengedit presentasi. Anda dapat mengedit presentasi PPTM dengan menambahkan baris teks baru ke dalamnya. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edit PPTM di PHP" %}}
Menggunakan [**Aspose.Slides untuk PHP via Java**](https://products.aspose.com/slides/id/php-java/), Anda dapat menambahkan baris teks baru ke dokumen PPTM hanya dengan beberapa baris kode.

{{% blocks/products/pf/agp/code-block title="Kode PHP untuk mengedit PPTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara mengedit PPTM di PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Muat presentasi PPTM yang ingin Anda edit.
{{< /blocks/products/pf/agp/step-autogen >}}
