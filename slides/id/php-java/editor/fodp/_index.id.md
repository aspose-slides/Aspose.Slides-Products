---
title: Edit FODP di PHP
url: /id/php-java/editor/fodp/
keywords: Edit FODP, Edit PowerPoint, FODP, PowerPoint, API PHP, Perpustakaan PHP
description: Edit FODP di PHP. Gunakan PHP library API untuk mengedit file FODP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edit FODP di PHP" h2="Pustaka PHP lintas platform dan berkecepatan tinggi untuk mengedit FODP menggunakan kode PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edit FODP menggunakan Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/id/php-java/) adalah library PHP canggih yang digunakan untuk memanipulasi dan mengedit presentasi. Anda dapat mengedit presentasi FODP dengan menambahkan baris teks baru ke dalamnya. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edit FODP di PHP" %}}
Menggunakan [**Aspose.Slides untuk PHP via Java**](https://products.aspose.com/slides/id/php-java/), Anda dapat menambahkan baris teks baru ke dokumen FODP hanya dengan beberapa baris kode.

{{% blocks/products/pf/agp/code-block title="Kode PHP untuk mengedit FODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara mengedit FODP di PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Muat presentasi FODP yang ingin Anda edit.
{{< /blocks/products/pf/agp/step-autogen >}}
