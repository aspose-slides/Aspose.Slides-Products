---
title: Edit POTX di PHP
url: /id/php-java/editor/potx/
keywords: Edit POTX, Edit PowerPoint, POTX, PowerPoint, API PHP, Perpustakaan PHP
description: Edit POTX di PHP. Gunakan PHP library API untuk mengedit file POTX
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edit POTX di PHP" h2="Pustaka PHP lintas platform dan berkecepatan tinggi untuk mengedit POTX menggunakan kode PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edit POTX menggunakan Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/id/php-java/) adalah library PHP canggih yang digunakan untuk memanipulasi dan mengedit presentasi. Anda dapat mengedit presentasi POTX dengan menambahkan baris teks baru ke dalamnya. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edit POTX di PHP" %}}
Menggunakan [**Aspose.Slides untuk PHP via Java**](https://products.aspose.com/slides/id/php-java/), Anda dapat menambahkan baris teks baru ke dokumen POTX hanya dengan beberapa baris kode.

{{% blocks/products/pf/agp/code-block title="Kode PHP untuk mengedit POTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara mengedit POTX di PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Muat presentasi POTX yang ingin Anda edit.
{{< /blocks/products/pf/agp/step-autogen >}}
