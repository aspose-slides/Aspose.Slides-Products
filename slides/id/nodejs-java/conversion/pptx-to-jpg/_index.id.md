---
title: Konversikan PPTX ke JPG di Node.js
url: /id/nodejs-java/conversion/pptx-to-jpg/
keywords: PPTX ke JPG, Konversi PPTX ke JPG, API Node.js, Pustaka Node.js, PPTX, JPG
description: Konversikan PPTX ke JPG di Node.js. Gunakan API perpustakaan Node.js untuk mengonversi file PPTX menjadi JPG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konversikan PPTX ke JPG di Node.js" h2="Aspose.Slides untuk Node.js melalui Java adalah pustaka yang kuat dan mudah digunakan yang memungkinkan Anda mengonversi presentasi PowerPoint ke berbagai format di Node.js. Ini mendukung semua elemen dan format presentasi dan menyediakan API yang kaya untuk mengakses dan memodifikasinya. Ini juga memungkinkan Anda mengekspor slide Anda ke berbagai format untuk diproses atau dibagikan lebih lanjut." >}}

{{% blocks/products/pf/feature-page-section h2="Konversikan PPTX ke JPG di Node.js" %}}

[**Aspose.Slides untuk Node.js melalui Java**](https://products.aspose.com/slides/id/nodejs-java/) adalah pustaka Node.js yang canggih untuk membuat dan memanipulasi file presentasi. Selain itu, ini menyediakan cara yang fleksibel untuk mengonversi PPTX ke JPG. Menggunakan **Aspose.Slides untuk Node.js melalui Java**, pengembang atau aplikasi mana pun dapat mengonversi file PPTX ke JPG hanya dengan beberapa baris kode.

Sebagai API pemrosesan dokumen modern, Aspose.Slides untuk Node.js mengekspor file PPTX ke format file JPG dengan cepat. Pustaka Aspose PowerPoint memungkinkan Anda mengonversi PPTX ke JPG dan banyak format file lainnya

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Konversikan PPTX ke JPG menggunakan Node.js" %}}
Untuk mengonversi PPTX ke JPG, Anda perlu membuat Presentasi dari file PPTX dan menyimpannya sebagai JPG.

{{% blocks/products/pf/agp/code-block title="Kode Node.js untuk mengubah PPTX menjadi JPG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara mengonversi PPTX ke JPG menggunakan Aspose.Slides untuk Node.js melalui Java API" >}}
