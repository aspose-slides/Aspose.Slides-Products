...
url: /id/net/merger/png-to-png/
keywords: Gabungkan PNG, PNG ke PNG, Gabung PNG, Gabungkan PNG, C# API, .NET Library
description: Menggabungkan PNG ke PNG dalam C#. Gunakan .NET library API untuk menggabungkan file PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Gabungkan PNG dalam C#" h2=".NET API lintas platform yang kuat untuk menggabungkan gambar PNG menggunakan kode C# pada Platform NET Framework, .NET Core, Windows Azure, Mono atau Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Menggabungkan PNG ke PNG menggunakan Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/id/net/) adalah pustaka .NET andal yang digunakan untuk menggabungkan dan memanipulasi presentasi, gambar, dan file lainnya. Saat Anda menggabungkan PNG ke PNG, Anda menggabungkan dua gambar secara efektif untuk mendapatkan satu gambar.
...
Menggunakan [**Aspose.Slides untuk .NET**](https://products.aspose.com/slides/id/net/), Anda dapat menggabungkan file PNG dengan cepat hanya dengan beberapa baris kode
