---
title: Menggabungkan PNG ke PDF dalam C#
url: /id/net/merger/png-to-pdf/
keywords: PNG ke PDF, Gabungkan PNG ke PDF, Gabungkan PNG ke PDF, PDF, PNG, C# API, .NET Library
description: Menggabungkan PNG ke PDF dalam C#. Gunakan .NET library API untuk menggabungkan PNG dan PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Menggabungkan PNG ke PDF dalam C#" h2="API .NET lintas platform yang kuat untuk menggabungkan file PNG ke PDF menggunakan kode C# pada Platform NET Framework, .NET Core, Windows Azure, Mono atau Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Gabungkan PNG ke PDF menggunakan Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/id/net/) adalah pustaka .NET andal yang digunakan untuk membuat, mengonversi, menggabungkan, dan memanipulasi presentasi, gambar, dan lainnya file. Saat Anda menggabungkan PNG ke PDF, Anda menggabungkan gambar PNG secara efektif untuk mendapatkan satu file PDF.
...
{{% blocks/products/pf/feature-page-section  h2="Menggabungkan PNG ke PDF dalam C#" %}}
Menggunakan [**Aspose.Slides untuk .NET**](https://products.aspose.com/slides/id/net/), Anda dapat menggabungkan PNG ke PDF dengan cepat hanya dengan beberapa baris kode

{{% blocks/products/pf/agp/code-block title="Kode C# untuk menggabungkan PNG ke PDF" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan PNG ke PDF di C#" >}}
