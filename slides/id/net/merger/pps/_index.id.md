...
{{< blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menggabungkan File PPS di C#" >}}
...
Muat semua file PPS dengan path lengkap.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Panggil metode Save() dan teruskan nama file (path lengkap) dan format (PPS) sebagai parameter.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Sekarang Anda dapat membuka dan menggunakan file PPS di Microsoft Office, Adobe PDF atau program lain yang kompatibel.
{{< /blocks/products/pf/agp/step-autogen >}}
