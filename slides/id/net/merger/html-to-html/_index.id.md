...
url: /id/net/merger/html-to-html/
keywords: Gabungkan HTML, HTML ke HTML, Gabungkan HTML, Gabungkan HTML, C# API, Perpustakaan .NET
description: Menggabungkan HTML ke HTML dalam C#. Gunakan .NET library API untuk menggabungkan file HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Menggabungkan HTML dalam C#" h2=".NET API lintas platform yang kuat untuk menggabungkan file HTML menggunakan kode C# pada Platform NET Framework, .NET Core, Windows Azure, Mono atau Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Menggabungkan HTML ke HTML menggunakan Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/id/net/) adalah library .NET andal yang digunakan untuk membuat, mengonversi, menggabungkan, dan memanipulasi presentasi, file HTML, dan dokumen lainnya. Saat Anda menggabungkan HTML ke HTML, Anda secara efektif menggabungkan konten dari 2 dokumen untuk mendapatkan satu file HTML. Aspose.Slides memungkinkan Anda menggabungkan dokumen HTML dengan berbagai cara. Anda dapat menggabungkan HTML dengan semua teks, pemformatan, gaya, dll.
...
Menggunakan [**Aspose.Slides untuk .NET**](https://products.aspose.com/slides/id/net/), Anda dapat menggabungkan file HTML dengan cepat hanya dengan beberapa baris kode
