---
title: Konversi HTML ke Gambar di C#
weight: 160
url: /id/net/conversion/html-to-image/ 
keywords: HTML ke Gambar, Konversi HTML ke Gambar, C# API, .NET Library, HTML, Gambar
description: Konversi HTML ke Gambar di C#. Gunakan .NET library API untuk mengonversi file HTML menjadi gambar
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi HTML ke Gambar di C#" h2="PowerPoint .NET API untuk mengonversi file HTML ke gambar di NET Framework, .NET Core, Windows Azure, Mono atau Platform Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi HTML ke Gambar di C#" %}}

Bagaimana cara mengonversi HTML ke Gambar dalam kode?

Menggunakan [**Aspose.Slides for .NET**](https://products.aspose.com/slides/id/net/), pengembang atau aplikasi apa pun dapat mengonversi HTML ke file gambar hanya dengan beberapa baris kode C#.

Sebagai API pemrosesan dokumen modern, Aspose.Slides untuk .NET mengekspor file HTML ke format file gambar dengan cepat. Perpustakaan Aspose PowerPoint memungkinkan Anda untuk mengonversi HTML ke gambar dan banyak format file lainnya
...
{{< blocks/products/pf/agp/feature-section-col title="Cara Mengonversi HTML ke Gambar di C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Pengembang dan aplikasi dapat mengonversi HTML ke Gambar dengan cara ini:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Tambahkan slide berdasarkan halaman HTML.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Sebelum Anda menjalankan kode C# konversi HTML ke Gambar, mesin Anda harus memiliki prasyarat berikut:
...
{{% blocks/products/pf/agp/code-block title="Kode C# untuk mengonversi HTML ke Gambar" offSpacer="" %}}
