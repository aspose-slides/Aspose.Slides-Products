---
title: Konversi PPTX ke PPSM melalui C#
weight: 8820
url: /id/net/conversion/pptx-to-ppsm/ 
description: Contoh kode untuk konversi PPTX ke PPSM C#. Gunakan kode contoh API untuk file PPTX batch ke konversi PPSM dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi PPTX ke PPSM melalui C#" h2="Ekspor file PowerPoint® PPTX ke PPSM di .NET Framework, .NET Core, Windows Azure, Mono, atau Platform Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="Pengembang .NET dapat dengan mudah memuat & mengonversi file PPTX ke PPSM hanya dalam beberapa baris kode." >}}
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan Konversi PPTX ke PPSM C#" offSpacer="" %}}
