---
title: Konversi ODP ke HTML melalui C#
weight: 2270
url: /id/net/conversion/odp-to-html/ 
description: Contoh kode untuk konversi ODP ke HTML C#. Gunakan kode contoh API untuk file batch ODP ke konversi HTML dalam VB.NET, Asp.NET atau aplikasi berbasis .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi ODP ke HTML melalui C#" h2="Ekspor file PowerPoint® ODP ke HTML di .NET Framework, .NET Core, Windows Azure, Mono atau Platform Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi ODP ke HTML Menggunakan C#" %}}

 Untuk mengonversi ODP ke HTML, kami akan menggunakan
...
{{< blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengkonversi ODP ke HTML melalui C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Pengembang .NET dapat dengan mudah memuat & mengonversi file ODP ke HTML hanya dalam beberapa baris kode." >}}
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan Konversi ODP ke HTML C#" offSpacer="" %}}
