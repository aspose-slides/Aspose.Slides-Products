---
title: Konversi PNG ke SVG di C#
weight: 240
url: /id/net/conversion/png-to-svg/ 
keywords: PNG ke SVG, Konversi PNG ke SVG, C# API, .NET Library
description: Konversi PNG ke SVG di C#. Gunakan .NET library API untuk mengonversi file PNG ke SVG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi PNG ke SVG di C#" h2="PowerPoint .NET API untuk mengonversi file gambar PNG ke SVG di NET Framework, .NET Core, Windows Azure, Mono atau Platform Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Konversi PNG ke SVG di C#" %}}

Bagaimana cara mengonversi PNG ke SVG dalam kode?
...
{{< blocks/products/pf/agp/feature-section-col title="Cara Mengonversi PNG ke SVG di C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Pengembang dan aplikasi dapat mengonversi PNG ke SVG dengan cara ini:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Simpan file sebagai gambar SVG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Sebelum Anda menjalankan kode C# konversi PNG ke SVG, mesin Anda harus memiliki prasyarat berikut:
...
{{% blocks/products/pf/agp/code-block title="Kode C# untuk mengonversi PNG ke SVG" offSpacer="" %}}
