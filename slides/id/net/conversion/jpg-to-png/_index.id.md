---
title: Konversi JPG ke PNG di C#
weight: 220
url: /id/net/conversion/jpg-to-png/ 
keywords: JPG ke PNG, Konversi JPG ke PNG, C# API, .NET Library
description: Konversi JPG ke PNG di C#. Gunakan .NET library API untuk mengonversi file JPG ke PNG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi JPG ke PNG di C#" h2="PowerPoint .NET API untuk mengonversi file gambar JPG ke PNG di NET Framework, .NET Core, Windows Azure, Mono atau Platform Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Konversi JPG ke PNG di C#" %}}

Bagaimana cara mengonversi JPG ke PNG dalam kode?
...
{{< blocks/products/pf/agp/feature-section-col title="Cara Mengonversi JPG ke PNG di C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Pengembang dan aplikasi dapat mengonversi JPG ke PNG dengan cara ini:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Sebelum Anda menjalankan kode C# konversi JPG ke PNG, mesin Anda harus memiliki prasyarat berikut:
...
{{% blocks/products/pf/agp/code-block title="Kode C# untuk mengonversi JPG ke PNG" offSpacer="" %}}
