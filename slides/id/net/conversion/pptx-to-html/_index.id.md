---
title: Konversi PPTX ke HTML melalui C#
weight: 4430
url: /id/net/conversion/pptx-to-html/ 
description: Contoh kode untuk konversi PPTX ke HTML C#. Gunakan kode contoh API untuk file PPTX batch ke konversi HTML dalam VB.NET, Asp.NET atau aplikasi berbasis .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi PPTX ke HTML melalui C#" h2="Ekspor file PowerPoint® PPTX ke HTML di .NET Framework, .NET Core, Windows Azure, Mono atau Platform Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi PPTX ke HTML Menggunakan C#" %}}

 Untuk mengonversi PPTX ke HTML, kami akan menggunakan
...
{{< blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengkonversi PPTX ke HTML melalui C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Pengembang .NET dapat dengan mudah memuat & mengonversi file PPTX ke HTML hanya dalam beberapa baris kode." >}}
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan Konversi PPTX ke HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/id/net/conversion/pptx-to-png/" name="PPTX TO PNG" description="Grafik Jaringan Portabel" >}}
