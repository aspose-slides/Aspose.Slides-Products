...
title: Konversi PDF ke JPG di C#
weight: 70
url: /id/net/conversion/pdf-to-jpg/ 
keywords: PDF ke JPG, Konversi PDF ke JPG, C# API, .NET Library, PDF, JPG
description: Konversi PDF ke JPG di C#. Gunakan .NET library API untuk mengonversi halaman PDF ke gambar JPG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi PDF ke JPG di C#" h2="PowerPoint .NET API untuk mengonversi dokumen PDF ke gambar JPG di NET Framework, .NET Core, Windows Azure, Mono atau Platform Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi PDF ke JPG di C#" %}}

Bagaimana cara mengonversi PDF ke JPG dalam kode?

Menggunakan [**Aspose.Slides for .NET**](https://products.aspose.com/slides/id/net/), pengembang atau aplikasi apa pun dapat mengonversi PDF ke format JPG hanya dengan beberapa baris kode C#.

Sebagai API pemrosesan dokumen modern, Aspose.Slides untuk .NET mengekspor halaman PDF ke JPG dengan cepat. Perpustakaan Aspose PowerPoint memungkinkan Anda mengonversi PDF ke JPG dan banyak format file lainnya
...
{{< blocks/products/pf/agp/feature-section-col title="Cara Mengonversi PDF ke JPG di C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Pengembang dan aplikasi dapat mengonversi PDF ke JPG dengan cara ini:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Panggil metode simpan untuk menyimpan slide sebagai gambar JPG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Sebelum Anda menjalankan kode C# konversi PDF ke JPG, mesin Anda harus memiliki prasyarat berikut:
...
{{% blocks/products/pf/agp/code-block title="Kode C# untuk mengonversi PDF ke JPG" offSpacer="" %}}
