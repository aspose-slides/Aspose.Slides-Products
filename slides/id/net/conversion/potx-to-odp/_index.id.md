...
title: Konversi POTX ke ODP melalui C#
weight: 40
url: /id/net/conversion/potx-to-odp/ 
description: Contoh kode untuk konversi POTX ke ODP C#. Gunakan kode contoh API untuk file batch POTX ke konversi ODP dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi POTX ke ODP melalui C#" h2="Ekspor file PowerPoint® POTX ke ODP di .NET Framework, .NET Core, Windows Azure, Mono atau Platform Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi POTX ke ODP Menggunakan C#" %}}

 Untuk mengonversi POTX ke ODP, kami akan menggunakan
...
{{< blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengkonversi POTX ke ODP melalui C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Pengembang .NET dapat dengan mudah memuat & mengonversi file POTX ke ODP hanya dalam beberapa baris kode." >}}
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan POTX ke ODP C# Konversi" offSpacer="" %}}
