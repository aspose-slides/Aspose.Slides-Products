...
weight: 100
url: /id/net/conversion/pdf-to-svg/ 
keywords: PDF ke SVG, Konversi PDF ke SVG, C# API, .NET Library, PDF, SVG
description: Konversi PDF ke SVG di C#. Gunakan .NET library API untuk mengonversi halaman PDF ke gambar SVG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi PDF ke SVG di C#" h2="PowerPoint .NET API untuk mengonversi dokumen PDF ke gambar SVG di NET Framework, .NET Core, Windows Azure, Mono atau Platform Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi PDF ke SVG di C#" %}}

Bagaimana cara mengonversi PDF ke SVG dalam kode?

Menggunakan [**Aspose.Slides for .NET**](https://products.aspose.com/slides/id/net/), pengembang atau aplikasi apa pun dapat mengonversi PDF ke format SVG hanya dengan beberapa baris kode C#.

Sebagai API pemrosesan dokumen modern, Aspose.Slides untuk .NET mengekspor halaman PDF ke SVG dengan cepat. Perpustakaan Aspose PowerPoint memungkinkan Anda mengonversi PDF ke SVG dan banyak format file lainnya
...
{{< blocks/products/pf/agp/feature-section-col title="Cara Mengonversi PDF ke SVG di C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Pengembang dan aplikasi dapat mengonversi PDF ke SVG dengan cara ini:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Simpan slide sebagai gambar SVG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Sebelum Anda menjalankan kode C# konversi PDF ke SVG, mesin Anda harus memiliki prasyarat berikut:
...
{{% blocks/products/pf/agp/code-block title="Kode C# untuk mengonversi PDF ke SVG" offSpacer="" %}}
