...
url: /id/net/conversion/image-to-pptx/
keywords: Konversi gambar ke PPTX, gambar ke PPTX, PowerPoint, gambar, PPTX, C# API, .NET Library
description: Konversi gambar ke PPTX dalam C#. Gunakan .NET library API untuk mengonversi gambar ke PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konversi gambar ke PPTX di C#" h2=".NET API lintas platform yang kuat untuk mengonversi gambar ke PPTX menggunakan kode C# pada Platform NET Framework, .NET Core, Windows Azure, Mono atau Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Konversikan gambar ke PPTX menggunakan Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/id/net/) adalah pustaka .NET andal yang digunakan untuk membuat, mengonversi, dan memanipulasi presentasi PowerPoint, PDF, dokumen HTML, dan file lainnya. Saat Anda mengonversi gambar ke PPTX, pada dasarnya Anda membuat presentasi PowerPoint yang berisi slide berdasarkan gambar tersebut.
...
{{% blocks/products/pf/agp/code-block title="Kode C# untuk mengonversi gambar ke PPTX" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Cara mengonversi gambar ke PPTX di C#" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/id/net/conversion/image-to-ppt/" name="IMAGE TO PPT" >}}
