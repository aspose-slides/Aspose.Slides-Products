...
title: Konversi SVG ke PNG di C#
weight: 250
url: /id/net/conversion/svg-to-png/ 
keywords: SVG ke PNG, Konversi SVG ke PNG, C# API, .NET Library
description: Konversi SVG ke PNG di C#. Gunakan .NET library API untuk mengonversi file SVG ke PNG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi SVG ke PNG di C#" h2="PowerPoint .NET API untuk mengonversi file gambar SVG ke PNG di NET Framework, .NET Core, Windows Azure, Mono atau Platform Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Konversi SVG ke PNG di C#" %}}

Bagaimana cara mengonversi SVG ke PNG dalam kode?

Menggunakan [**Aspose.Slides for .NET**](https://products.aspose.com/slides/id/net/), pengembang atau aplikasi apa pun dapat mengonversi SVG ke PNG hanya dengan beberapa baris kode C#.

Sebagai API pemrosesan dokumen modern, Aspose.Slides untuk .NET mengekspor file SVG ke PNG dengan cepat. Pustaka Aspose PowerPoint memungkinkan Anda mengonversi SVG ke PNG dan gambar dalam format lain.
...
{{< blocks/products/pf/agp/feature-section-col title="Cara Mengonversi SVG ke PNG di C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Pengembang dan aplikasi dapat mengonversi SVG ke PNG dengan cara ini:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Simpan file sebagai gambar PNG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Sebelum Anda menjalankan kode C# konversi SVG ke PNG, mesin Anda harus memiliki prasyarat berikut:
...
{{% blocks/products/pf/agp/code-block title="Kode C# untuk mengonversi SVG ke PNG" offSpacer="" %}}
