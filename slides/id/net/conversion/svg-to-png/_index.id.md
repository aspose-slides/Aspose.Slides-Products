...
Sebagai API pemrosesan dokumen modern, Aspose.Slides untuk .NET mengekspor file SVG ke PNG dengan cepat. Pustaka Apose PowerPoint memungkinkan Anda mengonversi SVG ke PNG dan gambar dalam format lain.
