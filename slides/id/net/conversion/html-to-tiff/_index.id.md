...
Sebagai API pemrosesan dokumen modern, Aspose.Slides untuk .NET mengekspor file HTML ke TIFF dengan cepat. Perpustakaan Apose PowerPoint memungkinkan Anda untuk mengonversi HTML ke TIFF dan banyak format file lainnya
