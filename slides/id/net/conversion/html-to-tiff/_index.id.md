---
title: Konversi HTML ke TIFF di C#
weight: 180
url: /id/net/conversion/html-to-tiff/ 
keywords: HTML ke TIFF, Konversi HTML ke TIFF, C# API, .NET Library, HTML, TIFF
description: Konversi HTML ke TIFF di C#. Gunakan .NET library API untuk mengonversi file HTML ke gambar TIFF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi HTML ke TIFF di C#" h2="PowerPoint .NET API untuk mengonversi file HTML ke gambar TIFF di NET Framework, .NET Core, Windows Azure, Mono atau Platform Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi HTML ke TIFF di C#" %}}

Bagaimana cara mengonversi HTML ke TIFF dalam kode?

Menggunakan [**Aspose.Slides for .NET**](https://products.aspose.com/slides/id/net/), pengembang atau aplikasi apa pun dapat mengonversi HTML ke format TIFF hanya dengan beberapa baris kode C#.

Sebagai API pemrosesan dokumen modern, Aspose.Slides untuk .NET mengekspor file HTML ke TIFF dengan cepat. Perpustakaan Aspose PowerPoint memungkinkan Anda untuk mengonversi HTML ke TIFF dan banyak format file lainnya
...
{{< blocks/products/pf/agp/feature-section-col title="Cara Mengonversi HTML ke TIFF di C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Pengembang dan aplikasi dapat mengonversi HTML ke TIFF dengan cara ini:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Sebelum Anda menjalankan kode C# konversi HTML ke TIFF, mesin Anda harus memiliki prasyarat berikut:
...
{{% blocks/products/pf/agp/code-block title="Kode C# untuk mengonversi HTML ke TIFF" offSpacer="" %}}
