---
title: Konversi PDF ke HTML di C#
weight: 120
url: /id/net/conversion/pdf-to-html/ 
keywords: PDF ke HTML, Konversi PDF ke HTML, C# API, .NET Library, PDF, HTML
description: Konversi PDF ke HTML di C#. Gunakan .NET library API untuk mengonversi halaman PDF ke file HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi PDF ke HTML di C#" h2="PowerPoint .NET API untuk mengonversi dokumen PDF ke file HTML di NET Framework, .NET Core, Windows Azure, Mono atau Platform Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi PDF ke HTML di C#" %}}

Bagaimana cara mengonversi PDF ke HTML dalam kode?

Menggunakan [**Aspose.Slides for .NET**](https://products.aspose.com/slides/id/net/), pengembang atau aplikasi apa pun dapat mengonversi file PDF ke HTML hanya dengan beberapa baris kode C#.

Sebagai API pemrosesan dokumen modern, Aspose.Slides untuk .NET mengekspor halaman PDF ke HTML dengan cepat. Pustaka Aspose PowerPoint memungkinkan Anda mengonversi PDF ke HTML dan banyak format file lainnya.
...
{{< blocks/products/pf/agp/feature-section-col title="Cara Mengonversi PDF ke HTML di C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Pengembang dan aplikasi dapat mengonversi PDF ke HTML dengan cara ini:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Panggil metode simpan untuk menyimpan slide ke HTML.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Sebelum Anda menjalankan kode C# konversi PDF ke HTML, mesin Anda harus memiliki prasyarat berikut:
...
{{% blocks/products/pf/agp/code-block title="Kode C# untuk mengonversi PDF ke HTML" offSpacer="" %}}
