---
title: Konversi HTML ke XML di C#
weight: 170
url: /id/net/conversion/html-to-xml/ 
keywords: HTML ke XML, Konversi HTML ke XML, C# API, .NET Library, HTML, XML
description: Konversi HTML ke XML di C#. Gunakan .NET library API untuk mengonversi dokumen HTML ke file XML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi HTML ke XML di C#" h2="PowerPoint .NET API untuk mengonversi dokumen HTML ke file XML di NET Framework, .NET Core, Windows Azure, Mono, atau Platform Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi HTML ke XML di C#" %}}

Bagaimana cara mengonversi HTML ke XML dalam kode?

Menggunakan [**Aspose.Slides for .NET**](https://products.aspose.com/slides/id/net/), pengembang atau aplikasi apa pun dapat mengonversi file HTML ke XML hanya dengan beberapa baris kode C#.

Sebagai API pemrosesan dokumen modern, Aspose.Slides untuk .NET mengekspor konten dalam HTML ke XML dengan cepat. Pustaka Aspose PowerPoint memungkinkan Anda untuk mengonversi HTML ke XML dan banyak format file lainnya.
...
{{< blocks/products/pf/agp/feature-section-col title="Cara Mengonversi HTML ke XML di C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Pengembang dan aplikasi dapat mengonversi HTML ke XML dengan cara ini:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Tambahkan slide berdasarkan konten file HTML.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Sebelum Anda menjalankan kode C# konversi HTML ke XML, mesin Anda harus memiliki prasyarat berikut:
...
{{% blocks/products/pf/agp/code-block title="Kode C# untuk mengonversi HTML ke XML" offSpacer="" %}}
