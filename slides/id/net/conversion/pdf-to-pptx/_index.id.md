---
title: Konversi PDF ke PPTX dalam C#
url: /id/net/conversion/pdf-to-pptx/
keywords: Konversi PDF ke PPTX, PDF ke PPTX, PowerPoint, PDF, PPTX, C# API, Perpustakaan .NET
description: Konversi PDF ke PPTX dalam C#. Gunakan .NET library API untuk mengonversi PDF ke PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konversi PDF ke PPTX dalam C#" h2=".NET API lintas platform yang kuat untuk mengonversi PDF ke PPTX menggunakan kode C# pada Platform NET Framework, .NET Core, Windows Azure, Mono atau Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Konversi PDF ke PPTX menggunakan Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/id/net/) adalah pustaka .NET andal yang digunakan untuk membuat, mengonversi, dan memanipulasi presentasi PowerPoint, PDF, dokumen HTML, dan file lainnya. Saat Anda mengonversi PDF ke PPTX, pada dasarnya Anda memindahkan konten pada halaman PDF ke slide dalam presentasi PowerPoint.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Konversi PDF ke PPTX dalam C#" %}}
Menggunakan [**Aspose.Slides untuk .NET**](https://products.aspose.com/slides/id/net/), Anda dapat mengonversi presentasi PDF ke PowerPoint hanya dengan beberapa baris kode:

{{% blocks/products/pf/agp/code-block title="Kode C# untuk mengonversi PDF ke PPTX" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Cara mengonversi PDF ke PPTX di C#" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Muat file PDF yang ingin Anda konversi ke PPTX.
{{< /blocks/products/pf/agp/step-autogen >}}
