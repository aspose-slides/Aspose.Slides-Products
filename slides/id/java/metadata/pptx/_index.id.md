---
title: Lihat atau Edit Metadata File PPTX menggunakan Java
url: /id/java/metadata/pptx/
keywords: Edit Metadata PPTX, Lihat Metadata PPTX, Edit properti PPTX, Lihat properti PPTX
description: kode sumber Java untuk mengedit atau melihat metadata format PPTX.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Edit properti PPTX menggunakan Java" h2="Bangun aplikasi Java Anda sendiri untuk mengubah properti Bawaan dan Kustom dalam file presentasi menggunakan API sisi server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" fileiconsmall4="POT" fileiconsmall5="ppsx" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for Java" >}}

{{% blocks/products/pf/feature-page-section  h2="Ubah Properti PPTX melalui Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Modifikasi PPTX Properti Bawaan - Java" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Tambahkan Properti Kustom ke PPTX - Java" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara Mengekstrak Metadata PPTX melalui Java" >}}
