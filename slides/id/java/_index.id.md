...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Fitur API Pemrosesan Dokumen Java PowerPoint Tingkat Lanjut</h2>

<p>Aspose.Slides for Java menggabungkan sejumlah fitur canggih yang memberi pengembang kendali penuh saat memprogram dengan presentasi Microsoft PowerPoint di lingkungan Java.</p>-->
   <h2 class="pr-ft">
...
<h2 class="h2title">Pemformatan Konten Slide</h2>

<p>Dimungkinkan untuk memformat teks dan bentuk pada slide dalam presentasi menggunakan Aspose.Slides for Java API. Teks dikelola melalui bingkai teks yang terkait dengan bentuk. Oleh karena itu teks diformat menggunakan paragraf dan bagian yang terkait dengan bingkai teks. Anda juga dapat memanipulasi atribut elemen bentuk seperti posisi, ukuran, garis, gambar, teks, dan isian.</p>
...
{{< blocks/products/pf/slr-element name="Catatan Rilis" href="https://releases.aspose.com/slides/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
