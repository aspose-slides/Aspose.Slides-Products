...
title: Konversi OTP ke ODP melalui Java
weight: 5880
url: /id/java/conversion/otp-to-odp/ 
description: Contoh kode konversi Java untuk format OTP ke file ODP. Gunakan kode contoh ini untuk mengekspor presentasi PowerPoint & OpenOffice ke ODP dalam Aplikasi berbasis Java Web atau Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi OTP ke ODP melalui Java" h2="Konversi Java OTP ke ODP untuk mengonversi satu atau beberapa halaman ke ODP menggunakan pustaka Java di tempat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTP" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi OTP ke ODP Menggunakan Java" %}}

 Untuk merender OTP ke ODP, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengkonversi OTP ke ODP melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Pengembang Java dapat dengan mudah mengonversi file OTP ke ODP hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/code-block title="Kode Sumber Konversi Java OTP ke ODP" offSpacer="" %}}
