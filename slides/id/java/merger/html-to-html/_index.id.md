...
description: Menggabungkan HTML ke HTML di Java. Gunakan Java library API untuk menggabungkan file HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Gabungkan HTML di Jawa" h2="Pustaka Java berkecepatan tinggi dan lintas platform untuk menggabungkan file HTML menggunakan kode Java" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Menggabungkan HTML ke HTML di Java" %}}
Menggunakan [**Aspose.Slides for Java**](https://products.aspose.com/slides/id/java/), Anda dapat menggabungkan file HTML dengan cepat hanya dengan beberapa baris kode

{{% blocks/products/pf/agp/code-block title="Kode Java untuk menggabungkan HTML ke HTML" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan HTML di Java" >}}
