---
title: Menggabungkan Gambar JPG di Jawa
url: /id/java/merger/jpg-to-jpg/
keywords: Gabungkan JPG, JPEG ke JPG, Gabung JPG, Gabungkan JPG, API Java, Perpustakaan Java
description: Menggabungkan JPG ke JPG di Jawa. Gunakan Java library API untuk menggabungkan file JPG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Menggabungkan JPG di Jawa" h2="Pustaka Java berkecepatan tinggi dan lintas platform untuk menggabungkan gambar JPG menggunakan kode Java" >}}

{{% blocks/products/pf/feature-page-section h2="Menggabungkan JPG ke JPG menggunakan Aspose.Slides" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/id/java/) adalah library Java andal yang digunakan untuk menggabungkan dan memanipulasi presentasi, gambar, dan file lainnya. Saat Anda menggabungkan JPG ke JPG, Anda menggabungkan dua gambar secara efektif untuk mendapatkan satu gambar.
...
{{% blocks/products/pf/feature-page-section  h2="Menggabungkan JPG ke JPG di Jawa" %}}
Menggunakan [**Aspose.Slides for Java**](https://products.aspose.com/slides/id/java/), Anda dapat menggabungkan file JPG dengan cepat hanya dengan beberapa baris kode

{{% blocks/products/pf/agp/code-block title="Kode Java untuk menggabungkan JPG ke JPG" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Cara menggabungkan JPG di Jawa" >}}
