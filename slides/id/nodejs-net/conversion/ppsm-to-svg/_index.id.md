---
title: Konversikan PPSM ke SVG dalam JavaScript
url: /id/nodejs-net/conversion/ppsm-to-svg/
keywords: PPSM ke SVG, Konversi PPSM ke SVG, API Node.js, Pustaka JavaScript, PPSM, SVG
description: Konversikan PPSM ke SVG dalam JavaScript. Gunakan API perpustakaan Node.js untuk mengonversi file PPSM ke SVG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konversikan PPSM ke SVG dalam JavaScript" h2="Aspose.Slides untuk Node.js melalui .NET adalah pustaka yang kuat dan mudah digunakan yang memungkinkan Anda mengonversi presentasi PowerPoint ke berbagai format dalam JavaScript. Ini mendukung semua elemen dan format presentasi dan menyediakan API yang kaya untuk mengakses dan memodifikasinya. Ini juga memungkinkan Anda mengekspor slide Anda ke berbagai format untuk diproses atau dibagikan lebih lanjut." >}}
...
Sebagai API pemrosesan dokumen modern, Aspose.Slides untuk Node.js melalui .NET mengekspor file PPSM ke format file SVG dengan cepat. Pustaka Aspose PowerPoint memungkinkan Anda mengonversi PPSM ke SVG dan banyak format file lainnya

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Konversikan PPSM ke SVG menggunakan JavaScript" %}}
Untuk mengonversi PPSM ke SVG, Anda perlu membuat Presentasi dari file PPSM dan menyimpannya sebagai SVG.

{{% blocks/products/pf/agp/code-block title="Kode JavaScript untuk mengubah PPSM menjadi SVG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara mengonversi PPSM ke SVG menggunakan Aspose.Slides untuk Node.js melalui .NET API" >}}
