---
title: Konversikan PPSX ke PPS dalam JavaScript
url: /id/nodejs-net/conversion/ppsx-to-pps/
keywords: PPSX ke PPS, Konversi PPSX ke PPS, API Node.js, Pustaka JavaScript, PPSX, PPS
description: Konversikan PPSX ke PPS dalam JavaScript. Gunakan API perpustakaan Node.js untuk mengonversi file PPSX ke PPS
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konversikan PPSX ke PPS dalam JavaScript" h2="Aspose.Slides untuk Node.js melalui .NET adalah pustaka yang kuat dan mudah digunakan yang memungkinkan Anda mengonversi presentasi PowerPoint ke berbagai format dalam JavaScript. Ini mendukung semua elemen dan format presentasi dan menyediakan API yang kaya untuk mengakses dan memodifikasinya. Ini juga memungkinkan Anda mengekspor slide Anda ke berbagai format untuk diproses atau dibagikan lebih lanjut." >}}

{{% blocks/products/pf/feature-page-section h2="Konversikan PPSX ke PPS di Node.js" %}}

[**Aspose.Slides untuk Node.js melalui .NET**](https://products.aspose.com/slides/id/nodejs-net/) adalah pustaka Node.js yang canggih untuk membuat dan memanipulasi file presentasi. Selain itu, ini menyediakan cara yang fleksibel untuk mengonversi PPSX ke PPS. Menggunakan **Aspose.Slides untuk Node.js melalui .NET**, pengembang atau aplikasi mana pun dapat mengonversi file PPSX ke PPS hanya dengan beberapa baris kode.

Sebagai API pemrosesan dokumen modern, Aspose.Slides untuk Node.js melalui .NET mengekspor file PPSX ke format file PPS dengan cepat. Pustaka Aspose PowerPoint memungkinkan Anda mengonversi PPSX ke PPS dan banyak format file lainnya

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Konversikan PPSX ke PPS menggunakan JavaScript" %}}
Untuk mengonversi PPSX ke PPS, Anda perlu membuat Presentasi dari file PPSX dan menyimpannya sebagai PPS.

{{% blocks/products/pf/agp/code-block title="Kode JavaScript untuk mengubah PPSX menjadi PPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara mengonversi PPSX ke PPS menggunakan Aspose.Slides untuk Node.js melalui .NET API" >}}
