---
title: Konversikan POT ke OTP dalam JavaScript
url: /id/nodejs-net/conversion/pot-to-otp/
keywords: POT ke OTP, Konversi POT ke OTP, API Node.js, Pustaka JavaScript, POT, OTP
description: Konversikan POT ke OTP dalam JavaScript. Gunakan API perpustakaan Node.js untuk mengonversi file POT ke OTP
---
...
{{% blocks/products/pf/feature-page-section h2="Konversikan POT ke OTP di Node.js" %}}

[**Aspose.Slides untuk Node.js melalui .NET**](https://products.aspose.com/slides/id/nodejs-net/) adalah pustaka Node.js yang canggih untuk membuat dan memanipulasi file presentasi. Selain itu, ini menyediakan cara yang fleksibel untuk mengonversi POT ke OTP. Menggunakan **Aspose.Slides untuk Node.js melalui .NET**, pengembang atau aplikasi mana pun dapat mengonversi file POT ke OTP hanya dengan beberapa baris kode.

Sebagai API pemrosesan dokumen modern, Aspose.Slides untuk Node.js melalui .NET mengekspor file POT ke format file OTP dengan cepat. Pustaka Aspose PowerPoint memungkinkan Anda mengonversi POT ke OTP dan banyak format file lainnya

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Konversikan POT ke OTP menggunakan JavaScript" %}}
Untuk mengonversi POT ke OTP, Anda perlu membuat Presentasi dari file POT dan menyimpannya sebagai OTP.

{{% blocks/products/pf/agp/code-block title="Kode JavaScript untuk mengubah POT menjadi OTP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara mengonversi POT ke OTP menggunakan Aspose.Slides untuk Node.js melalui .NET API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Untuk mengonversi POT ke OTP menggunakan Aspose.Slides untuk Node.js melalui .NET, Anda perlu mengimpor paket dalam file JavaScript Anda dan membuat instance kelas Presentation. Kelas Presentation mewakili dokumen PowerPoint dan menyediakan metode untuk mengakses dan memanipulasi elemen-elemennya." >}}
