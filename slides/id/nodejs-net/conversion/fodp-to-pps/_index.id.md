---
title: Konversikan FODP ke PPS dalam JavaScript
url: /id/nodejs-net/conversion/fodp-to-pps/
keywords: FODP ke PPS, Konversi FODP ke PPS, API Node.js, Pustaka JavaScript, FODP, PPS
description: Konversikan FODP ke PPS dalam JavaScript. Gunakan API perpustakaan Node.js untuk mengonversi file FODP ke PPS
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konversikan FODP ke PPS dalam JavaScript" h2="Aspose.Slides untuk Node.js melalui .NET adalah pustaka yang kuat dan mudah digunakan yang memungkinkan Anda mengonversi presentasi PowerPoint ke berbagai format dalam JavaScript. Ini mendukung semua elemen dan format presentasi dan menyediakan API yang kaya untuk mengakses dan memodifikasinya. Ini juga memungkinkan Anda mengekspor slide Anda ke berbagai format untuk diproses atau dibagikan lebih lanjut." >}}

{{% blocks/products/pf/feature-page-section h2="Konversikan FODP ke PPS di Node.js" %}}

[**Aspose.Slides untuk Node.js melalui .NET**](https://products.aspose.com/slides/id/nodejs-net/) adalah pustaka Node.js yang canggih untuk membuat dan memanipulasi file presentasi. Selain itu, ini menyediakan cara yang fleksibel untuk mengonversi FODP ke PPS. Menggunakan **Aspose.Slides untuk Node.js melalui .NET**, pengembang atau aplikasi mana pun dapat mengonversi file FODP ke PPS hanya dengan beberapa baris kode.

Sebagai API pemrosesan dokumen modern, Aspose.Slides untuk Node.js melalui .NET mengekspor file FODP ke format file PPS dengan cepat. Pustaka Aspose PowerPoint memungkinkan Anda mengonversi FODP ke PPS dan banyak format file lainnya

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Konversikan FODP ke PPS menggunakan JavaScript" %}}
Untuk mengonversi FODP ke PPS, Anda perlu membuat Presentasi dari file FODP dan menyimpannya sebagai PPS.

{{% blocks/products/pf/agp/code-block title="Kode JavaScript untuk mengubah FODP menjadi PPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cara mengonversi FODP ke PPS menggunakan Aspose.Slides untuk Node.js melalui .NET API" >}}
