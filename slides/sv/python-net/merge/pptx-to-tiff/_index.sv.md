---
title: Slå samman PPTX-filer till TIFF med Python
url: /sv/python-net/merge/pptx-to-tiff/
keywords: Slå samman PPTX till TIFF, gå med PPTX till TIFF, kombinera PPTX till TIFF, PowerPoint, Presentation, TIFF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Slå samman PPTX-filer till TIFF med Python" %}}
För att slå samman PowerPoint-presentationer måste du klona bilderna från en presentation till den andra.

{{% blocks/products/pf/agp/code-block title="Python-kod för att slå samman flera PPTX till en enda TIFF-fil" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man slår samman PPTX till TIFF med Aspose.Slides för Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Det här är stegen för att slå samman två PPTX-filer och spara resultatet som TIFF i Python." >}}
