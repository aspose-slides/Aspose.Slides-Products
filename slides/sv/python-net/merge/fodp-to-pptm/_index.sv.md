---
title: Slå samman FODP-filer till PPTM med Python
url: /sv/python-net/merge/fodp-to-pptm/
keywords: Slå samman FODP till PPTM, gå med FODP till PPTM, kombinera FODP till PPTM, PowerPoint, Presentation, PPTM, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Slå samman FODP-filer till PPTM i Python" h2="Höghastighets- och plattformsoberoende Python API som hjälper till att utveckla applikationer med möjligheten att skapa, slå samman, inspektera eller konvertera Microsoft PowerPoint- och OpenOffice-presentationsfiler utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Slå samman FODP till PPTM i Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Slå samman FODP-filer till PPTM med Python" %}}
För att slå samman PowerPoint-presentationer måste du klona bilderna från en presentation till den andra.

{{% blocks/products/pf/agp/code-block title="Python-kod för att slå samman flera FODP till en enda PPTM-fil" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man slår samman FODP till PPTM med Aspose.Slides för Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Det här är stegen för att slå samman två FODP-filer och spara resultatet som PPTM i Python." >}}
