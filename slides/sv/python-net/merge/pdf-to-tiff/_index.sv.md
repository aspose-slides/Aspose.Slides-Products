---
title: Slå samman PDF-filer till TIFF med Python
url: /sv/python-net/merge/pdf-to-tiff/
keywords: Slå samman PDF till TIFF, gå med PDF till TIFF, kombinera PDF till TIFF, PowerPoint, Presentation, TIFF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Slå samman PDF-filer till TIFF med Python" %}}
För att slå samman PowerPoint-presentationer måste du klona bilderna från en presentation till den andra.

{{% blocks/products/pf/agp/code-block title="Python-kod för att slå samman flera PDF till en enda TIFF-fil" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man slår samman PDF till TIFF med Aspose.Slides för Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Det här är stegen för att slå samman två PDF-filer och spara resultatet som TIFF i Python." >}}
