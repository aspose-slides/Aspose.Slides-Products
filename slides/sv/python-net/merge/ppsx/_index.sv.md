---
title: Slå samman PPSX-filer med Python
url: /sv/python-net/merge/ppsx/
keywords: Slå samman PPSX, gå med i PPSX, kombinera PPSX, PowerPoint, Presentation, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Slå samman PPSX-filer i Python" h2="Höghastighets- och plattformsoberoende Python API som hjälper till att utveckla applikationer med möjligheten att skapa, slå samman, inspektera eller konvertera Microsoft PowerPoint- och OpenOffice-presentationsfiler utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Slå samman PPSX i Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Slå samman PPSX-filer med Python" %}}
För att slå samman PowerPoint-presentationer måste du klona bilderna från en presentation till den andra.

{{% blocks/products/pf/agp/code-block title="Python-kod för att slå samman flera PPSX till en enda fil" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man slår samman PPSX med Aspose.Slides för Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Det här är stegen för att slå samman två PPSX-filer och spara resultatet som PPSX i Python." >}}
