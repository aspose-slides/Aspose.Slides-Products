...
{{< blocks/products/pf/feature-page-header h1="Slå samman POTM-filer till XPS i Python" h2="Höghastighets- och plattformsoberoende Python API som hjälper till att utveckla applikationer med möjligheten att skapa, slå samman, inspektera eller konvertera Microsoft PowerPoint- och OpenOffice-presentationsfiler utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Slå samman POTM till XPS i Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Slå samman POTM-filer till XPS med Python" %}}
För att slå samman PowerPoint-presentationer måste du klona bilderna från en presentation till den andra.

{{% blocks/products/pf/agp/code-block title="Python-kod för att slå samman flera POTM till en enda XPS-fil" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man slår samman POTM till XPS med Aspose.Slides för Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Det här är stegen för att slå samman två POTM-filer och spara resultatet som XPS i Python." >}}
