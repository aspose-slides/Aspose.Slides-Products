---
title: Slå samman POTM-filer till PPSX med Python
url: /sv/python-net/merge/potm-to-ppsx/
keywords: Slå samman POTM till PPSX, gå med POTM till PPSX, kombinera POTM till PPSX, PowerPoint, Presentation, PPSX, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Slå samman POTM-filer till PPSX i Python" h2="Höghastighets- och plattformsoberoende Python API som hjälper till att utveckla applikationer med möjligheten att skapa, slå samman, inspektera eller konvertera Microsoft PowerPoint- och OpenOffice-presentationsfiler utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Slå samman POTM till PPSX i Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Slå samman POTM-filer till PPSX med Python" %}}
För att slå samman PowerPoint-presentationer måste du klona bilderna från en presentation till den andra.

{{% blocks/products/pf/agp/code-block title="Python-kod för att slå samman flera POTM till en enda PPSX-fil" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man slår samman POTM till PPSX med Aspose.Slides för Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Det här är stegen för att slå samman två POTM-filer och spara resultatet som PPSX i Python." >}}
