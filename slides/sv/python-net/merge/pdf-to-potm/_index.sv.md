---
title: Slå samman PDF-filer till POTM med Python
url: /sv/python-net/merge/pdf-to-potm/
keywords: Slå samman PDF till POTM, gå med PDF till POTM, kombinera PDF till POTM, PowerPoint, Presentation, POTM, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Slå samman PDF-filer till POTM i Python" h2="Höghastighets- och plattformsoberoende Python API som hjälper till att utveckla applikationer med möjligheten att skapa, slå samman, inspektera eller konvertera Microsoft PowerPoint- och OpenOffice-presentationsfiler utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Slå samman PDF till POTM i Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Slå samman PDF-filer till POTM med Python" %}}
För att slå samman PowerPoint-presentationer måste du klona bilderna från en presentation till den andra.

{{% blocks/products/pf/agp/code-block title="Python-kod för att slå samman flera PDF till en enda POTM-fil" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man slår samman PDF till POTM med Aspose.Slides för Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Det här är stegen för att slå samman två PDF-filer och spara resultatet som POTM i Python." >}}
