---
title: Slå samman bild till BMP i Python
url: /sv/python-net/merge/image-to-bmp/
keywords: Bild till BMP, Sammanfoga bild till BMP, Sammanfoga bild till BMP, Kombinera bilder, Bild, BMP, Python API, Python Library
description: Slå samman bild till BMP i Python. Använd Python library API för att kombinera bilder
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Slå samman bild till BMP i Python" h2="Höghastighets- och plattformsoberoende Python-bibliotek för sammanslagning av bild till BMP-filer med Python-kod" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Slå samman bild till BMP i Python" %}}
Genom att använda [**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/sv/python-net/) kan du snabbt slå ihop bilden till BMP med bara några rader kod

{{% blocks/products/pf/agp/code-block title="Python-kod för att slå samman bild till BMP" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="Hur man slår ihop bild till BMP i Python" >}}
