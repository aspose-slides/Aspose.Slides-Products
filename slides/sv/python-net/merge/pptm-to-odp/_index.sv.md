---
title: Slå samman PPTM-filer till ODP med Python
url: /sv/python-net/merge/pptm-to-odp/
keywords: Slå samman PPTM till ODP, gå med PPTM till ODP, kombinera PPTM till ODP, PowerPoint, Presentation, ODP, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Slå samman PPTM-filer till ODP i Python" h2="Höghastighets- och plattformsoberoende Python API som hjälper till att utveckla applikationer med möjligheten att skapa, slå samman, inspektera eller konvertera Microsoft PowerPoint- och OpenOffice-presentationsfiler utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Slå samman PPTM till ODP i Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Slå samman PPTM-filer till ODP med Python" %}}
För att slå samman PowerPoint-presentationer måste du klona bilderna från en presentation till den andra.

{{% blocks/products/pf/agp/code-block title="Python-kod för att slå samman flera PPTM till en enda ODP-fil" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man slår samman PPTM till ODP med Aspose.Slides för Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Det här är stegen för att slå samman två PPTM-filer och spara resultatet som ODP i Python." >}}
