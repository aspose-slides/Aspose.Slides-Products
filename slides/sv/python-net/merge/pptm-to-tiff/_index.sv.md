---
title: Slå samman PPTM-filer till TIFF med Python
url: /sv/python-net/merge/pptm-to-tiff/
keywords: Slå samman PPTM till TIFF, gå med PPTM till TIFF, kombinera PPTM till TIFF, PowerPoint, Presentation, TIFF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Slå samman PPTM-filer till TIFF med Python" %}}
För att slå samman PowerPoint-presentationer måste du klona bilderna från en presentation till den andra.

{{% blocks/products/pf/agp/code-block title="Python-kod för att slå samman flera PPTM till en enda TIFF-fil" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man slår samman PPTM till TIFF med Aspose.Slides för Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Det här är stegen för att slå samman två PPTM-filer och spara resultatet som TIFF i Python." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/sv/python-net/merge/pptm-to-svg/" name="PPTM TO SVG" >}}  
