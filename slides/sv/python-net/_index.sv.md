---
title: Python PowerPoint API. Python PPTX, PPT från Aspose.Slides
weight: 5860
url: /sv/python-net/ 
description: Python-bibliotek för att arbeta med Microsoft PowerPoint-filer. Python PPTX, PPT. Skapa redigera konvertera PPT PPTX PPS POT PPSX PPTM PPSM POTX POTM ODP PDF och många fler format.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python PowerPoint API för presentationer. Python PPTX, PPT" h2="Skapa, läs, skriv, modifiera, slå samman, klona, ​​skydda och konvertera PowerPoint- och OpenOffice-presentationer i Python utan någon extern programvara." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-python.svg" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="https://downloads.aspose.com/slides/python-net" >}}
...
<p>Python är ett mycket populärt språk som ser mycket användning i vanliga applikationer, webbutveckling, forskning och akademiska uppgifter, dataanalys, etc. Av denna anledning är <strong>Aspose.Slides</strong>-teamet stolta över att kunna erbjuda < strong>Aspose.Slides för Python via .NET</strong> till python-gemenskapen. </p>
...
{{< blocks/products/pf/carousel-item h3="Plattformsoberoende" description="Python Presentation API stöder alla större plattformar inklusive följande." >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="Filformat som stöds" description="Aspose.Slides för Python via .NET stöder populära [presentationsformat](https://docs.aspose.com/slides/python-net/supported-file-formats/) och dessa exportformat." >}}
  ...
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <ul>
	  ...
	  <li>Om du skriver Python-kod på Linux, ta en titt på <a href="https://docs.aspose.com/slides/python-net/system-requirements/">ytterligare krav för Linux</a></li>
    </ul>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>Använd <strong>pip</strong> för att installera vårt Python-bibliotek för presentationsbearbetning från <a href="https://pypi.org/project/aspose.slides/">PyPI-arkivet</a></p>:
	<pre><code>pip install aspose.slides</code></pre>
   </div>
    <div class="col-lg-12">
        <h2 class="h2title">Skapa ny PowerPoint-presentation. Python PPTX, PPT eller ODP</h2>
...
with slides.Presentation() as presentation:
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Slå samman presentationer: Python PPTX, PPT eller ODP</h2>
...
with slides.Presentation("Presentation1.pptx") as pres1:
    ...
    <div class="col-lg-12">
        <h2 class="h2title"> Importera presentation från PDF: Python PPTX, PPT eller ODP</h2>
...
with slides.Presentation() as pres:
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Konvertera PowerPoint till PDF med standardalternativ: Python PPTX, PPT eller ODP till PDF</h2>
        <p>Den här pythonkoden visar hur du konverterar ett PowerPoint PPT-, PPTX- och OpenOffice ODP-dokument till ett PDF-dokument med standardalternativen. Den resulterande filen är ett PDF-dokument med högsta kvalitetsnivåer</p>
        <pre>
            <code class="python">
import aspose.slides as slides
...
presentation.save("PPT-to-PDF.pdf", slides.export.SaveFormat.PDF)
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Konvertera PowerPoint till JPG: Python PPTX, PPT eller ODP till JPEG</h2>
...
{{< blocks/products/pf/slr-element name="Dokumentation" href="https://docs.aspose.com/slides/python-net/" >}}
{{< blocks/products/pf/slr-element name="Källkod" href="https://github.com/aspose-slides/" >}}
{{< blocks/products/pf/slr-element name="API-referenser" href="https://docs.aspose.com/slides/python-net/api-reference/" >}}
...
{{< blocks/products/pf/slr-element name="Release Notes" href="https://docs.aspose.com/slides/python-net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Varför Aspose.Slides för Python via .NET?" tabId="success-stories" >}}
