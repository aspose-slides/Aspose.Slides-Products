...
Behöver du konvertera OTP-filer till BMP programmatiskt? Genom att använda [*Aspose.Slides för Python via .NET*](https://products.aspose.com/slides/sv/python-net/) kan vilken utvecklare som helst konvertera OTP till BMP-format med bara några rader Python-kod.
