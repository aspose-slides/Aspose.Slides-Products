---
title: Konvertera PPTM till TIFF i JavaScript
url: /sv/nodejs-net/conversion/pptm-to-tiff/
keywords: PPTM till TIFF, Konvertera PPTM till TIFF, Node.js API, JavaScript Library, PPTM, TIFF
description: Konvertera PPTM till TIFF i JavaScript. Använd Node.js biblioteks-API för att konvertera PPTM-filer till TIFF
---
...
{{% blocks/products/pf/feature-page-section h2="Konvertera PPTM till TIFF i Node.js" %}}

[**Aspose.Slides för Node.js via .NET**](https://products.aspose.com/slides/sv/nodejs-net/) är ett kraftfullt Node.js-bibliotek för att skapa och manipulera presentationsfiler. Dessutom ger det flexibla sätt att konvertera PPTM till TIFF. Genom att använda **Aspose.Slides för Node.js via .NET** kan alla utvecklare eller appar konvertera PPTM till TIFF-filer med bara några rader kod.

Som ett modernt dokumentbearbetnings-API exporterar Aspose.Slides för Node.js via .NET snabbt PPTM-filer till TIFF-filformat. Aspose PowerPoint-bibliotek låter dig konvertera PPTM till TIFF och många andra filformat

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Konvertera PPTM till TIFF med JavaScript" %}}
För att konvertera PPTM till TIFF måste du skapa en presentation från filen PPTM och spara den som TIFF.

{{% blocks/products/pf/agp/code-block title="JavaScript-kod för att konvertera PPTM till TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man konverterar PPTM till TIFF med Aspose.Slides för Node.js via .NET API" >}}
