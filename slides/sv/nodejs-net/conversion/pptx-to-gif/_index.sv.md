---
title: Konvertera PPTX till GIF i JavaScript
url: /sv/nodejs-net/conversion/pptx-to-gif/
keywords: PPTX till GIF, Konvertera PPTX till GIF, Node.js API, JavaScript Library, PPTX, GIF
description: Konvertera PPTX till GIF i JavaScript. Använd Node.js biblioteks-API för att konvertera PPTX-filer till GIF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konvertera PPTX till GIF i JavaScript" h2="Aspose.Slides för Node.js via .NET är ett kraftfullt och lättanvänt bibliotek som låter dig konvertera PowerPoint-presentationer till olika format i JavaScript. Den stöder alla presentationselement och format och tillhandahåller ett rikt API för att komma åt och ändra dem. Det låter dig också exportera dina bilder till olika format för vidare bearbetning eller delning." >}}

{{% blocks/products/pf/feature-page-section h2="Konvertera PPTX till GIF i Node.js" %}}

[**Aspose.Slides för Node.js via .NET**](https://products.aspose.com/slides/sv/nodejs-net/) är ett kraftfullt Node.js-bibliotek för att skapa och manipulera presentationsfiler. Dessutom ger det flexibla sätt att konvertera PPTX till GIF. Genom att använda **Aspose.Slides för Node.js via .NET** kan alla utvecklare eller appar konvertera PPTX till GIF-filer med bara några rader kod.

Som ett modernt dokumentbearbetnings-API exporterar Aspose.Slides för Node.js via .NET snabbt PPTX-filer till GIF-filformat. Aspose PowerPoint-bibliotek låter dig konvertera PPTX till GIF och många andra filformat

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Konvertera PPTX till GIF med JavaScript" %}}
För att konvertera PPTX till GIF måste du skapa en presentation från filen PPTX och spara den som GIF.

{{% blocks/products/pf/agp/code-block title="JavaScript-kod för att konvertera PPTX till GIF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man konverterar PPTX till GIF med Aspose.Slides för Node.js via .NET API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="För att konvertera PPTX till GIF med Aspose.Slides för Node.js via .NET måste du importera paketet i din JavaScript-fil och skapa en instans av klassen Presentation. Klassen Presentation representerar ett PowerPoint-dokument och tillhandahåller metoder för att komma åt och manipulera dess element." >}}
