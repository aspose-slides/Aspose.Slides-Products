---
title: Konvertera POTM till ODP i JavaScript
url: /sv/nodejs-net/conversion/potm-to-odp/
keywords: POTM till ODP, Konvertera POTM till ODP, Node.js API, JavaScript Library, POTM, ODP
description: Konvertera POTM till ODP i JavaScript. Använd Node.js biblioteks-API för att konvertera POTM-filer till ODP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konvertera POTM till ODP i JavaScript" h2="Aspose.Slides för Node.js via .NET är ett kraftfullt och lättanvänt bibliotek som låter dig konvertera PowerPoint-presentationer till olika format i JavaScript. Den stöder alla presentationselement och format och tillhandahåller ett rikt API för att komma åt och ändra dem. Det låter dig också exportera dina bilder till olika format för vidare bearbetning eller delning." >}}

{{% blocks/products/pf/feature-page-section h2="Konvertera POTM till ODP i Node.js" %}}

[**Aspose.Slides för Node.js via .NET**](https://products.aspose.com/slides/sv/nodejs-net/) är ett kraftfullt Node.js-bibliotek för att skapa och manipulera presentationsfiler. Dessutom ger det flexibla sätt att konvertera POTM till ODP. Genom att använda **Aspose.Slides för Node.js via .NET** kan alla utvecklare eller appar konvertera POTM till ODP-filer med bara några rader kod.

Som ett modernt dokumentbearbetnings-API exporterar Aspose.Slides för Node.js via .NET snabbt POTM-filer till ODP-filformat. Aspose PowerPoint-bibliotek låter dig konvertera POTM till ODP och många andra filformat

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Konvertera POTM till ODP med JavaScript" %}}
För att konvertera POTM till ODP måste du skapa en presentation från filen POTM och spara den som ODP.

{{% blocks/products/pf/agp/code-block title="JavaScript-kod för att konvertera POTM till ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man konverterar POTM till ODP med Aspose.Slides för Node.js via .NET API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="För att konvertera POTM till ODP med Aspose.Slides för Node.js via .NET måste du importera paketet i din JavaScript-fil och skapa en instans av klassen Presentation. Klassen Presentation representerar ett PowerPoint-dokument och tillhandahåller metoder för att komma åt och manipulera dess element." >}}
