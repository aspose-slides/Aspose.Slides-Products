...
createEmptyPresentation(); // Execute the function to create an empty presentation
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Hur man lägger till/tar bort bilder och redigerar formegenskaper i Node.js</h2>
...
function manipulatePresentation() {
   ...
   // Generate and save a thumbnail of the first slide
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Hur man konverterar PowerPoint till PDF, GIF eller HTML i Node.js</h2>
        <p>Den här Node.js-koden visar hur du konverterar ett PowerPoint PPT-, PPTX- och OpenOffice ODP-dokument till ett PDF-dokument med standardalternativen. Den resulterande filen är ett PDF-dokument med högsta kvalitetsnivåer</p>
        <pre>
            <code class="JavaScript">
// Import the Aspose.Slides module for PowerPoint file manipulation
const asposeSlides = require('aspose.slides.via.net');
...
{{< blocks/products/pf/offers-section pfName="Aspose.Slides" description="Aspose.Slides erbjuder individuella PowerPoint API:er för andra populära utvecklingsmiljöer enligt listan nedan:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/slides/sv/android-.NET/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-android-.NET.svg" sdkName="Android via .NET" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/slides/sv/php-.NET/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-.NET.svg" sdkName="PHP via .NET" >}}
