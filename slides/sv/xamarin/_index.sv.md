...
{{< blocks/products/pf/carousel-item h3="Filformat som stöds" description="Aspose.Slides för Xamarin stöder de populära [presentationsformaten](https://docs.aspose.com/slides/net/supported-file-formats/) och exportformaten nedan." >}}
