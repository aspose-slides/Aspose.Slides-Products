...
url: /sv/cpp/merger/jpg-to-jpg/
keywords: Slå samman JPG, JPEG till JPG, gå med i JPG, kombinera JPG, C++ API, C++ bibliotek
description: Slå samman JPG till JPG i C++. Använd C++ biblioteks-API för att kombinera JPG-filer
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Slå samman JPG i C++" h2="Höghastighets- och plattformsoberoende C++-bibliotek för sammanslagning av JPG-bilder med C++-kod" >}}

{{% blocks/products/pf/feature-page-section h2="Slå samman JPG till JPG med Aspose.Slides" %}}

[**Aspose.Slides för C++**](https://products.aspose.com/slides/sv/cpp/) är ett kraftfullt C++-bibliotek som används för att slå samman och manipulera presentationer, bilder och andra filer. När du slår ihop JPG till JPG, kombinerar du effektivt två bilder för att få en bild.
...
{{% blocks/products/pf/feature-page-section  h2="Slå samman JPG till JPEG i C++" %}}
Genom att använda [**Aspose.Slides for C++**](https://products.aspose.com/slides/sv/cpp/) kan du snabbt slå samman JPG-filer med bara några rader kod
