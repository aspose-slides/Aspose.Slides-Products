---
title: Slå ihop SVG till PNG i C++
url: /sv/cpp/merger/svg-to-png/
keywords: Slå samman SVG till PNG, SVG till PNG, Gå med SVG till PNG, Kombinera SVG till PNG, C++ API, C++ Library
description: Slå ihop SVG till PNG i C++. Använd C++ biblioteks-API för att kombinera SVG- och PNG-filer
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Slå ihop SVG till PNG i C++" h2="Höghastighets- och plattformsoberoende C++-bibliotek för sammanslagning av SVG- till PNG-bilder med C++-kod" >}}

{{% blocks/products/pf/feature-page-section h2="Slå ihop SVG till PNG med Aspose.Slides" %}}

[**Aspose.Slides för C++**](https://products.aspose.com/slides/sv/cpp/) är ett kraftfullt C++-bibliotek som används för att slå samman och manipulera presentationer, bilder och andra filer. När du slår ihop SVG till PNG, kombinerar du effektivt SVG-bilder för att få en PNG-bild.
...
{{% blocks/products/pf/feature-page-section  h2="Slå ihop SVG till PNG i C++" %}}
Genom att använda [**Aspose.Slides for C++**](https://products.aspose.com/slides/sv/cpp/) kan du snabbt slå ihop SVG- till PNG-filer med bara några rader kod
