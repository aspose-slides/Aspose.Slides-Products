---
title: Slå ihop PNG-bilder i C++
url: /sv/cpp/merger/png-to-png/
keywords: Slå samman PNG, PNG till PNG, gå med i PNG, kombinera PNG, C++ API, C++ bibliotek
description: Slå ihop PNG till PNG i C++. Använd C++ biblioteks-API för att kombinera PNG-filer
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Slå samman PNG i C++" h2="Höghastighets- och plattformsoberoende C++-bibliotek för sammanslagning av PNG-bilder med C++-kod" >}}

{{% blocks/products/pf/feature-page-section h2="Slå ihop PNG till PNG med Aspose.Slides" %}}

[**Aspose.Slides för C++**](https://products.aspose.com/slides/sv/cpp/) är ett kraftfullt C++-bibliotek som används för att slå samman och manipulera presentationer, bilder och andra filer. När du slår ihop PNG till PNG, kombinerar du effektivt två bilder för att få en bild.
...
{{% blocks/products/pf/feature-page-section  h2="Slå ihop PNG till PNG i C++" %}}
Genom att använda [**Aspose.Slides for C++**](https://products.aspose.com/slides/sv/cpp/) kan du snabbt slå samman PNG-filer med bara några rader kod
