...
url: /sv/cpp/merger/image-to-pdf/
keywords: Bild till PDF, Slå ihop bild till PDF, anslut bild till PDF, PDF, Bild, C++ API, C++ Library
description: Slå samman bild till PDF i C++. Använd C++ biblioteks API för att kombinera bild och PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Slå samman bild till PDF i C++" h2="Höghastighets- och plattformsoberoende C++-bibliotek för sammanslagning av bild till PDF-filer med C++-kod" >}}

{{% blocks/products/pf/feature-page-section h2="Slå samman bild till PDF med Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/sv/cpp/) är ett kraftfullt C++-bibliotek som används för att skapa, konvertera, slå samman och manipulera presentationer, PDF-filer, bilder och annat filer. När du slår ihop bild till PDF, kombinerar du effektivt bilder för att få en enda PDF-fil.
...
Genom att använda [**Aspose.Slides for C++**](https://products.aspose.com/slides/sv/cpp/) kan du snabbt slå samman bild till PDF med bara några rader kod
