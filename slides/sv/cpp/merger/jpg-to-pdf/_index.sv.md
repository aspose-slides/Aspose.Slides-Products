...
url: /sv/cpp/merger/jpg-to-pdf/
keywords: JPG till PDF, Slå samman JPG till PDF, Anslut JPG till PDF, PDF, JPG, C++ API, C++ Library
description: Slå samman JPG till PDF i C++. Använd C++ biblioteks-API för att kombinera JPG och PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Slå samman JPG till PDF i C++" h2="Höghastighets- och plattformsoberoende C++-bibliotek för sammanslagning av JPG- till PDF-filer med C++-kod" >}}

{{% blocks/products/pf/feature-page-section h2="Slå samman JPG till PDF med Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/sv/cpp/) är ett kraftfullt C++-bibliotek som används för att skapa, konvertera, slå samman och manipulera presentationer, PDF-filer, bilder och annat filer. När du slår samman JPG till PDF, kombinerar du effektivt JPG-bilder för att få en enda PDF-fil.
...
Med [**Aspose.Slides for C++**](https://products.aspose.com/slides/sv/cpp/) kan du snabbt slå samman JPG till PDF med bara några rader kod
