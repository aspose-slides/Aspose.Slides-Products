...
title: Exportera JasperReports till PowerPoint | Aspose.Slides
weight: 8320
url: /sv/jasperreports/ 
description: Aspose.Slides PowerPoint API för JaspreReport för att exportera rapporter från Jasper Reports och JasperServer till PowerPoint-format. Skapa och exportera kontodiagrambilder text och linjerapporter till PPT-presentation
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Exportera JasperServer-rapporter till PowerPoint-presentationer" h2="PowerPoint API för export av JasperReports och JasperServer-rapporter till PPT(X), PPS(X) och andra PowerPoint-format." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-jasperreports.svg" pfName="Aspose.Slides" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/slides/jasperreport" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="for JasperReports" >}}

{{< blocks/products/pf/i18n/sub-menu logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-jasperreports.svg" liveDemosLink="" PricingLink="https://purchase.aspose.com/pricing/slides/jasperreports" buyLink="https://purchase.aspose.com/pricing/slides/jasperreports/" docsLink="https://docs.aspose.com/slides/jasperreports/" installationsDocsLink="" nugetLink="" nugetPackageName="Microsoft PowerPoint:" mavenRepoLink="" directDownloadLink="https://downloads.aspose.com/slides/jasperreport" >}}

{{< blocks/products/pf/i18n/tab-content >}}
<p>
 Aspose.Slides för JasperReports är ett PowerPoint API för flexibel och lättanvänd export av JasperReports och JasperServer-rapporter till PowerPoint. JasperServer har inte den inbyggda förmågan att exportera rapporter som PowerPoint-presentationer. Men med detta PowerPoint API kan JasperServer-rapporterna exporteras till PPT, PPS, PPTX och PPSX presentationsformat utan att använda Microsoft PowerPoint.
</p>
...
{{< blocks/products/pf/carousel-item h3="En överblick" description="En översikt över Aspose.Slides för JasperReports." >}}
...
{{< blocks/products/pf/carousel-item h3="Plattformsoberoende" description="Aspose.Slides PowerPoint API stöder J2SE, JasperReports och JasperServer." >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header style="padding-left: 0px;">
    ...
    J2SE 1.4 eller högre
   </header>
   <ul>
    <li>
17.5 och tidigare versioner
    </li>
   </ul>
   <header style="padding-left: 0px;">
    <i class="fa fa-cubes">
    </i>
    J2SE 6.0 eller högre
   </header>
   <ul>
    <li>
17.6 och nyare versioner
    </li>
   </ul>
  </div>
  <!--/left-->
  <div class="d1-col d1-right">
   <header style="padding-left: 0px;">
    ...
    JasperReports 2.0, 3.0 eller högre
   </header>
   <ul>
    <li>
17.5 och tidigare versioner
   ...
   <header style="padding-left: 0px;">
    ...
    JasperReports 3.7.2 eller senare.
   </header>
   <ul>
    <li>
17.6 och nyare versioner
...
{{< blocks/products/pf/carousel-item h3="Filformat som stöds" description="Aspose.Slides för JasperReports kan exportera rapporter i Microsoft PowerPoint [filformat](https://docs.aspose.com/slides/jasperreports/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Avancerade JasperRapporter till presentationsexportfunktioner</h2>

<p> </p>

<div class="col-lg-4"><em class="fa fa-file-powerpoint-o  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Skapa kontorapporter och exportera dem till Microsoft PowerPoint-presentationer</p>

</div>

<div class="col-lg-4"><em class="fa fa-bar-chart   ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Skapa diagramrapporter och exportera dem till Microsoft PowerPoint-presentationer</p>

</div>

<div class="col-lg-4"><em class="fa fa-pie-chart ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Skapa diagramrapporter med flera axlar och exportera till Microsoft PowerPoint-presentationer</p>

</div>

<div class="col-lg-4"><em class="fa fa-file-text ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Skapa bilder, text, linjer och exportera dessa rapporter till Microsoft PowerPoint-presentation</p>

</div>-->
   <h2 class="pr-ft">
    Avancerade JasperReports PowerPoint API-funktioner
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Skapa diagramrapporter med flera axlar
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Lägg till bilder, text, rader i rapporter
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-file-text ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Exportera rapporter till PowerPoint-presentationer
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-file-text ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Förvandla SVG-bilder till former
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Stöd för kommentarsvar, Office 365 och externa Excel-arbetsböcker
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Rasterisering av former utan text
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Dölj vänster bildminiatyrfönster i skapad PPT
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-area-chart ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Tratt, 2D-kartdiagram och storleksegenskap för bubbeldiagram
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-cog ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Textmarkering, OpenDocument-kryptering och formrendering
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Ställ in egenskapen Transparency för skuggeffekter och Morph Transition
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Ställ in språk i applikationen och anropsform för seriedataetikett
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Lägg till stöd för Strict Open XML-format
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Få effekter genom text-box stycken
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     ChartData SetRange på en pivottabell
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Implementera serialisering med strikt överensstämmelse med Open XML-format
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Lägg till kodningsmetatagg när du sparar i HTML
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Överensstämmelse med FIPS-kompatibla algoritmer
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Stöd för multipelaxeldiagramrapport
    </h2>
    <p>
     Aspose.Slides för JasperReports stöder export av komplexa rapporter som innehåller
     <strong>
      MultipleAxisChartReport
     </strong>
     till Microsoft PowerPoint-presentationer. Utdata är exakt samma som hur det ser ut när det visas via JasperViewer.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Exportera rapporter till presentationsformat
    </h2>
    <p>
     JasperReports och JasperServer har inte det inbyggda stödet för att exportera rapporter till Microsoft PowerPoint-presentationer, men integration med Aspose.Slides för JasperReports låter dig exportera dina rapporter till Microsoft PowerPoint-presentationer (PPT, PPTX) och Microsoft PowerPoint-bildspel (PPS, PPSX).
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides för JasperReports är byggd med hanterad kod som inte behöver Microsoft PowerPoint för att installeras på maskinen för att fungera med PowerPoint-dokument. Det är ett perfekt Microsoft PowerPoint-automatiseringsalternativ när det gäller funktioner som stöds, säkerhet, stabilitet, skalbarhet, hastighet och pris.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Dokumentation" href="https://docs.aspose.com/slides/jasperreports/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Varför Aspose.Slides för JasperReports?" tabId="success-stories" >}}
