---
title: Ta bort PPT Annotation med .NET
weight: 4380
url: /sv/net/annotation/ppt/ 
description: C#-källkod för att ta bort anteckningar i PPT-format på .NET Framework, .NET Core, Windows Azure, Mono eller Xamarin-plattformar.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Ta bort kommentarer och kommentarsförfattare från PPT i C#" h2="Bygg dina egna .NET-appar för att manipulera kommentarer och författare i dokumentfiler med hjälp av API:er på serversidan." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5="ODP" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for .NET" >}}

{{% blocks/products/pf/feature-page-section  h2="Ta bort kommentarer från PPT via C#" %}}
För att ta bort anteckningar från PPT-filen använder vi [Aspose.Slides for .NET](https://products.aspose.com/slides/sv/net) API som är en funktionsrik, kraftfull och lättanvänd API för dokumentmanipulation för C#-plattformen.
{{% blocks/products/pf/agp/code-block title="Ta bort kommentarer från PPT - C#" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man tar bort kommentarer från PPT via C#" >}}
