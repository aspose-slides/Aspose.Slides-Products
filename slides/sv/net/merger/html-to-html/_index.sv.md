---
title: Slå samman HTML-filer i C#
url: /sv/net/merger/html-to-html/
keywords: Slå samman HTML, HTML till HTML, Gå med HTML, Kombinera HTML, C# API, .NET Library
description: Slå samman HTML till HTML i C#. Använd .NET library API för att kombinera HTML-filer
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Slå samman HTML i C#" h2="Kraftfullt plattformsoberoende .NET API för sammanslagning av HTML-filer med C#-kod på NET Framework, .NET Core, Windows Azure, Mono eller Xamarin Platforms" >}}

{{% blocks/products/pf/feature-page-section h2="Slå samman HTML till HTML med Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/sv/net/) är ett kraftfullt .NET-bibliotek som används för att skapa, konvertera, slå samman och manipulera presentationer, HTML-filer och andra dokument. När du slår samman HTML till HTML, kombinerar du effektivt innehållet från 2 dokument för att få en HTML-fil. Aspose.Slides låter dig slå samman HTML-dokument på olika sätt. Du får slå samman HTML med alla deras texter, formatering, stilar, etc.
...
{{% blocks/products/pf/feature-page-section  h2="Slå samman HTML till HTML i C#" %}}
Genom att använda [**Aspose.Slides for .NET**](https://products.aspose.com/slides/sv/net/) kan du snabbt slå samman HTML-filer med bara några rader kod

{{% blocks/products/pf/agp/code-block title="C#-kod för att slå samman HTML till HTML" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Hur man slår samman HTML i C#" >}}
