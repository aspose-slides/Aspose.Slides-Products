...
url: /sv/net/merger/pdf-to-pdf/
keywords: Slå samman PDF, PDF till PDF, Gå med PDF, Kombinera PDF, C# API, .NET Library
description: Slå ihop PDF till PDF i C#. Använd .NET library API för att kombinera PDF-filer
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Slå samman PDF i C#" h2="Kraftfullt plattformsoberoende .NET API för sammanslagning av PDF-filer med C#-kod på NET Framework, .NET Core, Windows Azure, Mono eller Xamarin Platforms" >}}

{{% blocks/products/pf/feature-page-section h2="Slå ihop PDF till PDF med Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/sv/net/) är ett kraftfullt .NET-bibliotek som används för att skapa, konvertera, slå samman och manipulera presentationer, PDF-filer och annat dokument. När du slår ihop PDF till PDF, kombinerar du effektivt sidor från 2 dokument för att få en PDF-fil. Aspose.Slides låter dig slå samman PDF-filer på olika sätt. Du får slå samman PDF-filer med alla deras former, stilar, texter, formatering, etc.
...
Genom att använda [**Aspose.Slides for .NET**](https://products.aspose.com/slides/sv/net/) kan du snabbt slå samman PDF-filer med bara några rader kod
