...
title: Konvertera ODP till PPSM via C#
weight: 6910
url: /sv/net/conversion/odp-to-ppsm/ 
description: Exempelkod för ODP till PPSM C#-konvertering. Använd API-exempelkod för batch-ODP-filer till PPSM-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera ODP till PPSM via C#" h2="Exportera PowerPoint® ODP-filer till PPSM på .NET Framework, .NET Core, Windows Azure, Mono eller Xamarin-plattformar" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar ODP till PPSM med C#" %}}

 För att konvertera ODP till PPSM kommer vi att använda
...
{{< blocks/products/pf/agp/feature-section-col title="Steg för att konvertera ODP till PPSM via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET-utvecklare kan enkelt ladda och konvertera ODP-filer till PPSM på bara några rader kod." >}}
...
{{% blocks/products/pf/agp/code-block title="Denna exempelkod visar ODP till PPSM C#-konvertering" offSpacer="" %}}
