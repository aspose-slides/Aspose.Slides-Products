...
keywords: Konvertera PDF till PPT, PDF till PPT, PowerPoint, PDF, PPT, C# API, .NET Library
description: Konvertera PDF till PPT i C#. Använd .NET library API för att konvertera PDF till PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konvertera PDF till PPT i C#" h2="Kraftfullt plattformsoberoende .NET API för att konvertera PDF till PPT med C#-kod på NET Framework, .NET Core, Windows Azure, Mono eller Xamarin Platforms" >}}

{{% blocks/products/pf/feature-page-section h2="Konvertera PDF till PPT med Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/sv/net/) är ett kraftfullt .NET-bibliotek som används för att skapa, konvertera och manipulera PowerPoint-presentationer, PDF-filer, HTML-dokument, och andra filer. När du konverterar PDF till PPT flyttar du i huvudsak innehållet på PDF-sidorna till bilder i en PowerPoint-presentation.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Konvertera PDF till PPT i C#" %}}
Med hjälp av [**Aspose.Slides for .NET**](https://products.aspose.com/slides/sv/net/) kan du konvertera PDF till PowerPoint-presentationer med bara några rader kod:
...
{{< blocks/products/pf/feature-page-section  h2="Hur man konverterar PDF till PPT i C#" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Ladda PDF-filen du vill konvertera till PPT.
{{< /blocks/products/pf/agp/step-autogen >}}
