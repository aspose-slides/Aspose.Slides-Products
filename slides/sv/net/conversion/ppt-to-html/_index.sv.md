---
title: Konvertera PPT till HTML via C#
weight: 5750
url: /sv/net/conversion/ppt-to-html/ 
description: Exempelkod för konvertering av PPT till HTML C#. Använd API-exempelkod för batch-PPT-filer till HTML-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera PPT till HTML via C#" h2="Exportera PowerPoint® PPT-filer till HTML på .NET Framework, .NET Core, Windows Azure, Mono eller Xamarin-plattformar" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar PPT till HTML med C#" %}}

 För att konvertera PPT till HTML kommer vi att använda
...
{{< blocks/products/pf/agp/feature-section-col title="Steg för att konvertera PPT till HTML via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET-utvecklare kan enkelt ladda och konvertera PPT-filer till HTML på bara några rader kod." >}}
...
{{% blocks/products/pf/agp/code-block title="Denna exempelkod visar PPT till HTML C#-konvertering" offSpacer="" %}}
