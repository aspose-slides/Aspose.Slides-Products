...
keywords: Konvertera HTML till PPTX, HTML till PPTX, PowerPoint, HTML, PPTX, C# API, .NET Library
description: Konvertera HTML till PPTX i C#. Använd .NET library API för att konvertera HTML till PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konvertera HTML till PPTX i C#" h2="Kraftfullt plattformsoberoende .NET API för att konvertera HTML till PPTX med C#-kod på NET Framework, .NET Core, Windows Azure, Mono eller Xamarin-plattformar" >}}

{{% blocks/products/pf/feature-page-section h2="Konvertera HTML till PPTX med Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/sv/net/) är ett kraftfullt .NET-bibliotek som används för att skapa, konvertera och manipulera PowerPoint-presentationer, PDF-filer, HTML-dokument, och andra filer. När du konverterar HTML till PPTX flyttar du i huvudsak innehållet i ett HTML-dokument till bilder i en PowerPoint-presentation.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Konvertera HTML till PPTX i C#" %}}
Med hjälp av [**Aspose.Slides for .NET**](https://products.aspose.com/slides/sv/net/) kan du konvertera HTML-dokument till PowerPoint-presentationer med bara några rader kod:
