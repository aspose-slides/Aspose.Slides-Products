...
url: /sv/net/conversion/pdf-to-pptx/
keywords: Konvertera PDF till PPTX, PDF till PPTX, PowerPoint, PDF, PPTX, C# API, .NET Library
description: Konvertera PDF till PPTX i C#. Använd .NET library API för att konvertera PDF till PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konvertera PDF till PPTX i C#" h2="Kraftfullt plattformsoberoende .NET API för att konvertera PDF till PPTX med C#-kod på NET Framework, .NET Core, Windows Azure, Mono eller Xamarin Platforms" >}}

{{% blocks/products/pf/feature-page-section h2="Konvertera PDF till PPTX med Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/sv/net/) är ett kraftfullt .NET-bibliotek som används för att skapa, konvertera och manipulera PowerPoint-presentationer, PDF-filer, HTML-dokument, och andra filer. När du konverterar PDF till PPTX flyttar du i huvudsak innehållet på PDF-sidorna till bilder i en PowerPoint-presentation.
...
{{< blocks/products/pf/feature-page-section  h2="Hur man konverterar PDF till PPTX i C#" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Ladda PDF-filen du vill konvertera till PPTX.
{{< /blocks/products/pf/agp/step-autogen >}}
