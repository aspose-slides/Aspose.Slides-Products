---
title: Lås upp ODP-dokument via .NET
weight: 5780
url: /sv/net/unlock/odp/ 
description: C#-källkod för att låsa upp lösenordsskyddad ODP-fil på .NET Framework, .NET Core, Windows Azure, Mono eller Xamarin-plattformar.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Lås upp ODP-presentation via C#" h2="Ta bort skyddet från ODP med .NET-biblioteket." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man låser upp ODP-fil med C#" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Lås upp ODP via C#" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/sv/net/unlock/pptx/" name="PPTX" description="Öppna XML-presentationsformat" >}}
