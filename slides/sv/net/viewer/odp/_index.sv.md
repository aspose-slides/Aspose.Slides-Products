...
title: Visa ODP-filformat via .NET
weight: 8370
url: /sv/net/viewer/odp/ 
description: C#-källkod för att ladda, rendera och visa ODP-dokument på .NET Framework, .NET Core, Windows Azure, Mono eller Xamarin-plattformar.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ODP File Viewer för .NET" h2="Visa presentationsfiler som ODP utan Microsoft PowerPoint eller Office Automation" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man visar ODP-fil med C#" %}}

 För att se ODP-filen använder vi
...
{{< blocks/products/pf/agp/feature-section-col title="Steg för att visa ODP via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Aspose.Slides gör det enkelt för utvecklarna att se ODP-filen med bara några rader kod." >}}

{{< blocks/products/pf/agp/step-autogen >}}
Instantiera ett presentationsobjekt och ladda ODP-filen
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Spara ODP-presentationen i HTML-format
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Ring Process.Börja med sökvägen till resulterande HTML för att ladda ODP-innehåll i standardwebbläsaren
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="C# exempelkod för att se ODP-fil" offSpacer="" %}}
