...
description: Reporting Services PowerPoint API är Aspose.Slides för SQL PPT. PowerPoint-presentationstjänster för SQL PowerPoint.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Reporting Services PowerPoint API" h2="Exportera RDL-rapporter till PowerPoint PPT-, PPTX-, PPS- och PPSX-format." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-reporting-services.svg" pfName="Aspose.Slides" subTitlepfName="for Reporting Services" downloadUrl="https://downloads.aspose.com/slides/reportingservices" >}}
...
<p>
 Aspose.Slides for Reporting Services är den enda lösningen på marknaden som gör det möjligt att generera presentationer i PowerPoints ursprungliga format inifrån Microsoft SQL Server Reporting Services.
</p>

<p>
 Aspose.Slides for Reporting Services stöder nästan alla RDL-funktioner som tabeller, matriser, diagram, bilder, listor, underrapporter och sidhuvuden/sidfötter, vilket gör det möjligt att exportera rapporter i PowerPoint-presentationsformat på ett sådant sätt att de ser likadana ut som originalet rapportdesign. Utför Reporting Services SQL PPT utan Microsoft PowerPoint Automation.
</p>
...
{{< blocks/products/pf/carousel-item h3="En överblick" description="En översikt över Aspose.Slides for Reporting Services." >}}
...
{{< blocks/products/pf/carousel-item h3="Plattformsoberoende" description="Produkten stöder Microsoft SQL Server Reporting Services." >}}
<div class="diagram1 d1-rs">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="Filformat som stöds" description="Aspose.Slides for Reporting Services stöder de vanligaste presentationerna [filformat](https://docs.aspose.com/slides/reportingservices/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Advanced Reporting Services API-funktioner
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Skapa jämförelsediagram i RDL-rapporter och exportera som presentationer
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Skapa komplexa RDL-rapporter och exportera till presentationsfiler
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Exportera datacentrerade RDL-rapporter med underrapporter
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Exportera inbäddade ljud och videor till PowerPoint-filer
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Exportera RDL-rapporter med delrapporter till PowerPoint
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     High Fidelity till rapportdesignen
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Ändra färg på serien och dess kategorier
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Rasterisering eller vektorisering av former utan text
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-share ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Konvertera SVG-bilder till former
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Ändra färg på hyperlänktexten under en presentation
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Stöd för Open Document-kryptering, Text Highlighter och Morph Transition
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Trattdiagram och 2D-kartdiagram stöds
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Stöd för kommentarsvar och Office 365
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Exportera till presentations- och bildspelsformat
    </h2>
    <p>
     SQL Server Reporting Services (SSRS) tillhandahåller inte inbyggt stöd för export av RDL-rapporter till PowerPoint-presentationer eller bildspel. När du använder Aspose.Slides för Reporting Services kan du enkelt lägga till stöd för ytterligare exportformat.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for Reporting Services stöder fullständig RDL-specifikation och man kan anpassa befintliga rapporter med detta tillägg. Att välja valfri RDL-rapportdesigner och sedan exportera rapporterna exakt på samma sätt som man utformade det är ganska enkelt.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for Reporting Services är byggd med hanterad kod som aldrig behöver installera Microsoft PowerPoint på maskinen för att fungera med PowerPoint-presentationer. Det är ett perfekt Microsoft PowerPoint-automatiseringsalternativ när det gäller funktioner som stöds, säkerhet, stabilitet, skalbarhet, hastighet och pris.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Dokumentation" href="https://docs.aspose.com/slides/reportingservices/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Varför Aspose.Slides för rapporteringstjänster?" tabId="success-stories" >}}
