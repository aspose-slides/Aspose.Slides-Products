---
title: Konvertera PPT till PDF i Node.js
url: /sv/nodejs-java/conversion/ppt-to-pdf/
keywords: PPT till PDF, Konvertera PPT till PDF, Node.js API, Node.js Library, PPT, PDF
description: Konvertera PPT till PDF i Node.js. Använd Node.js biblioteks-API för att konvertera PPT-filer till PDFs
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konvertera PPT till PDF i Node.js" h2="Aspose.Slides för Node.js via Java är ett kraftfullt och lättanvänt bibliotek som låter dig konvertera PowerPoint-presentationer till olika format i Node.js. Den stöder alla presentationselement och format och tillhandahåller ett rikt API för att komma åt och ändra dem. Det låter dig också exportera dina bilder till olika format för vidare bearbetning eller delning." >}}

{{% blocks/products/pf/feature-page-section h2="Konvertera PPT till PDF i Node.js" %}}

[**Aspose.Slides för Node.js via Java**](https://products.aspose.com/slides/sv/nodejs-java/) är ett kraftfullt Node.js-bibliotek för att skapa och manipulera presentationsfiler. Dessutom ger det flexibla sätt att konvertera PPT till PDF. Genom att använda **Aspose.Slides för Node.js via Java** kan alla utvecklare eller applikationer konvertera PPT till PDF-filer med bara några rader kod.

Som ett modernt dokumentbearbetnings-API exporterar Aspose.Slides för Node.js snabbt PPT-filer till PDF-filformat. Aspose PowerPoint-bibliotek låter dig konvertera PPT till PDF och många andra filformat

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Konvertera PPT till PDF med Node.js" %}}
För att konvertera PPT till PDF måste du skapa en presentation från filen PPT och spara den som PDF.

{{% blocks/products/pf/agp/code-block title="Node.js-kod för att konvertera PPT till PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man konverterar PPT till PDF med hjälp av Aspose.Slides för Node.js via Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="För att konvertera PPT till PDF med Aspose.Slides för Node.js via Java måste du importera paketet i din JavaScript-fil och skapa en instans av klassen Presentation. Klassen Presentation representerar ett PowerPoint-dokument och tillhandahåller metoder för att komma åt och manipulera dess element." >}}
