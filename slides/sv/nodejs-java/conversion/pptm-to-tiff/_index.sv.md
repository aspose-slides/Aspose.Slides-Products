---
title: Konvertera PPTM till TIFF i Node.js
url: /sv/nodejs-java/conversion/pptm-to-tiff/
keywords: PPTM till TIFF, Konvertera PPTM till TIFF, Node.js API, Node.js Library, PPTM, TIFF
description: Konvertera PPTM till TIFF i Node.js. Använd Node.js biblioteks-API för att konvertera PPTM-filer till TIFFs
---
...
{{% blocks/products/pf/feature-page-section  h2="Konvertera PPTM till TIFF med Node.js" %}}
För att konvertera PPTM till TIFF måste du skapa en presentation från filen PPTM och spara den som TIFF.

{{% blocks/products/pf/agp/code-block title="Node.js-kod för att konvertera PPTM till TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man konverterar PPTM till TIFF med hjälp av Aspose.Slides för Node.js via Java API" >}}
