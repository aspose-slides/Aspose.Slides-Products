...
title: Konvertera PPS till TIFF i Node.js
url: /sv/nodejs-java/conversion/pps-to-tiff/
keywords: PPS till TIFF, Konvertera PPS till TIFF, Node.js API, Node.js Library, PPS, TIFF
description: Konvertera PPS till TIFF i Node.js. Använd Node.js biblioteks-API för att konvertera PPS-filer till TIFFs
---
...
[**Aspose.Slides för Node.js via Java**](https://products.aspose.com/slides/sv/nodejs-java/) är ett kraftfullt Node.js-bibliotek för att skapa och manipulera presentationsfiler. Dessutom ger det flexibla sätt att konvertera PPS till TIFF. Genom att använda **Aspose.Slides för Node.js via Java** kan alla utvecklare eller applikationer konvertera PPS till TIFF-filer med bara några rader kod.

Som ett modernt dokumentbearbetnings-API exporterar Aspose.Slides för Node.js snabbt PPS-filer till TIFF-filformat. Aspose PowerPoint-bibliotek låter dig konvertera PPS till TIFF och många andra filformat

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Konvertera PPS till TIFF med Node.js" %}}
För att konvertera PPS till TIFF måste du skapa en presentation från filen PPS och spara den som TIFF.

{{% blocks/products/pf/agp/code-block title="Node.js-kod för att konvertera PPS till TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man konverterar PPS till TIFF med hjälp av Aspose.Slides för Node.js via Java API" >}}
