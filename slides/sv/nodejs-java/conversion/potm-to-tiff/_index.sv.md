---
title: Konvertera POTM till TIFF i Node.js
url: /sv/nodejs-java/conversion/potm-to-tiff/
keywords: POTM till TIFF, Konvertera POTM till TIFF, Node.js API, Node.js Library, POTM, TIFF
description: Konvertera POTM till TIFF i Node.js. Använd Node.js biblioteks-API för att konvertera POTM-filer till TIFFs
---
...
[**Aspose.Slides för Node.js via Java**](https://products.aspose.com/slides/sv/nodejs-java/) är ett kraftfullt Node.js-bibliotek för att skapa och manipulera presentationsfiler. Dessutom ger det flexibla sätt att konvertera POTM till TIFF. Genom att använda **Aspose.Slides för Node.js via Java** kan alla utvecklare eller applikationer konvertera POTM till TIFF-filer med bara några rader kod.

Som ett modernt dokumentbearbetnings-API exporterar Aspose.Slides för Node.js snabbt POTM-filer till TIFF-filformat. Aspose PowerPoint-bibliotek låter dig konvertera POTM till TIFF och många andra filformat

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Konvertera POTM till TIFF med Node.js" %}}
För att konvertera POTM till TIFF måste du skapa en presentation från filen POTM och spara den som TIFF.

{{% blocks/products/pf/agp/code-block title="Node.js-kod för att konvertera POTM till TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man konverterar POTM till TIFF med hjälp av Aspose.Slides för Node.js via Java API" >}}
