...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Avancerade Java PowerPoint Documents Processing API-funktioner</h2>

<p>Aspose.Slides för Java innehåller ett antal avancerade funktioner som ger utvecklare fullständig kontroll när de programmerar med Microsoft PowerPoint-presentationer i en Java-miljö.</p>-->
   <h2 class="pr-ft">
...
<h2 class="h2title">Innehållsformatering av bilder</h2>

<p>Det är möjligt att formatera text och former på bilder i en presentation med Aspose.Slides för Java API. Text hanteras genom textramar som är associerade med former. Därför formateras text med hjälp av stycken och delar som är associerade med textramarna. Du kan också manipulera attribut för formelement som position, storlek, linje, bild, text och fyllning.</p>
