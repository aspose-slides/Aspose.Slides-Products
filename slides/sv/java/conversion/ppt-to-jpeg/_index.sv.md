---
title: Konvertera PPT till JPEG via Java
weight: 4700
url: /sv/java/conversion/ppt-to-jpeg/ 
description: Exempel på Java-konverteringskod för PPT-format till JPEG-fil. Använd den här exempelkoden för att exportera PowerPoint- och OpenOffice-presentationer till JPEG inom alla Java-baserade webb- eller skrivbordsapplikationer.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera PPT till JPEG via Java" h2="PPT till JPEG Java-konvertering för att konvertera enstaka eller flera sidor till JPEG med hjälp av On-premise Java-biblioteket." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar PPT till JPEG med Java" %}}

 För att rendera PPT till JPEG kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera PPT till JPEG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera PPT-fil till JPEG på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="PPT till JPEG Java Conversion källkod" offSpacer="" %}}
