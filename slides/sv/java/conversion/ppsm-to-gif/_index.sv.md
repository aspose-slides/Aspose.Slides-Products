---
title: Konvertera PPSM till GIF via Java
weight: 1950
url: /sv/java/conversion/ppsm-to-gif/ 
description: Exempel på Java-konverteringskod för PPSM-format till GIF-fil. Använd den här exempelkoden för att exportera PowerPoint- och OpenOffice-presentationer till GIF inom alla Java-baserade webb- eller skrivbordsapplikationer.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera PPSM till GIF via Java" h2="PPSM till GIF Java-konvertering för att konvertera enstaka eller flera sidor till GIF med hjälp av det lokala Java-biblioteket." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSM" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar PPSM till GIF med Java" %}}

 För att rendera PPSM till GIF kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera PPSM till GIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera PPSM-filer till GIF på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="PPSM till GIF Java-konvertering källkod" offSpacer="" %}}
