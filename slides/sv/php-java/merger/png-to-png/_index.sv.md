---
title: Slå ihop PNG-bilder i PHP
url: /sv/php-java/merger/png-to-png/
keywords: Slå samman PNG, PNG till PNG, gå med i PNG, kombinera PNG, PHP API, PHP-bibliotek
description: Slå ihop PNG till PNG i PHP. Använd PHP-bibliotekets API för att kombinera PNG-filer
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Slå ihop PNG i PHP" h2="Höghastighets- och plattformsoberoende PHP-bibliotek för sammanslagning av PNG-bilder med PHP-kod" >}}

{{% blocks/products/pf/feature-page-section h2="Slå ihop PNG till PNG med Aspose.Slides" %}}

[**Aspose.Slides för PHP via Java**](https://products.aspose.com/slides/sv/php-java/) är ett kraftfullt PHP-bibliotek som används för att slå samman och manipulera presentationer, bilder och andra filer. När du slår ihop PNG till PNG, kombinerar du effektivt två bilder för att få en bild.
...
{{% blocks/products/pf/feature-page-section  h2="Slå ihop PNG till PNG i PHP" %}}
Genom att använda [**Aspose.Slides för PHP via Java**](https://products.aspose.com/slides/sv/php-java/) kan du snabbt slå ihop PNG-filer med bara några rader kod

{{% blocks/products/pf/agp/code-block title="PHP-kod för att slå ihop PNG till PNG" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Hur man slår ihop PNG i PHP" >}}
