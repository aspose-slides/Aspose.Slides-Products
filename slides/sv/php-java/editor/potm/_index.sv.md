---
title: Redigera POTM i PHP
url: /sv/php-java/editor/potm/
keywords: Redigera POTM, Redigera PowerPoint, POTM, PowerPoint, PHP API, PHP Library
description: Redigera POTM i PHP. Använd PHP-bibliotekets API för att redigera POTM-filer
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Redigera POTM i PHP" h2="Höghastighets- och plattformsoberoende PHP-bibliotek för redigering av POTM med PHP-kod" >}}

{{% blocks/products/pf/feature-page-section h2="Redigera POTM med Aspose.Slides" %}}

[**Aspose.Slides för PHP via Java**](https://products.aspose.com/slides/sv/php-java/) är ett kraftfullt PHP-bibliotek som används för att manipulera och redigera presentationer. Du kan redigera en POTM-presentation genom att lägga till en ny textrad till den. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Redigera POTM i PHP" %}}
Genom att använda [**Aspose.Slides för PHP via Java**](https://products.aspose.com/slides/sv/php-java/) kan du lägga till en ny textrad till POTM-dokumentet med bara en några rader kod.

{{% blocks/products/pf/agp/code-block title="PHP-kod för redigering POTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man redigerar POTM i PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Ladda POTM-presentationen som du vill redigera.
{{< /blocks/products/pf/agp/step-autogen >}}
