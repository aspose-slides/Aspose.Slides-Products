---
title: Redigera ODP i PHP
url: /sv/php-java/editor/odp/
keywords: Redigera ODP, Redigera PowerPoint, ODP, PowerPoint, PHP API, PHP Library
description: Redigera ODP i PHP. Använd PHP-bibliotekets API för att redigera ODP-filer
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Redigera ODP i PHP" h2="Höghastighets- och plattformsoberoende PHP-bibliotek för redigering av ODP med PHP-kod" >}}

{{% blocks/products/pf/feature-page-section h2="Redigera ODP med Aspose.Slides" %}}

[**Aspose.Slides för PHP via Java**](https://products.aspose.com/slides/sv/php-java/) är ett kraftfullt PHP-bibliotek som används för att manipulera och redigera presentationer. Du kan redigera en ODP-presentation genom att lägga till en ny textrad till den. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Redigera ODP i PHP" %}}
Genom att använda [**Aspose.Slides för PHP via Java**](https://products.aspose.com/slides/sv/php-java/) kan du lägga till en ny textrad till ODP-dokumentet med bara en några rader kod.

{{% blocks/products/pf/agp/code-block title="PHP-kod för redigering ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man redigerar ODP i PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Ladda ODP-presentationen som du vill redigera.
{{< /blocks/products/pf/agp/step-autogen >}}
