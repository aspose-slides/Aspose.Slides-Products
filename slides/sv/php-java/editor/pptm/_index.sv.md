...
description: Redigera PPTM i PHP. Använd PHP-bibliotekets API för att redigera PPTM-filer
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Redigera PPTM i PHP" h2="Höghastighets- och plattformsoberoende PHP-bibliotek för redigering av PPTM med PHP-kod" >}}

{{% blocks/products/pf/feature-page-section h2="Redigera PPTM med Aspose.Slides" %}}

[**Aspose.Slides för PHP via Java**](https://products.aspose.com/slides/sv/php-java/) är ett kraftfullt PHP-bibliotek som används för att manipulera och redigera presentationer. Du kan redigera en PPTM-presentation genom att lägga till en ny textrad till den. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Redigera PPTM i PHP" %}}
Genom att använda [**Aspose.Slides för PHP via Java**](https://products.aspose.com/slides/sv/php-java/) kan du lägga till en ny textrad till PPTM-dokumentet med bara en några rader kod.

{{% blocks/products/pf/agp/code-block title="PHP-kod för redigering PPTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man redigerar PPTM i PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Ladda PPTM-presentationen som du vill redigera.
{{< /blocks/products/pf/agp/step-autogen >}}
