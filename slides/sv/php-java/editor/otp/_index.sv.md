---
title: Redigera OTP i PHP
url: /sv/php-java/editor/otp/
keywords: Redigera OTP, Redigera PowerPoint, OTP, PowerPoint, PHP API, PHP Library
description: Redigera OTP i PHP. Använd PHP-bibliotekets API för att redigera OTP-filer
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Redigera OTP i PHP" h2="Höghastighets- och plattformsoberoende PHP-bibliotek för redigering av OTP med PHP-kod" >}}

{{% blocks/products/pf/feature-page-section h2="Redigera OTP med Aspose.Slides" %}}

[**Aspose.Slides för PHP via Java**](https://products.aspose.com/slides/sv/php-java/) är ett kraftfullt PHP-bibliotek som används för att manipulera och redigera presentationer. Du kan redigera en OTP-presentation genom att lägga till en ny textrad till den. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Redigera OTP i PHP" %}}
Genom att använda [**Aspose.Slides för PHP via Java**](https://products.aspose.com/slides/sv/php-java/) kan du lägga till en ny textrad till OTP-dokumentet med bara en några rader kod.

{{% blocks/products/pf/agp/code-block title="PHP-kod för redigering OTP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man redigerar OTP i PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Ladda OTP-presentationen som du vill redigera.
{{< /blocks/products/pf/agp/step-autogen >}}
