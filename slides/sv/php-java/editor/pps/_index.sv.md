---
title: Redigera PPS i PHP
url: /sv/php-java/editor/pps/
keywords: Redigera PPS, Redigera PowerPoint, PPS, PowerPoint, PHP API, PHP Library
description: Redigera PPS i PHP. Använd PHP-bibliotekets API för att redigera PPS-filer
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Redigera PPS i PHP" h2="Höghastighets- och plattformsoberoende PHP-bibliotek för redigering av PPS med PHP-kod" >}}

{{% blocks/products/pf/feature-page-section h2="Redigera PPS med Aspose.Slides" %}}

[**Aspose.Slides för PHP via Java**](https://products.aspose.com/slides/sv/php-java/) är ett kraftfullt PHP-bibliotek som används för att manipulera och redigera presentationer. Du kan redigera en PPS-presentation genom att lägga till en ny textrad till den. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Redigera PPS i PHP" %}}
Genom att använda [**Aspose.Slides för PHP via Java**](https://products.aspose.com/slides/sv/php-java/) kan du lägga till en ny textrad till PPS-dokumentet med bara en några rader kod.

{{% blocks/products/pf/agp/code-block title="PHP-kod för redigering PPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man redigerar PPS i PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Ladda PPS-presentationen som du vill redigera.
{{< /blocks/products/pf/agp/step-autogen >}}
