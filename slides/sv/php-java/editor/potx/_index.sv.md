---
title: Redigera POTX i PHP
url: /sv/php-java/editor/potx/
keywords: Redigera POTX, Redigera PowerPoint, POTX, PowerPoint, PHP API, PHP Library
description: Redigera POTX i PHP. Använd PHP-bibliotekets API för att redigera POTX-filer
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Redigera POTX i PHP" h2="Höghastighets- och plattformsoberoende PHP-bibliotek för redigering av POTX med PHP-kod" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Redigera POTX i PHP" %}}
Genom att använda [**Aspose.Slides för PHP via Java**](https://products.aspose.com/slides/sv/php-java/) kan du lägga till en ny textrad till POTX-dokumentet med bara en några rader kod.

{{% blocks/products/pf/agp/code-block title="PHP-kod för redigering POTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man redigerar POTX i PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Ladda POTX-presentationen som du vill redigera.
{{< /blocks/products/pf/agp/step-autogen >}}
