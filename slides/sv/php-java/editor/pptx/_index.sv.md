---
title: Redigera PPTX i PHP
url: /sv/php-java/editor/pptx/
keywords: Redigera PPTX, Redigera PowerPoint, PPTX, PowerPoint, PHP API, PHP Library
description: Redigera PPTX i PHP. Använd PHP-bibliotekets API för att redigera PPTX-filer
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Redigera PPTX i PHP" h2="Höghastighets- och plattformsoberoende PHP-bibliotek för redigering av PPTX med PHP-kod" >}}

{{% blocks/products/pf/feature-page-section h2="Redigera PPTX med Aspose.Slides" %}}

[**Aspose.Slides för PHP via Java**](https://products.aspose.com/slides/sv/php-java/) är ett kraftfullt PHP-bibliotek som används för att manipulera och redigera presentationer. Du kan redigera en PPTX-presentation genom att lägga till en ny textrad till den. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Redigera PPTX i PHP" %}}
Genom att använda [**Aspose.Slides för PHP via Java**](https://products.aspose.com/slides/sv/php-java/) kan du lägga till en ny textrad till PPTX-dokumentet med bara en några rader kod.

{{% blocks/products/pf/agp/code-block title="PHP-kod för redigering PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hur man redigerar PPTX i PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Ladda PPTX-presentationen som du vill redigera.
{{< /blocks/products/pf/agp/step-autogen >}}
