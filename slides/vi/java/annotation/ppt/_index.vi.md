---
title: Xóa chú thích PPT qua Java
weight: 3630
...
{{< blocks/products/pf/i18n/upper-banner h1="Xóa nhận xét và tác giả nhận xét khỏi PPT qua Java" h2="Xây dựng các ứng dụng Java của riêng bạn để thao tác các nhận xét và tác giả trong các tệp tài liệu bằng cách sử dụng các API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách chú thích tệp PPT bằng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước xóa nhận xét khỏi PPT qua Java" %}}
...
1. Lưu nó ở định dạng PPT
1. Xóa nhận xét tại vị trí cụ thể
1. Lưu lại tệp PPT và so sánh
...
{{% blocks/products/pf/agp/code-block title="Xóa chú thích khỏi PPT - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/vi/java/annotation/odp/" name="ODP" description="Định dạng bản trình bày OpenDocument" >}}
