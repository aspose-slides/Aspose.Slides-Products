---
title: Hợp nhất TIFF thành PDF trong Java
url: /vi/java/merger/tiff-to-pdf/
keywords: TIFF sang PDF, Hợp nhất TIFF sang PDF, Nối TIFF sang PDF, PDF, TIFF, API Java, Thư viện Java
description: Hợp nhất TIFF thành PDF trong Java. Sử dụng API thư viện Java để kết hợp TIFF và PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Hợp nhất TIFF thành PDF trong Java" h2="Thư viện Java tốc độ cao và đa nền tảng để hợp nhất các tệp TIFF thành PDF bằng mã Java" >}}

{{% blocks/products/pf/feature-page-section h2="Hợp nhất TIFF thành PDF bằng Aspose.Slides" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/vi/java/) là một thư viện Java mạnh mẽ được sử dụng để tạo, chuyển đổi, hợp nhất và thao tác với các bản trình bày, PDF, hình ảnh và các nội dung khác các tập tin. Khi bạn hợp nhất TIFF thành PDF, bạn đang kết hợp các hình ảnh một cách hiệu quả để thu được một tệp PDF duy nhất.
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất TIFF thành PDF trong Java" %}}
Sử dụng [**Aspose.Slides for Java**](https://products.aspose.com/slides/vi/java/), bạn có thể hợp nhất TIFF thành PDF một cách nhanh chóng chỉ với một vài dòng mã

{{% blocks/products/pf/agp/code-block title="Mã Java để hợp nhất TIFF thành PDF" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất TIFF thành PDF trong Java" >}}
