...
description: Hợp nhất HTML thành HTML trong Java. Sử dụng API thư viện Java để kết hợp các tệp HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Hợp nhất HTML trong Java" h2="Thư viện Java tốc độ cao và đa nền tảng để hợp nhất các tệp HTML bằng mã Java" >}}

{{% blocks/products/pf/feature-page-section h2="Hợp nhất HTML với HTML bằng Aspose.Slides" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/vi/java/) là một thư viện Java mạnh mẽ được sử dụng để tạo, chuyển đổi, hợp nhất và thao tác với bản trình bày, tệp HTML và các tài liệu khác . Khi bạn hợp nhất HTML với HTML, bạn đang kết hợp hiệu quả nội dung từ 2 tài liệu để có được một tệp HTML. Aspose.Slides cho phép bạn hợp nhất các tài liệu HTML theo nhiều cách khác nhau. Bạn có thể hợp nhất HTML với tất cả các văn bản, định dạng, kiểu, v.v.
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất HTML sang HTML trong Java" %}}
Sử dụng [**Aspose.Slides for Java**](https://products.aspose.com/slides/vi/java/), bạn có thể hợp nhất các tệp HTML một cách nhanh chóng chỉ với một vài dòng mã

{{% blocks/products/pf/agp/code-block title="Mã Java để hợp nhất HTML với HTML" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất HTML trong Java" >}}
