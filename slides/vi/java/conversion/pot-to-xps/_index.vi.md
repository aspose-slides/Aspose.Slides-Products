---
title: Chuyển đổi POT sang XPS qua Java
weight: 5660
url: /vi/java/conversion/pot-to-xps/ 
description: Mã chuyển đổi Java mẫu cho định dạng POT sang tệp XPS. Sử dụng mã ví dụ này để xuất bản trình bày PowerPoint & OpenOffice sang XPS trong bất kỳ Ứng dụng dựa trên Java trên Web hoặc Máy tính để bàn nào.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi POT sang XPS qua Java" h2="POT sang XPS Chuyển đổi Java để chuyển đổi một hoặc nhiều trang sang XPS bằng cách sử dụng thư viện Java tại chỗ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi POT sang XPS bằng Java" %}}

 Để hiển thị POT sang XPS, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi POT sang XPS qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Các nhà phát triển Java có thể dễ dàng chuyển đổi tệp POT sang XPS chỉ trong một vài dòng mã.
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi Java POT sang XPS" offSpacer="" %}}
