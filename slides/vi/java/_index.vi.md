...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Tính năng API xử lý tài liệu Java PowerPoint nâng cao</h2>

<p>Aspose.Slides for Java kết hợp một số tính năng nâng cao cung cấp cho các nhà phát triển quyền kiểm soát hoàn toàn khi lập trình với các bản trình bày Microsoft PowerPoint trong môi trường Java.</p>-->
   <h2 class="pr-ft">
...
<h2 class="h2title">Định dạng nội dung trang trình bày</h2>

<p>Có thể định dạng văn bản và hình dạng trên các trang trình bày trong bản trình bày bằng cách sử dụng API Aspose.Slides cho Java. Văn bản được quản lý thông qua các khung văn bản liên kết với các hình dạng. Do đó, văn bản được định dạng bằng cách sử dụng các đoạn và phần được liên kết với các khung văn bản. Bạn cũng có thể thao tác các thuộc tính của phần tử hình dạng như vị trí, kích thước, đường kẻ, hình ảnh, văn bản và tô màu.</p>
...
{{< blocks/products/pf/slr-element name="Ghi chú phát hành" href="https://releases.aspose.com/slides/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
