...
finally
{
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Cách thêm/xóa/sao chép slide và chỉnh sửa thuộc tính hình dạng trong Node.js</h2>
        <p>Mã Node.js này chỉ cho bạn cách chỉnh sửa các thuộc tính khác nhau và sao chép các slide:</p>
        <pre>
            <code class="JavaScript">
const asposeSlides = require('aspose.slides.via.net');
...
finally
{
    ...
    <div class="col-lg-12">
        ...
        <p>Mã Node.js này chỉ cho bạn cách chuyển đổi PowerPoint thành tài liệu PDF</p>
        <pre>
            <code class="JavaScript">
const asposeSlides = require('aspose.slides.via.net');
...
finally
{
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Cách chuyển đổi PowerPoint sang GIF trong Node.js</h2>
        <p>Mã Node.js này chỉ cho bạn cách chuyển đổi PowerPoint thành hình ảnh GIF</p>
        <pre>
            <code class="JavaScript">
const asposeSlides = require('aspose.slides.via.net');
...
finally
{
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Cách chuyển đổi PowerPoint sang HTML trong Node.js</h2>
        <p>Mã Node.js này chỉ cho bạn cách chuyển đổi PowerPoint thành tài liệu HTML</p>
        <pre>
            <code class="JavaScript">
const asposeSlides = require('aspose.slides.via.net');
...
finally
{
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Cách chuyển đổi PowerPoint sang ODP trong Node.js</h2>
        <p>Mã Node.js này chỉ cho bạn cách chuyển đổi PowerPoint thành tài liệu ODP</p>
        <pre>
            <code class="JavaScript">
const asposeSlides = require('aspose.slides.via.net');
