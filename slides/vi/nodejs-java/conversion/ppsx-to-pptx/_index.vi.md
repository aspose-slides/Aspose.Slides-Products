---
title: Chuyển đổi PPSX thành PPTX trong Node.js
url: /vi/nodejs-java/conversion/ppsx-to-pptx/
keywords: PPSX sang PPTX, Chuyển đổi PPSX sang PPTX, API Node.js, Thư viện Node.js, PPSX, PPTX
description: Chuyển đổi PPSX thành PPTX trong Node.js. Sử dụng API thư viện Node.js để chuyển đổi tệp PPSX thành tệp PPTX
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Chuyển đổi PPSX thành PPTX trong Node.js" h2="Aspose.Slides cho Node.js qua Java là một thư viện mạnh mẽ và dễ sử dụng cho phép bạn chuyển đổi bản trình bày PowerPoint sang các định dạng khác nhau trong Node.js. Nó hỗ trợ tất cả các thành phần và định dạng trình bày, đồng thời cung cấp API phong phú để truy cập và sửa đổi chúng. Nó cũng cho phép bạn xuất các slide của mình sang nhiều định dạng khác nhau để xử lý hoặc chia sẻ thêm." >}}

{{% blocks/products/pf/feature-page-section h2="Chuyển đổi PPSX thành PPTX trong Node.js" %}}

[**Aspose.Slides dành cho Node.js qua Java**](https://products.aspose.com/slides/vi/nodejs-java/) là thư viện Node.js mạnh mẽ để tạo và thao tác với các tệp bản trình bày. Hơn nữa, nó cung cấp những cách linh hoạt để chuyển đổi PPSX sang PPTX. Bằng cách sử dụng **Aspose.Slides cho Node.js qua Java**, bất kỳ nhà phát triển hoặc ứng dụng nào cũng có thể chuyển đổi tệp PPSX sang PPTX chỉ bằng một vài dòng mã.

Là một API xử lý tài liệu hiện đại, Aspose.Slides dành cho Node.js xuất các tệp PPSX sang định dạng tệp PPTX một cách nhanh chóng. Thư viện Aspose PowerPoint cho phép bạn chuyển đổi PPSX sang PPTX và nhiều định dạng tệp khác

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Chuyển đổi PPSX sang PPTX bằng Node.js" %}}
Để chuyển đổi PPSX sang PPTX, bạn cần tạo Bản trình bày từ tệp PPSX và lưu dưới dạng PPTX.

{{% blocks/products/pf/agp/code-block title="Mã Node.js để chuyển đổi PPSX thành PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách chuyển đổi PPSX sang PPTX bằng cách sử dụng Aspose.Slides cho Node.js qua API Java" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Để chuyển đổi PPSX sang PPTX bằng Aspose.Slides cho Node.js qua Java, bạn cần nhập gói trong tệp JavaScript của mình và tạo một phiên bản của lớp Trình bày. Lớp Trình bày đại diện cho một tài liệu PowerPoint và cung cấp các phương thức để truy cập và thao tác các phần tử của nó." >}}
