---
title: API Android PowerPoint | API Aspose.Slides dành cho Android
weight: 5960
url: /vi/android-java/ 
description: Aspose.Slides for Android API hoặc Android PowerPoint API để tạo đọc và thao tác PPT POT PPS PPTX POTX PPSX PowerPoint trên Android.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API Android PowerPoint" h2="Tạo, sửa đổi, chuyển đổi, hợp nhất, tách và quản lý bản trình bày PowerPoint trong ứng dụng Android." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-android-java.svg" pfName="Aspose.Slides" subTitlepfName="for Android via Java" downloadUrl="https://downloads.aspose.com/slides/androidjava" >}}
...
{{< blocks/products/pf/carousel-item h3="Sơ lược" description="Tổng quan về các tính năng API của Aspose.Slides dành cho Android." >}}
...
{{< blocks/products/pf/carousel-item h3="Nền tảng độc lập" description="API Aspose.Slides dành cho Android bao gồm các môi trường phát triển và nền tảng triển khai Android sau đây." >}}
<div class="diagram1 d1-android">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="Các định dạng tệp được hỗ trợ" description="API Aspose.Slides cho Android hỗ trợ [các định dạng PowerPoint] nguyên gốc (https://docs.aspose.com/slides/java/supported-file-formats/) và nhiều định dạng chuyển đổi." >}}
...
{{< blocks/products/pf/slr-element name="Tài liệu" href="https://docs.aspose.com/slides/androidjava/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Tại sao Aspose.Slides cho Android thông qua Java?" tabId="success-stories" >}}
