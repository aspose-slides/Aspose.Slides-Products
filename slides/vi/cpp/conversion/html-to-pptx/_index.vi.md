...
url: /vi/cpp/conversion/html-to-pptx/
keywords: Chuyển đổi HTML sang PPTX, HTML sang PPTX, PowerPoint, HTML, PPTX, API C++, Thư viện C++
description: Chuyển đổi HTML sang PPTX trong C++. Sử dụng API thư viện C++ để chuyển HTML sang PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Chuyển đổi HTML sang PPTX trong C++" h2="API C++ đa nền tảng mạnh mẽ để chuyển đổi HTML sang PPTX bằng mã C++" >}}

{{% blocks/products/pf/feature-page-section h2="Chuyển đổi HTML sang PPTX bằng Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/vi/cpp/) là một thư viện C++ mạnh mẽ được sử dụng để tạo, chuyển đổi và thao tác với các bản trình bày PowerPoint, PDF, tài liệu HTML, v.v. các tập tin. Khi bạn chuyển đổi HTML sang PPTX, về cơ bản, bạn đang di chuyển nội dung trong tài liệu HTML sang các trang chiếu trong bản trình bày PowerPoint.
