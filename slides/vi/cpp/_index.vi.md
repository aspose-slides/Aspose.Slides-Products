...
<p class="col-lg-10">Nhúng biểu đồ Excel dưới dạng đối tượng OLE trong trang trình bày</p>

</div>

<div class="col-lg-4"><em class="fa fa-print  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Quản lý các đối tượng Ole được liên kết</p>
...
<p class="col-lg-10">In ấn các bản trình bày theo yêu cầu</p>
...
<h2 class="h2title">Tích hợp liên tục các tính năng mới</h2>

<p>Bạn không bao giờ bị giới hạn đối với các tính năng hiện có. Nhóm sản phẩm của chúng tôi liên tục bổ sung ngày càng nhiều tính năng và mỗi phiên bản mới đều cung cấp nhiều tính năng hơn so với các phiên bản cũ. Bạn cũng có thể gửi yêu cầu tính năng mới nếu bạn thấy thiếu bất kỳ tính năng mong muốn nào của mình. Đây là danh sách một số lựa chọn từ các tính năng mới nhất.</p>

<ul>

<li>Rasterization hoặc vectơ hóa các Hình dạng không có văn bản.</li>

<li>Chuyển đổi hình ảnh SVG thành hình dạng.</li>

<li>Lấy nền bảng mặc định.</li>

<li>Hạn chế quyền truy cập hệ thống tệp cục bộ khi mở tài liệu.</li>

<li>Thêm thẻ meta mã hóa khi lưu vào HTML.</li>

<li>Cài đặt để xóa các thuộc tính chiều rộng và chiều cao của thẻ SVG khi lưu dưới dạng HTML.</li>

<li>Support for

<ul>

<li>Trả lời nhận xét, Office 365 và sổ làm việc Excel bên ngoài.</li>

<li>Kích thước biểu thị thuộc tính cho biểu đồ Bong bóng.</li>

<li>Ẩn ngăn hình thu nhỏ trang chiếu bên trái trong PPT đã tạo.</li>

<li>Biểu đồ kênh, biểu đồ bản đồ 2D và biểu đồ thiết lập đường dẫn sổ làm việc nguồn dữ liệu bên ngoài.</li>

<li>Tính năng mã hóa OpenDocument, Morph Transition và Text Highlighter.</li>

<li>Đặt thuộc tính Transparency cho các hiệu ứng đổ bóng.</li>

<li>Đặt hình dạng chú thích cho nhãn dữ liệu chuỗi.</li>

<li>Nhận hiệu ứng bằng các đoạn văn bản trong hộp văn bản.</li>

<li>Kết xuất hình dạng Hiệu ứng Soft Edges (EffectFormat).</li>

<li>ChartData SetRange trên Pivot Table.</li>

</ul>

</li>

<li>Triển khai định dạng Tiff nhiều trang, Tiện ích mở rộng cộng với định dạng siêu tệp (EMF +) và định dạng XML mở nghiêm ngặt.</li>

<li>Hiển thị nhận xét từ định dạng ODP không có tác giả.</li>

<li>Thực hiện tuần tự hóa với sự tuân thủ nghiêm ngặt định dạng XML Open.</li>
...
<h2 class="h2title">Xử lý hình dạng SmartArt</h2>

<p>Aspose.Slides for C ++ tạo điều kiện thuận lợi trong việc tạo các hình SmartArt từ đầu cũng như cung cấp khả năng truy cập, thao tác hoặc xóa các hình SmartArt hiện có khỏi một trang chiếu. Hơn nữa, cũng có thể định dạng các hình dạng SmartArt như kiểu thiết lập, màu sắc và bố cục.</p>
