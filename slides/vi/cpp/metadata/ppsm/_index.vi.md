---
title: Chỉnh sửa hoặc xem siêu dữ liệu tài liệu PPSM qua C ++
weight: 3220
url: /vi/cpp/metadata/ppsm/ 
description: Mã ví dụ C ++ để chỉnh sửa hoặc xem siêu dữ liệu tệp PPSM trên Môi trường thời gian chạy C ++ dành cho Windows 32 bit, Windows 64 bit và Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Trích xuất Siêu dữ liệu PPSM qua C ++" h2="Xây dựng ứng dụng C ++ của riêng bạn để thêm, chỉnh sửa, xóa hoặc trích xuất siêu dữ liệu từ tệp PPSM bằng cách sử dụng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách lấy siêu dữ liệu PPSM bằng C ++" %}}

 Để trích xuất siêu dữ liệu PPSM, chúng tôi sẽ sử dụng
...
{{< blocks/products/pf/agp/feature-section-col title="Các bước để trích xuất siêu dữ liệu của PPSM qua C ++" >}}
...
{{% blocks/products/pf/agp/code-block title="Trích xuất siêu dữ liệu của PPSM - C ++" offSpacer="" %}}
