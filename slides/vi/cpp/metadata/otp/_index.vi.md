---
title: Xem hoặc chỉnh sửa siêu dữ liệu tệp OTP bằng C++
url: /vi/cpp/metadata/otp/
keywords: Chỉnh sửa siêu dữ liệu OTP, Xem siêu dữ liệu OTP, Chỉnh sửa thuộc tính OTP, Xem thuộc tính OTP
description: mã nguồn C++ để chỉnh sửa hoặc xem siêu dữ liệu định dạng OTP.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chỉnh sửa thuộc tính OTP bằng C++" h2="Xây dựng các ứng dụng C++ của riêng bạn để sửa đổi các thuộc tính Tích hợp và Tùy chỉnh trong tệp bản trình bày bằng cách sử dụng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTP" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" fileiconsmall4="POT" fileiconsmall5="ppsx" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for C++" >}}

{{% blocks/products/pf/feature-page-section  h2="Sửa đổi Thuộc tính OTP qua C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Sửa đổi Thuộc tính tích hợp OTP - C++" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Thêm thuộc tính tùy chỉnh vào OTP - C++" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách trích xuất siêu dữ liệu của OTP qua C++" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để Trích xuất siêu dữ liệu từ tệp OTP." >}}

{{< blocks/products/pf/agp/step-autogen >}}
Khởi tạo lớp Trình bày với đường dẫn đến tệp OTP
{{< /blocks/products/pf/agp/step-autogen >}}
