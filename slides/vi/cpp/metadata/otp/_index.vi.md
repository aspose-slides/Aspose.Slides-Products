---
title: Chỉnh sửa hoặc xem siêu dữ liệu tài liệu OTP qua C ++
weight: 5860
url: /vi/cpp/metadata/otp/ 
description: Mã ví dụ C ++ để chỉnh sửa hoặc xem siêu dữ liệu tệp OTP trên Môi trường thời gian chạy C ++ dành cho Windows 32 bit, Windows 64 bit và Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Trích xuất siêu dữ liệu OTP qua C ++" h2="Xây dựng ứng dụng C ++ của riêng bạn để thêm, chỉnh sửa, xóa hoặc trích xuất siêu dữ liệu từ tệp OTP bằng cách sử dụng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTP" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách lấy siêu dữ liệu OTP bằng C ++" %}}

 Để trích xuất siêu dữ liệu OTP, chúng tôi sẽ sử dụng
...
{{< blocks/products/pf/agp/feature-section-col title="Các bước trích xuất siêu dữ liệu OTP qua C ++" >}}
...
{{% blocks/products/pf/agp/code-block title="Trích xuất siêu dữ liệu của OTP - C ++" offSpacer="" %}}
