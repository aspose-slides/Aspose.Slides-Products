...
url: /vi/cpp/merger/jpg-to-pdf/
keywords: JPG sang PDF, Hợp nhất JPG sang PDF, Nối JPG sang PDF, PDF, JPG, API C++, Thư viện C++
description: Hợp nhất JPG sang PDF trong C++. Sử dụng API thư viện C++ để kết hợp JPG và PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Hợp nhất JPG sang PDF trong C++" h2="Thư viện C++ tốc độ cao và đa nền tảng để hợp nhất các tệp JPG sang PDF bằng mã C++" >}}

{{% blocks/products/pf/feature-page-section h2="Hợp nhất JPG sang PDF bằng Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/vi/cpp/) là một thư viện C++ mạnh mẽ được sử dụng để tạo, chuyển đổi, hợp nhất và thao tác với các bản trình bày, PDF, hình ảnh và các nội dung khác các tập tin. Khi bạn hợp nhất JPG sang PDF, bạn đang kết hợp hiệu quả các hình ảnh JPG để có được một tệp PDF duy nhất.
...
Sử dụng [**Aspose.Slides for C++**](https://products.aspose.com/slides/vi/cpp/), bạn có thể nhanh chóng hợp nhất JPG sang PDF chỉ với một vài dòng mã
