...
url: /vi/cpp/merger/pdf-to-pdf/
keywords: Hợp nhất PDF, PDF sang PDF, Tham gia PDF, Kết hợp PDF, API C++, Thư viện C++
description: Hợp nhất PDF thành PDF trong C++. Sử dụng API thư viện C++ để kết hợp các tệp PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Hợp nhất PDF trong C++" h2="Thư viện C++ tốc độ cao và đa nền tảng để hợp nhất các tệp PDF bằng mã C++" >}}

{{% blocks/products/pf/feature-page-section h2="Hợp nhất PDF sang PDF bằng Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/vi/cpp/) là một thư viện C++ mạnh mẽ được sử dụng để tạo, chuyển đổi, hợp nhất và thao tác với các bản trình bày, tệp PDF và các tài liệu khác. Khi bạn hợp nhất PDF thành PDF, bạn đang kết hợp hiệu quả các trang từ 2 tài liệu để có được một tệp PDF. Aspose.Slides cho phép bạn hợp nhất các tệp PDF theo nhiều cách khác nhau. Bạn có thể hợp nhất các tệp PDF với tất cả các hình dạng, kiểu dáng, văn bản, định dạng, v.v.
...
Sử dụng [**Aspose.Slides for C++**](https://products.aspose.com/slides/vi/cpp/), bạn có thể hợp nhất các tệp PDF một cách nhanh chóng chỉ với một vài dòng mã
