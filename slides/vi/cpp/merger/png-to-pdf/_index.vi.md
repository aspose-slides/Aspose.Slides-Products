...
url: /vi/cpp/merger/png-to-pdf/
keywords: PNG sang PDF, Hợp nhất PNG sang PDF, Nối PNG sang PDF, PDF, PNG, API C++, Thư viện C++
description: Hợp nhất PNG sang PDF trong C++. Sử dụng API thư viện C++ để kết hợp PNG và PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Hợp nhất PNG sang PDF trong C++" h2="Thư viện C++ tốc độ cao và đa nền tảng để hợp nhất các tệp PNG thành PDF bằng mã C++" >}}

{{% blocks/products/pf/feature-page-section h2="Hợp nhất PNG sang PDF bằng Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/vi/cpp/) là một thư viện C++ mạnh mẽ được sử dụng để tạo, chuyển đổi, hợp nhất và thao tác với các bản trình bày, hình ảnh và các tệp khác. Khi bạn hợp nhất PNG thành PDF, bạn đang kết hợp hiệu quả các hình ảnh PNG để thu được một tệp PDF duy nhất.
...
Sử dụng [**Aspose.Slides for C++**](https://products.aspose.com/slides/vi/cpp/), bạn có thể hợp nhất PNG thành PDF một cách nhanh chóng chỉ với một vài dòng mã
