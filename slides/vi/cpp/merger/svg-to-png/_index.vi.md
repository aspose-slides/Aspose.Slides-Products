...
url: /vi/cpp/merger/svg-to-png/
keywords: Hợp nhất SVG thành PNG, SVG thành PNG, Nối SVG thành PNG, Kết hợp SVG thành PNG, API C++, Thư viện C++
description: Hợp nhất SVG thành PNG trong C++. Sử dụng API thư viện C++ để kết hợp các tệp SVG và PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Hợp nhất SVG thành PNG trong C++" h2="Thư viện C++ tốc độ cao và đa nền tảng để hợp nhất hình ảnh SVG thành PNG bằng mã C++" >}}

{{% blocks/products/pf/feature-page-section h2="Hợp nhất SVG thành PNG bằng Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/vi/cpp/) là một thư viện C++ mạnh mẽ được sử dụng để hợp nhất và thao tác với các bản trình bày, hình ảnh và các tệp khác. Khi bạn hợp nhất SVG với PNG, bạn đang kết hợp hiệu quả các hình ảnh SVG để có được một hình ảnh PNG.
...
Sử dụng [**Aspose.Slides for C++**](https://products.aspose.com/slides/vi/cpp/), bạn có thể nhanh chóng hợp nhất các tệp SVG với PNG chỉ bằng một vài dòng mã
