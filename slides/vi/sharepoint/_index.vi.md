...
title: SharePoint PowerPoint | API Aspose.Slides SharePoint
weight: 910
url: /vi/sharepoint/ 
description: SharePoint PowerPoint là một SharePoint Aspose.Slides để tạo và chuyển đổi SharePoint PPT, trình chiếu SharePoint, bản trình bày SharePoint.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Giải pháp SharePoint PowerPoint" h2="Quản lý và chuyển đổi bản trình bày PowerPoint trong SharePoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-sharepoint.svg" pfName="Aspose.Slides" subTitlepfName="for SharePoint" downloadUrl="https://downloads.aspose.com/slides/sharepoint" >}}
...
{{< blocks/products/pf/carousel-item h3="Sơ lược" description="Tổng quan về Aspose.Slides cho SharePoint" >}}
...
{{< blocks/products/pf/carousel-item h3="Nền tảng độc lập" description="Aspose.Slides cho SharePoint hoạt động với Microsoft Office SharePoint Server và Windows SharePoint Services." >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <ul>
    <li>
2007 (Tiêu chuẩn MOSS)
    </li>
    <li>
2007 (Doanh nghiệp MOSS)
    </li>
    <li>
2013
    </li>
...
{{< blocks/products/pf/carousel-item h3="Các định dạng tệp được hỗ trợ" description="Aspose.Slides dành cho SharePoint hỗ trợ hầu hết các [định dạng tệp] bản trình bày phổ biến (https://docs.aspose.com/slides/sharepoint/supported-file-formats/)." >}}
...
{{< blocks/products/pf/slr-element name="Tài liệu" href="https://docs.aspose.com/slides/sharepoint/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Tại sao nên dùng Aspose.Slides cho SharePoint?" tabId="success-stories" >}}
