---
title: Hợp nhất PNG sang PDF trong PHP
url: /vi/php-java/merger/png-to-pdf/
keywords: PNG sang PDF, Hợp nhất PNG sang PDF, Nối PNG sang PDF, PDF, PNG, API PHP, Thư viện PHP
description: Hợp nhất PNG sang PDF trong PHP. Sử dụng API thư viện PHP để kết hợp PNG và PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Hợp nhất PNG sang PDF trong PHP" h2="Thư viện PHP đa nền tảng và tốc độ cao để hợp nhất các tệp PNG thành PDF bằng mã PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Hợp nhất PNG sang PDF bằng Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/vi/php-java/) là một thư viện PHP mạnh mẽ được sử dụng để tạo, chuyển đổi, hợp nhất và thao tác với bản trình bày, hình ảnh, và các tập tin khác. Khi bạn hợp nhất PNG thành PDF, bạn đang kết hợp hiệu quả các hình ảnh PNG để thu được một tệp PDF duy nhất.
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất PNG sang PDF trong PHP" %}}
Sử dụng [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/vi/php-java/), bạn có thể nhanh chóng hợp nhất PNG thành PDF chỉ với một vài dòng mã

{{% blocks/products/pf/agp/code-block title="Mã PHP để hợp nhất PNG thành PDF" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PNG sang PDF trong PHP" >}}
