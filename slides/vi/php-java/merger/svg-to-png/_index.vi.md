---
title: Hợp nhất SVG thành PNG trong PHP
url: /vi/php-java/merger/svg-to-png/
keywords: Hợp nhất SVG thành PNG, SVG thành PNG, Tham gia SVG thành PNG, Kết hợp SVG thành PNG, API PHP, Thư viện PHP
description: Hợp nhất SVG thành PNG trong PHP. Sử dụng API thư viện PHP để kết hợp các tệp SVG và PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Hợp nhất SVG thành PNG trong PHP" h2="Thư viện PHP đa nền tảng và tốc độ cao để hợp nhất hình ảnh SVG thành PNG bằng mã PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Hợp nhất SVG thành PNG bằng Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/vi/php-java/) là một thư viện PHP mạnh mẽ được sử dụng để hợp nhất và thao tác với các bản trình bày, hình ảnh và các tệp khác. Khi bạn hợp nhất SVG với PNG, bạn đang kết hợp hiệu quả các hình ảnh SVG để có được một hình ảnh PNG.
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất SVG thành PNG trong PHP" %}}
Sử dụng [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/vi/php-java/), bạn có thể nhanh chóng hợp nhất các tệp SVG với PNG chỉ bằng một vài dòng mã

{{% blocks/products/pf/agp/code-block title="Mã PHP để hợp nhất SVG với PNG" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất SVG thành PNG trong PHP" >}}
