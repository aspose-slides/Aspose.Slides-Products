---
title: Chuyển đổi POTM sang JPG trong PHP
weight: 1100
url: /vi/php-java/conversion/potm-to-jpg/ 
keywords: "Convert, PowerPoint, POTM, JPG, Presentation, PHP"
description: Mã mẫu cho chuyển đổi PHP từ POTM sang JPG. Sử dụng PowerPoint PHP API để chuyển đổi hàng loạt tệp POTM sang tệp JPG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi POTM sang JPG trong PHP" h2="Thư viện PHP PowerPoint mạnh mẽ để chuyển đổi POTM sang JPG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi POTM sang JPG trong PHP" %}}

Bạn cần chuyển đổi tệp POTM thành JPG theo cách lập trình? Sử dụng [* Aspose.Slides cho PHP qua Java *](https://products.aspose.com/slides/vi/php-java/), bất kỳ nhà phát triển nào cũng có thể chuyển đổi định dạng POTM sang JPG chỉ với một vài dòng mã PHP .

Là một API xử lý bản trình bày hiện đại, Aspose.Slides for PHP tạo JPG từ POTM một cách nhanh chóng. Kiểm tra chất lượng của chuyển đổi POTM sang JPG ngay trong [browser] của bạn (https://products.aspose.app/slides/conversion/ppt-to-jpg). Thư viện Aspose PowerPoint PPTX cho phép bạn chuyển đổi tệp POTM sang nhiều định dạng phổ biến.
...
{{< blocks/products/pf/agp/feature-section-col title="Cách chuyển đổi POTM sang JPG trong PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để chuyển đổi tệp POTM thành JPG bằng PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị Chuyển đổi PHP từ POTM sang JPG" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu POTM dưới dạng JPG trong PHP" %}}
Sử dụng ứng dụng miễn phí để xem trình diễn về quá trình chuyển đổi POTM sang JPG. 
{{% /blocks/products/pf/agp/content %}}
