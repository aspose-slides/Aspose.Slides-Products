---
title: Chỉnh sửa PPTM trong PHP
url: /vi/php-java/editor/pptm/
keywords: Chỉnh sửa PPTM, Chỉnh sửa PowerPoint, PPTM, PowerPoint, API PHP, Thư viện PHP
description: Chỉnh sửa PPTM trong PHP. Sử dụng API thư viện PHP để chỉnh sửa tệp PPTM
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Chỉnh sửa PPTM trong PHP" h2="Thư viện PHP đa nền tảng và tốc độ cao để chỉnh sửa PPTM bằng mã PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Chỉnh sửa PPTM bằng Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/vi/php-java/) là một thư viện PHP mạnh mẽ dùng để thao tác và chỉnh sửa bản trình bày. Bạn có thể chỉnh sửa bản trình bày PPTM bằng cách thêm một dòng văn bản mới vào bản trình bày đó. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Chỉnh sửa PPTM trong PHP" %}}
Sử dụng [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/vi/php-java/), bạn có thể thêm một dòng văn bản mới vào tài liệu PPTM chỉ bằng một vài dòng mã.

{{% blocks/products/pf/agp/code-block title="Mã PHP để chỉnh sửa PPTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách chỉnh sửa PPTM trong PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Tải bản trình bày PPTM mà bạn muốn chỉnh sửa.
{{< /blocks/products/pf/agp/step-autogen >}}
