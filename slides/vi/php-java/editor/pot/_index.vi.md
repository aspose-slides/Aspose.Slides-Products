---
title: Chỉnh sửa POT trong PHP
url: /vi/php-java/editor/pot/
keywords: Chỉnh sửa POT, Chỉnh sửa PowerPoint, POT, PowerPoint, API PHP, Thư viện PHP
description: Chỉnh sửa POT trong PHP. Sử dụng API thư viện PHP để chỉnh sửa tệp POT
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Chỉnh sửa POT trong PHP" h2="Thư viện PHP đa nền tảng và tốc độ cao để chỉnh sửa POT bằng mã PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Chỉnh sửa POT bằng Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/vi/php-java/) là một thư viện PHP mạnh mẽ dùng để thao tác và chỉnh sửa bản trình bày. Bạn có thể chỉnh sửa bản trình bày POT bằng cách thêm một dòng văn bản mới vào bản trình bày đó. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Chỉnh sửa POT trong PHP" %}}
Sử dụng [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/vi/php-java/), bạn có thể thêm một dòng văn bản mới vào tài liệu POT chỉ bằng một vài dòng mã.

{{% blocks/products/pf/agp/code-block title="Mã PHP để chỉnh sửa POT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách chỉnh sửa POT trong PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Tải bản trình bày POT mà bạn muốn chỉnh sửa.
{{< /blocks/products/pf/agp/step-autogen >}}
