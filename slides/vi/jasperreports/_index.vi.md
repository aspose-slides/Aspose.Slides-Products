...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">JasperReports nâng cao cho các tính năng xuất bản trình bày</h2>

<p> </p>

<div class="col-lg-4"><em class="fa fa-file-powerpoint-o  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Tạo báo cáo tài khoản và xuất chúng sang bản trình bày Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-bar-chart   ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Tạo báo cáo biểu đồ và xuất chúng sang bản trình bày Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-pie-chart ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Tạo nhiều báo cáo biểu đồ trục và xuất sang bản trình bày Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-file-text ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Tạo hình ảnh, văn bản, dòng và xuất các báo cáo này sang bản trình bày Microsoft PowerPoint</p>
