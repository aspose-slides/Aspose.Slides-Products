...
description: Hợp nhất TIFF thành PDF trong C#. Sử dụng API thư viện .NET để kết hợp TIFF và PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Hợp nhất TIFF thành PDF trong C#" h2="API .NET đa nền tảng mạnh mẽ để hợp nhất các tệp TIFF thành PDF bằng mã C# trên các Nền tảng NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Hợp nhất TIFF thành PDF bằng Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/vi/net/) là thư viện .NET mạnh mẽ được sử dụng để tạo, chuyển đổi, hợp nhất và thao tác với bản trình bày, tệp PDF, hình ảnh, và các tập tin khác. Khi bạn hợp nhất TIFF thành PDF, bạn đang kết hợp các hình ảnh một cách hiệu quả để thu được một tệp PDF duy nhất.
...
Sử dụng [**Aspose.Slides for .NET**](https://products.aspose.com/slides/vi/net/), bạn có thể hợp nhất TIFF thành PDF một cách nhanh chóng chỉ với một vài dòng mã
