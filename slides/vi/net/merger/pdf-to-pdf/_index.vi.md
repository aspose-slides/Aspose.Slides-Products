...
url: /vi/net/merger/pdf-to-pdf/
keywords: Hợp nhất PDF, PDF thành PDF, Tham gia PDF, Kết hợp PDF, API C#, Thư viện .NET
description: Hợp nhất PDF thành PDF trong C#. Sử dụng API thư viện .NET để kết hợp các tệp PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Hợp nhất PDF trong C#" h2="API .NET đa nền tảng mạnh mẽ để hợp nhất các tệp PDF bằng mã C# trên Nền tảng NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Hợp nhất PDF sang PDF bằng Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/vi/net/) là một thư viện .NET mạnh mẽ được sử dụng để tạo, chuyển đổi, hợp nhất và thao tác với các bản trình bày, tệp PDF và các nội dung khác các tài liệu. Khi bạn hợp nhất PDF thành PDF, bạn đang kết hợp hiệu quả các trang từ 2 tài liệu để có được một tệp PDF. Aspose.Slides cho phép bạn hợp nhất các tệp PDF theo nhiều cách khác nhau. Bạn có thể hợp nhất các tệp PDF với tất cả các hình dạng, kiểu dáng, văn bản, định dạng, v.v.
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất PDF sang PDF trong C#" %}}
Sử dụng [**Aspose.Slides for .NET**](https://products.aspose.com/slides/vi/net/), bạn có thể hợp nhất các tệp PDF một cách nhanh chóng chỉ với một vài dòng mã

{{% blocks/products/pf/agp/code-block title="Mã C# để hợp nhất PDF thành PDF" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PDF trong C#" >}}
