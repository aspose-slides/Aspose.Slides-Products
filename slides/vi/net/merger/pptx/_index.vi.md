---
title: Hợp nhất các tệp PPTX qua .NET
weight: 3150
url: /vi/net/merger/pptx/ 
description: Mã nguồn C # để kết hợp các tài liệu PPTX trên .NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các định dạng PPTX trong C #" h2="Hợp nhất tài liệu PPTX nguyên bản và hiệu suất cao bằng cách sử dụng Aspose.Slides phía máy chủ cho các API .NET mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPTX" >}}
...
Tải tất cả các tệp PPTX với đường dẫn đầy đủ.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Gọi phương thức Save () và chuyển tên tệp (đường dẫn đầy đủ) và định dạng (PPTX) làm tham số.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Giờ đây, bạn có thể mở và sử dụng tệp PPTX trong Microsoft Office, Adobe PDF hoặc bất kỳ chương trình tương thích nào khác.
{{< /blocks/products/pf/agp/step-autogen >}}
