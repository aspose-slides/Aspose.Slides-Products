...
url: /vi/net/merger/html-to-image/
keywords: Hợp nhất HTML thành hình ảnh, HTML thành hình ảnh, Tham gia HTML, Kết hợp HTML, Hình ảnh, API C#, Thư viện .NET
description: Hợp nhất HTML với hình ảnh trong C#. Sử dụng API thư viện .NET để kết hợp HTML với hình ảnh
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Hợp nhất hình ảnh trong C#" h2="API .NET đa nền tảng mạnh mẽ để hợp nhất HTML với hình ảnh bằng cách sử dụng mã C# trên Nền tảng NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Hợp nhất HTML với hình ảnh bằng Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/vi/net/) là một thư viện .NET mạnh mẽ được sử dụng để hợp nhất và thao tác với các bản trình bày, tài liệu HTML và các tệp khác. Khi bạn hợp nhất HTML với hình ảnh, bạn đang kết hợp hiệu quả các nội dung trong tài liệu HTML để có được một hình ảnh duy nhất. 
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất HTML thành hình ảnh trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã C# để hợp nhất HTML với hình ảnh" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất HTML với hình ảnh trong C#" >}}
