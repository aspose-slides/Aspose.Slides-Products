...
url: /vi/net/merger/image-to-bmp/
keywords: Hình ảnh thành BMP, Hợp nhất hình ảnh thành BMP, Nối hình ảnh thành BMP, Kết hợp hình ảnh, Hình ảnh, BMP, API C#, Thư viện .NET
description: Hợp nhất hình ảnh thành BMP trong C#. Sử dụng API thư viện .NET để kết hợp Hình ảnh
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Hợp nhất hình ảnh thành BMP trong C#" h2="API .NET đa nền tảng mạnh mẽ để hợp nhất các tệp Hình ảnh với BMP bằng mã C# trên các Nền tảng NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Hợp nhất hình ảnh thành BMP bằng Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/vi/net/) là thư viện .NET mạnh mẽ được sử dụng để tạo, chuyển đổi, hợp nhất và thao tác với bản trình bày, tệp PDF, hình ảnh, và các tập tin khác. Khi bạn hợp nhất hình ảnh với BMP, bạn đang kết hợp các hình ảnh một cách hiệu quả để có được một tệp BMP.
...
Sử dụng [**Aspose.Slides for .NET**](https://products.aspose.com/slides/vi/net/), bạn có thể hợp nhất hình ảnh với BMP một cách nhanh chóng chỉ bằng một vài dòng mã
