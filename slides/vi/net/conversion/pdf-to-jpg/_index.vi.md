---
title: Chuyển đổi PDF sang JPG trong C #
weight: 70
url: /vi/net/conversion/pdf-to-jpg/ 
keywords: PDF sang JPG, Chuyển đổi PDF sang JPG, C # API, Thư viện .NET, PDF, JPG
description: Chuyển đổi PDF sang JPG trong C #. Sử dụng API thư viện .NET để chuyển đổi các trang PDF sang hình ảnh JPG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi PDF sang JPG trong C #" h2="PowerPoint .NET API để chuyển đổi tài liệu PDF sang hình ảnh JPG trên NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển PDF sang JPG trong C #" %}}

Làm cách nào để chuyển đổi PDF sang JPG trong mã?

Sử dụng [** Aspose.Slides for .NET **](https://products.aspose.com/slides/vi/net/), bất kỳ nhà phát triển hoặc ứng dụng nào cũng có thể chuyển đổi định dạng PDF sang JPG chỉ với một vài dòng mã C #.

Là một API xử lý tài liệu hiện đại, Aspose.Slides for .NET xuất các trang PDF sang JPG một cách nhanh chóng. Thư viện Aspose PowerPoint cho phép bạn chuyển đổi PDF sang JPG và nhiều định dạng tệp khác
...
{{< blocks/products/pf/agp/feature-section-col title="Cách chuyển PDF sang JPG trong C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Các nhà phát triển và ứng dụng có thể chuyển đổi PDF sang JPG theo cách này:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Gọi phương thức lưu để lưu các trang chiếu dưới dạng ảnh JPG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Trước khi bạn chạy mã C # chuyển đổi PDF sang JPG, máy của bạn phải có các điều kiện tiên quyết sau:
...
{{% blocks/products/pf/agp/code-block title="Mã C # để chuyển đổi PDF sang JPG" offSpacer="" %}}
