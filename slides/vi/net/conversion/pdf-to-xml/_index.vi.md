---
title: Chuyển đổi PDF sang XML trong C #
weight: 120
url: /vi/net/conversion/pdf-to-xml/ 
keywords: PDF sang XML, Chuyển đổi PDF sang XML, C # API, Thư viện .NET, PDF, XML
description: Chuyển đổi PDF sang XML trong C #. Sử dụng API thư viện .NET để chuyển đổi các trang PDF sang tệp XML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi PDF sang XML trong C #" h2="PowerPoint .NET API để chuyển đổi tài liệu PDF sang tệp XML trên NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển PDF sang XML trong C #" %}}

Làm cách nào để chuyển đổi PDF sang XML trong mã?

Sử dụng [** Aspose.Slides for .NET **](https://products.aspose.com/slides/vi/net/), bất kỳ nhà phát triển hoặc ứng dụng nào cũng có thể chuyển đổi tệp PDF sang XML chỉ với một vài dòng mã C #.
...
{{< blocks/products/pf/agp/feature-section-col title="Cách chuyển PDF sang XML trong C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Các nhà phát triển và ứng dụng có thể chuyển đổi PDF sang XML theo cách này:" >}}
...
{{% blocks/products/pf/agp/code-block title="Mã C # để chuyển đổi PDF sang XML" offSpacer="" %}}
