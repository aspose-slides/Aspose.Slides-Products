...
description: Chuyển đổi hình ảnh sang PPTX trong C#. Sử dụng API thư viện .NET để chuyển ảnh sang PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Chuyển đổi hình ảnh sang PPTX trong C#" h2="API .NET đa nền tảng mạnh mẽ để chuyển đổi hình ảnh sang PPTX bằng mã C# trên Nền tảng NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Chuyển đổi hình ảnh sang PPTX bằng Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/vi/net/) là một thư viện .NET mạnh mẽ được sử dụng để tạo, chuyển đổi và thao tác với các bản trình bày PowerPoint, PDF, tài liệu HTML, và các tập tin khác. Khi bạn chuyển đổi hình ảnh sang PPTX, về cơ bản, bạn đang tạo bản trình bày PowerPoint có chứa các trang chiếu dựa trên những hình ảnh đó.
...
{{% blocks/products/pf/agp/code-block title="Mã C# để chuyển đổi hình ảnh sang PPTX" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Cách chuyển đổi hình ảnh sang PPTX trong C#" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/vi/net/conversion/image-to-ppt/" name="IMAGE TO PPT" >}}
