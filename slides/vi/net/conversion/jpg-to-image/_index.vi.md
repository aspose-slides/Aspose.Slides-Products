---
title: Chuyển đổi JPG sang Hình ảnh trong C#
weight: 210
url: /vi/net/conversion/jpg-to-image/ 
keywords: JPG sang Hình ảnh, Chuyển đổi JPG sang Hình ảnh, C# API, Thư viện .NET
description: Chuyển đổi JPG sang Hình ảnh trong C#. Sử dụng API thư viện .NET để chuyển đổi JPG sang hình ảnh ở các định dạng khác nhau.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi JPG sang Hình ảnh trong C#" h2="PowerPoint .NET API để chuyển đổi ảnh JPG thành tệp Hình ảnh trên Nền tảng NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi JPG sang Hình ảnh trong C#" %}}

Làm cách nào để chuyển đổi JPG sang Image trong mã?

Sử dụng [** Aspose.Slides for .NET **](https://products.aspose.com/slides/vi/net/), bất kỳ nhà phát triển hoặc ứng dụng nào cũng có thể chuyển đổi JPG sang Image chỉ với một vài dòng mã C#.

Là một API xử lý tài liệu hiện đại, Aspose.Slides for .NET xuất các tệp JPG sang hình ảnh ở các định dạng khác một cách nhanh chóng. Thư viện Aspose PowerPoint cho phép bạn chuyển đổi JPG sang Image và nhiều định dạng tệp tin khác
...
{{< blocks/products/pf/agp/feature-section-col title="Làm thế nào để chuyển đổi JPG sang hình ảnh trong C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Các nhà phát triển và ứng dụng có thể chuyển đổi JPG sang Hình ảnh theo cách này:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Trước khi bạn chạy mã C# chuyển đổi JPG sang Image, máy của bạn phải có các điều kiện tiên quyết sau:
...
{{% blocks/products/pf/agp/code-block title="Mã C# để chuyển đổi JPG sang Hình ảnh" offSpacer="" %}}
