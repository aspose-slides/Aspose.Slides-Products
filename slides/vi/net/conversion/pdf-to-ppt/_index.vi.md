---
title: Chuyển đổi PDF sang PPT trong C#
url: /vi/net/conversion/pdf-to-ppt/
keywords: Chuyển đổi PDF sang PPT, PDF sang PPT, PowerPoint, PDF, PPT, C# API, Thư viện .NET
description: Chuyển đổi PDF sang PPT trong C#. Sử dụng API thư viện .NET để chuyển đổi PDF sang PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Chuyển đổi PDF sang PPT trong C#" h2="API .NET đa nền tảng mạnh mẽ để chuyển đổi PDF sang PPT bằng mã C# trên Nền tảng NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Chuyển đổi PDF sang PPT bằng Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/vi/net/) là một thư viện .NET mạnh mẽ được sử dụng để tạo, chuyển đổi và thao tác với các bản trình bày PowerPoint, PDF, tài liệu HTML, và các tập tin khác. Khi bạn chuyển đổi PDF sang PPT, về cơ bản, bạn đang di chuyển nội dung trên các trang PDF sang các trang chiếu trong bản trình bày PowerPoint.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Chuyển đổi PDF sang PPT trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã C# để chuyển đổi PDF sang PPT" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Cách chuyển đổi PDF sang PPT trong C#" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Tải tệp PDF bạn muốn chuyển đổi sang PPT.
{{< /blocks/products/pf/agp/step-autogen >}}
