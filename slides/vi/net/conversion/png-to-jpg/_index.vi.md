...
title: Chuyển đổi PNG sang JPG trong C#
weight: 230
url: /vi/net/conversion/png-to-jpg/ 
keywords: PNG sang JPG, Chuyển đổi PNG sang JPG, C# API, Thư viện .NET
description: Chuyển đổi PNG sang JPG trong C#. Sử dụng API thư viện .NET để chuyển đổi tệp PNG sang JPG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi PNG sang JPG trong C#" h2="PowerPoint .NET API để chuyển đổi tệp hình ảnh PNG sang JPG trên Nền tảng NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi PNG sang JPG trong C#" %}}

Làm cách nào để chuyển đổi PNG sang JPG trong mã?

Sử dụng [** Aspose.Slides for .NET **](https://products.aspose.com/slides/vi/net/), bất kỳ nhà phát triển hoặc ứng dụng nào cũng có thể chuyển đổi PNG sang JPG chỉ với một vài dòng mã C#.

Là một API xử lý tài liệu hiện đại, Aspose.Slides for .NET xuất các tệp PNG sang JPG một cách nhanh chóng. Thư viện Aspose PowerPoint cho phép bạn chuyển đổi PNG sang JPG và hình ảnh ở các định dạng khác.
...
{{< blocks/products/pf/agp/feature-section-col title="Cách chuyển đổi PNG sang JPG trong C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Các nhà phát triển và ứng dụng có thể chuyển đổi PNG sang JPG theo cách này:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Trước khi bạn chạy mã C# chuyển đổi PNG sang JPG, máy của bạn phải có các điều kiện tiên quyết sau:
...
{{% blocks/products/pf/agp/code-block title="Mã C# để chuyển đổi PNG sang JPG" offSpacer="" %}}
