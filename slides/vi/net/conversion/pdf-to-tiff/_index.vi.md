...
title: Chuyển đổi PDF sang TIFF trong C #
weight: 110
url: /vi/net/conversion/pdf-to-tiff/ 
keywords: PDF sang TIFF, Chuyển đổi PDF sang TIFF, C # API, Thư viện .NET, PDF, TIFF
description: Chuyển đổi PDF sang TIFF trong C #. Sử dụng API thư viện .NET để chuyển đổi các trang PDF sang hình ảnh TIFF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi PDF sang TIFF trong C #" h2="PowerPoint .NET API để chuyển đổi tài liệu PDF sang hình ảnh TIFF trên NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển PDF sang TIFF trong C #" %}}

Làm cách nào để chuyển đổi PDF sang TIFF trong mã?

Sử dụng [** Aspose.Slides for .NET **](https://products.aspose.com/slides/vi/net/), bất kỳ nhà phát triển hoặc ứng dụng nào cũng có thể chuyển đổi định dạng PDF sang TIFF chỉ với một vài dòng mã C #.

Là một API xử lý tài liệu hiện đại, Aspose.Slides for .NET xuất các trang PDF sang TIFF một cách nhanh chóng. Thư viện Aspose PowerPoint cho phép bạn chuyển đổi PDF sang TIFF và nhiều định dạng tệp khác
...
{{< blocks/products/pf/agp/feature-section-col title="Cách chuyển PDF sang TIFF trong C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Các nhà phát triển và ứng dụng có thể chuyển đổi PDF sang TIFF theo cách này:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Gọi phương thức lưu để lưu các trang chiếu dưới dạng ảnh TIFF.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Trước khi bạn chạy mã C # chuyển đổi PDF sang TIFF, máy của bạn phải có các điều kiện tiên quyết sau:
...
{{% blocks/products/pf/agp/code-block title="Mã C # để chuyển đổi PDF sang TIFF" offSpacer="" %}}
