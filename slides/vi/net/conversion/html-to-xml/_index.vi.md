...
title: Chuyển đổi HTML sang XML trong C #
weight: 170
url: /vi/net/conversion/html-to-xml/ 
keywords: HTML sang XML, Chuyển đổi HTML sang XML, C # API, Thư viện .NET, HTML, XML
description: Chuyển đổi HTML sang XML trong C #. Sử dụng API thư viện .NET để chuyển đổi tài liệu HTML sang tệp XML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi HTML sang XML trong C #" h2="PowerPoint .NET API để chuyển đổi tài liệu HTML sang tệp XML trên Nền tảng NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi HTML sang XML trong C #" %}}

Làm cách nào để chuyển đổi HTML sang XML trong mã?

Sử dụng [** Aspose.Slides cho .NET **](https://products.aspose.com/slides/vi/net/), bất kỳ nhà phát triển hoặc ứng dụng nào cũng có thể chuyển đổi tệp HTML sang XML chỉ với một vài dòng mã C #.

Là một API xử lý tài liệu hiện đại, Aspose.Slides for .NET xuất nội dung trong HTML sang XML một cách nhanh chóng. Thư viện Aspose PowerPoint cho phép bạn chuyển đổi HTML sang XML và nhiều định dạng tệp khác.
...
{{< blocks/products/pf/agp/feature-section-col title="Cách chuyển đổi HTML sang XML trong C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Các nhà phát triển và ứng dụng có thể chuyển đổi HTML sang XML theo cách này:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Thêm các trang trình bày dựa trên nội dung của tệp HTML.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Lưu các trang chiếu sang XML.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Trước khi bạn chạy mã C # chuyển đổi HTML sang XML, máy của bạn phải có các điều kiện tiên quyết sau:
...
{{% blocks/products/pf/agp/code-block title="Mã C # để chuyển đổi HTML sang XML" offSpacer="" %}}
