...
title: Chuyển đổi hình ảnh sang JPG trong C#
weight: 200
url: /vi/net/conversion/image-to-jpg/ 
keywords: Hình ảnh sang JPG, Chuyển đổi Hình ảnh sang JPG, C# API, Thư viện .NET, Hình ảnh, JPG
description: Chuyển đổi hình ảnh sang JPG trong C#. Sử dụng API thư viện .NET để chuyển đổi Hình ảnh sang ảnh JPG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi hình ảnh sang JPG trong C#" h2="PowerPoint .NET API để chuyển đổi Hình ảnh sang ảnh JPG trên Nền tảng NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi hình ảnh sang JPG trong C#" %}}

Làm cách nào để chuyển đổi Hình ảnh sang JPG trong mã?

Sử dụng [** Aspose.Slides cho .NET **](https://products.aspose.com/slides/vi/net/), bất kỳ nhà phát triển hoặc ứng dụng nào cũng có thể chuyển đổi một hình ảnh thành một hình ảnh JPG chỉ với một vài dòng mã C# .

Là một API xử lý tài liệu hiện đại, Aspose.Slides for .NET xuất hình ảnh ở các định dạng phổ biến sang JPG một cách nhanh chóng. Thư viện Aspose PowerPoint cho phép bạn chuyển đổi hình ảnh sang JPG và nhiều định dạng hình ảnh khác.
...
{{< blocks/products/pf/agp/feature-section-col title="Cách chuyển đổi hình ảnh sang JPG trong C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Các nhà phát triển và ứng dụng có thể chuyển đổi Hình ảnh sang JPG theo cách này:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Trước khi bạn chạy mã C# chuyển đổi Hình ảnh sang JPG, máy của bạn phải có các điều kiện tiên quyết sau:
...
{{% blocks/products/pf/agp/code-block title="Mã C# để chuyển đổi Hình ảnh sang JPG" offSpacer="" %}}
