---
title: Chuyển đổi HTML sang PDF trong C#
weight: 40
url: /vi/net/conversion/html-to-pdf/ 
keywords: HTML sang PDF, Chuyển đổi HTML sang PDF, C# API, Thư viện .NET, HTML, PDF
description: Chuyển đổi HTML sang PDF trong C#. Sử dụng API thư viện .NET để chuyển đổi các trang HTML sang tài liệu PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi HTML sang PDF trong C#" h2="PowerPoint .NET API để chuyển đổi các trang HTML sang tài liệu PDF trên NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi HTML sang PDF trong C#" %}}

Làm cách nào để chuyển đổi HTML sang PDF theo chương trình?

Sử dụng [** Aspose.Slides for .NET **](https://products.aspose.com/slides/vi/net/), bất kỳ nhà phát triển hoặc ứng dụng nào cũng có thể chuyển đổi định dạng HTML sang PDF chỉ với một vài dòng mã C#.

Là một API xử lý tài liệu hiện đại, Aspose.Slides for .NET tạo các tệp PDF từ các trang HTML một cách nhanh chóng. Thư viện Aspose PowerPoint cho phép bạn chuyển đổi HTML sang PDF và nhiều định dạng tệp khác
...
{{< blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi HTML sang PDF trong C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Các nhà phát triển và ứng dụng có thể chuyển đổi HTML sang PDF theo cách này:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Trước khi bạn chạy mã C# chuyển đổi HTML sang PDF, máy của bạn phải có các điều kiện tiên quyết sau:
...
{{% blocks/products/pf/agp/code-block title="Mã C# để chuyển đổi HTML sang PDF" offSpacer="" %}}
