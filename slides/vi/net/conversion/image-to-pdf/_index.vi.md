---
title: Chuyển đổi hình ảnh sang PDF trong C#
weight: 30
url: /vi/net/conversion/image-to-pdf/ 
keywords: Hình ảnh sang PDF, Chuyển đổi hình ảnh sang PDF, API C#, Thư viện .NET, Hình ảnh, JPG, PNG, PDF
description: Chuyển đổi hình ảnh sang PDF trong C#. Sử dụng API thư viện .NET để chuyển đổi Hình ảnh sang tài liệu PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi hình ảnh sang PDF trong C#" h2="PowerPoint .NET API để chuyển đổi hình ảnh sang tài liệu PDF trên NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi hình ảnh sang PDF trong C#" %}}

Làm cách nào để chuyển đổi hình ảnh sang PDF theo lập trình?

Sử dụng [** Aspose.Slides for .NET **](https://products.aspose.com/slides/vi/net/), bất kỳ nhà phát triển hoặc ứng dụng nào cũng có thể chuyển đổi hình ảnh sang định dạng PDF chỉ với một vài dòng mã C#.

Là một API xử lý tài liệu hiện đại, Aspose.Slides for .NET tạo tệp PDF từ hình ảnh JPG hoặc PNG một cách nhanh chóng. Thư viện Aspose PowerPoint cho phép bạn chuyển đổi Hình ảnh sang PDF và nhiều định dạng tệp tin khác
...
{{< blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi hình ảnh sang PDF trong C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Các nhà phát triển và ứng dụng có thể chuyển đổi Hình ảnh sang PDF theo cách này:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Gọi phương thức lưu để lưu tệp dưới dạng PDF.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Trước khi bạn chạy mã C# chuyển đổi hình ảnh sang PDF, máy của bạn phải có các điều kiện tiên quyết sau:
...
{{% blocks/products/pf/agp/code-block title="Mã C# để chuyển đổi Hình ảnh sang PDF" offSpacer="" %}}
