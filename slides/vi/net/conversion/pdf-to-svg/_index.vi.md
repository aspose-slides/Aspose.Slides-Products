---
title: Chuyển đổi PDF sang SVG trong C #
weight: 100
url: /vi/net/conversion/pdf-to-svg/ 
keywords: PDF sang SVG, Chuyển đổi PDF sang SVG, C # API, Thư viện .NET, PDF, SVG
description: Chuyển đổi PDF sang SVG trong C #. Sử dụng API thư viện .NET để chuyển đổi các trang PDF sang hình ảnh SVG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi PDF sang SVG trong C #" h2="PowerPoint .NET API để chuyển đổi tài liệu PDF sang ảnh SVG trên NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi PDF sang SVG trong C #" %}}

Làm cách nào để chuyển đổi PDF sang SVG trong mã?

Sử dụng [** Aspose.Slides for .NET **](https://products.aspose.com/slides/vi/net/), bất kỳ nhà phát triển hoặc ứng dụng nào cũng có thể chuyển đổi PDF sang định dạng SVG chỉ với một vài dòng mã C #.

Là một API xử lý tài liệu hiện đại, Aspose.Slides for .NET xuất các trang PDF sang SVG một cách nhanh chóng. Thư viện Aspose PowerPoint cho phép bạn chuyển đổi PDF sang SVG và nhiều định dạng tệp khác
...
{{< blocks/products/pf/agp/feature-section-col title="Cách chuyển đổi PDF sang SVG trong C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Các nhà phát triển và ứng dụng có thể chuyển đổi PDF sang SVG theo cách này:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Lưu các trang chiếu dưới dạng ảnh SVG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Trước khi bạn chạy mã C # chuyển đổi PDF sang SVG, máy của bạn phải có các điều kiện tiên quyết sau:
...
{{% blocks/products/pf/agp/code-block title="Mã C # để chuyển đổi PDF sang SVG" offSpacer="" %}}
