...
keywords: PDF sang hình ảnh, chuyển đổi PDF sang hình ảnh, API C #, Thư viện .NET, PDF, Hình ảnh
description: Chuyển đổi PDF sang hình ảnh trong C #. Sử dụng API thư viện .NET để chuyển đổi các trang PDF thành Hình ảnh
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi PDF sang hình ảnh trong C #" h2="PowerPoint .NET API để chuyển đổi tài liệu PDF sang Hình ảnh trên Nền tảng NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển PDF sang hình ảnh trong C #" %}}

Làm cách nào để chuyển đổi PDF sang Hình ảnh trong mã?

Sử dụng [** Aspose.Slides for .NET **](https://products.aspose.com/slides/vi/net/), bất kỳ nhà phát triển hoặc ứng dụng nào cũng có thể chuyển đổi PDF sang tệp hình ảnh chỉ với một vài dòng mã C #.

Là một API xử lý tài liệu hiện đại, Aspose.Slides for .NET xuất các trang PDF sang định dạng Hình ảnh một cách nhanh chóng. Thư viện Aspose PowerPoint cho phép bạn chuyển đổi PDF sang Hình ảnh và nhiều định dạng tệp tin khác.
...
{{< blocks/products/pf/agp/feature-section-col title="Cách chuyển PDF sang hình ảnh trong C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Các nhà phát triển và ứng dụng có thể chuyển đổi PDF thành Hình ảnh theo cách này:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Gọi phương thức lưu để lưu các trang chiếu dưới dạng hình ảnh.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Trước khi bạn chạy mã C # chuyển đổi PDF sang Hình ảnh, máy của bạn phải có các điều kiện tiên quyết sau:
...
{{% blocks/products/pf/agp/code-block title="Mã C # để chuyển đổi PDF sang Hình ảnh" offSpacer="" %}}
