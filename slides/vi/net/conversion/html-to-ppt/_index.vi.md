---
title: Chuyển đổi HTML sang PPT trong C#
url: /vi/net/conversion/html-to-ppt/
keywords: Chuyển đổi HTML sang PPT, HTML sang PPT, PowerPoint, HTML, PPT, C# API, Thư viện .NET
description: Chuyển đổi HTML sang PPT trong C#. Sử dụng API thư viện .NET để chuyển HTML sang PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Chuyển đổi HTML sang PPT trong C#" h2="API .NET đa nền tảng mạnh mẽ để chuyển đổi HTML sang PPT bằng mã C# trên Nền tảng NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Chuyển đổi HTML sang PPT bằng Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/vi/net/) là một thư viện .NET mạnh mẽ được sử dụng để tạo, chuyển đổi và thao tác với các bản trình bày PowerPoint, PDF, tài liệu HTML, và các tập tin khác. Khi bạn chuyển đổi HTML sang PPT, về cơ bản, bạn đang di chuyển nội dung trong tài liệu HTML sang các trang chiếu trong bản trình bày PowerPoint.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Chuyển đổi HTML sang PPT trong C#" %}}
