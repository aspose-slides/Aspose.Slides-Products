---
title: Chuyển đổi PNG sang PPT trong C#
url: /vi/net/conversion/png-to-ppt/
keywords: Chuyển đổi PNG sang PPT, PNG sang PPT, PowerPoint, PNG, PPT, C# API, Thư viện .NET
description: Chuyển đổi PNG sang PPT trong C#. Sử dụng API thư viện .NET để chuyển ảnh PNG sang PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Chuyển đổi PNG sang PPT trong C#" h2="API .NET đa nền tảng mạnh mẽ để chuyển đổi PNG sang PPT bằng mã C# trên Nền tảng NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Chuyển đổi PNG sang PPT bằng Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/vi/net/) là một thư viện .NET mạnh mẽ được sử dụng để tạo, chuyển đổi và thao tác với các bản trình bày PowerPoint, PDF, tài liệu HTML, và các tập tin khác. Khi bạn chuyển đổi PNG sang PPT, về cơ bản, bạn đang tạo bản trình bày PowerPoint có chứa các trang chiếu dựa trên hình ảnh PNG.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Chuyển đổi PNG sang PPT trong C#" %}}
Sử dụng [**Aspose.Slides for .NET**](https://products.aspose.com/slides/vi/net/), bạn có thể chuyển đổi hình ảnh PNG sang bản trình bày PowerPoint chỉ bằng một vài dòng mã:

{{% blocks/products/pf/agp/code-block title="Mã C# để chuyển đổi PNG sang PPT" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Cách chuyển đổi PNG sang PPT trong C#" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Tải hình ảnh PNG bạn muốn chuyển đổi sang PPT.
{{< /blocks/products/pf/agp/step-autogen >}}
