...
url: /vi/net/conversion/jpg-to-pptx/
keywords: Chuyển đổi JPG sang PPTX, JPG sang PPTX, PowerPoint, JPG, PPTX, C# API, Thư viện .NET
description: Chuyển đổi JPG sang PPTX trong C#. Sử dụng API thư viện .NET để chuyển ảnh JPG sang PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Chuyển đổi JPG sang PPTX trong C#" h2="API .NET đa nền tảng mạnh mẽ để chuyển đổi JPG sang PPTX bằng mã C# trên Nền tảng NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Chuyển đổi JPG sang PPTX bằng Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/vi/net/) là một thư viện .NET mạnh mẽ được sử dụng để tạo, chuyển đổi và thao tác với các bản trình bày PowerPoint, PDF, tài liệu HTML, và các tập tin khác. Khi bạn chuyển đổi JPG sang PPTX, về cơ bản, bạn đang tạo bản trình bày PowerPoint có chứa các trang chiếu dựa trên hình ảnh JPG.
