---
title: Xóa chú thích ODP qua .NET
weight: 1370
url: /vi/net/annotation/odp/ 
description: Mã nguồn C# để xóa chú thích định dạng ODP trên .NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Xóa nhận xét & tác giả nhận xét khỏi ODP qua C#" h2="Xây dựng ứng dụng .NET của riêng bạn để thao tác nhận xét và tác giả trong tệp tài liệu bằng cách sử dụng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách chú thích tệp ODP bằng C#" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Xóa nhận xét khỏi ODP qua C#" >}}
...
Tải ODP với một phiên bản của lớp Trình bày
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Xóa chú thích khỏi ODP - C#" offSpacer="" %}}
