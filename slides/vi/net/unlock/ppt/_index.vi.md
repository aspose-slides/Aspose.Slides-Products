---
title: Mở khóa tài liệu PPT qua .NET
weight: 8650
url: /vi/net/unlock/ppt/ 
description: Mã nguồn C# để mở khóa tệp PPT được bảo vệ bằng mật khẩu trên Nền tảng .NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Mở khóa Bản trình bày PPT qua C#" h2="Loại bỏ bảo vệ khỏi PPT bằng thư viện .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách mở khóa tệp PPT bằng C#" %}}

 Để xóa tệp PPT bảo vệ, chúng tôi sẽ sử dụng
...
{{< blocks/products/pf/agp/feature-section-col title="Mở khóa PPT qua C#" >}}
...
Tải PPT bị khóa với một phiên bản của Bản trình bày
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Kiểm tra bảo vệ bằng cách sử dụng thuộc tính kiểu boolean IProtectionManager.IsWriteProtected
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Loại bỏ bảo vệ bằng phương pháp IProtectionManager.RemoveWriteProtection
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/vi/net/unlock/odp/" name="ODP" description="Định dạng bản trình bày OpenDocument" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/vi/net/unlock/pptx/" name="PPTX" description="Định dạng bản trình bày XML mở" >}}
