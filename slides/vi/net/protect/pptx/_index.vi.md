---
title: Bảo vệ và khóa tài liệu PPTX qua .NET
weight: 5000
url: /vi/net/protect/pptx/ 
description: Mã nguồn C # để khóa tệp PPTX bằng mật khẩu trên .NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Mã hóa tệp PPTX qua C #" h2="Các bản trình bày PowerPoint được bảo vệ bằng mật khẩu bao gồm định dạng PPTX sử dụng Thư viện .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách bảo vệ tệp PPTX bằng C #" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Bảo vệ PPTX qua C #" >}}
...
Tải PPTX với một phiên bản của Bản trình bày
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/vi/net/protect/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
