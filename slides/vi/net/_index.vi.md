...
<h2 class="h2title">Kiểm soát hoàn toàn các phần tử trang chiếu PowerPoint</h2>

<p>Aspose.Slides for .NET có thể xử lý tất cả các phần tử của slide thuyết trình bao gồm hộp văn bản, bảng, hình chữ nhật, hình elip, polyline, hình dạng tự động, khung ảnh, khung âm thanh, khung video & khung đối tượng OLE. API cung cấp tập hợp các lớp được thiết kế tốt cho phép bạn thao tác toàn diện từng phần tử này.</p>
...
<h2 class="h2title">Hỗ trợ cho Office Open XML</h2>

<p>Office OpenXML (OOXML) là định dạng dựa trên XML đã được đưa vào Microsoft Office 2007.</p>

<p>PresentationML (OOXML, PPTX) là ngôn ngữ đánh dấu được Microsoft Office PowerPoint 2007 sử dụng để lưu trữ các tài liệu của nó. Aspose.Slides for .NET hỗ trợ rộng rãi việc tạo, đọc, thao tác và viết các tài liệu PresentationML.</p>
