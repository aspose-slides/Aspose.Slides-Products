...
title: Chuyển đổi PPSX sang PDF bằng Python
weight: 2070
url: /vi/python-net/conversion/ppsx-to-pdf/ 
keywords: "Convert, PowerPoint, PPSX, PDF, Presentation, Python"
description: Mã mẫu để chuyển đổi PPSX sang PDF Python. Sử dụng PowerPoint Python API để chuyển đổi hàng loạt tệp PPSX sang tệp PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi PPSX sang PDF bằng Python" h2="Thư viện PowerPoint Python mạnh mẽ để chuyển đổi PPSX sang PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi PPSX sang PDF bằng Python" %}}

Bạn cần chuyển đổi tệp PPSX sang PDF theo lập trình? Sử dụng [* Aspose.Slides cho Python qua .NET *](https://products.aspose.com/slides/vi/python-net/), bất kỳ nhà phát triển nào cũng có thể chuyển đổi PPSX sang định dạng PDF chỉ với một vài dòng mã Python.

Là một API xử lý bản trình bày hiện đại, Aspose.Slides for Python tạo PDF từ PPSX một cách nhanh chóng. Kiểm tra chất lượng của chuyển đổi PPSX sang PDF ngay trong [trình duyệt] của bạn (https://products.aspose.app/slides/conversion). Thư viện PPTX của Aspose PowerPoint cho phép bạn chuyển đổi các tệp PPSX sang nhiều định dạng phổ biến.
...
{{< blocks/products/pf/agp/feature-section-col title="Cách chuyển đổi PPSX sang PDF bằng Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để chuyển đổi tệp PPSX sang PDF bằng Python." >}}
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị Chuyển đổi PPSX sang PDF Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu PPSX dưới dạng PDF bằng Python" %}}
Sử dụng ứng dụng miễn phí để xem trình diễn về quy trình chuyển đổi PPSX sang PDF. 
{{% /blocks/products/pf/agp/content %}}
