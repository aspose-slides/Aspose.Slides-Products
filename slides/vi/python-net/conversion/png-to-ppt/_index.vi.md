---
title: Chuyển đổi PNG sang PPT trong Python
url: /vi/python-net/conversion/png-to-ppt/
keywords: Chuyển đổi PNG sang PPT, PNG sang PPT, PowerPoint, PNG, PPT, API Python, Thư viện Python
description: Chuyển đổi PNG sang PPT trong Python. Sử dụng API thư viện Python để chuyển ảnh PNG sang PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Chuyển đổi PNG sang PPT trong Python" h2="API Python đa nền tảng mạnh mẽ để chuyển đổi PNG sang PPT bằng mã Python" >}}

{{% blocks/products/pf/feature-page-section h2="Chuyển đổi PNG sang PPT bằng Aspose.Slides" %}}

[**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/vi/python-net/) là một thư viện Python mạnh mẽ dùng để tạo, chuyển đổi và thao tác với các bản trình bày PowerPoint, PDF, Tài liệu HTML và các tệp khác. Khi bạn chuyển đổi PNG sang PPT, về cơ bản, bạn đang tạo bản trình bày PowerPoint có chứa các trang chiếu dựa trên hình ảnh PNG.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Chuyển đổi PNG sang PPT trong Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để chuyển đổi PNG sang PPT" offSpacer="true" %}}
```py
...
{{< blocks/products/pf/feature-page-section  h2="Cách chuyển đổi PNG sang PPT trong Python" >}}
