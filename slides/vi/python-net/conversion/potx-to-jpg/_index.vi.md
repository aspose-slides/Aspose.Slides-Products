---
title: Chuyển đổi POTX sang JPG bằng Python
weight: 1380
url: /vi/python-net/conversion/potx-to-jpg/ 
keywords: "Convert, PowerPoint, POTX, JPG, Presentation, Python"
description: Mã mẫu để chuyển đổi POTX sang JPG Python. Sử dụng PowerPoint Python API để chuyển đổi hàng loạt tệp POTX sang tệp JPG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi POTX sang JPG bằng Python" h2="Thư viện PowerPoint Python mạnh mẽ để chuyển đổi POTX sang JPG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi POTX sang JPG bằng Python" %}}

Bạn cần chuyển đổi các tệp POTX sang JPG theo lập trình? Sử dụng [* Aspose.Slides cho Python qua .NET *](https://products.aspose.com/slides/vi/python-net/), bất kỳ nhà phát triển nào cũng có thể chuyển đổi định dạng POTX sang JPG chỉ với một vài dòng mã Python.

Là một API xử lý bản trình bày hiện đại, Aspose.Slides for Python tạo JPG từ POTX một cách nhanh chóng. Kiểm tra chất lượng của chuyển đổi POTX sang JPG ngay trong [trình duyệt] của bạn (https://products.aspose.app/slides/conversion/ppt-to-jpg). Thư viện PPTX của Aspose PowerPoint cho phép bạn chuyển đổi các tệp POTX sang nhiều định dạng phổ biến.
...
{{< blocks/products/pf/agp/feature-section-col title="Cách chuyển đổi POTX sang JPG bằng Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để chuyển đổi tệp POTX sang JPG bằng Python." >}}
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị Chuyển đổi Python POTX sang JPG" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu POTX dưới dạng JPG bằng Python" %}}
Sử dụng ứng dụng miễn phí để xem trình diễn về quá trình chuyển đổi POTX sang JPG. 
{{% /blocks/products/pf/agp/content %}}
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        appName="conversion"
        extension=""
        sectionTitle="Ứng dụng miễn phí để chuyển đổi POTX thành JPG" 
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/vi/python-net/conversion/potx-to-otp/" name="POTX TO OTP" description="Định dạng chuẩn OpenDocument" >}}  
