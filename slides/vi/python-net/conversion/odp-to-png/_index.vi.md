...
title: Chuyển đổi ODP sang PNG bằng Python
weight: 310
url: /vi/python-net/conversion/odp-to-png/ 
keywords: "Convert, PowerPoint, ODP, PNG, Presentation, Python"
description: Mã mẫu để chuyển đổi ODP sang PNG Python. Sử dụng API Python của PowerPoint để chuyển đổi hàng loạt tệp ODP sang tệp PNG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi ODP sang PNG bằng Python" h2="Thư viện PowerPoint Python mạnh mẽ để chuyển đổi ODP sang PNG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi ODP sang PNG bằng Python" %}}

Bạn cần lập trình chuyển đổi tệp ODP sang PNG? Sử dụng [* Aspose.Slides cho Python qua .NET *](https://products.aspose.com/slides/vi/python-net/), bất kỳ nhà phát triển nào cũng có thể chuyển đổi định dạng ODP sang PNG chỉ với một vài dòng mã Python.

Là một API xử lý bản trình bày hiện đại, Aspose.Slides for Python tạo PNG từ ODP một cách nhanh chóng. Kiểm tra chất lượng chuyển đổi ODP sang PNG ngay trong [trình duyệt] của bạn (https://products.aspose.app/slides/conversion/ppt-to-png). Thư viện Aspose PowerPoint PPTX cho phép bạn chuyển đổi các tập tin ODP sang nhiều định dạng phổ biến.
...
{{< blocks/products/pf/agp/feature-section-col title="Cách chuyển đổi ODP sang PNG bằng Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để chuyển đổi tệp ODP sang PNG bằng Python." >}}
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị Chuyển đổi Python từ ODP sang PNG" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu ODP dưới dạng PNG bằng Python" %}}
