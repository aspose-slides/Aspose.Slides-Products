...
{{% blocks/products/pf/agp/code-block title="Thêm hình mờ vào bản trình bày PPT bằng Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách thêm Hình mờ vào PPT qua Python" >}}
