---
title: Xem hoặc chỉnh sửa siêu dữ liệu tệp PPTM bằng Python
url: /vi/python-net/metadata/pptm/
keywords: Chỉnh sửa siêu dữ liệu PPTM, Xem siêu dữ liệu PPTM, Chỉnh sửa thuộc tính PPTM, Xem thuộc tính PPTM
description: mã nguồn Python để chỉnh sửa hoặc xem siêu dữ liệu định dạng PPTM.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chỉnh sửa thuộc tính PPTM bằng Python" h2="Xây dựng các ứng dụng Python của riêng bạn để sửa đổi các thuộc tính Tích hợp và Tùy chỉnh trong tệp bản trình bày bằng cách sử dụng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTM" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" fileiconsmall4="POT" fileiconsmall5="ppsx" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for Python via .NET" >}}

{{% blocks/products/pf/feature-page-section  h2="Sửa đổi Thuộc tính PPTM qua Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Sửa đổi Thuộc tính tích hợp PPTM - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Thêm thuộc tính tùy chỉnh vào PPTM - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách trích xuất siêu dữ liệu của PPTM qua Python" >}}
