---
title: Hợp nhất các tệp PPSX thành HTML bằng Python
url: /vi/python-net/merge/ppsx-to-html/
keywords: Hợp nhất PPSX thành HTML, Nối PPSX thành HTML, Kết hợp PPSX thành HTML, PowerPoint, Bản trình bày, HTML, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPSX thành HTML bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPSX thành một tệp HTML duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPSX với HTML bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPSX và lưu kết quả dưới dạng HTML bằng Python." >}}
