---
title: Hợp nhất các tệp POTM thành TIFF bằng Python
url: /vi/python-net/merge/potm-to-tiff/
keywords: Hợp nhất POTM thành TIFF, Nối POTM thành TIFF, Kết hợp POTM thành TIFF, PowerPoint, Bản trình bày, TIFF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POTM thành TIFF bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POTM thành một tệp TIFF duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POTM với TIFF bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POTM và lưu kết quả dưới dạng TIFF bằng Python." >}}
