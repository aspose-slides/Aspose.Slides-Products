---
title: Hợp nhất các tệp PPSX thành FODP bằng Python
url: /vi/python-net/merge/ppsx-to-fodp/
keywords: Hợp nhất PPSX thành FODP, Nối PPSX thành FODP, Kết hợp PPSX thành FODP, PowerPoint, Bản trình bày, FODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPSX thành FODP bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPSX thành một tệp FODP duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPSX với FODP bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPSX và lưu kết quả dưới dạng FODP bằng Python." >}}
