---
title: Hợp nhất các tệp PPTM thành TIFF bằng Python
url: /vi/python-net/merge/pptm-to-tiff/
keywords: Hợp nhất PPTM thành TIFF, Nối PPTM thành TIFF, Kết hợp PPTM thành TIFF, PowerPoint, Bản trình bày, TIFF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPTM thành TIFF bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPTM thành một tệp TIFF duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPTM với TIFF bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPTM và lưu kết quả dưới dạng TIFF bằng Python." >}}
