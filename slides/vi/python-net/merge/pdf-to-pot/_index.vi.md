---
title: Hợp nhất các tệp PDF thành POT bằng Python
url: /vi/python-net/merge/pdf-to-pot/
keywords: Hợp nhất PDF thành POT, Nối PDF thành POT, Kết hợp PDF thành POT, PowerPoint, Bản trình bày, POT, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PDF thành POT bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PDF thành một tệp POT duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PDF với POT bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PDF và lưu kết quả dưới dạng POT bằng Python." >}}
