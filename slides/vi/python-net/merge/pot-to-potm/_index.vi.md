---
title: Hợp nhất các tệp POT thành POTM bằng Python
url: /vi/python-net/merge/pot-to-potm/
keywords: Hợp nhất POT thành POTM, Nối POT thành POTM, Kết hợp POT thành POTM, PowerPoint, Bản trình bày, POTM, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POT thành POTM bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POT thành một tệp POTM duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POT với POTM bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POT và lưu kết quả dưới dạng POTM bằng Python." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/vi/python-net/merge/pot-to-pptm/" name="POT TO PPTM" >}}  
