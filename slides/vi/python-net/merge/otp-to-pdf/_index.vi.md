---
title: Hợp nhất các tệp OTP thành PDF bằng Python
url: /vi/python-net/merge/otp-to-pdf/
keywords: Hợp nhất OTP thành PDF, Nối OTP thành PDF, Kết hợp OTP thành PDF, PowerPoint, Bản trình bày, PDF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp OTP thành PDF bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều OTP thành một tệp PDF duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất OTP với PDF bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp OTP và lưu kết quả dưới dạng PDF bằng Python." >}}
