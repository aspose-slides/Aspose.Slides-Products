---
title: Hợp nhất các tệp PPSX thành XPS bằng Python
url: /vi/python-net/merge/ppsx-to-xps/
keywords: Hợp nhất PPSX thành XPS, Nối PPSX thành XPS, Kết hợp PPSX thành XPS, PowerPoint, Bản trình bày, XPS, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPSX thành XPS bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPSX thành một tệp XPS duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPSX với XPS bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPSX và lưu kết quả dưới dạng XPS bằng Python." >}}
