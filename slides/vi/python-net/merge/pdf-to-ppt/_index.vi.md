---
title: Hợp nhất các tệp PDF thành PPT bằng Python
url: /vi/python-net/merge/pdf-to-ppt/
keywords: Hợp nhất PDF thành PPT, Nối PDF thành PPT, Kết hợp PDF thành PPT, PowerPoint, Bản trình bày, PPT, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PDF thành PPT bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PDF thành một tệp PPT duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PDF với PPT bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PDF và lưu kết quả dưới dạng PPT bằng Python." >}}
