---
title: Hợp nhất các tệp POTX thành PDF bằng Python
url: /vi/python-net/merge/potx-to-pdf/
keywords: Hợp nhất POTX thành PDF, Nối POTX thành PDF, Kết hợp POTX thành PDF, PowerPoint, Bản trình bày, PDF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POTX thành PDF bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POTX thành một tệp PDF duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POTX với PDF bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POTX và lưu kết quả dưới dạng PDF bằng Python." >}}
