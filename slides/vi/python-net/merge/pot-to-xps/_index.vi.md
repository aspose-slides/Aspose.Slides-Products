---
title: Hợp nhất các tệp POT thành XPS bằng Python
url: /vi/python-net/merge/pot-to-xps/
keywords: Hợp nhất POT thành XPS, Nối POT thành XPS, Kết hợp POT thành XPS, PowerPoint, Bản trình bày, XPS, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POT thành XPS bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POT thành một tệp XPS duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POT với XPS bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POT và lưu kết quả dưới dạng XPS bằng Python." >}}
