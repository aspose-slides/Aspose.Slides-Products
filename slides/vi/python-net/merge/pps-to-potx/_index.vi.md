---
title: Hợp nhất các tệp PPS thành POTX bằng Python
url: /vi/python-net/merge/pps-to-potx/
keywords: Hợp nhất PPS thành POTX, Nối PPS thành POTX, Kết hợp PPS thành POTX, PowerPoint, Bản trình bày, POTX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPS thành POTX bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPS thành một tệp POTX duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPS với POTX bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPS và lưu kết quả dưới dạng POTX bằng Python." >}}
