---
title: Hợp nhất các tệp PPTM thành JPG bằng Python
url: /vi/python-net/merge/pptm-to-jpg/
keywords: Hợp nhất PPTM thành JPG, Nối PPTM thành JPG, Kết hợp PPTM thành JPG, PowerPoint, Bản trình bày, JPG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPTM thành JPG bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPTM thành một tệp JPG duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPTM với JPG bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPTM và lưu kết quả dưới dạng JPG bằng Python." >}}
