---
title: Hợp nhất các tệp POTX thành POTM bằng Python
url: /vi/python-net/merge/potx-to-potm/
keywords: Hợp nhất POTX thành POTM, Nối POTX thành POTM, Kết hợp POTX thành POTM, PowerPoint, Bản trình bày, POTM, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POTX thành POTM bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POTX thành một tệp POTM duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POTX với POTM bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POTX và lưu kết quả dưới dạng POTM bằng Python." >}}
