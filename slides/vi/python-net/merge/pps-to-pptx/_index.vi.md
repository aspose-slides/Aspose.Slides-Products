---
title: Hợp nhất các tệp PPS thành PPTX bằng Python
url: /vi/python-net/merge/pps-to-pptx/
keywords: Hợp nhất PPS thành PPTX, Nối PPS thành PPTX, Kết hợp PPS thành PPTX, PowerPoint, Bản trình bày, PPTX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPS thành PPTX bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPS thành một tệp PPTX duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPS với PPTX bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPS và lưu kết quả dưới dạng PPTX bằng Python." >}}
