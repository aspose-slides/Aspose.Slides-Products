---
title: Hợp nhất các tệp PDF thành FODP bằng Python
url: /vi/python-net/merge/pdf-to-fodp/
keywords: Hợp nhất PDF thành FODP, Nối PDF thành FODP, Kết hợp PDF thành FODP, PowerPoint, Bản trình bày, FODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PDF thành FODP bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PDF thành một tệp FODP duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PDF với FODP bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PDF và lưu kết quả dưới dạng FODP bằng Python." >}}
