---
title: Hợp nhất các tệp PPSX thành PPTX bằng Python
url: /vi/python-net/merge/ppsx-to-pptx/
keywords: Hợp nhất PPSX thành PPTX, Nối PPSX thành PPTX, Kết hợp PPSX thành PPTX, PowerPoint, Bản trình bày, PPTX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPSX thành PPTX bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPSX thành một tệp PPTX duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPSX với PPTX bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPSX và lưu kết quả dưới dạng PPTX bằng Python." >}}
