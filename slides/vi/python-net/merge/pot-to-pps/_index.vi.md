---
title: Hợp nhất các tệp POT thành PPS bằng Python
url: /vi/python-net/merge/pot-to-pps/
keywords: Hợp nhất POT thành PPS, Nối POT thành PPS, Kết hợp POT thành PPS, PowerPoint, Bản trình bày, PPS, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POT thành PPS bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POT thành một tệp PPS duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POT với PPS bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POT và lưu kết quả dưới dạng PPS bằng Python." >}}
