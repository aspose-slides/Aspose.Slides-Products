---
title: Hợp nhất các tệp POT thành FODP bằng Python
url: /vi/python-net/merge/pot-to-fodp/
keywords: Hợp nhất POT thành FODP, Nối POT thành FODP, Kết hợp POT thành FODP, PowerPoint, Bản trình bày, FODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POT thành FODP bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POT thành một tệp FODP duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POT với FODP bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POT và lưu kết quả dưới dạng FODP bằng Python." >}}
