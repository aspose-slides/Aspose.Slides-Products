---
title: Hợp nhất các tệp PDF trong Python
url: /vi/python-net/merge/pdf-to-pdf/
keywords: Hợp nhất PDF, PDF sang PDF, Tham gia PDF, Kết hợp PDF, API Python, Thư viện Python
description: Hợp nhất PDF thành PDF trong Python. Sử dụng API thư viện Python để kết hợp các tệp PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Hợp nhất PDF trong Python" h2="Thư viện Python tốc độ cao và đa nền tảng để hợp nhất các tệp PDF bằng mã Python" >}}

{{% blocks/products/pf/feature-page-section h2="Hợp nhất PDF sang PDF bằng Aspose.Slides" %}}

[**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/vi/python-net/) là một thư viện Python mạnh mẽ dùng để tạo, chuyển đổi, hợp nhất và thao tác với bản trình bày, tệp PDF , và các tài liệu khác. Khi bạn hợp nhất PDF thành PDF, bạn đang kết hợp hiệu quả các trang từ 2 tài liệu để có được một tệp PDF. Aspose.Slides cho phép bạn hợp nhất các tệp PDF theo nhiều cách khác nhau. Bạn có thể hợp nhất các tệp PDF với tất cả các hình dạng, kiểu dáng, văn bản, định dạng, v.v.
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất PDF thành PDF trong Python" %}}
Sử dụng [**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/vi/python-net/), bạn có thể nhanh chóng hợp nhất các tệp PDF chỉ với một vài dòng mã

{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất PDF thành PDF" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PDF trong Python" >}}
