---
title: Hợp nhất các tệp POTM thành BMP bằng Python
url: /vi/python-net/merge/potm-to-bmp/
keywords: Hợp nhất POTM thành BMP, Nối POTM thành BMP, Kết hợp POTM thành BMP, PowerPoint, Bản trình bày, BMP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POTM thành BMP bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POTM thành một tệp BMP duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POTM với BMP bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POTM và lưu kết quả dưới dạng BMP bằng Python." >}}
