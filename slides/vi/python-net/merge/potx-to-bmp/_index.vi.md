---
title: Hợp nhất các tệp POTX thành BMP bằng Python
url: /vi/python-net/merge/potx-to-bmp/
keywords: Hợp nhất POTX thành BMP, Nối POTX thành BMP, Kết hợp POTX thành BMP, PowerPoint, Bản trình bày, BMP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POTX thành BMP bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POTX thành một tệp BMP duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POTX với BMP bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POTX và lưu kết quả dưới dạng BMP bằng Python." >}}
