---
title: Hợp nhất các tệp PPSX thành JPG bằng Python
url: /vi/python-net/merge/ppsx-to-jpg/
keywords: Hợp nhất PPSX thành JPG, Nối PPSX thành JPG, Kết hợp PPSX thành JPG, PowerPoint, Bản trình bày, JPG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPSX thành JPG bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPSX thành một tệp JPG duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPSX với JPG bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPSX và lưu kết quả dưới dạng JPG bằng Python." >}}
