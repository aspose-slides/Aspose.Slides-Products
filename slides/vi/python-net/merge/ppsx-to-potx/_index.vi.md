---
title: Hợp nhất các tệp PPSX thành POTX bằng Python
url: /vi/python-net/merge/ppsx-to-potx/
keywords: Hợp nhất PPSX thành POTX, Nối PPSX thành POTX, Kết hợp PPSX thành POTX, PowerPoint, Bản trình bày, POTX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPSX thành POTX bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPSX thành một tệp POTX duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPSX với POTX bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPSX và lưu kết quả dưới dạng POTX bằng Python." >}}
