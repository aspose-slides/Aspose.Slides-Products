...
description: Hợp nhất JPG sang PDF bằng Python. Sử dụng API thư viện Python để kết hợp JPG và PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Hợp nhất JPG sang PDF trong Python" h2="Thư viện Python tốc độ cao và đa nền tảng để hợp nhất các tệp JPG sang PDF bằng mã Python" >}}

{{% blocks/products/pf/feature-page-section h2="Hợp nhất JPG sang PDF bằng Aspose.Slides" %}}

[**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/vi/python-net/) là một thư viện Python mạnh mẽ dùng để tạo, chuyển đổi, hợp nhất và thao tác với bản trình bày, tệp PDF , hình ảnh và các tệp khác. Khi bạn hợp nhất JPG sang PDF, bạn đang kết hợp hiệu quả các hình ảnh JPG để có được một tệp PDF duy nhất.
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất JPG sang PDF trong Python" %}}
Sử dụng [**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/vi/python-net/), bạn có thể nhanh chóng hợp nhất JPG sang PDF chỉ bằng một vài dòng mã

{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất JPG sang PDF" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất JPG sang PDF trong Python" >}}
