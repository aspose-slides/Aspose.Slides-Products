---
title: Hợp nhất các tệp PPSX thành ODP bằng Python
url: /vi/python-net/merge/ppsx-to-odp/
keywords: Hợp nhất PPSX thành ODP, Nối PPSX thành ODP, Kết hợp PPSX thành ODP, PowerPoint, Bản trình bày, ODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPSX thành ODP bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPSX thành một tệp ODP duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPSX với ODP bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPSX và lưu kết quả dưới dạng ODP bằng Python." >}}
