---
title: Hợp nhất các tệp PPTM thành POT bằng Python
url: /vi/python-net/merge/pptm-to-pot/
keywords: Hợp nhất PPTM thành POT, Nối PPTM thành POT, Kết hợp PPTM thành POT, PowerPoint, Bản trình bày, POT, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPTM thành POT bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPTM thành một tệp POT duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPTM với POT bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPTM và lưu kết quả dưới dạng POT bằng Python." >}}
