---
title: Hợp nhất các tệp PPSX thành PNG bằng Python
url: /vi/python-net/merge/ppsx-to-png/
keywords: Hợp nhất PPSX thành PNG, Nối PPSX thành PNG, Kết hợp PPSX thành PNG, PowerPoint, Bản trình bày, PNG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPSX thành PNG bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPSX thành một tệp PNG duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPSX với PNG bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPSX và lưu kết quả dưới dạng PNG bằng Python." >}}
