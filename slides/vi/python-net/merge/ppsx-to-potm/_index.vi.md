---
title: Hợp nhất các tệp PPSX thành POTM bằng Python
url: /vi/python-net/merge/ppsx-to-potm/
keywords: Hợp nhất PPSX thành POTM, Nối PPSX thành POTM, Kết hợp PPSX thành POTM, PowerPoint, Bản trình bày, POTM, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPSX thành POTM bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPSX thành một tệp POTM duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPSX với POTM bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPSX và lưu kết quả dưới dạng POTM bằng Python." >}}
