---
title: Hợp nhất các tệp PPSX thành BMP bằng Python
url: /vi/python-net/merge/ppsx-to-bmp/
keywords: Hợp nhất PPSX thành BMP, Nối PPSX thành BMP, Kết hợp PPSX thành BMP, PowerPoint, Bản trình bày, BMP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPSX thành BMP bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPSX thành một tệp BMP duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPSX với BMP bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPSX và lưu kết quả dưới dạng BMP bằng Python." >}}
