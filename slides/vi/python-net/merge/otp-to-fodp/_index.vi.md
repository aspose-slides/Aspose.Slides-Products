---
title: Hợp nhất các tệp OTP thành FODP bằng Python
url: /vi/python-net/merge/otp-to-fodp/
keywords: Hợp nhất OTP thành FODP, Nối OTP thành FODP, Kết hợp OTP thành FODP, PowerPoint, Bản trình bày, FODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp OTP thành FODP bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều OTP thành một tệp FODP duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất OTP với FODP bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp OTP và lưu kết quả dưới dạng FODP bằng Python." >}}
