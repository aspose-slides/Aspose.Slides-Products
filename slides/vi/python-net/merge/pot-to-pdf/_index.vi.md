---
title: Hợp nhất các tệp POT thành PDF bằng Python
url: /vi/python-net/merge/pot-to-pdf/
keywords: Hợp nhất POT thành PDF, Nối POT thành PDF, Kết hợp POT thành PDF, PowerPoint, Bản trình bày, PDF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POT thành PDF bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POT thành một tệp PDF duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POT với PDF bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POT và lưu kết quả dưới dạng PDF bằng Python." >}}
