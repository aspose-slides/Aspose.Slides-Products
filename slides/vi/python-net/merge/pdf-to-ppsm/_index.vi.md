---
title: Hợp nhất các tệp PDF thành PPSM bằng Python
url: /vi/python-net/merge/pdf-to-ppsm/
keywords: Hợp nhất PDF thành PPSM, Nối PDF thành PPSM, Kết hợp PDF thành PPSM, PowerPoint, Bản trình bày, PPSM, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PDF thành PPSM bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PDF thành một tệp PPSM duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PDF với PPSM bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PDF và lưu kết quả dưới dạng PPSM bằng Python." >}}
