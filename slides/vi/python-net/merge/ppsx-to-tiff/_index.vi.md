---
title: Hợp nhất các tệp PPSX thành TIFF bằng Python
url: /vi/python-net/merge/ppsx-to-tiff/
keywords: Hợp nhất PPSX thành TIFF, Nối PPSX thành TIFF, Kết hợp PPSX thành TIFF, PowerPoint, Bản trình bày, TIFF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPSX thành TIFF bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPSX thành một tệp TIFF duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPSX với TIFF bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPSX và lưu kết quả dưới dạng TIFF bằng Python." >}}
