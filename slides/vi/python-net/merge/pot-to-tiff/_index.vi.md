---
title: Hợp nhất các tệp POT thành TIFF bằng Python
url: /vi/python-net/merge/pot-to-tiff/
keywords: Hợp nhất POT thành TIFF, Nối POT thành TIFF, Kết hợp POT thành TIFF, PowerPoint, Bản trình bày, TIFF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POT thành TIFF bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POT thành một tệp TIFF duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POT với TIFF bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POT và lưu kết quả dưới dạng TIFF bằng Python." >}}
