---
title: Hợp nhất các tệp POTX thành FODP bằng Python
url: /vi/python-net/merge/potx-to-fodp/
keywords: Hợp nhất POTX thành FODP, Nối POTX thành FODP, Kết hợp POTX thành FODP, PowerPoint, Bản trình bày, FODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POTX thành FODP bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POTX thành một tệp FODP duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POTX với FODP bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POTX và lưu kết quả dưới dạng FODP bằng Python." >}}
