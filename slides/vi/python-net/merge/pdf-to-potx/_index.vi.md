---
title: Hợp nhất các tệp PDF thành POTX bằng Python
url: /vi/python-net/merge/pdf-to-potx/
keywords: Hợp nhất PDF thành POTX, Nối PDF thành POTX, Kết hợp PDF thành POTX, PowerPoint, Bản trình bày, POTX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PDF thành POTX bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PDF thành một tệp POTX duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PDF với POTX bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PDF và lưu kết quả dưới dạng POTX bằng Python." >}}
