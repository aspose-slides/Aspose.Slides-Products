---
title: Hợp nhất các tệp PDF thành PPS bằng Python
url: /vi/python-net/merge/pdf-to-pps/
keywords: Hợp nhất PDF thành PPS, Nối PDF thành PPS, Kết hợp PDF thành PPS, PowerPoint, Bản trình bày, PPS, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PDF thành PPS bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PDF thành một tệp PPS duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PDF với PPS bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PDF và lưu kết quả dưới dạng PPS bằng Python." >}}
