---
title: Hợp nhất các tệp OTP thành TIFF bằng Python
url: /vi/python-net/merge/otp-to-tiff/
keywords: Hợp nhất OTP thành TIFF, Nối OTP thành TIFF, Kết hợp OTP thành TIFF, PowerPoint, Bản trình bày, TIFF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp OTP thành TIFF bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều OTP thành một tệp TIFF duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất OTP với TIFF bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp OTP và lưu kết quả dưới dạng TIFF bằng Python." >}}
