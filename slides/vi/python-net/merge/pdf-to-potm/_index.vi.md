---
title: Hợp nhất các tệp PDF thành POTM bằng Python
url: /vi/python-net/merge/pdf-to-potm/
keywords: Hợp nhất PDF thành POTM, Nối PDF thành POTM, Kết hợp PDF thành POTM, PowerPoint, Bản trình bày, POTM, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PDF thành POTM bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PDF thành một tệp POTM duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PDF với POTM bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PDF và lưu kết quả dưới dạng POTM bằng Python." >}}
