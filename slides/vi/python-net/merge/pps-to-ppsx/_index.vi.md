---
title: Hợp nhất các tệp PPS thành PPSX bằng Python
url: /vi/python-net/merge/pps-to-ppsx/
keywords: Hợp nhất PPS thành PPSX, Nối PPS thành PPSX, Kết hợp PPS thành PPSX, PowerPoint, Bản trình bày, PPSX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPS thành PPSX bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPS thành một tệp PPSX duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPS với PPSX bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPS và lưu kết quả dưới dạng PPSX bằng Python." >}}
