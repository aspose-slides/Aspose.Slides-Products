---
title: Hợp nhất các tệp PDF thành HTML bằng Python
url: /vi/python-net/merge/pdf-to-html/
keywords: Hợp nhất PDF thành HTML, Nối PDF thành HTML, Kết hợp PDF thành HTML, PowerPoint, Bản trình bày, HTML, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PDF thành HTML bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PDF thành một tệp HTML duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PDF với HTML bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PDF và lưu kết quả dưới dạng HTML bằng Python." >}}
