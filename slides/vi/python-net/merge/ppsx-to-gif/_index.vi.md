---
title: Hợp nhất các tệp PPSX thành GIF bằng Python
url: /vi/python-net/merge/ppsx-to-gif/
keywords: Hợp nhất PPSX thành GIF, Nối PPSX thành GIF, Kết hợp PPSX thành GIF, PowerPoint, Bản trình bày, GIF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPSX thành GIF bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPSX thành một tệp GIF duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPSX với GIF bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPSX và lưu kết quả dưới dạng GIF bằng Python." >}}
