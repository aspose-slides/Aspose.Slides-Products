---
title: Hợp nhất các tệp POTM thành POT bằng Python
url: /vi/python-net/merge/potm-to-pot/
keywords: Hợp nhất POTM thành POT, Nối POTM thành POT, Kết hợp POTM thành POT, PowerPoint, Bản trình bày, POT, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POTM thành POT bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POTM thành một tệp POT duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POTM với POT bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POTM và lưu kết quả dưới dạng POT bằng Python." >}}
