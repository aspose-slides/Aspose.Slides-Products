---
title: Hợp nhất các tệp POTX thành SVG bằng Python
url: /vi/python-net/merge/potx-to-svg/
keywords: Hợp nhất POTX thành SVG, Nối POTX thành SVG, Kết hợp POTX thành SVG, PowerPoint, Bản trình bày, SVG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POTX thành SVG bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POTX thành một tệp SVG duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POTX với SVG bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POTX và lưu kết quả dưới dạng SVG bằng Python." >}}
