---
title: Hợp nhất các tệp PPSX thành PDF bằng Python
url: /vi/python-net/merge/ppsx-to-pdf/
keywords: Hợp nhất PPSX thành PDF, Nối PPSX thành PDF, Kết hợp PPSX thành PDF, PowerPoint, Bản trình bày, PDF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPSX thành PDF bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPSX thành một tệp PDF duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPSX với PDF bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPSX và lưu kết quả dưới dạng PDF bằng Python." >}}
