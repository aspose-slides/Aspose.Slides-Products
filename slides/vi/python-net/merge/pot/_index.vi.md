---
title: Hợp nhất các tệp POT bằng Python
url: /vi/python-net/merge/pot/
keywords: Hợp nhất POT, Tham gia POT, Kết hợp POT, PowerPoint, Bản trình bày, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POT bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POT thành một tệp duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POT bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POT và lưu kết quả dưới dạng POT bằng Python." >}}
