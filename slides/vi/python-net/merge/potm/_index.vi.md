---
title: Hợp nhất các tệp POTM bằng Python
url: /vi/python-net/merge/potm/
keywords: Hợp nhất POTM, Tham gia POTM, Kết hợp POTM, PowerPoint, Bản trình bày, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POTM bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POTM thành một tệp duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POTM bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POTM và lưu kết quả dưới dạng POTM bằng Python." >}}
