---
title: Hợp nhất các tệp PPTM bằng Python
url: /vi/python-net/merge/pptm/
keywords: Hợp nhất PPTM, Tham gia PPTM, Kết hợp PPTM, PowerPoint, Bản trình bày, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPTM bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPTM thành một tệp duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPTM bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPTM và lưu kết quả dưới dạng PPTM bằng Python." >}}
