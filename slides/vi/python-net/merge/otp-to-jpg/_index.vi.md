---
title: Hợp nhất các tệp OTP thành JPG bằng Python
url: /vi/python-net/merge/otp-to-jpg/
keywords: Hợp nhất OTP thành JPG, Nối OTP thành JPG, Kết hợp OTP thành JPG, PowerPoint, Bản trình bày, JPG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp OTP thành JPG bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều OTP thành một tệp JPG duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất OTP với JPG bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp OTP và lưu kết quả dưới dạng JPG bằng Python." >}}
