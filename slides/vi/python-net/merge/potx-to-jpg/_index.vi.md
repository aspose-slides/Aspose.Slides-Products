---
title: Hợp nhất các tệp POTX thành JPG bằng Python
url: /vi/python-net/merge/potx-to-jpg/
keywords: Hợp nhất POTX thành JPG, Nối POTX thành JPG, Kết hợp POTX thành JPG, PowerPoint, Bản trình bày, JPG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POTX thành JPG bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POTX thành một tệp JPG duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POTX với JPG bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POTX và lưu kết quả dưới dạng JPG bằng Python." >}}
