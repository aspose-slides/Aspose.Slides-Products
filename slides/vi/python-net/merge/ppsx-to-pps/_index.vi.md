---
title: Hợp nhất các tệp PPSX thành PPS bằng Python
url: /vi/python-net/merge/ppsx-to-pps/
keywords: Hợp nhất PPSX thành PPS, Nối PPSX thành PPS, Kết hợp PPSX thành PPS, PowerPoint, Bản trình bày, PPS, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPSX thành PPS bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPSX thành một tệp PPS duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPSX với PPS bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPSX và lưu kết quả dưới dạng PPS bằng Python." >}}
