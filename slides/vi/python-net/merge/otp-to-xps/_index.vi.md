---
title: Hợp nhất các tệp OTP thành XPS bằng Python
url: /vi/python-net/merge/otp-to-xps/
keywords: Hợp nhất OTP thành XPS, Nối OTP thành XPS, Kết hợp OTP thành XPS, PowerPoint, Bản trình bày, XPS, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp OTP thành XPS bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều OTP thành một tệp XPS duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất OTP với XPS bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp OTP và lưu kết quả dưới dạng XPS bằng Python." >}}
