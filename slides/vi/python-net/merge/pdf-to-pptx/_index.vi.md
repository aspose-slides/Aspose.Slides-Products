---
title: Hợp nhất các tệp PDF thành PPTX bằng Python
url: /vi/python-net/merge/pdf-to-pptx/
keywords: Hợp nhất PDF thành PPTX, Nối PDF thành PPTX, Kết hợp PDF thành PPTX, PowerPoint, Bản trình bày, PPTX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PDF thành PPTX bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PDF thành một tệp PPTX duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PDF với PPTX bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PDF và lưu kết quả dưới dạng PPTX bằng Python." >}}
