...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPTM thành XPS bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPTM thành một tệp XPS duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPTM với XPS bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPTM và lưu kết quả dưới dạng XPS bằng Python." >}}
