---
title: Hợp nhất các tệp POT thành POTX bằng Python
url: /vi/python-net/merge/pot-to-potx/
keywords: Hợp nhất POT thành POTX, Nối POT thành POTX, Kết hợp POT thành POTX, PowerPoint, Bản trình bày, POTX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POT thành POTX bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POT thành một tệp POTX duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POT với POTX bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POT và lưu kết quả dưới dạng POTX bằng Python." >}}
