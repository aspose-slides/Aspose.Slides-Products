---
title: Hợp nhất các tệp PPSX thành PPT bằng Python
url: /vi/python-net/merge/ppsx-to-ppt/
keywords: Hợp nhất PPSX thành PPT, Nối PPSX thành PPT, Kết hợp PPSX thành PPT, PowerPoint, Bản trình bày, PPT, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PPSX thành PPT bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PPSX thành một tệp PPT duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PPSX với PPT bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PPSX và lưu kết quả dưới dạng PPT bằng Python." >}}
