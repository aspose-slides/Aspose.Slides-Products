---
title: Hợp nhất các tệp POTX thành ODP bằng Python
url: /vi/python-net/merge/potx-to-odp/
keywords: Hợp nhất POTX thành ODP, Nối POTX thành ODP, Kết hợp POTX thành ODP, PowerPoint, Bản trình bày, ODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POTX thành ODP bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POTX thành một tệp ODP duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POTX với ODP bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POTX và lưu kết quả dưới dạng ODP bằng Python." >}}
