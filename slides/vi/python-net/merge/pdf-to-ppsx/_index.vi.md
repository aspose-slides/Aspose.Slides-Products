---
title: Hợp nhất các tệp PDF thành PPSX bằng Python
url: /vi/python-net/merge/pdf-to-ppsx/
keywords: Hợp nhất PDF thành PPSX, Nối PDF thành PPSX, Kết hợp PDF thành PPSX, PowerPoint, Bản trình bày, PPSX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PDF thành PPSX bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PDF thành một tệp PPSX duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PDF với PPSX bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PDF và lưu kết quả dưới dạng PPSX bằng Python." >}}
