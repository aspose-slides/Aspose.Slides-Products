---
title: Hợp nhất các tệp POTX thành PPSM bằng Python
url: /vi/python-net/merge/potx-to-ppsm/
keywords: Hợp nhất POTX thành PPSM, Nối POTX thành PPSM, Kết hợp POTX thành PPSM, PowerPoint, Bản trình bày, PPSM, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POTX thành PPSM bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POTX thành một tệp PPSM duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POTX với PPSM bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POTX và lưu kết quả dưới dạng PPSM bằng Python." >}}
