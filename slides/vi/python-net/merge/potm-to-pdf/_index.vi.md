---
title: Hợp nhất các tệp POTM thành PDF bằng Python
url: /vi/python-net/merge/potm-to-pdf/
keywords: Hợp nhất POTM thành PDF, Nối POTM thành PDF, Kết hợp POTM thành PDF, PowerPoint, Bản trình bày, PDF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POTM thành PDF bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POTM thành một tệp PDF duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POTM với PDF bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POTM và lưu kết quả dưới dạng PDF bằng Python." >}}
