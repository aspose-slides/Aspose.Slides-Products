---
title: Hợp nhất các tệp PDF thành PNG bằng Python
url: /vi/python-net/merge/pdf-to-png/
keywords: Hợp nhất PDF thành PNG, Nối PDF thành PNG, Kết hợp PDF thành PNG, PowerPoint, Bản trình bày, PNG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp PDF thành PNG bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều PDF thành một tệp PNG duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất PDF với PNG bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp PDF và lưu kết quả dưới dạng PNG bằng Python." >}}
