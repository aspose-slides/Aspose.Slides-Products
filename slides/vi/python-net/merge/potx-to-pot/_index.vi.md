---
title: Hợp nhất các tệp POTX thành POT bằng Python
url: /vi/python-net/merge/potx-to-pot/
keywords: Hợp nhất POTX thành POT, Nối POTX thành POT, Kết hợp POTX thành POT, PowerPoint, Bản trình bày, POT, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Hợp nhất các tệp POTX thành POT bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Python để hợp nhất nhiều POTX thành một tệp POT duy nhất" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cách hợp nhất POTX với POT bằng cách sử dụng Aspose.Slides cho Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để hợp nhất hai tệp POTX và lưu kết quả dưới dạng POT bằng Python." >}}
