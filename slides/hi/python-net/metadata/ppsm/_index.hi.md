...
{{% blocks/products/pf/agp/code-block title="PPSM अंतर्निहित गुणों को संशोधित करें - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="PPSM - Python में कस्टम गुण जोड़ें" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Python के द्वारा PPSM का मेटाडेटा कैसे निकालें" >}}
