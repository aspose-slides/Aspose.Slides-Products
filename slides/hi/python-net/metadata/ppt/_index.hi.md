---
title: Python का उपयोग करके PPT फ़ाइलें मेटाडेटा देखें या संपादित करें
url: /hi/python-net/metadata/ppt/
keywords: PPT मेटाडेटा संपादित करें, PPT मेटाडेटा देखें, PPT गुण संपादित करें, PPT गुण देखें
description: संपादित करने या PPT प्रारूप मेटाडेटा देखने के लिए Python स्रोत कोड.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Python का इस्तेमाल करके PPT प्रॉपर्टी में बदलाव करें" h2="सर्वर-साइड API का उपयोग करके प्रस्तुतिकरण फ़ाइलों में अंतर्निहित और कस्टम गुणों को संशोधित करने के लिए अपने स्वयं के Python ऐप्स बनाएं." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" fileiconsmall4="POT" fileiconsmall5="ppsx" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for Python via .NET" >}}

{{% blocks/products/pf/feature-page-section  h2="PPT प्रॉपर्टी को Python के ज़रिए बदलें" %}}
...
{{% blocks/products/pf/agp/code-block title="PPT अंतर्निहित गुणों को संशोधित करें - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="PPT - Python में कस्टम गुण जोड़ें" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Python के द्वारा PPT का मेटाडेटा कैसे निकालें" >}}
