...
description: पायथन में HTML को PPTX में बदलें। HTML को PowerPoint में बदलने के लिए Python लाइब्रेरी API का उपयोग करें
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="पायथन में HTML को PPTX में बदलें" h2="पायथन कोड का उपयोग करके HTML को PPTX में परिवर्तित करने के लिए शक्तिशाली क्रॉस-प्लेटफ़ॉर्म पायथन एपीआई" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides का उपयोग करके HTML को PPTX में कनवर्ट करें" %}}

[**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/hi/python-net/) एक शक्तिशाली Python लाइब्रेरी है जिसका उपयोग PowerPoint प्रस्तुतियों, PDF, को बनाने, रूपांतरित करने और हेरफेर करने के लिए किया जाता है। एचटीएमएल डॉक्स, और अन्य फाइलें। जब आप HTML को PPTX में कनवर्ट करते हैं, तो आप अनिवार्य रूप से सामग्री को HTML दस्तावेज़ में PowerPoint प्रस्तुति में स्लाइड पर ले जा रहे होते हैं।

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="पायथन में HTML को PPTX में बदलें" %}}
...
{{% blocks/products/pf/agp/code-block title="HTML को PPTX में बदलने के लिए पायथन कोड" offSpacer="true" %}}
```py
...
{{< blocks/products/pf/feature-page-section  h2="पायथन में HTML को PPTX में कैसे बदलें" >}}
