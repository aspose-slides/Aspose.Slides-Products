...
description: पायथन में छवि को छवि में मर्ज करें। छवियों को गठबंधन करने के लिए पायथन लाइब्रेरी एपीआई का प्रयोग करें
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge image in Python" h2="पायथन कोड का उपयोग करके छवियों को मर्ज करने के लिए हाई-स्पीड और क्रॉस-प्लेटफ़ॉर्म पायथन लाइब्रेरी" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides का उपयोग करके छवि को छवि में मर्ज करें" %}}

[**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/hi/python-net/) एक शक्तिशाली पायथन लाइब्रेरी है जिसका उपयोग प्रस्तुतियों, छवियों और अन्य फ़ाइलों को मर्ज और हेरफेर करने के लिए किया जाता है। जब आप छवि को छवि में मर्ज करते हैं, तो आप एक चित्र प्राप्त करने के लिए दो छवियों को प्रभावी ढंग से जोड़ रहे हैं।
...
{{% blocks/products/pf/feature-page-section  h2="पायथन में छवि को छवि में मर्ज करें" %}}
...
{{% blocks/products/pf/agp/code-block title="छवि को छवि में विलय करने के लिए पायथन कोड" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="पायथन में छवियों को कैसे मर्ज करें" >}}
