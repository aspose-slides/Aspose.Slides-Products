---
title: पायथन का उपयोग करके POTX फ़ाइलों को POTM में मर्ज करें
url: /hi/python-net/merge/potx-to-potm/
keywords: POTX को POTM में मिलाएं, POTX से POTM में शामिल हों, POTX से POTM, PowerPoint, प्रेजेंटेशन, POTM, Python, Aspose को मिलाएं
...
{{% blocks/products/pf/feature-page-section  h2="Python का उपयोग करके POTX फ़ाइलों को POTM में मर्ज करें" %}}
PowerPoint प्रस्तुतियों को मर्ज करने के लिए, आपको स्लाइडों को एक प्रस्तुति से दूसरी प्रस्तुति में क्लोन करना होगा।

{{% blocks/products/pf/agp/code-block title="एकाधिक POTX को एकल POTM फ़ाइल में मर्ज करने के लिए पायथन कोड" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Aspose.Slides for Python API का उपयोग करके POTX को POTM में कैसे मर्ज करें?" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="ये दो POTX फाइलों को मर्ज करने और परिणाम को पायथन में POTM के रूप में सहेजने के चरण हैं।" >}}
