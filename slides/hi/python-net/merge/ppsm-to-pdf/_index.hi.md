---
title: पायथन का उपयोग करके PPSM फ़ाइलों को PDF में मर्ज करें
url: /hi/python-net/merge/ppsm-to-pdf/
keywords: PPSM को PDF में मिलाएं, PPSM से PDF में शामिल हों, PPSM से PDF, PowerPoint, प्रेजेंटेशन, PDF, Python, Aspose को मिलाएं
...
{{% blocks/products/pf/feature-page-section h2="पायथन में PPSM को PDF में मर्ज करें" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Python का उपयोग करके PPSM फ़ाइलों को PDF में मर्ज करें" %}}
PowerPoint प्रस्तुतियों को मर्ज करने के लिए, आपको स्लाइडों को एक प्रस्तुति से दूसरी प्रस्तुति में क्लोन करना होगा।

{{% blocks/products/pf/agp/code-block title="एकाधिक PPSM को एकल PDF फ़ाइल में मर्ज करने के लिए पायथन कोड" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Aspose.Slides for Python API का उपयोग करके PPSM को PDF में कैसे मर्ज करें?" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="ये दो PPSM फाइलों को मर्ज करने और परिणाम को पायथन में PDF के रूप में सहेजने के चरण हैं।" >}}
