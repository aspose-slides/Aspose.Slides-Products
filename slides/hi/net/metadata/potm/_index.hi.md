...
{{% blocks/products/pf/agp/code-block title="POTM अंतर्निहित गुणों को संशोधित करें - C#" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="POTM - C# में कस्टम गुण जोड़ें" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="C# के द्वारा POTM का मेटाडेटा कैसे निकालें" >}}
