...
url: /hi/net/merger/png-to-pdf/
keywords: PNG से PDF, PNG को PDF में मर्ज करें, PNG से PDF, PDF, PNG, C# API, .NET लाइब्रेरी से जुड़ें
description: सी # में पीएनजी को पीडीएफ में मर्ज करें। PNG और PDF को संयोजित करने के लिए .NET लाइब्रेरी API का उपयोग करें
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="सी # में पीएनजी को पीडीएफ में मर्ज करें" h2="NET फ्रेमवर्क, .NET Core, Windows Azure, Mono या Xamarin प्लेटफ़ॉर्म पर C# कोड का उपयोग करके PNG को PDF फ़ाइलों में मर्ज करने के लिए शक्तिशाली क्रॉस-प्लेटफ़ॉर्म .NET API" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides का उपयोग करके PNG को PDF में मर्ज करें" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/hi/net/) एक शक्तिशाली .NET लाइब्रेरी है जिसका उपयोग प्रस्तुतियों, छवियों और अन्य को बनाने, परिवर्तित करने, विलय करने और हेरफेर करने के लिए किया जाता है। फ़ाइलें। जब आप पीएनजी को पीडीएफ में मर्ज करते हैं, तो आप एक पीडीएफ फाइल प्राप्त करने के लिए पीएनजी छवियों को प्रभावी ढंग से जोड़ रहे हैं।
...
[**Aspose.Slides for .NET**](https://products.aspose.com/slides/hi/net/) का उपयोग करके, आप कोड की कुछ पंक्तियों के साथ PNG को PDF में शीघ्र मर्ज कर सकते हैं

{{% blocks/products/pf/agp/code-block title="पीएनजी को पीडीएफ में विलय करने के लिए सी # कोड" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="सी # में पीएनजी को पीडीएफ में कैसे विलय करें" >}}
