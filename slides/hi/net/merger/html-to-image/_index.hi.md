---
title: सी # में एचटीएमएल को छवि में मर्ज करें
url: /hi/net/merger/html-to-image/
keywords: HTML को छवि में, HTML को छवि में मर्ज करें, HTML से जुड़ें, HTML, छवि, C# API, .NET लाइब्रेरी को मिलाएं
description: HTML को C# में छवि में मर्ज करें। HTML को छवि से संयोजित करने के लिए .NET लाइब्रेरी API का उपयोग करें
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="सी # में छवि मर्ज करें" h2="नेट फ्रेमवर्क, .NET कोर, विंडोज एज़्योर, मोनो या ज़ामरीन प्लेटफ़ॉर्म पर C# कोड का उपयोग करके HTML को इमेज में मर्ज करने के लिए शक्तिशाली क्रॉस-प्लेटफ़ॉर्म .NET API" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides का उपयोग करके HTML को इमेज में मर्ज करें" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/hi/net/) एक शक्तिशाली .NET लाइब्रेरी है जिसका उपयोग प्रस्तुतियों, HTML डॉक्स और अन्य फ़ाइलों को मर्ज और हेरफेर करने के लिए किया जाता है। जब आप HTML को छवि में मर्ज करते हैं, तो आप एकल छवि प्राप्त करने के लिए HTML दस्तावेज़ों में सामग्री को प्रभावी ढंग से संयोजित कर रहे हैं। 
...
{{% blocks/products/pf/agp/code-block title="एचटीएमएल को छवि में विलय करने के लिए सी # कोड" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="एचटीएमएल को सी # में छवि में कैसे विलय करें" >}}
