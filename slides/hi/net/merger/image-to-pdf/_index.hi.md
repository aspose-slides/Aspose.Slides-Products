...
url: /hi/net/merger/image-to-pdf/
keywords: इमेज टू पीडीएफ, मर्ज इमेज टू पीडीएफ, जॉइन इमेज टू पीडीएफ, पीडीएफ, इमेज, सी# एपीआई, .नेट लाइब्रेरी
description: सी # में छवि को पीडीएफ में मर्ज करें। छवि और पीडीएफ को संयोजित करने के लिए .NET लाइब्रेरी एपीआई का उपयोग करें
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="सी # में छवि को पीडीएफ में मर्ज करें" h2="नेट फ्रेमवर्क, .NET कोर, विंडोज एज़्योर, मोनो या ज़ामरीन प्लेटफ़ॉर्म पर सी # कोड का उपयोग करके छवि को पीडीएफ फाइलों में मर्ज करने के लिए शक्तिशाली क्रॉस-प्लेटफ़ॉर्म .NET एपीआई" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides का उपयोग करके छवि को PDF में मर्ज करें" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/hi/net/) एक शक्तिशाली .NET लाइब्रेरी है, जिसका इस्तेमाल प्रेजेंटेशन, PDF, इमेज बनाने, बदलने, मर्ज करने और हेरफेर करने के लिए किया जाता है। और अन्य फ़ाइलें। जब आप छवि को पीडीएफ में मर्ज करते हैं, तो आप एक पीडीएफ फाइल प्राप्त करने के लिए छवियों को प्रभावी ढंग से जोड़ रहे हैं।
...
[**Aspose.Slides for .NET**](https://products.aspose.com/slides/hi/net/) का उपयोग करके, आप कोड की कुछ पंक्तियों के साथ छवि को पीडीएफ में जल्दी से मर्ज कर सकते हैं
...
{{< blocks/products/pf/feature-page-section  h2="छवि को सी # में पीडीएफ में कैसे विलय करें" >}}
