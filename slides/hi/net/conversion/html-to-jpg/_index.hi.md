...
title: सी # में एचटीएमएल को जेपीजी में कनवर्ट करें
weight: 150
url: /hi/net/conversion/html-to-jpg/ 
keywords: HTML से JPG, HTML को JPG में बदलें, C# API, .NET लाइब्रेरी, HTML, JPG
description: सी # में एचटीएमएल को जेपीजी में कनवर्ट करें। HTML फ़ाइलों को JPG छवियों में बदलने के लिए .NET लाइब्रेरी API का उपयोग करें
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="सी # में एचटीएमएल को जेपीजी में कनवर्ट करें" h2="NET फ्रेमवर्क, .NET Core, Windows Azure, Mono या Xamarin प्लेटफॉर्म पर HTML फ़ाइलों को JPG छवियों में कनवर्ट करने के लिए PowerPoint .NET API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="HTML को JPG में C# में कैसे बदलें" %}}

मैं कोड में HTML को JPG में कैसे परिवर्तित करूं?

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/hi/net/) का उपयोग करके, कोई भी डेवलपर या एप्लिकेशन HTML को JPG प्रारूप में C# कोड की कुछ पंक्तियों के साथ परिवर्तित कर सकता है।

एक आधुनिक दस्तावेज़ संसाधन API के रूप में, Aspose.Slides .NET के लिए HTML फ़ाइलों को शीघ्रता से JPG में निर्यात करता है। Aspose PowerPoint पुस्तकालय आपको HTML को JPG और कई अन्य फ़ाइल स्वरूपों में बदलने की अनुमति देता है
...
{{< blocks/products/pf/agp/feature-section-col title="HTML को JPG में C# में कैसे बदलें" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="डेवलपर्स और एप्लिकेशन इस तरह से HTML को JPG में बदल सकते हैं:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
HTML दस्तावेज़ में सामग्री के आधार पर स्लाइड जोड़ें।
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
स्लाइड्स को JPG इमेज के रूप में सेव करें।
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 इससे पहले कि आप HTML से JPG रूपांतरण C# कोड चलाएँ, आपकी मशीन में ये पूर्वापेक्षाएँ होनी चाहिए:
...
{{% blocks/products/pf/agp/code-block title="HTML को JPG में बदलने के लिए C# कोड" offSpacer="" %}}
