---
title: C# के माध्यम से PPTM को ODP में बदलें
weight: 7460
url: /hi/net/conversion/pptm-to-odp/ 
description: पीपीटीएम से ओडीपी सी# रूपांतरण के लिए नमूना कोड। VB.NET, Asp.NET या किसी .NET आधारित एप्लिकेशन के भीतर PPTM फ़ाइलों को ODP रूपांतरण में बैच के लिए API उदाहरण कोड का उपयोग करें।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C# के माध्यम से PPTM को ODP में बदलें" h2="PowerPoint® PPTM फ़ाइलों को .NET Framework, .NET Core, Windows Azure, Mono या Xamarin प्लेटफॉर्म पर ODP में निर्यात करें" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTM" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET डेवलपर कोड की कुछ ही पंक्तियों में आसानी से PPTM फ़ाइलों को ODP में लोड और परिवर्तित कर सकते हैं।" >}}
...
{{% blocks/products/pf/agp/code-block title="यह नमूना कोड PPTM को ODP C# रूपांतरण दिखाता है" offSpacer="" %}}
