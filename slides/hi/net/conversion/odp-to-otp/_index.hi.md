---
title: ODP को C# के माध्यम से OTP में बदलें
weight: 2110
url: /hi/net/conversion/odp-to-otp/ 
description: ODP से OTP C# रूपांतरण के लिए नमूना कोड। VB.NET, Asp.NET या किसी .NET आधारित एप्लिकेशन के भीतर OTP रूपांतरण के लिए बैच ODP फ़ाइलों के लिए API उदाहरण कोड का उपयोग करें।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ODP को C# के माध्यम से OTP में बदलें" h2="PowerPoint® ODP फ़ाइलों को .NET Framework, .NET Core, Windows Azure, Mono या Xamarin प्लेटफ़ॉर्म पर OTP में निर्यात करें" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके ODP को OTP में कैसे बदलें" %}}

 ODP को OTP में बदलने के लिए, हम उपयोग करेंगे
...
{{< blocks/products/pf/agp/feature-section-col title="ODP को C# के माध्यम से OTP में बदलने के चरण" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET डेवलपर कोड की कुछ ही पंक्तियों में ODP फ़ाइलों को OTP में आसानी से लोड और परिवर्तित कर सकते हैं।" >}}
...
{{% blocks/products/pf/agp/code-block title="यह नमूना कोड ODP से OTP C# रूपांतरण दिखाता है" offSpacer="" %}}
