...
title: सी # के माध्यम से ओडीपी को पीएनजी में कनवर्ट करें
weight: 5570
url: /hi/net/conversion/odp-to-png/ 
description: ODP के लिए PNG C# रूपांतरण के लिए नमूना कोड। VB.NET, Asp.NET या किसी .NET आधारित एप्लिकेशन के भीतर PNG रूपांतरण के लिए बैच ODP फ़ाइलों के लिए API उदाहरण कोड का उपयोग करें।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="सी # के माध्यम से ओडीपी को पीएनजी में कनवर्ट करें" h2="PowerPoint® ODP फ़ाइलों को .NET Framework, .NET Core, Windows Azure, Mono या Xamarin प्लेटफ़ॉर्म पर PNG में निर्यात करें" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके ODP को PNG में कैसे बदलें" %}}

 ODP को PNG में बदलने के लिए, हम उपयोग करेंगे
...
{{< blocks/products/pf/agp/feature-section-col title="ODP को C# के माध्यम से PNG में बदलने के लिए कदम" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET डेवलपर कोड की कुछ ही पंक्तियों में ODP फ़ाइलों को पीएनजी में आसानी से लोड और परिवर्तित कर सकते हैं।" >}}
...
{{% blocks/products/pf/agp/code-block title="यह नमूना कोड ODP को PNG C# रूपांतरण दिखाता है" offSpacer="" %}}
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        ...
        sectionTitle="मुफ्त ऐप ODP को PNG में कन्वर्ट करने के लिए" 
