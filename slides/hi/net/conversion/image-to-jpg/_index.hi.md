---
title: छवि को जेपीजी में सी # में कनवर्ट करें
weight: 200
url: /hi/net/conversion/image-to-jpg/ 
keywords: छवि को JPG में बदलें, छवि को JPG में बदलें, C# API, .NET लाइब्रेरी, छवि, JPG
description: छवि को जेपीजी में सी # में कनवर्ट करें। छवियों को JPG चित्रों में बदलने के लिए .NET लाइब्रेरी API का उपयोग करें।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="छवि को जेपीजी में सी # में कनवर्ट करें" h2="NET फ्रेमवर्क, .NET Core, Windows Azure, Mono या Xamarin प्लेटफॉर्म पर छवियों को JPG चित्रों में कनवर्ट करने के लिए PowerPoint .NET API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="छवि को जेपीजी में सी # में कनवर्ट करें" %}}

मैं छवि को कोड में JPG में कैसे परिवर्तित करूं?

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/hi/net/) का उपयोग करके, कोई भी डेवलपर या एप्लिकेशन C# कोड की कुछ पंक्तियों के साथ किसी छवि को JPG चित्र में बदल सकता है .

एक आधुनिक दस्तावेज़ संसाधन API के रूप में, Aspose.Slides .NET के लिए लोकप्रिय स्वरूपों में छवियों को जल्दी से JPG में निर्यात करता है। Aspose PowerPoint पुस्तकालय आपको छवियों को JPG और कई अन्य छवि प्रारूपों में बदलने की अनुमति देता है।
...
{{< blocks/products/pf/agp/feature-section-col title="छवि को जेपीजी में सी # में कैसे परिवर्तित करें" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="डेवलपर्स और एप्लिकेशन इस तरह इमेज को जेपीजी में बदल सकते हैं:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 इससे पहले कि आप छवि को जेपीजी रूपांतरण सी # कोड में चलाएं, आपकी मशीन में ये पूर्वापेक्षाएँ होनी चाहिए:
...
{{% blocks/products/pf/agp/code-block title="छवि को जेपीजी में बदलने के लिए सी # कोड" offSpacer="" %}}
