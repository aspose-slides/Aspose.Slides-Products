...
title: पीडीएफ को एक्सएमएल में सी # में कनवर्ट करें
weight: 120
url: /hi/net/conversion/pdf-to-xml/ 
keywords: पीडीएफ से एक्सएमएल, पीडीएफ को एक्सएमएल में बदलें, सी# एपीआई, .NET लाइब्रेरी, पीडीएफ, एक्सएमएल
description: पीडीएफ को एक्सएमएल में सी # में कनवर्ट करें। पीडीएफ पेजों को एक्सएमएल फाइलों में बदलने के लिए .NET लाइब्रेरी एपीआई का इस्तेमाल करें
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="पीडीएफ को एक्सएमएल में सी # में कनवर्ट करें" h2="NET फ्रेमवर्क, .NET Core, Windows Azure, Mono या Xamarin प्लेटफॉर्म पर PDF दस्तावेज़ों को XML फ़ाइलों में कनवर्ट करने के लिए PowerPoint .NET API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="सी # में पीडीएफ को एक्सएमएल में कैसे बदलें" %}}

मैं कोड में पीडीएफ को एक्सएमएल में कैसे बदलूं?

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/hi/net/) का उपयोग करके, कोई भी डेवलपर या एप्लिकेशन पीडीएफ को एक्सएमएल फाइलों में सी# कोड की कुछ पंक्तियों के साथ परिवर्तित कर सकता है।

एक आधुनिक दस्तावेज़ संसाधन API के रूप में, Aspose.Slides .NET के लिए PDF पृष्ठों को XML को शीघ्रता से निर्यात करता है। एस्पोज पॉवरपॉइंट लाइब्रेरी आपको पीडीएफ को एक्सएमएल और कई अन्य फाइल फॉर्मेट में बदलने की अनुमति देती है।
...
{{< blocks/products/pf/agp/feature-section-col title="सी # में पीडीएफ को एक्सएमएल में कैसे बदलें" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="डेवलपर्स और एप्लिकेशन इस तरह पीडीएफ को एक्सएमएल में बदल सकते हैं:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 इससे पहले कि आप PDF से XML रूपांतरण C# कोड चलाएँ, आपकी मशीन में ये पूर्वापेक्षाएँ होनी चाहिए:
...
{{% blocks/products/pf/agp/code-block title="पीडीएफ को एक्सएमएल में बदलने के लिए सी # कोड" offSpacer="" %}}
