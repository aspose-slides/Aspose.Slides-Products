...
description: सी # में पीडीएफ को पीपीटी में कनवर्ट करें। PDF को PowerPoint में कनवर्ट करने के लिए .NET लाइब्रेरी API का उपयोग करें
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="सी # में पीडीएफ को पीपीटी में कनवर्ट करें" h2="शक्तिशाली क्रॉस-प्लेटफ़ॉर्म .NET API, NET फ्रेमवर्क, .NET Core, Windows Azure, Mono या Xamarin प्लेटफ़ॉर्म पर C# कोड का उपयोग करके PDF को PPT में बदलने के लिए" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides का उपयोग करके PDF को PPT में बदलें" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/hi/net/) एक शक्तिशाली .NET लाइब्रेरी है जिसका उपयोग PowerPoint प्रस्तुतियों, PDF, HTML डॉक्स को बनाने, बदलने और हेरफेर करने के लिए किया जाता है। और अन्य फ़ाइलें। जब आप पीडीएफ को पीपीटी में कनवर्ट करते हैं, तो आप अनिवार्य रूप से पीडीएफ पेजों की सामग्री को पावरपॉइंट प्रेजेंटेशन में स्लाइड्स में ले जा रहे हैं।

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="सी # में पीडीएफ को पीपीटी में कनवर्ट करें" %}}
...
{{% blocks/products/pf/agp/code-block title="पीडीएफ को पीपीटी में बदलने के लिए सी # कोड" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="सी # में पीडीएफ को पीपीटी में कैसे बदलें" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
उस पीडीएफ फाइल को लोड करें जिसे आप पीपीटी में बदलना चाहते हैं।
{{< /blocks/products/pf/agp/step-autogen >}}
