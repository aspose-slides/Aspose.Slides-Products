---
title: जेपीजी को पीएनजी में सी # में कनवर्ट करें
weight: 220
url: /hi/net/conversion/jpg-to-png/ 
keywords: जेपीजी से पीएनजी, जेपीजी को पीएनजी में बदलें, सी# एपीआई, .NET लाइब्रेरी
description: जेपीजी को पीएनजी में सी # में कनवर्ट करें। जेपीजी को पीएनजी फाइलों में बदलने के लिए .NET लाइब्रेरी एपीआई का इस्तेमाल करें।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="जेपीजी को पीएनजी में सी # में कनवर्ट करें" h2="NET Framework, .NET Core, Windows Azure, Mono या Xamarin प्लेटफॉर्म पर JPG को PNG छवि फ़ाइलों में कनवर्ट करने के लिए PowerPoint .NET API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="जेपीजी को पीएनजी में सी # में कनवर्ट करें" %}}

मैं कोड में JPG को PNG में कैसे परिवर्तित करूं?

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/hi/net/) का उपयोग करके, कोई भी डेवलपर या एप्लिकेशन C# कोड की कुछ पंक्तियों के साथ JPG को PNG में बदल सकता है।

एक आधुनिक दस्तावेज़ संसाधन API के रूप में, Aspose.Slides .NET के लिए JPG फ़ाइलों को शीघ्रता से PNG में निर्यात करता है। Aspose PowerPoint पुस्तकालय आपको JPG को PNG और अन्य स्वरूपों में छवियों को परिवर्तित करने की अनुमति देता है।
...
{{< blocks/products/pf/agp/feature-section-col title="C# में JPG को PNG में कैसे बदलें" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="डेवलपर और एप्लिकेशन इस तरह JPG को PNG में बदल सकते हैं:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 इससे पहले कि आप JPG से PNG रूपांतरण C# कोड चलाएँ, आपकी मशीन में ये पूर्वापेक्षाएँ होनी चाहिए:
...
{{% blocks/products/pf/agp/code-block title="जेपीजी को पीएनजी में बदलने के लिए सी # कोड" offSpacer="" %}}
