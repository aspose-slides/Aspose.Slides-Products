...
title: जेपीजी को सी # में छवि में कनवर्ट करें
weight: 210
url: /hi/net/conversion/jpg-to-image/ 
keywords: JPG से इमेज, JPG को इमेज में बदलें, C# API, .NET लाइब्रेरी
description: जेपीजी को सी # में छवि में कनवर्ट करें। जेपीजी को विभिन्न स्वरूपों में छवियों में बदलने के लिए .NET लाइब्रेरी एपीआई का उपयोग करें।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="जेपीजी को सी # में छवि में कनवर्ट करें" h2="NET फ्रेमवर्क, .NET Core, Windows Azure, Mono या Xamarin प्लेटफ़ॉर्म पर JPG चित्रों को छवि फ़ाइलों में कनवर्ट करने के लिए PowerPoint .NET API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="जेपीजी को सी # में छवि में कनवर्ट करें" %}}

मैं कोड में JPG को छवि में कैसे परिवर्तित करूं?

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/hi/net/) का उपयोग करके, कोई भी डेवलपर या एप्लिकेशन C# कोड की कुछ पंक्तियों के साथ JPG को इमेज में बदल सकता है।

एक आधुनिक दस्तावेज़ संसाधन API के रूप में, Aspose.Slides .NET के लिए JPG फ़ाइलों को अन्य स्वरूपों में छवियों को शीघ्रता से निर्यात करता है। Aspose PowerPoint पुस्तकालय आपको JPG को छवि और कई अन्य फ़ाइल स्वरूपों में बदलने की अनुमति देता है
...
{{< blocks/products/pf/agp/feature-section-col title="C# में JPG को इमेज में कैसे बदलें" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="डेवलपर्स और एप्लिकेशन इस तरह JPG को इमेज में बदल सकते हैं:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 इससे पहले कि आप JPG से छवि रूपांतरण C# कोड चलाएँ, आपकी मशीन में ये पूर्वापेक्षाएँ होनी चाहिए:
...
{{% blocks/products/pf/agp/code-block title="जेपीजी को छवि में बदलने के लिए सी # कोड" offSpacer="" %}}
