...
title: पीडीएफ को पीएनजी में सी # में कनवर्ट करें
weight: 90
url: /hi/net/conversion/pdf-to-png/ 
keywords: पीडीएफ से पीएनजी, पीडीएफ को पीएनजी में बदलें, सी# एपीआई, .NET लाइब्रेरी, पीडीएफ, पीएनजी
description: पीडीएफ को पीएनजी में सी # में कनवर्ट करें। पीडीएफ पेजों को पीएनजी इमेज में बदलने के लिए .NET लाइब्रेरी एपीआई का इस्तेमाल करें
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="पीडीएफ को पीएनजी में सी # में कनवर्ट करें" h2="NET फ्रेमवर्क, .NET Core, Windows Azure, Mono या Xamarin प्लेटफॉर्म पर PDF दस्तावेज़ों को PNG छवियों में कनवर्ट करने के लिए PowerPoint .NET API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="सी # में पीडीएफ को पीएनजी में कैसे बदलें" %}}

मैं कोड में पीडीएफ को पीएनजी में कैसे बदलूं?

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/hi/net/) का उपयोग करके, कोई भी डेवलपर या एप्लिकेशन पीडीएफ को पीएनजी प्रारूप में सी # कोड की कुछ पंक्तियों के साथ परिवर्तित कर सकता है।

एक आधुनिक दस्तावेज़ संसाधन API के रूप में, Aspose.Slides .NET के लिए PDF पृष्ठों को शीघ्रता से PNG में निर्यात करता है। Aspose PowerPoint पुस्तकालय आपको PDF को PNG और कई अन्य फ़ाइल स्वरूपों में बदलने की अनुमति देता है
...
{{< blocks/products/pf/agp/feature-section-col title="सी # में पीडीएफ को पीएनजी में कैसे बदलें" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="डेवलपर्स और एप्लिकेशन इस तरह पीडीएफ को पीएनजी में बदल सकते हैं:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
स्लाइड्स को PNG इमेज के रूप में सेव करने के लिए सेव मेथड को कॉल करें।
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 इससे पहले कि आप पीडीएफ को पीएनजी रूपांतरण सी # कोड में चलाएं, आपकी मशीन में ये पूर्वापेक्षाएँ होनी चाहिए:
...
{{% blocks/products/pf/agp/code-block title="पीडीएफ को पीएनजी में बदलने के लिए सी # कोड" offSpacer="" %}}
