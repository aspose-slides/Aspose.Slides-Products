...
title: जेपीजी को सी # में पीडीएफ में कनवर्ट करें
weight: 10
url: /hi/net/conversion/jpg-to-pdf/ 
keywords: JPG से PDF, JPG को PDF में बदलें, C# API, .NET लाइब्रेरी
description: जेपीजी को सी # में पीडीएफ में कनवर्ट करें। जेपीजी जेपीईजी छवियों को पीडीएफ दस्तावेजों में बदलने के लिए .NET पुस्तकालय एपीआई का प्रयोग करें।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="जेपीजी को सी # में पीडीएफ में कनवर्ट करें" h2="NET फ्रेमवर्क, .NET Core, Windows Azure, Mono या Xamarin प्लेटफॉर्म पर JPG छवियों को PDF दस्तावेज़ों में कनवर्ट करने के लिए PowerPoint .NET API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="C# में JPG को PDF में कैसे बदलें" %}}

मैं प्रोग्राम के रूप में JPG को PDF में कैसे परिवर्तित करूं?

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/hi/net/) का उपयोग करके, कोई भी डेवलपर या एप्लिकेशन C# कोड की कुछ पंक्तियों के साथ JPG को PDF फॉर्मेट में बदल सकता है।

एक आधुनिक दस्तावेज़ संसाधन API के रूप में, Aspose.Slides .NET के लिए जल्दी से JPG छवियों से PDF बनाता है। Aspose PowerPoint पुस्तकालय आपको JPG को PDF और कई अन्य फ़ाइल स्वरूपों में बदलने की अनुमति देता है
...
{{< blocks/products/pf/agp/feature-section-col title="C# में JPG को PDF में बदलने के चरण" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="डेवलपर और एप्लिकेशन इस तरह JPG को PDF में बदल सकते हैं:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 इससे पहले कि आप JPG से PDF रूपांतरण C# कोड चलाएँ, आपकी मशीन में ये पूर्वापेक्षाएँ होनी चाहिए:
...
{{% blocks/products/pf/agp/code-block title="जेपीजी को पीडीएफ में बदलने के लिए सी# कोड" offSpacer="" %}}
