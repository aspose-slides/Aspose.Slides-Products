---
title: पीडीएफ को जेपीजी में सी # में कनवर्ट करें
weight: 70
url: /hi/net/conversion/pdf-to-jpg/ 
keywords: पीडीएफ से जेपीजी, पीडीएफ को जेपीजी में बदलें, सी# एपीआई, .NET लाइब्रेरी, पीडीएफ, जेपीजी
description: पीडीएफ को जेपीजी में सी # में कनवर्ट करें। पीडीएफ पेजों को जेपीजी इमेज में बदलने के लिए .NET लाइब्रेरी एपीआई का इस्तेमाल करें
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="पीडीएफ को जेपीजी में सी # में कनवर्ट करें" h2="नेट फ्रेमवर्क, .NET कोर, विंडोज़ एज़्योर, मोनो या ज़ैमरिन प्लेटफ़ॉर्म पर पीडीएफ दस्तावेज़ों को जेपीजी छवियों में परिवर्तित करने के लिए पावरपॉइंट .NET एपीआई" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="सी#में पीडीएफ को जेपीजी में कैसे बदलें" %}}

मैं कोड में पीडीएफ को जेपीजी में कैसे बदलूं?

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/hi/net/) का उपयोग करके, कोई भी डेवलपर या एप्लिकेशन C# कोड की कुछ पंक्तियों के साथ PDF को JPG फॉर्मेट में बदल सकता है।

एक आधुनिक दस्तावेज़ संसाधन API के रूप में, Aspose.Slides .NET के लिए PDF पृष्ठों को शीघ्रता से JPG में निर्यात करता है। Aspose PowerPoint लाइब्रेरी आपको PDF को JPG और कई अन्य फ़ाइल स्वरूपों में बदलने की अनुमति देती है
...
{{< blocks/products/pf/agp/feature-section-col title="सी#में पीडीएफ को जेपीजी में कैसे बदलें" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="डेवलपर्स और एप्लिकेशन इस तरह पीडीएफ को जेपीजी में बदल सकते हैं:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
स्लाइड्स को JPG इमेज के रूप में सेव करने के लिए सेव मेथड को कॉल करें।
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 इससे पहले कि आप PDF से JPG रूपांतरण C# कोड चलाएँ, आपकी मशीन में ये पूर्वापेक्षाएँ होनी चाहिए:
...
{{% blocks/products/pf/agp/code-block title="पीडीएफ को जेपीजी में बदलने के लिए सी # कोड" offSpacer="" %}}
