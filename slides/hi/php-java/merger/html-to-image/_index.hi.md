...
description: PHP में HTML को छवि में मर्ज करें। HTML को छवि से संयोजित करने के लिए PHP लाइब्रेरी API का उपयोग करें
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="PHP में छवि मर्ज करें" h2="PHP कोड का उपयोग करके HTML को इमेज में मर्ज करने के लिए हाई-स्पीड और क्रॉस-प्लेटफ़ॉर्म PHP लाइब्रेरी" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides का उपयोग करके HTML को इमेज में मर्ज करें" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/hi/php-java/) एक शक्तिशाली PHP लाइब्रेरी है जिसका इस्तेमाल प्रेजेंटेशन, HTML डॉक्स और अन्य फाइलों को मर्ज और मैनिपुलेट करने के लिए किया जाता है। जब आप HTML को छवि में मर्ज करते हैं, तो आप एकल छवि प्राप्त करने के लिए HTML दस्तावेज़ों में सामग्री को प्रभावी ढंग से संयोजित कर रहे हैं। 
...
{{% blocks/products/pf/feature-page-section  h2="PHP में HTML को छवि में मर्ज करें" %}}
...
{{% blocks/products/pf/agp/code-block title="HTML को इमेज में मर्ज करने के लिए PHP कोड" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="PHP में HTML को इमेज में कैसे मर्ज करें" >}}
