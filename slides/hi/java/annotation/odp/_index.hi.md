...
{{% blocks/products/pf/agp/content h2="जावा का उपयोग करके ओडीपी फ़ाइल को कैसे एनोटेट करें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="जावा के माध्यम से ओडीपी से टिप्पणियां हटाने के चरण" %}}
...
1. इसे ODP फॉर्मेट में सेव करें
1. विशिष्ट स्थान पर टिप्पणी हटाएं
1. ODP फाइल को दोबारा सेव करें और तुलना करें
...
{{% blocks/products/pf/agp/code-block title="ओडीपी से एनोटेशन हटाएं - जावा" offSpacer="" %}}
