...
{{% blocks/products/pf/agp/code-block title="PPSX अंतर्निहित गुणों को संशोधित करें - Java" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="PPSX - Java में कस्टम गुण जोड़ें" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Java के द्वारा PPSX का मेटाडेटा कैसे निकालें" >}}
