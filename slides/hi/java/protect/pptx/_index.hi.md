---
title: जावा के माध्यम से PPTX दस्तावेज़ को सुरक्षित और लॉक करें
weight: 6710
url: /hi/java/protect/pptx/ 
description: जेएसपी/जेएसएफ एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए जावा रनटाइम एनवायरनमेंट पर पासवर्ड का उपयोग करके पीपीटीएक्स फ़ाइल को लॉक करने के लिए जावा नमूना कोड।
---
...
{{% blocks/products/pf/agp/content h2="जावा का उपयोग करके पीपीटीएक्स फ़ाइल को कैसे सुरक्षित करें" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="जावा के माध्यम से पीपीटीएक्स फाइलों की सुरक्षा के लिए कदम" >}}
