---
title: जावा के माध्यम से पीपीटी दस्तावेज़ को सुरक्षित और लॉक करें
weight: 640
url: /hi/java/protect/ppt/ 
description: जेएसपी/जेएसएफ एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए जावा रनटाइम एनवायरनमेंट पर पासवर्ड का उपयोग करके पीपीटी फ़ाइल को लॉक करने के लिए जावा नमूना कोड।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="जावा के माध्यम से पीपीटी फाइलों को एन्क्रिप्ट करें" h2=".NET लाइब्रेरी का उपयोग करके पीपीटी प्रारूप सहित पावरपॉइंट प्रस्तुतियों को पासवर्ड से सुरक्षित रखें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="जावा का उपयोग करके पीपीटी फ़ाइल को कैसे सुरक्षित करें" %}}

 पीपीटी फ़ाइल की सुरक्षा के लिए, हम उपयोग करेंगे
 [Aspose.Slides for Java](https://products.aspose.com/slides/hi/java)
 एपीआई जो एक सुविधा संपन्न, शक्तिशाली और जावा प्लेटफॉर्म के लिए उपयोग में आसान एन्क्रिप्शन एपीआई है। आप इसका नवीनतम संस्करण सीधे से डाउनलोड कर सकते हैं
...
{{< blocks/products/pf/agp/feature-section-col title="जावा के माध्यम से पीपीटी फाइलों की सुरक्षा के लिए कदम" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
पासवर्ड सेट करें getProtectionManager().encrypt(.) विधि
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
संरक्षित प्रस्तुति को पीपीटी प्रारूप में सहेजें
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/other-supported-section title="अन्य समर्थित सुरक्षा दस्तावेज" subTitle="जावा का उपयोग करके, कोई अन्य फ़ाइलों की सुरक्षा कर सकता है, जिनमें शामिल हैं।" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/hi/java/protect/odp/" name="ODP" description="OpenDocument प्रस्तुति स्वरूप" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/hi/java/protect/pptx/" name="PPTX" description="एक्सएमएल प्रस्तुति प्रारूप खोलें" >}}
