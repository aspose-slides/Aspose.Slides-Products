---
title: जावा में एचटीएमएल को पीपीटी में कनवर्ट करें
url: /hi/java/conversion/html-to-ppt/
keywords: HTML को PPT, HTML को PPT, PowerPoint, HTML, PPT, Java API, Java लाइब्रेरी में बदलें
description: जावा में एचटीएमएल को पीपीटी में कनवर्ट करें। HTML को PowerPoint में बदलने के लिए Java लाइब्रेरी API का उपयोग करें
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="जावा में एचटीएमएल को पीपीटी में कनवर्ट करें" h2="जावा कोड का उपयोग करके HTML को PPT में बदलने के लिए शक्तिशाली क्रॉस-प्लेटफ़ॉर्म Java API" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides का उपयोग करके HTML को PPT में बदलें" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/hi/java/) एक शक्तिशाली जावा लाइब्रेरी है जिसका उपयोग PowerPoint प्रस्तुतियों, PDF, HTML डॉक्स और अन्य को बनाने, बदलने और हेरफेर करने के लिए किया जाता है फ़ाइलें। जब आप HTML को पीपीटी में कनवर्ट करते हैं, तो आप अनिवार्य रूप से सामग्री को HTML दस्तावेज़ में PowerPoint प्रस्तुति में स्लाइड में ले जा रहे हैं।

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="जावा में एचटीएमएल को पीपीटी में कनवर्ट करें" %}}
...
{{% blocks/products/pf/agp/code-block title="एचटीएमएल को पीपीटी में बदलने के लिए जावा कोड" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="जावा में HTML को PPT में कैसे बदलें" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/hi/java/conversion/jpg-to-ppt/" name="JPG TO PPTX" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/hi/java/conversion/jpg-to-pptx/" name="JPG TO PPT" >}}
