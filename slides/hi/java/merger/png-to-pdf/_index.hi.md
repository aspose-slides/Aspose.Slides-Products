---
title: जावा में पीएनजी को पीडीएफ में मर्ज करें
url: /hi/java/merger/png-to-pdf/
keywords: पीएनजी से पीडीएफ, पीएनजी को पीडीएफ में मर्ज करें, पीएनजी से पीडीएफ, पीडीएफ, पीएनजी, जावा एपीआई, जावा लाइब्रेरी से जुड़ें
description: जावा में पीएनजी को पीडीएफ में मर्ज करें। पीएनजी और पीडीएफ को गठबंधन करने के लिए जावा लाइब्रेरी एपीआई का प्रयोग करें
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="जावा में पीएनजी को पीडीएफ में मर्ज करें" h2="जावा कोड का उपयोग करके पीएनजी को पीडीएफ फाइलों में मर्ज करने के लिए हाई-स्पीड और क्रॉस-प्लेटफॉर्म जावा लाइब्रेरी" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides का उपयोग करके PNG को PDF में मर्ज करें" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/hi/java/) एक शक्तिशाली जावा लाइब्रेरी है जिसका उपयोग प्रस्तुतियों, छवियों और अन्य फ़ाइलों को बनाने, परिवर्तित करने, विलय करने और हेरफेर करने के लिए किया जाता है। जब आप पीएनजी को पीडीएफ में मर्ज करते हैं, तो आप एक पीडीएफ फाइल प्राप्त करने के लिए पीएनजी छवियों को प्रभावी ढंग से जोड़ रहे हैं।
...
{{% blocks/products/pf/feature-page-section  h2="जावा में पीएनजी को पीडीएफ में मर्ज करें" %}}
[**Aspose.Slides for Java**](https://products.aspose.com/slides/hi/java/) का उपयोग करके, आप कोड की कुछ पंक्तियों के साथ PNG को PDF में शीघ्र मर्ज कर सकते हैं

{{% blocks/products/pf/agp/code-block title="पीएनजी को पीडीएफ में मर्ज करने के लिए जावा कोड" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="जावा में PNG को PDF में कैसे मर्ज करें" >}}
