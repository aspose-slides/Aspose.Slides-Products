---
title: C++ में TIFF को PDF में मर्ज करें
url: /hi/cpp/merger/tiff-to-pdf/
keywords: TIFF से PDF, TIFF को PDF में मर्ज करें, TIFF से PDF, PDF, TIFF, C++ API, C++ लाइब्रेरी में शामिल हों
description: C++ में TIFF को PDF में मर्ज करें। टीआईएफएफ और पीडीएफ को गठबंधन करने के लिए सी ++ लाइब्रेरी एपीआई का प्रयोग करें
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="C++ में TIFF को PDF में मर्ज करें" h2="C++ कोड का उपयोग करके TIFF को PDF फ़ाइलों में मर्ज करने के लिए हाई-स्पीड और क्रॉस-प्लेटफ़ॉर्म C++ लाइब्रेरी" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides का उपयोग करके TIFF को PDF में मर्ज करें" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/hi/cpp/) एक शक्तिशाली C++ लाइब्रेरी है जिसका उपयोग प्रस्तुतियों, PDF, छवियों और अन्य को बनाने, बदलने, मर्ज करने और हेरफेर करने के लिए किया जाता है फ़ाइलें। जब आप टीआईएफएफ को पीडीएफ में मर्ज करते हैं, तो आप एक पीडीएफ फाइल प्राप्त करने के लिए छवियों को प्रभावी ढंग से जोड़ रहे हैं।
...
{{% blocks/products/pf/feature-page-section  h2="C++ में TIFF को PDF में मर्ज करें" %}}
[**Aspose.Slides for C++**](https://products.aspose.com/slides/hi/cpp/) का उपयोग करके, आप कोड की बस कुछ पंक्तियों के साथ TIFF को PDF में मर्ज कर सकते हैं

{{% blocks/products/pf/agp/code-block title="TIFF को PDF में मर्ज करने के लिए C++ कोड" offSpacer="true" %}}
```cpp
