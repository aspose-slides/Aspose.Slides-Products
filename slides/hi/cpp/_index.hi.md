...
<p class="col-lg-10">एक्सेल चार्ट को स्लाइड में OLE ऑब्जेक्ट के रूप में एम्बेड करें</p>

</div>

<div class="col-lg-4"><em class="fa fa-print  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">लिंक किए गए ओले ऑब्जेक्ट्स को प्रबंधित करें</p>
...
<p class="col-lg-10">प्रस्तुतियों की अनुकूलित मुद्रण</p>
...
<h2 class="h2title">नई सुविधाओं का निरंतर एकीकरण</h2>

<p>आप कभी भी मौजूदा सुविधाओं तक सीमित नहीं होते हैं। हमारी उत्पाद टीमें लगातार अधिक से अधिक सुविधाएँ जोड़ रही हैं और हर नया संस्करण पुराने संस्करणों की तुलना में अधिक सुविधाएँ प्रदान करता है। यदि आप अपनी वांछित सुविधाओं में से कोई भी गायब पाते हैं तो आप नए फीचर अनुरोध भी भेज सकते हैं। यहां नवीनतम सुविधाओं में से कुछ चयनों की सूची दी गई है।</p>

<ul>

<li>पाठ के बिना आकृतियों का रेखापुंजीकरण या सदिशीकरण।</li>

<li>एसवीजी छवियों को आकृतियों में बदलें।</li>

<li>डिफ़ॉल्ट तालिका पृष्ठभूमि प्राप्त करें।</li>

<li>दस्तावेज़ खोलते समय स्थानीय फ़ाइल सिस्टम पहुँच को प्रतिबंधित करना।</li>

<li>HTML में सहेजते समय एन्कोडिंग मेटा टैग जोड़ें।</li>

<li>एचटीएमएल के रूप में सहेजते समय एसवीजी टैग की चौड़ाई और ऊंचाई विशेषताओं को हटाने के लिए सेटिंग।</li>

<li>Support for

<ul>

<li>टिप्पणियाँ उत्तर, Office 365 और बाहरी Excel कार्यपुस्तिकाएँ।</li>

<li>आकार बबल चार्ट के लिए संपत्ति का प्रतिनिधित्व करता है।</li>

<li>उत्पन्न पीपीटी में बाईं स्लाइड थंबनेल फलक को छिपाना।</li>

<li>फ़नल चार्ट, 2D मानचित्र चार्ट और चार्ट बाहरी डेटा स्रोत कार्यपुस्तिका पथ सेट करें।</li>

<li>ओपन डॉक्यूमेंट एन्क्रिप्शन, मॉर्फ ट्रांजिशन और टेक्स्ट हाइलाइटर फीचर।</li>

<li>छाया प्रभाव के लिए पारदर्शिता गुण सेट करना।</li>

<li>शृंखला डेटा लेबल के लिए कॉलआउट आकार सेट करना।</li>

<li>टेक्स्ट-बॉक्स पैराग्राफ द्वारा प्रभाव प्राप्त करें।</li>

<li>रेंडरिंग शेप सॉफ्ट एज (EffectFormat) इफेक्ट।</li>

<li>पिवट टेबल पर चार्टडेटा सेटरेंज।</li>

</ul>

</li>

<li>मल्टी-पेज टिफ फॉर्मेट, मेटाफाइल फॉर्मेट प्लस एक्सटेंशन्स (ईएमएफ+) और स्ट्रिक्ट ओपन एक्सएमएल फॉर्मेट को लागू करें।</li>

<li>ओडीपी प्रारूप से ऐसी टिप्पणियां प्रस्तुत करना जिनमें कोई लेखक नहीं है।</li>

<li>स्ट्रिक्ट ओपन एक्सएमएल प्रारूप अनुपालन के साथ क्रमांकन लागू करें।</li>
...
<h2 class="h2title">स्मार्टआर्ट आकार प्रसंस्करण</h2>

<p>Aspose.Slides for C++ स्क्रैच से स्मार्टआर्ट आकार बनाने में सुविधा प्रदान करता है और साथ ही स्लाइड से मौजूदा स्मार्टआर्ट आकृतियों तक पहुंचने, हेरफेर करने या हटाने की क्षमता प्रदान करता है। इसके अलावा, शैली, रंग और लेआउट सेट करने जैसी स्मार्टआर्ट आकृतियों को प्रारूपित करना भी संभव है।</p>
...
{{< blocks/products/pf/slr-element name="रिलीज नोट्स" href="https://releases.aspose.com/slides/cpp/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
