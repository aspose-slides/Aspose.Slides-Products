...
url: /hi/cpp/conversion/html-to-ppt/
keywords: HTML को PPT, HTML को PPT, PowerPoint, HTML, PPT, C++ API, C++ लाइब्रेरी में कनवर्ट करें
description: C++ में HTML को PPT में बदलें। HTML को PowerPoint में कनवर्ट करने के लिए C++ लाइब्रेरी API का उपयोग करें
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="C++ में HTML को PPT में बदलें" h2="C++ कोड का उपयोग करके HTML को PPT में बदलने के लिए शक्तिशाली क्रॉस-प्लेटफ़ॉर्म C++ API" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides का उपयोग करके HTML को PPT में बदलें" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/hi/cpp/) एक शक्तिशाली C++ लाइब्रेरी है जिसका उपयोग PowerPoint प्रस्तुतियों, PDF, HTML डॉक्स और अन्य को बनाने, बदलने और हेरफेर करने के लिए किया जाता है फ़ाइलें। जब आप HTML को पीपीटी में कनवर्ट करते हैं, तो आप अनिवार्य रूप से सामग्री को HTML दस्तावेज़ में PowerPoint प्रस्तुति में स्लाइड में ले जा रहे हैं।
