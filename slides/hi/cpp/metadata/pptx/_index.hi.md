---
title: C++ के माध्यम से PPTX दस्तावेज़ मेटाडेटा संपादित करें या देखें
weight: 3950
url: /hi/cpp/metadata/pptx/ 
description: विंडोज 32 बिट, विंडोज 64 बिट और लिनक्स 64 बिट के लिए सी ++ रनटाइम एनवायरनमेंट पर पीपीटीएक्स फ़ाइल मेटाडेटा को संपादित करने या देखने के लिए सी ++ उदाहरण कोड।
---
...
{{% blocks/products/pf/agp/content h2="C++ का उपयोग करके PPTX मेटाडेटा कैसे प्राप्त करें?" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="C++ के माध्यम से PPTX का मेटाडेटा निकालने के चरण" >}}
