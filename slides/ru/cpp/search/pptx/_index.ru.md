...
description: Пример кода C++ для поиска слов с шаблоном в файле PPTX в среде выполнения C++ для 32-разрядной версии Windows, 64-разрядной версии Windows и 64-разрядной версии Linux.
---
...
{{< blocks/products/pf/agp/feature-section-col title="Шаги для поиска файлов PPTX в C++" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ru/cpp/search/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
