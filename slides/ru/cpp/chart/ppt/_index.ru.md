---
title: Диаграмма документа PPT через C++
weight: 7490
url: /ru/cpp/chart/ppt/ 
description: Пример кода C++ для рисования и преобразования диаграммы или диаграммы в файл PPT в среде выполнения C++ для 32-разрядной версии Windows, 64-разрядной версии Windows и 64-разрядной версии Linux.
---
...
{{% blocks/products/pf/agp/content h2="Как создавать диаграммы файлов PPT с помощью C++" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/cpp/chart/pptx/" name="PPTX" description="Формат презентации Open XML" >}}
