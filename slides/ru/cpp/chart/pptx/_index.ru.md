...
title: Диаграмма документа PPTX через C++
weight: 5370
url: /ru/cpp/chart/pptx/ 
description: Пример кода C++ для рисования и преобразования диаграммы или диаграммы в файл PPTX в среде выполнения C++ для 32-разрядной версии Windows, 64-разрядной версии Windows и 64-разрядной версии Linux.
---
...
{{< blocks/products/pf/agp/step-autogen >}}
Получите книгу данных диаграммы.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Добавьте серии и категории.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Возьмите первую серию диаграммы и заполните данные.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Создать диаграмму файлов PPTX — C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="Другие поддерживаемые форматы графиков" subTitle="Используя C++, можно легко справиться с charing с различными форматами, в том числе." >}}
