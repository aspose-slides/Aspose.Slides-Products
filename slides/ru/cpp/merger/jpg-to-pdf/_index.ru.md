...
url: /ru/cpp/merger/jpg-to-pdf/
keywords: JPG в PDF, объединить JPG в PDF, объединить JPG в PDF, PDF, JPG, API C++, библиотеку C++
description: Объединение JPG в PDF на C++. Используйте API библиотеки C++ для объединения JPG и PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Объединить JPG в PDF на C++" h2="Высокоскоростная кроссплатформенная библиотека C++ для объединения файлов JPG в PDF с использованием кода C++." >}}

{{% blocks/products/pf/feature-page-section h2="Объединение JPG в PDF с помощью Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/ru/cpp/) — мощная библиотека C++, используемая для создания, преобразования, объединения и управления презентациями, PDF-файлами, изображениями и другими материалами. файлы. Когда вы объединяете JPG в PDF, вы эффективно объединяете изображения JPG, чтобы получить один файл PDF.
...
Используя [**Aspose.Slides for C++**](https://products.aspose.com/slides/ru/cpp/), вы можете быстро объединить JPG в PDF всего несколькими строками кода.

{{% blocks/products/pf/agp/code-block title="Код C++ для объединения JPG в PDF" offSpacer="true" %}}
```cpp
