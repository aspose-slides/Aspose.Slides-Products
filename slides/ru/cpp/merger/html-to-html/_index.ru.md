---
title: Слияние файлов HTML в C++
url: /ru/cpp/merger/html-to-html/
keywords: Объединение HTML, HTML в HTML, объединение HTML, объединение HTML, API C++, библиотека C++
description: Слияние HTML с HTML в C++. Используйте API библиотеки C++ для объединения файлов HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Слияние HTML в C++" h2="Высокоскоростная и кроссплатформенная библиотека C++ для слияния HTML-файлов с использованием кода C++." >}}

{{% blocks/products/pf/feature-page-section h2="Слияние HTML с HTML с помощью Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/ru/cpp/) — мощная библиотека C++, используемая для создания, преобразования, объединения и управления презентациями, HTML-файлами и другими документами. . Когда вы объединяете HTML в HTML, вы эффективно объединяете содержимое двух документов для получения одного HTML-файла. Aspose.Slides позволяет объединять HTML-документы различными способами. Вы можете объединить HTML со всеми их текстами, форматированием, стилями и т. д.
...
Используя [**Aspose.Slides for C++**](https://products.aspose.com/slides/ru/cpp/), вы можете быстро объединять HTML-файлы всего несколькими строками кода.
