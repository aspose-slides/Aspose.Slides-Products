---
title: Объединение PDF-файлов в C++
url: /ru/cpp/merger/pdf-to-pdf/
keywords: Объединение PDF, PDF в PDF, объединение PDF, объединение PDF, API C++, библиотека C++
description: Слияние PDF в PDF на C++. Используйте API библиотеки C++ для объединения PDF-файлов
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Объединить PDF в C++" h2="Высокоскоростная и кроссплатформенная библиотека C++ для слияния PDF-файлов с использованием кода C++." >}}

{{% blocks/products/pf/feature-page-section h2="Объединение PDF в PDF с помощью Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/ru/cpp/) — это мощная библиотека C++, используемая для создания, преобразования, объединения и управления презентациями, PDF-файлами и другими документами. Когда вы объединяете PDF в PDF, вы фактически объединяете страницы из двух документов для получения одного файла PDF. Aspose.Slides позволяет объединять PDF-файлы различными способами. Вы можете объединять PDF-файлы со всеми их формами, стилями, текстами, форматированием и т. д.
...
{{% blocks/products/pf/feature-page-section  h2="Объединить PDF в PDF на C++" %}}
Используя [**Aspose.Slides for C++**](https://products.aspose.com/slides/ru/cpp/), вы можете быстро объединять PDF-файлы всего несколькими строками кода.

{{% blocks/products/pf/agp/code-block title="Код C++ для слияния PDF в PDF" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PDF в C++" >}}
