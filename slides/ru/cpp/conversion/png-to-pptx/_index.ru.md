...
url: /ru/cpp/conversion/png-to-pptx/
keywords: Преобразование PNG в PPTX, PNG в PPTX, PowerPoint, PNG, PPTX, C++ API, C++ Library
description: Преобразование PNG в PPTX на C++. Используйте API библиотеки C++ для преобразования изображений PNG в PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Преобразование PNG в PPTX на C++" h2="Мощный кроссплатформенный C++ API для преобразования PNG в PPTX с использованием кода C++" >}}
...
{{% blocks/products/pf/agp/code-block title="Код C++ для преобразования PNG в PPTX" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="Как конвертировать PNG в PPTX на С++" >}}
