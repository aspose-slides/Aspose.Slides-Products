...
title: SSRS SQL PPT | API-интерфейс Aspose.Slides для PowerPoint
weight: 3020
url: /ru/reporting-services/ 
description: API PowerPoint служб Reporting Services — это Aspose.Slides для SQL PPT. Услуги презентации PowerPoint для SQL PowerPoint.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API служб отчетов PowerPoint" h2="Экспорт отчетов RDL в форматы PowerPoint PPT, PPTX, PPS и PPSX." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-reporting-services.svg" pfName="Aspose.Slides" subTitlepfName="for Reporting Services" downloadUrl="https://downloads.aspose.com/slides/reportingservices" >}}
...
<p>
 Aspose.Slides for Reporting Services — единственное решение на рынке, позволяющее создавать презентации в собственных форматах PowerPoint из служб отчетов Microsoft SQL Server.
</p>

<p>
 Aspose.Slides for Reporting Services поддерживает почти все функции RDL, такие как таблицы, матрицы, диаграммы, изображения, списки, вложенные отчеты и верхние/нижние колонтитулы, что позволяет экспортировать отчеты в форматы презентаций PowerPoint таким образом, чтобы они выглядели похожими на оригинал. дизайн отчета. Выполнение SQL PPT служб Reporting Services без Microsoft PowerPoint Automation.
</p>
...
{{< blocks/products/pf/carousel-item h3="С одного взгляда" description="Обзор Aspose.Slides для Reporting Services." >}}
...
{{< blocks/products/pf/carousel-item h3="Независимость от платформы" description="Продукт поддерживает службы отчетов Microsoft SQL Server." >}}
<div class="diagram1 d1-rs">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Расширенные функции API служб отчетов
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Создание сравнительных диаграмм в отчетах RDL и экспорт в виде презентаций
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Создание сложных отчетов RDL и экспорт в файлы презентаций
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Экспорт ориентированных на данные отчетов RDL, содержащих вложенные отчеты
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Экспорт встраивания аудио и видео в файлы PowerPoint
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Экспорт отчетов RDL, содержащих вложенные отчеты, в PowerPoint
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Изменить цвет серии и ее категорий
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Растеризация или векторизация фигур без текста
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-share ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Преобразование изображений SVG в фигуры
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Изменение цвета текста гиперссылки во время презентации
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Добавить метатег кодирования при сохранении в HTML
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Поддержка шифрования Open Document, выделения текста и Morph Transition.
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Поддерживаются воронкообразные диаграммы и двумерные картографические диаграммы.
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Поддержка ответов на комментарии и Office 365
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Экспорт в форматы презентаций и слайд-шоу
    </h2>
    <p>
     Службы отчетов SQL Server (SSRS) не предоставляют встроенной поддержки экспорта отчетов RDL в презентации или слайд-шоу PowerPoint. При использовании Aspose.Slides for Reporting Services вы можете легко добавить поддержку дополнительных форматов экспорта.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for Reporting Services поддерживает полную спецификацию RDL, и с помощью этого расширения можно настраивать существующие отчеты. Выбрать любой дизайнер отчетов RDL, а затем экспортировать отчеты точно так же, как он был разработан, довольно просто.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for Reporting Services построен с использованием управляемого кода, который никогда не требует установки Microsoft PowerPoint на компьютере для работы с презентациями PowerPoint. Это идеальная альтернатива автоматизации Microsoft PowerPoint с точки зрения поддерживаемых функций, безопасности, стабильности, масштабируемости, скорости и цены.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Документация" href="https://docs.aspose.com/slides/reportingservices/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Почему Aspose.Slides для Reporting Services?" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.Slides" description="Aspose.Slides предлагает отдельные API-интерфейсы PowerPoint для других популярных сред разработки, перечисленных ниже:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/slides/ru/python-java/" imgSrc="https://products.aspose.com/slides/images/aspose_slides-for-python-via-java.svg" sdkName="Python via Java" >}}
