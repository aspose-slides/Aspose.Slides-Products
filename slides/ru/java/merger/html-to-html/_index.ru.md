---
title: Слияние файлов HTML в Java
url: /ru/java/merger/html-to-html/
keywords: Объединение HTML, HTML в HTML, объединение HTML, объединение HTML, API Java, библиотека Java
description: Слияние HTML с HTML в Java. Используйте API библиотеки Java для объединения файлов HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Слияние HTML в Java" h2="Высокоскоростная и кроссплатформенная библиотека Java для слияния файлов HTML с использованием кода Java." >}}

{{% blocks/products/pf/feature-page-section h2="Слияние HTML с HTML с помощью Aspose.Slides" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/ru/java/) — мощная библиотека Java, используемая для создания, преобразования, объединения и управления презентациями, HTML-файлами и другими документами. . Когда вы объединяете HTML в HTML, вы фактически объединяете содержимое двух документов для получения одного HTML-файла. Aspose.Slides позволяет объединять HTML-документы различными способами. Вы можете объединить HTML со всеми их текстами, форматированием, стилями и т. д.
...
{{% blocks/products/pf/feature-page-section  h2="Слияние HTML с HTML в Java" %}}
Используя [**Aspose.Slides for Java**](https://products.aspose.com/slides/ru/java/), вы можете быстро объединять HTML-файлы всего несколькими строками кода.

{{% blocks/products/pf/agp/code-block title="Код Java для слияния HTML с HTML" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить HTML в Java" >}}
