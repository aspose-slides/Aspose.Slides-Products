...
title: Слияние файлов PPS через Java
weight: 3930
url: /ru/java/merger/pps/ 
description: Пример кода Java для объединения документов PPS в среде выполнения Java для приложений JSP/JSF и настольных приложений.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Объединение форматов PPS в Java" h2="Нативное слияние документов PPS с использованием серверных API Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPS" >}}
...
{{% blocks/products/pf/agp/content h2="Как объединить файлы PPS с помощью Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Шаги для слияния файлов PPS в Java" >}}
...
Загрузите первый файл PPS с экземпляром класса Presentation.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Загрузите второй документ PPS с экземпляром класса Presentation.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Прокрутите каждый слайд второго файла PPS.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Объединение файлов PPS — Java" offSpacer="" %}}
