...
url: /ru/java/merger/pdf-to-pdf/
keywords: Объединение PDF, PDF в PDF, объединение PDF, объединение PDF, API Java, библиотека Java
description: Слияние PDF в PDF в Java. Используйте API библиотеки Java для объединения файлов PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Объединить PDF в Java" h2="Высокоскоростная и кроссплатформенная библиотека Java для слияния файлов PDF с использованием кода Java." >}}

{{% blocks/products/pf/feature-page-section h2="Объединение PDF в PDF с помощью Aspose.Slides" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/ru/java/) — это мощная библиотека Java, используемая для создания, преобразования, объединения и управления презентациями, файлами PDF и другими документами. Когда вы объединяете PDF в PDF, вы эффективно объединяете страницы из двух документов для получения одного файла PDF. Aspose.Slides позволяет объединять PDF-файлы различными способами. Вы можете объединять PDF-файлы со всеми их формами, стилями, текстами, форматированием и т. д.
...
{{% blocks/products/pf/feature-page-section  h2="Объединение PDF в PDF в Java" %}}
Используя [**Aspose.Slides for Java**](https://products.aspose.com/slides/ru/java/), вы можете быстро объединять PDF-файлы всего несколькими строками кода.

{{% blocks/products/pf/agp/code-block title="Код Java для объединения PDF в PDF" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PDF в Java" >}}
