---
title: Поиск документа ODP без открытия через Java
weight: 1250
url: /ru/java/search/odp/ 
description: Пример кода Java для поиска слов с шаблоном в файле ODP в среде выполнения Java для приложений JSP/JSF и настольных приложений.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Поиск форматов ODP в Java" h2="Встроенный и высокопроизводительный поиск документов ODP с использованием серверных API-интерфейсов Aspose.Slides for Java без использования какого-либо программного обеспечения, такого как Microsoft или Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Как искать файл ODP с помощью Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Шаги для поиска файлов ODP в Java" >}}
...
Загрузите файл ODP, создав экземпляр объекта Presentation Class.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Поиск файлов ODP — Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ru/java/search/pptx/" name="PPTX" description="Формат презентации Open XML" >}}
