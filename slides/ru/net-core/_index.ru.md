...
{{< blocks/products/pf/carousel-item h3="Поддерживаемые форматы файлов" description="Aspose.Slides для .NET Core поддерживает популярные [форматы презентаций](https://docs.aspose.com/slides/net/supported-file-formats/) и форматы экспорта, перечисленные ниже." >}}
