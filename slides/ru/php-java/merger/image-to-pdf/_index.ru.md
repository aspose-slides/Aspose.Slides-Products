---
title: Объединить изображение в PDF в PHP
url: /ru/php-java/merger/image-to-pdf/
keywords: Изображение в PDF, Объединить изображение в PDF, Присоединить изображение к PDF, PDF, Изображение, PHP API, PHP-библиотека
description: Объединить изображение в PDF в PHP. Используйте API библиотеки PHP для объединения изображений и PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Объединить изображение в PDF в PHP" h2="Высокоскоростная и кроссплатформенная библиотека PHP для объединения изображений в файлы PDF с использованием кода PHP." >}}

{{% blocks/products/pf/feature-page-section h2="Объединить изображение в PDF с помощью Aspose.Slides" %}}

[**Aspose.Slides для PHP через Java**](https://products.aspose.com/slides/ru/php-java/) — это мощная библиотека PHP, используемая для создания, преобразования, объединения и управления презентациями, PDF-файлами, изображения и другие файлы. Когда вы объединяете изображение в PDF, вы фактически объединяете изображения для получения одного файла PDF.
...
{{% blocks/products/pf/feature-page-section  h2="Объединить изображение в PDF в PHP" %}}
Используя [**Aspose.Slides для PHP через Java**](https://products.aspose.com/slides/ru/php-java/), вы можете быстро объединить изображение в PDF, написав всего несколько строк кода.

{{% blocks/products/pf/agp/code-block title="PHP-код для объединения изображения в PDF" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить изображение в PDF в PHP" >}}
