---
title: Объединить файлы POTM с помощью PHP
url: /ru/php-java/merger/potm/
keywords: Объединить POTM, присоединиться к POTM, объединить POTM, PowerPoint, презентацию, PHP, Aspose
description: Объедините несколько файлов POTM в PHP.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Объединить файлы POTM вместе в PHP" h2="Высокоскоростной и кроссплатформенный PHP API, который помогает в разработке приложений с возможностью создания, объединения, проверки или преобразования файлов презентаций Microsoft PowerPoint и OpenOffice без использования какого-либо программного обеспечения, такого как Microsoft или Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Объединить POTM в PHP" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы POTM с помощью PHP" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код PHP для объединения нескольких POTM в один файл" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить POTM с помощью Aspose.Slides for PHP API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов POTM и сохранения результата как POTM в PHP." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Загрузите файлы POTM, которые вы хотите объединить.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Сохраните полученный документ POTM.
{{< /blocks/products/pf/agp/step-autogen >}}
