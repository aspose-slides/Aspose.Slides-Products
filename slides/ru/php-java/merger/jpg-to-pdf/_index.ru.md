---
title: Объединить JPG в PDF в PHP
url: /ru/php-java/merger/jpg-to-pdf/
keywords: JPG в PDF, Объединение JPG в PDF, Объединение JPG в PDF, PDF, JPG, PHP API, библиотека PHP
description: Объединение JPG в PDF в PHP. Используйте API библиотеки PHP для объединения JPG и PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Объединить JPG в PDF в PHP" h2="Высокоскоростная и кроссплатформенная библиотека PHP для объединения файлов JPG в PDF с использованием кода PHP." >}}
...
{{% blocks/products/pf/feature-page-section  h2="Объединить JPG в PDF в PHP" %}}
Используя [**Aspose.Slides для PHP через Java**](https://products.aspose.com/slides/ru/php-java/), вы можете быстро объединить JPG в PDF, написав всего несколько строк кода.

{{% blocks/products/pf/agp/code-block title="PHP-код для объединения JPG в PDF" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить JPG в PDF в PHP" >}}
