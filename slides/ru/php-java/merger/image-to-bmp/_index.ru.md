...
description: Объединить изображение в BMP на PHP. Используйте API библиотеки PHP для объединения изображений
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Объединить изображение в BMP в PHP" h2="Высокоскоростная и кроссплатформенная библиотека PHP для объединения файлов изображений в BMP с использованием кода PHP." >}}
...
{{% blocks/products/pf/feature-page-section  h2="Объединить изображение в BMP в PHP" %}}
Используя [**Aspose.Slides для PHP через Java**](https://products.aspose.com/slides/ru/php-java/), вы можете быстро объединить изображение в BMP, написав всего несколько строк кода.

{{% blocks/products/pf/agp/code-block title="PHP-код для объединения изображения в BMP" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить изображение в BMP в PHP" >}}
