---
title: Объединить TIFF в PDF в PHP
url: /ru/php-java/merger/tiff-to-pdf/
keywords: TIFF в PDF, объединить TIFF в PDF, объединить TIFF в PDF, PDF, TIFF, PHP API, библиотеку PHP
description: Объединение TIFF в PDF в PHP. Используйте API библиотеки PHP для объединения TIFF и PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Объединить TIFF в PDF в PHP" h2="Высокоскоростная и кроссплатформенная библиотека PHP для объединения файлов TIFF в PDF с использованием кода PHP." >}}
...
{{% blocks/products/pf/feature-page-section  h2="Объединить TIFF в PDF в PHP" %}}
Используя [**Aspose.Slides для PHP через Java**](https://products.aspose.com/slides/ru/php-java/), вы можете быстро объединить TIFF в PDF, написав всего несколько строк кода.

{{% blocks/products/pf/agp/code-block title="PHP-код для объединения TIFF в PDF" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить TIFF в PDF на PHP" >}}
