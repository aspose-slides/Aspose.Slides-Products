---
title: Объединить файлы POTX в PPSM с помощью Python
url: /ru/python-net/merge/potx-to-ppsm/
keywords: Объединить POTX в PPSM, объединить POTX в PPSM, объединить POTX в PPSM, PowerPoint, презентацию, PPSM, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы POTX в PPSM с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких POTX в один файл PPSM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить POTX с PPSM с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов POTX и сохранения результата как PPSM в Python." >}}
