---
title: Объединить файлы PDF в HTML с помощью Python
url: /ru/python-net/merge/pdf-to-html/
keywords: Объединить PDF в HTML, объединить PDF в HTML, объединить PDF в HTML, PowerPoint, презентацию, HTML, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PDF в HTML с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PDF в один файл HTML" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PDF с HTML с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PDF и сохранения результата как HTML в Python." >}}
