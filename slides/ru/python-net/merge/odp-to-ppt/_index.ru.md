---
title: Объединить файлы ODP в PPT с помощью Python
url: /ru/python-net/merge/odp-to-ppt/
keywords: Объединить ODP в PPT, объединить ODP в PPT, объединить ODP в PPT, PowerPoint, презентацию, PPT, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы ODP в PPT с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких ODP в один файл PPT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить ODP с PPT с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов ODP и сохранения результата как PPT в Python." >}}
