---
title: Объединить файлы OTP в POT с помощью Python
url: /ru/python-net/merge/otp-to-pot/
keywords: Объединить OTP в POT, объединить OTP в POT, объединить OTP в POT, PowerPoint, презентацию, POT, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы OTP в POT с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких OTP в один файл POT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить OTP с POT с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов OTP и сохранения результата как POT в Python." >}}
