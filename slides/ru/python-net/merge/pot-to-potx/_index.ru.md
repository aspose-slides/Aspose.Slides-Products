---
title: Объединить файлы POT в POTX с помощью Python
url: /ru/python-net/merge/pot-to-potx/
keywords: Объединить POT в POTX, объединить POT в POTX, объединить POT в POTX, PowerPoint, презентацию, POTX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы POT в POTX с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких POT в один файл POTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить POT с POTX с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов POT и сохранения результата как POTX в Python." >}}
