---
title: Объединить файлы ODP в PNG с помощью Python
url: /ru/python-net/merge/odp-to-png/
keywords: Объединить ODP в PNG, объединить ODP в PNG, объединить ODP в PNG, PowerPoint, презентацию, PNG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы ODP в PNG с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких ODP в один файл PNG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить ODP с PNG с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов ODP и сохранения результата как PNG в Python." >}}
