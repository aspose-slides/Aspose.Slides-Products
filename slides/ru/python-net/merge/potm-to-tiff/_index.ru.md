---
title: Объединить файлы POTM в TIFF с помощью Python
url: /ru/python-net/merge/potm-to-tiff/
keywords: Объединить POTM в TIFF, объединить POTM в TIFF, объединить POTM в TIFF, PowerPoint, презентацию, TIFF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы POTM в TIFF с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких POTM в один файл TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить POTM с TIFF с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов POTM и сохранения результата как TIFF в Python." >}}
