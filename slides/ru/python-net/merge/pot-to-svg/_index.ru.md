---
title: Объединить файлы POT в SVG с помощью Python
url: /ru/python-net/merge/pot-to-svg/
keywords: Объединить POT в SVG, объединить POT в SVG, объединить POT в SVG, PowerPoint, презентацию, SVG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы POT в SVG с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких POT в один файл SVG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить POT с SVG с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов POT и сохранения результата как SVG в Python." >}}
