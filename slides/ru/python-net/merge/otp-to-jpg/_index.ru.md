---
title: Объединить файлы OTP в JPG с помощью Python
url: /ru/python-net/merge/otp-to-jpg/
keywords: Объединить OTP в JPG, объединить OTP в JPG, объединить OTP в JPG, PowerPoint, презентацию, JPG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы OTP в JPG с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких OTP в один файл JPG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить OTP с JPG с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов OTP и сохранения результата как JPG в Python." >}}
