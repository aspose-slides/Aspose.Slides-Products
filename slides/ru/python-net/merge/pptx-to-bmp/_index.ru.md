---
title: Объединить файлы PPTX в BMP с помощью Python
url: /ru/python-net/merge/pptx-to-bmp/
keywords: Объединить PPTX в BMP, объединить PPTX в BMP, объединить PPTX в BMP, PowerPoint, презентацию, BMP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PPTX в BMP с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PPTX в один файл BMP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PPTX с BMP с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PPTX и сохранения результата как BMP в Python." >}}
