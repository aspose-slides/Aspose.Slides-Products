---
title: Объединить файлы OTP в PPS с помощью Python
url: /ru/python-net/merge/otp-to-pps/
keywords: Объединить OTP в PPS, объединить OTP в PPS, объединить OTP в PPS, PowerPoint, презентацию, PPS, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы OTP в PPS с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких OTP в один файл PPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить OTP с PPS с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов OTP и сохранения результата как PPS в Python." >}}
