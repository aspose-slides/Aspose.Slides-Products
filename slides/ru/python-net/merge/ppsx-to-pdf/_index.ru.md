---
title: Объединить файлы PPSX в PDF с помощью Python
url: /ru/python-net/merge/ppsx-to-pdf/
keywords: Объединить PPSX в PDF, объединить PPSX в PDF, объединить PPSX в PDF, PowerPoint, презентацию, PDF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PPSX в PDF с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PPSX в один файл PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PPSX с PDF с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PPSX и сохранения результата как PDF в Python." >}}
