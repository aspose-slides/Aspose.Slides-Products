---
title: Объединить файлы PPSM в PPTM с помощью Python
url: /ru/python-net/merge/ppsm-to-pptm/
keywords: Объединить PPSM в PPTM, объединить PPSM в PPTM, объединить PPSM в PPTM, PowerPoint, презентацию, PPTM, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PPSM в PPTM с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PPSM в один файл PPTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PPSM с PPTM с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PPSM и сохранения результата как PPTM в Python." >}}
