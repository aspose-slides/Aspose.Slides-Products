---
title: Объединить файлы PPSX с помощью Python
url: /ru/python-net/merge/ppsx/
keywords: Объединить PPSX, присоединиться к PPSX, объединить PPSX, PowerPoint, презентацию, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PPSX с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PPSX в один файл" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PPSX с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PPSX и сохранения результата как PPSX в Python." >}}
