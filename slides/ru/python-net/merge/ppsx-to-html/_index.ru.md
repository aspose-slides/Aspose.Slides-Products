---
title: Объединить файлы PPSX в HTML с помощью Python
url: /ru/python-net/merge/ppsx-to-html/
keywords: Объединить PPSX в HTML, объединить PPSX в HTML, объединить PPSX в HTML, PowerPoint, презентацию, HTML, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PPSX в HTML с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PPSX в один файл HTML" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PPSX с HTML с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PPSX и сохранения результата как HTML в Python." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ru/python-net/merge/ppsx-to-png/" name="PPSX TO PNG" >}}  
