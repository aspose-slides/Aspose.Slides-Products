---
title: Объединить файлы PPT в JPG с помощью Python
url: /ru/python-net/merge/ppt-to-jpg/
keywords: Объединить PPT в JPG, объединить PPT в JPG, объединить PPT в JPG, PowerPoint, презентацию, JPG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PPT в JPG с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PPT в один файл JPG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PPT с JPG с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PPT и сохранения результата как JPG в Python." >}}
