---
title: Объединить файлы POTX в PPSX с помощью Python
url: /ru/python-net/merge/potx-to-ppsx/
keywords: Объединить POTX в PPSX, объединить POTX в PPSX, объединить POTX в PPSX, PowerPoint, презентацию, PPSX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы POTX в PPSX с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких POTX в один файл PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить POTX с PPSX с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов POTX и сохранения результата как PPSX в Python." >}}
