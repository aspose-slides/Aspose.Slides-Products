---
title: Объединить файлы PPSX в XPS с помощью Python
url: /ru/python-net/merge/ppsx-to-xps/
keywords: Объединить PPSX в XPS, объединить PPSX в XPS, объединить PPSX в XPS, PowerPoint, презентацию, XPS, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PPSX в XPS с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PPSX в один файл XPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PPSX с XPS с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PPSX и сохранения результата как XPS в Python." >}}
