---
title: Объединить файлы PPT в GIF с помощью Python
url: /ru/python-net/merge/ppt-to-gif/
keywords: Объединить PPT в GIF, объединить PPT в GIF, объединить PPT в GIF, PowerPoint, презентацию, GIF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PPT в GIF с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PPT в один файл GIF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PPT с GIF с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PPT и сохранения результата как GIF в Python." >}}
