---
title: Объединить файлы PPSM в FODP с помощью Python
url: /ru/python-net/merge/ppsm-to-fodp/
keywords: Объединить PPSM в FODP, объединить PPSM в FODP, объединить PPSM в FODP, PowerPoint, презентацию, FODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PPSM в FODP с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PPSM в один файл FODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PPSM с FODP с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PPSM и сохранения результата как FODP в Python." >}}
