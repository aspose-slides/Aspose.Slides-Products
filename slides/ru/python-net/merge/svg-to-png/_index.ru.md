---
title: Объединить SVG в PNG в Python
url: /ru/python-net/merge/svg-to-png/
keywords: Объединение SVG в PNG, SVG в PNG, объединение SVG в PNG, объединение SVG в PNG, API Python, библиотека Python
description: Объедините SVG в PNG в Python. Используйте API библиотеки Python для объединения файлов SVG и PNG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Объединить SVG в PNG в Python" h2="Высокоскоростная и кроссплатформенная библиотека Python для объединения изображений SVG в PNG с использованием кода Python." >}}

{{% blocks/products/pf/feature-page-section h2="Объединение SVG в PNG с помощью Aspose.Slides" %}}

[**Aspose.Slides для Python через .NET**](https://products.aspose.com/slides/ru/python-net/) — мощная библиотека Python, используемая для объединения презентаций, изображений и других файлов и управления ими. Когда вы объединяете SVG в PNG, вы эффективно объединяете изображения SVG, чтобы получить изображение PNG.
...
{{% blocks/products/pf/feature-page-section  h2="Объединить SVG в PNG в Python" %}}
Используя [**Aspose.Slides для Python через .NET**](https://products.aspose.com/slides/ru/python-net/), вы можете быстро объединять файлы SVG в PNG всего несколькими строками кода.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения SVG в PNG" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить SVG в PNG в Python" >}}
