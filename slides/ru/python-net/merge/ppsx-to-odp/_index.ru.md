---
title: Объединить файлы PPSX в ODP с помощью Python
url: /ru/python-net/merge/ppsx-to-odp/
keywords: Объединить PPSX в ODP, объединить PPSX в ODP, объединить PPSX в ODP, PowerPoint, презентацию, ODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PPSX в ODP с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PPSX в один файл ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PPSX с ODP с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PPSX и сохранения результата как ODP в Python." >}}
