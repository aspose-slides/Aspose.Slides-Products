---
title: Объединить файлы PDF в PPSX с помощью Python
url: /ru/python-net/merge/pdf-to-ppsx/
keywords: Объединить PDF в PPSX, объединить PDF в PPSX, объединить PDF в PPSX, PowerPoint, презентацию, PPSX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PDF в PPSX с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PDF в один файл PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PDF с PPSX с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PDF и сохранения результата как PPSX в Python." >}}
