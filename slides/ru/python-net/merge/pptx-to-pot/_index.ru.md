---
title: Объединить файлы PPTX в POT с помощью Python
url: /ru/python-net/merge/pptx-to-pot/
keywords: Объединить PPTX в POT, объединить PPTX в POT, объединить PPTX в POT, PowerPoint, презентацию, POT, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PPTX в POT с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PPTX в один файл POT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PPTX с POT с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PPTX и сохранения результата как POT в Python." >}}
