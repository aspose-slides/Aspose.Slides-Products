---
title: Объединить файлы PDF в POTM с помощью Python
url: /ru/python-net/merge/pdf-to-potm/
keywords: Объединить PDF в POTM, объединить PDF в POTM, объединить PDF в POTM, PowerPoint, презентацию, POTM, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PDF в POTM с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PDF в один файл POTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PDF с POTM с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PDF и сохранения результата как POTM в Python." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ru/python-net/merge/pdf-to-fodp/" name="PDF TO FODP" >}}  
