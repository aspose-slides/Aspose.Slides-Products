---
title: Объединить файлы PPSM в PPTX с помощью Python
url: /ru/python-net/merge/ppsm-to-pptx/
keywords: Объединить PPSM в PPTX, объединить PPSM в PPTX, объединить PPSM в PPTX, PowerPoint, презентацию, PPTX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PPSM в PPTX с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PPSM в один файл PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PPSM с PPTX с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PPSM и сохранения результата как PPTX в Python." >}}
