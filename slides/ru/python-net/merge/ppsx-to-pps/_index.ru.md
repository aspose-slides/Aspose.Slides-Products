---
title: Объединить файлы PPSX в PPS с помощью Python
url: /ru/python-net/merge/ppsx-to-pps/
keywords: Объединить PPSX в PPS, объединить PPSX в PPS, объединить PPSX в PPS, PowerPoint, презентацию, PPS, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PPSX в PPS с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PPSX в один файл PPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PPSX с PPS с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PPSX и сохранения результата как PPS в Python." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Сохраните презентацию и получите результат в виде одного файла PPS.
```
pres1.save("presentation.pps", slides.export.SaveFormat.PPS)
```
