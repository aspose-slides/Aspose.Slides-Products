---
title: Объединить файлы ODP в PPSX с помощью Python
url: /ru/python-net/merge/odp-to-ppsx/
keywords: Объединить ODP в PPSX, объединить ODP в PPSX, объединить ODP в PPSX, PowerPoint, презентацию, PPSX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы ODP в PPSX с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких ODP в один файл PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить ODP с PPSX с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов ODP и сохранения результата как PPSX в Python." >}}
