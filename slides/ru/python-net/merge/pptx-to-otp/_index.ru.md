---
title: Объединить файлы PPTX в OTP с помощью Python
url: /ru/python-net/merge/pptx-to-otp/
keywords: Объединить PPTX в OTP, объединить PPTX в OTP, объединить PPTX в OTP, PowerPoint, презентацию, OTP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PPTX в OTP с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PPTX в один файл OTP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PPTX с OTP с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PPTX и сохранения результата как OTP в Python." >}}
