---
title: Объединить файлы PDF в PPTX с помощью Python
url: /ru/python-net/merge/pdf-to-pptx/
keywords: Объединить PDF в PPTX, объединить PDF в PPTX, объединить PDF в PPTX, PowerPoint, презентацию, PPTX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PDF в PPTX с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PDF в один файл PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PDF с PPTX с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PDF и сохранения результата как PPTX в Python." >}}
