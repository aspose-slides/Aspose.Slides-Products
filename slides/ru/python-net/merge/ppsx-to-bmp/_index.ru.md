---
title: Объединить файлы PPSX в BMP с помощью Python
url: /ru/python-net/merge/ppsx-to-bmp/
keywords: Объединить PPSX в BMP, объединить PPSX в BMP, объединить PPSX в BMP, PowerPoint, презентацию, BMP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Объединить файлы PPSX в BMP с помощью Python" %}}
Чтобы объединить презентации PowerPoint, вам нужно клонировать слайды из одной презентации в другую.

{{% blocks/products/pf/agp/code-block title="Код Python для объединения нескольких PPSX в один файл BMP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PPSX с BMP с помощью Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Это шаги для объединения двух файлов PPSX и сохранения результата как BMP в Python." >}}
