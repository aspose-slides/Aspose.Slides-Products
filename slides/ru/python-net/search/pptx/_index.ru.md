...
{{% blocks/products/pf/agp/code-block title="Поиск текста PPTX Презентация с использованием Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как искать текст в PPTX через Python" >}}
