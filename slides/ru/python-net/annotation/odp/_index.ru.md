---
title: Удалить аннотацию ODP с помощью Python
weight: 4380
url: /ru/python-net/annotation/odp/ 
description: Исходный код Python для удаления комментариев презентации ODP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Удалить комментарии и авторов комментариев из ODP в Python" h2="Создавайте собственные сценарии Python для управления комментариями и авторами в файлах документов с помощью серверных API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5="ODP" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for Python via .NET" >}}

{{% blocks/products/pf/feature-page-section  h2="Удалить комментарии из ODP через Python" %}}
Чтобы удалить аннотации из файла ODP, мы будем использовать API [Aspose.Slides для Python через .NET](https://products.aspose.com/slides/ru/python-net/), который является многофункциональным, мощный и простой в использовании API для работы с документами для платформы Python.
{{% blocks/products/pf/agp/code-block title="Удалить аннотации из ODP — Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Как удалить комментарии из ODP через Python" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ru/python-net/annotation/ppt/" name="PPT" >}}
