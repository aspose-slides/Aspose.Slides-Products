---
title: Слияние HTML-файлов в C#
url: /ru/net/merger/html-to-html/
keywords: Объединение HTML, HTML в HTML, объединение HTML, объединение HTML, API C#, библиотека .NET.
description: Слияние HTML с HTML в C#. Используйте API библиотеки .NET для объединения файлов HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Слияние HTML в C#" h2="Мощный кроссплатформенный .NET API для слияния файлов HTML с использованием кода C# на платформах NET Framework, .NET Core, Windows Azure, Mono или Xamarin." >}}

{{% blocks/products/pf/feature-page-section h2="Слияние HTML с HTML с помощью Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/ru/net/) — мощная библиотека .NET, используемая для создания, преобразования, объединения и управления презентациями, файлами HTML и другие документы. Когда вы объединяете HTML в HTML, вы эффективно объединяете содержимое двух документов для получения одного HTML-файла. Aspose.Slides позволяет объединять HTML-документы различными способами. Вы можете объединить HTML со всеми их текстами, форматированием, стилями и т. д.
...
{{% blocks/products/pf/feature-page-section  h2="Слияние HTML с HTML в C#" %}}
Используя [**Aspose.Slides для .NET**](https://products.aspose.com/slides/ru/net/), вы можете быстро объединять HTML-файлы всего несколькими строками кода.

{{% blocks/products/pf/agp/code-block title="Код C# для слияния HTML с HTML" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить HTML в C#" >}}
