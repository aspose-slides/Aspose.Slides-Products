...
url: /ru/net/merger/pdf-to-pdf/
keywords: Объединение PDF, PDF в PDF, объединение PDF, объединение PDF, API C#, библиотека .NET.
description: Слияние PDF в PDF на C#. Используйте API библиотеки .NET для объединения файлов PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Слияние PDF в C#" h2="Мощный кроссплатформенный .NET API для объединения файлов PDF с использованием кода C# на платформах NET Framework, .NET Core, Windows Azure, Mono или Xamarin." >}}

{{% blocks/products/pf/feature-page-section h2="Объединение PDF в PDF с помощью Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/ru/net/) — это мощная библиотека .NET, используемая для создания, преобразования, объединения и управления презентациями, файлами PDF и другими документы. Когда вы объединяете PDF в PDF, вы фактически объединяете страницы из двух документов для получения одного файла PDF. Aspose.Slides позволяет объединять PDF-файлы различными способами. Вы можете объединять PDF-файлы со всеми их формами, стилями, текстами, форматированием и т. д.
...
{{% blocks/products/pf/feature-page-section  h2="Объединить PDF в PDF в C#" %}}
Используя [**Aspose.Slides для .NET**](https://products.aspose.com/slides/ru/net/), вы можете быстро объединять файлы PDF всего несколькими строками кода.

{{% blocks/products/pf/agp/code-block title="Код С# для объединения PDF в PDF" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Как объединить PDF в С#" >}}
