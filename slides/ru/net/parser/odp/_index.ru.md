...
title: Извлечение текста и изображений из документа ODP через .NET
weight: 3070
url: /ru/net/parser/odp/ 
description: Исходный код C# для извлечения текста и изображений из файла ODP на платформах .NET Framework, .NET Core, Windows Azure, Mono или Xamarin.
---
