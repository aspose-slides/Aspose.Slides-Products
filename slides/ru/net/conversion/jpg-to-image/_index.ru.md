...
title: Преобразование JPG в изображение на C#
weight: 210
url: /ru/net/conversion/jpg-to-image/ 
keywords: JPG в изображение, преобразование JPG в изображение, C# API, библиотека .NET
description: Преобразование JPG в изображение на C#. Используйте API библиотеки .NET для преобразования JPG в изображения различных форматов.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразование JPG в изображение на C#" h2="API PowerPoint .NET для преобразования изображений JPG в файлы изображений на платформах NET Framework, .NET Core, Windows Azure, Mono или Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Преобразование JPG в изображение на C#" %}}

Как преобразовать JPG в изображение в коде?

С помощью [**Aspose.Slides for .NET**](https://products.aspose.com/slides/ru/net/) любой разработчик или приложение может преобразовать JPG в изображение всего несколькими строками кода C#.

Как современный API обработки документов, Aspose.Slides for .NET быстро экспортирует файлы JPG в изображения других форматов. Библиотека Aspose PowerPoint позволяет конвертировать JPG в изображения и многие другие форматы файлов.
...
{{< blocks/products/pf/agp/feature-section-col title="Как преобразовать JPG в изображение на C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Разработчики и приложения могут конвертировать JPG в изображения следующим образом:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Прежде чем запускать код C# преобразования JPG в изображение, на вашем компьютере должны быть выполнены следующие требования:
...
{{% blocks/products/pf/agp/code-block title="Код С# для преобразования JPG в изображение" offSpacer="" %}}
