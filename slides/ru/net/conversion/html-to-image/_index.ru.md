...
title: Преобразование HTML в изображение на C#
weight: 160
url: /ru/net/conversion/html-to-image/ 
keywords: HTML в изображение, преобразование HTML в изображение, C# API, библиотека .NET, HTML, изображение
description: Преобразование HTML в изображение на C#. Используйте API библиотеки .NET для преобразования файлов HTML в изображения.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразование HTML в изображение на C#" h2="API PowerPoint .NET для преобразования файлов HTML в изображения на платформах NET Framework, .NET Core, Windows Azure, Mono или Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать HTML в изображение на C#" %}}

Как преобразовать HTML в изображение в коде?

С помощью [**Aspose.Slides for .NET**](https://products.aspose.com/slides/ru/net/) любой разработчик или приложение может преобразовать HTML в файлы изображений всего несколькими строками кода C#.

Как современный API обработки документов, Aspose.Slides для .NET быстро экспортирует файлы HTML в форматы файлов изображений. Библиотека Aspose PowerPoint позволяет конвертировать HTML в изображения и файлы многих других форматов.
...
{{< blocks/products/pf/agp/feature-section-col title="Как преобразовать HTML в изображение на C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Разработчики и приложения могут конвертировать HTML в изображение следующим образом:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Добавляйте слайды на основе HTML-страниц.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Сохраните слайды как изображения.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Прежде чем запускать код C# преобразования HTML в изображение, на вашем компьютере должны быть выполнены следующие требования:
...
{{% blocks/products/pf/agp/code-block title="Код С# для преобразования HTML в изображение" offSpacer="" %}}
