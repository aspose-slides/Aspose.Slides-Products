...
title: Преобразование PDF в изображение на C#
weight: 80
url: /ru/net/conversion/pdf-to-image/ 
keywords: PDF в изображение, Преобразование PDF в изображение, C# API, .NET Library, PDF, Изображение
description: Преобразование PDF в изображение на C#. Используйте API библиотеки .NET для преобразования страниц PDF в изображения
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразование PDF в изображение на C#" h2="API PowerPoint .NET для преобразования PDF-документов в изображения на платформах NET Framework, .NET Core, Windows Azure, Mono или Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать PDF в изображение в C#" %}}

Как преобразовать PDF в изображение в коде?

С помощью [**Aspose.Slides for .NET**](https://products.aspose.com/slides/ru/net/) любой разработчик или приложение может преобразовать PDF в файлы изображений с помощью всего нескольких строк кода C#.

Как современный API обработки документов, Aspose.Slides для .NET быстро экспортирует страницы PDF в форматы изображений. Библиотека Aspose PowerPoint позволяет конвертировать PDF в изображения и многие другие форматы файлов.
...
{{< blocks/products/pf/agp/feature-section-col title="Как преобразовать PDF в изображение в C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Разработчики и приложения могут конвертировать PDF в изображения следующим образом:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Добавляйте слайды на основе страниц PDF.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Вызовите метод сохранения, чтобы сохранить слайды как изображения.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Прежде чем запускать код C# преобразования PDF в изображение, на вашем компьютере должны быть выполнены следующие требования:
...
{{% blocks/products/pf/agp/code-block title="Код С# для преобразования PDF в изображение" offSpacer="" %}}
