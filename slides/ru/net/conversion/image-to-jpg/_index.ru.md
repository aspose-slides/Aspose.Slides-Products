...
title: Преобразование изображения в JPG на C#
weight: 200
url: /ru/net/conversion/image-to-jpg/ 
keywords: Изображение в JPG, преобразование изображения в JPG, C# API, библиотека .NET, изображение, JPG
description: Преобразование изображения в JPG на C#. Используйте API библиотеки .NET для преобразования изображений в изображения JPG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразование изображения в JPG на C#" h2="API PowerPoint .NET для преобразования изображений в изображения JPG на платформах NET Framework, .NET Core, Windows Azure, Mono или Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Преобразование изображения в JPG на C#" %}}

Как преобразовать изображение в JPG в коде?

Используя [**Aspose.Slides для .NET**](https://products.aspose.com/slides/ru/net/), любой разработчик или приложение может преобразовать изображение в изображение JPG всего несколькими строками кода C#. .

Как современный API обработки документов, Aspose.Slides для .NET быстро экспортирует изображения в популярных форматах в JPG. Библиотека Aspose PowerPoint позволяет конвертировать изображения в JPG и многие другие графические форматы.
...
{{< blocks/products/pf/agp/feature-section-col title="Как преобразовать изображение в JPG на C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Разработчики и приложения могут конвертировать изображения в JPG следующим образом:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Сохраните файл как изображение JPG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Прежде чем запускать код C# для преобразования изображения в JPG, на вашем компьютере должны быть выполнены следующие требования:
...
{{% blocks/products/pf/agp/code-block title="Код С# для преобразования изображения в JPG" offSpacer="" %}}
