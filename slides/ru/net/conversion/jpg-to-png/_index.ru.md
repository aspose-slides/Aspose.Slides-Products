...
title: Преобразование JPG в PNG на C#
weight: 220
url: /ru/net/conversion/jpg-to-png/ 
keywords: JPG в PNG, конвертировать JPG в PNG, C# API, .NET Library
description: Преобразование JPG в PNG на C#. Используйте API библиотеки .NET для преобразования файлов JPG в PNG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразование JPG в PNG на C#" h2="API PowerPoint .NET для преобразования файлов изображений JPG в PNG на платформах NET Framework, .NET Core, Windows Azure, Mono или Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Преобразование JPG в PNG на C#" %}}

Как преобразовать JPG в PNG в коде?

С помощью [**Aspose.Slides for .NET**](https://products.aspose.com/slides/ru/net/) любой разработчик или приложение может преобразовать JPG в PNG всего несколькими строками кода C#.

Как современный API обработки документов, Aspose.Slides для .NET быстро экспортирует файлы JPG в PNG. Библиотека Aspose PowerPoint позволяет конвертировать JPG в PNG и изображения в другие форматы.
...
{{< blocks/products/pf/agp/feature-section-col title="Как конвертировать JPG в PNG в C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Разработчики и приложения могут конвертировать JPG в PNG следующим образом:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Сохраните файл как изображение PNG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Прежде чем запускать код C# для преобразования JPG в PNG, на вашем компьютере должны быть выполнены следующие требования:
...
{{% blocks/products/pf/agp/code-block title="Код С# для преобразования JPG в PNG" offSpacer="" %}}
