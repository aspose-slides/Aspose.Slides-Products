...
title: Преобразование PDF в HTML на C#
weight: 120
url: /ru/net/conversion/pdf-to-html/ 
keywords: PDF в HTML, конвертировать PDF в HTML, C# API, .NET Library, PDF, HTML
description: Преобразование PDF в HTML на C#. Используйте API библиотеки .NET для преобразования страниц PDF в файлы HTML.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразование PDF в HTML на C#" h2="API PowerPoint .NET для преобразования документов PDF в файлы HTML на платформах NET Framework, .NET Core, Windows Azure, Mono или Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Как конвертировать PDF в HTML на C#" %}}

Как преобразовать PDF в HTML в коде?

С помощью [**Aspose.Slides for .NET**](https://products.aspose.com/slides/ru/net/) любой разработчик или приложение может конвертировать PDF-файлы в HTML-файлы всего несколькими строками кода C#.

Как современный API обработки документов, Aspose.Slides для .NET быстро экспортирует страницы PDF в HTML. Библиотека Aspose PowerPoint позволяет конвертировать PDF в HTML и многие другие форматы файлов.
...
{{< blocks/products/pf/agp/feature-section-col title="Как конвертировать PDF в HTML на C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Разработчики и приложения могут конвертировать PDF в HTML следующим образом:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Вызовите метод сохранения, чтобы сохранить слайды в формате HTML.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Прежде чем запускать код C# для преобразования PDF в HTML, на вашем компьютере должны быть выполнены следующие требования:
...
{{% blocks/products/pf/agp/code-block title="Код С# для преобразования PDF в HTML" offSpacer="" %}}
