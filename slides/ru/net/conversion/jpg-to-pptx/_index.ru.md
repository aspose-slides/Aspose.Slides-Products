...
keywords: Преобразование JPG в PPTX, JPG в PPTX, PowerPoint, JPG, PPTX, API C#, библиотеку .NET.
description: Преобразование JPG в PPTX на C#. Используйте API библиотеки .NET для преобразования изображений JPG в PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Преобразование JPG в PPTX на C#" h2="Мощный кроссплатформенный .NET API для преобразования JPG в PPTX с использованием кода C# на платформах NET Framework, .NET Core, Windows Azure, Mono или Xamarin." >}}
...
Используя [**Aspose.Slides for .NET**](https://products.aspose.com/slides/ru/net/), вы можете преобразовать изображение JPG в презентацию PowerPoint всего несколькими строками кода:

{{% blocks/products/pf/agp/code-block title="Код С# для преобразования JPG в PPTX" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Как конвертировать JPG в PPTX на С#" >}}
