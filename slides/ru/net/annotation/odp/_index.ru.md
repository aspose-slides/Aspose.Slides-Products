---
title: Удалить аннотацию ODP через .NET
weight: 1370
...
{{< blocks/products/pf/i18n/upper-banner h1="Удалить комментарии и авторов комментариев из ODP через C#" h2="Создавайте собственные приложения .NET для управления комментариями и авторами в файлах документов с помощью серверных API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Как аннотировать файл ODP с помощью C#" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Удалить комментарии из ODP через C#" >}}
...
{{% blocks/products/pf/agp/code-block title="Удалить аннотации из ODP — C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ru/net/annotation/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
