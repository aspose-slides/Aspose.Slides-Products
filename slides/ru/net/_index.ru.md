...
<h2 class="h2title">Полный контроль над элементами слайдов PowerPoint</h2>

<p>Aspose.Slides для .NET может обрабатывать все элементы слайдов презентации, включая текстовое поле, таблицу, прямоугольник, эллипс, ломаную линию, автоформу, рамку изображения, аудиокадр, видеокадр и рамку объекта OLE. API предоставляет хорошо продуманный набор классов, который позволяет всесторонне манипулировать каждым из этих элементов.</p>
...
<h2 class="h2title">Поддержка Office Open XML</h2>

<p>Office OpenXML (OOXML) — это формат на основе XML, представленный в Microsoft Office 2007.</p>

<p>PresentationML (OOXML, PPTX) — это язык разметки, используемый Microsoft Office PowerPoint 2007 для хранения документов. Aspose.Slides для .NET широко поддерживает создание, чтение, управление и запись документов PresentationML.</p>
