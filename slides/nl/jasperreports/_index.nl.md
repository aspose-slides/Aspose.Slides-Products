...
title: Exporteer JasperReports naar PowerPoint | Aspose.Dia's
weight: 8320
url: /nl/jasperreports/ 
description: Aspose.Slides PowerPoint API voor JaspreReport om rapporten van Jasper Reports en JasperServer naar PowerPoint-formaten te exporteren. Maak en exporteer accounts, grafiekafbeeldingen, tekst en lijnrapporten naar PPT-presentatie
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Exporteer JasperServer-rapporten naar PowerPoint-presentaties" h2="PowerPoint API voor het exporteren van JasperReports en JasperServer-rapporten naar PPT(X), PPS(X) en andere PowerPoint-formaten." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-jasperreports.svg" pfName="Aspose.Slides" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/slides/jasperreport" >}}
...
{{< blocks/products/pf/carousel-item h3="In een oogopslag" description="Een overzicht van Aspose.Slides voor JasperReports." >}}
...
{{< blocks/products/pf/carousel-item h3="Platformonafhankelijkheid" description="Aspose.Slides PowerPoint API ondersteunt J2SE, JasperReports en JasperServer." >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
...
17.6 en nieuwere versies
  ...
  <div class="d1-col d1-right">
   <header style="padding-left: 0px;">
    ...
    JasperReports 2.0, 3.0 of hoger
   </header>
   <ul>
    <li>
17.5 en eerdere versies
...
{{< blocks/products/pf/carousel-item h3="Ondersteunde bestandsindelingen" description="Aspose.Slides voor JasperReports kan rapporten exporteren in Microsoft PowerPoint [bestandsindelingen](https://docs.aspose.com/slides/jasperreports/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Geavanceerde JasperReports naar presentatie-exportfuncties</h2>

<p> </p>

<div class="col-lg-4"><em class="fa fa-file-powerpoint-o  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Accountrapporten maken en exporteren naar Microsoft PowerPoint-presentaties</p>

</div>

<div class="col-lg-4"><em class="fa fa-bar-chart   ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Maak grafiekrapporten en exporteer ze naar Microsoft PowerPoint-presentaties</p>

</div>

<div class="col-lg-4"><em class="fa fa-pie-chart ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Maak grafieken met meerdere assen en exporteer naar Microsoft PowerPoint-presentaties</p>

</div>

<div class="col-lg-4"><em class="fa fa-file-text ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Maak afbeeldingen, tekst, lijnen en exporteer deze rapporten naar Microsoft PowerPoint-presentatie</p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Slides voor JasperReports ondersteunt het exporteren van complexe rapporten met:
     <strong>
      MultipleAxisChartReport
     </strong>
     naar Microsoft PowerPoint-presentaties. De uitvoer is precies hetzelfde als hoe deze eruitziet wanneer deze wordt bekeken via JasperViewer.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Documentatie" href="https://docs.aspose.com/slides/jasperreports/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Waarom Aspose.Slides voor JasperReports?" tabId="success-stories" >}}
