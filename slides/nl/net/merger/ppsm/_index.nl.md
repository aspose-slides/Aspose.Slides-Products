---
title: Voeg PPSM-bestanden samen via .NET
weight: 3860
url: /nl/net/merger/ppsm/ 
description: C#-broncode om PPSM-documenten te combineren op .NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Voeg PPSM-indelingen samen in C#" h2="Native en hoogwaardige PPSM-documentfusie met Aspose.Slides aan de serverzijde voor .NET API's, zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPSM" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe PPSM-bestand samen te voegen met behulp van C #" %}}
...
Laad alle PPSM-bestanden met het volledige pad.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Roep de methode Save() aan en geef de bestandsnaam (volledig pad) en formaat (PPSM) door als parameter.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Nu kunt u het PPSM-bestand openen en gebruiken in Microsoft Office, Adobe PDF of een ander compatibel programma.
{{< /blocks/products/pf/agp/step-autogen >}}
