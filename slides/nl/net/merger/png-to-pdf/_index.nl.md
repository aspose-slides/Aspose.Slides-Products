...
url: /nl/net/merger/png-to-pdf/
keywords: PNG naar PDF, PNG naar PDF samenvoegen, PNG naar PDF, PDF, PNG, C# API, .NET Library
description: Voeg PNG samen met PDF in C#. Gebruik de .NET-bibliotheek-API om PNG en PDF te combineren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Voeg PNG samen met PDF in C#" h2="Krachtige platformonafhankelijke .NET API voor het samenvoegen van PNG- naar PDF-bestanden met behulp van C#-code op NET Framework-, .NET Core-, Windows Azure-, Mono- of Xamarin-platforms" >}}

{{% blocks/products/pf/feature-page-section h2="Voeg PNG samen met PDF met behulp van Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/nl/net/) is een krachtige .NET-bibliotheek die wordt gebruikt om presentaties, afbeeldingen en andere bestanden. Wanneer u PNG naar PDF samenvoegt, combineert u in feite PNG-afbeeldingen om één PDF-bestand te verkrijgen.
...
Met [**Aspose.Slides for .NET**](https://products.aspose.com/slides/nl/net/) kunt u PNG snel samenvoegen naar PDF met slechts een paar regels code
