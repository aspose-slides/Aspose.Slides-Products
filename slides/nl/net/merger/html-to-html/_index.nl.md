---
title: HTML-bestanden samenvoegen in C#
url: /nl/net/merger/html-to-html/
keywords: HTML samenvoegen, HTML naar HTML, HTML samenvoegen, HTML combineren, C# API, .NET-bibliotheek
description: Voeg HTML samen met HTML in C#. Gebruik de .NET bibliotheek-API om HTML-bestanden te combineren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="HTML samenvoegen in C#" h2="Krachtige platformonafhankelijke .NET API voor het samenvoegen van HTML-bestanden met behulp van C#-code op NET Framework-, .NET Core-, Windows Azure-, Mono- of Xamarin-platforms" >}}

{{% blocks/products/pf/feature-page-section h2="HTML samenvoegen met HTML met behulp van Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/nl/net/) is een krachtige .NET-bibliotheek die wordt gebruikt om presentaties, HTML-bestanden en andere documenten. Wanneer u HTML met HTML samenvoegt, combineert u in feite de inhoud van 2 documenten om één HTML-bestand te verkrijgen. Met Aspose.Slides kunt u HTML-documenten op verschillende manieren samenvoegen. U kunt HTML samenvoegen met al hun teksten, opmaak, stijlen, enz.
...
{{% blocks/products/pf/feature-page-section  h2="HTML samenvoegen met HTML in C#" %}}
Met [**Aspose.Slides for .NET**](https://products.aspose.com/slides/nl/net/), kunt u HTML-bestanden snel samenvoegen met slechts een paar regels code

{{% blocks/products/pf/agp/code-block title="C# code voor het samenvoegen van HTML naar HTML" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="HTML samenvoegen in C#" >}}
