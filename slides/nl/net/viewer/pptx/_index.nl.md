...
title: Bekijk PPTX-bestandsindelingen via .NET
weight: 6390
url: /nl/net/viewer/pptx/ 
description: C#-broncode voor het laden, weergeven en weergeven van PPTX-documenten op .NET Framework-, .NET Core-, Windows Azure-, Mono- of Xamarin-platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="PPTX-bestandsviewer voor .NET" h2="Bekijk presentatiebestanden zoals PPTX zonder Microsoft PowerPoint of Office Automation" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe PPTX-bestand te bekijken met C#" %}}

 Om het PPTX-bestand te bekijken, gebruiken we
...
{{< blocks/products/pf/agp/feature-section-col title="Stappen om PPTX via C# te bekijken" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Aspose.Slides maakt het de ontwikkelaars gemakkelijk om het PPTX-bestand te bekijken met slechts enkele regels code." >}}

{{< blocks/products/pf/agp/step-autogen >}}
Instantieer een presentatie-object en laad het PPTX-bestand
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Sla de PPTX-presentatie op in HTML-indeling
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Roep Process aan. Start met pad naar resulterende HTML om PPTX-inhoud in standaardbrowser te laden
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="C# voorbeeldcode om het PPTX-bestand te bekijken" offSpacer="" %}}
