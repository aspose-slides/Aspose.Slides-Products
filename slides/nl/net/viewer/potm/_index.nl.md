---
title: Bekijk POTM-bestandsindelingen via .NET
weight: 3310
url: /nl/net/viewer/potm/ 
description: C#-broncode voor het laden, weergeven en weergeven van POTM-documenten op .NET Framework-, .NET Core-, Windows Azure-, Mono- of Xamarin-platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="POTM-bestandsviewer voor .NET" h2="Bekijk presentatiebestanden zoals POTM zonder Microsoft PowerPoint of Office Automation" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe POTM-bestand te bekijken met C#" %}}

 Om het POTM-bestand te bekijken, gebruiken we
...
{{< blocks/products/pf/agp/feature-section-col title="Stappen om POTM te bekijken via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Aspose.Slides maakt het de ontwikkelaars gemakkelijk om het POTM-bestand te bekijken met slechts enkele regels code." >}}

{{< blocks/products/pf/agp/step-autogen >}}
Instantieer een presentatie-object en laad het POTM-bestand
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Sla de POTM-presentatie op in HTML-indeling
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Roep Process.Start aan met pad naar resulterende HTML om POTM-inhoud in standaardbrowser te laden
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="C# voorbeeldcode om POTM-bestand te bekijken" offSpacer="" %}}
