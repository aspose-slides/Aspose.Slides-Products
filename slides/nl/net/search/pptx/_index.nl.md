---
title: Zoek PPTX-document zonder te openen via C#
weight: 7300
url: /nl/net/search/pptx/ 
description: C#-broncode om woorden met patroon in PPTX-bestand te zoeken op .NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Zoek PPTX-indelingen in C #" h2="Native en high-performance PPTX-document zoeken met Aspose.Slides aan de serverzijde voor .NET API's, zonder het gebruik van software zoals Microsoft of Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe PPTX-bestand te zoeken met C #" %}}

 Om het PPTX-bestand te doorzoeken, gebruiken we
 [Aspose.Slides voor .NET](https://products.aspose.com/slides/nl/net)
 API, een feature-rijke, krachtige en gebruiksvriendelijke Microsoft PowerPoint-bestanden die API zoeken voor C#-platform. Open
...
{{< blocks/products/pf/agp/feature-section-col title="Stappen om PPTX-bestanden te zoeken in C#" >}}
...
{{% blocks/products/pf/agp/code-block title="Zoek PPTX-bestanden - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/nl/net/search/odp/" name="ODP" description="OpenDocument-presentatie-indeling" >}}
