---
title: Converteer HTML naar afbeelding in C #
weight: 160
url: /nl/net/conversion/html-to-image/ 
keywords: HTML naar afbeelding, HTML naar afbeelding converteren, C# API, .NET-bibliotheek, HTML, afbeelding
description: Converteer HTML naar afbeelding in C#. Gebruik de .NET bibliotheek-API om HTML-bestanden naar afbeeldingen te converteren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converteer HTML naar afbeelding in C #" h2="PowerPoint .NET API voor het converteren van HTML-bestanden naar afbeeldingen op NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe HTML naar afbeelding te converteren in C #" %}}

Hoe converteer ik HTML naar afbeelding in code?

Met behulp van [**Aspose.Slides for .NET**](https://products.aspose.com/slides/nl/net/) kan elke ontwikkelaar of toepassing HTML converteren naar afbeeldingsbestanden met slechts een paar regels C#-code.

Als een moderne API voor documentverwerking, exporteert Aspose.Slides voor .NET HTML-bestanden snel naar afbeeldingsbestandsindelingen. Met de Aspose PowerPoint-bibliotheek kunt u HTML naar afbeeldingen en vele andere bestandsindelingen converteren
...
{{< blocks/products/pf/agp/feature-section-col title="Hoe HTML naar afbeelding te converteren in C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ontwikkelaars en applicaties kunnen HTML op deze manier naar afbeelding converteren:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Voeg dia's toe op basis van de HTML-pagina's.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Sla de dia's op als afbeeldingen.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Voordat u de HTML-naar-afbeelding-conversie C#-code uitvoert, moet uw computer aan deze vereisten voldoen:
...
{{% blocks/products/pf/agp/code-block title="C#-code om HTML naar afbeelding te converteren" offSpacer="" %}}
