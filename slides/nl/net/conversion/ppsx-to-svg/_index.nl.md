---
title: Converteer PPSX naar SVG via C#
weight: 1930
url: /nl/net/conversion/ppsx-to-svg/ 
description: Voorbeeldcode voor conversie van PPSX naar SVG C#. Gebruik API-voorbeeldcode voor batch-PPSX-bestanden naar SVG-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer PPSX naar SVG via C#" h2="Exporteer PowerPoint® PPSX-bestanden naar SVG op .NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSX" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET-ontwikkelaars kunnen PPSX-bestanden gemakkelijk laden en converteren naar SVG in slechts een paar regels code." >}}
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont PPSX naar SVG C#-conversie" offSpacer="" %}}
