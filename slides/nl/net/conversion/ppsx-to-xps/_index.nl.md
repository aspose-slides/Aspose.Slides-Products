---
title: Converteer PPSX naar XPS via C#
weight: 2640
url: /nl/net/conversion/ppsx-to-xps/ 
description: Voorbeeldcode voor conversie van PPSX naar XPS C#. Gebruik API-voorbeeldcode voor batch-PPSX-bestanden naar XPS-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer PPSX naar XPS via C#" h2="Exporteer PowerPoint® PPSX-bestanden naar XPS op .NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe PPSX naar XPS te converteren met C#" %}}

 Om PPSX naar XPS te converteren, gebruiken we
...
{{< blocks/products/pf/agp/feature-section-col title="Stappen om PPSX naar XPS te converteren via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET-ontwikkelaars kunnen eenvoudig PPSX-bestanden laden en converteren naar XPS in slechts een paar regels code." >}}
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont PPSX naar XPS C#-conversie" offSpacer="" %}}
