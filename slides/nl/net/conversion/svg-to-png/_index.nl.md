...
keywords: SVG naar PNG, SVG converteren naar PNG, C# API, .NET-bibliotheek
description: Converteer SVG naar PNG in C#. Gebruik de .NET-bibliotheek-API om SVG naar PNG-bestanden te converteren.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converteer SVG naar PNG in C#" h2="PowerPoint .NET API voor het converteren van SVG naar PNG-afbeeldingsbestanden op NET Framework-, .NET Core-, Windows Azure-, Mono- of Xamarin-platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Converteer SVG naar PNG in C#" %}}

Hoe converteer ik SVG naar PNG in code?

Met behulp van [**Aspose.Slides for .NET**](https://products.aspose.com/slides/nl/net/) kan elke ontwikkelaar of toepassing SVG converteren naar PNG met slechts een paar regels C#-code.

Als moderne API voor documentverwerking exporteert Aspose.Slides voor .NET SVG-bestanden snel naar PNG. Aspose PowerPoint-bibliotheek stelt u in staat om SVG naar PNG en afbeeldingen in andere formaten te converteren.
...
{{< blocks/products/pf/agp/feature-section-col title="Hoe SVG naar PNG te converteren in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ontwikkelaars en applicaties kunnen SVG op deze manier naar PNG converteren:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Voordat u de SVG-naar-PNG-conversie C#-code uitvoert, moet uw machine aan deze vereisten voldoen:
...
{{% blocks/products/pf/agp/code-block title="C#-code om SVG naar PNG te converteren" offSpacer="" %}}
