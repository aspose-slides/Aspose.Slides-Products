---
title: Converteer HTML naar XML in C#
weight: 170
url: /nl/net/conversion/html-to-xml/ 
keywords: HTML naar XML, HTML converteren naar XML, C# API, .NET Library, HTML, XML
description: Converteer HTML naar XML in C#. Gebruik .NET bibliotheek-API om HTML-document naar XML-bestand te converteren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converteer HTML naar XML in C#" h2="PowerPoint .NET API voor het converteren van HTML-documenten naar XML-bestanden op NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe HTML naar XML te converteren in C#" %}}

Hoe converteer ik HTML naar XML in code?

Met behulp van [**Aspose.Slides for .NET**](https://products.aspose.com/slides/nl/net/) kan elke ontwikkelaar of toepassing HTML converteren naar XML-bestanden met slechts een paar regels C#-code.

Als een moderne API voor documentverwerking, exporteert Aspose.Slides voor .NET de inhoud snel in HTML naar XML. Met de Aspose PowerPoint-bibliotheek kunt u HTML naar XML en vele andere bestandsindelingen converteren.
...
{{< blocks/products/pf/agp/feature-section-col title="Hoe HTML naar XML te converteren in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ontwikkelaars en applicaties kunnen HTML op deze manier naar XML converteren:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Voeg dia's toe op basis van de inhoud van het HTML-bestand.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Voordat u de HTML-naar-XML-conversie C#-code uitvoert, moet uw computer aan deze vereisten voldoen:
...
{{% blocks/products/pf/agp/code-block title="C#-code om HTML naar XML te converteren" offSpacer="" %}}
