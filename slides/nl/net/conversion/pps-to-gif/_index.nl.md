---
title: Converteer PPS naar GIF via C#
weight: 4000
url: /nl/net/conversion/pps-to-gif/ 
description: Voorbeeldcode voor PPS naar GIF C#-conversie. Gebruik API-voorbeeldcode voor batch PPS-bestanden naar GIF-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer PPS naar GIF via C#" h2="Exporteer PowerPoint® PPS-bestanden naar GIF op .NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPS" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe PPS naar GIF te converteren met C#" %}}

 Om PPS naar GIF te converteren, gebruiken we
...
{{< blocks/products/pf/agp/feature-section-col title="Stappen om PPS naar GIF te converteren via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET-ontwikkelaars kunnen PPS-bestanden gemakkelijk laden en converteren naar GIF in slechts een paar regels code." >}}
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont PPS naar GIF C#-conversie" offSpacer="" %}}
