...
title: Converteer JPG naar afbeelding in C#
weight: 210
url: /nl/net/conversion/jpg-to-image/ 
keywords: JPG naar afbeelding, JPG naar afbeelding converteren, C# API, .NET-bibliotheek
description: Converteer JPG naar afbeelding in C#. Gebruik de .NET bibliotheek-API om JPG te converteren naar afbeeldingen in verschillende formaten.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converteer JPG naar afbeelding in C#" h2="PowerPoint .NET API voor het converteren van JPG-afbeeldingen naar afbeeldingsbestanden op NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Converteer JPG naar afbeelding in C#" %}}

Hoe converteer ik JPG naar afbeelding in code?

Met behulp van [**Aspose.Slides for .NET**](https://products.aspose.com/slides/nl/net/) kan elke ontwikkelaar of toepassing JPG naar afbeelding converteren met slechts een paar regels C#-code.

Als een moderne API voor documentverwerking, exporteert Aspose.Slides voor .NET JPG-bestanden snel naar afbeeldingen in andere formaten. Met de Aspose PowerPoint-bibliotheek kunt u JPG naar afbeelding en vele andere bestandsindelingen converteren
...
{{< blocks/products/pf/agp/feature-section-col title="Hoe JPG naar afbeelding te converteren in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ontwikkelaars en applicaties kunnen JPG op deze manier naar afbeelding converteren:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Voordat u de JPG-naar-afbeelding-conversie C#-code uitvoert, moet uw machine aan deze vereisten voldoen:
...
{{% blocks/products/pf/agp/code-block title="C#-code om JPG naar afbeelding te converteren" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/nl/net/conversion/ppt-to-jpeg/" name="PPT TO JPEG" description="JPEG Image" >}}
