...
title: Converteer PPS naar TIFF via C#
weight: 1220
url: /nl/net/conversion/pps-to-tiff/ 
description: Voorbeeldcode voor PPS naar TIFF C#-conversie. Gebruik API-voorbeeldcode voor batch-PPS-bestanden naar TIFF-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer PPS naar TIFF via C#" h2="Exporteer PowerPoint® PPS-bestanden naar TIFF op .NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPS" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET-ontwikkelaars kunnen gemakkelijk PPS-bestanden laden en converteren naar TIFF in slechts een paar regels code." >}}
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont PPS naar TIFF C#-conversie" offSpacer="" %}}
