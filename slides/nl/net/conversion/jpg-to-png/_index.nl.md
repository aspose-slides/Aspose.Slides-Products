...
keywords: JPG naar PNG, JPG converteren naar PNG, C# API, .NET-bibliotheek
description: Converteer JPG naar PNG in C#. Gebruik de .NET bibliotheek-API om JPG naar PNG-bestanden te converteren.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converteer JPG naar PNG in C#" h2="PowerPoint .NET API voor het converteren van JPG naar PNG-afbeeldingsbestanden op NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Converteer JPG naar PNG in C#" %}}

Hoe converteer ik JPG naar PNG in code?

Met behulp van [**Aspose.Slides for .NET**](https://products.aspose.com/slides/nl/net/) kan elke ontwikkelaar of toepassing JPG naar PNG converteren met slechts een paar regels C#-code.

Als een moderne API voor documentverwerking, exporteert Aspose.Slides voor .NET JPG-bestanden snel naar PNG. Aspose PowerPoint-bibliotheek stelt u in staat om JPG naar PNG en afbeeldingen in andere formaten te converteren.
...
{{< blocks/products/pf/agp/feature-section-col title="Hoe JPG naar PNG te converteren in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ontwikkelaars en applicaties kunnen op deze manier JPG naar PNG converteren:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Sla het bestand op als een PNG-afbeelding.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Voordat u de JPG-naar-PNG-conversie C#-code uitvoert, moet uw machine aan deze vereisten voldoen:
...
{{% blocks/products/pf/agp/code-block title="C#-code om JPG naar PNG te converteren" offSpacer="" %}}
