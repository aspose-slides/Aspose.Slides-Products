---
title: Converteer afbeelding naar JPG in C#
weight: 200
url: /nl/net/conversion/image-to-jpg/ 
keywords: Afbeelding naar JPG, afbeelding converteren naar JPG, C# API, .NET-bibliotheek, afbeelding, JPG
description: Converteer afbeelding naar JPG in C#. Gebruik de .NET-bibliotheek-API om afbeeldingen naar JPG-afbeeldingen te converteren.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converteer afbeelding naar JPG in C#" h2="PowerPoint .NET API voor het converteren van afbeeldingen naar JPG-afbeeldingen op NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Converteer afbeelding naar JPG in C#" %}}

Hoe converteer ik een afbeelding naar JPG in code?

Met behulp van [**Aspose.Slides for .NET**](https://products.aspose.com/slides/nl/net/) kan elke ontwikkelaar of toepassing een afbeelding converteren naar een JPG-afbeelding met slechts een paar regels C#-code .

Als een moderne API voor documentverwerking, exporteert Aspose.Slides voor .NET afbeeldingen in populaire formaten snel naar JPG. Met de Aspose PowerPoint-bibliotheek kunt u afbeeldingen converteren naar JPG en vele andere afbeeldingsindelingen.
...
{{< blocks/products/pf/agp/feature-section-col title="Hoe een afbeelding naar JPG te converteren in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ontwikkelaars en applicaties kunnen afbeelding op deze manier naar JPG converteren:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Voordat u de C#-code voor de conversie van afbeelding naar JPG uitvoert, moet uw machine aan deze vereisten voldoen:
...
{{% blocks/products/pf/agp/code-block title="C#-code om afbeelding naar JPG te converteren" offSpacer="" %}}
