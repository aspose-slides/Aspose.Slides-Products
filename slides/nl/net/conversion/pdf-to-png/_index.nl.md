...
weight: 90
url: /nl/net/conversion/pdf-to-png/ 
keywords: PDF naar PNG, PDF converteren naar PNG, C# API, .NET Library, PDF, PNG
description: Converteer PDF naar PNG in C#. Gebruik de .NET-bibliotheek-API om PDF-pagina's naar PNG-afbeeldingen te converteren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converteer PDF naar PNG in C#" h2="PowerPoint .NET API voor het converteren van PDF-documenten naar PNG-afbeeldingen op NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe PDF naar PNG te converteren in C#" %}}

Hoe converteer ik PDF naar PNG in code?

Met behulp van [**Aspose.Slides for .NET**](https://products.aspose.com/slides/nl/net/) kan elke ontwikkelaar of toepassing PDF naar PNG-indeling converteren met slechts een paar regels C#-code.

Aspose.Slides voor .NET is een moderne API voor documentverwerking en exporteert snel PDF-pagina's naar PNG. Met de Aspose PowerPoint-bibliotheek kunt u PDF naar PNG en vele andere bestandsindelingen converteren
...
{{< blocks/products/pf/agp/feature-section-col title="Hoe PDF naar PNG te converteren in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ontwikkelaars en applicaties kunnen op deze manier PDF naar PNG converteren:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Roep de opslagmethode aan om de dia's op te slaan als PNG-afbeeldingen.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Voordat u de C#-code voor conversie van PDF naar PNG uitvoert, moet uw computer aan deze vereisten voldoen:
...
{{% blocks/products/pf/agp/code-block title="C#-code om PDF naar PNG te converteren" offSpacer="" %}}
