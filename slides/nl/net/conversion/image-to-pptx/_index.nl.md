...
description: Converteer afbeelding naar PPTX in C#. Gebruik de .NET-bibliotheek-API om afbeeldingen naar PowerPoint te converteren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Afbeelding converteren naar PPTX in C#" h2="Krachtige platformonafhankelijke .NET API voor het converteren van afbeeldingen naar PPTX met behulp van C#-code op NET Framework-, .NET Core-, Windows Azure-, Mono- of Xamarin-platforms" >}}

{{% blocks/products/pf/feature-page-section h2="Converteer afbeelding naar PPTX met behulp van Aspose.Slides" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Afbeelding converteren naar PPTX in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C#-code voor het converteren van afbeeldingen naar PPTX" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Hoe afbeelding naar PPTX in C# te converteren" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/nl/net/conversion/image-to-ppt/" name="IMAGE TO PPT" >}}
