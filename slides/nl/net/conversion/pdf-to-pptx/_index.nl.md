...
url: /nl/net/conversion/pdf-to-pptx/
keywords: Converteer PDF naar PPTX, PDF naar PPTX, PowerPoint, PDF, PPTX, C# API, .NET Library
description: Converteer PDF naar PPTX in C#. Gebruik de .NET-bibliotheek-API om PDF naar PowerPoint te converteren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converteer PDF naar PPTX in C#" h2="Krachtige platformonafhankelijke .NET API voor het converteren van PDF naar PPTX met behulp van C#-code op NET Framework-, .NET Core-, Windows Azure-, Mono- of Xamarin-platforms" >}}

{{% blocks/products/pf/feature-page-section h2="Converteer PDF naar PPTX met behulp van Aspose.Slides" %}}

[**Aspose.Slides voor .NET**](https://products.aspose.com/slides/nl/net/) is een krachtige .NET-bibliotheek die wordt gebruikt om PowerPoint-presentaties, pdf's, HTML-documenten, en andere bestanden. Wanneer u PDF naar PPTX converteert, verplaatst u in feite de inhoud van de PDF-pagina's naar dia's in een PowerPoint-presentatie.
...
{{< blocks/products/pf/feature-page-section  h2="Hoe PDF naar PPTX te converteren in C#" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Laad het PDF-bestand dat u naar PPTX wilt converteren.
{{< /blocks/products/pf/agp/step-autogen >}}
