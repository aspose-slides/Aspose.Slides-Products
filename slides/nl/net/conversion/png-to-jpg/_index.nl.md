...
keywords: PNG naar JPG, PNG converteren naar JPG, C# API, .NET-bibliotheek
description: Converteer PNG naar JPG in C#. Gebruik de .NET bibliotheek-API om PNG naar JPG-bestanden te converteren.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converteer PNG naar JPG in C#" h2="PowerPoint .NET API voor het converteren van PNG naar JPG-afbeeldingsbestanden op NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Converteer PNG naar JPG in C#" %}}

Hoe converteer ik PNG naar JPG in code?

Met behulp van [**Aspose.Slides for .NET**](https://products.aspose.com/slides/nl/net/) kan elke ontwikkelaar of toepassing PNG naar JPG converteren met slechts een paar regels C#-code.

Als een moderne API voor documentverwerking, exporteert Aspose.Slides voor .NET PNG-bestanden snel naar JPG. Met de Aspose PowerPoint-bibliotheek kunt u PNG naar JPG en afbeeldingen in andere formaten converteren.
...
{{< blocks/products/pf/agp/feature-section-col title="Hoe PNG naar JPG te converteren in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ontwikkelaars en applicaties kunnen op deze manier PNG naar JPG converteren:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Sla het bestand op als een JPG-afbeelding.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Voordat u de PNG-naar-JPG-conversie C#-code uitvoert, moet uw machine aan deze vereisten voldoen:
...
{{% blocks/products/pf/agp/code-block title="C#-code om PNG naar JPG te converteren" offSpacer="" %}}
