---
title: Converteer PDF naar afbeelding in C#
weight: 80
url: /nl/net/conversion/pdf-to-image/ 
keywords: PDF naar afbeelding, PDF naar afbeelding converteren, C# API, .NET-bibliotheek, PDF, afbeelding
description: Converteer PDF naar afbeelding in C#. Gebruik de .NET bibliotheek-API om PDF-pagina's naar afbeeldingen te converteren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converteer PDF naar afbeelding in C#" h2="PowerPoint .NET API voor het converteren van PDF-documenten naar afbeeldingen op NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe PDF naar afbeelding in C# te converteren" %}}

Hoe converteer ik PDF naar afbeelding in code?

Met behulp van [**Aspose.Slides for .NET**](https://products.aspose.com/slides/nl/net/) kan elke ontwikkelaar of toepassing PDF converteren naar afbeeldingsbestanden met slechts een paar regels C#-code.

Aspose.Slides voor .NET is een moderne API voor documentverwerking en exporteert snel PDF-pagina's naar afbeeldingsindelingen. Met de Aspose PowerPoint-bibliotheek kunt u PDF naar afbeelding en vele andere bestandsindelingen converteren.
...
{{< blocks/products/pf/agp/feature-section-col title="Hoe PDF naar afbeelding in C# te converteren" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ontwikkelaars en applicaties kunnen op deze manier PDF naar afbeelding converteren:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Roep de opslagmethode aan om de dia's als afbeeldingen op te slaan.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Voordat u de C#-code voor conversie van PDF naar afbeelding uitvoert, moet uw machine aan deze vereisten voldoen:
...
{{% blocks/products/pf/agp/code-block title="C#-code om PDF naar afbeelding te converteren" offSpacer="" %}}
