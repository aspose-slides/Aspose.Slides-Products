...
keywords: PNG naar SVG, PNG converteren naar SVG, C# API, .NET-bibliotheek
description: Converteer PNG naar SVG in C#. Gebruik de .NET bibliotheek-API om PNG naar SVG-bestanden te converteren.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converteer PNG naar SVG in C#" h2="PowerPoint .NET API voor het converteren van PNG naar SVG-afbeeldingsbestanden op NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Converteer PNG naar SVG in C#" %}}

Hoe converteer ik PNG naar SVG in code?

Met behulp van [**Aspose.Slides for .NET**](https://products.aspose.com/slides/nl/net/) kan elke ontwikkelaar of toepassing PNG converteren naar SVG met slechts een paar regels C#-code.

Als een moderne API voor documentverwerking, exporteert Aspose.Slides voor .NET PNG-bestanden snel naar SVG. Aspose PowerPoint-bibliotheek stelt u in staat om PNG naar SVG en afbeeldingen in andere formaten te converteren.
...
{{< blocks/products/pf/agp/feature-section-col title="Hoe PNG naar SVG te converteren in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ontwikkelaars en applicaties kunnen PNG op deze manier naar SVG converteren:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Sla het bestand op als een SVG-afbeelding.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Voordat u de PNG-naar-SVG-conversie C#-code uitvoert, moet uw machine aan deze vereisten voldoen:
...
{{% blocks/products/pf/agp/code-block title="C#-code om PNG naar SVG te converteren" offSpacer="" %}}
