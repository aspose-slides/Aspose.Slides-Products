...
url: /nl/net/conversion/png-to-ppt/
keywords: Converteer PNG naar PPT, PNG naar PPT, PowerPoint, PNG, PPT, C# API, .NET Library
description: Converteer PNG naar PPT in C#. Gebruik de .NET-bibliotheek-API om PNG-afbeeldingen naar PowerPoint te converteren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converteer PNG naar PPT in C#" h2="Krachtige platformonafhankelijke .NET API voor het converteren van PNG naar PPT met behulp van C#-code op NET Framework-, .NET Core-, Windows Azure-, Mono- of Xamarin-platforms" >}}
...
Met behulp van [**Aspose.Slides for .NET**](https://products.aspose.com/slides/nl/net/), kunt u een PNG-afbeelding converteren naar een PowerPoint-presentatie met slechts een paar regels code:
