---
title: Android PowerPoint-API | Aspose.Slides voor Android API
weight: 5960
url: /nl/android-java/ 
description: Aspose.Slides voor Android API of Android PowerPoint API om PPT POT PPS PPTX POTX PPSX PowerPoint op Android te maken en te manipuleren.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Android PowerPoint-API" h2="PowerPoint-presentaties maken, wijzigen, converteren, samenvoegen, splitsen en beheren in Android-apps." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-android-java.svg" pfName="Aspose.Slides" subTitlepfName="for Android via Java" downloadUrl="https://downloads.aspose.com/slides/androidjava" >}}
...
<p>
 Aspose.Slides voor Android via Java is een PowerPoint API voor Android-applicaties. Ontwikkelaars kunnen een breed scala aan presentatieverwerkingstaken uitvoeren, waaronder lezen, schrijven, wijzigen, samenvoegen, splitsen, converteren en manipuleren van presentaties zonder enige afhankelijkheid van Microsoft PowerPoint.
</p>

<p>
 Aspose.Slides voor Android via Java ondersteunt bijna alle native PowerPoint-bestandsindelingen en OpenOffice-presentatie-indeling (ODP). Maak uw PowerPoint-viewer-app voor Android, evenals converter, editor of iets anders. Presentatie-elementen zoals SmartArt-vormen, MSO-diagrammen, ActiveX-componenten en OLE-frameobjecten zijn toegankelijk via de PowerPoint API voor beheer en manipulatie.
</p>
...
{{< blocks/products/pf/carousel-item h3="In een oogopslag" description="Aspose.Slides voor Android API-functies overzicht." >}}
...
{{< blocks/products/pf/carousel-item h3="Platformonafhankelijkheid" description="Aspose.Slides voor Android API omvat de volgende Android-ontwikkelomgevingen en implementatieplatforms." >}}
<div class="diagram1 d1-android">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="Ondersteunde bestandsindelingen" description="Aspose.Slides voor Android API ondersteunt native [PowerPoint-indelingen](https://docs.aspose.com/slides/java/supported-file-formats/) en vele conversie-indelingen." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Geavanceerde Android PowerPoint API-functies
   </h2>
   <p>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Nieuwe dia's maken of klonen van sjablonen
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     De beveiliging op vormen toevoegen of verwijderen
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Microsoft Excel-diagrammen toevoegen als OleObjects
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     HTML-tekst importeren en exporteren naar dia's
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     ActiveX- en SmartArt-componenten beheren
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Overgang diavoorstelling toevoegen of wijzigen
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Vormen zonder tekst vectoriseren
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Render SVG-afbeeldingen naar vormen
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Presentatie-opmaak op minuutniveau
    </h2>
    <p>
     PowerPoint-bibliotheek kan gemakkelijk tekst- en vormopmaakfuncties verwerken, zoals lettergrootte, type, kleur en tinten, alinea-uitlijning, opsommingstekens en oriëntatie en hyperlinks.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Presentatieconversie met notities
    </h2>
    <p>
     API biedt conversie naar TIFF en PDF met notities. Ontwikkelaars kunnen de hele presentatie in de Notes-diaweergave converteren naar het ondersteunde formaat en in het geval van afbeeldingen kan men een diaminiatuur maken in de Notes-diaweergave voor afzonderlijke dia's. Hier is de TIFF-conversiecode.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Presentaties converteren met Notes
     </h3>
...
pres.save(dataDir + "TestNotes.tiff", SaveFormat.Tiff,opts);
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Elementen manipuleren via openbare API
    </h2>
    <p>
     API kan alle presentatiedia-elementen verwerken, inclusief rechthoek, tabel, tekstvak, ellips, polylijn, afbeeldingsframe, auto-shape, audioframe, OLE-objectframe en videoframe. API biedt ook een uitgebreide set API-opdrachten om elk van deze elementen te manipuleren. Bovendien wordt tekstopmaak ondersteund door een goed ontworpen reeks klassen.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Documentatie" href="https://docs.aspose.com/slides/androidjava/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Waarom Aspose.Slides voor Android via Java?" tabId="success-stories" >}}
