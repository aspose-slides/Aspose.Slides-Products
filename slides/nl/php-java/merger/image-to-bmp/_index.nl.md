...
description: Afbeelding samenvoegen naar BMP in PHP. Gebruik de PHP-bibliotheek-API om afbeeldingen te combineren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Afbeelding samenvoegen naar BMP in PHP" h2="High-speed en platformonafhankelijke PHP-bibliotheek voor het samenvoegen van afbeelding naar BMP-bestanden met behulp van PHP-code" >}}

{{% blocks/products/pf/feature-page-section h2="Afbeelding samenvoegen tot BMP met behulp van Aspose.Slides" %}}

[**Aspose.Slides voor PHP via Java**](https://products.aspose.com/slides/nl/php-java/) is een krachtige PHP-bibliotheek die wordt gebruikt om presentaties, pdf's, afbeeldingen en andere bestanden. Wanneer u afbeeldingen samenvoegt tot BMP, combineert u in feite afbeeldingen om een ​​enkel BMP-bestand te verkrijgen.
...
{{% blocks/products/pf/feature-page-section  h2="Afbeelding samenvoegen naar BMP in PHP" %}}
Door [**Aspose.Slides voor PHP via Java**](https://products.aspose.com/slides/nl/php-java/) te gebruiken, kunt u afbeeldingen snel samenvoegen tot BMP met slechts een paar regels code

{{% blocks/products/pf/agp/code-block title="PHP-code voor het samenvoegen van afbeelding naar BMP" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Afbeelding samenvoegen met BMP in PHP" >}}
