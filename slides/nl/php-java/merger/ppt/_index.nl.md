---
title: Voeg PPT bestanden samen met behulp van PHP
url: /nl/php-java/merger/ppt/
keywords: Samenvoegen PPT, Join PPT, Combineren PPT, PowerPoint, Presentatie, PHP, Aspose
description: Voeg meerdere PPT-bestanden samen in PHP.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Voeg PPT bestanden samen in PHP" h2="Snelle en platformonafhankelijke PHP API die helpt bij het ontwikkelen van applicaties met de mogelijkheid om Microsoft PowerPoint- en OpenOffice-presentatiebestanden te maken, samen te voegen, te inspecteren of te converteren zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Voeg PPT samen in PHP" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Voeg PPT bestanden samen met PHP" %}}
Om de PowerPoint-presentaties samen te voegen, moet u de dia's van de ene presentatie naar de andere klonen.

{{% blocks/products/pf/agp/code-block title="PHP-code voor het samenvoegen van meerdere PPT in één bestand" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hoe PPT samen te voegen met Aspose.Slides voor PHP API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dit zijn de stappen om twee PPT bestanden samen te voegen en het resultaat op te slaan als PPT in PHP." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Laad de PPT bestanden die je wilt samenvoegen.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Sla het resulterende PPT-document op.
{{< /blocks/products/pf/agp/step-autogen >}}
