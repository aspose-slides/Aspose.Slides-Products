---
title: Bewerk PPTX in PHP
url: /nl/php-java/editor/pptx/
keywords: Bewerk PPTX, Bewerk PowerPoint, PPTX, PowerPoint, PHP API, PHP Library
description: Bewerk PPTX in PHP. Gebruik de PHP-bibliotheek-API om PPTX-bestanden te bewerken
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Bewerk PPTX in PHP" h2="Snelle en platformonafhankelijke PHP-bibliotheek voor het bewerken van PPTX met behulp van PHP-code" >}}

{{% blocks/products/pf/feature-page-section h2="Bewerk PPTX met Aspose.Slides" %}}

[**Aspose.Slides voor PHP via Java**](https://products.aspose.com/slides/nl/php-java/) is een krachtige PHP-bibliotheek die wordt gebruikt om presentaties te manipuleren en te bewerken. Je kunt een PPTX presentatie bewerken door er een nieuwe regel tekst aan toe te voegen. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Bewerk PPTX in PHP" %}}
Met behulp van [**Aspose.Slides voor PHP via Java**](https://products.aspose.com/slides/nl/php-java/), kunt u een nieuwe regel tekst toevoegen aan het PPTX-document met slechts een paar regels code.

{{% blocks/products/pf/agp/code-block title="PHP-code voor het bewerken van PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hoe PPTX in PHP te bewerken" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Laad de PPTX presentatie die je wilt bewerken.
{{< /blocks/products/pf/agp/step-autogen >}}
