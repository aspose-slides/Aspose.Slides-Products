---
title: Python PowerPoint-API. Python PPTX, PPT van Aspose.Slides
weight: 5860
url: /nl/python-net/ 
description: Python-bibliotheek om te werken met Microsoft PowerPoint-bestanden. Python PPTX, PPT. Maken bewerken converteren PPT PPTX PPS POT PPSX PPTM PPSM POTX POTM ODP PDF en nog veel meer formaten.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python PowerPoint-API voor presentaties. Python PPTX, PPT" h2="Maak, lees, schrijf, wijzig, voeg samen, kloon, bescherm en converteer PowerPoint- en OpenOffice-presentaties in Python zonder externe software." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-python.svg" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="https://downloads.aspose.com/slides/python-net" >}}
...
<p><strong>Aspose.Slides voor Python via .NET</strong> is een krachtige klassenbibliotheek voor het werken met of het verwerken van presentaties. Met dit product kunnen applicaties en ontwikkelaars PowerPoint-presentaties (PPT, PPTX) en presentaties in andere formaten (ODP) lezen, bewerken of manipuleren en converteren zonder applicaties of afhankelijkheden van derden. </p>

<p><strong>Aspose.Slides voor Python via. NET</strong> biedt deze populaire functies:</p>
<ul>
    <li>Presentaties laden, openen en bekijken.</li>
    <li>Presentaties bewerken.</li>
    <li>Presentaties converteren naar PDF, Word, JPG, HTML, GIF, SVG en vele andere formaten.</li>
    <li>Presentaties maken en afdrukken.</li>
    <li>Versleutelen en ontsleutelen van presentaties; presentaties met wachtwoord beveiligen en wachtwoorden verwijderen.</li>
    <li>Manipuleren van presentatie-entiteiten, zoals basisdia's, vormen, grafieken, fotolijsten, audioframes, videoframes, OLE, VBA-macro's, animaties, enz.</li>
    <li>En nog veel meer functies.</li>
</ul>

<p>Python is een zeer populaire taal die veel wordt gebruikt in reguliere toepassingen, webontwikkeling, onderzoeks- en academische taken, gegevensanalyse, enz. Om deze reden is het <strong>Aspose.Slides</strong>-team trots om <strong> strong>Aspose.Slides voor Python via .NET</strong> aan de python-community. </p>
...
{{< blocks/products/pf/carousel-item h3="Platformonafhankelijkheid" description="Python-presentatie-API ondersteunt alle belangrijke platforms, waaronder de volgende." >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="Ondersteunde bestandsindelingen" description="Aspose.Slides voor Python via .NET ondersteunt populaire [presentatieformaten](https://docs.aspose.com/slides/python-net/supported-file-formats/) en deze exportformaten." >}}
  ...
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <ul>
	  ...
	  <li>Als je Python-code op Linux schrijft, kijk dan eens naar <a href="https://docs.aspose.com/slides/python-net/system-requirements/">aanvullende vereisten voor Linux</a></li>
    </ul>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>Gebruik <strong>pip</strong> om onze Python-bibliotheek voor presentatieverwerking te installeren vanuit de <a href="https://pypi.org/project/aspose.slides/">PyPI-repository</a></p>:
	<pre><code>pip install aspose.slides</code></pre>
   </div>
    <div class="col-lg-12">
        <h2 class="h2title">Maak een nieuwe PowerPoint-presentatie. Python PPTX, PPT of ODP</h2>
        <p>In het onderstaande voorbeeld hebben we een regel toegevoegd aan de eerste dia van de presentatie.</p>
        <pre>
            <code class="python">
...
with slides.Presentation() as presentation:
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Presentaties samenvoegen: Python PPTX, PPT of ODP</h2>
        <p>Deze Python-code laat zien hoe je presentaties samenvoegt:</p>
        <pre>
            <code class="python">
import aspose.slides as slides
...
with slides.Presentation("Presentation1.pptx") as pres1:
    ...
    <div class="col-lg-12">
        <h2 class="h2title"> Presentatie importeren vanuit PDF: Python PPTX, PPT of ODP</h2>
...
with slides.Presentation() as pres:
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Converteer PowerPoint naar PDF met standaardopties: Python PPTX, PPT of ODP naar PDF</h2>
        <p>Deze python-code laat zien hoe u een PowerPoint PPT-, PPTX- en OpenOffice ODP-document converteert naar een PDF-document met behulp van de standaardopties. Het resulterende bestand is een PDF-document met de maximale kwaliteitsniveaus</p>
        <pre>
            <code class="python">
import aspose.slides as slides
...
presentation.save("PPT-to-PDF.pdf", slides.export.SaveFormat.PDF)
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Converteer PowerPoint naar JPG: Python PPTX, PPT of ODP naar JPEG</h2>
...
<p class="first">
We hebben gemerkt dat Aspose.Slides gemakkelijk te gebruiken is en goed werkt op onze servers. We hebben ontdekt dat ze in een belangrijke behoefte voorzien voor het dynamisch genereren van bestanden om ons bereik buiten de traditionele webapplicatie uit te breiden.
 <em>
...
{{< blocks/products/pf/slr-element name="Documentatie" href="https://docs.aspose.com/slides/python-net/" >}}
{{< blocks/products/pf/slr-element name="Broncode" href="https://github.com/aspose-slides/" >}}
{{< blocks/products/pf/slr-element name="API-referenties" href="https://docs.aspose.com/slides/python-net/api-reference/" >}}
...
{{< blocks/products/pf/slr-element name="Release-opmerkingen" href="https://releases.aspose.com/slides/python-net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Waarom Aspose.Slides voor Python via .NET?" tabId="success-stories" >}}
