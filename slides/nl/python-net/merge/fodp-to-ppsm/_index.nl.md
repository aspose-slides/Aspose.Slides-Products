---
title: Voeg FODP-bestanden samen naar PPSM met Python
url: /nl/python-net/merge/fodp-to-ppsm/
keywords: Voeg FODP samen tot PPSM, voeg FODP toe aan PPSM, combineer FODP tot PPSM, PowerPoint, Presentatie, PPSM, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Samenvoegen FODP bestanden naar PPSM samen in Python" h2="Hoge snelheid en platformonafhankelijke Python API die helpt bij het ontwikkelen van applicaties met de mogelijkheid om Microsoft PowerPoint- en OpenOffice-presentatiebestanden te maken, samen te voegen, te inspecteren of te converteren zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Samenvoegen FODP naar PPSM in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Voeg FODP bestanden samen tot PPSM met Python" %}}
Om de PowerPoint-presentaties samen te voegen, moet u de dia's van de ene presentatie naar de andere klonen.

{{% blocks/products/pf/agp/code-block title="Python-code voor het samenvoegen van meerdere FODP in een enkel PPSM bestand" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hoe FODP samen te voegen met PPSM met behulp van Aspose.Slides voor Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dit zijn de stappen om twee FODP-bestanden samen te voegen en het resultaat op te slaan als PPSM in Python." >}}
