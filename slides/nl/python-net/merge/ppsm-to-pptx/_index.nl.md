---
title: Voeg PPSM-bestanden samen naar PPTX met Python
url: /nl/python-net/merge/ppsm-to-pptx/
keywords: Voeg PPSM samen tot PPTX, voeg PPSM toe aan PPTX, combineer PPSM tot PPTX, PowerPoint, Presentatie, PPTX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Voeg PPSM bestanden samen tot PPTX met Python" %}}
Om de PowerPoint-presentaties samen te voegen, moet u de dia's van de ene presentatie naar de andere klonen.

{{% blocks/products/pf/agp/code-block title="Python-code voor het samenvoegen van meerdere PPSM in een enkel PPTX bestand" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hoe PPSM samen te voegen met PPTX met behulp van Aspose.Slides voor Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dit zijn de stappen om twee PPSM-bestanden samen te voegen en het resultaat op te slaan als PPTX in Python." >}}
