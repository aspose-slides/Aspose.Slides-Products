---
title: Voeg POTM-bestanden samen naar PNG met Python
url: /nl/python-net/merge/potm-to-png/
keywords: Voeg POTM samen tot PNG, voeg POTM toe aan PNG, combineer POTM tot PNG, PowerPoint, Presentatie, PNG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Voeg POTM bestanden samen tot PNG met Python" %}}
Om de PowerPoint-presentaties samen te voegen, moet u de dia's van de ene presentatie naar de andere klonen.

{{% blocks/products/pf/agp/code-block title="Python-code voor het samenvoegen van meerdere POTM in een enkel PNG bestand" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hoe POTM samen te voegen met PNG met behulp van Aspose.Slides voor Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dit zijn de stappen om twee POTM-bestanden samen te voegen en het resultaat op te slaan als PNG in Python." >}}
