---
title: Voeg PPT-bestanden samen naar PPTX met Python
url: /nl/python-net/merge/ppt-to-pptx/
keywords: Voeg PPT samen tot PPTX, voeg PPT toe aan PPTX, combineer PPT tot PPTX, PowerPoint, Presentatie, PPTX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Voeg PPT bestanden samen tot PPTX met Python" %}}
Om de PowerPoint-presentaties samen te voegen, moet u de dia's van de ene presentatie naar de andere klonen.

{{% blocks/products/pf/agp/code-block title="Python-code voor het samenvoegen van meerdere PPT in een enkel PPTX bestand" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hoe PPT samen te voegen met PPTX met behulp van Aspose.Slides voor Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dit zijn de stappen om twee PPT-bestanden samen te voegen en het resultaat op te slaan als PPTX in Python." >}}
