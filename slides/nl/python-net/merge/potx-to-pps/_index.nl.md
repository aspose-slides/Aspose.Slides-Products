---
title: Voeg POTX-bestanden samen naar PPS met Python
url: /nl/python-net/merge/potx-to-pps/
keywords: Voeg POTX samen tot PPS, voeg POTX toe aan PPS, combineer POTX tot PPS, PowerPoint, Presentatie, PPS, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Samenvoegen POTX bestanden naar PPS samen in Python" h2="Hoge snelheid en platformonafhankelijke Python API die helpt bij het ontwikkelen van applicaties met de mogelijkheid om Microsoft PowerPoint- en OpenOffice-presentatiebestanden te maken, samen te voegen, te inspecteren of te converteren zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Samenvoegen POTX naar PPS in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Voeg POTX bestanden samen tot PPS met Python" %}}
Om de PowerPoint-presentaties samen te voegen, moet u de dia's van de ene presentatie naar de andere klonen.

{{% blocks/products/pf/agp/code-block title="Python-code voor het samenvoegen van meerdere POTX in een enkel PPS bestand" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hoe POTX samen te voegen met PPS met behulp van Aspose.Slides voor Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dit zijn de stappen om twee POTX-bestanden samen te voegen en het resultaat op te slaan als PPS in Python." >}}
