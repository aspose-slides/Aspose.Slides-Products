---
title: Voeg PPS-bestanden samen naar PNG met Python
url: /nl/python-net/merge/pps-to-png/
keywords: Voeg PPS samen tot PNG, voeg PPS toe aan PNG, combineer PPS tot PNG, PowerPoint, Presentatie, PNG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Voeg PPS bestanden samen tot PNG met Python" %}}
Om de PowerPoint-presentaties samen te voegen, moet u de dia's van de ene presentatie naar de andere klonen.

{{% blocks/products/pf/agp/code-block title="Python-code voor het samenvoegen van meerdere PPS in een enkel PNG bestand" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hoe PPS samen te voegen met PNG met behulp van Aspose.Slides voor Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dit zijn de stappen om twee PPS-bestanden samen te voegen en het resultaat op te slaan als PNG in Python." >}}
