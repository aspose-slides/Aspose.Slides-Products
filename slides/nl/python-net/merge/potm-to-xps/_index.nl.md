---
title: Voeg POTM-bestanden samen naar XPS met Python
url: /nl/python-net/merge/potm-to-xps/
keywords: Voeg POTM samen tot XPS, voeg POTM toe aan XPS, combineer POTM tot XPS, PowerPoint, Presentatie, XPS, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Samenvoegen POTM bestanden naar XPS samen in Python" h2="Hoge snelheid en platformonafhankelijke Python API die helpt bij het ontwikkelen van applicaties met de mogelijkheid om Microsoft PowerPoint- en OpenOffice-presentatiebestanden te maken, samen te voegen, te inspecteren of te converteren zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Samenvoegen POTM naar XPS in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Voeg POTM bestanden samen tot XPS met Python" %}}
Om de PowerPoint-presentaties samen te voegen, moet u de dia's van de ene presentatie naar de andere klonen.

{{% blocks/products/pf/agp/code-block title="Python-code voor het samenvoegen van meerdere POTM in een enkel XPS bestand" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hoe POTM samen te voegen met XPS met behulp van Aspose.Slides voor Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dit zijn de stappen om twee POTM-bestanden samen te voegen en het resultaat op te slaan als XPS in Python." >}}
