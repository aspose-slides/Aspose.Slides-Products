---
title: Voeg FODP-bestanden samen naar PNG met Python
url: /nl/python-net/merge/fodp-to-png/
keywords: Voeg FODP samen tot PNG, voeg FODP toe aan PNG, combineer FODP tot PNG, PowerPoint, Presentatie, PNG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Voeg FODP bestanden samen tot PNG met Python" %}}
Om de PowerPoint-presentaties samen te voegen, moet u de dia's van de ene presentatie naar de andere klonen.

{{% blocks/products/pf/agp/code-block title="Python-code voor het samenvoegen van meerdere FODP in een enkel PNG bestand" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hoe FODP samen te voegen met PNG met behulp van Aspose.Slides voor Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dit zijn de stappen om twee FODP-bestanden samen te voegen en het resultaat op te slaan als PNG in Python." >}}
