---
title: Voeg PPSM-bestanden samen naar FODP met Python
url: /nl/python-net/merge/ppsm-to-fodp/
keywords: Voeg PPSM samen tot FODP, voeg PPSM toe aan FODP, combineer PPSM tot FODP, PowerPoint, Presentatie, FODP, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Samenvoegen PPSM bestanden naar FODP samen in Python" h2="Hoge snelheid en platformonafhankelijke Python API die helpt bij het ontwikkelen van applicaties met de mogelijkheid om Microsoft PowerPoint- en OpenOffice-presentatiebestanden te maken, samen te voegen, te inspecteren of te converteren zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Samenvoegen PPSM naar FODP in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Voeg PPSM bestanden samen tot FODP met Python" %}}
Om de PowerPoint-presentaties samen te voegen, moet u de dia's van de ene presentatie naar de andere klonen.

{{% blocks/products/pf/agp/code-block title="Python-code voor het samenvoegen van meerdere PPSM in een enkel FODP bestand" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hoe PPSM samen te voegen met FODP met behulp van Aspose.Slides voor Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dit zijn de stappen om twee PPSM-bestanden samen te voegen en het resultaat op te slaan als FODP in Python." >}}
