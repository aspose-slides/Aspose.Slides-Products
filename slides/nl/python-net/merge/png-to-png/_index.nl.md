...
description: Voeg PNG samen met PNG in Python. Gebruik de Python-bibliotheek-API om PNG-bestanden te combineren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Voeg PNG samen in Python" h2="Snelle en platformonafhankelijke Python-bibliotheek voor het samenvoegen van PNG-afbeeldingen met behulp van Python-code" >}}

{{% blocks/products/pf/feature-page-section h2="Voeg PNG samen met PNG met behulp van Aspose.Slides" %}}

[**Aspose.Slides voor Python via .NET**](https://products.aspose.com/slides/nl/python-net/) is een krachtige Python-bibliotheek die wordt gebruikt om presentaties, afbeeldingen en andere bestanden samen te voegen en te manipuleren. Wanneer u PNG samenvoegt met PNG, combineert u in feite twee afbeeldingen om één afbeelding te krijgen.
...
{{% blocks/products/pf/feature-page-section  h2="Voeg PNG samen met PNG in Python" %}}
Met behulp van [**Aspose.Slides voor Python via .NET**](https://products.aspose.com/slides/nl/python-net/), kunt u snel PNG-bestanden samenvoegen met slechts een paar regels code

{{% blocks/products/pf/agp/code-block title="Python-code voor het samenvoegen van PNG naar PNG" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="Hoe PNG in Python samen te voegen" >}}
