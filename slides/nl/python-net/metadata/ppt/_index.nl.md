---
title: Bekijk of bewerk metadata van PPT bestanden met behulp van Python
url: /nl/python-net/metadata/ppt/
keywords: Bewerk PPT metadata, bekijk PPT metadata, bewerk PPT eigenschappen, bekijk PPT eigenschappen
description: Python broncode om metadata in PPT-indeling te bewerken of te bekijken.
---
...
{{% blocks/products/pf/feature-page-section  h2="Wijzig PPT eigenschappen via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Wijzig PPT ingebouwde eigenschappen - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Aangepaste eigenschappen toevoegen aan PPT - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Metadata van PPT extraheren via Python" >}}
