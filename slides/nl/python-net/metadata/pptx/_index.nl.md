---
title: Bekijk of bewerk metadata van PPTX bestanden met behulp van Python
url: /nl/python-net/metadata/pptx/
keywords: Bewerk PPTX metadata, bekijk PPTX metadata, bewerk PPTX eigenschappen, bekijk PPTX eigenschappen
description: Python broncode om metadata in PPTX-indeling te bewerken of te bekijken.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Bewerk PPTX eigenschappen met Python" h2="Bouw uw eigen Python-apps om ingebouwde en aangepaste eigenschappen in presentatiebestanden aan te passen met behulp van server-side API's." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" fileiconsmall4="POT" fileiconsmall5="ppsx" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for Python via .NET" >}}

{{% blocks/products/pf/feature-page-section  h2="Wijzig PPTX eigenschappen via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Wijzig PPTX ingebouwde eigenschappen - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Aangepaste eigenschappen toevoegen aan PPTX - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Metadata van PPTX extraheren via Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dit zijn de stappen om metadata te extraheren uit PPTX-bestanden." >}}

{{< blocks/products/pf/agp/step-autogen >}}
Maak een instantie van de Presentation-klasse met het pad naar het PPTX-bestand
{{< /blocks/products/pf/agp/step-autogen >}}
