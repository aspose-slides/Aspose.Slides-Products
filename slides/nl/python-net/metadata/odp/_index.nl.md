---
title: Bekijk of bewerk metadata van ODP bestanden met behulp van Python
url: /nl/python-net/metadata/odp/
keywords: Bewerk ODP metadata, bekijk ODP metadata, bewerk ODP eigenschappen, bekijk ODP eigenschappen
description: Python broncode om metadata in ODP-indeling te bewerken of te bekijken.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Bewerk ODP eigenschappen met Python" h2="Bouw uw eigen Python-apps om ingebouwde en aangepaste eigenschappen in presentatiebestanden aan te passen met behulp van server-side API's." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" fileiconsmall4="POT" fileiconsmall5="ppsx" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for Python via .NET" >}}

{{% blocks/products/pf/feature-page-section  h2="Wijzig ODP eigenschappen via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Wijzig ODP ingebouwde eigenschappen - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Aangepaste eigenschappen toevoegen aan ODP - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Metadata van ODP extraheren via Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dit zijn de stappen om metadata te extraheren uit ODP-bestanden." >}}

{{< blocks/products/pf/agp/step-autogen >}}
Maak een instantie van de Presentation-klasse met het pad naar het ODP-bestand
{{< /blocks/products/pf/agp/step-autogen >}}
