...
Wilt u PPTX-bestanden programmatisch naar FODP converteren? Met behulp van [*Aspose.Slides voor Python via .NET*](https://products.aspose.com/slides/nl/python-net/) kan elke ontwikkelaar PPTX naar FODP-formaat converteren met slechts een paar regels Python-code.
