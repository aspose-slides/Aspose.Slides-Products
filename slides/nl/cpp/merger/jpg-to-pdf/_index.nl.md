...
url: /nl/cpp/merger/jpg-to-pdf/
keywords: JPG naar PDF, JPG naar PDF samenvoegen, JPG naar PDF samenvoegen, PDF, JPG, C++ API, C++ bibliotheek
description: Voeg JPG samen met PDF in C++. Gebruik de C++-bibliotheek-API om JPG en PDF te combineren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Voeg JPG samen met PDF in C++" h2="Snelle en platformonafhankelijke C++-bibliotheek voor het samenvoegen van JPG- naar PDF-bestanden met behulp van C++-code" >}}

{{% blocks/products/pf/feature-page-section h2="Voeg JPG samen met PDF met behulp van Aspose.Slides" %}}

[**Aspose.Slides voor C++**](https://products.aspose.com/slides/nl/cpp/) is een krachtige C++-bibliotheek die wordt gebruikt om presentaties, pdf's, afbeeldingen en andere bestanden. Wanneer u JPG naar PDF samenvoegt, combineert u in feite JPG-afbeeldingen om één PDF-bestand te krijgen.
...
Met [**Aspose.Slides voor C++**](https://products.aspose.com/slides/nl/cpp/) kunt u snel JPG naar PDF samenvoegen met slechts een paar regels code
