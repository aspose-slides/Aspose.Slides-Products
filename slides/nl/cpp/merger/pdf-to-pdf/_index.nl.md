...
url: /nl/cpp/merger/pdf-to-pdf/
keywords: PDF samenvoegen, PDF naar PDF, lid worden van PDF, PDF combineren, C++ API, C++ Library
description: PDF naar PDF samenvoegen in C++. Gebruik de C++-bibliotheek-API om PDF-bestanden te combineren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="PDF samenvoegen in C++" h2="Snelle en platformonafhankelijke C++-bibliotheek voor het samenvoegen van PDF-bestanden met behulp van C++-code" >}}
...
Met [**Aspose.Slides for C++**](https://products.aspose.com/slides/nl/cpp/) kunt u PDF-bestanden snel samenvoegen met slechts een paar regels code
