...
url: /nl/cpp/merger/html-to-html/
keywords: HTML samenvoegen, HTML naar HTML, lid worden van HTML, HTML combineren, C++ API, C++ Library
description: Voeg HTML samen met HTML in C++. Gebruik de C++-bibliotheek-API om HTML-bestanden te combineren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Voeg HTML samen in C++" h2="Snelle en platformonafhankelijke C++-bibliotheek voor het samenvoegen van HTML-bestanden met behulp van C++-code" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Voeg HTML samen met HTML in C++" %}}
Met [**Aspose.Slides for C++**](https://products.aspose.com/slides/nl/cpp/) kunt u HTML-bestanden snel samenvoegen met slechts een paar regels code
