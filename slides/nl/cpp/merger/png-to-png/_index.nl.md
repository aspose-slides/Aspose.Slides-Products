...
url: /nl/cpp/merger/png-to-png/
keywords: Voeg PNG, PNG naar PNG samen, word lid van PNG, combineer PNG, C++ API, C++ bibliotheek
description: Voeg PNG samen met PNG in C++. Gebruik de C++-bibliotheek-API om PNG-bestanden te combineren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Voeg PNG samen in C++" h2="Snelle en platformonafhankelijke C++-bibliotheek voor het samenvoegen van PNG-afbeeldingen met behulp van C++-code" >}}

{{% blocks/products/pf/feature-page-section h2="Voeg PNG samen met PNG met behulp van Aspose.Slides" %}}

[**Aspose.Slides voor C++**](https://products.aspose.com/slides/nl/cpp/) is een krachtige C++-bibliotheek die wordt gebruikt om presentaties, afbeeldingen en andere bestanden samen te voegen en te manipuleren. Wanneer u PNG samenvoegt met PNG, combineert u in feite twee afbeeldingen om één afbeelding te krijgen.
...
Met [**Aspose.Slides for C++**](https://products.aspose.com/slides/nl/cpp/) kunt u snel PNG-bestanden samenvoegen met slechts een paar regels code
...
{{< blocks/products/pf/feature-page-section  h2="Hoe PNG samen te voegen in C++" >}}
