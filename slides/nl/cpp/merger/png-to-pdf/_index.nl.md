---
title: Voeg PNG samen met PDF in C++
url: /nl/cpp/merger/png-to-pdf/
keywords: PNG naar PDF, PNG naar PDF samenvoegen, PNG naar PDF, PDF, PNG, C++ API, C++ bibliotheek
description: Voeg PNG samen met PDF in C++. Gebruik de C++-bibliotheek-API om PNG en PDF te combineren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Voeg PNG samen met PDF in C++" h2="Snelle en platformonafhankelijke C++-bibliotheek voor het samenvoegen van PNG- naar PDF-bestanden met behulp van C++-code" >}}

{{% blocks/products/pf/feature-page-section h2="Voeg PNG samen met PDF met behulp van Aspose.Slides" %}}

[**Aspose.Slides voor C++**](https://products.aspose.com/slides/nl/cpp/) is een krachtige C++-bibliotheek die wordt gebruikt voor het maken, converteren, samenvoegen en manipuleren van presentaties, afbeeldingen en andere bestanden. Wanneer u PNG naar PDF samenvoegt, combineert u in feite PNG-afbeeldingen om één PDF-bestand te verkrijgen.
...
{{% blocks/products/pf/feature-page-section  h2="Voeg PNG samen met PDF in C++" %}}
Met [**Aspose.Slides voor C++**](https://products.aspose.com/slides/nl/cpp/) kunt u PNG snel samenvoegen naar PDF met slechts een paar regels code

{{% blocks/products/pf/agp/code-block title="C++-code voor het samenvoegen van PNG naar PDF" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="PNG samenvoegen met PDF in C++" >}}
