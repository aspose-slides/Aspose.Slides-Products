...
title: Converteer PPTX naar PDF via de C++-toepassing
weight: 8040
url: /nl/cpp/conversion/pptx-to-pdf/ 
description: Voorbeeld van C++-conversiecode voor PPTX-document naar PDF-formaat. Gebruik voorbeeldcode voor batch-PPTX naar PDF-conversie binnen elke C++-toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer PPTX naar PDF via C++" h2="Hoogwaardige PPTX naar PDF-conversie met behulp van de C++-bibliotheek zonder de noodzaak van Microsoft PowerPoint-installatie." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-ontwikkelaars kunnen het PPTX-bestand gemakkelijk converteren naar PDF in slechts een paar regels code.
...
{{% blocks/products/pf/agp/code-block title="PPTX naar PDF C++ conversie broncode" offSpacer="" %}}
