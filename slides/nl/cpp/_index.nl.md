...
<p class="col-lg-10">Excel-diagrammen insluiten als OLE-objecten in dia's</p>

</div>

<div class="col-lg-4"><em class="fa fa-print  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Gekoppelde Ole Objects beheren</p>
...
<p class="col-lg-10">Bedrukking van presentaties op maat</p>
...
<h2 class="h2title">Continue integratie van nieuwe functies</h2>

<p>U bent nooit beperkt tot bestaande functies. Onze productteams voegen voortdurend meer en meer functies toe en elke nieuwe versie biedt meer functies in vergelijking met de oudere versies. U kunt ook nieuwe functieverzoeken verzenden als u merkt dat een van uw gewenste functies ontbreekt. Hier is de lijst met enkele keuzes van de nieuwste functies.</p>

<ul>

<li>Rasterisatie of vectorisatie van vormen zonder tekst.</li>

<li>Converteer SVG-afbeeldingen naar vormen.</li>

<li>Verkrijg de standaard tabelachtergrond.</li>

<li>Toegang tot het lokale bestandssysteem beperken bij het openen van een document.</li>

<li>Voeg coderende metatag toe bij het opslaan in HTML.</li>

<li>Instelling voor het verwijderen van de breedte- en hoogtekenmerken van de SVG-tag bij het opslaan als HTML.</li>

<li>Support for

<ul>

<li>Reacties antwoorden, Office 365 en externe Excel-werkmappen.</li>

<li>Grootte vertegenwoordigt eigenschap voor bellendiagram.</li>

<li>Het linkerdeelvenster met diaminiaturen verbergen in gegenereerde PPT.</li>

<li>Trechterdiagrammen, 2D-kaartdiagrammen en werkmappad voor externe gegevensbron instellen.</li>

<li>OpenDocument-codering, Morph Transition en Text Highlighter-functie.</li>

<li>Transparantie-eigenschap instellen voor schaduweffecten.</li>

<li>Toelichtingsvorm instellen voor seriegegevenslabel.</li>

<li>Krijg effecten door alinea's in tekstvakken.</li>

<li>Rendering vorm Zachte randen (EffectFormat) effect.</li>

<li>ChartData SetRange op een draaitabel.</li>

</ul>

</li>

<li>Implementeer Tiff-formaat met meerdere pagina's, Metafile Format Plus Extensions (EMF+) en Strict Open XML-formaat.</li>

<li>Rendering van opmerkingen van ODP-indeling die geen auteur hebben.</li>

<li>Implementeer serialisatie met naleving van de strikte open XML-indeling.</li>
...
<h2 class="h2title">Verwerking van SmartArt-vormen</h2>

<p>Aspose.Slides voor C++ vergemakkelijkt het maken van SmartArt-vormen vanaf het begin en biedt de mogelijkheid om bestaande SmartArt-vormen van een dia te openen, te manipuleren of te verwijderen. Verder is het ook mogelijk om de SmartArt vormen op te maken zoals het instellen van stijl, kleur & layout.</p>
...
{{< blocks/products/pf/slr-element name="Release-opmerkingen" href="https://releases.aspose.com/slides/cpp/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
