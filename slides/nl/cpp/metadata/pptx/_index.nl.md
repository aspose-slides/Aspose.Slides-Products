---
title: Bekijk of bewerk metadata van PPTX bestanden met behulp van C++
url: /nl/cpp/metadata/pptx/
keywords: Bewerk PPTX metadata, bekijk PPTX metadata, bewerk PPTX eigenschappen, bekijk PPTX eigenschappen
description: C++ broncode om metadata in PPTX-indeling te bewerken of te bekijken.
---
...
{{% blocks/products/pf/feature-page-section  h2="Wijzig PPTX eigenschappen via C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Wijzig PPTX ingebouwde eigenschappen - C++" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Aangepaste eigenschappen toevoegen aan PPTX - C++" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Metadata van PPTX extraheren via C++" >}}
