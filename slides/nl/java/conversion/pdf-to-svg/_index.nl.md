---
title: Converteer PDF naar SVG in Java
url: /nl/java/conversion/pdf-to-svg/
keywords: PDF naar SVG, Converteer PDF naar SVG, Java API, Java Library, PDF, SVG
description: Converteer PDF naar SVG in Java. Gebruik de Java-bibliotheek-API om PDF-bestanden naar SVG-bestanden te converteren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converteer PDF naar SVG in Java" h2="Snelle en platformonafhankelijke Java-bibliotheek die helpt bij het ontwikkelen van toepassingen met de mogelijkheid om Microsoft PowerPoint- en OpenOffice-presentatiebestanden te maken, samen te voegen, te inspecteren of te converteren zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Converteer PDF naar SVG in Java" %}}

[**Aspose.Slides voor Java**](https://products.aspose.com/slides/nl/java/) is een krachtige Java-bibliotheek voor het maken en manipuleren van presentatiebestanden. Bovendien biedt het flexibele manieren om PDF naar SVG te converteren. Met **Aspose.Slides voor Java** kan elke ontwikkelaar of toepassing PDF naar SVG bestanden converteren met slechts een paar regels Java-code.

Aspose.Slides voor Java is een moderne documentverwerkings-API en exporteert snel PDF-bestanden naar SVG-bestandsindelingen. Met de Aspose PowerPoint-bibliotheek kunt u PDF naar SVGs en vele andere bestandsindelingen converteren

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converteer PDF naar SVG met behulp van Java" %}}
Om de PDF naar SVG te converteren, moet u een presentatie maken van het PDF-bestand en deze opslaan als SVG.

{{% blocks/products/pf/agp/code-block title="Java-code voor het converteren van PDF naar SVG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Hoe PDF naar SVG te converteren met Aspose.Slides voor Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Dit zijn de stappen om PDF naar SVG in Java te converteren." >}}
