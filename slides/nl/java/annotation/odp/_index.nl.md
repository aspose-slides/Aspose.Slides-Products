---
title: ODP-annotatie verwijderen via Java
weight: 1790
url: /nl/java/annotation/odp/ 
description: Java-voorbeeldcode voor het verwijderen van annotaties in ODP-indeling op Java Runtime Environment voor JSP/JSF-applicaties en desktopapplicaties.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Verwijder opmerkingen en commentaarauteurs van ODP via Java" h2="Bouw uw eigen Java-apps om opmerkingen en auteurs in documentbestanden te manipuleren met behulp van server-side API's." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Hoe een ODP-bestand te annoteren met Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om opmerkingen van ODP te verwijderen via Java" %}}
...
1. Sla het op in ODP-formaat
1. Reactie op specifieke locatie verwijderen
1. Sla het ODP-bestand opnieuw op en vergelijk
...
{{% blocks/products/pf/agp/code-block title="Annotaties verwijderen uit ODP - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/nl/java/annotation/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
