---
title: Voeg PNG-afbeeldingen samen in Java
url: /nl/java/merger/png-to-png/
keywords: Voeg PNG, PNG naar PNG samen, word lid van PNG, combineer PNG, Java API, Java Library
description: Voeg PNG samen met PNG in Java. Gebruik de Java-bibliotheek-API om PNG-bestanden te combineren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Voeg PNG samen in Java" h2="Snelle en platformonafhankelijke Java-bibliotheek voor het samenvoegen van PNG-afbeeldingen met behulp van Java-code" >}}

{{% blocks/products/pf/feature-page-section h2="Voeg PNG samen met PNG met behulp van Aspose.Slides" %}}

[**Aspose.Slides voor Java**](https://products.aspose.com/slides/nl/java/) is een krachtige Java-bibliotheek die wordt gebruikt om presentaties, afbeeldingen en andere bestanden samen te voegen en te manipuleren. Wanneer u PNG samenvoegt met PNG, combineert u in feite twee afbeeldingen om één afbeelding te krijgen.
...
{{% blocks/products/pf/feature-page-section  h2="Voeg PNG samen met PNG in Java" %}}
Met [**Aspose.Slides for Java**](https://products.aspose.com/slides/nl/java/) kunt u snel PNG-bestanden samenvoegen met slechts een paar regels code

{{% blocks/products/pf/agp/code-block title="Java-code voor het samenvoegen van PNG naar PNG" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Hoe PNG in Java samen te voegen" >}}
