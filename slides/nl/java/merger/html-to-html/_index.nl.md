---
title: Voeg HTML-bestanden samen in Java
url: /nl/java/merger/html-to-html/
keywords: HTML samenvoegen, HTML naar HTML, lid worden van HTML, HTML combineren, Java API, Java Library
description: Voeg HTML samen met HTML in Java. Gebruik de Java-bibliotheek-API om HTML-bestanden te combineren
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Voeg HTML samen in Java" h2="Snelle en platformonafhankelijke Java-bibliotheek voor het samenvoegen van HTML-bestanden met behulp van Java-code" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Voeg HTML samen met HTML in Java" %}}
Met [**Aspose.Slides for Java**](https://products.aspose.com/slides/nl/java/) kunt u snel HTML-bestanden samenvoegen met slechts een paar regels code

{{% blocks/products/pf/agp/code-block title="Java-code voor het samenvoegen van HTML naar HTML" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Hoe HTML in Java samen te voegen" >}}
