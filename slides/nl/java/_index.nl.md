...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Geavanceerde API-functies voor het verwerken van Java PowerPoint-documenten</h2>

<p>Aspose.Slides voor Java bevat een aantal geavanceerde functies die ontwikkelaars volledige controle geven bij het programmeren met Microsoft PowerPoint-presentaties in een Java-omgeving.</p>-->
   <h2 class="pr-ft">
...
<h2 class="h2title">Opmaak van inhoud van dia's</h2>

<p>Het is mogelijk om tekst en vormen op dia's in een presentatie op te maken met Aspose.Slides for Java API. Tekst wordt beheerd via tekstkaders die aan vormen zijn gekoppeld. Daarom wordt tekst opgemaakt met behulp van alinea's en gedeelten die bij de tekstkaders horen. U kunt ook attributen van vormelementen manipuleren, zoals positie, grootte, lijn, afbeelding, tekst en vulling.</p>
...
{{< blocks/products/pf/slr-element name="Release-opmerkingen" href="https://docs.aspose.com/slides/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
