---
title: Bekijk of bewerk metadata van PPTX bestanden met behulp van Java
url: /nl/java/metadata/pptx/
keywords: Bewerk PPTX metadata, bekijk PPTX metadata, bewerk PPTX eigenschappen, bekijk PPTX eigenschappen
description: Java broncode om metadata in PPTX-indeling te bewerken of te bekijken.
---
...
{{% blocks/products/pf/feature-page-section  h2="Wijzig PPTX eigenschappen via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Wijzig PPTX ingebouwde eigenschappen - Java" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Aangepaste eigenschappen toevoegen aan PPTX - Java" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Metadata van PPTX extraheren via Java" >}}
