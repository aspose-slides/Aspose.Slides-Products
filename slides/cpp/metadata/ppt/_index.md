---
title: Edit or View PPT Document Metadata via C++ 
weight: 6080
url: /cpp/metadata/ppt/ 
description: Try our On-Premise document metadata editing or viewer APIs to edit or view PPT file metadata on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Extract PPT Metadata via C++" h2="Build your own C++ apps to add, edit, remove or extract metadata from PPT files using server-side APIs." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/slides/272x272/aspose_slides-for-cpp.png" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="How to Get PPT Metadata Using C++" %}}
