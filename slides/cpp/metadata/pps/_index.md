---
title: Edit or View PPS Document Metadata via C++ 
weight: 3180
url: /cpp/metadata/pps/ 
description: Try our On-Premise document metadata editing or viewer APIs to edit or view PPS file metadata on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Extract PPS Metadata via C++" h2="Build your own C++ apps to add, edit, remove or extract metadata from PPS files using server-side APIs." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/slides/272x272/aspose_slides-for-cpp.png" sourceAdditionalConversionTag="" additionalConversionTag="PPS" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="How to Get PPS Metadata Using C++" %}}

 In order to extract PPS metadata, weвЂ™ll use
