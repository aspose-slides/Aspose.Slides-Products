...
title: Convertir POTM a XPS en PHP
weight: 1260
url: /es/php-java/conversion/potm-to-xps/ 
keywords: "Convert, PowerPoint, POTM, XPS, Presentation, PHP"
description: Código de muestra para la conversión PHP de POTM a XPS. Utilice la API PHP de PowerPoint para la conversión por lotes de archivos POTM a archivos XPS.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir POTM a XPS en PHP" h2="Potente biblioteca PHP de PowerPoint para convertir POTM a XPS" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir POTM a XPS en PHP" %}}

¿Necesita convertir archivos POTM a XPS mediante programación? Usando [*Aspose.Slides for PHP via Java*](https://products.aspose.com/slides/es/php-java/) cualquier desarrollador puede convertir POTM a XPS con solo unas pocas líneas de código PHP .

Como una API moderna de procesamiento de presentaciones, Aspose.Slides para PHP crea XPS desde POTM rápidamente. Pruebe la calidad de la conversión de POTM a XPS directamente en su [navegador](https://products.aspose.app/slides/conversion). La biblioteca Aspose PowerPoint PPTX le permite convertir archivos POTM a muchos formatos populares.
...
{{< blocks/products/pf/agp/feature-section-col title="Cómo convertir POTM a XPS en PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estos son los pasos para convertir un archivo POTM a XPS usando PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra POTM a XPS Conversión de PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Guardar POTM como XPS en PHP" %}}
