---
title: Convertir JPG a PNG en PHP
url: /es/php-java/conversion/jpg-to-png/
keywords: JPG a PNG, Convertir JPG a PNG, API de PHP, Biblioteca PHP, JPG, PNG
description: Convierte JPG a PNG en PHP. Use la API PHP de PowerPoint para convertir archivos JPG a PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convertir JPG a PNG en PHP" h2="Potente biblioteca PHP de PowerPoint que ayuda a desarrollar aplicaciones con la capacidad de crear, fusionar, inspeccionar o convertir archivos de presentación de Microsoft PowerPoint y OpenOffice sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Convertir JPG a PNG en PHP" %}}
...
Como una API de procesamiento de documentos moderna, Aspose.Slides para PHP exporta archivos JPG a formatos de archivo PNG rápidamente. La biblioteca de PowerPoint de Aspose le permite convertir JPG a PNGs y muchos otros formatos de archivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convierta JPG a PNG usando PHP" %}}
Para convertir JPG a PNG, deberá crear la presentación desde el archivo JPG y guardarlo como PNG.

{{% blocks/products/pf/agp/code-block title="Código PHP para convertir JPG en PNG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cómo convertir JPG a PNG usando Aspose.Slides para PHP API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estos son los pasos para convertir JPG a PNG en PHP." >}}
