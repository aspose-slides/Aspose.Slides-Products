---
title: Convertir PNG a SVG en PHP
url: /es/php-java/conversion/png-to-svg/
keywords: PNG a SVG, Convertir PNG a SVG, API de PHP, Biblioteca PHP, PNG, SVG
description: Convierte PNG a SVG en PHP. Use la API PHP de PowerPoint para convertir archivos PNG a SVG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convertir PNG a SVG en PHP" h2="Potente biblioteca PHP de PowerPoint que ayuda a desarrollar aplicaciones con la capacidad de crear, fusionar, inspeccionar o convertir archivos de presentación de Microsoft PowerPoint y OpenOffice sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Convertir PNG a SVG en PHP" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/es/php-java/) es una potente biblioteca de PHP para crear y manipular archivos de presentación. Además, proporciona formas flexibles de convertir PNG a SVG. Con **Aspose.Slides para PHP a través de Java**, cualquier desarrollador o aplicación puede convertir archivos PNG a SVG con solo unas pocas líneas de código PHP.

Como una API de procesamiento de documentos moderna, Aspose.Slides para PHP exporta archivos PNG a formatos de archivo SVG rápidamente. La biblioteca de PowerPoint de Aspose le permite convertir PNG a SVGs y muchos otros formatos de archivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convierta PNG a SVG usando PHP" %}}
Para convertir PNG a SVG, deberá crear la presentación desde el archivo PNG y guardarlo como SVG.

{{% blocks/products/pf/agp/code-block title="Código PHP para convertir PNG en SVG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cómo convertir PNG a SVG usando Aspose.Slides para PHP API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estos son los pasos para convertir PNG a SVG en PHP." >}}
