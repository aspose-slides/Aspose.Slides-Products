...
title: Convertir POT a JPG en PHP
weight: 890
url: /es/php-java/conversion/pot-to-jpg/ 
keywords: "Convert, PowerPoint, POT, JPG, Presentation, PHP"
description: Código de muestra para la conversión PHP de POT a JPG. Utilice la API PHP de PowerPoint para la conversión por lotes de archivos POT a archivos JPG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir POT a JPG en PHP" h2="Potente biblioteca PHP de PowerPoint para convertir POT a JPG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir POT a JPG en PHP" %}}

¿Necesita convertir archivos POT a JPG mediante programación? Usando [*Aspose.Slides for PHP via Java*](https://products.aspose.com/slides/es/php-java/) cualquier desarrollador puede convertir POT a JPG con solo unas pocas líneas de código PHP .
...
{{< blocks/products/pf/agp/feature-section-col title="Cómo convertir POT a JPG en PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estos son los pasos para convertir un archivo POT a JPG usando PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra POT a JPG Conversión de PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Guardar POT como JPG en PHP" %}}
Utilice la aplicación gratuita para ver una demostración del proceso de conversión de POT a JPG. 
{{% /blocks/products/pf/agp/content %}}
