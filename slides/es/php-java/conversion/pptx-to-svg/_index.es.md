---
title: Convertir PPTX a SVG en PHP
weight: 2700
url: /es/php-java/conversion/pptx-to-svg/ 
keywords: "Convert, PowerPoint, PPTX, SVG, Presentation, PHP"
description: Código de muestra para la conversión PHP de PPTX a SVG. Utilice la API PHP de PowerPoint para la conversión por lotes de archivos PPTX a archivos SVG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PPTX a SVG en PHP" h2="Potente biblioteca PHP de PowerPoint para convertir PPTX a SVG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir PPTX a SVG en PHP" %}}

¿Necesita convertir archivos PPTX a SVG mediante programación? Usando [*Aspose.Slides for PHP via Java*](https://products.aspose.com/slides/es/php-java/) cualquier desarrollador puede convertir PPTX a SVG con solo unas pocas líneas de código PHP .

Como una API moderna de procesamiento de presentaciones, Aspose.Slides para PHP crea SVG desde PPTX rápidamente. Pruebe la calidad de la conversión de PPTX a SVG directamente en su [navegador](https://products.aspose.app/slides/conversion). La biblioteca Aspose PowerPoint PPTX le permite convertir archivos PPTX a muchos formatos populares.
...
{{< blocks/products/pf/agp/feature-section-col title="Cómo convertir PPTX a SVG en PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estos son los pasos para convertir un archivo PPTX a SVG usando PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra PPTX a SVG Conversión de PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Guardar PPTX como SVG en PHP" %}}
