...
title: Convertir PPTX a PNG en PHP
weight: 2610
url: /es/php-java/conversion/pptx-to-png/ 
keywords: "Convert, PowerPoint, PPTX, PNG, Presentation, PHP"
description: Código de muestra para la conversión PHP de PPTX a PNG. Utilice la API PHP de PowerPoint para la conversión por lotes de archivos PPTX a archivos PNG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PPTX a PNG en PHP" h2="Potente biblioteca PHP de PowerPoint para convertir PPTX a PNG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir PPTX a PNG en PHP" %}}

¿Necesita convertir archivos PPTX a PNG mediante programación? Usando [*Aspose.Slides for PHP via Java*](https://products.aspose.com/slides/es/php-java/) cualquier desarrollador puede convertir PPTX a PNG con solo unas pocas líneas de código PHP .

Como una API moderna de procesamiento de presentaciones, Aspose.Slides para PHP crea PNG desde PPTX rápidamente. Pruebe la calidad de la conversión de PPTX a PNG directamente en su [navegador](https://products.aspose.app/slides/conversion/ppt-to-png). La biblioteca Aspose PowerPoint PPTX le permite convertir archivos PPTX a muchos formatos populares.
...
{{< blocks/products/pf/agp/feature-section-col title="Cómo convertir PPTX a PNG en PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estos son los pasos para convertir un archivo PPTX a PNG usando PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra PPTX a PNG Conversión de PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Guardar PPTX como PNG en PHP" %}}
