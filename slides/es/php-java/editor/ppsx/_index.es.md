---
title: Editar PPSX en PHP
url: /es/php-java/editor/ppsx/
keywords: Editar PPSX, Editar PowerPoint, PPSX, PowerPoint, API de PHP, Biblioteca de PHP
description: Edite PPSX en PHP. Use la API de la biblioteca PHP para editar archivos PPSX
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Editar PPSX en PHP" h2="Biblioteca PHP de alta velocidad y multiplataforma para editar PPSX usando código PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edite PPSX usando Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/es/php-java/) es una poderosa biblioteca de PHP que se utiliza para manipular y editar presentaciones. Puedes editar una presentación PPSX agregándole una nueva línea de texto. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Editar PPSX en PHP" %}}
Usando [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/es/php-java/), puede agregar una nueva línea de texto al documento PPSX con solo un pocas líneas de código.

{{% blocks/products/pf/agp/code-block title="Código PHP para editar PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cómo editar PPSX en PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Cargue la presentación PPSX que desea editar.
{{< /blocks/products/pf/agp/step-autogen >}}
