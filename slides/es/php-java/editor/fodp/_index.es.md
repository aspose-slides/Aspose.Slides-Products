---
title: Editar FODP en PHP
url: /es/php-java/editor/fodp/
keywords: Editar FODP, Editar PowerPoint, FODP, PowerPoint, API de PHP, Biblioteca de PHP
description: Edite FODP en PHP. Use la API de la biblioteca PHP para editar archivos FODP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Editar FODP en PHP" h2="Biblioteca PHP de alta velocidad y multiplataforma para editar FODP usando código PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edite FODP usando Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/es/php-java/) es una poderosa biblioteca de PHP que se utiliza para manipular y editar presentaciones. Puedes editar una presentación FODP agregándole una nueva línea de texto. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Editar FODP en PHP" %}}
Usando [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/es/php-java/), puede agregar una nueva línea de texto al documento FODP con solo un pocas líneas de código.

{{% blocks/products/pf/agp/code-block title="Código PHP para editar FODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cómo editar FODP en PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Cargue la presentación FODP que desea editar.
{{< /blocks/products/pf/agp/step-autogen >}}
