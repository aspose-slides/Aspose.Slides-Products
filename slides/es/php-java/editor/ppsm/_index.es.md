---
title: Editar PPSM en PHP
url: /es/php-java/editor/ppsm/
keywords: Editar PPSM, Editar PowerPoint, PPSM, PowerPoint, API de PHP, Biblioteca de PHP
description: Edite PPSM en PHP. Use la API de la biblioteca PHP para editar archivos PPSM
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Editar PPSM en PHP" h2="Biblioteca PHP de alta velocidad y multiplataforma para editar PPSM usando código PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edite PPSM usando Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/es/php-java/) es una poderosa biblioteca de PHP que se utiliza para manipular y editar presentaciones. Puedes editar una presentación PPSM agregándole una nueva línea de texto. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Editar PPSM en PHP" %}}
Usando [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/es/php-java/), puede agregar una nueva línea de texto al documento PPSM con solo un pocas líneas de código.

{{% blocks/products/pf/agp/code-block title="Código PHP para editar PPSM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cómo editar PPSM en PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Cargue la presentación PPSM que desea editar.
{{< /blocks/products/pf/agp/step-autogen >}}
