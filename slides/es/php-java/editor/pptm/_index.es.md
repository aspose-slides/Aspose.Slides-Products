---
title: Editar PPTM en PHP
url: /es/php-java/editor/pptm/
keywords: Editar PPTM, Editar PowerPoint, PPTM, PowerPoint, API de PHP, Biblioteca de PHP
description: Edite PPTM en PHP. Use la API de la biblioteca PHP para editar archivos PPTM
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Editar PPTM en PHP" h2="Biblioteca PHP de alta velocidad y multiplataforma para editar PPTM usando código PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edite PPTM usando Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/es/php-java/) es una poderosa biblioteca de PHP que se utiliza para manipular y editar presentaciones. Puedes editar una presentación PPTM agregándole una nueva línea de texto. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Editar PPTM en PHP" %}}
Usando [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/es/php-java/), puede agregar una nueva línea de texto al documento PPTM con solo un pocas líneas de código.

{{% blocks/products/pf/agp/code-block title="Código PHP para editar PPTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cómo editar PPTM en PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Cargue la presentación PPTM que desea editar.
{{< /blocks/products/pf/agp/step-autogen >}}
