---
title: Editar PPT en PHP
url: /es/php-java/editor/ppt/
keywords: Editar PPT, Editar PowerPoint, PPT, PowerPoint, API de PHP, Biblioteca de PHP
description: Edite PPT en PHP. Use la API de la biblioteca PHP para editar archivos PPT
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Editar PPT en PHP" h2="Biblioteca PHP de alta velocidad y multiplataforma para editar PPT usando código PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edite PPT usando Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/es/php-java/) es una poderosa biblioteca de PHP que se utiliza para manipular y editar presentaciones. Puedes editar una presentación PPT agregándole una nueva línea de texto. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Editar PPT en PHP" %}}
Usando [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/es/php-java/), puede agregar una nueva línea de texto al documento PPT con solo un pocas líneas de código.

{{% blocks/products/pf/agp/code-block title="Código PHP para editar PPT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cómo editar PPT en PHP" >}}
