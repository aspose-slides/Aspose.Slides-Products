---
title: Combinar archivos PPS usando PHP
url: /es/php-java/merger/pps/
keywords: Fusionar PPS, Unirse PPS, Combinar PPS, PowerPoint, Presentación, PHP, Aspose
description: Combinar múltiples archivos PPS en PHP.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Combinar archivos PPS juntos en PHP" h2="API de PHP multiplataforma y de alta velocidad que ayuda a desarrollar aplicaciones con la capacidad de crear, fusionar, inspeccionar o convertir archivos de presentación de Microsoft PowerPoint y OpenOffice sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Combinar PPS en PHP" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Combinar archivos PPS usando PHP" %}}
Para fusionar las presentaciones de PowerPoint, deberá clonar las diapositivas de una presentación a la otra.

{{% blocks/products/pf/agp/code-block title="Código PHP para fusionar múltiples PPS en un solo archivo" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cómo fusionar PPS usando Aspose.Slides para la API de PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estos son los pasos para fusionar dos archivos PPS y guardar el resultado como PPS en PHP." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Cargue los archivos PPS que desea fusionar.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Guarde el documento PPS resultante.
{{< /blocks/products/pf/agp/step-autogen >}}
