---
title: Combinar imágenes PNG en PHP
url: /es/php-java/merger/png-to-png/
keywords: Fusionar PNG, PNG a PNG, Unir PNG, Combinar PNG, PHP API, Biblioteca PHP
description: Combinar PNG a PNG en PHP. Use la API de la biblioteca PHP para combinar archivos PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Combinar PNG en PHP" h2="Biblioteca PHP de alta velocidad y multiplataforma para fusionar imágenes PNG usando código PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Combinar PNG a PNG usando Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/es/php-java/) es una potente biblioteca de PHP que se utiliza para fusionar y manipular presentaciones, imágenes y otros archivos. Cuando combina PNG con PNG, está combinando efectivamente dos imágenes para obtener una imagen.
...
{{% blocks/products/pf/feature-page-section  h2="Combinar PNG a PNG en PHP" %}}
Con [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/es/php-java/), puede fusionar archivos PNG rápidamente con solo unas pocas líneas de código

{{% blocks/products/pf/agp/code-block title="Código PHP para fusionar PNG a PNG" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Cómo fusionar PNG en PHP" >}}
