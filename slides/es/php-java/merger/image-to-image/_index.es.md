---
title: Combinar imágenes en PHP
url: /es/php-java/merger/image-to-image/
keywords: Fusionar imagen, imagen a imagen, unir imágenes, combinar imágenes, API PHP, biblioteca PHP
description: Combinar imagen a imagen en PHP. Use la API de la biblioteca PHP para combinar imágenes
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Fusionar imagen en PHP" h2="Biblioteca PHP de alta velocidad y multiplataforma para fusionar imágenes usando código PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Combinar imagen a imagen usando Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/es/php-java/) es una potente biblioteca de PHP que se utiliza para fusionar y manipular presentaciones, imágenes y otros archivos. Cuando fusiona una imagen con otra, está combinando efectivamente dos imágenes para obtener una imagen.
...
{{% blocks/products/pf/feature-page-section  h2="Fusionar imagen a imagen en PHP" %}}
...
{{% blocks/products/pf/agp/code-block title="Código PHP para fusionar imagen a imagen" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Cómo fusionar imágenes en PHP" >}}
