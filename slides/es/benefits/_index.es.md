...
![Salida del otro producto sin los efectos](effect.shadow.other.png)
...
### Salida del otro producto (Efectos de forma):
...
![Salida del otro producto sin los efectos de WordArt](wordart.other.png)
