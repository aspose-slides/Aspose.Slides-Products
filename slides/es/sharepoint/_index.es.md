...
title: PowerPoint de SharePoint | API de SharePoint de Aspose.Slides
weight: 910
url: /es/sharepoint/ 
description: SharePoint PowerPoint es un Aspose.Slides SharePoint para crear y convertir SharePoint PPT, presentación de diapositivas de SharePoint, presentación de SharePoint.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Solución de PowerPoint de SharePoint" h2="Administre y convierta presentaciones de PowerPoint en SharePoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-sharepoint.svg" pfName="Aspose.Slides" subTitlepfName="for SharePoint" downloadUrl="https://downloads.aspose.com/slides/sharepoint" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="for SharePoint" >}}

{{< blocks/products/pf/i18n/sub-menu logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-sharepoint.svg" liveDemosLink="" PricingLink="https://purchase.aspose.com/pricing/slides/sharepoint" buyLink="https://purchase.aspose.com/pricing/slides/sharepoint/" docsLink="https://releases.aspose.com/slides/sharepoint/release-notes/" installationsDocsLink="" nugetLink="" nugetPackageName="Microsoft PowerPoint:" mavenRepoLink="" directDownloadLink="https://downloads.aspose.com/slides/sharepoint" >}}

{{< blocks/products/pf/i18n/tab-content >}}
<p>
 Aspose.Slides for SharePoint para administrar y convertir archivos de PowerPoint en SharePoint. Aspose.Slides, como una solución de PowerPoint de SharePoint, puede importar fácilmente formatos de presentación comunes de Microsoft, incluidos PPT, POT, PPS, PPTX, POTX y PPSX, y puede exportar estos formatos a archivos PDF, TIFF y XPS. Utilice toda la funcionalidad de SharePoint PPT sin necesidad de Microsoft PowerPoint Automation.
</p>

<p>
 Aspose.Slides para SharePoint funciona con Windows SharePoint Services WSS 3.0 y Microsoft Office SharePoint Server 2007, 2010 y 2013.
</p>
...
{{< blocks/products/pf/carousel-item h3="de un vistazo" description="Una descripción general de Aspose.Slides para SharePoint" >}}
...
{{< blocks/products/pf/carousel-item h3="Independencia de la plataforma" description="Aspose.Slides para SharePoint funciona con Microsoft Office SharePoint Server y Windows SharePoint Services." >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
...
{{< blocks/products/pf/carousel-item h3="Formatos de archivo admitidos" description="Aspose.Slides para SharePoint es compatible con los [formatos de archivo] de presentación más comunes (https://docs.aspose.com/slides/sharepoint/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Características de la aplicación de conversión de presentaciones de SharePoint
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Convierta archivos de PowerPoint de la biblioteca de documentos de SharePoint
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Obtener fondo de tabla predeterminado
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     El tamaño representa la propiedad del gráfico de burbujas
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Ocultar el panel de miniaturas de la diapositiva izquierda en el PPT generado
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Compatibilidad con libros de Excel externos
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Restricción del acceso al sistema de archivos local al abrir un documento
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Convierta presentaciones de PowerPoint a varios formatos
    </h2>
    <p>
     Aspose.Slides for SharePoint convierte presentaciones de su biblioteca de documentos de SharePoint a muchos formatos populares de intercambio de documentos. Aspose.Slides para SharePoint admite formatos de presentación comunes como formatos de entrada y puede exportar a formatos de presentación, así como a PDF, TIFF y XPS.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Instalación fácil y liviana
    </h2>
    <p>
     Aspose.Slides para SharePoint está disponible como archivo ZIP. Descomprima el archivo ZIP en la unidad local del servidor MOSS 7.0 o WSS 3.0 y ejecute setup.exe para instalarlo y usarlo. ¡Es fácil!
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Documentación" href="https://docs.aspose.com/slides/sharepoint/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.Slides para SharePoint?" tabId="success-stories" >}}
