---
title: Convertir PPT a SVG en JavaScript
url: /es/nodejs-net/conversion/ppt-to-svg/
keywords: PPT a SVG, Convertir PPT a SVG, API de Node.js, Biblioteca JavaScript, PPT, SVG
description: Convierta PPT a SVG en JavaScript. Utilice la API de la biblioteca Node.js para convertir archivos PPT a SVG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convertir PPT a SVG en JavaScript" h2="Aspose.Slides para Node.js vía .NET es una biblioteca potente y fácil de usar que le permite convertir presentaciones de PowerPoint a varios formatos en JavaScript. Admite todos los elementos y formatos de presentación y proporciona una API enriquecida para acceder a ellos y modificarlos. También le permite exportar sus diapositivas a varios formatos para procesarlas o compartirlas posteriormente." >}}

{{% blocks/products/pf/feature-page-section h2="Convierta PPT a SVG en Node.js" %}}

[**Aspose.Slides para Node.js vía .NET**](https://products.aspose.com/slides/es/nodejs-net/) es una poderosa biblioteca de Node.js para crear y manipular archivos de presentación. Además, proporciona formas flexibles de convertir PPT a SVG. Al utilizar **Aspose.Slides para Node.js a través de .NET**, cualquier desarrollador o aplicación puede convertir archivos PPT a SVG con solo unas pocas líneas de código.

Como API moderna de procesamiento de documentos, Aspose.Slides para Node.js a través de .NET exporta archivos PPT a formatos de archivo SVG rápidamente. La biblioteca Aspose PowerPoint le permite convertir PPT a SVGs y muchos otros formatos de archivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convierta PPT a SVG usando JavaScript" %}}
Para convertir PPT a SVG, deberá crear una presentación a partir del archivo PPT y guardarla como SVG.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para convertir PPT en SVG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cómo convertir PPT a SVG usando Aspose.Slides para Node.js a través de .NET API" >}}
