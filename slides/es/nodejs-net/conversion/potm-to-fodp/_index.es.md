---
title: Convertir POTM a FODP en JavaScript
url: /es/nodejs-net/conversion/potm-to-fodp/
keywords: POTM a FODP, Convertir POTM a FODP, API de Node.js, Biblioteca JavaScript, POTM, FODP
description: Convierta POTM a FODP en JavaScript. Utilice la API de la biblioteca Node.js para convertir archivos POTM a FODP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convertir POTM a FODP en JavaScript" h2="Aspose.Slides para Node.js vía .NET es una biblioteca potente y fácil de usar que le permite convertir presentaciones de PowerPoint a varios formatos en JavaScript. Admite todos los elementos y formatos de presentación y proporciona una API enriquecida para acceder a ellos y modificarlos. También le permite exportar sus diapositivas a varios formatos para procesarlas o compartirlas posteriormente." >}}

{{% blocks/products/pf/feature-page-section h2="Convierta POTM a FODP en Node.js" %}}

[**Aspose.Slides para Node.js vía .NET**](https://products.aspose.com/slides/es/nodejs-net/) es una poderosa biblioteca de Node.js para crear y manipular archivos de presentación. Además, proporciona formas flexibles de convertir POTM a FODP. Al utilizar **Aspose.Slides para Node.js a través de .NET**, cualquier desarrollador o aplicación puede convertir archivos POTM a FODP con solo unas pocas líneas de código.

Como API moderna de procesamiento de documentos, Aspose.Slides para Node.js a través de .NET exporta archivos POTM a formatos de archivo FODP rápidamente. La biblioteca Aspose PowerPoint le permite convertir POTM a FODPs y muchos otros formatos de archivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convierta POTM a FODP usando JavaScript" %}}
Para convertir POTM a FODP, deberá crear una presentación a partir del archivo POTM y guardarla como FODP.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para convertir POTM en FODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cómo convertir POTM a FODP usando Aspose.Slides para Node.js a través de .NET API" >}}
