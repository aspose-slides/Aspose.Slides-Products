---
title: Convertir POTM a POTX en JavaScript
url: /es/nodejs-net/conversion/potm-to-potx/
keywords: POTM a POTX, Convertir POTM a POTX, API de Node.js, Biblioteca JavaScript, POTM, POTX
description: Convierta POTM a POTX en JavaScript. Utilice la API de la biblioteca Node.js para convertir archivos POTM a POTX
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convertir POTM a POTX en JavaScript" h2="Aspose.Slides para Node.js vía .NET es una biblioteca potente y fácil de usar que le permite convertir presentaciones de PowerPoint a varios formatos en JavaScript. Admite todos los elementos y formatos de presentación y proporciona una API enriquecida para acceder a ellos y modificarlos. También le permite exportar sus diapositivas a varios formatos para procesarlas o compartirlas posteriormente." >}}

{{% blocks/products/pf/feature-page-section h2="Convierta POTM a POTX en Node.js" %}}

[**Aspose.Slides para Node.js vía .NET**](https://products.aspose.com/slides/es/nodejs-net/) es una poderosa biblioteca de Node.js para crear y manipular archivos de presentación. Además, proporciona formas flexibles de convertir POTM a POTX. Al utilizar **Aspose.Slides para Node.js a través de .NET**, cualquier desarrollador o aplicación puede convertir archivos POTM a POTX con solo unas pocas líneas de código.

Como API moderna de procesamiento de documentos, Aspose.Slides para Node.js a través de .NET exporta archivos POTM a formatos de archivo POTX rápidamente. La biblioteca Aspose PowerPoint le permite convertir POTM a POTXs y muchos otros formatos de archivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convierta POTM a POTX usando JavaScript" %}}
Para convertir POTM a POTX, deberá crear una presentación a partir del archivo POTM y guardarla como POTX.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para convertir POTM en POTX" offSpacer="true" %}}
