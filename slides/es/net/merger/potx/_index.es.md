...
title: Combinar archivos POTX a través de .NET
weight: 2510
url: /es/net/merger/potx/ 
description: Código fuente C# para combinar documentos POTX en plataformas .NET Framework, .NET Core, Windows Azure, Mono o Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Combinar formatos POTX en C#" h2="Fusión de documentos POTX nativa y de alto rendimiento utilizando Aspose.Slides del lado del servidor para las API de .NET, sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="POTX" >}}
...
Cargue todos los archivos POTX con la ruta completa.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Llame al método Save() y pase el nombre del archivo (ruta completa) y el formato (POTX) como parámetro.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Ahora puede abrir y usar el archivo POTX en Microsoft Office, Adobe PDF o cualquier otro programa compatible.
{{< /blocks/products/pf/agp/step-autogen >}}
