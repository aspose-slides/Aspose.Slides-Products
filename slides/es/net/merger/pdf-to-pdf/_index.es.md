...
url: /es/net/merger/pdf-to-pdf/
keywords: Combinar PDF, PDF a PDF, Unir PDF, Combinar PDF, API C#, Biblioteca .NET
description: Combinar PDF a PDF en C#. Use la API de la biblioteca .NET para combinar archivos PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Fusionar PDF en C#" h2="Potente API .NET multiplataforma para fusionar archivos PDF usando código C# en plataformas NET Framework, .NET Core, Windows Azure, Mono o Xamarin" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Combinar PDF a PDF en C#" %}}
Usando [**Aspose.Slides for .NET**](https://products.aspose.com/slides/es/net/), puede fusionar archivos PDF rápidamente con solo unas pocas líneas de código

{{% blocks/products/pf/agp/code-block title="Código C# para fusionar PDF a PDF" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Cómo fusionar PDF en C#" >}}
