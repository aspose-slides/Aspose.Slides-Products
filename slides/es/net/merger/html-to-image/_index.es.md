...
url: /es/net/merger/html-to-image/
keywords: Combinar HTML con imagen, HTML con imagen, unir HTML, combinar HTML, imagen, API de C#, biblioteca .NET
description: Combinar HTML a imagen en C#. Use la API de la biblioteca .NET para combinar HTML con la imagen
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Fusionar imagen en C#" h2="Potente API .NET multiplataforma para fusionar HTML con imágenes usando código C# en plataformas NET Framework, .NET Core, Windows Azure, Mono o Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Combinar HTML a imagen usando Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/es/net/) es una potente biblioteca .NET que se utiliza para fusionar y manipular presentaciones, documentos HTML y otros archivos. Cuando fusiona HTML con una imagen, está combinando efectivamente los contenidos en documentos HTML para obtener una sola imagen. 
...
{{% blocks/products/pf/agp/code-block title="Código C# para fusionar HTML con la imagen" offSpacer="true" %}}
```cs
