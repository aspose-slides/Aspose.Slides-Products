---
title: Combinar imágenes JPG en C#
url: /es/net/merger/jpg-to-jpg/
keywords: Fusionar JPG, JPEG a JPG, unir JPG, combinar JPG, API de C#, biblioteca .NET
description: Combinar JPG a JPG en C#. Use la API de la biblioteca .NET para combinar archivos JPG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Combinar JPG en C#" h2="Potente API .NET multiplataforma para fusionar imágenes JPG usando código C# en plataformas NET Framework, .NET Core, Windows Azure, Mono o Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Combinar JPG a JPG usando Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/es/net/) es una potente biblioteca .NET que se utiliza para fusionar y manipular presentaciones, imágenes y otros archivos. Cuando combina JPG con JPG, está combinando efectivamente dos imágenes para obtener una imagen.
...
{{% blocks/products/pf/feature-page-section  h2="Combinar JPG a JPG en C#" %}}
Usando [**Aspose.Slides for .NET**](https://products.aspose.com/slides/es/net/), puede fusionar archivos JPG rápidamente con solo unas pocas líneas de código

{{% blocks/products/pf/agp/code-block title="Código C# para fusionar JPG a JPG" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Cómo fusionar JPG en C#" >}}
