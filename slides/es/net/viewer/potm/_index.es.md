...
title: Ver formatos de archivo POTM a través de .NET
weight: 3310
url: /es/net/viewer/potm/ 
description: Código fuente de C# para cargar, representar y mostrar documentos POTM en plataformas .NET Framework, .NET Core, Windows Azure, Mono o Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Visor de archivos POTM para .NET" h2="Ver archivos de presentación como POTM sin Microsoft PowerPoint u Office Automation" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo ver el archivo POTM usando C#" %}}

 Para ver el archivo POTM, usaremos
...
{{< blocks/products/pf/agp/feature-section-col title="Pasos para ver POTM a través de C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Aspose.Slides facilita a los desarrolladores la visualización del archivo POTM con solo unas pocas líneas de código." >}}

{{< blocks/products/pf/agp/step-autogen >}}
Cree una instancia de un objeto de presentación y cargue el archivo POTM
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Guarde la presentación POTM en formato HTML
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Proceso de llamada. Comience con la ruta al HTML resultante para cargar contenido POTM en el navegador predeterminado
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Código de ejemplo de C# para ver el archivo POTM" offSpacer="" %}}
