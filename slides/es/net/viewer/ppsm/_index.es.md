---
title: Ver formatos de archivo PPSM a través de .NET
weight: 4780
url: /es/net/viewer/ppsm/ 
description: Código fuente C# para cargar, renderizar y mostrar documentos PPSM en plataformas .NET Framework, .NET Core, Windows Azure, Mono o Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Visor de archivos PPSM para .NET" h2="Ver archivos de presentación como PPSM sin Microsoft PowerPoint o Office Automation" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSM" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo ver el archivo PPSM usando C#" %}}

 Para ver el archivo PPSM, usaremos
...
{{< blocks/products/pf/agp/feature-section-col title="Pasos para ver PPSM a través de C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Aspose.Slides facilita a los desarrolladores la visualización del archivo PPSM con solo unas pocas líneas de código." >}}

{{< blocks/products/pf/agp/step-autogen >}}
Cree una instancia de un objeto de presentación y cargue el archivo PPSM
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Guarde la presentación de PPSM en formato HTML
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Proceso de llamada. Comience con la ruta al HTML resultante para cargar contenido PPSM en el navegador predeterminado
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Código de ejemplo de C# para ver el archivo PPSM" offSpacer="" %}}
