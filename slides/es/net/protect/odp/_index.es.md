---
title: Proteja y bloquee el documento ODP a través de .NET
weight: 4230
url: /es/net/protect/odp/ 
description: Código fuente de C# para bloquear el archivo ODP con contraseña en las plataformas .NET Framework, .NET Core, Windows Azure, Mono o Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Cifrar archivos ODP a través de C#" h2="Proteja con contraseña las presentaciones de PowerPoint, incluido el formato ODP, utilizando la biblioteca .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo proteger el archivo ODP usando C#" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Proteja ODP a través de C#" >}}
