...
keywords: PNG a SVG, Convertir PNG a SVG, C# API, Biblioteca .NET
description: Convierte PNG a SVG en C#. Utilice la API de la biblioteca .NET para convertir archivos PNG a SVG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PNG a SVG en C#" h2="API de PowerPoint .NET para convertir archivos de imagen PNG a SVG en plataformas NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir PNG a SVG en C#" %}}

¿Cómo convierto PNG a SVG en código?

Con [**Aspose.Slides for .NET**](https://products.aspose.com/slides/es/net/), cualquier desarrollador o aplicación puede convertir PNG a SVG con solo unas pocas líneas de código C#.

Como API moderna de procesamiento de documentos, Aspose.Slides para .NET exporta archivos PNG a SVG rápidamente. La biblioteca de PowerPoint de Aspose le permite convertir PNG a SVG e imágenes en otros formatos.
...
{{< blocks/products/pf/agp/feature-section-col title="Cómo convertir PNG a SVG en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Los desarrolladores y las aplicaciones pueden convertir PNG a SVG de esta manera:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Guarde el archivo como una imagen SVG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Antes de ejecutar el código C# de conversión de PNG a SVG, su máquina debe tener estos requisitos previos:
...
{{% blocks/products/pf/agp/code-block title="Código C# para convertir PNG a SVG" offSpacer="" %}}
