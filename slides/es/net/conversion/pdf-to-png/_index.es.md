...
weight: 90
url: /es/net/conversion/pdf-to-png/ 
keywords: PDF a PNG, Convertir PDF a PNG, C# API, Biblioteca .NET, PDF, PNG
description: Convierte PDF a PNG en C#. Use la API de la biblioteca .NET para convertir páginas PDF a imágenes PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PDF a PNG en C#" h2="API de PowerPoint .NET para convertir documentos PDF a imágenes PNG en plataformas NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir PDF a PNG en C#" %}}

¿Cómo convierto PDF a PNG en código?

Con [**Aspose.Slides for .NET**](https://products.aspose.com/slides/es/net/), cualquier desarrollador o aplicación puede convertir PDF a formato PNG con solo unas pocas líneas de código C#.

Como una API de procesamiento de documentos moderna, Aspose.Slides para .NET exporta páginas PDF a PNG rápidamente. La biblioteca de PowerPoint de Aspose le permite convertir PDF a PNG y muchos otros formatos de archivo
...
{{< blocks/products/pf/agp/feature-section-col title="Cómo convertir PDF a PNG en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Los desarrolladores y las aplicaciones pueden convertir PDF a PNG de esta manera:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Llama al método save para guardar las diapositivas como imágenes PNG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Antes de ejecutar el código C# de conversión de PDF a PNG, su máquina debe tener estos requisitos previos:
...
{{% blocks/products/pf/agp/code-block title="Código C# para convertir PDF a PNG" offSpacer="" %}}
