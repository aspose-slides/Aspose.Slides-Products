...
keywords: PNG a PDF, Convertir PNG a PDF, C# API, Biblioteca .NET, PNG, PDF
description: Convierte PNG a PDF en C#. Utilice la API de la biblioteca .NET para convertir imágenes PNG en documentos PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PNG a PDF en C#" h2="API de PowerPoint .NET para convertir imágenes PNG a documentos PDF en plataformas NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="PNG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir PNG a PDF en C#" %}}

¿Cómo convierto PNG a PDF mediante programación?

Con [**Aspose.Slides for .NET**](https://products.aspose.com/slides/es/net/), cualquier desarrollador o aplicación puede convertir PNG a formato PDF con solo unas pocas líneas de código C#.

Como una API moderna de procesamiento de documentos, Aspose.Slides para .NET crea rápidamente archivos PDF a partir de imágenes PNG. La biblioteca Aspose PowerPoint le permite convertir PNG a PDF y muchos otros formatos de archivo
...
{{< blocks/products/pf/agp/feature-section-col title="Pasos para convertir PNG a PDF en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Los desarrolladores y las aplicaciones pueden convertir PNG a PDF de esta manera:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Antes de ejecutar el código C# de conversión de PNG a PDF, su máquina debe tener estos requisitos previos:
...
{{% blocks/products/pf/agp/code-block title="Código C# para convertir PNG a PDF" offSpacer="" %}}
