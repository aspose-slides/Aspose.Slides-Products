...
keywords: JPG a PNG, Convertir JPG a PNG, C# API, Biblioteca .NET
description: Convierte JPG a PNG en C#. Utilice la API de la biblioteca .NET para convertir archivos JPG a PNG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir JPG a PNG en C#" h2="API de PowerPoint .NET para convertir archivos de imagen JPG a PNG en plataformas NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir JPG a PNG en C#" %}}

¿Cómo convierto JPG a PNG en código?

Usando [**Aspose.Slides para .NET**](https://products.aspose.com/slides/es/net/), cualquier desarrollador o aplicación puede convertir JPG a PNG con solo unas pocas líneas de código C#.

Como una API moderna de procesamiento de documentos, Aspose.Slides para .NET exporta archivos JPG a PNG rápidamente. La biblioteca de PowerPoint de Aspose le permite convertir JPG a PNG e imágenes en otros formatos.
...
{{< blocks/products/pf/agp/feature-section-col title="Cómo convertir JPG a PNG en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Los desarrolladores y las aplicaciones pueden convertir JPG a PNG de esta manera:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Antes de ejecutar el código C# de conversión de JPG a PNG, su máquina debe tener estos requisitos previos:
...
{{% blocks/products/pf/agp/code-block title="Código C# para convertir JPG a PNG" offSpacer="" %}}
