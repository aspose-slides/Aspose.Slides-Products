---
title: Convertir JPG a PDF en C#
weight: 10
url: /es/net/conversion/jpg-to-pdf/ 
keywords: JPG a PDF, Convertir JPG a PDF, C# API, Biblioteca .NET
description: Convierte JPG a PDF en C#. Utilice la API de la biblioteca .NET para convertir imágenes JPG JPEG en documentos PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir JPG a PDF en C#" h2="API de PowerPoint .NET para convertir imágenes JPG a documentos PDF en plataformas NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir JPG a PDF en C#" %}}

¿Cómo convierto JPG a PDF mediante programación?

Con [**Aspose.Slides for .NET**](https://products.aspose.com/slides/es/net/), cualquier desarrollador o aplicación puede convertir JPG a formato PDF con solo unas pocas líneas de código C#.

Como una API moderna de procesamiento de documentos, Aspose.Slides para .NET crea rápidamente archivos PDF a partir de imágenes JPG. La biblioteca de PowerPoint de Aspose le permite convertir JPG a PDF y muchos otros formatos de archivo
...
{{< blocks/products/pf/agp/feature-section-col title="Pasos para convertir JPG a PDF en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Los desarrolladores y las aplicaciones pueden convertir JPG a PDF de esta manera:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Antes de ejecutar el código C# de conversión de JPG a PDF, su máquina debe tener estos requisitos previos:
...
{{% blocks/products/pf/agp/code-block title="Código C# para convertir JPG a PDF" offSpacer="" %}}
