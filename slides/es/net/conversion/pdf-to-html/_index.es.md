...
title: Convertir PDF a HTML en C#
weight: 120
url: /es/net/conversion/pdf-to-html/ 
keywords: PDF a HTML, convertir PDF a HTML, C# API, biblioteca .NET, PDF, HTML
description: Convierte PDF a HTML en C#. Utilice la API de la biblioteca .NET para convertir páginas PDF en archivos HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PDF a HTML en C#" h2="API de PowerPoint .NET para convertir documentos PDF a archivos HTML en plataformas NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir PDF a HTML en C#" %}}

¿Cómo convierto PDF a HTML en código?

Con [**Aspose.Slides for .NET**](https://products.aspose.com/slides/es/net/), cualquier desarrollador o aplicación puede convertir archivos PDF a HTML con solo unas pocas líneas de código C#.

Como una API moderna de procesamiento de documentos, Aspose.Slides para .NET exporta páginas PDF a HTML rápidamente. La biblioteca de PowerPoint de Aspose le permite convertir PDF a HTML y muchos otros formatos de archivo.
...
{{< blocks/products/pf/agp/feature-section-col title="Cómo convertir PDF a HTML en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Los desarrolladores y las aplicaciones pueden convertir PDF a HTML de esta manera:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Llame al método save para guardar las diapositivas en HTML.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Antes de ejecutar el código C# de conversión de PDF a HTML, su máquina debe tener estos requisitos previos:
...
{{% blocks/products/pf/agp/code-block title="Código C# para convertir PDF a HTML" offSpacer="" %}}
