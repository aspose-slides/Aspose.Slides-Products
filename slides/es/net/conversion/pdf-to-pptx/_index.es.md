...
url: /es/net/conversion/pdf-to-pptx/
keywords: Convierta PDF a PPTX, PDF a PPTX, PowerPoint, PDF, PPTX, C# API, Biblioteca .NET
description: Convierte PDF a PPTX en C#. Use la API de la biblioteca .NET para convertir PDF a PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convertir PDF a PPTX en C#" h2="Potente API .NET multiplataforma para convertir PDF a PPTX usando código C# en plataformas NET Framework, .NET Core, Windows Azure, Mono o Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Convierta PDF a PPTX usando Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/es/net/) es una potente biblioteca .NET que se utiliza para crear, convertir y manipular presentaciones de PowerPoint, PDF, documentos HTML, y otros archivos. Cuando convierte PDF a PPTX, básicamente está moviendo el contenido de las páginas PDF a diapositivas en una presentación de PowerPoint.
...
{{% blocks/products/pf/agp/code-block title="Código C# para convertir PDF a PPTX" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Cómo convertir PDF a PPTX en C#" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Cargue el archivo PDF que desea convertir a PPTX.
{{< /blocks/products/pf/agp/step-autogen >}}
