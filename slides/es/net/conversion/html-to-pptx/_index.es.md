---
title: Convertir HTML a PPTX en C#
url: /es/net/conversion/html-to-pptx/
keywords: Convierta HTML a PPTX, HTML a PPTX, PowerPoint, HTML, PPTX, C# API, biblioteca .NET
description: Convierte HTML a PPTX en C#. Use la API de la biblioteca .NET para convertir HTML a PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convertir HTML a PPTX en C#" h2="Potente API .NET multiplataforma para convertir HTML a PPTX usando código C# en plataformas NET Framework, .NET Core, Windows Azure, Mono o Xamarin" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir HTML a PPTX en C#" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cómo convertir HTML a PPTX en C#" >}}
