---
title: Convertir PNG a PPT en C#
url: /es/net/conversion/png-to-ppt/
keywords: Convierta PNG a PPT, PNG a PPT, PowerPoint, PNG, PPT, C# API, Biblioteca .NET
description: Convierte PNG a PPT en C#. Use la API de la biblioteca .NET para convertir imágenes PNG a PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convertir PNG a PPT en C#" h2="Potente API .NET multiplataforma para convertir PNG a PPT usando código C# en plataformas NET Framework, .NET Core, Windows Azure, Mono o Xamarin" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir PNG a PPT en C#" %}}
Con [**Aspose.Slides for .NET**](https://products.aspose.com/slides/es/net/), puede convertir una imagen PNG en una presentación de PowerPoint con solo unas pocas líneas de código:

{{% blocks/products/pf/agp/code-block title="Código C# para convertir PNG a PPT" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Cómo convertir PNG a PPT en C#" >}}
