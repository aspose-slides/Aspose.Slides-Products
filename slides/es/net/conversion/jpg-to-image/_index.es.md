...
title: Convertir JPG a imagen en C#
weight: 210
url: /es/net/conversion/jpg-to-image/ 
keywords: JPG a imagen, convertir JPG a imagen, C# API, biblioteca .NET
description: Convierta JPG a imagen en C#. Use la API de la biblioteca .NET para convertir JPG a imágenes en diferentes formatos.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir JPG a imagen en C#" h2="API de PowerPoint .NET para convertir imágenes JPG en archivos de imagen en plataformas NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir JPG a imagen en C#" %}}

¿Cómo convierto JPG a imagen en código?

Con [**Aspose.Slides for .NET**](https://products.aspose.com/slides/es/net/), cualquier desarrollador o aplicación puede convertir JPG a imagen con solo unas pocas líneas de código C#.

Como una API moderna de procesamiento de documentos, Aspose.Slides para .NET exporta rápidamente archivos JPG a imágenes en otros formatos. La biblioteca Aspose PowerPoint le permite convertir JPG a imagen y muchos otros formatos de archivo
...
{{< blocks/products/pf/agp/feature-section-col title="Cómo convertir JPG a imagen en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Los desarrolladores y las aplicaciones pueden convertir JPG a imagen de esta manera:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Antes de ejecutar el código C# de conversión de JPG a imagen, su máquina debe tener estos requisitos previos:
...
{{% blocks/products/pf/agp/code-block title="Código C# para convertir JPG a imagen" offSpacer="" %}}
