...
url: /es/net/conversion/ppt-to-word/
keywords: Convierta PPT a Word, PPT a Word, PPT a DOC, PowerPoint a Word, C# API, Biblioteca .NET
description: Convierta PPT a Word en C#. Use la API de la biblioteca .NET para convertir PowerPoint a Word
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convertir PPT a Word en C#" h2="Potente API .NET multiplataforma para convertir PowerPoint a Word usando código C# en plataformas NET Framework, .NET Core, Windows Azure, Mono o Xamarin" >}}
