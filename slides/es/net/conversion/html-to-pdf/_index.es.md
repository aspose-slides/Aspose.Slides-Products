...
title: Convertir HTML a PDF en C#
weight: 40
url: /es/net/conversion/html-to-pdf/ 
keywords: HTML a PDF, Convertir HTML a PDF, C# API, Biblioteca .NET, HTML, PDF
description: Convierte HTML a PDF en C#. Utilice la API de la biblioteca .NET para convertir páginas HTML en documentos PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir HTML a PDF en C#" h2="API de PowerPoint .NET para convertir páginas HTML a documentos PDF en plataformas NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTML a PDF en C#" %}}

¿Cómo convierto HTML a PDF mediante programación?

Con [**Aspose.Slides for .NET**](https://products.aspose.com/slides/es/net/), cualquier desarrollador o aplicación puede convertir HTML a formato PDF con solo unas pocas líneas de código C#.

Como una API moderna de procesamiento de documentos, Aspose.Slides para .NET crea rápidamente archivos PDF a partir de páginas HTML. La biblioteca de PowerPoint de Aspose le permite convertir HTML a PDF y muchos otros formatos de archivo
...
{{< blocks/products/pf/agp/feature-section-col title="Pasos para convertir HTML a PDF en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Los desarrolladores y las aplicaciones pueden convertir HTML a PDF de esta manera:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Antes de ejecutar el código C# de conversión de HTML a PDF, su máquina debe tener estos requisitos previos:
...
{{% blocks/products/pf/agp/code-block title="Código C# para convertir HTML a PDF" offSpacer="" %}}
