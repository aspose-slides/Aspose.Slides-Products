...
title: Convertir PDF a Imagen en C#
weight: 80
url: /es/net/conversion/pdf-to-image/ 
keywords: PDF a imagen, convertir PDF a imagen, C# API, biblioteca .NET, PDF, imagen
description: Convertir PDF a imagen en C#. Utilice la API de la biblioteca .NET para convertir páginas PDF en imágenes
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PDF a Imagen en C#" h2="API de PowerPoint .NET para convertir documentos PDF a imágenes en plataformas NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir PDF a imagen en C#" %}}

¿Cómo convierto PDF a imagen en código?

Con [**Aspose.Slides for .NET**](https://products.aspose.com/slides/es/net/), cualquier desarrollador o aplicación puede convertir PDF en archivos de imagen con solo unas pocas líneas de código C#.

Como una API moderna de procesamiento de documentos, Aspose.Slides para .NET exporta páginas PDF a formatos de imagen rápidamente. La biblioteca Aspose PowerPoint le permite convertir PDF a imagen y muchos otros formatos de archivo.
...
{{< blocks/products/pf/agp/feature-section-col title="Cómo convertir PDF a imagen en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Los desarrolladores y las aplicaciones pueden convertir PDF a imagen de esta manera:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Llame al método save para guardar las diapositivas como imágenes.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Antes de ejecutar el código C# de conversión de PDF a imagen, su máquina debe tener estos requisitos previos:
...
{{% blocks/products/pf/agp/code-block title="Código C# para convertir PDF a imagen" offSpacer="" %}}
