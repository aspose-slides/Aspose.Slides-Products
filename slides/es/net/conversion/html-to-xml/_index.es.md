...
title: Convertir HTML a XML en C#
weight: 170
url: /es/net/conversion/html-to-xml/ 
keywords: HTML a XML, Convertir HTML a XML, C# API, Biblioteca .NET, HTML, XML
description: Convierte HTML a XML en C#. Utilice la API de la biblioteca .NET para convertir un documento HTML en un archivo XML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir HTML a XML en C#" h2="API de PowerPoint .NET para convertir documentos HTML a archivos XML en plataformas NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTML a XML en C#" %}}

¿Cómo convierto HTML a XML en código?

Con [**Aspose.Slides for .NET**](https://products.aspose.com/slides/es/net/), cualquier desarrollador o aplicación puede convertir archivos HTML a XML con solo unas pocas líneas de código C#.

Como una API de procesamiento de documentos moderna, Aspose.Slides para .NET exporta el contenido en HTML a XML rápidamente. La biblioteca de PowerPoint de Aspose le permite convertir HTML a XML y muchos otros formatos de archivo.
...
{{< blocks/products/pf/agp/feature-section-col title="Cómo convertir HTML a XML en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Los desarrolladores y las aplicaciones pueden convertir HTML a XML de esta manera:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Agregue diapositivas basadas en el contenido del archivo HTML.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Antes de ejecutar el código C# de conversión de HTML a XML, su máquina debe tener estos requisitos previos:
...
{{% blocks/products/pf/agp/code-block title="Código C# para convertir HTML a XML" offSpacer="" %}}
