...
weight: 100
url: /es/net/conversion/pdf-to-svg/ 
keywords: PDF a SVG, convertir PDF a SVG, C# API, biblioteca .NET, PDF, SVG
description: Convierte PDF a SVG en C#. Use la API de la biblioteca .NET para convertir páginas PDF a imágenes SVG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PDF a SVG en C#" h2="API de PowerPoint .NET para convertir documentos PDF a imágenes SVG en plataformas NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir PDF a SVG en C#" %}}

¿Cómo convierto PDF a SVG en código?

Con [**Aspose.Slides for .NET**](https://products.aspose.com/slides/es/net/), cualquier desarrollador o aplicación puede convertir PDF a formato SVG con solo unas pocas líneas de código C#.

Como API moderna de procesamiento de documentos, Aspose.Slides para .NET exporta páginas PDF a SVG rápidamente. La biblioteca Aspose de PowerPoint le permite convertir PDF a SVG y muchos otros formatos de archivo
...
{{< blocks/products/pf/agp/feature-section-col title="Cómo convertir PDF a SVG en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Los desarrolladores y las aplicaciones pueden convertir PDF a SVG de esta manera:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Guarde las diapositivas como imágenes SVG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Antes de ejecutar el código C# de conversión de PDF a SVG, su máquina debe tener estos requisitos previos:
...
{{% blocks/products/pf/agp/code-block title="Código C# para convertir PDF a SVG" offSpacer="" %}}
