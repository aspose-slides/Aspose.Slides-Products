...
url: /es/cpp/merger/pdf-to-pdf/
keywords: Combinar PDF, PDF a PDF, Unir PDF, Combinar PDF, API de C++, Biblioteca de C++
description: Combinar PDF a PDF en C++. Use la API de la biblioteca C++ para combinar archivos PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Fusionar PDF en C++" h2="Biblioteca C++ multiplataforma y de alta velocidad para fusionar archivos PDF usando código C++" >}}
...
Usando [**Aspose.Slides for C++**](https://products.aspose.com/slides/es/cpp/), puede fusionar archivos PDF rápidamente con solo unas pocas líneas de código
