---
title: Fusionar imagen a BMP en C++
url: /es/cpp/merger/image-to-bmp/
keywords: Imagen a BMP, Fusionar imagen a BMP, Unir imagen a BMP, Combinar imágenes, Imagen, BMP, API de C++, Biblioteca de C++
description: Fusionar imagen a BMP en C++. Use la API de la biblioteca C++ para combinar imágenes
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Fusionar imagen a BMP en C++" h2="Biblioteca C++ multiplataforma y de alta velocidad para fusionar archivos de imagen a BMP usando código C++" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Fusionar imagen a BMP en C++" %}}
Con [**Aspose.Slides for C++**](https://products.aspose.com/slides/es/cpp/), puede fusionar imágenes en BMP rápidamente con solo unas pocas líneas de código

{{% blocks/products/pf/agp/code-block title="Código C++ para fusionar Image a BMP" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="Cómo fusionar imagen a BMP en C++" >}}
