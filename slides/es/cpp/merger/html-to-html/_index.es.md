---
title: Combinar archivos HTML en C++
url: /es/cpp/merger/html-to-html/
keywords: Combinar HTML, HTML a HTML, unir HTML, combinar HTML, API de C++, biblioteca de C++
description: Combinar HTML a HTML en C++. Use la API de la biblioteca C++ para combinar archivos HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Combinar HTML en C++" h2="Biblioteca C++ multiplataforma y de alta velocidad para fusionar archivos HTML usando código C++" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Combinar HTML a HTML en C++" %}}
Con [**Aspose.Slides for C++**](https://products.aspose.com/slides/es/cpp/), puede fusionar archivos HTML rápidamente con solo unas pocas líneas de código

{{% blocks/products/pf/agp/code-block title="Código C++ para fusionar HTML con HTML" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="Cómo fusionar HTML en C++" >}}
