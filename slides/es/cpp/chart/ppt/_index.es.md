---
title: Cuadro de documento PPT a través de C++
weight: 7490
url: /es/cpp/chart/ppt/ 
description: Código de ejemplo de C++ para dibujar y convertir gráficos o diagramas en un archivo PPT en C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits y Linux de 64 bits.
---
...
{{% blocks/products/pf/agp/content h2="Cómo crear gráficos de archivos PPT usando C++" %}}
...
<!-- aboutfile Starts -->
 ...
 Genere gráficos de documentos PPT ahora mismo visitando nuestro
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/cpp/chart/pptx/" name="PPTX" description="Formato de presentación XML abierto" >}}
