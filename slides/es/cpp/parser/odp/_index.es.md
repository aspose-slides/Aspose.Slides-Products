...
title: Extraiga texto e imágenes del documento ODP a través de C++
weight: 460
url: /es/cpp/parser/odp/ 
description: Código de ejemplo de C++ para extraer texto e imágenes del archivo ODP en C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits y Linux de 64 bits.
---
...
{{% blocks/products/pf/agp/content h2="Cómo analizar archivos ODP usando C++" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/es/cpp/parser/pptx/" name="PPTX" description="Formato de presentación XML abierto" >}}
