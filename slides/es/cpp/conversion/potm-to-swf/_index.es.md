---
title: Convierta POTM a SWF a través de la aplicación C ++
url: /es/cpp/conversion/potm-to-swf/ 
description: Ejemplo de código de conversión de C++ para documento POTM a formato SWF. Utilice un código de ejemplo para la conversión por lotes de POTM a SWF dentro de cualquier aplicación C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta POTM a SWF a través de C++" h2="Conversión de POTM a SWF de alto rendimiento utilizando la biblioteca C++ sin necesidad de instalar Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWF" pfName="Aspose.SLIDES" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="SLIDES" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 La API de Aspose.SLIDES facilita a los desarrolladores la conversión de archivos POTM a SWF en solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de POTM a SWF C++" offSpacer="" %}}
