...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Funciones avanzadas de exportación de JasperReports a presentación</h2>

<p> </p>

<div class="col-lg-4"><em class="fa fa-file-powerpoint-o  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Cree informes de cuentas y expórtelos a presentaciones de Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-bar-chart   ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Cree informes de gráficos y expórtelos a presentaciones de Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-pie-chart ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Cree informes de gráficos de ejes múltiples y expórtelos a presentaciones de Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-file-text ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Cree imágenes, texto, líneas y exporte estos informes a una presentación de Microsoft PowerPoint</p>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Ocultar el panel de miniaturas de la diapositiva izquierda en el PPT creado
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-area-chart ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Implemente la serialización con el cumplimiento estricto del formato Open XML
    </p>
   </div>
   <div class="col-lg-4">
