---
title: Aspose. Diapositivas para .NET Core | API de PowerPoint de .NET Core
weight: 5190
url: /es/net-core/ 
description: Aspose.Slides .NET Core API para crear soluciones de PowerPoint .NET Core.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API de .NET Core para presentaciones" h2="Cree soluciones .NET Core multiplataforma para procesar presentaciones sin PowerPoint ni Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-net-core.svg" pfName="Aspose.Slides" subTitlepfName="for .NET Core" downloadUrl="https://downloads.aspose.com/slides/net" >}}
...
<p>
 Aspose.Slides para .NET Core se utiliza para crear soluciones de procesamiento de presentaciones en cualquier sistema operativo: Windows, Linux o macOS. Cree y cambie la presentación y sus elementos: texto, tablas, gráficos, medios, animaciones, SmartArts y elementos ActiveX.
</p>

<p>
 Amplíe sus aplicaciones con visor de presentaciones, creador, convertidor, editor, constructor de plantillas, administrador, fusión, comparador, divisor, impresora, protector y otros. Permita que las aplicaciones de C# modifiquen cualquier contenido de presentación: textos, tablas, gráficos, medios, SmartArts, ActiveX.
</p>

<p>
 La API de PowerPoint .NET Core de Aspose.Slides es una oportunidad única para evitar la duplicación de código y utilizar todo el poder de la plataforma .NET Core. La API funciona independientemente de PowerPoint u Open Office y no los requiere.
</p>
...
{{< blocks/products/pf/carousel-item h3="de un vistazo" description="Descripción general de las capacidades de .NET Core PowerPoint API de Aspose.Slides." >}}
...
{{< blocks/products/pf/carousel-item h3="Independencia de la plataforma" description="Aspose.Slides para .NET Core para Windows, Linux y macOS." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <!--/left-->
  <!--/right-->
...
{{< blocks/products/pf/carousel-item h3="Formatos de archivo admitidos" description="Aspose.Slides para .NET Core admite los [formatos de presentación] populares (https://docs.aspose.com/slides/net/supported-file-formats/) y los formatos de exportación que se enumeran a continuación." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Funciones avanzadas de la API de PowerPoint de .NET Core
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Convertir presentación en .NET Core
    </h2>
    <p>
     Aspose.Slides para .NET Core API puede convertir cualquier formato de presentación de PowerPoint en un formato de documento, imagen, web o archivo. Algunos de los formatos de conversión populares son: PDF, HTML, JPEG, XPS. Los formatos de presentación también se pueden convertir entre sí (p. ej., PPT a PPTX, PPTX a ODP), o en un formato de plantilla (p. ej., PPTX a POTM), un formato de presentación de diapositivas (p. ej., PPTX a PPSX) y viceversa. La calidad del archivo convertido es la más alta gracias a un motor de renderizado desarrollado por Aspose.Slides para PowerPoint .NET Core API. Puede estar seguro de convertir cualquier presentación en cualquier sistema operativo: Windows, Linux o macOS.
    </p>
...
prs.Save(dir + "output.tiff", Aspose.Slides.Export.SaveFormat.Tiff);</code></pre>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Modificar presentación en .NET Core
    </h2>
    <p>
     Con Aspose.Slides para .NET Core puedes modificar la lógica y el aspecto de la presentación. Todo el contenido textual se puede editar a través de elementos como texto, párrafo, porción, tabla, nota, comentario, símbolo matemático. Los efectos y animaciones 2D y 3D están disponibles para formas, gráficos, SmartArts y WordArts. El diseño de presentaciones se puede crear usando plantilla, tema, patrón de diapositivas, diseño de diapositivas. También se puede acceder a medios, marcas de agua, ActiveX a través de PowerPoint .NET Core API de Aspose.Slides.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Combinar, comparar, dividir, imprimir presentaciones en .NET Core
    </h2>
    <p>
     Aspose.Slides para .NET Core es compatible con muchas funciones adicionales que PowerPoint y otros software de terceros no proporcionan para presentaciones. Entre ellos se encuentran la comparación de presentaciones y plantillas, la división de presentaciones según la lógica personalizada, la fusión de presentaciones de varios formatos, la fusión/aplicación de plantillas en un conjunto de presentaciones, la impresión de presentaciones, etc.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Notas de lanzamiento" href="https://releases.aspose.com/slides/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.Slides para .NET Core?" tabId="success-stories" >}}
