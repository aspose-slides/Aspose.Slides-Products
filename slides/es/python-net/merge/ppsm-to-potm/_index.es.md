---
title: Fusionar archivos PPSM a POTM usando Python
url: /es/python-net/merge/ppsm-to-potm/
keywords: Combinar PPSM a POTM, unir PPSM a POTM, combinar PPSM a POTM, PowerPoint, Presentation, POTM, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Combinar archivos PPSM a POTM juntos en Python" h2="API de Python multiplataforma y de alta velocidad que ayuda a desarrollar aplicaciones con la capacidad de crear, fusionar, inspeccionar o convertir archivos de presentación de Microsoft PowerPoint y OpenOffice sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Combinar PPSM a POTM en Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Combinar archivos PPSM a POTM usando Python" %}}
Para fusionar las presentaciones de PowerPoint, deberá clonar las diapositivas de una presentación a la otra.

{{% blocks/products/pf/agp/code-block title="Código de Python para fusionar múltiples PPSM en un solo archivo POTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cómo fusionar PPSM a POTM usando Aspose.Slides para la API de Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estos son los pasos para fusionar dos archivos PPSM y guardar el resultado como POTM en Python." >}}
