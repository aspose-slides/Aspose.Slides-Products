---
title: Fusionar archivos ODP a PPT usando Python
url: /es/python-net/merge/odp-to-ppt/
keywords: Combinar ODP a PPT, unir ODP a PPT, combinar ODP a PPT, PowerPoint, Presentation, PPT, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Combinar archivos ODP a PPT juntos en Python" h2="API de Python multiplataforma y de alta velocidad que ayuda a desarrollar aplicaciones con la capacidad de crear, fusionar, inspeccionar o convertir archivos de presentación de Microsoft PowerPoint y OpenOffice sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Combinar ODP a PPT en Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Combinar archivos ODP a PPT usando Python" %}}
Para fusionar las presentaciones de PowerPoint, deberá clonar las diapositivas de una presentación a la otra.

{{% blocks/products/pf/agp/code-block title="Código de Python para fusionar múltiples ODP en un solo archivo PPT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cómo fusionar ODP a PPT usando Aspose.Slides para la API de Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estos son los pasos para fusionar dos archivos ODP y guardar el resultado como PPT en Python." >}}
