---
title: Fusionar archivos POTM a ODP usando Python
url: /es/python-net/merge/potm-to-odp/
keywords: Combinar POTM a ODP, unir POTM a ODP, combinar POTM a ODP, PowerPoint, Presentation, ODP, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Combinar archivos POTM a ODP juntos en Python" h2="API de Python multiplataforma y de alta velocidad que ayuda a desarrollar aplicaciones con la capacidad de crear, fusionar, inspeccionar o convertir archivos de presentación de Microsoft PowerPoint y OpenOffice sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Combinar POTM a ODP en Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Combinar archivos POTM a ODP usando Python" %}}
Para fusionar las presentaciones de PowerPoint, deberá clonar las diapositivas de una presentación a la otra.

{{% blocks/products/pf/agp/code-block title="Código de Python para fusionar múltiples POTM en un solo archivo ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cómo fusionar POTM a ODP usando Aspose.Slides para la API de Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estos son los pasos para fusionar dos archivos POTM y guardar el resultado como ODP en Python." >}}
