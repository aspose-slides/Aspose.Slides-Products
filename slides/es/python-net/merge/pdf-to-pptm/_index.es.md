---
title: Fusionar archivos PDF a PPTM usando Python
url: /es/python-net/merge/pdf-to-pptm/
keywords: Combinar PDF a PPTM, unir PDF a PPTM, combinar PDF a PPTM, PowerPoint, Presentation, PPTM, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Combinar archivos PDF a PPTM juntos en Python" h2="API de Python multiplataforma y de alta velocidad que ayuda a desarrollar aplicaciones con la capacidad de crear, fusionar, inspeccionar o convertir archivos de presentación de Microsoft PowerPoint y OpenOffice sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Combinar PDF a PPTM en Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Combinar archivos PDF a PPTM usando Python" %}}
Para fusionar las presentaciones de PowerPoint, deberá clonar las diapositivas de una presentación a la otra.

{{% blocks/products/pf/agp/code-block title="Código de Python para fusionar múltiples PDF en un solo archivo PPTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cómo fusionar PDF a PPTM usando Aspose.Slides para la API de Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estos son los pasos para fusionar dos archivos PDF y guardar el resultado como PPTM en Python." >}}
