...
weight: 1420
url: /es/python-net/conversion/potx-to-png/ 
keywords: "Convert, PowerPoint, POTX, PNG, Presentation, Python"
description: Código de muestra para la conversión de POTX a PNG Python. Utilice la API Python de PowerPoint para la conversión por lotes de archivos POTX a archivos PNG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir POTX a PNG en Python" h2="Potente biblioteca de PowerPoint Python para convertir POTX a PNG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir POTX a PNG en Python" %}}

¿Necesita convertir archivos POTX a PNG mediante programación? Usando [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/es/python-net/) cualquier desarrollador puede convertir POTX a formato PNG con solo unas pocas líneas de código de Python.

Como una API moderna de procesamiento de presentaciones, Aspose.Slides for Python crea PNG a partir de POTX rápidamente. Pruebe la calidad de la conversión de POTX a PNG directamente en su [navegador](https://products.aspose.app/slides/conversion/ppt-to-png). La biblioteca Aspose PowerPoint PPTX le permite convertir archivos POTX a muchos formatos populares.
...
{{< blocks/products/pf/agp/feature-section-col title="Cómo convertir POTX a PNG en Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estos son los pasos para convertir un archivo POTX a PNG usando Python." >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de POTX a PNG Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Guardar POTX como PNG en Python" %}}
Utilice la aplicación gratuita para ver una demostración del proceso de conversión de POTX a PNG. 
{{% /blocks/products/pf/agp/content %}}
