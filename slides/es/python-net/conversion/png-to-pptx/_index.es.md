---
title: Convertir PNG a PPTX en Python
url: /es/python-net/conversion/png-to-pptx/
keywords: Convierta PNG a PPTX, PNG a PPTX, PowerPoint, PNG, PPTX, API de Python, biblioteca de Python
description: Convierta PNG a PPTX en Python. Use la API de la biblioteca de Python para convertir imágenes PNG a PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convertir PNG a PPTX en Python" h2="Potente API de Python multiplataforma para convertir PNG a PPTX usando código de Python" >}}

{{% blocks/products/pf/feature-page-section h2="Convierta PNG a PPTX usando Aspose.Slides" %}}

[**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/es/python-net/) es una poderosa biblioteca de Python que se utiliza para crear, convertir y manipular presentaciones de PowerPoint, archivos PDF, documentos HTML y otros archivos. Cuando convierte PNG a PPTX, básicamente está creando una presentación de PowerPoint que contiene diapositivas basadas en imágenes PNG.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Convertir PNG a PPTX en Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Código de Python para convertir PNG a PPTX" offSpacer="true" %}}
```py
...
{{< blocks/products/pf/feature-page-section  h2="Cómo convertir PNG a PPTX en Python" >}}
