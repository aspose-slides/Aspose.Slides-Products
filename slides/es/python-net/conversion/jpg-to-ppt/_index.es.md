---
title: Convertir JPG a PPT en Python
url: /es/python-net/conversion/jpg-to-ppt/
keywords: Convertir JPG a PPT, JPG a PPT, PowerPoint, JPG, PPT, API de Python, Biblioteca de Python
description: Convierta JPG a PPT en Python. Use la API de la biblioteca de Python para convertir imágenes JPG a PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convertir JPG a PPT en Python" h2="Potente API de Python multiplataforma para convertir JPG a PPT usando código de Python" >}}

{{% blocks/products/pf/feature-page-section h2="Convierta JPG a PPT usando Aspose.Slides" %}}

[**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/es/python-net/) es una poderosa biblioteca de Python que se utiliza para crear, convertir y manipular presentaciones de PowerPoint, archivos PDF, documentos HTML y otros archivos. Cuando convierte JPG a PPT, básicamente está creando una presentación de PowerPoint que contiene diapositivas basadas en imágenes JPG.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Convertir JPG a PPT en Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Código Python para convertir JPG a PPT" offSpacer="true" %}}
```py
...
{{< blocks/products/pf/feature-page-section  h2="Cómo convertir JPG a PPT en Python" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Cargue la imagen JPG que desea convertir a PPT.
{{< /blocks/products/pf/agp/step-autogen >}}
