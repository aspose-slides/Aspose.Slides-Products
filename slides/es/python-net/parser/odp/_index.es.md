---
title: Extraiga texto e imágenes de archivos ODP usando Python
url: /es/python-net/parser/odp/
keywords: analizar ODP con Python, ODP analizar Python, extraer datos de ODP en Python, extraer texto de ODP con Python, extraer imágenes de ODP con Python
description: Código fuente de Python para analizar la presentación de ODP.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Extraiga texto e imágenes de la presentación ODP usando Python" h2="Cree sus propias aplicaciones de Python para extraer archivos de texto, imagen, video y audio de PowerPoint utilizando las API del lado del servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" fileiconsmall4="POT" fileiconsmall5="ppsx" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for Python via .NET" >}}

{{% blocks/products/pf/feature-page-section  h2="Extraer texto de la presentación ODP a través de Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Extraer texto de la presentación ODP usando Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cómo extraer texto de ODP a través de Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estos son los pasos para analizar archivos ODP." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Obtenga una matriz de objetos TextFrame de todas las diapositivas en ODP
{{< /blocks/products/pf/agp/step-autogen >}}
