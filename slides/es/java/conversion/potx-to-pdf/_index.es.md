---
title: Convierta POTX a PDF a través de Java
weight: 3700
url: /es/java/conversion/potx-to-pdf/ 
description: Ejemplo de código de conversión de Java para formato POTX a archivo PDF. Utilice este código de ejemplo para exportar presentaciones de PowerPoint y OpenOffice a PDF dentro de cualquier aplicación web o de escritorio basada en Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta POTX a PDF a través de Java" h2="Conversión POTX a PDF Java para convertir una o varias páginas a PDF utilizando la biblioteca Java local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir POTX a PDF usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir POTX a PDF a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo POTX a PDF con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de POTX a PDF Java" offSpacer="" %}}
