...
title: Combinar archivos POTM a través de Java
weight: 6620
url: /es/java/merger/potm/ 
description: Código de muestra de Java para combinar documentos POTM en Java Runtime Environment para aplicaciones JSP/JSF y aplicaciones de escritorio.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Combinar formatos POTM en Java" h2="Fusión nativa de documentos POTM utilizando API de Java del lado del servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo fusionar archivos POTM usando Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Pasos para fusionar archivos POTM en Java" >}}
...
Cargue el primer archivo POTM con una instancia de la clase Presentation.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Cargue el segundo documento POTM con una instancia de la clase Presentation.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Recorra cada diapositiva del segundo archivo POTM.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Fusionar archivos POTM - Java" offSpacer="" %}}
