---
title: Combinar imágenes en Java
url: /es/java/merger/image-to-image/
keywords: Fusionar imagen, imagen a imagen, unir imágenes, combinar imágenes, API de Java, biblioteca de Java
description: Combinar imagen a imagen en Java. Use la API de la biblioteca Java para combinar imágenes
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge image in Java" h2="Biblioteca Java de alta velocidad y multiplataforma para fusionar imágenes usando código Java" >}}

{{% blocks/products/pf/feature-page-section h2="Combinar imagen a imagen usando Aspose.Slides" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/es/java/) es una potente biblioteca de Java que se utiliza para fusionar y manipular presentaciones, imágenes y otros archivos. Cuando fusiona una imagen con otra, está combinando efectivamente dos imágenes para obtener una imagen.
...
{{% blocks/products/pf/feature-page-section  h2="Fusionar imagen a imagen en Java" %}}
Using [**Aspose.Slides for Java**](https://products.aspose.com/slides/es/java/), you can merge image files quickly with just a few lines of code

{{% blocks/products/pf/agp/code-block title="Código Java para fusionar imagen a imagen" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Cómo fusionar imágenes en Java" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/es/java/merger/png-to-pdf/" name="PNG TO PDF" >}}
