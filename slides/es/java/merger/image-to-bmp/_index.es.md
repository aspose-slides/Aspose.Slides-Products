---
title: Fusionar imagen a BMP en Java
url: /es/java/merger/image-to-bmp/
keywords: Imagen a BMP, Fusionar imagen a BMP, Unir imagen a BMP, Combinar imágenes, Imagen, BMP, API de Java, Biblioteca de Java
description: Fusionar imagen a BMP en Java. Use la API de la biblioteca Java para combinar imágenes
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Fusionar imagen a BMP en Java" h2="Biblioteca Java de alta velocidad y multiplataforma para fusionar archivos de imagen a BMP usando código Java" >}}

{{% blocks/products/pf/feature-page-section h2="Fusionar imagen a BMP usando Aspose.Slides" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/es/java/) es una potente biblioteca de Java que se utiliza para crear, convertir, fusionar y manipular presentaciones, archivos PDF, imágenes y otros archivos Cuando combina una imagen en BMP, está combinando imágenes de manera efectiva para obtener un solo archivo BMP.
...
{{% blocks/products/pf/feature-page-section  h2="Fusionar imagen a BMP en Java" %}}
Con [**Aspose.Slides for Java**](https://products.aspose.com/slides/es/java/), puede fusionar imágenes en BMP rápidamente con solo unas pocas líneas de código

{{% blocks/products/pf/agp/code-block title="Código Java para fusionar imagen a BMP" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Cómo fusionar imagen a BMP en Java" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Guarde el archivo BMP resultante.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/es/java/merger/svg-to-png/" name="SVG TO PNG" >}} 
