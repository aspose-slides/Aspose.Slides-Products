---
title: Fusionar imagen a PDF en Java
url: /es/java/merger/image-to-pdf/
keywords: Imagen a PDF, Fusionar imagen a PDF, Unir imagen a PDF, PDF, Imagen, API de Java, Biblioteca de Java
description: Fusionar imagen a PDF en Java. Use la API de la biblioteca Java para combinar imágenes y PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Fusionar imagen a PDF en Java" h2="Biblioteca Java de alta velocidad y multiplataforma para fusionar archivos de imagen a PDF usando código Java" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Fusionar imagen a PDF en Java" %}}
Con [**Aspose.Slides for Java**](https://products.aspose.com/slides/es/java/), puede fusionar imágenes en PDF rápidamente con solo unas pocas líneas de código

{{% blocks/products/pf/agp/code-block title="Código Java para fusionar imagen a PDF" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Cómo fusionar imagen a PDF en Java" >}}
