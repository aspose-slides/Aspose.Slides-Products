---
title: Convierta PPSM a PNG en Node.js
url: /es/nodejs-java/conversion/ppsm-to-png/
keywords: PPSM a PNG, Convertir PPSM a PNG, API de Node.js, Biblioteca Node.js, PPSM, PNG
description: Convierta PPSM a PNG en Node.js. Utilice la API de la biblioteca Node.js para convertir archivos PPSM a PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convierta PPSM a PNG en Node.js" h2="Aspose.Slides para Node.js vía Java es una biblioteca potente y fácil de usar que le permite convertir presentaciones de PowerPoint a varios formatos en Node.js. Admite todos los elementos y formatos de presentación y proporciona una API enriquecida para acceder a ellos y modificarlos. También le permite exportar sus diapositivas a varios formatos para procesarlas o compartirlas posteriormente." >}}

{{% blocks/products/pf/feature-page-section h2="Convierta PPSM a PNG en Node.js" %}}

[**Aspose.Slides para Node.js vía Java**](https://products.aspose.com/slides/es/nodejs-java/) es una poderosa biblioteca de Node.js para crear y manipular archivos de presentación. Además, proporciona formas flexibles de convertir PPSM a PNG. Al utilizar **Aspose.Slides para Node.js a través de Java**, cualquier desarrollador o aplicación puede convertir archivos PPSM a PNG con solo unas pocas líneas de código.

Como API moderna de procesamiento de documentos, Aspose.Slides para Node.js exporta archivos PPSM a formatos de archivo PNG rápidamente. La biblioteca Aspose PowerPoint le permite convertir PPSM a PNGs y muchos otros formatos de archivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convierta PPSM a PNG usando Node.js" %}}
Para convertir PPSM a PNG, deberá crear una presentación a partir del archivo PPSM y guardarla como PNG.

{{% blocks/products/pf/agp/code-block title="Código Node.js para convertir PPSM en PNG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cómo convertir PPSM a PNG usando Aspose.Slides para Node.js a través de la API de Java" >}}
