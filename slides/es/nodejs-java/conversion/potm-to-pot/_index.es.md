---
title: Convierta POTM a POT en Node.js
url: /es/nodejs-java/conversion/potm-to-pot/
keywords: POTM a POT, Convertir POTM a POT, API de Node.js, Biblioteca Node.js, POTM, POT
description: Convierta POTM a POT en Node.js. Utilice la API de la biblioteca Node.js para convertir archivos POTM a POT
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convierta POTM a POT en Node.js" h2="Aspose.Slides para Node.js vía Java es una biblioteca potente y fácil de usar que le permite convertir presentaciones de PowerPoint a varios formatos en Node.js. Admite todos los elementos y formatos de presentación y proporciona una API enriquecida para acceder a ellos y modificarlos. También le permite exportar sus diapositivas a varios formatos para procesarlas o compartirlas posteriormente." >}}

{{% blocks/products/pf/feature-page-section h2="Convierta POTM a POT en Node.js" %}}
...
Como API moderna de procesamiento de documentos, Aspose.Slides para Node.js exporta archivos POTM a formatos de archivo POT rápidamente. La biblioteca Aspose PowerPoint le permite convertir POTM a POTs y muchos otros formatos de archivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convierta POTM a POT usando Node.js" %}}
Para convertir POTM a POT, deberá crear una presentación a partir del archivo POTM y guardarla como POT.

{{% blocks/products/pf/agp/code-block title="Código Node.js para convertir POTM en POT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Cómo convertir POTM a POT usando Aspose.Slides para Node.js a través de la API de Java" >}}
