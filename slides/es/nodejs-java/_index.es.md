...
{{< blocks/products/pf/testimonials title="Lo que la gente esta diciendo" subTitle="No confíe sólo en nuestra palabra. Vea lo que los usuarios tienen que decir sobre las API de PowerPoint." caseStudiesLink="https://about.aspose.com/customers/success-stories/" >}}
...
{{< blocks/products/pf/support-learning-resources >}}
    ...
    {{< blocks/products/pf/slr-tab tabTitle="Soporte de producto" tabId="support" >}}
        ...
        {{< blocks/products/pf/slr-element name="Notas de lanzamiento" href="https://releases.aspose.com/slides/nodejs-java/release-notes/" >}}
    {{< /blocks/products/pf/slr-tab >}}
