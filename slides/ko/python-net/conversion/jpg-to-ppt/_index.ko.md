---
title: Python에서 JPG를 PPT로 변환
url: /ko/python-net/conversion/jpg-to-ppt/
keywords: JPG를 PPT로, JPG를 PPT로, PowerPoint, JPG, PPT, Python API, Python 라이브러리로 변환
description: Python에서 JPG를 PPT로 변환합니다. Python 라이브러리 API를 사용하여 JPG 이미지를 PowerPoint로 변환
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Python에서 JPG를 PPT로 변환" h2="Python 코드를 사용하여 JPG를 PPT로 변환하기 위한 강력한 크로스 플랫폼 Python API" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides를 사용하여 JPG를 PPT로 변환" %}}

[**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/ko/python-net/)은 PowerPoint 프레젠테이션, PDF, HTML 문서 및 기타 파일. JPG를 PPT로 변환하면 본질적으로 JPG 이미지를 기반으로 하는 슬라이드가 포함된 PowerPoint 프레젠테이션을 만드는 것입니다.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Python에서 JPG를 PPT로 변환" %}}
...
{{% blocks/products/pf/agp/code-block title="JPG를 PPT로 변환하는 Python 코드" offSpacer="true" %}}
```py
...
{{< blocks/products/pf/feature-page-section  h2="Python에서 JPG를 PPT로 변환하는 방법" >}}
