---
title: Python을 사용하여 PDF 파일을 TIFF에 병합
url: /ko/python-net/merge/pdf-to-tiff/
keywords: PDF을 TIFF에 병합, PDF을 TIFF에 결합, PDF을 TIFF에 결합, PowerPoint, Presentation, TIFF, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Python에서 PDF 파일을 TIFF으로 병합" h2="Microsoft 또는 Open Office, Adobe PDF와 같은 소프트웨어를 사용하지 않고도 Microsoft PowerPoint 및 OpenOffice 프레젠테이션 파일을 생성, 병합, 검사 또는 변환할 수 있는 기능으로 응용 프로그램 개발에 도움이 되는 고속 교차 플랫폼 Python API입니다." >}}

{{% blocks/products/pf/feature-page-section h2="Python에서 PDF을 TIFF으로 병합" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Python을 사용하여 PDF 파일을 TIFF에 병합" %}}
PowerPoint 프레젠테이션을 병합하려면 한 프레젠테이션에서 다른 프레젠테이션으로 슬라이드를 복제해야 합니다.

{{% blocks/products/pf/agp/code-block title="여러 PDF을 단일 TIFF 파일로 병합하기 위한 Python 코드" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Aspose.Slides for Python API를 사용하여 PDF을 TIFF으로 병합하는 방법" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="다음은 두 개의 PDF 파일을 병합하고 결과를 Python에서 TIFF으로 저장하는 단계입니다." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ko/python-net/merge/pdf-to-xps/" name="PDF TO XPS" >}}  
