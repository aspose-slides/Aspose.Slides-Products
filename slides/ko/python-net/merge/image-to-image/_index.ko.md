---
title: Python에서 이미지 병합
url: /ko/python-net/merge/image-to-image/
keywords: 이미지 병합, 이미지를 이미지로, 이미지 결합, 이미지 결합, Python API, Python 라이브러리
description: Python에서 이미지를 이미지로 병합합니다. Python 라이브러리 API를 사용하여 이미지 결합
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge image in Python" h2="Python 코드를 사용하여 이미지를 병합하기 위한 고속 및 교차 플랫폼 Python 라이브러리" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides를 사용하여 이미지를 이미지에 병합" %}}

[**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/ko/python-net/)은 프레젠테이션, 이미지 및 기타 파일을 병합하고 조작하는 데 사용되는 강력한 Python 라이브러리입니다. 이미지를 이미지로 병합하면 두 개의 이미지를 효과적으로 결합하여 하나의 사진을 얻을 수 있습니다.
...
{{% blocks/products/pf/feature-page-section  h2="Python에서 이미지를 이미지로 병합" %}}
Using [**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/ko/python-net/), you can merge image files quickly with just a few lines of code

{{% blocks/products/pf/agp/code-block title="이미지를 이미지에 병합하는 Python 코드" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="Python에서 이미지를 병합하는 방법" >}}
