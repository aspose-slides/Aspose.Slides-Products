...
url: /ko/net/conversion/ppt-to-word/
keywords: PPT를 Word로, PPT를 Word로, PPT를 DOC로, PowerPoint를 Word로, C# API, .NET 라이브러리로 변환
description: C#에서 PPT를 Word로 변환합니다. .NET 라이브러리 API를 사용하여 PowerPoint를 Word로 변환
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="C#에서 PPT를 Word로 변환" h2="NET Framework, .NET Core, Windows Azure, Mono 또는 Xamarin 플랫폼에서 C# 코드를 사용하여 PowerPoint를 Word로 변환하기 위한 강력한 크로스 플랫폼 .NET API" >}}
