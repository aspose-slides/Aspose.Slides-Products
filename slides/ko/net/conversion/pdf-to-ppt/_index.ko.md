...
description: C#에서 PDF를 PPT로 변환합니다. .NET 라이브러리 API를 사용하여 PDF를 PowerPoint로 변환
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="C#에서 PDF를 PPT로 변환" h2="NET Framework, .NET Core, Windows Azure, Mono 또는 Xamarin 플랫폼에서 C# 코드를 사용하여 PDF를 PPT로 변환하기 위한 강력한 크로스 플랫폼 .NET API" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides를 사용하여 PDF를 PPT로 변환" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/ko/net/)은 PowerPoint 프레젠테이션, PDF, HTML 문서, 및 기타 파일. PDF를 PPT로 변환하면 기본적으로 PDF 페이지의 내용이 PowerPoint 프레젠테이션의 슬라이드로 이동됩니다.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="C#에서 PDF를 PPT로 변환" %}}
[**Aspose.Slides for .NET**](https://products.aspose.com/slides/ko/net/)을 사용하면 단 몇 줄의 코드만으로 PDF를 PowerPoint 프레젠테이션으로 변환할 수 있습니다.

{{% blocks/products/pf/agp/code-block title="PDF를 PPT로 변환하기 위한 C# 코드" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="C#에서 PDF를 PPT로 변환하는 방법" >}}
