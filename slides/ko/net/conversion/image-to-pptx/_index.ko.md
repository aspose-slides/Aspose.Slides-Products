---
title: C#에서 이미지를 PPTX로 변환
url: /ko/net/conversion/image-to-pptx/
keywords: 이미지를 PPTX로, 이미지를 PPTX로, PowerPoint, 이미지, PPTX, C# API, .NET 라이브러리로 변환
description: C#에서 이미지를 PPTX로 변환합니다. .NET 라이브러리 API를 사용하여 이미지를 PowerPoint로 변환
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="C#에서 이미지를 PPTX로 변환" h2="NET Framework, .NET Core, Windows Azure, Mono 또는 Xamarin 플랫폼에서 C# 코드를 사용하여 이미지를 PPTX로 변환하기 위한 강력한 크로스 플랫폼 .NET API" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides를 사용하여 이미지를 PPTX로 변환" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/ko/net/)은 PowerPoint 프레젠테이션, PDF, HTML 문서, 및 기타 파일. 이미지를 PPTX로 변환하면 기본적으로 해당 이미지를 기반으로 하는 슬라이드가 포함된 PowerPoint 프레젠테이션을 만드는 것입니다.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="C#에서 이미지를 PPTX로 변환" %}}
[**Aspose.Slides for .NET**](https://products.aspose.com/slides/ko/net/)을 사용하면 몇 줄의 코드만으로 이미지를 PowerPoint 프레젠테이션으로 변환할 수 있습니다.

{{% blocks/products/pf/agp/code-block title="이미지를 PPTX로 변환하기 위한 C# 코드" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="C#에서 이미지를 PPTX로 변환하는 방법" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ko/net/conversion/image-to-ppt/" name="IMAGE TO PPT" >}}
