---
title: C#을 통해 열지 않고 ODP 문서 검색
weight: 8110
url: /ko/net/search/odp/ 
description: .NET Framework, .NET Core, Windows Azure, Mono 또는 Xamarin 플랫폼의 ODP 파일에서 패턴이 있는 단어를 검색하는 C# 소스 코드.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C#에서 ODP 형식 검색" h2="Microsoft 또는 Adobe PDF와 같은 소프트웨어를 사용하지 않고 .NET API용 서버측 Aspose.Slides를 사용하여 기본 및 고성능 ODP 문서 검색." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 ODP 파일을 검색하는 방법" %}}

 ODP 파일을 검색하려면 다음을 사용합니다.
 [.NET용 Aspose.Slides](https://products.aspose.com/slides/ko/net)
 기능이 풍부하고 강력하며 사용하기 쉬운 C# 플랫폼용 PowerPoint 프레젠테이션 검색 API입니다. 열려 있는
 [NuGet](https://www.nuget.org/packages/aspose.slides.net)
 패키지 관리자에서 Aspose.Slides를 검색하여 설치합니다. 패키지 관리자 콘솔에서 다음 명령을 사용할 수도 있습니다.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ko/net/search/pptx/" name="PPTX" description="Open XML 프레젠테이션 형식" >}}
