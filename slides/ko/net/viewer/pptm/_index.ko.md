...
title: .NET을 통해 PPTM 파일 형식 보기
weight: 4190
url: /ko/net/viewer/pptm/ 
description: .NET Framework, .NET Core, Windows Azure, Mono 또는 Xamarin 플랫폼에서 PPTM 문서를 로드, 렌더링 및 표시하는 C# 소스 코드.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1=".NET용 PPTM 파일 뷰어" h2="Microsoft PowerPoint 또는 Office Automation 없이 PPTM과 같은 프레젠테이션 파일 보기" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTM" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 PPTM 파일을 보는 방법" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="C#을 통해 PPTM을 보는 단계" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Aspose.Slides를 사용하면 개발자가 몇 줄의 코드로 PPTM 파일을 쉽게 볼 수 있습니다." >}}

{{< blocks/products/pf/agp/step-autogen >}}
프레젠테이션 개체 인스턴스화 및 PPTM 파일 로드
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
PPTM 프레젠테이션을 HTML 형식으로 저장
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
기본 브라우저에서 PPTM 콘텐츠를 로드하기 위해 결과 HTML에 대한 경로로 Process.Start를 호출합니다.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="PPTM 파일을 보는 C# 예제 코드" offSpacer="" %}}
