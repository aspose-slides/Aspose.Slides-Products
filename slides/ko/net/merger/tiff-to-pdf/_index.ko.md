...
description: C#에서 TIFF를 PDF로 병합합니다. .NET 라이브러리 API를 사용하여 TIFF와 PDF 결합
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="C#에서 TIFF를 PDF로 병합" h2="NET Framework, .NET Core, Windows Azure, Mono 또는 Xamarin 플랫폼에서 C# 코드를 사용하여 TIFF를 PDF 파일로 병합하기 위한 강력한 크로스 플랫폼 .NET API" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides를 사용하여 TIFF를 PDF로 병합" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/ko/net/)은 프레젠테이션, PDF, 이미지, 및 기타 파일. TIFF를 PDF로 병합하면 이미지를 효과적으로 결합하여 단일 PDF 파일을 얻을 수 있습니다.
...
[**Aspose.Slides for .NET**](https://products.aspose.com/slides/ko/net/)을 사용하면 단 몇 줄의 코드만으로 TIFF를 PDF로 빠르게 병합할 수 있습니다.
