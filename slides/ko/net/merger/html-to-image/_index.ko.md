...
url: /ko/net/merger/html-to-image/
keywords: HTML을 이미지에 병합, HTML을 이미지에 병합, HTML 결합, HTML 결합, 이미지, C# API, .NET 라이브러리
description: C#에서 HTML을 이미지에 병합합니다. .NET 라이브러리 API를 사용하여 HTML을 이미지에 결합
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="C#에서 이미지 병합" h2="NET Framework, .NET Core, Windows Azure, Mono 또는 Xamarin 플랫폼에서 C# 코드를 사용하여 HTML을 이미지에 병합하기 위한 강력한 크로스 플랫폼 .NET API" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides를 사용하여 HTML을 이미지에 병합" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/ko/net/)은 프레젠테이션, HTML 문서 및 기타 파일을 병합하고 조작하는 데 사용되는 강력한 .NET 라이브러리입니다. HTML을 이미지에 병합하면 HTML 문서의 내용을 효과적으로 결합하여 단일 이미지를 얻을 수 있습니다. 
