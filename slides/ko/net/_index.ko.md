...
<h2 class="h2title">PowerPoint 슬라이드 요소에 대한 완벽한 제어</h2>

<p>.NET용 Aspose.Slides는 텍스트 상자, 테이블, 직사각형, 타원, 폴리라인, 자동 모양, 그림 프레임, 오디오 프레임, 비디오 프레임 및 OLE 개체 프레임을 포함한 모든 프레젠테이션 슬라이드 요소를 처리할 수 있습니다. API는 이러한 각 요소를 종합적으로 조작할 수 있도록 잘 설계된 클래스 세트를 제공합니다.</p>
...
<h2 class="h2title">Office Open XML 지원</h2>

<p>OOXML(Office OpenXML)은 Microsoft Office 2007에 도입된 XML 기반 형식입니다.</p>

<p>PresentationML(OOXML, PPTX)은 Microsoft Office PowerPoint 2007에서 문서를 저장하는 데 사용하는 마크업 언어입니다. .NET용 Aspose.Slides는 PresentationML 문서의 생성, 읽기, 조작 및 쓰기를 광범위하게 지원합니다.</p>
