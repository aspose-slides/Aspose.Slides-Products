...
title: PowerPoint로 JasperReports 내보내기 | Aspose.슬라이드
weight: 8320
url: /ko/jasperreports/ 
description: Aspose.Slides PowerPoint API는 Jasper Reports 및 JasperServer에서 PowerPoint 형식으로 보고서를 내보낼 수 있습니다. 계정 차트 이미지 텍스트 및 라인 보고서를 만들고 PPT 프레젠테이션으로 내보내기
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="PowerPoint 프레젠테이션으로 JasperServer 보고서 내보내기" h2="JasperReports 및 JasperServer 보고서를 PPT(X), PPS(X) 및 기타 PowerPoint 형식으로 내보내기 위한 PowerPoint API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-jasperreports.svg" pfName="Aspose.Slides" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/slides/jasperreport" >}}
...
<p>
 Aspose.Slides for JasperReports는 JasperReports 및 JasperServer 보고서를 PowerPoint로 유연하고 사용하기 쉽게 내보내기 위한 PowerPoint API입니다. JasperServer에는 보고서를 PowerPoint 프레젠테이션으로 내보내는 기본 제공 기능이 없습니다. 그러나 이 PowerPoint API를 사용하면 Microsoft PowerPoint를 사용하지 않고도 JasperServer 보고서를 PPT, PPS, PPTX 및 PPSX 프레젠테이션 형식으로 내보낼 수 있습니다.
</p>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">프레젠테이션 내보내기 기능에 대한 고급 JasperReports</h2>

<p> </p>

<div class="col-lg-4"><em class="fa fa-file-powerpoint-o  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">계정 보고서를 만들고 Microsoft PowerPoint 프레젠테이션으로 내보내기</p>

</div>

<div class="col-lg-4"><em class="fa fa-bar-chart   ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">차트 보고서를 만들고 Microsoft PowerPoint 프레젠테이션으로 내보내기</p>

</div>

<div class="col-lg-4"><em class="fa fa-pie-chart ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">다중 축 차트 보고서를 만들고 Microsoft PowerPoint 프레젠테이션으로 내보내기</p>

</div>

<div class="col-lg-4"><em class="fa fa-file-text ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">이미지, 텍스트, 선을 만들고 이 보고서를 Microsoft PowerPoint 프레젠테이션으로 내보냅니다.</p>

</div>-->
   <h2 class="pr-ft">
    고급 JasperReports PowerPoint API 기능
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     댓글 회신, Office 365 및 외부 Excel 통합 문서 지원
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     텍스트 형광펜, OpenDocument 암호화 및 모양 렌더링
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     시리즈 데이터 레이블에 대한 응용 프로그램 및 콜아웃 모양의 로케일 설정
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    ...
    <p>
     JasperReports용 Aspose.Slides는 다음을 포함하는 복잡한 보고서 내보내기를 지원합니다.
     <강한>
      다중 축 차트 보고서
     </strong>
     Microsoft PowerPoint 프레젠테이션으로 이동합니다. 출력은 JasperViewer를 통해 볼 때 나타나는 것과 정확히 동일합니다.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     보고서를 프레젠테이션 형식으로 내보내기
    </h2>
    <p>
     JasperReports 및 JasperServer에는 보고서를 Microsoft PowerPoint 프레젠테이션으로 내보내기 위한 기본 제공 지원이 없지만 Aspose.Slides for JasperReports와의 통합을 통해 보고서를 Microsoft PowerPoint 프레젠테이션(PPT, PPTX) 및 Microsoft PowerPoint 슬라이드쇼(PPS, PPSX).
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     JasperReports용 Aspose.Slides는 PowerPoint 문서 작업을 위해 시스템에 Microsoft PowerPoint를 설치할 필요가 없는 관리 코드를 사용하여 구축됩니다. 지원되는 기능, 보안, 안정성, 확장성, 속도 및 가격 측면에서 완벽한 Microsoft PowerPoint 자동화 대안입니다.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="선적 서류 비치" href="https://docs.aspose.com/slides/jasperreports/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="JasperReports에 Aspose.Slides가 필요한 이유는 무엇입니까?" tabId="success-stories" >}}
