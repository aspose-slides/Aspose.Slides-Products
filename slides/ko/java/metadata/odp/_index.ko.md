---
title: Java를 통해 ODP 파일 메타데이터 편집 또는 보기
weight: 7720
url: /ko/java/metadata/odp/ 
description: JSP/JSF 애플리케이션 및 데스크탑 애플리케이션용 Java Runtime Environment에서 ODP 형식 메타데이터를 편집하거나 보기 위한 Java 샘플 코드입니다.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java를 통해 ODP 메타데이터 추출" h2="서버 측 API를 사용하여 ODP 파일에서 메타데이터를 추가, 편집, 제거 또는 추출하는 자체 Java 앱을 빌드합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Java를 사용하여 ODP 메타데이터를 추출하는 방법" %}}

 ODP 파일 메타데이터를 얻으려면 다음을 사용합니다.
...
{{< blocks/products/pf/agp/feature-section-col title="Java를 통해 ODP의 메타데이터를 추출하는 단계" >}}
...
getPresentationInfo()를 사용하여 ODP 정보 가져오기
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="ODP의 메타데이터 추출 - Java" offSpacer="" %}}
