---
title: Java를 통해 PPSX 파일 메타데이터 편집 또는 보기
weight: 3170
url: /ko/java/metadata/ppsx/ 
description: JSP/JSF 응용 프로그램 및 데스크탑 응용 프로그램용 Java Runtime Environment에서 PPSX 형식 메타데이터를 편집하거나 보기 위한 Java 샘플 코드입니다.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java를 통해 PPSX 메타데이터 추출" h2="서버 측 API를 사용하여 PPSX 파일에서 메타데이터를 추가, 편집, 제거 또는 추출하는 자체 Java 앱을 빌드합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSX" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Java를 사용하여 PPSX 메타데이터를 추출하는 방법" %}}

 PPSX 파일 메타데이터를 가져오기 위해 다음을 사용합니다.
...
{{< blocks/products/pf/agp/feature-section-col title="Java를 통해 PPSX의 메타데이터를 추출하는 단계" >}}
...
getPresentationInfo()를 사용하여 PPSX 정보 가져오기
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="PPSX의 메타데이터 추출 - Java" offSpacer="" %}}
