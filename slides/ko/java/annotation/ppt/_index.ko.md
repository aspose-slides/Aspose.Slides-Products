---
title: Java를 사용하여 PPT 주석 제거
weight: 3630
url: /ko/java/annotation/ppt/ 
description: JSP/JSF 응용 프로그램 및 데스크톱 응용 프로그램용 Java Runtime Environment에서 PPT 형식 주석을 삭제하는 Java 샘플 코드입니다.
---
...
{{% blocks/products/pf/feature-page-section  h2="Java를 통해 PPT에서 주석 제거" %}}
...
{{% blocks/products/pf/agp/code-block title="PPT에서 주석 삭제 - Java" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Java를 통해 PPT에서 주석을 제거하는 방법" >}}
