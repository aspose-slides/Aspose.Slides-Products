---
title: Java에서 JPG를 PPTX로 변환
url: /ko/java/conversion/jpg-to-pptx/
keywords: JPG를 PPTX로, JPG를 PPTX, PowerPoint, JPG, PPTX, Java API, Java 라이브러리로 변환
description: Java에서 JPG를 PPTX로 변환합니다. Java 라이브러리 API를 사용하여 JPG 이미지를 PowerPoint로 변환
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Java에서 JPG를 PPTX로 변환" h2="Java 코드를 사용하여 JPG를 PPTX로 변환하기 위한 강력한 크로스 플랫폼 Java API" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides를 사용하여 JPG를 PPTX로 변환" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/ko/java/)는 PowerPoint 프레젠테이션, PDF, HTML 문서 및 기타 문서를 생성, 변환 및 조작하는 데 사용되는 강력한 Java 라이브러리입니다. 파일. JPG를 PPTX로 변환하면 본질적으로 JPG 이미지를 기반으로 하는 슬라이드가 포함된 PowerPoint 프레젠테이션을 만드는 것입니다.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Java에서 JPG를 PPTX로 변환" %}}
...
{{% blocks/products/pf/agp/code-block title="JPG를 PPTX로 변환하는 Java 코드" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Java에서 JPG를 PPTX로 변환하는 방법" >}}
