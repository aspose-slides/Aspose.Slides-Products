---
title: Java에서 HTML을 PPT로 변환
url: /ko/java/conversion/html-to-ppt/
keywords: HTML을 PPT로, HTML을 PPT로, PowerPoint, HTML, PPT, Java API, Java 라이브러리로 변환
description: Java에서 HTML을 PPT로 변환합니다. Java 라이브러리 API를 사용하여 HTML을 PowerPoint로 변환
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Java에서 HTML을 PPT로 변환" h2="Java 코드를 사용하여 HTML을 PPT로 변환하기 위한 강력한 크로스 플랫폼 Java API" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides를 사용하여 HTML을 PPT로 변환" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/ko/java/)는 PowerPoint 프레젠테이션, PDF, HTML 문서 및 기타 문서를 생성, 변환 및 조작하는 데 사용되는 강력한 Java 라이브러리입니다. 파일. HTML을 PPT로 변환하면 기본적으로 HTML 문서의 내용이 PowerPoint 프레젠테이션의 슬라이드로 이동됩니다.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Java에서 HTML을 PPT로 변환" %}}
...
{{% blocks/products/pf/agp/code-block title="HTML을 PPT로 변환하기 위한 Java 코드" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Java에서 HTML을 PPT로 변환하는 방법" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ko/java/conversion/jpg-to-ppt/" name="JPG TO PPTX" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ko/java/conversion/jpg-to-pptx/" name="JPG TO PPT" >}}
