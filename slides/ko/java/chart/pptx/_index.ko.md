---
title: Java를 통한 PPTX 문서 차트
weight: 160
url: /ko/java/chart/pptx/ 
description: JSP/JSF 응용 프로그램 및 데스크탑 응용 프로그램용 Java 런타임 환경에서 차트 또는 다이어그램을 PPTX 파일로 그리고 변환하는 Java 샘플 코드입니다.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="자바에서 PPTX 형식 차트" h2="Microsoft 또는 Adobe PDF와 같은 소프트웨어를 사용하지 않고 Java API용 서버측 Aspose.Slides를 사용하는 기본 및 고성능 PPTX 문서 차트." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Java를 사용하여 PPTX 파일 차트를 만드는 방법" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Java에서 PPTX 파일 차트를 만드는 단계" >}}
...
{{% blocks/products/pf/agp/code-block title="PPTX 파일 차트 생성 - 자바" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ko/java/chart/ppt/" name="PPT" description="마이크로소프트 파워포인트 97-2003" >}}
