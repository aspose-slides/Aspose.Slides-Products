---
title: PHP를 사용하여 PPSM 파일 병합
url: /ko/php-java/merger/ppsm/
keywords: PPSM 병합, PPSM 가입, PPSM 결합, PowerPoint, 프레젠테이션, PHP, Aspose
description: PHP에서 여러 PPSM 파일을 병합합니다.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="PHP에서 PPSM 파일 병합" h2="Microsoft 또는 Open Office, Adobe PDF와 같은 소프트웨어를 사용하지 않고 Microsoft PowerPoint 및 OpenOffice 프레젠테이션 파일을 생성, 병합, 검사 또는 변환할 수 있는 기능으로 응용 프로그램을 개발하는 데 도움이 되는 고속 및 교차 플랫폼 PHP API입니다." >}}

{{% blocks/products/pf/feature-page-section h2="PHP에서 PPSM 병합" %}}

[**Java를 통한 PHP용 Aspose.Slides**](https://products.aspose.com/slides/ko/php-java/)는 프레젠테이션 파일을 만들고 조작하기 위한 강력한 PHP 라이브러리입니다. 또한 여러 PPSM 프레젠테이션을 결합하는 유연한 방법을 제공합니다. 하나의 프레젠테이션을 다른 프레젠테이션에 병합하면 하나의 프레젠테이션에서 해당 슬라이드를 효과적으로 결합하여 하나의 파일을 얻는 것입니다. Aspose.Slides를 사용하면 서로 다른 방식으로 두 프레젠테이션을 병합할 수 있습니다. 품질이나 데이터 손실에 대해 걱정할 필요 없이 프레젠테이션을 모든 모양, 스타일, 텍스트, 서식, 주석, 애니메이션 등과 병합할 수 있습니다.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="PHP를 사용하여 PPSM 파일 병합" %}}
PowerPoint 프레젠테이션을 병합하려면 한 프레젠테이션에서 다른 프레젠테이션으로 슬라이드를 복제해야 합니다.

{{% blocks/products/pf/agp/code-block title="여러 PPSM을 단일 파일로 병합하기 위한 PHP 코드" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Aspose.Slides for PHP API를 사용하여 PPSM을 병합하는 방법" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="다음은 두 PPSM 파일을 병합하고 결과를 PHP에서 PPSM으로 저장하는 단계입니다." >}}
