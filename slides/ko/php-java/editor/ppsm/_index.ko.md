---
title: PHP에서 PPSM 편집
url: /ko/php-java/editor/ppsm/
keywords: PPSM 편집, PowerPoint 편집, PPSM, PowerPoint, PHP API, PHP 라이브러리
description: PHP에서 PPSM을 편집합니다. PHP 라이브러리 API를 사용하여 PPSM 파일 편집
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="PHP에서 PPSM 편집" h2="PHP 코드를 사용하여 PPSM 편집을 위한 고속 및 교차 플랫폼 PHP 라이브러리" >}}
...
{{% blocks/products/pf/feature-page-section  h2="PHP에서 PPSM 편집" %}}
[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/ko/php-java/)를 사용하면 몇 줄의 코드.

{{% blocks/products/pf/agp/code-block title="PPSM 편집을 위한 PHP 코드" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="PHP에서 PPSM을 편집하는 방법" >}}
