---
title: PHP에서 FODP 편집
url: /ko/php-java/editor/fodp/
keywords: FODP 편집, PowerPoint 편집, FODP, PowerPoint, PHP API, PHP 라이브러리
description: PHP에서 FODP을 편집합니다. PHP 라이브러리 API를 사용하여 FODP 파일 편집
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="PHP에서 FODP 편집" h2="PHP 코드를 사용하여 FODP 편집을 위한 고속 및 교차 플랫폼 PHP 라이브러리" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides를 사용하여 FODP 편집" %}}

[**Java를 통한 PHP용 Aspose.Slides**](https://products.aspose.com/slides/ko/php-java/)는 프레젠테이션을 조작하고 편집하는 데 사용되는 강력한 PHP 라이브러리입니다. 새 텍스트 줄을 추가하여 FODP 프레젠테이션을 편집할 수 있습니다. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="PHP에서 FODP 편집" %}}
[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/ko/php-java/)를 사용하면 몇 줄의 코드.

{{% blocks/products/pf/agp/code-block title="FODP 편집을 위한 PHP 코드" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="PHP에서 FODP을 편집하는 방법" >}}
