...
{{< blocks/products/pf/carousel-item h3="지원되는 파일 형식" description="Xamarin용 Aspose.Slides는 널리 사용되는 [프레젠테이션 형식](https://docs.aspose.com/slides/net/supported-file-formats/) 및 아래 나열된 내보내기 형식을 지원합니다." >}}
