...
url: /ko/cpp/conversion/png-to-pptx/
keywords: PNG를 PPTX로, PNG를 PPTX로, PowerPoint, PNG, PPTX, C++ API, C++ 라이브러리로 변환
description: C++에서 PNG를 PPTX로 변환합니다. C++ 라이브러리 API를 사용하여 PNG 이미지를 PowerPoint로 변환
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="C++에서 PNG를 PPTX로 변환" h2="C++ 코드를 사용하여 PNG를 PPTX로 변환하기 위한 강력한 크로스 플랫폼 C++ API" >}}

{{% blocks/products/pf/feature-page-section h2="Aspose.Slides를 사용하여 PNG를 PPTX로 변환" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/ko/cpp/)는 PowerPoint 프레젠테이션, PDF, HTML 문서 및 기타 문서를 생성, 변환 및 조작하는 데 사용되는 강력한 C++ 라이브러리입니다. 파일. PNG를 PPTX로 변환하면 본질적으로 PNG 이미지를 기반으로 하는 슬라이드가 포함된 PowerPoint 프레젠테이션을 만드는 것입니다.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="C++에서 PNG를 PPTX로 변환" %}}
[**Aspose.Slides for C++**](https://products.aspose.com/slides/ko/cpp/)를 사용하면 몇 줄의 코드만으로 PNG 이미지를 PowerPoint 프레젠테이션으로 변환할 수 있습니다.

{{% blocks/products/pf/agp/code-block title="PNG를 PPTX로 변환하기 위한 C++ 코드" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="C++에서 PNG를 PPTX로 변환하는 방법" >}}
