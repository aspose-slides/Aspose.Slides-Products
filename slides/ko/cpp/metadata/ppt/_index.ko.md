...
{{% blocks/products/pf/agp/content h2="C++를 사용하여 PPT 메타데이터를 얻는 방법" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="C++를 통해 PPT의 메타데이터를 추출하는 단계" >}}
...
{{% blocks/products/pf/agp/code-block title="PPT 메타데이터 추출 - C++" offSpacer="" %}}
