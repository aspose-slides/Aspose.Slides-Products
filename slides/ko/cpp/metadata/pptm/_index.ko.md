---
title: C++를 통해 PPTM 문서 메타데이터 편집 또는 보기
weight: 6050
url: /ko/cpp/metadata/pptm/ 
description: Windows 32비트, Windows 64비트 및 Linux 64비트용 C++ 런타임 환경에서 PPTM 파일 메타데이터를 편집하거나 보기 위한 C++ 예제 코드.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C++를 통해 PPTM 메타데이터 추출" h2="서버 측 API를 사용하여 PPTM 파일에서 메타데이터를 추가, 편집, 제거 또는 추출하는 고유한 C++ 앱을 빌드합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTM" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="C++를 사용하여 PPTM 메타데이터를 얻는 방법" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="C++를 통해 PPTM의 메타데이터를 추출하는 단계" >}}
...
{{% blocks/products/pf/agp/code-block title="PPTM의 메타데이터 추출 - C++" offSpacer="" %}}
