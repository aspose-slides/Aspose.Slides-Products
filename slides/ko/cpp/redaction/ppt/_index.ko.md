---
title: C++을(를) 사용하여 PPT 프레젠테이션 파일 수정
url: /ko/cpp/redaction/ppt/
keywords: PPT 수정, PPT에서 텍스트 찾기 및 바꾸기, PPT 프레젠테이션 업데이트
description: PPT Presentation에서 텍스트를 찾고 교체하기 위한 C++ 소스 코드.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C++을 사용하여 PPT 수정" h2="서버 측 API를 사용하여 프리젠테이션 파일에서 텍스트를 찾고 교체하는 나만의 C++ 앱을 빌드하세요. PPT 프레젠테이션의 콘텐츠, 댓글 또는 메타데이터에서 텍스트를 검색하고 바꾸는 방법을 알아보세요." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" fileiconsmall4="POT" fileiconsmall5="ppsx" >}}
