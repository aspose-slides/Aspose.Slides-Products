...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie ODP in BMP mit Java" %}}

 Um ODP in BMP zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von ODP in BMP über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können ODP-Dateien in nur wenigen Codezeilen problemlos in BMP konvertieren.
...
{{% blocks/products/pf/agp/code-block title="ODP-zu-BMP-Java-Konvertierungsquellcode" offSpacer="" %}}
