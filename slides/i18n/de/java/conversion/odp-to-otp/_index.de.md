...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie ODP in OTP mit Java" %}}

 Um ODP zu OTP zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von ODP in OTP über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können ODP-Dateien in nur wenigen Codezeilen problemlos in OTP konvertieren.
...
{{% blocks/products/pf/agp/code-block title="ODP-zu-OTP-Java-Konvertierungsquellcode" offSpacer="" %}}
