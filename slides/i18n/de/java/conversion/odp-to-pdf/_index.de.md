...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie ODP in PDF mit Java" %}}

 Um ODP in PDF zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von ODP in PDF über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können ODP-Dateien in nur wenigen Codezeilen problemlos in PDF konvertieren.
...
{{% blocks/products/pf/agp/code-block title="ODP-zu-PDF-Java-Konvertierungsquellcode" offSpacer="" %}}
