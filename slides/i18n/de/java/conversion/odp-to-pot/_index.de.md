...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie ODP in POT mit Java" %}}

 Um ODP in POT zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von ODP in POT über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können ODP-Dateien in nur wenigen Codezeilen problemlos in POT konvertieren.
...
{{% blocks/products/pf/agp/code-block title="ODP-zu-POT-Java-Konvertierungsquellcode" offSpacer="" %}}
