...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie ODP in PPT mit Java" %}}

 Um ODP in PPT zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von ODP in PPT über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können ODP-Dateien in nur wenigen Codezeilen problemlos in PPT konvertieren.
...
{{% blocks/products/pf/agp/code-block title="ODP-zu-PPT-Java-Konvertierungsquellcode" offSpacer="" %}}
