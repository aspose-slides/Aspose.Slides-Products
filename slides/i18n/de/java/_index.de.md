...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Erweiterte API-Funktionen für die Verarbeitung von Java-PowerPoint-Dokumenten</h2>

<p>Aspose.Slides for Java enthält eine Reihe erweiterter Funktionen, die Entwicklern die vollständige Kontrolle beim Programmieren mit Microsoft PowerPoint-Präsentationen in einer Java-Umgebung geben.</p>-->
   <h2 class="pr-ft">
...
<h2 class="h2title">Inhaltsformatierung von Folien</h2>

<p>Es ist möglich, Text und Formen auf Folien in einer Präsentation mit Aspose.Slides for Java API zu formatieren. Text wird über Textrahmen verwaltet, die Formen zugeordnet sind. Daher wird Text unter Verwendung von Absätzen und Abschnitten formatiert, die den Textrahmen zugeordnet sind. Sie können auch Attribute von Formelementen wie Position, Größe, Linie, Bild, Text und Füllung bearbeiten.</p>
...
{{< blocks/products/pf/slr-element name="Versionshinweise" href="https://docs.aspose.com/slides/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
