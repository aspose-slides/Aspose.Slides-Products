---
title: Entfernen Sie die PPTX-Anmerkung über Java
weight: 360
url: /de/java/annotation/pptx/ 
description: Java-Beispielcode zum Löschen von Annotationen im PPTX-Format in Java Runtime Environment für JSP/JSF-Anwendung und Desktop-Anwendungen.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Entfernen Sie Kommentare und Kommentarautoren aus PPTX über Java" h2="Erstellen Sie Ihre eigenen Java-Apps, um Kommentare und Autoren in Dokumentdateien mithilfe serverseitiger APIs zu bearbeiten." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="So kommentieren Sie eine PPTX-Datei mit Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Entfernen von Kommentaren aus PPTX über Java" %}}
...
1. Speichern Sie es im PPTX-Format
1. Kommentar an bestimmter Stelle entfernen
1. PPTX-Datei erneut speichern und vergleichen
...
{{% blocks/products/pf/agp/code-block title="Löschen Sie Anmerkungen aus PPTX - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/java/annotation/odp/" name="ODP" description="OpenDocument-Präsentationsformat" >}}
