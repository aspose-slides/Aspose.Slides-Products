---
title: Bearbeiten oder Anzeigen von PPTX-Dokumentmetadaten über C++
weight: 3950
url: /de/cpp/metadata/pptx/ 
description: C++-Beispielcode zum Bearbeiten oder Anzeigen von PPTX-Dateimetadaten in der C++-Laufzeitumgebung für Windows 32 Bit, Windows 64 Bit und Linux 64 Bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extrahieren Sie PPTX-Metadaten über C++" h2="Erstellen Sie Ihre eigenen C++-Apps zum Hinzufügen, Bearbeiten, Entfernen oder Extrahieren von Metadaten aus PPTX-Dateien mithilfe serverseitiger APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="So erhalten Sie PPTX-Metadaten mit C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Extrahieren Sie Metadaten von PPTX - C++" offSpacer="" %}}
