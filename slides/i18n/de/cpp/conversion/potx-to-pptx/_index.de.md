---
title: Konvertieren Sie POTX über eine C++-Anwendung in PPTX
weight: 5910
url: /de/cpp/conversion/potx-to-pptx/ 
description: Beispiel-C++-Konvertierungscode für das POTX-Dokument in das PPTX-Format. Verwenden Sie Beispielcode für die Batch-Konvertierung von POTX in PPTX in einer beliebigen C++-Anwendung.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie POTX über C++ in PPTX" h2="Leistungsstarke POTX-zu-PPTX-Konvertierung mithilfe der C++-Bibliothek ohne die Notwendigkeit einer Microsoft PowerPoint-Installation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-Entwickler können POTX-Dateien in nur wenigen Codezeilen problemlos in PPTX konvertieren.
...
{{% blocks/products/pf/agp/code-block title="POTX-zu-PPTX-C++-Konvertierungsquellcode" offSpacer="" %}}
