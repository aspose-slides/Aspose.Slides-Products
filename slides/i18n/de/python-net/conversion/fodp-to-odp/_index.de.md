...
Müssen Sie FODP-Dateien programmgesteuert in ODP konvertieren? Mit [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/python-net/) kann jeder Entwickler FODP mit nur wenigen Zeilen Python-Code in das ODP-Format konvertieren.
