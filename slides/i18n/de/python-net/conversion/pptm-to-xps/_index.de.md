...
Müssen Sie PPTM-Dateien programmgesteuert in XPS konvertieren? Mit [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/python-net/) kann jeder Entwickler mit nur wenigen Zeilen Python-Code PPTM in das XPS-Format konvertieren.
