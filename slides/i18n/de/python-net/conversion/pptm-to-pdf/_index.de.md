...
Müssen Sie PPTM-Dateien programmgesteuert in PDF konvertieren? Mit [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/python-net/) kann jeder Entwickler PPTM mit nur wenigen Zeilen Python-Code in das PDF-Format konvertieren.
