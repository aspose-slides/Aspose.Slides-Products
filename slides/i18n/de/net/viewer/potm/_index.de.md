---
title: Zeigen Sie POTM-Dateiformate über .NET an
weight: 3310
url: /de/net/viewer/potm/ 
description: C#-Quellcode zum Laden, Rendern und Anzeigen von POTM-Dokumenten auf .NET Framework-, .NET Core-, Windows Azure-, Mono- oder Xamarin-Plattformen.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="POTM-Dateibetrachter für .NET" h2="Zeigen Sie Präsentationsdateien wie POTM ohne Microsoft PowerPoint oder Office Automation an" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="So zeigen Sie die POTM-Datei mit C # an" %}}

 Um die POTM-Datei anzuzeigen, verwenden wir
...
{{< blocks/products/pf/agp/feature-section-col title="Schritte zum Anzeigen von POTM über C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Aspose.Slides macht es den Entwicklern leicht, die POTM-Datei mit nur wenigen Codezeilen anzuzeigen." >}}

{{< blocks/products/pf/agp/step-autogen >}}
Instanziieren Sie ein Präsentationsobjekt und laden Sie die POTM-Datei
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Speichern Sie die POTM-Präsentation im HTML-Format
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Rufen Sie Process.Start mit dem Pfad zum resultierenden HTML auf, um den POTM-Inhalt im Standardbrowser zu laden
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="C#-Beispielcode zum Anzeigen der POTM-Datei" offSpacer="" %}}
