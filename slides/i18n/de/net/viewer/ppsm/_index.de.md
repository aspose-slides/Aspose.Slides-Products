---
title: Zeigen Sie PPSM-Dateiformate über .NET an
weight: 4780
url: /de/net/viewer/ppsm/ 
description: C#-Quellcode zum Laden, Rendern und Anzeigen von PPSM-Dokumenten auf .NET Framework-, .NET Core-, Windows Azure-, Mono- oder Xamarin-Plattformen.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="PPSM-Dateibetrachter für .NET" h2="Zeigen Sie Präsentationsdateien wie PPSM ohne Microsoft PowerPoint oder Office Automation an" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSM" >}}
...
{{% blocks/products/pf/agp/content h2="So zeigen Sie die PPSM-Datei mit C # an" %}}

 Um die PPSM-Datei anzuzeigen, verwenden wir
...
{{< blocks/products/pf/agp/feature-section-col title="Schritte zum Anzeigen von PPSM über C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Aspose.Slides macht es den Entwicklern leicht, die PPSM-Datei mit nur wenigen Codezeilen anzuzeigen." >}}

{{< blocks/products/pf/agp/step-autogen >}}
Instanziieren Sie ein Präsentationsobjekt und laden Sie die PPSM-Datei
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Speichern Sie die PPSM-Präsentation im HTML-Format
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Rufen Sie Process.Start mit dem Pfad zum resultierenden HTML auf, um den PPSM-Inhalt im Standardbrowser zu laden
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="C#-Beispielcode zum Anzeigen der PPSM-Datei" offSpacer="" %}}
