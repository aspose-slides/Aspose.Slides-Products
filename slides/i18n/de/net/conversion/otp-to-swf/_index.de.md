---
title: Konvertieren Sie OTP in SWF über C#
weight: 1690
url: /de/net/conversion/otp-to-swf/ 
description: Beispielcode für die Konvertierung von OTP in SWF C#. Verwenden Sie den API-Beispielcode für die Batch-Konvertierung von OTP-Dateien in SWF innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie OTP in SWF über C#" h2="Exportieren Sie PowerPoint®-OTP-Dateien in SWF auf .NET Framework-, .NET Core-, Windows Azure-, Mono- oder Xamarin-Plattformen" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTP" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTP in SWF mit C#" %}}
 ...
 Um OTP in SWF zu konvertieren, verwenden wir
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET-Entwickler können OTP-Dateien in nur wenigen Codezeilen problemlos laden und in SWF konvertieren." >}}
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die OTP-zu-SWF-C#-Konvertierung" offSpacer="" %}}
