---
title: Konvertieren Sie OTP über C# in GIF
weight: 7750
url: /de/net/conversion/otp-to-gif/ 
description: Beispielcode für die C#-Konvertierung von OTP in GIF. Verwenden Sie den API-Beispielcode für die Batch-Konvertierung von OTP-Dateien in GIF innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie OTP über C# in GIF" h2="Exportieren Sie PowerPoint®-OTP-Dateien in GIF auf .NET Framework-, .NET Core-, Windows Azure-, Mono- oder Xamarin-Plattformen" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTP" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET-Entwickler können OTP-Dateien in nur wenigen Codezeilen problemlos laden und in GIF konvertieren." >}}
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die C#-Konvertierung von OTP in GIF" offSpacer="" %}}
