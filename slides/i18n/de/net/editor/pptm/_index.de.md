...
Um die PPTM-Datei zu bearbeiten, verwenden wir die API <a href="https://products.aspose.com/slides/net">Aspose.Slides for .NET</a>, die eine funktionsreiche und leistungsstarke API ist und benutzerfreundliche API für die C#-Plattform für jeden Editor. Öffnen Sie den <a href="https://www.nuget.org/packages/aspose.slides.net">NuGet</a>-Paketmanager, suchen Sie nach <b>Aspose.Slides</b> und installieren Sie es. Sie können auch den folgenden Befehl in der Paket-Manager-Konsole verwenden.
