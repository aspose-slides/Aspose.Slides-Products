---
title: Bearbeiten Sie POTM-Dateien über .NET
url: /de/net/editor/potm/ 
description: C#-Quellcode zum Bearbeiten von POTM-Dokumenten auf .NET Framework-, .NET Core-, Windows Azure-, Mono- oder Xamarin-Plattformen.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Bearbeiten Sie POTM-Formate in C#" h2="Native und leistungsstarke POTM-Dokumentbearbeitung mit serverseitigen Aspose.Slides für .NET-APIs, ohne die Verwendung von Software wie Microsoft oder Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="So bearbeiten Sie eine POTM-Datei mit C#" %}}

Um die POTM-Datei zu bearbeiten, verwenden wir die API <a href="https://products.aspose.com/slides/net">Aspose.Slides for .NET</a>, die eine funktionsreiche und leistungsstarke API ist und benutzerfreundliche API für die C#-Plattform für jeden Editor. Öffnen Sie den <a href="https://www.nuget.org/packages/aspose.slides.net">NuGet</a>-Paketmanager, suchen Sie nach <b>Aspose.Slides</b> und installieren Sie es. Sie können auch den folgenden Befehl in der Paket-Manager-Konsole verwenden.
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Bearbeiten von POTM-Dateien in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="POTM-Dateien bearbeiten – C#" offSpacer="" %}}
