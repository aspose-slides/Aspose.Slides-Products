...
{{% blocks/products/pf/agp/content h2="So extrahieren Sie PPTM-Metadaten mit C#" %}}
...
Instanziieren Sie die Präsentationsklasse mit dem Pfad zur PPTM-Datei
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Metadaten von PPTM extrahieren – C#" offSpacer="" %}}
