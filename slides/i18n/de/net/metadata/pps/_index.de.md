---
title: Anzeigen oder Bearbeiten von Metadaten von PPS-Dateien über .NET
weight: 7210
url: /de/net/metadata/pps/ 
description: C#-Quellcode zum Bearbeiten oder Anzeigen von Metadaten im PPS-Format auf .NET Framework-, .NET Core-, Windows Azure-, Mono- oder Xamarin-Plattformen.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="PPS-Metadaten über .NET extrahieren" h2="Erstellen Sie Ihre eigenen .NET-Apps zum Hinzufügen, Bearbeiten, Entfernen oder Extrahieren von Metadaten aus PPS-Dateien mithilfe serverseitiger APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPS" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="So extrahieren Sie PPS-Metadaten mit C#" %}}
...
Instanziieren Sie die Präsentationsklasse mit dem Pfad zur PPS-Datei
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Metadaten von PPS extrahieren – C#" offSpacer="" %}}
