...
weight: 910
url: /de/sharepoint/ 
description: SharePoint PowerPoint ist ein Aspose.Slides SharePoint zum Erstellen und Konvertieren von SharePoint PPT, SharePoint Slideshow, SharePoint Präsentation.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="SharePoint PowerPoint-Lösung" h2="Verwalten und konvertieren Sie PowerPoint-Präsentationen in SharePoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-sharepoint.svg" pfName="Aspose.Slides" subTitlepfName="for SharePoint" downloadUrl="https://downloads.aspose.com/slides/sharepoint" >}}
...
<p>
 Aspose.Slides for SharePoint zum Verwalten und Konvertieren von PowerPoint-Dateien in SharePoint. Aspose.Slides kann als SharePoint PowerPoint-Lösung problemlos gängige Microsoft-Präsentationsformate wie PPT, POT, PPS, PPTX, POTX und PPSX importieren und diese Formate in PDF-, TIFF- und XPS-Dateien exportieren. Verwenden Sie alle SharePoint-PPT-Funktionen, ohne dass eine Microsoft PowerPoint-Automatisierung erforderlich ist.
</p>

<p>
 Aspose.Slides for SharePoint funktioniert mit Windows SharePoint Services WSS 3.0 und Microsoft Office SharePoint Server 2007, 2010 & 2013.
</p>
...
{{< blocks/products/pf/carousel-item h3="Auf einen Blick" description="Eine Übersicht über Aspose.Slides für SharePoint" >}}
...
{{< blocks/products/pf/carousel-item h3="Plattformunabhängigkeit" description="Aspose.Slides for SharePoint funktioniert mit Microsoft Office SharePoint Server und Windows SharePoint Services." >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
...
{{< blocks/products/pf/carousel-item h3="Unterstützte Dateiformate" description="Aspose.Slides for SharePoint unterstützt die gängigsten [Dateiformate] für Präsentationen (https://docs.aspose.com/slides/sharepoint/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Funktionen der SharePoint-Präsentationskonvertierungs-App
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Konvertieren Sie PowerPoint-Dateien aus der SharePoint-Dokumentbibliothek
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Holen Sie sich den Standard-Tabellenhintergrund
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Die Größe stellt die Eigenschaft für das Blasendiagramm dar
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Ausblenden des linken Fensters mit Miniaturansichten der Folie in generierter PPT
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Externe Excel-Arbeitsmappen werden unterstützt
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Legen Sie den Arbeitsmappenpfad der externen Datenquelle des Diagramms fest
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Einschränken des Zugriffs auf das lokale Dateisystem beim Öffnen eines Dokuments
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Konvertieren Sie PowerPoint-Präsentationen in mehrere Formate
    </h2>
    <p>
     Aspose.Slides for SharePoint konvertiert Präsentationen aus Ihrer SharePoint-Dokumentbibliothek in viele gängige Dokumentaustauschformate. Aspose.Slides for SharePoint unterstützt gängige Präsentationsformate als Eingabeformate und kann in Präsentationsformate sowie PDF, TIFF und XPS exportieren.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for SharePoint ist als ZIP-Archiv verfügbar. Entpacken Sie die ZIP-Datei auf das lokale Laufwerk auf dem MOSS 7.0- oder WSS 3.0-Server und führen Sie setup.exe aus, um sie zur Verwendung zu installieren. So einfach ist das!
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Microsoft PowerPoint-Automatisierung – nicht erforderlich
    </h2>
    <p>
     Aspose.Slides for SharePoint basiert auf verwaltetem Code, der nie die Installation von Microsoft PowerPoint auf dem Computer erfordert, um mit der Konvertierung von PowerPoint-Dokumentformaten zu arbeiten. Es ist eine perfekte Microsoft PowerPoint-Automatisierungsalternative in Bezug auf unterstützte Funktionen, Sicherheit, Stabilität, Skalierbarkeit, Geschwindigkeit und Preis.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Dokumentation" href="https://docs.aspose.com/slides/sharepoint/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Warum Aspose.Slides für SharePoint?" tabId="success-stories" >}}
