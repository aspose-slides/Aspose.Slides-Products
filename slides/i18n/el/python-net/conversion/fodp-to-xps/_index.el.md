...
Θέλετε να μετατρέψετε αρχεία FODP σε XPS μέσω προγραμματισμού; Χρησιμοποιώντας το [*Aspose.Slides for Python μέσω .NET*](https://products.aspose.com/slides/python-net/) οποιοσδήποτε προγραμματιστής μπορεί να μετατρέψει το FODP σε μορφή XPS με λίγες μόνο γραμμές κώδικα Python.
