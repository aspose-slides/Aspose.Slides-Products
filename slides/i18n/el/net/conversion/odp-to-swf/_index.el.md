...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε το ODP σε SWF χρησιμοποιώντας C#" %}}
 ...
 Για να μετατρέψουμε το ODP σε SWF, θα χρησιμοποιήσουμε
...
{{< blocks/products/pf/agp/steps-block-autogen name="Οι προγραμματιστές .NET μπορούν εύκολα να φορτώσουν και να μετατρέψουν αρχεία ODP σε SWF σε λίγες μόνο γραμμές κώδικα." >}}
...
{{% blocks/products/pf/agp/code-block title="Αυτό το δείγμα κώδικα δείχνει τη μετατροπή ODP σε SWF C#" offSpacer="" %}}
