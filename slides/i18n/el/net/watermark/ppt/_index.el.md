---
title: Υδατογράφημα έγγραφο PPT μέσω .NET
weight: 7740
url: /el/net/watermark/ppt/ 
description: Πηγαίος κώδικας C# για προσθήκη ή αφαίρεση υδατογραφήματος σε αρχείο PPT σε πλατφόρμες .NET Framework, .NET Core, Windows Azure, Mono ή Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Προσθήκη υδατογραφήματος κειμένου στο PPT μέσω C#" h2="Δημιουργήστε τις δικές σας εφαρμογές .NET για να υδατογραφήσετε αρχεία PPT χρησιμοποιώντας API από την πλευρά του διακομιστή." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
