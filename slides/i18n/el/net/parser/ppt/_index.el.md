---
title: Εξαγωγή κειμένου και εικόνων από έγγραφο PPT μέσω .NET
weight: 70
url: /el/net/parser/ppt/ 
description: Πηγαίος κώδικας C# για εξαγωγή κειμένου και εικόνων από αρχείο PPT σε πλατφόρμες .NET Framework, .NET Core, Windows Azure, Mono ή Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Ανάλυση μορφών PPT σε C#" h2="Εγγενής ανάλυση εγγράφων PPT υψηλής απόδοσης με χρήση Aspose.Slides από την πλευρά του διακομιστή για API .NET, χωρίς τη χρήση λογισμικού όπως η Microsoft ή το Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να αναλύσετε το αρχείο PPT χρησιμοποιώντας C#" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Βήματα για την ανάλυση αρχείων PPT σε C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Μια βασική ανάλυση εγγράφων με [Aspose.Slides for .NET](https://products.aspose.com/slides/net) API μπορεί να γίνει με λίγες μόνο γραμμές κώδικα." >}}
...
{{% blocks/products/pf/agp/code-block title="Ανάλυση αρχείων PPT - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/net/parser/odp/" name="ODP" description="Μορφή παρουσίασης OpenDocument" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/net/parser/pptx/" name="PPTX" description="Ανοίξτε τη μορφή παρουσίασης XML" >}}
