---
title: Καταργήστε τον σχολιασμό PPTX μέσω .NET
weight: 6550
...
{{< blocks/products/pf/i18n/upper-banner h1="Κατάργηση σχολίων και συντακτών σχολίων από το PPTX μέσω C#" h2="Δημιουργήστε τις δικές σας εφαρμογές .NET για να χειρίζεστε σχόλια και συντάκτες σε αρχεία εγγράφων χρησιμοποιώντας API από την πλευρά του διακομιστή." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να σχολιάσετε αρχείο PPTX χρησιμοποιώντας C#" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Κατάργηση σχολίων από το PPTX μέσω C#" >}}
...
{{% blocks/products/pf/agp/code-block title="Διαγραφή σχολιασμών από PPTX - C#" offSpacer="" %}}
