...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Προηγμένες δυνατότητες API επεξεργασίας εγγράφων Java PowerPoint</h2>

<p>Το Aspose.Slides για Java ενσωματώνει μια σειρά από προηγμένες δυνατότητες που δίνουν στους προγραμματιστές πλήρη έλεγχο κατά τον προγραμματισμό με παρουσιάσεις του Microsoft PowerPoint σε περιβάλλον Java.</p>-->
   <h2 class="pr-ft">
...
<h2 class="h2title">Μορφοποίηση περιεχομένου διαφανειών</h2>

<p>Είναι δυνατή η μορφοποίηση κειμένου και σχημάτων σε διαφάνειες σε μια παρουσίαση χρησιμοποιώντας το Aspose.Slides for Java API. Η διαχείριση του κειμένου γίνεται μέσω πλαισίων κειμένου που σχετίζονται με σχήματα. Ως εκ τούτου, το κείμενο μορφοποιείται χρησιμοποιώντας παραγράφους και τμήματα που σχετίζονται με τα πλαίσια κειμένου. Μπορείτε επίσης να χειριστείτε χαρακτηριστικά του στοιχείου σχήματος όπως θέση, μέγεθος, γραμμή, εικόνα, κείμενο και γέμισμα.</p>
