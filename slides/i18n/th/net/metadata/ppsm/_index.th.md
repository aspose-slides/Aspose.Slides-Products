---
title: ดูหรือแก้ไขข้อมูลเมตาของไฟล์ PPSM ผ่าน .NET
weight: 8130
url: /th/net/metadata/ppsm/ 
description: ซอร์สโค้ด C# เพื่อแก้ไขหรือดูข้อมูลเมตารูปแบบ PPSM บน .NET Framework, .NET Core, Windows Azure, Mono หรือ Xamarin Platforms
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="แยกข้อมูลเมตา PPSM ผ่าน .NET" h2="สร้างแอป .NET ของคุณเองเพื่อเพิ่ม แก้ไข ลบ หรือแยกข้อมูลเมตาจากไฟล์ PPSM โดยใช้ API ฝั่งเซิร์ฟเวอร์" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแยกข้อมูลเมตา PPSM โดยใช้ C #" %}}

 ในการแยกข้อมูลเมตา PPSM เราจะใช้
...
{{< blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการดึงข้อมูลเมตาของ PPSM ผ่าน C#" >}}
...
สร้างอินสแตนซ์ของคลาสการนำเสนอด้วยพาธไปยังไฟล์ PPSM
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="แยกข้อมูลเมตาของ PPSM - C#" offSpacer="" %}}
