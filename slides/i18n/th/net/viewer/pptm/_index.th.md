---
title: ดูรูปแบบไฟล์ PPTM ผ่าน .NET
weight: 4190
url: /th/net/viewer/pptm/ 
description: ซอร์สโค้ด C# เพื่อโหลด แสดงผล และแสดงเอกสาร PPTM บน .NET Framework, .NET Core, Windows Azure, Mono หรือ Xamarin Platforms
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="โปรแกรมดูไฟล์ PPTM สำหรับ .NET" h2="ดูไฟล์นำเสนอ เช่น PPTM โดยไม่ต้องใช้ Microsoft PowerPoint หรือ Office Automation" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTM" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีดูไฟล์ PPTM โดยใช้ C#" %}}

 ในการดูไฟล์ PPTM เราจะใช้
...
{{< blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการดู PPTM ผ่าน C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Aspose.Slides ช่วยให้นักพัฒนาสามารถดูไฟล์ PPTM ได้ง่ายด้วยโค้ดเพียงไม่กี่บรรทัด" >}}

{{< blocks/products/pf/agp/step-autogen >}}
สร้างอินสแตนซ์วัตถุการนำเสนอและโหลดไฟล์ PPTM
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
บันทึกงานนำเสนอ PPTM ในรูปแบบ HTML
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
กระบวนการเรียก เริ่มต้นด้วยเส้นทางไปยัง HTML ที่เป็นผลลัพธ์เพื่อโหลดเนื้อหา PPTM ในเบราว์เซอร์เริ่มต้น
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="โค้ดตัวอย่าง C# เพื่อดูไฟล์ PPTM" offSpacer="" %}}
