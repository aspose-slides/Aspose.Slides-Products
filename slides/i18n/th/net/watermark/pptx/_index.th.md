---
title: เอกสารลายน้ำ PPTX ผ่าน .NET
weight: 5590
url: /th/net/watermark/pptx/ 
description: ซอร์สโค้ด C# เพื่อเพิ่มหรือลบลายน้ำให้กับไฟล์ PPTX บน .NET Framework, .NET Core, Windows Azure, Mono หรือ Xamarin Platforms
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="เพิ่มลายน้ำข้อความไปยัง PPTX ผ่าน C #" h2="สร้างแอป .NET ของคุณเองเพื่อใส่ลายน้ำไฟล์ PPTX โดยใช้ API ฝั่งเซิร์ฟเวอร์" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
