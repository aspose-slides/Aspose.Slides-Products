...
ในการแก้ไขไฟล์ POTX เราจะใช้ <a href="https://products.aspose.com/slides/net">Aspose.Slides for .NET</a> API ซึ่งเป็นคุณลักษณะที่มีประสิทธิภาพและทรงพลัง และ API ที่ใช้งานง่ายสำหรับแพลตฟอร์ม C# สำหรับตัวแก้ไขใดๆ เปิด <a href="https://www.nuget.org/packages/aspose.slides.net">NuGet</a> package manager ค้นหา <b>Aspose.Slides</b> และติดตั้ง คุณยังสามารถใช้คำสั่งต่อไปนี้จาก Package Manager Console
