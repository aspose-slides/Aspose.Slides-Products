---
title: ป้องกันและล็อกเอกสาร PPTX ผ่าน .NET
weight: 5000
url: /th/net/protect/pptx/ 
description: ซอร์สโค้ด C# เพื่อล็อกไฟล์ PPTX โดยใช้รหัสผ่านบน .NET Framework, .NET Core, Windows Azure, Mono หรือ Xamarin Platforms
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="เข้ารหัสไฟล์ PPTX ผ่าน C#" h2="งานนำเสนอ PowerPoint ที่ป้องกันด้วยรหัสผ่านรวมถึงรูปแบบ PPTX โดยใช้ .NET Library" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีป้องกันไฟล์ PPTX โดยใช้ C #" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="ปกป้อง PPTX ผ่าน C#" >}}
...
โหลด PPTX ด้วยตัวอย่างการนำเสนอ
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/net/protect/odp/" name="ODP" description="รูปแบบการนำเสนอ OpenDocument" >}}
