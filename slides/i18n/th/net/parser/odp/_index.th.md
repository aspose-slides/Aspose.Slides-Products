---
title: แยกข้อความและรูปภาพจากเอกสาร ODP ผ่าน .NET
weight: 3070
url: /th/net/parser/odp/ 
description: ซอร์สโค้ด C# เพื่อแยกข้อความและรูปภาพจากไฟล์ ODP บน .NET Framework, .NET Core, Windows Azure, Mono หรือ Xamarin Platforms
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="แยกวิเคราะห์รูปแบบ ODP ใน C #" h2="การแยกวิเคราะห์เอกสาร ODP ดั้งเดิมและประสิทธิภาพสูงโดยใช้ Aspose.Slides ฝั่งเซิร์ฟเวอร์สำหรับ .NET API โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Adobe PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแยกไฟล์ ODP โดยใช้ C #" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแยกวิเคราะห์ไฟล์ ODP ใน C#" >}}
...
{{% blocks/products/pf/agp/code-block title="แยกไฟล์ ODP - C #" offSpacer="" %}}
