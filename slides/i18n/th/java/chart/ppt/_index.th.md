...
{{% blocks/products/pf/agp/content h2="วิธีสร้างแผนภูมิไฟล์ PPT โดยใช้ Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสร้างแผนภูมิไฟล์ PPT ใน Java" >}}
...
{{% blocks/products/pf/agp/code-block title="สร้างแผนภูมิไฟล์ PPT - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/java/chart/pptx/" name="PPTX" description="เปิดรูปแบบการนำเสนอ XML" >}}
