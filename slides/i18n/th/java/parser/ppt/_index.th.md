...
{{< blocks/products/pf/agp/steps-block-autogen name="การแยกวิเคราะห์เอกสารพื้นฐานด้วย API ของ [Aspose.Slides for Java](https://products.aspose.com/slides/java) สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/java/parser/odp/" name="ODP" description="รูปแบบการนำเสนอ OpenDocument" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/java/parser/pptx/" name="PPTX" description="เปิดรูปแบบการนำเสนอ XML" >}}
