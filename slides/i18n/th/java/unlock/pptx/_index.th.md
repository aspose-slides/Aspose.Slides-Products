---
title: ปลดล็อกเอกสาร PPTX ผ่าน Java
weight: 4970
url: /th/java/unlock/pptx/ 
description: โค้ดตัวอย่าง Java เพื่อปลดล็อกไฟล์ PPTX ที่ป้องกันด้วยรหัสผ่านบน Java Runtime Environment สำหรับแอปพลิเคชัน JSP/JSF และแอปพลิเคชันเดสก์ท็อป
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ปลดล็อกไฟล์ PPTX ผ่าน Java" h2="ลบการป้องกันจากงานนำเสนอ PowerPoint รวมถึงไฟล์ PPTX โดยใช้ Java Library" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีลบไฟล์ป้องกัน PPTX โดยใช้ Java" %}}

 เพื่อปลดล็อกไฟล์ PPTX เราจะใช้
...
{{< blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการปลดล็อก PPTX ผ่าน Java" >}}
...
{{% blocks/products/pf/agp/code-block title="ปลดล็อกไฟล์ PPTX ผ่าน C #" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/java/unlock/odp/" name="ODP" description="รูปแบบการนำเสนอ OpenDocument" >}}
