---
title: ค้นหาและแทนที่ข้อความในเอกสาร ODP ผ่าน Java
weight: 240
url: /th/java/redaction/odp/ 
description: โค้ดตัวอย่าง Java เพื่อแก้ไขข้อมูลที่ละเอียดอ่อนในไฟล์ ODP บน Java Runtime Environment สำหรับแอปพลิเคชัน JSP/JSF และแอปพลิเคชันเดสก์ท็อป
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="แก้ไขรูปแบบ ODP ใน Java" h2="ข้อมูลการแก้ไขที่ละเอียดอ่อนของเอกสาร ODP ดั้งเดิมและมีประสิทธิภาพสูงโดยใช้ Aspose ฝั่งเซิร์ฟเวอร์ สไลด์สำหรับ Java API โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Adobe PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="วิธี Redact ไฟล์ ODP โดยใช้ Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการ Redact ไฟล์ ODP ใน Java" >}}
...
{{% blocks/products/pf/agp/code-block title="แก้ไขไฟล์ ODP - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/th/java/redaction/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
