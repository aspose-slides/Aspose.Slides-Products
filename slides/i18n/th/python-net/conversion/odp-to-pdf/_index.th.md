...
ต้องการแปลงไฟล์ ODP เป็น PDF โดยทางโปรแกรมหรือไม่ การใช้ [*Aspose.Slides สำหรับ Python ผ่าน .NET*](https://products.aspose.com/slides/python-net/) นักพัฒนาซอฟต์แวร์ทุกคนสามารถแปลง ODP เป็นรูปแบบ PDF ด้วยโค้ด Python เพียงไม่กี่บรรทัด
