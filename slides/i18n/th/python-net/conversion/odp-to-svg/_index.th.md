---
title: แปลง ODP เป็น SVG ใน Python
weight: 410
url: /th/python-net/conversion/odp-to-svg/ 
keywords: "Convert, PowerPoint, ODP, SVG, Presentation, Python"
description: โค้ดตัวอย่างสำหรับการแปลง ODP เป็น SVG Python ใช้ PowerPoint Python API สำหรับการแปลงไฟล์ ODP แบบกลุ่มเป็นไฟล์ SVG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="แปลง ODP เป็น SVG ใน Python" h2="ไลบรารี PowerPoint Python อันทรงพลังสำหรับการแปลง ODP เป็น SVG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="แปลง ODP เป็น SVG ใน Python" %}}

ต้องการแปลงไฟล์ ODP เป็น SVG โดยทางโปรแกรมหรือไม่ การใช้ [*Aspose.Slides สำหรับ Python ผ่าน .NET*](https://products.aspose.com/slides/python-net/) นักพัฒนาซอฟต์แวร์ทุกคนสามารถแปลง ODP เป็นรูปแบบ SVG ด้วยโค้ด Python เพียงไม่กี่บรรทัด

ในฐานะที่เป็น API การประมวลผลการนำเสนอที่ทันสมัย ​​Aspose.Slides สำหรับ Python จะสร้าง SVG จาก ODP อย่างรวดเร็ว ทดสอบคุณภาพของการแปลง ODP เป็น SVG ใน [เบราว์เซอร์](https://products.aspose.app/slides/conversion) ของคุณ Aspose ไลบรารี PowerPoint PPTX ช่วยให้คุณสามารถแปลงไฟล์ ODP เป็นรูปแบบยอดนิยมได้มากมาย
...
{{< blocks/products/pf/agp/feature-section-col title="วิธีแปลง ODP เป็น SVG ใน Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="นี่คือขั้นตอนในการแปลงไฟล์ ODP เป็น SVG โดยใช้ Python" >}}
...
{{% blocks/products/pf/agp/code-block title="โค้ดตัวอย่างนี้แสดงการแปลง ODP เป็น SVG Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="บันทึก ODP เป็น SVG ใน Python" %}}
ใช้แอปฟรีเพื่อดูการสาธิตกระบวนการแปลง ODP เป็น SVG 
{{% /blocks/products/pf/agp/content %}}
