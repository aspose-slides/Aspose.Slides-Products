...
<p class="col-lg-10">Excel 차트를 슬라이드에 OLE 개체로 포함</p>

</div>

<div class="col-lg-4"><em class="fa fa-print  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">연결된 Ole 개체 관리</p>
...
<p class="col-lg-10">프레젠테이션의 맞춤형 인쇄</p>
...
<h2 class="h2title">새로운 기능의 지속적인 통합</h2>

<p>기존 기능으로 제한되지 않습니다. 우리 제품 팀은 지속적으로 더 많은 기능을 추가하고 있으며 모든 새 버전은 이전 버전에 비해 더 많은 기능을 제공합니다. 원하는 기능이 누락된 경우 새 기능 요청을 보낼 수도 있습니다. 다음은 최신 기능의 몇 가지 선택 목록입니다.</p>

<ul>

<li>텍스트가 없는 모양의 래스터화 또는 벡터화.</li>

<li>SVG 이미지를 모양으로 변환합니다.</li>

<li>기본 테이블 배경을 얻습니다.</li>

<li>문서를 열 때 로컬 파일 시스템 액세스를 제한합니다.</li>

<li>HTML로 저장할 때 인코딩 메타 태그를 추가합니다.</li>

<li>HTML로 저장할 때 SVG 태그의 너비 및 높이 속성을 제거하기 위한 설정입니다.</li>

<li>Support for

<ul>

<li>댓글 답장, Office 365 및 외부 Excel 통합 문서.</li>

<li>크기는 거품형 차트의 속성을 나타냅니다.</li>

<li>생성된 PPT에서 왼쪽 슬라이드 축소판 창을 숨깁니다.</li>

<li>깔때기형 차트, 2D 맵 차트 및 차트 외부 데이터 소스 통합 문서 경로 설정.</li>

<li>OpenDocument 암호화, 모프 전환 및 텍스트 형광펜 기능.</li>

<li>그림자 효과에 대한 투명도 속성을 설정합니다.</li>

<li>시리즈 데이터 레이블에 대한 설명선 모양 설정.</li>

<li>텍스트 상자 단락으로 효과를 얻습니다.</li>

<li>렌더링 모양 부드러운 가장자리(EffectFormat) 효과.</li>

<li>피벗 테이블의 ChartData SetRange.</li>

</ul>

</li>

<li>다중 페이지 Tiff 형식, 메타파일 형식 플러스 확장(EMF+) 및 Strict Open XML 형식을 구현합니다.</li>

<li>작성자가 없는 ODP 형식에서 주석을 렌더링합니다.</li>

<li>Strict Open XML 형식 준수로 직렬화를 구현합니다.</li>
...
<h2 class="h2title">SmartArt 도형 처리</h2>

<p>C++용 Aspose.Slides는 SmartArt 모양을 처음부터 쉽게 만들 수 있을 뿐만 아니라 슬라이드에서 기존 SmartArt 모양에 액세스, 조작 또는 제거하는 기능을 제공합니다. 또한 스타일, 색상 및 레이아웃 설정과 같은 SmartArt 모양의 서식을 지정할 수도 있습니다.</p>
