---
title: .NET을 통해 PPTM 파일 편집
url: /ko/net/editor/pptm/ 
description: .NET Framework, .NET Core, Windows Azure, Mono 또는 Xamarin 플랫폼에서 PPTM 문서를 편집하는 C# 소스 코드.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C#에서 PPTM 형식 편집" h2="Microsoft 또는 Adobe PDF와 같은 소프트웨어를 사용하지 않고 .NET API용 서버 측 Aspose.Slides를 사용하여 기본 및 고성능 PPTM 문서 편집." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 PPTM 파일을 편집하는 방법" %}}

PPTM 파일을 편집하기 위해 우리는 기능이 풍부하고 강력한 <a href="https://products.aspose.com/slides/ko/net">Aspose.Slides for .NET</a> API를 사용할 것입니다. 모든 편집기에서 사용하기 쉬운 C# 플랫폼용 API입니다. <a href="https://www.nuget.org/packages/aspose.slides.net">NuGet</a> 패키지 관리자를 열고 <b>Aspose.Slides</b>를 검색하여 설치합니다. 패키지 관리자 콘솔에서 다음 명령을 사용할 수도 있습니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 PPTM 파일을 편집하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="PPTM 파일 편집 - C#" offSpacer="" %}}
