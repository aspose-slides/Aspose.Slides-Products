...
OTP 파일을 편집하기 위해 우리는 기능이 풍부하고 강력한 <a href="https://products.aspose.com/slides/net">Aspose.Slides for .NET</a> API를 사용할 것입니다. 모든 편집기에서 사용하기 쉬운 C# 플랫폼용 API입니다. <a href="https://www.nuget.org/packages/aspose.slides.net">NuGet</a> 패키지 관리자를 열고 <b>Aspose.Slides</b>를 검색하여 설치합니다. 패키지 관리자 콘솔에서 다음 명령을 사용할 수도 있습니다.
