---
title: C#을 통해 POTX를 PPSX로 변환
weight: 2830
url: /ko/net/conversion/potx-to-ppsx/ 
description: POTX에서 PPSX로의 C# 변환을 위한 샘플 코드. VB.NET, Asp.NET 또는 모든 .NET 기반 응용 프로그램 내에서 배치 POTX 파일을 PPSX로 변환하는 API 예제 코드를 사용합니다.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C#을 통해 POTX를 PPSX로 변환" h2="PowerPoint® POTX 파일을 .NET Framework, .NET Core, Windows Azure, Mono 또는 Xamarin 플랫폼의 PPSX로 내보내기" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 POTX를 PPSX로 변환하는 방법" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="C#을 통해 POTX를 PPSX로 변환하는 단계" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET 개발자는 몇 줄의 코드로 POTX 파일을 PPSX로 쉽게 로드 및 변환할 수 있습니다." >}}
...
{{% blocks/products/pf/agp/code-block title="이 샘플 코드는 POTX에서 PPSX C#으로의 변환을 보여줍니다." offSpacer="" %}}
