---
title: C#을 통해 PPTM을 HTML로 변환
weight: 6000
url: /ko/net/conversion/pptm-to-html/ 
description: PPTM에서 HTML C#으로의 변환을 위한 샘플 코드입니다. VB.NET, Asp.NET 또는 모든 .NET 기반 응용 프로그램 내에서 배치 PPTM 파일을 HTML로 변환하는 API 예제 코드를 사용합니다.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C#을 통해 PPTM을 HTML로 변환" h2=".NET Framework, .NET Core, Windows Azure, Mono 또는 Xamarin 플랫폼에서 PowerPoint® PPTM 파일을 HTML로 내보내기" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTM" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 PPTM을 HTML로 변환하는 방법" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="C#을 통해 PPTM을 HTML로 변환하는 단계" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET 개발자는 몇 줄의 코드로 PPTM 파일을 쉽게 로드하고 HTML로 변환할 수 있습니다." >}}
...
{{% blocks/products/pf/agp/code-block title="이 샘플 코드는 PPTM에서 HTML C#으로의 변환을 보여줍니다." offSpacer="" %}}
