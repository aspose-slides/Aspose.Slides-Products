---
title: .NET을 통해 ODP 문서에서 텍스트 및 이미지 추출
weight: 3070
url: /ko/net/parser/odp/ 
description: .NET Framework, .NET Core, Windows Azure, Mono 또는 Xamarin 플랫폼의 ODP 파일에서 텍스트와 이미지를 추출하는 C# 소스 코드.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C#에서 ODP 형식 구문 분석" h2="Microsoft 또는 Adobe PDF와 같은 소프트웨어를 사용하지 않고 .NET API용 서버측 Aspose.Slides를 사용하여 기본 및 고성능 ODP 문서 구문 분석." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 ODP 파일을 구문 분석하는 방법" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/net/parser/ppt/" name="PPT" description="마이크로소프트 파워포인트 97-2003" >}}
