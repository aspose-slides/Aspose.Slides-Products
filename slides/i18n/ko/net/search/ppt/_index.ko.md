---
title: C#을 통해 열지 않고 PPT 문서 검색
weight: 6250
url: /ko/net/search/ppt/ 
description: .NET Framework, .NET Core, Windows Azure, Mono 또는 Xamarin 플랫폼의 PPT 파일에서 패턴이 있는 단어를 검색하는 C# 소스 코드.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C#에서 PPT 형식 검색" h2="Microsoft 또는 Adobe PDF와 같은 소프트웨어를 사용하지 않고 .NET API용 서버측 Aspose.Slides를 사용하여 기본 및 고성능 PPT 문서 검색." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 PPT 파일을 검색하는 방법" %}}

 PPT 파일을 검색하기 위해, 우리는
 [.NET용 Aspose.Slides](https://products.aspose.com/slides/net)
 기능이 풍부하고 강력하며 사용하기 쉬운 Microsoft PowerPoint 문서 검색 API인 C# 플랫폼용 API입니다. 열려 있는
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/net/search/pptx/" name="PPTX" description="Open XML 프레젠테이션 형식" >}}
