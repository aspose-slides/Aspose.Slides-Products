---
title: .NET을 통해 ODP 문서 잠금 해제
weight: 5780
url: /ko/net/unlock/odp/ 
description: .NET Framework, .NET Core, Windows Azure, Mono 또는 Xamarin 플랫폼에서 암호로 보호된 ODP 파일의 잠금을 해제하는 C# 소스 코드.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C#을 통해 ODP 프레젠테이션 잠금 해제" h2=".NET 라이브러리를 사용하여 ODP에서 보호를 제거합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 ODP 파일을 잠금 해제하는 방법" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="C#을 통해 ODP 잠금 해제" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ko/net/unlock/pptx/" name="PPTX" description="Open XML 프레젠테이션 형식" >}}
