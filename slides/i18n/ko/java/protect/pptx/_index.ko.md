---
title: Java를 통해 PPTX 문서 보호 및 잠금
weight: 6710
url: /ko/java/protect/pptx/ 
description: JSP/JSF 응용 프로그램 및 데스크탑 응용 프로그램용 Java Runtime Environment에서 암호를 사용하여 PPTX 파일을 잠그는 Java 샘플 코드입니다.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java를 통해 PPTX 파일 암호화" h2=".NET 라이브러리를 사용하여 PPTX 형식을 포함한 PowerPoint 프레젠테이션을 암호로 보호합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Java를 사용하여 PPTX 파일을 보호하는 방법" %}}

 PPTX 파일을 보호하기 위해
 [자바용 Aspose.Slides](https://products.aspose.com/slides/java)
 기능이 풍부하고 강력하며 사용하기 쉬운 Java 플랫폼용 암호화 API인 API입니다. 에서 직접 최신 버전을 다운로드할 수 있습니다.
...
{{< blocks/products/pf/agp/feature-section-col title="Java를 통해 PPTX 파일을 보호하는 단계" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
비밀번호 설정 getProtectionManager().encrypt(.) 메소드
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
PPTX 형식으로 보호된 프레젠테이션 저장
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/other-supported-section title="기타 지원되는 보호 문서" subTitle="Java를 사용하면 다음을 포함한 다른 파일을 보호할 수 있습니다." >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/java/protect/odp/" name="ODP" description="OpenDocument 프레젠테이션 형식" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/java/protect/ppt/" name="PPT" description="마이크로소프트 파워포인트 97-2003" >}}
