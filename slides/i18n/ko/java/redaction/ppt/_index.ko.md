...
{{% blocks/products/pf/agp/content h2="Java를 사용하여 PPT 파일을 수정하는 방법" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Java에서 PPT 파일을 수정하는 단계" >}}
...
{{% blocks/products/pf/agp/code-block title="PPT 파일 수정 - 자바" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ko/java/redaction/odp/" name="ODP" description="OpenDocument 프레젠테이션 형식" >}}
