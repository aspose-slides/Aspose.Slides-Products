---
title: Java를 통해 POTX를 XPS로 변환
weight: 8150
url: /ko/java/conversion/potx-to-xps/ 
description: POTX 형식을 XPS 파일로 변환하는 샘플 Java 변환 코드. 이 예제 코드를 사용하여 웹 또는 데스크탑 Java 기반 응용 프로그램 내에서 PowerPoint 및 OpenOffice 프레젠테이션을 XPS로 내보낼 수 있습니다.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java를 통해 POTX를 XPS로 변환" h2="온프레미스 Java 라이브러리를 사용하여 단일 또는 여러 페이지를 XPS로 변환하는 POTX에서 XPS Java 변환." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="Java를 사용하여 POTX를 XPS로 변환하는 방법" %}}

 POTX를 XPS로 렌더링하려면 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Java를 통해 POTX를 XPS로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

 Java 개발자는 몇 줄의 코드로 POTX 파일을 XPS로 쉽게 변환할 수 있습니다.
...
{{% blocks/products/pf/agp/code-block title="POTX에서 XPS Java 변환 소스 코드" offSpacer="" %}}
