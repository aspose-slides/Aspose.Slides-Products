---
title: Java를 통해 POTM 파일 병합
weight: 6620
url: /ko/java/merger/potm/ 
description: JSP/JSF 애플리케이션 및 데스크탑 애플리케이션용 Java Runtime Environment에서 POTM 문서를 결합하는 Java 샘플 코드입니다.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java에서 POTM 형식 병합" h2="서버측 Java API를 사용한 기본 POTM 문서 병합." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="Java를 사용하여 POTM 파일을 병합하는 방법" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Java에서 POTM 파일을 병합하는 단계" >}}
...
Presentation 클래스의 인스턴스가 있는 첫 번째 POTM 파일을 로드합니다.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Presentation 클래스의 인스턴스가 있는 두 번째 POTM 문서를 로드합니다.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
두 번째 POTM 파일의 각 슬라이드를 반복합니다.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="POTM 파일 병합 - 자바" offSpacer="" %}}
