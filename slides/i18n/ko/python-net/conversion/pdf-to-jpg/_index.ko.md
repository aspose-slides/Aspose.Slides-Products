...
프로그래밍 방식으로 PDF 파일을 JPG로 변환해야 합니까? [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/ko/python-net/)을 사용하면 모든 개발자가 몇 줄의 Python 코드로 PDF를 JPG 형식으로 변환할 수 있습니다.
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        ...
        sectionTitle="PDF을 JPG로 변환하는 무료 앱" 
        sectionDescription="[PDF을 JPG로 변환하려면 무료 앱을 사용해보십시오.](https://products.aspose.app/slides/import/)" 
    >}}
