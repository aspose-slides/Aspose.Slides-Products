---
title: 通过 Java 搜索和替换 ODP 文档中的文本
weight: 240
url: /zh/java/redaction/odp/ 
description: Java 示例代码，用于在 JSP/JSF 应用程序和桌面应用程序的 Java 运行时环境中编辑 ODP 文件中的敏感信息。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="在 Java 中编辑 ODP 格式" h2="使用用于 Java API 的服务器端 Aspose.Slides 的本机和高性能 ODP 文档敏感编辑信息，无需使用 Microsoft 或 Adob​​e PDF 等任何软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 编辑 ODP 文件" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="在 Java 中编辑 ODP 文件的步骤" >}}
...
{{% blocks/products/pf/agp/code-block title="编辑 ODP 文件 - Java" offSpacer="" %}}
