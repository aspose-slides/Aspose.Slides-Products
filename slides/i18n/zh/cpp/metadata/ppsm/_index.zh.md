---
title: 通过 C++ 编辑或查看 PPSM 文档元数据
weight: 3220
url: /zh/cpp/metadata/ppsm/ 
description: 用于在 Windows 32 位、Windows 64 位和 Linux 64 位的 C++ 运行时环境中编辑或查看 PPSM 文件元数据的 C++ 示例代码。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C++ 提取 PPSM 元数据" h2="构建您自己的 C++ 应用程序，以使用服务器端 API 从 PPSM 文件中添加、编辑、删除或提取元数据。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 获取 PPSM 元数据" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="通过 C++ 提取 PPSM 元数据的步骤" >}}
...
{{% blocks/products/pf/agp/code-block title="提取 PPSM 的元数据 - C++" offSpacer="" %}}
