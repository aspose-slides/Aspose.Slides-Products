...
{{% blocks/products/pf/agp/content h2="如何使用 C# 编辑 PPTM 文件" %}}

为了编辑 PPTM 文件，我们将使用 <a href="https://products.aspose.com/slides/net">Aspose.Slides for .NET</a> API，这是一个功能丰富、功能强大的 API以及适用于任何编辑器的 C# 平台的易于使用的 API。打开 <a href="https://www.nuget.org/packages/aspose.slides.net">NuGet</a> 包管理器，搜索 <b>Aspose.Slides</b> 并安装。您还可以从包管理器控制台使用以下命令。
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中编辑 PPTM 文件的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="编辑 PPTM 文件 - C#" offSpacer="" %}}
