...
<h2 class="h2title">完全控制 PowerPoint 幻灯片元素</h2>

<p>Aspose.Slides for .NET 可以处理所有演示幻灯片元素，包括文本框、表格、矩形、椭圆、折线、自动形状、图片框、音频框、视频框和 OLE 对象框。 API 提供了一组精心设计的类，使您能够全面地操作这些元素中的每一个。</p>
