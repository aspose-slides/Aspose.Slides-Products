---
title: 通过 .NET 解锁 ODP 文档
weight: 5780
url: /zh/net/unlock/odp/ 
description: 在 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上解锁受密码保护的 ODP 文件的 C# 源代码。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 解锁 ODP 演示文稿" h2="使用 .NET 库从 ODP 中删除保护。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{< blocks/products/pf/agp/feature-section-col title="通过 C# 解锁 ODP" >}}
