...
{{< blocks/products/pf/agp/steps-block-autogen name="只需几行代码即可使用 [Aspose.Slides for .NET](https://products.aspose.com/slides/net) API 绘制基本文档图表。" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/net/chart/ppt/" name="PPT" description="微软PowerPoint 97-2003" >}}
