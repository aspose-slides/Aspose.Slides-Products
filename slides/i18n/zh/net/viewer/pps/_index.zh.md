---
title: 通过 .NET 查看 PPS 文件格式
weight: 7110
url: /zh/net/viewer/pps/ 
description: 用于在 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上加载、呈现和显示 PPS 文档的 C# 源代码。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1=".NET 的 PPS 文件查看器" h2="无需 Microsoft PowerPoint 或 Office 自动化即可查看 PPS 等演示文件" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPS" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPS" >}}
...
{{< blocks/products/pf/agp/feature-section-col title="通过 C# 查看 PPS 的步骤" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Aspose.Slides 使开发人员只需几行代码即可轻松查看 PPS 文件。" >}}

{{< blocks/products/pf/agp/step-autogen >}}
实例化一个 Presentation 对象并加载 PPS 文件
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
调用 Process.Start 以生成 HTML 的路径以在默认浏览器中加载 PPS 内容
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="C# 示例代码查看 PPS 文件" offSpacer="" %}}
