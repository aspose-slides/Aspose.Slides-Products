...
weight: 910
url: /zh/sharepoint/ 
description: SharePoint PowerPoint 是一个 Aspose.Slides SharePoint，用于创建和转换 SharePoint PPT、SharePoint 幻灯片、SharePoint 演示文稿。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="SharePoint PowerPoint 解决方案" h2="在 SharePoint 中管理和转换 PowerPoint 演示文稿。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-sharepoint.svg" pfName="Aspose.Slides" subTitlepfName="for SharePoint" downloadUrl="https://downloads.aspose.com/slides/sharepoint" >}}
...
<p>
 Aspose.Slides for SharePoint 用于管理和转换 SharePoint 中的 PowerPoint 文件。 Aspose.Slides 作为 SharePoint PowerPoint 解决方案，可以轻松导入常见的 Microsoft 演示格式，包括 PPT、POT、PPS、PPTX、POTX 和 PPSX，并且可以将这些格式导出为 PDF、TIFF 和 XPS 文件。无需 Microsoft PowerPoint 自动化即可使用所有 SharePoint PPT 功能。
</p>

<p>
 Aspose.Slides for SharePoint 适用于 Windows SharePoint Services WSS 3.0 和 Microsoft Office SharePoint Server 2007、2010 和 2013。
</p>
...
{{< blocks/products/pf/carousel-item h3="平台独立性" description="Aspose.Slides for SharePoint 可与 Microsoft Office SharePoint Server 和 Windows SharePoint Services 一起使用。" >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Aspose.Slides for SharePoint 支持最常见的演示文稿 [文件格式](https://docs.aspose.com/slides/sharepoint/supported-file-formats/)。" >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     从 SharePoint 文档库转换 PowerPoint 文件
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     将 PowerPoint 演示文稿转换为多种格式
    </h2>
    <p>
     Aspose.Slides for SharePoint 将您的 SharePoint 文档库中的演示文稿转换为许多流行的文档交换格式。 Aspose.Slides for SharePoint 支持常见的演示格式作为输入格式，并且可以导出为演示格式以及 PDF、TIFF 和 XPS。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for SharePoint 以 ZIP 存档的形式提供。将ZIP文件解压到MOSS 7.0或WSS 3.0服务器的本地驱动器，运行setup.exe安装使用。就这么简单！
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for SharePoint 使用托管代码构建，无需在机器上安装 Microsoft PowerPoint 即可处理 PowerPoint 文档格式转换。在支持的功能、安全性、稳定性、可扩展性、速度和价格方面，它是一个完美的 Microsoft PowerPoint 自动化替代方案。
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="文档" href="https://docs.aspose.com/slides/sharepoint/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="为什么使用 Aspose.Slides for SharePoint？" tabId="success-stories" >}}
