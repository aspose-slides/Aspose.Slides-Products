---
title: 在 Python 中将 POTX 转换为 JPG
weight: 1380
url: /zh/python-net/conversion/potx-to-jpg/ 
keywords: "Convert, PowerPoint, POTX, JPG, Presentation, Python"
description: POTX 到 JPG Python 转换的示例代码。使用 PowerPoint Python API 将 POTX 文件批量转换为 JPG 文件。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="在 Python 中将 POTX 转换为 JPG" h2="用于将 POTX 转换为 JPG 的强大 PowerPoint Python 库" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="在 Python 中将 POTX 转换为 JPG" %}}

需要以编程方式将 POTX 文件转换为 JPG？使用 [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/python-net/) 任何开发人员只需几行 Python 代码即可将 POTX 转换为 JPG 格式。

作为现代演示处理 API，Aspose.Slides for Python 从 POTX 快速创建 JPG。在您的 [浏览器](https://products.aspose.app/slides/conversion/ppt-to-jpg) 中测试 POTX 到 JPG 转换的质量。 Aspose PowerPoint PPTX 库允许您将 POTX 文件转换为许多流行的格式。
...
{{< blocks/products/pf/agp/feature-section-col title="如何在 Python 中将 POTX 转换为 JPG" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="这些是使用 Python 将 POTX 文件转换为 JPG 的步骤。" >}}
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 POTX 到 JPG Python 转换" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="在 Python 中将 POTX 保存为 JPG" %}}
使用免费应用程序查看 POTX 到 JPG 转换过程的演示。 
{{% /blocks/products/pf/agp/content %}}
