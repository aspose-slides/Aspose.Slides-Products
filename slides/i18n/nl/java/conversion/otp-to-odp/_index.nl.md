---
title: Converteer OTP naar ODP via Java
weight: 5880
url: /nl/java/conversion/otp-to-odp/ 
description: Voorbeeld Java-conversiecode voor OTP-indeling naar ODP-bestand. Gebruik deze voorbeeldcode om PowerPoint- en OpenOffice-presentaties naar ODP te exporteren binnen elke web- of desktop-Java-gebaseerde applicatie.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer OTP naar ODP via Java" h2="OTP naar ODP Java-conversie om enkele of meerdere pagina's naar ODP te converteren met behulp van een lokale Java-bibliotheek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTP" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe OTP naar ODP te converteren met Java" %}}

 Om OTP naar ODP te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om OTP naar ODP te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-ontwikkelaars kunnen eenvoudig een OTP-bestand naar ODP converteren in slechts een paar regels code.
...
{{% blocks/products/pf/agp/code-block title="OTP naar ODP Java-conversiebroncode" offSpacer="" %}}
