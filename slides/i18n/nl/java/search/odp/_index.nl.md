---
title: Zoek ODP-document zonder te openen via Java
weight: 1250
url: /nl/java/search/odp/ 
description: Java-voorbeeldcode om woorden met patroon te zoeken in ODP-bestand op Java Runtime Environment voor JSP/JSF-applicaties en desktopapplicaties.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Zoek ODP-indelingen in Java" h2="Native en high-performance ODP-document zoeken met Aspose.Slides aan de serverzijde voor Java API's, zonder het gebruik van software zoals Microsoft of Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe een ODP-bestand te zoeken met Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Stappen om ODP-bestanden in Java te zoeken" >}}
...
{{% blocks/products/pf/agp/code-block title="Zoek ODP-bestanden - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/java/search/pptx/" name="PPTX" description="Open XML-presentatie-indeling" >}}
