---
title: Bewerk of bekijk PPT-documentmetagegevens via C++
weight: 6080
url: /nl/cpp/metadata/ppt/ 
description: C++ voorbeeldcode om metadata van PPT-bestanden te bewerken of te bekijken in C++ Runtime Environment voor Windows 32 bit, Windows 64 bit en Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="PPT-metadata extraheren via C++" h2="Bouw uw eigen C++-apps om metadata uit PPT-bestanden toe te voegen, te bewerken, te verwijderen of te extraheren met behulp van server-side API's." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Hoe PPT-metadata te verkrijgen met C++" %}}
