---
title: Converteer PPT naar PDF via C++ applicatie
weight: 6240
url: /nl/cpp/conversion/ppt-to-pdf/ 
description: Voorbeeld C++-conversiecode voor PPT-document naar PDF-formaat. Gebruik voorbeeldcode voor batch PPT-naar-PDF-conversie binnen elke C++-toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer PPT naar PDF via C++" h2="Hoogwaardige PPT-naar-PDF-conversie met behulp van de C++-bibliotheek zonder de noodzaak van Microsoft PowerPoint-installatie." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-ontwikkelaars kunnen PPT-bestanden gemakkelijk converteren naar PDF in slechts een paar regels code.
...
{{% blocks/products/pf/agp/code-block title="PPT naar PDF C++ conversie broncode" offSpacer="" %}}
