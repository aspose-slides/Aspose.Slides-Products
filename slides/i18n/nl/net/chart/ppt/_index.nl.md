---
title: PPT-documentgrafiek via .NET
weight: 7050
url: /nl/net/chart/ppt/ 
description: C#-broncode om een ​​grafiek of diagram te tekenen en om te zetten in PPT-bestand op .NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="PPT-diagrammen maken met C #" %}}

 Om PPT-diagrammen te maken, gebruiken we
...
{{% blocks/products/pf/agp/code-block title="Maak PPT-bestanden grafiek - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/nl/net/chart/pptx/" name="PPTX" description="Open XML-presentatie-indeling" >}}
