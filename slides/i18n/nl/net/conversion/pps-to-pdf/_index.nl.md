---
title: Converteer PPS naar PDF via C#
weight: 3560
url: /nl/net/conversion/pps-to-pdf/ 
description: Voorbeeldcode voor PPS naar PDF C#-conversie. Gebruik API-voorbeeldcode voor batch-PPS-bestanden naar PDF-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer PPS naar PDF via C#" h2="Exporteer PowerPoint® PPS-bestanden naar PDF op .NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPS" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET-ontwikkelaars kunnen PPS-bestanden gemakkelijk laden en converteren naar PDF in slechts een paar regels code." >}}
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont PPS naar PDF C#-conversie" offSpacer="" %}}
