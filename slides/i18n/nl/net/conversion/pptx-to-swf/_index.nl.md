---
title: Converteer PPTX naar SWF via C#
weight: 6360
url: /nl/net/conversion/pptx-to-swf/ 
description: Voorbeeldcode voor conversie van PPTX naar SWF C#. Gebruik API-voorbeeldcode voor batch-PPTX-bestanden naar SWF-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer PPTX naar SWF via C#" h2="Exporteer PowerPoint® PPTX-bestanden naar SWF op .NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe PPTX naar SWF te converteren met C#" %}}
 ...
 Om PPTX naar SWF te converteren, gebruiken we
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET-ontwikkelaars kunnen eenvoudig PPTX-bestanden laden en converteren naar SWF in slechts een paar regels code." >}}
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont PPTX naar SWF C#-conversie" offSpacer="" %}}
