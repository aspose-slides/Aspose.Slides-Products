---
title: Converteer PPTX naar JPEG via C#
weight: 480
url: /nl/net/conversion/pptx-to-jpeg/ 
description: Voorbeeldcode voor conversie van PPTX naar JPEG C#. Gebruik API-voorbeeldcode voor batch-PPTX-bestanden naar JPEG-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer PPTX naar JPEG via C#" h2="Exporteer PowerPoint® PPTX-bestanden naar JPEG op .NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe PPTX naar JPEG te converteren met C#" %}}

 Om PPTX naar JPEG te converteren, gebruiken we
...
{{< blocks/products/pf/agp/feature-section-col title="Stappen om PPTX naar JPEG te converteren via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET-ontwikkelaars kunnen PPTX-bestanden gemakkelijk laden en converteren naar JPEG in slechts een paar regels code." >}}
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont PPTX naar JPEG C#-conversie" offSpacer="" %}}
