---
title: Bescherm en vergrendel PPT-document via .NET
weight: 1330
url: /nl/net/protect/ppt/ 
description: C#-broncode om het PPT-bestand te vergrendelen met een wachtwoord op .NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Versleutel PPT-bestanden via C#" h2="Beveilig PowerPoint-presentaties met een wachtwoord, inclusief PPT-indeling, met behulp van .NET Library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe PPT-bestand te beschermen met C #" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Bescherm PPT via C#" >}}
...
Laad PPT met een exemplaar van Presentation
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/nl/net/protect/odp/" name="ODP" description="OpenDocument-presentatie-indeling" >}}
