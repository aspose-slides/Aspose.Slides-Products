---
title: Bekijk of bewerk metadata van PPS-bestanden via .NET
weight: 7210
url: /nl/net/metadata/pps/ 
description: C#-broncode om metadata in PPS-indeling te bewerken of te bekijken op .NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="PPS-metadata extraheren via .NET" h2="Bouw uw eigen .NET-apps om metadata uit PPS-bestanden toe te voegen, te bewerken, te verwijderen of te extraheren met behulp van server-side API's." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPS" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Hoe PPS-metadata te extraheren met C#" %}}

 Om PPS-metadata te extraheren, gebruiken we
...
{{< blocks/products/pf/agp/feature-section-col title="Stappen om metadata van PPS te extraheren via C#" >}}
...
Instantieer de presentatieklasse met pad naar PPS-bestand
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Metadata van PPS extraheren - C#" offSpacer="" %}}
