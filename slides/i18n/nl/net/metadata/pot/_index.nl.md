---
title: Metadata van POT-bestanden bekijken of bewerken via .NET
weight: 6520
url: /nl/net/metadata/pot/ 
description: C#-broncode om metadata in POT-indeling te bewerken of te bekijken op .NET Framework, .NET Core, Windows Azure, Mono of Xamarin-platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="POT-metadata extraheren via .NET" h2="Bouw je eigen .NET-apps om metadata uit POT-bestanden toe te voegen, te bewerken, te verwijderen of te extraheren met behulp van server-side API's." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Hoe POT-metadata te extraheren met C#" %}}
...
Instantieer de klasse Presentatie met pad naar POT-bestand
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/net/metadata/odp/" name="ODP" description="OpenDocument-presentatie-indeling" >}}
