---
title: Metadata van POTX-bestanden bekijken of bewerken via .NET
weight: 7180
url: /nl/net/metadata/potx/ 
description: C#-broncode om metadata in POTX-formaat te bewerken of te bekijken op .NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extraheer POTX-metagegevens via .NET" h2="Bouw uw eigen .NET-apps om metadata uit POTX-bestanden toe te voegen, te bewerken, te verwijderen of te extraheren met behulp van server-side API's." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Hoe POTX-metadata te extraheren met C#" %}}
...
Instantieer de klasse Presentatie met pad naar POTX-bestand
{{< /blocks/products/pf/agp/step-autogen >}}
