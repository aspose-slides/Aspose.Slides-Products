---
title: Bekijk of bewerk de metagegevens van PPSX-bestanden via .NET
weight: 1570
url: /nl/net/metadata/ppsx/ 
description: C#-broncode om metadata in PPSX-indeling te bewerken of te bekijken op .NET Framework-, .NET Core-, Windows Azure-, Mono- of Xamarin-platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extraheer PPSX-metagegevens via .NET" h2="Bouw uw eigen .NET-apps om metadata uit PPSX-bestanden toe te voegen, te bewerken, te verwijderen of te extraheren met behulp van server-side API's." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Hoe PPSX-metadata te extraheren met C#" %}}
...
Instantieer de klasse Presentatie met pad naar PPSX-bestand
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Extraheer metadata van PPSX - C#" offSpacer="" %}}
