---
title: Bekijk of bewerk de metagegevens van PPTX-bestanden via .NET
weight: 7710
url: /nl/net/metadata/pptx/ 
description: C#-broncode om metadata in PPTX-indeling te bewerken of te bekijken op .NET Framework, .NET Core, Windows Azure, Mono of Xamarin-platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extraheer PPTX-metagegevens via .NET" h2="Bouw uw eigen .NET-apps om metadata uit PPTX-bestanden toe te voegen, te bewerken, te verwijderen of te extraheren met behulp van server-side API's." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Hoe PPTX-metadata te extraheren met C#" %}}
...
Instantieer de presentatieklasse met pad naar PPTX-bestand
{{< /blocks/products/pf/agp/step-autogen >}}
