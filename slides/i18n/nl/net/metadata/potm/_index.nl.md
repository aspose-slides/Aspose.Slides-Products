---
title: Metadata van POTM-bestanden bekijken of bewerken via .NET
weight: 590
url: /nl/net/metadata/potm/ 
description: C#-broncode om metadata in POTM-formaat te bewerken of te bekijken op .NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extraheer POTM-metadata via .NET" h2="Bouw uw eigen .NET-apps om metadata uit POTM-bestanden toe te voegen, te bewerken, te verwijderen of te extraheren met behulp van server-side API's." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Hoe POTM-metadata te extraheren met C#" %}}

 Om POTM-metadata te extraheren, gebruiken we
...
{{< blocks/products/pf/agp/feature-section-col title="Stappen om metadata van POTM te extraheren via C#" >}}
...
Instantieer de klasse Presentatie met pad naar POTM-bestand
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Metadata van POTM extraheren - C#" offSpacer="" %}}
