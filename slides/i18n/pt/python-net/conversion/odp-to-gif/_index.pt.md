...
Precisa converter arquivos ODP para GIF programaticamente? Usando [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/python-net/) qualquer desenvolvedor pode converter ODP para formato GIF com apenas algumas linhas de código Python.
