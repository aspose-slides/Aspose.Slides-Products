...
Precisa converter arquivos PPSX para HTML programaticamente? Usando [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/python-net/) qualquer desenvolvedor pode converter PPSX para formato HTML com apenas algumas linhas de código Python.
