...
Precisa converter arquivos ODP para POT programaticamente? Usando [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/python-net/) qualquer desenvolvedor pode converter ODP para o formato POT com apenas algumas linhas de código Python.
