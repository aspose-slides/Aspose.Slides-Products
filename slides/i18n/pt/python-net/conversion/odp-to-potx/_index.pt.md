...
Precisa converter arquivos ODP para POTX programaticamente? Usando [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/python-net/) qualquer desenvolvedor pode converter o formato ODP para POTX com apenas algumas linhas de código Python.
