...
Precisa converter arquivos OTP para HTML programaticamente? Usando [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/pt/python-net/) qualquer desenvolvedor pode converter OTP para formato HTML com apenas algumas linhas de código Python.
