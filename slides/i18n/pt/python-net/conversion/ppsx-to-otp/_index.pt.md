...
Precisa converter arquivos PPSX para OTP programaticamente? Usando [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/python-net/) qualquer desenvolvedor pode converter o formato PPSX para OTP com apenas algumas linhas de código Python.
