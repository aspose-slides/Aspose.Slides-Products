...
Precisa converter arquivos ODP para FODP programaticamente? Usando [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/python-net/) qualquer desenvolvedor pode converter o formato ODP para FODP com apenas algumas linhas de código Python.
