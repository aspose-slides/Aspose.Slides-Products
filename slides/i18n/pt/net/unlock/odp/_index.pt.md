---
title: Desbloqueie o documento ODP via .NET
weight: 5780
url: /pt/net/unlock/odp/ 
description: Código-fonte C# para desbloquear o arquivo ODP protegido por senha em plataformas .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Desbloqueie a apresentação ODP via C#" h2="Remova a proteção do ODP usando a biblioteca .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Como desbloquear o arquivo ODP usando C #" %}}

 Para remover o arquivo ODP de proteção, usaremos
...
{{< blocks/products/pf/agp/feature-section-col title="Desbloqueie o ODP via C#" >}}
