---
title: Converter PPTX para XPS via C#
weight: 7600
url: /pt/net/conversion/pptx-to-xps/ 
description: Código de exemplo para conversão de PPTX para XPS C#. Use o código de exemplo da API para arquivos PPTX em lote para conversão XPS em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PPTX para XPS via C#" h2="Exporte arquivos PPTX do PowerPoint® para XPS em plataformas .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{< blocks/products/pf/agp/feature-section-col title="Passos para converter PPTX para XPS via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Os desenvolvedores .NET podem facilmente carregar e converter arquivos PPTX para XPS em apenas algumas linhas de código." >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de PPTX para XPS C#" offSpacer="" %}}
