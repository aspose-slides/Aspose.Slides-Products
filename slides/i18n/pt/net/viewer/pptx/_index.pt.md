---
title: Visualizar formatos de arquivo PPTX via .NET
weight: 6390
url: /pt/net/viewer/pptx/ 
description: Código-fonte C# para carregar, renderizar e exibir documentos PPTX em plataformas .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Visualizador de arquivos PPTX para .NET" h2="Visualize arquivos de apresentação como PPTX sem Microsoft PowerPoint ou Office Automation" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Como visualizar o arquivo PPTX usando C #" %}}

 Para visualizar o arquivo PPTX, usaremos
...
{{< blocks/products/pf/agp/feature-section-col title="Etapas para visualizar PPTX via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Aspose.Slides torna mais fácil para os desenvolvedores visualizar o arquivo PPTX com apenas algumas linhas de código." >}}

{{< blocks/products/pf/agp/step-autogen >}}
Instanciar um objeto de apresentação e carregar o arquivo PPTX
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Salve a apresentação PPTX em formato HTML
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Chame Process.Start com o caminho para o HTML resultante para carregar o conteúdo PPTX no navegador padrão
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Código de exemplo C# para visualizar o arquivo PPTX" offSpacer="" %}}
