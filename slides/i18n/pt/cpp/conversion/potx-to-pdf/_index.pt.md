---
title: Converter POTX para PDF via aplicativo C++
weight: 4900
url: /pt/cpp/conversion/potx-to-pdf/ 
description: Exemplo de código de conversão C++ para documento POTX para formato PDF. Use o código de exemplo para conversão em lote de POTX para PDF em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter POTX para PDF via C++" h2="Conversão de POTX para PDF de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os desenvolvedores de C++ podem facilmente converter arquivos POTX para PDF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código fonte de conversão POTX para PDF C++" offSpacer="" %}}
