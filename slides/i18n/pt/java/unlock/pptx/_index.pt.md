---
title: Desbloquear documento PPTX via Java
weight: 4970
url: /pt/java/unlock/pptx/ 
description: Código de amostra Java para desbloquear o arquivo PPTX protegido por senha no Java Runtime Environment para aplicativos JSP/JSF e aplicativos de desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Desbloqueie arquivos PPTX via Java" h2="Remova a proteção de apresentações do PowerPoint, incluindo arquivo PPTX, usando a Biblioteca Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Como remover o arquivo PPTX de proteção usando Java" %}}

 Para desbloquear o arquivo PPTX, usaremos
...
{{< blocks/products/pf/agp/feature-section-col title="Etapas para desbloquear PPTX via Java" >}}
...
{{% blocks/products/pf/agp/code-block title="Desbloqueie arquivos PPTX via C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/java/unlock/odp/" name="ODP" description="Formato de apresentação do OpenDocument" >}}
