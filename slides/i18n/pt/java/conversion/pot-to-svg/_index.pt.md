---
title: Converter POT para SVG via Java
weight: 7820
url: /pt/java/conversion/pot-to-svg/ 
description: Exemplo de código de conversão Java para formato POT para arquivo SVG. Use este código de exemplo para exportar apresentações do PowerPoint e OpenOffice para SVG em qualquer aplicativo baseado em Java Web ou Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter POT para SVG via Java" h2="Conversão de POT para SVG Java para converter uma ou várias páginas em SVG usando a biblioteca Java no local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter POT para SVG usando Java" %}}

 Para renderizar POT para SVG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter POT para SVG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os desenvolvedores Java podem facilmente converter arquivos POT para SVG em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de POT para SVG Java" offSpacer="" %}}
