---
title: Converter ODP para POTX via Java
weight: 6340
url: /pt/java/conversion/odp-to-potx/ 
description: Exemplo de código de conversão Java para formato ODP para arquivo POTX. Use este código de exemplo para exportar apresentações do PowerPoint e OpenOffice para POTX em qualquer aplicativo baseado em Java Web ou Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter ODP para POTX via Java" h2="Conversão de ODP para POTX Java para converter uma ou várias páginas em POTX usando a biblioteca Java no local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter ODP para POTX usando Java" %}}

 Para renderizar ODP para POTX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter ODP para POTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os desenvolvedores Java podem facilmente converter arquivos ODP para POTX em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão Java de ODP para POTX" offSpacer="" %}}
