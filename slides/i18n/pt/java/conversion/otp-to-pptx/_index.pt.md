---
title: Converter OTP para PPTX via Java
weight: 5810
url: /pt/java/conversion/otp-to-pptx/ 
description: Exemplo de código de conversão Java para formato OTP para arquivo PPTX. Use este código de exemplo para exportar apresentações do PowerPoint e OpenOffice para PPTX em qualquer aplicativo baseado em Java Web ou Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter OTP para PPTX via Java" h2="Conversão de OTP para PPTX Java para converter páginas únicas ou múltiplas para PPTX usando a biblioteca Java no local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTP" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter OTP para PPTX usando Java" %}}

 Para renderizar OTP para PPTX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter OTP para PPTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os desenvolvedores Java podem facilmente converter arquivos OTP para PPTX em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão Java de OTP para PPTX" offSpacer="" %}}
