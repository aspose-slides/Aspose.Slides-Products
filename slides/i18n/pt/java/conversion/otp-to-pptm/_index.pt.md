---
title: Converter OTP para PPTM via Java
weight: 3590
url: /pt/java/conversion/otp-to-pptm/ 
description: Exemplo de código de conversão Java para formato OTP para arquivo PPTM. Use este código de exemplo para exportar apresentações do PowerPoint e OpenOffice para PPTM em qualquer aplicativo baseado em Java Web ou Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter OTP para PPTM via Java" h2="Conversão de OTP para PPTM Java para converter uma ou várias páginas em PPTM usando a biblioteca Java no local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTP" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter OTP para PPTM usando Java" %}}

 Para renderizar OTP para PPTM, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter OTP para PPTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os desenvolvedores Java podem facilmente converter arquivos OTP para PPTM em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão Java de OTP para PPTM" offSpacer="" %}}
