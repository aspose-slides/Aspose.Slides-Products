---
title: Converter POTX para POT via Java
weight: 50
url: /pt/java/conversion/potx-to-pot/ 
description: Exemplo de código de conversão Java para formato POTX para arquivo POT. Use este código de exemplo para exportar apresentações do PowerPoint e OpenOffice para POT em qualquer aplicativo baseado em Java Web ou Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter POTX para POT via Java" h2="Conversão de POTX para POT Java para converter uma ou várias páginas em POT usando a biblioteca Java no local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="POT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter POTX para POT usando Java" %}}

 Para renderizar POTX para POT, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter POTX para POT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os desenvolvedores Java podem facilmente converter arquivos POTX para POT em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código fonte de conversão POTX para POT Java" offSpacer="" %}}
