---
title: Converter OTP para XPS via Java
weight: 700
url: /pt/java/conversion/otp-to-xps/ 
description: Exemplo de código de conversão Java para formato OTP para arquivo XPS. Use este código de exemplo para exportar apresentações do PowerPoint e OpenOffice para XPS em qualquer aplicativo baseado em Java Web ou Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter OTP para XPS via Java" h2="Conversão de OTP para XPS Java para converter uma ou várias páginas em XPS usando a biblioteca Java no local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTP" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter OTP para XPS usando Java" %}}

 Para renderizar OTP para XPS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter OTP para XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os desenvolvedores Java podem facilmente converter arquivos OTP para XPS em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de OTP para XPS Java" offSpacer="" %}}
