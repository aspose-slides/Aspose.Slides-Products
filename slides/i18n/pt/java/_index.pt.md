...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Recursos avançados da API de processamento de documentos Java PowerPoint</h2>

<p>Aspose.Slides for Java incorpora uma série de recursos avançados que dão aos desenvolvedores controle total ao programar com apresentações do Microsoft PowerPoint em um ambiente Java.</p>-->
   <h2 class="pr-ft">
...
<h2 class="h2title">Formatação do conteúdo do Apresentações</h2>

<p>É possível formatar texto e formas em slides em uma apresentação usando Aspose.Slides for Java API. O texto é gerenciado por meio de quadros de texto associados a formas. Portanto, o texto é formatado usando parágrafos e partes associadas aos quadros de texto. Você também pode manipular atributos do elemento de forma como posição, tamanho, linha, imagem, texto e preenchimento.</p>
