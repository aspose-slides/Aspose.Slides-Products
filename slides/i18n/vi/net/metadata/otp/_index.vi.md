---
title: Xem hoặc chỉnh sửa siêu dữ liệu tệp OTP qua .NET
weight: 6590
url: /vi/net/metadata/otp/ 
description: Mã nguồn C # để chỉnh sửa hoặc xem siêu dữ liệu định dạng OTP trên .NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Trích xuất siêu dữ liệu OTP qua .NET" h2="Xây dựng ứng dụng .NET của riêng bạn để thêm, chỉnh sửa, xóa hoặc trích xuất siêu dữ liệu từ các tệp OTP bằng cách sử dụng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách giải nén siêu dữ liệu OTP bằng C #" %}}
...
Khởi tạo lớp Bản trình bày với đường dẫn đến tệp OTP
{{< /blocks/products/pf/agp/step-autogen >}}
