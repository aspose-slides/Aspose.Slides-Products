---
title: Xem hoặc chỉnh sửa siêu dữ liệu tệp PPTM qua .NET
weight: 950
url: /vi/net/metadata/pptm/ 
description: Mã nguồn C # để chỉnh sửa hoặc xem siêu dữ liệu định dạng PPTM trên .NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Trích xuất siêu dữ liệu PPTM qua .NET" h2="Xây dựng ứng dụng .NET của riêng bạn để thêm, chỉnh sửa, xóa hoặc trích xuất siêu dữ liệu từ tệp PPTM bằng cách sử dụng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách giải nén siêu dữ liệu PPTM bằng C #" %}}

 Để trích xuất siêu dữ liệu PPTM, chúng tôi sẽ sử dụng
...
{{< blocks/products/pf/agp/feature-section-col title="Các bước để trích xuất siêu dữ liệu của PPTM qua C #" >}}
...
{{% blocks/products/pf/agp/code-block title="Trích xuất siêu dữ liệu của PPTM - C #" offSpacer="" %}}
