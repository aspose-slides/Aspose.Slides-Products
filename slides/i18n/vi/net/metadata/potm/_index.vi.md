---
title: Xem hoặc chỉnh sửa siêu dữ liệu tệp POTM qua .NET
weight: 590
url: /vi/net/metadata/potm/ 
description: Mã nguồn C # để chỉnh sửa hoặc xem siêu dữ liệu định dạng POTM trên .NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Trích xuất siêu dữ liệu POTM qua .NET" h2="Xây dựng ứng dụng .NET của riêng bạn để thêm, chỉnh sửa, xóa hoặc trích xuất siêu dữ liệu từ tệp POTM bằng cách sử dụng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách trích xuất siêu dữ liệu POTM bằng C #" %}}

 Để trích xuất siêu dữ liệu POTM, chúng tôi sẽ sử dụng
...
{{< blocks/products/pf/agp/feature-section-col title="Các bước để trích xuất siêu dữ liệu của POTM qua C #" >}}
...
{{% blocks/products/pf/agp/code-block title="Trích xuất siêu dữ liệu của POTM - C #" offSpacer="" %}}
