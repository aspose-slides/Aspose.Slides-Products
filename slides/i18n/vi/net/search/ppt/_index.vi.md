---
title: Tìm kiếm tài liệu PPT mà không cần mở qua C #
weight: 6250
url: /vi/net/search/ppt/ 
description: Mã nguồn C # để tìm kiếm các từ có mẫu trong tệp PPT trên .NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Tìm kiếm Định dạng PPT trong C #" h2="Tìm kiếm tài liệu PPT nguyên bản và hiệu suất cao bằng cách sử dụng Aspose.Slides phía máy chủ cho các API .NET mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách tìm kiếm tệp PPT bằng C #" %}}

 Để tìm kiếm tệp PPT, chúng tôi sẽ sử dụng
 [Aspose.Slides dành cho .NET](https://products.aspose.com/slides/net)
 API là một API tìm kiếm tài liệu Microsoft PowerPoint giàu tính năng, mạnh mẽ và dễ sử dụng cho nền tảng C #. Mở
...
{{< blocks/products/pf/agp/feature-section-col title="Các bước tìm kiếm tệp PPT trong C #" >}}
...
{{% blocks/products/pf/agp/code-block title="Tìm kiếm tệp PPT - C #" offSpacer="" %}}
