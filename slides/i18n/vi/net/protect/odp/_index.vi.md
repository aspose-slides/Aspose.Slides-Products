---
title: Bảo vệ và khóa tài liệu ODP qua .NET
weight: 4230
url: /vi/net/protect/odp/ 
description: Mã nguồn C # để khóa tệp ODP bằng mật khẩu trên .NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Mã hóa tệp ODP qua C #" h2="Các bản trình bày PowerPoint được bảo vệ bằng mật khẩu bao gồm định dạng ODP sử dụng Thư viện .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Cách bảo vệ tệp ODP bằng C #" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Bảo vệ ODP qua C #" >}}
...
Tải ODP với một phiên bản của Bản trình bày
{{< /blocks/products/pf/agp/step-autogen >}}
