---
title: Xóa chú thích PPT qua .NET
weight: 4380
url: /vi/net/annotation/ppt/ 
description: Mã nguồn C # để xóa chú thích định dạng PPT trên .NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Xóa nhận xét & tác giả nhận xét khỏi PPT qua C #" h2="Xây dựng ứng dụng .NET của riêng bạn để thao tác nhận xét và tác giả trong tệp tài liệu bằng cách sử dụng API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách chú thích tệp PPT bằng C #" %}}

 Để chú thích tệp PPT, chúng tôi sẽ sử dụng
...
{{< blocks/products/pf/agp/feature-section-col title="Xóa nhận xét khỏi PPT qua C #" >}}
...
Tải PPT với một phiên bản của lớp Trình bày
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Xóa chú thích khỏi PPT - C #" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/net/annotation/odp/" name="ODP" description="Định dạng bản trình bày OpenDocument" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/net/annotation/pptx/" name="PPTX" description="Định dạng bản trình bày XML mở" >}}
