---
title: Tìm kiếm và thay thế văn bản trong tài liệu PPT qua .NET
weight: 1410
url: /vi/net/redaction/ppt/ 
description: Mã nguồn C # để biên tập lại thông tin nhạy cảm trong tệp PPT trên .NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Redact PPT định dạng trong C #" h2="Thông tin phản hồi nhạy cảm của tài liệu PPT gốc và hiệu suất cao bằng cách sử dụng Aspose.Slides phía máy chủ cho các API .NET, mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách tạo lại tệp PPT bằng C #" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Các bước chỉnh sửa tệp PPT trong C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Có thể thực hiện tìm kiếm tài liệu cơ bản và thay thế văn bản trong nội dung, nhận xét hoặc siêu dữ liệu bằng API [Aspose.Slides for .NET](https://products.aspose.com/slides/vi/net) chỉ với vài dòng mã. Tìm và thay thế văn bản trong PowerPoint và OpenOffice. Chỉnh sửa văn bản, nhận xét, siêu dữ liệu trong bản trình bày thông qua đối sánh dữ liệu regexp." >}}
...
{{% blocks/products/pf/agp/code-block title="Redact Tệp PPT - C #" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/vi/net/redaction/odp/" name="ODP" description="Định dạng bản trình bày OpenDocument" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/vi/net/redaction/pptx/" name="PPTX" description="Định dạng bản trình bày XML mở" >}}
