---
title: Chuyển đổi ODP sang PDF qua C #
weight: 2960
url: /vi/net/conversion/odp-to-pdf/ 
description: Mã mẫu để chuyển đổi ODP sang PDF C #. Sử dụng mã ví dụ API để chuyển đổi hàng loạt tệp ODP sang PDF trong VB.NET, Asp.NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi ODP sang PDF qua C #" h2="Xuất tệp PowerPoint® ODP sang PDF trên Nền tảng .NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi ODP sang PDF bằng C #" %}}

 Để chuyển đổi ODP sang PDF, chúng tôi sẽ sử dụng
...
{{< blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi ODP sang PDF qua C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Các nhà phát triển .NET có thể dễ dàng tải và chuyển đổi các tệp ODP sang PDF chỉ trong một vài dòng mã." >}}
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị Chuyển đổi ODP sang PDF C #" offSpacer="" %}}
