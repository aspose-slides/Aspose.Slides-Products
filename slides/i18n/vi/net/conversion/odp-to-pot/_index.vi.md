---
title: Chuyển đổi ODP sang POT qua C #
weight: 2190
url: /vi/net/conversion/odp-to-pot/ 
description: Mã mẫu cho chuyển đổi ODP sang POT C #. Sử dụng mã ví dụ API cho các tệp ODP hàng loạt để chuyển đổi POT trong VB.NET, Asp.NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi ODP sang POT qua C #" h2="Xuất tệp PowerPoint® ODP sang POT trên Nền tảng .NET Framework, .NET Core, Windows Azure, Mono hoặc Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="Các nhà phát triển .NET có thể dễ dàng tải và chuyển đổi các tệp ODP sang POT chỉ trong một vài dòng mã." >}}
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị Chuyển đổi ODP sang POT C #" offSpacer="" %}}
