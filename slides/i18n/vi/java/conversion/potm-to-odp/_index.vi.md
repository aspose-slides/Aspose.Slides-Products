---
title: Chuyển đổi POTM sang ODP qua Java
weight: 8220
url: /vi/java/conversion/potm-to-odp/ 
description: Mã chuyển đổi Java mẫu cho định dạng POTM sang tệp ODP. Sử dụng mã ví dụ này để xuất bản trình bày PowerPoint & OpenOffice sang ODP trong bất kỳ Ứng dụng dựa trên Java trên Web hoặc Máy tính để bàn nào.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi POTM sang ODP qua Java" h2="Chuyển đổi POTM sang ODP Java để chuyển đổi một hoặc nhiều trang sang ODP bằng cách sử dụng thư viện Java tại chỗ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi POTM sang ODP bằng Java" %}}

 Để hiển thị POTM sang ODP, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi POTM sang ODP qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Các nhà phát triển Java có thể dễ dàng chuyển đổi tệp POTM sang ODP chỉ trong một vài dòng mã.
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi POTM sang ODP Java" offSpacer="" %}}
