---
title: Bảo vệ và khóa tài liệu PPT qua C ++
weight: 2570
url: /vi/cpp/protect/ppt/ 
description: Mã ví dụ C ++ để khóa tệp PPT bằng mật khẩu trên Môi trường thời gian chạy C ++ cho Windows 32 bit, Windows 64 bit và Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Mã hóa tệp PPT qua C ++" h2="Các bản trình bày PowerPoint được bảo vệ bằng mật khẩu bao gồm định dạng PPT sử dụng Thư viện .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách bảo mật tệp PPT bằng C ++" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Các bước bảo vệ tệp PPT qua C ++" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Lưu bản trình bày PPT được bảo vệ
{{< /blocks/products/pf/agp/step-autogen >}}
