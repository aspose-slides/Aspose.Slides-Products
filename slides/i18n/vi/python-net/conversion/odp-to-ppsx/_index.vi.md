...
Bạn cần chuyển đổi các tệp ODP sang PPSX theo lập trình? Sử dụng [* Aspose.Slides cho Python qua .NET *](https://products.aspose.com/slides/python-net/), bất kỳ nhà phát triển nào cũng có thể chuyển đổi định dạng ODP sang PPSX chỉ với một vài dòng mã Python.
