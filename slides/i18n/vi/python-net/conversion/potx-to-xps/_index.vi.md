---
title: Chuyển đổi POTX sang XPS bằng Python
weight: 1540
url: /vi/python-net/conversion/potx-to-xps/ 
keywords: "Convert, PowerPoint, POTX, XPS, Presentation, Python"
description: Mã mẫu để chuyển đổi POTX sang XPS Python. Sử dụng API PowerPoint Python để chuyển đổi hàng loạt tệp POTX sang tệp XPS.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi POTX sang XPS bằng Python" h2="Thư viện PowerPoint Python mạnh mẽ để chuyển đổi POTX sang XPS" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi POTX sang XPS bằng Python" %}}

Bạn cần chuyển đổi các tệp POTX sang XPS theo lập trình? Sử dụng [* Aspose.Slides cho Python qua .NET *](https://products.aspose.com/slides/python-net/), bất kỳ nhà phát triển nào cũng có thể chuyển đổi định dạng POTX sang XPS chỉ với một vài dòng mã Python.
...
{{< blocks/products/pf/agp/feature-section-col title="Cách chuyển đổi POTX sang XPS bằng Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Đây là các bước để chuyển đổi tệp POTX sang XPS bằng Python." >}}
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị Chuyển đổi Python từ POTX sang XPS" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu POTX dưới dạng XPS bằng Python" %}}
