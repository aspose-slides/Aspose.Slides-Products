---
title: पायथन में FODP को HTML में बदलें
weight: 40
url: /hi/python-net/conversion/fodp-to-html/ 
keywords: "Convert, PowerPoint, FODP, HTML, Presentation, Python"
description: एफओडीपी के लिए एचटीएमएल पायथन रूपांतरण के लिए नमूना कोड। FODP फ़ाइलों को HTML फ़ाइलों में बैच रूपांतरण के लिए PowerPoint Python API का उपयोग करें।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="पायथन में FODP को HTML में बदलें" h2="FODP को HTML में बदलने के लिए शक्तिशाली पावरपॉइंट पायथन लाइब्रेरी" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="पायथन में FODP को HTML में बदलें" %}}

FODP फ़ाइलों को प्रोग्रामेटिक रूप से HTML में कनवर्ट करने की आवश्यकता है? .NET*](https://products.aspose.com/slides/python-net/) के माध्यम से पायथन के लिए [*Aspose.Slides का उपयोग करके कोई भी डेवलपर FODP को HTML प्रारूप में केवल कुछ पंक्तियों के साथ पायथन कोड में परिवर्तित कर सकता है।

एक आधुनिक प्रेजेंटेशन प्रोसेसिंग एपीआई के रूप में, Aspose.Slides for Python जल्दी से FODP से HTML बनाता है। सीधे अपने [ब्राउज़र](https://products.aspose.app/slides/conversion) में FODP से HTML रूपांतरण की गुणवत्ता का परीक्षण करें। Aspose PowerPoint PPTX लाइब्रेरी आपको FODP फ़ाइलों को कई लोकप्रिय प्रारूपों में बदलने की अनुमति देती है।
...
{{< blocks/products/pf/agp/feature-section-col title="पायथन में FODP को HTML में कैसे बदलें" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="पायथन का उपयोग करके FODP फ़ाइल को HTML में बदलने के लिए ये चरण हैं।" >}}
...
{{% blocks/products/pf/agp/code-block title="यह नमूना कोड FODP को HTML पायथन रूपांतरण में दिखाता है" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="FODP को Python में HTML के रूप में सहेजें" %}}
