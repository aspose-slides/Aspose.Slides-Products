---
title: C++ के माध्यम से PPS दस्तावेज़ मेटाडेटा संपादित करें या देखें
weight: 7320
url: /hi/cpp/metadata/pps/ 
description: विंडोज 32 बिट, विंडोज 64 बिट और लिनक्स 64 बिट के लिए सी ++ रनटाइम एनवायरनमेंट पर पीपीएस फ़ाइल मेटाडेटा को संपादित करने या देखने के लिए सी ++ उदाहरण कोड।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C++ के माध्यम से PPS मेटाडेटा निकालें" h2="सर्वर-साइड एपीआई का उपयोग करके पीपीएस फाइलों से मेटाडेटा जोड़ने, संपादित करने, हटाने या निकालने के लिए अपने स्वयं के सी ++ ऐप्स बनाएं।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPS" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="C++ का उपयोग करके PPS मेटाडेटा कैसे प्राप्त करें" %}}

 PPS मेटाडेटा निकालने के लिए, हम उपयोग करेंगे
...
{{< blocks/products/pf/agp/feature-section-col title="C++ के माध्यम से PPS का मेटाडेटा निकालने के चरण" >}}
...
{{% blocks/products/pf/agp/code-block title="PPS का मेटाडेटा निकालें - C++" offSpacer="" %}}
