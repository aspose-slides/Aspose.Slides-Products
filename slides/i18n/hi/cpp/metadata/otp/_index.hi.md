---
title: C++ के माध्यम से OTP दस्तावेज़ मेटाडेटा संपादित करें या देखें
weight: 5860
url: /hi/cpp/metadata/otp/ 
description: विंडोज 32 बिट, विंडोज 64 बिट और लिनक्स 64 बिट के लिए सी ++ रनटाइम एनवायरनमेंट पर ओटीपी फ़ाइल मेटाडेटा को संपादित करने या देखने के लिए सी ++ उदाहरण कोड।
---
...
{{% blocks/products/pf/agp/content h2="C++ का उपयोग करके OTP मेटाडेटा कैसे प्राप्त करें" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="C++ के माध्यम से OTP का मेटाडेटा निकालने के चरण" >}}
...
{{% blocks/products/pf/agp/code-block title="OTP का मेटाडेटा निकालें - C++" offSpacer="" %}}
