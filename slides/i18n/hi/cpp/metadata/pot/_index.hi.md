---
title: C++ के माध्यम से POT दस्तावेज़ मेटाडेटा संपादित करें या देखें
weight: 5800
url: /hi/cpp/metadata/pot/ 
description: विंडोज 32 बिट, विंडोज 64 बिट और लिनक्स 64 बिट के लिए सी ++ रनटाइम एनवायरनमेंट पर पीओटी फ़ाइल मेटाडेटा को संपादित या देखने के लिए सी ++ उदाहरण कोड।
---
...
{{% blocks/products/pf/agp/content h2="C++ का उपयोग करके पॉट मेटाडेटा कैसे प्राप्त करें" %}}

 पीओटी मेटाडेटा निकालने के लिए, हम उपयोग करेंगे
...
{{< blocks/products/pf/agp/feature-section-col title="C++ के माध्यम से POT का मेटाडेटा निकालने के चरण" >}}
...
{{% blocks/products/pf/agp/code-block title="पॉट का मेटाडेटा निकालें - C++" offSpacer="" %}}
