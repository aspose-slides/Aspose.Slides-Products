---
title: C++ के माध्यम से खोले बिना PPT दस्तावेज़ खोजें
weight: 7970
url: /hi/cpp/search/ppt/ 
description: विंडोज 32 बिट, विंडोज 64 बिट और लिनक्स 64 बिट के लिए सी ++ रनटाइम एनवायरनमेंट पर पीपीटी फाइल में पैटर्न वाले शब्दों को खोजने के लिए सी ++ उदाहरण कोड।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="सी ++ में पीपीटी प्रारूप खोजें" h2="सर्वर-साइड Aspose का उपयोग करके मूल और उच्च प्रदर्शन पीपीटी दस्तावेज़ खोज। माइक्रोसॉफ्ट या एडोब पीडीएफ जैसे किसी भी सॉफ्टवेयर के उपयोग के बिना सी ++ एपीआई के लिए स्लाइड।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPT" >}}
...
{{< blocks/products/pf/agp/feature-section-col title="C++ में PPT फ़ाइलें खोजने के चरण" >}}
...
प्रेजेंटेशन क्लास ऑब्जेक्ट को इंस्टेंट करके पीपीटी फाइल लोड करें।
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
पहली स्लाइड से ITextFrame ऑब्जेक्ट का ऐरे प्राप्त करें।
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
वर्तमान आईपीराग्राफ में भागों के माध्यम से लूप
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
फ़ॉन्ट ऊंचाई और फ़ॉन्ट नाम प्रदर्शित करें।
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/other-supported-section title="अन्य समर्थित खोज दस्तावेज़" subTitle="सी ++ का उपयोग करके, कोई अन्य फाइलों को भी खोज सकता है जिनमें शामिल हैं।" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/cpp/search/odp/" name="ODP" description="OpenDocument प्रस्तुति स्वरूप" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/cpp/search/pptx/" name="PPTX" description="एक्सएमएल प्रस्तुति प्रारूप खोलें" >}}
