---
title: जावा के माध्यम से ODP दस्तावेज़ को सुरक्षित और लॉक करें
weight: 2650
url: /hi/java/protect/odp/ 
description: JSP/JSF एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए जावा रनटाइम एनवायरनमेंट पर पासवर्ड का उपयोग करके ODP फ़ाइल को लॉक करने के लिए जावा नमूना कोड।
---
...
{{% blocks/products/pf/agp/content h2="जावा का उपयोग करके ओडीपी फ़ाइल को कैसे सुरक्षित करें" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="जावा के माध्यम से ओडीपी फाइलों की सुरक्षा के लिए कदम" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
संरक्षित प्रस्तुति को ओडीपी प्रारूप में सहेजें
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/hi/java/protect/ppt/" name="PPT" description="माइक्रोसॉफ्ट पावरपॉइंट 97-2003" >}}
