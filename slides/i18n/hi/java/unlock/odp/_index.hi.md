---
title: जावा के माध्यम से ओडीपी दस्तावेज़ अनलॉक करें
weight: 3650
url: /hi/java/unlock/odp/ 
description: जेएसपी/जेएसएफ एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए जावा रनटाइम एनवायरनमेंट पर पासवर्ड से सुरक्षित ओडीपी फ़ाइल को अनलॉक करने के लिए जावा नमूना कोड।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="जावा के माध्यम से ODP फ़ाइलें अनलॉक करें" h2="जावा लाइब्रेरी का उपयोग करके ODP फ़ाइल सहित PowerPoint प्रस्तुतियों से सुरक्षा निकालें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Java का उपयोग करके सुरक्षा ODP फ़ाइल कैसे निकालें" %}}

 ODP फ़ाइल को अनलॉक करने के लिए, हम उपयोग करेंगे
...
{{< blocks/products/pf/agp/feature-section-col title="जावा के माध्यम से ओडीपी अनलॉक करने के चरण" >}}
...
{{% blocks/products/pf/agp/code-block title="सी # के माध्यम से ओडीपी फाइलों को अनलॉक करें" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/java/unlock/pptx/" name="PPTX" description="एक्सएमएल प्रस्तुति प्रारूप खोलें" >}}
