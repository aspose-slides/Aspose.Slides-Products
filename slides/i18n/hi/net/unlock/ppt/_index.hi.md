---
title: .NET . के माध्यम से पीपीटी दस्तावेज़ अनलॉक करें
weight: 8650
url: /hi/net/unlock/ppt/ 
description: .NET फ्रेमवर्क, .NET Core, Windows Azure, Mono या Xamarin प्लेटफॉर्म पर पासवर्ड प्रोटेक्टेड PPT फाइल को अनलॉक करने के लिए C# सोर्स कोड।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="सी # के माध्यम से पीपीटी प्रेजेंटेशन अनलॉक करें" h2=".NET लाइब्रेरी का उपयोग करके पीपीटी से सुरक्षा निकालें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके PPT फ़ाइल को कैसे अनलॉक करें" %}}

 सुरक्षा पीपीटी फ़ाइल को हटाने के लिए, हम उपयोग करेंगे
...
{{< blocks/products/pf/agp/feature-section-col title="सी # के माध्यम से पीपीटी अनलॉक करें" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/hi/net/unlock/pptx/" name="PPTX" description="एक्सएमएल प्रस्तुति प्रारूप खोलें" >}}
