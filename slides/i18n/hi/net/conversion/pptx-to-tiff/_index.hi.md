---
title: सी # के माध्यम से पीपीटीएक्स को टीआईएफएफ में कनवर्ट करें
weight: 3330
url: /hi/net/conversion/pptx-to-tiff/ 
description: पीपीटीएक्स से टीआईएफएफ सी# रूपांतरण के लिए नमूना कोड। VB.NET, Asp.NET या किसी .NET आधारित एप्लिकेशन के भीतर TIFF रूपांतरण में बैच PPTX फ़ाइलों के लिए API उदाहरण कोड का उपयोग करें।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="सी # के माध्यम से पीपीटीएक्स को टीआईएफएफ में कनवर्ट करें" h2=".NET Framework, .NET Core, Windows Azure, Mono या Xamarin प्लेटफॉर्म पर TIFF में PowerPoint® PPTX फ़ाइलें निर्यात करें" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET डेवलपर कोड की कुछ ही पंक्तियों में PPTX फ़ाइलों को आसानी से TIFF में लोड और परिवर्तित कर सकते हैं।" >}}
...
{{% blocks/products/pf/agp/code-block title="यह नमूना कोड PPTX से TIFF C# रूपांतरण दिखाता है" offSpacer="" %}}
