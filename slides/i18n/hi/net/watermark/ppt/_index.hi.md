---
title: वॉटरमार्क पीपीटी दस्तावेज़ .NET . के माध्यम से
weight: 7740
url: /hi/net/watermark/ppt/ 
description: C# सोर्स कोड .NET Framework, .NET Core, Windows Azure, Mono या Xamarin प्लेटफॉर्म पर PPT फाइल में वॉटरमार्क जोड़ने या हटाने के लिए।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="सी # के माध्यम से पीपीटी में टेक्स्ट वॉटरमार्क जोड़ें" h2="सर्वर-साइड एपीआई का उपयोग करके पीपीटी फाइलों को वॉटरमार्क करने के लिए अपने स्वयं के .NET ऐप्स बनाएं।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{< blocks/products/pf/agp/feature-section-col title="सी#के माध्यम से पीपीटी में वॉटरमार्क जोड़ने के चरण" >}}
...
{{% blocks/products/pf/agp/code-block title="पीपीटी में वॉटरमार्क जोड़ें - सी #" offSpacer="" %}}
