...
weight: 490
url: /it/python-net/conversion/otp-to-html/ 
keywords: "Convert, PowerPoint, OTP, HTML, Presentation, Python"
description: Codice di esempio per la conversione da OTP a HTML Python. Usa l'API Python di PowerPoint per la conversione batch di file OTP in file HTML.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti OTP in HTML in Python" h2="Potente libreria PowerPoint Python per la conversione di OTP in HTML" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Converti OTP in HTML in Python" %}}

Hai bisogno di convertire i file OTP in HTML a livello di codice? Utilizzando [*Aspose.Slides per Python tramite .NET*](https://products.aspose.com/slides/python-net/) qualsiasi sviluppatore può convertire OTP in formato HTML con poche righe di codice Python.
...
{{< blocks/products/pf/agp/feature-section-col title="Come convertire OTP in HTML in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Questi sono i passaggi per convertire un file OTP in HTML usando Python." >}}
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da OTP a HTML Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Salva OTP come HTML in Python" %}}
