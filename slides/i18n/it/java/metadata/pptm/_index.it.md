---
title: Modifica o visualizza i metadati dei file PPTM tramite Java
weight: 3850
url: /it/java/metadata/pptm/ 
description: Codice di esempio Java per modificare o visualizzare i metadati in formato PPTM su Java Runtime Environment per l'applicazione JSP/JSF e le applicazioni desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Estrai metadati PPTM tramite Java" h2="Crea le tue app Java per aggiungere, modificare, rimuovere o estrarre metadati dai file PPTM utilizzando le API lato server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTM" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Come estrarre i metadati PPTM utilizzando Java" %}}

 Per ottenere i metadati dei file PPTM, utilizzeremo
...
{{< blocks/products/pf/agp/feature-section-col title="Passaggi per estrarre i metadati di PPTM tramite Java" >}}
...
Ottieni informazioni PPTM usando getPresentationInfo()
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Aggiorna e scrivi informazioni PPTM con nuove proprietà
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Estrai metadati di PPTM - Java" offSpacer="" %}}
