...
{{% blocks/products/pf/agp/content h2="Come convertire PPS in XPS usando Java" %}}

 Per eseguire il rendering da PPS a XPS, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire PPS in XPS tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Gli sviluppatori Java possono convertire facilmente file PPS in XPS in poche righe di codice.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione Java da PPS a XPS" offSpacer="" %}}
