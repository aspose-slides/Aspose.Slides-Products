---
title: SharePoint PowerPoint | Aspose.Slides API di SharePoint
weight: 910
url: /it/sharepoint/ 
description: SharePoint PowerPoint è un Aspose.Slides SharePoint per creare e convertire SharePoint PPT, presentazione di SharePoint, presentazione di SharePoint.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Soluzione PowerPoint di SharePoint" h2="Gestisci e converti presentazioni PowerPoint in SharePoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-sharepoint.svg" pfName="Aspose.Slides" subTitlepfName="for SharePoint" downloadUrl="https://downloads.aspose.com/slides/sharepoint" >}}
...
<p>
 Aspose.Slides per SharePoint per gestire e convertire file PowerPoint in SharePoint. Aspose.Slides, come soluzione di SharePoint PowerPoint, può importare facilmente formati di presentazione Microsoft comuni tra cui PPT, POT, PPS, PPTX, POTX e PPSX ed esportare questi formati in file PDF, TIFF e XPS. Utilizza tutte le funzionalità PPT di SharePoint senza l'automazione di Microsoft PowerPoint necessaria.
</p>

<p>
 Aspose.Slides per SharePoint funziona con Windows SharePoint Services WSS 3.0 e Microsoft Office SharePoint Server 2007, 2010 e 2013.
</p>
...
{{< blocks/products/pf/carousel-item h3="A prima vista" description="Una panoramica di Aspose.Slides per SharePoint" >}}
...
{{< blocks/products/pf/carousel-item h3="Indipendenza dalla piattaforma" description="Aspose.Slides per SharePoint funziona con Microsoft Office SharePoint Server e Windows SharePoint Services." >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
...
{{< blocks/products/pf/carousel-item h3="Formati di file supportati" description="Aspose.Slides per SharePoint supporta la presentazione più comune [formati di file](https://docs.aspose.com/slides/sharepoint/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Funzionalità dell'app di conversione della presentazione di SharePoint
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Converti file PowerPoint dalla raccolta documenti di SharePoint
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Ottieni lo sfondo della tabella predefinito
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     La dimensione rappresenta la proprietà per il grafico a bolle
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Nascondere il riquadro delle miniature della diapositiva sinistra nel PPT generato
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Cartelle di lavoro Excel esterne supportate
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Imposta il percorso della cartella di lavoro dell'origine dati esterna del grafico
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Limitazione dell'accesso al file system locale all'apertura di un documento
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Converti presentazioni PowerPoint in diversi formati
    </h2>
    <p>
     Aspose.Slides per SharePoint converte le presentazioni dalla raccolta documenti di SharePoint in molti formati di scambio di documenti popolari. Aspose.Slides per SharePoint supporta formati di presentazione comuni come formati di input e può esportare in formati di presentazione, nonché PDF, TIFF e XPS.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Installazione facile e leggera
    </h2>
    <p>
     Aspose.Slides per SharePoint è disponibile come archivio ZIP. Decomprimere il file ZIP nell'unità locale sul server MOSS 7.0 o WSS 3.0 ed eseguire setup.exe per installarlo per l'uso. È così facile!
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides per SharePoint viene creato utilizzando codice gestito che non necessita mai dell'installazione di Microsoft PowerPoint sul computer per funzionare con la conversione dei formati di documenti PowerPoint. È una perfetta alternativa all'automazione di Microsoft PowerPoint in termini di funzionalità supportate, sicurezza, stabilità, scalabilità, velocità e prezzo.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Documentazione" href="https://docs.aspose.com/slides/sharepoint/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Perché Aspose.Slides per SharePoint?" tabId="success-stories" >}}
