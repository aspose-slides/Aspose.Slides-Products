---
title: Converti PPTX in POTX tramite C#
weight: 7680
url: /it/net/conversion/pptx-to-potx/ 
description: Codice di esempio per la conversione da PPTX a POTX C#. Utilizzare il codice di esempio API per la conversione batch di file PPTX in POTX all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti PPTX in POTX tramite C#" h2="Esporta file PowerPoint® PPTX in POTX su piattaforme .NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="Gli sviluppatori .NET possono facilmente caricare e convertire file PPTX in POTX in poche righe di codice." >}}
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da PPTX a POTX C#" offSpacer="" %}}
