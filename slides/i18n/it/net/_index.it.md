...
<h2 class="h2title">Controllo completo sugli elementi della diapositiva di PowerPoint</h2>

<p>Aspose.Slides per .NET può gestire tutti gli elementi della diapositiva della presentazione, inclusi casella di testo, tabella, rettangolo, ellisse, polilinea, forma automatica, cornice immagine, cornice audio, cornice video e cornice oggetto OLE. L'API fornisce un set di classi ben progettato che consente di manipolare in modo completo ciascuno di questi elementi.</p>
