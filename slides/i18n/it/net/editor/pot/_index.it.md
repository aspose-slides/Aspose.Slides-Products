---
title: Modifica i file POT tramite .NET
url: /it/net/editor/pot/ 
description: Codice sorgente C# per modificare il documento POT su piattaforme .NET Framework, .NET Core, Windows Azure, Mono o Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Modifica i formati POT in C#" h2="Modifica di documenti POT nativa e ad alte prestazioni utilizzando Aspose.Slides lato server per API .NET, senza l'uso di software come Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Come modificare il file POT usando C#" %}}

Per modificare il file POT, utilizzeremo <a href="https://products.aspose.com/slides/it/net">Aspose.Slides for .NET</a> API che è un'API potente e ricca di funzionalità e API facile da usare per la piattaforma C# per qualsiasi editor. Apri <a href="https://www.nuget.org/packages/aspose.slides.net">NuGet</a> gestore pacchetti, cerca <b>Aspose.Slides</b> e installa. È inoltre possibile utilizzare il seguente comando dalla Console di gestione pacchetti.
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la modifica dei file POT in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Modifica file POT - C#" offSpacer="" %}}
