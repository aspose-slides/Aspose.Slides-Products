---
title: Visualizza o modifica i metadati dei file OTP tramite .NET
weight: 6590
url: /it/net/metadata/otp/ 
description: Codice sorgente C# per modificare o visualizzare i metadati in formato OTP su piattaforme .NET Framework, .NET Core, Windows Azure, Mono o Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Estrai metadati OTP tramite .NET" h2="Crea le tue app .NET per aggiungere, modificare, rimuovere o estrarre metadati dai file OTP utilizzando le API lato server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Come estrarre i metadati OTP usando C#" %}}

 Per estrarre i metadati OTP, utilizzeremo
...
{{< blocks/products/pf/agp/feature-section-col title="Passaggi per estrarre i metadati di OTP tramite C#" >}}
...
{{% blocks/products/pf/agp/code-block title="Estrai metadati di OTP - C#" offSpacer="" %}}
