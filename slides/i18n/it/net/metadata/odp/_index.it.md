---
title: Visualizza o modifica i metadati dei file ODP tramite .NET
weight: 8200
url: /it/net/metadata/odp/ 
description: Codice sorgente C# per modificare o visualizzare i metadati in formato ODP su piattaforme .NET Framework, .NET Core, Windows Azure, Mono o Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Estrai metadati ODP tramite .NET" h2="Crea le tue app .NET per aggiungere, modificare, rimuovere o estrarre metadati dai file ODP utilizzando le API lato server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Come estrarre i metadati ODP usando C#" %}}

 Per estrarre i metadati ODP, utilizzeremo
...
{{< blocks/products/pf/agp/feature-section-col title="Passaggi per estrarre i metadati di ODP tramite C#" >}}
...
{{% blocks/products/pf/agp/code-block title="Estrai metadati di ODP - C#" offSpacer="" %}}
