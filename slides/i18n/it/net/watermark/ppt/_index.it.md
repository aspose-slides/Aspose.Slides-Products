---
title: Filigrana documento PPT tramite .NET
weight: 7740
url: /it/net/watermark/ppt/ 
description: Codice sorgente C# per aggiungere o rimuovere filigrana nel file PPT su piattaforme .NET Framework, .NET Core, Windows Azure, Mono o Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Aggiungi filigrana di testo a PPT tramite C#" h2="Crea le tue app .NET per filigranare i file PPT utilizzando le API lato server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Come filigranare il file PPT usando C#" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/it/net/watermark/pptx/" name="PPTX" description="Apri il formato di presentazione XML" >}}
