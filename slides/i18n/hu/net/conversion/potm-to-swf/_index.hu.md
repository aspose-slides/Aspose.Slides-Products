---
title: A POTM konvertálása SWF-re C#-on keresztül
weight: 3320
url: /hu/net/conversion/potm-to-swf/ 
description: Mintakód a POTM-ből SWF C# konvertáláshoz. Használjon API-példakódot a POTM-fájlok kötegelt SWF-re konvertálásához VB.NET-en, Asp.NET-en vagy bármely .NET-alapú alkalmazáson belül.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="A POTM konvertálása SWF-re C#-on keresztül" h2="Exportáljon PowerPoint® POTM fájlokat SWF-be .NET-keretrendszeren, .NET Core-on, Windows Azure-on, Mono- vagy Xamarin-platformokon" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="A POTM konvertálása SWF-re C# használatával" %}}
 ...
 A POTM SWF formátumba konvertálásához használjuk
...
{{< blocks/products/pf/agp/feature-section-col title="A POTM konvertálása SWF-re C#-on keresztül" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="A .NET-fejlesztők egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják a POTM-fájlokat SWF-formátumba." >}}
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a POTM-ből SWF C# konvertálást mutat be" offSpacer="" %}}
