---
title: POTM konvertálása POTX-re C#-on keresztül
weight: 3400
url: /hu/net/conversion/potm-to-potx/ 
description: Mintakód a POTM–POTX C# konverzióhoz. Használjon API-példakódot a POTM-fájlok kötegelt POTX-re konvertálásához VB.NET-en, Asp.NET-en vagy bármely .NET-alapú alkalmazáson belül.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="POTM konvertálása POTX-re C#-on keresztül" h2="Exportáljon PowerPoint® POTM fájlokat POTX-be .NET Framework, .NET Core, Windows Azure, Mono vagy Xamarin platformokon" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{< blocks/products/pf/agp/feature-section-col title="A POTM konvertálása POTX-re C#-on keresztül" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="A .NET-fejlesztők egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják a POTM fájlokat POTX-re." >}}
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a POTM-ból POTX-be C# konvertálást mutat" offSpacer="" %}}
