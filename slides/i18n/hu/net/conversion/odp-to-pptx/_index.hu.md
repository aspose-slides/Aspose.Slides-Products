---
title: ODP konvertálása PPTX-re C# segítségével
weight: 8380
url: /hu/net/conversion/odp-to-pptx/ 
description: Mintakód az ODP-PPTX C# konverzióhoz. Használjon API-példakódot az ODP-fájlok kötegelt PPTX-re konvertálásához VB.NET-en, Asp.NET-en vagy bármely .NET-alapú alkalmazáson belül.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ODP konvertálása PPTX-re C# segítségével" h2="Exportáljon PowerPoint® ODP-fájlokat PPTX-be .NET-keretrendszeren, .NET Core-on, Windows Azure-on, Mono- vagy Xamarin-platformokon" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{< blocks/products/pf/agp/feature-section-col title="Lépések az ODP-ből PPTX-vé konvertálásához C#-on keresztül" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="A .NET-fejlesztők egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják az ODP-fájlokat PPTX-re." >}}
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód az ODP-ből PPTX-be való C# konvertálást mutatja" offSpacer="" %}}
