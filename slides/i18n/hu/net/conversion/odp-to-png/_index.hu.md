---
title: ODP konvertálása PNG-re C#-n keresztül
weight: 5570
url: /hu/net/conversion/odp-to-png/ 
description: Mintakód az ODP-ből PNG-be C# konvertáláshoz. Használjon API-példakódot az ODP-fájlok kötegelt PNG-vé konvertálásához VB.NET-en, Asp.NET-en vagy bármely .NET-alapú alkalmazáson belül.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ODP konvertálása PNG-re C#-n keresztül" h2="Exportáljon PowerPoint® ODP fájlokat PNG formátumba .NET Framework, .NET Core, Windows Azure, Mono vagy Xamarin platformokon" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet az ODP-t PNG-be konvertálni C# használatával" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Az ODP PNG-re konvertálásának lépései C# segítségével" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="A .NET fejlesztők egyszerűen betölthetik és konvertálhatják az ODP fájlokat PNG-re, mindössze néhány sornyi kóddal." >}}
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód az ODP-ből PNG-be való C# konvertálást mutatja" offSpacer="" %}}
