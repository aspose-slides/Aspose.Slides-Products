---
title: ODP konvertálása PPTM-re C#-on keresztül
weight: 1800
url: /hu/net/conversion/odp-to-pptm/ 
description: Mintakód az ODP-PPTM C# konverzióhoz. Használjon API-példakódot az ODP-fájlok kötegelt PPTM-átalakításához VB.NET-en, Asp.NET-en vagy bármely .NET-alapú alkalmazáson belül.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ODP konvertálása PPTM-re C#-on keresztül" h2="Exportálja a PowerPoint® ODP-fájlokat PPTM-be .NET-keretrendszeren, .NET Core-on, Windows Azure-on, Mono- vagy Xamarin-platformokon" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet az ODP-t PPTM-re konvertálni C# használatával" %}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="A .NET-fejlesztők egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják az ODP-fájlokat PPTM-re." >}}
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód az ODP-ből PPTM-be való C# konvertálást mutatja" offSpacer="" %}}
