...
{{% blocks/products/pf/agp/content h2="A POTM konvertálása SVG-vé a C# használatával" %}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="A .NET-fejlesztők egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják a POTM-fájlokat SVG-formátumba." >}}
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a POTM-ből SVG C# konvertálást mutat be" offSpacer="" %}}
