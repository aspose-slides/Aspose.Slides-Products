---
title: POTM konvertálása PNG-re C#-on keresztül
weight: 2580
url: /hu/net/conversion/potm-to-png/ 
description: Mintakód a POTM-ből PNG-be C# konvertáláshoz. Használjon API-példakódot a POTM-fájlok kötegelt PNG-vé konvertálásához VB.NET-en, Asp.NET-en vagy bármely .NET-alapú alkalmazáson belül.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="POTM konvertálása PNG-re C#-on keresztül" h2="Exportálja a PowerPoint® POTM fájlokat PNG formátumba .NET Framework, .NET Core, Windows Azure, Mono vagy Xamarin platformokon" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="A POTM konvertálása PNG-re C# használatával" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="A POTM konvertálása PNG-re C#-on keresztül" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="A .NET-fejlesztők egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják a POTM fájlokat PNG formátumba." >}}
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a POTM-ből PNG-be való C# konvertálást mutatja" offSpacer="" %}}
