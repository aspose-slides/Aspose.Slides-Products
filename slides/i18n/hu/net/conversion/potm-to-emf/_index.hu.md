---
title: A POTM konvertálása EMF-re C# segítségével
weight: 8890
url: /hu/net/conversion/potm-to-emf/ 
description: Mintakód a POTM-ből EMF C# konvertáláshoz. Használjon API-példakódot a kötegelt POTM-fájlok EMF-átalakításához VB.NET-en, Asp.NET-en vagy bármely .NET-alapú alkalmazáson belül.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="A POTM konvertálása EMF-re C# segítségével" h2="Exportáljon PowerPoint® POTM fájlokat EMF-be .NET Framework, .NET Core, Windows Azure, Mono vagy Xamarin platformokon" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="A POTM konvertálása EMF-re a C# használatával" %}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="A .NET-fejlesztők néhány kódsor segítségével könnyedén betölthetik és átalakíthatják a POTM-fájlokat EMF-re." >}}
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a POTM-ből EMF C# konvertálást mutat be" offSpacer="" %}}
