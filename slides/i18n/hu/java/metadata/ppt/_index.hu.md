---
title: Szerkessze vagy tekintse meg a PPT-fájlok metaadatait Java-n keresztül
weight: 4490
url: /hu/java/metadata/ppt/ 
description: Java mintakód a PPT formátumú metaadatok szerkesztéséhez vagy megtekintéséhez a Java Runtime Environment for JSP/JSF alkalmazásokhoz és asztali alkalmazásokhoz.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="PPT metaadatok kibontása Java-n keresztül" h2="Készítse el saját Java-alkalmazásait a PPT-fájlok metaadatok hozzáadásához, szerkesztéséhez, eltávolításához vagy kibontásához szerveroldali API-k segítségével." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="PPT metaadatok kinyerése Java használatával" %}}

 A PPT-fájl metaadatainak beszerzéséhez használjuk
...
{{< blocks/products/pf/agp/feature-section-col title="A PPT metaadatainak Java-n keresztüli kinyerésének lépései" >}}
...
PPT információk lekérése a getPresentationInfo() segítségével
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Frissítse és írjon PPT információkat új tulajdonságokkal
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="PPT metaadatainak kibontása - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/java/metadata/pptx/" name="PPTX" description="Nyissa meg az XML prezentációs formátumot" >}}
