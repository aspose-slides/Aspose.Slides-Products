---
title: Szerkessze vagy tekintse meg az OTP-fájlok metaadatait Java segítségével
weight: 4920
url: /hu/java/metadata/otp/ 
description: Java mintakód az OTP formátumú metaadatok szerkesztéséhez vagy megtekintéséhez a Java Runtime Environment for JSP/JSF alkalmazásokhoz és asztali alkalmazásokhoz.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Az OTP metaadatok kinyerése Java-n keresztül" h2="Készítse el saját Java-alkalmazásait az OTP-fájlok metaadatainak hozzáadásához, szerkesztéséhez, eltávolításához vagy kibontásához szerveroldali API-k segítségével." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTP" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Az OTP metaadatok kinyerése Java használatával" %}}

 Az OTP-fájlok metaadatainak beszerzéséhez használjuk
...
{{< blocks/products/pf/agp/feature-section-col title="Az OTP metaadatainak Java-n keresztüli kinyerésének lépései" >}}
...
OTP információk lekérése a getPresentationInfo() segítségével
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Frissítse és írjon OTP információkat új tulajdonságokkal
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Az OTP metaadatainak kibontása – Java" offSpacer="" %}}
