---
title: Szerkessze vagy tekintse meg a PPS-fájlok metaadatait Java-n keresztül
weight: 8790
url: /hu/java/metadata/pps/ 
description: Java mintakód a PPS formátum metaadatok szerkesztéséhez vagy megtekintéséhez Java Runtime Environment for JSP/JSF Applications és asztali alkalmazásokhoz.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="PPS metaadatok kibontása Java-n keresztül" h2="Készítse el saját Java-alkalmazásait a PPS-fájlok metaadatok hozzáadásához, szerkesztéséhez, eltávolításához vagy kibontásához szerveroldali API-k segítségével." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPS" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="A PPS metaadatok kinyerése Java használatával" %}}

 A PPS-fájlok metaadatainak beszerzéséhez használjuk
...
{{< blocks/products/pf/agp/feature-section-col title="A PPS metaadatainak Java-n keresztüli kinyerésének lépései" >}}
...
PPS-adatok beszerzése a getPresentationInfo() segítségével
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Frissítse és írjon PPS-információkat új tulajdonságokkal
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="PPS metaadatainak kibontása - Java" offSpacer="" %}}
