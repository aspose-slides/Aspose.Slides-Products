...
{{% blocks/products/pf/agp/content h2="Hogyan lehet a POT-ot POTM-má konvertálni Java használatával" %}}

 Ahhoz, hogy a POT-ot POTM-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a POT konvertálásához POTM-má Java segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztők könnyedén konvertálhatnak POT fájlt POTM-má, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="POT to POTM Java konverziós forráskód" offSpacer="" %}}
