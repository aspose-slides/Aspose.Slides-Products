...
{{% blocks/products/pf/agp/content h2="Hogyan lehet PPT-t OTP-vé konvertálni Java használatával" %}}

 Ahhoz, hogy a PPT-t OTP-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a PPT OTP-vé konvertálásához Java segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztők könnyedén konvertálhatják a PPT fájlt OTP-vé, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="PPT-ből OTP Java konvertálási forráskód" offSpacer="" %}}
