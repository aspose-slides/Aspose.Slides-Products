...
{{% blocks/products/pf/agp/content h2="Hogyan lehet a POT-ot OTP-vé konvertálni Java használatával" %}}

 Ahhoz, hogy a POT-ot OTP-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a POT OTP-vé konvertálásához Java segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztők könnyedén konvertálhatnak POT fájlt OTP-vé, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="POT-ból OTP Java konverziós forráskód" offSpacer="" %}}
