...
{{% blocks/products/pf/agp/content h2="Hogyan lehet a POT-ot SWF-re konvertálni Java használatával" %}}

 Ahhoz, hogy a POT-ot SWF-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a POT SWF formátumba konvertálásához Java segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztők könnyedén konvertálhatják a POT fájlt SWF formátumba, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="POT SWF Java konvertálási forráskód" offSpacer="" %}}
