...
{{% blocks/products/pf/agp/content h2="Hogyan lehet a POT-ot PPT-vé konvertálni Java használatával" %}}

 Ahhoz, hogy a POT-ot PPT-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a POT konvertálásához PPT-vé Java segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztők könnyedén konvertálhatják a POT fájlt PPT-vé, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="POT–PPT Java konverziós forráskód" offSpacer="" %}}
