---
title: Védje és zárolja az ODP-dokumentumot Java-n keresztül
weight: 2650
url: /hu/java/protect/odp/ 
description: Java-mintakód az ODP-fájl jelszóval történő zárolásához a Java Runtime Environment JSP/JSF-alkalmazásokhoz és asztali alkalmazásokhoz.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ODP-fájlok titkosítása Java-n keresztül" h2="Jelszóval védheti a PowerPoint prezentációkat, beleértve az ODP formátumot is a .NET Library használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Az ODP-fájlok biztonsága Java használatával" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Az ODP-fájlok Java-n keresztüli védelmének lépései" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Jelszó beállítása getProtectionManager().encrypt(.) metódus
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Mentse el a védett prezentációt ODP formátumban
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/hu/java/protect/pptx/" name="PPTX" description="Nyissa meg az XML prezentációs formátumot" >}}
