...
Programozottan kell konvertálnia a PPSM fájlokat XPS-re? Az [*Aspose.Slides for Python .NET-en keresztüli használatával*](https://products.aspose.com/slides/python-net/) bármely fejlesztő konvertálhatja a PPSM-et XPS formátumba, mindössze néhány sor Python kóddal.
