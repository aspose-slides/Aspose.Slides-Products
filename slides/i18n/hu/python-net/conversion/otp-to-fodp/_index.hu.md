...
Programozottan kell konvertálnia az OTP fájlokat FODP-re? Az [*Aspose.Slides for Python for .NET használatával*](https://products.aspose.com/slides/python-net/) bármely fejlesztő az OTP-t FODP formátumba konvertálhatja, mindössze néhány sor Python kóddal.
