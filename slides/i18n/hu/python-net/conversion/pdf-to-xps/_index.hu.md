...
Programozottan kell konvertálnia a PDF fájlokat XPS-re? Az [*Aspose.Slides for Python for .NET használatával*](https://products.aspose.com/slides/python-net/) bármely fejlesztő konvertálhatja a PDF-et XPS formátumba, mindössze néhány sor Python kóddal.
