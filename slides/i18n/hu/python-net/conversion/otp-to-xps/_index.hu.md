...
Programozottan kell konvertálnia az OTP fájlokat XPS-re? Az [*Aspose.Slides for Python for .NET segítségével*](https://products.aspose.com/slides/python-net/) használatával bármely fejlesztő az OTP-t XPS formátumba konvertálhatja, mindössze néhány sor Python kóddal.
