---
title: Konvertálja az ODP-t JPEG-be C++ alkalmazással
weight: 4730
url: /hu/cpp/conversion/odp-to-jpeg/ 
description: Minta C++ konverziós kód az ODP dokumentumhoz JPEG formátumba. Használjon példakódot a kötegelt ODP-JPEG konvertáláshoz bármely C++ alkalmazáson belül.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertálja az ODP-t JPEG-be a C++ segítségével" h2="Nagy teljesítményű ODP-JPEG konvertálás C++ könyvtár használatával, Microsoft PowerPoint telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Hogyan konvertálhat ODP-t JPEG-be C++ használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az ODP konvertálásához JPEG formátumba C++ segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A C++ fejlesztők egyszerűen, néhány sornyi kóddal konvertálhatják az ODP fájlokat JPEG formátumba.
...
{{% blocks/products/pf/agp/code-block title="ODP JPEG C++ átalakítási forráskód" offSpacer="" %}}
