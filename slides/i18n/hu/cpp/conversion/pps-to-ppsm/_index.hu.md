...
{{% blocks/products/pf/agp/content h2="Hogyan lehet PPS-t PPSM-re konvertálni C++ használatával" %}}

 A PPS PPSM-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A PPS konvertálása PPSM-re C++ segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A C++ fejlesztők könnyedén konvertálhatnak PPS fájlt PPSM-re, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="PPS-ből PPSM C++ konverziós forráskód" offSpacer="" %}}
