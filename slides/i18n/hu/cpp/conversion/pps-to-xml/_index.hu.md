...
{{% blocks/products/pf/agp/content h2="Hogyan lehet PPS-t XML-re konvertálni C++ használatával" %}}

 A PPS XML-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A PPS konvertálása XML-re C++ segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A C++ fejlesztők könnyedén konvertálhatnak PPS fájlt XML-re, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="PPS-ből XML C++ konverziós forráskód" offSpacer="" %}}
