---
title: Javaを介してPPTXドキュメントを保護およびロックする
weight: 6710
url: /ja/java/protect/pptx/ 
description: JSP/JSFアプリケーションおよびデスクトップアプリケーション用のJavaランタイム環境でパスワードを使用してPPTXファイルをロックするJavaサンプルコード。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Javaを介してPPTXファイルを暗号化する" h2=".NETライブラリを使用したPPTX形式を含むPowerPointプレゼンテーションをパスワードで保護します。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してPPTXファイルを保護する方法" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Javaを介してPPTXファイルを保護する手順" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ja/java/protect/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
