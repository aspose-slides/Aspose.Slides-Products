---
title: Javaを介してPPSファイルのメタデータを編集または表示する
weight: 8790
url: /ja/java/metadata/pps/ 
description: JSP/JSFアプリケーションおよびデスクトップアプリケーション用のJavaランタイム環境でPPS形式のメタデータを編集または表示するためのJavaサンプルコード。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Javaを介してPPSメタデータを抽出する" h2="サーバー側APIを使用して、PPSファイルからメタデータを追加、編集、削除、または抽出するための独自のJavaアプリを構築します。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPS" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してPPSメタデータを抽出する方法" %}}

 PPSファイルのメタデータを取得するために、
...
{{< blocks/products/pf/agp/feature-section-col title="Javaを介してPPSのメタデータを抽出する手順" >}}
...
getPresentationInfo（）を使用してPPS情報を取得します
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="PPSのメタデータを抽出する-Java" offSpacer="" %}}
