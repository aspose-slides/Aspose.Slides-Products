---
title: Javaを介してPPTファイルのメタデータを編集または表示する
weight: 4490
url: /ja/java/metadata/ppt/ 
description: JSP/JSFアプリケーションおよびデスクトップアプリケーション用のJavaランタイム環境でPPT形式のメタデータを編集または表示するためのJavaサンプルコード。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Javaを介してPPTメタデータを抽出する" h2="サーバー側APIを使用して、PPTファイルからメタデータを追加、編集、削除、または抽出するための独自のJavaアプリを構築します。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してPPTメタデータを抽出する方法" %}}

 PPTファイルのメタデータを取得するために、
...
{{< blocks/products/pf/agp/feature-section-col title="Javaを介してPPTのメタデータを抽出する手順" >}}
...
getPresentationInfo（）を使用してPPT情報を取得します
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="PPTのメタデータの抽出-Java" offSpacer="" %}}
