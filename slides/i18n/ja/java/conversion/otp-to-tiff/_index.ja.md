---
title: Java経由でOTPをTIFFに変換する
weight: 470
url: /ja/java/conversion/otp-to-tiff/ 
description: OTP形式からTIFFファイルへのサンプルJava変換コード。このサンプルコードを使用して、PowerPointおよびOpenOfficeプレゼンテーションをWebまたはデスクトップJavaベースのアプリケーション内のTIFFにエクスポートします。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java経由でOTPをTIFFに変換する" h2="オンプレミスJavaライブラリを使用して単一または複数のページをTIFFに変換するためのOTPからTIFFへのJava変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTP" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してOTPをTIFFに変換する方法" %}}

 OTPをTIFFにレンダリングするために、
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してOTPをTIFFに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Java開発者は、わずか数行のコードでOTPファイルをTIFFに簡単に変換できます。
...
{{% blocks/products/pf/agp/code-block title="OTPからTIFFへのJava変換ソースコード" offSpacer="" %}}
