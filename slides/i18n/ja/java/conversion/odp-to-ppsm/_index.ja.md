---
title: Javaを介してODPをPPSMに変換する
weight: 5170
url: /ja/java/conversion/odp-to-ppsm/ 
description: ODP形式からPPSMファイルへのサンプルJava変換コード。このサンプルコードを使用して、PowerPointおよびOpenOfficeプレゼンテーションをWebまたはデスクトップJavaベースのアプリケーション内のPPSMにエクスポートします。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Javaを介してODPをPPSMに変換する" h2="オンプレミスJavaライブラリを使用して単一または複数のページをPPSMに変換するためのODPからPPSMへのJava変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してODPをPPSMに変換する方法" %}}

 ODPをPPSMにレンダリングするために、
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してODPをPPSMに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Java開発者は、わずか数行のコードでODPファイルをPPSMに簡単に変換できます。
...
{{% blocks/products/pf/agp/code-block title="ODPからPPSMへのJava変換ソースコード" offSpacer="" %}}
