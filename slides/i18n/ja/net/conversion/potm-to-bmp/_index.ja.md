...
{{% blocks/products/pf/agp/content h2="C＃を使用してPOTMをBMPに変換する方法" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="C＃を介してPOTMをBMPに変換する手順" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET開発者は、わずか数行のコードでPOTMファイルを簡単にロードしてBMPに変換できます。" >}}
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードは、POTMからBMPへのC＃変換を示しています" offSpacer="" %}}
