---
title: C＃を介してPPSをPOTXに変換する
weight: 5380
url: /ja/net/conversion/pps-to-potx/ 
description: PPSからPOTXC＃への変換のサンプルコード。 VB.NET、Asp.NET、または任意の.NETベースのアプリケーション内でのバッチPPSファイルからPOTXへの変換にAPIサンプルコードを使用します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C＃を介してPPSをPOTXに変換する" h2="PowerPoint®PPSファイルを.NETFramework、.NET Core、Windows Azure、Mono、またはXamarinプラットフォーム上のPOTXにエクスポートします" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPS" >}}
...
{{% blocks/products/pf/agp/content h2="C＃を使用してPPSをPOTXに変換する方法" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="C＃を介してPPSをPOTXに変換する手順" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET開発者は、わずか数行のコードでPPSファイルを簡単にロードしてPOTXに変換できます。" >}}
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードは、PPSからPOTXへのC＃変換を示しています" offSpacer="" %}}
