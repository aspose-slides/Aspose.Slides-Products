---
title: .NET経由でPPTXドキュメントのロックを解除する
weight: 6480
url: /ja/net/unlock/pptx/ 
description: .NET Framework、.NET Core、Windows Azure、Mono、またはXamarinプラットフォームでパスワードで保護されたPPTXファイルのロックを解除するためのC＃ソースコード。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C＃経由でPPTXプレゼンテーションのロックを解除する" h2=".NETライブラリを使用してPPTXから保護を削除します。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="C＃を使用してPPTXファイルのロックを解除する方法" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="C＃経由でPPTXのロックを解除する" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ja/net/unlock/odp/" name="ODP" description="OpenDocumentプレゼンテーション形式" >}}
