---
title: .NET経由でPOTXファイル形式を表示
weight: 5740
url: /ja/net/viewer/potx/ 
description: .NET Framework、.NET Core、Windows Azure、Mono、またはXamarinプラットフォームでPOTXドキュメントをロード、レンダリング、および表示するためのC＃ソースコード。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1=".NET用POTXファイルビューア" h2="MicrosoftPowerPointやOfficeAutomationを使用せずにPOTXなどのプレゼンテーションファイルを表示する" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="C＃を使用してPOTXファイルを表示する方法" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="C＃経由でPOTXを表示する手順" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Aspose.Slidesを使用すると、開発者は数行のコードでPOTXファイルを簡単に表示できます。" >}}

{{< blocks/products/pf/agp/step-autogen >}}
プレゼンテーションオブジェクトをインスタンス化し、POTXファイルをロードします
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
POTXプレゼンテーションをHTML形式で保存します
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Processを呼び出します。結果のHTMLへのパスから開始して、デフォルトのブラウザにPOTXコンテンツをロードします。
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="POTXファイルを表示するためのC＃サンプルコード" offSpacer="" %}}
