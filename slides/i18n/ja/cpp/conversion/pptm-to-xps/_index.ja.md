...
{{% blocks/products/pf/agp/text %}}
 ...
 C ++開発者は、わずか数行のコードでPPTMファイルをXPSに簡単に変換できます。
...
{{% blocks/products/pf/agp/code-block title="PPTMからXPSC++への変換ソースコード" offSpacer="" %}}
