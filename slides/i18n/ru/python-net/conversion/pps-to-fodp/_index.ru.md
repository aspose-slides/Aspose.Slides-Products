...
Нужно программно преобразовать файлы PPS в FODP? С помощью [*Aspose.Slides for Python через .NET*](https://products.aspose.com/slides/ru/python-net/) любой разработчик может преобразовать PPS в формат FODP всего несколькими строками кода Python.
