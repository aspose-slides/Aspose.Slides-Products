---
title: API PowerPoint для Android | Aspose.Slides для Android API
weight: 5960
url: /ru/android-java/ 
description: Aspose.Slides для Android API или Android PowerPoint API для создания и управления PPT POT PPS PPTX POTX PPSX PowerPoint на Android.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API PowerPoint для Android" h2="Создавайте, изменяйте, конвертируйте, объединяйте, разделяйте и управляйте презентациями PowerPoint в приложениях для Android." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-android-java.svg" pfName="Aspose.Slides" subTitlepfName="for Android via Java" downloadUrl="https://downloads.aspose.com/slides/androidjava" >}}
...
<p>
 Aspose.Slides для Android через Java — это API PowerPoint для приложений Android. Разработчики могут выполнять широкий спектр задач по обработке презентаций, включая чтение, запись, изменение, слияние, разделение, преобразование и управление презентациями без какой-либо зависимости от Microsoft PowerPoint.
</p>

<p>
 Aspose.Slides для Android через Java поддерживает почти все родные форматы файлов PowerPoint, а также формат презентаций OpenOffice (ODP). Создайте свое приложение для просмотра PowerPoint для Android, а также конвертер, редактор или любое другое. К элементам презентации, таким как фигуры SmartArt, диаграммы MSO, компоненты ActiveX и объекты кадра OLE, можно получить доступ через API PowerPoint для управления и манипулирования.
</p>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Усовершенствованные функции Android PowerPoint API
   </h2>
   <p>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Создавайте новые слайды или клонируйте из шаблонов
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Добавить или удалить защиту фигур
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Добавьте диаграммы Microsoft Excel как OleObjects
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Импорт и экспорт HTML-текста в слайды
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Управление компонентами ActiveX и SmartArt
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Добавить или изменить переход слайд-шоу
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Преобразование изображений SVG в формы
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Форматирование презентации на минутном уровне
    </h2>
    <p>
     Библиотека PowerPoint может легко обрабатывать функции форматирования текста и фигур, такие как размер шрифта, тип, цвет и оттенки, выравнивание абзаца, маркеры и ориентация и гиперссылки.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Преобразование презентации с примечаниями
    </h2>
    <p>
     API обеспечивает преобразование в TIFF и PDF с примечаниями. Разработчики могут преобразовать всю презентацию в представлении Notes Slide в поддерживаемый формат, а в случае изображений можно создать миниатюру слайда в представлении Notes Slide для отдельных слайдов. Вот код преобразования TIFF.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Преобразование презентаций с помощью Notes
     </h3>
...
pres.save(dataDir + "TestNotes.tiff", SaveFormat.Tiff,opts);
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Управление элементами через общедоступный API
    </h2>
    <p>
     API может обрабатывать все элементы слайдов презентации, включая прямоугольник, таблицу, текстовое поле, эллипс, полилинию, рамку изображения, автоформу, звуковую рамку, рамку объекта OLE и видеокадр. API также предоставляет богатый набор команд API для управления каждым из этих элементов. Кроме того, форматирование текста поддерживается с помощью хорошо разработанного набора классов.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Документация" href="https://docs.aspose.com/slides/androidjava/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Почему Aspose.Slides для Android через Java?" tabId="success-stories" >}}
