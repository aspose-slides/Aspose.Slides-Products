...
{{< blocks/products/pf/i18n/carousel-item h3="С одного взгляда" description="Обзор функций Aspose.Slides for Java API." >}}
...
{{< blocks/products/pf/i18n/carousel-item h3="Независимость от платформы" description="Aspose.Slides for Java API можно использовать в любом рабочем столе на основе Java, корпоративном веб-приложении или в любой среде Linux и Unix." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/i18n/carousel-item h3="Поддерживаемые форматы файлов" description="Aspose.Slides for Java API поддерживает следующие [презентации](https://docs.aspose.com/slides/java/supported-file-formats/) и форматы преобразования." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Расширенные функции API обработки документов Java PowerPoint</h2>

<p>Aspose.Slides for Java включает в себя ряд дополнительных функций, которые дают разработчикам полный контроль при программировании презентаций Microsoft PowerPoint в среде Java.</p>-->
   <h2 class="pr-ft">
...
<h2 class="h2title">Форматирование содержимого слайдов</h2>

<p>Можно форматировать текст и фигуры на слайдах в презентации с помощью Aspose.Slides for Java API. Текст управляется с помощью текстовых фреймов, связанных с фигурами. Следовательно, текст форматируется с использованием абзацев и частей, связанных с текстовыми фреймами. Вы также можете управлять атрибутами элемента формы, такими как положение, размер, линия, изображение, текст и заливка.</p>
...
{{< blocks/products/pf/slr-element name="Примечания к выпуску" href="https://docs.aspose.com/slides/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
