---
title: Экспорт JasperReports в PowerPoint | Aspose.Слайды
weight: 8320
url: /ru/jasperreports/ 
description: Aspose.Slides PowerPoint API для JaspreReport для экспорта отчетов из Jasper Reports и JasperServer в форматы PowerPoint. Создавайте и экспортируйте изображения графиков счетов, текстовые и линейные отчеты в презентацию PPT.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Экспорт отчетов JasperServer в презентации PowerPoint" h2="API PowerPoint для экспорта отчетов JasperReports и JasperServer в форматы PPT(X), PPS(X) и другие форматы PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-jasperreports.svg" pfName="Aspose.Slides" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/slides/jasperreport" >}}
...
<p>
 Aspose.Slides for JasperReports — это API PowerPoint для гибкого и простого в использовании экспорта отчетов JasperReports и JasperServer в PowerPoint. JasperServer не имеет встроенной возможности экспорта отчетов в виде презентаций PowerPoint. Однако с помощью этого API PowerPoint отчеты JasperServer можно экспортировать в форматы презентаций PPT, PPS, PPTX и PPSX без использования Microsoft PowerPoint.
</p>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Расширенные возможности JasperReports для экспорта презентаций</h2>

<p> </p>

<div class="col-lg-4"><em class="fa fa-file-powerpoint-o  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Создавайте отчеты об учетных записях и экспортируйте их в презентации Microsoft PowerPoint.</p>

</div>

<div class="col-lg-4"><em class="fa fa-bar-chart   ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Создавайте отчеты в виде диаграмм и экспортируйте их в презентации Microsoft PowerPoint.</p>

</div>

<div class="col-lg-4"><em class="fa fa-pie-chart ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Создавайте отчеты с несколькими осями и экспортируйте их в презентации Microsoft PowerPoint.</p>

</div>

<div class="col-lg-4"><em class="fa fa-file-text ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Создавайте изображения, текст, линии и экспортируйте эти отчеты в презентацию Microsoft PowerPoint.</p>

</div>-->
   <h2 class="pr-ft">
    Расширенные функции JasperReports PowerPoint API
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Создание отчетов по учетным записям
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Создание отчетов с несколькими осями
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Добавляйте изображения, текст, строки в отчеты
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-file-text ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Экспорт отчетов в презентации PowerPoint
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-file-text ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Поддержка ответов на комментарии, Office 365 и внешних книг Excel.
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Скрыть панель эскизов левого слайда в созданном PPT
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-area-chart ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Воронка, двумерные карты и свойство размера для пузырьковой диаграммы
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-cog ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Подсветка текста, шифрование OpenDocument и рендеринг фигур
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Установите свойство Transparency для эффектов тени и перехода Morph Transition.
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Установить языковой стандарт в приложении и форму выноски для метки данных серии
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Добавлена ​​поддержка формата Strict Open XML.
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Получите эффекты по абзацам текстового поля
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     ChartData SetRange в сводной таблице
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Реализуйте сериализацию со строгим соответствием формату Open XML.
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Соответствие алгоритмам, совместимым с FIPS
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Поддержка отчета с несколькими осями
    </h2>
    <p>
     Aspose.Slides for JasperReports поддерживает экспорт сложных отчетов, содержащих
     <сильный>
      Отчет о нескольких осях диаграммы
     </strong>
     к презентациям Microsoft PowerPoint. Вывод точно такой же, как при просмотре через JasperViewer.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Экспорт отчетов в форматы презентаций
    </h2>
    <p>
     JasperReports и JasperServer не имеют встроенной поддержки экспорта отчетов в презентации Microsoft PowerPoint, однако интеграция с Aspose.Slides для JasperReports позволяет экспортировать ваши отчеты в презентации Microsoft PowerPoint (PPT, PPTX) и слайд-шоу Microsoft PowerPoint (PPS, ППСС).
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides для JasperReports построен с использованием управляемого кода, который не требует установки Microsoft PowerPoint на компьютере для работы с документами PowerPoint. Это идеальная альтернатива автоматизации Microsoft PowerPoint с точки зрения поддерживаемых функций, безопасности, стабильности, масштабируемости, скорости и цены.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Документация" href="https://docs.aspose.com/slides/jasperreports/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Почему Aspose.Slides для JasperReports?" tabId="success-stories" >}}
