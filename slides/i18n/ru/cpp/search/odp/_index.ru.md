---
title: Поиск документа ODP без открытия через C++
weight: 6500
url: /ru/cpp/search/odp/ 
description: Пример кода C++ для поиска слов с шаблоном в файле ODP в среде выполнения C++ для 32-разрядной версии Windows, 64-разрядной версии Windows и 64-разрядной версии Linux.
---
...
{{< blocks/products/pf/agp/feature-section-col title="Шаги для поиска файлов ODP в C++" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/cpp/search/pptx/" name="PPTX" description="Формат презентации Open XML" >}}
