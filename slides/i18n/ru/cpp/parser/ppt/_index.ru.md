---
title: Извлечение текста и изображений из документа PPT с помощью C++
weight: 2780
url: /ru/cpp/parser/ppt/ 
description: Пример кода C++ для извлечения текста и изображений из файла PPT в среде выполнения C++ для 32-разрядной версии Windows, 64-разрядной версии Windows и 64-разрядной версии Linux.
---
...
{{% blocks/products/pf/agp/code-block title="Разбор файлов PPT — C++" offSpacer="" %}}
