---
title: PPT SQL SSRS | API PowerPoint Aspose.Slides
weight: 3020
url: /fr/reporting-services/ 
description: L'API PowerPoint de Reporting Services est Aspose.Slides pour SQL PPT. Services de présentation PowerPoint pour SQL PowerPoint.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API PowerPoint des services de rapports" h2="Exportez les rapports RDL aux formats PowerPoint PPT, PPTX, PPS et PPSX." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-reporting-services.svg" pfName="Aspose.Slides" subTitlepfName="for Reporting Services" downloadUrl="https://downloads.aspose.com/slides/reportingservices" >}}
...
<p>
 Aspose.Slides for Reporting Services est la seule solution sur le marché qui permet de générer des présentations dans les formats natifs de PowerPoint à partir de Microsoft SQL Server Reporting Services.
</p>

<p>
 Aspose.Slides for Reporting Services prend en charge presque toutes les fonctionnalités RDL telles que les tableaux, les matrices, les graphiques, les images, les listes, les sous-rapports et les en-têtes / pieds de page, permettant ainsi d'exporter des rapports dans des formats de présentation PowerPoint de manière à ce qu'ils ressemblent à l'original. conception du rapport. Exécutez Reporting Services SQL PPT sans Microsoft PowerPoint Automation.
</p>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Fonctionnalités de l'API des services de création de rapports avancés
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Créez des tableaux de comparaison dans les rapports RDL et exportez-les sous forme de présentations
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Créez des rapports RDL complexes et exportez-les vers des fichiers de présentation
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Exporter des rapports RDL centrés sur les données contenant des sous-rapports
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Exporter des fichiers audio et vidéo intégrés vers des fichiers PowerPoint
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Exporter des rapports RDL contenant des sous-rapports vers PowerPoint
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Haute fidélité à la conception du rapport
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Changer la couleur de la série et ses catégories
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Rasterisation ou vectorisation de Formes sans texte
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-share ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Convertir des images SVG en formes
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Modifier la couleur du texte du lien hypertexte dans une présentation
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Prise en charge du cryptage Open Document, du surligneur de texte et de la transition Morph
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Graphiques en entonnoir et graphiques cartographiques 2D pris en charge
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Prise en charge des réponses aux commentaires et d'Office 365
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Exporter vers des formats de présentation et de diaporama
    </h2>
    <p>
     SQL Server Reporting Services (SSRS) ne fournit pas de prise en charge intégrée pour l'exportation de rapports RDL vers des présentations PowerPoint ou des diaporamas. Lorsque vous utilisez Aspose.Slides pour Reporting Services, vous pouvez facilement ajouter la prise en charge de formats d'exportation supplémentaires.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for Reporting Services prend en charge la spécification RDL complète et on peut personnaliser les rapports existants à l'aide de cette extension. Il est assez facile de sélectionner le concepteur de rapport RDL de votre choix, puis d'exporter les rapports exactement de la même manière qu'ils l'ont conçu.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for Reporting Services est construit à l'aide d'un code géré qui n'a jamais besoin que Microsoft PowerPoint soit installé sur la machine pour fonctionner avec des présentations PowerPoint. C'est une alternative parfaite à l'automatisation de Microsoft PowerPoint en termes de fonctionnalités prises en charge, de sécurité, de stabilité, d'évolutivité, de vitesse et de prix.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.Slides pour les services de reporting ?" tabId="success-stories" >}}
