...
Besoin de convertir des fichiers ODP en POT par programmation ? En utilisant [*Aspose.Slides pour Python via .NET*](https://products.aspose.com/slides/fr/python-net/), tout développeur peut convertir ODP au format POT avec seulement quelques lignes de code Python.
