...
Besoin de convertir des fichiers POTX en OTP par programme ? En utilisant [*Aspose.Slides pour Python via .NET*](https://products.aspose.com/slides/python-net/), tout développeur peut convertir POTX au format OTP avec seulement quelques lignes de code Python.
