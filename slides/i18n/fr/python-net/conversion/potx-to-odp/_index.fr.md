...
Besoin de convertir des fichiers POTX en ODP par programmation ? En utilisant [*Aspose.Slides pour Python via .NET*](https://products.aspose.com/slides/python-net/), tout développeur peut convertir POTX au format ODP avec seulement quelques lignes de code Python.
