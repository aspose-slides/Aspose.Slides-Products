---
title: Convertir POTX en XPS en Python
weight: 1540
url: /fr/python-net/conversion/potx-to-xps/ 
keywords: "Convert, PowerPoint, POTX, XPS, Presentation, Python"
description: Exemple de code pour la conversion POTX vers XPS Python. Utilisez l'API PowerPoint Python pour la conversion par lots de fichiers POTX en fichiers XPS.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir POTX en XPS en Python" h2="Puissante bibliothèque PowerPoint Python pour convertir POTX en XPS" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir POTX en XPS en Python" %}}

Besoin de convertir des fichiers POTX en XPS par programmation ? En utilisant [*Aspose.Slides pour Python via .NET*](https://products.aspose.com/slides/python-net/), tout développeur peut convertir POTX au format XPS avec seulement quelques lignes de code Python.

En tant qu'API de traitement de présentation moderne, Aspose.Slides pour Python crée rapidement XPS à partir de POTX. Testez la qualité de la conversion POTX en XPS directement dans votre [navigateur](https://products.aspose.app/slides/conversion). La bibliothèque Aspose PowerPoint PPTX vous permet de convertir des fichiers POTX dans de nombreux formats populaires.
...
{{< blocks/products/pf/agp/feature-section-col title="Comment convertir POTX en XPS en Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Voici les étapes pour convertir un fichier POTX en XPS en utilisant Python." >}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion de POTX en XPS Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer POTX en tant que XPS en Python" %}}
Utilisez l'application gratuite pour voir une démonstration du processus de conversion POTX vers XPS. 
{{% /blocks/products/pf/agp/content %}}
