...
Besoin de convertir des fichiers PPS en JPG par programmation ? En utilisant [*Aspose.Slides pour Python via .NET*](https://products.aspose.com/slides/python-net/), n'importe quel développeur peut convertir le format PPS au format JPG avec seulement quelques lignes de code Python.
