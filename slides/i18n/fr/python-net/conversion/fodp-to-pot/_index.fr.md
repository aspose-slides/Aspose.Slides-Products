...
Besoin de convertir des fichiers FODP en POT par programme ? En utilisant [*Aspose.Slides pour Python via .NET*](https://products.aspose.com/slides/python-net/), n'importe quel développeur peut convertir le format FODP au format POT avec seulement quelques lignes de code Python.
