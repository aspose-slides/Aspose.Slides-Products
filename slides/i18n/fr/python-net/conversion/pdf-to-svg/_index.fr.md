...
Besoin de convertir des fichiers PDF en SVG par programmation ? En utilisant [*Aspose.Slides pour Python via .NET*](https://products.aspose.com/slides/fr/python-net/), n'importe quel développeur peut convertir un PDF au format SVG avec seulement quelques lignes de code Python.
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        ...
        sectionTitle="Application gratuite pour convertir PDF en SVG" 
        sectionDescription="[Essayez notre application gratuite pour convertir PDF en SVG](https://products.aspose.app/slides/import/)" 
    >}}
