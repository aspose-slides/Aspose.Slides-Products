...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Fonctionnalités avancées d'exportation de JasperReports vers la présentation</h2>

<p> </p>

<div class="col-lg-4"><em class="fa fa-file-powerpoint-o  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Créez des rapports de comptes et exportez-les vers des présentations Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-bar-chart   ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Créez des rapports graphiques et exportez-les vers des présentations Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-pie-chart ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Créez des rapports de graphique à axes multiples et exportez-les vers des présentations Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-file-text ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Créez des images, du texte, des lignes et exportez ces rapports vers une présentation Microsoft PowerPoint</p>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Masquer le volet des vignettes des diapositives de gauche dans le PPT créé
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-area-chart ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Mettre en œuvre la sérialisation avec la conformité au format Strict Open XML
    </p>
   </div>
   <div class="col-lg-4">
