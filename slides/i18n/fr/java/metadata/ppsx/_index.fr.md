---
title: Modifier ou afficher les métadonnées des fichiers PPSX via Java
weight: 3170
url: /fr/java/metadata/ppsx/ 
description: Exemple de code Java pour modifier ou afficher les métadonnées au format PPSX sur l'environnement d'exécution Java pour les applications d'application et de bureau JSP/JSF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extraire les métadonnées PPSX via Java" h2="Créez vos propres applications Java pour ajouter, modifier, supprimer ou extraire des métadonnées des fichiers PPSX à l'aide d'API côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSX" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Comment extraire les métadonnées PPSX à l'aide de Java" %}}

 Afin d'obtenir les métadonnées du fichier PPSX, nous utiliserons
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour extraire les métadonnées de PPSX via Java" >}}
...
Obtenir des informations PPSX à l'aide de getPresentationInfo()
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Mettre à jour et écrire des informations PPSX avec de nouvelles propriétés
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Extraire les métadonnées de PPSX - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/java/metadata/odp/" name="ODP" description="Format de présentation OpenDocument" >}}
