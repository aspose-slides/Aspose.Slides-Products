---
title: Convertir PPSX en TIFF via Java
weight: 1720
url: /fr/java/conversion/ppsx-to-tiff/ 
description: Exemple de code de conversion Java pour le format PPSX en fichier TIFF. Utilisez cet exemple de code pour exporter des présentations PowerPoint et OpenOffice au format TIFF dans n'importe quelle application Web ou de bureau basée sur Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir PPSX en TIFF en utilisant Java" %}}

 Afin de rendre PPSX en TIFF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir PPSX en TIFF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier PPSX en TIFF en quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion Java PPSX vers TIFF" offSpacer="" %}}
