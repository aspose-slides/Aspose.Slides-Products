...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Fonctionnalités avancées de l'API de traitement de documents Java PowerPoint</h2>

<p>Aspose.Slides pour Java intègre un certain nombre de fonctionnalités avancées qui donnent aux développeurs un contrôle total lors de la programmation avec des présentations Microsoft PowerPoint dans un environnement Java.</p>-->
   <h2 class="pr-ft">
...
<h2 class="h2title">Formatage du contenu des diapositives</h2>

<p>Il est possible de formater du texte et des formes sur des diapositives dans une présentation à l'aide de l'API Aspose.Slides for Java. Le texte est géré par des cadres de texte associés à des formes. Par conséquent, le texte est formaté à l'aide de paragraphes et de portions associés aux cadres de texte. Vous pouvez également manipuler les attributs de l'élément de forme comme la position, la taille, la ligne, l'image, le texte et le remplissage.</p>
...
{{< blocks/products/pf/slr-element name="Notes de version" href="https://docs.aspose.com/slides/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
