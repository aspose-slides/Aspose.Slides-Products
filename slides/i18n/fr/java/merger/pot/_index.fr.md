---
title: Fusionner des fichiers POT via Java
weight: 1100
url: /fr/java/merger/pot/ 
description: Exemple de code Java pour combiner des documents POT sur l'environnement d'exécution Java pour les applications d'application et de bureau JSP/JSF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Fusionner les formats POT en Java" h2="Fusion de documents POT natifs à l'aide d'API Java côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="POT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment fusionner des fichiers POT à l'aide de Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour fusionner des fichiers POT en Java" >}}
...
Chargez le premier fichier POT avec une instance de la classe Presentation.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Chargez le deuxième document POT avec une instance de la classe Presentation.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Parcourez chaque diapositive du deuxième fichier POT.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Fusionner les fichiers POT - Java" offSpacer="" %}}
