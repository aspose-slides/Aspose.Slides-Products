---
title: Fusionner des fichiers POTM via Java
weight: 6620
url: /fr/java/merger/potm/ 
description: Exemple de code Java pour combiner des documents POTM sur Java Runtime Environment pour les applications JSP/JSF et les applications de bureau.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Fusionner les formats POTM en Java" h2="Fusion de documents POTM natifs à l'aide d'API Java côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="Comment fusionner des fichiers POTM à l'aide de Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour fusionner des fichiers POTM en Java" >}}
...
Chargez le premier fichier POTM avec une instance de la classe Presentation.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Chargez le deuxième document POTM avec une instance de la classe Presentation.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Parcourez chaque diapositive du deuxième fichier POTM.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Fusionner les fichiers POTM - Java" offSpacer="" %}}
