...
{{% blocks/products/pf/agp/content h2="Comment convertir PPTM en XPS en utilisant C++" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs C++ peuvent facilement convertir un fichier PPTM en XPS en quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion PPTM vers XPS C++" offSpacer="" %}}
