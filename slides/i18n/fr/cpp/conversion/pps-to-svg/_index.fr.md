...
{{% blocks/products/pf/agp/content h2="Comment convertir PPS en SVG en utilisant C++" %}}

 Afin de convertir PPS en SVG, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir PPS en SVG via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir un fichier PPS en SVG en quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion PPS vers SVG C++" offSpacer="" %}}
