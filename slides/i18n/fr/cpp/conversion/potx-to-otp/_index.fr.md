---
title: Convertir POTX en OTP via une application C++
weight: 7990
url: /fr/cpp/conversion/potx-to-otp/ 
description: Exemple de code de conversion C++ pour le document POTX au format OTP. Utilisez un exemple de code pour la conversion par lots de POTX en OTP dans n'importe quelle application C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir POTX en OTP via C++" h2="Conversion POTX vers OTP haute performance à l'aide de la bibliothèque C++ sans avoir besoin de l'installation de Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir POTX en OTP en utilisant C++" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs C++ peuvent facilement convertir un fichier POTX en OTP en quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion POTX vers OTP C++" offSpacer="" %}}
