---
title: Convertir POTM en TIFF via une application C++
weight: 7410
url: /fr/cpp/conversion/potm-to-tiff/ 
description: Exemple de code de conversion C++ pour le document POTM au format TIFF. Utilisez un exemple de code pour la conversion par lots de POTM en TIFF dans n'importe quelle application C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir POTM en TIFF via C++" h2="Conversion POTM vers TIFF haute performance à l'aide de la bibliothèque C++ sans avoir besoin de l'installation de Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir POTM en TIFF en utilisant C++" %}}
 ...
 Pour convertir POTM en TIFF, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs C++ peuvent facilement convertir un fichier POTM en TIFF en quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion POTM vers TIFF C++" offSpacer="" %}}
