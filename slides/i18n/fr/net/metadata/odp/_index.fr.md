---
title: Afficher ou modifier les métadonnées des fichiers ODP via .NET
weight: 8200
url: /fr/net/metadata/odp/ 
description: Code source C # pour modifier ou afficher les métadonnées au format ODP sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extraire les métadonnées ODP via .NET" h2="Créez vos propres applications .NET pour ajouter, modifier, supprimer ou extraire des métadonnées de fichiers ODP à l'aide d'API côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Comment extraire les métadonnées ODP à l'aide de C#" %}}
...
Instanciez la classe Presentation avec le chemin d'accès au fichier ODP
{{< /blocks/products/pf/agp/step-autogen >}}
