---
title: Afficher ou modifier les métadonnées des fichiers POTM via .NET
weight: 590
url: /fr/net/metadata/potm/ 
description: Code source C # pour modifier ou afficher les métadonnées au format POTM sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extraire les métadonnées POTM via .NET" h2="Créez vos propres applications .NET pour ajouter, modifier, supprimer ou extraire des métadonnées des fichiers POTM à l'aide d'API côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Comment extraire les métadonnées POTM à l'aide de C #" %}}
...
Instanciez la classe Presentation avec le chemin d'accès au fichier POTM
{{< /blocks/products/pf/agp/step-autogen >}}
