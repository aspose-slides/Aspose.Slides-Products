...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour éditer des fichiers PPT en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Modifier les fichiers PPT - C#" offSpacer="" %}}
