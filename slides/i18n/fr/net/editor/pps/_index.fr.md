...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour éditer des fichiers PPS en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Modifier les fichiers PPS - C#" offSpacer="" %}}
