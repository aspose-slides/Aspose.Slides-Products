---
title: Convertir POTX en SWF via C#
weight: 7640
url: /fr/net/conversion/potx-to-swf/ 
description: Exemple de code pour la conversion POTX vers SWF C#. Utilisez le code d'exemple d'API pour les fichiers POTX par lots en conversion SWF dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir POTX en SWF via C#" h2="Exportez des fichiers PowerPoint® POTX vers SWF sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir POTX en SWF en utilisant C #" %}}
 ...
 Pour convertir POTX en SWF, nous utiliserons
...
{{< blocks/products/pf/agp/steps-block-autogen name="Les développeurs .NET peuvent facilement charger et convertir des fichiers POTX en SWF en seulement quelques lignes de code." >}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion de POTX en SWF C#" offSpacer="" %}}
