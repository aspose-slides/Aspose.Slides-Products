...
{{% blocks/products/pf/agp/content h2="Comment convertir PPS en POT à l'aide de C #" %}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="Les développeurs .NET peuvent facilement charger et convertir des fichiers PPS en POT en quelques lignes de code seulement." >}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion PPS en POT C#" offSpacer="" %}}
