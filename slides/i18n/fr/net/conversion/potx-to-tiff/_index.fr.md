---
title: Convertir POTX en TIFF via C#
weight: 570
url: /fr/net/conversion/potx-to-tiff/ 
description: Exemple de code pour la conversion POTX en TIFF C#. Utilisez le code d'exemple d'API pour la conversion de fichiers POTX par lots en TIFF dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir POTX en TIFF via C#" h2="Exportez des fichiers PowerPoint® POTX au format TIFF sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir POTX en TIFF avec C#" %}}

 Pour convertir POTX en TIFF, nous utiliserons
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour convertir POTX en TIFF via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Les développeurs .NET peuvent facilement charger et convertir des fichiers POTX en TIFF en quelques lignes de code seulement." >}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion POTX en TIFF C#" offSpacer="" %}}
