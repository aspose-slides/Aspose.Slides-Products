---
title: Fusionner des fichiers PPSX via .NET
weight: 6100
url: /fr/net/merger/ppsx/ 
description: Code source C # pour combiner des documents PPSX sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Fusionner les formats PPSX en C#" h2="Fusion de documents PPSX native et haute performance à l'aide d'Aspose.Slides côté serveur pour les API .NET, sans l'utilisation de logiciels tels que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment fusionner un fichier PPSX à l'aide de C #" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour fusionner des fichiers PPSX en C#" >}}
...
Chargez tous les fichiers PPSX avec le chemin complet.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Appelez la méthode Save() et passez le nom du fichier (chemin complet) et le format (PPSX) en paramètre.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Vous pouvez maintenant ouvrir et utiliser le fichier PPSX dans Microsoft Office, Adobe PDF ou tout autre programme compatible.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Fusionner des fichiers PPSX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/net/merger/ppsm/" name="PPSM" description="Diaporama compatible avec les macros" >}}
