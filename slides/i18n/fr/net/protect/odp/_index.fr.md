...
{{< blocks/products/pf/i18n/upper-banner h1="Crypter les fichiers ODP via C#" h2="Protégez par mot de passe les présentations PowerPoint, y compris le format ODP, à l'aide de la bibliothèque .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Comment protéger un fichier ODP avec C#" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Protéger ODP via C#" >}}
