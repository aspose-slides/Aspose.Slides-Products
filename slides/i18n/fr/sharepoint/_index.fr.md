---
title: PowerPoint SharePoint | API SharePoint Aspose.Slides
weight: 910
url: /fr/sharepoint/ 
description: SharePoint PowerPoint est un Aspose.Slides SharePoint pour créer et convertir SharePoint PPT, diaporama SharePoint, présentation SharePoint.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Solution PowerPoint SharePoint" h2="Gérez et convertissez des présentations PowerPoint dans SharePoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-sharepoint.svg" pfName="Aspose.Slides" subTitlepfName="for SharePoint" downloadUrl="https://downloads.aspose.com/slides/sharepoint" >}}
...
<p>
 Aspose.Slides pour SharePoint pour gérer et convertir des fichiers PowerPoint dans SharePoint. Aspose.Slides, en tant que solution SharePoint PowerPoint, peut facilement importer des formats de présentation Microsoft courants, notamment PPT, POT, PPS, PPTX, POTX et PPSX, et peut exporter ces formats vers des fichiers PDF, TIFF et XPS. Utilisez toutes les fonctionnalités SharePoint PPT sans Microsoft PowerPoint Automation nécessaire.
</p>

<p>
 Aspose.Slides pour SharePoint fonctionne avec Windows SharePoint Services WSS 3.0 et Microsoft Office SharePoint Server 2007, 2010 et 2013.
</p>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Fonctionnalités de l'application de conversion de présentation SharePoint
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Convertir des fichiers PowerPoint à partir de la bibliothèque de documents SharePoint
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Obtenir l'arrière-plan du tableau par défaut
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     La taille représente la propriété du graphique à bulles
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Masquer le volet des miniatures des diapositives de gauche dans le PPT généré
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Classeurs Excel externes pris en charge
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Restreindre l'accès au système de fichiers local lors de l'ouverture d'un document
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Convertir des présentations PowerPoint en plusieurs formats
    </h2>
    <p>
     Aspose.Slides pour SharePoint convertit les présentations de votre bibliothèque de documents SharePoint en de nombreux formats d'échange de documents populaires. Aspose.Slides pour SharePoint prend en charge les formats de présentation courants en tant que formats d'entrée et peut exporter vers des formats de présentation ainsi que PDF, TIFF et XPS.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Installation facile et légère
    </h2>
    <p>
     Aspose.Slides pour SharePoint est disponible sous forme d'archive ZIP. Décompressez le fichier ZIP sur le lecteur local sur le serveur MOSS 7.0 ou WSS 3.0 et exécutez le setup.exe à installer pour l'utiliser. C'est si facile!
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides pour SharePoint est construit à l'aide d'un code géré qui n'a jamais besoin d'installer Microsoft PowerPoint sur la machine pour travailler avec la conversion des formats de documents PowerPoint. C'est une alternative parfaite à l'automatisation de Microsoft PowerPoint en termes de fonctionnalités prises en charge, de sécurité, de stabilité, d'évolutivité, de vitesse et de prix.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.Slides pour SharePoint ?" tabId="success-stories" >}}
