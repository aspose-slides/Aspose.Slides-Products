...
<p>
 Aspose.Slides para Xamarin es una solución multiplataforma para crear aplicaciones móviles de PowerPoint para cualquier dispositivo y sistema operativo. Permita que su aplicación móvil edite texto, medios y formas de la diapositiva, guarde la presentación en el formato deseado. Revisa la presentación desde el móvil, agrega comentarios y notas, y envíala. Aplique un nuevo tema en la presentación, divida la presentación en varios archivos.
</p>

<p>
 Aspose.Slides para Xamarin es una API de PowerPoint de Xamarin independiente que no requiere Microsoft PowerPoint ni ningún otro software adicional.
</p>
...
{{< blocks/products/pf/i18n/carousel-item h3="de un vistazo" description="Descripción general de las capacidades de Xamarin PowerPoint API de Aspose.Slides." >}}
...
{{< blocks/products/pf/i18n/carousel-item h3="Independencia de la plataforma" description="Aspose.Slides para Xamarin en Android, iOS y Windows." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <!--/left-->
  <!--/right-->
...
{{< blocks/products/pf/i18n/carousel-item h3="Formatos de archivo admitidos" description="Aspose.Slides para Xamarin admite los [formatos de presentación] populares (https://docs.aspose.com/display/slidesnet/Supported+File+Formats) y los formatos de exportación que se enumeran a continuación." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Funciones avanzadas de la API de PowerPoint de Xamarin
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Convertir presentación a través de Xamarin PowerPoint API
    </h2>
    <p>
     Aspose.Slides for Xamarin API permite crear aplicaciones móviles para la conversión de PowerPoint en cualquier documento, texto, imagen, web u otros formatos. Convierte presentaciones con una gran calidad incluso desde un móvil. Convierte presentaciones a formato PDF, HTML, XPS, JPG. La API de PowerPoint Xamarin es fácil de usar, la lógica de conversión se implementa en un código de 1-2 líneas. Simplemente cargue una presentación y guárdela en el formato necesario.
    </p>
...
prs.Save(dir + "output.tiff", Aspose.Slides.Export.SaveFormat.Tiff);</code></pre>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Modificar la presentación a través de la API de PowerPoint de Xamarin
    </h2>
    <p>
     Con Xamarin PowerPoint API de Aspose es posible modificar el contenido de cualquier diapositiva y presentación, así como los metadatos. Se puede acceder a texto, tablas, formas, gráficos, SmartArts y animaciones a través de la aplicación móvil Xamarin. Todas las operaciones disponibles en el contenido de la presentación se pueden aplicar a través de la API Xamarin de Aspose.Slides. Los comentarios de la presentación, las notas, las propiedades del documento, así como los diseños, los temas y las plantillas también están disponibles para modificar.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Combinar, comparar, dividir, imprimir presentaciones a través de la API de Xamarin PowerPoint
    </h2>
    <p>
     Cree un sistema de procesamiento de presentaciones en Xamarin con Aspose.Slides Xamarin API. Están disponibles tales operaciones sobre presentaciones y diapositivas de cualquier tipo: fusionar, dividir, comparar, imprimir, etc. Las operaciones se pueden utilizar para crear muchos escenarios de procesamiento. Por ejemplo, la funcionalidad de combinación se puede usar para aplicar una plantilla a una presentación, para combinar algunas plantillas, para combinar presentaciones de diferentes formatos en un solo formato, etc.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.Slides para Xamarin?" tabId="success-stories" >}}
