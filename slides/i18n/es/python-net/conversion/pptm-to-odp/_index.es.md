...
weight: 2490
url: /es/python-net/conversion/pptm-to-odp/ 
keywords: "Convert, PowerPoint, PPTM, ODP, Presentation, Python"
description: Ejemplo de código para la conversión de PPTM a ODP Python. Utilice la API Python de PowerPoint para la conversión por lotes de archivos PPTM a archivos ODP.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PPTM a ODP en Python" h2="Potente biblioteca de PowerPoint Python para convertir PPTM a ODP" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir PPTM a ODP en Python" %}}

¿Necesita convertir archivos PPTM a ODP mediante programación? Usando [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/python-net/) cualquier desarrollador puede convertir PPTM a formato ODP con solo unas pocas líneas de código de Python.

Como una API moderna de procesamiento de presentaciones, Aspose.Slides para Python crea rápidamente ODP a partir de PPTM. Pruebe la calidad de la conversión de PPTM a ODP directamente en su [navegador] (https://products.aspose.app/slides/conversion). La biblioteca Aspose PowerPoint PPTX le permite convertir archivos PPTM a muchos formatos populares.
...
{{< blocks/products/pf/agp/feature-section-col title="Cómo convertir PPTM a ODP en Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estos son los pasos para convertir un archivo PPTM a ODP usando Python." >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de Python de PPTM a ODP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Guardar PPTM como ODP en Python" %}}
