---
title: Convertir PPTM a PDF en Python
weight: 2510
url: /es/python-net/conversion/pptm-to-pdf/ 
keywords: "Convert, PowerPoint, PPTM, PDF, Presentation, Python"
description: Código de muestra para la conversión de Python de PPTM a PDF. Utilice la API Python de PowerPoint para la conversión por lotes de archivos PPTM a archivos PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PPTM a PDF en Python" h2="Potente biblioteca de PowerPoint Python para convertir PPTM a PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir PPTM a PDF en Python" %}}

¿Necesita convertir archivos PPTM a PDF mediante programación? Usando [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/python-net/) cualquier desarrollador puede convertir PPTM a formato PDF con solo unas pocas líneas de código de Python.

Como una API moderna de procesamiento de presentaciones, Aspose.Slides para Python crea PDF a partir de PPTM rápidamente. Pruebe la calidad de la conversión de PPTM a PDF directamente en su [navegador](https://products.aspose.app/slides/conversion). La biblioteca Aspose PowerPoint PPTX le permite convertir archivos PPTM a muchos formatos populares.
...
{{< blocks/products/pf/agp/feature-section-col title="Cómo convertir PPTM a PDF en Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estos son los pasos para convertir un archivo PPTM a PDF usando Python." >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de Python de PPTM a PDF" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Guardar PPTM como PDF en Python" %}}
