---
title: Combinar archivos PPTM a través de .NET
weight: 5580
url: /es/net/merger/pptm/ 
description: Código fuente C# para combinar documentos PPTM en plataformas .NET Framework, .NET Core, Windows Azure, Mono o Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Combinar formatos PPTM en C#" h2="Fusión de documentos PPTM nativos y de alto rendimiento utilizando Aspose.Slides del lado del servidor para las API de .NET, sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPTM" >}}
...
Cargue todos los archivos PPTM con la ruta completa.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Llame al método Save() y pase el nombre del archivo (ruta completa) y el formato (PPTM) como parámetro.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Ahora puede abrir y usar el archivo PPTM en Microsoft Office, Adobe PDF o cualquier otro programa compatible.
{{< /blocks/products/pf/agp/step-autogen >}}
