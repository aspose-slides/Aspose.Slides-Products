---
title: Desbloquear documento PPTX a través de .NET
weight: 6480
url: /es/net/unlock/pptx/ 
description: Código fuente de C# para desbloquear archivos PPTX protegidos con contraseña en plataformas .NET Framework, .NET Core, Windows Azure, Mono o Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Desbloquee la presentación PPTX a través de C#" h2="Elimine la protección de PPTX usando la biblioteca .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo desbloquear archivos PPTX usando C#" %}}

 Para eliminar el archivo PPTX de protección, usaremos
...
{{< blocks/products/pf/agp/feature-section-col title="Desbloquear PPTX a través de C#" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/es/net/unlock/odp/" name="ODP" description="Formato de presentación de OpenDocument" >}}
