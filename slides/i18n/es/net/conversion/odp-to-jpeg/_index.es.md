---
title: Convierta ODP a JPEG a través de C#
weight: 1850
url: /es/net/conversion/odp-to-jpeg/ 
description: Código de muestra para la conversión de ODP a JPEG C#. Utilice el código de ejemplo de API para la conversión de archivos ODP por lotes a JPEG dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta ODP a JPEG a través de C#" h2="Exporte archivos ODP de PowerPoint® a JPEG en plataformas .NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="Los desarrolladores de .NET pueden cargar y convertir fácilmente archivos ODP a JPEG con solo unas pocas líneas de código." >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la conversión de ODP a JPEG C#" offSpacer="" %}}
