...
<p class="col-lg-10">Incruste gráficos de Excel como objetos OLE en diapositivas</p>

</div>

<div class="col-lg-4"><em class="fa fa-print  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Administrar objetos Ole vinculados</p>
...
<p class="col-lg-10">Impresión personalizada de presentaciones</p>
...
<h2 class="h2title">Integración continua de nuevas características</h2>

<p>Nunca está restringido a las funciones existentes. Nuestros equipos de productos agregan continuamente más y más funciones y cada nueva versión ofrece más funciones en comparación con las versiones anteriores. También puede enviar solicitudes de nuevas funciones si encuentra que falta alguna de las funciones deseadas. Aquí está la lista de algunas selecciones de las últimas características.</p>

<ul>

<li>Rasterización o vectorización de Shapes sin texto.</li>

<li>Convierta imágenes SVG en formas.</li>

<li>Obtenga el fondo de la tabla por defecto.</li>

<li>Restricción del acceso al sistema de archivos local al abrir un documento.</li>

<li>Agregue una metaetiqueta de codificación al guardar en HTML.</li>

<li>Configuración para eliminar los atributos de ancho y alto de la etiqueta SVG al guardar como HTML.</li>

<li>Support for

<ul>

<li>Respuestas a comentarios, Office 365 y libros de Excel externos.</li>

<li>El tamaño representa la propiedad del gráfico de burbujas.</li>

<li>Ocultar el panel de miniaturas de la diapositiva izquierda en el PPT generado.</li>

<li>Gráficos de embudo, gráficos de mapa 2D y ruta de libro de trabajo de fuente de datos externa de gráfico establecido.</li>

<li>Cifrado de OpenDocument, transición Morph y función de resaltado de texto.</li>

<li>Configuración de la propiedad Transparencia para efectos de sombra.</li>

<li>Configuración de la forma de la llamada para la etiqueta de datos de la serie.</li>

<li>Obtener efectos por párrafos de cuadro de texto.</li>

<li>Forma de representación Efecto Bordes suaves (EffectFormat).</li>

<li>ChartData SetRange en una tabla dinámica.</li>

</ul>

</li>

<li>Implemente el formato Tiff de varias páginas, Metafile Format Plus Extensions (EMF+) y el formato Strict Open XML.</li>

<li>Representación de comentarios en formato ODP que no tienen autor.</li>

<li>Implemente la serialización con el cumplimiento estricto del formato XML abierto.</li>
...
<h2 class="h2title">Procesamiento de formas SmartArt</h2>

<p>Aspose.Slides para C++ facilita la creación de formas SmartArt desde cero y brinda la capacidad de acceder, manipular o eliminar formas SmartArt existentes de una diapositiva. Además, también es posible dar formato a las formas SmartArt, como el estilo de configuración, el color y el diseño.</p>
...
{{< blocks/products/pf/slr-element name="Notas de lanzamiento" href="https://docs.aspose.com/slides/cpp/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
