---
title: Desbloquear documento ODP a través de Java
weight: 3650
url: /es/java/unlock/odp/ 
description: Código de muestra de Java para desbloquear archivos ODP protegidos con contraseña en Java Runtime Environment para aplicaciones de escritorio y aplicaciones JSP/JSF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Desbloquear archivos ODP a través de Java" h2="Elimine la protección de las presentaciones de PowerPoint, incluido el archivo ODP, utilizando la Biblioteca Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo quitar el archivo ODP de protección usando Java" %}}

 Para desbloquear el archivo ODP, usaremos
...
{{< blocks/products/pf/agp/feature-section-col title="Pasos para desbloquear ODP a través de Java" >}}
...
{{% blocks/products/pf/agp/code-block title="Desbloquear archivos ODP a través de C#" offSpacer="" %}}
