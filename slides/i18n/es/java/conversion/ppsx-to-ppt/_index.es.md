---
title: Convierta PPSX a PPT a través de Java
weight: 8690
url: /es/java/conversion/ppsx-to-ppt/ 
description: Ejemplo de código de conversión de Java para formato PPSX a archivo PPT. Utilice este código de ejemplo para exportar presentaciones de PowerPoint y OpenOffice a PPT dentro de cualquier aplicación basada en Java web o de escritorio.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta PPSX a PPT a través de Java" h2="Conversión de PPSX a PPT Java para convertir una o varias páginas a PPT utilizando la biblioteca Java local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir PPSX a PPT usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir PPSX a PPT a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo PPSX a PPT con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de PPSX a PPT Java" offSpacer="" %}}
