...
Muat semua file POTM dengan path lengkap.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Panggil metode Save() dan berikan nama file (path lengkap) dan format (POTM) sebagai parameter.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Sekarang Anda dapat membuka dan menggunakan file POTM di Microsoft Office, Adobe PDF atau program lain yang kompatibel.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Gabungkan File POTM - C#" offSpacer="" %}}
