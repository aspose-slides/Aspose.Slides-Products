...
Muat semua file PPTX dengan path lengkap.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Panggil metode Save() dan teruskan nama file (path lengkap) dan format (PPTX) sebagai parameter.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Sekarang Anda dapat membuka dan menggunakan file PPTX di Microsoft Office, Adobe PDF atau program lain yang kompatibel.
{{< /blocks/products/pf/agp/step-autogen >}}
