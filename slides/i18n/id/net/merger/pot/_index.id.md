...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan File POT Menggunakan C#" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menggabungkan File POT di C#" >}}
...
Muat semua file POT dengan path lengkap.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Panggil metode Save() dan teruskan nama file (path lengkap) dan format (POT) sebagai parameter.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Sekarang Anda dapat membuka dan menggunakan file POT di Microsoft Office, Adobe PDF atau program lain yang kompatibel.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Gabungkan File POT - C#" offSpacer="" %}}
