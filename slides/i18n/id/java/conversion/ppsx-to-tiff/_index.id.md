---
title: Konversi PPSX ke TIFF melalui Java
weight: 1720
url: /id/java/conversion/ppsx-to-tiff/ 
description: Contoh kode konversi Java untuk format PPSX ke file TIFF. Gunakan kode contoh ini untuk mengekspor presentasi PowerPoint & OpenOffice ke TIFF dalam Aplikasi berbasis Java Web atau Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi PPSX ke TIFF melalui Java" h2="Konversi PPSX ke TIFF Java untuk mengonversi satu atau beberapa halaman ke TIFF menggunakan perpustakaan Java di tempat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi PPSX ke TIFF Menggunakan Java" %}}

 Untuk merender PPSX ke TIFF, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengkonversi PPSX ke TIFF melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Pengembang Java dapat dengan mudah mengonversi file PPSX ke TIFF hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/code-block title="Kode Sumber Konversi Java PPSX ke TIFF" offSpacer="" %}}
