...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi PPS ke ODP Menggunakan C++" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Pengembang C++ dapat dengan mudah mengonversi file PPS ke ODP hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/code-block title="Kode Sumber Konversi PPS ke ODP C++" offSpacer="" %}}
