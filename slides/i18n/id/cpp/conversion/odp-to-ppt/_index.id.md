...
{{% blocks/products/pf/agp/text %}}
 ...
 Pengembang C++ dapat dengan mudah mengonversi file ODP ke PPT hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/code-block title="Kode Sumber Konversi ODP ke PPT C++" offSpacer="" %}}
