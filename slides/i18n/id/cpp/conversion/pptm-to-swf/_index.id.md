...
Untuk mengonversi PPTM ke SWF, kami akan menggunakan <a href="https://products.aspose.com/slides/cpp">Aspose.Slides for C++</a> API yang kaya fitur dan kuat dan mudah digunakan manipulasi dokumen dan API konversi untuk platform C++. Kamu bisa langsung download versi terbarunya, cukup buka <a href="https://www.nuget.org/packages/aspose.slides">NuGet</a> package manager, cari <b>Aspose.Slides.Cpp </b> dan instal. Anda juga dapat menggunakan perintah berikut dari Package Manager Console.
