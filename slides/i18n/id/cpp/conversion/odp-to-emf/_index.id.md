...
{{% blocks/products/pf/agp/text %}}
 ...
 Pengembang C++ dapat dengan mudah mengonversi file ODP ke EMF hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/code-block title="Kode Sumber Konversi ODP ke EMF C++" offSpacer="" %}}
