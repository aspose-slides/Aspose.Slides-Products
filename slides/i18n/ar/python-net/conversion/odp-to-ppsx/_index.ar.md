---
title: تحويل ODP إلى PPSX في Python
weight: 370
url: /ar/python-net/conversion/odp-to-ppsx/ 
keywords: "Convert, PowerPoint, ODP, PPSX, Presentation, Python"
description: رمز عينة لتحويل ODP إلى PPSX Python. استخدم PowerPoint Python API لتحويل ملفات ODP إلى ملفات PPSX.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل ODP إلى PPSX في Python" h2="مكتبة بايثون قوية لتحويل ODP إلى PPSX" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل ODP إلى PPSX في Python" %}}

هل تحتاج إلى تحويل ملفات ODP إلى PPSX برمجيًا؟ باستخدام [* Aspose.Slides for Python عبر .NET *](https://products.aspose.com/slides/python-net/) يمكن لأي مطور تحويل ODP إلى تنسيق PPSX ببضعة أسطر فقط من كود Python.

باعتبارها واجهة برمجة تطبيقات حديثة لمعالجة العروض التقديمية ، تقوم Aspose.Slides for Python بإنشاء PPSX من ODP بسرعة. اختبر جودة تحويل ODP إلى PPSX مباشرة في [المتصفح](https://products.aspose.app/slides/conversion). تسمح لك مكتبة Aspose PowerPoint PPTX بتحويل ملفات ODP إلى العديد من التنسيقات الشائعة.
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل ODP إلى PPSX في Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي خطوات تحويل ملف ODP إلى PPSX باستخدام Python." >}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الكود هذا تحويل ODP إلى PPSX Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ ODP كـ PPSX في Python" %}}
استخدم التطبيق المجاني لمشاهدة عرض توضيحي لعملية تحويل ODP إلى PPSX. 
{{% /blocks/products/pf/agp/content %}}
