---
title: تحويل ODP إلى PNG في Python
weight: 310
url: /ar/python-net/conversion/odp-to-png/ 
keywords: "Convert, PowerPoint, ODP, PNG, Presentation, Python"
description: رمز عينة لتحويل ODP إلى PNG Python. استخدم PowerPoint Python API لتحويل ملفات ODP إلى ملفات PNG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل ODP إلى PNG في Python" h2="مكتبة بايثون قوية لتحويل ODP إلى PNG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل ODP إلى PNG في Python" %}}

هل تحتاج إلى تحويل ملفات ODP إلى PNG برمجيًا؟ باستخدام [* Aspose.Slides for Python عبر .NET *](https://products.aspose.com/slides/python-net/) يمكن لأي مطور تحويل ODP إلى تنسيق PNG ببضعة أسطر فقط من كود Python.

كواجهة برمجة تطبيقات حديثة لمعالجة العروض التقديمية ، تقوم Aspose.Slides for Python بإنشاء PNG من ODP بسرعة. اختبر جودة تحويل ODP إلى PNG مباشرة في [المتصفح](https://products.aspose.app/slides/conversion/ppt-to-png). تسمح لك مكتبة Aspose PowerPoint PPTX بتحويل ملفات ODP إلى العديد من التنسيقات الشائعة.
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل ODP إلى PNG في Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لتحويل ملف ODP إلى PNG باستخدام Python." >}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الكود هذا تحويل ODP إلى PNG Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ ODP بصيغة PNG في Python" %}}
استخدم التطبيق المجاني لمشاهدة عرض توضيحي لعملية تحويل ODP إلى PNG. 
{{% /blocks/products/pf/agp/content %}}
