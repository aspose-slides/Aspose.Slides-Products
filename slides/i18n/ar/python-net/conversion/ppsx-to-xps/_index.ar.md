...
هل تحتاج إلى تحويل ملفات PPSX إلى XPS برمجيًا؟ باستخدام [* Aspose.Slides for Python عبر .NET *](https://products.aspose.com/slides/python-net/) يمكن لأي مطور تحويل PPSX إلى تنسيق XPS ببضعة أسطر فقط من كود Python.
