---
title: تحويل ODP إلى POTX في Python
weight: 340
url: /ar/python-net/conversion/odp-to-potx/ 
keywords: "Convert, PowerPoint, ODP, POTX, Presentation, Python"
description: رمز عينة لتحويل ODP إلى POTX Python. استخدم PowerPoint Python API لتحويل ملفات ODP إلى ملفات POTX.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل ODP إلى POTX في Python" h2="مكتبة بايثون قوية لتحويل ODP إلى POTX" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل ODP إلى POTX في Python" %}}

هل تحتاج إلى تحويل ملفات ODP إلى POTX برمجيًا؟ باستخدام [* Aspose.Slides for Python عبر .NET *](https://products.aspose.com/slides/python-net/) يمكن لأي مطور تحويل ODP إلى تنسيق POTX ببضعة أسطر فقط من كود Python.

كواجهة برمجة تطبيقات حديثة لمعالجة العروض التقديمية ، تقوم Aspose.Slides for Python بإنشاء POTX من ODP بسرعة. اختبر جودة تحويل ODP إلى POTX مباشرة في [المتصفح](https://products.aspose.app/slides/conversion). تسمح لك مكتبة Aspose PowerPoint PPTX بتحويل ملفات ODP إلى العديد من التنسيقات الشائعة.
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل ODP إلى POTX في Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي خطوات تحويل ملف ODP إلى POTX باستخدام Python." >}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الكود هذا تحويل ODP إلى POTX Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ ODP كـ POTX في Python" %}}
استخدم التطبيق المجاني لمشاهدة عرض توضيحي لعملية تحويل ODP إلى POTX. 
{{% /blocks/products/pf/agp/content %}}
