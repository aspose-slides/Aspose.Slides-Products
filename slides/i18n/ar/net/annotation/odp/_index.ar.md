---
title: إزالة ODP Annotation عبر .NET
weight: 1370
...
{{% blocks/products/pf/agp/content h2="كيفية علق ملف ODP باستخدام C #" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="إزالة التعليقات من ODP عبر C #" >}}
...
{{% blocks/products/pf/agp/code-block title="حذف التعليقات التوضيحية من ODP - C #" offSpacer="" %}}
