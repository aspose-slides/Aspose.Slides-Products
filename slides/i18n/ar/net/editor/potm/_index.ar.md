...
من أجل تحرير ملف POTM ، سنستخدم <a href="https://products.aspose.com/slides/net"> Aspose.Slides for .NET </a> API وهو غني بالميزات وقوي وسهل الاستخدام API لمنصة C # لأي محرر. افتح مدير الحزمة <a href="https://www.nuget.org/packages/aspose.slides.net"> NuGet </a> ، وابحث عن <b> Aspose.Slides </b> وثبته. يمكنك أيضًا استخدام الأمر التالي من Package Manager Console.
