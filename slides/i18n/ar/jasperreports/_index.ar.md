---
title: تصدير JasperReports إلى PowerPoint | ينزلق
weight: 8320
url: /ar/jasperreports/ 
description: Aspose.Slides PowerPoint API لـ JaspreReport لتصدير التقارير من Jasper Reports و JasperServer إلى تنسيقات PowerPoint. إنشاء وتصدير صور مخططات حسابات نصية وتقارير خطية إلى عرض PPT
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="تصدير تقارير JasperServer إلى عروض PowerPoint التقديمية" h2="PowerPoint API لتصدير تقارير JasperReports و JasperServer إلى PPT (X) و PPS (X) وتنسيقات PowerPoint أخرى." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-jasperreports.svg" pfName="Aspose.Slides" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/slides/jasperreport" >}}
...
<p>
 Aspose.Slides for JasperReports هو PowerPoint API لتصدير مرن وسهل الاستخدام لتقارير JasperReports و JasperServer إلى PowerPoint. لا يمتلك JasperServer القدرة المضمنة على تصدير التقارير كعروض PowerPoint التقديمية. ومع ذلك ، باستخدام PowerPoint API ، يمكن تصدير تقارير JasperServer إلى تنسيقات العروض التقديمية PPT و PPS و PPTX و PPSX دون استخدام Microsoft PowerPoint.
</p>
...
{{< blocks/products/pf/carousel-item h3="لمحة سريعة" description="نظرة عامة على Aspose.Slides for JasperReports." >}}
...
{{< blocks/products/pf/carousel-item h3="منصة الاستقلال" description="Aspose.Slides PowerPoint API يدعم J2SE و JasperReports و JasperServer." >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
...
{{< blocks/products/pf/carousel-item h3="تنسيقات الملفات المدعومة" description="Aspose.Slides for JasperReports يمكن تصدير التقارير في Microsoft PowerPoint [تنسيقات الملفات](https://docs.aspose.com/slides/jasperreports/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">تقارير جاسبر المتقدمة لميزات تصدير العرض التقديمي</h2>

<p> </p>

<div class="col-lg-4"><em class="fa fa-file-powerpoint-o  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">إنشاء تقارير الحسابات وتصديرها إلى عروض Microsoft PowerPoint التقديمية</p>

</div>

<div class="col-lg-4"><em class="fa fa-bar-chart   ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">إنشاء تقارير المخططات وتصديرها إلى عروض Microsoft PowerPoint التقديمية</p>

</div>

<div class="col-lg-4"><em class="fa fa-pie-chart ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">قم بإنشاء تقارير مخططات محاور متعددة وتصديرها إلى عروض Microsoft PowerPoint التقديمية</p>

</div>

<div class="col-lg-4"><em class="fa fa-file-text ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">قم بإنشاء الصور والنصوص والخطوط وتصدير هذه التقارير إلى Microsoft PowerPoint Presentation</p>

</div>-->
   <h2 class="pr-ft">
    المتقدمة JasperReports PowerPoint API الميزات
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     إنشاء تقارير متعددة لمخطط المحاور
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     إضافة الصور والنصوص والخطوط إلى التقارير
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-file-text ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     تصدير التقارير إلى عروض PowerPoint التقديمية
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-file-text ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     دعم ردود التعليقات و Office 365 ومصنفات Excel الخارجية
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     إخفاء جزء الصور المصغرة للشرائح اليسرى في PPT الذي تم إنشاؤه
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-area-chart ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     قمع ومخططات خرائط ثنائية الأبعاد وخاصية الحجم لمخطط الفقاعات
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-cog ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     تمييز النص وتشفير OpenDocument وعرض الشكل
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     اضبط خاصية الشفافية لتأثيرات الظل والانتقال التدريجي
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     قم بتعيين الإعدادات المحلية في التطبيق وشكل وسيلة الشرح لتسمية بيانات السلسلة
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     أضف دعمًا لتنسيق Strict Open XML
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     احصل على التأثيرات من خلال فقرات مربع النص
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     SetRange بيانات المخطط على جدول محوري
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     تنفيذ التسلسل مع التوافق الصارم مع تنسيق XML المفتوح
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     أضف علامة وصفية للتشفير عند الحفظ في HTML
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     التوافق مع الخوارزميات المتوافقة مع FIPS
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     دعم تقرير الرسم البياني متعدد المحاور
    </h2>
    <p>
     Aspose.Slides for JasperReports يدعم تصدير تقارير معقدة تحتوي على
     <strong>
      MultiAxisChartReport
     </strong>
     إلى عروض Microsoft PowerPoint التقديمية. الإخراج هو نفسه تمامًا كما يظهر عند عرضه من خلال JasperViewer.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     تصدير التقارير إلى تنسيقات العرض التقديمي
    </h2>
    <p>
     ليس لدى JasperReports و JasperServer الدعم المدمج لتصدير التقارير إلى عروض Microsoft PowerPoint التقديمية ، ومع ذلك ، التكامل مع Aspose. تتيح لك الشرائح لـ JasperReports تصدير تقاريرك إلى عروض Microsoft PowerPoint التقديمية (PPT ، PPTX) وعروض شرائح Microsoft PowerPoint (PPS ، PPSX).
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for JasperReports تم تصميمه باستخدام التعليمات البرمجية المدارة التي لا تحتاج إلى تثبيت Microsoft PowerPoint على الجهاز للعمل مع مستندات PowerPoint. إنه بديل مثالي لأتمتة Microsoft PowerPoint من حيث الميزات المدعومة والأمان والاستقرار وقابلية التوسع والسرعة والسعر.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="توثيق" href="https://docs.aspose.com/slides/jasperreports/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="لماذا Aspose.Slides for JasperReports؟" tabId="success-stories" >}}
