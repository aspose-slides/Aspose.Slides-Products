---
title: واجهة برمجة تطبيقات Android PowerPoint | Aspose.Slides for Android API
weight: 5960
url: /ar/android-java/ 
description: Aspose.Slides for Android API أو Android PowerPoint API لإنشاء قراءة ومعالجة PPT POT PPS PPTX POTX PPSX PowerPoint على Android.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Android PowerPoint API" h2="يمكنك إنشاء عروض PowerPoint التقديمية وتعديلها وتحويلها ودمجها وتقسيمها وإدارتها في تطبيقات Android." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-android-java.svg" pfName="Aspose.Slides" subTitlepfName="for Android via Java" downloadUrl="https://downloads.aspose.com/slides/androidjava" >}}
...
<p>
 Aspose.Slides for Android عبر Java هو PowerPoint API لتطبيقات Android. يمكن للمطورين أداء مجموعة واسعة من مهام معالجة العروض التقديمية بما في ذلك القراءة والكتابة والتعديل والدمج والتقسيم وتحويل ومعالجة العروض التقديمية دون أي اعتماد على Microsoft PowerPoint.
</p>

<p>
 Aspose.Slides for Android عبر Java يدعم تقريبًا جميع تنسيقات ملفات PowerPoint الأصلية بالإضافة إلى تنسيق عرض OpenOffice (ODP). قم بإنشاء تطبيق عارض PowerPoint الخاص بك لنظام Android ، بالإضافة إلى المحول أو المحرر أو أي تطبيق آخر. يمكن الوصول إلى عناصر العرض التقديمي مثل أشكال SmartArt ومخططات MSO ومكونات ActiveX وكائنات إطار OLE عبر PowerPoint API للإدارة والمعالجة.
</p>
...
{{< blocks/products/pf/carousel-item h3="لمحة سريعة" description="Aspose.Slides نظرة عامة على ميزات Android API." >}}
...
{{< blocks/products/pf/carousel-item h3="منصة الاستقلال" description="Aspose.Slides for Android API تغطي بيئات تطوير Android ومنصات النشر التالية." >}}
<div class="diagram1 d1-android">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="تنسيقات الملفات المدعومة" description="Aspose.Slides for Android API يدعم [تنسيقات PowerPoint](https://docs.aspose.com/slides/java/supported-file-formats/) والعديد من تنسيقات التحويل." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    تقدم ميزات Android PowerPoint API
   </h2>
   <p>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     إنشاء شرائح جديدة أو استنساخ من القوالب
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     إضافة أو حذف الحماية على الأشكال
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     أضف مخططات Microsoft Excel كـ OleObjects
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     استيراد وتصدير نص HTML إلى الشرائح
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     إدارة مكونات ActiveX و SmartArt
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     عرض صور SVG على الأشكال
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     تنسيق العرض التقديمي على مستوى الدقيقة
    </h2>
    <p>
     يمكن لمكتبة PowerPoint التعامل بسهولة مع ميزات تنسيق النص والشكل مثل حجم الخط والنوع واللون والظلال ومحاذاة الفقرة والتعداد النقطي والاتجاه والارتباطات التشعبية.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     تحويل العرض التقديمي مع الملاحظات
    </h2>
    <p>
     يوفر API التحويل إلى TIFF و PDF مع الملاحظات. يمكن للمطورين تحويل العرض التقديمي بالكامل في طريقة عرض شرائح الملاحظات إلى التنسيق المدعوم وكذلك في حالة الصور ، يمكن للمرء إنشاء صورة مصغرة للشريحة في عرض شرائح الملاحظات للشرائح الفردية. هذا هو رمز التحويل TIFF.
    </p>
    <div class="codeblock" id="code">
     <h3>
      تحويل العروض التقديمية باستخدام Notes
     </h3>
...
pres.save(dataDir + "TestNotes.tiff", SaveFormat.Tiff,opts);
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     معالجة العناصر عبر واجهة برمجة التطبيقات العامة
    </h2>
    <p>
     API قادر على التعامل مع جميع عناصر شرائح العرض بما في ذلك المستطيل ، الجدول ، مربع النص ، القطع الناقص ، متعدد الخطوط ، إطار الصورة ، الشكل التلقائي ، إطار الصوت ، إطار كائن OLE ، وإطار الفيديو. توفر API أيضًا مجموعة غنية من أوامر API لمعالجة كل عنصر من هذه العناصر. علاوة على ذلك ، يتم دعم تنسيق النص من خلال مجموعة من الفئات جيدة التصميم.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="توثيق" href="https://docs.aspose.com/slides/androidjava/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="لماذا Aspose.Slides لنظام Android عبر Java؟" tabId="success-stories" >}}
