...
<p class="col-lg-10">قم بتضمين مخططات Excel ككائنات OLE في الشرائح</p>

</div>

<div class="col-lg-4"><em class="fa fa-print  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">إدارة كائنات Ole المرتبطة</p>
...
<p class="col-lg-10">طباعة مخصصة للعروض التقديمية</p>
...
<h2 class="h2title">التكامل المستمر للميزات الجديدة</h2>

<p>أنت غير مقيد أبدا إلى الميزات الموجودة. تضيف فرق منتجاتنا باستمرار المزيد والمزيد من الميزات وكل إصدار جديد يقدم المزيد من الميزات مقارنة بالإصدارات القديمة. يمكنك أيضًا إرسال طلبات ميزات جديدة إذا وجدت أيًا من الميزات التي تريدها مفقودة. فيما يلي قائمة ببعض الاختيارات من أحدث الميزات.</p>

<ul>

<li>تنقيط أو تحويل الأشكال بدون نص.</li>

<li>تحويل صور SVG إلى أشكال.</li>

<li>الحصول على خلفية الجدول الافتراضية.</li>

<li>تقييد الوصول إلى نظام الملفات المحلي عند فتح مستند.</li>

<li>أضف علامة وصفية للتشفير عند الحفظ في HTML.</li>

<li>إعداد لإزالة سمات العرض والارتفاع لعلامة SVG عند الحفظ بتنسيق HTML.</li>

<li>Support for

<ul>

<li>ردود التعليقات ، Office 365 ومصنفات Excel الخارجية.</li>

<li>يمثل الحجم خاصية لمخطط الفقاعات.</li>

<li>إخفاء جزء الصور المصغرة للشرائح الأيسر في PPT الذي تم إنشاؤه.</li>

<li>المخططات القمعية ومخططات الخرائط ثنائية الأبعاد وتعيين مسار مصنف مصدر البيانات الخارجية للمخطط.</li>

<li>تشفير OpenDocument و Morph Transition و Text Highlighter.</li>

<li>ضبط خاصية الشفافية لتأثيرات الظل.</li>

<li>تعيين شكل وسيلة الشرح لتسمية بيانات المتسلسلة.</li>

<li>احصل على التأثيرات من خلال فقرات مربع النص.</li>

<li>عرض تأثير الحواف الناعمة (EffectFormat).</li>

<li>SetRange بيانات المخطط على جدول محوري.</li>

</ul>

</li>

<li>تنفيذ تنسيق Tiff متعدد الصفحات وتنسيق Metafile Plus Extensions (EMF +) وتنسيق Strict Open XML.</li>

<li>تقديم التعليقات من صيغة ODP التي ليس لها مؤلف.</li>

<li>تنفيذ التسلسل مع التوافق الصارم مع تنسيق XML المفتوح.</li>
...
<h2 class="h2title">معالجة أشكال SmartArt</h2>

<p>Aspose.Slides for C ++ تسهل في إنشاء أشكال SmartArt من الصفر بالإضافة إلى توفير القدرة على الوصول إلى أشكال SmartArt الموجودة أو معالجتها أو إزالتها من الشريحة. علاوة على ذلك ، من الممكن أيضًا تنسيق أشكال SmartArt مثل إعداد النمط واللون والتخطيط.</p>
