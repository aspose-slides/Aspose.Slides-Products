---
title: حماية وقفل مستند ODP عبر C ++
weight: 670
url: /ar/cpp/protect/odp/ 
description: مثال على كود C ++ لقفل ملف ODP باستخدام كلمة مرور في C ++ Runtime Environment لنظام التشغيل Windows 32 بت و Windows 64 بت و Linux 64 بت.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تشفير ملفات ODP عبر C ++" h2="حماية عروض PowerPoint التقديمية بكلمة مرور بما في ذلك تنسيق ODP باستخدام مكتبة .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تأمين ملف ODP باستخدام C ++" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="خطوات حماية ملفات ODP عبر C ++" >}}
