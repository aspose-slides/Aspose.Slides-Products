---
title: تحويل PPS إلى ODP عبر تطبيق C ++
weight: 7650
url: /ar/cpp/conversion/pps-to-odp/ 
description: عينة رمز تحويل C ++ لمستند PPS إلى تنسيق ODP. استخدم رمز المثال لتحويل PPS إلى ODP داخل أي تطبيق C ++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل PPS إلى ODP عبر C ++" h2="أداء عالٍ لتحويل PPS إلى ODP باستخدام مكتبة C ++ دون الحاجة إلى تثبيت Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C ++ بسهولة تحويل ملف PPS إلى ODP في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/code-block title="PPS إلى كود مصدر تحويل ODP C ++" offSpacer="" %}}
