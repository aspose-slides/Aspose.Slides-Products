---
title: تحويل PPS إلى TIFF عبر تطبيق C ++
weight: 5250
url: /ar/cpp/conversion/pps-to-tiff/ 
description: عينة كود تحويل C ++ لمستند PPS إلى تنسيق TIFF. استخدم رمز المثال لتحويل PPS إلى TIFF داخل أي تطبيق C ++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل PPS إلى TIFF عبر C ++" h2="أداء عالي لتحويل PPS إلى TIFF باستخدام مكتبة C ++ دون الحاجة إلى تثبيت Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C ++ بسهولة تحويل ملف PPS إلى TIFF في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/code-block title="PPS إلى رمز مصدر تحويل TIFF C ++" offSpacer="" %}}
