---
title: دمج ملفات POTM عبر جافا
weight: 6620
url: /ar/java/merger/potm/ 
description: نموذج كود Java لدمج مستندات POTM في Java Runtime Environment لتطبيق JSP / JSF وتطبيقات سطح المكتب.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="دمج تنسيقات POTM في Java" h2="دمج مستند POTM الأصلي باستخدام واجهات برمجة تطبيقات Java من جانب الخادم." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية دمج ملفات POTM باستخدام Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="خطوات دمج ملفات POTM في Java" >}}
...
قم بتحميل أول ملف POTM بنسخة من فئة Presentation.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
قم بتحميل مستند POTM الثاني بنسخة من فئة Presentation.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
قم بالتكرار خلال كل شريحة من ملف POTM الثاني.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="دمج ملفات POTM - جافا" offSpacer="" %}}
