...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">ميزات واجهة برمجة تطبيقات معالجة المستندات المتقدمة لـ Java PowerPoint</h2>

<p>Aspose.Slides for Java يشتمل على عدد من الميزات المتقدمة التي تمنح المطورين تحكمًا كاملاً عند البرمجة باستخدام عروض Microsoft PowerPoint التقديمية في بيئة Java.</p>-->
   <h2 class="pr-ft">
...
<h2 class="h2title">تنسيق محتوى الشرائح</h2>

<p>من الممكن تنسيق النص والأشكال على الشرائح في عرض تقديمي باستخدام Aspose.Slides for Java API. تتم إدارة النص من خلال إطارات النص المرتبطة بالأشكال. ومن ثم يتم تنسيق النص باستخدام الفقرات والأجزاء المرتبطة بإطارات النص. يمكنك أيضًا معالجة سمات عنصر الشكل مثل الموضع والحجم والخط والصورة والنص والتعبئة.</p>
