---
title: Usuń adnotację ODP przez Java
weight: 1790
url: /pl/java/annotation/odp/ 
description: Przykładowy kod Java do usuwania adnotacji formatu ODP w środowisku Java Runtime Environment dla aplikacji JSP/JSF i aplikacji komputerowych.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Usuń komentarze i autorów komentarzy z ODP za pomocą Java" h2="Twórz własne aplikacje Java, aby manipulować komentarzami i autorami w plikach dokumentów za pomocą interfejsów API po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak dodawać adnotacje do pliku ODP za pomocą Javy" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby usunąć komentarze z ODP za pomocą Java" %}}
...
1. Zapisz go w formacie ODP
1. Usuń komentarz w określonej lokalizacji
1. Ponownie zapisz plik ODP i porównaj
...
{{% blocks/products/pf/agp/code-block title="Usuń adnotacje z ODP — Java" offSpacer="" %}}
