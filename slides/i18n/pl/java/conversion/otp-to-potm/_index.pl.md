---
title: Konwertuj OTP na POTM przez Java
weight: 4020
url: /pl/java/conversion/otp-to-potm/ 
description: Przykładowy kod konwersji Java dla formatu OTP do pliku POTM. Użyj tego przykładowego kodu, aby wyeksportować prezentacje PowerPoint i OpenOffice do POTM w dowolnej aplikacji internetowej lub aplikacji opartej na Javie.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj OTP na POTM przez Java" h2="Konwersja OTP do POTM Java w celu konwersji jednej lub wielu stron do POTM przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTP" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować OTP na POTM za pomocą Java?" %}}

 Aby renderować OTP do POTM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować OTP na POTM za pomocą Javy" %}}

{{% blocks/products/pf/agp/text %}}

 Programiści Java mogą łatwo przekonwertować plik OTP do POTM w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji OTP do POTM Java" offSpacer="" %}}
