---
title: Konwertuj POTX na HTML za pomocą Java
weight: 4050
url: /pl/java/conversion/potx-to-html/ 
description: Przykładowy kod konwersji Java dla formatu POTX do pliku HTML. Użyj tego przykładowego kodu, aby wyeksportować prezentacje PowerPoint i OpenOffice do HTML w dowolnej aplikacji internetowej lub aplikacji opartej na Javie.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj POTX na HTML za pomocą Java" h2="Konwersja POTX do HTML Java w celu konwersji jednej lub wielu stron do HTML przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować POTX na HTML za pomocą Java" %}}

 Aby wyrenderować POTX do HTML, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować POTX na HTML za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Programiści Java mogą łatwo przekonwertować plik POTX na HTML w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji POTX do HTML Java" offSpacer="" %}}
