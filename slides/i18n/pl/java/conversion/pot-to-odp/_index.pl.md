---
title: Konwertuj POT na ODP przez Javę
weight: 1050
url: /pl/java/conversion/pot-to-odp/ 
description: Przykładowy kod konwersji Java dla formatu POT do pliku ODP. Użyj tego przykładowego kodu, aby wyeksportować prezentacje PowerPoint i OpenOffice do ODP w dowolnej aplikacji internetowej lub aplikacji opartej na Javie.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj POT na ODP przez Javę" h2="Konwersja POT do ODP Java w celu konwersji jednej lub wielu stron na ODP przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować POT na ODP za pomocą Java?" %}}

 Aby renderować POT do ODP, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Jak przekonwertować POT na ODP za pomocą Javy" %}}

{{% blocks/products/pf/agp/text %}}

 Programiści Java mogą łatwo przekonwertować plik POT na ODP w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji POT do ODP Java" offSpacer="" %}}
