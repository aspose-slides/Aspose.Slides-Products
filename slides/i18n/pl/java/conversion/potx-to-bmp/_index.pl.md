---
title: Konwertuj POTX na BMP przez Java
weight: 2020
url: /pl/java/conversion/potx-to-bmp/ 
description: Przykładowy kod konwersji Java dla formatu POTX do pliku BMP. Użyj tego przykładowego kodu, aby wyeksportować prezentacje PowerPoint i OpenOffice do BMP w dowolnej aplikacji internetowej lub desktopowej Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj POTX na BMP przez Java" h2="Konwersja POTX do BMP Java w celu konwersji jednej lub wielu stron do BMP przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować POTX na BMP za pomocą Javy" %}}

 Aby renderować POTX do BMP, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować POTX na BMP za pomocą Javy" %}}

{{% blocks/products/pf/agp/text %}}

 Programiści Java mogą łatwo przekonwertować plik POTX na BMP w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji POTX na BMP Java" offSpacer="" %}}
