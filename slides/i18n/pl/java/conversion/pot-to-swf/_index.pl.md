...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować POT na SWF za pomocą Javy?" %}}

 Aby renderować POT do SWF, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować POT na SWF za pomocą Javy" %}}

{{% blocks/products/pf/agp/text %}}

 Programiści Java mogą łatwo przekonwertować plik POT do SWF w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji POT do SWF Java" offSpacer="" %}}
