...
{{< blocks/products/pf/i18n/carousel-item h3="W skrócie" description="Aspose.Slides for Java API omówienie funkcji." >}}
...
{{< blocks/products/pf/i18n/carousel-item h3="Niezależność od platformy" description="Aspose.Slides for Java API może być używany w dowolnym komputerze stacjonarnym opartym na języku Java, korporacyjnej aplikacji internetowej lub w dowolnym środowisku Linux i Unix." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/i18n/carousel-item h3="Obsługiwane formaty plików" description="Aspose.Slides for Java API obsługuje następujące [prezentacje](https://docs.aspose.com/slides/java/supported-file-formats/) i formaty konwersji." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Zaawansowane funkcje API przetwarzania dokumentów Java PowerPoint</h2>

<p>Aspose.Slides for Java zawiera szereg zaawansowanych funkcji, które zapewniają programistom pełną kontrolę podczas programowania prezentacji programu Microsoft PowerPoint w środowisku Java.</p>-->
   <h2 class="pr-ft">
...
<h2 class="h2title">Formatowanie treści slajdów</h2>

<p>Możliwe jest formatowanie tekstu i kształtów na slajdach w prezentacji przy użyciu Aspose.Slides for Java API. Zarządzanie tekstem odbywa się za pomocą ramek tekstowych powiązanych z kształtami. Dlatego tekst jest formatowany za pomocą akapitów i fragmentów powiązanych z ramkami tekstowymi. Możesz także manipulować atrybutami elementu kształtu, takimi jak pozycja, rozmiar, linia, obraz, tekst i wypełnienie.</p>
...
{{< blocks/products/pf/slr-element name="Informacje o wydaniu" href="https://docs.aspose.com/slides/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
