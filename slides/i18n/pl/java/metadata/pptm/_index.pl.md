---
title: Edytuj lub przeglądaj metadane plików PPTM za pomocą Java
weight: 3850
url: /pl/java/metadata/pptm/ 
description: Przykładowy kod Java do edycji lub przeglądania metadanych formatu PPTM w środowisku Java Runtime Environment dla aplikacji JSP/JSF i aplikacji komputerowych.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Wyodrębnij metadane PPTM za pomocą Javy" h2="Twórz własne aplikacje Java, aby dodawać, edytować, usuwać lub wyodrębniać metadane z plików PPTM za pomocą interfejsów API po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTM" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak wyodrębnić metadane PPTM za pomocą Javy" %}}

 Aby uzyskać metadane pliku PPTM, użyjemy
...
{{< blocks/products/pf/agp/feature-section-col title="Kroki wyodrębniania metadanych PPTM za pomocą Javy" >}}
...
Uzyskaj informacje PPTM za pomocą getPresentationInfo()
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Aktualizuj i zapisuj informacje PPTM z nowymi właściwościami
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Wyodrębnij metadane PPTM — Java" offSpacer="" %}}
