...
{{% blocks/products/pf/agp/content h2="Jak zredagować plik PPTX za pomocą Javy" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Kroki redagowania plików PPTX w Javie" >}}
...
{{% blocks/products/pf/agp/code-block title="Redaguj pliki PPTX — Java" offSpacer="" %}}
