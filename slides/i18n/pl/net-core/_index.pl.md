...
{{< blocks/products/pf/i18n/carousel-item h3="W skrócie" description="Przegląd możliwości interfejsu API programu .NET Core PowerPoint według Aspose.Slides." >}}
...
{{< blocks/products/pf/i18n/carousel-item h3="Niezależność od platformy" description="Aspose.Slides dla platformy .NET Core dla systemów Windows, Linux i macOS." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <!--/left-->
  <!--/right-->
...
{{< blocks/products/pf/i18n/carousel-item h3="Obsługiwane formaty plików" description="Aspose.Slides dla platformy .NET Core obsługuje popularne [formaty prezentacji](https://docs.aspose.com/display/slidesnet/Supported+File+Formats) i formaty eksportu wymienione poniżej." >}}
