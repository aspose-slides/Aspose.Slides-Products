---
title: Przeglądaj lub edytuj metadane plików PPTM przez .NET
weight: 950
url: /pl/net/metadata/pptm/ 
description: Kod źródłowy C# do edycji lub wyświetlania metadanych formatu PPTM na platformach .NET Framework, .NET Core, Windows Azure, Mono lub Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Wyodrębnij metadane PPTM przez .NET" h2="Twórz własne aplikacje .NET, aby dodawać, edytować, usuwać lub wyodrębniać metadane z plików PPTM za pomocą interfejsów API po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak wyodrębnić metadane PPTM za pomocą C#" %}}

 Aby wyodrębnić metadane PPTM, użyjemy
...
{{< blocks/products/pf/agp/feature-section-col title="Kroki, aby wyodrębnić metadane PPTM za pomocą C#" >}}
...
Utwórz wystąpienie klasy Presentation ze ścieżką do pliku PPTM
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Wyodrębnij metadane PPTM — C#" offSpacer="" %}}
