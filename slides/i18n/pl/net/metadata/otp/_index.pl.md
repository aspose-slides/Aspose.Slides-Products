---
title: Przeglądaj lub edytuj metadane plików OTP za pośrednictwem platformy .NET
weight: 6590
url: /pl/net/metadata/otp/ 
description: C# kod źródłowy do edycji lub wyświetlania metadanych formatu OTP na platformach .NET Framework, .NET Core, Windows Azure, Mono lub Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Wyodrębnij metadane OTP przez .NET" h2="Twórz własne aplikacje .NET, aby dodawać, edytować, usuwać lub wyodrębniać metadane z plików OTP za pomocą interfejsów API po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak wyodrębnić metadane OTP za pomocą C#" %}}
...
Utwórz wystąpienie klasy Presentation ze ścieżką do pliku OTP
{{< /blocks/products/pf/agp/step-autogen >}}
