...
description: Kod źródłowy C# do wyszukiwania słów ze wzorcem w pliku ODP na platformach .NET Framework, .NET Core, Windows Azure, Mono lub Xamarin.
---
