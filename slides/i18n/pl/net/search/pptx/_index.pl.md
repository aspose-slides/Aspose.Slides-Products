---
title: Wyszukaj dokument PPTX bez otwierania za pomocą C#
weight: 7300
url: /pl/net/search/pptx/ 
description: Kod źródłowy C# do wyszukiwania słów ze wzorcem w pliku PPTX na platformach .NET Framework, .NET Core, Windows Azure, Mono lub Xamarin.
---
...
{{% blocks/products/pf/agp/content h2="Jak wyszukiwać plik PPTX za pomocą C#" %}}
 ...
 API, który jest bogatym w funkcje, wydajnym i łatwym w użyciu interfejsem API do wyszukiwania plików Microsoft PowerPoint dla platformy C#. otwarty
