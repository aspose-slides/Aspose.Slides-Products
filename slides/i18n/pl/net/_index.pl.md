...
{{< blocks/products/pf/i18n/carousel-item h3="Niezależność od platformy" description="Aspose.Slides dla platformy .NET obsługuje platformę .NET Framework, .NET Core i Xamarin. Może być również używany z Mono i innymi platformami za pośrednictwem COM Interop." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/i18n/carousel-item h3="Obsługiwane formaty plików" description="Aspose.Slides for .NET obsługuje popularne [formaty prezentacji](https://docs.aspose.com/slides/net/supported-file-formats/) i formaty eksportu wymienione poniżej." >}}
...
<h2 class="h2title">Pełna kontrola nad elementami slajdów PowerPoint</h2>

<p>Aspose.Slides dla platformy .NET może obsługiwać wszystkie elementy slajdów prezentacji, w tym pole tekstowe, tabelę, prostokąt, elipsę, polilinię, auto-kształt, ramkę obrazu, ramkę audio, ramkę wideo i ramkę obiektu OLE. API dostarcza dobrze zaprojektowany zestaw klas, który pozwala na wszechstronną manipulację każdym z tych elementów.</p>
...
<h2 class="h2title">Wsparcie dla Office Open XML</h2>

<p>Office OpenXML (OOXML) to format oparty na XML, który został wprowadzony do pakietu Microsoft Office 2007.</p>

<p>PresentationML (OOXML, PPTX) to język znaczników używany przez Microsoft Office PowerPoint 2007 do przechowywania dokumentów. Aspose.Slides for .NET obszernie obsługuje tworzenie, odczytywanie, manipulowanie i pisanie dokumentów PresentationML.</p>
