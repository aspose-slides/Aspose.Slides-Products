---
title: Konwertuj PPSM na XPS za pomocą C#
weight: 8440
url: /pl/net/conversion/ppsm-to-xps/ 
description: Przykładowy kod konwersji PPSM do XPS C#. Użyj przykładowego kodu API dla plików wsadowych PPSM do konwersji XPS w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj PPSM na XPS za pomocą C#" h2="Eksportuj pliki PowerPoint® PPSM do XPS na platformach .NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSM" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="Programiści .NET mogą łatwo ładować i konwertować pliki PPSM do XPS w zaledwie kilku linijkach kodu." >}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod przedstawia konwersję PPSM do XPS C#" offSpacer="" %}}
