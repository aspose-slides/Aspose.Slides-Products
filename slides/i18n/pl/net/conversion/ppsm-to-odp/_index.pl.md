---
title: Konwertuj PPSM na ODP za pomocą C#
weight: 2460
url: /pl/net/conversion/ppsm-to-odp/ 
description: Przykładowy kod konwersji PPSM do ODP C#. Użyj przykładowego kodu API dla plików wsadowych PPSM do konwersji ODP w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj PPSM na ODP za pomocą C#" h2="Eksportuj pliki PowerPoint® PPSM do ODP na platformach .NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSM" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="Programiści .NET mogą łatwo ładować i konwertować pliki PPSM na ODP w zaledwie kilku linijkach kodu." >}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję PPSM do ODP C#" offSpacer="" %}}
