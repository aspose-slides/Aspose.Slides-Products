---
title: Konwertuj POTX na PPSM za pomocą C#
weight: 5230
url: /pl/net/conversion/potx-to-ppsm/ 
description: Przykładowy kod konwersji POTX do PPSM C#. Użyj przykładowego kodu API dla plików wsadowych POTX do konwersji PPSM w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj POTX na PPSM za pomocą C#" h2="Eksportuj pliki PowerPoint® POTX do PPSM na platformach .NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{< blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować POTX na PPSM za pomocą C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Programiści .NET mogą łatwo ładować i konwertować pliki POTX do PPSM w zaledwie kilku linijkach kodu." >}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję C# POTX na PPSM" offSpacer="" %}}
