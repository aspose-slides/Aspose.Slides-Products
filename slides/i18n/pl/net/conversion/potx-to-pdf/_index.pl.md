---
title: Konwertuj POTX na PDF za pomocą C#
weight: 2010
url: /pl/net/conversion/potx-to-pdf/ 
description: Przykładowy kod do konwersji POTX na PDF w C#. Użyj przykładowego kodu API dla plików wsadowych POTX do konwersji PDF w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj POTX na PDF za pomocą C#" h2="Eksportuj pliki PowerPoint® POTX do formatu PDF na platformach .NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{< blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować POTX na PDF za pomocą C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Programiści .NET mogą łatwo ładować i konwertować pliki POTX do formatu PDF w zaledwie kilku linijkach kodu." >}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję C# POTX na PDF" offSpacer="" %}}
