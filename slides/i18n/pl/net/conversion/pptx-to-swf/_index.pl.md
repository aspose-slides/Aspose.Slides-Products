...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować PPTX na SWF za pomocą C#" %}}
 ...
 Aby przekonwertować PPTX na SWF, użyjemy
...
{{< blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować PPTX na SWF za pomocą C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Programiści .NET mogą łatwo ładować i konwertować pliki PPTX na SWF w zaledwie kilku wierszach kodu." >}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod przedstawia konwersję PPTX do SWF C#" offSpacer="" %}}
