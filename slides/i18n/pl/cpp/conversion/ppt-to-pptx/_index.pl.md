---
title: Konwertuj PPT na PPTX za pomocą aplikacji C++
weight: 5680
url: /pl/cpp/conversion/ppt-to-pptx/ 
description: Przykładowy kod konwersji C++ dla dokumentu PPT do formatu PPTX. Użyj przykładowego kodu do wsadowej konwersji PPT na PPTX w dowolnej aplikacji C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj PPT na PPTX przez C++" h2="Wydajna konwersja PPT do PPTX przy użyciu biblioteki C++ bez konieczności instalacji programu Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki do konwersji PPT na PPTX za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 Programiści C++ mogą łatwo przekonwertować plik PPT na PPTX w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji PPT do PPTX C++" offSpacer="" %}}
