...
{{% blocks/products/pf/agp/text %}}
 ...
 Programiści C++ mogą łatwo przekonwertować plik PPS na PPT w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji PPS na PPT C++" offSpacer="" %}}
