---
title: Konwertuj PPT na PDF za pomocą aplikacji C++
weight: 6240
url: /pl/cpp/conversion/ppt-to-pdf/ 
description: Przykładowy kod konwersji C++ dla dokumentu PPT do formatu PDF. Użyj przykładowego kodu do wsadowej konwersji PPT na PDF w dowolnej aplikacji C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj PPT na PDF za pomocą C++" h2="Wydajna konwersja PPT do PDF przy użyciu biblioteki C++ bez konieczności instalacji programu Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programiści C++ mogą łatwo przekonwertować plik PPT do formatu PDF w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji PPT na PDF C++" offSpacer="" %}}
