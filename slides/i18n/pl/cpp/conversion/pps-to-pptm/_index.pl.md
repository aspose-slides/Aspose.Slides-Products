...
{{% blocks/products/pf/agp/text %}}
 ...
 Programiści C++ mogą łatwo przekonwertować plik PPS na PPTM w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji PPS do PPTM C++" offSpacer="" %}}
