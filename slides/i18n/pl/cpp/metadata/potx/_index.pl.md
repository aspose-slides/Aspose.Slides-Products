---
title: Edytuj lub przeglądaj metadane dokumentu POTX za pomocą C++
weight: 4270
url: /pl/cpp/metadata/potx/ 
description: Przykładowy kod C++ do edycji lub przeglądania metadanych pliku POTX w C++ Runtime Environment dla Windows 32-bitowy, Windows 64-bitowy i Linux 64-bitowy.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Wyodrębnij metadane POTX za pomocą C++" h2="Twórz własne aplikacje w języku C++, aby dodawać, edytować, usuwać lub wyodrębniać metadane z plików POTX za pomocą interfejsów API po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTX" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak uzyskać metadane POTX za pomocą C++?" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Kroki wyodrębniania metadanych POTX za pomocą C++" >}}
