...
Chcesz programowo przekonwertować pliki POTM na XPS? Używając [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/python-net/) każdy programista może przekonwertować POTM na format XPS za pomocą zaledwie kilku linijek kodu Pythona.
