...
Chcesz programowo przekonwertować pliki PPT na XPS? Używając [*Aspose.Slides for Python przez .NET*](https://products.aspose.com/slides/python-net/) każdy programista może przekonwertować PPT na format XPS za pomocą zaledwie kilku wierszy kodu Pythona.
