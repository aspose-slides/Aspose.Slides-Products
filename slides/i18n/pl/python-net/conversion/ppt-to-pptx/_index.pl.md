...
weight: 2380
url: /pl/python-net/conversion/ppt-to-pptx/ 
keywords: "Convert, PowerPoint, PPT, PPTX, Presentation, Python"
description: Przykładowy kod do konwersji PPT na PPTX Python. Użyj PowerPoint Python API do wsadowej konwersji plików PPT do plików PPTX.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj PPT na PPTX w Pythonie" h2="Potężna biblioteka PowerPoint Python do konwersji PPT na PPTX" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Konwertuj PPT na PPTX w Pythonie" %}}

Chcesz programowo przekonwertować pliki PPT na PPTX? Używając [*Aspose.Slides for Python przez .NET*](https://products.aspose.com/slides/python-net/) każdy programista może przekonwertować PPT na format PPTX za pomocą zaledwie kilku wierszy kodu Pythona.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak przekonwertować PPT na PPTX w Pythonie?" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Oto kroki, aby przekonwertować plik PPT na PPTX za pomocą Pythona." >}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję PPT do PPTX w Pythonie" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz PPT jako PPTX w Pythonie" %}}
Skorzystaj z bezpłatnej aplikacji, aby zobaczyć demonstrację procesu konwersji PPT na PPTX. 
{{% /blocks/products/pf/agp/content %}}
