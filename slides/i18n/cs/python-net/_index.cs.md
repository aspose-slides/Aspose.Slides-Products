---
title: Python PowerPoint API. Python PPTX, PPT od Aspose.Slides
weight: 5860
url: /cs/python-net/ 
description: Knihovna Python pro práci se soubory Microsoft PowerPoint. Python PPTX, PPT. Vytvořit upravit převést PPT PPTX PPS POT PPSX PPTM PPSM POTX POTM ODP PDF a mnoho dalších formátů.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python PowerPoint API pro prezentace. Python PPTX, PPT" h2="Vytvářejte, čtěte, pište, upravujte, spojujte, klonujte, chraňte a převádějte prezentace PowerPoint a OpenOffice v Pythonu bez jakéhokoli externího softwaru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-python.svg" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="https://downloads.aspose.com/slides/python-net" >}}
...
<p><strong>Aspose.Slides pro Python přes .NET</strong> je výkonná knihovna tříd pro práci s prezentacemi nebo jejich zpracování. Pomocí tohoto produktu mohou aplikace a vývojáři číst, upravovat nebo manipulovat a převádět prezentace PowerPoint (PPT, PPTX) a prezentace v jiných formátech (ODP) bez aplikací nebo závislostí třetích stran. </p>

<p><strong>Aspose.Slides pro Python prostřednictvím. NET</strong> poskytuje tyto oblíbené funkce:</p>
<ul>
    <li>Načítání, otevírání a prohlížení prezentací.</li>
    <li>Úprava prezentací.</li>
    <li>Převod prezentací do PDF, Word, JPG, HTML, GIF, SVG a mnoha dalších formátů.</li>
...
<p>Python je velmi populární jazyk, který nachází mnoho využití v běžných aplikacích, vývoji webu, výzkumných a akademických úkolech, analýze dat atd. Z tohoto důvodu je tým <strong>Aspose.Slides</strong> hrdý na to, že může nabídnout < strong>Aspose.Slides pro Python přes .NET</strong>do komunity pythonů. </p>
...
{{< blocks/products/pf/carousel-item h3="Nezávislost na platformě" description="Python Presentation API podporuje všechny hlavní platformy včetně následujících." >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="Podporované formáty souborů" description="Aspose.Slides pro Python přes .NET podporuje oblíbené [formáty prezentace](https://docs.aspose.com/slides/python-net/supported-file-formats/) a tyto exportní formáty." >}}
  ...
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <ul>
	  ...
	  <li>V případě, že píšete kód Pythonu na Linuxu, podívejte se na <a href="https://docs.aspose.com/slides/python-net/system-requirements/">další požadavky pro Linux</a></li>
    </ul>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>Pomocí <strong>pip</strong> nainstalujte naši knihovnu Python pro zpracování prezentací z <a href="https://pypi.org/project/aspose.slides/">úložiště PyPI</a></p>:
	<pre><code>pip install aspose.slides</code></pre>
   </div>
    <div class="col-lg-12">
        <h2 class="h2title">Vytvořit novou prezentaci v PowerPointu. Python PPTX, PPT nebo ODP</h2>
        <p>V níže uvedeném příkladu jsme přidali řádek na první snímek prezentace.</p>
        <pre>
            <code class="python">
...
with slides.Presentation() as presentation:
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Sloučit prezentace: Python PPTX, PPT nebo ODP</h2>
        <p>Tento kód Pythonu ukazuje, jak sloučit prezentace:</p>
        <pre>
            <code class="python">
import aspose.slides as slides
...
with slides.Presentation("Presentation1.pptx") as pres1:
    ...
    <div class="col-lg-12">
        <h2 class="h2title"> Import prezentace z PDF: Python PPTX, PPT nebo ODP</h2>
        <p>Tento kód Pythonu demonstruje proces převodu PDF do PowerPointu:</p>
        <pre>
            <code class="python">
import aspose.slides as slides
...
with slides.Presentation() as pres:
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Převeďte PowerPoint do PDF s výchozími možnostmi: Python PPTX, PPT nebo ODP do PDF</h2>
        <p>Tento kód pythonu vám ukazuje, jak převést dokument PowerPoint PPT, PPTX a OpenOffice ODP na dokument PDF pomocí výchozích možností. Výsledný soubor je dokument PDF v maximální kvalitě</p>
        <pre>
            <code class="python">
import aspose.slides as slides
...
presentation.save("PPT-to-PDF.pdf", slides.export.SaveFormat.PDF)
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Převeďte PowerPoint do JPG: Python PPTX, PPT nebo ODP na JPEG</h2>
...
{{< blocks/products/pf/slr-element name="Dokumentace" href="https://docs.aspose.com/slides/python-net/" >}}
{{< blocks/products/pf/slr-element name="Zdrojový kód" href="https://github.com/aspose-slides/" >}}
{{< blocks/products/pf/slr-element name="Reference API" href="https://docs.aspose.com/slides/python-net/api-reference/" >}}
...
{{< blocks/products/pf/slr-element name="Poznámky k vydání" href="https://docs.aspose.com/slides/python-net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Proč Aspose.Slides pro Python přes .NET?" tabId="success-stories" >}}
