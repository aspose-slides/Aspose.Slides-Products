...
Potřebujete převést soubory OTP na POT programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/python-net/) může každý vývojář převést OTP do formátu POT pomocí pouhých několika řádků kódu Python.
