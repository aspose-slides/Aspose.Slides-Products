...
Potřebujete převést soubory PDF na OTP programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/python-net/) může každý vývojář převést PDF do formátu OTP pomocí pouhých několika řádků kódu Python.
