...
Potřebujete převést soubory OTP na FODP programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/python-net/) může každý vývojář převést OTP do formátu FODP pomocí pouhých několika řádků kódu Python.
