...
Potřebujete převést soubory ODP na SVG programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/python-net/) může každý vývojář převést ODP do formátu SVG pomocí pouhých několika řádků kódu Python.
