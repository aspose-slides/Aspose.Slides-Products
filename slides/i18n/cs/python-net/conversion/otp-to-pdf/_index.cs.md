---
title: Převeďte OTP do PDF v Pythonu
weight: 520
url: /cs/python-net/conversion/otp-to-pdf/ 
keywords: "Convert, PowerPoint, OTP, PDF, Presentation, Python"
description: Ukázkový kód pro převod OTP na PDF Python. Použijte PowerPoint Python API pro dávkový převod souborů OTP na soubory PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte OTP do PDF v Pythonu" h2="Výkonná PowerPoint Python knihovna pro převod OTP do PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Převeďte OTP do PDF v Pythonu" %}}

Potřebujete převést OTP soubory do PDF programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/python-net/) může každý vývojář převést OTP do formátu PDF pomocí pouhých několika řádků kódu Python.

Aspose.Slides pro Python jako moderní API pro zpracování prezentací rychle vytváří PDF z OTP. Otestujte kvalitu převodu OTP do PDF přímo ve svém [prohlížeči](https://products.aspose.app/slides/conversion). Knihovna Aspose PowerPoint PPTX umožňuje převádět soubory OTP do mnoha oblíbených formátů.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést OTP do PDF v Pythonu" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky k převodu souboru OTP do PDF pomocí Pythonu." >}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod OTP na PDF Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Uložit OTP jako PDF v Pythonu" %}}
Pomocí bezplatné aplikace si můžete prohlédnout ukázku procesu převodu OTP do PDF. 
{{% /blocks/products/pf/agp/content %}}
