...
Potřebujete převést soubory ODP na PPS programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/python-net/) může každý vývojář převést ODP na formát PPS pomocí pouhých několika řádků kódu Python.
