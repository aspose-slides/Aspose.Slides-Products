---
title: Převeďte PDF na FODP v Pythonu
weight: 690
url: /cs/python-net/conversion/pdf-to-fodp/ 
keywords: "Convert, PowerPoint, PDF, FODP, Presentation, Python"
description: Ukázkový kód pro převod PDF na FODP Python. Použijte PowerPoint Python API pro dávkový převod souborů PDF na soubory FODP.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte PDF na FODP v Pythonu" h2="Výkonná PowerPoint Python knihovna pro převod PDF do FODP" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Převeďte PDF na FODP v Pythonu" %}}

Potřebujete převést soubory PDF na FODP programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/python-net/) může každý vývojář převést PDF do formátu FODP pomocí pouhých několika řádků kódu Python.

Aspose.Slides pro Python jako moderní API pro zpracování prezentací rychle vytváří FODP z PDF. Otestujte kvalitu převodu PDF na FODP přímo ve svém [prohlížeči](https://products.aspose.app/slides/conversion). Knihovna Aspose PowerPoint PPTX umožňuje převádět soubory PDF do mnoha oblíbených formátů.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést PDF na FODP v Pythonu" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky k převodu souboru PDF na FODP pomocí Pythonu." >}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod PDF na FODP Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Uložit PDF jako FODP v Pythonu" %}}
Pomocí bezplatné aplikace si můžete prohlédnout ukázku procesu převodu PDF na FODP. 
{{% /blocks/products/pf/agp/content %}}
