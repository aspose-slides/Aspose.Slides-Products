...
Potřebujete převést soubory PDF na FODP programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/cs/python-net/) může každý vývojář převést PDF do formátu FODP pomocí pouhých několika řádků kódu Python.
