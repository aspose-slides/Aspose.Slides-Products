...
Potřebujete převést soubory ODP na PPSX programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/python-net/) může každý vývojář převést ODP do formátu PPSX pomocí pouhých několika řádků kódu Python.
