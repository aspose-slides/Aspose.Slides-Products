...
Potřebujete převést soubory FODP na ODP programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/cs/python-net/) může každý vývojář převést FODP do formátu ODP pomocí pouhých několika řádků kódu Python.
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        ...
        sectionTitle="Aplikace zdarma k převodu FODP na ODP" 
