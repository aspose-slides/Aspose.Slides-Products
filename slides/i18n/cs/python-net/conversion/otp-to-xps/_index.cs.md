...
Potřebujete převést soubory OTP na XPS programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/python-net/) může každý vývojář převést OTP do formátu XPS pomocí pouhých několika řádků kódu Python.
