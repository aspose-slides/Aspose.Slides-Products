---
title: Aspose.Slides pro Xamarin | Xamarin PowerPoint API
weight: 800
url: /cs/xamarin/ 
description: Aspose.Slides pro Xamarin pro vytváření aplikací Xamarin PowerPoint.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="PowerPoint Xamarin API od Aspose.Slides" h2="Vytvářejte mobilní aplikace pro zpracování PowerPointu v Xamarin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-xamarin.svg" pfName="Aspose.Slides" subTitlepfName="for Xamarin" downloadUrl="https://downloads.aspose.com/slides/net" >}}
...
<p>
 Aspose.Slides for Xamarin je multiplatformní řešení pro vytváření mobilních aplikací PowerPoint pro jakékoli zařízení a OS. Umožněte své mobilní aplikaci upravovat text, média a tvary snímku, ukládat prezentaci v požadovaném formátu. Prohlédněte si prezentaci z mobilu, přidejte komentáře a poznámky a odešlete ji. Použijte nový motiv na prezentaci, rozdělte prezentaci na několik souborů.
</p>

<p>
 Aspose.Slides for Xamarin je samostatné Xamarin PowerPoint API, které nevyžaduje Microsoft PowerPoint ani žádný další doplňkový software.
</p>
...
{{< blocks/products/pf/carousel-item h3="Na první pohled" description="Přehled schopností Xamarin PowerPoint API od Aspose.Slides." >}}
...
{{< blocks/products/pf/carousel-item h3="Nezávislost na platformě" description="Aspose.Slides pro Xamarin pro Android, iOS a Windows." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <!--/left-->
  <!--/right-->
...
{{< blocks/products/pf/carousel-item h3="Podporované formáty souborů" description="Aspose.Slides pro Xamarin podporuje oblíbené [formáty prezentace](https://docs.aspose.com/display/slidesnet/Supported+File+Formats) a exportní formáty uvedené níže." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Pokročilé funkce Xamarin PowerPoint API
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Převeďte prezentaci přes Xamarin PowerPoint API
    </h2>
    <p>
     Aspose.Slides for Xamarin API umožňuje vytváření mobilních aplikací pro převod PowerPointu do jakéhokoli dokumentu, textového, obrázkového, webového nebo jiného formátu. Převádějte prezentace ve vysoké kvalitě i z mobilu. Převod prezentací do formátu PDF, HTML, XPS, JPG. PowerPoint Xamarin API se snadno používá, logika převodu je implementována v 1-2 řádkovém kódu. Stačí načíst prezentaci a uložit ji v potřebném formátu.
    </p>
...
prs.Save(dir + "output.tiff", Aspose.Slides.Export.SaveFormat.Tiff);</code></pre>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Upravte prezentaci přes Xamarin PowerPoint API
    </h2>
    <p>
     S Xamarin PowerPoint API od Aspose je možné upravovat jakýkoli obsah snímků a prezentací i metadata. K textu, tabulkám, tvarům, grafům, SmartArts, animacím lze přistupovat prostřednictvím mobilní aplikace Xamarin. Všechny operace dostupné s obsahem prezentace lze použít prostřednictvím Aspose.Slides Xamarin API. Prezentační komentáře, poznámky, vlastnosti dokumentu, stejně jako rozvržení, motivy, šablony jsou také k dispozici k úpravě.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Sloučit, porovnat, rozdělit, vytisknout prezentaci přes Xamarin PowerPoint API
    </h2>
    <p>
     Vytvořte systém zpracování prezentací v Xamarin pomocí Aspose.Slides Xamarin API. K dispozici jsou takové operace nad prezentacemi a snímky jakéhokoli typu: sloučení, rozdělení, porovnání, tisk atd. Tyto operace lze použít k vytvoření mnoha scénářů zpracování. Například funkci sloučení lze použít k aplikaci šablony na prezentaci, ke sloučení několika šablon, ke sloučení prezentací různých formátů do jednoho formátu atd.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for Xamarin nevyžaduje instalaci Microsoft Office nebo Microsoft PowerPoint do počítače, aby mohl pracovat s formáty PowerPoint. Jedná se o perfektní alternativu pro automatizaci Microsoft Office z hlediska podporovaných funkcí, zabezpečení, stability, škálovatelnosti, rychlosti a ceny.
    </p>
   </div>
   <!--<div class="col-lg-12">
...
{{< blocks/products/pf/slr-tab tabTitle="Proč Aspose.Slides pro Xamarin?" tabId="success-stories" >}}
