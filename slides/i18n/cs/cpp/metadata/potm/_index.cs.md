---
title: Upravujte nebo zobrazujte metadata dokumentu POTM prostřednictvím C++
weight: 6600
url: /cs/cpp/metadata/potm/ 
description: Příklad kódu C++ pro úpravu nebo zobrazení metadat souboru POTM v C++ Runtime Environment pro Windows 32 bit, Windows 64 bit a Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extrahujte metadata POTM přes C++" h2="Sestavte si své vlastní aplikace C++ pro přidávání, úpravy, odstraňování nebo extrahování metadat ze souborů POTM pomocí rozhraní API na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak získat metadata POTM pomocí C++" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/cpp/metadata/pps/" name="PPS" description="Prezentace PowerPoint" >}}
