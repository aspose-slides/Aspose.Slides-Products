---
title: Převeďte POTM na ODP pomocí aplikace C++
weight: 430
url: /cs/cpp/conversion/potm-to-odp/ 
description: Ukázka převodního kódu C++ pro dokument POTM do formátu ODP. Použijte ukázkový kód pro dávkovou konverzi POTM na ODP v jakékoli aplikaci C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte POTM na ODP přes C++" h2="Vysoce výkonný převod POTM na ODP pomocí knihovny C++ bez nutnosti instalace Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor POTM na ODP v několika řádcích kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze POTM na ODP C++" offSpacer="" %}}
