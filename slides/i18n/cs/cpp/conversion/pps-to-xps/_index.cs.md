---
title: Převeďte PPS na XPS pomocí aplikace C++
weight: 3440
url: /cs/cpp/conversion/pps-to-xps/ 
description: Ukázka převodního kódu C++ pro dokument PPS do formátu XPS. Použijte ukázkový kód pro dávkovou konverzi PPS na XPS v jakékoli aplikaci C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést PPS na XPS přes C++" h2="Vysoce výkonný převod PPS na XPS pomocí knihovny C++ bez nutnosti instalace Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu PPS na XPS přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor PPS na XPS pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze PPS na XPS C++" offSpacer="" %}}
