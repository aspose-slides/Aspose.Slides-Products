---
title: Převeďte OTP na XPS pomocí aplikace C++
weight: 7080
url: /cs/cpp/conversion/otp-to-xps/ 
description: Ukázka převodního kódu C++ pro dokument OTP do formátu XPS. Použijte ukázkový kód pro dávkovou konverzi OTP na XPS v jakékoli aplikaci C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést OTP na XPS přes C++" h2="Vysoce výkonný převod OTP na XPS pomocí knihovny C++ bez nutnosti instalace Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTP" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor OTP na XPS pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze OTP na XPS C++" offSpacer="" %}}
