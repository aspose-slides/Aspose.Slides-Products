---
title: Vodoznak PPT dokumentu přes .NET
weight: 7740
url: /cs/net/watermark/ppt/ 
description: Zdrojový kód C# pro přidání nebo odstranění vodoznaku do souboru PPT na platformách .NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Přidat textový vodoznak do PPT přes C#" h2="Sestavte si své vlastní aplikace .NET pro vodoznakové soubory PPT pomocí rozhraní API na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
