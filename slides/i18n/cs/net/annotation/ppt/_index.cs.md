---
title: Odebrat PPT anotaci přes .NET
weight: 4380
...
{{< blocks/products/pf/i18n/upper-banner h1="Odebrat komentáře a autory komentářů z PPT přes C#" h2="Sestavte si své vlastní aplikace .NET pro manipulaci s komentáři a autory v souborech dokumentů pomocí rozhraní API na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{< blocks/products/pf/agp/feature-section-col title="Odebrat komentáře z PPT přes C#" >}}
...
{{% blocks/products/pf/agp/code-block title="Odstranit anotace z PPT - C#" offSpacer="" %}}
