---
title: Převést PPTM do PDF přes C#
weight: 8310
url: /cs/net/conversion/pptm-to-pdf/ 
description: Ukázkový kód pro převod PPTM do PDF C#. Použijte ukázkový kód API pro dávkový převod souborů PPTM do PDF v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést PPTM do PDF přes C#" h2="Exportujte soubory PowerPoint® PPTM do PDF na platformách .NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTM" >}}
...
{{< blocks/products/pf/agp/feature-section-col title="Kroky k převodu PPTM do PDF přes C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři .NET mohou snadno načíst a převést soubory PPTM do PDF pomocí několika řádků kódu." >}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod PPTM do PDF C#" offSpacer="" %}}
