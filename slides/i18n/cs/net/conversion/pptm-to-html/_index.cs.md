---
title: Převést PPTM na HTML přes C#
weight: 6000
url: /cs/net/conversion/pptm-to-html/ 
description: Ukázkový kód pro konverzi PPTM do HTML C#. Použijte ukázkový kód API pro dávkový převod souborů PPTM do HTML v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést PPTM na HTML přes C#" h2="Export souborů PowerPoint® PPTM do HTML na platformách .NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTM" >}}
...
{{< blocks/products/pf/agp/feature-section-col title="Kroky k převodu PPTM na HTML přes C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři .NET mohou snadno načíst a převést soubory PPTM do HTML pomocí několika řádků kódu." >}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod PPTM na HTML C#" offSpacer="" %}}
