---
title: Převést PPTM na SWF přes C#
weight: 530
url: /cs/net/conversion/pptm-to-swf/ 
description: Ukázkový kód pro konverzi PPTM do SWF C#. Použijte ukázkový kód API pro dávkový převod souborů PPTM na SWF v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést PPTM na SWF přes C#" h2="Exportujte soubory PowerPoint® PPTM do SWF na platformách .NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést PPTM na SWF pomocí C#" %}}
 ...
 Abychom převedli PPTM na SWF, použijeme
...
{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři .NET mohou snadno načíst a převést soubory PPTM na SWF pomocí několika řádků kódu." >}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod PPTM na SWF C#" offSpacer="" %}}
