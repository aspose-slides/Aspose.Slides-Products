---
title: Převést POTM na TIFF přes C#
weight: 7700
url: /cs/net/conversion/potm-to-tiff/ 
description: Ukázkový kód pro konverzi POTM na TIFF C#. Použijte ukázkový kód API pro dávkový převod souborů POTM na TIFF v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést POTM na TIFF přes C#" h2="Exportujte soubory PowerPoint® POTM do formátu TIFF na platformách .NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést POTM na TIFF pomocí C#" %}}

 Abychom převedli POTM na TIFF, použijeme
...
{{< blocks/products/pf/agp/feature-section-col title="Kroky pro převod POTM na TIFF přes C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři .NET mohou snadno načíst a převést soubory POTM na TIFF pomocí několika řádků kódu." >}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod POTM na TIFF C#" offSpacer="" %}}
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        ...
        sectionTitle="Aplikace zdarma k převodu POTM na TIFF" 
