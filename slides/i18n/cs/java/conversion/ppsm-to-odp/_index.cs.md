...
{{% blocks/products/pf/agp/content h2="Jak převést PPSM na ODP pomocí Java" %}}

 K převedení PPSM na ODP použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod PPSM na ODP přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor PPSM na ODP pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze PPSM na ODP Java" offSpacer="" %}}
