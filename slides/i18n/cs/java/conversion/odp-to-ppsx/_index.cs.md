---
title: Převést ODP na PPSX přes Java
weight: 2850
url: /cs/java/conversion/odp-to-ppsx/ 
description: Ukázkový konverzní kód Java pro formát ODP na soubor PPSX. Tento příklad kódu použijte k exportu prezentací PowerPoint a OpenOffice do PPSX v rámci jakékoli webové nebo desktopové Java aplikace.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést ODP na PPSX přes Java" h2="Konverze ODP na PPSX Java pro převod jedné nebo více stránek na PPSX pomocí On-premise Java knihovny." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést ODP na PPSX pomocí Java" %}}

 K vykreslení ODP na PPSX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod ODP na PPSX přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor ODP na PPSX pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze ODP na PPSX Java" offSpacer="" %}}
