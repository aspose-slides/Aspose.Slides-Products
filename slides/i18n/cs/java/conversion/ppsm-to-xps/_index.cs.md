---
title: Převeďte PPSM na XPS přes Java
weight: 5650
url: /cs/java/conversion/ppsm-to-xps/ 
description: Ukázkový konverzní kód Java pro formát PPSM na soubor XPS. Tento příklad kódu použijte k exportu prezentací PowerPoint a OpenOffice do XPS v rámci jakékoli webové nebo desktopové Java aplikace.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte PPSM na XPS přes Java" h2="Konverze PPSM na XPS Java pro převod jedné nebo více stránek na XPS pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést PPSM na XPS pomocí Java" %}}

 K vykreslení PPSM na XPS použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod PPSM na XPS přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor PPSM na XPS pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze PPSM na XPS Java" offSpacer="" %}}
