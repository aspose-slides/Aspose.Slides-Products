---
title: Upravujte nebo prohlížejte metadata souborů PPTM prostřednictvím Java
weight: 3850
url: /cs/java/metadata/pptm/ 
description: Ukázkový kód Java pro úpravu nebo zobrazení metadat formátu PPTM v prostředí Java Runtime Environment pro aplikace a desktopové aplikace JSP/JSF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extrahujte metadata PPTM přes Java" h2="Sestavte si své vlastní Java aplikace pro přidávání, úpravy, odstraňování nebo extrahování metadat ze souborů PPTM pomocí rozhraní API na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTM" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak extrahovat metadata PPTM pomocí Javy" %}}

 Abychom získali metadata souboru PPTM, použijeme
...
{{< blocks/products/pf/agp/feature-section-col title="Kroky k extrahování metadat PPTM přes Java" >}}
...
Získejte informace o PPTM pomocí getPresentationInfo()
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Aktualizujte a zapisujte informace PPTM o nové vlastnosti
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Extrahujte metadata PPTM - Java" offSpacer="" %}}
