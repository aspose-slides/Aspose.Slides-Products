---
title: Upravujte nebo zobrazujte metadata souborů PPSM přes Java
weight: 5610
url: /cs/java/metadata/ppsm/ 
description: Ukázkový kód Java pro úpravu nebo zobrazení metadat formátu PPSM v prostředí Java Runtime Environment pro aplikace a desktopové aplikace JSP/JSF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extrahujte metadata PPSM přes Java" h2="Sestavte si své vlastní Java aplikace pro přidávání, úpravy, odstraňování nebo extrahování metadat ze souborů PPSM pomocí rozhraní API na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak extrahovat metadata PPSM pomocí Java" %}}

 Abychom získali metadata souboru PPSM, použijeme
...
{{< blocks/products/pf/agp/feature-section-col title="Kroky k extrahování metadat PPSM přes Java" >}}
...
Získejte informace o PPSM pomocí getPresentationInfo()
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Aktualizujte a zapište informace PPSM s novými vlastnostmi
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Extrahujte metadata PPSM - Java" offSpacer="" %}}
