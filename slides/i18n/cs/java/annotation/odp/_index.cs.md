---
title: Odebrat anotaci ODP přes Java
weight: 1790
url: /cs/java/annotation/odp/ 
description: Ukázkový kód Java pro odstranění anotací formátu ODP v prostředí Java Runtime Environment pro aplikace a desktopové aplikace JSP/JSF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Odstraňte komentáře a autory komentářů z ODP přes Java" h2="Sestavte si své vlastní Java aplikace pro manipulaci s komentáři a autory v souborech dokumentů pomocí rozhraní API na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak anotovat soubor ODP pomocí Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k odstranění komentářů z ODP přes Java" %}}
...
1. Uložte jej ve formátu ODP
1. Odeberte komentář na konkrétním místě
1. Znovu uložte soubor ODP a porovnejte
...
{{% blocks/products/pf/agp/code-block title="Odstranit anotace z ODP - Java" offSpacer="" %}}
