...
Behöver du konvertera PPSX-filer till PPT programmatiskt? Genom att använda [*Aspose.Slides för Python via .NET*](https://products.aspose.com/slides/python-net/) kan alla utvecklare konvertera PPSX till PPT-format med bara några rader Python-kod.
