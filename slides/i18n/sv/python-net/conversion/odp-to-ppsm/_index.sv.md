...
Behöver du konvertera ODP-filer till PPSM programmatiskt? Genom att använda [*Aspose.Slides för Python via .NET*](https://products.aspose.com/slides/python-net/) kan vilken utvecklare som helst konvertera ODP till PPSM-format med bara några rader Python-kod.
