...
Behöver du konvertera PPS-filer till ODP programmatiskt? Genom att använda [*Aspose.Slides för Python via .NET*](https://products.aspose.com/slides/python-net/) kan alla utvecklare konvertera PPS till ODP-format med bara några rader Python-kod.
