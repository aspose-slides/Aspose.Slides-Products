...
{{% blocks/products/pf/agp/content h2="Hur man konverterar PPSM till TIFF med Java" %}}

 För att rendera PPSM till TIFF kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera PPSM till TIFF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera PPSM-filer till TIFF på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="Källkod för Java-konvertering från PPSM till TIFF" offSpacer="" %}}
