---
title: Konvertera PPSM till XPS via Java
weight: 5650
url: /sv/java/conversion/ppsm-to-xps/ 
description: Exempel på Java-konverteringskod för PPSM-format till XPS-fil. Använd den här exempelkoden för att exportera PowerPoint- och OpenOffice-presentationer till XPS inom alla Java-baserade webb- eller skrivbordsapplikationer.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera PPSM till XPS via Java" h2="PPSM till XPS Java-konvertering för att konvertera enstaka eller flera sidor till XPS med hjälp av On-premise Java-biblioteket." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSM" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar PPSM till XPS med Java" %}}

 För att rendera PPSM till XPS kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera PPSM till XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera PPSM-filer till XPS på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="Källkod för Java-konvertering från PPSM till XPS" offSpacer="" %}}
