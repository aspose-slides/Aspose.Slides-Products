---
title: Redigera eller visa POTM-dokumentmetadata via C++
weight: 6600
url: /sv/cpp/metadata/potm/ 
description: C++ exempelkod för att redigera eller visa POTM-filmetadata i C++ Runtime Environment för Windows 32 bitar, Windows 64 bitar och Linux 64 bitar.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extrahera POTM-metadata via C++" h2="Bygg dina egna C++-appar för att lägga till, redigera, ta bort eller extrahera metadata från POTM-filer med hjälp av API:er på serversidan." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Hur man hämtar POTM-metadata med C++" %}}
