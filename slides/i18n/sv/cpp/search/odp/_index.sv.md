---
title: Sök ODP-dokument utan att öppna via C++
weight: 6500
url: /sv/cpp/search/odp/ 
description: C++ exempelkod för att söka efter ord med mönster i ODP-fil på C++ Runtime Environment för Windows 32 bitar, Windows 64 bitar och Linux 64 bitar.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Sök ODP-format i C++" h2="Inbyggd och högpresterande ODP-dokumentsökning med Aspose.Slides på serversidan för C++ API:er, utan användning av någon programvara som Microsoft eller Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man söker ODP-fil med C++" %}}

 För att söka ODP-fil använder vi
...
{{< blocks/products/pf/agp/feature-section-col title="Steg för att söka ODP-filer i C++" >}}
...
Ladda ODP-fil genom att instansiera Presentation Class-objekt.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Få en uppsättning ITextFrame-objekt från den första bilden.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Visa teckensnittshöjd och teckensnittsnamn.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Sök ODP-filer - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/sv/cpp/search/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/sv/cpp/search/pptx/" name="PPTX" description="Öppna XML-presentationsformat" >}}
