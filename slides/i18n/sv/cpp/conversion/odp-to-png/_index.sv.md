---
title: Konvertera ODP till PNG via C++-applikation
weight: 990
url: /sv/cpp/conversion/odp-to-png/ 
description: Exempel på C++-konverteringskod för ODP-dokument till PNG-format. Använd exempelkod för batch ODP till PNG-konvertering inom valfri C++-applikation.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera ODP till PNG via C++" h2="Högpresterande ODP till PNG-konvertering med C++-bibliotek utan behov av Microsoft PowerPoint-installation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-utvecklare kan enkelt konvertera ODP-fil till PNG på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="ODP till PNG C++ Källkod för konvertering" offSpacer="" %}}
