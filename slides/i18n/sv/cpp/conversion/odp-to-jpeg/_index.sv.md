---
title: Konvertera ODP till JPEG via C++-applikation
weight: 4730
url: /sv/cpp/conversion/odp-to-jpeg/ 
description: Exempel på C++-konverteringskod för ODP-dokument till JPEG-format. Använd exempelkod för batch-ODP till JPEG-konvertering inom valfri C++-applikation.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera ODP till JPEG via C++" h2="Högpresterande ODP till JPEG-konvertering med C++-bibliotek utan behov av Microsoft PowerPoint-installation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar ODP till JPEG med C++" %}}

 För att konvertera ODP till JPEG kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera ODP till JPEG via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++-utvecklare kan enkelt konvertera ODP-fil till JPEG på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="ODP till JPEG C++ Källkod för konvertering" offSpacer="" %}}
