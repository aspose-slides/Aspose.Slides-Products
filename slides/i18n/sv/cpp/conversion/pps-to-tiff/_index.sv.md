...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-utvecklare kan enkelt konvertera PPS-fil till TIFF på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="PPS till TIFF C++ Källkod för konvertering" offSpacer="" %}}
