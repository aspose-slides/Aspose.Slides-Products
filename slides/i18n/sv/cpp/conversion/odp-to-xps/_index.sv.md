---
title: Konvertera ODP till XPS via C++-applikation
weight: 2870
url: /sv/cpp/conversion/odp-to-xps/ 
description: Exempel på C++-konverteringskod för ODP-dokument till XPS-format. Använd exempelkod för batch-konvertering av ODP till XPS inom valfri C++-applikation.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera ODP till XPS via C++" h2="Högpresterande ODP till XPS-konvertering med C++-bibliotek utan behov av Microsoft PowerPoint-installation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar ODP till XPS med C++" %}}

 För att konvertera ODP till XPS kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera ODP till XPS via C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++-utvecklare kan enkelt konvertera ODP-fil till XPS på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="ODP till XPS C++ Källkod för konvertering" offSpacer="" %}}
