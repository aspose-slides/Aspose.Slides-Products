...
<p class="col-lg-10">Bädda in Excel-diagram som OLE-objekt i bilder</p>

</div>

<div class="col-lg-4"><em class="fa fa-print  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Hantera länkade Ole-objekt</p>
...
<p class="col-lg-10">Skräddarsydd utskrift av presentationer</p>
...
<h2 class="h2title">Kontinuerlig integration av nya funktioner</h2>

<p>Du är aldrig begränsad till befintliga funktioner. Våra produktteam lägger kontinuerligt till fler och fler funktioner och varje ny version erbjuder fler funktioner jämfört med de äldre versionerna. Du kan också skicka nya funktionsförfrågningar om du upptäcker att någon av dina önskade funktioner saknas. Här är listan över några val från de senaste funktionerna.</p>

<ul>

<li>Rasterisering eller vektorisering av former utan text.</li>

<li>Konvertera SVG-bilder till former.</li>

<li>Skaffa standardtabellbakgrunden.</li>

<li>Begränsa åtkomst till lokalt filsystem när ett dokument öppnas.</li>

<li>Lägg till kodningsmetatagg när du sparar i HTML.</li>

<li>Inställning för att ta bort bredd- och höjdattribut för SVG-taggen när du sparar som HTML.</li>

<li>Support for

<ul>

<li>Kommentarsvar, Office 365 och externa Excel-arbetsböcker.</li>

<li>Storlek representerar egenskapen för bubbeldiagram.</li>

<li>Döljer vänster bildminiatyrfönster i genererad PPT.</li>

<li>Trattdiagram, 2D-kartdiagram och ange sökväg för arbetsbok för extern datakälla.</li>

<li>OpenDocument-kryptering, Morph Transition och Text Highlighter-funktion.</li>

<li>Ställa in egenskapen Transparency för skuggeffekter.</li>

<li>Ställa in bildtextform för seriedataetikett.</li>

<li>Få effekter genom text-box stycken.</li>

<li>Återgivande form Soft Edges (EffectFormat) effekt.</li>

<li>ChartData SetRange på en pivottabell.</li>

</ul>

</li>

<li>Implementera Multi-page Tiff-format, Metafile Format Plus Extensions (EMF+) och Strict Open XML-format.</li>

<li>Återger kommentarer från ODP-format som inte har någon författare.</li>

<li>Implementera serialisering med strikt överensstämmelse med Open XML-format.</li>
...
<p>Aspose.Slides för C++ underlättar att skapa SmartArt-former från grunden samt ger möjlighet att komma åt, manipulera eller ta bort befintliga SmartArt-former från en bild. Dessutom är det också möjligt att formatera SmartArt-formerna såsom inställningsstil, färg och layout.</p>
