---
title: Android PowerPoint API | Aspose.Slides för Android API
weight: 5960
url: /sv/android-java/ 
description: Aspose.Slides för Android API eller Android PowerPoint API för att skapa läsa och manipulera PPT POT PPS PPTX POTX PPSX PowerPoint på Android.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Android PowerPoint API" h2="Skapa, ändra, konvertera, slå samman, dela och hantera PowerPoint-presentationer i Android-appar." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-android-java.svg" pfName="Aspose.Slides" subTitlepfName="for Android via Java" downloadUrl="https://downloads.aspose.com/slides/androidjava" >}}
...
{{< blocks/products/pf/carousel-item h3="En överblick" description="Aspose.Slides för Android API funktioner översikt." >}}
...
{{< blocks/products/pf/carousel-item h3="Plattformsoberoende" description="Aspose.Slides för Android API täcker följande Android-utvecklingsmiljöer och distributionsplattformar." >}}
<div class="diagram1 d1-android">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="Filformat som stöds" description="Aspose.Slides för Android API stöder inbyggda [PowerPoint-format](https://docs.aspose.com/slides/java/supported-file-formats/) och många konverteringsformat." >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Varför Aspose.Slides för Android via Java?" tabId="success-stories" >}}
