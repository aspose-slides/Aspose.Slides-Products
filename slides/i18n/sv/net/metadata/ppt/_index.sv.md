---
title: Visa eller redigera PPT-filers metadata via .NET
weight: 6210
url: /sv/net/metadata/ppt/ 
description: C#-källkod för att redigera eller visa PPT-formatmetadata på .NET Framework, .NET Core, Windows Azure, Mono eller Xamarin-plattformar.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extrahera PPT-metadata via .NET" h2="Bygg dina egna .NET-appar för att lägga till, redigera, ta bort eller extrahera metadata från PPT-filer med hjälp av API:er på serversidan." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Hur man extraherar PPT-metadata med C#" %}}
...
Instantiera klassen Presentation med sökväg till PPT-fil
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Extrahera metadata från PPT - C#" offSpacer="" %}}
