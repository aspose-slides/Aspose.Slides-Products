---
title: 通過 Java 將 PPSM 轉換為 ODP
weight: 1040
url: /zh-hant/java/conversion/ppsm-to-odp/ 
description: PPSM 格式到 ODP 文件的示例 Java 轉換代碼。使用此示例代碼將 PowerPoint 和 OpenOffice 演示文稿導出到任何基於 Web 或桌面 Java 的應用程序中的 ODP。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 將 PPSM 轉換為 ODP" h2="PPSM 到 ODP Java 轉換使用本地 Java 庫將單個或多個頁面轉換為 ODP。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSM" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將 PPSM 轉換為 ODP" %}}

 為了將 PPSM 渲染為 ODP，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 將 PPSM 轉換為 ODP 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 Java 開發人員只需幾行代碼即可輕鬆地將 PPSM 文件轉換為 ODP。
...
{{% blocks/products/pf/agp/code-block title="PPSM 到 ODP Java 轉換源代碼" offSpacer="" %}}
