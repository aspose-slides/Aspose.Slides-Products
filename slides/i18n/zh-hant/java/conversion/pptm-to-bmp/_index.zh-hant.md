---
title: 通過 Java 將 PPTM 轉換為 BMP
weight: 8290
url: /zh-hant/java/conversion/pptm-to-bmp/ 
description: PPTM 格式到 BMP 文件的示例 Java 轉換代碼。使用此示例代碼將 PowerPoint 和 OpenOffice 演示文稿導出到任何基於 Web 或桌面 Java 的應用程序中的 BMP。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 將 PPTM 轉換為 BMP" h2="PPTM 到 BMP Java 轉換使用本地 Java 庫將單個或多個頁面轉換為 BMP。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTM" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將 PPTM 轉換為 BMP" %}}

 為了將 PPTM 渲染為 BMP，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 將 PPTM 轉換為 BMP 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 Java 開發人員只需幾行代碼即可輕鬆地將 PPTM 文件轉換為 BMP。
...
{{% blocks/products/pf/agp/code-block title="PPTM 到 BMP Java 轉換源代碼" offSpacer="" %}}
