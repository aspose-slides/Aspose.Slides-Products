---
title: 通過 .NET 解鎖 PPTX 文檔
weight: 6480
url: /zh-hant/net/unlock/pptx/ 
description: 在 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上解鎖受密碼保護的 PPTX 文件的 C# 源代碼。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 解鎖 PPTX 演示文稿" h2="使用 .NET 庫從 PPTX 中刪除保護。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 解鎖 PPTX 文件" %}}

 為了刪除保護 PPTX 文件，我們將使用
...
{{< blocks/products/pf/agp/feature-section-col title="通過 C# 解鎖 PPTX" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/zh-hant/net/unlock/odp/" name="ODP" description="OpenDocument 演示格式" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/zh-hant/net/unlock/ppt/" name="PPT" description="微軟PowerPoint 97-2003" >}}
