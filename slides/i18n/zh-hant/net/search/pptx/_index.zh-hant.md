...
description: C# 源代碼，用於在 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上的 PPTX 文件中搜索帶有模式的單詞。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="在 C# 中搜索 PPTX 格式" h2="使用用於 .NET API 的服務器端 Aspose.Slides 進行本機和高性能 PPTX 文檔搜索，無需使用 Microsoft 或 Adob​​e PDF 等任何軟件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 搜索 PPTX 文件" %}}
 ...
 API 是一個功能豐富、功能強大且易於使用的 Microsoft PowerPoint 文件搜索 API，適用於 C# 平台。打開
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/zh-hant/net/search/ppt/" name="PPT" description="微軟PowerPoint 97-2003" >}}
