---
title: 通過 .NET 保護和鎖定 ODP 文檔
weight: 4230
url: /zh-hant/net/protect/odp/ 
description: 在 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上使用密碼鎖定 ODP 文件的 C# 源代碼。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 加密 ODP 文件" h2="密碼保護 PowerPoint 演示文稿，包括使用 .NET 庫的 ODP 格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{< blocks/products/pf/agp/feature-section-col title="通過 C# 保護 ODP" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/net/protect/ppt/" name="PPT" description="微軟PowerPoint 97-2003" >}}
