...
<h2 class="h2title">完全控制 PowerPoint 幻燈片元素</h2>

<p>Aspose.Slides for .NET 可以處理所有演示幻燈片元素，包括文本框、表格、矩形、橢圓、折線、自動形狀、圖片框、音頻框、視頻框和 OLE 對象框。 API 提供了一組精心設計的類，使您能夠全面地操作這些元素中的每一個。</p>
