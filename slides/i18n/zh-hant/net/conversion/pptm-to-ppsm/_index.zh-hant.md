---
title: 通過 C# 將 PPTM 轉換為 PPSM
weight: 1470
url: /zh-hant/net/conversion/pptm-to-ppsm/ 
description: PPTM 到 PPSM C# 轉換的示例代碼。使用 API 示例代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中將批處理 PPTM 文件轉換為 PPSM。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 將 PPTM 轉換為 PPSM" h2="將 PowerPoint® PPTM 文件導出到 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上的 PPSM" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTM" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET 開發人員只需幾行代碼即可輕鬆加載 PPTM 文件並將其轉換為 PPSM。" >}}
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 PPTM 到 PPSM C# 的轉換" offSpacer="" %}}
