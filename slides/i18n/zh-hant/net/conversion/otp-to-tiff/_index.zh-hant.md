---
title: 通過 C# 將 OTP 轉換為 TIFF
weight: 3060
url: /zh-hant/net/conversion/otp-to-tiff/ 
description: OTP 到 TIFF C# 轉換的示例代碼。使用 API 示例代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中將 OTP 文件批量轉換為 TIFF。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 將 OTP 轉換為 TIFF" h2="在 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上將 PowerPoint® OTP 文件導出為 TIFF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTP" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET 開發人員只需幾行代碼即可輕鬆加載 OTP 文件並將其轉換為 TIFF。" >}}
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 OTP 到 TIFF C# 轉換" offSpacer="" %}}
