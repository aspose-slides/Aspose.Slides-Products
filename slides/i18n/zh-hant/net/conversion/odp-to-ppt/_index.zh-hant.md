---
title: 通過 C# 將 ODP 轉換為 PPT
weight: 2000
url: /zh-hant/net/conversion/odp-to-ppt/ 
description: ODP 到 PPT C# 轉換的示例代碼。使用 API 示例代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中將 ODP 文件批量轉換為 PPT。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 將 ODP 轉換為 PPT" h2="將 PowerPoint® ODP 文件導出到 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上的 PPT" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 將 ODP 轉換為 PPT" %}}

 為了將 ODP 轉換為 PPT，我們將使用
...
{{< blocks/products/pf/agp/feature-section-col title="通過 C# 將 ODP 轉換為 PPT 的步驟" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET 開發人員只需幾行代碼即可輕鬆加載 ODP 文件並將其轉換為 PPT。" >}}
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 ODP 到 PPT C# 轉換" offSpacer="" %}}
