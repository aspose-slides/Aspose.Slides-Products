---
title: 通過 .NET 查看 POTM 文件格式
weight: 3310
url: /zh-hant/net/viewer/potm/ 
description: 用於在 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上加載、呈現和顯示 POTM 文檔的 C# 源代碼。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1=".NET 的 POTM 文件查看器" h2="在沒有 Microsoft PowerPoint 或 Office Automation 的情況下查看演示文件，例如 POTM" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{< blocks/products/pf/agp/feature-section-col title="通過 C# 查看 POTM 的步驟" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Aspose.Slides 讓開發人員只需幾行代碼即可輕鬆查看 POTM 文件。" >}}

{{< blocks/products/pf/agp/step-autogen >}}
實例化一個 Presentation 對象並加載 POTM 文件
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
調用 Process.Start 以生成的 HTML 的路徑以在默認瀏覽器中加載 POTM 內容
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="C# 示例代碼查看 POTM 文件" offSpacer="" %}}
