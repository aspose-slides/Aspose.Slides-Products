---
title: 通過 .NET 編輯 PPTM 文件
url: /zh-hant/net/editor/pptm/ 
description: 用於在 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上編輯 PPTM 文檔的 C# 源代碼。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="在 C# 中編輯 PPTM 格式" h2="使用用於 .NET API 的服務器端 Aspose.Slides 進行本機和高性能 PPTM 文檔編輯，無需使用 Microsoft 或 Adob​​e PDF 等任何軟件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 編輯 PPTM 文件" %}}

為了編輯 PPTM 文件，我們將使用 <a href="https://products.aspose.com/slides/zh-hant/net">Aspose.Slides for .NET</a> API，這是一個功能豐富、功能強大的 API以及適用於任何編輯器的 C# 平台的易於使用的 API。打開 <a href="https://www.nuget.org/packages/aspose.slides.net">NuGet</a> 包管理器，搜索 <b>Aspose.Slides</b> 並安裝。您還可以從包管理器控制台使用以下命令。
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中編輯 PPTM 文件的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="編輯 PPTM 文件 - C#" offSpacer="" %}}
