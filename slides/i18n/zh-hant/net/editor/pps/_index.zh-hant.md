---
title: 通過 .NET 編輯 PPS 文件
url: /zh-hant/net/editor/pps/ 
description: 用於在 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上編輯 PPS 文檔的 C# 源代碼。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="在 C# 中編輯 PPS 格式" h2="使用用於 .NET API 的服務器端 Aspose.Slides 進行本機和高性能 PPS 文檔編輯，無需使用 Microsoft 或 Adob​​e PDF 等任何軟件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中編輯 PPS 文件的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="編輯 PPS 文件 - C#" offSpacer="" %}}
