...
為了編輯 POTM 文件，我們將使用 <a href="https://products.aspose.com/slides/net">Aspose.Slides for .NET</a> API，這是一個功能豐富、功能強大的 API以及適用於任何編輯器的 C# 平台的易於使用的 API。打開 <a href="https://www.nuget.org/packages/aspose.slides.net">NuGet</a> 包管理器，搜索 <b>Aspose.Slides</b> 並安裝。您還可以從包管理器控制台使用以下命令。
