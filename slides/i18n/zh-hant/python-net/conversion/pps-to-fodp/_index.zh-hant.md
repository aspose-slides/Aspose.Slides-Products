...
weight: 1570
url: /zh-hant/python-net/conversion/pps-to-fodp/ 
keywords: "Convert, PowerPoint, PPS, FODP, Presentation, Python"
description: PPS 到 FODP Python 轉換的示例代碼。使用 PowerPoint Python API 將 PPS 文件批量轉換為 FODP 文件。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="在 Python 中將 PPS 轉換為 FODP" h2="用於將 PPS 轉換為 FODP 的強大 PowerPoint Python 庫" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="在 Python 中將 PPS 轉換為 FODP" %}}

需要以編程方式將 PPS 文件轉換為 FODP？使用 [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/python-net/) 任何開發人員只需幾行 Python 代碼即可將 PPS 轉換為 FODP 格式。

作為現代演示處理 API，Aspose.Slides for Python 從 PPS 快速創建 FODP。在您的 [瀏覽器](https://products.aspose.app/slides/conversion) 中測試 PPS 到 FODP 轉換的質量。 Aspose PowerPoint PPTX 庫允許您將 PPS 文件轉換為許多流行的格式。
...
{{< blocks/products/pf/agp/feature-section-col title="如何在 Python 中將 PPS 轉換為 FODP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="這些是使用 Python 將 PPS 文件轉換為 FODP 的步驟。" >}}
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 PPS 到 FODP Python 轉換" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="在 Python 中將 PPS 保存為 FODP" %}}
使用免費應用程序查看 PPS 到 FODP 轉換過程的演示。 
{{% /blocks/products/pf/agp/content %}}
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        ...
        sectionTitle="免費應用程序將PPS轉換為FODP" 
