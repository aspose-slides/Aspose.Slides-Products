---
title: 在 Python 中將 POTX 轉換為 PPTX
weight: 1500
url: /zh-hant/python-net/conversion/potx-to-pptx/ 
keywords: "Convert, PowerPoint, POTX, PPTX, Presentation, Python"
description: POTX 到 PPTX Python 轉換的示例代碼。使用 PowerPoint Python API 將 POTX 文件批量轉換為 PPTX 文件。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="在 Python 中將 POTX 轉換為 PPTX" h2="強大的 PowerPoint Python 庫，用於將 POTX 轉換為 PPTX" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="在 Python 中將 POTX 轉換為 PPTX" %}}

需要以編程方式將 POTX 文件轉換為 PPTX？使用 [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/python-net/) 任何開發人員只需幾行 Python 代碼即可將 POTX 轉換為 PPTX 格式。

作為現代演示處理 API，Aspose.Slides for Python 從 POTX 快速創建 PPTX。在您的 [瀏覽器](https://products.aspose.app/slides/conversion) 中測試 POTX 到 PPTX 轉換的質量。 Aspose PowerPoint PPTX 庫允許您將 POTX 文件轉換為許多流行的格式。
...
{{< blocks/products/pf/agp/feature-section-col title="如何在 Python 中將 POTX 轉換為 PPTX" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="這些是使用 Python 將 POTX 文件轉換為 PPTX 的步驟。" >}}
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 POTX 到 PPTX Python 轉換" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="在 Python 中將 POTX 保存為 PPTX" %}}
使用免費應用程序查看 POTX 到 PPTX 轉換過程的演示。 
{{% /blocks/products/pf/agp/content %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/python-net/conversion/potx-to-xps/" name="POTX TO XPS" description="XML 紙張規格" >}}  
