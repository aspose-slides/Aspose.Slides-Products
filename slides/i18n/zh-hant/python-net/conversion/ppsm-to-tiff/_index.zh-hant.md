...
需要以編程方式將 PPSM 文件轉換為 TIFF？使用 [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/zh-hant/python-net/) 任何開發人員只需幾行 Python 代碼即可將 PPSM 轉換為 TIFF 格式。
