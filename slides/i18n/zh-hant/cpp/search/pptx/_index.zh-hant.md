...
{{< blocks/products/pf/agp/feature-section-col title="在 C++ 中搜索 PPTX 文件的步驟" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="使用 Aspose.Slides API 的基本文檔搜索只需幾行代碼即可完成。" >}}

{{< blocks/products/pf/agp/step-autogen >}}
通過實例​​化 Presentation Class 對象來加載 PPTX 文件。
{{< /blocks/products/pf/agp/step-autogen >}}
