...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ 開發人員只需幾行代碼即可輕鬆地將 POTX 文件轉換為 XPS。
...
{{% blocks/products/pf/agp/code-block title="POTX 到 XPS C++ 轉換源代碼" offSpacer="" %}}
