...
為了將 PPTM 轉換為 SWF，我們將使用 <a href="https://products.aspose.com/slides/cpp">Aspose.Slides for C++</a> API，這是一個功能豐富、功能強大的 API和易於使用的 C++ 平台的文檔操作和轉換 API。可以直接下載最新版本，打開<a href="https://www.nuget.org/packages/aspose.slides">NuGet</a>包管理器，搜索<b>Aspose.Slides.Cpp </b> 並安裝。您還可以從包管理器控制台使用以下命令。
