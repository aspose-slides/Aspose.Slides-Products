...
{{< blocks/products/pf/i18n/carousel-item h3="Bir Bakışta" description="Aspose.Slides for Java API özelliklerine genel bakış." >}}
...
{{< blocks/products/pf/i18n/carousel-item h3="Platform Bağımsızlığı" description="Aspose.Slides for Java API, herhangi bir Java tabanlı masaüstünde, kurumsal web uygulamasında veya herhangi bir Linux ve Unix ortamında kullanılabilir." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/i18n/carousel-item h3="Desteklenen Dosya Formatları" description="Aspose.Slides for Java API, aşağıdaki [sunum](https://docs.aspose.com/slides/java/supported-file-formats/) ve dönüştürme formatlarını destekler." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Gelişmiş Java PowerPoint Belgeleri İşleme API Özellikleri</h2>

<p>Aspose.Slides for Java, geliştiricilere bir Java ortamında Microsoft PowerPoint sunumları ile programlama yaparken tam kontrol sağlayan bir dizi gelişmiş özellik içerir.</p>-->
   <h2 class="pr-ft">
...
<h2 class="h2title">Slayt İçeriği Biçimlendirme</h2>

<p>Aspose.Slides for Java API kullanarak bir sunumdaki slaytlardaki metin ve şekilleri biçimlendirmek mümkündür. Metin, şekillerle ilişkili metin çerçeveleri aracılığıyla yönetilir. Bu nedenle metin, metin çerçeveleriyle ilişkili paragraflar ve bölümler kullanılarak biçimlendirilir. Konum, boyut, çizgi, görüntü, metin ve dolgu gibi şekil öğesinin niteliklerini de değiştirebilirsiniz.</p>
...
{{< blocks/products/pf/slr-element name="Sürüm notları" href="https://docs.aspose.com/slides/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
