---
title: Java ile açmadan ODP belgesini arayın
weight: 1250
url: /tr/java/search/odp/ 
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Runtime Environment'daki ODP dosyasında kalıplı kelimeleri aramak için Java örnek kodu.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java'da ODP Biçimlerini Ara" h2="Sunucu tarafı Aspose.Slides for Java API'lerini kullanarak, Microsoft veya Adobe PDF gibi herhangi bir yazılım kullanmadan yerel ve yüksek performanslı ODP belge arama." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak ODP Dosyası Nasıl Aranır" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Java'da ODP Dosyalarını Arama Adımları" >}}
...
{{% blocks/products/pf/agp/code-block title="ODP Dosyalarında Ara - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/java/search/pptx/" name="PPTX" description="Açık XML sunum Formatı" >}}
