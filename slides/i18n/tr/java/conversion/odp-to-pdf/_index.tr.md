---
title: Java ile ODP'yi PDF'ye dönüştürün
weight: 450
url: /tr/java/conversion/odp-to-pdf/ 
description: ODP formatının PDF dosyasına örnek Java dönüştürme kodu. PowerPoint ve OpenOffice sunumlarını herhangi bir Web veya Masaüstü Java tabanlı Uygulama içinde PDF'ye aktarmak için bu örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java ile ODP'yi PDF'ye dönüştürün" h2="ODP'den PDF'ye Java dönüştürme, Yerinde Java kitaplığını kullanarak tek veya birden çok sayfayı PDF'ye dönüştürmek için." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak ODP'yi PDF'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile ODP'yi PDF'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, ODP dosyasını yalnızca birkaç satır kodla kolayca PDF'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="ODP'den PDF'ye Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
