...
{{% blocks/products/pf/agp/content h2="Java Kullanarak POTX'i PPSM'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile POTX'i PPSM'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, POTX dosyasını yalnızca birkaç satır kodla kolayca PPSM'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="POTX - PPSM Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
