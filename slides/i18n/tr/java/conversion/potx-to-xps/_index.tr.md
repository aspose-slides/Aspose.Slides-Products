...
{{% blocks/products/pf/agp/content h2="Java Kullanarak POTX'i XPS'ye Dönüştürme" %}}

 POTX'i XPS'e dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile POTX'i XPS'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, POTX dosyasını yalnızca birkaç satır kodla kolayca XPS'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="POTX'ten XPS'ye Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
