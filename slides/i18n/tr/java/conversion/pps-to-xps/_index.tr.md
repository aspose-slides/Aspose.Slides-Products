---
title: Java ile PPS'yi XPS'ye dönüştürün
weight: 6560
url: /tr/java/conversion/pps-to-xps/ 
description: PPS formatı için XPS dosyasına örnek Java dönüştürme kodu. PowerPoint ve OpenOffice sunularını herhangi bir Web veya Masaüstü Java tabanlı Uygulama içinde XPS'ye aktarmak için bu örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java ile PPS'yi XPS'ye dönüştürün" h2="Yerinde Java kitaplığını kullanarak tek veya birden çok sayfayı XPS'ye dönüştürmek için PPS'den XPS'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPS" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak PPS'yi XPS'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile PPS'yi XPS'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç kod satırıyla PPS dosyasını kolayca XPS'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="PPS'den XPS'ye Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
