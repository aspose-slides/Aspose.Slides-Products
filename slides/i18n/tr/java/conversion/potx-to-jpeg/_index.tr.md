---
title: Java ile POTX'i JPEG'e dönüştürün
weight: 270
url: /tr/java/conversion/potx-to-jpeg/ 
description: POTX formatı için JPEG dosyasına örnek Java dönüştürme kodu. PowerPoint ve OpenOffice sunumlarını herhangi bir Web veya Masaüstü Java tabanlı Uygulama içinde JPEG'e aktarmak için bu örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java ile POTX'i JPEG'e dönüştürün" h2="POTX'ten JPEG'e Java dönüştürme, tek veya birden çok sayfayı Yerinde Java kitaplığı kullanarak JPEG'e dönüştürmek için." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak POTX'i JPEG'e Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile POTX'i JPEG'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, POTX dosyasını yalnızca birkaç satır kodla kolayca JPEG'e dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="POTX - JPEG Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
