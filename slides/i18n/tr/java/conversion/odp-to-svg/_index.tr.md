---
title: ODP'yi Java ile SVG'ye dönüştürün
weight: 8550
url: /tr/java/conversion/odp-to-svg/ 
description: ODP formatı için SVG dosyasına örnek Java dönüştürme kodu. PowerPoint ve OpenOffice sunumlarını herhangi bir Web veya Masaüstü Java tabanlı Uygulama içinde SVG'ye aktarmak için bu örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ODP'yi Java ile SVG'ye dönüştürün" h2="Yerinde Java kitaplığını kullanarak tek veya birden çok sayfayı SVG'ye dönüştürmek için ODP'den SVG'ye Java dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak ODP'yi SVG'ye Dönüştürme" %}}

 ODP'yi SVG'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile ODP'yi SVG'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, ODP dosyasını yalnızca birkaç satır kodla kolayca SVG'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="ODP'den SVG'ye Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
