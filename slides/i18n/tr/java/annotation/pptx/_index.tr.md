---
title: Java ile PPTX Açıklamasını Kaldır
weight: 360
url: /tr/java/annotation/pptx/ 
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Çalışma Zamanı Ortamı'ndaki PPTX biçimi ek açıklamalarını silmek için Java örnek kodu.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Yorumları ve Yorum Yazarlarını Java ile PPTX'ten Kaldırma" h2="Sunucu tarafı API'lerini kullanarak belge dosyalarındaki yorumları ve yazarları değiştirmek için kendi Java uygulamalarınızı oluşturun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak PPTX Dosyasına Açıklama Ekleme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile PPTX'ten Yorumları Kaldırma Adımları" %}}
...
1. PPTX formatında kaydedin
1. Belirli bir konumdaki yorumu kaldırın
1. PPTX dosyasını tekrar kaydedin ve karşılaştırın
...
{{% blocks/products/pf/agp/code-block title="PPTX'ten Açıklamaları Sil - Java" offSpacer="" %}}
