---
title: C++ uygulaması ile ODP'yi POTM'ye dönüştürün
weight: 5330
url: /tr/cpp/conversion/odp-to-potm/ 
description: ODP belgesinin POTM formatına dönüştürülmesi için örnek C++ kodu. Herhangi bir C++ Uygulamasında toplu ODP'den POTM'ye dönüştürme için örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ODP'yi C++ ile POTM'ye dönüştürün" h2="Microsoft PowerPoint kurulumuna ihtiyaç duymadan C++ kitaplığını kullanarak yüksek performanslı ODP'den POTM'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ geliştiricileri, ODP dosyasını yalnızca birkaç satır kodla kolayca POTM'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="ODP - POTM C++ Dönüştürme Kaynak Kodu" offSpacer="" %}}
