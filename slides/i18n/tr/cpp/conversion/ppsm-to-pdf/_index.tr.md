---
title: C++ uygulaması aracılığıyla PPSM'yi PDF'ye dönüştürün
weight: 6930
url: /tr/cpp/conversion/ppsm-to-pdf/ 
description: PPSM belgesinden PDF formatına örnek C++ dönüştürme kodu. Herhangi bir C++ Uygulamasında toplu PPSM'den PDF'ye dönüştürme için örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="PPSM'yi C++ ile PDF'ye dönüştürün" h2="Microsoft PowerPoint kurulumuna ihtiyaç duymadan C++ kitaplığını kullanarak yüksek performanslı PPSM'den PDF'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSM" >}}
...
{{% blocks/products/pf/agp/content h2="C++ Kullanarak PPSM'yi PDF'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="PPSM'yi C++ ile PDF'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 C++ geliştiricileri, PPSM dosyasını yalnızca birkaç satır kodla kolayca PDF'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="PPSM'den PDF'ye C++ Dönüştürme Kaynak Kodu" offSpacer="" %}}
