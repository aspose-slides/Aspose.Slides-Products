---
title: ODP'yi C++ uygulamasıyla PDF'ye dönüştürün
weight: 7330
url: /tr/cpp/conversion/odp-to-pdf/ 
description: ODP belgesinden PDF formatına örnek C++ dönüştürme kodu. Herhangi bir C++ Uygulamasında toplu ODP'den PDF'ye dönüştürme için örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ODP'yi C++ ile PDF'ye dönüştürün" h2="Microsoft PowerPoint kurulumuna ihtiyaç duymadan C++ kitaplığını kullanarak yüksek performanslı ODP'den PDF'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ geliştiricileri, ODP dosyasını yalnızca birkaç satır kodla kolayca PDF'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="ODP'den PDF'ye C++ Dönüştürme Kaynak Kodu" offSpacer="" %}}
