---
title: ODP'yi C++ uygulaması aracılığıyla PPSX'e dönüştürün
weight: 6290
url: /tr/cpp/conversion/odp-to-ppsx/ 
description: ODP belgesi için PPSX formatına örnek C++ dönüştürme kodu. Herhangi bir C++ Uygulamasında toplu ODP'den PPSX'e dönüştürme için örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ODP'yi C++ ile PPSX'e dönüştürün" h2="Microsoft PowerPoint kurulumuna ihtiyaç duymadan C++ kitaplığını kullanarak yüksek performanslı ODP'den PPSX'e dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ geliştiricileri, ODP dosyasını yalnızca birkaç satır kodla kolayca PPSX'e dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="ODP'den PPSX'e C++ Dönüştürme Kaynak Kodu" offSpacer="" %}}
