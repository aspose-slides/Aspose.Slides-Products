---
title: POTX'i C++ uygulamasıyla ODP'ye dönüştürün
weight: 6270
url: /tr/cpp/conversion/potx-to-odp/ 
description: POTX belgesi için ODP formatına örnek C++ dönüştürme kodu. Herhangi bir C++ Uygulamasında toplu POTX'ten ODP'ye dönüştürme için örnek kod kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="POTX'i C++ ile ODP'ye dönüştürün" h2="Microsoft PowerPoint kurulumuna ihtiyaç duymadan C++ kitaplığını kullanarak yüksek performanslı POTX'ten ODP'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ geliştiricileri, yalnızca birkaç satır kodla POTX dosyasını ODP'ye kolayca dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="POTX - ODP C++ Dönüştürme Kaynak Kodu" offSpacer="" %}}
