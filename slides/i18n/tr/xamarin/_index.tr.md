---
title: Xamarin için Aspose.Slides | Xamarin PowerPoint API'sı
weight: 800
url: /tr/xamarin/ 
description: Aspose.Slides for Xamarin, Xamarin PowerPoint uygulamaları oluşturmak için.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Aspose.Slides tarafından sunulan PowerPoint Xamarin API" h2="PowerPoint'i Xamarin'de işlemek için mobil uygulamalar oluşturun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-xamarin.svg" pfName="Aspose.Slides" subTitlepfName="for Xamarin" downloadUrl="https://downloads.aspose.com/slides/net" >}}
...
<p>
 Aspose.Slides for Xamarin, herhangi bir cihaz ve işletim sistemi için PowerPoint mobil uygulamaları oluşturmak için platformlar arası bir çözümdür. Mobil uygulamanızın slaytın metnini, ortamını ve şekillerini düzenlemesine izin verin, sunumu istediğiniz biçimde kaydedin. Sunumu mobilden inceleyin, yorum ve notlar ekleyin ve gönderin. Sunuma yeni tema uygulayın, sunumu birkaç dosyaya bölün.
</p>

<p>
 Aspose.Slides for Xamarin, Microsoft PowerPoint veya başka herhangi bir ek yazılım gerektirmeyen bağımsız bir Xamarin PowerPoint API'sidir.
</p>
...
{{< blocks/products/pf/i18n/carousel-item h3="Bir Bakışta" description="Aspose.Slides'ın Xamarin PowerPoint API'sine genel bakış." >}}
...
{{< blocks/products/pf/i18n/carousel-item h3="Platform Bağımsızlığı" description="Android, iOS ve Windows üzerinde Xamarin için Aspose.Slides." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <!--/left-->
  <!--/right-->
...
{{< blocks/products/pf/i18n/carousel-item h3="Desteklenen Dosya Formatları" description="Aspose.Slides for Xamarin, popüler [sunu formatlarını](https://docs.aspose.com/display/slidesnet/Supported+File+Formats) ve aşağıda listelenen dışa aktarma formatlarını destekler." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Xamarin PowerPoint API'nin Gelişmiş Özellikleri
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Sunumu Xamarin PowerPoint API ile Dönüştür
    </h2>
    <p>
     Aspose.Slides for Xamarin API, PowerPoint'in herhangi bir belge, metin, resim, web veya diğer biçimlere dönüştürülmesi için mobil uygulamalar oluşturmaya olanak tanır. Sunumları bir cep telefonundan bile yüksek kalitede dönüştürün. Sunumları PDF, HTML, XPS, JPG formatına dönüştürün. PowerPoint Xamarin API'nin kullanımı kolaydır, dönüştürme mantığı 1-2 satırlık bir kodda uygulanır. Sadece bir sunuyu yükleyin ve gerekli biçimde kaydedin.
    </p>
...
prs.Save(dir + "output.tiff", Aspose.Slides.Export.SaveFormat.Tiff);</code></pre>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Sunumu Xamarin PowerPoint API ile Değiştirin
    </h2>
    <p>
     Aspose'un Xamarin PowerPoint API'si ile meta verilerinin yanı sıra herhangi bir slayt ve sunum içeriğini değiştirmek mümkündür. Metin, tablo, şekil, çizelge, SmartArts, animasyonlara Xamarin mobil uygulaması üzerinden ulaşılabilir. Sunum içeriği üzerinde mevcut olan tüm işlemler Aspose.Slides Xamarin API üzerinden uygulanabilmektedir. Sunum yorumları, notlar, belge özelliklerinin yanı sıra düzenler, temalar, şablonlar da değiştirilebilir.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Xamarin PowerPoint API ile Sunumu Birleştir, Karşılaştır, Böl, Yazdır
    </h2>
    <p>
     Aspose.Slides Xamarin API ile Xamarin'de bir sunum işleme sistemi oluşturun. Her türden sunum ve slayt üzerinde bu tür işlemler mevcuttur: birleştirme, bölme, karşılaştırma, yazdırma, vb. İşlemler, birçok işleme senaryosu oluşturmak için kullanılabilir. Örneğin, bir şablon sunuya uygulamak, birkaç şablonu birleştirmek, farklı biçimlerdeki sunuları tek bir biçimde birleştirmek vb. için birleştirme işlevi kullanılabilir.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for Xamarin, PowerPoint formatlarıyla çalışabilmesi için makineye Microsoft Office veya Microsoft PowerPoint'in yüklenmesine ihtiyaç duymaz. Desteklenen özellikler, güvenlik, kararlılık, ölçeklenebilirlik, hız ve fiyat açısından mükemmel bir Microsoft Office otomasyon alternatifidir.
    </p>
   </div>
   <!--<div class="col-lg-12">

<h2 class="h2title">Office Açık XML Desteği</h2>

<p>Office OpenXML (OOXML), Microsoft Office 2007'de tanıtılan XML tabanlı biçimdir.</p>

<p>PresentationML (OOXML, PPTX), Microsoft Office PowerPoint 2007 tarafından belgelerini depolamak için kullanılan biçimlendirme dilidir. Aspose.Slides for .NET, PresentationML belgeleri oluşturmayı, okumayı, değiştirmeyi ve yazmayı kapsamlı bir şekilde destekler.</p>
...
{{< blocks/products/pf/slr-tab tabTitle="Neden Aspose.Slides for Xamarin?" tabId="success-stories" >}}
