---
title: .NET aracılığıyla PPSM dosyalarını düzenleyin
url: /tr/net/editor/ppsm/ 
description: .NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında PPSM belgesini düzenlemek için C# kaynak kodu.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="PPSM Formatlarını C# ile Düzenle" h2="Microsoft veya Adobe PDF gibi herhangi bir yazılım kullanmadan sunucu taraflı Aspose.Slides for .NET API'lerini kullanarak yerel ve yüksek performanslı PPSM belge düzenleme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="PPSM Dosyalarını C# ile Düzenleme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="PPSM Dosyalarını Düzenle - C#" offSpacer="" %}}
