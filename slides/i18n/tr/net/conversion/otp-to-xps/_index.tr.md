---
title: OTP'yi C# ile XPS'ye dönüştürün
weight: 2690
url: /tr/net/conversion/otp-to-xps/ 
description: OTP'den XPS'ye C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu OTP dosyalarının XPS'ye dönüştürülmesi için API örnek kodunu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="OTP'yi C# ile XPS'ye dönüştürün" h2="PowerPoint® OTP dosyalarını .NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında XPS'e aktarın" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTP" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET geliştiricileri, yalnızca birkaç kod satırıyla OTP dosyalarını kolayca yükleyebilir ve XPS'ye dönüştürebilir." >}}
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, OTP'den XPS'ye C# Dönüşümünü gösterir" offSpacer="" %}}
