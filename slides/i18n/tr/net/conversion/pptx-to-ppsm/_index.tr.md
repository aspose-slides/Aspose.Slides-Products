---
title: PPTX'i C# ile PPSM'ye dönüştürün
weight: 8820
url: /tr/net/conversion/pptx-to-ppsm/ 
description: PPTX'ten PPSM'ye C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu PPTX dosyalarının PPSM'ye dönüştürülmesi için API örnek kodunu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="PPTX'i C# ile PPSM'ye dönüştürün" h2="PowerPoint® PPTX dosyalarını .NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında PPSM'ye aktarın" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET geliştiricileri, yalnızca birkaç kod satırıyla PPTX dosyalarını kolayca yükleyebilir ve PPSM'ye dönüştürebilir." >}}
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, PPTX'ten PPSM'ye C# Dönüşümünü gösterir" offSpacer="" %}}
