---
title: PPTX'i C# ile PPSX'e dönüştürün
weight: 2180
url: /tr/net/conversion/pptx-to-ppsx/ 
description: PPTX'ten PPSX'e C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu PPTX dosyalarının PPSX'e dönüştürülmesi için API örnek kodunu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="PPTX'i C# ile PPSX'e dönüştürün" h2="PowerPoint® PPTX dosyalarını .NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında PPSX'e aktarın" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET geliştiricileri, PPTX dosyalarını yalnızca birkaç kod satırıyla kolayca yükleyebilir ve PPSX'e dönüştürebilir." >}}
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, PPTX'ten PPSX'e C# Dönüşümünü gösterir" offSpacer="" %}}
