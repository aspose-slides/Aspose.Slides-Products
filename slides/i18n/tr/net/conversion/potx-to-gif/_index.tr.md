---
title: POTX'i C# ile GIF'e dönüştürün
weight: 1620
url: /tr/net/conversion/potx-to-gif/ 
description: POTX'ten GIF'e C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu POTX dosyalarının GIF'e dönüştürülmesi için API örnek kodunu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="POTX'i C# ile GIF'e dönüştürün" h2="PowerPoint® POTX dosyalarını .NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında GIF'e aktarın" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET geliştiricileri, POTX dosyalarını yalnızca birkaç satır kodla kolayca yükleyebilir ve GIF'e dönüştürebilir." >}}
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, POTX'ten GIF'e C# Dönüşümünü gösterir" offSpacer="" %}}
