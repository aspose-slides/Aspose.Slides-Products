---
title: PPTM'yi C# ile PPTX'e dönüştürün
weight: 1090
url: /tr/net/conversion/pptm-to-pptx/ 
description: PPTM'den PPTX'e C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu PPTM dosyalarını PPTX'e dönüştürmek için API örnek kodunu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="PPTM'yi C# ile PPTX'e dönüştürün" h2="PowerPoint® PPTM dosyalarını .NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında PPTX'e aktarın" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTM" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET geliştiricileri, yalnızca birkaç satır kodla PPTM dosyalarını kolayca yükleyebilir ve PPTX'e dönüştürebilir." >}}
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, PPTM'den PPTX'e C# Dönüşümünü gösterir" offSpacer="" %}}
