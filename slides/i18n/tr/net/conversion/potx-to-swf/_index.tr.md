---
title: POTX'i C# ile SWF'ye dönüştürün
weight: 7640
url: /tr/net/conversion/potx-to-swf/ 
description: POTX'ten SWF'ye C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu POTX dosyalarının SWF'ye dönüştürülmesi için API örnek kodunu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="POTX'i C# ile SWF'ye dönüştürün" h2="PowerPoint® POTX dosyalarını .NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında SWF'ye aktarın" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak POTX'i SWF'ye Dönüştürme" %}}
 ...
 POTX'i SWF'ye dönüştürmek için kullanacağız
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET geliştiricileri, yalnızca birkaç satır kodla POTX dosyalarını kolayca yükleyebilir ve SWF'ye dönüştürebilir." >}}
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, POTX'ten SWF'ye C# Dönüşümünü gösterir" offSpacer="" %}}
