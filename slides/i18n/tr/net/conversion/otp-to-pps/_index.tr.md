---
title: OTP'yi C# ile PPS'ye dönüştürün
weight: 7390
url: /tr/net/conversion/otp-to-pps/ 
description: OTP'den PPS'ye C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu OTP dosyalarının PPS'ye dönüştürülmesi için API örnek kodunu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="OTP'yi C# ile PPS'ye dönüştürün" h2="PowerPoint® OTP dosyalarını .NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında PPS'ye aktarın" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTP" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET geliştiricileri, OTP dosyalarını yalnızca birkaç satır kodla kolayca yükleyebilir ve PPS'ye dönüştürebilir." >}}
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, OTP'den PPS'ye C# Dönüşümünü gösterir" offSpacer="" %}}
