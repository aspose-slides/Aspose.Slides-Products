---
title: PPTM'yi C# ile HTML'ye dönüştürün
weight: 6000
url: /tr/net/conversion/pptm-to-html/ 
description: PPTM'den HTML'ye C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu PPTM dosyalarını HTML'ye dönüştürmek için API örnek kodunu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="PPTM'yi C# ile HTML'ye dönüştürün" h2="PowerPoint® PPTM dosyalarını .NET Framework, .NET Core, Windows Azure, Mono veya Xamarin Platformlarında HTML'ye aktarın" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTM" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET geliştiricileri, PPTM dosyalarını yalnızca birkaç satır kodla kolayca yükleyebilir ve HTML'ye dönüştürebilir." >}}
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, PPTM'den HTML'ye C# Dönüşümünü gösterir" offSpacer="" %}}
