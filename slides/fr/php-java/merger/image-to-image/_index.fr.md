---
title: Fusionner des images en PHP
url: /fr/php-java/merger/image-to-image/
keywords: Fusionner une image, image à image, Joindre des images, Combiner des images, API PHP, Bibliothèque PHP
description: Fusionner image à image en PHP. Utiliser l'API de la bibliothèque PHP pour combiner des images
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Fusionner l'image en PHP" h2="Bibliothèque PHP haute vitesse et multiplateforme pour fusionner des images à l'aide de code PHP" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Fusionner image à image en PHP" %}}
En utilisant [**Aspose.Slides pour PHP via Java**](https://products.aspose.com/slides/fr/php-java/), vous pouvez fusionner rapidement des fichiers image avec seulement quelques lignes de code

{{% blocks/products/pf/agp/code-block title="Code PHP pour fusionner image à image" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Comment fusionner des images en PHP" >}}
