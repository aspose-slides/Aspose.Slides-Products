...
title: API PowerPoint PHP. Présentation PHP, PPT de Aspose.Slides
weight: 5890
url: /fr/php-java/ 
description: Bibliothèque PHP pour travailler avec des fichiers Microsoft PowerPoint. Présentation PHP, PPT, PPTX. Créer modifier convertir PPT PPTX PPS POT PPSX PPTM PPSM POTX POTM ODP PDF et bien d'autres formats.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API PHP PowerPoint pour les présentations. Présentation PHP, PPT, PPTX, ODP" h2="Créez, lisez, écrivez, modifiez, fusionnez, clonez, protégez et convertissez des présentations PowerPoint et OpenOffice en PHP sans aucun logiciel externe." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-php-via-java.svg" pfName="Aspose.Slides" subTitlepfName="for PHP via Java" downloadUrl="https://downloads.aspose.com/slides/php-java" >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <p>
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Créer une nouvelle présentation PowerPoint. Présentation PHP : PPT, PPTX, ODP</h2>
        <p>Dans l'exemple ci-dessous, nous avons ajouté une ligne à la première diapositive de la présentation.</p>
        <pre>
            <code class="php">	
...
finally
{
   ...
   <div class="col-lg-12">
    ...
    <ul>
	  <li>Compatible avec PHP 7 ou version ultérieure</li>
    </ul>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>Utilisez <strong>packagist</strong> pour installer notre bibliothèque PHP pour le traitement des présentations à partir du <a href="https://packagist.org/packages/aspose/slides">dépôt de packages PHP :</a></p>
	<pre><code>composer require aspose/slides</code></pre>
   </div>
    <div class="col-lg-12">
        <h2 class="h2title">Fusionner les présentations. Présentation PHP : PPT, PPTX, ODP</h2>
        <p>Ce code PHP vous montre comment fusionner des présentations :</p>
        <pre>
            <code class="php">
require_once("http://localhost:8080/JavaBridge/java/Java.inc");
require_once("lib/aspose.slides.php");
...
finally
{
    ...
    <div class="col-lg-12">
        <h2 class="h2title"> Importer une présentation à partir d'un PDF. Présentation PHP : PDF vers PPT, PDF vers PPTX, PDF vers ODP</h2>
        <p>Ce code PHP illustre le processus de conversion PDF vers PowerPoint :</p>
        <pre>
            <code class="php">
require_once("http://localhost:8080/JavaBridge/java/Java.inc");
require_once("lib/aspose.slides.php");
...
finally
{
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Convertissez PowerPoint en PDF avec les options par défaut : Présentation PHP, PPT, PPTX ou ODP en PDF</h2>
        <p>Ce code PHP vous montre comment convertir un document PowerPoint PPT, PPTX et OpenOffice ODP en un document PDF en utilisant les options par défaut. Le fichier résultant est un document PDF aux niveaux de qualité maximum</p>
        <pre>
            <code class="php">
require_once("http://localhost:8080/JavaBridge/java/Java.inc");
require_once("lib/aspose.slides.php");
...
finally
{
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Convertissez PowerPoint en JPG. Présentation PHP. PPT en JPG, PPTX en JPG, ODP en JPG</h2>
...
<p><strong>Aspose.Slides pour PHP via Java</strong> est une puissante bibliothèque de classes pour travailler avec ou traiter des présentations. Grâce à ce produit, les applications et les développeurs peuvent lire, éditer ou manipuler et convertir des présentations PowerPoint (PPT, PPTX) et des présentations dans d'autres formats (ODP) sans applications ou dépendances tierces. </p>

<p><strong>Aspose.Slides pour PHP via Java</strong> fournit ces fonctionnalités populaires :</p>
<ul>
    <li>Charger, ouvrir et afficher des présentations.</li>
    <li>Édition de présentations.</li>
    <li>Conversion de présentations en PDF, Word, JPG, HTML, GIF, SVG et de nombreux autres formats.</li>
    <li>Présentations de rendu et d'impression.</li>
    <li>Cryptage et décryptage des présentations ; protéger les présentations par mot de passe et supprimer les mots de passe.</li>
    <li>Manipuler des entités de présentation, telles que des diapositives principales, des formes, des graphiques, des cadres photo, des cadres audio, des cadres vidéo, des macros OLE, VBA, des animations, etc.</li>
    <li>Et bien d'autres fonctionnalités.</li>
</ul>

<p>PHP est un langage de script à usage général populaire, en particulier à des fins de développement Web. Pour cette raison, l'équipe <strong>Aspose.Slides</strong> est fière d'offrir <strong>Aspose.Slides pour PHP via Java</strong> à la communauté PHP. </p>
...
{{< blocks/products/pf/carousel-item h3="Indépendance de la plate-forme" description="L'API de présentation PHP prend en charge toutes les principales plates-formes, y compris les suivantes." >}}
<div class="diagram1 d1-php-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="Formats de fichiers pris en charge" description="Aspose.Slides pour PHP via Java prend en charge les [formats de présentation] populaires (https://docs.aspose.com/slides/php-java/supported-file-formats/) et ces formats d'exportation." >}}
...
<p class="first">
Nous avons trouvé Aspose.Slides facile à utiliser et fonctionnant bien sur nos serveurs. Nous avons constaté qu'ils répondent à un besoin important de génération dynamique de fichiers pour étendre notre portée au-delà de l'application Web traditionnelle.
 <em>
...
{{< blocks/products/pf/slr-element name="Références API" href="https://docs.aspose.com/slides/php-java/api-reference/" >}}
...
{{< blocks/products/pf/slr-element name="Notes de version" href="https://releases.aspose.com/slides/php-java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.Slides pour PHP via Java ?" tabId="success-stories" >}}
