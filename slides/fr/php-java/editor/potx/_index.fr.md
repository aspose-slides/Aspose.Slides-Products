---
title: Modifier POTX en PHP
url: /fr/php-java/editor/potx/
keywords: Modifier POTX, Modifier PowerPoint, POTX, PowerPoint, API PHP, Bibliothèque PHP
description: Modifiez POTX en PHP. Utilisez l'API de la bibliothèque PHP pour modifier les fichiers POTX
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Modifier POTX en PHP" h2="Bibliothèque PHP haute vitesse et multiplateforme pour l'édition de POTX à l'aide de code PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Modifier POTX à l'aide d'Aspose.Slides" %}}

[**Aspose.Slides pour PHP via Java**](https://products.aspose.com/slides/fr/php-java/) est une puissante bibliothèque PHP utilisée pour manipuler et modifier des présentations. Vous pouvez modifier une présentation POTX en y ajoutant une nouvelle ligne de texte. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Modifier POTX en PHP" %}}
En utilisant [**Aspose.Slides pour PHP via Java**](https://products.aspose.com/slides/fr/php-java/), vous pouvez ajouter une nouvelle ligne de texte au document POTX avec juste un quelques lignes de code.

{{% blocks/products/pf/agp/code-block title="Code PHP pour l'édition de POTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment modifier POTX en PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Chargez la présentation POTX que vous souhaitez modifier.
{{< /blocks/products/pf/agp/step-autogen >}}
