---
title: Convertir POTM en HTML en PHP
weight: 1090
url: /fr/php-java/conversion/potm-to-html/ 
keywords: "Convert, PowerPoint, POTM, HTML, Presentation, PHP"
description: Exemple de code pour la conversion PHP de POTM à HTML. Utilisez l'API PHP PowerPoint pour la conversion par lots de fichiers POTM en fichiers HTML.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir POTM en HTML en PHP" h2="Bibliothèque PHP PowerPoint puissante pour convertir POTM en HTML" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir POTM en HTML en PHP" %}}

Besoin de convertir des fichiers POTM en HTML par programmation ? En utilisant [*Aspose.Slides pour PHP via Java*](https://products.aspose.com/slides/fr/php-java/), n'importe quel développeur peut convertir le format POTM au format HTML avec seulement quelques lignes de code PHP .

En tant qu'API de traitement de présentation moderne, Aspose.Slides pour PHP crée rapidement HTML à partir de POTM. Testez la qualité de la conversion de POTM à HTML directement dans votre [navigateur](https://products.aspose.app/slides/conversion). La bibliothèque Aspose PowerPoint PPTX vous permet de convertir des fichiers POTM vers de nombreux formats populaires.
...
{{< blocks/products/pf/agp/feature-section-col title="Comment convertir POTM en HTML en PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Voici les étapes pour convertir un fichier POTM en HTML en utilisant PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion PHP de POTM à HTML" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer POTM sous HTML en PHP" %}}
Utilisez l'application gratuite pour voir une démonstration du processus de conversion de POTM à HTML. 
{{% /blocks/products/pf/agp/content %}}
