---
title: Convertir FODP en ODP en PHP
weight: 50
url: /fr/php-java/conversion/fodp-to-odp/ 
keywords: "Convert, PowerPoint, FODP, ODP, Presentation, PHP"
description: Exemple de code pour la conversion PHP de FODP à ODP. Utilisez l'API PHP PowerPoint pour la conversion par lots de fichiers FODP en fichiers ODP.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir FODP en ODP en PHP" h2="Bibliothèque PHP PowerPoint puissante pour convertir FODP en ODP" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir FODP en ODP en PHP" %}}

Besoin de convertir des fichiers FODP en ODP par programmation ? En utilisant [*Aspose.Slides pour PHP via Java*](https://products.aspose.com/slides/fr/php-java/), n'importe quel développeur peut convertir le format FODP au format ODP avec seulement quelques lignes de code PHP .

En tant qu'API de traitement de présentation moderne, Aspose.Slides pour PHP crée rapidement ODP à partir de FODP. Testez la qualité de la conversion de FODP à ODP directement dans votre [navigateur](https://products.aspose.app/slides/conversion). La bibliothèque Aspose PowerPoint PPTX vous permet de convertir des fichiers FODP vers de nombreux formats populaires.
...
{{< blocks/products/pf/agp/feature-section-col title="Comment convertir FODP en ODP en PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Voici les étapes pour convertir un fichier FODP en ODP en utilisant PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion PHP de FODP à ODP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer FODP sous ODP en PHP" %}}
Utilisez l'application gratuite pour voir une démonstration du processus de conversion de FODP à ODP. 
{{% /blocks/products/pf/agp/content %}}
