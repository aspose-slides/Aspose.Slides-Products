---
title: Convertir PPSM en SVG en PHP
weight: 1860
url: /fr/php-java/conversion/ppsm-to-svg/ 
keywords: "Convert, PowerPoint, PPSM, SVG, Presentation, PHP"
description: Exemple de code pour la conversion PHP de PPSM à SVG. Utilisez l'API PHP PowerPoint pour la conversion par lots de fichiers PPSM en fichiers SVG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PPSM en SVG en PHP" h2="Bibliothèque PHP PowerPoint puissante pour convertir PPSM en SVG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir PPSM en SVG en PHP" %}}

Besoin de convertir des fichiers PPSM en SVG par programmation ? En utilisant [*Aspose.Slides pour PHP via Java*](https://products.aspose.com/slides/fr/php-java/), n'importe quel développeur peut convertir le format PPSM au format SVG avec seulement quelques lignes de code PHP .

En tant qu'API de traitement de présentation moderne, Aspose.Slides pour PHP crée rapidement SVG à partir de PPSM. Testez la qualité de la conversion de PPSM à SVG directement dans votre [navigateur](https://products.aspose.app/slides/conversion). La bibliothèque Aspose PowerPoint PPTX vous permet de convertir des fichiers PPSM vers de nombreux formats populaires.
...
{{< blocks/products/pf/agp/feature-section-col title="Comment convertir PPSM en SVG en PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Voici les étapes pour convertir un fichier PPSM en SVG en utilisant PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion PHP de PPSM à SVG" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer PPSM sous SVG en PHP" %}}
Utilisez l'application gratuite pour voir une démonstration du processus de conversion de PPSM à SVG. 
{{% /blocks/products/pf/agp/content %}}
