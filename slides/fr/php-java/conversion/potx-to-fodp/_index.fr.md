...
title: Convertir POTX en FODP en PHP
weight: 1280
url: /fr/php-java/conversion/potx-to-fodp/ 
keywords: "Convert, PowerPoint, POTX, FODP, Presentation, PHP"
description: Exemple de code pour la conversion PHP de POTX à FODP. Utilisez l'API PHP PowerPoint pour la conversion par lots de fichiers POTX en fichiers FODP.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir POTX en FODP en PHP" h2="Bibliothèque PHP PowerPoint puissante pour convertir POTX en FODP" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir POTX en FODP en PHP" %}}

Besoin de convertir des fichiers POTX en FODP par programmation ? En utilisant [*Aspose.Slides pour PHP via Java*](https://products.aspose.com/slides/fr/php-java/), n'importe quel développeur peut convertir le format POTX au format FODP avec seulement quelques lignes de code PHP .

En tant qu'API de traitement de présentation moderne, Aspose.Slides pour PHP crée rapidement FODP à partir de POTX. Testez la qualité de la conversion de POTX à FODP directement dans votre [navigateur](https://products.aspose.app/slides/conversion). La bibliothèque Aspose PowerPoint PPTX vous permet de convertir des fichiers POTX vers de nombreux formats populaires.
...
{{< blocks/products/pf/agp/feature-section-col title="Comment convertir POTX en FODP en PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Voici les étapes pour convertir un fichier POTX en FODP en utilisant PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion PHP de POTX à FODP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer POTX sous FODP en PHP" %}}
Utilisez l'application gratuite pour voir une démonstration du processus de conversion de POTX à FODP. 
{{% /blocks/products/pf/agp/content %}}
