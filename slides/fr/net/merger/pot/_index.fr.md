...
title: Fusionner des fichiers POT via .NET
weight: 7360
url: /fr/net/merger/pot/ 
description: Code source C# pour combiner des documents POT sur les plateformes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Fusionner les formats POT en C#" h2="Fusion de documents POT native et haute performance à l'aide d'Aspose.Slides côté serveur pour les API .NET, sans l'utilisation de logiciels tels que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="POT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment fusionner un fichier POT à l'aide de C#" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour fusionner des fichiers POT en C#" >}}
...
Chargez tous les fichiers POT avec le chemin complet.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Appelez la méthode Save() et passez le nom du fichier (chemin complet) et le format (POT) en paramètre.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Vous pouvez maintenant ouvrir et utiliser le fichier POT dans Microsoft Office, Adobe PDF ou tout autre programme compatible.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Fusionner les fichiers POT - C#" offSpacer="" %}}
