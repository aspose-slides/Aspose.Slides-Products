---
title: Fusionner SVG en PNG en C#
url: /fr/net/merger/svg-to-png/
keywords: Fusionner SVG vers PNG, SVG vers PNG, Joindre SVG vers PNG, Combiner SVG vers PNG, API C#, Bibliothèque .NET
description: Fusionnez SVG en PNG en C#. Utilisez l'API de la bibliothèque .NET pour combiner des fichiers SVG et PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Fusionner SVG en PNG en C#" h2="API .NET multiplateforme puissante pour fusionner des images SVG vers PNG à l'aide de code C# sur les plates-formes NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Fusionner SVG en PNG en utilisant Aspose.Slides" %}}

[**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/) est une puissante bibliothèque .NET utilisée pour fusionner et manipuler des présentations, des images et d'autres fichiers. Lorsque vous fusionnez SVG en PNG, vous combinez effectivement des images SVG pour obtenir une image PNG.
...
{{% blocks/products/pf/feature-page-section  h2="Fusionner SVG en PNG en C#" %}}
En utilisant [**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/), vous pouvez fusionner rapidement des fichiers SVG en PNG avec seulement quelques lignes de code

{{% blocks/products/pf/agp/code-block title="Code C# pour fusionner SVG en PNG" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Comment fusionner SVG en PNG en C#" >}}
