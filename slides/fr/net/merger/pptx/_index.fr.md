---
title: Fusionner des fichiers PPTX via .NET
weight: 3150
url: /fr/net/merger/pptx/ 
description: Code source C# pour combiner des documents PPTX sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Fusionner les formats PPTX en C#" h2="Fusion de documents PPTX native et haute performance à l'aide d'Aspose.Slides côté serveur pour les API .NET, sans l'utilisation de logiciels tels que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment fusionner un fichier PPTX à l'aide de C#" %}}

 Afin de fusionner le fichier PPTX, nous utiliserons
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour fusionner des fichiers PPTX en C#" >}}
...
Chargez tous les fichiers PPTX avec le chemin complet.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Appelez la méthode Save() et passez le nom du fichier (chemin complet) et le format (PPTX) en paramètre.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Vous pouvez maintenant ouvrir et utiliser le fichier PPTX dans Microsoft Office, Adobe PDF ou tout autre programme compatible.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Fusionner des fichiers PPTX - C#" offSpacer="" %}}
