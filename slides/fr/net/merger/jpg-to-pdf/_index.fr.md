...
url: /fr/net/merger/jpg-to-pdf/
keywords: JPG en PDF, fusionner JPG en PDF, joindre JPG en PDF, PDF, JPG, API C#, bibliothèque .NET
description: Fusionnez JPG en PDF en C#. Utilisez l'API de la bibliothèque .NET pour combiner JPG et PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Fusionner JPG en PDF en C#" h2="Puissante API .NET multiplateforme pour fusionner des fichiers JPG en PDF à l'aide de code C# sur les plates-formes NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Fusionner JPG en PDF à l'aide d'Aspose.Slides" %}}

[**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/) est une puissante bibliothèque .NET utilisée pour créer, convertir, fusionner et manipuler des présentations, des PDF, des images, et d'autres fichiers. Lorsque vous fusionnez JPG en PDF, vous combinez efficacement des images JPG pour obtenir un seul fichier PDF.
...
En utilisant [**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/), vous pouvez rapidement fusionner JPG en PDF avec seulement quelques lignes de code
