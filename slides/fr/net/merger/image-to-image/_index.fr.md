...
url: /fr/net/merger/image-to-image/
keywords: Fusionner une image, image à image, Joindre des images, Combiner des images, API C#, Bibliothèque .NET
description: Fusionner image à image en C#. Utiliser l'API de la bibliothèque .NET pour combiner des images
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Fusionner l'image en C#" h2="API .NET multiplateforme puissante pour fusionner des images à l'aide de code C# sur les plates-formes NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Fusionner image à image en utilisant Aspose.Slides" %}}

[**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/) est une puissante bibliothèque .NET utilisée pour fusionner et manipuler des présentations, des images et d'autres fichiers. Lorsque vous fusionnez une image à l'autre, vous combinez effectivement deux images pour obtenir une seule image.
