---
title: Déverrouiller le document PPT via .NET
weight: 8650
url: /fr/net/unlock/ppt/ 
description: Code source C # pour déverrouiller le fichier PPT protégé par mot de passe sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Déverrouiller la présentation PPT via C#" h2="Supprimez la protection de PPT à l'aide de la bibliothèque .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{< blocks/products/pf/agp/feature-section-col title="Déverrouiller PPT via C #" >}}
