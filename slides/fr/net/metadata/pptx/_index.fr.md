---
title: Afficher ou modifier les métadonnées des fichiers PPTX à l'aide de .NET
...
{{% blocks/products/pf/agp/code-block title="Modifier les propriétés intégrées de PPTX - C#" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Ajouter des propriétés personnalisées à PPTX - C#" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment extraire les métadonnées de PPTX via C#" >}}
