---
title: Afficher ou modifier les métadonnées des fichiers POT à l'aide de .NET
url: /fr/net/metadata/pot/
...
{{% blocks/products/pf/agp/code-block title="Modifier les propriétés intégrées de POT - C#" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Ajouter des propriétés personnalisées à POT - C#" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment extraire les métadonnées de POT via C#" >}}
