---
title: Protégez et verrouillez le document PPTX via .NET
weight: 5000
url: /fr/net/protect/pptx/ 
description: Code source C# pour verrouiller le fichier PPTX à l'aide d'un mot de passe sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Crypter les fichiers PPTX via C#" h2="Protégez par mot de passe les présentations PowerPoint, y compris le format PPTX, à l'aide de la bibliothèque .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment protéger un fichier PPTX à l'aide de C#" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Protéger PPTX via C#" >}}
...
Charger PPTX avec une instance de Présentation
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/fr/net/protect/odp/" name="ODP" description="Format de présentation OpenDocument" >}}
