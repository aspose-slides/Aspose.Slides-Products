...
{{< blocks/products/pf/i18n/upper-banner h1="Visionneuse de fichiers POTX pour .NET" h2="Afficher des fichiers de présentation tels que POTX sans Microsoft PowerPoint ou Office Automation" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment afficher le fichier POTX à l'aide de C#" %}}
...
Instanciez un objet Presentation et chargez le fichier POTX
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Enregistrez la présentation POTX au format HTML
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Appelez Process.Start avec le chemin vers le HTML résultant pour charger le contenu POTX dans le navigateur par défaut
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Exemple de code C# pour afficher le fichier POTX" offSpacer="" %}}
