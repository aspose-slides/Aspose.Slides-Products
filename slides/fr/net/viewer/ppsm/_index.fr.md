...
title: Afficher les formats de fichiers PPSM via .NET
weight: 4780
url: /fr/net/viewer/ppsm/ 
description: Code source C# pour charger, restituer et afficher des documents PPSM sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Visionneuse de fichiers PPSM pour .NET" h2="Afficher des fichiers de présentation tels que PPSM sans Microsoft PowerPoint ou Office Automation" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSM" >}}
...
{{% blocks/products/pf/agp/content h2="Comment afficher le fichier PPSM à l'aide de C#" %}}

 Pour afficher le fichier PPSM, nous utiliserons
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour afficher PPSM via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Aspose.Slides permet aux développeurs de visualiser facilement le fichier PPSM avec seulement quelques lignes de code." >}}

{{< blocks/products/pf/agp/step-autogen >}}
Instanciez un objet Presentation et chargez le fichier PPSM
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Enregistrer la présentation PPSM au format HTML
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Appelez Process.Start avec le chemin vers le HTML résultant pour charger le contenu PPSM dans le navigateur par défaut
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Exemple de code C# pour afficher le fichier PPSM" offSpacer="" %}}
