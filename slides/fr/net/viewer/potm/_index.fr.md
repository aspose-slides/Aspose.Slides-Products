...
title: Afficher les formats de fichiers POTM via .NET
weight: 3310
url: /fr/net/viewer/potm/ 
description: Code source C# pour charger, restituer et afficher des documents POTM sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Visionneuse de fichiers POTM pour .NET" h2="Afficher des fichiers de présentation tels que POTM sans Microsoft PowerPoint ou Office Automation" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="Comment afficher le fichier POTM à l'aide de C#" %}}

 Pour afficher le fichier POTM, nous utiliserons
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour afficher POTM via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Aspose.Slides permet aux développeurs de visualiser facilement le fichier POTM avec seulement quelques lignes de code." >}}

{{< blocks/products/pf/agp/step-autogen >}}
Instanciez un objet Presentation et chargez le fichier POTM
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Enregistrer la présentation POTM au format HTML
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Appelez Process.Start avec le chemin vers le HTML résultant pour charger le contenu POTM dans le navigateur par défaut
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Exemple de code C# pour afficher le fichier POTM" offSpacer="" %}}
