...
title: Convertir PPS en BMP via C#
weight: 1980
url: /fr/net/conversion/pps-to-bmp/ 
description: Exemple de code pour la conversion PPS en BMP C#. Utilisez le code d'exemple d'API pour les fichiers PPS par lots en conversion BMP dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PPS en BMP via C#" h2="Exportez des fichiers PowerPoint® PPS vers BMP sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPS" >}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion PPS en BMP C#" offSpacer="" %}}
