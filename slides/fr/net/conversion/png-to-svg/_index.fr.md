...
keywords: PNG en SVG, Convertir PNG en SVG, API C#, Bibliothèque .NET
description: Convertir PNG en SVG en C#. Utilisez l'API de la bibliothèque .NET pour convertir les fichiers PNG en fichiers SVG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PNG en SVG en C#" h2="API PowerPoint .NET pour convertir des fichiers image PNG en SVG sur les plates-formes NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir PNG en SVG en C#" %}}

Comment convertir PNG en SVG dans le code ?

En utilisant [**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/), n'importe quel développeur ou application peut convertir PNG en SVG avec seulement quelques lignes de code C#.

En tant qu'API de traitement de documents moderne, Aspose.Slides pour .NET exporte rapidement les fichiers PNG vers SVG. La bibliothèque Aspose PowerPoint vous permet de convertir PNG en SVG et des images dans d'autres formats.
...
{{< blocks/products/pf/agp/feature-section-col title="Comment convertir PNG en SVG en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Les développeurs et les applications peuvent convertir PNG en SVG de cette façon :" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Enregistrez le fichier en tant qu'image SVG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Avant d'exécuter le code C# de conversion PNG vers SVG, votre ordinateur doit disposer des prérequis suivants :
...
{{% blocks/products/pf/agp/code-block title="Code C# pour convertir PNG en SVG" offSpacer="" %}}
