...
title: Convertir PPS en PPSM via C#
weight: 6760
url: /fr/net/conversion/pps-to-ppsm/ 
description: Exemple de code pour la conversion PPS en PPSM C#. Utilisez le code d'exemple d'API pour la conversion de fichiers PPS par lots en PPSM dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PPS en PPSM via C#" h2="Exportez des fichiers PowerPoint® PPS vers PPSM sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir PPS en PPSM à l'aide de C#" %}}

 Afin de convertir PPS en PPSM, nous utiliserons
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour convertir PPS en PPSM via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Les développeurs .NET peuvent facilement charger et convertir des fichiers PPS en PPSM en quelques lignes de code seulement." >}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion PPS en PPSM C#" offSpacer="" %}}
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        appName="conversion"
        extension=""
        sectionTitle="Application gratuite pour convertir PPS en PPSM" 
