...
title: Convertir HTML en TIFF en C#
weight: 180
url: /fr/net/conversion/html-to-tiff/ 
keywords: HTML en TIFF, Convertir HTML en TIFF, API C#, Bibliothèque .NET, HTML, TIFF
description: Convertissez HTML en TIFF en C#. Utilisez l'API de la bibliothèque .NET pour convertir des fichiers HTML en images TIFF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir HTML en TIFF en C#" h2="API PowerPoint .NET pour convertir des fichiers HTML en images TIFF sur les plates-formes NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir HTML en TIFF en C#" %}}

Comment convertir HTML en TIFF dans le code ?

En utilisant [**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/), n'importe quel développeur ou application peut convertir du HTML au format TIFF avec seulement quelques lignes de code C#.

En tant qu'API de traitement de documents moderne, Aspose.Slides pour .NET exporte rapidement les fichiers HTML au format TIFF. La bibliothèque Aspose PowerPoint vous permet de convertir HTML en TIFF et de nombreux autres formats de fichiers
...
{{< blocks/products/pf/agp/feature-section-col title="Comment convertir HTML en TIFF en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Les développeurs et les applications peuvent convertir HTML en TIFF de cette manière :" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Enregistrez le document au format TIFF.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Avant d'exécuter le code C# de conversion HTML vers TIFF, votre ordinateur doit disposer des prérequis suivants :
...
{{% blocks/products/pf/agp/code-block title="Code C# pour convertir HTML en TIFF" offSpacer="" %}}
