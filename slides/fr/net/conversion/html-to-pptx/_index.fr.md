---
title: Convertir HTML en PPTX en C#
url: /fr/net/conversion/html-to-pptx/
keywords: Convertir HTML en PPTX, HTML en PPTX, PowerPoint, HTML, PPTX, API C#, bibliothèque .NET
description: Convertir HTML en PPTX en C#. Utiliser l'API de la bibliothèque .NET pour convertir HTML en PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convertir HTML en PPTX en C#" h2="Puissante API .NET multiplateforme pour convertir HTML en PPTX à l'aide de code C# sur les plates-formes NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Convertir HTML en PPTX en utilisant Aspose.Slides" %}}

[**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/) est une puissante bibliothèque .NET utilisée pour créer, convertir et manipuler des présentations PowerPoint, des PDF, des documents HTML, et d'autres fichiers. Lorsque vous convertissez HTML en PPTX, vous déplacez essentiellement le contenu d'un document HTML vers des diapositives dans une présentation PowerPoint.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Convertir HTML en PPTX en C#" %}}
En utilisant [**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/), vous pouvez convertir un document HTML en présentation PowerPoint avec seulement quelques lignes de code :

{{% blocks/products/pf/agp/code-block title="Code C# pour convertir HTML en PPTX" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Comment convertir HTML en PPTX en C#" >}}
