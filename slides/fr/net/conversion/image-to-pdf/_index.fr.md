...
title: Convertir une image en PDF en C#
weight: 30
url: /fr/net/conversion/image-to-pdf/ 
keywords: Image en PDF, Convertir une image en PDF, API C#, Bibliothèque .NET, Image, JPG, PNG, PDF
description: Convertir une image en PDF en C#. Utilisez l'API de la bibliothèque .NET pour convertir des images en documents PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir une image en PDF en C#" h2="API PowerPoint .NET pour convertir des images en documents PDF sur les plates-formes NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir une image en PDF en C#" %}}

Comment convertir une image en PDF par programmation ?

En utilisant [**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/), n'importe quel développeur ou application peut convertir une image au format PDF avec seulement quelques lignes de code C#.

En tant qu'API de traitement de documents moderne, Aspose.Slides pour .NET crée rapidement des fichiers PDF à partir d'images JPG ou PNG. La bibliothèque Aspose PowerPoint vous permet de convertir une image en PDF et de nombreux autres formats de fichiers
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour convertir une image en PDF en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Les développeurs et les applications peuvent convertir Image en PDF de cette façon :" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Avant d'exécuter le code C# de conversion d'image en PDF, votre ordinateur doit disposer des prérequis suivants :
...
{{% blocks/products/pf/agp/code-block title="Code C# pour convertir une image en PDF" offSpacer="" %}}
