...
weight: 90
url: /fr/net/conversion/pdf-to-png/ 
keywords: PDF en PNG, Convertir PDF en PNG, API C#, Bibliothèque .NET, PDF, PNG
description: Convertir PDF en PNG en C#. Utilisez l'API de la bibliothèque .NET pour convertir des pages PDF en images PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PDF en PNG en C#" h2="API PowerPoint .NET pour convertir des documents PDF en images PNG sur les plates-formes NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir un PDF en PNG en C#" %}}

Comment convertir un PDF en PNG dans le code ?

En utilisant [**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/), n'importe quel développeur ou application peut convertir un PDF au format PNG avec seulement quelques lignes de code C#.

En tant qu'API de traitement de documents moderne, Aspose.Slides pour .NET exporte rapidement les pages PDF vers PNG. La bibliothèque Aspose PowerPoint vous permet de convertir des PDF en PNG et de nombreux autres formats de fichiers
...
{{< blocks/products/pf/agp/feature-section-col title="Comment convertir un PDF en PNG en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Les développeurs et les applications peuvent convertir des PDF en PNG de cette façon :" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Appelez la méthode save pour enregistrer les diapositives en tant qu'images PNG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Avant d'exécuter le code C# de conversion PDF vers PNG, votre ordinateur doit disposer des prérequis suivants :
...
{{% blocks/products/pf/agp/code-block title="Code C# pour convertir PDF en PNG" offSpacer="" %}}
