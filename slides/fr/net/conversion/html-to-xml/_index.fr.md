...
title: Convertir HTML en XML en C#
weight: 170
url: /fr/net/conversion/html-to-xml/ 
keywords: HTML en XML, Convertir HTML en XML, API C#, Bibliothèque .NET, HTML, XML
description: Convertissez HTML en XML en C#. Utilisez l'API de la bibliothèque .NET pour convertir un document HTML en fichier XML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir HTML en XML en C#" h2="API PowerPoint .NET pour convertir des documents HTML en fichiers XML sur les plates-formes NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir HTML en XML en C#" %}}

Comment convertir HTML en XML dans le code ?

En utilisant [**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/), n'importe quel développeur ou application peut convertir des fichiers HTML en XML avec seulement quelques lignes de code C#.
...
{{< blocks/products/pf/agp/feature-section-col title="Comment convertir HTML en XML en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Les développeurs et les applications peuvent convertir HTML en XML de cette manière :" >}}
...
{{% blocks/products/pf/agp/code-block title="Code C# pour convertir HTML en XML" offSpacer="" %}}
