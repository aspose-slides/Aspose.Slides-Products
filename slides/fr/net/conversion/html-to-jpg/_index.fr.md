...
keywords: HTML en JPG, Convertir HTML en JPG, API C#, Bibliothèque .NET, HTML, JPG
description: Convertir HTML en JPG en C#. Utilisez l'API de la bibliothèque .NET pour convertir des fichiers HTML en images JPG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir HTML en JPG en C#" h2="API PowerPoint .NET pour convertir des fichiers HTML en images JPG sur les plates-formes NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir HTML en JPG en C#" %}}

Comment convertir HTML en JPG dans le code ?

En utilisant [**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/), n'importe quel développeur ou application peut convertir le format HTML au format JPG avec seulement quelques lignes de code C#.

En tant qu'API de traitement de documents moderne, Aspose.Slides pour .NET exporte rapidement les fichiers HTML vers JPG. La bibliothèque Aspose PowerPoint vous permet de convertir HTML en JPG et de nombreux autres formats de fichiers
...
{{< blocks/products/pf/agp/feature-section-col title="Comment convertir HTML en JPG en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Les développeurs et les applications peuvent convertir HTML en JPG de cette façon :" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Ajoutez des diapositives en fonction du contenu du document HTML.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Enregistrez les diapositives sous forme d'images JPG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Avant d'exécuter le code C# de conversion HTML vers JPG, votre ordinateur doit disposer des prérequis suivants :
...
{{% blocks/products/pf/agp/code-block title="Code C# pour convertir HTML en JPG" offSpacer="" %}}
