...
weight: 210
url: /fr/net/conversion/jpg-to-image/ 
keywords: JPG en Image, Convertir JPG en Image, API C#, Bibliothèque .NET
description: Convertir JPG en Image en C#. Utilisez l'API de la bibliothèque .NET pour convertir JPG en images dans différents formats.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir JPG en image en C#" h2="API PowerPoint .NET pour convertir des images JPG en fichiers image sur les plates-formes NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir JPG en image en C#" %}}

Comment convertir JPG en Image dans le code ?

En utilisant [**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/), n'importe quel développeur ou application peut convertir JPG en image avec seulement quelques lignes de code C#.

En tant qu'API de traitement de documents moderne, Aspose.Slides pour .NET exporte rapidement des fichiers JPG vers des images dans d'autres formats. La bibliothèque Aspose PowerPoint vous permet de convertir JPG en image et de nombreux autres formats de fichiers
...
{{< blocks/products/pf/agp/feature-section-col title="Comment convertir JPG en image en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Les développeurs et les applications peuvent convertir JPG en image de cette façon :" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Avant d'exécuter le code C# de conversion JPG en image, votre machine doit avoir ces prérequis :
...
{{% blocks/products/pf/agp/code-block title="Code C# pour convertir JPG en image" offSpacer="" %}}
