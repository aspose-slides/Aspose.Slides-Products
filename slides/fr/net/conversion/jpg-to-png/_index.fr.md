...
keywords: JPG en PNG, Convertir JPG en PNG, API C#, Bibliothèque .NET
description: Convertissez JPG en PNG en C#. Utilisez l'API de la bibliothèque .NET pour convertir des fichiers JPG en PNG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir JPG en PNG en C#" h2="API PowerPoint .NET pour convertir des fichiers image JPG en PNG sur les plates-formes NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir JPG en PNG en C#" %}}

Comment convertir JPG en PNG dans le code ?

En utilisant [**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/), n'importe quel développeur ou application peut convertir JPG en PNG avec seulement quelques lignes de code C#.

En tant qu'API de traitement de documents moderne, Aspose.Slides pour .NET exporte rapidement les fichiers JPG vers PNG. La bibliothèque Aspose PowerPoint vous permet de convertir JPG en PNG et des images dans d'autres formats.
...
{{< blocks/products/pf/agp/feature-section-col title="Comment convertir JPG en PNG en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Les développeurs et les applications peuvent convertir JPG en PNG de cette façon :" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Avant d'exécuter le code C# de conversion JPG en PNG, votre ordinateur doit disposer des prérequis suivants :
...
{{% blocks/products/pf/agp/code-block title="Code C# pour convertir JPG en PNG" offSpacer="" %}}
