...
title: Convertir PPS en PNG via C#
weight: 6130
url: /fr/net/conversion/pps-to-png/ 
description: Exemple de code pour la conversion PPS en PNG C#. Utilisez le code d'exemple d'API pour la conversion de fichiers PPS par lots en PNG dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PPS en PNG via C#" h2="Exportez des fichiers PowerPoint® PPS au format PNG sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPS" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="Les développeurs .NET peuvent facilement charger et convertir des fichiers PPS en PNG en quelques lignes de code seulement." >}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion PPS en PNG C#" offSpacer="" %}}
