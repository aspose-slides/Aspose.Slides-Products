...
title: Convertir HTML en image en C#
weight: 160
url: /fr/net/conversion/html-to-image/ 
keywords: HTML en image, Convertir HTML en image, API C#, Bibliothèque .NET, HTML, Image
description: Convertir HTML en image en C#. Utiliser l'API de la bibliothèque .NET pour convertir des fichiers HTML en images
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir HTML en image en C#" h2="API PowerPoint .NET pour convertir des fichiers HTML en images sur les plates-formes NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir HTML en image en C#" %}}

Comment convertir HTML en image dans le code ?

En utilisant [**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/), n'importe quel développeur ou application peut convertir du HTML en fichiers image avec seulement quelques lignes de code C#.

En tant qu'API de traitement de documents moderne, Aspose.Slides pour .NET exporte rapidement des fichiers HTML vers des formats de fichiers image. La bibliothèque Aspose PowerPoint vous permet de convertir du HTML en images et de nombreux autres formats de fichiers
...
{{< blocks/products/pf/agp/feature-section-col title="Comment convertir HTML en image en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Les développeurs et les applications peuvent convertir HTML en image de cette façon :" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Ajoutez des diapositives basées sur les pages HTML.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Enregistrez les diapositives sous forme d'images.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Avant d'exécuter le code C# de conversion HTML vers Image, votre ordinateur doit disposer des prérequis suivants :
...
{{% blocks/products/pf/agp/code-block title="Code C# pour convertir HTML en image" offSpacer="" %}}
