---
title: Convertir POTM en HTML via C#
weight: 6950
url: /fr/net/conversion/potm-to-html/ 
description: Exemple de code pour la conversion POTM vers HTML C#. Utilisez le code d'exemple d'API pour les fichiers POTM par lots en conversion HTML dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir POTM en HTML via C#" h2="Exportez des fichiers PowerPoint® POTM au format HTML sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir POTM en HTML à l'aide de C#" %}}

 Pour convertir POTM en HTML, nous utiliserons
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour convertir POTM en HTML via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Les développeurs .NET peuvent facilement charger et convertir des fichiers POTM en HTML en quelques lignes de code." >}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion POTM en HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/fr/net/conversion/potm-to-xps/" name="POTM TO XPS" description="Spécifications papier XML" >}}
