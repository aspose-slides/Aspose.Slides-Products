...
keywords: Convertir PDF en PPT, PDF en PPT, PowerPoint, PDF, PPT, API C#, bibliothèque .NET
description: Convertir PDF en PPT en C#. Utiliser l'API de la bibliothèque .NET pour convertir un PDF en PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convertir PDF en PPT en C#" h2="Puissante API .NET multiplateforme pour la conversion de PDF en PPT à l'aide de code C# sur les plates-formes NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Convertir PDF en PPT en utilisant Aspose.Slides" %}}

[**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/) est une puissante bibliothèque .NET utilisée pour créer, convertir et manipuler des présentations PowerPoint, des PDF, des documents HTML, et d'autres fichiers. Lorsque vous convertissez un PDF en PPT, vous déplacez essentiellement le contenu des pages PDF vers des diapositives dans une présentation PowerPoint.
...
{{< blocks/products/pf/feature-page-section  h2="Comment convertir un PDF en PPT en C#" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Chargez le fichier PDF que vous souhaitez convertir en PPT.
{{< /blocks/products/pf/agp/step-autogen >}}
