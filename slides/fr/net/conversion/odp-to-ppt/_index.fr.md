...
title: Convertir ODP en PPT via C#
weight: 2000
url: /fr/net/conversion/odp-to-ppt/ 
description: Exemple de code pour la conversion ODP en PPT C#. Utilisez le code d'exemple d'API pour la conversion de fichiers ODP par lots en PPT dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir ODP en PPT via C#" h2="Exportez des fichiers PowerPoint® ODP vers PPT sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="Les développeurs .NET peuvent facilement charger et convertir des fichiers ODP en PPT en quelques lignes de code seulement." >}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion ODP en PPT C#" offSpacer="" %}}
