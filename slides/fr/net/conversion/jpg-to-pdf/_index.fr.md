...
keywords: JPG en PDF, Convertir JPG en PDF, API C#, Bibliothèque .NET
description: Convertir JPG en PDF en C#. Utilisez l'API de la bibliothèque .NET pour convertir des images JPG JPEG en documents PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir JPG en PDF en C#" h2="API PowerPoint .NET pour convertir des images JPG en documents PDF sur les plates-formes NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir JPG en PDF en C#" %}}

Comment convertir JPG en PDF par programmation ?

En utilisant [**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/), n'importe quel développeur ou application peut convertir JPG au format PDF avec seulement quelques lignes de code C#.

En tant qu'API de traitement de documents moderne, Aspose.Slides pour .NET crée rapidement des fichiers PDF à partir d'images JPG. La bibliothèque Aspose PowerPoint vous permet de convertir JPG en PDF et de nombreux autres formats de fichiers
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour convertir JPG en PDF en C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Les développeurs et les applications peuvent convertir JPG en PDF de cette façon :" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Avant d'exécuter le code C# de conversion JPG en PDF, votre ordinateur doit disposer des prérequis suivants :
...
{{% blocks/products/pf/agp/code-block title="Code C# pour convertir JPG en PDF" offSpacer="" %}}
