...
url: /fr/net/conversion/image-to-ppt/
keywords: Convertir une image en PPT, image en PPT, PowerPoint, image, PPT, API C#, bibliothèque .NET
description: Convertir une image en PPT en C#. Utiliser l'API de la bibliothèque .NET pour convertir l'image en PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convertir une image en PPT en C#" h2="Puissante API .NET multiplateforme pour convertir une image en PPT à l'aide de code C# sur les plates-formes NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Convertir l'image en PPT en utilisant Aspose.Slides" %}}

[**Aspose.Slides pour .NET**](https://products.aspose.com/slides/fr/net/) est une puissante bibliothèque .NET utilisée pour créer, convertir et manipuler des présentations PowerPoint, des PDF, des documents HTML, et d'autres fichiers. Lorsque vous convertissez une image en PPT, vous créez essentiellement une présentation PowerPoint contenant des diapositives basées sur ces images.
...
{{< blocks/products/pf/feature-page-section  h2="Comment convertir une image en PPT en C#" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/fr/net/conversion/image-to-pptx/" name="IMAGE TO PPTX" >}}
