...
title: Extraire du texte et des images d'un document PPTX via Java
weight: 1000
url: /fr/java/parser/pptx/ 
description: Exemple de code Java pour extraire le texte et les images du fichier PPTX sur Java Runtime Environment pour les applications JSP/JSF et les applications de bureau.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Analyser les formats PPTX en Java" h2="Analyse de documents PPTX native et hautes performances à l'aide d'Aspose.Slides côté serveur pour les API Java, sans l'utilisation de logiciels tels que Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment analyser un fichier PPTX à l'aide de Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour analyser les fichiers PPTX en Java" >}}
...
Chargez le fichier PPTX en instaurant la classe Presentation.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Analyser les fichiers PPTX - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/fr/java/parser/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
