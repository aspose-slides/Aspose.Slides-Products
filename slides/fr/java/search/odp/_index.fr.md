---
title: Rechercher un document ODP sans l'ouvrir via Java
weight: 1250
url: /fr/java/search/odp/ 
description: Exemple de code Java pour rechercher des mots avec un modèle dans le fichier ODP sur l'environnement d'exécution Java pour les applications d'application et de bureau JSP/JSF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Rechercher des formats ODP en Java" h2="Recherche de documents ODP native et hautes performances à l'aide d'Aspose.Slides côté serveur pour les API Java, sans l'utilisation de logiciels tels que Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Comment rechercher un fichier ODP à l'aide de Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour rechercher des fichiers ODP en Java" >}}
...
Chargez le fichier ODP en instanciant l'objet Presentation Class.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Rechercher des fichiers ODP - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/fr/java/search/pptx/" name="PPTX" description="Format de présentation XML ouvert" >}}
