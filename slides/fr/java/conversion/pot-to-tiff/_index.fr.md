...
title: Convertir POT en TIFF via Java
weight: 4590
url: /fr/java/conversion/pot-to-tiff/ 
description: Exemple de code de conversion Java pour le format POT en fichier TIFF. Utilisez cet exemple de code pour exporter des présentations PowerPoint et OpenOffice au format TIFF dans n'importe quelle application Web ou de bureau basée sur Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir POT en TIFF via Java" h2="Conversion Java POT en TIFF pour convertir une ou plusieurs pages en TIFF à l'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir POT en TIFF en utilisant Java" %}}

 Afin de rendre POT en TIFF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir POT en TIFF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier POT en TIFF en quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion Java POT en TIFF" offSpacer="" %}}
