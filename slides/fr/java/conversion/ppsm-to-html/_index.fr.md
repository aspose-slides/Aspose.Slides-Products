---
title: Convertir PPSM en HTML via Java
weight: 8760
url: /fr/java/conversion/ppsm-to-html/ 
description: Exemple de code de conversion Java pour le format PPSM en fichier HTML. Utilisez cet exemple de code pour exporter des présentations PowerPoint et OpenOffice au format HTML dans n'importe quelle application Web ou de bureau basée sur Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PPSM en HTML via Java" h2="Conversion PPSM vers HTML Java pour convertir une ou plusieurs pages en HTML à l'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSM" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir PPSM en HTML à l'aide de Java" %}}

 Afin de rendre PPSM en HTML, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir PPSM en HTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier PPSM en HTML en quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion PPSM vers HTML Java" offSpacer="" %}}
