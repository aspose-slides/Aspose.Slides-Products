---
title: Convertir PPSX en ODP via Java
weight: 5760
url: /fr/java/conversion/ppsx-to-odp/ 
description: Exemple de code de conversion Java pour le format PPSX en fichier ODP. Utilisez cet exemple de code pour exporter des présentations PowerPoint et OpenOffice vers ODP dans n'importe quelle application Web ou de bureau basée sur Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PPSX en ODP via Java" h2="Conversion PPSX vers ODP Java pour convertir une ou plusieurs pages en ODP à l'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir PPSX en ODP en utilisant Java" %}}

 Afin de rendre PPSX à ODP, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir PPSX en ODP via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier PPSX en ODP en quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion Java PPSX vers ODP" offSpacer="" %}}
