---
title: Convertir PPSX en BMP via Java
weight: 7090
url: /fr/java/conversion/ppsx-to-bmp/ 
description: Exemple de code de conversion Java pour le format PPSX en fichier BMP. Utilisez cet exemple de code pour exporter des présentations PowerPoint et OpenOffice vers BMP dans n'importe quelle application Web ou de bureau basée sur Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PPSX en BMP via Java" h2="Conversion PPSX vers BMP Java pour convertir une ou plusieurs pages en BMP à l'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir PPSX en BMP en utilisant Java" %}}

 Afin de rendre PPSX en BMP, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir PPSX en BMP via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier PPSX en BMP en quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion Java PPSX vers BMP" offSpacer="" %}}
