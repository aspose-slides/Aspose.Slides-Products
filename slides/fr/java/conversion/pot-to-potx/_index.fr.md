---
title: Convertir POT en POTX via Java
weight: 2060
url: /fr/java/conversion/pot-to-potx/ 
description: Exemple de code de conversion Java pour le format POT en fichier POTX. Utilisez cet exemple de code pour exporter des présentations PowerPoint et OpenOffice vers POTX dans n'importe quelle application Web ou de bureau basée sur Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir POT en POTX via Java" h2="Conversion Java POT vers POTX pour convertir une ou plusieurs pages en POTX à l'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir POT en POTX en utilisant Java" %}}

 Afin de rendre POT à POTX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir POT en POTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier POT en POTX en quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion Java de POT à POTX" offSpacer="" %}}
