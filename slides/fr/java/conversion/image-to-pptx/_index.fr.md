---
title: Convertir une image en PPTX en Java
url: /fr/java/conversion/image-to-pptx/
keywords: Convertir l'image en PPTX, l'image en PPTX, PowerPoint, l'image, PPTX, l'API Java, la bibliothèque Java
description: Convertir l'image en PPTX en Java. Utiliser l'API de la bibliothèque Java pour convertir une image en PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convertir une image en PPTX en Java" h2="Bibliothèque Java haute vitesse et multiplateforme qui aide au développement d'applications avec la possibilité de créer, fusionner, inspecter ou convertir des fichiers de présentation Microsoft PowerPoint et OpenOffice sans utiliser de logiciel comme Microsoft ou Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Convertir une image en PPTX en utilisant Java" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/fr/java/) est une puissante bibliothèque Java utilisée pour créer, convertir et manipuler des présentations PowerPoint, des PDF, des documents HTML et d'autres des dossiers. Lorsque vous convertissez une image en PPTX, vous créez essentiellement une présentation PowerPoint contenant des diapositives basées sur ces images.

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convertir une image en PPTX en Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Code Java pour convertir une image en PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment convertir une image en PPTX à l'aide d'Aspose.Slides pour l'API Java" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Voici les étapes pour convertir Image en PPTX en Java." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/fr/java/conversion/image-to-ppt/" name="IMAGE TO PPT" >}}
