...
url: /fr/java/merger/pdf-to-pdf/
keywords: Fusionner PDF, PDF à PDF, Joindre PDF, Combiner PDF, API Java, Bibliothèque Java
description: Fusionner PDF en PDF en Java. Utiliser l'API de la bibliothèque Java pour combiner des fichiers PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Fusionner PDF en Java" h2="Bibliothèque Java haute vitesse et multiplateforme pour la fusion de fichiers PDF à l'aide de code Java" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Fusionner PDF en PDF en Java" %}}
En utilisant [**Aspose.Slides pour Java**](https://products.aspose.com/slides/fr/java/), vous pouvez fusionner rapidement des fichiers PDF avec seulement quelques lignes de code

{{% blocks/products/pf/agp/code-block title="Code Java pour fusionner PDF en PDF" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Comment fusionner un PDF en Java" >}}
