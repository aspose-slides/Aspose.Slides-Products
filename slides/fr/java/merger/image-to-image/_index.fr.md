---
title: Fusionner des images en Java
url: /fr/java/merger/image-to-image/
keywords: Fusionner une image, image à image, Joindre des images, Combiner des images, API Java, Bibliothèque Java
description: Fusionner image à image en Java. Utiliser l'API de la bibliothèque Java pour combiner des images
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge image in Java" h2="Bibliothèque Java haute vitesse et multiplateforme pour fusionner des images à l'aide de code Java" >}}

{{% blocks/products/pf/feature-page-section h2="Fusionner image à image en utilisant Aspose.Slides" %}}

[**Aspose.Slides pour Java**](https://products.aspose.com/slides/fr/java/) est une puissante bibliothèque Java utilisée pour fusionner et manipuler des présentations, des images et d'autres fichiers. Lorsque vous fusionnez une image à l'autre, vous combinez effectivement deux images pour obtenir une seule image.
...
{{% blocks/products/pf/feature-page-section  h2="Fusionner image à image en Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Code Java pour fusionner image à image" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Comment fusionner des images en Java" >}}
