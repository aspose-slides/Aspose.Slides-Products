...
title: Fusionner des fichiers PPSX via Java
weight: 5500
url: /fr/java/merger/ppsx/ 
description: Exemple de code Java pour combiner des documents PPSX sur l'environnement d'exécution Java pour les applications d'application et de bureau JSP/JSF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Fusionner les formats PPSX en Java" h2="Fusion de documents PPSX natifs à l'aide d'API Java côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment fusionner des fichiers PPSX à l'aide de Java" %}}

 Afin de fusionner le fichier PPSX, nous utiliserons
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour fusionner des fichiers PPSX en Java" >}}
...
Chargez le premier fichier PPSX avec une instance de la classe Presentation.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Chargez le deuxième document PPSX avec une instance de la classe Presentation.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Parcourez chaque diapositive du deuxième fichier PPSX.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Fusionner des fichiers PPSX - Java" offSpacer="" %}}
