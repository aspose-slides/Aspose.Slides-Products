---
title: Rechercher et remplacer du texte dans un document PPTX via Java
weight: 3610
url: /fr/java/redaction/pptx/ 
description: Exemple de code Java pour masquer les informations sensibles dans le fichier PPTX sur l'environnement d'exécution Java pour les applications d'application et de bureau JSP/JSF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Masquer les formats PPTX en Java" h2="Informations de rédaction sensibles aux documents PPTX natifs et hautes performances à l'aide d'Aspose.Slides côté serveur pour les API Java, sans l'utilisation de logiciels tels que Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment expurger un fichier PPTX à l'aide de Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour expurger les fichiers PPTX en Java" >}}
...
{{% blocks/products/pf/agp/code-block title="Masquer les fichiers PPTX - Java" offSpacer="" %}}
