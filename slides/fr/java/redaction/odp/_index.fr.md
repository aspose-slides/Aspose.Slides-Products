---
title: Rechercher et remplacer du texte dans un document ODP via Java
weight: 240
url: /fr/java/redaction/odp/ 
description: Exemple de code Java pour masquer les informations sensibles dans le fichier ODP sur l'environnement d'exécution Java pour les applications d'application et de bureau JSP/JSF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Masquer les formats ODP en Java" h2="Informations de rédaction sensibles aux documents ODP natives et hautes performances à l'aide des API Aspose.Slides pour Java côté serveur, sans l'utilisation de logiciels tels que Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/code-block title="Masquer les fichiers ODP - Java" offSpacer="" %}}
