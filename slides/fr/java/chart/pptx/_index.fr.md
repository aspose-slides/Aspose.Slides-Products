...
title: Tableau de documents PPTX via Java
weight: 160
url: /fr/java/chart/pptx/ 
description: Exemple de code Java pour dessiner et convertir un graphique ou un diagramme dans un fichier PPTX sur Java Runtime Environment pour les applications JSP/JSF et les applications de bureau.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Tableaux des formats PPTX en Java" h2="Graphiques de documents PPTX natifs et hautes performances utilisant Aspose.Slides côté serveur pour les API Java, sans l'utilisation de logiciels tels que Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment créer des graphiques de fichiers PPTX à l'aide de Java" %}}

 Afin de créer des graphiques de fichiers PPTX, nous utiliserons
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour créer des graphiques de fichiers PPTX en Java" >}}
...
{{% blocks/products/pf/agp/code-block title="Créer un graphique de fichiers PPTX - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/fr/java/chart/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
