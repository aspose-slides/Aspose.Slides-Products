---
title: Afficher ou modifier les métadonnées des fichiers PPSX à l'aide de Java
...
{{% blocks/products/pf/agp/code-block title="Modifier les propriétés intégrées de PPSX - Java" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Ajouter des propriétés personnalisées à PPSX - Java" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment extraire les métadonnées de PPSX via Java" >}}
