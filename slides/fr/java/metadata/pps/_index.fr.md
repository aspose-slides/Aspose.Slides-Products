---
title: Modifier ou afficher les métadonnées des fichiers PPS via Java
weight: 8790
url: /fr/java/metadata/pps/ 
description: Exemple de code Java pour modifier ou afficher les métadonnées au format PPS sur l'environnement d'exécution Java pour les applications d'application et de bureau JSP/JSF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extraire les métadonnées PPS via Java" h2="Créez vos propres applications Java pour ajouter, modifier, supprimer ou extraire des métadonnées de fichiers PPS à l'aide d'API côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPS" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Comment extraire les métadonnées PPS à l'aide de Java" %}}

 Afin d'obtenir les métadonnées du fichier PPS, nous utiliserons
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour extraire les métadonnées de PPS via Java" >}}
...
Obtenir des informations PPS à l'aide de getPresentationInfo()
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Mettre à jour et écrire des informations PPS avec de nouvelles propriétés
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Extraire les métadonnées de PPS - Java" offSpacer="" %}}
