---
title: Modifier ou afficher les métadonnées des fichiers PPTX via Java
weight: 6090
url: /fr/java/metadata/pptx/ 
description: Exemple de code Java pour modifier ou afficher les métadonnées au format PPTX sur l'environnement d'exécution Java pour les applications d'application et de bureau JSP/JSF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extraire les métadonnées PPTX via Java" h2="Créez vos propres applications Java pour ajouter, modifier, supprimer ou extraire des métadonnées de fichiers PPTX à l'aide d'API côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Comment extraire les métadonnées PPTX à l'aide de Java" %}}

 Afin d'obtenir les métadonnées du fichier PPTX, nous utiliserons
...
{{< blocks/products/pf/agp/feature-section-col title="Étapes pour extraire les métadonnées de PPTX via Java" >}}
...
Obtenir des informations PPTX à l'aide de getPresentationInfo()
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Mettre à jour et écrire des informations PPTX avec de nouvelles propriétés
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Extraire les métadonnées de PPTX - Java" offSpacer="" %}}
