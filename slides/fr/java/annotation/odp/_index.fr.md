---
title: Supprimer l'annotation ODP via Java
weight: 1790
...
{{< blocks/products/pf/i18n/upper-banner h1="Supprimer les commentaires et les auteurs de commentaires d'ODP via Java" h2="Créez vos propres applications Java pour manipuler les commentaires et les auteurs dans les fichiers de documents à l'aide d'API côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Comment annoter un fichier ODP avec Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour supprimer les commentaires d'ODP via Java" %}}
...
1. Enregistrez-le au format ODP
1. Supprimer le commentaire à un emplacement spécifique
1. Enregistrez à nouveau le fichier ODP et comparez
...
{{% blocks/products/pf/agp/code-block title="Supprimer les annotations d'ODP - Java" offSpacer="" %}}
