---
title: Ajouter un filigrane aux fichiers de présentation PPT à l'aide de C++
...
description: Code source C++ pour ajouter un filigrane à la présentation PPT.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Ajouter un filigrane à la présentation PPT en utilisant C++" h2="Créez vos propres applications C++ pour insérer un filigrane de texte ou d'image dans une présentation PPT, PPTX ou ODP à l'aide d'API côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" fileiconsmall4="POT" fileiconsmall5="ppsx" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for C++" >}}

{{% blocks/products/pf/feature-page-section  h2="Ajouter un filigrane à la présentation PPT via C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Ajouter un filigrane de texte à PPT en utilisant C++" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Ajouter un filigrane d'image à la présentation PPT à l'aide de C++" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment ajouter un filigrane à PPT via C++" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/fr/cpp/watermark/odp/" name="ODP" >}}
