...
url: /fr/cpp/merger/image-to-pdf/
keywords: Image au format PDF, Fusionner l'image au format PDF, Joindre l'image au format PDF, PDF, Image, API C++, Bibliothèque C++
description: Fusionner l'image au format PDF en C++. Utilisez l'API de la bibliothèque C++ pour combiner Image et PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Fusionner l'image au format PDF en C++" h2="Bibliothèque C++ haute vitesse et multiplateforme pour fusionner des fichiers Image vers PDF à l'aide de code C++" >}}
...
En utilisant [**Aspose.Slides pour C++**](https://products.aspose.com/slides/fr/cpp/), vous pouvez rapidement fusionner une image au format PDF avec seulement quelques lignes de code
