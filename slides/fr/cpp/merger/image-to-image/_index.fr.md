---
title: Fusionner des images en C++
url: /fr/cpp/merger/image-to-image/
keywords: Fusionner une image, image à image, Joindre des images, Combiner des images, API C++, Bibliothèque C++
description: Fusionner image à image en C++. Utiliser l'API de la bibliothèque C++ pour combiner des images
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Fusionner une image en C++" h2="Bibliothèque C++ haute vitesse et multiplateforme pour fusionner des images à l'aide de code C++" >}}

{{% blocks/products/pf/feature-page-section h2="Fusionner image à image en utilisant Aspose.Slides" %}}

[**Aspose.Slides pour C++**](https://products.aspose.com/slides/fr/cpp/) est une puissante bibliothèque C++ utilisée pour fusionner et manipuler des présentations, des images et d'autres fichiers. Lorsque vous fusionnez une image à l'autre, vous combinez effectivement deux images pour obtenir une seule image.
...
{{% blocks/products/pf/feature-page-section  h2="Fusionner image à image en C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Code C++ pour fusionner image à image" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="Comment fusionner des images en C++" >}}
