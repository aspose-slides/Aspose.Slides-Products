...
url: /fr/cpp/merger/pdf-to-pdf/
keywords: Fusionner PDF, PDF à PDF, Joindre PDF, Combiner PDF, API C++, Bibliothèque C++
description: Fusionnez PDF en PDF en C++. Utiliser l'API de la bibliothèque C++ pour combiner des fichiers PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Fusionner PDF en C++" h2="Bibliothèque C++ haute vitesse et multiplateforme pour fusionner des fichiers PDF à l'aide de code C++" >}}
...
En utilisant [**Aspose.Slides pour C++**](https://products.aspose.com/slides/fr/cpp/), vous pouvez fusionner rapidement des fichiers PDF avec seulement quelques lignes de code
