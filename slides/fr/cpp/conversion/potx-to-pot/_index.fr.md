...
{{% blocks/products/pf/agp/content h2="Comment convertir POTX en POT en utilisant C++" %}}

 Afin de convertir POTX en POT, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir POTX en POT via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir un fichier POTX en POT en quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion POTX vers POT C++" offSpacer="" %}}
