---
title: Convertir PPTX en HTML via une application C++
weight: 4170
url: /fr/cpp/conversion/pptx-to-html/ 
description: Exemple de code de conversion C++ pour le document PPTX au format HTML. Utilisez un exemple de code pour la conversion par lots de PPTX en HTML dans n'importe quelle application C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PPTX en HTML via C++" h2="Conversion PPTX vers HTML haute performance à l'aide de la bibliothèque C++ sans avoir besoin de l'installation de Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir PPTX en HTML en utilisant C++" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs C++ peuvent facilement convertir un fichier PPTX en HTML en quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion PPTX vers HTML C++" offSpacer="" %}}
