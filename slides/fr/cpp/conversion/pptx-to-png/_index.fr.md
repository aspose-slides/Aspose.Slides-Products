...
title: Convertir PPTX en PNG via l'application C++
weight: 1600
url: /fr/cpp/conversion/pptx-to-png/ 
description: Exemple de code de conversion C++ pour le document PPTX au format PNG. Utilisez un exemple de code pour la conversion par lots de PPTX en PNG dans n'importe quelle application C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PPTX en PNG via C++" h2="Conversion PPTX en PNG haute performance à l'aide de la bibliothèque C++ sans avoir besoin de l'installation de Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir PPTX en PNG en utilisant C++" %}}

 Pour convertir PPTX en PNG, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir PPTX en PNG via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir un fichier PPTX en PNG en quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion PPTX vers PNG C++" offSpacer="" %}}
