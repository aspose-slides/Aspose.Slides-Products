---
title: Convertir OTP en SWF via une application C++
url: /fr/cpp/conversion/otp-to-swf/ 
description: Exemple de code de conversion C++ pour un document OTP au format SWF. Utilisez un exemple de code pour la conversion par lots d'OTP en SWF dans n'importe quelle application C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir OTP en SWF via C++" h2="Conversion OTP vers SWF haute performance à l'aide de la bibliothèque C++ sans avoir besoin de l'installation de Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWF" pfName="Aspose.SLIDES" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="SLIDES" fileiconsmall4="XML" fileiconsmall5="OTP" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir OTP en SWF via C++" %}}

{{% blocks/products/pf/agp/text %}}

 L'API Aspose.SLIDES permet aux développeurs de convertir facilement un fichier OTP en SWF en quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion OTP vers SWF C++" offSpacer="" %}}
