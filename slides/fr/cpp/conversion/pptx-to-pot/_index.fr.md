...
{{% blocks/products/pf/agp/content h2="Comment convertir PPTX en POT en utilisant C++" %}}

 Afin de convertir PPTX en POT, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir PPTX en POT via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir un fichier PPTX en POT en quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion PPTX vers POT C++" offSpacer="" %}}
