...
title: Convertir POTX en ODP via une application C++
weight: 6270
url: /fr/cpp/conversion/potx-to-odp/ 
description: Exemple de code de conversion C++ pour le document POTX au format ODP. Utilisez un exemple de code pour la conversion par lots de POTX en ODP dans n'importe quelle application C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir POTX en ODP via C++" h2="Conversion POTX vers ODP haute performance à l'aide de la bibliothèque C++ sans avoir besoin de l'installation de Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir POTX en ODP en utilisant C++" %}}

 Afin de convertir POTX en ODP, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir POTX en ODP via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir un fichier POTX en ODP en quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion POTX vers ODP C++" offSpacer="" %}}
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        appName="conversion"
        extension=""
        sectionTitle="Application gratuite pour convertir POTX en ODP" 
