...
url: /fr/cpp/conversion/jpg-to-pptx/
keywords: Convertir JPG en PPTX, JPG en PPTX, PowerPoint, JPG, PPTX, API C++, Bibliothèque C++
description: Convertir JPG en PPTX en C++. Utilisez l'API de la bibliothèque C++ pour convertir des images JPG en PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convertir JPG en PPTX en C++" h2="Puissante API C++ multiplateforme pour convertir JPG en PPTX à l'aide de code C++" >}}
