---
title: Afficher ou modifier les métadonnées des fichiers POTX à l'aide de C++
url: /fr/cpp/metadata/potx/
...
{{% blocks/products/pf/agp/code-block title="Modifier les propriétés intégrées de POTX - C++" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Ajouter des propriétés personnalisées à POTX - C++" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment extraire les métadonnées de POTX via C++" >}}
