---
title: API PowerPoint Android | Aspose.Slides pour l'API Android
weight: 5960
url: /fr/android-java/ 
description: Aspose.Slides pour l'API Android ou l'API Android PowerPoint pour créer lire et manipuler PPT POT PPS PPTX POTX PPSX PowerPoint sur Android.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API PowerPoint Android" h2="Créez, modifiez, convertissez, fusionnez, divisez et gérez des présentations PowerPoint dans des applications Android." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-android-java.svg" pfName="Aspose.Slides" subTitlepfName="for Android via Java" downloadUrl="https://downloads.aspose.com/slides/androidjava" >}}
...
<p>
 Aspose.Slides pour Android via Java est une API PowerPoint pour les applications Android. Les développeurs peuvent effectuer un large éventail de tâches de traitement de présentation, notamment la lecture, l'écriture, la modification, la fusion, le fractionnement, la conversion et la manipulation de présentations sans aucune dépendance à Microsoft PowerPoint.
</p>

<p>
 Aspose.Slides pour Android via Java prend en charge presque tous les formats de fichiers PowerPoint natifs ainsi que le format de présentation OpenOffice (ODP). Créez votre application de visionneuse PowerPoint pour Android, ainsi qu'un convertisseur, un éditeur ou tout autre. Les éléments de présentation tels que les formes SmartArt, les graphiques MSO, les composants ActiveX et les objets de cadre OLE sont accessibles via l'API PowerPoint pour la gestion et la manipulation.
</p>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Fonctionnalités avancées de l'API Android PowerPoint
   </h2>
   <p>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Créer de nouvelles diapositives ou cloner à partir de modèles
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Ajouter ou supprimer la protection sur les formes
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Ajouter des graphiques Microsoft Excel en tant qu'OleObjects
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Importer et exporter du texte HTML vers des diapositives
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Gérer les composants ActiveX et SmartArt
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Ajouter ou modifier une transition de diaporama
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Vectoriser des formes sans texte
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Formatage de la présentation au niveau de la minute
    </h2>
    <p>
     La bibliothèque PowerPoint peut facilement gérer les fonctionnalités de mise en forme du texte et des formes telles que la taille de la police, le type, la couleur et les nuances, l'alignement des paragraphes, les puces et l'orientation et les hyperliens.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Conversion de présentation avec des notes
    </h2>
    <p>
     L'API permet la conversion en TIFF et PDF avec des notes. Les développeurs peuvent convertir l'ensemble de la présentation dans la vue Diapositive Notes au format pris en charge ainsi que dans le cas d'images, on peut créer une vignette de diapositive dans la vue Diapositive Notes pour des diapositives individuelles. Voici le code de conversion TIFF.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Convertir des présentations avec Notes
     </h3>
...
pres.save(dataDir + "TestNotes.tiff", SaveFormat.Tiff,opts);
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Manipuler des éléments via l'API publique
    </h2>
    <p>
     L'API est capable de gérer tous les éléments de diapositive de présentation, y compris le rectangle, le tableau, la zone de texte, l'ellipse, la polyligne, le cadre d'image, la forme automatique, le cadre audio, le cadre d'objet OLE et le cadre vidéo. L'API fournit également un riche ensemble de commandes API pour manipuler chacun de ces éléments. De plus, la mise en forme du texte est prise en charge par un ensemble de classes bien conçu.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.Slides pour Android via Java ?" tabId="success-stories" >}}
