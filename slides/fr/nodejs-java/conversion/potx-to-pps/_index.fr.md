---
title: Convertir POTX en PPS dans Node.js
url: /fr/nodejs-java/conversion/potx-to-pps/
keywords: POTX en PPS, Convertir POTX en PPS, API Node.js, Bibliothèque Node.js, POTX, PPS
description: Convertissez POTX en PPS dans Node.js. Utilisez l'API de la bibliothèque Node.js pour convertir les fichiers POTX en PPS
---
...
[**Aspose.Slides pour Node.js via Java**](https://products.aspose.com/slides/fr/nodejs-java/) est une puissante bibliothèque Node.js permettant de créer et de manipuler des fichiers de présentation. De plus, il offre des moyens flexibles de convertir POTX en PPS. En utilisant **Aspose.Slides pour Node.js via Java**, tout développeur ou application peut convertir des fichiers POTX en PPS avec seulement quelques lignes de code.

En tant qu'API moderne de traitement de documents, Aspose.Slides pour Node.js exporte rapidement les fichiers POTX vers les formats de fichiers PPS. La bibliothèque Aspose PowerPoint vous permet de convertir POTX en PPS et de nombreux autres formats de fichiers

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convertir POTX en PPS à l'aide de Node.js" %}}
Pour convertir le POTX en PPS, vous devrez créer une présentation à partir du fichier POTX et l'enregistrer sous PPS.

{{% blocks/products/pf/agp/code-block title="Code Node.js pour convertir POTX en PPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment convertir POTX en PPS à l'aide d'Aspose.Slides pour Node.js via l'API Java" >}}
