---
title: Convertir PPTX en PPS dans Node.js
url: /fr/nodejs-java/conversion/pptx-to-pps/
keywords: PPTX en PPS, Convertir PPTX en PPS, API Node.js, Bibliothèque Node.js, PPTX, PPS
description: Convertissez PPTX en PPS dans Node.js. Utilisez l'API de la bibliothèque Node.js pour convertir les fichiers PPTX en PPS
---
...
[**Aspose.Slides pour Node.js via Java**](https://products.aspose.com/slides/fr/nodejs-java/) est une puissante bibliothèque Node.js permettant de créer et de manipuler des fichiers de présentation. De plus, il offre des moyens flexibles de convertir PPTX en PPS. En utilisant **Aspose.Slides pour Node.js via Java**, tout développeur ou application peut convertir des fichiers PPTX en PPS avec seulement quelques lignes de code.

En tant qu'API moderne de traitement de documents, Aspose.Slides pour Node.js exporte rapidement les fichiers PPTX vers les formats de fichiers PPS. La bibliothèque Aspose PowerPoint vous permet de convertir PPTX en PPS et de nombreux autres formats de fichiers

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convertir PPTX en PPS à l'aide de Node.js" %}}
Pour convertir le PPTX en PPS, vous devrez créer une présentation à partir du fichier PPTX et l'enregistrer sous PPS.

{{% blocks/products/pf/agp/code-block title="Code Node.js pour convertir PPTX en PPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment convertir PPTX en PPS à l'aide d'Aspose.Slides pour Node.js via l'API Java" >}}
