---
title: Convertir PDF en JPG en JavaScript
url: /fr/nodejs-net/conversion/pdf-to-jpg/
keywords: PDF en JPG, Convertir PDF en JPG, API Node.js, Bibliothèque JavaScript, PDF, JPG
description: Convertissez PDF en JPG en JavaScript. Utilisez l'API de la bibliothèque Node.js pour convertir les fichiers PDF en JPG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convertir PDF en JPG en JavaScript" h2="Aspose.Slides pour Node.js via .NET est une bibliothèque puissante et facile à utiliser qui vous permet de convertir des présentations PowerPoint en différents formats en JavaScript. Il prend en charge tous les éléments et formats de présentation et fournit une API riche pour y accéder et les modifier. Il vous permet également d'exporter vos diapositives vers différents formats pour un traitement ou un partage ultérieur." >}}

{{% blocks/products/pf/feature-page-section h2="Convertir PDF en JPG dans Node.js" %}}

[**Aspose.Slides pour Node.js via .NET**](https://products.aspose.com/slides/fr/nodejs-net/) est une puissante bibliothèque Node.js permettant de créer et de manipuler des fichiers de présentation. De plus, il offre des moyens flexibles de convertir PDF en JPG. En utilisant **Aspose.Slides pour Node.js via .NET**, n'importe quel développeur ou application peut convertir des fichiers PDF en JPG avec seulement quelques lignes de code.

En tant qu'API moderne de traitement de documents, Aspose.Slides pour Node.js via .NET exporte rapidement les fichiers PDF vers les formats de fichiers JPG. La bibliothèque Aspose PowerPoint vous permet de convertir PDF en JPG et de nombreux autres formats de fichiers

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convertir PDF en JPG à l'aide de JavaScript" %}}
Pour convertir le PDF en JPG, vous devrez créer une présentation à partir du fichier PDF et l'enregistrer sous JPG.

{{% blocks/products/pf/agp/code-block title="Code JavaScript pour convertir PDF en JPG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment convertir PDF en JPG à l'aide d'Aspose.Slides pour Node.js via l'API .NET" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Pour convertir PDF en JPG à l'aide d'Aspose.Slides pour Node.js via .NET, vous devez importer le package dans votre fichier JavaScript et créer une instance de la classe Présentation. La classe Présentation représente un document PowerPoint et fournit des méthodes pour accéder et manipuler ses éléments." >}}
