...
{{% blocks/products/pf/agp/code-block title="Texte de recherche PPT Présentation utilisant Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment rechercher du texte en PPT via Python" >}}
