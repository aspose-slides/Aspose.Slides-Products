---
title: Afficher ou modifier les métadonnées des fichiers PPTM à l'aide de Python
url: /fr/python-net/metadata/pptm/
...
{{% blocks/products/pf/agp/code-block title="Modifier les propriétés intégrées de PPTM - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Ajouter des propriétés personnalisées à PPTM - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment extraire les métadonnées de PPTM via Python" >}}
