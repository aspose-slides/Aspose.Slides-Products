---
title: Afficher ou modifier les métadonnées des fichiers PPS à l'aide de Python
url: /fr/python-net/metadata/pps/
...
{{% blocks/products/pf/agp/code-block title="Modifier les propriétés intégrées de PPS - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Ajouter des propriétés personnalisées à PPS - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment extraire les métadonnées de PPS via Python" >}}
