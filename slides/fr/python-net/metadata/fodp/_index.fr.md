---
title: Afficher ou modifier les métadonnées des fichiers FODP à l'aide de Python
url: /fr/python-net/metadata/fodp/
...
{{% blocks/products/pf/agp/code-block title="Modifier les propriétés intégrées de FODP - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Ajouter des propriétés personnalisées à FODP - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment extraire les métadonnées de FODP via Python" >}}
