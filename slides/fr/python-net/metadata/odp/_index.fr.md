---
title: Afficher ou modifier les métadonnées des fichiers ODP à l'aide de Python
url: /fr/python-net/metadata/odp/
...
{{% blocks/products/pf/agp/code-block title="Modifier les propriétés intégrées de ODP - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Ajouter des propriétés personnalisées à ODP - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment extraire les métadonnées de ODP via Python" >}}
