---
title: Fusionner les fichiers OTP vers BMP à l'aide de Python
url: /fr/python-net/merge/otp-to-bmp/
keywords: Fusionner OTP à BMP, Joindre OTP à BMP, Combiner OTP à BMP, PowerPoint, Présentation, BMP, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Fusionner les fichiers OTP vers BMP ensemble en Python" h2="API Python haute vitesse et multiplateforme qui aide au développement d'applications avec la possibilité de créer, fusionner, inspecter ou convertir des fichiers de présentation Microsoft PowerPoint et OpenOffice sans utiliser de logiciel comme Microsoft ou Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Fusionner OTP à BMP en Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Fusionner les fichiers OTP vers BMP à l'aide de Python" %}}
Pour fusionner les présentations PowerPoint, vous devrez cloner les diapositives d'une présentation à l'autre.

{{% blocks/products/pf/agp/code-block title="Code Python pour fusionner plusieurs OTP en un seul fichier BMP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment fusionner OTP à BMP en utilisant Aspose.Slides pour l'API Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Voici les étapes pour fusionner deux fichiers OTP et enregistrer le résultat sous BMP en Python." >}}
