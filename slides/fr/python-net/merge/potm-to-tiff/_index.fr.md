---
title: Fusionner les fichiers POTM vers TIFF à l'aide de Python
url: /fr/python-net/merge/potm-to-tiff/
keywords: Fusionner POTM à TIFF, Joindre POTM à TIFF, Combiner POTM à TIFF, PowerPoint, Présentation, TIFF, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Fusionner les fichiers POTM vers TIFF ensemble en Python" h2="API Python haute vitesse et multiplateforme qui aide au développement d'applications avec la possibilité de créer, fusionner, inspecter ou convertir des fichiers de présentation Microsoft PowerPoint et OpenOffice sans utiliser de logiciel comme Microsoft ou Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Fusionner POTM à TIFF en Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Fusionner les fichiers POTM vers TIFF à l'aide de Python" %}}
Pour fusionner les présentations PowerPoint, vous devrez cloner les diapositives d'une présentation à l'autre.

{{% blocks/products/pf/agp/code-block title="Code Python pour fusionner plusieurs POTM en un seul fichier TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment fusionner POTM à TIFF en utilisant Aspose.Slides pour l'API Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Voici les étapes pour fusionner deux fichiers POTM et enregistrer le résultat sous TIFF en Python." >}}
