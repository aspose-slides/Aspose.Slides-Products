---
title: Fusionner les fichiers POTM vers POT à l'aide de Python
url: /fr/python-net/merge/potm-to-pot/
keywords: Fusionner POTM à POT, Joindre POTM à POT, Combiner POTM à POT, PowerPoint, Présentation, POT, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Fusionner les fichiers POTM vers POT à l'aide de Python" %}}
Pour fusionner les présentations PowerPoint, vous devrez cloner les diapositives d'une présentation à l'autre.

{{% blocks/products/pf/agp/code-block title="Code Python pour fusionner plusieurs POTM en un seul fichier POT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment fusionner POTM à POT en utilisant Aspose.Slides pour l'API Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Voici les étapes pour fusionner deux fichiers POTM et enregistrer le résultat sous POT en Python." >}}
