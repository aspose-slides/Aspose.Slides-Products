---
title: Fusionner les fichiers PPS vers OTP à l'aide de Python
url: /fr/python-net/merge/pps-to-otp/
keywords: Fusionner PPS à OTP, Joindre PPS à OTP, Combiner PPS à OTP, PowerPoint, Présentation, OTP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Fusionner les fichiers PPS vers OTP à l'aide de Python" %}}
Pour fusionner les présentations PowerPoint, vous devrez cloner les diapositives d'une présentation à l'autre.

{{% blocks/products/pf/agp/code-block title="Code Python pour fusionner plusieurs PPS en un seul fichier OTP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment fusionner PPS à OTP en utilisant Aspose.Slides pour l'API Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Voici les étapes pour fusionner deux fichiers PPS et enregistrer le résultat sous OTP en Python." >}}
