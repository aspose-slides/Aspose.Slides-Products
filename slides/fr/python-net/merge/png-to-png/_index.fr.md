---
title: Fusionner des images PNG en Python
url: /fr/python-net/merge/png-to-png/
keywords: Fusionner PNG, PNG vers PNG, Joindre PNG, Combiner PNG, API Python, Bibliothèque Python
description: Fusionnez PNG à PNG en Python. Utiliser l'API de la bibliothèque Python pour combiner des fichiers PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Fusionner PNG en Python" h2="Bibliothèque Python haute vitesse et multiplateforme pour fusionner des images PNG à l'aide de code Python" >}}

{{% blocks/products/pf/feature-page-section h2="Fusionner PNG à PNG en utilisant Aspose.Slides" %}}

[**Aspose.Slides pour Python via .NET**](https://products.aspose.com/slides/fr/python-net/) est une puissante bibliothèque Python utilisée pour fusionner et manipuler des présentations, des images et d'autres fichiers. Lorsque vous fusionnez PNG à PNG, vous combinez effectivement deux images pour obtenir une image.
...
{{% blocks/products/pf/feature-page-section  h2="Fusionner PNG à PNG en Python" %}}
En utilisant [**Aspose.Slides pour Python via .NET**](https://products.aspose.com/slides/fr/python-net/), vous pouvez fusionner rapidement des fichiers PNG avec seulement quelques lignes de code

{{% blocks/products/pf/agp/code-block title="Code Python pour fusionner PNG à PNG" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="Comment fusionner PNG en Python" >}}
