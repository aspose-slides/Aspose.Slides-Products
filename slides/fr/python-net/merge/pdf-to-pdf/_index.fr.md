...
url: /fr/python-net/merge/pdf-to-pdf/
keywords: Fusionner PDF, PDF à PDF, Joindre PDF, Combiner PDF, API Python, Bibliothèque Python
description: Fusionner PDF en PDF en Python. Utilisez l'API de la bibliothèque Python pour combiner des fichiers PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Fusionner PDF en Python" h2="Bibliothèque Python haute vitesse et multiplateforme pour fusionner des fichiers PDF à l'aide de code Python" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Fusionner PDF en PDF en Python" %}}
En utilisant [**Aspose.Slides pour Python via .NET**](https://products.aspose.com/slides/fr/python-net/), vous pouvez fusionner rapidement des fichiers PDF avec seulement quelques lignes de code

{{% blocks/products/pf/agp/code-block title="Code Python pour fusionner PDF en PDF" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="Comment fusionner un PDF en Python" >}}
