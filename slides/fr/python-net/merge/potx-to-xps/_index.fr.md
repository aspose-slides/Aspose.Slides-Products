---
title: Fusionner les fichiers POTX vers XPS à l'aide de Python
url: /fr/python-net/merge/potx-to-xps/
keywords: Fusionner POTX à XPS, Joindre POTX à XPS, Combiner POTX à XPS, PowerPoint, Présentation, XPS, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Fusionner les fichiers POTX vers XPS à l'aide de Python" %}}
Pour fusionner les présentations PowerPoint, vous devrez cloner les diapositives d'une présentation à l'autre.

{{% blocks/products/pf/agp/code-block title="Code Python pour fusionner plusieurs POTX en un seul fichier XPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Comment fusionner POTX à XPS en utilisant Aspose.Slides pour l'API Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Voici les étapes pour fusionner deux fichiers POTX et enregistrer le résultat sous XPS en Python." >}}
