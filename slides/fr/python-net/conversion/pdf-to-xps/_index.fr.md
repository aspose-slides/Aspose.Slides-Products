...
Besoin de convertir des fichiers PDF en XPS par programmation ? En utilisant [*Aspose.Slides pour Python via .NET*](https://products.aspose.com/slides/fr/python-net/), n'importe quel développeur peut convertir un PDF au format XPS avec seulement quelques lignes de code Python.
