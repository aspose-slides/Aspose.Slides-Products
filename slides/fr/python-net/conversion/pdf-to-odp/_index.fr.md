...
title: Convertir PDF en ODP en Python
weight: 730
url: /fr/python-net/conversion/pdf-to-odp/ 
keywords: "Convert, PowerPoint, PDF, ODP, Presentation, Python"
description: Exemple de code pour la conversion PDF vers ODP Python. Utilisez l'API PowerPoint Python pour la conversion par lots de fichiers PDF en fichiers ODP.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PDF en ODP en Python" h2="Puissante bibliothèque PowerPoint Python pour la conversion de PDF en ODP" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir PDF en ODP en Python" %}}

Besoin de convertir des fichiers PDF en ODP par programmation ? En utilisant [*Aspose.Slides pour Python via .NET*](https://products.aspose.com/slides/fr/python-net/), tout développeur peut convertir un PDF au format ODP avec seulement quelques lignes de code Python.

En tant qu'API de traitement de présentation moderne, Aspose.Slides pour Python crée rapidement ODP à partir de PDF. Testez la qualité de la conversion PDF vers ODP directement dans votre [navigateur](https://products.aspose.app/slides/conversion). La bibliothèque Aspose PowerPoint PPTX vous permet de convertir des fichiers PDF dans de nombreux formats populaires.
...
{{< blocks/products/pf/agp/feature-section-col title="Comment convertir un PDF en ODP en Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Voici les étapes pour convertir un fichier PDF en ODP à l'aide de Python." >}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion PDF en ODP Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer le PDF au format ODP en Python" %}}
Utilisez l'application gratuite pour voir une démonstration du processus de conversion PDF vers ODP. 
{{% /blocks/products/pf/agp/content %}}
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        appName="conversion"
        extension=""
        sectionTitle="Application gratuite pour convertir PDF en ODP" 
        sectionDescription="[Essayez notre application gratuite pour convertir PDF en ODP](https://products.aspose.app/slides/import/)" 
    >}}
