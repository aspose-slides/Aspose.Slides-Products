...
Besoin de convertir des fichiers ODP en PPSX par programme ? En utilisant [*Aspose.Slides pour Python via .NET*](https://products.aspose.com/slides/fr/python-net/), tout développeur peut convertir ODP au format PPSX avec seulement quelques lignes de code Python.
