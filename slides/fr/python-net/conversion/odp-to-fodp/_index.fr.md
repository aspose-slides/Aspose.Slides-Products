...
Besoin de convertir des fichiers ODP en FODP par programmation ? En utilisant [*Aspose.Slides pour Python via .NET*](https://products.aspose.com/slides/fr/python-net/), tout développeur peut convertir le format ODP au format FODP avec seulement quelques lignes de code Python.
