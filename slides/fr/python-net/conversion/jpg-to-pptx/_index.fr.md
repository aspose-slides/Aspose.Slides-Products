---
title: Convertir JPG en PPTX en Python
url: /fr/python-net/conversion/jpg-to-pptx/
keywords: Convertir JPG en PPTX, JPG en PPTX, PowerPoint, JPG, PPTX, API Python, Bibliothèque Python
description: Convertissez JPG en PPTX en Python. Utilisez l'API de la bibliothèque Python pour convertir des images JPG en PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Convertir JPG en PPTX en Python" h2="Puissante API Python multiplateforme pour convertir JPG en PPTX à l'aide de code Python" >}}

{{% blocks/products/pf/feature-page-section h2="Convertir JPG en PPTX en utilisant Aspose.Slides" %}}

[**Aspose.Slides pour Python via .NET**](https://products.aspose.com/slides/fr/python-net/) est une puissante bibliothèque Python utilisée pour créer, convertir et manipuler des présentations PowerPoint, des PDF, Documents HTML et autres fichiers. Lorsque vous convertissez JPG en PPTX, vous créez essentiellement une présentation PowerPoint contenant des diapositives basées sur des images JPG.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Convertir JPG en PPTX en Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Code Python pour convertir JPG en PPTX" offSpacer="true" %}}
```py
...
{{< blocks/products/pf/feature-page-section  h2="Comment convertir JPG en PPTX en Python" >}}
