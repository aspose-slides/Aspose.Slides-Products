...
Besoin de convertir des fichiers FODP en GIF par programme ? En utilisant [*Aspose.Slides pour Python via .NET*](https://products.aspose.com/slides/fr/python-net/), n'importe quel développeur peut convertir le format FODP au format GIF avec seulement quelques lignes de code Python.
