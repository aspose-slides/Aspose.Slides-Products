---
title: Convertir ODP en SVG en Python
weight: 410
url: /fr/python-net/conversion/odp-to-svg/ 
keywords: "Convert, PowerPoint, ODP, SVG, Presentation, Python"
description: Exemple de code pour la conversion ODP en SVG Python. Utilisez l'API PowerPoint Python pour la conversion par lots de fichiers ODP en fichiers SVG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir ODP en SVG en Python" h2="Puissante bibliothèque PowerPoint Python pour convertir ODP en SVG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir ODP en SVG en Python" %}}

Besoin de convertir des fichiers ODP en SVG par programmation ? En utilisant [*Aspose.Slides pour Python via .NET*](https://products.aspose.com/slides/fr/python-net/), tout développeur peut convertir ODP au format SVG avec seulement quelques lignes de code Python.

En tant qu'API de traitement de présentation moderne, Aspose.Slides pour Python crée rapidement du SVG à partir d'ODP. Testez la qualité de la conversion ODP en SVG directement dans votre [navigateur](https://products.aspose.app/slides/conversion). La bibliothèque Aspose PowerPoint PPTX vous permet de convertir des fichiers ODP dans de nombreux formats populaires.
...
{{< blocks/products/pf/agp/feature-section-col title="Comment convertir ODP en SVG en Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Voici les étapes pour convertir un fichier ODP en SVG en utilisant Python." >}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion ODP en SVG Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer ODP au format SVG en Python" %}}
Utilisez l'application gratuite pour voir une démonstration du processus de conversion ODP en SVG. 
{{% /blocks/products/pf/agp/content %}}
