...
weight: 810
url: /fr/python-net/conversion/pdf-to-ppsx/ 
keywords: "Convert, PowerPoint, PDF, PPSX, Presentation, Python"
description: Exemple de code pour la conversion PDF vers PPSX Python. Utilisez l'API PowerPoint Python pour la conversion par lots de fichiers PDF en fichiers PPSX.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PDF en PPSX en Python" h2="Puissante bibliothèque PowerPoint Python pour convertir PDF en PPSX" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir PDF en PPSX en Python" %}}

Besoin de convertir des fichiers PDF en PPSX par programmation ? En utilisant [*Aspose.Slides pour Python via .NET*](https://products.aspose.com/slides/fr/python-net/), tout développeur peut convertir un PDF au format PPSX avec seulement quelques lignes de code Python.

En tant qu'API de traitement de présentation moderne, Aspose.Slides pour Python crée rapidement PPSX à partir de PDF. Testez la qualité de la conversion PDF en PPSX directement dans votre [navigateur](https://products.aspose.app/slides/conversion). La bibliothèque Aspose PowerPoint PPTX vous permet de convertir des fichiers PDF dans de nombreux formats populaires.
...
{{< blocks/products/pf/agp/feature-section-col title="Comment convertir un PDF en PPSX en Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Voici les étapes pour convertir un fichier PDF en PPSX en utilisant Python." >}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion PDF en PPSX Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer le PDF au format PPSX en Python" %}}
Utilisez l'application gratuite pour voir une démonstration du processus de conversion PDF en PPSX. 
{{% /blocks/products/pf/agp/content %}}
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        appName="conversion"
        extension=""
        sectionTitle="Application gratuite pour convertir PDF en PPSX" 
        sectionDescription="[Essayez notre application gratuite pour convertir PDF en PPSX](https://products.aspose.app/slides/import/)" 
    >}}
