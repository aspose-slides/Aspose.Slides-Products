...
Besoin de convertir des fichiers FODP en PPSM par programmation ? En utilisant [*Aspose.Slides pour Python via .NET*](https://products.aspose.com/slides/fr/python-net/), n'importe quel développeur peut convertir le format FODP au format PPSM avec seulement quelques lignes de code Python.
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        appName="conversion"
        extension=""
        sectionTitle="Application gratuite pour convertir FODP en PPSM" 
