...
title: Convertir ODP en PPTM en Python
weight: 390
url: /fr/python-net/conversion/odp-to-pptm/ 
keywords: "Convert, PowerPoint, ODP, PPTM, Presentation, Python"
description: Exemple de code pour la conversion ODP vers PPTM Python. Utilisez l'API PowerPoint Python pour la conversion par lots de fichiers ODP en fichiers PPTM.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir ODP en PPTM en Python" h2="Puissante bibliothèque PowerPoint Python pour convertir ODP en PPTM" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir ODP en PPTM en Python" %}}

Besoin de convertir des fichiers ODP en PPTM par programmation ? En utilisant [*Aspose.Slides pour Python via .NET*](https://products.aspose.com/slides/fr/python-net/), n'importe quel développeur peut convertir ODP au format PPTM avec seulement quelques lignes de code Python.

En tant qu'API de traitement de présentation moderne, Aspose.Slides pour Python crée rapidement PPTM à partir d'ODP. Testez la qualité de la conversion ODP en PPTM directement dans votre [navigateur](https://products.aspose.app/slides/conversion). La bibliothèque Aspose PowerPoint PPTX vous permet de convertir des fichiers ODP dans de nombreux formats populaires.
...
{{< blocks/products/pf/agp/feature-section-col title="Comment convertir ODP en PPTM en Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Voici les étapes pour convertir un fichier ODP en PPTM en utilisant Python." >}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion Python ODP en PPTM" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer ODP en tant que PPTM en Python" %}}
Utilisez l'application gratuite pour voir une démonstration du processus de conversion ODP en PPTM. 
{{% /blocks/products/pf/agp/content %}}
