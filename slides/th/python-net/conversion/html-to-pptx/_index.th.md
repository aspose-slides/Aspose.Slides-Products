---
title: แปลง HTML เป็น PPTX ใน Python
url: /th/python-net/conversion/html-to-pptx/
keywords: แปลง HTML เป็น PPTX, HTML เป็น PPTX, PowerPoint, HTML, PPTX, Python API, Python Library
description: แปลง HTML เป็น PPTX ใน Python ใช้ Python library API เพื่อแปลง HTML เป็น PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="แปลง HTML เป็น PPTX ใน Python" h2="Python API ข้ามแพลตฟอร์มที่มีประสิทธิภาพสำหรับการแปลง HTML เป็น PPTX โดยใช้โค้ด Python" >}}

{{% blocks/products/pf/feature-page-section h2="แปลง HTML เป็น PPTX โดยใช้ Aspose.Slides" %}}

[**Aspose.Slides สำหรับ Python ผ่าน .NET**](https://products.aspose.com/slides/th/python-net/) เป็นไลบรารี Python อันทรงพลังที่ใช้สร้าง แปลง และจัดการงานนำเสนอ PowerPoint, PDF, เอกสาร HTML และไฟล์อื่นๆ เมื่อคุณแปลง HTML เป็น PPTX คุณจะต้องย้ายเนื้อหาในเอกสาร HTML ไปยังสไลด์ในงานนำเสนอ PowerPoint

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="แปลง HTML เป็น PPTX ใน Python" %}}
...
{{% blocks/products/pf/agp/code-block title="รหัส Python สำหรับแปลง HTML เป็น PPTX" offSpacer="true" %}}
```py
...
{{< blocks/products/pf/feature-page-section  h2="วิธีแปลง HTML เป็น PPTX ใน Python" >}}
