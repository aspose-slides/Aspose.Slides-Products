...
{{% blocks/products/pf/agp/code-block title="แก้ไข PPSM คุณสมบัติในตัว - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="เพิ่มคุณสมบัติที่กำหนดเองใน PPSM - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="วิธีดึงข้อมูลเมตาของ PPSM ผ่าน Python" >}}
