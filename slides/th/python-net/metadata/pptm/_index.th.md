...
{{% blocks/products/pf/agp/code-block title="แก้ไข PPTM คุณสมบัติในตัว - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="เพิ่มคุณสมบัติที่กำหนดเองใน PPTM - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="วิธีดึงข้อมูลเมตาของ PPTM ผ่าน Python" >}}
