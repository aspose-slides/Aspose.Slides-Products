...
{{% blocks/products/pf/agp/code-block title="แก้ไข POT คุณสมบัติในตัว - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="เพิ่มคุณสมบัติที่กำหนดเองใน POT - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="วิธีดึงข้อมูลเมตาของ POT ผ่าน Python" >}}
