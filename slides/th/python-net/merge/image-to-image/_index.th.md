---
title: รวมรูปภาพใน Python
url: /th/python-net/merge/image-to-image/
keywords: รวมภาพ, ภาพต่อภาพ, รวมภาพ, รวมภาพ, Python API, Python Library
description: รวมรูปภาพกับรูปภาพใน Python ใช้ Python library API เพื่อรวมรูปภาพ
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge image in Python" h2="ไลบรารี Python ข้ามแพลตฟอร์มความเร็วสูงสำหรับการรวมรูปภาพโดยใช้โค้ด Python" >}}

{{% blocks/products/pf/feature-page-section h2="รวมรูปภาพกับรูปภาพโดยใช้ Aspose.Slides" %}}

[**Aspose.Slides สำหรับ Python ผ่าน .NET**](https://products.aspose.com/slides/th/python-net/) เป็นไลบรารี Python อันทรงพลังที่ใช้ในการรวมและจัดการงานนำเสนอ รูปภาพ และไฟล์อื่นๆ เมื่อคุณรวมรูปภาพเข้ากับรูปภาพ คุณกำลังรวมรูปภาพสองรูปเข้าด้วยกันอย่างมีประสิทธิภาพเพื่อให้ได้รูปภาพเดียว
...
{{% blocks/products/pf/feature-page-section  h2="รวมรูปภาพกับรูปภาพใน Python" %}}
...
{{% blocks/products/pf/agp/code-block title="รหัส Python สำหรับการรวมรูปภาพเข้ากับรูปภาพ" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="วิธีผสานรูปภาพใน Python" >}}
