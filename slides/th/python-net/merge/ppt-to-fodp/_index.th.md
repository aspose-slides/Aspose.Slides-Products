---
title: รวมไฟล์ PPT เข้ากับ FODP โดยใช้ Python
url: /th/python-net/merge/ppt-to-fodp/
keywords: รวม PPT เป็น FODP เข้าร่วม PPT ถึง FODP รวม PPT เป็น FODP PowerPoint การนำเสนอ FODP Python Aspose
...
{{% blocks/products/pf/feature-page-section  h2="รวมไฟล์ PPT เข้ากับ FODP โดยใช้ Python" %}}
ในการผสานงานนำเสนอ PowerPoint คุณจะต้องโคลนสไลด์จากงานนำเสนอหนึ่งไปยังอีกงานนำเสนอหนึ่ง

{{% blocks/products/pf/agp/code-block title="รหัสหลามสำหรับรวมหลาย ๆ PPT เป็นไฟล์เดียว FODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="วิธีผสาน PPT กับ FODP โดยใช้ Aspose.Slides สำหรับ Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="นี่คือขั้นตอนในการรวมไฟล์ PPT สองไฟล์เข้าด้วยกัน และบันทึกผลลัพธ์เป็น FODP ใน Python" >}}
