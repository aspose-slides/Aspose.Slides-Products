---
title: รวมไฟล์ PPTX เข้ากับ ODP โดยใช้ Python
url: /th/python-net/merge/pptx-to-odp/
keywords: รวม PPTX เป็น ODP เข้าร่วม PPTX ถึง ODP รวม PPTX เป็น ODP PowerPoint การนำเสนอ ODP Python Aspose
...
{{% blocks/products/pf/feature-page-section  h2="รวมไฟล์ PPTX เข้ากับ ODP โดยใช้ Python" %}}
ในการผสานงานนำเสนอ PowerPoint คุณจะต้องโคลนสไลด์จากงานนำเสนอหนึ่งไปยังอีกงานนำเสนอหนึ่ง

{{% blocks/products/pf/agp/code-block title="รหัสหลามสำหรับรวมหลาย ๆ PPTX เป็นไฟล์เดียว ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="วิธีผสาน PPTX กับ ODP โดยใช้ Aspose.Slides สำหรับ Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="นี่คือขั้นตอนในการรวมไฟล์ PPTX สองไฟล์เข้าด้วยกัน และบันทึกผลลัพธ์เป็น ODP ใน Python" >}}
