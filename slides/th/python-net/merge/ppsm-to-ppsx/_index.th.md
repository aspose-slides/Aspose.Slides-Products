---
title: รวมไฟล์ PPSM เข้ากับ PPSX โดยใช้ Python
url: /th/python-net/merge/ppsm-to-ppsx/
keywords: รวม PPSM เป็น PPSX เข้าร่วม PPSM ถึง PPSX รวม PPSM เป็น PPSX PowerPoint การนำเสนอ PPSX Python Aspose
...
{{% blocks/products/pf/feature-page-section  h2="รวมไฟล์ PPSM เข้ากับ PPSX โดยใช้ Python" %}}
ในการผสานงานนำเสนอ PowerPoint คุณจะต้องโคลนสไลด์จากงานนำเสนอหนึ่งไปยังอีกงานนำเสนอหนึ่ง

{{% blocks/products/pf/agp/code-block title="รหัสหลามสำหรับรวมหลาย ๆ PPSM เป็นไฟล์เดียว PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="วิธีผสาน PPSM กับ PPSX โดยใช้ Aspose.Slides สำหรับ Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="นี่คือขั้นตอนในการรวมไฟล์ PPSM สองไฟล์เข้าด้วยกัน และบันทึกผลลัพธ์เป็น PPSX ใน Python" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/th/python-net/merge/ppsm-to-xps/" name="PPSM TO XPS" >}}  
