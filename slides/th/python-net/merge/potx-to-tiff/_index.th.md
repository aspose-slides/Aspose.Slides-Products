---
title: รวมไฟล์ POTX เข้ากับ TIFF โดยใช้ Python
url: /th/python-net/merge/potx-to-tiff/
keywords: รวม POTX เป็น TIFF เข้าร่วม POTX ถึง TIFF รวม POTX เป็น TIFF PowerPoint การนำเสนอ TIFF Python Aspose
...
{{% blocks/products/pf/feature-page-section  h2="รวมไฟล์ POTX เข้ากับ TIFF โดยใช้ Python" %}}
ในการผสานงานนำเสนอ PowerPoint คุณจะต้องโคลนสไลด์จากงานนำเสนอหนึ่งไปยังอีกงานนำเสนอหนึ่ง

{{% blocks/products/pf/agp/code-block title="รหัสหลามสำหรับรวมหลาย ๆ POTX เป็นไฟล์เดียว TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="วิธีผสาน POTX กับ TIFF โดยใช้ Aspose.Slides สำหรับ Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="นี่คือขั้นตอนในการรวมไฟล์ POTX สองไฟล์เข้าด้วยกัน และบันทึกผลลัพธ์เป็น TIFF ใน Python" >}}
