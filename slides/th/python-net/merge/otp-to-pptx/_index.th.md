---
title: รวมไฟล์ OTP เข้ากับ PPTX โดยใช้ Python
url: /th/python-net/merge/otp-to-pptx/
keywords: รวม OTP เป็น PPTX เข้าร่วม OTP ถึง PPTX รวม OTP เป็น PPTX PowerPoint การนำเสนอ PPTX Python Aspose
...
{{% blocks/products/pf/feature-page-section  h2="รวมไฟล์ OTP เข้ากับ PPTX โดยใช้ Python" %}}
ในการผสานงานนำเสนอ PowerPoint คุณจะต้องโคลนสไลด์จากงานนำเสนอหนึ่งไปยังอีกงานนำเสนอหนึ่ง

{{% blocks/products/pf/agp/code-block title="รหัสหลามสำหรับรวมหลาย ๆ OTP เป็นไฟล์เดียว PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="วิธีผสาน OTP กับ PPTX โดยใช้ Aspose.Slides สำหรับ Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="นี่คือขั้นตอนในการรวมไฟล์ OTP สองไฟล์เข้าด้วยกัน และบันทึกผลลัพธ์เป็น PPTX ใน Python" >}}
