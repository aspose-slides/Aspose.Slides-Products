---
title: รวมไฟล์ ODP เข้ากับ POTM โดยใช้ Python
url: /th/python-net/merge/odp-to-potm/
keywords: รวม ODP เป็น POTM เข้าร่วม ODP ถึง POTM รวม ODP เป็น POTM PowerPoint การนำเสนอ POTM Python Aspose
...
{{% blocks/products/pf/feature-page-section h2="รวม ODP เป็น POTM ใน Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="รวมไฟล์ ODP เข้ากับ POTM โดยใช้ Python" %}}
ในการผสานงานนำเสนอ PowerPoint คุณจะต้องโคลนสไลด์จากงานนำเสนอหนึ่งไปยังอีกงานนำเสนอหนึ่ง

{{% blocks/products/pf/agp/code-block title="รหัสหลามสำหรับรวมหลาย ๆ ODP เป็นไฟล์เดียว POTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="วิธีผสาน ODP กับ POTM โดยใช้ Aspose.Slides สำหรับ Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="นี่คือขั้นตอนในการรวมไฟล์ ODP สองไฟล์เข้าด้วยกัน และบันทึกผลลัพธ์เป็น POTM ใน Python" >}}
