---
title: รวมรูปภาพใน PHP
url: /th/php-java/merger/image-to-image/
keywords: รวมภาพ, ภาพต่อภาพ, รวมภาพ, รวมภาพ, PHP API, PHP Library
description: รวมรูปภาพกับรูปภาพใน PHP ใช้ PHP library API เพื่อรวมรูปภาพ
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="รวมรูปภาพใน PHP" h2="ไลบรารี PHP ความเร็วสูงและข้ามแพลตฟอร์มสำหรับการรวมรูปภาพโดยใช้โค้ด PHP" >}}

{{% blocks/products/pf/feature-page-section h2="รวมรูปภาพกับรูปภาพโดยใช้ Aspose.Slides" %}}

[**Aspose.Slides สำหรับ PHP ผ่าน Java**](https://products.aspose.com/slides/th/php-java/) เป็นไลบรารี PHP ที่มีประสิทธิภาพที่ใช้ในการรวมและจัดการงานนำเสนอ รูปภาพ และไฟล์อื่นๆ เมื่อคุณรวมรูปภาพเข้ากับรูปภาพ คุณกำลังรวมรูปภาพสองรูปเข้าด้วยกันอย่างมีประสิทธิภาพเพื่อให้ได้รูปภาพเดียว
...
{{% blocks/products/pf/feature-page-section  h2="รวมรูปภาพกับรูปภาพใน PHP" %}}
...
{{% blocks/products/pf/agp/code-block title="โค้ด PHP สำหรับการรวมรูปภาพเข้ากับรูปภาพ" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="วิธีผสานรูปภาพใน PHP" >}}
