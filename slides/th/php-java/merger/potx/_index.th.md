...
{{< blocks/products/pf/feature-page-section  h2="วิธีผสาน POTX โดยใช้ Aspose.Slides สำหรับ PHP API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="นี่คือขั้นตอนในการรวมไฟล์ POTX สองไฟล์และบันทึกผลลัพธ์เป็น POTX ใน PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
โหลดไฟล์ POTX ที่คุณต้องการผสาน
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
บันทึกเอกสาร POTX ที่ได้
{{< /blocks/products/pf/agp/step-autogen >}}
