---
title: รวมไฟล์ PDF ใน PHP
url: /th/php-java/merger/pdf-to-pdf/
keywords: ผสาน PDF, PDF เป็น PDF, เข้าร่วม PDF, รวม PDF, PHP API, PHP Library
description: รวม PDF เป็น PDF ใน PHP ใช้ PHP library API เพื่อรวมไฟล์ PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="รวม PDF ใน PHP" h2="ไลบรารี PHP ความเร็วสูงและข้ามแพลตฟอร์มสำหรับการรวมไฟล์ PDF โดยใช้โค้ด PHP" >}}

{{% blocks/products/pf/feature-page-section h2="รวม PDF เป็น PDF โดยใช้ Aspose.Slides" %}}

[**Aspose.Slides สำหรับ PHP ผ่าน Java**](https://products.aspose.com/slides/th/php-java/) เป็นไลบรารี PHP ที่มีประสิทธิภาพที่ใช้สร้าง แปลง ผสาน และจัดการงานนำเสนอ PDF และเอกสารอื่นๆ เมื่อคุณผสาน PDF เป็น PDF คุณกำลังรวมหน้าจากเอกสาร 2 ฉบับอย่างมีประสิทธิภาพเพื่อให้ได้ไฟล์ PDF ไฟล์เดียว Aspose.Slides ช่วยให้คุณผสาน PDF ในรูปแบบต่างๆ คุณสามารถรวมไฟล์ PDF เข้ากับรูปร่าง สไตล์ ข้อความ การจัดรูปแบบ และอื่นๆ
...
{{% blocks/products/pf/feature-page-section  h2="รวม PDF เป็น PDF ใน PHP" %}}
การใช้ [**Aspose.Slides สำหรับ PHP ผ่าน Java**](https://products.aspose.com/slides/th/php-java/) คุณสามารถรวมไฟล์ PDF ได้อย่างรวดเร็วด้วยโค้ดเพียงไม่กี่บรรทัด

{{% blocks/products/pf/agp/code-block title="รหัส PHP สำหรับการรวม PDF เป็น PDF" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="วิธีผสาน PDF ใน PHP" >}}
