---
title: รวม JPG เป็น PDF ใน PHP
url: /th/php-java/merger/jpg-to-pdf/
keywords: JPG เป็น PDF, รวม JPG เป็น PDF, เข้าร่วม JPG เป็น PDF, PDF, JPG, PHP API, PHP Library
description: รวม JPG เป็น PDF ใน PHP ใช้ PHP library API เพื่อรวม JPG และ PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="รวม JPG เป็น PDF ใน PHP" h2="ไลบรารี PHP ความเร็วสูงและข้ามแพลตฟอร์มสำหรับการรวมไฟล์ JPG เป็น PDF โดยใช้โค้ด PHP" >}}

{{% blocks/products/pf/feature-page-section h2="รวม JPG เป็น PDF โดยใช้ Aspose.Slides" %}}

[**Aspose.Slides สำหรับ PHP ผ่าน Java**](https://products.aspose.com/slides/th/php-java/) เป็นไลบรารี PHP ที่มีประสิทธิภาพที่ใช้สร้าง แปลง ผสาน และจัดการงานนำเสนอ PDF รูปภาพ และไฟล์อื่นๆ เมื่อคุณรวม JPG เข้ากับ PDF คุณกำลังรวมรูปภาพ JPG อย่างมีประสิทธิภาพเพื่อให้ได้ไฟล์ PDF ไฟล์เดียว
...
{{% blocks/products/pf/feature-page-section  h2="รวม JPG เป็น PDF ใน PHP" %}}
เมื่อใช้ [**Aspose.Slides สำหรับ PHP ผ่าน Java**](https://products.aspose.com/slides/th/php-java/) คุณสามารถรวม JPG เป็น PDF ได้อย่างรวดเร็วด้วยโค้ดเพียงไม่กี่บรรทัด

{{% blocks/products/pf/agp/code-block title="รหัส PHP สำหรับการรวม JPG เป็น PDF" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="วิธีรวม JPG เป็น PDF ใน PHP" >}}
