...
<p class="col-lg-10">ฝังแผนภูมิ Excel เป็นวัตถุ OLE ในสไลด์</p>

</div>

<div class="col-lg-4"><em class="fa fa-print  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">จัดการ Ole Objects ที่เชื่อมโยง</p>
...
<p class="col-lg-10">การพิมพ์แบบกำหนดเองของงานนำเสนอ</p>
...
<h2 class="h2title">การรวมคุณสมบัติใหม่อย่างต่อเนื่อง</h2>

<p>คุณจะไม่ถูกจำกัดคุณสมบัติที่มีอยู่ ทีมผลิตภัณฑ์ของเราได้เพิ่มคุณสมบัติอย่างต่อเนื่อง และทุกเวอร์ชันใหม่มีคุณลักษณะมากกว่าเมื่อเทียบกับเวอร์ชันเก่า คุณยังสามารถส่งคำขอคุณสมบัติใหม่ได้ หากคุณพบว่าคุณสมบัติที่คุณต้องการขาดหายไป ต่อไปนี้คือรายการตัวเลือกบางส่วนจากฟีเจอร์ล่าสุด</p>

<ul>

<li>Rasterization หรือ vectorization ของ Shapes โดยไม่มีข้อความ</li>

<li>แปลงภาพ SVG เป็นรูปร่าง</li>

<li>รับพื้นหลังตารางเริ่มต้น</li>

<li>จำกัดการเข้าถึงระบบไฟล์ในเครื่องเมื่อเปิดเอกสาร</li>

<li>เพิ่มการเข้ารหัสเมตาแท็กเมื่อบันทึกเป็น HTML</li>

<li>การตั้งค่าการลบแอตทริบิวต์ width และ height ของแท็ก SVG เมื่อบันทึกเป็น HTML</li>

<li>Support for

<ul>

<li>การตอบกลับความคิดเห็น Office 365 และเวิร์กบุ๊ก Excel ภายนอก</li>

<li>ขนาดแสดงถึงคุณสมบัติของแผนภูมิฟอง</li>

<li>การซ่อนบานหน้าต่างรูปขนาดย่อของสไลด์ด้านซ้ายใน PPT ที่สร้างขึ้น</li>

<li>แผนภูมิกรวย แผนภูมิแผนที่ 2 มิติ และกำหนดเส้นทางเวิร์กบุ๊กแหล่งข้อมูลภายนอกของแผนภูมิ</li>

<li>การเข้ารหัส OpenDocument การเปลี่ยนมอร์ฟและคุณลักษณะตัวเน้นข้อความ</li>

<li>การตั้งค่าคุณสมบัติความโปร่งใสสำหรับเอฟเฟกต์เงา</li>

<li>การตั้งค่ารูปร่างคำบรรยายสำหรับป้ายกำกับข้อมูลชุดข้อมูล</li>

<li>รับเอฟเฟกต์ตามย่อหน้าของกล่องข้อความ</li>

<li>การแสดงเอฟเฟกต์ขอบนุ่ม (EffectFormat)</li>

<li>ChartData SetRange บนตาราง Pivot</li>

</ul>

</li>

<li>ใช้รูปแบบ Tiff แบบหลายหน้า, ส่วนขยาย Metafile Format Plus (EMF+) และรูปแบบ Open XML ที่เข้มงวด</li>

<li>การแสดงความคิดเห็นจากรูปแบบ ODP ที่ไม่มีผู้เขียน</li>

<li>ใช้การทำให้เป็นอนุกรมกับการปฏิบัติตามรูปแบบ Open XML ที่เข้มงวด</li>
...
<h2 class="h2title">การประมวลผลรูปร่าง SmartArt</h2>

<p>Aspose.Slides สำหรับ C++ ช่วยอำนวยความสะดวกในการสร้างรูปร่าง SmartArt ตั้งแต่เริ่มต้น ตลอดจนให้ความสามารถในการเข้าถึง จัดการ หรือเอารูปร่าง SmartArt ที่มีอยู่ออกจากสไลด์ นอกจากนี้ยังสามารถจัดรูปแบบรูปร่าง SmartArt เช่น ลักษณะการตั้งค่า สี และเค้าโครง</p>
