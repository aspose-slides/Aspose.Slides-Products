---
title: แยกข้อความและรูปภาพจากเอกสาร PPTX ผ่าน C++
weight: 2290
url: /th/cpp/parser/pptx/ 
description: โค้ดตัวอย่าง C++ เพื่อแยกข้อความและรูปภาพจากไฟล์ PPTX บน C++ Runtime Environment สำหรับ Windows 32 บิต, Windows 64 บิต และ Linux 64 บิต
---
...
{{% blocks/products/pf/agp/content h2="วิธีแยกวิเคราะห์ไฟล์ PPTX โดยใช้ C++" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/th/cpp/parser/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
