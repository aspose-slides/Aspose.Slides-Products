---
title: แยกข้อความและรูปภาพจากเอกสาร ODP ผ่าน C++
weight: 460
url: /th/cpp/parser/odp/ 
description: โค้ดตัวอย่าง C++ สำหรับดึงข้อความและรูปภาพจากไฟล์ ODP บน C++ Runtime Environment สำหรับ Windows 32 บิต, Windows 64 บิต และ Linux 64 บิต
---
...
{{% blocks/products/pf/agp/content h2="วิธีแยกวิเคราะห์ไฟล์ ODP โดยใช้ C++" %}}
