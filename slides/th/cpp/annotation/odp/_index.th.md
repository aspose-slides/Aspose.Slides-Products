---
title: ลบคำอธิบายประกอบ ODP โดยใช้ C++
weight: 4380
url: /th/cpp/annotation/odp/ 
description: ซอร์สโค้ด C++ เพื่อลบคำอธิบายประกอบจาก ODP
---
...
ในการลบคำอธิบายประกอบออกจากไฟล์ ODP เราจะใช้ [Aspose.Slides สำหรับ C++](https://products.aspose.com/slides/th/cpp/) API ซึ่งมีคุณลักษณะหลากหลาย ทรงพลัง และใช้งานง่าย API การจัดการเอกสารสำหรับแพลตฟอร์ม C++
