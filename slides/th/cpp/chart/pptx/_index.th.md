...
{{< blocks/products/pf/agp/steps-block-autogen name="การสร้างแผนภูมิเอกสารพื้นฐานด้วย API ของ [Aspose.Slides for C++](https://products.aspose.com/slides/th/cpp/) สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/th/cpp/chart/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
