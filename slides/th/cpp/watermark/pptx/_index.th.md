---
title: เอกสารลายน้ำ PPTX ผ่าน C++
weight: 2900
url: /th/cpp/watermark/pptx/ 
description: โค้ดตัวอย่าง C++ เพื่อเพิ่มหรือลบลายน้ำในไฟล์ PPTX บน C++ Runtime Environment สำหรับ Windows 32 บิต, Windows 64 บิต และ Linux 64 บิต
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="เพิ่มลายน้ำข้อความไปยัง PPTX ผ่าน C++" h2="สร้างแอป C++ ของคุณเองเพื่อใส่ลายน้ำไฟล์ PPTX โดยใช้ API ฝั่งเซิร์ฟเวอร์" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{< blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการเพิ่มลายน้ำให้กับ PPTX ผ่าน C++" >}}
...
{{% blocks/products/pf/agp/code-block title="เพิ่มลายน้ำให้กับ PPTX - C++" offSpacer="" %}}
