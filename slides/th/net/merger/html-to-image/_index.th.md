...
url: /th/net/merger/html-to-image/
keywords: ผสาน HTML เข้ากับรูปภาพ, HTML เข้ากับรูปภาพ, เข้าร่วม HTML, รวม HTML, รูปภาพ, C# API, .NET Library
description: รวม HTML เข้ากับรูปภาพใน C# ใช้ .NET library API เพื่อรวม HTML เข้ากับรูปภาพ
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="รวมรูปภาพใน C#" h2=".NET API ข้ามแพลตฟอร์มอันทรงพลังสำหรับการผสาน HTML เข้ากับรูปภาพโดยใช้โค้ด C# บน NET Framework, .NET Core, Windows Azure, Mono หรือ Xamarin Platforms" >}}

{{% blocks/products/pf/feature-page-section h2="รวม HTML เข้ากับรูปภาพโดยใช้ Aspose.Slides" %}}

[**Aspose.Slides สำหรับ .NET**](https://products.aspose.com/slides/th/net/) เป็นไลบรารี .NET ที่มีประสิทธิภาพซึ่งใช้ในการรวมและจัดการงานนำเสนอ เอกสาร HTML และไฟล์อื่นๆ เมื่อคุณรวม HTML เข้ากับรูปภาพ คุณกำลังรวมเนื้อหาในเอกสาร HTML เพื่อให้ได้รูปภาพเดียวอย่างมีประสิทธิภาพ 
