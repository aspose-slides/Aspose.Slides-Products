---
title: ปลดล็อกเอกสาร PPT ผ่าน .NET
weight: 8650
url: /th/net/unlock/ppt/ 
description: ซอร์สโค้ด C# เพื่อปลดล็อกไฟล์ PPT ที่ป้องกันด้วยรหัสผ่านบน .NET Framework, .NET Core, Windows Azure, Mono หรือ Xamarin Platforms
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ปลดล็อกการนำเสนอ PPT ผ่าน C#" h2="ลบการป้องกันจาก PPT โดยใช้ไลบรารี .NET" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีปลดล็อกไฟล์ PPT โดยใช้ C #" %}}

 เพื่อลบไฟล์ป้องกัน PPT เราจะใช้
...
{{< blocks/products/pf/agp/feature-section-col title="ปลดล็อก PPT ผ่าน C #" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/th/net/unlock/pptx/" name="PPTX" description="เปิดรูปแบบการนำเสนอ XML" >}}
