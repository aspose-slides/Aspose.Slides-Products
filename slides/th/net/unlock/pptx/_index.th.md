---
title: ปลดล็อกเอกสาร PPTX ผ่าน .NET
weight: 6480
url: /th/net/unlock/pptx/ 
description: ซอร์สโค้ด C# เพื่อปลดล็อกไฟล์ PPTX ที่ป้องกันด้วยรหัสผ่านบน .NET Framework, .NET Core, Windows Azure, Mono หรือ Xamarin Platforms
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ปลดล็อกการนำเสนอ PPTX ผ่าน C#" h2="ลบการป้องกันจาก PPTX โดยใช้ไลบรารี .NET" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีปลดล็อกไฟล์ PPTX โดยใช้ C #" %}}

 เพื่อลบการป้องกันไฟล์ PPTX เราจะใช้
...
{{< blocks/products/pf/agp/feature-section-col title="ปลดล็อก PPTX ผ่าน C#" >}}
...
โหลด PPTX ที่ถูกล็อคด้วยตัวอย่างการนำเสนอ
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
ตรวจสอบการป้องกันโดยใช้คุณสมบัติประเภทบูลีน IProtectionManager.IsWriteProtected
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
ลบการป้องกันโดยใช้เมธอด IProtectionManager.RemoveWriteProtection
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/other-supported-section title="รูปแบบการปลดล็อกอื่น ๆ ที่รองรับ" subTitle="เมื่อใช้ C # เราสามารถลบการป้องกัน / ปลดล็อกรูปแบบต่าง ๆ ได้อย่างง่ายดายรวมถึง" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/th/net/unlock/odp/" name="ODP" description="รูปแบบการนำเสนอ OpenDocument" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/th/net/unlock/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
