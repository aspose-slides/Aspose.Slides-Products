...
keywords: PNG เป็น JPG, แปลง PNG เป็น JPG, C# API, .NET Library
description: แปลง PNG เป็น JPG ใน C# ใช้ .NET library API เพื่อแปลงไฟล์ PNG เป็น JPG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="แปลง PNG เป็น JPG ใน C#" h2="PowerPoint .NET API สำหรับแปลงไฟล์ภาพ PNG เป็น JPG บน NET Framework, .NET Core, Windows Azure, Mono หรือ Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="แปลง PNG เป็น JPG ใน C#" %}}

ฉันจะแปลง PNG เป็น JPG ในรหัสได้อย่างไร

การใช้ [**Aspose.Slides for .NET**](https://products.aspose.com/slides/th/net/) นักพัฒนาซอฟต์แวร์หรือแอปพลิเคชันใดๆ สามารถแปลง PNG เป็น JPG ด้วยโค้ด C# เพียงไม่กี่บรรทัด

ในฐานะที่เป็น API การประมวลผลเอกสารที่ทันสมัย ​​Aspose.Slides for .NET จะส่งออกไฟล์ PNG เป็น JPG อย่างรวดเร็ว Aspose ไลบรารี PowerPoint ช่วยให้คุณสามารถแปลง PNG เป็น JPG และรูปภาพในรูปแบบอื่นได้
...
{{< blocks/products/pf/agp/feature-section-col title="วิธีแปลง PNG เป็น JPG ใน C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="นักพัฒนาและแอปพลิเคชันสามารถแปลง PNG เป็น JPG ด้วยวิธีนี้:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 ก่อนที่คุณจะรันโค้ด C# ของการแปลง PNG เป็น JPG เครื่องของคุณต้องมีข้อกำหนดเบื้องต้นเหล่านี้:
...
{{% blocks/products/pf/agp/code-block title="รหัส C# เพื่อแปลง PNG เป็น JPG" offSpacer="" %}}
