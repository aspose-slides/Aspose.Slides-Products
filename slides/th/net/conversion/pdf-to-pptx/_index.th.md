...
url: /th/net/conversion/pdf-to-pptx/
keywords: แปลง PDF เป็น PPTX, PDF เป็น PPTX, PowerPoint, PDF, PPTX, C# API, .NET Library
description: แปลง PDF เป็น PPTX ใน C# ใช้ .NET library API เพื่อแปลงไฟล์ PDF เป็น PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="แปลง PDF เป็น PPTX ใน C#" h2=".NET API ข้ามแพลตฟอร์มอันทรงพลังสำหรับการแปลง PDF เป็น PPTX โดยใช้โค้ด C# บนแพลตฟอร์ม NET Framework, .NET Core, Windows Azure, Mono หรือ Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="แปลง PDF เป็น PPTX โดยใช้ Aspose.Slides" %}}

[**Aspose.Slides สำหรับ .NET**](https://products.aspose.com/slides/th/net/) เป็นไลบรารี .NET ที่มีประสิทธิภาพซึ่งใช้ในการสร้าง แปลง และจัดการงานนำเสนอ PowerPoint, PDF, เอกสาร HTML และไฟล์อื่นๆ เมื่อคุณแปลง PDF เป็น PPTX คุณจะต้องย้ายเนื้อหาในหน้า PDF ไปยังสไลด์ในงานนำเสนอ PowerPoint
...
{{% blocks/products/pf/agp/code-block title="รหัส C# สำหรับแปลง PDF เป็น PPTX" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="วิธีแปลง PDF เป็น PPTX ใน C#" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
โหลดไฟล์ PDF ที่คุณต้องการแปลงเป็น PPTX
{{< /blocks/products/pf/agp/step-autogen >}}
