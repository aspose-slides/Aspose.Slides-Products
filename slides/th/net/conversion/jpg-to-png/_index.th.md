...
keywords: JPG เป็น PNG, แปลง JPG เป็น PNG, C# API, .NET Library
description: แปลง JPG เป็น PNG ใน C# ใช้ .NET library API เพื่อแปลงไฟล์ JPG เป็น PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="แปลง JPG เป็น PNG ใน C#" h2="PowerPoint .NET API สำหรับการแปลงไฟล์ภาพ JPG เป็น PNG บน NET Framework, .NET Core, Windows Azure, Mono หรือ Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="แปลง JPG เป็น PNG ใน C#" %}}

ฉันจะแปลง JPG เป็น PNG เป็นรหัสได้อย่างไร

การใช้ [**Aspose.Slides for .NET**](https://products.aspose.com/slides/th/net/) นักพัฒนาหรือแอปพลิเคชันใดๆ สามารถแปลง JPG เป็น PNG ด้วยโค้ด C# เพียงไม่กี่บรรทัด

ในฐานะที่เป็น API การประมวลผลเอกสารที่ทันสมัย ​​Aspose.Slides for .NET จะส่งออกไฟล์ JPG ไปยัง PNG อย่างรวดเร็ว Aspose ไลบรารี PowerPoint ช่วยให้คุณสามารถแปลง JPG เป็น PNG และรูปภาพในรูปแบบอื่นได้
...
{{< blocks/products/pf/agp/feature-section-col title="วิธีแปลง JPG เป็น PNG ใน C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="นักพัฒนาและแอปพลิเคชันสามารถแปลง JPG เป็น PNG ด้วยวิธีนี้:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 ก่อนที่คุณจะรันโค้ด C# ของการแปลง JPG เป็น PNG เครื่องของคุณต้องมีข้อกำหนดเบื้องต้นเหล่านี้:
...
{{% blocks/products/pf/agp/code-block title="รหัส C# เพื่อแปลง JPG เป็น PNG" offSpacer="" %}}
