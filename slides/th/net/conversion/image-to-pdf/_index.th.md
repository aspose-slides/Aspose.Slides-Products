...
title: แปลงรูปภาพเป็น PDF ใน C#
weight: 30
url: /th/net/conversion/image-to-pdf/ 
keywords: รูปภาพเป็น PDF, แปลงรูปภาพเป็น PDF, C# API, .NET Library, รูปภาพ, JPG, PNG, PDF
description: แปลงรูปภาพเป็น PDF ใน C# ใช้ .NET library API เพื่อแปลงรูปภาพเป็นเอกสาร PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="แปลงรูปภาพเป็น PDF ใน C#" h2="PowerPoint .NET API สำหรับแปลงรูปภาพเป็นเอกสาร PDF บน NET Framework, .NET Core, Windows Azure, Mono หรือ Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลงรูปภาพเป็น PDF ใน C#" %}}

ฉันจะแปลงรูปภาพเป็น PDF โดยทางโปรแกรมได้อย่างไร

การใช้ [**Aspose.Slides for .NET**](https://products.aspose.com/slides/th/net/) นักพัฒนาซอฟต์แวร์หรือแอปพลิเคชันใดๆ สามารถแปลงรูปภาพเป็นรูปแบบ PDF ด้วยโค้ด C# เพียงไม่กี่บรรทัด

ในฐานะที่เป็น API การประมวลผลเอกสารที่ทันสมัย ​​Aspose.Slides for .NET จะสร้าง PDF จากรูปภาพ JPG หรือ PNG อย่างรวดเร็ว ไลบรารี Aspose PowerPoint ช่วยให้คุณสามารถแปลงรูปภาพเป็น PDF และรูปแบบไฟล์อื่น ๆ ได้มากมาย
...
{{< blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลงรูปภาพเป็น PDF ใน C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="นักพัฒนาและแอปพลิเคชันสามารถแปลงรูปภาพเป็น PDF ด้วยวิธีนี้:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 ก่อนที่คุณจะรันโค้ด C# ของการแปลงรูปภาพเป็น PDF เครื่องของคุณต้องมีข้อกำหนดเบื้องต้นเหล่านี้:
...
{{% blocks/products/pf/agp/code-block title="รหัส C# เพื่อแปลงรูปภาพเป็น PDF" offSpacer="" %}}
