...
weight: 120
url: /th/net/conversion/pdf-to-xml/ 
keywords: PDF เป็น XML, แปลง PDF เป็น XML, C# API, .NET Library, PDF, XML
description: แปลง PDF เป็น XML ใน C # ใช้ .NET library API เพื่อแปลงหน้า PDF เป็นไฟล์ XML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="แปลง PDF เป็น XML ใน C #" h2="PowerPoint .NET API สำหรับแปลงเอกสาร PDF เป็นไฟล์ XML บน NET Framework, .NET Core, Windows Azure, Mono หรือ Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง PDF เป็น XML ใน C #" %}}

ฉันจะแปลง PDF เป็น XML ในโค้ดได้อย่างไร

การใช้ [**Aspose.Slides for .NET**](https://products.aspose.com/slides/th/net/) นักพัฒนาหรือแอปพลิเคชันใดๆ สามารถแปลง PDF เป็นไฟล์ XML ด้วยโค้ด C# เพียงไม่กี่บรรทัด

ในฐานะที่เป็น API การประมวลผลเอกสารที่ทันสมัย ​​Aspose.Slides สำหรับ .NET จะส่งออกหน้า PDF ไปยัง XML อย่างรวดเร็ว ไลบรารี Aspose PowerPoint ช่วยให้คุณสามารถแปลง PDF เป็น XML และรูปแบบไฟล์อื่น ๆ ได้มากมาย
...
{{< blocks/products/pf/agp/feature-section-col title="วิธีแปลง PDF เป็น XML ใน C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="นักพัฒนาและแอปพลิเคชันสามารถแปลง PDF เป็น XML ด้วยวิธีนี้:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 ก่อนที่คุณจะรันโค้ด C# ของการแปลง PDF เป็น XML เครื่องของคุณต้องมีข้อกำหนดเบื้องต้นเหล่านี้:
...
{{% blocks/products/pf/agp/code-block title="รหัส C# เพื่อแปลง PDF เป็น XML" offSpacer="" %}}
