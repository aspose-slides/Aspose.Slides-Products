...
title: แปลง JPG เป็นรูปภาพใน C#
weight: 210
url: /th/net/conversion/jpg-to-image/ 
keywords: JPG เป็นรูปภาพ, แปลง JPG เป็นรูปภาพ, C# API, .NET Library
description: แปลง JPG เป็นรูปภาพใน C# ใช้ .NET library API เพื่อแปลง JPG เป็นรูปภาพในรูปแบบต่างๆ
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="แปลง JPG เป็นรูปภาพใน C#" h2="PowerPoint .NET API สำหรับแปลงรูปภาพ JPG เป็นไฟล์รูปภาพบน NET Framework, .NET Core, Windows Azure, Mono หรือ Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="แปลง JPG เป็นรูปภาพใน C#" %}}

ฉันจะแปลง JPG เป็นรูปภาพในรหัสได้อย่างไร

การใช้ [**Aspose.Slides for .NET**](https://products.aspose.com/slides/th/net/) นักพัฒนาซอฟต์แวร์หรือแอปพลิเคชันใดๆ สามารถแปลง JPG เป็น Image ด้วยโค้ด C# เพียงไม่กี่บรรทัด

ในฐานะที่เป็น API การประมวลผลเอกสารที่ทันสมัย ​​Aspose.Slides for .NET จะส่งออกไฟล์ JPG ไปยังรูปภาพในรูปแบบอื่นได้อย่างรวดเร็ว Aspose PowerPoint ช่วยให้คุณแปลง JPG เป็นรูปภาพและรูปแบบไฟล์อื่น ๆ อีกมากมาย
...
{{< blocks/products/pf/agp/feature-section-col title="วิธีแปลง JPG เป็นรูปภาพใน C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="นักพัฒนาและแอปพลิเคชันสามารถแปลง JPG เป็นรูปภาพได้ด้วยวิธีนี้:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 ก่อนที่คุณจะรันโค้ด C# ของการแปลง JPG เป็น Image เครื่องของคุณต้องมีข้อกำหนดเบื้องต้นเหล่านี้:
...
{{% blocks/products/pf/agp/code-block title="รหัส C# เพื่อแปลง JPG เป็น Image" offSpacer="" %}}
