---
title: แปลงรูปภาพเป็น JPG ใน C#
weight: 200
url: /th/net/conversion/image-to-jpg/ 
keywords: รูปภาพเป็น JPG, แปลงรูปภาพเป็น JPG, C# API, .NET Library, รูปภาพ, JPG
description: แปลงรูปภาพเป็น JPG ใน C# ใช้ .NET library API เพื่อแปลงรูปภาพเป็นรูปภาพ JPG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="แปลงรูปภาพเป็น JPG ใน C#" h2="PowerPoint .NET API สำหรับแปลงรูปภาพเป็นรูปภาพ JPG บน NET Framework, .NET Core, Windows Azure, Mono หรือ Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="แปลงรูปภาพเป็น JPG ใน C#" %}}

ฉันจะแปลงรูปภาพเป็น JPG ในโค้ดได้อย่างไร

การใช้ [**Aspose.Slides for .NET**](https://products.aspose.com/slides/th/net/) นักพัฒนาซอฟต์แวร์หรือแอปพลิเคชันใดๆ สามารถแปลงรูปภาพเป็นรูปภาพ JPG ด้วยโค้ด C# เพียงไม่กี่บรรทัด .

ในฐานะที่เป็น API การประมวลผลเอกสารที่ทันสมัย ​​Aspose.Slides for .NET จะส่งออกรูปภาพในรูปแบบยอดนิยมไปยัง JPG อย่างรวดเร็ว ไลบรารี Aspose PowerPoint ช่วยให้คุณสามารถแปลงรูปภาพเป็น JPG และรูปแบบรูปภาพอื่น ๆ ได้มากมาย
...
{{< blocks/products/pf/agp/feature-section-col title="วิธีแปลงรูปภาพเป็น JPG ใน C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="นักพัฒนาและแอปพลิเคชันสามารถแปลงรูปภาพเป็น JPG ด้วยวิธีนี้:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 ก่อนที่คุณจะรันโค้ด C# ของการแปลง Image เป็น JPG เครื่องของคุณต้องมีข้อกำหนดเบื้องต้นเหล่านี้:
...
{{% blocks/products/pf/agp/code-block title="รหัส C# เพื่อแปลงรูปภาพเป็น JPG" offSpacer="" %}}
