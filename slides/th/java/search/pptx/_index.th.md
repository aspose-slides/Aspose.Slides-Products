...
{{% blocks/products/pf/agp/code-block title="ค้นหาข้อความ PPTX งานนำเสนอโดยใช้ Java" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="วิธีค้นหาข้อความใน PPTX ผ่าน Java" >}}
