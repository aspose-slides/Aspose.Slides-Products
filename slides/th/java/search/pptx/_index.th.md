---
title: ค้นหาเอกสาร PPTX โดยไม่ต้องเปิดผ่าน Java
weight: 8800
url: /th/java/search/pptx/ 
description: โค้ดตัวอย่าง Java เพื่อค้นหาคำที่มีรูปแบบในไฟล์ PPTX บน Java Runtime Environment สำหรับแอปพลิเคชัน JSP/JSF และแอปพลิเคชันเดสก์ท็อป
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ค้นหารูปแบบ PPTX ใน Java" h2="การค้นหาเอกสาร PPTX ดั้งเดิมและประสิทธิภาพสูงโดยใช้ Aspose.Slides ฝั่งเซิร์ฟเวอร์สำหรับ Java API โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Adobe PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีค้นหาไฟล์ PPTX โดยใช้ Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการค้นหาไฟล์ PPTX ใน Java" >}}
...
โหลดไฟล์ PPTX โดยสร้างอ็อบเจ็กต์ Presentation Class
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="ค้นหาไฟล์ PPTX - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/th/java/search/odp/" name="ODP" description="รูปแบบการนำเสนอ OpenDocument" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/th/java/search/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
