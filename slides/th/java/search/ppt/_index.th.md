...
{{% blocks/products/pf/agp/content h2="วิธีค้นหาไฟล์ PPT โดยใช้ Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการค้นหาไฟล์ PPT ใน Java" >}}
...
โหลดไฟล์ PPT โดยการสร้างอินสแตนซ์คลาสอ็อบเจ็กต์
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="ค้นหาไฟล์ PPT - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/th/java/search/pptx/" name="PPTX" description="เปิดรูปแบบการนำเสนอ XML" >}}
