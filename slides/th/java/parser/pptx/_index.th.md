---
title: แยกข้อความและรูปภาพจากเอกสาร PPTX ผ่าน Java
weight: 1000
url: /th/java/parser/pptx/ 
description: โค้ดตัวอย่าง Java เพื่อแยกข้อความและรูปภาพจากไฟล์ PPTX บน Java Runtime Environment สำหรับแอปพลิเคชัน JSP/JSF และแอปพลิเคชันเดสก์ท็อป
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="แยกวิเคราะห์รูปแบบ PPTX ใน Java" h2="การแยกวิเคราะห์เอกสาร PPTX ดั้งเดิมและประสิทธิภาพสูงโดยใช้ Aspose.Slides ฝั่งเซิร์ฟเวอร์สำหรับ Java API โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Adobe PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแยกไฟล์ PPTX โดยใช้ Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแยกวิเคราะห์ไฟล์ PPTX ใน Java" >}}
...
โหลดไฟล์ PPTX โดยสร้างคลาสการนำเสนอ
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="แยกไฟล์ PPTX - Java" offSpacer="" %}}
