---
title: รวมรูปภาพเป็น PDF ใน Java
url: /th/java/merger/image-to-pdf/
keywords: รูปภาพเป็น PDF, รวมรูปภาพเป็น PDF, รวมรูปภาพเป็น PDF, PDF, รูปภาพ, Java API, Java Library
description: รวมรูปภาพเป็น PDF ใน Java ใช้ Java library API เพื่อรวม Image และ PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="รวมรูปภาพเป็น PDF ใน Java" h2="ไลบรารี Java ความเร็วสูงและข้ามแพลตฟอร์มสำหรับการรวมไฟล์ Image กับ PDF โดยใช้โค้ด Java" >}}

{{% blocks/products/pf/feature-page-section h2="รวมรูปภาพเป็น PDF โดยใช้ Aspose.Slides" %}}

[**Aspose.Slides สำหรับ Java**](https://products.aspose.com/slides/th/java/) คือไลบรารี Java อันทรงพลังที่ใช้สร้าง แปลง ผสาน และจัดการงานนำเสนอ PDF รูปภาพ และอื่นๆ ไฟล์. เมื่อคุณรวมรูปภาพเป็น PDF คุณกำลังรวมรูปภาพอย่างมีประสิทธิภาพเพื่อให้ได้ไฟล์ PDF ไฟล์เดียว
...
{{% blocks/products/pf/feature-page-section  h2="รวมรูปภาพเป็น PDF ใน Java" %}}
เมื่อใช้ [**Aspose.Slides สำหรับ Java**](https://products.aspose.com/slides/th/java/) คุณสามารถผสานรูปภาพเป็น PDF ได้อย่างรวดเร็วด้วยโค้ดเพียงไม่กี่บรรทัด

{{% blocks/products/pf/agp/code-block title="รหัส Java สำหรับการรวมรูปภาพเป็น PDF" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="วิธีรวมรูปภาพเป็น PDF ใน Java" >}}
