...
description: รวม TIFF เป็น PDF ใน Java ใช้ Java library API เพื่อรวม TIFF และ PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="รวม TIFF เป็น PDF ใน Java" h2="ไลบรารี Java ความเร็วสูงและข้ามแพลตฟอร์มสำหรับการรวมไฟล์ TIFF เป็น PDF โดยใช้โค้ด Java" >}}

{{% blocks/products/pf/feature-page-section h2="รวม TIFF เป็น PDF โดยใช้ Aspose.Slides" %}}

[**Aspose.Slides สำหรับ Java**](https://products.aspose.com/slides/th/java/) คือไลบรารี Java อันทรงพลังที่ใช้สร้าง แปลง ผสาน และจัดการงานนำเสนอ PDF รูปภาพ และอื่นๆ ไฟล์. เมื่อคุณรวม TIFF เป็น PDF คุณจะรวมรูปภาพได้อย่างมีประสิทธิภาพเพื่อให้ได้ไฟล์ PDF ไฟล์เดียว
...
{{% blocks/products/pf/feature-page-section  h2="รวม TIFF เป็น PDF ใน Java" %}}
เมื่อใช้ [**Aspose.Slides สำหรับ Java**](https://products.aspose.com/slides/th/java/) คุณสามารถรวม TIFF เป็น PDF ได้อย่างรวดเร็วด้วยโค้ดเพียงไม่กี่บรรทัด

{{% blocks/products/pf/agp/code-block title="รหัส Java สำหรับการรวม TIFF เป็น PDF" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="วิธีรวม TIFF เป็น PDF ใน Java" >}}
