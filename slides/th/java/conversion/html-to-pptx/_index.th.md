---
title: แปลง HTML เป็น PPTX ใน Java
url: /th/java/conversion/html-to-pptx/
keywords: แปลง HTML เป็น PPTX, HTML เป็น PPTX, PowerPoint, HTML, PPTX, Java API, Java Library
description: แปลง HTML เป็น PPTX ใน Java ใช้ Java library API เพื่อแปลง HTML เป็น PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="แปลง HTML เป็น PPTX ใน Java" h2="Java API ข้ามแพลตฟอร์มที่มีประสิทธิภาพสำหรับการแปลง HTML เป็น PPTX โดยใช้โค้ด Java" >}}

{{% blocks/products/pf/feature-page-section h2="แปลง HTML เป็น PPTX โดยใช้ Aspose.Slides" %}}

[**Aspose.Slides สำหรับ Java**](https://products.aspose.com/slides/th/java/) เป็นไลบรารี Java อันทรงพลังที่ใช้สร้าง แปลง และจัดการงานนำเสนอ PowerPoint, PDF, เอกสาร HTML และอื่นๆ ไฟล์. เมื่อคุณแปลง HTML เป็น PPTX คุณจะต้องย้ายเนื้อหาในเอกสาร HTML ไปยังสไลด์ในงานนำเสนอ PowerPoint

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="แปลง HTML เป็น PPTX ใน Java" %}}
...
{{% blocks/products/pf/agp/code-block title="โค้ด Java สำหรับแปลง HTML เป็น PPTX" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="วิธีแปลง HTML เป็น PPTX ใน Java" >}}
