...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">คุณสมบัติ API การประมวลผลเอกสาร Java PowerPoint ขั้นสูง</h2>

<p>Aspose.Slides for Java มีคุณลักษณะขั้นสูงจำนวนหนึ่งที่ช่วยให้นักพัฒนาสามารถควบคุมได้อย่างสมบูรณ์เมื่อเขียนโปรแกรมด้วยงานนำเสนอ Microsoft PowerPoint ในสภาพแวดล้อม Java</p>-->
   <h2 class="pr-ft">
...
<h2 class="h2title">การจัดรูปแบบเนื้อหาสไลด์</h2>

<p>เป็นไปได้ที่จะจัดรูปแบบข้อความและรูปร่างบนสไลด์ในงานนำเสนอโดยใช้ Aspose.Slides สำหรับ Java API ข้อความได้รับการจัดการผ่านกรอบข้อความที่เกี่ยวข้องกับรูปร่าง ดังนั้นข้อความจึงถูกจัดรูปแบบโดยใช้ย่อหน้าและส่วนที่เกี่ยวข้องกับกรอบข้อความ คุณยังสามารถจัดการแอตทริบิวต์ขององค์ประกอบรูปร่างได้ เช่น ตำแหน่ง ขนาด เส้น รูปภาพ ข้อความ และการเติม</p>
