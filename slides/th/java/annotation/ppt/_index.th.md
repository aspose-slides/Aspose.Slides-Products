---
title: ลบคำอธิบายประกอบ PPT ผ่าน Java
weight: 3630
url: /th/java/annotation/ppt/ 
description: โค้ดตัวอย่าง Java สำหรับลบคำอธิบายประกอบรูปแบบ PPT บน Java Runtime Environment สำหรับแอปพลิเคชัน JSP/JSF และแอปพลิเคชันเดสก์ท็อป
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ลบความคิดเห็นและผู้เขียนความคิดเห็นจาก PPT ผ่าน Java" h2="สร้างแอป Java ของคุณเองเพื่อจัดการความคิดเห็นและผู้เขียนในไฟล์เอกสารโดยใช้ API ฝั่งเซิร์ฟเวอร์" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการลบความคิดเห็นจาก PPT ผ่าน Java" %}}
...
1. บันทึกในรูปแบบ PPT
1. ลบความคิดเห็น ณ สถานที่เฉพาะ
1. บันทึกไฟล์ PPT อีกครั้งและเปรียบเทียบ
...
{{% blocks/products/pf/agp/code-block title="ลบคำอธิบายประกอบจาก PPT - Java" offSpacer="" %}}
