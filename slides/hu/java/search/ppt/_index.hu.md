---
title: Szöveg keresése PPT prezentációs fájlokban a Java használatával
...
{{% blocks/products/pf/agp/code-block title="Keresési szöveges PPT prezentáció a Java használatával" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Szöveg keresése PPT nyelven a Java segítségével" >}}
