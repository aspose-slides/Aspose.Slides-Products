...
{{% blocks/products/pf/agp/content h2="Hogyan lehet ODP-fájlt megjegyzésekkel ellátni Java használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a megjegyzések eltávolításához az ODP-ről Java segítségével" %}}
...
1. Mentse el ODP formátumban
1. Távolítsa el a megjegyzést egy adott helyen
1. Mentse újra az ODP-fájlt, és hasonlítsa össze
...
{{% blocks/products/pf/agp/code-block title="Annotációk törlése az ODP-ből – Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/hu/java/annotation/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
