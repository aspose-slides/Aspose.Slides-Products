---
title: Távolítsa el a PPTX megjegyzést Java-n keresztül
weight: 360
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet megjegyzéseket fűzni PPTX fájlhoz Java használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a megjegyzések eltávolításához a PPTX-ből Java segítségével" %}}
...
1. Mentse el PPTX formátumban
1. Távolítsa el a megjegyzést egy adott helyen
1. Mentse el újra a PPTX fájlt, és hasonlítsa össze
...
{{% blocks/products/pf/agp/code-block title="Annotációk törlése a PPTX - Java programból" offSpacer="" %}}
