---
title: PNG egyesítése PDF-be Java nyelven
url: /hu/java/merger/png-to-pdf/
keywords: PNG PDF-be, PNG egyesítése PDF-be, PNG csatlakozás PDF-be, PDF, PNG, Java API, Java Library
description: PNG egyesítése PDF-be Java nyelven. Használja a Java könyvtár API-t a PNG és a PDF kombinálásához
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="PNG egyesítése PDF-be Java nyelven" h2="Nagy sebességű és többplatformos Java könyvtár PNG-fájlok és PDF-fájlok egyesítéséhez Java kód használatával" >}}

{{% blocks/products/pf/feature-page-section h2="PNG egyesítése PDF-be az Aspose.Slides segítségével" %}}

Az [**Aspose.Slides for Java**](https://products.aspose.com/slides/hu/java/) egy hatékony Java-könyvtár, amely prezentációk, képek és egyéb fájlok létrehozására, konvertálására, egyesítésére és kezelésére szolgál. Ha PNG-t PDF-be egyesít, akkor hatékonyan kombinálja a PNG-képeket, hogy egyetlen PDF-fájlt kapjon.
...
{{% blocks/products/pf/feature-page-section  h2="PNG egyesítése PDF-be Java nyelven" %}}
Az [**Aspose.Slides for Java**](https://products.aspose.com/slides/hu/java/) használatával gyorsan egyesítheti a PNG-t PDF-formátumba, mindössze néhány sornyi kóddal.

{{% blocks/products/pf/agp/code-block title="Java kód a PNG és a PDF egyesítéséhez" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Hogyan lehet PNG-t PDF-be egyesíteni Java-ban" >}}
