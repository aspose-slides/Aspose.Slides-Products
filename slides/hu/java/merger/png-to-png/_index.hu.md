---
title: PNG-képek egyesítése Java-ban
url: /hu/java/merger/png-to-png/
keywords: PNG, PNG egyesítése PNG-be, csatlakozás PNG-hez, PNG egyesítése, Java API, Java könyvtár
description: PNG egyesítése PNG-vel Java nyelven. Használja a Java könyvtár API-t a PNG-fájlok kombinálásához
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="PNG egyesítése Java-ban" h2="Nagy sebességű és többplatformos Java-könyvtár PNG-képek Java kóddal történő egyesítéséhez" >}}

{{% blocks/products/pf/feature-page-section h2="PNG és PNG egyesítése az Aspose.Slides segítségével" %}}

Az [**Aspose.Slides for Java**](https://products.aspose.com/slides/hu/java/) egy hatékony Java-könyvtár, amellyel prezentációkat, képeket és egyéb fájlokat egyesíthet és kezelhet. Ha PNG-t PNG-vel egyesít, akkor hatékonyan kombinál két képet, hogy egy képet kapjon.
...
{{% blocks/products/pf/feature-page-section  h2="PNG egyesítése PNG-vel Java nyelven" %}}
Az [**Aspose.Slides for Java**](https://products.aspose.com/slides/hu/java/) használatával gyorsan egyesíthet PNG-fájlokat, mindössze néhány sornyi kóddal.

{{% blocks/products/pf/agp/code-block title="Java kód a PNG és a PNG egyesítéséhez" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Hogyan lehet PNG-t egyesíteni Java-ban" >}}
