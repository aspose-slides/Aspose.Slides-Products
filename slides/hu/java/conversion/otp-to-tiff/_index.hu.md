...
{{% blocks/products/pf/agp/content h2="Hogyan lehet az OTP-t TIFF-re konvertálni Java használatával" %}}

 Az OTP TIFF formátumban való megjelenítéséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az OTP TIFF-re konvertálásához Java segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztők könnyedén konvertálhatnak OTP fájlt TIFF formátumba, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="OTP TIFF Java konvertálási forráskód" offSpacer="" %}}
