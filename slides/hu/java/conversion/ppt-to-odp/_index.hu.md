...
{{% blocks/products/pf/agp/content h2="Hogyan lehet PPT-t ODP-vé konvertálni Java használatával" %}}

 Ahhoz, hogy a PPT-t ODP-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a PPT ODP-vé konvertálásához Java segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztők könnyedén konvertálhatják a PPT fájlt ODP-vé, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="PPT ODP Java konverziós forráskód" offSpacer="" %}}
