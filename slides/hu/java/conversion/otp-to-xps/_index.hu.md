...
{{% blocks/products/pf/agp/content h2="Hogyan lehet az OTP-t XPS-re konvertálni Java használatával" %}}

 Ahhoz, hogy az OTP-t XPS-re rendereljük, ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az OTP XPS-re konvertálásához Java segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztők egyszerűen konvertálhatják az OTP fájlt XPS-re, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="OTP-ből XPS-be konvertáló Java-forráskód" offSpacer="" %}}
