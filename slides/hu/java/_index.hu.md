...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Speciális Java PowerPoint dokumentumfeldolgozási API-szolgáltatások</h2>

<p>Az Aspose.Slides for Java számos fejlett funkciót tartalmaz, amelyek teljes irányítást biztosítanak a fejlesztőknek, amikor Microsoft PowerPoint prezentációkkal programoznak Java környezetben.</p>-->
   <h2 class="pr-ft">
...
<h2 class="h2title">Diák tartalom formázása</h2>

<p>Lehetőség van szövegek és alakzatok formázására a prezentáció diákjain az Aspose.Slides for Java API segítségével. A szöveg kezelése alakzatokhoz társított szövegkereteken keresztül történik. Ezért a szöveg formázása a szövegkeretekhez társított bekezdésekkel és részekkel történik. Az alakelemek attribútumait is módosíthatja, például pozíciót, méretet, vonalat, képet, szöveget és kitöltést.</p>
...
{{< blocks/products/pf/slr-element name="Kiadási megjegyzések" href="https://docs.aspose.com/slides/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
