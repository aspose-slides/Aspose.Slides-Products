...
weight: 5190
url: /hu/net-core/ 
description: Aspose.Slides .NET Core API a PowerPoint .NET Core megoldások létrehozásához.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1=".NET Core API for Presentations" h2="Hozzon létre többplatformos .NET Core megoldásokat prezentációk feldolgozásához PowerPoint és Office Automation nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-net-core.svg" pfName="Aspose.Slides" subTitlepfName="for .NET Core" downloadUrl="https://downloads.aspose.com/slides/net" >}}
...
<p>
 Az Aspose.Slides for .NET Core prezentációfeldolgozási megoldások létrehozására használható bármilyen operációs rendszeren: Windows, Linux vagy macOS. Prezentáció és elemeinek létrehozása és módosítása: szöveg, táblázatok, diagramok, média, animációk, SmartArts és ActiveX elemek.
</p>

<p>
 Bővítse alkalmazásait prezentációnézegetővel, készítővel, konvertálóval, szerkesztővel, sablonkészítővel, kezelővel, egyesítővel, összehasonlítóval, elosztóval, nyomtatóval, védővel és másokkal. Lehetővé teszi a C# alkalmazások számára, hogy módosítsák a prezentáció tartalmát: szövegek, táblázatok, diagramok, média, SmartArts, ActiveX.
</p>

<p>
 Az Aspose.Slides .NET Core PowerPoint API egyedülálló lehetőséget kínál a kódduplikáció elkerülésére és a .NET Core platform minden erejének kihasználására. Az API a PowerPointtól vagy az Open Office-tól függetlenül működik, és nincs szükség rájuk.
</p>
...
{{< blocks/products/pf/carousel-item h3="Ránézésre" description="Az Aspose.Slides által készített .NET Core PowerPoint API képességeinek áttekintése." >}}
...
{{< blocks/products/pf/carousel-item h3="Platformfüggetlenség" description="Aspose.Slides for .NET Core for Windows, Linux és macOS." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <!--/left-->
  <!--/right-->
...
{{< blocks/products/pf/carousel-item h3="Támogatott fájlformátumok" description="Az Aspose.Slides for .NET Core támogatja az alább felsorolt ​​népszerű [prezentációs formátumokat](https://docs.aspose.com/slides/net/supported-file-formats/) és exportformátumokat." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    A .NET Core PowerPoint API speciális szolgáltatásai
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Prezentáció konvertálása .NET Core-ban
    </h2>
    <p>
     Az Aspose.Slides for .NET Core API bármilyen PowerPoint prezentációs formátumot konvertálhat dokumentum-, kép-, web- vagy fájlformátummá. Néhány népszerű konverziós formátum: PDF, HTML, JPEG, XPS. A prezentációs formátumok egymás között is konvertálhatók (például PPT-ből PPTX-be, PPTX-ből ODP-be), vagy sablonformátumba (például PPTX-ből POTM-be), diavetítés-formátumba (pl. PPTX-ből PPSX-be) és fordítva. A konvertált fájl minősége a legmagasabb az Aspose.Slides által a PowerPoint .NET Core API-hoz fejlesztett renderelő motornak köszönhetően. Biztos lehet benne, hogy bármilyen prezentációt bármilyen operációs rendszerre konvertál: Windows, Linux vagy macOS.
    </p>
...
prs.Save(dir + "output.tiff", Aspose.Slides.Export.SaveFormat.Tiff);</code></pre>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Prezentáció módosítása a .NET Core-ban
    </h2>
    <p>
     Az Aspose.Slides for .NET Core segítségével módosíthatja a prezentáció logikáját és megjelenését. Minden szöveges tartalom szerkeszthető olyan elemeken keresztül, mint a szöveg, bekezdés, rész, táblázat, jegyzet, megjegyzés, matematikai szimbólum. 2D, 3D effektusok és animációk állnak rendelkezésre alakzatokhoz, diagramokhoz, SmartArt-okhoz és WordArt-okhoz. A prezentációtervezés sablon, téma, diaminta, diaelrendezés segítségével hozható létre. A média, a vízjel, az ActiveX az Aspose.Slides által a PowerPoint .NET Core API-n keresztül is elérhető.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Egyesítés, összehasonlítás, felosztás, bemutató nyomtatása .NET Core-ban
    </h2>
    <p>
     Az Aspose.Slides for .NET Core számos olyan további funkciót támogat, amelyeket a PowerPoint és más, harmadik féltől származó prezentációs szoftverek nem biztosítanak. Ezek közé tartozik a prezentációk és sablonok összehasonlítása, a prezentációk felosztása az egyéni logika alapján, a különböző formátumú prezentációk összevonása, a sablonok egyesítése/alkalmazása prezentációk készletébe, prezentációk nyomtatása stb.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Az Aspose.Slides for .NET Core-hoz nem szükséges a Microsoft Office vagy a Microsoft PowerPoint telepítése a gépen ahhoz, hogy PowerPoint formátumokkal működjön. Tökéletes Microsoft Office automatizálási alternatíva a támogatott szolgáltatások, biztonság, stabilitás, méretezhetőség, sebesség és ár tekintetében.
    </p>
   </div>
   <!--<div class="col-lg-12">

<h2 class="h2title">Az Office Open XML támogatása</h2>

<p>Az Office OpenXML (OOXML) az XML-alapú formátum, amelyet a Microsoft Office 2007-be vezettek be.</p>

<p>A PresentationML (OOXML, PPTX) a Microsoft Office PowerPoint 2007 által a dokumentumok tárolására használt jelölőnyelv. Az Aspose.Slides for .NET széles körben támogatja a PresentationML dokumentumok létrehozását, olvasását, kezelését és írását.</p>
...
{{< blocks/products/pf/slr-element name="Kiadási megjegyzések" href="https://releases.aspose.com/slides/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Miért az Aspose.Slides for .NET Core?" tabId="success-stories" >}}
