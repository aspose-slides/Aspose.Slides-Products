...
{{% blocks/products/pf/agp/content h2="Hogyan keressünk ODP fájlokat C++ használatával" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Lépések az ODP-fájlok kereséséhez C++ nyelven" >}}
...
{{% blocks/products/pf/agp/code-block title="ODP-fájlok keresése - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/hu/cpp/search/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/hu/cpp/search/pptx/" name="PPTX" description="Nyissa meg az XML prezentációs formátumot" >}}
