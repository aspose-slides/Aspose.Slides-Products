...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztők könnyedén konvertálhatnak PPT fájlt BMP-vé, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="PPT-ből BMP C++ konverziós forráskód" offSpacer="" %}}
