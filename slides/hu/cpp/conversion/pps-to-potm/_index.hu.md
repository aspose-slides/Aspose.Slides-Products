...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a PPS konvertálásához POTM-má C++ segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A C++ fejlesztők könnyedén konvertálhatnak PPS fájlt POTM-re, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="PPS-ből POTM C++ konverziós forráskód" offSpacer="" %}}
