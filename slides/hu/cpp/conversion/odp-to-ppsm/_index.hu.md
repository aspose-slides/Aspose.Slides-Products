...
{{% blocks/products/pf/agp/content h2="Hogyan lehet ODP-t PPSM-re konvertálni C++ használatával" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztők könnyedén konvertálhatnak ODP-fájlt PPSM-re, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="ODP–PPSM C++ konverziós forráskód" offSpacer="" %}}
