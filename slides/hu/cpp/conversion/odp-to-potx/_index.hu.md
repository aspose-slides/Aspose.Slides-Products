...
{{% blocks/products/pf/agp/content h2="Hogyan lehet ODP-t POTX-re konvertálni C++ használatával" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztők könnyedén konvertálhatnak ODP fájlt POTX-re, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="ODP-POTX C++ konverziós forráskód" offSpacer="" %}}
