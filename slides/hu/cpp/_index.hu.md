...
<p class="col-lg-10">Beágyazhat Excel diagramokat OLE-objektumként a diákba</p>

</div>

<div class="col-lg-4"><em class="fa fa-print  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Kapcsolt Ole objektumok kezelése</p>
...
<p class="col-lg-10">Egyedi prezentációk nyomtatása</p>
...
<h2 class="h2title">Az új funkciók folyamatos integrálása</h2>

<p>Ön soha nem korlátozódik a meglévő funkciókra. Termékcsapataink folyamatosan újabb és újabb funkciókat adnak hozzá, és minden új verzió több funkciót kínál a régebbi verziókhoz képest. Új funkciókra vonatkozó kéréseket is küldhet, ha úgy találja, hogy valamelyik kívánt funkció hiányzik. Íme a lista a legújabb funkciókból.</p>

<ul>

<li>Alakzatok raszterizálása vagy vektorizálása szöveg nélkül.</li>

<li>Konvertálja az SVG képeket alakzatokká.</li>

<li>Szerezze meg az alapértelmezett táblázat hátterét.</li>

<li>A helyi fájlrendszerhez való hozzáférés korlátozása dokumentum megnyitásakor.</li>

<li>Kódolási metatag hozzáadása a HTML-be történő mentéskor.</li>

<li>Beállítás az SVG címke szélesség és magasság attribútumainak eltávolításához HTML formátumban történő mentéskor.</li>

<li>Support for

<ul>

<li>Megjegyzésekre adott válaszok, Office 365 és külső Excel-munkafüzetek.</li>

<li>A méret a buborékdiagram tulajdonságait jelöli.</li>

<li>A bal oldali dia miniatűrök ablaktábla elrejtése a generált PPT-ben.</li>

<li>Tölcsérdiagramok, 2D térképdiagramok és halmazdiagramok külső adatforrás munkafüzet elérési útja.</li>

<li>OpenDocument titkosítás, Morph Transition és Text Highlighter funkció.</li>

<li>Átlátszóság tulajdonság beállítása árnyékhatásokhoz.</li>

<li>Kiemelés alakjának beállítása a sorozat adatcímkéjéhez.</li>

<li>Szerezzen effektusokat szövegdoboz-bekezdések alapján.</li>

<li>Alakzat renderelése Soft Edges (EffectFormat) effektus.</li>

<li>ChartData SetRange egy kimutatástáblán.</li>

</ul>

</li>

<li>Valósítson meg többoldalas Tiff formátumot, Metafile Format Plus Extensions (EMF+) és Strict Open XML formátumot.</li>

<li>ODP formátumból származó megjegyzések megjelenítése, amelyeknek nincs szerzőjük.</li>

<li>Végezze el a szerializálást a Strict Open XML formátum megfelelőségével.</li>
...
prs-&gt;Save(dir + L"output.xps", Aspose::Slides::Export::SaveFormat::Xps);</code></pre>
   ...
   <div class="col-lg-12">
    ...
    <p>
     A Library lehetővé teszi alakzatok és szövegek formázását a fájl diákjain API használata közben. A szöveg kezelése alakzatokhoz társított szövegkereteken keresztül történik, ezért a szöveg formázása a szövegkeretekhez társított bekezdésekkel és részekkel történik. Kezelheti a betűtípust, a színt, a méretet, az árnyalatokat, valamint a bekezdések igazítását, felsorolását és tájolását. Az alakelemek attribútumait, például a méretet, vonalat, pozíciót, képet, szöveget és kitöltést is könnyedén kezelheti.
    </p>
   </div>
   <!--<div class="col-lg-12">

<h2 class="h2title">SmartArt alakzatok feldolgozása</h2>

<p>Az Aspose.Slides for C++ megkönnyíti a SmartArt-alakzatok létrehozását a semmiből, valamint lehetővé teszi a meglévő SmartArt-alakzatok elérését, kezelését vagy eltávolítását a diákról. Ezenkívül lehetőség van a SmartArt alakzatok formázására is, például stílus, szín és elrendezés beállítására.</p>
...
{{< blocks/products/pf/slr-element name="Kiadási megjegyzések" href="https://releases.aspose.com/slides/cpp/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
