...
url: /hu/cpp/merger/svg-to-png/
keywords: Egyesítse az SVG-t PNG-be, az SVG-t a PNG-be, az SVG-t egyesítse a PNG-be, az SVG-t egyesítse a PNG-be, a C++ API-t, a C++-könyvtárat
description: Egyesítse az SVG-t PNG-be C++-ban. Használja a C++ könyvtár API-t az SVG és PNG fájlok kombinálásához
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Egyesítse az SVG-t PNG-be C++-ban" h2="Nagy sebességű és többplatformos C++ könyvtár az SVG és PNG képek egyesítéséhez C++ kóddal" >}}

{{% blocks/products/pf/feature-page-section h2="Egyesítse az SVG-t PNG-be az Aspose.Slides segítségével" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/hu/cpp/) egy hatékony C++ könyvtár, amellyel prezentációkat, képeket és egyéb fájlokat egyesíthet és kezelhet. Ha egyesíti az SVG-t PNG-vel, akkor hatékonyan kombinálja az SVG-képeket, hogy PNG-képet kapjon.
...
Az [**Aspose.Slides for C++**](https://products.aspose.com/slides/hu/cpp/) használatával gyorsan egyesítheti az SVG-fájlokat PNG-fájlokkal, mindössze néhány sornyi kóddal.
