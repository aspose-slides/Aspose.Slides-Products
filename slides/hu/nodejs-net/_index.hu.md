 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <ul>
      <li>Az Aspose.Slides for Node.js a .NET-en keresztül a Node.js-en alapuló szerveroldali JavaScript API. Windows, Unix/Linux és Mac platformokon futhat .NET6 vagy újabb verzióval.</li>
    </ul>
   </div>
   <div class="col-lg-12">
...
createEmptyPresentation(); // Execute the function to create an empty presentation
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Diák hozzáadása/eltávolítása és alakzattulajdonságok szerkesztése a Node.js-ben</h2>
...
function manipulatePresentation() {
   ...
   // Generate and save a thumbnail of the first slide
    ...
    <div class="col-lg-12">
        <h2 class="h2title">PowerPoint konvertálása PDF, GIF vagy HTML formátumba a Node.js-ben</h2>
...
{{< blocks/products/pf/offers-section pfName="Aspose.Slides" description="Az Aspose.Slides egyedi PowerPoint API-kat kínál más népszerű fejlesztői környezetekhez, az alábbiak szerint:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/slides/hu/android-.NET/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-android-.NET.svg" sdkName="Android via .NET" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/slides/hu/php-.NET/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-.NET.svg" sdkName="PHP via .NET" >}}
