---
title: Android PowerPoint API | Aspose.Slides Android API-hoz
weight: 5960
url: /hu/android-java/ 
description: Aspose.Slides for Android API vagy Android PowerPoint API PPT POT PPS PPTX POTX PPSX PowerPoint létrehozásához és kezeléséhez Androidon.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Android PowerPoint API" h2="Létrehozhat, módosíthat, konvertálhat, egyesíthet, oszthat fel és kezelhet PowerPoint-prezentációkat Android-alkalmazásokban." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-android-java.svg" pfName="Aspose.Slides" subTitlepfName="for Android via Java" downloadUrl="https://downloads.aspose.com/slides/androidjava" >}}
...
<p>
 Az Aspose.Slides for Android a Java-n keresztül egy PowerPoint API Android-alkalmazásokhoz. A fejlesztők a prezentációfeldolgozási feladatok széles skáláját hajthatják végre, beleértve a prezentációk olvasását, írását, módosítását, egyesítését, felosztását, konvertálását és manipulálását anélkül, hogy a Microsoft PowerPointtól függenének.
</p>

<p>
 Az Aspose.Slides for Android a Java segítségével szinte az összes natív PowerPoint fájlformátumot, valamint az OpenOffice prezentációs formátumot (ODP) támogatja. Hozzon létre PowerPoint megjelenítő alkalmazást Androidra, valamint konvertert, szerkesztőt vagy bármilyen mást. A bemutatóelemek, például a SmartArt-alakzatok, az MSO-diagramok, az ActiveX-összetevők és az OLE-keretobjektumok a PowerPoint API-n keresztül érhetők el kezelés és kezelés céljából.
</p>
...
{{< blocks/products/pf/carousel-item h3="Ránézésre" description="Az Aspose.Slides for Android API funkcióinak áttekintése." >}}
...
{{< blocks/products/pf/carousel-item h3="Platformfüggetlenség" description="Az Aspose.Slides for Android API a következő Android fejlesztői környezeteket és telepítési platformokat fedi le." >}}
<div class="diagram1 d1-android">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="Támogatott fájlformátumok" description="Az Aspose.Slides for Android API támogatja a natív [PowerPoint-formátumokat](https://docs.aspose.com/slides/java/supported-file-formats/) és számos konverziós formátumot." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Fejlessze az Android PowerPoint API funkcióit
   </h2>
   <p>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Új diák létrehozása vagy klónozása sablonokból
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Adja hozzá vagy törölje az alakzatok védelmét
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Microsoft Excel diagramok hozzáadása OleObjectsként
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     HTML szöveg importálása és exportálása diákba
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     ActiveX és SmartArt összetevők kezelése
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Diavetítés átmenet hozzáadása vagy módosítása
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Alakzatok vektorizálása szöveg nélkül
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Rendereljen SVG képeket alakzatokká
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Prezentáció formázása perc szinten
    </h2>
    <p>
     A PowerPoint könyvtár könnyen kezeli a szöveg- és alakformázási funkciókat, például a betűméretet, típust, színt és árnyalatokat, bekezdésigazítást, felsorolásjeleket és tájolást, valamint hiperhivatkozásokat.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Prezentáció átalakítása jegyzetekkel
    </h2>
    <p>
     Az API TIFF és PDF formátumba konvertálást biztosít jegyzetekkel. A fejlesztők a Notes Slide nézetben a teljes prezentációt a támogatott formátumba konvertálhatják, valamint a képek esetében a Notes Slide nézetben diabélyegképet is létrehozhatnak az egyes diákhoz. Itt van a TIFF konverziós kód.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Konvertálja a prezentációkat a Notes segítségével
     </h3>
...
pres.save(dataDir + "TestNotes.tiff", SaveFormat.Tiff,opts);
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Az elemek manipulálása nyilvános API-n keresztül
    </h2>
    <p>
     Az API képes kezelni az összes prezentációs diaelemet, beleértve a téglalapot, a táblázatot, a szövegdobozt, az ellipszist, a vonalláncot, a képkeretet, az automatikus alakzatot, a hangkeretet, az OLE objektumkeretet és a videókockát. Az API ezenkívül az API-parancsok gazdag készletét is biztosítja ezen elemek mindegyikének manipulálásához. Ezenkívül a szöveg formázását jól megtervezett osztálykészlet támogatja.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Dokumentáció" href="https://docs.aspose.com/slides/androidjava/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Miért az Aspose.Slides for Android Java-n keresztül?" tabId="success-stories" >}}
