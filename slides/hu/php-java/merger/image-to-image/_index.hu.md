---
title: Képek egyesítése PHP-ben
url: /hu/php-java/merger/image-to-image/
keywords: Kép egyesítése, kép képhez, képek összekapcsolása, képek kombinálása, PHP API, PHP könyvtár
description: Kép egyesítése képpel PHP-ben. Használja a PHP könyvtár API-t a képek kombinálásához
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Kép egyesítése PHP-ben" h2="Nagy sebességű és platformfüggetlen PHP könyvtár képek egyesítéséhez PHP kóddal" >}}

{{% blocks/products/pf/feature-page-section h2="Kép egyesítése képpel az Aspose.Slides segítségével" %}}

Az [**Aspose.Slides for PHP Java-n keresztül**](https://products.aspose.com/slides/hu/php-java/) egy hatékony PHP-könyvtár, amellyel prezentációkat, képeket és egyéb fájlokat egyesíthet és kezelhet. Ha képet képpel egyesít, akkor hatékonyan kombinál két képet, hogy egy képet kapjon.
...
{{% blocks/products/pf/feature-page-section  h2="Kép egyesítése képpel PHP-ben" %}}
...
{{% blocks/products/pf/agp/code-block title="PHP kód a kép képhez egyesítéséhez" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Hogyan lehet képeket egyesíteni PHP-ben" >}}
