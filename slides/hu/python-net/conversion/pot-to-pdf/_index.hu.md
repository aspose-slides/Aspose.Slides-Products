---
title: Konvertálja a POT-ot PDF-be Pythonban
weight: 970
url: /hu/python-net/conversion/pot-to-pdf/ 
keywords: "Convert, PowerPoint, POT, PDF, Presentation, Python"
description: Mintakód POT-ból PDF Python konvertáláshoz. Használja a PowerPoint Python API-t a POT-fájlok PDF-fájlokká konvertálásához.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertálja a POT-ot PDF-be Pythonban" h2="Hatékony PowerPoint Python-könyvtár a POT PDF-be konvertálásához" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{< blocks/products/pf/agp/feature-section-col title="Hogyan lehet a POT-ot PDF-be konvertálni a Pythonban" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ezek a lépések a POT-fájlok PDF-be konvertálásához Python használatával." >}}
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a POT-ból PDF-be való Python konvertálást mutatja be" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="POT mentése PDF-ként Pythonban" %}}
Az ingyenes alkalmazás segítségével megtekintheti a POT PDF-be konvertálási folyamat bemutatóját. 
{{% /blocks/products/pf/agp/content %}}
