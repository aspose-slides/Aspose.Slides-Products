...
Programozottan kell konvertálnia az ODP fájlokat FODP-re? Az [*Aspose.Slides for Python for .NET segítségével*](https://products.aspose.com/slides/hu/python-net/) használatával bármely fejlesztő az ODP-t FODP formátumba konvertálhatja, mindössze néhány sor Python kóddal.
