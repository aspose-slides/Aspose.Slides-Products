...
Programozottan kell konvertálnia az ODP fájlokat PPS-re? Az [*Aspose.Slides for Python for .NET segítségével*](https://products.aspose.com/slides/hu/python-net/) használatával bármely fejlesztő néhány sor Python kóddal PPS formátumba konvertálhatja az ODP-t.
