...
A PPT fájlokat programozottan PPSX-re kell konvertálni? Az [*Aspose.Slides for Python .NET-en keresztüli használatával*](https://products.aspose.com/slides/hu/python-net/) bármely fejlesztő PPT-t PPSX formátumba konvertálhat, mindössze néhány sor Python kóddal.
