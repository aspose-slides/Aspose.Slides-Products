---
title: Egyesítse a FODP fájlokat a ODP formátumba Python használatával
url: /hu/python-net/merge/fodp-to-odp/
keywords: A(z) FODP egyesítése a(z) ODP formátumba, a(z) FODP csatlakozása a(z) ODP formátumba, a(z)(FODP) összevonása a(z) ODP formátumba, PowerPoint, Presentation, ODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Egyesítse a FODP fájlokat a ODP fájlba Python használatával" %}}
A PowerPoint-prezentációk egyesítéséhez klónoznia kell a diákat egyik prezentációból a másikba.

{{% blocks/products/pf/agp/code-block title="Python-kód több FODP egyesítéséhez egyetlen ODP fájlba" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="A FODP és a ODP egyesítése az Aspose.Slides for Python API használatával" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ezek a lépések két FODP fájl egyesítéséhez és az eredmény mentéséhez ODP formátumban a Pythonban." >}}
