---
title: Egyesítse a ODP fájlokat a PNG formátumba Python használatával
url: /hu/python-net/merge/odp-to-png/
keywords: A(z) ODP egyesítése a(z) PNG formátumba, a(z) ODP csatlakozása a(z) PNG formátumba, a(z)(ODP) összevonása a(z) PNG formátumba, PowerPoint, Presentation, PNG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section h2="Egyesítse a ODP formátumot a PNG formátumba a Pythonban" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Egyesítse a ODP fájlokat a PNG fájlba Python használatával" %}}
A PowerPoint-prezentációk egyesítéséhez klónoznia kell a diákat egyik prezentációból a másikba.

{{% blocks/products/pf/agp/code-block title="Python-kód több ODP egyesítéséhez egyetlen PNG fájlba" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="A ODP és a PNG egyesítése az Aspose.Slides for Python API használatával" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ezek a lépések két ODP fájl egyesítéséhez és az eredmény mentéséhez PNG formátumban a Pythonban." >}}
