---
title: Egyesítse a POT fájlokat a ODP formátumba Python használatával
url: /hu/python-net/merge/pot-to-odp/
keywords: A(z) POT egyesítése a(z) ODP formátumba, a(z) POT csatlakozása a(z) ODP formátumba, a(z)(POT) összevonása a(z) ODP formátumba, PowerPoint, Presentation, ODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Egyesítse a POT fájlokat a ODP fájlba Python használatával" %}}
A PowerPoint-prezentációk egyesítéséhez klónoznia kell a diákat egyik prezentációból a másikba.

{{% blocks/products/pf/agp/code-block title="Python-kód több POT egyesítéséhez egyetlen ODP fájlba" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="A POT és a ODP egyesítése az Aspose.Slides for Python API használatával" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ezek a lépések két POT fájl egyesítéséhez és az eredmény mentéséhez ODP formátumban a Pythonban." >}}
