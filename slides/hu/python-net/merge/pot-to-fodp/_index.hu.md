---
title: Egyesítse a POT fájlokat a FODP formátumba Python használatával
url: /hu/python-net/merge/pot-to-fodp/
keywords: A(z) POT egyesítése a(z) FODP formátumba, a(z) POT csatlakozása a(z) FODP formátumba, a(z)(POT) összevonása a(z) FODP formátumba, PowerPoint, Presentation, FODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Egyesítse a POT fájlokat a FODP fájlba Python használatával" %}}
A PowerPoint-prezentációk egyesítéséhez klónoznia kell a diákat egyik prezentációból a másikba.

{{% blocks/products/pf/agp/code-block title="Python-kód több POT egyesítéséhez egyetlen FODP fájlba" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="A POT és a FODP egyesítése az Aspose.Slides for Python API használatával" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ezek a lépések két POT fájl egyesítéséhez és az eredmény mentéséhez FODP formátumban a Pythonban." >}}
