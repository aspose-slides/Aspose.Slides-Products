---
title: Egyesítse a PPT fájlokat a FODP formátumba Python használatával
url: /hu/python-net/merge/ppt-to-fodp/
keywords: A(z) PPT egyesítése a(z) FODP formátumba, a(z) PPT csatlakozása a(z) FODP formátumba, a(z)(PPT) összevonása a(z) FODP formátumba, PowerPoint, Presentation, FODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Egyesítse a PPT fájlokat a FODP fájlba Python használatával" %}}
A PowerPoint-prezentációk egyesítéséhez klónoznia kell a diákat egyik prezentációból a másikba.

{{% blocks/products/pf/agp/code-block title="Python-kód több PPT egyesítéséhez egyetlen FODP fájlba" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="A PPT és a FODP egyesítése az Aspose.Slides for Python API használatával" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ezek a lépések két PPT fájl egyesítéséhez és az eredmény mentéséhez FODP formátumban a Pythonban." >}}
