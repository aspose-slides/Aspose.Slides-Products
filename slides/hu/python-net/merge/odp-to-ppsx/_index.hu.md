---
title: Egyesítse a ODP fájlokat a PPSX formátumba Python használatával
url: /hu/python-net/merge/odp-to-ppsx/
keywords: A(z) ODP egyesítése a(z) PPSX formátumba, a(z) ODP csatlakozása a(z) PPSX formátumba, a(z)(ODP) összevonása a(z) PPSX formátumba, PowerPoint, Presentation, PPSX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section h2="Egyesítse a ODP formátumot a PPSX formátumba a Pythonban" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Egyesítse a ODP fájlokat a PPSX fájlba Python használatával" %}}
A PowerPoint-prezentációk egyesítéséhez klónoznia kell a diákat egyik prezentációból a másikba.

{{% blocks/products/pf/agp/code-block title="Python-kód több ODP egyesítéséhez egyetlen PPSX fájlba" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="A ODP és a PPSX egyesítése az Aspose.Slides for Python API használatával" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ezek a lépések két ODP fájl egyesítéséhez és az eredmény mentéséhez PPSX formátumban a Pythonban." >}}
