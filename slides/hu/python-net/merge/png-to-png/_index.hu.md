---
title: PNG-képek egyesítése Pythonban
url: /hu/python-net/merge/png-to-png/
keywords: PNG, PNG egyesítése PNG-be, csatlakozás PNG-hez, PNG egyesítése, Python API, Python Library
description: PNG és PNG egyesítése Pythonban. Használja a Python könyvtár API-t a PNG-fájlok kombinálásához
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="PNG egyesítése Pythonban" h2="Nagy sebességű és többplatformos Python-könyvtár PNG-képek egyesítéséhez Python-kóddal" >}}

{{% blocks/products/pf/feature-page-section h2="PNG és PNG egyesítése az Aspose.Slides segítségével" %}}

Az [**Aspose.Slides for Python .NET-en keresztül**](https://products.aspose.com/slides/hu/python-net/) egy hatékony Python-könyvtár, amellyel prezentációkat, képeket és egyéb fájlokat egyesíthet és kezelhet. Ha PNG-t PNG-vel egyesít, akkor hatékonyan kombinál két képet, hogy egy képet kapjon.
...
{{% blocks/products/pf/feature-page-section  h2="PNG és PNG egyesítése Pythonban" %}}
Az [**Aspose.Slides for Python .NET-en keresztül**](https://products.aspose.com/slides/hu/python-net/) használatával gyorsan egyesíthet PNG-fájlokat, mindössze néhány sornyi kóddal.

{{% blocks/products/pf/agp/code-block title="Python kód a PNG és a PNG egyesítéséhez" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="Hogyan lehet PNG-t egyesíteni a Pythonban" >}}
