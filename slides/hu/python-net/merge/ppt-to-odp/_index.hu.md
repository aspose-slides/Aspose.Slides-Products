---
title: Egyesítse a PPT fájlokat a ODP formátumba Python használatával
url: /hu/python-net/merge/ppt-to-odp/
keywords: A(z) PPT egyesítése a(z) ODP formátumba, a(z) PPT csatlakozása a(z) ODP formátumba, a(z)(PPT) összevonása a(z) ODP formátumba, PowerPoint, Presentation, ODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Egyesítse a PPT fájlokat a ODP fájlba Python használatával" %}}
A PowerPoint-prezentációk egyesítéséhez klónoznia kell a diákat egyik prezentációból a másikba.

{{% blocks/products/pf/agp/code-block title="Python-kód több PPT egyesítéséhez egyetlen ODP fájlba" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="A PPT és a ODP egyesítése az Aspose.Slides for Python API használatával" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ezek a lépések két PPT fájl egyesítéséhez és az eredmény mentéséhez ODP formátumban a Pythonban." >}}
