---
title: Egyesítse a PPTX fájlokat a PPSX formátumba Python használatával
url: /hu/python-net/merge/pptx-to-ppsx/
keywords: A(z) PPTX egyesítése a(z) PPSX formátumba, a(z) PPTX csatlakozása a(z) PPSX formátumba, a(z)(PPTX) összevonása a(z) PPSX formátumba, PowerPoint, Presentation, PPSX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Egyesítse a PPTX fájlokat a PPSX fájlba Python használatával" %}}
A PowerPoint-prezentációk egyesítéséhez klónoznia kell a diákat egyik prezentációból a másikba.

{{% blocks/products/pf/agp/code-block title="Python-kód több PPTX egyesítéséhez egyetlen PPSX fájlba" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="A PPTX és a PPSX egyesítése az Aspose.Slides for Python API használatával" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ezek a lépések két PPTX fájl egyesítéséhez és az eredmény mentéséhez PPSX formátumban a Pythonban." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Mentse a prezentációt, és kapja meg az eredményt egyetlen PPSX fájlként.
```
pres1.save("presentation.ppsx", slides.export.SaveFormat.PPSX)
```
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/hu/python-net/merge/pptx-to-gif/" name="PPTX TO GIF" >}}  
