---
title: Egyesítse a PDF fájlokat a ODP formátumba Python használatával
url: /hu/python-net/merge/pdf-to-odp/
keywords: A(z) PDF egyesítése a(z) ODP formátumba, a(z) PDF csatlakozása a(z) ODP formátumba, a(z)(PDF) összevonása a(z) ODP formátumba, PowerPoint, Presentation, ODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section h2="Egyesítse a PDF formátumot a ODP formátumba a Pythonban" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Egyesítse a PDF fájlokat a ODP fájlba Python használatával" %}}
A PowerPoint-prezentációk egyesítéséhez klónoznia kell a diákat egyik prezentációból a másikba.

{{% blocks/products/pf/agp/code-block title="Python-kód több PDF egyesítéséhez egyetlen ODP fájlba" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="A PDF és a ODP egyesítése az Aspose.Slides for Python API használatával" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ezek a lépések két PDF fájl egyesítéséhez és az eredmény mentéséhez ODP formátumban a Pythonban." >}}
