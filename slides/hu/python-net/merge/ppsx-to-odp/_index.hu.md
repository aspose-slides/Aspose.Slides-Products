---
title: Egyesítse a PPSX fájlokat a ODP formátumba Python használatával
url: /hu/python-net/merge/ppsx-to-odp/
keywords: A(z) PPSX egyesítése a(z) ODP formátumba, a(z) PPSX csatlakozása a(z) ODP formátumba, a(z)(PPSX) összevonása a(z) ODP formátumba, PowerPoint, Presentation, ODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Egyesítse a PPSX fájlokat a ODP fájlba Python használatával" %}}
A PowerPoint-prezentációk egyesítéséhez klónoznia kell a diákat egyik prezentációból a másikba.

{{% blocks/products/pf/agp/code-block title="Python-kód több PPSX egyesítéséhez egyetlen ODP fájlba" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="A PPSX és a ODP egyesítése az Aspose.Slides for Python API használatával" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ezek a lépések két PPSX fájl egyesítéséhez és az eredmény mentéséhez ODP formátumban a Pythonban." >}}
