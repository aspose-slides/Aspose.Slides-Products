---
title: Egyesítse a PDF fájlokat a XPS formátumba Python használatával
url: /hu/python-net/merge/pdf-to-xps/
keywords: A(z) PDF egyesítése a(z) XPS formátumba, a(z) PDF csatlakozása a(z) XPS formátumba, a(z)(PDF) összevonása a(z) XPS formátumba, PowerPoint, Presentation, XPS, Python, Aspose
...
{{% blocks/products/pf/feature-page-section h2="Egyesítse a PDF formátumot a XPS formátumba a Pythonban" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Egyesítse a PDF fájlokat a XPS fájlba Python használatával" %}}
A PowerPoint-prezentációk egyesítéséhez klónoznia kell a diákat egyik prezentációból a másikba.

{{% blocks/products/pf/agp/code-block title="Python-kód több PDF egyesítéséhez egyetlen XPS fájlba" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="A PDF és a XPS egyesítése az Aspose.Slides for Python API használatával" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ezek a lépések két PDF fájl egyesítéséhez és az eredmény mentéséhez XPS formátumban a Pythonban." >}}
