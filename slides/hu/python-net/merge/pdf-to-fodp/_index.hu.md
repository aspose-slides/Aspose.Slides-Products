---
title: Egyesítse a PDF fájlokat a FODP formátumba Python használatával
url: /hu/python-net/merge/pdf-to-fodp/
keywords: A(z) PDF egyesítése a(z) FODP formátumba, a(z) PDF csatlakozása a(z) FODP formátumba, a(z)(PDF) összevonása a(z) FODP formátumba, PowerPoint, Presentation, FODP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section h2="Egyesítse a PDF formátumot a FODP formátumba a Pythonban" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Egyesítse a PDF fájlokat a FODP fájlba Python használatával" %}}
A PowerPoint-prezentációk egyesítéséhez klónoznia kell a diákat egyik prezentációból a másikba.

{{% blocks/products/pf/agp/code-block title="Python-kód több PDF egyesítéséhez egyetlen FODP fájlba" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="A PDF és a FODP egyesítése az Aspose.Slides for Python API használatával" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ezek a lépések két PDF fájl egyesítéséhez és az eredmény mentéséhez FODP formátumban a Pythonban." >}}
