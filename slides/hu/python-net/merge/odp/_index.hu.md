---
title: Egyesítse a ODP fájlokat Python használatával
url: /hu/python-net/merge/odp/
keywords: Egyesítés ODP, Csatlakozás ODP, Összevonás ODP, PowerPoint, Prezentáció, Python, Aspose
...
{{% blocks/products/pf/feature-page-section h2="A ODP egyesítése Pythonban" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Egyesítsen ODP fájlokat Python használatával" %}}
A PowerPoint-prezentációk egyesítéséhez klónoznia kell a diákat egyik prezentációból a másikba.

{{% blocks/products/pf/agp/code-block title="Python kód több ODP egy fájlba egyesítéséhez" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="A ODP egyesítése az Aspose.Slides for Python API használatával" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ezek a lépések két ODP fájl egyesítéséhez és az eredmény mentéséhez ODP formátumban a Pythonban." >}}
