---
title: Egyesítse a FODP fájlokat a PPSX formátumba Python használatával
url: /hu/python-net/merge/fodp-to-ppsx/
keywords: A(z) FODP egyesítése a(z) PPSX formátumba, a(z) FODP csatlakozása a(z) PPSX formátumba, a(z)(FODP) összevonása a(z) PPSX formátumba, PowerPoint, Presentation, PPSX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Egyesítse a FODP fájlokat a PPSX fájlba Python használatával" %}}
A PowerPoint-prezentációk egyesítéséhez klónoznia kell a diákat egyik prezentációból a másikba.

{{% blocks/products/pf/agp/code-block title="Python-kód több FODP egyesítéséhez egyetlen PPSX fájlba" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="A FODP és a PPSX egyesítése az Aspose.Slides for Python API használatával" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ezek a lépések két FODP fájl egyesítéséhez és az eredmény mentéséhez PPSX formátumban a Pythonban." >}}
