---
title: A ODP fájlok metaadatainak megtekintése vagy szerkesztése a Python használatával
url: /hu/python-net/metadata/odp/
keywords: ODP metaadatok szerkesztése, ODP metaadatok megtekintése, ODP tulajdonságok szerkesztése, ODP tulajdonságok megtekintése
description: Python forráskód a ODP formátumú metaadatok szerkesztéséhez vagy megtekintéséhez.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Szerkessze a ODP tulajdonságokat a Python használatával" h2="Készítse el saját Python alkalmazásait a prezentációs fájlok beépített és egyéni tulajdonságainak kiszolgálóoldali API-k segítségével történő módosításához." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" fileiconsmall4="POT" fileiconsmall5="ppsx" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for Python via .NET" >}}

{{% blocks/products/pf/feature-page-section  h2="A ODP tulajdonságok módosítása a Python segítségével" %}}
...
{{% blocks/products/pf/agp/code-block title="A ODP beépített tulajdonságainak módosítása – Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Egyéni tulajdonságok hozzáadása a következőhöz: ODP – Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="A ODP metaadatainak kinyerése a Python segítségével" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Ezek a lépések a metaadatok kibontásához a ODP fájlokból." >}}

{{< blocks/products/pf/agp/step-autogen >}}
Példányosítsa a Presentation osztályt a ODP fájl elérési útjával
{{< /blocks/products/pf/agp/step-autogen >}}
