...
{{% blocks/products/pf/agp/code-block title="Keresési szöveges PPTX prezentáció a Python használatával" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Szöveg keresése PPTX nyelven a Python segítségével" >}}
