---
title: A PPS-fájlok metaadatainak megtekintése vagy szerkesztése .NET-en keresztül
weight: 7210
url: /hu/net/metadata/pps/ 
description: C#-forráskód a PPS-formátumú metaadatok szerkesztéséhez vagy megtekintéséhez .NET-keretrendszeren, .NET Core-on, Windows Azure-on, Mono- vagy Xamarin-platformokon.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="PPS-metaadatok kibontása .NET-en keresztül" h2="Készítse el saját .NET-alkalmazásait a PPS-fájlok metaadatok hozzáadásához, szerkesztéséhez, eltávolításához vagy kibontásához szerveroldali API-k segítségével." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPS" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="PPS metaadatok kinyerése C# használatával" %}}

 A PPS metaadatok kinyeréséhez ezt használjuk
...
{{< blocks/products/pf/agp/feature-section-col title="A PPS metaadatainak C#-on keresztüli kinyerésének lépései" >}}
...
{{% blocks/products/pf/agp/code-block title="PPS metaadatainak kibontása - C#" offSpacer="" %}}
