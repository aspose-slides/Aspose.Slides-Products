---
title: JPG egyesítése PDF-be C#-ban
url: /hu/net/merger/jpg-to-pdf/
keywords: JPG PDF-be, JPG egyesítése PDF-be, JPG csatlakozás PDF-be, PDF, JPG, C# API, .NET Library
description: JPG egyesítése PDF-be C#-ban. Használja a .NET könyvtár API-t a JPG és a PDF kombinálásához
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="JPG egyesítése PDF-be C#-ban" h2="Hatékony, többplatformos .NET API JPG és PDF fájlok egyesítéséhez C# kóddal NET Framework, .NET Core, Windows Azure, Mono vagy Xamarin platformokon" >}}

{{% blocks/products/pf/feature-page-section h2="Egyesítse a JPG-t PDF-be az Aspose.Slides segítségével" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/hu/net/) egy hatékony .NET-könyvtár, amellyel prezentációkat, PDF-eket, képeket, és egyéb fájlok. Ha JPG-t PDF-be egyesít, akkor hatékonyan kombinálja a JPG-képeket, hogy egyetlen PDF-fájlt kapjon.
...
{{% blocks/products/pf/feature-page-section  h2="JPG egyesítése PDF-be C#-ban" %}}
Az [**Aspose.Slides for .NET**](https://products.aspose.com/slides/hu/net/) használatával gyorsan egyesítheti a JPG-t PDF-be, mindössze néhány sornyi kóddal.

{{% blocks/products/pf/agp/code-block title="C# kód a JPG és a PDF egyesítéséhez" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Hogyan lehet a JPG-t PDF-be egyesíteni C#-ban" >}}
