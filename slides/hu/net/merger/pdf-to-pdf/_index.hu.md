...
url: /hu/net/merger/pdf-to-pdf/
keywords: PDF, PDF egyesítése PDF-be, PDF csatlakozás, PDF, C# API, .NET-könyvtár egyesítése
description: PDF egyesítése PDF-be C#-ban. Használja a .NET könyvtár API-t a PDF-fájlok kombinálásához
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="PDF egyesítése C#-ban" h2="Hatékony, többplatformos .NET API PDF-fájlok egyesítéséhez C# kóddal NET Framework, .NET Core, Windows Azure, Mono vagy Xamarin platformokon" >}}

{{% blocks/products/pf/feature-page-section h2="PDF egyesítése PDF-be az Aspose.Slides segítségével" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/hu/net/) egy hatékony .NET-könyvtár prezentációk, PDF-ek és egyéb dokumentumok létrehozására, konvertálására, egyesítésére és kezelésére. dokumentumokat. Ha PDF-et egyesít PDF-be, akkor hatékonyan kombinálja 2 dokumentum oldalait, hogy egyetlen PDF-fájlt kapjon. Az Aspose.Slides lehetővé teszi a PDF-fájlok különböző módon történő egyesítését. Egyesítheti a PDF-fájlokat minden formájával, stílusával, szövegével, formázásával stb.
...
{{% blocks/products/pf/feature-page-section  h2="PDF egyesítése PDF-be C#-ban" %}}
Az [**Aspose.Slides for .NET**](https://products.aspose.com/slides/hu/net/) használatával gyorsan egyesíthet PDF-fájlokat, mindössze néhány sornyi kóddal.

{{% blocks/products/pf/agp/code-block title="C# kód a PDF PDF-be olvasztásához" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Hogyan lehet PDF-et egyesíteni C#-ban" >}}
