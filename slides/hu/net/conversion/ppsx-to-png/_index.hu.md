...
title: PPSX konvertálása PNG-re C#-on keresztül
weight: 120
url: /hu/net/conversion/ppsx-to-png/ 
description: Mintakód a PPSX-ből PNG-be C# konvertáláshoz. Használjon API-példakódot a PPSX-fájlok kötegelt PNG-vé konvertálásához VB.NET-en, Asp.NET-en vagy bármely .NET-alapú alkalmazáson belül.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="PPSX konvertálása PNG-re C#-on keresztül" h2="Exportáljon PowerPoint® PPSX fájlokat PNG formátumba .NET Framework, .NET Core, Windows Azure, Mono vagy Xamarin platformokon" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="A PPSX konvertálása PNG-re C# használatával" %}}

 A PPSX PNG-re konvertálásához használjuk
...
{{< blocks/products/pf/agp/feature-section-col title="A PPSX konvertálása PNG-re C#-on keresztül" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="A .NET fejlesztők egyszerűen betölthetik és konvertálhatják a PPSX fájlokat PNG formátumba, mindössze néhány sornyi kóddal." >}}
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a PPSX-ből PNG-be való C# konvertálást mutatja" offSpacer="" %}}
