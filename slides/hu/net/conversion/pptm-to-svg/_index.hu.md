...
{{% blocks/products/pf/agp/content h2="PPTM konvertálása SVG-vé a C# használatával" %}}

 A PPTM SVG-vé konvertálásához használjuk
...
{{< blocks/products/pf/agp/feature-section-col title="A PPTM SVG-vé konvertálásának lépései C# segítségével" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="A .NET-fejlesztők néhány kódsor segítségével könnyedén betölthetik és konvertálhatják a PPTM-fájlokat SVG-formátumba." >}}
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a PPTM SVG C# konvertálást mutatja" offSpacer="" %}}
