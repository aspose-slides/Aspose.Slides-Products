...
title: Konvertálja a PPSX-t PPT-vé C#-on keresztül
weight: 5940
url: /hu/net/conversion/ppsx-to-ppt/ 
description: Mintakód a PPSX-ből PPT C# konvertáláshoz. Használjon API-példakódot a PPSX-fájlok kötegelt PPT-vé konvertálásához VB.NET-en, Asp.NET-en vagy bármely .NET-alapú alkalmazáson belül.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertálja a PPSX-t PPT-vé C#-on keresztül" h2="Exportáljon PowerPoint® PPSX fájlokat PPT-be .NET Framework, .NET Core, Windows Azure, Mono vagy Xamarin platformokon" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="A PPSX konvertálása PPT-vé a C# használatával" %}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="A .NET fejlesztők egyszerűen betölthetik és konvertálhatják a PPSX fájlokat PPT-vé, mindössze néhány sornyi kóddal." >}}
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a PPSX-ből PPT C# konvertálást mutatja" offSpacer="" %}}
