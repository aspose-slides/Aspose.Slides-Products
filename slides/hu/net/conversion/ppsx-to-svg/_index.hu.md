---
title: Konvertálja a PPSX-et SVG-vé C#-on keresztül
weight: 1930
url: /hu/net/conversion/ppsx-to-svg/ 
description: Mintakód a PPSX-ből SVG C# konvertáláshoz. Használjon API-példakódot a PPSX-fájlok kötegelt SVG-vé konvertálásához VB.NET-en, Asp.NET-en vagy bármely .NET-alapú alkalmazáson belül.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertálja a PPSX-et SVG-vé C#-on keresztül" h2="Exportáljon PowerPoint® PPSX fájlokat SVG formátumba .NET Framework, .NET Core, Windows Azure, Mono vagy Xamarin platformokon" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="A PPSX konvertálása SVG-vé a C# használatával" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Lépések a PPSX konvertálásához SVG-vé C#-on keresztül" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="A .NET-fejlesztők egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják a PPSX fájlokat SVG formátumba." >}}
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a PPSX-ből SVG C# konvertálást mutat be" offSpacer="" %}}
