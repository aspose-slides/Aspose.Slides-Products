---
title: Convert OTP to TIFF in Python 
weight: 650
url: /python-net/conversion/otp-to-tiff/ 
keywords: "Convert, PowerPoint, OTP, TIFF, Presentation, Python"
description: Sample code for OTP to TIFF Python conversion. Use PowerPoint Python API for batch conversion OTP files to TIFF files.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert OTP to TIFF in Python" h2="Powerful PowerPoint Python library for converting OTP to TIFF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Convert OTP to TIFF in Python" %}}

Need to convert OTP files to TIFF programmatically? Using [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/python-net/) any developer can convert OTP to TIFF format with just a few lines of Python code.

As a modern presentation processing API, Aspose.Slides for Python creates TIFF from OTP quickly. Test the quality of OTP to TIFF conversion right in your [browser](https://products.aspose.app/slides/conversion). Aspose PowerPoint PPTX library allows you to convert OTP files to many popular formats.
...
{{< blocks/products/pf/agp/feature-section-col title="How to Convert OTP to TIFF in Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="These are the steps to convert a OTP file to TIFF using Python." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows OTP to TIFF Python Conversion" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Save OTP as TIFF in Python" %}}
