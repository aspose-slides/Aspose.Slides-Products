---
title: Visualize ou edite metadados de arquivos OTP usando .NET
...
{{% blocks/products/pf/agp/code-block title="Modificar propriedades integradas OTP - C#" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Adicionar propriedades personalizadas a OTP - C#" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como extrair metadados de OTP via C#" >}}
