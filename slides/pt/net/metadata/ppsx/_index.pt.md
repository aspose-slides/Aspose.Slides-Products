---
title: Visualize ou edite metadados de arquivos PPSX usando .NET
...
{{% blocks/products/pf/agp/code-block title="Modificar propriedades integradas PPSX - C#" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Adicionar propriedades personalizadas a PPSX - C#" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como extrair metadados de PPSX via C#" >}}
