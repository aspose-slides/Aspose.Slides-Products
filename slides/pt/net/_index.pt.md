...
<h2 class="h2title">Controle total sobre os elementos do slide do PowerPoint</h2>

<p>Aspose.Slides para .NET pode lidar com todos os elementos de slide de apresentação, incluindo caixa de texto, tabela, retângulo, elipse, polilinha, forma automática, moldura de imagem, moldura de áudio, moldura de vídeo e moldura de objeto OLE. A API fornece um conjunto bem projetado de classes que permite manipular de forma abrangente cada um desses elementos.</p>
...
{{< blocks/products/pf/slr-element name="Notas de lançamento" href="https://releases.aspose.com/slides/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
