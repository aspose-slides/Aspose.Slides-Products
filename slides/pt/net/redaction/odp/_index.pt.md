---
title: Pesquise e substitua texto no documento ODP via .NET
weight: 4100
url: /pt/net/redaction/odp/ 
description: Código-fonte C# para redigir informações confidenciais no arquivo ODP nas plataformas .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Redigir formatos ODP em C#" h2="Informações de redação confidenciais de documentos ODP nativas e de alto desempenho usando Aspose.Slides do lado do servidor para APIs .NET, sem o uso de qualquer software como Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Como redigir o arquivo ODP usando C #" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Etapas para redigir arquivos ODP em C#" >}}
...
{{% blocks/products/pf/agp/code-block title="Redigir arquivos ODP - C#" offSpacer="" %}}
