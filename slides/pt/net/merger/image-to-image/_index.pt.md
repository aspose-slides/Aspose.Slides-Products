...
description: Mesclar imagem para imagem em C#. Use a API da biblioteca .NET para combinar imagens
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar imagem em C#" h2="Poderosa API .NET de plataforma cruzada para mesclar imagens usando código C# em plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar imagem a imagem usando Aspose.Slides" %}}

[**Aspose.Slides para .NET**](https://products.aspose.com/slides/pt/net/) é uma poderosa biblioteca .NET usada para mesclar e manipular apresentações, imagens e outros arquivos. Ao mesclar imagem com imagem, você está efetivamente combinando duas imagens para obter uma imagem.
...
{{% blocks/products/pf/feature-page-section  h2="Mesclar imagem para imagem em C#" %}}
Usando [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pt/net/), você pode mesclar arquivos de imagem rapidamente com apenas algumas linhas de código

{{% blocks/products/pf/agp/code-block title="Código C# para mesclar imagem a imagem" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Como mesclar imagens em C#" >}}
