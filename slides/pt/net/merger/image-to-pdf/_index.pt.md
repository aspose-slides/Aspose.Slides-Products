---
title: Mesclar imagem para PDF em C#
url: /pt/net/merger/image-to-pdf/
keywords: Imagem para PDF, Mesclar imagem para PDF, Juntar imagem para PDF, PDF, Imagem, API C#, Biblioteca .NET
description: Mesclar imagem para PDF em C#. Use a API da biblioteca .NET para combinar imagem e PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar imagem para PDF em C#" h2="Poderosa API .NET multiplataforma para mesclar imagens em arquivos PDF usando código C# em plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar imagem para PDF usando Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/pt/net/) é uma poderosa biblioteca .NET usada para criar, converter, mesclar e manipular apresentações, PDFs, imagens, e outros arquivos. Ao mesclar imagem em PDF, você está efetivamente combinando imagens para obter um único arquivo PDF.
...
{{% blocks/products/pf/feature-page-section  h2="Mesclar imagem para PDF em C#" %}}
Usando [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pt/net/), você pode mesclar imagens em PDF rapidamente com apenas algumas linhas de código

{{% blocks/products/pf/agp/code-block title="Código C# para mesclar imagem em PDF" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Como mesclar imagem para PDF em C#" >}}
