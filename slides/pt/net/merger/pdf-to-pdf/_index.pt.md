...
url: /pt/net/merger/pdf-to-pdf/
keywords: Mesclar PDF, PDF para PDF, Juntar PDF, Combinar PDF, API C#, Biblioteca .NET
description: Mesclar PDF para PDF em C#. Use a API da biblioteca .NET para combinar arquivos PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar PDF em C#" h2="Poderosa API .NET de plataforma cruzada para mesclar arquivos PDF usando código C# em plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Mesclar PDF para PDF em C#" %}}
Usando [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pt/net/), você pode mesclar arquivos PDF rapidamente com apenas algumas linhas de código

{{% blocks/products/pf/agp/code-block title="Código C# para mesclar PDF para PDF" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Como mesclar PDF em C#" >}}
