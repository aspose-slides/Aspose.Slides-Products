...
url: /pt/net/merger/html-to-image/
keywords: Mesclar HTML para imagem, HTML para imagem, Juntar HTML, Combinar HTML, Imagem, C# API, Biblioteca .NET
description: Mesclar HTML para imagem em C#. Use a API da biblioteca .NET para combinar HTML com imagem
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar imagem em C#" h2="Poderosa API .NET de plataforma cruzada para mesclar HTML com imagem usando código C# em plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar HTML para imagem usando Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/pt/net/) é uma poderosa biblioteca .NET usada para mesclar e manipular apresentações, documentos HTML e outros arquivos. Ao mesclar HTML com imagem, você está efetivamente combinando o conteúdo em documentos HTML para obter uma única imagem. 
