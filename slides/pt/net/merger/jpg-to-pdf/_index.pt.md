...
description: Mesclar JPG para PDF em C#. Use a API da biblioteca .NET para combinar JPG e PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar JPG para PDF em C#" h2="Poderosa API .NET de plataforma cruzada para mesclar arquivos JPG em PDF usando código C# em plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar JPG para PDF usando Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/pt/net/) é uma poderosa biblioteca .NET usada para criar, converter, mesclar e manipular apresentações, PDFs, imagens, e outros arquivos. Ao mesclar JPG com PDF, você está efetivamente combinando imagens JPG para obter um único arquivo PDF.
...
Usando [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pt/net/), você pode mesclar JPG para PDF rapidamente com apenas algumas linhas de código
