---
title: Converter PPSM para PDF via C#
weight: 4030
url: /pt/net/conversion/ppsm-to-pdf/ 
description: Código de exemplo para conversão de PPSM para PDF C#. Use o código de exemplo da API para arquivos PPSM em lote para conversão de PDF em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PPSM para PDF via C#" h2="Exporte arquivos PowerPoint® PPSM para PDF em plataformas .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSM" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PPSM para PDF usando C#" %}}

 Para converter PPSM para PDF, usaremos
...
{{< blocks/products/pf/agp/feature-section-col title="Etapas para converter PPSM em PDF via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Os desenvolvedores .NET podem facilmente carregar e converter arquivos PPSM para PDF em apenas algumas linhas de código." >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de PPSM para PDF C#" offSpacer="" %}}
