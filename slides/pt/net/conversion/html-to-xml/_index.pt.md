---
title: Converter HTML para XML em C#
weight: 170
url: /pt/net/conversion/html-to-xml/ 
keywords: HTML para XML, Converter HTML para XML, API C#, Biblioteca .NET, HTML, XML
description: Converter HTML para XML em C#. Use a API da biblioteca .NET para converter documento HTML em arquivo XML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter HTML para XML em C#" h2="API .NET do PowerPoint para converter documentos HTML em arquivos XML nas plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter HTML para XML em C #" %}}

Como faço para converter HTML para XML em código?

Usando o [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pt/net/), qualquer desenvolvedor ou aplicativo pode converter arquivos HTML em XML com apenas algumas linhas de código C#.

Como uma API de processamento de documentos moderna, o Aspose.Slides para .NET exporta o conteúdo em HTML para XML rapidamente. A biblioteca Aspose PowerPoint permite converter HTML para XML e muitos outros formatos de arquivo.
...
{{< blocks/products/pf/agp/feature-section-col title="Como converter HTML para XML em C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Desenvolvedores e aplicativos podem converter HTML em XML desta forma:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Adicione slides com base no conteúdo do arquivo HTML.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Antes de executar o código C# de conversão de HTML para XML, sua máquina deve ter estes pré-requisitos:
...
{{% blocks/products/pf/agp/code-block title="Código C# para converter HTML em XML" offSpacer="" %}}
