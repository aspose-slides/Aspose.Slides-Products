...
title: Converter imagem para PDF em C#
weight: 30
url: /pt/net/conversion/image-to-pdf/ 
keywords: Imagem para PDF, Converter imagem para PDF, API C#, Biblioteca .NET, Imagem, JPG, PNG, PDF
description: Converter imagem para PDF em C#. Use a API da biblioteca .NET para converter imagens em documentos PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter imagem para PDF em C#" h2="API .NET do PowerPoint para converter imagens em documentos PDF nas plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter imagem para PDF em C#" %}}

Como faço para converter imagem para PDF programaticamente?

Usando o [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pt/net/), qualquer desenvolvedor ou aplicativo pode converter imagem em formato PDF com apenas algumas linhas de código C#.

Como uma API moderna de processamento de documentos, o Aspose.Slides for .NET cria PDFs a partir de imagens JPG ou PNG rapidamente. A biblioteca Aspose PowerPoint permite converter imagem em PDF e muitos outros formatos de arquivo
...
{{< blocks/products/pf/agp/feature-section-col title="Etapas para converter imagem em PDF em C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Desenvolvedores e aplicativos podem converter imagem em PDF desta forma:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Antes de executar o código C# de conversão de imagem para PDF, sua máquina deve ter estes pré-requisitos:
...
{{% blocks/products/pf/agp/code-block title="Código C# para converter imagem em PDF" offSpacer="" %}}
