...
url: /pt/net/conversion/image-to-pptx/
keywords: Converter imagem para PPTX, imagem para PPTX, PowerPoint, imagem, PPTX, C# API, Biblioteca .NET
description: Converter imagem para PPTX em C#. Use a API da biblioteca .NET para converter imagens em PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter imagem para PPTX em C#" h2="Poderosa API .NET multiplataforma para converter imagens em PPTX usando código C# em plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Converter imagem para PPTX usando Aspose.Slides" %}}
...
Usando [**Aspose.Slides para .NET**](https://products.aspose.com/slides/pt/net/), você pode converter imagens em apresentações do PowerPoint com apenas algumas linhas de código:
...
{{< blocks/products/pf/feature-page-section  h2="Como converter imagem para PPTX em C#" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/pt/net/conversion/image-to-ppt/" name="IMAGE TO PPT" >}}
