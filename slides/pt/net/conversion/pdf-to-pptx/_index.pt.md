---
title: Converter PDF para PPTX em C#
url: /pt/net/conversion/pdf-to-pptx/
keywords: Converta PDF para PPTX, PDF para PPTX, PowerPoint, PDF, PPTX, C# API, Biblioteca .NET
description: Converta PDF para PPTX em C#. Use a API da biblioteca .NET para converter PDF em PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter PDF para PPTX em C#" h2="Poderosa API .NET multiplataforma para converter PDF em PPTX usando código C# em plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Converter PDF para PPTX usando Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/pt/net/) é uma poderosa biblioteca .NET usada para criar, converter e manipular apresentações em PowerPoint, PDFs, documentos HTML, e outros arquivos. Ao converter PDF para PPTX, você está basicamente movendo o conteúdo das páginas do PDF para slides em uma apresentação do PowerPoint.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Converter PDF para PPTX em C#" %}}
Usando [**Aspose.Slides para .NET**](https://products.aspose.com/slides/pt/net/), você pode converter PDF em apresentação do PowerPoint com apenas algumas linhas de código:

{{% blocks/products/pf/agp/code-block title="Código C# para converter PDF para PPTX" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PDF para PPTX em C#" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Carregue o arquivo PDF que deseja converter para PPTX.
{{< /blocks/products/pf/agp/step-autogen >}}
