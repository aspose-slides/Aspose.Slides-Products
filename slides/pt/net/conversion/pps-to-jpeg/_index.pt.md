---
title: Converter PPS para JPEG via C#
weight: 2600
url: /pt/net/conversion/pps-to-jpeg/ 
description: Código de exemplo para conversão de PPS para JPEG C#. Use o código de exemplo da API para arquivos PPS em lote para conversão JPEG em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PPS para JPEG via C#" h2="Exporte arquivos PowerPoint® PPS para JPEG em plataformas .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPS" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PPS para JPEG usando C#" %}}

 Para converter PPS para JPEG, usaremos
...
{{< blocks/products/pf/agp/feature-section-col title="Passos para converter PPS para JPEG via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Os desenvolvedores .NET podem facilmente carregar e converter arquivos PPS para JPEG em apenas algumas linhas de código." >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de PPS para JPEG C#" offSpacer="" %}}
