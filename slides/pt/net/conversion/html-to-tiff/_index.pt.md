---
title: Converter HTML para TIFF em C #
weight: 180
url: /pt/net/conversion/html-to-tiff/ 
keywords: HTML para TIFF, Converter HTML para TIFF, API C#, Biblioteca .NET, HTML, TIFF
description: Converta HTML para TIFF em C#. Use a API da biblioteca .NET para converter arquivos HTML em imagens TIFF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter HTML para TIFF em C #" h2="API .NET do PowerPoint para converter arquivos HTML em imagens TIFF nas plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter HTML para TIFF em C #" %}}

Como faço para converter HTML para TIFF no código?

Usando o [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pt/net/), qualquer desenvolvedor ou aplicativo pode converter HTML para formato TIFF com apenas algumas linhas de código C#.

Como uma API de processamento de documentos moderna, o Aspose.Slides para .NET exporta arquivos HTML para TIFF rapidamente. A biblioteca Aspose PowerPoint permite converter HTML para TIFF e muitos outros formatos de arquivo
...
{{< blocks/products/pf/agp/feature-section-col title="Como converter HTML para TIFF em C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Desenvolvedores e aplicativos podem converter HTML em TIFF desta forma:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Antes de executar o código C# de conversão de HTML para TIFF, sua máquina deve ter estes pré-requisitos:
...
{{% blocks/products/pf/agp/code-block title="Código C# para converter HTML em TIFF" offSpacer="" %}}
