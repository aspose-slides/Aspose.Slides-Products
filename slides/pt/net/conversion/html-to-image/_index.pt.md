---
title: Converter HTML para imagem em C #
weight: 160
url: /pt/net/conversion/html-to-image/ 
keywords: HTML para imagem, converter HTML para imagem, API C#, biblioteca .NET, HTML, imagem
description: Converter HTML para imagem em C#. Use a API da biblioteca .NET para converter arquivos HTML em imagens
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter HTML para imagem em C #" h2="API .NET do PowerPoint para converter arquivos HTML em imagens nas plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter HTML para imagem em C #" %}}

Como faço para converter HTML em imagem no código?

Usando o [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pt/net/), qualquer desenvolvedor ou aplicativo pode converter HTML em arquivos de imagem com apenas algumas linhas de código C#.

Como uma API de processamento de documentos moderna, o Aspose.Slides for .NET exporta arquivos HTML para formatos de arquivo de imagem rapidamente. A biblioteca Aspose PowerPoint permite converter HTML em imagens e muitos outros formatos de arquivo
...
{{< blocks/products/pf/agp/feature-section-col title="Como converter HTML para imagem em C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Desenvolvedores e aplicativos podem converter HTML em imagem desta forma:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Adicione slides com base nas páginas HTML.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Salve os slides como imagens.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Antes de executar o código C# de conversão de HTML para imagem, sua máquina deve ter estes pré-requisitos:
...
{{% blocks/products/pf/agp/code-block title="Código C # para converter HTML em imagem" offSpacer="" %}}
