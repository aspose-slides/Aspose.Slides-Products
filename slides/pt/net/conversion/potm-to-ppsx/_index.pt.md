...
title: Converter POTM para PPSX via C#
weight: 4670
url: /pt/net/conversion/potm-to-ppsx/ 
description: Código de exemplo para conversão de POTM para PPSX C#. Use o código de exemplo da API para arquivos POTM em lote para conversão PPSX em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter POTM para PPSX via C#" h2="Exporte arquivos PowerPoint® POTM para PPSX em plataformas .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="Os desenvolvedores .NET podem facilmente carregar e converter arquivos POTM para PPSX em apenas algumas linhas de código." >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de POTM para PPSX C#" offSpacer="" %}}
