...
url: /pt/net/conversion/html-to-pptx/
keywords: Converta HTML para PPTX, HTML para PPTX, PowerPoint, HTML, PPTX, C# API, Biblioteca .NET
description: Converta HTML para PPTX em C#. Use a API da biblioteca .NET para converter HTML em PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter HTML para PPTX em C#" h2="Poderosa API .NET multiplataforma para converter HTML em PPTX usando código C# em plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Converter HTML para PPTX em C#" %}}
Usando [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pt/net/), você pode converter um documento HTML em uma apresentação do PowerPoint com apenas algumas linhas de código:

{{% blocks/products/pf/agp/code-block title="Código C# para converter HTML em PPTX" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Como converter HTML para PPTX em C#" >}}
