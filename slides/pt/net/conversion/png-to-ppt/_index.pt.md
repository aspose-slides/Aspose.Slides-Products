---
title: Converter PNG para PPT em C#
url: /pt/net/conversion/png-to-ppt/
keywords: Converter PNG para PPT, PNG para PPT, PowerPoint, PNG, PPT, C# API, Biblioteca .NET
description: Converta PNG para PPT em C#. Use a API da biblioteca .NET para converter imagens PNG em PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter PNG para PPT em C#" h2="Poderosa API .NET multiplataforma para converter PNG em PPT usando código C# em plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Converter PNG para PPT em C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Código C# para converter PNG para PPT" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PNG para PPT em C#" >}}
