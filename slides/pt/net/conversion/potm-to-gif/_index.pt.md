...
title: Converter POTM para GIF via C#
weight: 5300
url: /pt/net/conversion/potm-to-gif/ 
description: Código de exemplo para conversão de POTM para GIF C#. Use o código de exemplo da API para conversão de arquivos POTM em lote para GIF em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter POTM para GIF via C#" h2="Exporte arquivos PowerPoint® POTM para GIF em plataformas .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter POTM para GIF usando C#" %}}

 Para converter POTM para GIF, usaremos
...
{{< blocks/products/pf/agp/feature-section-col title="Passos para converter POTM para GIF via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Os desenvolvedores .NET podem facilmente carregar e converter arquivos POTM para GIF em apenas algumas linhas de código." >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de POTM para GIF C#" offSpacer="" %}}
