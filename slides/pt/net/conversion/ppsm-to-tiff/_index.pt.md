...
{{% blocks/products/pf/agp/content h2="Como converter PPSM para TIFF usando C#" %}}

 Para converter PPSM para TIFF, usaremos
...
{{< blocks/products/pf/agp/feature-section-col title="Etapas para converter PPSM em TIFF via C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Os desenvolvedores .NET podem facilmente carregar e converter arquivos PPSM para TIFF em apenas algumas linhas de código." >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de PPSM para TIFF C#" offSpacer="" %}}
