...
description: Converta JPG para PPTX em C#. Use a API da biblioteca .NET para converter imagens JPG em PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter JPG para PPTX em C#" h2="Poderosa API .NET multiplataforma para converter JPG em PPTX usando código C# em plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" >}}
