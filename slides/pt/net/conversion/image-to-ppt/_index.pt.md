...
url: /pt/net/conversion/image-to-ppt/
keywords: Converter imagem para PPT, imagem para PPT, PowerPoint, imagem, PPT, C# API, Biblioteca .NET
description: Converter imagem para PPT em C#. Use a API da biblioteca .NET para converter imagens em PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter imagem para PPT em C#" h2="Poderosa API .NET multiplataforma para converter imagem em PPT usando código C# em plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Converter imagem para PPT usando Aspose.Slides" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter imagem para PPT em C#" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/pt/net/conversion/image-to-pptx/" name="IMAGE TO PPTX" >}}
