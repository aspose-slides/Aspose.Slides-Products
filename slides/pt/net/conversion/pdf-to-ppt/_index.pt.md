...
description: Converta PDF para PPT em C#. Use a API da biblioteca .NET para converter PDF em PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter PDF para PPT em C#" h2="Poderosa API .NET multiplataforma para converter PDF em PPT usando código C# em plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Converter PDF para PPT usando Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/pt/net/) é uma poderosa biblioteca .NET usada para criar, converter e manipular apresentações em PowerPoint, PDFs, documentos HTML, e outros arquivos. Ao converter PDF para PPT, você está basicamente movendo o conteúdo das páginas do PDF para slides em uma apresentação do PowerPoint.
...
{{% blocks/products/pf/agp/code-block title="Código C# para converter PDF para PPT" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PDF para PPT em C#" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Carregue o arquivo PDF que deseja converter em PPT.
{{< /blocks/products/pf/agp/step-autogen >}}
