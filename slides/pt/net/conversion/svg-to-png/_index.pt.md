...
keywords: SVG para PNG, Converter SVG para PNG, API C#, Biblioteca .NET
description: Converta SVG para PNG em C#. Use a API da biblioteca .NET para converter arquivos SVG para PNG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter SVG para PNG em C#" h2="API .NET do PowerPoint para converter arquivos de imagem SVG em PNG nas plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Converter SVG para PNG em C#" %}}

Como faço para converter SVG para PNG no código?

Usando o [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pt/net/), qualquer desenvolvedor ou aplicativo pode converter SVG para PNG com apenas algumas linhas de código C#.

Como uma API moderna de processamento de documentos, o Aspose.Slides for .NET exporta arquivos SVG para PNG rapidamente. A biblioteca Aspose PowerPoint permite converter SVG para PNG e imagens em outros formatos.
...
{{< blocks/products/pf/agp/feature-section-col title="Como converter SVG para PNG em C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Desenvolvedores e aplicativos podem converter SVG para PNG desta forma:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Salve o arquivo como uma imagem PNG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Antes de executar o código C# de conversão de SVG para PNG, sua máquina deve ter estes pré-requisitos:
...
{{% blocks/products/pf/agp/code-block title="Código C# para converter SVG para PNG" offSpacer="" %}}
