...
title: Converter PDF para HTML em C#
weight: 120
url: /pt/net/conversion/pdf-to-html/ 
keywords: PDF para HTML, Converter PDF para HTML, API C#, Biblioteca .NET, PDF, HTML
description: Converta PDF para HTML em C#. Use a API da biblioteca .NET para converter páginas PDF em arquivos HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter PDF para HTML em C#" h2="API .NET do PowerPoint para converter documentos PDF em arquivos HTML nas plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PDF para HTML em C #" %}}

Como faço para converter PDF para HTML em código?

Usando o [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pt/net/), qualquer desenvolvedor ou aplicativo pode converter PDF em arquivos HTML com apenas algumas linhas de código C#.

Como uma API moderna de processamento de documentos, o Aspose.Slides for .NET exporta páginas PDF para HTML rapidamente. A biblioteca Aspose PowerPoint permite converter PDF para HTML e muitos outros formatos de arquivo.
...
{{< blocks/products/pf/agp/feature-section-col title="Como converter PDF para HTML em C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Desenvolvedores e aplicativos podem converter PDF em HTML desta forma:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Adicione slides com base nas páginas do PDF.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Chame o método save para salvar os slides em HTML.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Antes de executar o código C# de conversão de PDF para HTML, sua máquina deve ter estes pré-requisitos:
...
{{% blocks/products/pf/agp/code-block title="Código C# para converter PDF em HTML" offSpacer="" %}}
