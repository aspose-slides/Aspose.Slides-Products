...
keywords: HTML para PDF, Converter HTML para PDF, API C#, Biblioteca .NET, HTML, PDF
description: Converta HTML para PDF em C#. Use a API da biblioteca .NET para converter páginas HTML em documentos PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter HTML para PDF em C#" h2="API .NET do PowerPoint para converter páginas HTML em documentos PDF nas plataformas NET Framework, .NET Core, Windows Azure, Mono ou Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter HTML para PDF em C#" %}}

Como faço para converter HTML para PDF programaticamente?

Usando o [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pt/net/), qualquer desenvolvedor ou aplicativo pode converter HTML em formato PDF com apenas algumas linhas de código C#.

Como uma API moderna de processamento de documentos, o Aspose.Slides for .NET cria PDFs a partir de páginas HTML rapidamente. A biblioteca Aspose PowerPoint permite converter HTML para PDF e muitos outros formatos de arquivo
...
{{< blocks/products/pf/agp/feature-section-col title="Etapas para converter HTML em PDF em C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Desenvolvedores e aplicativos podem converter HTML em PDF desta forma:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Antes de executar o código C# de conversão de HTML para PDF, sua máquina deve ter estes pré-requisitos:
...
{{% blocks/products/pf/agp/code-block title="Código C# para converter HTML em PDF" offSpacer="" %}}
