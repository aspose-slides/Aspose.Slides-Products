...
url: /pt/cpp/merger/jpg-to-pdf/
keywords: JPG para PDF, Mesclar JPG para PDF, Juntar JPG para PDF, PDF, JPG, API C++, Biblioteca C++
description: Mesclar JPG para PDF em C++. Use a API da biblioteca C++ para combinar JPG e PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar JPG para PDF em C++" h2="Biblioteca C++ de plataforma cruzada e de alta velocidade para mesclar arquivos JPG em PDF usando código C++" >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar JPG para PDF usando Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/pt/cpp/) é uma poderosa biblioteca C++ usada para criar, converter, mesclar e manipular apresentações, PDFs, imagens e outros arquivos. Ao mesclar JPG com PDF, você está efetivamente combinando imagens JPG para obter um único arquivo PDF.
...
{{% blocks/products/pf/feature-page-section  h2="Mesclar JPG para PDF em C++" %}}
Usando [**Aspose.Slides for C++**](https://products.aspose.com/slides/pt/cpp/), você pode mesclar JPG para PDF rapidamente com apenas algumas linhas de código

{{% blocks/products/pf/agp/code-block title="Código C++ para mesclar JPG para PDF" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="Como mesclar JPG para PDF em C++" >}}
