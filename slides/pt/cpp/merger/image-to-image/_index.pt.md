...
url: /pt/cpp/merger/image-to-image/
keywords: Mesclar imagem, imagem a imagem, unir imagens, combinar imagens, API C++, biblioteca C++
description: Mesclar imagem para imagem em C++. Use a API da biblioteca C++ para combinar imagens
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar imagem em C++" h2="Biblioteca C++ multiplataforma e de alta velocidade para mesclar imagens usando código C++" >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar imagem a imagem usando Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/pt/cpp/) é uma poderosa biblioteca C++ usada para mesclar e manipular apresentações, imagens e outros arquivos. Ao mesclar imagem com imagem, você está efetivamente combinando duas imagens para obter uma imagem.
