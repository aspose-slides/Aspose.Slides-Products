...
url: /pt/cpp/merger/pdf-to-pdf/
keywords: Mesclar PDF, PDF para PDF, Juntar PDF, Combinar PDF, API C++, Biblioteca C++
description: Mesclar PDF para PDF em C++. Use a API da biblioteca C++ para combinar arquivos PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar PDF em C++" h2="Biblioteca C++ multiplataforma e de alta velocidade para mesclar arquivos PDF usando código C++" >}}
...
Usando [**Aspose.Slides for C++**](https://products.aspose.com/slides/pt/cpp/), você pode mesclar arquivos PDF rapidamente com apenas algumas linhas de código
