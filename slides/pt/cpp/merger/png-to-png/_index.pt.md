...
url: /pt/cpp/merger/png-to-png/
keywords: Mesclar PNG, PNG para PNG, Unir PNG, Combinar PNG, API C++, Biblioteca C++
description: Mesclar PNG para PNG em C++. Use a API da biblioteca C++ para combinar arquivos PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar PNG em C++" h2="Biblioteca C++ multiplataforma e de alta velocidade para mesclar imagens PNG usando código C++" >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar PNG para PNG usando Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/pt/cpp/) é uma poderosa biblioteca C++ usada para mesclar e manipular apresentações, imagens e outros arquivos. Ao mesclar PNG com PNG, você está efetivamente combinando duas imagens para obter uma imagem.
...
Usando [**Aspose.Slides for C++**](https://products.aspose.com/slides/pt/cpp/), você pode mesclar arquivos PNG rapidamente com apenas algumas linhas de código
