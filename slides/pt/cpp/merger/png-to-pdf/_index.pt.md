...
url: /pt/cpp/merger/png-to-pdf/
keywords: PNG para PDF, Mesclar PNG para PDF, Juntar PNG para PDF, PDF, PNG, API C++, Biblioteca C++
description: Mesclar PNG para PDF em C++. Use a API da biblioteca C++ para combinar PNG e PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar PNG para PDF em C++" h2="Biblioteca C++ de plataforma cruzada e de alta velocidade para mesclar arquivos PNG para PDF usando código C++" >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar PNG para PDF usando Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/pt/cpp/) é uma poderosa biblioteca C++ usada para criar, converter, mesclar e manipular apresentações, imagens e outros arquivos. Ao mesclar PNG com PDF, você está efetivamente combinando imagens PNG para obter um único arquivo PDF.
...
Usando [**Aspose.Slides for C++**](https://products.aspose.com/slides/pt/cpp/), você pode mesclar PNG para PDF rapidamente com apenas algumas linhas de código
