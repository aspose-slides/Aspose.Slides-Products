...
url: /pt/cpp/merger/image-to-pdf/
keywords: Imagem para PDF, Mesclar imagem para PDF, Juntar imagem para PDF, PDF, Imagem, API C++, Biblioteca C++
description: Mesclar imagem para PDF em C++. Use a API da biblioteca C++ para combinar imagem e PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar imagem para PDF em C++" h2="Biblioteca C++ multiplataforma e de alta velocidade para mesclar imagens em arquivos PDF usando código C++" >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar imagem para PDF usando Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/pt/cpp/) é uma poderosa biblioteca C++ usada para criar, converter, mesclar e manipular apresentações, PDFs, imagens e outros arquivos. Ao mesclar imagem em PDF, você está efetivamente combinando imagens para obter um único arquivo PDF.
...
Usando [**Aspose.Slides for C++**](https://products.aspose.com/slides/pt/cpp/), você pode mesclar imagem em PDF rapidamente com apenas algumas linhas de código
