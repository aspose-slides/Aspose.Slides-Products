...
{{% blocks/products/pf/agp/text %}}
 ...
 Os desenvolvedores de C++ podem facilmente converter arquivos OTP para POT em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de OTP para POT C++" offSpacer="" %}}
