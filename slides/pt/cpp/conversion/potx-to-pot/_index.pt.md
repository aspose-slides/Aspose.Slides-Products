...
{{% blocks/products/pf/agp/content h2="Como converter POTX para POT usando C++" %}}

 Para converter POTX para POT, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter POTX para POT via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Desenvolvedores C++ podem facilmente converter arquivos POTX para POT em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão POTX para POT C++" offSpacer="" %}}
