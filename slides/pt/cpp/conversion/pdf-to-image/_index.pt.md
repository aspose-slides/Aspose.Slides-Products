---
title: Converter PDF para Image em C++
url: /pt/cpp/conversion/pdf-to-image/
keywords: PDF para Image, Converter PDF para Image, API C++, Biblioteca C++, PDF, Image
description: Converta PDF para Image em C++. Use a API da biblioteca C++ para converter arquivos PDF em Images
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter PDF para Image em C++" h2="Biblioteca C++ de plataforma cruzada e de alta velocidade que ajuda no desenvolvimento de aplicativos com a capacidade de criar, mesclar, inspecionar ou converter arquivos de apresentação do Microsoft PowerPoint e OpenOffice sem o uso de qualquer software como Microsoft ou Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Converter PDF para Image em C++" %}}
...
Como uma API moderna de processamento de documentos, o Aspose.Slides for C++ exporta arquivos PDF para formatos de arquivo Image rapidamente. A biblioteca Aspose PowerPoint permite converter PDF para Images e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converter PDF para Image usando C++" %}}
Para converter o PDF para Image, você precisará criar a apresentação do arquivo PDF e salvá-lo como Image.

{{% blocks/products/pf/agp/code-block title="Código C++ para converter PDF em Image" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PDF para Image usando Aspose.Slides para C++ API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estas são as etapas para converter PDF em Image em C++." >}}
