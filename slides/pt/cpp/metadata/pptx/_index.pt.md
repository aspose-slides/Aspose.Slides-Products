---
title: Visualize ou edite metadados de arquivos PPTX usando C++
...
{{% blocks/products/pf/agp/code-block title="Modificar propriedades integradas PPTX - C++" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Adicionar propriedades personalizadas a PPTX - C++" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como extrair metadados de PPTX via C++" >}}
