---
title: Mesclar JPG para PDF em PHP
url: /pt/php-java/merger/jpg-to-pdf/
keywords: JPG para PDF, Mesclar JPG para PDF, Juntar JPG para PDF, PDF, JPG, API PHP, Biblioteca PHP
description: Mesclar JPG para PDF em PHP. Use a API da biblioteca PHP para combinar JPG e PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar JPG para PDF em PHP" h2="Biblioteca PHP multiplataforma e de alta velocidade para mesclar arquivos JPG em PDF usando código PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar JPG para PDF usando Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pt/php-java/) é uma poderosa biblioteca PHP usada para criar, converter, mesclar e manipular apresentações, PDFs, imagens e outros arquivos. Ao mesclar JPG com PDF, você está efetivamente combinando imagens JPG para obter um único arquivo PDF.
...
{{% blocks/products/pf/feature-page-section  h2="Mesclar JPG para PDF em PHP" %}}
Usando [**Aspose.Slides para PHP via Java**](https://products.aspose.com/slides/pt/php-java/), você pode mesclar JPG para PDF rapidamente com apenas algumas linhas de código

{{% blocks/products/pf/agp/code-block title="Código PHP para mesclar JPG para PDF" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Como mesclar JPG para PDF em PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Carregue as imagens JPG que deseja mesclar como molduras.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/pt/php-java/merger/svg-to-png/" name="SVG TO PNG" >}} 
