---
title: Mesclar HTML para imagem em PHP
url: /pt/php-java/merger/html-to-image/
keywords: Mesclar HTML para imagem, HTML para imagem, Juntar HTML, Combinar HTML, Imagem, API PHP, Biblioteca PHP
description: Mesclar HTML para imagem em PHP. Use a API da biblioteca PHP para combinar HTML com imagem
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar imagem em PHP" h2="Biblioteca PHP multiplataforma e de alta velocidade para mesclar HTML com imagem usando código PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar HTML para imagem usando Aspose.Slides" %}}

[**Aspose.Slides para PHP via Java**](https://products.aspose.com/slides/pt/php-java/) é uma poderosa biblioteca PHP usada para mesclar e manipular apresentações, documentos HTML e outros arquivos. Ao mesclar HTML com imagem, você está efetivamente combinando o conteúdo em documentos HTML para obter uma única imagem. 
...
{{% blocks/products/pf/feature-page-section  h2="Mesclar HTML para imagem em PHP" %}}
...
{{% blocks/products/pf/agp/code-block title="Código PHP para mesclar HTML com imagem" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Como mesclar HTML para imagem em PHP" >}}
