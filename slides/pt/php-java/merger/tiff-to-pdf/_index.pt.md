---
title: Mesclar TIFF para PDF em PHP
url: /pt/php-java/merger/tiff-to-pdf/
keywords: TIFF para PDF, Mesclar TIFF para PDF, Juntar TIFF para PDF, PDF, TIFF, API PHP, Biblioteca PHP
description: Mesclar TIFF para PDF em PHP. Use a API da biblioteca PHP para combinar TIFF e PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar TIFF para PDF em PHP" h2="Biblioteca PHP multiplataforma e de alta velocidade para mesclar arquivos TIFF em PDF usando código PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar TIFF para PDF usando Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pt/php-java/) é uma poderosa biblioteca PHP usada para criar, converter, mesclar e manipular apresentações, PDFs, imagens e outros arquivos. Ao mesclar TIFF com PDF, você está efetivamente combinando imagens para obter um único arquivo PDF.
...
{{% blocks/products/pf/feature-page-section  h2="Mesclar TIFF para PDF em PHP" %}}
Usando [**Aspose.Slides para PHP via Java**](https://products.aspose.com/slides/pt/php-java/), você pode mesclar TIFF para PDF rapidamente com apenas algumas linhas de código

{{% blocks/products/pf/agp/code-block title="Código PHP para mesclar TIFF para PDF" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Como mesclar TIFF para PDF em PHP" >}}
