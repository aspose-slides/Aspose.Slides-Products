---
title: Mesclar imagens em PHP
url: /pt/php-java/merger/image-to-image/
keywords: Mesclar imagem, imagem a imagem, unir imagens, combinar imagens, PHP API, biblioteca PHP
description: Mesclar imagem para imagem em PHP. Use a API da biblioteca PHP para combinar imagens
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar imagem em PHP" h2="Biblioteca PHP multiplataforma e de alta velocidade para mesclar imagens usando código PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar imagem a imagem usando Aspose.Slides" %}}

[**Aspose.Slides para PHP via Java**](https://products.aspose.com/slides/pt/php-java/) é uma poderosa biblioteca PHP usada para mesclar e manipular apresentações, imagens e outros arquivos. Ao mesclar imagem com imagem, você está efetivamente combinando duas imagens para obter uma imagem.
...
{{% blocks/products/pf/feature-page-section  h2="Mesclar imagem para imagem em PHP" %}}
Usando [**Aspose.Slides para PHP via Java**](https://products.aspose.com/slides/pt/php-java/), você pode mesclar arquivos de imagem rapidamente com apenas algumas linhas de código

{{% blocks/products/pf/agp/code-block title="Código PHP para mesclar imagem com imagem" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Como mesclar imagens em PHP" >}}
