---
title: Mesclar imagens PNG em PHP
url: /pt/php-java/merger/png-to-png/
keywords: Mesclar PNG, PNG para PNG, Unir PNG, Combinar PNG, PHP API, Biblioteca PHP
description: Mesclar PNG para PNG em PHP. Use a API da biblioteca PHP para combinar arquivos PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar PNG em PHP" h2="Biblioteca PHP multiplataforma e de alta velocidade para mesclar imagens PNG usando código PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar PNG para PNG usando Aspose.Slides" %}}

[**Aspose.Slides para PHP via Java**](https://products.aspose.com/slides/pt/php-java/) é uma poderosa biblioteca PHP usada para mesclar e manipular apresentações, imagens e outros arquivos. Ao mesclar PNG com PNG, você está efetivamente combinando duas imagens para obter uma imagem.
...
{{% blocks/products/pf/feature-page-section  h2="Mesclar PNG para PNG em PHP" %}}
Usando [**Aspose.Slides para PHP via Java**](https://products.aspose.com/slides/pt/php-java/), você pode mesclar arquivos PNG rapidamente com apenas algumas linhas de código

{{% blocks/products/pf/agp/code-block title="Código PHP para mesclar PNG para PNG" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Como mesclar PNG em PHP" >}}
