...
title: Converter PDF para ODP em PHP
weight: 690
url: /pt/php-java/conversion/pdf-to-odp/ 
keywords: "Convert, PowerPoint, PDF, ODP, Presentation, PHP"
description: Código de exemplo para conversão PHP de PDF para ODP. Use a API PHP do PowerPoint para conversão em lote de arquivos PDF para arquivos ODP.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PDF para ODP em PHP" h2="Poderosa biblioteca PHP do PowerPoint para converter PDF para ODP" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Converter PDF para ODP em PHP" %}}

Precisa converter arquivos PDF para ODP programaticamente? Usando [*Aspose.Slides for PHP via Java*](https://products.aspose.com/slides/pt/php-java/) qualquer desenvolvedor pode converter o formato PDF para ODP com apenas algumas linhas de código PHP .
...
{{< blocks/products/pf/agp/feature-section-col title="Como converter PDF para ODP em PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estas são as etapas para converter um arquivo PDF para ODP usando PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de PDF para ODP PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Salve PDF como ODP em PHP" %}}
