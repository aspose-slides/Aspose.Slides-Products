...
title: Converter POTX para XPS em PHP
weight: 1470
url: /pt/php-java/conversion/potx-to-xps/ 
keywords: "Convert, PowerPoint, POTX, XPS, Presentation, PHP"
description: Código de exemplo para conversão PHP de POTX para XPS. Use a API PHP do PowerPoint para conversão em lote de arquivos POTX para arquivos XPS.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter POTX para XPS em PHP" h2="Poderosa biblioteca PHP do PowerPoint para converter POTX para XPS" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Converter POTX para XPS em PHP" %}}

Precisa converter arquivos POTX para XPS programaticamente? Usando [*Aspose.Slides for PHP via Java*](https://products.aspose.com/slides/pt/php-java/) qualquer desenvolvedor pode converter o formato POTX para XPS com apenas algumas linhas de código PHP .

Como uma API de processamento de apresentação moderna, o Aspose.Slides for PHP cria XPS a partir de POTX rapidamente. Teste a qualidade da conversão de POTX para XPS diretamente no seu [navegador](https://products.aspose.app/slides/conversion). A biblioteca Aspose PowerPoint PPTX permite converter arquivos POTX para muitos formatos populares.
...
{{< blocks/products/pf/agp/feature-section-col title="Como converter POTX para XPS em PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estas são as etapas para converter um arquivo POTX para XPS usando PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de POTX para XPS PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Salve POTX como XPS em PHP" %}}
Use o aplicativo gratuito para ver uma demonstração do processo de conversão de POTX para XPS. 
{{% /blocks/products/pf/agp/content %}}
