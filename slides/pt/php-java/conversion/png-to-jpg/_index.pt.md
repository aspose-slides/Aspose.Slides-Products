---
title: Converter PNG para JPG em PHP
url: /pt/php-java/conversion/png-to-jpg/
keywords: PNG para JPG, Converter PNG para JPG, API PHP, Biblioteca PHP, PNG, JPG
description: Converter PNG para JPG em PHP. Use a API PHP do PowerPoint para converter arquivos PNG em JPG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter PNG para JPG em PHP" h2="Poderosa biblioteca PowerPoint PHP que ajuda no desenvolvimento de aplicativos com a capacidade de criar, mesclar, inspecionar ou converter arquivos de apresentação do Microsoft PowerPoint e OpenOffice sem o uso de qualquer software como Microsoft ou Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Converter PNG para JPG em PHP" %}}

[**Aspose.Slides para PHP via Java**](https://products.aspose.com/slides/pt/php-java/) é uma poderosa biblioteca PHP para criar e manipular arquivos de apresentação. Além disso, oferece maneiras flexíveis de converter PNG em JPG. Usando **Aspose.Slides para PHP via Java**, qualquer desenvolvedor ou aplicativo pode converter arquivos PNG em JPG com apenas algumas linhas de código PHP.

Como uma API moderna de processamento de documentos, o Aspose.Slides for PHP exporta arquivos PNG para formatos de arquivo JPG rapidamente. A biblioteca Aspose PowerPoint permite converter PNG para JPGs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converter PNG para JPG usando PHP" %}}
Para converter o PNG para JPG, você precisará criar a apresentação do arquivo PNG e salvá-lo como JPG.

{{% blocks/products/pf/agp/code-block title="Código PHP para converter PNG em JPG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PNG para JPG usando Aspose.Slides para PHP API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estas são as etapas para converter PNG para JPG em PHP." >}}
