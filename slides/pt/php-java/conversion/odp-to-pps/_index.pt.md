---
title: Converter ODP para PPS em PHP
weight: 330
url: /pt/php-java/conversion/odp-to-pps/ 
keywords: "Convert, PowerPoint, ODP, PPS, Presentation, PHP"
description: Código de exemplo para conversão PHP de ODP para PPS. Use a API PHP do PowerPoint para conversão em lote de arquivos ODP para arquivos PPS.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter ODP para PPS em PHP" h2="Poderosa biblioteca PHP do PowerPoint para converter ODP para PPS" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Converter ODP para PPS em PHP" %}}

Precisa converter arquivos ODP para PPS programaticamente? Usando [*Aspose.Slides for PHP via Java*](https://products.aspose.com/slides/pt/php-java/) qualquer desenvolvedor pode converter o formato ODP para PPS com apenas algumas linhas de código PHP .

Como uma API de processamento de apresentação moderna, o Aspose.Slides for PHP cria PPS a partir de ODP rapidamente. Teste a qualidade da conversão de ODP para PPS diretamente no seu [navegador](https://products.aspose.app/slides/conversion). A biblioteca Aspose PowerPoint PPTX permite converter arquivos ODP para muitos formatos populares.
...
{{< blocks/products/pf/agp/feature-section-col title="Como converter ODP para PPS em PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estas são as etapas para converter um arquivo ODP para PPS usando PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de ODP para PPS PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Salve ODP como PPS em PHP" %}}
