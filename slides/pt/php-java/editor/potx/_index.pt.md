---
title: Editar POTX em PHP
url: /pt/php-java/editor/potx/
keywords: Editar POTX, Editar PowerPoint, POTX, PowerPoint, API PHP, Biblioteca PHP
description: Edite POTX em PHP. Use a API da biblioteca PHP para editar arquivos POTX
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Editar POTX em PHP" h2="Biblioteca PHP multiplataforma e de alta velocidade para edição POTX usando código PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edite POTX usando Aspose.Slides" %}}

[**Aspose.Slides para PHP via Java**](https://products.aspose.com/slides/pt/php-java/) é uma poderosa biblioteca PHP usada para manipular e editar apresentações. Você pode editar uma apresentação POTX adicionando uma nova linha de texto a ela. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Editar POTX em PHP" %}}
Usando [**Aspose.Slides para PHP via Java**](https://products.aspose.com/slides/pt/php-java/), você pode adicionar uma nova linha de texto ao documento POTX com apenas um algumas linhas de código.

{{% blocks/products/pf/agp/code-block title="Código PHP para edição POTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como editar POTX em PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Carregue a apresentação POTX que deseja editar.
{{< /blocks/products/pf/agp/step-autogen >}}
