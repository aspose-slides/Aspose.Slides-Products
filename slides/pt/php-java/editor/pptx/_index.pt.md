---
title: Editar PPTX em PHP
url: /pt/php-java/editor/pptx/
keywords: Editar PPTX, Editar PowerPoint, PPTX, PowerPoint, API PHP, Biblioteca PHP
description: Edite PPTX em PHP. Use a API da biblioteca PHP para editar arquivos PPTX
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Editar PPTX em PHP" h2="Biblioteca PHP multiplataforma e de alta velocidade para edição PPTX usando código PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edite PPTX usando Aspose.Slides" %}}

[**Aspose.Slides para PHP via Java**](https://products.aspose.com/slides/pt/php-java/) é uma poderosa biblioteca PHP usada para manipular e editar apresentações. Você pode editar uma apresentação PPTX adicionando uma nova linha de texto a ela. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Editar PPTX em PHP" %}}
Usando [**Aspose.Slides para PHP via Java**](https://products.aspose.com/slides/pt/php-java/), você pode adicionar uma nova linha de texto ao documento PPTX com apenas um algumas linhas de código.

{{% blocks/products/pf/agp/code-block title="Código PHP para edição PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como editar PPTX em PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Carregue a apresentação PPTX que deseja editar.
{{< /blocks/products/pf/agp/step-autogen >}}
