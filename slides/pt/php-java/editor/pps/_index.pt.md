---
title: Editar PPS em PHP
url: /pt/php-java/editor/pps/
keywords: Editar PPS, Editar PowerPoint, PPS, PowerPoint, API PHP, Biblioteca PHP
description: Edite PPS em PHP. Use a API da biblioteca PHP para editar arquivos PPS
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Editar PPS em PHP" h2="Biblioteca PHP multiplataforma e de alta velocidade para edição PPS usando código PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edite PPS usando Aspose.Slides" %}}

[**Aspose.Slides para PHP via Java**](https://products.aspose.com/slides/pt/php-java/) é uma poderosa biblioteca PHP usada para manipular e editar apresentações. Você pode editar uma apresentação PPS adicionando uma nova linha de texto a ela. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Editar PPS em PHP" %}}
Usando [**Aspose.Slides para PHP via Java**](https://products.aspose.com/slides/pt/php-java/), você pode adicionar uma nova linha de texto ao documento PPS com apenas um algumas linhas de código.

{{% blocks/products/pf/agp/code-block title="Código PHP para edição PPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como editar PPS em PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Carregue a apresentação PPS que deseja editar.
{{< /blocks/products/pf/agp/step-autogen >}}
