---
title: Editar ODP em PHP
url: /pt/php-java/editor/odp/
keywords: Editar ODP, Editar PowerPoint, ODP, PowerPoint, API PHP, Biblioteca PHP
description: Edite ODP em PHP. Use a API da biblioteca PHP para editar arquivos ODP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Editar ODP em PHP" h2="Biblioteca PHP multiplataforma e de alta velocidade para edição ODP usando código PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edite ODP usando Aspose.Slides" %}}

[**Aspose.Slides para PHP via Java**](https://products.aspose.com/slides/pt/php-java/) é uma poderosa biblioteca PHP usada para manipular e editar apresentações. Você pode editar uma apresentação ODP adicionando uma nova linha de texto a ela. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Editar ODP em PHP" %}}
Usando [**Aspose.Slides para PHP via Java**](https://products.aspose.com/slides/pt/php-java/), você pode adicionar uma nova linha de texto ao documento ODP com apenas um algumas linhas de código.

{{% blocks/products/pf/agp/code-block title="Código PHP para edição ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como editar ODP em PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Carregue a apresentação ODP que deseja editar.
{{< /blocks/products/pf/agp/step-autogen >}}
