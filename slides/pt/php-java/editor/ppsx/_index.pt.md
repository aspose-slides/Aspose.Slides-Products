---
title: Editar PPSX em PHP
url: /pt/php-java/editor/ppsx/
keywords: Editar PPSX, Editar PowerPoint, PPSX, PowerPoint, API PHP, Biblioteca PHP
description: Edite PPSX em PHP. Use a API da biblioteca PHP para editar arquivos PPSX
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Editar PPSX em PHP" h2="Biblioteca PHP multiplataforma e de alta velocidade para edição PPSX usando código PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edite PPSX usando Aspose.Slides" %}}

[**Aspose.Slides para PHP via Java**](https://products.aspose.com/slides/pt/php-java/) é uma poderosa biblioteca PHP usada para manipular e editar apresentações. Você pode editar uma apresentação PPSX adicionando uma nova linha de texto a ela. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Editar PPSX em PHP" %}}
Usando [**Aspose.Slides para PHP via Java**](https://products.aspose.com/slides/pt/php-java/), você pode adicionar uma nova linha de texto ao documento PPSX com apenas um algumas linhas de código.

{{% blocks/products/pf/agp/code-block title="Código PHP para edição PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como editar PPSX em PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Carregue a apresentação PPSX que deseja editar.
{{< /blocks/products/pf/agp/step-autogen >}}
