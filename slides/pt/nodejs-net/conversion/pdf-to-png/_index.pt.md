...
Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos PDF para formatos de arquivo PNG rapidamente. A biblioteca Aspose PowerPoint permite converter PDF em PNGs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PDF em PNG usando JavaScript" %}}
Para converter PDF para PNG, você precisará criar uma apresentação a partir do arquivo PDF e salvá-la como PNG.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter PDF em PNG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PDF para PNG usando Aspose.Slides para Node.js via .NET API" >}}
