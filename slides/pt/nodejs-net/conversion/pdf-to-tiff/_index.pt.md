...
Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos PDF para formatos de arquivo TIFF rapidamente. A biblioteca Aspose PowerPoint permite converter PDF em TIFFs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PDF em TIFF usando JavaScript" %}}
Para converter PDF para TIFF, você precisará criar uma apresentação a partir do arquivo PDF e salvá-la como TIFF.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter PDF em TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PDF para TIFF usando Aspose.Slides para Node.js via .NET API" >}}
