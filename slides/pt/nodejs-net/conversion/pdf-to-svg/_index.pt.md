...
Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos PDF para formatos de arquivo SVG rapidamente. A biblioteca Aspose PowerPoint permite converter PDF em SVGs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PDF em SVG usando JavaScript" %}}
Para converter PDF para SVG, você precisará criar uma apresentação a partir do arquivo PDF e salvá-la como SVG.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter PDF em SVG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PDF para SVG usando Aspose.Slides para Node.js via .NET API" >}}
