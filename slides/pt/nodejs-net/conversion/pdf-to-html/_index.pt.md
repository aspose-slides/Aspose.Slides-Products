...
Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos PDF para formatos de arquivo HTML rapidamente. A biblioteca Aspose PowerPoint permite converter PDF em HTMLs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PDF em HTML usando JavaScript" %}}
Para converter PDF para HTML, você precisará criar uma apresentação a partir do arquivo PDF e salvá-la como HTML.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter PDF em HTML" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PDF para HTML usando Aspose.Slides para Node.js via .NET API" >}}
