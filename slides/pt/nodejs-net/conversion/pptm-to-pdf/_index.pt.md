---
title: Converter PPTM em PDF em JavaScript
url: /pt/nodejs-net/conversion/pptm-to-pdf/
keywords: PPTM para PDF, converter PPTM para PDF, API Node.js, biblioteca JavaScript, PPTM, PDF
description: Converta PPTM em PDF em JavaScript. Use a API da biblioteca Node.js para converter arquivos PPTM em PDF
---
...
Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos PPTM para formatos de arquivo PDF rapidamente. A biblioteca Aspose PowerPoint permite converter PPTM em PDFs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PPTM em PDF usando JavaScript" %}}
Para converter PPTM para PDF, você precisará criar uma apresentação a partir do arquivo PPTM e salvá-la como PDF.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter PPTM em PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PPTM para PDF usando Aspose.Slides para Node.js via .NET API" >}}
