---
title: Converter FODP em POTM em JavaScript
url: /pt/nodejs-net/conversion/fodp-to-potm/
keywords: FODP para POTM, converter FODP para POTM, API Node.js, biblioteca JavaScript, FODP, POTM
description: Converta FODP em POTM em JavaScript. Use a API da biblioteca Node.js para converter arquivos FODP em POTM
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter FODP em POTM em JavaScript" h2="Aspose.Slides para Node.js via .NET é uma biblioteca poderosa e fácil de usar que permite converter apresentações do PowerPoint para vários formatos em JavaScript. Ele suporta todos os elementos e formatos de apresentação e fornece uma API avançada para acessá-los e modificá-los. Também permite exportar seus slides para vários formatos para processamento ou compartilhamento posterior." >}}
...
Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos FODP para formatos de arquivo POTM rapidamente. A biblioteca Aspose PowerPoint permite converter FODP em POTMs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta FODP em POTM usando JavaScript" %}}
Para converter FODP para POTM, você precisará criar uma apresentação a partir do arquivo FODP e salvá-la como POTM.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter FODP em POTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter FODP para POTM usando Aspose.Slides para Node.js via .NET API" >}}
