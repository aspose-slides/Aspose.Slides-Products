...
Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos OTP para formatos de arquivo POTX rapidamente. A biblioteca Aspose PowerPoint permite converter OTP em POTXs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta OTP em POTX usando JavaScript" %}}
Para converter OTP para POTX, você precisará criar uma apresentação a partir do arquivo OTP e salvá-la como POTX.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter OTP em POTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter OTP para POTX usando Aspose.Slides para Node.js via .NET API" >}}
