...
Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos PDF para formatos de arquivo PPSM rapidamente. A biblioteca Aspose PowerPoint permite converter PDF em PPSMs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PDF em PPSM usando JavaScript" %}}
Para converter PDF para PPSM, você precisará criar uma apresentação a partir do arquivo PDF e salvá-la como PPSM.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter PDF em PPSM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PDF para PPSM usando Aspose.Slides para Node.js via .NET API" >}}
