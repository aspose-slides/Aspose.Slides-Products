...
Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos PDF para formatos de arquivo OTP rapidamente. A biblioteca Aspose PowerPoint permite converter PDF em OTPs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PDF em OTP usando JavaScript" %}}
Para converter PDF para OTP, você precisará criar uma apresentação a partir do arquivo PDF e salvá-la como OTP.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter PDF em OTP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PDF para OTP usando Aspose.Slides para Node.js via .NET API" >}}
