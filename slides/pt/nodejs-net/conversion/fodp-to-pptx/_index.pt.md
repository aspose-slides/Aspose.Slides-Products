---
title: Converter FODP em PPTX em JavaScript
url: /pt/nodejs-net/conversion/fodp-to-pptx/
keywords: FODP para PPTX, converter FODP para PPTX, API Node.js, biblioteca JavaScript, FODP, PPTX
description: Converta FODP em PPTX em JavaScript. Use a API da biblioteca Node.js para converter arquivos FODP em PPTX
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter FODP em PPTX em JavaScript" h2="Aspose.Slides para Node.js via .NET é uma biblioteca poderosa e fácil de usar que permite converter apresentações do PowerPoint para vários formatos em JavaScript. Ele suporta todos os elementos e formatos de apresentação e fornece uma API avançada para acessá-los e modificá-los. Também permite exportar seus slides para vários formatos para processamento ou compartilhamento posterior." >}}
...
Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos FODP para formatos de arquivo PPTX rapidamente. A biblioteca Aspose PowerPoint permite converter FODP em PPTXs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta FODP em PPTX usando JavaScript" %}}
Para converter FODP para PPTX, você precisará criar uma apresentação a partir do arquivo FODP e salvá-la como PPTX.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter FODP em PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter FODP para PPTX usando Aspose.Slides para Node.js via .NET API" >}}
