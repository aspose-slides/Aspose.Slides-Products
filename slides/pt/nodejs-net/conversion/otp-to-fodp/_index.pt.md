---
title: Converter OTP em FODP em JavaScript
url: /pt/nodejs-net/conversion/otp-to-fodp/
keywords: OTP para FODP, converter OTP para FODP, API Node.js, biblioteca JavaScript, OTP, FODP
description: Converta OTP em FODP em JavaScript. Use a API da biblioteca Node.js para converter arquivos OTP em FODP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter OTP em FODP em JavaScript" h2="Aspose.Slides para Node.js via .NET é uma biblioteca poderosa e fácil de usar que permite converter apresentações do PowerPoint para vários formatos em JavaScript. Ele suporta todos os elementos e formatos de apresentação e fornece uma API avançada para acessá-los e modificá-los. Também permite exportar seus slides para vários formatos para processamento ou compartilhamento posterior." >}}

{{% blocks/products/pf/feature-page-section h2="Converter OTP em FODP em Node.js" %}}

[**Aspose.Slides para Node.js via .NET**](https://products.aspose.com/slides/pt/nodejs-net/) é uma biblioteca Node.js poderosa para criar e manipular arquivos de apresentação. Além disso, oferece maneiras flexíveis de converter OTP em FODP. Usando **Aspose.Slides para Node.js via .NET**, qualquer desenvolvedor ou aplicativo pode converter arquivos OTP em FODP com apenas algumas linhas de código.

Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos OTP para formatos de arquivo FODP rapidamente. A biblioteca Aspose PowerPoint permite converter OTP em FODPs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta OTP em FODP usando JavaScript" %}}
Para converter OTP para FODP, você precisará criar uma apresentação a partir do arquivo OTP e salvá-la como FODP.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter OTP em FODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter OTP para FODP usando Aspose.Slides para Node.js via .NET API" >}}
