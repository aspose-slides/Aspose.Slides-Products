...
Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos PDF para formatos de arquivo JPG rapidamente. A biblioteca Aspose PowerPoint permite converter PDF em JPGs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PDF em JPG usando JavaScript" %}}
Para converter PDF para JPG, você precisará criar uma apresentação a partir do arquivo PDF e salvá-la como JPG.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter PDF em JPG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PDF para JPG usando Aspose.Slides para Node.js via .NET API" >}}
