...
Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos PDF para formatos de arquivo POT rapidamente. A biblioteca Aspose PowerPoint permite converter PDF em POTs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PDF em POT usando JavaScript" %}}
Para converter PDF para POT, você precisará criar uma apresentação a partir do arquivo PDF e salvá-la como POT.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter PDF em POT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PDF para POT usando Aspose.Slides para Node.js via .NET API" >}}
