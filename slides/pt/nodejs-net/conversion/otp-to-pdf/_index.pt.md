---
title: Converter OTP em PDF em JavaScript
url: /pt/nodejs-net/conversion/otp-to-pdf/
keywords: OTP para PDF, converter OTP para PDF, API Node.js, biblioteca JavaScript, OTP, PDF
description: Converta OTP em PDF em JavaScript. Use a API da biblioteca Node.js para converter arquivos OTP em PDF
---
...
Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos OTP para formatos de arquivo PDF rapidamente. A biblioteca Aspose PowerPoint permite converter OTP em PDFs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta OTP em PDF usando JavaScript" %}}
Para converter OTP para PDF, você precisará criar uma apresentação a partir do arquivo OTP e salvá-la como PDF.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter OTP em PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter OTP para PDF usando Aspose.Slides para Node.js via .NET API" >}}
