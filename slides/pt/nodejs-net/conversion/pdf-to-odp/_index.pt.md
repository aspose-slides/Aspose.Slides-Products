...
Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos PDF para formatos de arquivo ODP rapidamente. A biblioteca Aspose PowerPoint permite converter PDF em ODPs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PDF em ODP usando JavaScript" %}}
Para converter PDF para ODP, você precisará criar uma apresentação a partir do arquivo PDF e salvá-la como ODP.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter PDF em ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PDF para ODP usando Aspose.Slides para Node.js via .NET API" >}}
