...
Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos PDF para formatos de arquivo PPTX rapidamente. A biblioteca Aspose PowerPoint permite converter PDF em PPTXs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PDF em PPTX usando JavaScript" %}}
Para converter PDF para PPTX, você precisará criar uma apresentação a partir do arquivo PDF e salvá-la como PPTX.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter PDF em PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PDF para PPTX usando Aspose.Slides para Node.js via .NET API" >}}
