---
title: Converter OTP em HTML em JavaScript
url: /pt/nodejs-net/conversion/otp-to-html/
keywords: OTP para HTML, converter OTP para HTML, API Node.js, biblioteca JavaScript, OTP, HTML
description: Converta OTP em HTML em JavaScript. Use a API da biblioteca Node.js para converter arquivos OTP em HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter OTP em HTML em JavaScript" h2="Aspose.Slides para Node.js via .NET é uma biblioteca poderosa e fácil de usar que permite converter apresentações do PowerPoint para vários formatos em JavaScript. Ele suporta todos os elementos e formatos de apresentação e fornece uma API avançada para acessá-los e modificá-los. Também permite exportar seus slides para vários formatos para processamento ou compartilhamento posterior." >}}
...
Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos OTP para formatos de arquivo HTML rapidamente. A biblioteca Aspose PowerPoint permite converter OTP em HTMLs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta OTP em HTML usando JavaScript" %}}
Para converter OTP para HTML, você precisará criar uma apresentação a partir do arquivo OTP e salvá-la como HTML.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter OTP em HTML" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter OTP para HTML usando Aspose.Slides para Node.js via .NET API" >}}
