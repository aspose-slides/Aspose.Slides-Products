---
title: Converter PDF em GIF em JavaScript
url: /pt/nodejs-net/conversion/pdf-to-gif/
keywords: PDF para GIF, converter PDF para GIF, API Node.js, biblioteca JavaScript, PDF, GIF
description: Converta PDF em GIF em JavaScript. Use a API da biblioteca Node.js para converter arquivos PDF em GIF
---
...
Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos PDF para formatos de arquivo GIF rapidamente. A biblioteca Aspose PowerPoint permite converter PDF em GIFs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PDF em GIF usando JavaScript" %}}
Para converter PDF para GIF, você precisará criar uma apresentação a partir do arquivo PDF e salvá-la como GIF.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter PDF em GIF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PDF para GIF usando Aspose.Slides para Node.js via .NET API" >}}
