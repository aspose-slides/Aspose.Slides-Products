---
title: Converter PPTM em SVG em JavaScript
url: /pt/nodejs-net/conversion/pptm-to-svg/
keywords: PPTM para SVG, converter PPTM para SVG, API Node.js, biblioteca JavaScript, PPTM, SVG
description: Converta PPTM em SVG em JavaScript. Use a API da biblioteca Node.js para converter arquivos PPTM em SVG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter PPTM em SVG em JavaScript" h2="Aspose.Slides para Node.js via .NET é uma biblioteca poderosa e fácil de usar que permite converter apresentações do PowerPoint para vários formatos em JavaScript. Ele suporta todos os elementos e formatos de apresentação e fornece uma API avançada para acessá-los e modificá-los. Também permite exportar seus slides para vários formatos para processamento ou compartilhamento posterior." >}}

{{% blocks/products/pf/feature-page-section h2="Converter PPTM em SVG em Node.js" %}}

[**Aspose.Slides para Node.js via .NET**](https://products.aspose.com/slides/pt/nodejs-net/) é uma biblioteca Node.js poderosa para criar e manipular arquivos de apresentação. Além disso, oferece maneiras flexíveis de converter PPTM em SVG. Usando **Aspose.Slides para Node.js via .NET**, qualquer desenvolvedor ou aplicativo pode converter arquivos PPTM em SVG com apenas algumas linhas de código.

Como uma API moderna de processamento de documentos, Aspose.Slides para Node.js via .NET exporta arquivos PPTM para formatos de arquivo SVG rapidamente. A biblioteca Aspose PowerPoint permite converter PPTM em SVGs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PPTM em SVG usando JavaScript" %}}
Para converter PPTM para SVG, você precisará criar uma apresentação a partir do arquivo PPTM e salvá-la como SVG.

{{% blocks/products/pf/agp/code-block title="Código JavaScript para converter PPTM em SVG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PPTM para SVG usando Aspose.Slides para Node.js via .NET API" >}}
