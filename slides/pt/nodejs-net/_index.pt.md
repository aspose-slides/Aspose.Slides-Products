...
finally
{
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Como adicionar/remover/clonar slides e editar propriedades de forma em Node.js</h2>
        <p>Este código Node.js mostra como editar várias propriedades e clonar slides:</p>
        <pre>
            <code class="JavaScript">
const asposeSlides = require('aspose.slides.via.net');
...
finally
{
    ...
    <div class="col-lg-12">
        ...
        <p>Este código Node.js mostra como converter um PowerPoint em um documento PDF</p>
        <pre>
            <code class="JavaScript">
const asposeSlides = require('aspose.slides.via.net');
...
finally
{
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Como converter PowerPoint para GIF em Node.js</h2>
        <p>Este código Node.js mostra como converter um PowerPoint em uma imagem GIF</p>
        <pre>
            <code class="JavaScript">
const asposeSlides = require('aspose.slides.via.net');
...
finally
{
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Como converter PowerPoint para HTML em Node.js</h2>
        <p>Este código Node.js mostra como converter um PowerPoint em um documento HTML</p>
        <pre>
            <code class="JavaScript">
const asposeSlides = require('aspose.slides.via.net');
...
finally
{
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Como converter PowerPoint para ODP em Node.js</h2>
        <p>Este código Node.js mostra como converter um PowerPoint em um documento ODP</p>
        <pre>
            <code class="JavaScript">
const asposeSlides = require('aspose.slides.via.net');
