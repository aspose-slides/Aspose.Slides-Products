...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Recursos avançados de exportação de JasperReports para apresentação</h2>

<p> </p>

<div class="col-lg-4"><em class="fa fa-file-powerpoint-o  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Crie relatórios de contas e exporte-os para apresentações do Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-bar-chart   ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Crie relatórios de gráficos e exporte-os para apresentações do Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-pie-chart ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Crie relatórios de gráficos de vários eixos e exporte para apresentações do Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-file-text ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Crie imagens, texto, linhas e exporte esses relatórios para a apresentação do Microsoft PowerPoint</p>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Ocultar o painel de miniaturas do slide esquerdo no PPT criado
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-area-chart ico-blue fa-2x col-lg-2">
