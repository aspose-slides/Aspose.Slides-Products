---
title: API Node.js PowerPoint por Aspose.Slides
weight: 5890
url: /pt/nodejs-java/ 
description: Aspose.Slides para Node.js via Java é uma API Node.js PowerPoint que permite criar, modificar e converter apresentações PowerPoint em Node.js.
---
...
<p>Node.js é um ambiente de execução JavaScript popular, gratuito, de código aberto e multiplataforma que permite aos desenvolvedores escrever ferramentas de linha de comando e scripts do lado do servidor fora de um navegador. Por esse motivo, a equipe <strong>Aspose.Slides</strong> tem o orgulho de oferecer <strong>Aspose.Slides para Node.js via Java</strong> para a comunidade Node.js.</p>
...
<div class="diagram1 d1-nodejs">
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <ul>
    <li>Gerenciar gráficos</li>
    <li>Gerenciar SmartArts</li>
    <li>Gerenciar formas do PowerPoint</li>
    <li>Gerenciar controles ActiveX</li>
    <li>Gerenciar OleObjects</li>
   </ul>
   <header>
   ...
   <ul>
    <li>Manipular texto e formatação</li>
    <li>Manipular texto do hiperlink</li>
    <li>Definir tipo de espaço reservado</li>
   </ul>
  </div>
  <!--/left-->
  <div class="d1-col d1-right">
   ...
   <ul>
    <li>Gerenciar transições de slides</li>
    <li>Gerenciar efeitos de animação</li>
    <li>Adicionar conectores às formas</li>
    <li>Girar e inverter formas</li>
    <li>Gerenciar estilos de linha da forma</li>
   </ul>
  </div>
  <!--/right-->
 </div>
...
{{< blocks/products/pf/carousel-item h3="Independência de plataforma" description="Aspose.Slides para Node.js via Java é uma API JavaScript do lado do servidor baseada em Node.js. Ele pode ser executado em plataformas Windows, Unix/Linux e Mac com JDK 1.8 ou superior." >}}
<div class="diagram1 d1-nodejs">
 <div class="d1-row">
...
{{< blocks/products/pf/carousel-item h3="Formatos de arquivo suportados" description="Aspose.Slides para Node.js via Java suporta [formatos de apresentação](https://docs.aspose.com/slides/nodejs-java/supported-file-formats/) populares e esses formatos de exportação." >}}
<div class="diagram1 d2 d1-nodejs">
 <div class="d1-row">
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    <li><b>Layout fixo:</b>PDF, PDF/A, XPS</li>
    <li><b>Imagens:</b>JPEG, PNG, BMP, TIFF, GIF</li>
    <li>SVG</li>
    <li><b>Web:</b>HTML</li>
   </ul>
  </div>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <ul>
      <li>Aspose.Slides para Node.js via Java é uma API JavaScript do lado do servidor baseada em Node.js. Ele pode ser executado em plataformas Windows, Unix/Linux e Mac com JDK 1.8 ou superior.</li>
    </ul>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">Como instalar</h2>
    <p>Use <strong>NPM</strong> para instalar nossa biblioteca Node.js para processamento de apresentações do <a href="https://www.npmjs.com/package/aspose.slides.via.java">repositório de pacotes NPM :</a></p>
...
finally
{
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Como mesclar apresentações em Node.js</h2>
...
finally
{
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Como importar uma apresentação de PDF em Node.js. Converta PDF para PPT, Converta PDF para PPTX, Converta PDF para ODP</h2>
        <p>Este código Node.js demonstra o processo de conversão de PDF em PowerPoint:</p>
        <pre>
            <code class="javascript">
var aspose = aspose || {};
...
finally
{
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Como converter PowerPoint para PDF em Node.js</h2>
...
finally
{
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Como converter PowerPoint para JPG em Node.js. Converter PPT para JPG, Converter PPTX para JPG, Converter ODP para JPG</h2>
...
{{< blocks/products/pf/support-learning-resources >}}
    {{< blocks/products/pf/slr-tab tabTitle="Recursos de aprendizagem" tabId="resources" >}}
        {{< blocks/products/pf/slr-element name="Documentação" href="https://docs.aspose.com/slides/nodejs-java/" >}}
        {{< blocks/products/pf/slr-element name="Código fonte" href="https://github.com/aspose-slides/" >}}
        {{< blocks/products/pf/slr-element name="Referências de API" href="https://docs.aspose.com/slides/nodejs-java/api-reference/" >}}
    ...
    {{< blocks/products/pf/slr-tab tabTitle="Suporte ao produto" tabId="support" >}}
        ...
        {{< blocks/products/pf/slr-element name="Notas de versão" href="https://releases.aspose.com/slides/nodejs-java/release-notes/" >}}
    {{< /blocks/products/pf/slr-tab >}}

    {{< blocks/products/pf/slr-tab tabTitle="Por que Aspose.Slides para Node.js via Java?" tabId="success-stories" >}}
