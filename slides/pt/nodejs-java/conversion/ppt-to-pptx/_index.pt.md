---
title: Converter PPT em PPTX em Node.js
url: /pt/nodejs-java/conversion/ppt-to-pptx/
keywords: PPT para PPTX, converter PPT para PPTX, API Node.js, biblioteca Node.js, PPT, PPTX
description: Converta PPT em PPTX em Node.js. Use a API da biblioteca Node.js para converter arquivos PPT em PPTXs
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter PPT em PPTX em Node.js" h2="Aspose.Slides para Node.js via Java é uma biblioteca poderosa e fácil de usar que permite converter apresentações do PowerPoint para vários formatos em Node.js. Ele suporta todos os elementos e formatos de apresentação e fornece uma API avançada para acessá-los e modificá-los. Também permite exportar seus slides para vários formatos para processamento ou compartilhamento posterior." >}}
...
Como uma API moderna de processamento de documentos, Aspose.Slides for Node.js exporta arquivos PPT para formatos de arquivo PPTX rapidamente. A biblioteca Aspose PowerPoint permite converter PPT em PPTXs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PPT para PPTX usando Node.js" %}}
Para converter PPT para PPTX, você precisará criar uma apresentação a partir do arquivo PPT e salvá-la como PPTX.

{{% blocks/products/pf/agp/code-block title="Código Node.js para converter PPT em PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PPT para PPTX usando Aspose.Slides para Node.js via Java API" >}}
