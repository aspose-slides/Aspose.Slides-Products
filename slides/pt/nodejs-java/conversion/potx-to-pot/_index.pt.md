---
title: Converter POTX em POT em Node.js
url: /pt/nodejs-java/conversion/potx-to-pot/
keywords: POTX para POT, converter POTX para POT, API Node.js, biblioteca Node.js, POTX, POT
description: Converta POTX em POT em Node.js. Use a API da biblioteca Node.js para converter arquivos POTX em POTs
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter POTX em POT em Node.js" h2="Aspose.Slides para Node.js via Java é uma biblioteca poderosa e fácil de usar que permite converter apresentações do PowerPoint para vários formatos em Node.js. Ele suporta todos os elementos e formatos de apresentação e fornece uma API avançada para acessá-los e modificá-los. Também permite exportar seus slides para vários formatos para processamento ou compartilhamento posterior." >}}

{{% blocks/products/pf/feature-page-section h2="Converter POTX em POT em Node.js" %}}

[**Aspose.Slides para Node.js via Java**](https://products.aspose.com/slides/pt/nodejs-java/) é uma biblioteca Node.js poderosa para criar e manipular arquivos de apresentação. Além disso, oferece maneiras flexíveis de converter POTX em POT. Usando **Aspose.Slides para Node.js via Java**, qualquer desenvolvedor ou aplicativo pode converter arquivos POTX em POT com apenas algumas linhas de código.

Como uma API moderna de processamento de documentos, Aspose.Slides for Node.js exporta arquivos POTX para formatos de arquivo POT rapidamente. A biblioteca Aspose PowerPoint permite converter POTX em POTs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta POTX para POT usando Node.js" %}}
Para converter POTX para POT, você precisará criar uma apresentação a partir do arquivo POTX e salvá-la como POT.

{{% blocks/products/pf/agp/code-block title="Código Node.js para converter POTX em POT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter POTX para POT usando Aspose.Slides para Node.js via Java API" >}}
