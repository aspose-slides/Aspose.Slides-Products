---
title: Converter PPSX em PDF em Node.js
url: /pt/nodejs-java/conversion/ppsx-to-pdf/
keywords: PPSX para PDF, converter PPSX para PDF, API Node.js, biblioteca Node.js, PPSX, PDF
description: Converta PPSX em PDF em Node.js. Use a API da biblioteca Node.js para converter arquivos PPSX em PDFs
---
...
Como uma API moderna de processamento de documentos, Aspose.Slides for Node.js exporta arquivos PPSX para formatos de arquivo PDF rapidamente. A biblioteca Aspose PowerPoint permite converter PPSX em PDFs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PPSX para PDF usando Node.js" %}}
Para converter PPSX para PDF, você precisará criar uma apresentação a partir do arquivo PPSX e salvá-la como PDF.

{{% blocks/products/pf/agp/code-block title="Código Node.js para converter PPSX em PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PPSX para PDF usando Aspose.Slides para Node.js via Java API" >}}
