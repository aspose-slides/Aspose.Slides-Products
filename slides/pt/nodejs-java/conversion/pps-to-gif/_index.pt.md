---
title: Converter PPS em GIF em Node.js
url: /pt/nodejs-java/conversion/pps-to-gif/
keywords: PPS para GIF, converter PPS para GIF, API Node.js, biblioteca Node.js, PPS, GIF
description: Converta PPS em GIF em Node.js. Use a API da biblioteca Node.js para converter arquivos PPS em GIFs
---
...
Como uma API moderna de processamento de documentos, Aspose.Slides for Node.js exporta arquivos PPS para formatos de arquivo GIF rapidamente. A biblioteca Aspose PowerPoint permite converter PPS em GIFs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PPS para GIF usando Node.js" %}}
Para converter PPS para GIF, você precisará criar uma apresentação a partir do arquivo PPS e salvá-la como GIF.

{{% blocks/products/pf/agp/code-block title="Código Node.js para converter PPS em GIF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PPS para GIF usando Aspose.Slides para Node.js via Java API" >}}
