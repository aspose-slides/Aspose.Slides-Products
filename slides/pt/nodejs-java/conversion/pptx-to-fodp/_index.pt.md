---
title: Converter PPTX em FODP em Node.js
url: /pt/nodejs-java/conversion/pptx-to-fodp/
keywords: PPTX para FODP, converter PPTX para FODP, API Node.js, biblioteca Node.js, PPTX, FODP
description: Converta PPTX em FODP em Node.js. Use a API da biblioteca Node.js para converter arquivos PPTX em FODPs
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter PPTX em FODP em Node.js" h2="Aspose.Slides para Node.js via Java é uma biblioteca poderosa e fácil de usar que permite converter apresentações do PowerPoint para vários formatos em Node.js. Ele suporta todos os elementos e formatos de apresentação e fornece uma API avançada para acessá-los e modificá-los. Também permite exportar seus slides para vários formatos para processamento ou compartilhamento posterior." >}}
...
Como uma API moderna de processamento de documentos, Aspose.Slides for Node.js exporta arquivos PPTX para formatos de arquivo FODP rapidamente. A biblioteca Aspose PowerPoint permite converter PPTX em FODPs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PPTX para FODP usando Node.js" %}}
Para converter PPTX para FODP, você precisará criar uma apresentação a partir do arquivo PPTX e salvá-la como FODP.

{{% blocks/products/pf/agp/code-block title="Código Node.js para converter PPTX em FODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PPTX para FODP usando Aspose.Slides para Node.js via Java API" >}}
