---
title: Converter POTX em PDF em Node.js
url: /pt/nodejs-java/conversion/potx-to-pdf/
keywords: POTX para PDF, converter POTX para PDF, API Node.js, biblioteca Node.js, POTX, PDF
description: Converta POTX em PDF em Node.js. Use a API da biblioteca Node.js para converter arquivos POTX em PDFs
---
...
Como uma API moderna de processamento de documentos, Aspose.Slides for Node.js exporta arquivos POTX para formatos de arquivo PDF rapidamente. A biblioteca Aspose PowerPoint permite converter POTX em PDFs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta POTX para PDF usando Node.js" %}}
Para converter POTX para PDF, você precisará criar uma apresentação a partir do arquivo POTX e salvá-la como PDF.

{{% blocks/products/pf/agp/code-block title="Código Node.js para converter POTX em PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter POTX para PDF usando Aspose.Slides para Node.js via Java API" >}}
