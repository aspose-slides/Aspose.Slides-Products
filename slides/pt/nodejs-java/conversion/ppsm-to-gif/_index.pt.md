---
title: Converter PPSM em GIF em Node.js
url: /pt/nodejs-java/conversion/ppsm-to-gif/
keywords: PPSM para GIF, converter PPSM para GIF, API Node.js, biblioteca Node.js, PPSM, GIF
description: Converta PPSM em GIF em Node.js. Use a API da biblioteca Node.js para converter arquivos PPSM em GIFs
---
...
Como uma API moderna de processamento de documentos, Aspose.Slides for Node.js exporta arquivos PPSM para formatos de arquivo GIF rapidamente. A biblioteca Aspose PowerPoint permite converter PPSM em GIFs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PPSM para GIF usando Node.js" %}}
Para converter PPSM para GIF, você precisará criar uma apresentação a partir do arquivo PPSM e salvá-la como GIF.

{{% blocks/products/pf/agp/code-block title="Código Node.js para converter PPSM em GIF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PPSM para GIF usando Aspose.Slides para Node.js via Java API" >}}
