---
title: Converter PPTX em PDF em Node.js
url: /pt/nodejs-java/conversion/pptx-to-pdf/
keywords: PPTX para PDF, converter PPTX para PDF, API Node.js, biblioteca Node.js, PPTX, PDF
description: Converta PPTX em PDF em Node.js. Use a API da biblioteca Node.js para converter arquivos PPTX em PDFs
---
...
Como uma API moderna de processamento de documentos, Aspose.Slides for Node.js exporta arquivos PPTX para formatos de arquivo PDF rapidamente. A biblioteca Aspose PowerPoint permite converter PPTX em PDFs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PPTX para PDF usando Node.js" %}}
Para converter PPTX para PDF, você precisará criar uma apresentação a partir do arquivo PPTX e salvá-la como PDF.

{{% blocks/products/pf/agp/code-block title="Código Node.js para converter PPTX em PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PPTX para PDF usando Aspose.Slides para Node.js via Java API" >}}
