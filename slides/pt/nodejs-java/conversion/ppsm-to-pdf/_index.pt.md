...
title: Converter PPSM em PDF em Node.js
url: /pt/nodejs-java/conversion/ppsm-to-pdf/
keywords: PPSM para PDF, converter PPSM para PDF, API Node.js, biblioteca Node.js, PPSM, PDF
description: Converta PPSM em PDF em Node.js. Use a API da biblioteca Node.js para converter arquivos PPSM em PDFs
---
...
Como uma API moderna de processamento de documentos, Aspose.Slides for Node.js exporta arquivos PPSM para formatos de arquivo PDF rapidamente. A biblioteca Aspose PowerPoint permite converter PPSM em PDFs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PPSM para PDF usando Node.js" %}}
Para converter PPSM para PDF, você precisará criar uma apresentação a partir do arquivo PPSM e salvá-la como PDF.

{{% blocks/products/pf/agp/code-block title="Código Node.js para converter PPSM em PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PPSM para PDF usando Aspose.Slides para Node.js via Java API" >}}
