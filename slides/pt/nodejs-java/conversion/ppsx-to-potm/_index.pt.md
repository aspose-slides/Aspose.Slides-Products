---
title: Converter PPSX em POTM em Node.js
url: /pt/nodejs-java/conversion/ppsx-to-potm/
keywords: PPSX para POTM, converter PPSX para POTM, API Node.js, biblioteca Node.js, PPSX, POTM
description: Converta PPSX em POTM em Node.js. Use a API da biblioteca Node.js para converter arquivos PPSX em POTMs
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter PPSX em POTM em Node.js" h2="Aspose.Slides para Node.js via Java é uma biblioteca poderosa e fácil de usar que permite converter apresentações do PowerPoint para vários formatos em Node.js. Ele suporta todos os elementos e formatos de apresentação e fornece uma API avançada para acessá-los e modificá-los. Também permite exportar seus slides para vários formatos para processamento ou compartilhamento posterior." >}}
...
Como uma API moderna de processamento de documentos, Aspose.Slides for Node.js exporta arquivos PPSX para formatos de arquivo POTM rapidamente. A biblioteca Aspose PowerPoint permite converter PPSX em POTMs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PPSX para POTM usando Node.js" %}}
Para converter PPSX para POTM, você precisará criar uma apresentação a partir do arquivo PPSX e salvá-la como POTM.

{{% blocks/products/pf/agp/code-block title="Código Node.js para converter PPSX em POTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PPSX para POTM usando Aspose.Slides para Node.js via Java API" >}}
