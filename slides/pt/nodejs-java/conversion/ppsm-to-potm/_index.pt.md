---
title: Converter PPSM em POTM em Node.js
url: /pt/nodejs-java/conversion/ppsm-to-potm/
keywords: PPSM para POTM, converter PPSM para POTM, API Node.js, biblioteca Node.js, PPSM, POTM
description: Converta PPSM em POTM em Node.js. Use a API da biblioteca Node.js para converter arquivos PPSM em POTMs
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter PPSM em POTM em Node.js" h2="Aspose.Slides para Node.js via Java é uma biblioteca poderosa e fácil de usar que permite converter apresentações do PowerPoint para vários formatos em Node.js. Ele suporta todos os elementos e formatos de apresentação e fornece uma API avançada para acessá-los e modificá-los. Também permite exportar seus slides para vários formatos para processamento ou compartilhamento posterior." >}}
...
Como uma API moderna de processamento de documentos, Aspose.Slides for Node.js exporta arquivos PPSM para formatos de arquivo POTM rapidamente. A biblioteca Aspose PowerPoint permite converter PPSM em POTMs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PPSM para POTM usando Node.js" %}}
Para converter PPSM para POTM, você precisará criar uma apresentação a partir do arquivo PPSM e salvá-la como POTM.

{{% blocks/products/pf/agp/code-block title="Código Node.js para converter PPSM em POTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PPSM para POTM usando Aspose.Slides para Node.js via Java API" >}}
