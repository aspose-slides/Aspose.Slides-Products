---
title: Converter PPS em PDF em Node.js
url: /pt/nodejs-java/conversion/pps-to-pdf/
keywords: PPS para PDF, converter PPS para PDF, API Node.js, biblioteca Node.js, PPS, PDF
description: Converta PPS em PDF em Node.js. Use a API da biblioteca Node.js para converter arquivos PPS em PDFs
---
...
Como uma API moderna de processamento de documentos, Aspose.Slides for Node.js exporta arquivos PPS para formatos de arquivo PDF rapidamente. A biblioteca Aspose PowerPoint permite converter PPS em PDFs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PPS para PDF usando Node.js" %}}
Para converter PPS para PDF, você precisará criar uma apresentação a partir do arquivo PPS e salvá-la como PDF.

{{% blocks/products/pf/agp/code-block title="Código Node.js para converter PPS em PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PPS para PDF usando Aspose.Slides para Node.js via Java API" >}}
