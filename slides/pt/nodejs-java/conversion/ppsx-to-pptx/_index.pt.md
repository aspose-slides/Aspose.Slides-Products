---
title: Converter PPSX em PPTX em Node.js
url: /pt/nodejs-java/conversion/ppsx-to-pptx/
keywords: PPSX para PPTX, converter PPSX para PPTX, API Node.js, biblioteca Node.js, PPSX, PPTX
description: Converta PPSX em PPTX em Node.js. Use a API da biblioteca Node.js para converter arquivos PPSX em PPTXs
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter PPSX em PPTX em Node.js" h2="Aspose.Slides para Node.js via Java é uma biblioteca poderosa e fácil de usar que permite converter apresentações do PowerPoint para vários formatos em Node.js. Ele suporta todos os elementos e formatos de apresentação e fornece uma API avançada para acessá-los e modificá-los. Também permite exportar seus slides para vários formatos para processamento ou compartilhamento posterior." >}}
...
Como uma API moderna de processamento de documentos, Aspose.Slides for Node.js exporta arquivos PPSX para formatos de arquivo PPTX rapidamente. A biblioteca Aspose PowerPoint permite converter PPSX em PPTXs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PPSX para PPTX usando Node.js" %}}
Para converter PPSX para PPTX, você precisará criar uma apresentação a partir do arquivo PPSX e salvá-la como PPTX.

{{% blocks/products/pf/agp/code-block title="Código Node.js para converter PPSX em PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PPSX para PPTX usando Aspose.Slides para Node.js via Java API" >}}
