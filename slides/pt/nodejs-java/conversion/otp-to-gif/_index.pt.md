---
title: Converter OTP em GIF em Node.js
url: /pt/nodejs-java/conversion/otp-to-gif/
keywords: OTP para GIF, converter OTP para GIF, API Node.js, biblioteca Node.js, OTP, GIF
description: Converta OTP em GIF em Node.js. Use a API da biblioteca Node.js para converter arquivos OTP em GIFs
---
...
Como uma API moderna de processamento de documentos, Aspose.Slides for Node.js exporta arquivos OTP para formatos de arquivo GIF rapidamente. A biblioteca Aspose PowerPoint permite converter OTP em GIFs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta OTP para GIF usando Node.js" %}}
Para converter OTP para GIF, você precisará criar uma apresentação a partir do arquivo OTP e salvá-la como GIF.

{{% blocks/products/pf/agp/code-block title="Código Node.js para converter OTP em GIF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter OTP para GIF usando Aspose.Slides para Node.js via Java API" >}}
