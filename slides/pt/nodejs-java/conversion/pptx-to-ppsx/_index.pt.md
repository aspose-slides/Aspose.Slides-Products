...
Como uma API moderna de processamento de documentos, Aspose.Slides for Node.js exporta arquivos PPTX para formatos de arquivo PPSX rapidamente. A biblioteca Aspose PowerPoint permite converter PPTX em PPSXs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converta PPTX para PPSX usando Node.js" %}}
Para converter PPTX para PPSX, você precisará criar uma apresentação a partir do arquivo PPTX e salvá-la como PPSX.

{{% blocks/products/pf/agp/code-block title="Código Node.js para converter PPTX em PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PPTX para PPSX usando Aspose.Slides para Node.js via Java API" >}}
