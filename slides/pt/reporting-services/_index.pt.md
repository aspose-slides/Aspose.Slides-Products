...
title: SSRS SQL PPT | API do PowerPoint Aspose.Slides
weight: 3020
url: /pt/reporting-services/ 
description: A API do PowerPoint do Reporting Services é Aspose.Slides para SQL PPT. Serviços de apresentação do PowerPoint para SQL PowerPoint.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API do PowerPoint do Reporting Services" h2="Exporte relatórios RDL para os formatos PowerPoint PPT, PPTX, PPS e PPSX." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-reporting-services.svg" pfName="Aspose.Slides" subTitlepfName="for Reporting Services" downloadUrl="https://downloads.aspose.com/slides/reportingservices" >}}
...
<p>
 Aspose.Slides for Reporting Services é a única solução no mercado que permite gerar apresentações nos formatos nativos do PowerPoint a partir do Microsoft SQL Server Reporting Services.
</p>

<p>
 O Aspose.Slides for Reporting Services suporta quase todos os recursos RDL, como tabelas, matrizes, gráficos, imagens, listas, sub-relatórios e cabeçalho/rodapé, permitindo exportar relatórios em formatos de apresentação do PowerPoint de forma que pareçam semelhantes ao original projeto de relatório. Execute o Reporting Services SQL PPT sem o Microsoft PowerPoint Automation.
</p>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Recursos avançados da API do Reporting Services
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Crie gráficos de comparação em relatórios RDL e exporte como apresentações
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Crie relatórios RDL complexos e exporte para arquivos de apresentação
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Exporte relatórios RDL centrados em dados com sub-relatórios
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Exporte áudio e vídeos incorporados para arquivos do PowerPoint
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Exporte relatórios RDL carregando sub-relatórios para o PowerPoint
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Alterar a cor da série e suas categorias
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Rasterização ou vetorização de Shapes sem texto
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-share ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Converter imagens SVG em formas
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Alterar a cor do texto do hiperlink em uma apresentação
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Suporte para criptografia Open Document, Text Highlighter e Morph Transition
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Gráficos de funil e gráficos de mapa 2D suportados
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Suporte para respostas de comentários e Office 365
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Exportar para formatos de apresentação e apresentação de slides
    </h2>
    <p>
     O SQL Server Reporting Services (SSRS) não fornece suporte interno para exportar relatórios RDL para apresentações do PowerPoint ou apresentações de slides. Ao usar o Aspose.Slides para Reporting Services, você pode adicionar suporte para formatos de exportação adicionais com facilidade.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for Reporting Services suporta a especificação RDL completa e pode-se personalizar os relatórios existentes usando esta extensão. Selecionar qualquer designer de relatório RDL de sua escolha e exportar os relatórios exatamente da mesma maneira que foi projetado é bastante fácil.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     O Aspose.Slides for Reporting Services é construído usando código gerenciado que nunca precisa que o Microsoft PowerPoint seja instalado na máquina para trabalhar com apresentações do PowerPoint. É uma alternativa perfeita de automação do Microsoft PowerPoint em termos de recursos suportados, segurança, estabilidade, escalabilidade, velocidade e preço.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Documentação" href="https://docs.aspose.com/slides/reportingservices/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Por que Aspose.Slides para Reporting Services?" tabId="success-stories" >}}
