...
Precisa converter arquivos POTX para PPSM programaticamente? Usando [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/pt/python-net/) qualquer desenvolvedor pode converter o formato POTX para PPSM com apenas algumas linhas de código Python.
