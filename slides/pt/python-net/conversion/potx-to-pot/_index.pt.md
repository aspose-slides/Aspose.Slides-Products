...
Precisa converter arquivos POTX para POT programaticamente? Usando [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/pt/python-net/) qualquer desenvolvedor pode converter o formato POTX para POT com apenas algumas linhas de código Python.
