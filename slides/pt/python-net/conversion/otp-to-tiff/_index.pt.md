...
Precisa converter arquivos OTP para TIFF programaticamente? Usando [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/pt/python-net/) qualquer desenvolvedor pode converter o formato OTP para TIFF com apenas algumas linhas de código Python.
