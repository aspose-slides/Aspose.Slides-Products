...
Precisa converter arquivos POTX para HTML programaticamente? Usando [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/pt/python-net/) qualquer desenvolvedor pode converter POTX para formato HTML com apenas algumas linhas de código Python.
