---
title: Converter POTX para XPS em Python
weight: 1540
url: /pt/python-net/conversion/potx-to-xps/ 
keywords: "Convert, PowerPoint, POTX, XPS, Presentation, Python"
description: Código de exemplo para conversão de POTX para XPS Python. Use a API Python do PowerPoint para arquivos POTX de conversão em lote para arquivos XPS.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter POTX para XPS em Python" h2="Poderosa biblioteca Python do PowerPoint para converter POTX para XPS" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Converter POTX para XPS em Python" %}}

Precisa converter arquivos POTX para XPS programaticamente? Usando o [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/pt/python-net/) qualquer desenvolvedor pode converter o formato POTX para XPS com apenas algumas linhas de código Python.

Como uma API de processamento de apresentação moderna, o Aspose.Slides for Python cria XPS a partir de POTX rapidamente. Teste a qualidade da conversão de POTX para XPS diretamente no seu [navegador](https://products.aspose.app/slides/conversion). A biblioteca Aspose PowerPoint PPTX permite converter arquivos POTX para muitos formatos populares.
...
{{< blocks/products/pf/agp/feature-section-col title="Como converter POTX para XPS em Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estas são as etapas para converter um arquivo POTX em XPS usando Python." >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de POTX para XPS Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Salvar POTX como XPS em Python" %}}
