...
Precisa converter arquivos POT para XPS programaticamente? Usando [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/pt/python-net/) qualquer desenvolvedor pode converter o formato POT para XPS com apenas algumas linhas de código Python.
