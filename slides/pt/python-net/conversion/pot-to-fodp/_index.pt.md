...
Precisa converter arquivos POT para FODP programaticamente? Usando [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/pt/python-net/) qualquer desenvolvedor pode converter o formato POT para FODP com apenas algumas linhas de código Python.
