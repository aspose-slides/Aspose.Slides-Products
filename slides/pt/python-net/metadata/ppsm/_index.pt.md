---
title: Visualize ou edite metadados de arquivos PPSM usando Python
url: /pt/python-net/metadata/ppsm/
keywords: Editar metadados PPSM, visualizar metadados PPSM, editar propriedades PPSM, visualizar propriedades PPSM
description: Código-fonte Python para editar ou visualizar metadados do formato PPSM.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Edite propriedades PPSM usando Python" h2="Crie seus próprios aplicativos Python para modificar propriedades integradas e personalizadas em arquivos de apresentação usando APIs do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" fileiconsmall4="POT" fileiconsmall5="ppsx" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for Python via .NET" >}}

{{% blocks/products/pf/feature-page-section  h2="Modifique as propriedades de PPSM por meio de Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Modificar propriedades integradas PPSM - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Adicionar propriedades personalizadas a PPSM - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como extrair metadados de PPSM via Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estas são as etapas para extrair metadados de arquivos PPSM." >}}

{{< blocks/products/pf/agp/step-autogen >}}
Instanciar a classe de apresentação com o caminho para o arquivo PPSM
{{< /blocks/products/pf/agp/step-autogen >}}
