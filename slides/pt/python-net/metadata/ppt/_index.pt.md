---
title: Visualize ou edite metadados de arquivos PPT usando Python
url: /pt/python-net/metadata/ppt/
keywords: Editar metadados PPT, visualizar metadados PPT, editar propriedades PPT, visualizar propriedades PPT
description: Código-fonte Python para editar ou visualizar metadados do formato PPT.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Edite propriedades PPT usando Python" h2="Crie seus próprios aplicativos Python para modificar propriedades integradas e personalizadas em arquivos de apresentação usando APIs do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" fileiconsmall4="POT" fileiconsmall5="ppsx" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for Python via .NET" >}}

{{% blocks/products/pf/feature-page-section  h2="Modifique as propriedades de PPT por meio de Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Modificar propriedades integradas PPT - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Adicionar propriedades personalizadas a PPT - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como extrair metadados de PPT via Python" >}}
