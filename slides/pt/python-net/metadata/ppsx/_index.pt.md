---
title: Visualize ou edite metadados de arquivos PPSX usando Python
url: /pt/python-net/metadata/ppsx/
keywords: Editar metadados PPSX, visualizar metadados PPSX, editar propriedades PPSX, visualizar propriedades PPSX
description: Código-fonte Python para editar ou visualizar metadados do formato PPSX.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Edite propriedades PPSX usando Python" h2="Crie seus próprios aplicativos Python para modificar propriedades integradas e personalizadas em arquivos de apresentação usando APIs do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSX" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" fileiconsmall4="POT" fileiconsmall5="ppsx" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for Python via .NET" >}}

{{% blocks/products/pf/feature-page-section  h2="Modifique as propriedades de PPSX por meio de Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Modificar propriedades integradas PPSX - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Adicionar propriedades personalizadas a PPSX - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como extrair metadados de PPSX via Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estas são as etapas para extrair metadados de arquivos PPSX." >}}

{{< blocks/products/pf/agp/step-autogen >}}
Instanciar a classe de apresentação com o caminho para o arquivo PPSX
{{< /blocks/products/pf/agp/step-autogen >}}
