...
{{% blocks/products/pf/agp/code-block title="Modificar propriedades integradas FODP - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Adicionar propriedades personalizadas a FODP - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como extrair metadados de FODP via Python" >}}
