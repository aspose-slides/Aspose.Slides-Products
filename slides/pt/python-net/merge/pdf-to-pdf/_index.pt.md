...
url: /pt/python-net/merge/pdf-to-pdf/
keywords: Mesclar PDF, PDF para PDF, Juntar PDF, Combinar PDF, API Python, Biblioteca Python
description: Mesclar PDF para PDF em Python. Use a API da biblioteca Python para combinar arquivos PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar PDF em Python" h2="Biblioteca Python de plataforma cruzada e de alta velocidade para mesclar arquivos PDF usando código Python" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Mesclar PDF para PDF em Python" %}}
Usando [**Aspose.Slides para Python via .NET**](https://products.aspose.com/slides/pt/python-net/), você pode mesclar arquivos PDF rapidamente com apenas algumas linhas de código

{{% blocks/products/pf/agp/code-block title="Código Python para mesclar PDF para PDF" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="Como mesclar PDF em Python" >}}
