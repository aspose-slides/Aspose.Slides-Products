---
title: Mesclar arquivos PDF para PPTX usando Python
url: /pt/python-net/merge/pdf-to-pptx/
keywords: Mesclar PDF com PPTX, juntar PDF com PPTX, combinar PDF com PPTX, PowerPoint, Presentation, PPTX, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Mesclar arquivos PDF para PPTX juntos em Python" h2="API Python de alta velocidade e plataforma cruzada que ajuda no desenvolvimento de aplicativos com a capacidade de criar, mesclar, inspecionar ou converter arquivos de apresentação do Microsoft PowerPoint e OpenOffice sem o uso de nenhum software como Microsoft ou Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar PDF para PPTX em Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Mesclar arquivos PDF para PPTX usando Python" %}}
Para mesclar as apresentações do PowerPoint, você precisará clonar os slides de uma apresentação para outra.

{{% blocks/products/pf/agp/code-block title="Código Python para mesclar vários PDF em um único arquivo PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como mesclar PDF para PPTX usando Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estas são as etapas para mesclar dois arquivos PDF e salvar o resultado como PPTX em Python." >}}
