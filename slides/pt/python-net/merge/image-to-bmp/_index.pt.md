---
title: Mesclar imagem para BMP em Python
url: /pt/python-net/merge/image-to-bmp/
keywords: Imagem para BMP, Mesclar imagem para BMP, Juntar imagem para BMP, Combinar imagens, Imagem, BMP, API Python, Biblioteca Python
description: Mesclar imagem para BMP em Python. Use a API da biblioteca Python para combinar imagens
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar imagem para BMP em Python" h2="Biblioteca Python de plataforma cruzada e de alta velocidade para mesclar arquivos de imagem em BMP usando código Python" >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar imagem para BMP usando Aspose.Slides" %}}

[**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/pt/python-net/) é uma poderosa biblioteca Python usada para criar, converter, mesclar e manipular apresentações, PDFs , imagens e outros arquivos. Ao mesclar imagem com BMP, você está efetivamente combinando imagens para obter um único arquivo BMP.
...
{{% blocks/products/pf/feature-page-section  h2="Mesclar imagem para BMP em Python" %}}
Usando [**Aspose.Slides para Python via .NET**](https://products.aspose.com/slides/pt/python-net/), você pode mesclar imagem para BMP rapidamente com apenas algumas linhas de código

{{% blocks/products/pf/agp/code-block title="Código Python para mesclar imagem para BMP" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="Como mesclar imagem para BMP em Python" >}}
