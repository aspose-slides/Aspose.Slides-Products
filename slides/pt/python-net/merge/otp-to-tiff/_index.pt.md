---
title: Mesclar arquivos OTP para TIFF usando Python
url: /pt/python-net/merge/otp-to-tiff/
keywords: Mesclar OTP com TIFF, juntar OTP com TIFF, combinar OTP com TIFF, PowerPoint, Presentation, TIFF, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Mesclar arquivos OTP para TIFF usando Python" %}}
Para mesclar as apresentações do PowerPoint, você precisará clonar os slides de uma apresentação para outra.

{{% blocks/products/pf/agp/code-block title="Código Python para mesclar vários OTP em um único arquivo TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como mesclar OTP para TIFF usando Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estas são as etapas para mesclar dois arquivos OTP e salvar o resultado como TIFF em Python." >}}
