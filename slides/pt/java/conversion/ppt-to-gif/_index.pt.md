...
title: Converter PPT para GIF via Java
weight: 4360
url: /pt/java/conversion/ppt-to-gif/ 
description: Exemplo de código de conversão Java para formato PPT para arquivo GIF. Use este código de exemplo para exportar apresentações do PowerPoint e OpenOffice para GIF em qualquer aplicativo baseado em Java Web ou Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PPT para GIF via Java" h2="Conversão de PPT para GIF Java para converter uma ou várias páginas em GIF usando a biblioteca Java no local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PPT para GIF usando Java" %}}

 Para renderizar PPT para GIF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter PPT para GIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os desenvolvedores Java podem facilmente converter arquivos PPT para GIF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de PPT para GIF Java" offSpacer="" %}}
