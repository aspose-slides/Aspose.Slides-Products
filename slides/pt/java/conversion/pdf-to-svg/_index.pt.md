---
title: Converter PDF para SVG em Java
url: /pt/java/conversion/pdf-to-svg/
keywords: PDF para SVG, Converter PDF para SVG, API Java, Biblioteca Java, PDF, SVG
description: Converter PDF para SVG em Java. Use a API da biblioteca Java para converter arquivos PDF em SVGs
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter PDF para SVG em Java" h2="Biblioteca Java de plataforma cruzada e de alta velocidade que ajuda no desenvolvimento de aplicativos com a capacidade de criar, mesclar, inspecionar ou converter arquivos de apresentação do Microsoft PowerPoint e OpenOffice sem o uso de qualquer software como Microsoft ou Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Converter PDF para SVG em Java" %}}
...
Como uma API moderna de processamento de documentos, o Aspose.Slides for Java exporta arquivos PDF para formatos de arquivo SVG rapidamente. A biblioteca Aspose PowerPoint permite converter PDF para SVGs e muitos outros formatos de arquivo

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Converter PDF para SVG usando Java" %}}
Para converter o PDF para SVG, você precisará criar a apresentação do arquivo PDF e salvá-lo como SVG.

{{% blocks/products/pf/agp/code-block title="Código Java para converter PDF em SVG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PDF para SVG usando Aspose.Slides para Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Estas são as etapas para converter PDF para SVG em Java." >}}
