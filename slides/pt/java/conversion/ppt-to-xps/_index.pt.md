---
title: Converter PPT para XPS via Java
weight: 8210
url: /pt/java/conversion/ppt-to-xps/ 
description: Exemplo de código de conversão Java para formato PPT para arquivo XPS. Use este código de exemplo para exportar apresentações do PowerPoint e OpenOffice para XPS em qualquer aplicativo baseado em Java Web ou Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PPT para XPS via Java" h2="Conversão de PPT para XPS Java para converter uma ou várias páginas em XPS usando a biblioteca Java no local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PPT para XPS usando Java" %}}

 Para renderizar PPT para XPS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter PPT para XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os desenvolvedores Java podem facilmente converter arquivos PPT para XPS em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de PPT para XPS Java" offSpacer="" %}}
