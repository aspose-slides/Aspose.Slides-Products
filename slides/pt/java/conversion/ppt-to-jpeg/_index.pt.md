...
title: Converter PPT para JPEG via Java
weight: 4700
url: /pt/java/conversion/ppt-to-jpeg/ 
description: Exemplo de código de conversão Java para formato PPT para arquivo JPEG. Use este código de exemplo para exportar apresentações do PowerPoint e OpenOffice para JPEG em qualquer aplicativo baseado em Java Web ou Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PPT para JPEG via Java" h2="Conversão de PPT para JPEG Java para converter uma ou várias páginas em JPEG usando a biblioteca Java no local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PPT para JPEG usando Java" %}}

 Para renderizar PPT para JPEG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter PPT para JPEG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os desenvolvedores Java podem facilmente converter arquivos PPT para JPEG em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de PPT para JPEG Java" offSpacer="" %}}
