---
title: Converter PNG para PPT em Java
url: /pt/java/conversion/png-to-ppt/
keywords: Converter PNG para PPT, PNG para PPT, PowerPoint, PNG, PPT, API Java, Biblioteca Java
description: Converter PNG para PPT em Java. Use a API da biblioteca Java para converter imagens PNG em PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converter PNG para PPT em Java" h2="Poderosa API Java de plataforma cruzada para converter PNG em PPT usando código Java" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Converter PNG para PPT em Java" %}}
Usando [**Aspose.Slides para Java**](https://products.aspose.com/slides/pt/java/), você pode converter imagens PNG em apresentações do PowerPoint com apenas algumas linhas de código:

{{% blocks/products/pf/agp/code-block title="Código Java para converter PNG para PPT" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Como converter PNG para PPT em Java" >}}
