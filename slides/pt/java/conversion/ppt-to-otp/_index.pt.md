---
title: Converter PPT para OTP via Java
weight: 30
url: /pt/java/conversion/ppt-to-otp/ 
description: Exemplo de código de conversão Java para formato PPT para arquivo OTP. Use este código de exemplo para exportar apresentações do PowerPoint e OpenOffice para OTP em qualquer aplicativo baseado em Java Web ou Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PPT para OTP via Java" h2="Conversão de PPT para OTP Java para converter páginas únicas ou múltiplas para OTP usando a biblioteca Java no local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PPT para OTP usando Java" %}}

 Para renderizar PPT para OTP, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter PPT para OTP via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os desenvolvedores Java podem facilmente converter arquivos PPT para OTP em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão Java de PPT para OTP" offSpacer="" %}}
