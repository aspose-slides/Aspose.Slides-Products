---
title: Converter PPT para ODP via Java
weight: 2760
url: /pt/java/conversion/ppt-to-odp/ 
description: Exemplo de código de conversão Java para formato PPT para arquivo ODP. Use este código de exemplo para exportar apresentações do PowerPoint e OpenOffice para ODP em qualquer aplicativo baseado em Java Web ou Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PPT para ODP via Java" h2="Conversão de PPT para ODP Java para converter páginas únicas ou múltiplas para ODP usando a biblioteca Java no local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PPT para ODP usando Java" %}}

 Para renderizar PPT para ODP, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter PPT para ODP via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os desenvolvedores Java podem facilmente converter arquivos PPT para ODP em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão Java de PPT para ODP" offSpacer="" %}}
