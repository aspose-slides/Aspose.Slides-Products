---
title: Converter PPSX para TIFF via Java
weight: 1720
url: /pt/java/conversion/ppsx-to-tiff/ 
description: Exemplo de código de conversão Java para formato PPSX para arquivo TIFF. Use este código de exemplo para exportar apresentações do PowerPoint e OpenOffice para TIFF em qualquer aplicativo baseado em Java Web ou Desktop.
---
...
{{% blocks/products/pf/agp/content h2="Como converter PPSX para TIFF usando Java" %}}

 Para renderizar PPSX para TIFF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter PPSX para TIFF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os desenvolvedores Java podem facilmente converter arquivos PPSX para TIFF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão Java PPSX para TIFF" offSpacer="" %}}
