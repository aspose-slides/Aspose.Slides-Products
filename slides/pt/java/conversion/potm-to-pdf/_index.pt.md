---
title: Converter POTM para PDF via Java
weight: 7440
url: /pt/java/conversion/potm-to-pdf/ 
description: Exemplo de código de conversão Java para formato POTM para arquivo PDF. Use este código de exemplo para exportar apresentações do PowerPoint e OpenOffice para PDF em qualquer aplicativo baseado em Java Web ou Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter POTM para PDF via Java" h2="Conversão de POTM para PDF Java para converter uma ou várias páginas em PDF usando a biblioteca Java no local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter POTM para PDF usando Java" %}}

 Para renderizar POTM para PDF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter POTM para PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os desenvolvedores Java podem facilmente converter arquivos POTM para PDF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de POTM para PDF Java" offSpacer="" %}}
