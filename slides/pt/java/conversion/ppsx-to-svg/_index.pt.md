---
title: Converter PPSX para SVG via Java
weight: 3470
url: /pt/java/conversion/ppsx-to-svg/ 
description: Exemplo de código de conversão Java para formato PPSX para arquivo SVG. Use este código de exemplo para exportar apresentações do PowerPoint e OpenOffice para SVG em qualquer aplicativo baseado em Java Web ou Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PPSX para SVG via Java" h2="Conversão de PPSX para SVG Java para converter uma ou várias páginas em SVG usando a biblioteca Java no local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PPSX para SVG usando Java" %}}

 Para renderizar PPSX para SVG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter PPSX para SVG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os desenvolvedores Java podem facilmente converter arquivos PPSX para SVG em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão Java PPSX para SVG" offSpacer="" %}}
