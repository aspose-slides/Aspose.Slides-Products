---
title: Edite ou visualize metadados de arquivos OTP via Java
weight: 4920
url: /pt/java/metadata/otp/ 
description: Código de amostra Java para editar ou exibir metadados de formato OTP no Java Runtime Environment para aplicativos JSP/JSF e aplicativos de desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extrair metadados OTP via Java" h2="Crie seus próprios aplicativos Java para adicionar, editar, remover ou extrair metadados de arquivos OTP usando APIs do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTP" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Como extrair metadados OTP usando Java" %}}

 Para obter metadados de arquivo OTP, usaremos
...
{{< blocks/products/pf/agp/feature-section-col title="Etapas para extrair metadados de OTP via Java" >}}
...
Obtenha informações de OTP usando getPresentationInfo()
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Atualizar e gravar informações de OTP com novas propriedades
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Extrair metadados de OTP - Java" offSpacer="" %}}
