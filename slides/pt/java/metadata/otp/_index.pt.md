...
{{% blocks/products/pf/agp/code-block title="Modificar propriedades integradas OTP - Java" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Adicionar propriedades personalizadas a OTP - Java" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como extrair metadados de OTP via Java" >}}
