...
{{% blocks/products/pf/agp/code-block title="Modificar propriedades integradas FODP - Java" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Adicionar propriedades personalizadas a FODP - Java" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Como extrair metadados de FODP via Java" >}}
