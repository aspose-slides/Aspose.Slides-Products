---
title: Mesclar SVG para PNG em Java
url: /pt/java/merger/svg-to-png/
keywords: Mesclar SVG para PNG, SVG para PNG, Juntar SVG para PNG, Combinar SVG para PNG, API Java, Biblioteca Java
description: Mesclar SVG para PNG em Java. Use a API da biblioteca Java para combinar arquivos SVG e PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar SVG para PNG em Java" h2="Biblioteca Java de plataforma cruzada e de alta velocidade para mesclar imagens SVG a PNG usando código Java" >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar SVG para PNG usando Aspose.Slides" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/pt/java/) é uma poderosa biblioteca Java usada para mesclar e manipular apresentações, imagens e outros arquivos. Ao mesclar SVG com PNG, você está efetivamente combinando imagens SVG para obter uma imagem PNG.
...
{{% blocks/products/pf/feature-page-section  h2="Mesclar SVG para PNG em Java" %}}
Usando [**Aspose.Slides for Java**](https://products.aspose.com/slides/pt/java/), você pode mesclar arquivos SVG para PNG rapidamente com apenas algumas linhas de código

{{% blocks/products/pf/agp/code-block title="Código Java para mesclar SVG para PNG" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Como mesclar SVG para PNG em Java" >}}
