---
title: Mesclar JPG para PDF em Java
url: /pt/java/merger/jpg-to-pdf/
keywords: JPG para PDF, Mesclar JPG para PDF, Juntar JPG para PDF, PDF, JPG, API Java, Biblioteca Java
description: Mesclar JPG para PDF em Java. Use a API da biblioteca Java para combinar JPG e PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Mesclar JPG para PDF em Java" h2="Biblioteca Java multiplataforma e de alta velocidade para mesclar arquivos JPG em PDF usando código Java" >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar JPG para PDF usando Aspose.Slides" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/pt/java/) é uma poderosa biblioteca Java usada para criar, converter, mesclar e manipular apresentações, PDFs, imagens e outros arquivos. Ao mesclar JPG com PDF, você está efetivamente combinando imagens JPG para obter um único arquivo PDF.
...
{{% blocks/products/pf/feature-page-section  h2="Mesclar JPG para PDF em Java" %}}
Usando [**Aspose.Slides for Java**](https://products.aspose.com/slides/pt/java/), você pode mesclar JPG para PDF rapidamente com apenas algumas linhas de código

{{% blocks/products/pf/agp/code-block title="Código Java para mesclar JPG para PDF" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Como mesclar JPG para PDF em Java" >}}
