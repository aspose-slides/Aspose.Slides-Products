---
title: Mesclar imagens em Java
url: /pt/java/merger/image-to-image/
keywords: Mesclar imagem, imagem a imagem, unir imagens, combinar imagens, API Java, biblioteca Java
description: Mesclar imagem para imagem em Java. Use a API da biblioteca Java para combinar imagens
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge image in Java" h2="Biblioteca Java de plataforma cruzada e de alta velocidade para mesclar imagens usando código Java" >}}

{{% blocks/products/pf/feature-page-section h2="Mesclar imagem a imagem usando Aspose.Slides" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/pt/java/) é uma poderosa biblioteca Java usada para mesclar e manipular apresentações, imagens e outros arquivos. Ao mesclar imagem com imagem, você está efetivamente combinando duas imagens para obter uma imagem.
...
{{% blocks/products/pf/feature-page-section  h2="Mesclar imagem para imagem em Java" %}}
Using [**Aspose.Slides for Java**](https://products.aspose.com/slides/pt/java/), you can merge image files quickly with just a few lines of code

{{% blocks/products/pf/agp/code-block title="Código Java para mesclar imagem a imagem" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Como mesclar imagens em Java" >}}
