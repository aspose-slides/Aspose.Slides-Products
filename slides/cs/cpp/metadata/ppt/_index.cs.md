---
title: Upravujte nebo zobrazujte metadata dokumentu PPT prostřednictvím C++
weight: 6080
url: /cs/cpp/metadata/ppt/ 
description: Příklad kódu C++ pro úpravu nebo zobrazení metadat souboru PPT v prostředí C++ Runtime Environment pro Windows 32 bit, Windows 64 bit a Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extrahujte metadata PPT přes C++" h2="Sestavte si své vlastní aplikace C++ pro přidávání, úpravy, odstraňování nebo extrahování metadat ze souborů PPT pomocí rozhraní API na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak získat metadata PPT pomocí C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Extrahujte metadata PPT - C++" offSpacer="" %}}
