...
url: /cs/cpp/editor/pdf/
keywords: Upravit PDF, PDF, C++ API, C++ knihovna
description: Upravit PDF v C++. K úpravě dokumentu PDF použijte API knihovny C++
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Upravit PDF v C++" h2="Vysokorychlostní a multiplatformní knihovna C++ pro úpravu PDF pomocí kódu C++" >}}

{{% blocks/products/pf/feature-page-section h2="Upravte PDF pomocí Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/cs/cpp/) je výkonná knihovna C++ používaná k manipulaci a úpravám prezentací, dokumentů PDF a dalších souborů. Dokument PDF můžete upravit přidáním nového řádku textu. 
...
Pomocí [**Aspose.Slides for C++**](https://products.aspose.com/slides/cs/cpp/) můžete do dokumentu PDF přidat nový řádek textu pomocí pouhých několika řádků kódu.
...
{{< blocks/products/pf/feature-page-section  h2="Jak upravovat PDF v C++" >}}
