...
title: Převeďte PPT do PDF pomocí aplikace C++
weight: 6240
url: /cs/cpp/conversion/ppt-to-pdf/ 
description: Ukázka převodního kódu C++ pro dokument PPT do formátu PDF. Použijte ukázkový kód pro dávkový převod PPT do PDF v jakékoli aplikaci C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést PPT do PDF přes C++" h2="Vysoce výkonný převod PPT do PDF pomocí knihovny C++ bez nutnosti instalace Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor PPT do PDF pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze PPT do PDF C++" offSpacer="" %}}
