...
url: /cs/cpp/merger/image-to-pdf/
keywords: Obrázek do PDF, Sloučit obrázek do PDF, Sloučit obrázek do PDF, PDF, Obrázek, C++ API, C++ knihovna
description: Sloučit obrázek do PDF v C++. Použijte API knihovny C++ ke kombinaci obrázků a PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Sloučit obrázek do PDF v C++" h2="Vysokorychlostní a multiplatformní knihovna C++ pro slučování obrázků do souborů PDF pomocí kódu C++" >}}

{{% blocks/products/pf/feature-page-section h2="Sloučit obrázek do PDF pomocí Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/cs/cpp/) je výkonná knihovna C++ používaná k vytváření, převodu, slučování a manipulaci s prezentacemi, soubory PDF, obrázky a dalšími soubory. Když sloučíte obrázek do PDF, efektivně kombinujete obrázky a získáte jeden soubor PDF.
...
Pomocí [**Aspose.Slides for C++**](https://products.aspose.com/slides/cs/cpp/) můžete rychle sloučit obrázek do PDF pomocí několika řádků kódu
