---
title: Sloučit SVG do PNG v C++
url: /cs/cpp/merger/svg-to-png/
keywords: Sloučit SVG do PNG, SVG do PNG, Připojit SVG k PNG, Kombinovat SVG do PNG, C++ API, C++ knihovna
description: Sloučit SVG do PNG v C++. Použijte API knihovny C++ ke kombinaci souborů SVG a PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Sloučit SVG do PNG v C++" h2="Vysokorychlostní a multiplatformní knihovna C++ pro slučování obrázků SVG do PNG pomocí kódu C++" >}}

{{% blocks/products/pf/feature-page-section h2="Sloučit SVG do PNG pomocí Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/cs/cpp/) je výkonná knihovna C++ používaná ke slučování a manipulaci s prezentacemi, obrázky a dalšími soubory. Když sloučíte SVG do PNG, efektivně kombinujete obrázky SVG a získáte obrázek PNG.
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit SVG do PNG v C++" %}}
Pomocí [**Aspose.Slides for C++**](https://products.aspose.com/slides/cs/cpp/) můžete rychle sloučit soubory SVG do PNG pomocí několika řádků kódu

{{% blocks/products/pf/agp/code-block title="C++ kód pro sloučení SVG do PNG" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="Jak sloučit SVG do PNG v C++" >}}
