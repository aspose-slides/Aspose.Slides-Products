...
url: /cs/cpp/merger/png-to-pdf/
keywords: PNG do PDF, Sloučit PNG do PDF, Připojit PNG k PDF, PDF, PNG, C++ API, C++ Library
description: Sloučit PNG do PDF v C++. Použijte API knihovny C++ ke kombinaci PNG a PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Sloučit PNG do PDF v C++" h2="Vysokorychlostní a multiplatformní knihovna C++ pro slučování souborů PNG do PDF pomocí kódu C++" >}}

{{% blocks/products/pf/feature-page-section h2="Sloučit PNG do PDF pomocí Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/cs/cpp/) je výkonná knihovna C++ používaná k vytváření, převodu, slučování a manipulaci s prezentacemi, obrázky a dalšími soubory. Když sloučíte PNG do PDF, efektivně kombinujete obrázky PNG a získáte jeden soubor PDF.
...
Pomocí [**Aspose.Slides for C++**](https://products.aspose.com/slides/cs/cpp/) můžete rychle sloučit PNG do PDF pomocí několika řádků kódu
