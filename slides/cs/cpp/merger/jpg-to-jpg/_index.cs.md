...
url: /cs/cpp/merger/jpg-to-jpg/
keywords: Sloučit JPG, JPEG do JPG, připojit JPG, kombinovat JPG, C++ API, C++ knihovna
description: Sloučit JPG do JPG v C++. Ke kombinaci souborů JPG použijte API knihovny C++
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Sloučit JPG v C++" h2="Vysokorychlostní a multiplatformní knihovna C++ pro slučování obrázků JPG pomocí kódu C++" >}}

{{% blocks/products/pf/feature-page-section h2="Sloučit JPG do JPG pomocí Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/cs/cpp/) je výkonná knihovna C++ používaná ke slučování a manipulaci s prezentacemi, obrázky a dalšími soubory. Když sloučíte JPG do JPG, efektivně kombinujete dva obrázky a získáte jeden obrázek.
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit JPG do JPEG v C++" %}}
Pomocí [**Aspose.Slides for C++**](https://products.aspose.com/slides/cs/cpp/) můžete rychle sloučit soubory JPG pomocí několika řádků kódu
