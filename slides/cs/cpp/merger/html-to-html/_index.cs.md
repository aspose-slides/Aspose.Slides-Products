...
description: Sloučit HTML do HTML v C++. Ke kombinování souborů HTML použijte API knihovny C++
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Sloučit HTML v C++" h2="Vysokorychlostní a multiplatformní knihovna C++ pro slučování souborů HTML pomocí kódu C++" >}}

{{% blocks/products/pf/feature-page-section h2="Sloučit HTML do HTML pomocí Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/cs/cpp/) je výkonná knihovna C++ používaná k vytváření, převodu, slučování a manipulaci s prezentacemi, soubory HTML a dalšími dokumenty . Když sloučíte HTML do HTML, efektivně kombinujete obsah ze 2 dokumentů a získáte jeden soubor HTML. Aspose.Slides umožňuje sloučit dokumenty HTML různými způsoby. Můžete sloučit HTML se všemi jejich texty, formátováním, styly atd.
...
Pomocí [**Aspose.Slides for C++**](https://products.aspose.com/slides/cs/cpp/) můžete rychle sloučit soubory HTML pomocí několika řádků kódu
