...
title: Extrahujte text a obrázky z dokumentu ODP přes C++
weight: 460
url: /cs/cpp/parser/odp/ 
description: Příklad kódu C++ pro extrahování textu a obrázků ze souboru ODP v C++ Runtime Environment pro Windows 32 bit, Windows 64 bit a Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Analyzujte formáty ODP v C++" h2="Nativní a vysoce výkonná analýza dokumentů ODP pomocí Aspose.Slides pro C++ API na straně serveru bez použití jakéhokoli softwaru, jako je Microsoft nebo Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Jak analyzovat soubor ODP pomocí C++" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Kroky k analýze souborů ODP v C++" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Základní analýzu dokumentu pomocí [Aspose.Slides for C++](https://products.aspose.com/slides/cs/cpp/) API lze provést pomocí několika řádků kódu." >}}
...
{{% blocks/products/pf/agp/code-block title="Analyzovat soubory ODP - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/cs/cpp/parser/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/cs/cpp/parser/pptx/" name="PPTX" description="Formát otevřené prezentace XML" >}}
