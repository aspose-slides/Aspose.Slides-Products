---
title: Export JasperReports do PowerPointu | Aspose.Slides
weight: 8320
url: /cs/jasperreports/ 
description: Aspose.Slides PowerPoint API pro JaspreReport pro export zpráv z Jasper Reports a JasperServer do formátů PowerPoint. Vytvářejte a exportujte účty, obrázky grafů, textové a řádkové zprávy do prezentace PPT
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Export sestav JasperServer do prezentací PowerPoint" h2="PowerPoint API pro export zpráv JasperReports a JasperServer do PPT(X), PPS(X) a dalších formátů PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-jasperreports.svg" pfName="Aspose.Slides" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/slides/jasperreport" >}}
...
{{< blocks/products/pf/carousel-item h3="Na první pohled" description="Přehled Aspose.Slides pro JasperReports." >}}
...
{{< blocks/products/pf/carousel-item h3="Nezávislost na platformě" description="Aspose.Slides PowerPoint API podporuje J2SE, JasperReports a JasperServer." >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
...
17.6 a novější verze
  ...
  <div class="d1-col d1-right">
   <header style="padding-left: 0px;">
    ...
    JasperReports 2.0, 3.0 nebo vyšší
   </header>
   <ul>
    <li>
17.5 a starší verze
   ...
   <header style="padding-left: 0px;">
    ...
    JasperReports 3.7.2 nebo vyšší.
   </header>
   <ul>
    <li>
17.6 a novější verze
...
{{< blocks/products/pf/carousel-item h3="Podporované formáty souborů" description="Aspose.Slides pro JasperReports může exportovat sestavy v Microsoft PowerPointu [formáty souborů](https://docs.aspose.com/slides/jasperreports/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Pokročilé funkce JasperReports pro export prezentací</h2>

<p> </p>

<div class="col-lg-4"><em class="fa fa-file-powerpoint-o  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Vytvářejte sestavy účtů a exportujte je do prezentací Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-bar-chart   ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Vytvářejte sestavy grafů a exportujte je do prezentací Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-pie-chart ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Vytvářejte sestavy víceosých grafů a exportujte je do prezentací Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-file-text ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Vytvářejte obrázky, text, čáry a exportujte tyto sestavy do prezentace Microsoft PowerPoint</p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Slides pro JasperReports podporuje export komplexních sestav obsahujících
     <strong>
      MultipleAxisChartReport
     </strong>
     do prezentací Microsoft PowerPoint. Výstup je přesně stejný, jak se jeví při prohlížení přes JasperViewer.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Dokumentace" href="https://docs.aspose.com/slides/jasperreports/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Proč Aspose.Slides pro JasperReports?" tabId="success-stories" >}}
