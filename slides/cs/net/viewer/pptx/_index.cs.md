...
title: Zobrazit formáty souborů PPTX přes .NET
weight: 6390
url: /cs/net/viewer/pptx/ 
description: Zdrojový kód C# pro načítání, vykreslování a zobrazování dokumentů PPTX na platformách .NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Prohlížeč souborů PPTX pro .NET" h2="Prohlížejte prezentační soubory, jako je PPTX, bez aplikace Microsoft PowerPoint nebo Office Automation" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak zobrazit soubor PPTX pomocí C#" %}}

 K zobrazení souboru PPTX použijeme
...
{{< blocks/products/pf/agp/feature-section-col title="Kroky k zobrazení PPTX přes C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Aspose.Slides usnadňuje vývojářům prohlížení souboru PPTX pomocí několika řádků kódu." >}}

{{< blocks/products/pf/agp/step-autogen >}}
Vytvořte instanci objektu Presentation a načtěte soubor PPTX
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Uložte prezentaci PPTX ve formátu HTML
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Zavolejte Process.Start s cestou k výslednému HTML pro načtení obsahu PPTX ve výchozím prohlížeči
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="C# příklad kódu pro zobrazení souboru PPTX" offSpacer="" %}}
