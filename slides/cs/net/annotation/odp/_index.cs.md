---
title: Odebrat anotaci ODP pomocí .NET
weight: 4380
...
{{< blocks/products/pf/upper-banner h1="Odebrat komentáře a autory komentářů z ODP v C#" h2="Vytvářejte své vlastní aplikace .NET pro manipulaci s komentáři a autory v souborech dokumentů pomocí rozhraní API na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5="ODP" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for .NET" >}}

{{% blocks/products/pf/feature-page-section  h2="Odebrat komentáře z ODP přes C#" %}}
Abychom odstranili anotace ze souboru ODP, použijeme [Aspose.Slides for .NET](https://products.aspose.com/slides/cs/net) API, které je bohaté na funkce, výkonné a snadno použitelné API pro manipulaci s dokumenty pro platformu C#.
