---
title: Sloučit soubory HTML v C#
url: /cs/net/merger/html-to-html/
keywords: Merge HTML, HTML to HTML, Join HTML, Combine HTML, C# API, .NET Library
description: Sloučit HTML do HTML v C#. Ke kombinování souborů HTML použijte rozhraní API knihovny .NET
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Sloučit HTML v C#" h2="Výkonné rozhraní .NET API pro různé platformy pro slučování souborů HTML pomocí kódu C# na platformách NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Sloučit HTML do HTML pomocí Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/cs/net/) je výkonná knihovna .NET používaná k vytváření, převodu, slučování a manipulaci s prezentacemi, soubory HTML a jiné dokumenty. Když sloučíte HTML do HTML, efektivně kombinujete obsah ze 2 dokumentů a získáte jeden soubor HTML. Aspose.Slides umožňuje sloučit dokumenty HTML různými způsoby. Můžete sloučit HTML se všemi jejich texty, formátováním, styly atd.
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit HTML do HTML v C#" %}}
Pomocí [**Aspose.Slides for .NET**](https://products.aspose.com/slides/cs/net/) můžete rychle sloučit soubory HTML pomocí několika řádků kódu

{{% blocks/products/pf/agp/code-block title="C# kód pro sloučení HTML do HTML" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Jak sloučit HTML v C#" >}}
