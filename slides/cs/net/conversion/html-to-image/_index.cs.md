...
title: Převést HTML na obrázek v C#
weight: 160
url: /cs/net/conversion/html-to-image/ 
keywords: HTML to Image, Convert HTML to Image, C# API, .NET Library, HTML, Image
description: Převést HTML na obrázek v C#. K převodu souborů HTML na obrázky použijte rozhraní API knihovny .NET
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převést HTML na obrázek v C#" h2="PowerPoint .NET API pro převod souborů HTML na obrázky na platformách NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést HTML na obrázek v C#" %}}

Jak převedu HTML na obrázek v kódu?

Pomocí [**Aspose.Slides for .NET**](https://products.aspose.com/slides/cs/net/) může každý vývojář nebo aplikace převést HTML na obrázkové soubory pomocí pouhých několika řádků kódu C#.

Aspose.Slides for .NET jako moderní API pro zpracování dokumentů rychle exportuje soubory HTML do formátů souborů obrázků. Knihovna Aspose PowerPoint vám umožňuje převádět HTML na obrázky a mnoho dalších formátů souborů
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést HTML na obrázek v C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři a aplikace mohou převést HTML na obrázek tímto způsobem:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Přidejte snímky na základě stránek HTML.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Uložte snímky jako obrázky.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Než spustíte C# kód pro konverzi HTML na obrázek, váš počítač musí splňovat tyto požadavky:
...
{{% blocks/products/pf/agp/code-block title="C# kód pro převod HTML na obrázek" offSpacer="" %}}
