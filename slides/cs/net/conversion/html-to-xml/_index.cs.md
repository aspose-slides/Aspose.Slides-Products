...
title: Převést HTML na XML v C#
weight: 170
url: /cs/net/conversion/html-to-xml/ 
keywords: HTML to XML, Convert HTML to XML, C# API, .NET Library, HTML, XML
description: Převést HTML na XML v C#. K převodu dokumentu HTML na soubor XML použijte rozhraní API knihovny .NET
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převést HTML na XML v C#" h2="PowerPoint .NET API pro převod dokumentů HTML na soubory XML na platformách NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést HTML do XML v C#" %}}

Jak převedu HTML do XML v kódu?

Pomocí [**Aspose.Slides for .NET**](https://products.aspose.com/slides/cs/net/) může každý vývojář nebo aplikace převést soubory HTML na XML pomocí pouhých několika řádků kódu C#.

Aspose.Slides for .NET jako moderní API pro zpracování dokumentů rychle exportuje obsah v HTML do XML. Knihovna Aspose PowerPoint vám umožňuje převádět HTML do XML a mnoho dalších formátů souborů.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést HTML do XML v C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři a aplikace mohou převádět HTML do XML tímto způsobem:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Přidejte snímky na základě obsahu souboru HTML.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Před spuštěním kódu C# pro převod HTML na XML musí váš počítač splňovat tyto požadavky:
...
{{% blocks/products/pf/agp/code-block title="C# kód pro převod HTML do XML" offSpacer="" %}}
