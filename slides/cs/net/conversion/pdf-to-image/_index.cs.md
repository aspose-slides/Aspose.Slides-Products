...
title: Převést PDF na obrázek v C#
weight: 80
url: /cs/net/conversion/pdf-to-image/ 
keywords: PDF na obrázek, převod PDF na obrázek, C# API, .NET knihovna, PDF, obrázek
description: Převést PDF na obrázek v C#. K převodu stránek PDF na obrázky použijte rozhraní API knihovny .NET
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převést PDF na obrázek v C#" h2="PowerPoint .NET API pro převod dokumentů PDF na obrázky na platformách NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést PDF na obrázek v C#" %}}

Jak převedu PDF na obrázek v kódu?

Pomocí [**Aspose.Slides for .NET**](https://products.aspose.com/slides/cs/net/) může každý vývojář nebo aplikace převést PDF na obrazové soubory pomocí pouhých několika řádků kódu C#.

Aspose.Slides for .NET jako moderní API pro zpracování dokumentů rychle exportuje stránky PDF do obrazových formátů. Knihovna Aspose PowerPoint vám umožňuje převádět PDF na obrázek a mnoho dalších formátů souborů.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést PDF na obrázek v C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři a aplikace mohou převádět PDF na obrázek tímto způsobem:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Chcete-li snímky uložit jako obrázky, zavolejte metodu uložení.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Než spustíte C# kód pro převod PDF na obrázek, váš počítač musí splňovat tyto požadavky:
...
{{% blocks/products/pf/agp/code-block title="C# kód pro převod PDF na obrázek" offSpacer="" %}}
