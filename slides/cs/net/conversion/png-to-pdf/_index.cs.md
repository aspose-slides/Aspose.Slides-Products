---
title: Převést PNG do PDF v C#
weight: 30
url: /cs/net/conversion/png-to-pdf/ 
keywords: PNG do PDF, Převod PNG do PDF, C# API, .NET Library, PNG, PDF
description: Převést PNG do PDF v C#. K převodu obrázků PNG na dokumenty PDF použijte rozhraní API knihovny .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převést PNG do PDF v C#" h2="PowerPoint .NET API pro převod obrázků PNG do dokumentů PDF na platformách NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="PNG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG do PDF v C#" %}}

Jak programově převedu PNG do PDF?

Pomocí [**Aspose.Slides for .NET**](https://products.aspose.com/slides/cs/net/) může každý vývojář nebo aplikace převést PNG do formátu PDF pomocí pouhých několika řádků kódu C#.

Aspose.Slides for .NET jako moderní API pro zpracování dokumentů rychle vytváří soubory PDF z obrázků PNG. Knihovna Aspose PowerPoint vám umožňuje převádět PNG do PDF a mnoha dalších formátů souborů
...
{{< blocks/products/pf/agp/feature-section-col title="Kroky k převodu PNG do PDF v C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři a aplikace mohou převést PNG do PDF tímto způsobem:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Než spustíte C# kód převodu PNG do PDF, váš počítač musí splňovat tyto požadavky:
...
{{% blocks/products/pf/agp/code-block title="C# kód pro převod PNG do PDF" offSpacer="" %}}
