---
title: Převést ODP na BMP přes C#
weight: 320
url: /cs/net/conversion/odp-to-bmp/ 
description: Ukázkový kód pro převod ODP na BMP C#. Použijte ukázkový kód API pro dávkový převod souborů ODP na BMP v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést ODP na BMP přes C#" h2="Export souborů PowerPoint® ODP do BMP na platformách .NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři .NET mohou snadno načíst a převést soubory ODP do BMP pomocí několika řádků kódu." >}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod ODP na BMP C#" offSpacer="" %}}
