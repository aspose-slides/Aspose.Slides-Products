...
keywords: HTML na JPG, Převod HTML na JPG, C# API, .NET Library, HTML, JPG
description: Převést HTML na JPG v C#. K převodu souborů HTML na obrázky JPG použijte rozhraní API knihovny .NET
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převést HTML na JPG v C#" h2="PowerPoint .NET API pro převod souborů HTML na obrázky JPG na platformách NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést HTML na JPG v C#" %}}

Jak převedu HTML do JPG v kódu?

Pomocí [**Aspose.Slides for .NET**](https://products.aspose.com/slides/cs/net/) může každý vývojář nebo aplikace převést HTML do formátu JPG pomocí pouhých několika řádků kódu C#.

Aspose.Slides for .NET jako moderní API pro zpracování dokumentů rychle exportuje HTML soubory do JPG. Knihovna Aspose PowerPoint vám umožňuje převádět HTML na JPG a mnoho dalších formátů souborů
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést HTML na JPG v C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři a aplikace mohou převádět HTML do JPG tímto způsobem:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Přidejte snímky na základě obsahu v dokumentu HTML.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Uložte snímky jako obrázky JPG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Než spustíte C# kód pro převod HTML na JPG, váš počítač musí splňovat tyto požadavky:
...
{{% blocks/products/pf/agp/code-block title="C# kód pro převod HTML do JPG" offSpacer="" %}}
