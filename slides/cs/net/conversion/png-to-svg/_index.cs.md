...
keywords: PNG na SVG, Převod PNG na SVG, C# API, .NET Library
description: Převést PNG na SVG v C#. K převodu souborů PNG na SVG použijte rozhraní API knihovny .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převést PNG na SVG v C#" h2="PowerPoint .NET API pro převod souborů obrázků PNG na SVG na platformách NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Převést PNG na SVG v C#" %}}

Jak převedu PNG na SVG v kódu?

Pomocí [**Aspose.Slides for .NET**](https://products.aspose.com/slides/cs/net/) může každý vývojář nebo aplikace převést PNG na SVG pomocí pouhých několika řádků kódu C#.

Aspose.Slides for .NET jako moderní API pro zpracování dokumentů rychle exportuje soubory PNG do SVG. Knihovna Aspose PowerPoint vám umožňuje převádět PNG na SVG a obrázky v jiných formátech.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést PNG na SVG v C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři a aplikace mohou převést PNG na SVG tímto způsobem:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Uložte soubor jako obrázek SVG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Před spuštěním kódu C# převodu PNG na SVG musí váš počítač splňovat tyto požadavky:
...
{{% blocks/products/pf/agp/code-block title="C# kód pro převod PNG na SVG" offSpacer="" %}}
