...
weight: 110
url: /cs/net/conversion/pdf-to-tiff/ 
keywords: PDF na TIFF, převod PDF na TIFF, C# API, .NET knihovna, PDF, TIFF
description: Převést PDF na TIFF v C#. K převodu stránek PDF na obrázky TIFF použijte rozhraní API knihovny .NET
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převést PDF na TIFF v C#" h2="PowerPoint .NET API pro převod dokumentů PDF na obrázky TIFF na platformách NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést PDF na TIFF v C#" %}}

Jak převedu PDF do TIFF v kódu?

Pomocí [**Aspose.Slides for .NET**](https://products.aspose.com/slides/cs/net/) může každý vývojář nebo aplikace převést PDF do formátu TIFF pomocí pouhých několika řádků kódu C#.

Aspose.Slides for .NET jako moderní API pro zpracování dokumentů rychle exportuje stránky PDF do formátu TIFF. Knihovna Aspose PowerPoint vám umožňuje převádět PDF na TIFF a mnoho dalších formátů souborů
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést PDF na TIFF v C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři a aplikace mohou převádět PDF na TIFF tímto způsobem:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Chcete-li snímky uložit jako obrázky TIFF, zavolejte metodu uložení.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Než spustíte kód C# převodu PDF na TIFF, váš počítač musí splňovat tyto požadavky:
...
{{% blocks/products/pf/agp/code-block title="C# kód pro převod PDF na TIFF" offSpacer="" %}}
