---
title: Převést PDF na PPT v C#
url: /cs/net/conversion/pdf-to-ppt/
keywords: Převod PDF do PPT, PDF do PPT, PowerPoint, PDF, PPT, C# API, .NET Library
description: Převést PDF na PPT v C#. K převodu PDF do PowerPointu použijte rozhraní API knihovny .NET
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Převést PDF na PPT v C#" h2="Výkonné rozhraní .NET API pro různé platformy pro převod PDF na PPT pomocí kódu C# na platformách NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Převeďte PDF na PPT pomocí Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/cs/net/) je výkonná knihovna .NET používaná k vytváření, převodu a manipulaci s prezentacemi v PowerPointu, PDF, HTML dokumenty, a další soubory. Když převádíte PDF na PPT, v podstatě přesouváte obsah stránek PDF na snímky v prezentaci PowerPoint.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Převést PDF na PPT v C#" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak převést PDF na PPT v C#" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Načtěte soubor PDF, který chcete převést na PPT.
{{< /blocks/products/pf/agp/step-autogen >}}
