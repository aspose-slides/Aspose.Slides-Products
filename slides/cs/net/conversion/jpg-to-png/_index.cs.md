...
keywords: JPG na PNG, Převod JPG na PNG, C# API, .NET Library
description: Převést JPG na PNG v C#. K převodu souborů JPG na PNG použijte rozhraní API knihovny .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převést JPG na PNG v C#" h2="PowerPoint .NET API pro převod souborů obrázků JPG na PNG na platformách NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Převést JPG na PNG v C#" %}}

Jak převedu JPG do PNG v kódu?

Pomocí [**Aspose.Slides for .NET**](https://products.aspose.com/slides/cs/net/) může každý vývojář nebo aplikace převést JPG na PNG pomocí pouhých několika řádků kódu C#.

Aspose.Slides for .NET jako moderní API pro zpracování dokumentů rychle exportuje soubory JPG do PNG. Knihovna Aspose PowerPoint vám umožňuje převádět JPG do PNG a obrázky v jiných formátech.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést JPG na PNG v C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři a aplikace mohou převést JPG na PNG tímto způsobem:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Než spustíte C# kód převodu JPG na PNG, musí váš počítač splňovat tyto požadavky:
...
{{% blocks/products/pf/agp/code-block title="C# kód pro převod JPG na PNG" offSpacer="" %}}
