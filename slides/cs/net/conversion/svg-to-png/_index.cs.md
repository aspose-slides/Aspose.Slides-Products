...
keywords: SVG na PNG, Převod SVG na PNG, C# API, .NET Library
description: Převést SVG na PNG v C#. K převodu souborů SVG na soubory PNG použijte rozhraní API knihovny .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převést SVG na PNG v C#" h2="PowerPoint .NET API pro převod obrazových souborů SVG na PNG na platformách NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Převést SVG na PNG v C#" %}}

Jak převedu SVG do PNG v kódu?

Pomocí [**Aspose.Slides for .NET**](https://products.aspose.com/slides/cs/net/) může každý vývojář nebo aplikace převést SVG na PNG pomocí pouhých několika řádků kódu C#.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést SVG na PNG v C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři a aplikace mohou převést SVG na PNG tímto způsobem:" >}}
...
{{% blocks/products/pf/agp/code-block title="C# kód pro převod SVG na PNG" offSpacer="" %}}
