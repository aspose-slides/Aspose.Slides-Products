---
title: Převést PDF do HTML v C#
weight: 120
url: /cs/net/conversion/pdf-to-html/ 
keywords: PDF do HTML, Převod PDF do HTML, C# API, .NET Library, PDF, HTML
description: Převést PDF do HTML v C#. K převodu stránek PDF na soubory HTML použijte rozhraní API knihovny .NET
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převést PDF do HTML v C#" h2="PowerPoint .NET API pro převod dokumentů PDF na soubory HTML na platformách NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést PDF do HTML v C#" %}}

Jak převedu PDF do HTML v kódu?

Pomocí [**Aspose.Slides for .NET**](https://products.aspose.com/slides/cs/net/) může každý vývojář nebo aplikace převést soubory PDF do HTML pomocí několika řádků kódu C#.

Aspose.Slides for .NET jako moderní API pro zpracování dokumentů rychle exportuje stránky PDF do HTML. Knihovna Aspose PowerPoint vám umožňuje převádět PDF do HTML a mnoha dalších formátů souborů.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést PDF do HTML v C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři a aplikace mohou převádět PDF do HTML tímto způsobem:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Chcete-li snímky uložit do HTML, zavolejte metodu uložení.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Než spustíte C# kód pro převod PDF do HTML, váš počítač musí splňovat tyto požadavky:
...
{{% blocks/products/pf/agp/code-block title="C# kód pro převod PDF do HTML" offSpacer="" %}}
