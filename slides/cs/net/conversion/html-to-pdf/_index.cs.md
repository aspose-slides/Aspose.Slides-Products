...
title: Převést HTML do PDF v C#
weight: 40
url: /cs/net/conversion/html-to-pdf/ 
keywords: HTML to PDF, Convert HTML to PDF, C# API, .NET Library, HTML, PDF
description: Převést HTML do PDF v C#. K převodu stránek HTML na dokumenty PDF použijte rozhraní API knihovny .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převést HTML do PDF v C#" h2="PowerPoint .NET API pro převod HTML stránek do PDF dokumentů na platformách NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést HTML do PDF v C#" %}}

Jak programově převedu HTML do PDF?

Pomocí [**Aspose.Slides for .NET**](https://products.aspose.com/slides/cs/net/) může každý vývojář nebo aplikace převést HTML do formátu PDF pomocí pouhých několika řádků kódu C#.

Jako moderní API pro zpracování dokumentů vytváří Aspose.Slides for .NET rychle soubory PDF ze stránek HTML. Knihovna Aspose PowerPoint vám umožňuje převádět HTML do PDF a mnoho dalších formátů souborů
...
{{< blocks/products/pf/agp/feature-section-col title="Kroky k převodu HTML do PDF v C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři a aplikace mohou převádět HTML do PDF tímto způsobem:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Před spuštěním kódu C# pro převod HTML do PDF musí váš počítač splňovat tyto požadavky:
...
{{% blocks/products/pf/agp/code-block title="C# kód pro převod HTML do PDF" offSpacer="" %}}
