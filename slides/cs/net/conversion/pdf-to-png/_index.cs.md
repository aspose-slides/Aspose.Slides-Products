...
title: Převést PDF do PNG v C#
weight: 90
url: /cs/net/conversion/pdf-to-png/ 
keywords: PDF do PNG, Převod PDF do PNG, C# API, .NET Library, PDF, PNG
description: Převést PDF do PNG v C#. K převodu stránek PDF na obrázky PNG použijte rozhraní API knihovny .NET
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převést PDF do PNG v C#" h2="PowerPoint .NET API pro převod dokumentů PDF na obrázky PNG na platformách NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést PDF do PNG v C#" %}}

Jak převedu PDF do PNG v kódu?

Pomocí [**Aspose.Slides for .NET**](https://products.aspose.com/slides/cs/net/) může každý vývojář nebo aplikace převést PDF do formátu PNG pomocí pouhých několika řádků kódu C#.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést PDF do PNG v C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři a aplikace mohou převádět PDF do PNG tímto způsobem:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Chcete-li snímky uložit jako obrázky PNG, zavolejte metodu uložení.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="C# kód pro převod PDF do PNG" offSpacer="" %}}
