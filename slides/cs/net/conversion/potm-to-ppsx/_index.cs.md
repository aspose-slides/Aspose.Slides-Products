---
title: Převést POTM na PPSX přes C#
weight: 4670
url: /cs/net/conversion/potm-to-ppsx/ 
description: Ukázkový kód pro konverzi POTM na PPSX C#. Použijte ukázkový kód API pro dávkový převod souborů POTM na PPSX v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést POTM na PPSX přes C#" h2="Export souborů PowerPoint® POTM do PPSX na platformách .NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést POTM na PPSX pomocí C#" %}}

 Abychom převedli POTM na PPSX, použijeme
...
{{< blocks/products/pf/agp/feature-section-col title="Kroky k převodu POTM na PPSX přes C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři .NET mohou snadno načíst a převést soubory POTM do PPSX pomocí několika řádků kódu." >}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi POTM na PPSX C#" offSpacer="" %}}
