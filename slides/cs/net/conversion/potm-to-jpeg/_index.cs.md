---
title: Převést POTM na JPEG přes C#
weight: 6160
url: /cs/net/conversion/potm-to-jpeg/ 
description: Ukázkový kód pro konverzi POTM na JPEG C#. Použijte ukázkový kód API pro dávkový převod souborů POTM na JPEG v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést POTM na JPEG přes C#" h2="Export souborů PowerPoint® POTM do JPEG na platformách .NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést POTM na JPEG pomocí C#" %}}

 Abychom převedli POTM do JPEG, použijeme
...
{{< blocks/products/pf/agp/feature-section-col title="Kroky k převodu POTM na JPEG přes C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři .NET mohou snadno načíst a převést soubory POTM do JPEG pomocí několika řádků kódu." >}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod POTM na JPEG C#" offSpacer="" %}}
