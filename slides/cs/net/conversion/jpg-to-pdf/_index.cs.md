...
title: Převést JPG do PDF v C#
weight: 10
url: /cs/net/conversion/jpg-to-pdf/ 
keywords: JPG do PDF, Převod JPG do PDF, C# API, .NET Library
description: Převést JPG do PDF v C#. K převodu obrázků JPG JPEG na dokumenty PDF použijte rozhraní API knihovny .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převést JPG do PDF v C#" h2="PowerPoint .NET API pro převod obrázků JPG do dokumentů PDF na platformách NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést JPG do PDF v C#" %}}

Jak programově převedu JPG do PDF?

Pomocí [**Aspose.Slides for .NET**](https://products.aspose.com/slides/cs/net/) může každý vývojář nebo aplikace převést JPG do formátu PDF pomocí pouhých několika řádků kódu C#.

Jako moderní API pro zpracování dokumentů vytváří Aspose.Slides for .NET rychle soubory PDF z obrázků JPG. Knihovna Aspose PowerPoint vám umožňuje převádět JPG do PDF a mnoho dalších formátů souborů
...
{{< blocks/products/pf/agp/feature-section-col title="Kroky k převodu JPG do PDF v C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři a aplikace mohou převádět JPG do PDF tímto způsobem:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Než spustíte C# kód pro převod JPG do PDF, váš počítač musí splňovat tyto požadavky:
...
{{% blocks/products/pf/agp/code-block title="C# kód pro převod JPG do PDF" offSpacer="" %}}
