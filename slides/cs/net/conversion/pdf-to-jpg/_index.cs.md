---
title: Převést PDF na JPG v C#
weight: 70
url: /cs/net/conversion/pdf-to-jpg/ 
keywords: PDF do JPG, Převod PDF do JPG, C# API, .NET Library, PDF, JPG
description: Převést PDF do JPG v C#. K převodu stránek PDF na obrázky JPG použijte rozhraní API knihovny .NET
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převést PDF na JPG v C#" h2="PowerPoint .NET API pro převod dokumentů PDF na obrázky JPG na platformách NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést PDF na JPG v C#" %}}

Jak převedu PDF do JPG v kódu?

Pomocí [**Aspose.Slides for .NET**](https://products.aspose.com/slides/cs/net/) může každý vývojář nebo aplikace převést PDF do formátu JPG pomocí pouhých několika řádků kódu C#.

Aspose.Slides for .NET jako moderní API pro zpracování dokumentů rychle exportuje stránky PDF do JPG. Knihovna Aspose PowerPoint vám umožňuje převádět PDF do JPG a mnoha dalších formátů souborů
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést PDF na JPG v C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Vývojáři a aplikace mohou převádět PDF do JPG tímto způsobem:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Chcete-li snímky uložit jako obrázky JPG, zavolejte metodu uložení.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Než spustíte C# kód pro převod PDF na JPG, váš počítač musí splňovat tyto požadavky:
...
{{% blocks/products/pf/agp/code-block title="C# kód pro převod PDF do JPG" offSpacer="" %}}
