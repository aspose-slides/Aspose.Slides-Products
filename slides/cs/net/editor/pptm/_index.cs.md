...
title: Upravujte soubory PPTM přes .NET
url: /cs/net/editor/pptm/ 
description: Zdrojový kód C# pro úpravu dokumentu PPTM na platformách .NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Upravit formáty PPTM v C#" h2="Nativní a vysoce výkonné úpravy dokumentů PPTM pomocí rozhraní Aspose.Slides pro .NET API na straně serveru bez použití jakéhokoli softwaru, jako je Microsoft nebo Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak upravit soubor PPTM pomocí C#" %}}

K úpravě souboru PPTM použijeme rozhraní <a href="https://products.aspose.com/slides/cs/net">Aspose.Slides for .NET</a> API, které je bohaté na funkce a výkonné a snadno použitelné API pro platformu C# pro jakýkoli editor. Otevřete správce balíčků <a href="https://www.nuget.org/packages/aspose.slides.net">NuGet</a>, vyhledejte <b>Aspose.Slides</b> a nainstalujte. Můžete také použít následující příkaz z konzoly Správce balíčků.
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro úpravu souborů PPTM v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Upravit soubory PPTM – C#" offSpacer="" %}}
