...
<h2 class="h2title">Podpora pro Office Open XML</h2>

<p>Office OpenXML (OOXML) je formát založený na XML, který byl zaveden do Microsoft Office 2007.</p>

<p>PresentationML (OOXML, PPTX) je značkovací jazyk používaný aplikací Microsoft Office PowerPoint 2007 k ukládání dokumentů. Aspose.Slides for .NET rozsáhle podporuje vytváření, čtení, manipulaci a psaní dokumentů PresentationML.</p>
...
{{< blocks/products/pf/slr-element name="Poznámky k vydání" href="https://releases.aspose.com/slides/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
