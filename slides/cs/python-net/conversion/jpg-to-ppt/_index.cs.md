---
title: Převést JPG na PPT v Pythonu
url: /cs/python-net/conversion/jpg-to-ppt/
keywords: Převést JPG na PPT, JPG na PPT, PowerPoint, JPG, PPT, Python API, Python Library
description: Převést JPG na PPT v Pythonu. K převodu obrázků JPG do PowerPointu použijte API knihovny Python
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Převést JPG na PPT v Pythonu" h2="Výkonné multiplatformní Python API pro převod JPG na PPT pomocí kódu Python" >}}

{{% blocks/products/pf/feature-page-section h2="Převeďte JPG na PPT pomocí Aspose.Slides" %}}

[**Aspose.Slides pro Python přes .NET**](https://products.aspose.com/slides/cs/python-net/) je výkonná knihovna Pythonu používaná k vytváření, převodu a manipulaci s prezentacemi v PowerPointu, PDF, HTML dokumenty a další soubory. Když převedete JPG na PPT, v podstatě vytváříte prezentaci PowerPoint, která obsahuje snímky založené na obrázcích JPG.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Převést JPG na PPT v Pythonu" %}}
...
{{% blocks/products/pf/agp/code-block title="Python kód pro převod JPG na PPT" offSpacer="true" %}}
```py
...
{{< blocks/products/pf/feature-page-section  h2="Jak převést JPG na PPT v Pythonu" >}}
