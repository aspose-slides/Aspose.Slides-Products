---
title: Převeďte PNG na PPTX v Pythonu
url: /cs/python-net/conversion/png-to-pptx/
keywords: Převést PNG na PPTX, PNG na PPTX, PowerPoint, PNG, PPTX, Python API, Python Library
description: Převeďte PNG na PPTX v Pythonu. K převodu obrázků PNG do PowerPointu použijte rozhraní API knihovny Python
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Převeďte PNG na PPTX v Pythonu" h2="Výkonné multiplatformní Python API pro převod PNG na PPTX pomocí kódu Python" >}}

{{% blocks/products/pf/feature-page-section h2="Převeďte PNG na PPTX pomocí Aspose.Slides" %}}

[**Aspose.Slides pro Python přes .NET**](https://products.aspose.com/slides/cs/python-net/) je výkonná knihovna Pythonu používaná k vytváření, převodu a manipulaci s prezentacemi v PowerPointu, PDF, HTML dokumenty a další soubory. Když převedete PNG na PPTX, v podstatě vytváříte prezentaci PowerPoint, která obsahuje snímky založené na obrázcích PNG.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Převeďte PNG na PPTX v Pythonu" %}}
...
{{% blocks/products/pf/agp/code-block title="Python kód pro převod PNG na PPTX" offSpacer="true" %}}
```py
...
{{< blocks/products/pf/feature-page-section  h2="Jak převést PNG na PPTX v Pythonu" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Načtěte obrázek PNG, který chcete převést na PPTX.
{{< /blocks/products/pf/agp/step-autogen >}}
