...
title: Převést OTP na JPG v Pythonu
weight: 500
url: /cs/python-net/conversion/otp-to-jpg/ 
keywords: "Convert, PowerPoint, OTP, JPG, Presentation, Python"
description: Ukázkový kód pro převod OTP na JPG Python. Použijte PowerPoint Python API pro dávkovou konverzi souborů OTP na soubory JPG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést OTP na JPG v Pythonu" h2="Výkonná PowerPoint Python knihovna pro převod OTP do JPG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Převést OTP na JPG v Pythonu" %}}

Potřebujete převést OTP soubory do JPG programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/cs/python-net/) může každý vývojář převést OTP do formátu JPG pomocí pouhých několika řádků kódu Python.

Aspose.Slides pro Python jako moderní API pro zpracování prezentací rychle vytváří JPG z OTP. Otestujte kvalitu převodu OTP na JPG přímo ve svém [prohlížeči](https://products.aspose.app/slides/conversion/ppt-to-jpg). Knihovna Aspose PowerPoint PPTX umožňuje převádět soubory OTP do mnoha oblíbených formátů.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést OTP na JPG v Pythonu" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky k převodu souboru OTP na JPG pomocí Pythonu." >}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod OTP na JPG Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Uložte OTP jako JPG v Pythonu" %}}
Pomocí bezplatné aplikace si můžete prohlédnout ukázku procesu převodu OTP na JPG. 
{{% /blocks/products/pf/agp/content %}}
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        appName="conversion"
        extension=""
        sectionTitle="Aplikace zdarma k převodu OTP na JPG" 
