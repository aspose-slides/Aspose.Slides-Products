...
Potřebujete převést soubory OTP na PPS programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/cs/python-net/) může každý vývojář převést OTP do formátu PPS pomocí pouhých několika řádků kódu Python.
