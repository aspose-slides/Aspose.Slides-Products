...
Potřebujete převést soubory PPSX do POT programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/cs/python-net/) může každý vývojář převést PPSX do formátu POT pomocí pouhých několika řádků kódu Python.
