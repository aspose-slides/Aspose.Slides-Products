...
Potřebujete převést soubory OTP na PPT programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/cs/python-net/) může každý vývojář převést OTP do formátu PPT pomocí pouhých několika řádků kódu Python.
