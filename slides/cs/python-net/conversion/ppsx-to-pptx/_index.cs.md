...
Potřebujete převést soubory PPSX na PPTX programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/cs/python-net/) může každý vývojář převést PPSX do formátu PPTX pomocí pouhých několika řádků kódu Python.
