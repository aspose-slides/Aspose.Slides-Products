...
Potřebujete převést soubory PPSX na XPS programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/cs/python-net/) může každý vývojář převést PPSX do formátu XPS pomocí pouhých několika řádků kódu Python.
