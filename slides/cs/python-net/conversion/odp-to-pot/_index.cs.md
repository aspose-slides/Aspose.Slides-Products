...
weight: 320
url: /cs/python-net/conversion/odp-to-pot/ 
keywords: "Convert, PowerPoint, ODP, POT, Presentation, Python"
description: Ukázkový kód pro konverzi ODP na POT Python. Použijte PowerPoint Python API pro dávkovou konverzi souborů ODP na soubory POT.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte ODP na POT v Pythonu" h2="Výkonná PowerPoint Python knihovna pro převod ODP na POT" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Převeďte ODP na POT v Pythonu" %}}

Potřebujete převést soubory ODP na POT programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/cs/python-net/) může každý vývojář převést ODP do formátu POT pomocí pouhých několika řádků kódu Python.

Jako moderní API pro zpracování prezentací vytváří Aspose.Slides pro Python rychle POT z ODP. Otestujte kvalitu převodu ODP na POT přímo ve svém [prohlížeči](https://products.aspose.app/slides/conversion). Knihovna Aspose PowerPoint PPTX umožňuje převádět soubory ODP do mnoha oblíbených formátů.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést ODP na POT v Pythonu" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky k převodu souboru ODP na POT pomocí Pythonu." >}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod ODP na POT Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Uložte ODP jako POT v Pythonu" %}}
Pomocí bezplatné aplikace si můžete prohlédnout ukázku procesu převodu ODP na POT. 
{{% /blocks/products/pf/agp/content %}}
