...
weight: 180
url: /cs/python-net/conversion/fodp-to-pptx/ 
keywords: "Convert, PowerPoint, FODP, PPTX, Presentation, Python"
description: Ukázkový kód pro konverzi FODP na PPTX Python. Použijte PowerPoint Python API pro dávkový převod souborů FODP na soubory PPTX.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte FODP na PPTX v Pythonu" h2="Výkonná PowerPoint Python knihovna pro převod FODP na PPTX" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Převeďte FODP na PPTX v Pythonu" %}}

Potřebujete převést soubory FODP na PPTX programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/cs/python-net/) může každý vývojář převést FODP do formátu PPTX pomocí pouhých několika řádků kódu Python.

Aspose.Slides pro Python jako moderní API pro zpracování prezentací rychle vytváří PPTX z FODP. Otestujte kvalitu převodu FODP na PPTX přímo ve svém [prohlížeči](https://products.aspose.app/slides/conversion). Knihovna Aspose PowerPoint PPTX umožňuje převádět soubory FODP do mnoha oblíbených formátů.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést FODP na PPTX v Pythonu" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky k převodu souboru FODP na PPTX pomocí Pythonu." >}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod FODP na PPTX Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Uložte FODP jako PPTX v Pythonu" %}}
Pomocí bezplatné aplikace si můžete prohlédnout ukázku procesu převodu FODP na PPTX. 
{{% /blocks/products/pf/agp/content %}}
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        appName="conversion"
        extension=""
        sectionTitle="Aplikace zdarma k převodu FODP na PPTX" 
