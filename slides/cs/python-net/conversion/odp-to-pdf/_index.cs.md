...
Potřebujete převést soubory ODP do PDF programově? Pomocí [*Aspose.Slides pro Python přes .NET*](https://products.aspose.com/slides/cs/python-net/) může každý vývojář převést ODP do formátu PDF pomocí pouhých několika řádků kódu Python.
