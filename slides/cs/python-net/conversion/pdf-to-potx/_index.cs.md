...
title: Převeďte PDF do POTX v Pythonu
weight: 780
url: /cs/python-net/conversion/pdf-to-potx/ 
keywords: "Convert, PowerPoint, PDF, POTX, Presentation, Python"
description: Ukázkový kód pro převod PDF na POTX Python. Použijte PowerPoint Python API pro dávkový převod souborů PDF na soubory POTX.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte PDF do POTX v Pythonu" h2="Výkonná PowerPoint Python knihovna pro převod PDF do POTX" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést PDF do POTX v Pythonu" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky k převodu souboru PDF na POTX pomocí Pythonu." >}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi PDF na POTX Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Uložit PDF jako POTX v Pythonu" %}}
Pomocí bezplatné aplikace si můžete prohlédnout ukázku procesu převodu PDF na POTX. 
{{% /blocks/products/pf/agp/content %}}
