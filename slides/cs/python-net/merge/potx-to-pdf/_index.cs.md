---
title: Sloučit soubory POTX do PDF pomocí Pythonu
url: /cs/python-net/merge/potx-to-pdf/
keywords: Sloučit POTX do PDF, připojit POTX do PDF, kombinovat POTX do PDF, PowerPoint, Presentation, PDF, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Sloučit soubory POTX do PDF dohromady v Pythonu" h2="Vysokorychlostní a multiplatformní Python API, které pomáhá při vývoji aplikací se schopností vytvářet, slučovat, kontrolovat nebo převádět prezentační soubory Microsoft PowerPoint a OpenOffice bez použití jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Sloučit POTX do PDF v Pythonu" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit soubory POTX do PDF pomocí Pythonu" %}}
Chcete-li sloučit prezentace PowerPoint, budete muset naklonovat snímky z jedné prezentace do druhé.

{{% blocks/products/pf/agp/code-block title="Python kód pro sloučení více POTX do jednoho souboru PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak sloučit POTX do PDF pomocí Aspose.Slides pro Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky ke sloučení dvou souborů POTX a uložení výsledku jako PDF v Pythonu." >}}
