---
title: Sloučit soubory PDF do HTML pomocí Pythonu
url: /cs/python-net/merge/pdf-to-html/
keywords: Sloučit PDF do HTML, připojit PDF do HTML, kombinovat PDF do HTML, PowerPoint, Presentation, HTML, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Sloučit soubory PDF do HTML dohromady v Pythonu" h2="Vysokorychlostní a multiplatformní Python API, které pomáhá při vývoji aplikací se schopností vytvářet, slučovat, kontrolovat nebo převádět prezentační soubory Microsoft PowerPoint a OpenOffice bez použití jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Sloučit PDF do HTML v Pythonu" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit soubory PDF do HTML pomocí Pythonu" %}}
Chcete-li sloučit prezentace PowerPoint, budete muset naklonovat snímky z jedné prezentace do druhé.

{{% blocks/products/pf/agp/code-block title="Python kód pro sloučení více PDF do jednoho souboru HTML" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak sloučit PDF do HTML pomocí Aspose.Slides pro Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky ke sloučení dvou souborů PDF a uložení výsledku jako HTML v Pythonu." >}}
