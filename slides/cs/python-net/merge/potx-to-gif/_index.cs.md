---
title: Sloučit soubory POTX do GIF pomocí Pythonu
url: /cs/python-net/merge/potx-to-gif/
keywords: Sloučit POTX do GIF, připojit POTX do GIF, kombinovat POTX do GIF, PowerPoint, Presentation, GIF, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Sloučit soubory POTX do GIF dohromady v Pythonu" h2="Vysokorychlostní a multiplatformní Python API, které pomáhá při vývoji aplikací se schopností vytvářet, slučovat, kontrolovat nebo převádět prezentační soubory Microsoft PowerPoint a OpenOffice bez použití jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Sloučit POTX do GIF v Pythonu" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit soubory POTX do GIF pomocí Pythonu" %}}
Chcete-li sloučit prezentace PowerPoint, budete muset naklonovat snímky z jedné prezentace do druhé.

{{% blocks/products/pf/agp/code-block title="Python kód pro sloučení více POTX do jednoho souboru GIF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak sloučit POTX do GIF pomocí Aspose.Slides pro Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky ke sloučení dvou souborů POTX a uložení výsledku jako GIF v Pythonu." >}}
