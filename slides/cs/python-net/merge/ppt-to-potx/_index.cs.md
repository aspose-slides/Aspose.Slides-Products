---
title: Sloučit soubory PPT do POTX pomocí Pythonu
url: /cs/python-net/merge/ppt-to-potx/
keywords: Sloučit PPT do POTX, připojit PPT do POTX, kombinovat PPT do POTX, PowerPoint, Presentation, POTX, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Sloučit soubory PPT do POTX dohromady v Pythonu" h2="Vysokorychlostní a multiplatformní Python API, které pomáhá při vývoji aplikací se schopností vytvářet, slučovat, kontrolovat nebo převádět prezentační soubory Microsoft PowerPoint a OpenOffice bez použití jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Sloučit PPT do POTX v Pythonu" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit soubory PPT do POTX pomocí Pythonu" %}}
Chcete-li sloučit prezentace PowerPoint, budete muset naklonovat snímky z jedné prezentace do druhé.

{{% blocks/products/pf/agp/code-block title="Python kód pro sloučení více PPT do jednoho souboru POTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak sloučit PPT do POTX pomocí Aspose.Slides pro Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky ke sloučení dvou souborů PPT a uložení výsledku jako POTX v Pythonu." >}}
