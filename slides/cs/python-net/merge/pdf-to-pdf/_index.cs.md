---
title: Sloučit soubory PDF v Pythonu
url: /cs/python-net/merge/pdf-to-pdf/
keywords: Sloučit PDF, PDF do PDF, Připojit PDF, Kombinovat PDF, Python API, Python Library
description: Sloučit PDF do PDF v Pythonu. Ke kombinování souborů PDF použijte rozhraní API knihovny Python
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Sloučit PDF v Pythonu" h2="Vysokorychlostní a multiplatformní knihovna Python pro slučování souborů PDF pomocí kódu Python" >}}

{{% blocks/products/pf/feature-page-section h2="Sloučit PDF do PDF pomocí Aspose.Slides" %}}

[**Aspose.Slides pro Python přes .NET**](https://products.aspose.com/slides/cs/python-net/) je výkonná knihovna Pythonu používaná k vytváření, převodu, slučování a manipulaci s prezentacemi a soubory PDF a další dokumenty. Když sloučíte PDF do PDF, efektivně kombinujete stránky ze 2 dokumentů a získáte jeden soubor PDF. Aspose.Slides umožňuje sloučit soubory PDF různými způsoby. Můžete sloučit soubory PDF se všemi jejich tvary, styly, texty, formátováním atd.
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit PDF do PDF v Pythonu" %}}
Pomocí [**Aspose.Slides pro Python přes .NET**](https://products.aspose.com/slides/cs/python-net/) můžete rychle sloučit soubory PDF pomocí několika řádků kódu

{{% blocks/products/pf/agp/code-block title="Python kód pro sloučení PDF do PDF" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="Jak sloučit PDF v Pythonu" >}}
