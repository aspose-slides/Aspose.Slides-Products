---
title: Sloučit TIFF do PDF v Pythonu
url: /cs/python-net/merge/tiff-to-pdf/
keywords: TIFF do PDF, Sloučit TIFF do PDF, Připojit TIFF k PDF, PDF, TIFF, Python API, Python Library
description: Sloučit TIFF do PDF v Pythonu. Ke kombinaci TIFF a PDF použijte API knihovny Python
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Sloučit TIFF do PDF v Pythonu" h2="Vysokorychlostní a multiplatformní knihovna Pythonu pro slučování souborů TIFF do souborů PDF pomocí kódu Python" >}}

{{% blocks/products/pf/feature-page-section h2="Sloučit TIFF do PDF pomocí Aspose.Slides" %}}

[**Aspose.Slides pro Python přes .NET**](https://products.aspose.com/slides/cs/python-net/) je výkonná knihovna Pythonu používaná k vytváření, převodu, slučování a manipulaci s prezentacemi a soubory PDF , obrázky a další soubory. Když sloučíte TIFF do PDF, efektivně kombinujete obrázky a získáte jeden soubor PDF.
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit TIFF do PDF v Pythonu" %}}
Pomocí [**Aspose.Slides pro Python přes .NET**](https://products.aspose.com/slides/cs/python-net/) můžete rychle sloučit TIFF do PDF pomocí několika řádků kódu

{{% blocks/products/pf/agp/code-block title="Python kód pro sloučení TIFF do PDF" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="Jak sloučit TIFF do PDF v Pythonu" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Načtěte soubory TIFF, které chcete sloučit jako rámečky obrázků.
{{< /blocks/products/pf/agp/step-autogen >}}
