---
title: Sloučit soubory PPTX do JPG pomocí Pythonu
url: /cs/python-net/merge/pptx-to-jpg/
keywords: Sloučit PPTX do JPG, připojit PPTX do JPG, kombinovat PPTX do JPG, PowerPoint, Presentation, JPG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit soubory PPTX do JPG pomocí Pythonu" %}}
Chcete-li sloučit prezentace PowerPoint, budete muset naklonovat snímky z jedné prezentace do druhé.

{{% blocks/products/pf/agp/code-block title="Python kód pro sloučení více PPTX do jednoho souboru JPG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak sloučit PPTX do JPG pomocí Aspose.Slides pro Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky ke sloučení dvou souborů PPTX a uložení výsledku jako JPG v Pythonu." >}}
