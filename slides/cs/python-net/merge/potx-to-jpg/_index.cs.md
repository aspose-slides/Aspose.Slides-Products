---
title: Sloučit soubory POTX do JPG pomocí Pythonu
url: /cs/python-net/merge/potx-to-jpg/
keywords: Sloučit POTX do JPG, připojit POTX do JPG, kombinovat POTX do JPG, PowerPoint, Presentation, JPG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit soubory POTX do JPG pomocí Pythonu" %}}
Chcete-li sloučit prezentace PowerPoint, budete muset naklonovat snímky z jedné prezentace do druhé.

{{% blocks/products/pf/agp/code-block title="Python kód pro sloučení více POTX do jednoho souboru JPG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak sloučit POTX do JPG pomocí Aspose.Slides pro Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky ke sloučení dvou souborů POTX a uložení výsledku jako JPG v Pythonu." >}}
