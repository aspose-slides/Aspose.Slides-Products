---
title: Sloučit soubory PPTX do PPSX pomocí Pythonu
url: /cs/python-net/merge/pptx-to-ppsx/
keywords: Sloučit PPTX do PPSX, připojit PPTX do PPSX, kombinovat PPTX do PPSX, PowerPoint, Presentation, PPSX, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Sloučit soubory PPTX do PPSX dohromady v Pythonu" h2="Vysokorychlostní a multiplatformní Python API, které pomáhá při vývoji aplikací se schopností vytvářet, slučovat, kontrolovat nebo převádět prezentační soubory Microsoft PowerPoint a OpenOffice bez použití jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Sloučit PPTX do PPSX v Pythonu" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit soubory PPTX do PPSX pomocí Pythonu" %}}
Chcete-li sloučit prezentace PowerPoint, budete muset naklonovat snímky z jedné prezentace do druhé.

{{% blocks/products/pf/agp/code-block title="Python kód pro sloučení více PPTX do jednoho souboru PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak sloučit PPTX do PPSX pomocí Aspose.Slides pro Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky ke sloučení dvou souborů PPTX a uložení výsledku jako PPSX v Pythonu." >}}
