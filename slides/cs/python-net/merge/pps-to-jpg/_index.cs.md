---
title: Sloučit soubory PPS do JPG pomocí Pythonu
url: /cs/python-net/merge/pps-to-jpg/
keywords: Sloučit PPS do JPG, připojit PPS do JPG, kombinovat PPS do JPG, PowerPoint, Presentation, JPG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit soubory PPS do JPG pomocí Pythonu" %}}
Chcete-li sloučit prezentace PowerPoint, budete muset naklonovat snímky z jedné prezentace do druhé.

{{% blocks/products/pf/agp/code-block title="Python kód pro sloučení více PPS do jednoho souboru JPG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak sloučit PPS do JPG pomocí Aspose.Slides pro Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky ke sloučení dvou souborů PPS a uložení výsledku jako JPG v Pythonu." >}}
