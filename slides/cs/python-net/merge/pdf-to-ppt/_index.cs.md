---
title: Sloučit soubory PDF do PPT pomocí Pythonu
url: /cs/python-net/merge/pdf-to-ppt/
keywords: Sloučit PDF do PPT, připojit PDF do PPT, kombinovat PDF do PPT, PowerPoint, Presentation, PPT, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Sloučit soubory PDF do PPT dohromady v Pythonu" h2="Vysokorychlostní a multiplatformní Python API, které pomáhá při vývoji aplikací se schopností vytvářet, slučovat, kontrolovat nebo převádět prezentační soubory Microsoft PowerPoint a OpenOffice bez použití jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Sloučit PDF do PPT v Pythonu" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit soubory PDF do PPT pomocí Pythonu" %}}
Chcete-li sloučit prezentace PowerPoint, budete muset naklonovat snímky z jedné prezentace do druhé.

{{% blocks/products/pf/agp/code-block title="Python kód pro sloučení více PDF do jednoho souboru PPT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak sloučit PDF do PPT pomocí Aspose.Slides pro Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky ke sloučení dvou souborů PDF a uložení výsledku jako PPT v Pythonu." >}}
