---
title: Sloučit soubory PDF do JPG pomocí Pythonu
url: /cs/python-net/merge/pdf-to-jpg/
keywords: Sloučit PDF do JPG, připojit PDF do JPG, kombinovat PDF do JPG, PowerPoint, Presentation, JPG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit soubory PDF do JPG pomocí Pythonu" %}}
Chcete-li sloučit prezentace PowerPoint, budete muset naklonovat snímky z jedné prezentace do druhé.

{{% blocks/products/pf/agp/code-block title="Python kód pro sloučení více PDF do jednoho souboru JPG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak sloučit PDF do JPG pomocí Aspose.Slides pro Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky ke sloučení dvou souborů PDF a uložení výsledku jako JPG v Pythonu." >}}
