---
title: Sloučit soubory PPSM do BMP pomocí Pythonu
url: /cs/python-net/merge/ppsm-to-bmp/
keywords: Sloučit PPSM do BMP, připojit PPSM do BMP, kombinovat PPSM do BMP, PowerPoint, Presentation, BMP, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Sloučit soubory PPSM do BMP dohromady v Pythonu" h2="Vysokorychlostní a multiplatformní Python API, které pomáhá při vývoji aplikací se schopností vytvářet, slučovat, kontrolovat nebo převádět prezentační soubory Microsoft PowerPoint a OpenOffice bez použití jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Sloučit PPSM do BMP v Pythonu" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit soubory PPSM do BMP pomocí Pythonu" %}}
Chcete-li sloučit prezentace PowerPoint, budete muset naklonovat snímky z jedné prezentace do druhé.

{{% blocks/products/pf/agp/code-block title="Python kód pro sloučení více PPSM do jednoho souboru BMP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak sloučit PPSM do BMP pomocí Aspose.Slides pro Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky ke sloučení dvou souborů PPSM a uložení výsledku jako BMP v Pythonu." >}}
