---
title: Vyhledejte a nahraďte text v dokumentu PPT pomocí Java
weight: 3270
url: /cs/java/redaction/ppt/ 
description: Ukázkový kód Java pro redigování citlivých informací v souboru PPT v prostředí Java Runtime Environment pro aplikace a desktopové aplikace JSP/JSF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Upravte formáty PPT v Javě" h2="Nativní a vysoce výkonné PPT dokumenty citlivé redakční informace pomocí serveru Aspose.Slides pro Java API, bez použití jakéhokoli softwaru, jako je Microsoft nebo Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/code-block title="Úprava souborů PPT - Java" offSpacer="" %}}
