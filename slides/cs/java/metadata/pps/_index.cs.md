---
title: Upravujte nebo zobrazujte metadata souborů PPS prostřednictvím Java
weight: 8790
url: /cs/java/metadata/pps/ 
description: Ukázkový kód Java pro úpravu nebo zobrazení metadat formátu PPS v prostředí Java Runtime Environment pro aplikace a desktopové aplikace JSP/JSF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extrahujte PPS metadata přes Java" h2="Sestavte si své vlastní Java aplikace pro přidávání, úpravy, odstraňování nebo extrahování metadat ze souborů PPS pomocí rozhraní API na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPS" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak extrahovat PPS metadata pomocí Java" %}}

 Abychom získali metadata souboru PPS, použijeme
...
{{< blocks/products/pf/agp/feature-section-col title="Kroky k extrahování metadat PPS přes Java" >}}
...
Získejte informace o PPS pomocí getPresentationInfo()
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Aktualizujte a zapište informace o PPS s novými vlastnostmi
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Extrahujte metadata PPS - Java" offSpacer="" %}}
