---
title: Upravujte nebo zobrazujte metadata souborů POTX prostřednictvím Java
weight: 6630
url: /cs/java/metadata/potx/ 
description: Ukázkový kód Java pro úpravu nebo zobrazení metadat formátu POTX v prostředí Java Runtime Environment pro aplikace JSP/JSF a desktopové aplikace.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extrahujte metadata POTX přes Java" h2="Sestavte si své vlastní Java aplikace pro přidávání, úpravu, odstraňování nebo extrahování metadat ze souborů POTX pomocí rozhraní API na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTX" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak extrahovat metadata POTX pomocí Java" %}}

 Abychom získali metadata souboru POTX, použijeme
...
{{< blocks/products/pf/agp/feature-section-col title="Kroky k extrahování metadat POTX přes Java" >}}
...
Získejte informace o POTX pomocí getPresentationInfo()
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Aktualizujte a zapisujte informace POTX s novými vlastnostmi
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Extrahujte metadata POTX - Java" offSpacer="" %}}
