---
title: Upravujte nebo zobrazujte metadata souborů PPSX přes Java
weight: 3170
url: /cs/java/metadata/ppsx/ 
description: Ukázkový kód Java pro úpravu nebo zobrazení metadat formátu PPSX v prostředí Java Runtime Environment pro aplikace a desktopové aplikace JSP/JSF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extrahujte PPSX metadata přes Java" h2="Sestavte si své vlastní Java aplikace pro přidávání, úpravy, odstraňování nebo extrahování metadat ze souborů PPSX pomocí rozhraní API na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSX" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak extrahovat PPSX metadata pomocí Java" %}}

 Abychom získali metadata souboru PPSX, použijeme
...
{{< blocks/products/pf/agp/feature-section-col title="Kroky k extrahování metadat PPSX přes Java" >}}
...
Získejte informace PPSX pomocí getPresentationInfo()
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Aktualizujte a zapisujte informace PPSX s novými vlastnostmi
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Extrahujte metadata PPSX - Java" offSpacer="" %}}
