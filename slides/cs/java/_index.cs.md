...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Pokročilé funkce API pro zpracování dokumentů Java PowerPoint</h2>

<p>Aspose.Slides for Java obsahuje řadu pokročilých funkcí, které poskytují vývojářům úplnou kontrolu při programování s prezentacemi Microsoft PowerPoint v prostředí Java.</p>-->
   <h2 class="pr-ft">
...
<h2 class="h2title">Formátování obsahu snímků</h2>

<p>Pomocí Aspose.Slides for Java API je možné formátovat text a tvary na snímcích v prezentaci. Text je spravován pomocí textových rámečků spojených s tvary. Text je tedy formátován pomocí odstavců a částí spojených s textovými rámečky. Můžete také manipulovat s atributy prvku tvaru, jako je poloha, velikost, čára, obrázek, text a výplň.</p>
...
{{< blocks/products/pf/slr-element name="Poznámky k vydání" href="https://docs.aspose.com/slides/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
