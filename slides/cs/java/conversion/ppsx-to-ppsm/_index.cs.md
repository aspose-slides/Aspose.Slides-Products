...
title: Převeďte PPSX na PPSM přes Java
weight: 6030
url: /cs/java/conversion/ppsx-to-ppsm/ 
description: Ukázkový konverzní kód Java pro formát PPSX na soubor PPSM. Tento příklad kódu použijte k exportu prezentací PowerPoint a OpenOffice do PPSM v rámci jakékoli webové nebo desktopové Java aplikace.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte PPSX na PPSM přes Java" h2="Konverze PPSX na PPSM Java pro převod jedné nebo více stránek na PPSM pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést PPSX na PPSM pomocí Java" %}}

 K vykreslení PPSX na PPSM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu PPSX na PPSM přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor PPSX na PPSM pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze PPSX na PPSM Java" offSpacer="" %}}
