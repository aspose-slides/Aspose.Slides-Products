---
title: Převést OTP na POT přes Java
weight: 8770
url: /cs/java/conversion/otp-to-pot/ 
description: Ukázkový konverzní kód Java pro formát OTP do souboru POT. Tento příklad kódu použijte k exportu prezentací PowerPoint a OpenOffice do POT v rámci jakékoli webové nebo desktopové Java aplikace.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést OTP na POT přes Java" h2="Konverze OTP na POT Java pro převod jedné nebo více stránek na POT pomocí On-premise Java knihovny." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="POT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTP" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod OTP na POT přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor OTP na POT pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze OTP na POT Java" offSpacer="" %}}
