...
title: Převést PPS na PPTX přes Java
weight: 7840
url: /cs/java/conversion/pps-to-pptx/ 
description: Ukázkový konverzní kód Java pro formát PPS na soubor PPTX. Tento ukázkový kód použijte k exportu prezentací PowerPoint a OpenOffice do PPTX v jakékoli webové nebo desktopové Java aplikaci.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést PPS na PPTX přes Java" h2="Konverze PPS na PPTX Java pro převod jedné nebo více stránek na PPTX pomocí On-premise Java knihovny." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést PPS na PPTX pomocí Java" %}}

 K vykreslení PPS na PPTX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu PPS na PPTX přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor PPS na PPTX pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze Java PPS na PPTX" offSpacer="" %}}
