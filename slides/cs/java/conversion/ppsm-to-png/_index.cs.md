...
title: Převést PPSM na PNG přes Java
weight: 8170
url: /cs/java/conversion/ppsm-to-png/ 
description: Ukázkový konverzní kód Java pro formát PPSM na soubor PNG. Tento příklad kódu použijte k exportu prezentací PowerPoint a OpenOffice do formátu PNG v jakékoli webové nebo desktopové aplikaci založené na Javě.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést PPSM na PNG přes Java" h2="Konverze PPSM na PNG Java pro převod jedné nebo více stránek na PNG pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést PPSM na PNG pomocí Java" %}}

 K vykreslení PPSM do PNG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod PPSM na PNG přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor PPSM na PNG pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze PPSM na PNG Java" offSpacer="" %}}
