---
title: Převeďte PPSM na JPEG přes Java
weight: 5070
url: /cs/java/conversion/ppsm-to-jpeg/ 
description: Ukázkový konverzní kód Java pro formát PPSM na soubor JPEG. Tento příklad kódu použijte k exportu prezentací PowerPoint a OpenOffice do formátu JPEG v jakékoli webové nebo desktopové aplikaci založené na Javě.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte PPSM na JPEG přes Java" h2="Konverze PPSM na JPEG Java pro převod jedné nebo více stránek na JPEG pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést PPSM na JPEG pomocí Java" %}}

 K vykreslení PPSM do JPEG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod PPSM na JPEG přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor PPSM na JPEG pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze PPSM na JPEG Java" offSpacer="" %}}
