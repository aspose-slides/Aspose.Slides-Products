---
title: Převést PPSX na PPT přes Java
weight: 8690
url: /cs/java/conversion/ppsx-to-ppt/ 
description: Ukázkový konverzní kód Java pro formát PPSX na soubor PPT. Tento vzorový kód použijte k exportu prezentací PowerPoint a OpenOffice do PPT v rámci jakékoli webové nebo desktopové Java aplikace.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést PPSX na PPT přes Java" h2="PPSX to PPT Java konverze pro převod jedné nebo více stránek na PPT pomocí On-premise Java knihovny." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést PPSX na PPT pomocí Java" %}}

 K vykreslení PPSX na PPT použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu PPSX na PPT přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor PPSX na PPT pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze PPSX na PPT Java" offSpacer="" %}}
