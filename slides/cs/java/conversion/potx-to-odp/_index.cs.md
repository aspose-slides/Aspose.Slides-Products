...
{{% blocks/products/pf/agp/content h2="Jak převést POTX na ODP pomocí Java" %}}

 K vykreslení POTX na ODP použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu POTX na ODP přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor POTX na ODP v několika řádcích kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze Java na POTX na ODP" offSpacer="" %}}
