...
title: Převést PPSX na GIF přes Java
weight: 5090
url: /cs/java/conversion/ppsx-to-gif/ 
description: Ukázka převodního kódu Java pro formát PPSX na soubor GIF. Tento příklad kódu použijte k exportu prezentací PowerPoint a OpenOffice do formátu GIF v jakékoli webové nebo desktopové aplikaci založené na Javě.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést PPSX na GIF přes Java" h2="Konverze PPSX na GIF Java pro převod jedné nebo více stránek na GIF pomocí On-premise Java knihovny." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést PPSX na GIF pomocí Java" %}}

 K vykreslení PPSX na GIF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu PPSX na GIF přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor PPSX na GIF pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze PPSX na GIF Java" offSpacer="" %}}
