...
{{% blocks/products/pf/agp/content h2="Jak převést ODP na PPS pomocí Java" %}}

 K převedení ODP na PPS použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod ODP na PPS přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor ODP na PPS pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze ODP na PPS Java" offSpacer="" %}}
