---
title: Převést PPSX na PNG přes Java
weight: 2750
url: /cs/java/conversion/ppsx-to-png/ 
description: Ukázka převodního kódu Java pro formát PPSX na soubor PNG. Tento příklad kódu použijte k exportu prezentací PowerPoint a OpenOffice do formátu PNG v jakékoli webové nebo desktopové aplikaci založené na Javě.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést PPSX na PNG přes Java" h2="PPSX to PNG Java konverze pro převod jedné nebo více stránek do PNG pomocí On-premise Java knihovny." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést PPSX na PNG pomocí Java" %}}

 K vykreslení PPSX do PNG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu PPSX na PNG přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor PPSX na PNG pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze PPSX na PNG Java" offSpacer="" %}}
