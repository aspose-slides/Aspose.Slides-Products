...
title: Převést ODP na PPTX přes Java
weight: 5710
url: /cs/java/conversion/odp-to-pptx/ 
description: Ukázkový konverzní kód Java pro formát ODP na soubor PPTX. Tento příklad kódu použijte k exportu prezentací PowerPoint a OpenOffice do PPTX v jakékoli webové nebo desktopové Java aplikaci.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést ODP na PPTX přes Java" h2="Konverze ODP na PPTX Java pro převod jedné nebo více stránek na PPTX pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést ODP na PPTX pomocí Java" %}}

 K vykreslení ODP na PPTX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod ODP na PPTX přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor ODP na PPTX pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze ODP na PPTX Java" offSpacer="" %}}
