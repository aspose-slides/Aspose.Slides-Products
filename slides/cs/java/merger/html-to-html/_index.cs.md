---
title: Sloučit HTML soubory v Javě
url: /cs/java/merger/html-to-html/
keywords: Merge HTML, HTML to HTML, Join HTML, Combine HTML, Java API, Java Library
description: Sloučit HTML do HTML v Javě. Ke kombinování souborů HTML použijte API knihovny Java
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Sloučit HTML v Javě" h2="Vysokorychlostní a multiplatformní Java knihovna pro slučování HTML souborů pomocí Java kódu" >}}

{{% blocks/products/pf/feature-page-section h2="Sloučit HTML do HTML pomocí Aspose.Slides" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/cs/java/) je výkonná Java knihovna, která se používá k vytváření, převodu, slučování a manipulaci s prezentacemi, soubory HTML a dalšími dokumenty. . Když sloučíte HTML do HTML, efektivně kombinujete obsah ze 2 dokumentů a získáte jeden soubor HTML. Aspose.Slides umožňuje sloučit dokumenty HTML různými způsoby. Můžete sloučit HTML se všemi jejich texty, formátováním, styly atd.
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit HTML do HTML v Javě" %}}
Pomocí [**Aspose.Slides for Java**](https://products.aspose.com/slides/cs/java/) můžete rychle sloučit soubory HTML pomocí několika řádků kódu

{{% blocks/products/pf/agp/code-block title="Java kód pro sloučení HTML do HTML" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Jak sloučit HTML v Javě" >}}
