---
title: Sloučit JPG do PDF v Javě
url: /cs/java/merger/jpg-to-pdf/
keywords: JPG do PDF, Sloučit JPG do PDF, Spojit JPG do PDF, PDF, JPG, Java API, Java Library
description: Sloučit JPG do PDF v Javě. Ke kombinaci JPG a PDF použijte API knihovny Java
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Sloučit JPG do PDF v Javě" h2="Vysokorychlostní a multiplatformní Java knihovna pro slučování souborů JPG do PDF pomocí kódu Java" >}}

{{% blocks/products/pf/feature-page-section h2="Sloučit JPG do PDF pomocí Aspose.Slides" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/cs/java/) je výkonná knihovna Java, která se používá k vytváření, převodu, slučování a manipulaci s prezentacemi, soubory PDF, obrázky a dalšími soubory. Když sloučíte JPG do PDF, efektivně kombinujete obrázky JPG a získáte jeden soubor PDF.
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit JPG do PDF v Javě" %}}
Pomocí [**Aspose.Slides for Java**](https://products.aspose.com/slides/cs/java/) můžete rychle sloučit JPG do PDF pomocí několika řádků kódu

{{% blocks/products/pf/agp/code-block title="Java kód pro sloučení JPG do PDF" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Jak sloučit JPG do PDF v Javě" >}}
