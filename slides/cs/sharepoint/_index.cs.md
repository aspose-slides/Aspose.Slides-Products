...
weight: 910
url: /cs/sharepoint/ 
description: SharePoint PowerPoint je Aspose.Slides SharePoint pro vytváření a převod SharePoint PPT, SharePoint slideshow, SharePointových prezentací.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Řešení SharePoint PowerPoint" h2="Spravujte a převádějte PowerPointové prezentace na SharePointu." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-sharepoint.svg" pfName="Aspose.Slides" subTitlepfName="for SharePoint" downloadUrl="https://downloads.aspose.com/slides/sharepoint" >}}
...
<p>
 Aspose.Slides pro SharePoint pro správu a převod souborů PowerPoint v SharePointu. Aspose.Slides, jako řešení SharePoint PowerPoint, může snadno importovat běžné prezentační formáty společnosti Microsoft včetně PPT, POT, PPS, PPTX, POTX & PPSX a může tyto formáty exportovat do souborů PDF, TIFF a XPS. Používejte všechny funkce SharePoint PPT bez nutnosti automatizace aplikace Microsoft PowerPoint.
</p>

<p>
 Aspose.Slides for SharePoint funguje se službou Windows SharePoint Services WSS 3.0 a Microsoft Office SharePoint Server 2007, 2010 a 2013.
</p>
...
{{< blocks/products/pf/carousel-item h3="Na první pohled" description="Přehled Aspose.Slides pro SharePoint" >}}
...
{{< blocks/products/pf/carousel-item h3="Nezávislost na platformě" description="Aspose.Slides for SharePoint pracuje s Microsoft Office SharePoint Server a Windows SharePoint Services." >}}
<div class="diagram1 d1-sharepoint">
 <div class="d1-row">
  <div class="d1-col d1-left">
...
{{< blocks/products/pf/carousel-item h3="Podporované formáty souborů" description="Aspose.Slides for SharePoint podporuje většinu běžných prezentačních [formátů souborů](https://docs.aspose.com/slides/sharepoint/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Funkce aplikace pro převod prezentací SharePoint
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Převeďte soubory PowerPoint z knihovny dokumentů SharePoint
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Získejte výchozí pozadí tabulky
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Velikost představuje vlastnost bublinového grafu
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Skrytí levého panelu miniatur snímků ve vygenerovaném PPT
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Podporovány externí sešity Excelu
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Omezení přístupu k místnímu systému souborů při otevírání dokumentu
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Převeďte PowerPointové prezentace do několika formátů
    </h2>
    <p>
     Aspose.Slides pro SharePoint převádí prezentace z vaší knihovny dokumentů SharePoint do mnoha oblíbených formátů pro výměnu dokumentů. Aspose.Slides for SharePoint podporuje běžné prezentační formáty jako vstupní formáty a umí exportovat do prezentačních formátů, stejně jako PDF, TIFF a XPS.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Snadná a lehká instalace
    </h2>
    <p>
     Aspose.Slides pro SharePoint je k dispozici jako archiv ZIP. Rozbalte soubor ZIP na místní disk na serveru MOSS 7.0 nebo WSS 3.0 a spusťte soubor setup.exe, abyste jej mohli použít. Je to tak snadné!
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for SharePoint je vytvořen pomocí spravovaného kódu, který pro práci s převodem formátů dokumentů PowerPoint nikdy nevyžaduje instalaci aplikace Microsoft PowerPoint do počítače. Jedná se o dokonalou automatizační alternativu Microsoft PowerPoint z hlediska podporovaných funkcí, zabezpečení, stability, škálovatelnosti, rychlosti a ceny.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Dokumentace" href="https://docs.aspose.com/slides/sharepoint/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Proč Aspose.Slides pro SharePoint?" tabId="success-stories" >}}
