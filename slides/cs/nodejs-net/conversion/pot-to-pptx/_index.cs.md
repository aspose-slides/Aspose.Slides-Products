---
title: Převeďte POT do PPTX v JavaScriptu
url: /cs/nodejs-net/conversion/pot-to-pptx/
keywords: POT do PPTX, Převést POT do PPTX, Node.js API, JavaScript Library, POT, PPTX
description: Převeďte POT do PPTX v JavaScriptu. Pomocí rozhraní API knihovny Node.js převeďte soubory POT na PPTX
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Převeďte POT do PPTX v JavaScriptu" h2="Aspose.Slides for Node.js přes .NET je výkonná a snadno použitelná knihovna, která vám umožňuje převádět PowerPointové prezentace do různých formátů v JavaScriptu. Podporuje všechny prezentační prvky a formáty a poskytuje bohaté API pro přístup a úpravu. Umožňuje také exportovat snímky do různých formátů pro další zpracování nebo sdílení." >}}

{{% blocks/products/pf/feature-page-section h2="Převeďte POT na PPTX v Node.js" %}}

[**Aspose.Slides pro Node.js přes .NET**](https://products.aspose.com/slides/cs/nodejs-net/) je výkonná knihovna Node.js pro vytváření a manipulaci s prezentačními soubory. Navíc poskytuje flexibilní způsoby převodu POT do PPTX. Pomocí **Aspose.Slides for Node.js přes .NET** může každý vývojář nebo aplikace převést soubory POT do PPTX pomocí několika řádků kódu.

Aspose.Slides pro Node.js přes .NET jako moderní API pro zpracování dokumentů rychle exportuje soubory POT do formátů souborů PPTX. Knihovna Aspose PowerPoint vám umožňuje převést POT do PPTXs a mnoho dalších formátů souborů

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Převeďte POT do PPTX pomocí JavaScriptu" %}}
Chcete-li převést POT do PPTX, budete muset vytvořit prezentaci ze souboru POT a uložit ji jako PPTX.

{{% blocks/products/pf/agp/code-block title="JavaScript kód pro převod POT do PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak převést POT do PPTX pomocí Aspose.Slides pro Node.js přes .NET API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Chcete-li převést POT na PPTX pomocí Aspose.Slides for Node.js přes .NET, musíte importovat balíček do souboru JavaScript a vytvořit instanci třídy Presentation. Třída Prezentace představuje dokument PowerPoint a poskytuje metody pro přístup a manipulaci s jeho prvky." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/cs/nodejs-net/conversion/pot-to-png/" name="POT TO PNG" >}}
