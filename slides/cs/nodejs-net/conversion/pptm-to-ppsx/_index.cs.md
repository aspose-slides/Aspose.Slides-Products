---
title: Převeďte PPTM do PPSX v JavaScriptu
url: /cs/nodejs-net/conversion/pptm-to-ppsx/
keywords: PPTM do PPSX, Převést PPTM do PPSX, Node.js API, JavaScript Library, PPTM, PPSX
description: Převeďte PPTM do PPSX v JavaScriptu. Pomocí rozhraní API knihovny Node.js převeďte soubory PPTM na PPSX
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Převeďte PPTM do PPSX v JavaScriptu" h2="Aspose.Slides for Node.js přes .NET je výkonná a snadno použitelná knihovna, která vám umožňuje převádět PowerPointové prezentace do různých formátů v JavaScriptu. Podporuje všechny prezentační prvky a formáty a poskytuje bohaté API pro přístup a úpravu. Umožňuje také exportovat snímky do různých formátů pro další zpracování nebo sdílení." >}}

{{% blocks/products/pf/feature-page-section h2="Převeďte PPTM na PPSX v Node.js" %}}

[**Aspose.Slides pro Node.js přes .NET**](https://products.aspose.com/slides/cs/nodejs-net/) je výkonná knihovna Node.js pro vytváření a manipulaci s prezentačními soubory. Navíc poskytuje flexibilní způsoby převodu PPTM do PPSX. Pomocí **Aspose.Slides for Node.js přes .NET** může každý vývojář nebo aplikace převést soubory PPTM do PPSX pomocí několika řádků kódu.

Aspose.Slides pro Node.js přes .NET jako moderní API pro zpracování dokumentů rychle exportuje soubory PPTM do formátů souborů PPSX. Knihovna Aspose PowerPoint vám umožňuje převést PPTM do PPSXs a mnoho dalších formátů souborů

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Převeďte PPTM do PPSX pomocí JavaScriptu" %}}
Chcete-li převést PPTM do PPSX, budete muset vytvořit prezentaci ze souboru PPTM a uložit ji jako PPSX.

{{% blocks/products/pf/agp/code-block title="JavaScript kód pro převod PPTM do PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak převést PPTM do PPSX pomocí Aspose.Slides pro Node.js přes .NET API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Chcete-li převést PPTM na PPSX pomocí Aspose.Slides for Node.js přes .NET, musíte importovat balíček do souboru JavaScript a vytvořit instanci třídy Presentation. Třída Prezentace představuje dokument PowerPoint a poskytuje metody pro přístup a manipulaci s jeho prvky." >}}
