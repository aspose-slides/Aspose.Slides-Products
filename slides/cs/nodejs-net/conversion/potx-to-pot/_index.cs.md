---
title: Převeďte POTX do POT v JavaScriptu
url: /cs/nodejs-net/conversion/potx-to-pot/
keywords: POTX do POT, Převést POTX do POT, Node.js API, JavaScript Library, POTX, POT
description: Převeďte POTX do POT v JavaScriptu. Pomocí rozhraní API knihovny Node.js převeďte soubory POTX na POT
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Převeďte POTX do POT v JavaScriptu" h2="Aspose.Slides for Node.js přes .NET je výkonná a snadno použitelná knihovna, která vám umožňuje převádět PowerPointové prezentace do různých formátů v JavaScriptu. Podporuje všechny prezentační prvky a formáty a poskytuje bohaté API pro přístup a úpravu. Umožňuje také exportovat snímky do různých formátů pro další zpracování nebo sdílení." >}}

{{% blocks/products/pf/feature-page-section h2="Převeďte POTX na POT v Node.js" %}}

[**Aspose.Slides pro Node.js přes .NET**](https://products.aspose.com/slides/cs/nodejs-net/) je výkonná knihovna Node.js pro vytváření a manipulaci s prezentačními soubory. Navíc poskytuje flexibilní způsoby převodu POTX do POT. Pomocí **Aspose.Slides for Node.js přes .NET** může každý vývojář nebo aplikace převést soubory POTX do POT pomocí několika řádků kódu.

Aspose.Slides pro Node.js přes .NET jako moderní API pro zpracování dokumentů rychle exportuje soubory POTX do formátů souborů POT. Knihovna Aspose PowerPoint vám umožňuje převést POTX do POTs a mnoho dalších formátů souborů

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Převeďte POTX do POT pomocí JavaScriptu" %}}
Chcete-li převést POTX do POT, budete muset vytvořit prezentaci ze souboru POTX a uložit ji jako POT.

{{% blocks/products/pf/agp/code-block title="JavaScript kód pro převod POTX do POT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak převést POTX do POT pomocí Aspose.Slides pro Node.js přes .NET API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Chcete-li převést POTX na POT pomocí Aspose.Slides for Node.js přes .NET, musíte importovat balíček do souboru JavaScript a vytvořit instanci třídy Presentation. Třída Prezentace představuje dokument PowerPoint a poskytuje metody pro přístup a manipulaci s jeho prvky." >}}
