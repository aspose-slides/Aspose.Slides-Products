---
title: Převeďte PDF do ODP v JavaScriptu
url: /cs/nodejs-net/conversion/pdf-to-odp/
keywords: PDF do ODP, Převést PDF do ODP, Node.js API, JavaScript Library, PDF, ODP
description: Převeďte PDF do ODP v JavaScriptu. Pomocí rozhraní API knihovny Node.js převeďte soubory PDF na ODP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Převeďte PDF do ODP v JavaScriptu" h2="Aspose.Slides for Node.js přes .NET je výkonná a snadno použitelná knihovna, která vám umožňuje převádět PowerPointové prezentace do různých formátů v JavaScriptu. Podporuje všechny prezentační prvky a formáty a poskytuje bohaté API pro přístup a úpravu. Umožňuje také exportovat snímky do různých formátů pro další zpracování nebo sdílení." >}}

{{% blocks/products/pf/feature-page-section h2="Převeďte PDF na ODP v Node.js" %}}

[**Aspose.Slides pro Node.js přes .NET**](https://products.aspose.com/slides/cs/nodejs-net/) je výkonná knihovna Node.js pro vytváření a manipulaci s prezentačními soubory. Navíc poskytuje flexibilní způsoby převodu PDF do ODP. Pomocí **Aspose.Slides for Node.js přes .NET** může každý vývojář nebo aplikace převést soubory PDF do ODP pomocí několika řádků kódu.

Aspose.Slides pro Node.js přes .NET jako moderní API pro zpracování dokumentů rychle exportuje soubory PDF do formátů souborů ODP. Knihovna Aspose PowerPoint vám umožňuje převést PDF do ODPs a mnoho dalších formátů souborů

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Převeďte PDF do ODP pomocí JavaScriptu" %}}
Chcete-li převést PDF do ODP, budete muset vytvořit prezentaci ze souboru PDF a uložit ji jako ODP.

{{% blocks/products/pf/agp/code-block title="JavaScript kód pro převod PDF do ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak převést PDF do ODP pomocí Aspose.Slides pro Node.js přes .NET API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Chcete-li převést PDF na ODP pomocí Aspose.Slides for Node.js přes .NET, musíte importovat balíček do souboru JavaScript a vytvořit instanci třídy Presentation. Třída Prezentace představuje dokument PowerPoint a poskytuje metody pro přístup a manipulaci s jeho prvky." >}}
