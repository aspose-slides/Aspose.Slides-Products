...
createEmptyPresentation(); // Execute the function to create an empty presentation
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Jak přidat/odebrat snímky a upravit vlastnosti tvaru v Node.js</h2>
...
function manipulatePresentation() {
   ...
   // Generate and save a thumbnail of the first slide
    ...
    <div class="col-lg-12">
        <h2 class="h2title">Jak převést PowerPoint do PDF, GIF nebo HTML v Node.js</h2>
...
{{< blocks/products/pf/offers-section pfName="Aspose.Slides" description="Aspose.Slides nabízí jednotlivá rozhraní PowerPoint API pro další populární vývojová prostředí, jak je uvedeno níže:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/slides/cs/android-.NET/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-android-.NET.svg" sdkName="Android via .NET" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/slides/cs/php-.NET/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-.NET.svg" sdkName="PHP via .NET" >}}
