...
title: Převeďte OTP do ODP v PHP
weight: 480
url: /cs/php-java/conversion/otp-to-odp/ 
keywords: "Convert, PowerPoint, OTP, ODP, Presentation, PHP"
description: Ukázkový kód pro konverzi PHP z OTP do ODP. Použijte PowerPoint PHP API pro dávkový převod souborů OTP na soubory ODP.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte OTP do ODP v PHP" h2="Výkonná PowerPoint PHP knihovna pro převod OTP do ODP" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Převeďte OTP do ODP v PHP" %}}

Potřebujete převést soubory OTP do ODP programově? Pomocí [*Aspose.Slides pro PHP přes Java*](https://products.aspose.com/slides/cs/php-java/) může každý vývojář převést OTP do formátu ODP pomocí několika řádků kódu PHP .

Aspose.Slides pro PHP jako moderní API pro zpracování prezentací rychle vytváří ODP z OTP. Otestujte kvalitu převodu OTP na ODP přímo ve svém [prohlížeči](https://products.aspose.app/slides/conversion). Knihovna Aspose PowerPoint PPTX vám umožňuje převádět soubory OTP do mnoha oblíbených formátů.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést OTP do ODP v PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky k převodu souboru OTP na ODP pomocí PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi PHP z OTP do ODP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Uložit OTP jako ODP v PHP" %}}
Použijte bezplatnou aplikaci a podívejte se na ukázku procesu převodu OTP do ODP. 
{{% /blocks/products/pf/agp/content %}}
