---
title: Převeďte PPTM do PDF v PHP
weight: 2390
url: /cs/php-java/conversion/pptm-to-pdf/ 
keywords: "Convert, PowerPoint, PPTM, PDF, Presentation, PHP"
description: Ukázkový kód pro konverzi PHP z PPTM do PDF. Použijte PowerPoint PHP API pro dávkový převod souborů PPTM na soubory PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte PPTM do PDF v PHP" h2="Výkonná PowerPoint PHP knihovna pro převod PPTM do PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Převeďte PPTM do PDF v PHP" %}}

Potřebujete převést soubory PPTM do PDF programově? Pomocí [*Aspose.Slides pro PHP přes Java*](https://products.aspose.com/slides/cs/php-java/) může každý vývojář převést PPTM do formátu PDF pomocí několika řádků kódu PHP .

Aspose.Slides pro PHP jako moderní API pro zpracování prezentací rychle vytváří PDF z PPTM. Otestujte kvalitu převodu PPTM na PDF přímo ve svém [prohlížeči](https://products.aspose.app/slides/conversion). Knihovna Aspose PowerPoint PPTX vám umožňuje převádět soubory PPTM do mnoha oblíbených formátů.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést PPTM do PDF v PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky k převodu souboru PPTM na PDF pomocí PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi PHP z PPTM do PDF" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Uložit PPTM jako PDF v PHP" %}}
Použijte bezplatnou aplikaci a podívejte se na ukázku procesu převodu PPTM do PDF. 
{{% /blocks/products/pf/agp/content %}}
