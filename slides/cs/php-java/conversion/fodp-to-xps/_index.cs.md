...
title: Převeďte FODP do XPS v PHP
weight: 210
url: /cs/php-java/conversion/fodp-to-xps/ 
keywords: "Convert, PowerPoint, FODP, XPS, Presentation, PHP"
description: Ukázkový kód pro konverzi PHP z FODP do XPS. Použijte PowerPoint PHP API pro dávkový převod souborů FODP na soubory XPS.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte FODP do XPS v PHP" h2="Výkonná PowerPoint PHP knihovna pro převod FODP do XPS" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Převeďte FODP do XPS v PHP" %}}

Potřebujete převést soubory FODP do XPS programově? Pomocí [*Aspose.Slides pro PHP přes Java*](https://products.aspose.com/slides/cs/php-java/) může každý vývojář převést FODP do formátu XPS pomocí několika řádků kódu PHP .

Aspose.Slides pro PHP jako moderní API pro zpracování prezentací rychle vytváří XPS z FODP. Otestujte kvalitu převodu FODP na XPS přímo ve svém [prohlížeči](https://products.aspose.app/slides/conversion). Knihovna Aspose PowerPoint PPTX vám umožňuje převádět soubory FODP do mnoha oblíbených formátů.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak převést FODP do XPS v PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Toto jsou kroky k převodu souboru FODP na XPS pomocí PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi PHP z FODP do XPS" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Uložit FODP jako XPS v PHP" %}}
Použijte bezplatnou aplikaci a podívejte se na ukázku procesu převodu FODP do XPS. 
{{% /blocks/products/pf/agp/content %}}
