---
title: Upravte OTP v PHP
url: /cs/php-java/editor/otp/
keywords: Upravit OTP, Upravit PowerPoint, OTP, PowerPoint, PHP API, PHP Library
description: Upravte OTP v PHP. K úpravě souborů OTP použijte API knihovny PHP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Upravte OTP v PHP" h2="Vysokorychlostní a multiplatformní PHP knihovna pro editaci OTP pomocí PHP kódu" >}}

{{% blocks/products/pf/feature-page-section h2="Upravte OTP pomocí Aspose.Slides" %}}

[**Aspose.Slides pro PHP přes Javu**](https://products.aspose.com/slides/cs/php-java/) je výkonná PHP knihovna používaná k manipulaci a úpravám prezentací. Prezentaci OTP můžete upravit přidáním nového řádku textu. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Upravte OTP v PHP" %}}
Pomocí [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/cs/php-java/) můžete přidat nový řádek textu do dokumentu OTP pouhým několik řádků kódu.

{{% blocks/products/pf/agp/code-block title="PHP kód pro úpravu OTP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak upravit OTP v PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Načtěte prezentaci OTP, kterou chcete upravit.
{{< /blocks/products/pf/agp/step-autogen >}}
