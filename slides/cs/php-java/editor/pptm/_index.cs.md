---
title: Upravte PPTM v PHP
url: /cs/php-java/editor/pptm/
keywords: Upravit PPTM, Upravit PowerPoint, PPTM, PowerPoint, PHP API, PHP Library
description: Upravte PPTM v PHP. K úpravě souborů PPTM použijte API knihovny PHP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Upravte PPTM v PHP" h2="Vysokorychlostní a multiplatformní PHP knihovna pro editaci PPTM pomocí PHP kódu" >}}

{{% blocks/products/pf/feature-page-section h2="Upravte PPTM pomocí Aspose.Slides" %}}

[**Aspose.Slides pro PHP přes Javu**](https://products.aspose.com/slides/cs/php-java/) je výkonná PHP knihovna používaná k manipulaci a úpravám prezentací. Prezentaci PPTM můžete upravit přidáním nového řádku textu. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Upravte PPTM v PHP" %}}
Pomocí [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/cs/php-java/) můžete přidat nový řádek textu do dokumentu PPTM pouhým několik řádků kódu.

{{% blocks/products/pf/agp/code-block title="PHP kód pro úpravu PPTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak upravit PPTM v PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Načtěte prezentaci PPTM, kterou chcete upravit.
{{< /blocks/products/pf/agp/step-autogen >}}
