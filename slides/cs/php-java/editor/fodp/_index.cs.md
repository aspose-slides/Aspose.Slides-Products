---
title: Upravte FODP v PHP
url: /cs/php-java/editor/fodp/
keywords: Upravit FODP, Upravit PowerPoint, FODP, PowerPoint, PHP API, PHP Library
description: Upravte FODP v PHP. K úpravě souborů FODP použijte API knihovny PHP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Upravte FODP v PHP" h2="Vysokorychlostní a multiplatformní PHP knihovna pro editaci FODP pomocí PHP kódu" >}}

{{% blocks/products/pf/feature-page-section h2="Upravte FODP pomocí Aspose.Slides" %}}

[**Aspose.Slides pro PHP přes Javu**](https://products.aspose.com/slides/cs/php-java/) je výkonná PHP knihovna používaná k manipulaci a úpravám prezentací. Prezentaci FODP můžete upravit přidáním nového řádku textu. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Upravte FODP v PHP" %}}
Pomocí [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/cs/php-java/) můžete přidat nový řádek textu do dokumentu FODP pouhým několik řádků kódu.

{{% blocks/products/pf/agp/code-block title="PHP kód pro úpravu FODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak upravit FODP v PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Načtěte prezentaci FODP, kterou chcete upravit.
{{< /blocks/products/pf/agp/step-autogen >}}
