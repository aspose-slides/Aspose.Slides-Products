---
title: Upravte PPSM v PHP
url: /cs/php-java/editor/ppsm/
keywords: Upravit PPSM, Upravit PowerPoint, PPSM, PowerPoint, PHP API, PHP Library
description: Upravte PPSM v PHP. K úpravě souborů PPSM použijte API knihovny PHP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Upravte PPSM v PHP" h2="Vysokorychlostní a multiplatformní PHP knihovna pro editaci PPSM pomocí PHP kódu" >}}

{{% blocks/products/pf/feature-page-section h2="Upravte PPSM pomocí Aspose.Slides" %}}

[**Aspose.Slides pro PHP přes Javu**](https://products.aspose.com/slides/cs/php-java/) je výkonná PHP knihovna používaná k manipulaci a úpravám prezentací. Prezentaci PPSM můžete upravit přidáním nového řádku textu. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Upravte PPSM v PHP" %}}
Pomocí [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/cs/php-java/) můžete přidat nový řádek textu do dokumentu PPSM pouhým několik řádků kódu.

{{% blocks/products/pf/agp/code-block title="PHP kód pro úpravu PPSM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak upravit PPSM v PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Načtěte prezentaci PPSM, kterou chcete upravit.
{{< /blocks/products/pf/agp/step-autogen >}}
