---
title: Upravte POTM v PHP
url: /cs/php-java/editor/potm/
keywords: Upravit POTM, Upravit PowerPoint, POTM, PowerPoint, PHP API, PHP Library
description: Upravte POTM v PHP. K úpravě souborů POTM použijte API knihovny PHP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Upravte POTM v PHP" h2="Vysokorychlostní a multiplatformní PHP knihovna pro editaci POTM pomocí PHP kódu" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Upravte POTM v PHP" %}}
Pomocí [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/cs/php-java/) můžete přidat nový řádek textu do dokumentu POTM pouhým několik řádků kódu.

{{% blocks/products/pf/agp/code-block title="PHP kód pro úpravu POTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak upravit POTM v PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Načtěte prezentaci POTM, kterou chcete upravit.
{{< /blocks/products/pf/agp/step-autogen >}}
