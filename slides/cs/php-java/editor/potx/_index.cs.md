---
title: Upravte POTX v PHP
url: /cs/php-java/editor/potx/
keywords: Upravit POTX, Upravit PowerPoint, POTX, PowerPoint, PHP API, PHP Library
description: Upravte POTX v PHP. K úpravě souborů POTX použijte API knihovny PHP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Upravte POTX v PHP" h2="Vysokorychlostní a multiplatformní PHP knihovna pro editaci POTX pomocí PHP kódu" >}}

{{% blocks/products/pf/feature-page-section h2="Upravte POTX pomocí Aspose.Slides" %}}

[**Aspose.Slides pro PHP přes Javu**](https://products.aspose.com/slides/cs/php-java/) je výkonná PHP knihovna používaná k manipulaci a úpravám prezentací. Prezentaci POTX můžete upravit přidáním nového řádku textu. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Upravte POTX v PHP" %}}
Pomocí [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/cs/php-java/) můžete přidat nový řádek textu do dokumentu POTX pouhým několik řádků kódu.

{{% blocks/products/pf/agp/code-block title="PHP kód pro úpravu POTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak upravit POTX v PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Načtěte prezentaci POTX, kterou chcete upravit.
{{< /blocks/products/pf/agp/step-autogen >}}
