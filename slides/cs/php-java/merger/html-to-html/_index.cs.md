---
title: Sloučit HTML soubory v PHP
url: /cs/php-java/merger/html-to-html/
keywords: Merge HTML, HTML to HTML, Join HTML, Combine HTML, PHP API, PHP Library
description: Sloučit HTML do HTML v PHP. Ke kombinování souborů HTML použijte API knihovny PHP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Sloučit HTML v PHP" h2="Vysokorychlostní a multiplatformní PHP knihovna pro slučování HTML souborů pomocí PHP kódu" >}}

{{% blocks/products/pf/feature-page-section h2="Sloučit HTML do HTML pomocí Aspose.Slides" %}}

[**Aspose.Slides pro PHP přes Javu**](https://products.aspose.com/slides/cs/php-java/) je výkonná PHP knihovna používaná k vytváření, převodu, slučování a manipulaci s prezentacemi, soubory HTML a další dokumenty. Když sloučíte HTML do HTML, efektivně kombinujete obsah ze 2 dokumentů a získáte jeden soubor HTML. Aspose.Slides umožňuje sloučit dokumenty HTML různými způsoby. Můžete sloučit HTML se všemi jejich texty, formátováním, styly atd.
...
{{% blocks/products/pf/feature-page-section  h2="Sloučit HTML do HTML v PHP" %}}
Pomocí [**Aspose.Slides for PHP přes Java**](https://products.aspose.com/slides/cs/php-java/) můžete rychle sloučit soubory HTML pomocí několika řádků kódu

{{% blocks/products/pf/agp/code-block title="PHP kód pro sloučení HTML do HTML" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Jak sloučit HTML v PHP" >}}
