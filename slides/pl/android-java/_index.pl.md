---
title: Interfejs API programu PowerPoint na Androida | Aspose.Slides dla Android API
weight: 5960
url: /pl/android-java/ 
description: Aspose.Slides dla Android API lub Android PowerPoint API do tworzenia odczytu i manipulowania PPT POT PPS PPTX POTX PPSX PowerPoint na Androida.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Interfejs API programu PowerPoint na Androida" h2="Twórz, modyfikuj, konwertuj, scalaj, dziel i zarządzaj prezentacjami PowerPoint w aplikacjach na Androida." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-android-java.svg" pfName="Aspose.Slides" subTitlepfName="for Android via Java" downloadUrl="https://downloads.aspose.com/slides/androidjava" >}}
...
<p>
 Aspose.Slides dla systemu Android przez Javę to interfejs API programu PowerPoint dla aplikacji na Androida. Programiści mogą wykonywać szeroki zakres zadań związanych z przetwarzaniem prezentacji, w tym czytać, pisać, modyfikować, scalać, dzielić, konwertować i manipulować prezentacjami bez jakiejkolwiek zależności od programu Microsoft PowerPoint.
</p>

<p>
 Aspose.Slides dla Androida za pośrednictwem Javy obsługuje prawie wszystkie natywne formaty plików PowerPoint, a także format prezentacji OpenOffice (ODP). Utwórz aplikację przeglądarki PowerPoint dla systemu Android, a także konwerter, edytor lub dowolną inną. Dostęp do elementów prezentacji, takich jak kształty SmartArt, wykresy MSO, składniki ActiveX i obiekty ramek OLE, można uzyskać za pośrednictwem interfejsu API programu PowerPoint w celu zarządzania i manipulacji.
</p>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Zaawansowane funkcje Androida PowerPoint API
   </h2>
   <p>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Twórz nowe slajdy lub klonuj z szablonów
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Dodaj lub usuń ochronę kształtów
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Dodaj wykresy Microsoft Excel jako OleObjects
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Importuj i eksportuj tekst HTML do slajdów
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Zarządzaj komponentami ActiveX i SmartArt
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Dodaj lub zmodyfikuj przejście pokazu slajdów
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Wektoryzuj kształty bez tekstu
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Renderuj obrazy SVG do kształtów
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Formatowanie prezentacji na poziomie minut
    </h2>
    <p>
     Biblioteka PowerPoint może z łatwością obsługiwać funkcje formatowania tekstu i kształtu, takie jak rozmiar czcionki, typ, kolor i odcienie, wyrównanie akapitów, punktory i orientacja oraz hiperłącza.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Konwersja prezentacji z notatkami
    </h2>
    <p>
     API zapewnia konwersję do formatu TIFF i PDF z notatkami. Programiści mogą konwertować całą prezentację w widoku Notes Slide do obsługiwanego formatu, a w przypadku obrazów można utworzyć miniaturę slajdów w widoku Notes Slide dla poszczególnych slajdów. Oto kod konwersji TIFF.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Konwertuj prezentacje za pomocą Notatek
     </h3>
...
pres.save(dataDir + "TestNotes.tiff", SaveFormat.Tiff,opts);
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Manipuluj elementami za pomocą publicznego interfejsu API
    </h2>
    <p>
     API może obsługiwać wszystkie elementy slajdów prezentacji, w tym prostokąt, tabelę, pole tekstowe, elipsę, polilinię, ramkę obrazu, auto-kształt, ramkę audio, ramkę obiektu OLE i ramkę wideo. API zapewnia również bogaty zestaw poleceń API do manipulowania każdym z tych elementów. Ponadto formatowanie tekstu jest obsługiwane przez dobrze zaprojektowany zestaw klas.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Dokumentacja" href="https://docs.aspose.com/slides/androidjava/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Dlaczego Aspose.Slides dla Androida przez Javę?" tabId="success-stories" >}}
