...
{{% blocks/products/pf/agp/code-block title="Zmodyfikuj wbudowane właściwości FODP – C#" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Dodaj niestandardowe właściwości do FODP – C#" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak wyodrębnić metadane FODP przez C#" >}}
