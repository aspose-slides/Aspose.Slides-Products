---
title: Scal TIFF do PDF w C#
url: /pl/net/merger/tiff-to-pdf/
keywords: TIFF do PDF, łączenie TIFF do PDF, dołączanie TIFF do PDF, PDF, TIFF, C# API, biblioteka .NET
description: Scal TIFF do PDF w C#. Użyj API biblioteki .NET, aby połączyć TIFF i PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Scal TIFF do PDF w C#" h2="Potężny, wieloplatformowy interfejs API platformy .NET do łączenia plików TIFF z plikami PDF przy użyciu kodu C# w platformach NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Połącz TIFF z PDF za pomocą Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/) to potężna biblioteka .NET używana do tworzenia, konwertowania, scalania i manipulowania prezentacjami, plikami PDF, obrazami, i inne pliki. Podczas scalania formatu TIFF z formatem PDF skutecznie łączysz obrazy w celu uzyskania pojedynczego pliku PDF.
...
{{% blocks/products/pf/feature-page-section  h2="Scal TIFF do PDF w C#" %}}
Korzystając z [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/), możesz szybko scalić TIFF do PDF za pomocą zaledwie kilku wierszy kodu

{{% blocks/products/pf/agp/code-block title="Kod C# do scalania TIFF do PDF" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Jak scalić TIFF z PDF w C#" >}}
