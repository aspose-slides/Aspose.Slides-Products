---
title: Scal JPG do PDF w C#
url: /pl/net/merger/jpg-to-pdf/
keywords: JPG do PDF, Scal JPG do PDF, Dołącz JPG do PDF, PDF, JPG, C# API, .NET Library
description: Scal JPG do PDF w C#. Użyj API biblioteki .NET, aby połączyć pliki JPG i PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Scal JPG do PDF w C#" h2="Potężny, wieloplatformowy interfejs API platformy .NET do łączenia plików JPG z plikami PDF przy użyciu kodu C# w platformach NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Połącz JPG z PDF za pomocą Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/) to potężna biblioteka .NET używana do tworzenia, konwertowania, scalania i manipulowania prezentacjami, plikami PDF, obrazami, i inne pliki. Łącząc JPG z PDF, skutecznie łączysz obrazy JPG, aby uzyskać pojedynczy plik PDF.
...
{{% blocks/products/pf/feature-page-section  h2="Scal JPG do PDF w C#" %}}
Korzystając z [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/), możesz szybko scalić JPG do PDF za pomocą zaledwie kilku linii kodu

{{% blocks/products/pf/agp/code-block title="Kod C# do łączenia JPG z PDF" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Jak scalić JPG z PDF w C#" >}}
