...
url: /pl/net/merger/png-to-png/
keywords: Scalanie PNG, PNG do PNG, Dołącz do PNG, Łącz PNG, C# API, Biblioteka .NET
description: Połącz PNG z PNG w C#. Użyj interfejsu API biblioteki platformy .NET, aby połączyć pliki PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Połącz PNG w C#" h2="Potężny wieloplatformowy interfejs API .NET do łączenia obrazów PNG przy użyciu kodu C# na platformach NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Połącz PNG z PNG za pomocą Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/) to potężna biblioteka .NET używana do łączenia i manipulowania prezentacjami, obrazami i innymi plikami. Łącząc PNG z PNG, skutecznie łączysz dwa obrazy, aby uzyskać jeden obraz.
...
Korzystając z [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/), możesz szybko łączyć pliki PNG za pomocą zaledwie kilku wierszy kodu
