---
title: Chroń i blokuj dokument ODP przez .NET
weight: 4230
url: /pl/net/protect/odp/ 
description: Kod źródłowy C# do blokowania pliku ODP przy użyciu hasła na platformach .NET Framework, .NET Core, Windows Azure, Mono lub Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Szyfruj pliki ODP za pomocą C#" h2="Chroń hasłem prezentacje PowerPoint, w tym format ODP, korzystając z biblioteki .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Jak chronić plik ODP za pomocą C#" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Chroń ODP za pomocą C#" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/pl/net/protect/ppt/" name="PPT" description="Microsoft PowerPoint 97-2003" >}}
