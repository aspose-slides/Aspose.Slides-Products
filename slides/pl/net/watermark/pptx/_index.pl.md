---
title: Dokument PPTX ze znakiem wodnym przez .NET
weight: 5590
url: /pl/net/watermark/pptx/ 
description: C# kod źródłowy do dodawania lub usuwania znaku wodnego do pliku PPTX na platformach .NET Framework, .NET Core, Windows Azure, Mono lub Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Dodaj tekstowy znak wodny do PPTX za pomocą C#" h2="Twórz własne aplikacje .NET do znakowania plików PPTX przy użyciu interfejsów API po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/code-block title="Dodaj znak wodny do PPTX - C#" offSpacer="" %}}
