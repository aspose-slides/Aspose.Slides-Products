...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować PNG na PDF w C#" %}}

Jak programowo przekonwertować PNG na PDF?

Używając [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/), każdy programista lub aplikacja może przekonwertować format PNG na PDF za pomocą zaledwie kilku wierszy kodu C#.

Jako nowoczesny interfejs API do przetwarzania dokumentów, Aspose.Slides for .NET szybko tworzy pliki PDF z obrazów PNG. Biblioteka Aspose PowerPoint umożliwia konwersję PNG do PDF i wielu innych formatów plików
...
{{< blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować PNG na PDF w C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Programiści i aplikacje mogą konwertować PNG na PDF w ten sposób:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Przed uruchomieniem kodu C# konwersji PNG do PDF komputer musi spełniać następujące wymagania wstępne:
...
{{% blocks/products/pf/agp/code-block title="Kod C# do konwersji PNG na PDF" offSpacer="" %}}
