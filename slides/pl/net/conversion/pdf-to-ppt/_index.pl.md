---
title: Konwertuj PDF na PPT w C#
url: /pl/net/conversion/pdf-to-ppt/
keywords: Konwertuj PDF na PPT, PDF na PPT, PowerPoint, PDF, PPT, C# API, bibliotekę .NET
description: Konwertuj PDF na PPT w C#. Użyj interfejsu API biblioteki .NET, aby przekonwertować plik PDF na format PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konwertuj PDF na PPT w C#" h2="Potężny, wieloplatformowy interfejs API .NET do konwersji plików PDF na PPT przy użyciu kodu C# na platformach NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Konwertuj pliki PDF na PPT za pomocą Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/) to potężna biblioteka .NET używana do tworzenia, konwertowania i manipulowania prezentacjami programu PowerPoint, plikami PDF, dokumentami HTML, i inne pliki. Konwertując plik PDF na PPT, zasadniczo przenosisz zawartość stron PDF na slajdy w prezentacji PowerPoint.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Konwertuj PDF na PPT w C#" %}}
Używając [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/), możesz przekonwertować plik PDF na prezentację PowerPoint za pomocą zaledwie kilku linijek kodu:

{{% blocks/products/pf/agp/code-block title="Kod C# do konwersji plików PDF na PPT" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Jak przekonwertować PDF na PPT w C#" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Załaduj plik PDF, który chcesz przekonwertować na PPT.
{{< /blocks/products/pf/agp/step-autogen >}}
