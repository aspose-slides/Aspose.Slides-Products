...
keywords: PDF na HTML, Konwertuj PDF na HTML, C# API, .NET Library, PDF, HTML
description: Konwertuj PDF na HTML w C#. Użyj interfejsu API biblioteki .NET do konwersji stron PDF na pliki HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj PDF na HTML w C#" h2="PowerPoint .NET API do konwertowania dokumentów PDF na pliki HTML na platformach NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować PDF na HTML w C#" %}}

Jak przekonwertować PDF na HTML w kodzie?

Korzystając z [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/), każdy programista lub aplikacja może konwertować pliki PDF na pliki HTML za pomocą zaledwie kilku wierszy kodu C#.

Jako nowoczesny interfejs API do przetwarzania dokumentów, Aspose.Slides for .NET szybko eksportuje strony PDF do HTML. Biblioteka Aspose PowerPoint umożliwia konwersję plików PDF do HTML i wielu innych formatów plików.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak przekonwertować PDF na HTML w C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Programiści i aplikacje mogą konwertować pliki PDF na HTML w ten sposób:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Wywołaj metodę zapisywania, aby zapisać slajdy w formacie HTML.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Przed uruchomieniem kodu C# konwersji PDF na HTML komputer musi spełniać następujące wymagania wstępne:
...
{{% blocks/products/pf/agp/code-block title="Kod C# do konwersji PDF na HTML" offSpacer="" %}}
