...
keywords: SVG do PNG, konwertuj SVG do PNG, C# API, biblioteka .NET
description: Konwertuj SVG na PNG w C#. Użyj interfejsu API biblioteki .NET, aby przekonwertować pliki SVG na PNG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj SVG na PNG w C#" h2="PowerPoint .NET API do konwertowania plików graficznych SVG do PNG na platformach NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Konwertuj SVG na PNG w C#" %}}

Jak przekonwertować SVG do PNG w kodzie?

Używając [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/), każdy programista lub aplikacja może przekonwertować SVG na PNG za pomocą zaledwie kilku wierszy kodu C#.

Jako nowoczesny interfejs API do przetwarzania dokumentów, Aspose.Slides for .NET szybko eksportuje pliki SVG do formatu PNG. Biblioteka Aspose PowerPoint pozwala na konwersję SVG do PNG oraz obrazy w innych formatach.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak przekonwertować SVG do PNG w C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Programiści i aplikacje mogą konwertować SVG do PNG w ten sposób:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Przed uruchomieniem kodu C# konwersji SVG do PNG Twój komputer musi mieć następujące wymagania wstępne:
...
{{% blocks/products/pf/agp/code-block title="Kod C# do konwersji SVG do PNG" offSpacer="" %}}
