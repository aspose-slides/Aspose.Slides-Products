...
description: Konwertuj PDF na PPTX w C#. Użyj interfejsu API biblioteki .NET, aby przekonwertować plik PDF na format PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konwertuj PDF na PPTX w C#" h2="Potężny, wieloplatformowy interfejs API .NET do konwersji plików PDF na PPTX przy użyciu kodu C# na platformach NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Konwertuj PDF na PPTX za pomocą Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/) to potężna biblioteka .NET używana do tworzenia, konwertowania i manipulowania prezentacjami programu PowerPoint, plikami PDF, dokumentami HTML, i inne pliki. Kiedy konwertujesz PDF na PPTX, zasadniczo przenosisz zawartość stron PDF na slajdy w prezentacji PowerPoint.
...
{{% blocks/products/pf/agp/code-block title="Kod C# do konwersji plików PDF na PPTX" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Jak przekonwertować PDF na PPTX w C#" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Załaduj plik PDF, który chcesz przekonwertować na PPTX.
{{< /blocks/products/pf/agp/step-autogen >}}
