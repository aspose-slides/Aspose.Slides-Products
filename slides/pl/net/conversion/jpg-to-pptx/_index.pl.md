...
url: /pl/net/conversion/jpg-to-pptx/
keywords: Konwertuj JPG na PPTX, JPG na PPTX, PowerPoint, JPG, PPTX, C# API, bibliotekę .NET
description: Konwertuj JPG na PPTX w C#. Użyj interfejsu API biblioteki platformy .NET, aby przekonwertować obrazy JPG na format programu PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Konwertuj JPG na PPTX w C#" h2="Potężne, wieloplatformowe API .NET do konwersji JPG na PPTX przy użyciu kodu C# na platformach NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Konwertuj JPG na PPTX za pomocą Aspose.Slides" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/) to potężna biblioteka .NET używana do tworzenia, konwertowania i manipulowania prezentacjami programu PowerPoint, plikami PDF, dokumentami HTML, i inne pliki. Kiedy konwertujesz JPG na PPTX, zasadniczo tworzysz prezentację PowerPoint zawierającą slajdy oparte na obrazach JPG.
