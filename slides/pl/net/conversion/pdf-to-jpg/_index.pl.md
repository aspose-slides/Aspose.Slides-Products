...
weight: 70
url: /pl/net/conversion/pdf-to-jpg/ 
keywords: PDF na JPG, Konwertuj PDF na JPG, C# API, .NET Library, PDF, JPG
description: Konwertuj PDF na JPG w C#. Użyj interfejsu API biblioteki .NET do konwersji stron PDF na obrazy JPG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj PDF na JPG w C#" h2="PowerPoint .NET API do konwertowania dokumentów PDF na obrazy JPG na platformach NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować plik PDF na JPG w C#" %}}

Jak przekonwertować plik PDF na JPG w kodzie?

Używając [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/), każdy programista lub aplikacja może przekonwertować plik PDF na format JPG za pomocą zaledwie kilku wierszy kodu C#.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak przekonwertować plik PDF na JPG w C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Programiści i aplikacje mogą konwertować pliki PDF na JPG w ten sposób:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Wywołaj metodę zapisywania, aby zapisać slajdy jako obrazy JPG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Kod C# do konwersji PDF na JPG" offSpacer="" %}}
