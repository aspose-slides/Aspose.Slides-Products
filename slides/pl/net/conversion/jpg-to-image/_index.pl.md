...
title: Konwertuj JPG na obraz w C#
weight: 210
url: /pl/net/conversion/jpg-to-image/ 
keywords: JPG na obraz, Konwertuj JPG na obraz, C# API, Biblioteka .NET
description: Konwertuj JPG na obraz w C#. Użyj interfejsu API biblioteki .NET, aby przekonwertować JPG na obrazy w różnych formatach.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj JPG na obraz w C#" h2="PowerPoint .NET API do konwertowania obrazów JPG na pliki obrazów na platformach NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Konwertuj JPG na obraz w C#" %}}

Jak przekonwertować JPG na obraz w kodzie?

Używając [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/), każdy programista lub aplikacja może przekonwertować JPG na obraz za pomocą zaledwie kilku wierszy kodu C#.

Jako nowoczesny interfejs API do przetwarzania dokumentów, Aspose.Slides for .NET szybko eksportuje pliki JPG do obrazów w innych formatach. Biblioteka Aspose PowerPoint umożliwia konwersję JPG do obrazu i wielu innych formatów plików
...
{{< blocks/products/pf/agp/feature-section-col title="Jak przekonwertować JPG na obraz w C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Programiści i aplikacje mogą konwertować JPG na obraz w ten sposób:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Przed uruchomieniem kodu C# konwersji JPG do obrazu komputer musi mieć następujące wymagania wstępne:
...
{{% blocks/products/pf/agp/code-block title="Kod C# do konwersji JPG na obraz" offSpacer="" %}}
