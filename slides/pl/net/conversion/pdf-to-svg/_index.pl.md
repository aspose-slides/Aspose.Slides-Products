...
weight: 100
url: /pl/net/conversion/pdf-to-svg/ 
keywords: PDF do SVG, Konwersja PDF do SVG, C# API, .NET Library, PDF, SVG
description: Konwertuj PDF na SVG w C#. Użyj interfejsu API biblioteki .NET do konwersji stron PDF na obrazy SVG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj PDF na SVG w C#" h2="PowerPoint .NET API do konwertowania dokumentów PDF na obrazy SVG na platformach NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować plik PDF na SVG w C#" %}}

Jak przekonwertować plik PDF na SVG w kodzie?

Używając [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/), każdy programista lub aplikacja może przekonwertować plik PDF na format SVG za pomocą zaledwie kilku wierszy kodu C#.

Jako nowoczesny interfejs API do przetwarzania dokumentów, Aspose.Slides for .NET szybko eksportuje strony PDF do SVG. Biblioteka Aspose PowerPoint umożliwia konwersję plików PDF do SVG i wielu innych formatów plików
...
{{< blocks/products/pf/agp/feature-section-col title="Jak przekonwertować plik PDF na SVG w C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Programiści i aplikacje mogą konwertować pliki PDF na SVG w ten sposób:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Przed uruchomieniem kodu C# konwersji PDF do SVG komputer musi spełniać następujące wymagania wstępne:
...
{{% blocks/products/pf/agp/code-block title="Kod C# do konwersji PDF na SVG" offSpacer="" %}}
