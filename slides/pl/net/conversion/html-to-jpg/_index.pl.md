...
title: Konwertuj HTML na JPG w C#
weight: 150
url: /pl/net/conversion/html-to-jpg/ 
keywords: HTML na JPG, Konwertuj HTML na JPG, C# API, .NET Library, HTML, JPG
description: Konwertuj HTML na JPG w C#. Użyj interfejsu API biblioteki .NET do konwersji plików HTML na obrazy JPG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj HTML na JPG w C#" h2="PowerPoint .NET API do konwertowania plików HTML na obrazy JPG na platformach NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować HTML na JPG w C#" %}}

Jak przekonwertować HTML na JPG w kodzie?

Używając [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/), każdy programista lub aplikacja może przekonwertować HTML na format JPG za pomocą zaledwie kilku wierszy kodu C#.

Jako nowoczesny interfejs API do przetwarzania dokumentów, Aspose.Slides for .NET szybko eksportuje pliki HTML do formatu JPG. Biblioteka Aspose PowerPoint umożliwia konwersję HTML do JPG i wielu innych formatów plików
...
{{< blocks/products/pf/agp/feature-section-col title="Jak przekonwertować HTML na JPG w C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Programiści i aplikacje mogą konwertować HTML na JPG w ten sposób:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Dodaj slajdy na podstawie zawartości dokumentu HTML.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Zapisz slajdy jako obrazy JPG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Przed uruchomieniem kodu C# konwersji HTML do JPG komputer musi mieć następujące wymagania wstępne:
...
{{% blocks/products/pf/agp/code-block title="Kod C# do konwersji HTML na JPG" offSpacer="" %}}
