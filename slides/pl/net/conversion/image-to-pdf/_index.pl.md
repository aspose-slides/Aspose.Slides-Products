...
title: Konwertuj obraz na PDF w C#
weight: 30
url: /pl/net/conversion/image-to-pdf/ 
keywords: Obraz do PDF, Konwertuj obraz do PDF, C# API, .NET Library, Image, JPG, PNG, PDF
description: Konwertuj obraz na PDF w C#. Użyj interfejsu API biblioteki .NET, aby przekonwertować obrazy na dokumenty PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj obraz na PDF w C#" h2="PowerPoint .NET API do konwertowania obrazów do dokumentów PDF na platformach NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować obraz do formatu PDF w C#" %}}

Jak programowo przekonwertować obraz do formatu PDF?

Używając [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/), każdy programista lub aplikacja może przekonwertować obraz na format PDF za pomocą zaledwie kilku wierszy kodu C#.

Jako nowoczesny interfejs API do przetwarzania dokumentów, Aspose.Slides for .NET szybko tworzy pliki PDF z obrazów JPG lub PNG. Biblioteka Aspose PowerPoint umożliwia konwersję obrazu do formatu PDF i wielu innych formatów plików
...
{{< blocks/products/pf/agp/feature-section-col title="Kroki konwersji obrazu do formatu PDF w C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Programiści i aplikacje mogą konwertować obraz do formatu PDF w ten sposób:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Wywołaj metodę zapisywania, aby zapisać plik w formacie PDF.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Przed uruchomieniem kodu C# konwersji obrazu na PDF komputer musi mieć następujące wymagania wstępne:
...
{{% blocks/products/pf/agp/code-block title="Kod C# do konwersji obrazu na PDF" offSpacer="" %}}
