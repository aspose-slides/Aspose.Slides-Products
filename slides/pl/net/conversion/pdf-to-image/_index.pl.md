...
title: Konwertuj PDF na obraz w C#
weight: 80
url: /pl/net/conversion/pdf-to-image/ 
keywords: PDF na obraz, konwertuj PDF na obraz, C# API, biblioteka .NET, PDF, obraz
description: Konwertuj plik PDF na obraz w C#. Użyj interfejsu API biblioteki .NET do konwersji stron PDF na obrazy
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj PDF na obraz w C#" h2="PowerPoint .NET API do konwertowania dokumentów PDF na obrazy na platformach NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować plik PDF na obraz w C#" %}}

Jak przekonwertować plik PDF na obraz w kodzie?

Używając [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/), każdy programista lub aplikacja może konwertować pliki PDF na pliki obrazów za pomocą zaledwie kilku wierszy kodu C#.

Jako nowoczesny interfejs API do przetwarzania dokumentów, Aspose.Slides for .NET szybko eksportuje strony PDF do formatów obrazu. Biblioteka Aspose PowerPoint umożliwia konwersję plików PDF do obrazów i wielu innych formatów plików.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak przekonwertować plik PDF na obraz w C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Programiści i aplikacje mogą konwertować pliki PDF na obraz w ten sposób:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Wywołaj metodę zapisywania, aby zapisać slajdy jako obrazy.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Przed uruchomieniem kodu C# konwersji PDF na obraz komputer musi spełniać następujące wymagania wstępne:
...
{{% blocks/products/pf/agp/code-block title="Kod C# do konwersji PDF na obraz" offSpacer="" %}}
