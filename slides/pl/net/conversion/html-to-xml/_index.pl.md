---
title: Konwertuj HTML na XML w C#
weight: 170
url: /pl/net/conversion/html-to-xml/ 
keywords: HTML na XML, Konwertuj HTML na XML, C# API, .NET Library, HTML, XML
description: Konwertuj HTML na XML w C#. Użyj interfejsu API biblioteki .NET, aby przekonwertować dokument HTML na plik XML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj HTML na XML w C#" h2="PowerPoint .NET API do konwertowania dokumentów HTML na pliki XML na platformach NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować HTML na XML w C#" %}}

Jak przekonwertować HTML na XML w kodzie?

Używając [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/), każdy programista lub aplikacja może konwertować pliki HTML na XML za pomocą zaledwie kilku wierszy kodu C#.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak przekonwertować HTML na XML w C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Programiści i aplikacje mogą konwertować HTML na XML w ten sposób:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Dodaj slajdy na podstawie zawartości pliku HTML.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Kod C# do konwersji HTML na XML" offSpacer="" %}}
