---
title: Konwertuj POTM na SVG za pomocą C#
weight: 4440
url: /pl/net/conversion/potm-to-svg/ 
description: Przykładowy kod konwersji POTM do SVG C#. Użyj przykładowego kodu API dla plików wsadowych POTM do konwersji SVG w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj POTM na SVG za pomocą C#" h2="Eksportuj pliki PowerPoint® POTM do SVG na platformach .NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować POTM na SVG za pomocą C#" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować POTM do SVG za pomocą C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Programiści .NET mogą łatwo ładować i konwertować pliki POTM do SVG w zaledwie kilku linijkach kodu." >}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję POTM do SVG C#" offSpacer="" %}}
