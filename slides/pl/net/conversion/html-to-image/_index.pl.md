...
title: Konwertuj HTML na obraz w C#
weight: 160
url: /pl/net/conversion/html-to-image/ 
keywords: HTML na obraz, konwertuj HTML na obraz, C# API, biblioteka .NET, HTML, obraz
description: Konwertuj HTML na obraz w C#. Użyj interfejsu API biblioteki .NET do konwersji plików HTML na obrazy
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj HTML na obraz w C#" h2="PowerPoint .NET API do konwertowania plików HTML na obrazy na platformach NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować HTML na obraz w C#" %}}

Jak przekonwertować HTML na obraz w kodzie?

Używając [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/), każdy programista lub aplikacja może przekonwertować HTML na pliki obrazów za pomocą zaledwie kilku wierszy kodu C#.

Jako nowoczesny interfejs API do przetwarzania dokumentów, Aspose.Slides for .NET szybko eksportuje pliki HTML do formatów plików graficznych. Biblioteka Aspose PowerPoint umożliwia konwersję HTML do obrazów i wielu innych formatów plików
...
{{< blocks/products/pf/agp/feature-section-col title="Jak przekonwertować HTML na obraz w C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Programiści i aplikacje mogą konwertować HTML na obraz w ten sposób:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Dodaj slajdy na podstawie stron HTML.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Zapisz slajdy jako obrazy.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Przed uruchomieniem kodu C# konwersji HTML do obrazu komputer musi mieć następujące wymagania wstępne:
...
{{% blocks/products/pf/agp/code-block title="Kod C# do konwersji HTML na obraz" offSpacer="" %}}
