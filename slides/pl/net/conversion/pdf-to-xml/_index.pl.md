...
keywords: PDF na XML, Konwertuj PDF na XML, C# API, .NET Library, PDF, XML
description: Konwertuj PDF na XML w C#. Użyj interfejsu API biblioteki .NET do konwersji stron PDF na pliki XML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj PDF na XML w C#" h2="PowerPoint .NET API do konwertowania dokumentów PDF na pliki XML na platformach NET Framework, .NET Core, Windows Azure, Mono lub Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować PDF na XML w C#" %}}

Jak przekonwertować plik PDF na XML w kodzie?

Używając [**Aspose.Slides for .NET**](https://products.aspose.com/slides/pl/net/), każdy programista lub aplikacja może konwertować pliki PDF na XML za pomocą zaledwie kilku wierszy kodu C#.

Jako nowoczesny interfejs API do przetwarzania dokumentów, Aspose.Slides for .NET szybko eksportuje strony PDF do formatu XML. Biblioteka Aspose PowerPoint umożliwia konwersję plików PDF do XML i wielu innych formatów plików.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak przekonwertować PDF na XML w C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Programiści i aplikacje mogą konwertować pliki PDF na XML w ten sposób:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Przed uruchomieniem kodu C# konwersji PDF na XML komputer musi spełniać następujące wymagania wstępne:
...
{{% blocks/products/pf/agp/code-block title="Kod C# do konwersji PDF na XML" offSpacer="" %}}
