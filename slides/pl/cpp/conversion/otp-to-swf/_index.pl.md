...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.SLIDES API ułatwia programistom konwersję pliku OTP do SWF w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji OTP do SWF C++" offSpacer="" %}}
