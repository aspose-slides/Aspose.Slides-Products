...
<p class="col-lg-10">Osadź wykresy Excela jako obiekty OLE na slajdach</p>

</div>

<div class="col-lg-4"><em class="fa fa-print  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Zarządzaj połączonymi obiektami Ole</p>
...
<p class="col-lg-10">Indywidualne drukowanie prezentacji</p>
...
<h2 class="h2title">Ciągła integracja nowych funkcji</h2>

<p>Nigdy nie jesteś ograniczony do istniejących funkcji. Nasze zespoły produktowe stale dodają coraz więcej funkcji, a każda nowa wersja oferuje więcej funkcji w porównaniu ze starszymi wersjami. Możesz także wysłać nowe prośby o dodanie funkcji, jeśli zauważysz, że brakuje którejś z żądanych funkcji. Oto lista kilku wybranych z najnowszych funkcji.</p>

<ul>

<li>Rasteryzacja lub wektoryzacja kształtów bez tekstu.</li>

<li>Konwertuj obrazy SVG na kształty.</li>

<li>Uzyskaj domyślne tło tabeli.</li>

<li>Ograniczanie dostępu do lokalnego systemu plików podczas otwierania dokumentu.</li>

<li>Dodaj kodowanie tagu meta podczas zapisywania w formacie HTML.</li>

<li>Ustawienie usuwania atrybutów szerokości i wysokości tagu SVG podczas zapisywania jako HTML.</li>

<li>Support for

<ul>

<li>Odpowiedzi na komentarze, Office 365 i zewnętrzne skoroszyty programu Excel.</li>

<li>Rozmiar reprezentuje właściwość wykresu bąbelkowego.</li>

<li>Ukrywanie lewego okienka miniatur slajdów w wygenerowanym PPT.</li>

<li>Wykresy lejkowe, wykresy mapy 2D i ścieżka skoroszytu zewnętrznego źródła danych wykresu.</li>

<li>Szyfrowanie OpenDocument, funkcja Morph Transition i Text Highlighter.</li>

<li>Ustawienie właściwości przezroczystości dla efektów cienia.</li>

<li>Ustawianie kształtu objaśnienia dla etykiety danych serii.</li>

<li>Uzyskaj efekty za pomocą akapitów pól tekstowych.</li>

<li>Renderowanie kształtu Efekt Miękkie krawędzie (EffectFormat).</li>

<li>ChartData SetRange w tabeli przestawnej.</li>

</ul>

</li>

<li>Implementuj wielostronicowy format Tiff, rozszerzenia Metafile Format Plus (EMF+) i format Strict Open XML.</li>

<li>Renderowanie komentarzy z formatu ODP, które nie mają autora.</li>

<li>Implementuj serializację z zachowaniem zgodności z formatem Strict Open XML.</li>
...
<h2 class="h2title">Przetwarzanie kształtów SmartArt</h2>

<p>Aspose.Slides for C++ ułatwia tworzenie od podstaw kształtów SmartArt, a także umożliwia dostęp, manipulowanie lub usuwanie istniejących kształtów SmartArt ze slajdu. Ponadto możliwe jest również formatowanie kształtów SmartArt, takich jak ustawienie stylu, koloru i układu.</p>
