---
title: Edytuj lub wyświetl metadane dokumentu PPTM za pomocą C++
weight: 6050
url: /pl/cpp/metadata/pptm/ 
description: Przykładowy kod C++ do edycji lub przeglądania metadanych pliku PPTM w środowisku wykonawczym C++ dla Windows 32-bitowego, Windows 64-bitowego i Linux 64-bitowego.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Wyodrębnij metadane PPTM za pomocą C++" h2="Twórz własne aplikacje C++, aby dodawać, edytować, usuwać lub wyodrębniać metadane z plików PPTM za pomocą interfejsów API po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTM" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak uzyskać metadane PPTM za pomocą C++?" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Kroki wyodrębniania metadanych PPTM za pomocą C++" >}}
