---
title: Edytuj lub wyświetl metadane dokumentu POTM za pomocą C++
weight: 6600
url: /pl/cpp/metadata/potm/ 
description: Przykładowy kod C++ do edycji lub przeglądania metadanych pliku POTM w C++ Runtime Environment dla Windows 32-bitowy, Windows 64-bitowy i Linux 64-bitowy.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Wyodrębnij metadane POTM za pomocą C++" h2="Twórz własne aplikacje C++, aby dodawać, edytować, usuwać lub wyodrębniać metadane z plików POTM za pomocą interfejsów API po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="Aspose.Slides" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak uzyskać metadane POTM za pomocą C++" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Kroki do wyodrębnienia metadanych POTM za pomocą C++" >}}
