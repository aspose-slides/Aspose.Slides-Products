---
title: Połącz pliki HTML w C++
url: /pl/cpp/merger/html-to-html/
keywords: Scal HTML, HTML do HTML, Dołącz do HTML, Połącz HTML, C++ API, C++ Library
description: Połącz HTML z HTML w C++. Użyj interfejsu API biblioteki C++ do łączenia plików HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Połącz HTML w C++" h2="Szybka i wieloplatformowa biblioteka C++ do łączenia plików HTML przy użyciu kodu C++" >}}

{{% blocks/products/pf/feature-page-section h2="Scal HTML do HTML za pomocą Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/pl/cpp/) to potężna biblioteka C++ używana do tworzenia, konwertowania, scalania i manipulowania prezentacjami, plikami HTML i innymi dokumentami . Kiedy łączysz HTML z HTML, skutecznie łączysz zawartość z 2 dokumentów, aby uzyskać jeden plik HTML. Aspose.Slides umożliwia łączenie dokumentów HTML na różne sposoby. Możesz scalić HTML ze wszystkimi ich tekstami, formatowaniem, stylami itp.
...
{{% blocks/products/pf/feature-page-section  h2="Połącz HTML z HTML w C++" %}}
Używając [**Aspose.Slides for C++**](https://products.aspose.com/slides/pl/cpp/), możesz szybko łączyć pliki HTML za pomocą zaledwie kilku wierszy kodu
