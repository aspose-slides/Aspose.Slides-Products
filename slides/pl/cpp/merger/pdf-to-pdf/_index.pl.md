---
title: Scalanie plików PDF w C++
url: /pl/cpp/merger/pdf-to-pdf/
keywords: Scal PDF, PDF do PDF, Dołącz do PDF, Połącz PDF, C++ API, C++ Library
description: Scal PDF do PDF w C++. Użyj interfejsu API biblioteki C++ do łączenia plików PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Scal PDF w C++" h2="Szybka i wieloplatformowa biblioteka C++ do łączenia plików PDF przy użyciu kodu C++" >}}

{{% blocks/products/pf/feature-page-section h2="Scal PDF do PDF za pomocą Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/pl/cpp/) to potężna biblioteka C++ używana do tworzenia, konwertowania, scalania i manipulowania prezentacjami, plikami PDF i innymi dokumentami. Łącząc pliki PDF z PDF, skutecznie łączysz strony z 2 dokumentów, aby uzyskać jeden plik PDF. Aspose.Slides umożliwia łączenie plików PDF na różne sposoby. Możesz łączyć pliki PDF ze wszystkimi ich kształtami, stylami, tekstami, formatowaniem itp.
...
Korzystając z [**Aspose.Slides for C++**](https://products.aspose.com/slides/pl/cpp/), możesz szybko łączyć pliki PDF za pomocą zaledwie kilku wierszy kodu
