...
url: /pl/cpp/merger/image-to-bmp/
keywords: Obraz do BMP, Scal obraz do BMP, Dołącz obraz do BMP, Połącz obrazy, Obraz, BMP, C++ API, Biblioteka C++
description: Scal obraz do BMP w C++. Użyj interfejsu API biblioteki C++ do łączenia obrazów
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Scal obraz do BMP w C++" h2="Szybka i wieloplatformowa biblioteka C++ do łączenia obrazów z plikami BMP przy użyciu kodu C++" >}}

{{% blocks/products/pf/feature-page-section h2="Scal obraz do BMP za pomocą Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/pl/cpp/) to potężna biblioteka C++ używana do tworzenia, konwertowania, scalania i manipulowania prezentacjami, plikami PDF, obrazami i innymi akta. Kiedy scalasz obraz do BMP, skutecznie łączysz obrazy, aby uzyskać pojedynczy plik BMP.
...
Używając [**Aspose.Slides for C++**](https://products.aspose.com/slides/pl/cpp/), możesz szybko scalić obraz do BMP za pomocą zaledwie kilku linijek kodu

{{% blocks/products/pf/agp/code-block title="Kod C++ do scalania obrazu do BMP" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="Jak scalić obraz do BMP w C++" >}}
