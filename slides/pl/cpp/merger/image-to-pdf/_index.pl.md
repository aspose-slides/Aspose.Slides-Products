...
url: /pl/cpp/merger/image-to-pdf/
keywords: Obraz do PDF, Scal obraz do PDF, Dołącz obraz do PDF, PDF, Obraz, C++ API, Biblioteka C++
description: Scal obraz do PDF w C++. Użyj interfejsu API biblioteki C++, aby połączyć obraz i plik PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Scal obraz do PDF w C++" h2="Szybka i wieloplatformowa biblioteka C++ do łączenia obrazów z plikami PDF przy użyciu kodu C++" >}}

{{% blocks/products/pf/feature-page-section h2="Scal obraz do pliku PDF za pomocą Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/pl/cpp/) to potężna biblioteka C++ używana do tworzenia, konwertowania, scalania i manipulowania prezentacjami, plikami PDF, obrazami i innymi akta. Scalając obraz do pliku PDF, skutecznie łączysz obrazy, aby uzyskać pojedynczy plik PDF.
...
Używając [**Aspose.Slides for C++**](https://products.aspose.com/slides/pl/cpp/), możesz szybko scalić obraz do pliku PDF za pomocą zaledwie kilku wierszy kodu

{{% blocks/products/pf/agp/code-block title="Kod C++ do scalania obrazu do formatu PDF" offSpacer="true" %}}
```cpp
