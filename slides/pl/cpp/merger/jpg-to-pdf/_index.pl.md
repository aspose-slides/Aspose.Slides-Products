...
url: /pl/cpp/merger/jpg-to-pdf/
keywords: JPG do PDF, Scal JPG do PDF, Dołącz JPG do PDF, PDF, JPG, C++ API, C++ Library
description: Scal JPG do PDF w C++. Użyj API biblioteki C++, aby połączyć JPG i PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Scal JPG do PDF w C++" h2="Szybka i wieloplatformowa biblioteka C++ do łączenia plików JPG z plikami PDF przy użyciu kodu C++" >}}

{{% blocks/products/pf/feature-page-section h2="Połącz JPG z PDF za pomocą Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/pl/cpp/) to potężna biblioteka C++ używana do tworzenia, konwertowania, scalania i manipulowania prezentacjami, plikami PDF, obrazami i innymi akta. Łącząc JPG z PDF, skutecznie łączysz obrazy JPG, aby uzyskać pojedynczy plik PDF.
...
Używając [**Aspose.Slides for C++**](https://products.aspose.com/slides/pl/cpp/), możesz szybko scalić JPG do PDF za pomocą zaledwie kilku linijek kodu
...
{{< blocks/products/pf/feature-page-section  h2="Jak scalić JPG do PDF w C++" >}}
