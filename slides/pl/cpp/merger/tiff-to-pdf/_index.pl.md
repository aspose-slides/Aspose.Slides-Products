...
url: /pl/cpp/merger/tiff-to-pdf/
keywords: TIFF do PDF, Scal TIFF do PDF, Dołącz TIFF do PDF, PDF, TIFF, C++ API, C++ Library
description: Scal TIFF do PDF w C++. Użyj API biblioteki C++, aby połączyć TIFF i PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Scal TIFF do PDF w C++" h2="Szybka i wieloplatformowa biblioteka C++ do łączenia plików TIFF z plikami PDF przy użyciu kodu C++" >}}

{{% blocks/products/pf/feature-page-section h2="Połącz TIFF z PDF za pomocą Aspose.Slides" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/pl/cpp/) to potężna biblioteka C++ używana do tworzenia, konwertowania, scalania i manipulowania prezentacjami, plikami PDF, obrazami i innymi akta. Podczas scalania formatu TIFF z formatem PDF skutecznie łączysz obrazy w celu uzyskania pojedynczego pliku PDF.
...
Korzystając z [**Aspose.Slides for C++**](https://products.aspose.com/slides/pl/cpp/), możesz szybko scalić TIFF do PDF za pomocą zaledwie kilku wierszy kodu

{{% blocks/products/pf/agp/code-block title="Kod C++ do łączenia TIFF z PDF" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="Jak scalić TIFF do PDF w C++" >}}
