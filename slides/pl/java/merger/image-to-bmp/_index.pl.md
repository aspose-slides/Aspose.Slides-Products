---
title: Scal obraz do BMP w Javie
url: /pl/java/merger/image-to-bmp/
keywords: Obraz do BMP, Scal obraz do BMP, Dołącz obraz do BMP, Połącz obrazy, Obraz, BMP, Java API, Biblioteka Java
description: Scal obraz do BMP w Javie. Użyj API biblioteki Java do łączenia obrazów
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Scal obraz do BMP w Javie" h2="Szybka i wieloplatformowa biblioteka Java do łączenia obrazów z plikami BMP przy użyciu kodu Java" >}}

{{% blocks/products/pf/feature-page-section h2="Scal obraz do BMP za pomocą Aspose.Slides" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/pl/java/) to potężna biblioteka Java służąca do tworzenia, konwertowania, scalania i manipulowania prezentacjami, plikami PDF, obrazami i innymi akta. Kiedy scalasz obraz do BMP, skutecznie łączysz obrazy, aby uzyskać pojedynczy plik BMP.
...
{{% blocks/products/pf/feature-page-section  h2="Scal obraz do BMP w Javie" %}}
Używając [**Aspose.Slides for Java**](https://products.aspose.com/slides/pl/java/), możesz szybko scalić obraz do BMP za pomocą zaledwie kilku linijek kodu

{{% blocks/products/pf/agp/code-block title="Kod Java do łączenia obrazu z BMP" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Jak scalić obraz do BMP w Javie" >}}
