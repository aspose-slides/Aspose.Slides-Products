---
title: Scal obrazy w Javie
url: /pl/java/merger/image-to-image/
keywords: Scal obraz, obraz do obrazu, dołącz obrazy, połącz obrazy, Java API, biblioteka Java
description: Scal obraz do obrazu w Javie. Użyj API biblioteki Java do łączenia obrazów
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge image in Java" h2="Szybka i wieloplatformowa biblioteka Java do łączenia obrazów przy użyciu kodu Java" >}}

{{% blocks/products/pf/feature-page-section h2="Połącz obraz z obrazem za pomocą Aspose.Slides" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/pl/java/) to potężna biblioteka Java używana do łączenia i manipulowania prezentacjami, obrazami i innymi plikami. Łącząc obraz z obrazem, skutecznie łączysz dwa obrazy, aby uzyskać jeden obraz.
...
{{% blocks/products/pf/feature-page-section  h2="Scal obraz do obrazu w Javie" %}}
Using [**Aspose.Slides for Java**](https://products.aspose.com/slides/pl/java/), you can merge image files quickly with just a few lines of code

{{% blocks/products/pf/agp/code-block title="Kod Java do scalania obrazu w obraz" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Jak scalić obrazy w Javie" >}}
