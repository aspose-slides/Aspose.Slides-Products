---
title: Połącz pliki HTML w Javie
url: /pl/java/merger/html-to-html/
keywords: Scal HTML, HTML do HTML, Dołącz do HTML, Połącz HTML, Java API, Java Library
description: Połącz HTML z HTML w Javie. Użyj API biblioteki Java do łączenia plików HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Połącz HTML w Javie" h2="Szybka i wieloplatformowa biblioteka Java do łączenia plików HTML przy użyciu kodu Java" >}}

{{% blocks/products/pf/feature-page-section h2="Scal HTML do HTML za pomocą Aspose.Slides" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/pl/java/) to potężna biblioteka Java używana do tworzenia, konwertowania, scalania i manipulowania prezentacjami, plikami HTML i innymi dokumentami . Kiedy łączysz HTML z HTML, skutecznie łączysz zawartość z 2 dokumentów, aby uzyskać jeden plik HTML. Aspose.Slides umożliwia łączenie dokumentów HTML na różne sposoby. Możesz scalić HTML ze wszystkimi ich tekstami, formatowaniem, stylami itp.
...
{{% blocks/products/pf/feature-page-section  h2="Połącz HTML z HTML w Javie" %}}
Używając [**Aspose.Slides for Java**](https://products.aspose.com/slides/pl/java/), możesz szybko łączyć pliki HTML za pomocą zaledwie kilku wierszy kodu

{{% blocks/products/pf/agp/code-block title="Kod Java do łączenia HTML z HTML" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Jak scalić HTML w Javie" >}}
