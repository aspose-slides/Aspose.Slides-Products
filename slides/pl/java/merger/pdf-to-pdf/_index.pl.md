...
url: /pl/java/merger/pdf-to-pdf/
keywords: Scal PDF, PDF do PDF, Dołącz do PDF, Połącz PDF, Java API, Java Library
description: Scal PDF do PDF w Javie. Użyj API biblioteki Java do łączenia plików PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Scal PDF w Javie" h2="Szybka i wieloplatformowa biblioteka Java do łączenia plików PDF przy użyciu kodu Java" >}}

{{% blocks/products/pf/feature-page-section h2="Scal PDF do PDF za pomocą Aspose.Slides" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/pl/java/) to potężna biblioteka Java używana do tworzenia, konwertowania, scalania i manipulowania prezentacjami, plikami PDF i innymi dokumentami. Łącząc pliki PDF z PDF, skutecznie łączysz strony z 2 dokumentów, aby uzyskać jeden plik PDF. Aspose.Slides umożliwia łączenie plików PDF na różne sposoby. Możesz łączyć pliki PDF ze wszystkimi ich kształtami, stylami, tekstami, formatowaniem itp.
...
{{% blocks/products/pf/feature-page-section  h2="Scal PDF do PDF w Javie" %}}
Korzystając z [**Aspose.Slides for Java**](https://products.aspose.com/slides/pl/java/), możesz szybko łączyć pliki PDF za pomocą zaledwie kilku wierszy kodu

{{% blocks/products/pf/agp/code-block title="Kod Java do łączenia plików PDF z PDF" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Jak scalić PDF w Javie" >}}
