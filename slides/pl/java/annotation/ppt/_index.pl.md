---
title: Usuń adnotację PPT przez Java
weight: 3630
url: /pl/java/annotation/ppt/ 
description: Przykładowy kod Java do usuwania adnotacji formatu PPT w środowisku Java Runtime Environment dla aplikacji JSP/JSF i aplikacji komputerowych.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Usuń komentarze i autorów komentarzy z PPT za pomocą Java" h2="Twórz własne aplikacje Java, aby manipulować komentarzami i autorami w plikach dokumentów za pomocą interfejsów API po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby usunąć komentarze z PPT przez Java" %}}
...
1. Zapisz go w formacie PPT
1. Usuń komentarz w określonej lokalizacji
1. Ponownie zapisz plik PPT i porównaj
...
{{% blocks/products/pf/agp/code-block title="Usuń adnotacje z PPT - Java" offSpacer="" %}}
