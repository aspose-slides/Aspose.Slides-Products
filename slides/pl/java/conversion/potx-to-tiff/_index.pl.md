---
title: Konwertuj POTX na TIFF przez Java
weight: 3910
url: /pl/java/conversion/potx-to-tiff/ 
description: Przykładowy kod konwersji Java dla formatu POTX do pliku TIFF. Użyj tego przykładowego kodu, aby wyeksportować prezentacje PowerPoint i OpenOffice do formatu TIFF w dowolnej aplikacji internetowej lub aplikacji opartej na języku Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj POTX na TIFF przez Java" h2="Konwersja POTX do TIFF Java w celu konwersji jednej lub wielu stron do formatu TIFF przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować POTX na TIFF za pomocą Javy?" %}}

 Aby renderować POTX do TIFF, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Jak przekonwertować POTX na TIFF przez Javę" %}}

{{% blocks/products/pf/agp/text %}}

 Programiści Java mogą łatwo przekonwertować plik POTX na TIFF w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji POTX do TIFF Java" offSpacer="" %}}
