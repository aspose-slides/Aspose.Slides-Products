---
title: Konwertuj PPTX na POT przez Java
weight: 3810
url: /pl/java/conversion/pptx-to-pot/ 
description: Przykładowy kod konwersji Java dla formatu PPTX do pliku POT. Użyj tego przykładowego kodu, aby wyeksportować prezentacje PowerPoint i OpenOffice do POT w dowolnej aplikacji internetowej lub aplikacji opartej na Javie.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj PPTX na POT przez Java" h2="Konwersja PPTX do POT Java w celu konwersji jednej lub wielu stron na POT przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="POT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować PPTX na POT za pomocą Java?" %}}

 Aby renderować PPTX do POT, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować PPTX na POT za pomocą Javy" %}}

{{% blocks/products/pf/agp/text %}}

 Programiści Java mogą łatwo przekonwertować plik PPTX na POT w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji PPTX do POT Java" offSpacer="" %}}
