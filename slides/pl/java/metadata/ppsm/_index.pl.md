---
title: Wyświetl lub edytuj metadane plików PPSM za pomocą Java
...
{{% blocks/products/pf/agp/code-block title="Zmodyfikuj wbudowane właściwości PPSM – Java" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Dodaj niestandardowe właściwości do PPSM – Java" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak wyodrębnić metadane PPSM przez Java" >}}
