...
{{% blocks/products/pf/agp/code-block title="Zmodyfikuj wbudowane właściwości POTM – Java" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Dodaj niestandardowe właściwości do POTM – Java" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak wyodrębnić metadane POTM przez Java" >}}
