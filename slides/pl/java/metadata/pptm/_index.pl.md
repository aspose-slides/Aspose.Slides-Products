---
title: Wyświetl lub edytuj metadane plików PPTM za pomocą Java
...
{{% blocks/products/pf/agp/code-block title="Zmodyfikuj wbudowane właściwości PPTM – Java" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Dodaj niestandardowe właściwości do PPTM – Java" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak wyodrębnić metadane PPTM przez Java" >}}
