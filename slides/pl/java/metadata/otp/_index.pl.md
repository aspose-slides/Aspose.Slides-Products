---
title: Wyświetl lub edytuj metadane plików OTP za pomocą Java
...
{{% blocks/products/pf/agp/code-block title="Zmodyfikuj wbudowane właściwości OTP – Java" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Dodaj niestandardowe właściwości do OTP – Java" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak wyodrębnić metadane OTP przez Java" >}}
