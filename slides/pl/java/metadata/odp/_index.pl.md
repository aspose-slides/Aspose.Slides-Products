---
title: Wyświetl lub edytuj metadane plików ODP za pomocą Java
...
{{% blocks/products/pf/agp/code-block title="Zmodyfikuj wbudowane właściwości ODP – Java" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Dodaj niestandardowe właściwości do ODP – Java" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak wyodrębnić metadane ODP przez Java" >}}
