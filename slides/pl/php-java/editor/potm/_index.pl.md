---
title: Edytuj POTM w PHP
url: /pl/php-java/editor/potm/
keywords: Edytuj POTM, Edytuj PowerPoint, POTM, PowerPoint, PHP API, PHP Library
description: Edytuj POTM w PHP. Użyj API biblioteki PHP do edycji plików POTM
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edytuj POTM w PHP" h2="Szybka i wieloplatformowa biblioteka PHP do edycji POTM przy użyciu kodu PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edytuj POTM za pomocą Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/) to potężna biblioteka PHP używana do manipulowania i edytowania prezentacji. Możesz edytować prezentację POTM, dodając do niej nowy wiersz tekstu. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edytuj POTM w PHP" %}}
Używając [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/), możesz dodać nowy wiersz tekstu do dokumentu POTM za pomocą zaledwie kilka linijek kodu.

{{% blocks/products/pf/agp/code-block title="Kod PHP do edycji POTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak edytować POTM w PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Załaduj prezentację POTM, którą chcesz edytować.
{{< /blocks/products/pf/agp/step-autogen >}}
