...
description: Edytuj PPSX w PHP. Użyj API biblioteki PHP do edycji plików PPSX
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edytuj PPSX w PHP" h2="Szybka i wieloplatformowa biblioteka PHP do edycji PPSX przy użyciu kodu PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edytuj PPSX za pomocą Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/) to potężna biblioteka PHP używana do manipulowania i edytowania prezentacji. Możesz edytować prezentację PPSX, dodając do niej nowy wiersz tekstu. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edytuj PPSX w PHP" %}}
Używając [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/), możesz dodać nowy wiersz tekstu do dokumentu PPSX za pomocą zaledwie kilka linijek kodu.

{{% blocks/products/pf/agp/code-block title="Kod PHP do edycji PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak edytować PPSX w PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Załaduj prezentację PPSX, którą chcesz edytować.
{{< /blocks/products/pf/agp/step-autogen >}}
