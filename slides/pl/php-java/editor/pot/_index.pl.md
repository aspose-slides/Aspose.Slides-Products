---
title: Edytuj POT w PHP
url: /pl/php-java/editor/pot/
keywords: Edytuj POT, Edytuj PowerPoint, POT, PowerPoint, PHP API, PHP Library
description: Edytuj POT w PHP. Użyj API biblioteki PHP do edycji plików POT
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edytuj POT w PHP" h2="Szybka i wieloplatformowa biblioteka PHP do edycji POT przy użyciu kodu PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edytuj POT za pomocą Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/) to potężna biblioteka PHP używana do manipulowania i edytowania prezentacji. Możesz edytować prezentację POT, dodając do niej nowy wiersz tekstu. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edytuj POT w PHP" %}}
Używając [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/), możesz dodać nowy wiersz tekstu do dokumentu POT za pomocą zaledwie kilka linijek kodu.

{{% blocks/products/pf/agp/code-block title="Kod PHP do edycji POT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak edytować POT w PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Załaduj prezentację POT, którą chcesz edytować.
{{< /blocks/products/pf/agp/step-autogen >}}
