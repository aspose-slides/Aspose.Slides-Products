---
title: Edytuj HTML w PHP
url: /pl/php-java/editor/html/
keywords: Edytuj HTML, Edytuj PowerPoint, HTML, PowerPoint, PHP API, PHP Library
description: Edytuj HTML w PHP. Użyj API biblioteki PHP do edycji plików HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edytuj HTML w PHP" h2="Szybka i wieloplatformowa biblioteka PHP do edycji HTML przy użyciu kodu PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edytuj HTML za pomocą Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/) to potężna biblioteka PHP używana do manipulowania i edytowania prezentacji. Możesz edytować prezentację HTML, dodając do niej nowy wiersz tekstu. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edytuj HTML w PHP" %}}
Używając [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/), możesz dodać nowy wiersz tekstu do dokumentu HTML za pomocą zaledwie kilka linijek kodu.

{{% blocks/products/pf/agp/code-block title="Kod PHP do edycji HTML" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak edytować HTML w PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Załaduj prezentację HTML, którą chcesz edytować.
{{< /blocks/products/pf/agp/step-autogen >}}
