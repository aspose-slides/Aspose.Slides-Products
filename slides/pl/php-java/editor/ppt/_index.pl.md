---
title: Edytuj PPT w PHP
url: /pl/php-java/editor/ppt/
keywords: Edytuj PPT, Edytuj PowerPoint, PPT, PowerPoint, PHP API, PHP Library
description: Edytuj PPT w PHP. Użyj API biblioteki PHP do edycji plików PPT
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edytuj PPT w PHP" h2="Szybka i wieloplatformowa biblioteka PHP do edycji PPT przy użyciu kodu PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edytuj PPT za pomocą Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/) to potężna biblioteka PHP używana do manipulowania i edytowania prezentacji. Możesz edytować prezentację PPT, dodając do niej nowy wiersz tekstu. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edytuj PPT w PHP" %}}
Używając [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/), możesz dodać nowy wiersz tekstu do dokumentu PPT za pomocą zaledwie kilka linijek kodu.

{{% blocks/products/pf/agp/code-block title="Kod PHP do edycji PPT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak edytować PPT w PHP" >}}
