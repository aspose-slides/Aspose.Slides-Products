---
title: Edytuj PPSM w PHP
url: /pl/php-java/editor/ppsm/
keywords: Edytuj PPSM, Edytuj PowerPoint, PPSM, PowerPoint, PHP API, PHP Library
description: Edytuj PPSM w PHP. Użyj API biblioteki PHP do edycji plików PPSM
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edytuj PPSM w PHP" h2="Szybka i wieloplatformowa biblioteka PHP do edycji PPSM przy użyciu kodu PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edytuj PPSM za pomocą Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/) to potężna biblioteka PHP używana do manipulowania i edytowania prezentacji. Możesz edytować prezentację PPSM, dodając do niej nowy wiersz tekstu. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edytuj PPSM w PHP" %}}
Używając [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/), możesz dodać nowy wiersz tekstu do dokumentu PPSM za pomocą zaledwie kilka linijek kodu.

{{% blocks/products/pf/agp/code-block title="Kod PHP do edycji PPSM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak edytować PPSM w PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Załaduj prezentację PPSM, którą chcesz edytować.
{{< /blocks/products/pf/agp/step-autogen >}}
