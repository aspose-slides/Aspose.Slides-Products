---
title: Edytuj OTP w PHP
url: /pl/php-java/editor/otp/
keywords: Edytuj OTP, Edytuj PowerPoint, OTP, PowerPoint, PHP API, PHP Library
description: Edytuj OTP w PHP. Użyj API biblioteki PHP do edycji plików OTP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edytuj OTP w PHP" h2="Szybka i wieloplatformowa biblioteka PHP do edycji OTP przy użyciu kodu PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edytuj OTP za pomocą Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/) to potężna biblioteka PHP używana do manipulowania i edytowania prezentacji. Możesz edytować prezentację OTP, dodając do niej nowy wiersz tekstu. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edytuj OTP w PHP" %}}
Używając [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/), możesz dodać nowy wiersz tekstu do dokumentu OTP za pomocą zaledwie kilka linijek kodu.

{{% blocks/products/pf/agp/code-block title="Kod PHP do edycji OTP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak edytować OTP w PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Załaduj prezentację OTP, którą chcesz edytować.
{{< /blocks/products/pf/agp/step-autogen >}}
