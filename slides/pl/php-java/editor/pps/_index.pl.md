---
title: Edytuj PPS w PHP
url: /pl/php-java/editor/pps/
keywords: Edytuj PPS, Edytuj PowerPoint, PPS, PowerPoint, PHP API, PHP Library
description: Edytuj PPS w PHP. Użyj API biblioteki PHP do edycji plików PPS
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edytuj PPS w PHP" h2="Szybka i wieloplatformowa biblioteka PHP do edycji PPS przy użyciu kodu PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edytuj PPS za pomocą Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/) to potężna biblioteka PHP używana do manipulowania i edytowania prezentacji. Możesz edytować prezentację PPS, dodając do niej nowy wiersz tekstu. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edytuj PPS w PHP" %}}
Używając [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/), możesz dodać nowy wiersz tekstu do dokumentu PPS za pomocą zaledwie kilka linijek kodu.

{{% blocks/products/pf/agp/code-block title="Kod PHP do edycji PPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak edytować PPS w PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Załaduj prezentację PPS, którą chcesz edytować.
{{< /blocks/products/pf/agp/step-autogen >}}
