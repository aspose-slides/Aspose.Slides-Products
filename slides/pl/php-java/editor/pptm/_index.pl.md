---
title: Edytuj PPTM w PHP
url: /pl/php-java/editor/pptm/
keywords: Edytuj PPTM, Edytuj PowerPoint, PPTM, PowerPoint, PHP API, PHP Library
description: Edytuj PPTM w PHP. Użyj API biblioteki PHP do edycji plików PPTM
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Edytuj PPTM w PHP" h2="Szybka i wieloplatformowa biblioteka PHP do edycji PPTM przy użyciu kodu PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Edytuj PPTM za pomocą Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/) to potężna biblioteka PHP używana do manipulowania i edytowania prezentacji. Możesz edytować prezentację PPTM, dodając do niej nowy wiersz tekstu. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Edytuj PPTM w PHP" %}}
Używając [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/), możesz dodać nowy wiersz tekstu do dokumentu PPTM za pomocą zaledwie kilka linijek kodu.

{{% blocks/products/pf/agp/code-block title="Kod PHP do edycji PPTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak edytować PPTM w PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Załaduj prezentację PPTM, którą chcesz edytować.
{{< /blocks/products/pf/agp/step-autogen >}}
