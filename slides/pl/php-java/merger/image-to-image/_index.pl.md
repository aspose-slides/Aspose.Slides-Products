---
title: Połącz obrazy w PHP
url: /pl/php-java/merger/image-to-image/
keywords: Scal obraz, obraz do obrazu, dołącz obrazy, połącz obrazy, PHP API, PHP Library
description: Scal obraz do obrazu w PHP. Użyj interfejsu API biblioteki PHP do łączenia obrazów
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Scal obraz w PHP" h2="Szybka i wieloplatformowa biblioteka PHP do łączenia obrazów przy użyciu kodu PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Połącz obraz z obrazem za pomocą Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/) to potężna biblioteka PHP używana do łączenia i manipulowania prezentacjami, obrazami i innymi plikami. Łącząc obraz z obrazem, skutecznie łączysz dwa obrazy, aby uzyskać jeden obraz.
...
{{% blocks/products/pf/feature-page-section  h2="Scal obraz do obrazu w PHP" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod PHP do scalania obrazu w obraz" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Jak scalić obrazy w PHP" >}}
