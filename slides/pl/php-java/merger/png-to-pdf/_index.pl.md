---
title: Połącz PNG z PDF w PHP
url: /pl/php-java/merger/png-to-pdf/
keywords: PNG do PDF, łączenie PNG do PDF, łączenie PNG do PDF, PDF, PNG, PHP API, biblioteka PHP
description: Połącz PNG z PDF w PHP. Użyj interfejsu API biblioteki PHP, aby połączyć pliki PNG i PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Połącz PNG z PDF w PHP" h2="Szybka i wieloplatformowa biblioteka PHP do łączenia plików PNG z PDF przy użyciu kodu PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Scalanie PNG do PDF za pomocą Aspose.Slides" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/) to potężna biblioteka PHP używana do tworzenia, konwertowania, scalania i manipulowania prezentacjami, obrazami, i inne pliki. Kiedy scalasz PNG z PDF, skutecznie łączysz obrazy PNG, aby uzyskać pojedynczy plik PDF.
...
{{% blocks/products/pf/feature-page-section  h2="Połącz PNG z PDF w PHP" %}}
Używając [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/pl/php-java/), możesz szybko scalić PNG z PDF za pomocą zaledwie kilku linii kodu

{{% blocks/products/pf/agp/code-block title="Kod PHP do łączenia PNG z PDF" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Jak scalić PNG do PDF w PHP" >}}
