---
title: Scal obrazy w Pythonie
url: /pl/python-net/merge/image-to-image/
keywords: Scal obraz, obraz do obrazu, dołącz obrazy, połącz obrazy, Python API, Python Library
description: Scal obraz do obrazu w Pythonie. Użyj interfejsu API biblioteki Pythona, aby połączyć obrazy
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Merge image in Python" h2="Szybka i wieloplatformowa biblioteka Pythona do łączenia obrazów przy użyciu kodu Pythona" >}}

{{% blocks/products/pf/feature-page-section h2="Połącz obraz z obrazem za pomocą Aspose.Slides" %}}

[**Aspose.Slides dla Pythona przez .NET**](https://products.aspose.com/slides/pl/python-net/) to potężna biblioteka Pythona używana do łączenia i manipulowania prezentacjami, obrazami i innymi plikami. Łącząc obraz z obrazem, skutecznie łączysz dwa obrazy, aby uzyskać jeden obraz.
...
{{% blocks/products/pf/feature-page-section  h2="Scal obraz do obrazu w Pythonie" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod Pythona do łączenia obrazu z obrazem" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="Jak scalać obrazy w Pythonie" >}}
