---
title: Scal pliki PPTM do SVG za pomocą Pythona
url: /pl/python-net/merge/pptm-to-svg/
...
{{% blocks/products/pf/feature-page-section  h2="Scal pliki PPTM do SVG za pomocą Pythona" %}}
Aby scalić prezentacje PowerPoint, musisz sklonować slajdy z jednej prezentacji do drugiej.

{{% blocks/products/pf/agp/code-block title="Kod Pythona do łączenia wielu plików PPTM w jeden plik SVG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak połączyć PPTM z SVG za pomocą Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Oto kroki, aby połączyć dwa pliki PPTM i zapisać wynik jako SVG w Pythonie." >}}
