---
title: Scal pliki PPSX do PNG za pomocą Pythona
url: /pl/python-net/merge/ppsx-to-png/
...
{{< blocks/products/pf/feature-page-header h1="Scal pliki PPSX do PNG razem w Pythonie" h2="Szybki i wieloplatformowy interfejs API Pythona, który pomaga w tworzeniu aplikacji z możliwością tworzenia, scalania, sprawdzania lub konwertowania plików prezentacji Microsoft PowerPoint i OpenOffice bez użycia jakiegokolwiek oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Scal PPSX do PNG w Pythonie" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Scal pliki PPSX do PNG za pomocą Pythona" %}}
Aby scalić prezentacje PowerPoint, musisz sklonować slajdy z jednej prezentacji do drugiej.

{{% blocks/products/pf/agp/code-block title="Kod Pythona do łączenia wielu plików PPSX w jeden plik PNG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak połączyć PPSX z PNG za pomocą Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Oto kroki, aby połączyć dwa pliki PPSX i zapisać wynik jako PNG w Pythonie." >}}
