---
title: Scal pliki PPSX do XPS za pomocą Pythona
url: /pl/python-net/merge/ppsx-to-xps/
...
{{< blocks/products/pf/feature-page-header h1="Scal pliki PPSX do XPS razem w Pythonie" h2="Szybki i wieloplatformowy interfejs API Pythona, który pomaga w tworzeniu aplikacji z możliwością tworzenia, scalania, sprawdzania lub konwertowania plików prezentacji Microsoft PowerPoint i OpenOffice bez użycia jakiegokolwiek oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Scal PPSX do XPS w Pythonie" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Scal pliki PPSX do XPS za pomocą Pythona" %}}
Aby scalić prezentacje PowerPoint, musisz sklonować slajdy z jednej prezentacji do drugiej.

{{% blocks/products/pf/agp/code-block title="Kod Pythona do łączenia wielu plików PPSX w jeden plik XPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak połączyć PPSX z XPS za pomocą Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Oto kroki, aby połączyć dwa pliki PPSX i zapisać wynik jako XPS w Pythonie." >}}
