---
title: Scal pliki PPSM do POTX za pomocą Pythona
url: /pl/python-net/merge/ppsm-to-potx/
...
{{% blocks/products/pf/feature-page-section  h2="Scal pliki PPSM do POTX za pomocą Pythona" %}}
Aby scalić prezentacje PowerPoint, musisz sklonować slajdy z jednej prezentacji do drugiej.

{{% blocks/products/pf/agp/code-block title="Kod Pythona do łączenia wielu plików PPSM w jeden plik POTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak połączyć PPSM z POTX za pomocą Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Oto kroki, aby połączyć dwa pliki PPSM i zapisać wynik jako POTX w Pythonie." >}}
