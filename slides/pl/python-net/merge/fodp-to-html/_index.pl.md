---
title: Scal pliki FODP do HTML za pomocą Pythona
url: /pl/python-net/merge/fodp-to-html/
...
{{< blocks/products/pf/feature-page-header h1="Scal pliki FODP do HTML razem w Pythonie" h2="Szybki i wieloplatformowy interfejs API Pythona, który pomaga w tworzeniu aplikacji z możliwością tworzenia, scalania, sprawdzania lub konwertowania plików prezentacji Microsoft PowerPoint i OpenOffice bez użycia jakiegokolwiek oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Scal FODP do HTML w Pythonie" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Scal pliki FODP do HTML za pomocą Pythona" %}}
Aby scalić prezentacje PowerPoint, musisz sklonować slajdy z jednej prezentacji do drugiej.

{{% blocks/products/pf/agp/code-block title="Kod Pythona do łączenia wielu plików FODP w jeden plik HTML" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak połączyć FODP z HTML za pomocą Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Oto kroki, aby połączyć dwa pliki FODP i zapisać wynik jako HTML w Pythonie." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/pl/python-net/merge/fodp-to-pot/" name="FODP TO POT" >}}  
