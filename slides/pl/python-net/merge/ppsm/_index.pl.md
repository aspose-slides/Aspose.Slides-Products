---
title: Scal pliki PPSM za pomocą Pythona
url: /pl/python-net/merge/ppsm/
...
{{% blocks/products/pf/feature-page-section  h2="Scal pliki PPSM za pomocą Pythona" %}}
Aby scalić prezentacje PowerPoint, musisz sklonować slajdy z jednej prezentacji do drugiej.

{{% blocks/products/pf/agp/code-block title="Kod Pythona do łączenia wielu PPSM w jeden plik" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak scalić PPSM za pomocą Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Oto kroki, aby połączyć dwa pliki PPSM i zapisać wynik jako PPSM w Pythonie." >}}
