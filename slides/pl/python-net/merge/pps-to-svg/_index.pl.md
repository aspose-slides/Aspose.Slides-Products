---
title: Scal pliki PPS do SVG za pomocą Pythona
url: /pl/python-net/merge/pps-to-svg/
...
{{% blocks/products/pf/feature-page-section  h2="Scal pliki PPS do SVG za pomocą Pythona" %}}
Aby scalić prezentacje PowerPoint, musisz sklonować slajdy z jednej prezentacji do drugiej.

{{% blocks/products/pf/agp/code-block title="Kod Pythona do łączenia wielu plików PPS w jeden plik SVG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak połączyć PPS z SVG za pomocą Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Oto kroki, aby połączyć dwa pliki PPS i zapisać wynik jako SVG w Pythonie." >}}
