---
title: Scal obrazy JPG w Pythonie
url: /pl/python-net/merge/jpg-to-jpg/
keywords: Scal JPG, JPEG do JPG, Dołącz do JPG, Połącz JPG, Python API, Python Library
description: Połącz JPG z JPG w Pythonie. Użyj interfejsu API biblioteki Pythona, aby połączyć pliki JPG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Połącz JPG w Pythonie" h2="Szybka i wieloplatformowa biblioteka Pythona do łączenia obrazów JPG przy użyciu kodu Pythona" >}}

{{% blocks/products/pf/feature-page-section h2="Połącz JPG z JPG za pomocą Aspose.Slides" %}}

[**Aspose.Slides dla Pythona przez .NET**](https://products.aspose.com/slides/pl/python-net/) to potężna biblioteka Pythona używana do łączenia i manipulowania prezentacjami, obrazami i innymi plikami. Łącząc JPG z JPG, skutecznie łączysz dwa obrazy, aby uzyskać jedno zdjęcie.
...
{{% blocks/products/pf/feature-page-section  h2="Połącz JPG z JPG w Pythonie" %}}
Używając [**Aspose.Slides for Python przez .NET**](https://products.aspose.com/slides/pl/python-net/), możesz szybko scalać pliki JPG za pomocą zaledwie kilku linii kodu

{{% blocks/products/pf/agp/code-block title="Kod Pythona do łączenia JPG z JPG" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="Jak scalić JPG w Pythonie" >}}
