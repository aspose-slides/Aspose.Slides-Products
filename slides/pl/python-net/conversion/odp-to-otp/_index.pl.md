...
weight: 290
url: /pl/python-net/conversion/odp-to-otp/ 
keywords: "Convert, PowerPoint, ODP, OTP, Presentation, Python"
description: Przykładowy kod do konwersji ODP na OTP Python. Użyj PowerPoint Python API do wsadowej konwersji plików ODP na pliki OTP.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj ODP na OTP w Pythonie" h2="Potężna biblioteka PowerPoint Python do konwersji ODP na OTP" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Konwertuj ODP na OTP w Pythonie" %}}

Chcesz programowo przekonwertować pliki ODP na OTP? Używając [*Aspose.Slides for Python przez .NET*](https://products.aspose.com/slides/pl/python-net/) każdy programista może przekonwertować ODP na format OTP za pomocą zaledwie kilku wierszy kodu Pythona.

Jako nowoczesny interfejs API do przetwarzania prezentacji, Aspose.Slides for Python szybko tworzy OTP z ODP. Przetestuj jakość konwersji ODP na OTP bezpośrednio w [przeglądarce](https://products.aspose.app/slides/conversion). Biblioteka Aspose PowerPoint PPTX umożliwia konwersję plików ODP do wielu popularnych formatów.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak przekonwertować ODP na OTP w Pythonie?" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Oto kroki, aby przekonwertować plik ODP na OTP za pomocą Pythona." >}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję ODP do OTP w Pythonie" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz ODP jako OTP w Pythonie" %}}
Skorzystaj z bezpłatnej aplikacji, aby zobaczyć demonstrację procesu konwersji ODP na OTP. 
{{% /blocks/products/pf/agp/content %}}
