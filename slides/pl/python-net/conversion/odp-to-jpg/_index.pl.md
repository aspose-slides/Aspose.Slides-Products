...
weight: 280
url: /pl/python-net/conversion/odp-to-jpg/ 
keywords: "Convert, PowerPoint, ODP, JPG, Presentation, Python"
description: Przykładowy kod do konwersji ODP na JPG w Pythonie. Użyj PowerPoint Python API do wsadowej konwersji plików ODP na pliki JPG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj ODP na JPG w Pythonie" h2="Potężna biblioteka PowerPoint Python do konwersji ODP na JPG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Konwertuj ODP na JPG w Pythonie" %}}

Chcesz programowo przekonwertować pliki ODP na JPG? Używając [*Aspose.Slides for Python via .NET*](https://products.aspose.com/slides/pl/python-net/) każdy programista może przekonwertować ODP na format JPG za pomocą zaledwie kilku linijek kodu Pythona.

Jako nowoczesny interfejs API do przetwarzania prezentacji, Aspose.Slides for Python szybko tworzy JPG z ODP. Przetestuj jakość konwersji ODP do JPG bezpośrednio w [przeglądarce](https://products.aspose.app/slides/conversion/ppt-to-jpg). Biblioteka Aspose PowerPoint PPTX umożliwia konwersję plików ODP do wielu popularnych formatów.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak przekonwertować ODP na JPG w Pythonie?" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Oto kroki, aby przekonwertować plik ODP na JPG za pomocą Pythona." >}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję ODP do JPG w Pythonie" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz ODP jako JPG w Pythonie" %}}
Skorzystaj z bezpłatnej aplikacji, aby zobaczyć demonstrację procesu konwersji ODP do JPG. 
{{% /blocks/products/pf/agp/content %}}
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        ...
        sectionTitle="Darmowa aplikacja do konwersji ODP do JPG" 
