---
title: Konwertuj ODP na PPTX w Pythonie
weight: 400
url: /pl/python-net/conversion/odp-to-pptx/ 
keywords: "Convert, PowerPoint, ODP, PPTX, Presentation, Python"
description: Przykładowy kod do konwersji ODP na PPTX w Pythonie. Użyj PowerPoint Python API do wsadowej konwersji plików ODP do plików PPTX.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj ODP na PPTX w Pythonie" h2="Potężna biblioteka PowerPoint Python do konwersji ODP na PPTX" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Konwertuj ODP na PPTX w Pythonie" %}}

Chcesz programowo przekonwertować pliki ODP na PPTX? Używając [*Aspose.Slides for Python przez .NET*](https://products.aspose.com/slides/pl/python-net/) każdy programista może przekonwertować ODP na format PPTX za pomocą zaledwie kilku linijek kodu Pythona.
...
{{< blocks/products/pf/agp/feature-section-col title="Jak przekonwertować ODP na PPTX w Pythonie?" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Oto kroki, aby przekonwertować plik ODP na PPTX za pomocą Pythona." >}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję ODP do PPTX w Pythonie" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz ODP jako PPTX w Pythonie" %}}
Skorzystaj z bezpłatnej aplikacji, aby zobaczyć demonstrację procesu konwersji ODP na PPTX. 
{{% /blocks/products/pf/agp/content %}}
