...
{{% blocks/products/pf/agp/code-block title="Zmodyfikuj wbudowane właściwości OTP – Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Dodaj niestandardowe właściwości do OTP – Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak wyodrębnić metadane OTP przez Python" >}}
