...
{{% blocks/products/pf/agp/code-block title="Zmodyfikuj wbudowane właściwości POTX – Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Dodaj niestandardowe właściwości do POTX – Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Jak wyodrębnić metadane POTX przez Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Oto kroki, aby wyodrębnić metadane z plików POTX." >}}
