---
title: Convert OTP to POT via Java 
weight: 8770
url: /java/conversion/otp-to-pot/ 
description: Sample Java conversion code for OTP format to POT file. Use this example code to export PowerPoint & OpenOffice presentations to POT within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert OTP to POT via Java" h2="OTP to POT Java conversion to convert single or multiple pages to POT using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="POT" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTP" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert OTP to POT Using Java" %}}

 In order to render OTP to POT, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert OTP to POT via Java" %}}
