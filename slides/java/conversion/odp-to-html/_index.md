---
title: Convert ODP to HTML via Java 
weight: 710
url: /java/conversion/odp-to-html/ 
description: Sample Java conversion code for ODP format to HTML file. Use this example code to export PowerPoint & OpenOffice presentations to HTML within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert ODP to HTML via Java" h2="ODP to HTML Java conversion to convert single or multiple pages to HTML using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert ODP to HTML Using Java" %}}

 In order to render ODP to HTML, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert ODP to HTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Slides API makes it easy for the developers to convert ODP file to HTML in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="ODP to HTML Java Conversion Source Code" offSpacer="" %}}
