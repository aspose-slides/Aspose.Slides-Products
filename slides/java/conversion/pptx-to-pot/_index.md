...
{{% blocks/products/pf/agp/content h2="How to Convert PPTX to POT Using Java" %}}

 In order to render PPTX to POT, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PPTX to POT via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="PPTX to POT Java Conversion Source Code" offSpacer="" %}}
