---
title: Convert POTX to PPTX via Java 
weight: 6870
url: /java/conversion/potx-to-pptx/ 
description: Sample Java conversion code for POTX format to PPTX file. Use this example code to export PowerPoint & OpenOffice presentations to PPTX within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert POTX to PPTX via Java" h2="POTX to PPTX Java conversion to convert single or multiple pages to PPTX using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert POTX to PPTX Using Java" %}}

 In order to render POTX to PPTX, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert POTX to PPTX via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="POTX to PPTX Java Conversion Source Code" offSpacer="" %}}
