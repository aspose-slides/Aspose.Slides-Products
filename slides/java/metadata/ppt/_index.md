---
title: Edit or View PPT Files Metadata via Java 
weight: 5810
...
{{% blocks/products/pf/agp/content h2="How to Extract PPT Metadata Using Java" %}}

 In order to get PPT file metadata, weвЂ™ll use
