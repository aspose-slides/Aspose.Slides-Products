---
title: View or Edit POT Files Metadata via .NET 
weight: 6520
...
{{< blocks/products/pf/upper-banner h1="Extract POT Metadata via .NET" h2="Build your own .NET apps to add, edit, remove or extract metadata from POT files using server-side APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="How to Extract POT Metadata Using C#" %}}

 In order to extract POT metadata, we’ll use
