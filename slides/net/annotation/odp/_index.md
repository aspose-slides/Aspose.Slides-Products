---
title: Remove ODP Annotation via .NET 
weight: 1370
url: /net/annotation/odp/ 
description: Try our On-Premise document annotation APIs to delete ODP format annotations on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Remove Comments & Comment Authors from ODP via C#" h2="Build your own .NET apps to manipulate comments & authors in document files using server-side APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="How to Annotate ODP File Using C#" %}}

 In order to annotate ODP file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Remove Comments from ODP via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Delete Annotations from ODP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/net/annotation/pptx" name="PPTX" description="Open XML presentation Format" >}}
