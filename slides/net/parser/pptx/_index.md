...
weight: 8590
url: /net/parser/pptx/ 
description: Try our On-Premise document parser APIs to extract text and images from PPTX file on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms.
---
