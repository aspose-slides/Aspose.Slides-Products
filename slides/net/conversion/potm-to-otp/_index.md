---
title: Convert POTM to OTP via C# 
weight: 8100
url: /net/conversion/potm-to-otp/ 
description: Sample code for POTM to OTP C# conversion. Use API example code for batch POTM files to OTP conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET developers can easily load & convert POTM files to OTP in just a few lines of code." >}}
