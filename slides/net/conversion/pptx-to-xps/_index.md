...
{{< blocks/products/pf/upper-banner h1="Convert PPTX to XPS via C#" h2="Export PowerPointВ® PPTX files to XPS on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms" logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/slides/272x272/aspose_slides-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName=".NET C# Code for PPTX to XPS Conversion" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Convert PPTX to XPS via C#" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET C# Code for PPTX to XPS Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/faq imgSrc="https://www.aspose.com/templates/brand/images/slides/aspose_slides-brand.png" >}}
    ...
    {{< blocks/products/pf/agp/faq-item question="Can I convert PPTX to XPS via Java & C++?" answer="Aspose.Slides is available for all major programming environments. Checkout [Java](https://products.aspose.com/slides/java/conversion/pptx-to-xps) and [C++](https://products.aspose.com/slides/cpp/conversion/pptx-to-xps) source code snippets for PPTX to XPS conversion." >}}
    {{< blocks/products/pf/agp/faq-item question="Can I convert PPTX to XPS on other platforms?" answer="You can execute the code with .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms." >}}
    {{< blocks/products/pf/agp/faq-item question="I do not have time to set up. Do you have a quick demo that I can try?" answer="Indeed. Try [PPTX to XPS Conversion Demo](https://products.aspose.app/slides/conversion/pptx-to-xps) to quickly check the conversion results." >}}
 
{{< /blocks/products/pf/agp/faq >}}

<!-- aboutfile Starts -->

{{< blocks/products/pf/agp/demobox sectionTitle="[Free Online App for PPTX to XPS Conversion](https://products.aspose.app/slides/conversion/pptx-to-xps)" sectionDescription="" >}}
