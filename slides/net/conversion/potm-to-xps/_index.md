---
title: Convert POTM to XPS via C# 
weight: 110
url: /net/conversion/potm-to-xps/ 
description: Sample code for POTM to XPS C# conversion. Use API example code for batch POTM files to XPS conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert POTM to XPS via C#" h2="Export PowerPoint® POTM files to XPS on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Slides makes it easy for the developers to load & convert POTM files to XPS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows POTM to XPS C# Conversion" offSpacer="" %}}
