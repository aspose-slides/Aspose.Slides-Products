---
title: Convert PPT to ODP via C# 
weight: 630
url: /net/conversion/ppt-to-odp/ 
description: Sample code for PPT to ODP C# conversion. Use API example code for batch PPT files to ODP conversion within VB.NET, Asp.NET or any .NET based application.
---
