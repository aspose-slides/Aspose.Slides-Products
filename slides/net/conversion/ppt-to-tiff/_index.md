---
title: Convert PPT to TIFF via .NET 
weight: 6740
...
{{< blocks/products/pf/upper-banner h1="Convert PPT to TIFF via C#" h2="Export PowerPoint® PPT files to TIFF on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Export PowerPoint" %}}
 ...
 In order to convert PPT to TIFF, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PPT to TIFF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Slides makes it easy for the developers to load & convert PPT files to TIFF in just a few lines of code.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PPT to TIFF" sectionDescription="Check our live demos for [PPT to TIFF conversion](https://products.aspose.app/slides/conversion/ppt-to-tiff) with following benefits." >}}
    ...
    {{% blocks/products/pf/agp/content h2="How to Convert PPT to TIFF Using C#" %}}
