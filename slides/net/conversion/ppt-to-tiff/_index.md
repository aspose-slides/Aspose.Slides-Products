---
title: Convert PPT to TIFF via C# 
weight: 6740
url: /net/conversion/ppt-to-tiff/ 
description: Sample code for PPT to TIFF C# conversion. Use API example code for batch PPT files to TIFF conversion within VB.NET, Asp.NET or any .NET based application.
---
