---
title: Convert POT to PPTX via C# 
weight: 4450
url: /net/conversion/pot-to-pptx/ 
description: Sample code for POT to PPTX C# conversion. Use API example code for batch POT files to PPTX conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert POT to PPTX via C#" h2="Export PowerPoint® POT files to PPTX on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POT" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET developers can easily load & convert POT files to PPTX in just a few lines of code." >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows POT to PPTX C# Conversion" offSpacer="" %}}
