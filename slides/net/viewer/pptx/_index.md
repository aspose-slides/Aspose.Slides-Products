...
weight: 6390
url: /net/viewer/pptx/ 
description: Try our On-Premise APIs to load, render and display PPTX documents on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="PPTX File Viewer for .NET" h2="View presentation files such as PPTX without Microsoft PowerPoint or Office Automation" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="How to View PPTX File Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to View PPTX via C#" %}}
...
1.  Instantiate a Presentation object & load the PPTX file
...
1.  Save the PPTX presentation in HTML format
1.  Call Process.Start with path to resultant HTML to load PPTX content in default browser
