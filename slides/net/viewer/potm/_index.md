...
weight: 8750
url: /net/viewer/potm/ 
description: Try our On-Premise APIs to load, render and display POTM documents on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="POTM File Viewer for .NET" h2="View presentation files such as POTM without Microsoft PowerPoint or Office Automation" logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/slides/272x272/aspose_slides-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/slides/net" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Slides makes it easy for the developers to view the POTM file with just few lines of code.

{{% /blocks/products/pf/agp/text %}}

1.  Instantiate a Presentation object & load the POTM file
...
1.  Save the POTM presentation in HTML format
1.  Call Process.Start with path to resultant HTML to load POTM content in default browser
...
{{% blocks/products/pf/agp/code-block title="View POTM - C#" offSpacer="" %}}
