...
description: 在 PHP 中将图像合并到图像。使用 PHP 库 API 组合图像
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 PHP 中合并图像" h2="用于使用 PHP 代码合并图像的高速跨平台 PHP 库" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 将图像合并到图像" %}}

[**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/zh/php-java/) 是一个功能强大的 PHP 库，用于合并和操作演示文稿、图像和其他文件。将图像合并到图像时，实际上是将两幅图像组合成一张照片。
...
{{% blocks/products/pf/feature-page-section  h2="在 PHP 中将图像合并到图像" %}}
使用 [**Aspose.Slides for PHP via Java**](https://products.aspose.com/slides/zh/php-java/)，只需几行代码即可快速合并图像文件

{{% blocks/products/pf/agp/code-block title="用于将图像合并到图像的 PHP 代码" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="如何在 PHP 中合并图像" >}}
