...
weight: 5960
url: /zh/android-java/ 
description: Aspose.Slides for Android API 或 Android PowerPoint API 在 Android 上创建读取和操作 PPT POT PPS PPTX POTX PPSX PowerPoint。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="安卓 PowerPoint API" h2="在 Android 应用程序中创建、修改、转换、合并、拆分和管理 PowerPoint 演示文稿。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-android-java.svg" pfName="Aspose.Slides" subTitlepfName="for Android via Java" downloadUrl="https://downloads.aspose.com/slides/androidjava" >}}
...
<p>
 Aspose.Slides for Android via Java 是适用于 Android 应用程序的 PowerPoint API。开发人员可以执行广泛的演示文稿处理任务，包括阅读、编写、修改、合并、拆分、转换和操作演示文稿，而无需依赖 Microsoft PowerPoint。
</p>

<p>
 Aspose.Slides for Android via Java 支持几乎所有原生 PowerPoint 文件格式以及 OpenOffice 演示文稿格式 (ODP)。创建适用于 Android 的 PowerPoint 查看器应用程序，以及转换器、编辑器或任何其他应用程序。 SmartArt 形状、MSO 图表、ActiveX 组件和 OLE 框架对象等演示元素可以通过 PowerPoint API 进行访问以进行管理和操作。
</p>
...
{{< blocks/products/pf/carousel-item h3="平台独立性" description="Aspose.Slides for Android API 涵盖以下 Android 开发环境和部署平台。" >}}
<div class="diagram1 d1-android">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Aspose.Slides for Android API 支持原生 [PowerPoint 格式](https://docs.aspose.com/slides/java/supported-file-formats/) 和多种转换格式。" >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     将 Microsoft Excel 图表添加为 OleObjects
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    ...
    <p>
     PowerPoint 库可以轻松处理文本和形状格式设置功能，例如字体大小、类型、颜色和阴影、段落对齐、项目符号和方向以及超链接。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     API 提供到 TIFF 和 PDF 的转换并附有注释。开发人员可以将 Notes Slide 视图中的整个演示文稿转换为支持的格式，并且对于图像，可以在 Notes Slide 视图中为单个幻灯片创建幻灯片缩略图。这是 TIFF 转换代码。
    </p>
...
pres.save(dataDir + "TestNotes.tiff", SaveFormat.Tiff,opts);
   ...
   <div class="col-lg-12">
    ...
    <p>
     API 能够处理所有演示幻灯片元素，包括矩形、表格、文本框、椭圆、折线、图片框、自动形状、音频框、OLE 对象框和视频框。 API 还提供了一组丰富的 API 命令来操作这些元素中的每一个。此外，通过一组精心设计的类支持文本格式。
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="文档" href="https://docs.aspose.com/slides/androidjava/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="为什么 Aspose.Slides for Android 通过 Java？" tabId="success-stories" >}}
