...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Aspose.Slides for Xamarin 支持下面列出的流行 [演示文稿格式](https://docs.aspose.com/display/slidesnet/Supported+File+Formats) 和导出格式。" >}}
