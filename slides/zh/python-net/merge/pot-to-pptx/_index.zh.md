---
title: 使用 Python 将 POT 文件合并到 PPTX
url: /zh/python-net/merge/pot-to-pptx/
keywords: 将 POT 合并到 PPTX，将 POT 连接到 PPTX，将 POT 合并到 PPTX，PowerPoint，演示文稿，PPTX，Python，Aspose
...
{{< blocks/products/pf/feature-page-header h1="在 Python 中将 POT 文件合并到 PPTX" h2="高速和跨平台的 Python API，有助于开发应用程序，无需使用 Microsoft 或 Open Office、Adobe PDF 等任何软件即可创建、合并、检查或转换 Microsoft PowerPoint 和 OpenOffice 演示文件。" >}}

{{% blocks/products/pf/feature-page-section h2="在 Python 中将 POT 合并到 PPTX" %}}
...
{{% blocks/products/pf/feature-page-section  h2="使用 Python 将 POT 文件合并到 PPTX" %}}
要合并 PowerPoint 演示文稿，您需要将幻灯片从一个演示文稿克隆到另一个演示文稿。

{{% blocks/products/pf/agp/code-block title="用于将多个 POT 合并为单个 PPTX 文件的 Python 代码" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="如何使用 Aspose.Slides for Python API 将 POT 合并到 PPTX" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="这些是在 Python 中合并两个 POT 文件并将结果保存为 PPTX 的步骤。" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/zh/python-net/merge/pot-to-potm/" name="POT TO POTM" >}}  
