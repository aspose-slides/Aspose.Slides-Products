---
title: 使用 Python 将 PPTX 文件合并到 HTML
url: /zh/python-net/merge/pptx-to-html/
keywords: 将 PPTX 合并到 HTML，将 PPTX 连接到 HTML，将 PPTX 合并到 HTML，PowerPoint，演示文稿，HTML，Python，Aspose
...
{{< blocks/products/pf/feature-page-header h1="在 Python 中将 PPTX 文件合并到 HTML" h2="高速和跨平台的 Python API，有助于开发应用程序，无需使用 Microsoft 或 Open Office、Adobe PDF 等任何软件即可创建、合并、检查或转换 Microsoft PowerPoint 和 OpenOffice 演示文件。" >}}

{{% blocks/products/pf/feature-page-section h2="在 Python 中将 PPTX 合并到 HTML" %}}
...
{{% blocks/products/pf/feature-page-section  h2="使用 Python 将 PPTX 文件合并到 HTML" %}}
要合并 PowerPoint 演示文稿，您需要将幻灯片从一个演示文稿克隆到另一个演示文稿。

{{% blocks/products/pf/agp/code-block title="用于将多个 PPTX 合并为单个 HTML 文件的 Python 代码" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="如何使用 Aspose.Slides for Python API 将 PPTX 合并到 HTML" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="这些是在 Python 中合并两个 PPTX 文件并将结果保存为 HTML 的步骤。" >}}
