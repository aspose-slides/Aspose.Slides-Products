---
title: 在 Python 中将 TIFF 合并为 PDF
url: /zh/python-net/merge/tiff-to-pdf/
keywords: TIFF 到 PDF，合并 TIFF 到 PDF，将 TIFF 加入 PDF，PDF，TIFF，Python API，Python 库
description: 在 Python 中将 TIFF 合并为 PDF。使用 Python 库 API 结合 TIFF 和 PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 Python 中将 TIFF 合并为 PDF" h2="用于使用 Python 代码将 TIFF 合并为 PDF 文件的高速跨平台 Python 库" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 将 TIFF 合并为 PDF" %}}

[**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/zh/python-net/) 是一个强大的 Python 库，用于创建、转换、合并和操作演示文稿、PDF 、图像和其他文件。当您将 TIFF 合并为 PDF 时，您实际上是在组合图像以获得单个 PDF 文件。
...
{{% blocks/products/pf/feature-page-section  h2="在 Python 中将 TIFF 合并为 PDF" %}}
使用 [**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/zh/python-net/)，只需几行代码即可将 TIFF 快速合并为 PDF

{{% blocks/products/pf/agp/code-block title="将 TIFF 合并为 PDF 的 Python 代码" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="如何在 Python 中将 TIFF 合并为 PDF" >}}
