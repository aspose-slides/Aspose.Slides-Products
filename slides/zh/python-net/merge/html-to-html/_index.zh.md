---
title: 在 Python 中合并 HTML 文件
url: /zh/python-net/merge/html-to-html/
keywords: 合并 HTML、HTML 到 HTML、加入 HTML、合并 HTML、Python API、Python 库
description: 在 Python 中将 HTML 合并到 HTML。使用 Python 库 API 组合 HTML 文件
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 Python 中合并 HTML" h2="用于使用 Python 代码合并 HTML 文件的高速跨平台 Python 库" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 将 HTML 合并到 HTML" %}}

[**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/zh/python-net/) 是一个强大的 Python 库，用于创建、转换、合并和操作演示文稿、HTML文件和其他文件。将 HTML 合并到 HTML 时，实际上是将 2 个文档的内容合并为一个 HTML 文件。 Aspose.Slides 允许您以不同的方式合并 HTML 文档。您可以将 HTML 与其所有文本、格式、样式等合并。
...
{{% blocks/products/pf/feature-page-section  h2="在 Python 中将 HTML 合并为 HTML" %}}
使用 [**Aspose.Slides for Python via .NET**](https://products.aspose.com/slides/zh/python-net/)，只需几行代码即可快速合并 HTML 文件

{{% blocks/products/pf/agp/code-block title="将 HTML 合并为 HTML 的 Python 代码" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="如何在 Python 中合并 HTML" >}}
