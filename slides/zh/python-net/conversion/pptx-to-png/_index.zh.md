---
title: 在 Python 中将 PPTX 转换为 PNG
weight: 2740
url: /zh/python-net/conversion/pptx-to-png/ 
keywords: "Convert, PowerPoint, PPTX, PNG, Presentation, Python"
description: PPTX 到 PNG Python 转换的示例代码。使用 PowerPoint Python API 将 PPTX 文件批量转换为 PNG 文件。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="在 Python 中将 PPTX 转换为 PNG" h2="强大的 PowerPoint Python 库，用于将 PPTX 转换为 PNG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{< blocks/products/pf/agp/feature-section-col title="如何在 Python 中将 PPTX 转换为 PNG" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="这些是使用 Python 将 PPTX 文件转换为 PNG 的步骤。" >}}
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 PPTX 到 PNG Python 转换" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="在 Python 中将 PPTX 保存为 PNG" %}}
使用免费应用程序查看 PPTX 到 PNG 转换过程的演示。 
{{% /blocks/products/pf/agp/content %}}
