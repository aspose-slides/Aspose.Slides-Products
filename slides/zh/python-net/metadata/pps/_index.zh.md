---
title: 使用 Python 查看或编辑 PPS 文件元数据
url: /zh/python-net/metadata/pps/
keywords: 编辑 PPS 元数据，查看 PPS 元数据，编辑 PPS 属性，查看 PPS 属性
description: Python 源代码，用于编辑或查看 PPS 格式元数据。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="使用 Python 编辑 PPS 属性" h2="构建您自己的 Python 应用程序，以使用服务器端 API 修改演示文稿文件中的内置和自定义属性。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPS" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" fileiconsmall4="POT" fileiconsmall5="ppsx" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for Python via .NET" >}}

{{% blocks/products/pf/feature-page-section  h2="通过 Python 修改 PPS 属性" %}}
...
{{% blocks/products/pf/agp/code-block title="修改 PPS 内置属性 - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="将自定义属性添加到 PPS - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="如何通过 Python 提取 PPS 的元数据" >}}
