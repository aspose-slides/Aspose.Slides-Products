...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Aspose.Slides for .NET Core 支持流行的 [演示格式](https://docs.aspose.com/slides/net/supported-file-formats/) 和下面列出的导出格式。" >}}
