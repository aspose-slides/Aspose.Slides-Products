...
weight: 5190
url: /zh/net-core/ 
description: Aspose.Slides .NET Core API 用于构建 PowerPoint .NET Core 解决方案。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="用于演示的 .NET Core API" h2="构建跨平台 .NET Core 解决方案，无需 PowerPoint 和 Office 自动化即可处理演示文稿。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-net-core.svg" pfName="Aspose.Slides" subTitlepfName="for .NET Core" downloadUrl="https://downloads.aspose.com/slides/net" >}}
...
<p>
 Aspose.Slides for .NET Core 用于在任何操作系统上创建演示处理解决方案：Windows、Linux 或 macOS。创建和更改演示文稿及其元素：文本、表格、图表、媒体、动画、SmartArts 和 ActiveX 元素。
</p>

<p>
 使用演示文稿查看器、创建器、转换器、编辑器、模板构造器、管理器、合并器、比较器、拆分器、打印机、保护器等扩展您的应用程序。允许 C# 应用程序修改任何演示内容：文本、表格、图表、媒体、SmartArts、ActiveX。
</p>

<p>
 Aspose.Slides 的 .NET Core PowerPoint API 是避免代码重复和使用 .NET Core 平台所有功能的独特机会。 API 独立于 PowerPoint 或 Open Office 工作，不需要它们。
</p>
...
{{< blocks/products/pf/carousel-item h3="乍看上去" description="Aspose.Slides 对 .NET Core PowerPoint API 的功能概述。" >}}
...
{{< blocks/products/pf/carousel-item h3="平台独立性" description="适用于 Windows、Linux 和 macOS 的 .NET Core 的 Aspose.Slides。" >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <!--/left-->
  <!--/right-->
...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Aspose.Slides for .NET Core 支持流行的 [演示格式](https://docs.aspose.com/display/slidesnet/Supported+File+Formats) 和下面列出的导出格式。" >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Slides for .NET Core API 可以将任何 PowerPoint 演示文稿格式转换为文档、图像、Web 或文件格式。一些流行的转换格式是：PDF、HTML、JPEG、XPS。演示格式也可以相互转换（例如 PPT 到 PPTX、PPTX 到 ODP），或转换为模板格式（例如 PPTX 到 POTM）、幻灯片格式（例如 PPTX 到 PPSX），反之亦然。由于 Aspose.Slides 为 PowerPoint .NET Core API 开发的渲染引擎，转换后的文件质量最高。您可以确保在任何操作系统上转换任何演示文稿：Windows、Linux 或 macOS。
    </p>
...
prs.Save(dir + "output.tiff", Aspose.Slides.Export.SaveFormat.Tiff);</code></pre>
   ...
   <div class="col-lg-12">
    ...
    <p>
     使用 Aspose.Slides for .NET Core，您可以修改演示文稿的逻辑和外观。所有文本内容都可以通过文本、段落、部分、表格、注释、注释、数学符号等元素进行编辑。 2D、3D 效果和动画可用于形状、图表、SmartArts、WordArts。可以使用模板、主题、幻灯片母版、幻灯片布局来创建演示文稿设计。媒体、水印、ActiveX 也可以通过 Aspose.Slides 的 PowerPoint .NET Core API 访问。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     在 .NET Core 中合并、比较、拆分、打印演示文稿
    </h2>
    <p>
     Aspose.Slides for .NET Core 支持 PowerPoint 和其他第三方演示软件未提供的许多附加功能。其中包括比较演示文稿和模板、根据自定义逻辑拆分演示文稿、合并各种格式的演示文稿、将模板合并/应用为一组演示文稿、打印演示文稿等。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for .NET Core 不需要在机器上安装 Microsoft Office 或 Microsoft PowerPoint 即可使用 PowerPoint 格式。在支持的功能、安全性、稳定性、可扩展性、速度和价格方面，它是一个完美的 Microsoft Office 自动化替代方案。
    </p>
   </div>
   <!--<div class="col-lg-12">

<h2 class="h2title">支持 Office Open XML</h2>

<p>Office OpenXML (OOXML) 是 Microsoft Office 2007 中引入的基于 XML 的格式。</p>

<p>PresentationML (OOXML, PPTX) 是 Microsoft Office PowerPoint 2007 用来存储其文档的标记语言。 Aspose.Slides for .NET 广泛支持创建、读取、操作和编写 PresentationML 文档。</p>
