...
weight: 5890
url: /zh/nodejs-java/ 
description: Aspose.Slides for Node.js via Java 是一个 Node.js PowerPoint API，可让您在 Node.js 中创建、修改和转换 PowerPoint 演示文稿。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1="用于演示的 Node.js PowerPoint API" h2="使用 Node.js 创建、阅读、修改和转换 PowerPoint 和 OpenOffice 演示文稿，无需任何外部软件。" logoImageSrc="https://products.aspose.com/slides/zh/images/aspose_slides-for-nodejs-via-java-header.svg" pfName="Aspose.Slides" subTitlepfName="for Node.js via Java" downloadUrl="https://releases.aspose.com/slides/nodejs-java/" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="for Node.js via Java" >}}

{{< blocks/products/pf/sub-menu logoImageSrc="https://products.aspose.com/slides/zh/images/aspose_slides-for-nodejs-via-java.svg" liveDemosLink="https://products.aspose.app/slides/family/" PricingLink="https://purchase.aspose.com/pricing/slides/nodejs-java/" buyLink="https://purchase.aspose.com/buy" docsLink="https://docs.aspose.com/slides/nodejs-java/" installationsDocsLink="https://docs.aspose.com/slides/nodejs-java/installation/" nugetLink="" nugetPackageName="" mavenRepoLink="" directDownloadLink="https://releases.aspose.com/slides/nodejs-java/" >}}

{{< blocks/products/pf/tab-content >}}

<p><strong>Aspose.Slides for Node.js via Java</strong> 是一个 Node.js 库，可让您在 Node.js 中创建、修改和转换 PowerPoint 演示文稿。它支持所有演示元素，例如幻灯片、形状、文本、图表、表格、图像等。它还提供许多高级功能，例如合并、克隆、拆分、比较和打印演示文稿。它的工作没有任何依赖性，可以在短时间内处理数千个演示文稿。</p>
...
<p>Node.js 是一种流行的、免费的、开源的、跨平台的 JavaScript 运行时环境，允许开发人员在浏览器之外编写命令行工具和服务器端脚本。因此，<strong>Aspose.Slides</strong> 团队很自豪能够向 Node.js 社区提供<strong>Aspose.Slides for Node.js via Java</strong>。</p>
...
<div class="diagram1 d1-nodejs">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Node.js PowerPoint Processing APIs" src="https://products.aspose.com/slides/zh/images/aspose_slides-for-nodejs-via-java.svg"/>
...
{{< blocks/products/pf/carousel-item h3="平台独立性" description="Aspose.Slides for Node.js via Java 是基于 Node.js 的服务器端 JavaScript API。它可以在具有 JDK 1.8 或更高版本的 Windows、Unix/Linux 和 Mac 平台上运行。" >}}
<div class="diagram1 d1-nodejs">
 <div class="d1-row">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Presentation APIs for Node.js" src="https://products.aspose.com/slides/zh/images/aspose_slides-for-nodejs-via-java.svg"/>
  <header>
   Aspose.Slides
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Aspose.Slides for Node.js via Java 支持流行的[演示文稿格式](https://docs.aspose.com/slides/nodejs-java/supported-file-formats/) 和这些导出格式。" >}}
<div class="diagram1 d2 d1-nodejs">
 <div class="d1-row">
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li><b>图像：</b>JPEG、PNG、BMP、TIFF、GIF</li>
    <li>静止无功发生器</li>
    <li><b>网页：</b>HTML</li>
   </ul>
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="PowerPoint Presentation API" src="https://products.aspose.com/slides/zh/images/aspose_slides-for-nodejs-via-java.svg"/>
  <header>Aspose.Slides</header>
  <footer>
   <small>
    <em>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <ul>
      <li>Aspose.Slides for Node.js via Java 是基于 Node.js 的服务器端 JavaScript API。它可以在具有 JDK 1.8 或更高版本的 Windows、Unix/Linux 和 Mac 平台上运行。</li>
    </ul>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">如何安装</h2>
    <p>使用 <strong>NPM</strong> 从 <a href="https://www.npmjs.com/package/aspose.slides.via.java">NPM 软件包存储库安装用于演示处理的 Node.js 库：</a></p>
...
finally
{
    ...
    <div class="col-lg-12">
        <h2 class="h2title">如何在 Node.js 中从 PDF 导入演示文稿。将 PDF 转换为 PPT、将 PDF 转换为 PPTX、将 PDF 转换为 ODP</h2>
        <p>此 Node.js 代码演示了 PDF 到 PowerPoint 的转换过程：</p>
        <pre>
            <code class="javascript">
var aspose = aspose || {};
...
finally
{
    ...
    <div class="col-lg-12">
        ...
        <p>此 Node.js 代码向您展示如何使用默认选项将 PowerPoint PPT、PPTX 和 OpenOffice ODP 文档转换为 PDF 文档。生成的文件是具有最高质量水平的 PDF 文档</p>
        <pre>
            <code class="javascript">
var aspose = aspose || {};
...
finally
{
    ...
    <div class="col-lg-12">
        <h2 class="h2title">如何在 Node.js 中将 PowerPoint 转换为 JPG。将 PPT 转换为 JPG、将 PPTX 转换为 JPG、将 ODP 转换为 JPG</h2>
...
{{< blocks/products/pf/testimonials title="人们在说什么" subTitle="不要只相信我们的话。了解用户对 PowerPoint API 的评价。" caseStudiesLink="https://releases.aspose.com/corporate/case-studies/aspose.slides/" >}}

{{< blocks/products/pf/testimonials-quote >}}
<p class="first">
 我们发现 Aspose.Slides 易于使用并且在我们的服务器上运行良好。我们发现它们满足了动态生成文件的重要需求，从而将我们的业务范围扩展到传统的 Web 应用程序之外。
 <em>
...
{{< blocks/products/pf/testimonials-quote >}}
<p class="second">
 该产品的工作原理与广告中所宣传的一样，文档易于理解，支持论坛就是我们所需要的所有帮助。我们部署的最终解决方案大大超出了我们最初的预期。
 <em>
...
{{< blocks/products/pf/support-learning-resources >}}
    {{< blocks/products/pf/slr-tab tabTitle="学习资源" tabId="resources" >}}
        {{< blocks/products/pf/slr-element name="文档" href="https://docs.aspose.com/slides/nodejs-java/" >}}
        {{< blocks/products/pf/slr-element name="源代码" href="https://github.com/aspose-slides/" >}}
        {{< blocks/products/pf/slr-element name="API 参考" href="https://docs.aspose.com/slides/nodejs-java/api-reference/" >}}
    ...
    {{< blocks/products/pf/slr-tab tabTitle="产品支持" tabId="support" >}}
        ...
        {{< blocks/products/pf/slr-element name="发行说明" href="https://docs.aspose.com/slides/nodejs-java/release-notes/" >}}
    {{< /blocks/products/pf/slr-tab >}}

    {{< blocks/products/pf/slr-tab tabTitle="为什么通过 Java Aspose.Slides for Node.js？" tabId="success-stories" >}}
