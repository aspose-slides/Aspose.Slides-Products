...
url: /zh/cpp/merger/svg-to-png/
keywords: 将 SVG 合并到 PNG、将 SVG 合并到 PNG、将 SVG 合并到 PNG、将 SVG 合并到 PNG、C++ API、C++ 库
description: 在 C++ 中将 SVG 合并为 PNG。使用 C++ 库 API 合并 SVG 和 PNG 文件
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 C++ 中将 SVG 合并为 PNG" h2="用于使用 C++ 代码将 SVG 合并为 PNG 图像的高速跨平台 C++ 库" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 将 SVG 合并为 PNG" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/zh/cpp/) 是一个功能强大的 C++ 库，用于合并和操作演示文稿、图像和其他文件。当您将 SVG 合并到 PNG 时，您实际上是在组合 SVG 图像以获得 PNG 图片。
...
使用 [**Aspose.Slides for C++**](https://products.aspose.com/slides/zh/cpp/)，只需几行代码即可快速将 SVG 合并为 PNG 文件

{{% blocks/products/pf/agp/code-block title="将 SVG 合并为 PNG 的 C++ 代码" offSpacer="true" %}}
```cpp
