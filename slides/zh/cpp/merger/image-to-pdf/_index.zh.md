...
url: /zh/cpp/merger/image-to-pdf/
keywords: 图像到 PDF、合并图像到 PDF、将图像合并到 PDF、PDF、图像、C++ API、C++ 库
description: 在 C++ 中将图像合并为 PDF。使用 C++ 库 API 合并图像和 PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 C++ 中将图像合并为 PDF" h2="用于使用 C++ 代码将图像合并为 PDF 文件的高速跨平台 C++ 库" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 将图像合并为 PDF" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/zh/cpp/) 是一个功能强大的 C++ 库，用于创建、转换、合并和操作演示文稿、PDF、图像和其他文件。当您将图像合并为 PDF 时，您实际上是在组合图像以获得单个 PDF 文件。
...
使用 [**Aspose.Slides for C++**](https://products.aspose.com/slides/zh/cpp/)，只需几行代码即可快速将图像合并为 PDF
