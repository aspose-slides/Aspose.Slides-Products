...
url: /zh/cpp/merger/tiff-to-pdf/
keywords: TIFF 到 PDF、合并 TIFF 到 PDF、将 TIFF 合并到 PDF、PDF、TIFF、C++ API、C++ 库
description: 在 C++ 中将 TIFF 合并为 PDF。使用 C++ 库 API 合并 TIFF 和 PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 C++ 中将 TIFF 合并为 PDF" h2="用于使用 C++ 代码将 TIFF 合并为 PDF 文件的高速跨平台 C++ 库" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 将 TIFF 合并为 PDF" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/zh/cpp/) 是一个功能强大的 C++ 库，用于创建、转换、合并和操作演示文稿、PDF、图像和其他文件。当您将 TIFF 合并为 PDF 时，您实际上是在组合图像以获得单个 PDF 文件。
...
{{% blocks/products/pf/feature-page-section  h2="在 C++ 中将 TIFF 合并为 PDF" %}}
使用 [**Aspose.Slides for C++**](https://products.aspose.com/slides/zh/cpp/)，只需几行代码即可快速将 TIFF 合并为 PDF

{{% blocks/products/pf/agp/code-block title="将 TIFF 合并为 PDF 的 C++ 代码" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="如何在 C++ 中将 TIFF 合并为 PDF" >}}
