...
<p class="col-lg-10">将 Excel 图表作为 OLE 对象嵌入到幻灯片中</p>

</div>

<div class="col-lg-4"><em class="fa fa-print  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">管理链接的 Ole 对象</p>
...
<h2 class="h2title">新功能的持续集成</h2>

<p>您永远不会局限于现有功能。我们的产品团队不断添加越来越多的功能，并且与旧版本相比，每个新版本都提供了更多功能。如果您发现缺少任何所需的功能，您也可以发送新功能请求。以下是最新功能的一些精选列表。</p>

<ul>

<li>没有文本的形状的光栅化或矢量化。</li>

<li>将 SVG 图像转换为形状。</li>

<li>获取默认的表格背景。</li>

<li>打开文档时限制本地文件系统访问。</li>

<li>保存到 HTML 时添加编码元标记。</li>

<li>保存为 HTML 时删除 SVG 标签的宽度和高度属性的设置。</li>

<li>Support for

<ul>

<li>评论回复、Office 365 和外部 Excel 工作簿。</li>

<li>大小代表气泡图的属性。</li>

<li>在生成的 PPT 中隐藏左侧幻灯片缩略图窗格。</li>

<li>漏斗图、2D 地图图表和设置图表外部数据源工作簿路径。</li>

<li>OpenDocument 加密、变形转换和文本荧光笔功能。</li>
...
<li>渲染形状软边缘（EffectFormat）效果。</li>

<li>数据透视表上的 ChartData SetRange。</li>

</ul>

</li>

<li>实现多页 Tiff 格式、Metafile Format Plus Extensions (EMF+) 和 Strict Open XML 格式。</li>

<li>以 ODP 格式呈现没有作者的评论。</li>

<li>使用严格的 Open XML 格式合规性实施序列化。</li>
...
<h2 class="h2title">SmartArt 形状处理</h2>

<p>Aspose.Slides for C++ 有助于从头开始创建 SmartArt 形状，并提供从幻灯片中访问、操作或删除现有 SmartArt 形状的能力。此外，还可以格式化 SmartArt 形状，例如设置样式、颜色和布局。</p>
...
{{< blocks/products/pf/slr-element name="发行说明" href="https://releases.aspose.com/slides/cpp/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
