...
url: /zh/cpp/conversion/html-to-pptx/
keywords: 将 HTML 转换为 PPTX、将 HTML 转换为 PPTX、PowerPoint、HTML、PPTX、C++ API、C++ 库
description: 在 C++ 中将 HTML 转换为 PPTX。使用 C++ 库 API 将 HTML 转换为 PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 C++ 中将 HTML 转换为 PPTX" h2="强大的跨平台 C++ API，用于使用 C++ 代码将 HTML 转换为 PPTX" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 将 HTML 转换为 PPTX" %}}

[**Aspose.Slides for C++**](https://products.aspose.com/slides/zh/cpp/) 是一个功能强大的 C++ 库，用于创建、转换和操作 PowerPoint 演示文稿、PDF、HTML 文档和其他文件。将 HTML 转换为 PPTX 时，实际上是将 HTML 文档中的内容移动到 PowerPoint 演示文稿中的幻灯片。
