...
title: 通过 C++ 应用程序将 OTP 转换为 SVG
weight: 6380
url: /zh/cpp/conversion/otp-to-svg/ 
description: OTP 文档到 SVG 格式的示例 C++ 转换代码。在任何 C++ 应用程序中使用示例代码进行批量 OTP 到 SVG 的转换。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C++ 将 OTP 转换为 SVG" h2="使用 C++ 库进行高性能 OTP 到 SVG 转换，无需安装 Microsoft PowerPoint。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTP" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ 开发人员只需几行代码即可轻松地将 OTP 文件转换为 SVG。
...
{{% blocks/products/pf/agp/code-block title="OTP 到 SVG C++ 转换源代码" offSpacer="" %}}
