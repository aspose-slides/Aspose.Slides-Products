---
title: 通过 .NET 从 PPTX 文档中提取文本和图像
weight: 1480
url: /zh/net/parser/pptx/ 
description: C# 源代码，用于从 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上的 PPTX 文件中提取文本和图像。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="在 C# 中解析 PPTX 格式" h2="使用用于 .NET API 的服务器端 Aspose.Slides 进行本机和高性能 PPTX 文档解析，无需使用 Microsoft 或 Adob​​e PDF 等任何软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPTX" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/zh/net/parser/odp/" name="ODP" description="OpenDocument 演示格式" >}}
