...
keywords: 编辑 HTML、HTML、C# API、.NET 库
description: 在 C# 中编辑 HTML。使用 .NET 库 API 编辑 HTML 文件
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 C# 中编辑 HTML" h2="强大的跨平台 .NET API，用于在 NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上使用 C# 代码编辑 HTML" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 编辑 HTML" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh/net/) 是一个功能强大的 .NET 库，用于操作和编辑演示文稿、HTML 文档和其他文件。您可以通过向其中添加新的文本行来编辑 HTML 文档。 
...
使用 [**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh/net/)，只需几行代码即可向 HTML 文档添加新的文本行。
