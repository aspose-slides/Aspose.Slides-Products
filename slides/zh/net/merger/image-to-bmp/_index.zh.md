...
url: /zh/net/merger/image-to-bmp/
keywords: 图像到 BMP、合并图像到 BMP、合并图像到 BMP、合并图像、图像、BMP、C# API、.NET 库
description: 在 C# 中将图像合并为 BMP。使用 .NET 库 API 组合图像
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 C# 中将图像合并为 BMP" h2="强大的跨平台 .NET API，用于在 NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上使用 C# 代码将图像合并为 BMP 文件" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 将图像合并为 BMP" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh/net/) 是一个功能强大的 .NET 库，用于创建、转换、合并和操作演示文稿、PDF、图像、和其他文件。当您将图像合并为 BMP 时，您实际上是在组合图像以获得单个 BMP 文件。
...
使用[**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh/net/)，只需几行代码即可快速将图像合并为BMP
...
{{< blocks/products/pf/feature-page-section  h2="如何在C#中将图像合并为BMP" >}}
