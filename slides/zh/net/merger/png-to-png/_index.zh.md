...
url: /zh/net/merger/png-to-png/
keywords: 合并 PNG、PNG 到 PNG、合并 PNG、合并 PNG、C# API、.NET 库
description: 在 C# 中将 PNG 合并为 PNG。使用 .NET 库 API 合并 PNG 文件
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 C# 中合并 PNG" h2="强大的跨平台 .NET API，用于在 NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上使用 C# 代码合并 PNG 图像" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 将 PNG 合并为 PNG" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh/net/) 是一个功能强大的 .NET 库，用于合并和操作演示文稿、图像和其他文件。将 PNG 合并为 PNG 时，实际上是将两张图像组合成一张图片。
...
使用 [**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh/net/)，只需几行代码即可快速合并 PNG 文件
...
{{< blocks/products/pf/feature-page-section  h2="如何在C#中合并PNG" >}}
