---
title: 在 C# 中合并 HTML 文件
url: /zh/net/merger/html-to-html/
keywords: 合并 HTML、HTML 到 HTML、加入 HTML、合并 HTML、C# API、.NET 库
description: 在 C# 中将 HTML 合并到 HTML。使用 .NET 库 API 组合 HTML 文件
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 C# 中合并 HTML" h2="强大的跨平台 .NET API，用于在 NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上使用 C# 代码合并 HTML 文件" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 将 HTML 合并到 HTML" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh/net/) 是一个功能强大的 .NET 库，用于创建、转换、合并和操作演示文稿、HTML 文件和其他文件。将 HTML 合并到 HTML 时，实际上是将 2 个文档的内容合并为一个 HTML 文件。 Aspose.Slides 允许您以不同的方式合并 HTML 文档。您可以将 HTML 与其所有文本、格式、样式等合并。
...
{{% blocks/products/pf/feature-page-section  h2="在 C# 中将 HTML 合并为 HTML" %}}
使用 [**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh/net/)，只需几行代码即可快速合并 HTML 文件

{{% blocks/products/pf/agp/code-block title="用于将 HTML 合并到 HTML 的 C# 代码" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="如何在 C# 中合并 HTML" >}}
