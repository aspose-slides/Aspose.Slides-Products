...
url: /zh/net/merger/jpg-to-jpg/
keywords: 合并 JPG、JPEG 到 JPG、合并 JPG、合并 JPG、C# API、.NET 库
description: 在 C# 中将 JPG 合并为 JPG。使用 .NET 库 API 合并 JPG 文件
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 C# 中合并 JPG" h2="强大的跨平台 .NET API，用于在 NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上使用 C# 代码合并 JPG 图像" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 将 JPG 合并为 JPG" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh/net/) 是一个功能强大的 .NET 库，用于合并和操作演示文稿、图像和其他文件。当您将 JPG 合并为 JPG 时，实际上是将两张图像组合成一张图片。
...
{{% blocks/products/pf/feature-page-section  h2="在 C# 中将 JPG 合并为 JPG" %}}
使用[**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh/net/)，只需几行代码即可快速合并JPG文件

{{% blocks/products/pf/agp/code-block title="用于将 JPG 合并为 JPG 的 C# 代码" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="如何在C#中合并JPG" >}}
