---
title: 通过 C# 将 PPSX 转换为 SVG
weight: 1930
url: /zh/net/conversion/ppsx-to-svg/ 
description: PPSX 到 SVG C# 转换的示例代码。使用 API 示例代码在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中将 PPSX 文件批量转换为 SVG。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 将 PPSX 转换为 SVG" h2="在 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上将 PowerPoint® PPSX 文件导出为 SVG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 PPSX 转换为 SVG" %}}

 为了将 PPSX 转换为 SVG，我们将使用
...
{{< blocks/products/pf/agp/feature-section-col title="通过 C# 将 PPSX 转换为 SVG 的步骤" >}}

{{< blocks/products/pf/agp/steps-block-autogen name=".NET 开发人员只需几行代码即可轻松加载 PPSX 文件并将其转换为 SVG。" >}}
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 PPSX 到 SVG C# 的转换" offSpacer="" %}}
