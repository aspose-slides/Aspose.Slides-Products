...
title: 通过 C# 将 PPSX 转换为 PPT
weight: 5940
url: /zh/net/conversion/ppsx-to-ppt/ 
description: PPSX 到 PPT C# 转换的示例代码。使用 API 示例代码在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中将批处理 PPSX 文件转换为 PPT。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 将 PPSX 转换为 PPT" h2="将 PowerPoint® PPSX 文件导出到 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上的 PPT" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSX" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name=".NET 开发人员只需几行代码即可轻松加载 PPSX 文件并将其转换为 PPT。" >}}
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 PPSX 到 PPT C# 转换" offSpacer="" %}}
