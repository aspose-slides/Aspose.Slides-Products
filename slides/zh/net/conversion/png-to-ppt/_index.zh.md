...
url: /zh/net/conversion/png-to-ppt/
keywords: 将 PNG 转换为 PPT、将 PNG 转换为 PPT、PowerPoint、PNG、PPT、C# API、.NET 库
description: 在 C# 中将 PNG 转换为 PPT。使用 .NET 库 API 将 PNG 图像转换为 PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 C# 中将 PNG 转换为 PPT" h2="强大的跨平台 .NET API，用于在 NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上使用 C# 代码将 PNG 转换为 PPT" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 将 PNG 转换为 PPT" %}}

[**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh/net/) 是一个功能强大的 .NET 库，用于创建、转换和操作 PowerPoint 演示文稿、PDF、HTML 文档、和其他文件。将 PNG 转换为 PPT 时，实际上是在创建包含基于 PNG 图像的幻灯片的 PowerPoint 演示文稿。

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="在 C# 中将 PNG 转换为 PPT" %}}
使用 [**Aspose.Slides for .NET**](https://products.aspose.com/slides/zh/net/)，您只需几行代码就可以将 PNG 图像转换为 PowerPoint 演示文稿：
