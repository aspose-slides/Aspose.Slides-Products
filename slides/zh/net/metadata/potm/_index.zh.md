---
title: 使用 .NET 查看或编辑 POTM 文件元数据
url: /zh/net/metadata/potm/
keywords: 编辑 POTM 元数据，查看 POTM 元数据，编辑 POTM 属性，查看 POTM 属性
description: C# 源代码，用于编辑或查看 POTM 格式元数据。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="使用 C# 编辑 POTM 属性" h2="构建您自己的 .NET 应用程序，以使用服务器端 API 修改演示文稿文件中的内置和自定义属性。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPT" fileiconsmall2="PPTX" fileiconsmall3="ODP" fileiconsmall4="POT" fileiconsmall5="ppsx" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for .NET" >}}

{{% blocks/products/pf/feature-page-section  h2="通过 C# 修改 POTM 属性" %}}
...
{{% blocks/products/pf/agp/code-block title="修改 POTM 内置属性 - C#" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="将自定义属性添加到 POTM - C#" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="如何通过 C# 提取 POTM 的元数据" >}}
