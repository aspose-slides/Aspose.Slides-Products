---
title: 通过.NET的PPT文档图表
weight: 7050
url: /zh/net/chart/ppt/ 
description: C# 源代码，用于在 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上绘制和转换 PPT 文件中的图表或图表。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C#中的PPT格式图表" h2="使用用于 .NET API 的服务器端 Aspose.Slides 的原生和高性能 PPT 文档图表，无需使用 Microsoft 或 Adob​​e PDF 等任何软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 创建 PPT 图表" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="在 C# 中创建 PPT 文件图表的步骤" >}}
...
{{% blocks/products/pf/agp/code-block title="创建 PPT 文件图表 - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/zh/net/chart/pptx/" name="PPTX" description="打开 XML 表示格式" >}}
