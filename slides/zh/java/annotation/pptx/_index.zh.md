---
title: 通过 Java 删除 PPTX 注释
weight: 360
url: /zh/java/annotation/pptx/ 
description: Java 示例代码，用于删除 JSP/JSF 应用程序和桌面应用程序的 Java 运行时环境中的 PPTX 格式注释。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 Java 从 PPTX 中删除评论和评论作者" h2="使用服务器端 API 构建您自己的 Java 应用程序来处理文档文件中的评论和作者。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 注释 PPTX 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 从 PPTX 中删除评论的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="从 PPTX 中删除注释 - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/zh/java/annotation/odp/" name="ODP" description="OpenDocument 演示格式" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/zh/java/annotation/ppt/" name="PPT" description="微软PowerPoint 97-2003" >}}
