...
{{< blocks/products/pf/i18n/upper-banner h1="通过 Java 从 ODP 中删除评论和评论作者" h2="使用服务器端 API 构建您自己的 Java 应用程序来处理文档文件中的评论和作者。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 注释 ODP 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 从 ODP 中删除评论的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="从 ODP 中删除注释 - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/zh/java/annotation/pptx/" name="PPTX" description="打开 XML 表示格式" >}}
