...
title: 通过 Java 将 PPSX 转换为 PPT
weight: 8690
url: /zh/java/conversion/ppsx-to-ppt/ 
description: PPSX 格式到 PPT 文件的示例 Java 转换代码。使用此示例代码可在任何基于 Web 或桌面 Java 的应用程序中将 PowerPoint 和 OpenOffice 演示文稿导出为 PPT。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 Java 将 PPSX 转换为 PPT" h2="PPSX 到 PPT Java 转换使用本地 Java 库将单个或多个页面转换为 PPT。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 将 PPSX 转换为 PPT" %}}

 为了将 PPSX 渲染为 PPT，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 将 PPSX 转换为 PPT 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 Java 开发人员只需几行代码即可轻松地将 PPSX 文件转换为 PPT。
...
{{% blocks/products/pf/agp/code-block title="PPSX 到 PPT Java 转换源代码" offSpacer="" %}}
