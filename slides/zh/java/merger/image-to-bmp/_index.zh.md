---
title: 在 Java 中将图像合并为 BMP
url: /zh/java/merger/image-to-bmp/
keywords: 图像到 BMP、合并图像到 BMP、将图像连接到 BMP、合并图像、图像、BMP、Java API、Java 库
description: 在 Java 中将图像合并为 BMP。使用 Java 库 API 组合图像
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="在 Java 中将图像合并为 BMP" h2="用于使用 Java 代码将图像合并为 BMP 文件的高速跨平台 Java 库" >}}

{{% blocks/products/pf/feature-page-section h2="使用 Aspose.Slides 将图像合并为 BMP" %}}

[**Aspose.Slides for Java**](https://products.aspose.com/slides/zh/java/) 是一个功能强大的 Java 库，用于创建、转换、合并和操作演示文稿、PDF、图像和其他文件。当您将图像合并为 BMP 时，您实际上是在组合图像以获得单个 BMP 文件。
...
{{% blocks/products/pf/feature-page-section  h2="在 Java 中将图像合并为 BMP" %}}
使用[**Aspose.Slides for Java**](https://products.aspose.com/slides/zh/java/)，只需几行代码即可快速将图像合并为BMP

{{% blocks/products/pf/agp/code-block title="将Image合并为BMP的Java代码" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="如何在 Java 中将图像合并到 BMP" >}}
