...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">高级 Java PowerPoint 文档处理 API 功能</h2>

<p>Aspose.Slides for Java 结合了许多高级功能，让开发人员在 Java 环境中使用 Microsoft PowerPoint 演示文稿进行编程时可以完全控制。</p>-->
   <h2 class="pr-ft">
...
<h2 class="h2title">幻灯片内容格式</h2>

<p>可以使用 Aspose.Slides for Java API 对演示文稿中的幻灯片上的文本和形状进行格式化。文本通过与形状关联的文本框架进行管理。因此，使用与文本框架相关联的段落和部分来格式化文本。您还可以操作形状元素的属性，如位置、大小、线条、图像、文本和填充。</p>
...
{{< blocks/products/pf/slr-element name="发行说明" href="https://docs.aspose.com/slides/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
