...
description: Reporting Services PowerPoint API 是 Aspose.Slides for SQL PPT。用于 SQL PowerPoint 的 PowerPoint 演示服务。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="报告服务 PowerPoint API" h2="将 RDL 报告导出为 PowerPoint PPT、PPTX、PPS 和 PPSX 格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-reporting-services.svg" pfName="Aspose.Slides" subTitlepfName="for Reporting Services" downloadUrl="https://downloads.aspose.com/slides/reportingservices" >}}
...
<p>
 Aspose.Slides for Reporting Services 是市场上唯一可以在 Microsoft SQL Server Reporting Services 中生成 PowerPoint 原生格式的演示文稿的解决方案。
</p>

<p>
 Aspose.Slides for Reporting Services 支持几乎所有 RDL 功能，如表格、矩阵、图表、图像、列表、子报告和页眉/页脚，因此允许以 PowerPoint 演示文稿格式导出报告，使其看起来与原始格式相似报告设计。在没有 Microsoft PowerPoint 自动化的情况下执行 Reporting Services SQL PPT。
</p>
...
{{< blocks/products/pf/carousel-item h3="乍看上去" description="用于 Reporting Services 的 Aspose.Slides 概述。" >}}
...
{{< blocks/products/pf/carousel-item h3="平台独立性" description="产品支持 Microsoft SQL Server Reporting Services。" >}}
<div class="diagram1 d1-rs">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     SQL Server Reporting Services (SSRS) 不提供将 RDL 报告导出到 PowerPoint 演示文稿或幻灯片的内置支持。在使用 Aspose.Slides for Reporting Services 时，您可以轻松添加对其他导出格式的支持。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for Reporting Services 支持完整的 RDL 规范，并且可以使用此扩展自定义现有报告。选择任何 RDL 报表设计器，然后以完全相同的方式导出报表是非常容易的。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for Reporting Services 使用托管代码构建，无需在计算机上安装 Microsoft PowerPoint 即可处理 PowerPoint 演示文稿。在支持的功能、安全性、稳定性、可扩展性、速度和价格方面，它是一个完美的 Microsoft PowerPoint 自动化替代方案。
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="文档" href="https://docs.aspose.com/slides/reportingservices/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="为什么 Aspose.Slides 用于报告服务？" tabId="success-stories" >}}
