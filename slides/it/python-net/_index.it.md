---
title: API Python PowerPoint. Python PPTX, PPT da Aspose.Slides
weight: 5860
url: /it/python-net/ 
description: Libreria Python per lavorare con i file di Microsoft PowerPoint. Python PPTX, PPT. Crea modifica converti PPT PPTX PPS POT PPSX PPTM PPSM POTX POTM ODP PDF e molti altri formati.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API Python per presentazioni. Python PPTX, PPT" h2="Crea, leggi, scrivi, modifica, unisci, clona, ​​proteggi e converti presentazioni PowerPoint e OpenOffice in Python senza alcun software esterno." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-python.svg" pfName="Aspose.Slides" subTitlepfName="for Python via .NET" downloadUrl="https://downloads.aspose.com/slides/python-net" >}}
...
<p><strong>Aspose.Slides per Python via. NET</strong> fornisce queste popolari funzionalità:</p>
<ul>
...
<p>Python è un linguaggio molto popolare che trova molto utilizzo nelle normali applicazioni, nello sviluppo web, nelle attività di ricerca e accademiche, nell'analisi dei dati, ecc. Per questo motivo, il team di <strong>Aspose.Slides</strong> è orgoglioso di offrire <strong>Aspose.Slides</strong> strong>Aspose.Slides per Python tramite .NET</strong> alla comunità di Python. </p>
...
{{< blocks/products/pf/carousel-item h3="Indipendenza dalla piattaforma" description="Python Presentation API supporta tutte le principali piattaforme, incluse le seguenti." >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="Formati di file supportati" description="Aspose.Slides per Python tramite .NET supporta i popolari [formati di presentazione](https://docs.aspose.com/slides/python-net/supported-file-formats/) e questi formati di esportazione." >}}
...
{{< blocks/products/pf/slr-element name="Documentazione" href="https://docs.aspose.com/slides/python-net/" >}}
{{< blocks/products/pf/slr-element name="Codice sorgente" href="https://github.com/aspose-slides/" >}}
{{< blocks/products/pf/slr-element name="Riferimenti API" href="https://docs.aspose.com/slides/python-net/api-reference/" >}}
...
{{< blocks/products/pf/slr-element name="Note di rilascio" href="https://releases.aspose.com/slides/python-net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
