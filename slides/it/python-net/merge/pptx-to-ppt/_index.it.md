---
title: Unisci file PPTX a PPT usando Python
url: /it/python-net/merge/pptx-to-ppt/
keywords: Unisci PPTX a PPT, Unisci PPTX a PPT, Combina PPTX a PPT, PowerPoint, Presentazione, PPT, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Unisci i file PPTX a PPT insieme in Python" h2="API Python ad alta velocità e multipiattaforma che aiuta nello sviluppo di applicazioni con la possibilità di creare, unire, ispezionare o convertire file di presentazione Microsoft PowerPoint e OpenOffice senza l'uso di software come Microsoft o Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Unisci PPTX a PPT in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Unisci i file PPTX a PPT usando Python" %}}
Per unire le presentazioni PowerPoint, dovrai clonare le diapositive da una presentazione all'altra.

{{% blocks/products/pf/agp/code-block title="Codice Python per unire più PPTX in un singolo file PPT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Come unire PPTX a PPT usando Aspose.Slides per l'API Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Questi sono i passaggi per unire due file PPTX e salvare il risultato come PPT in Python." >}}
