---
title: Unisci file ODP a PPS usando Python
url: /it/python-net/merge/odp-to-pps/
keywords: Unisci ODP a PPS, Unisci ODP a PPS, Combina ODP a PPS, PowerPoint, Presentazione, PPS, Python, Aspose
...
{{< blocks/products/pf/feature-page-header h1="Unisci i file ODP a PPS insieme in Python" h2="API Python ad alta velocità e multipiattaforma che aiuta nello sviluppo di applicazioni con la possibilità di creare, unire, ispezionare o convertire file di presentazione Microsoft PowerPoint e OpenOffice senza l'uso di software come Microsoft o Open Office, Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="Unisci ODP a PPS in Python" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Unisci i file ODP a PPS usando Python" %}}
Per unire le presentazioni PowerPoint, dovrai clonare le diapositive da una presentazione all'altra.

{{% blocks/products/pf/agp/code-block title="Codice Python per unire più ODP in un singolo file PPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Come unire ODP a PPS usando Aspose.Slides per l'API Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Questi sono i passaggi per unire due file ODP e salvare il risultato come PPS in Python." >}}
