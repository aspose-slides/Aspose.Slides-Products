---
title: Visualizza o modifica i metadati dei file PPS utilizzando Python
url: /it/python-net/metadata/pps/
keywords: Modifica metadati PPS, Visualizza metadati PPS, Modifica proprietà PPS, Visualizza proprietà PPS
description: Python codice sorgente per modificare o visualizzare i metadati del formato PPS.
---
...
{{% blocks/products/pf/feature-page-section  h2="Modifica le proprietà PPS tramite Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Modifica proprietà integrate PPS - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Aggiungi proprietà personalizzate a PPS - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Come estrarre i metadati di PPS tramite Python" >}}
