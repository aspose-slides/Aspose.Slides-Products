...
url: /it/cpp/conversion/html-to-pptx/
keywords: Converti HTML in PPTX, HTML in PPTX, PowerPoint, HTML, PPTX, API C++, Libreria C++
description: Converti HTML in PPTX in C++. Usa l'API della libreria C++ per convertire HTML in PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Converti HTML in PPTX in C++" h2="Potente API C++ multipiattaforma per la conversione di HTML in PPTX utilizzando il codice C++" >}}
...
Usando [**Aspose.Slides per C++**](https://products.aspose.com/slides/it/cpp/), puoi convertire un documento HTML in una presentazione PowerPoint con poche righe di codice:
