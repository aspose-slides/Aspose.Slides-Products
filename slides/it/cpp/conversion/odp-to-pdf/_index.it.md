...
title: Converti ODP in PDF tramite l'applicazione C++
weight: 7330
url: /it/cpp/conversion/odp-to-pdf/ 
description: Esempio di codice di conversione C++ per documento ODP in formato PDF. Utilizzare il codice di esempio per la conversione batch da ODP a PDF all'interno di qualsiasi applicazione C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti ODP in PDF tramite C++" h2="Conversione da ODP a PDF ad alte prestazioni utilizzando la libreria C++ senza la necessità dell'installazione di Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Gli sviluppatori C++ possono convertire facilmente file ODP in PDF in poche righe di codice.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da ODP a PDF C++" offSpacer="" %}}
