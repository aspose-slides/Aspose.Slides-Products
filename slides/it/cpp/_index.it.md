...
<p class="col-lg-10">Incorpora i grafici di Excel come oggetti OLE nelle diapositive</p>

</div>

<div class="col-lg-4"><em class="fa fa-print  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Gestisci oggetti Ole collegati</p>
...
<p class="col-lg-10">Stampa personalizzata di presentazioni</p>
...
<h2 class="h2title">Integrazione continua di nuove funzionalità</h2>

<p>Non sei mai limitato alle funzionalità esistenti. I nostri team di prodotto aggiungono continuamente sempre più funzionalità e ogni nuova versione offre più funzionalità rispetto alle versioni precedenti. Puoi anche inviare nuove richieste di funzionalità se trovi mancante una delle funzionalità desiderate. Ecco l'elenco di alcune scelte dalle ultime funzionalità.</p>

<ul>

<li>Rasterizzazione o vettorizzazione di forme senza testo.</li>

<li>Converti le immagini SVG in forme.</li>

<li>Ottieni lo sfondo della tabella predefinito.</li>

<li>Limitazione dell'accesso al file system locale all'apertura di un documento.</li>

<li>Aggiungi meta tag di codifica durante il salvataggio in HTML.</li>

<li>Impostazione per la rimozione degli attributi di larghezza e altezza del tag SVG durante il salvataggio come HTML.</li>

<li>Support for

<ul>

<li>Risposte ai commenti, Office 365 e cartelle di lavoro Excel esterne.</li>

<li>La dimensione rappresenta la proprietà per il grafico a bolle.</li>

<li>Nascondere il riquadro delle miniature della diapositiva sinistra nel PPT generato.</li>

<li>Grafici a imbuto, grafici di mappe 2D e percorso della cartella di lavoro dell'origine dati esterna del grafico.</li>

<li>Crittografia OpenDocument, Transizione Morph ed Evidenziatore di testo.</li>

<li>Impostazione della proprietà Trasparenza per effetti ombra.</li>

<li>Impostazione della forma del callout per l'etichetta dei dati della serie.</li>

<li>Ottieni effetti per paragrafi della casella di testo.</li>

<li>Rendering della forma Effetto Bordi morbidi (EffectFormat).</li>

<li>ChartData SetRange su una tabella pivot.</li>

</ul>

</li>

<li>Implementa il formato Tiff multipagina, Metafile Format Plus Extensions (EMF+) e il formato Strict Open XML.</li>

<li>Rendering di commenti dal formato ODP senza autore.</li>

<li>Implementare la serializzazione con la conformità al formato Strict Open XML.</li>
...
<h2 class="h2title">Elaborazione delle forme SmartArt</h2>

<p>Aspose.Slides per C++ facilita la creazione di forme SmartArt da zero e offre la possibilità di accedere, manipolare o rimuovere forme SmartArt esistenti da una diapositiva. Inoltre, è anche possibile formattare le forme SmartArt come impostare lo stile, il colore e il layout.</p>
...
{{< blocks/products/pf/slr-element name="Note di rilascio" href="https://docs.aspose.com/slides/cpp/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
