...
url: /it/cpp/merger/png-to-png/
keywords: Unisci PNG, PNG in PNG, Unisci PNG, Combina PNG, API C++, Libreria C++
description: Unisci PNG a PNG in C++. Utilizza l'API della libreria C++ per combinare i file PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Unisci PNG in C++" h2="Libreria C++ ad alta velocità e multipiattaforma per l'unione di immagini PNG utilizzando il codice C++" >}}

{{% blocks/products/pf/feature-page-section h2="Unisci PNG a PNG usando Aspose.Slides" %}}

[**Aspose.Slides per C++**](https://products.aspose.com/slides/it/cpp/) è una potente libreria C++ utilizzata per unire e manipolare presentazioni, immagini e altri file. Quando unisci PNG a PNG, stai effettivamente combinando due immagini per ottenere un'immagine.
...
Utilizzando [**Aspose.Slides per C++**](https://products.aspose.com/slides/it/cpp/), puoi unire file PNG rapidamente con poche righe di codice

{{% blocks/products/pf/agp/code-block title="Codice C++ per unire PNG a PNG" offSpacer="true" %}}
```cpp
