---
title: Unisci TIFF in PDF in C++
url: /it/cpp/merger/tiff-to-pdf/
keywords: Da TIFF a PDF, Unisci TIFF a PDF, Unisci TIFF a PDF, PDF, TIFF, API C++, Libreria C++
description: Unisci TIFF in PDF in C++. Utilizza l'API della libreria C++ per combinare TIFF e PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Unisci TIFF in PDF in C++" h2="Libreria C++ ad alta velocità e multipiattaforma per l'unione di file TIFF in PDF utilizzando il codice C++" >}}

{{% blocks/products/pf/feature-page-section h2="Unisci TIFF in PDF utilizzando Aspose.Slides" %}}

[**Aspose.Slides per C++**](https://products.aspose.com/slides/it/cpp/) è una potente libreria C++ utilizzata per creare, convertire, unire e manipolare presentazioni, PDF, immagini e altro File. Quando unisci TIFF a PDF, combini effettivamente le immagini per ottenere un singolo file PDF.
...
{{% blocks/products/pf/feature-page-section  h2="Unisci TIFF in PDF in C++" %}}
Usando [**Aspose.Slides per C++**](https://products.aspose.com/slides/it/cpp/), puoi unire rapidamente TIFF a PDF con poche righe di codice
