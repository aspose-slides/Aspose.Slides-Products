...
url: /it/cpp/merger/image-to-pdf/
keywords: Immagine in PDF, Unisci immagine in PDF, Unisci immagine in PDF, PDF, Immagine, API C++, Libreria C++
description: Unisci immagine a PDF in C++. Utilizza l'API della libreria C++ per combinare immagini e PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Unisci immagine a PDF in C++" h2="Libreria C++ ad alta velocità e multipiattaforma per l'unione di immagini in file PDF utilizzando il codice C++" >}}

{{% blocks/products/pf/feature-page-section h2="Unisci immagine in PDF utilizzando Aspose.Slides" %}}

[**Aspose.Slides per C++**](https://products.aspose.com/slides/it/cpp/) è una potente libreria C++ utilizzata per creare, convertire, unire e manipolare presentazioni, PDF, immagini e altro File. Quando unisci un'immagine a un PDF, combini effettivamente le immagini per ottenere un singolo file PDF.
...
Usando [**Aspose.Slides per C++**](https://products.aspose.com/slides/it/cpp/), puoi unire rapidamente l'immagine al PDF con poche righe di codice
...
{{< blocks/products/pf/feature-page-section  h2="Come unire un'immagine in PDF in C++" >}}
