...
{{< blocks/products/pf/agp/step-autogen >}}
Carica il secondo documento POTX con un'istanza della classe Presentation.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Passa in rassegna ogni diapositiva del secondo file POTX.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Unisci file POTX - Java" offSpacer="" %}}
