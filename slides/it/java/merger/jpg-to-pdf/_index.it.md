---
title: Unisci JPG a PDF in Java
url: /it/java/merger/jpg-to-pdf/
keywords: Da JPG a PDF, Unisci JPG a PDF, Unisci JPG a PDF, PDF, JPG, API Java, Libreria Java
description: Unisci JPG a PDF in Java. Utilizza l'API della libreria Java per combinare JPG e PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Unisci JPG a PDF in Java" h2="Libreria Java ad alta velocità e multipiattaforma per l'unione di file JPG in PDF utilizzando il codice Java" >}}

{{% blocks/products/pf/feature-page-section h2="Unisci JPG a PDF utilizzando Aspose.Slides" %}}

[**Aspose.Slides per Java**](https://products.aspose.com/slides/it/java/) è una potente libreria Java utilizzata per creare, convertire, unire e manipolare presentazioni, PDF, immagini e altro File. Quando unisci JPG a PDF, stai effettivamente combinando immagini JPG per ottenere un singolo file PDF.
...
{{% blocks/products/pf/feature-page-section  h2="Unisci JPG a PDF in Java" %}}
Utilizzando [**Aspose.Slides per Java**](https://products.aspose.com/slides/it/java/), puoi unire rapidamente JPG a PDF con poche righe di codice

{{% blocks/products/pf/agp/code-block title="Codice Java per unire JPG a PDF" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Come unire JPG a PDF in Java" >}}
