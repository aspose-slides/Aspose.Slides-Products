---
title: Visualizza o modifica i metadati dei file PPTM utilizzando Java
...
description: Java codice sorgente per modificare o visualizzare i metadati del formato PPTM.
---
...
{{% blocks/products/pf/feature-page-section  h2="Modifica le proprietà PPTM tramite Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Modifica proprietà integrate PPTM - Java" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Aggiungi proprietà personalizzate a PPTM - Java" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Come estrarre i metadati di PPTM tramite Java" >}}
