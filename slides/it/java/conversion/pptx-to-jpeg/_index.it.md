...
title: Converti PPTX in JPEG tramite Java
weight: 3710
url: /it/java/conversion/pptx-to-jpeg/ 
description: Esempio di codice di conversione Java per il formato PPTX in file JPEG. Utilizzare questo codice di esempio per esportare presentazioni PowerPoint e OpenOffice in JPEG all'interno di qualsiasi applicazione basata su Java Web o desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti PPTX in JPEG tramite Java" h2="Conversione da PPTX a JPEG Java per convertire pagine singole o multiple in JPEG utilizzando la libreria Java in loco." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire PPTX in JPEG utilizzando Java" %}}

 Per rendere PPTX in JPEG, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire PPTX in JPEG tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Gli sviluppatori Java possono convertire facilmente file PPTX in JPEG in poche righe di codice.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione Java da PPTX a JPEG" offSpacer="" %}}
