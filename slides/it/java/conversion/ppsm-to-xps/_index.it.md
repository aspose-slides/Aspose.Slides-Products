...
{{% blocks/products/pf/agp/content h2="Come convertire PPSM in XPS usando Java" %}}

 Per eseguire il rendering da PPSM a XPS, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire PPSM in XPS tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Gli sviluppatori Java possono convertire facilmente file PPSM in XPS in poche righe di codice.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione Java da PPSM a XPS" offSpacer="" %}}
