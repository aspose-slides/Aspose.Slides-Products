---
title: Converti ODP in PDF tramite Java
weight: 450
url: /it/java/conversion/odp-to-pdf/ 
description: Esempio di codice di conversione Java per il formato ODP in file PDF. Utilizzare questo codice di esempio per esportare presentazioni PowerPoint e OpenOffice in PDF all'interno di qualsiasi applicazione basata su Java Web o desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti ODP in PDF tramite Java" h2="Conversione da ODP a PDF Java per convertire pagine singole o multiple in PDF utilizzando la libreria Java in loco." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire ODP in PDF usando Java" %}}

 Per eseguire il rendering di ODP in PDF, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire ODP in PDF tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Gli sviluppatori Java possono convertire facilmente file ODP in PDF in poche righe di codice.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione Java da ODP a PDF" offSpacer="" %}}
