---
title: Cerca il documento PPTX senza aprire tramite Java
weight: 8800
url: /it/java/search/pptx/ 
description: Codice di esempio Java per cercare parole con pattern nel file PPTX su Java Runtime Environment per applicazioni JSP/JSF e applicazioni desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Cerca i formati PPTX in Java" h2="Ricerca di documenti PPTX nativa e ad alte prestazioni utilizzando Aspose.Slides lato server per API Java, senza l'uso di software come Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Come cercare file PPTX utilizzando Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Passaggi per cercare file PPTX in Java" >}}
...
Carica il file PPTX creando un'istanza dell'oggetto Classe di presentazione.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Cerca file PPTX - Java" offSpacer="" %}}
