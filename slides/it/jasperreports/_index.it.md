---
title: Esporta JasperReports in PowerPoint | Aspose.Slides
weight: 8320
url: /it/jasperreports/ 
description: Aspose.Slides API PowerPoint per JaspreReport per esportare report da Jasper Reports e JasperServer in formati PowerPoint. Crea ed esporta le immagini dei grafici dei conti, il testo e i rapporti di linea nella presentazione PPT
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Esporta i report di JasperServer in presentazioni PowerPoint" h2="API PowerPoint per l'esportazione di report JasperReports e JasperServer in PPT(X), PPS(X) e altri formati PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-jasperreports.svg" pfName="Aspose.Slides" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/slides/jasperreport" >}}
...
<p>
 Aspose.Slides for JasperReports è un'API PowerPoint per l'esportazione flessibile e facile da usare di report JasperReports e JasperServer in PowerPoint. JasperServer non ha la capacità integrata di esportare i report come presentazioni PowerPoint. Tuttavia, con questa API PowerPoint, i report JasperServer possono essere esportati nei formati di presentazione PPT, PPS, PPTX e PPSX senza utilizzare Microsoft PowerPoint.
</p>
...
{{< blocks/products/pf/carousel-item h3="A prima vista" description="Una panoramica di Aspose.Slides per JasperReports." >}}
...
{{< blocks/products/pf/carousel-item h3="Indipendenza dalla piattaforma" description="L'API di Aspose.Slides PowerPoint supporta J2SE, JasperReports e JasperServer." >}}
<div class="diagram1 d1-jasper">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header style="padding-left: 0px;">
    ...
    J2SE 1.4 o superiore
   </header>
   <ul>
    <li>
17.5 e versioni precedenti
    </li>
   </ul>
   <header style="padding-left: 0px;">
    <i class="fa fa-cubes">
    </i>
    J2SE 6.0 o successivo
   </header>
   <ul>
    <li>
17.6 e versioni successive
    </li>
   </ul>
  </div>
  <!--/left-->
  <div class="d1-col d1-right">
   <header style="padding-left: 0px;">
    ...
    JasperReports 2.0, 3.0 o versioni successive
   </header>
   <ul>
    <li>
17.5 e versioni precedenti
   ...
   <header style="padding-left: 0px;">
    ...
    JasperReports 3.7.2 o versioni successive.
   </header>
   <ul>
    <li>
17.6 e versioni successive
...
{{< blocks/products/pf/carousel-item h3="Formati di file supportati" description="Aspose.Slides per JasperReports può esportare report in Microsoft PowerPoint [formati di file](https://docs.aspose.com/slides/jasperreports/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">JasperReports avanzato alle funzionalità di esportazione della presentazione</h2>

<p> </p>

<div class="col-lg-4"><em class="fa fa-file-powerpoint-o  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Crea rapporti sugli account ed esportali in presentazioni Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-bar-chart   ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Crea report grafici ed esportali in presentazioni Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-pie-chart ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Crea report con grafici a più assi ed esporta in presentazioni Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-file-text ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Crea immagini, testo, linee ed esporta questi report in presentazioni Microsoft PowerPoint</p>

</div>-->
   <h2 class="pr-ft">
    Funzionalità avanzate dell'API di JasperReports PowerPoint
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Crea report di grafici a più assi
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Aggiungi immagini, testo, righe ai rapporti
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-file-text ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Esporta report in presentazioni PowerPoint
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-file-text ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Trasforma le immagini SVG in forme
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Supporto per le risposte ai commenti, Office 365 e cartelle di lavoro Excel esterne
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Rasterizzazione di forme senza testo
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Nascondi il riquadro delle miniature della diapositiva sinistra nel PPT creato
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-area-chart ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Imbuto, mappe 2D e proprietà Size per il grafico a bolle
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-cog ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Evidenziatore di testo, Crittografia OpenDocument e Rendering di forme
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Imposta la proprietà Trasparenza per effetti ombra e Transizione Morph
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Imposta le impostazioni locali nell'applicazione e la forma del richiamo per l'etichetta dei dati della serie
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Aggiungi il supporto per il formato Strict Open XML
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Ottieni effetti per paragrafi della casella di testo
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     ChartData SetRange su una tabella pivot
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Implementare la serializzazione con la conformità al formato Strict Open XML
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Conformità ad algoritmi conformi a FIPS
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Supporto per rapporto grafico ad assi multipli
    </h2>
    <p>
     Aspose.Slides per JasperReports supporta l'esportazione di report complessi contenenti
     <forte>
      MultipleAxisChartReport
     </strong>
     alle presentazioni di Microsoft PowerPoint. L'output è esattamente lo stesso di come appare quando viene visualizzato tramite JasperViewer.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Esporta report in formati di presentazione
    </h2>
    <p>
     JasperReports e JasperServer non dispongono del supporto integrato per l'esportazione di report in presentazioni Microsoft PowerPoint, tuttavia, l'integrazione con Aspose.Slides per JasperReports consente di esportare i report in presentazioni Microsoft PowerPoint (PPT, PPTX) e presentazioni Microsoft PowerPoint (PPS, PPSX).
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides per JasperReports è creato utilizzando codice gestito che non richiede l'installazione di Microsoft PowerPoint sulla macchina per lavorare con i documenti PowerPoint. È una perfetta alternativa all'automazione di Microsoft PowerPoint in termini di funzionalità supportate, sicurezza, stabilità, scalabilità, velocità e prezzo.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Documentazione" href="https://docs.aspose.com/slides/jasperreports/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Perché Aspose.Slides per JasperReports?" tabId="success-stories" >}}
