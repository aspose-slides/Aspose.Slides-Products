---
title: Modifica PDF in PHP
url: /it/php-java/editor/pdf/
keywords: Modifica PDF, modifica PowerPoint, PDF, PowerPoint, API PHP, libreria PHP
description: Modifica PDF in PHP. Usa l'API della libreria PHP per modificare i file PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Modifica PDF in PHP" h2="Libreria PHP ad alta velocità e multipiattaforma per la modifica di PDF utilizzando il codice PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Modifica PDF utilizzando Aspose.Slides" %}}

[**Aspose.Slides per PHP via Java**](https://products.aspose.com/slides/it/php-java/) è una potente libreria PHP utilizzata per manipolare e modificare le presentazioni. Puoi modificare una presentazione PDF aggiungendovi una nuova riga di testo. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Modifica PDF in PHP" %}}
Usando [**Aspose.Slides per PHP via Java**](https://products.aspose.com/slides/it/php-java/), puoi aggiungere una nuova riga di testo al documento PDF con solo un poche righe di codice.

{{% blocks/products/pf/agp/code-block title="Codice PHP per modificare PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Come modificare PDF in PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Carica la presentazione PDF che desideri modificare.
{{< /blocks/products/pf/agp/step-autogen >}}
