---
title: Modifica ODP in PHP
url: /it/php-java/editor/odp/
keywords: Modifica ODP, modifica PowerPoint, ODP, PowerPoint, API PHP, libreria PHP
description: Modifica ODP in PHP. Usa l'API della libreria PHP per modificare i file ODP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Modifica ODP in PHP" h2="Libreria PHP ad alta velocità e multipiattaforma per la modifica di ODP utilizzando il codice PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Modifica ODP utilizzando Aspose.Slides" %}}

[**Aspose.Slides per PHP via Java**](https://products.aspose.com/slides/it/php-java/) è una potente libreria PHP utilizzata per manipolare e modificare le presentazioni. Puoi modificare una presentazione ODP aggiungendovi una nuova riga di testo. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Modifica ODP in PHP" %}}
Usando [**Aspose.Slides per PHP via Java**](https://products.aspose.com/slides/it/php-java/), puoi aggiungere una nuova riga di testo al documento ODP con solo un poche righe di codice.

{{% blocks/products/pf/agp/code-block title="Codice PHP per modificare ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Come modificare ODP in PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Carica la presentazione ODP che desideri modificare.
{{< /blocks/products/pf/agp/step-autogen >}}
