---
title: Modifica POTM in PHP
url: /it/php-java/editor/potm/
keywords: Modifica POTM, modifica PowerPoint, POTM, PowerPoint, API PHP, libreria PHP
description: Modifica POTM in PHP. Usa l'API della libreria PHP per modificare i file POTM
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Modifica POTM in PHP" h2="Libreria PHP ad alta velocità e multipiattaforma per la modifica di POTM utilizzando il codice PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Modifica POTM utilizzando Aspose.Slides" %}}

[**Aspose.Slides per PHP via Java**](https://products.aspose.com/slides/it/php-java/) è una potente libreria PHP utilizzata per manipolare e modificare le presentazioni. Puoi modificare una presentazione POTM aggiungendovi una nuova riga di testo. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Modifica POTM in PHP" %}}
Usando [**Aspose.Slides per PHP via Java**](https://products.aspose.com/slides/it/php-java/), puoi aggiungere una nuova riga di testo al documento POTM con solo un poche righe di codice.

{{% blocks/products/pf/agp/code-block title="Codice PHP per modificare POTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Come modificare POTM in PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Carica la presentazione POTM che desideri modificare.
{{< /blocks/products/pf/agp/step-autogen >}}
