---
title: Modifica HTML in PHP
url: /it/php-java/editor/html/
keywords: Modifica HTML, modifica PowerPoint, HTML, PowerPoint, API PHP, libreria PHP
description: Modifica HTML in PHP. Usa l'API della libreria PHP per modificare i file HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Modifica HTML in PHP" h2="Libreria PHP ad alta velocità e multipiattaforma per la modifica di HTML utilizzando il codice PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Modifica HTML utilizzando Aspose.Slides" %}}

[**Aspose.Slides per PHP via Java**](https://products.aspose.com/slides/it/php-java/) è una potente libreria PHP utilizzata per manipolare e modificare le presentazioni. Puoi modificare una presentazione HTML aggiungendovi una nuova riga di testo. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Modifica HTML in PHP" %}}
Usando [**Aspose.Slides per PHP via Java**](https://products.aspose.com/slides/it/php-java/), puoi aggiungere una nuova riga di testo al documento HTML con solo un poche righe di codice.

{{% blocks/products/pf/agp/code-block title="Codice PHP per modificare HTML" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Come modificare HTML in PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Carica la presentazione HTML che desideri modificare.
{{< /blocks/products/pf/agp/step-autogen >}}
