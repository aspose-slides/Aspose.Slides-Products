---
title: Modifica POT in PHP
url: /it/php-java/editor/pot/
keywords: Modifica POT, modifica PowerPoint, POT, PowerPoint, API PHP, libreria PHP
description: Modifica POT in PHP. Usa l'API della libreria PHP per modificare i file POT
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Modifica POT in PHP" h2="Libreria PHP ad alta velocità e multipiattaforma per la modifica di POT utilizzando il codice PHP" >}}

{{% blocks/products/pf/feature-page-section h2="Modifica POT utilizzando Aspose.Slides" %}}

[**Aspose.Slides per PHP via Java**](https://products.aspose.com/slides/it/php-java/) è una potente libreria PHP utilizzata per manipolare e modificare le presentazioni. Puoi modificare una presentazione POT aggiungendovi una nuova riga di testo. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Modifica POT in PHP" %}}
Usando [**Aspose.Slides per PHP via Java**](https://products.aspose.com/slides/it/php-java/), puoi aggiungere una nuova riga di testo al documento POT con solo un poche righe di codice.

{{% blocks/products/pf/agp/code-block title="Codice PHP per modificare POT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Come modificare POT in PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Carica la presentazione POT che desideri modificare.
{{< /blocks/products/pf/agp/step-autogen >}}
