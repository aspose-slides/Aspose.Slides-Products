...
title: Converti HTML in JPG in C#
weight: 150
url: /it/net/conversion/html-to-jpg/ 
keywords: HTML in JPG, Converti HTML in JPG, API C#, Libreria .NET, HTML, JPG
description: Converti HTML in JPG in C#. Usa l'API della libreria .NET per convertire i file HTML in immagini JPG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converti HTML in JPG in C#" h2="API PowerPoint .NET per la conversione di file HTML in immagini JPG su piattaforme NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire HTML in JPG in C#" %}}

Come posso convertire HTML in JPG nel codice?

Utilizzando [**Aspose.Slides for .NET**](https://products.aspose.com/slides/it/net/), qualsiasi sviluppatore o applicazione può convertire HTML in formato JPG con poche righe di codice C#.

In quanto moderna API di elaborazione dei documenti, Aspose.Slides per .NET esporta rapidamente i file HTML in JPG. La libreria Aspose PowerPoint ti consente di convertire HTML in JPG e molti altri formati di file
...
{{< blocks/products/pf/agp/feature-section-col title="Come convertire HTML in JPG in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Gli sviluppatori e le applicazioni possono convertire HTML in JPG in questo modo:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Aggiungi diapositive in base al contenuto del documento HTML.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Salva le diapositive come immagini JPG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Prima di eseguire il codice C# di conversione da HTML a JPG, la tua macchina deve avere questi prerequisiti:
...
{{% blocks/products/pf/agp/code-block title="Codice C# per convertire HTML in JPG" offSpacer="" %}}
