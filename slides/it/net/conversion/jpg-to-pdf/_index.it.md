...
keywords: JPG in PDF, Converti JPG in PDF, API C#, Libreria .NET
description: Converti JPG in PDF in C#. Usa l'API della libreria .NET per convertire immagini JPG JPEG in documenti PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converti JPG in PDF in C#" h2="API PowerPoint .NET per la conversione di immagini JPG in documenti PDF su piattaforme NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire JPG in PDF in C#" %}}

Come posso convertire JPG in PDF a livello di codice?

Utilizzando [**Aspose.Slides for .NET**](https://products.aspose.com/slides/it/net/), qualsiasi sviluppatore o applicazione può convertire JPG in formato PDF con poche righe di codice C#.

In quanto moderna API di elaborazione dei documenti, Aspose.Slides for .NET crea rapidamente PDF da immagini JPG. La libreria Aspose PowerPoint ti consente di convertire JPG in PDF e molti altri formati di file
...
{{< blocks/products/pf/agp/feature-section-col title="Passaggi per convertire JPG in PDF in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Gli sviluppatori e le applicazioni possono convertire JPG in PDF in questo modo:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Prima di eseguire il codice C# di conversione da JPG a PDF, la tua macchina deve avere questi prerequisiti:
...
{{% blocks/products/pf/agp/code-block title="Codice C# per convertire JPG in PDF" offSpacer="" %}}
