---
title: Converti immagine in PDF in C#
weight: 30
url: /it/net/conversion/image-to-pdf/ 
keywords: Immagine in PDF, Converti immagine in PDF, API C#, Libreria .NET, Immagine, JPG, PNG, PDF
description: Converti immagine in PDF in C#. Usa l'API della libreria .NET per convertire le immagini in documenti PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converti immagine in PDF in C#" h2="API PowerPoint .NET per la conversione di immagini in documenti PDF su piattaforme NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire un'immagine in PDF in C#" %}}

Come posso convertire un'immagine in PDF a livello di codice?

Utilizzando [**Aspose.Slides for .NET**](https://products.aspose.com/slides/it/net/), qualsiasi sviluppatore o applicazione può convertire l'immagine in formato PDF con poche righe di codice C#.

In quanto moderna API di elaborazione dei documenti, Aspose.Slides for .NET crea rapidamente PDF da immagini JPG o PNG. La libreria Aspose PowerPoint ti consente di convertire l'immagine in PDF e molti altri formati di file
...
{{< blocks/products/pf/agp/feature-section-col title="Passaggi per convertire l'immagine in PDF in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Gli sviluppatori e le applicazioni possono convertire l'immagine in PDF in questo modo:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Chiama il metodo di salvataggio per salvare il file come PDF.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Prima di eseguire il codice C# di conversione da immagine a PDF, il tuo computer deve avere questi prerequisiti:
...
{{% blocks/products/pf/agp/code-block title="Codice C# per convertire l'immagine in PDF" offSpacer="" %}}
