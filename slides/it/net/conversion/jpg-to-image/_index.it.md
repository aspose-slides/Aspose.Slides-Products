---
title: Converti JPG in immagine in C#
weight: 210
url: /it/net/conversion/jpg-to-image/ 
keywords: JPG in immagine, Converti JPG in immagine, API C#, Libreria .NET
description: Converti JPG in immagine in C#. Usa l'API della libreria .NET per convertire JPG in immagini in diversi formati.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converti JPG in immagine in C#" h2="API PowerPoint .NET per la conversione di immagini JPG in file immagine su piattaforme NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Converti JPG in immagine in C#" %}}

Come posso convertire JPG in immagine nel codice?

Utilizzando [**Aspose.Slides for .NET**](https://products.aspose.com/slides/it/net/), qualsiasi sviluppatore o applicazione può convertire JPG in immagine con poche righe di codice C#.

In quanto moderna API di elaborazione dei documenti, Aspose.Slides per .NET esporta rapidamente i file JPG in immagini in altri formati. La libreria Aspose PowerPoint ti consente di convertire JPG in immagine e molti altri formati di file
...
{{< blocks/products/pf/agp/feature-section-col title="Come convertire JPG in immagine in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Gli sviluppatori e le applicazioni possono convertire JPG in Immagine in questo modo:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Prima di eseguire il codice C# di conversione da JPG a immagine, la tua macchina deve avere questi prerequisiti:
...
{{% blocks/products/pf/agp/code-block title="Codice C# per convertire JPG in immagine" offSpacer="" %}}
