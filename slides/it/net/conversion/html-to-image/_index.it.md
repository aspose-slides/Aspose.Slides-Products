...
title: Converti HTML in immagine in C#
weight: 160
url: /it/net/conversion/html-to-image/ 
keywords: HTML in immagine, Converti HTML in immagine, API C#, Libreria .NET, HTML, Immagine
description: Converti HTML in immagine in C#. Usa l'API della libreria .NET per convertire i file HTML in immagini
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converti HTML in immagine in C#" h2="API PowerPoint .NET per la conversione di file HTML in immagini su piattaforme NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire HTML in immagine in C#" %}}

Come posso convertire HTML in Immagine nel codice?

Utilizzando [**Aspose.Slides for .NET**](https://products.aspose.com/slides/it/net/), qualsiasi sviluppatore o applicazione può convertire HTML in file immagine con poche righe di codice C#.

In quanto moderna API di elaborazione dei documenti, Aspose.Slides per .NET esporta rapidamente file HTML in formati di file immagine. La libreria Aspose PowerPoint ti consente di convertire HTML in immagini e molti altri formati di file
...
{{< blocks/products/pf/agp/feature-section-col title="Come convertire HTML in immagine in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Gli sviluppatori e le applicazioni possono convertire HTML in Image in questo modo:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Aggiungi diapositive in base alle pagine HTML.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Salva le diapositive come immagini.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Prima di eseguire il codice C# di conversione da HTML a immagine, la tua macchina deve avere questi prerequisiti:
...
{{% blocks/products/pf/agp/code-block title="Codice C# per convertire HTML in immagine" offSpacer="" %}}
