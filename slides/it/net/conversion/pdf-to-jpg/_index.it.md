...
weight: 70
url: /it/net/conversion/pdf-to-jpg/ 
keywords: PDF in JPG, Converti PDF in JPG, API C#, Libreria .NET, PDF, JPG
description: Converti PDF in JPG in C#. Usa l'API della libreria .NET per convertire le pagine PDF in immagini JPG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converti PDF in JPG in C#" h2="API PowerPoint .NET per la conversione di documenti PDF in immagini JPG su piattaforme NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire PDF in JPG in C#" %}}

Come posso convertire PDF in JPG nel codice?

Utilizzando [**Aspose.Slides for .NET**](https://products.aspose.com/slides/it/net/), qualsiasi sviluppatore o applicazione può convertire PDF in formato JPG con poche righe di codice C#.

In quanto moderna API di elaborazione dei documenti, Aspose.Slides per .NET esporta rapidamente le pagine PDF in JPG. La libreria Aspose PowerPoint ti consente di convertire PDF in JPG e molti altri formati di file
...
{{< blocks/products/pf/agp/feature-section-col title="Come convertire PDF in JPG in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Gli sviluppatori e le applicazioni possono convertire PDF in JPG in questo modo:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Chiama il metodo di salvataggio per salvare le diapositive come immagini JPG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Prima di eseguire il codice C# di conversione da PDF a JPG, la tua macchina deve avere questi prerequisiti:
...
{{% blocks/products/pf/agp/code-block title="Codice C# per convertire PDF in JPG" offSpacer="" %}}
