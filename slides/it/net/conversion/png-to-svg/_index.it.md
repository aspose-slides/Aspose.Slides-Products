...
keywords: PNG in SVG, Converti PNG in SVG, API C#, Libreria .NET
description: Converti PNG in SVG in C#. Usa l'API della libreria .NET per convertire i file PNG in SVG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converti PNG in SVG in C#" h2="API PowerPoint .NET per la conversione di file immagine PNG in SVG su piattaforme NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Converti PNG in SVG in C#" %}}

Come posso convertire PNG in SVG nel codice?

Utilizzando [**Aspose.Slides for .NET**](https://products.aspose.com/slides/it/net/), qualsiasi sviluppatore o applicazione può convertire PNG in SVG con poche righe di codice C#.

In quanto moderna API di elaborazione dei documenti, Aspose.Slides for .NET esporta rapidamente i file PNG in SVG. La libreria Aspose PowerPoint ti consente di convertire PNG in SVG e immagini in altri formati.
...
{{< blocks/products/pf/agp/feature-section-col title="Come convertire PNG in SVG in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Gli sviluppatori e le applicazioni possono convertire PNG in SVG in questo modo:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Salva il file come immagine SVG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Prima di eseguire il codice C# di conversione da PNG a SVG, la tua macchina deve avere questi prerequisiti:
...
{{% blocks/products/pf/agp/code-block title="Codice C# per convertire PNG in SVG" offSpacer="" %}}
