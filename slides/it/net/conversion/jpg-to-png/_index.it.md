...
title: Converti JPG in PNG in C#
weight: 220
url: /it/net/conversion/jpg-to-png/ 
keywords: JPG in PNG, Converti JPG in PNG, API C#, Libreria .NET
description: Converti JPG in PNG in C#. Usa l'API della libreria .NET per convertire i file JPG in PNG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converti JPG in PNG in C#" h2="API PowerPoint .NET per la conversione di file immagine JPG in PNG su piattaforme NET Framework, .NET Core, Windows Azure, Mono o Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Converti JPG in PNG in C#" %}}

Come posso convertire JPG in PNG nel codice?

Utilizzando [**Aspose.Slides for .NET**](https://products.aspose.com/slides/it/net/), qualsiasi sviluppatore o applicazione può convertire JPG in PNG con poche righe di codice C#.

In quanto moderna API di elaborazione dei documenti, Aspose.Slides per .NET esporta rapidamente i file JPG in PNG. La libreria Aspose PowerPoint ti consente di convertire JPG in PNG e immagini in altri formati.
...
{{< blocks/products/pf/agp/feature-section-col title="Come convertire JPG in PNG in C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Gli sviluppatori e le applicazioni possono convertire JPG in PNG in questo modo:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Prima di eseguire il codice C# di conversione da JPG a PNG, la tua macchina deve avere questi prerequisiti:
...
{{% blocks/products/pf/agp/code-block title="Codice C# per convertire JPG in PNG" offSpacer="" %}}
