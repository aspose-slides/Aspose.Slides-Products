---
title: Unisci immagine a BMP in C#
url: /it/net/merger/image-to-bmp/
keywords: Da immagine a BMP, Unisci immagine a BMP, Unisci immagine a BMP, Combina immagini, Immagine, BMP, API C#, Libreria .NET
description: Unisci immagine a BMP in C#. Usa l'API della libreria .NET per combinare le immagini
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Unisci immagine a BMP in C#" h2="Potente API .NET multipiattaforma per l'unione di immagini in file BMP utilizzando il codice C# su piattaforme NET Framework, .NET Core, Windows Azure, Mono o Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Unisci immagine a BMP utilizzando Aspose.Slides" %}}

[**Aspose.Slides per .NET**](https://products.aspose.com/slides/it/net/) è una potente libreria .NET utilizzata per creare, convertire, unire e manipolare presentazioni, PDF, immagini, e altri file. Quando unisci un'immagine a BMP, stai effettivamente combinando le immagini per ottenere un singolo file BMP.
...
{{% blocks/products/pf/feature-page-section  h2="Unisci immagine a BMP in C#" %}}
Utilizzando [**Aspose.Slides per .NET**](https://products.aspose.com/slides/it/net/), puoi unire rapidamente l'immagine a BMP con poche righe di codice

{{% blocks/products/pf/agp/code-block title="Codice C# per unire Image a BMP" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Come unire l'immagine a BMP in C#" >}}
