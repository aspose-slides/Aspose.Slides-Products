...
url: /it/net/merger/svg-to-png/
keywords: Unisci SVG a PNG, SVG a PNG, Unisci SVG a PNG, Combina SVG a PNG, API C#, Libreria .NET
description: Unisci SVG a PNG in C#. Utilizza l'API della libreria .NET per combinare file SVG e PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Unisci SVG a PNG in C#" h2="Potente API .NET multipiattaforma per unire immagini da SVG a PNG utilizzando il codice C# su piattaforme NET Framework, .NET Core, Windows Azure, Mono o Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Unisci SVG a PNG usando Aspose.Slides" %}}

[**Aspose.Slides per .NET**](https://products.aspose.com/slides/it/net/) è una potente libreria .NET utilizzata per unire e manipolare presentazioni, immagini e altri file. Quando unisci SVG a PNG, stai effettivamente combinando immagini SVG per ottenere un'immagine PNG.
...
Usando [**Aspose.Slides per .NET**](https://products.aspose.com/slides/it/net/), puoi unire rapidamente i file SVG a PNG con poche righe di codice
