---
title: Unisci immagini PNG in C#
url: /it/net/merger/png-to-png/
keywords: Unisci PNG, PNG in PNG, Unisci PNG, Combina PNG, API C#, Libreria .NET
description: Unisci PNG a PNG in C#. Utilizza l'API della libreria .NET per combinare i file PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Unisci PNG in C#" h2="Potente API .NET multipiattaforma per l'unione di immagini PNG utilizzando il codice C# su piattaforme NET Framework, .NET Core, Windows Azure, Mono o Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Unisci PNG a PNG usando Aspose.Slides" %}}

[**Aspose.Slides per .NET**](https://products.aspose.com/slides/it/net/) è una potente libreria .NET utilizzata per unire e manipolare presentazioni, immagini e altri file. Quando unisci PNG a PNG, stai effettivamente combinando due immagini per ottenere un'immagine.
...
{{% blocks/products/pf/feature-page-section  h2="Unisci PNG a PNG in C#" %}}
Utilizzando [**Aspose.Slides per .NET**](https://products.aspose.com/slides/it/net/), puoi unire file PNG rapidamente con poche righe di codice

{{% blocks/products/pf/agp/code-block title="Codice C# per unire PNG in PNG" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Come unire PNG in C#" >}}
