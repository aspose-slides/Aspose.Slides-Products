---
title: Unisci JPG a PDF in C#
url: /it/net/merger/jpg-to-pdf/
keywords: Da JPG a PDF, Unisci JPG a PDF, Unisci JPG a PDF, PDF, JPG, API C#, Libreria .NET
description: Unisci JPG a PDF in C#. Utilizza l'API della libreria .NET per combinare JPG e PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Unisci JPG a PDF in C#" h2="Potente API .NET multipiattaforma per l'unione di file JPG in PDF utilizzando il codice C# su piattaforme NET Framework, .NET Core, Windows Azure, Mono o Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Unisci JPG a PDF utilizzando Aspose.Slides" %}}

[**Aspose.Slides per .NET**](https://products.aspose.com/slides/it/net/) è una potente libreria .NET utilizzata per creare, convertire, unire e manipolare presentazioni, PDF, immagini, e altri file. Quando unisci JPG a PDF, stai effettivamente combinando immagini JPG per ottenere un singolo file PDF.
...
{{% blocks/products/pf/feature-page-section  h2="Unisci JPG a PDF in C#" %}}
Utilizzando [**Aspose.Slides per .NET**](https://products.aspose.com/slides/it/net/), puoi unire rapidamente JPG a PDF con poche righe di codice

{{% blocks/products/pf/agp/code-block title="Codice C# per l'unione di JPG in PDF" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Come unire JPG in PDF in C#" >}}
