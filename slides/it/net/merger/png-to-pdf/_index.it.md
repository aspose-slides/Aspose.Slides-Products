---
title: Unisci PNG a PDF in C#
url: /it/net/merger/png-to-pdf/
keywords: Da PNG a PDF, Unisci PNG a PDF, Unisci PNG a PDF, PDF, PNG, API C#, Libreria .NET
description: Unisci PNG a PDF in C#. Utilizza l'API della libreria .NET per combinare PNG e PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Unisci PNG a PDF in C#" h2="Potente API .NET multipiattaforma per l'unione di file PNG in PDF utilizzando il codice C# su piattaforme NET Framework, .NET Core, Windows Azure, Mono o Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Unisci PNG in PDF utilizzando Aspose.Slides" %}}

[**Aspose.Slides per .NET**](https://products.aspose.com/slides/it/net/) è una potente libreria .NET utilizzata per creare, convertire, unire e manipolare presentazioni, immagini e altri File. Quando unisci PNG a PDF, stai effettivamente combinando immagini PNG per ottenere un singolo file PDF.
...
{{% blocks/products/pf/feature-page-section  h2="Unisci PNG a PDF in C#" %}}
Usando [**Aspose.Slides per .NET**](https://products.aspose.com/slides/it/net/), puoi unire rapidamente PNG a PDF con poche righe di codice

{{% blocks/products/pf/agp/code-block title="Codice C# per unire PNG in PDF" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Come unire PNG in PDF in C#" >}}
