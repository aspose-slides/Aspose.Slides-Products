---
title: Proteggi e blocca il documento ODP tramite .NET
weight: 4230
url: /it/net/protect/odp/ 
description: Codice sorgente C# per bloccare il file ODP usando la password su piattaforme .NET Framework, .NET Core, Windows Azure, Mono o Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Crittografa i file ODP tramite C#" h2="Proteggi con password le presentazioni PowerPoint, incluso il formato ODP, utilizzando .NET Library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Come proteggere il file ODP usando C#" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Proteggi ODP tramite C#" >}}
