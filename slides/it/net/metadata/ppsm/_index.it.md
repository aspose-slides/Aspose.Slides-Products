---
title: Visualizza o modifica i metadati dei file PPSM tramite .NET
weight: 8130
url: /it/net/metadata/ppsm/ 
description: Codice sorgente C# per modificare o visualizzare i metadati in formato PPSM su piattaforme .NET Framework, .NET Core, Windows Azure, Mono o Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Estrai metadati PPSM tramite .NET" h2="Crea le tue app .NET per aggiungere, modificare, rimuovere o estrarre metadati dai file PPSM utilizzando le API lato server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Come estrarre i metadati PPSM usando C#" %}}
