---
title: Visualizza o modifica i metadati dei file PPS tramite .NET
weight: 7210
url: /it/net/metadata/pps/ 
description: Codice sorgente C# per modificare o visualizzare i metadati in formato PPS su piattaforme .NET Framework, .NET Core, Windows Azure, Mono o Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Estrai metadati PPS tramite .NET" h2="Crea le tue app .NET per aggiungere, modificare, rimuovere o estrarre metadati da file PPS utilizzando API lato server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPS" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
