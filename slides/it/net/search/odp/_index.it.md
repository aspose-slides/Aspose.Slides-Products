---
title: Cerca il documento ODP senza aprire tramite C#
weight: 8110
url: /it/net/search/odp/ 
description: Codice sorgente C# per cercare parole con pattern nel file ODP su piattaforme .NET Framework, .NET Core, Windows Azure, Mono o Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Cerca formati ODP in C#" h2="Ricerca di documenti ODP nativa e ad alte prestazioni utilizzando Aspose.Slides lato server per API .NET, senza l'uso di software come Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Come cercare file ODP usando C#" %}}

 Per cercare il file ODP, useremo
 [Aspose.Slides per .NET](https://products.aspose.com/slides/it/net)
 API che è un'API di ricerca di presentazioni PowerPoint ricca di funzionalità, potente e facile da usare per la piattaforma C#. Aprire
...
{{< blocks/products/pf/agp/feature-section-col title="Passaggi per cercare file ODP in C#" >}}
...
{{% blocks/products/pf/agp/code-block title="Cerca file ODP - C#" offSpacer="" %}}
