---
title: API di PowerPoint per Android | Aspose.Slides per API Android
weight: 5960
url: /it/android-java/ 
description: Aspose.Slides per API Android o API PowerPoint per Android per creare leggere e manipolare PPT POT PPS PPTX POTX PPSX PowerPoint su Android.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API di PowerPoint per Android" h2="Crea, modifica, converti, unisci, dividi e gestisci presentazioni PowerPoint nelle app Android." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-android-java.svg" pfName="Aspose.Slides" subTitlepfName="for Android via Java" downloadUrl="https://downloads.aspose.com/slides/androidjava" >}}
...
<p>
 Aspose.Slides per Android tramite Java è un'API di PowerPoint per applicazioni Android. Gli sviluppatori possono eseguire un'ampia gamma di attività di elaborazione delle presentazioni, tra cui leggere, scrivere, modificare, unire, dividere, convertire e manipolare le presentazioni senza alcuna dipendenza da Microsoft PowerPoint.
</p>

<p>
 Aspose.Slides per Android tramite Java supporta quasi tutti i formati di file PowerPoint nativi e il formato di presentazione OpenOffice (ODP). Crea la tua app di visualizzazione di PowerPoint per Android, nonché convertitore, editor o qualsiasi altro. È possibile accedere a elementi di presentazione come forme SmartArt, grafici MSO, componenti ActiveX e oggetti frame OLE tramite l'API di PowerPoint per la gestione e la manipolazione.
</p>
...
{{< blocks/products/pf/carousel-item h3="A prima vista" description="Panoramica delle funzionalità dell'API Aspose.Slides per Android." >}}
...
{{< blocks/products/pf/carousel-item h3="Indipendenza dalla piattaforma" description="Aspose.Slides per l'API Android copre i seguenti ambienti di sviluppo Android e piattaforme di distribuzione." >}}
<div class="diagram1 d1-android">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="Formati di file supportati" description="Aspose.Slides per Android API supporta [formati PowerPoint] nativi (https://docs.aspose.com/slides/java/supported-file-formats/) e molti formati di conversione." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Funzionalità avanzate dell'API di PowerPoint per Android
   </h2>
   <p>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Crea nuove diapositive o clona dai modelli
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Aggiungi o elimina la protezione sulle forme
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Aggiungi i grafici di Microsoft Excel come OleObjects
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Importa ed esporta testo HTML in diapositive
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Gestisci i componenti ActiveX e SmartArt
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Aggiungi o modifica la transizione della presentazione
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Rendering di immagini SVG in forme
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Formattazione della presentazione a livello di minuto
    </h2>
    <p>
     La libreria di PowerPoint può gestire facilmente le funzioni di formattazione del testo e della forma come la dimensione del carattere, il tipo, il colore e le sfumature, l'allineamento dei paragrafi, i punti elenco e l'orientamento e i collegamenti ipertestuali.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Conversione di presentazione con note
    </h2>
    <p>
     L'API fornisce la conversione in TIFF e PDF con note. Gli sviluppatori possono convertire l'intera presentazione nella visualizzazione diapositiva di Notes nel formato supportato e, in caso di immagini, è possibile creare una miniatura della diapositiva nella visualizzazione diapositiva di Notes per singole diapositive. Ecco il codice di conversione TIFF.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Converti presentazioni con Note
     </h3>
...
pres.save(dataDir + "TestNotes.tiff", SaveFormat.Tiff,opts);
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Manipola elementi tramite API pubblica
    </h2>
    <p>
     L'API è in grado di gestire tutti gli elementi della diapositiva della presentazione inclusi rettangolo, tabella, casella di testo, ellisse, polilinea, cornice immagine, forma automatica, cornice audio, cornice oggetto OLE e cornice video. API fornisce anche un ricco set di comandi API per manipolare ciascuno di questi elementi. Inoltre, la formattazione del testo è supportata da un insieme di classi ben progettato.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Documentazione" href="https://docs.aspose.com/slides/androidjava/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Perché Aspose.Slides per Android tramite Java?" tabId="success-stories" >}}
