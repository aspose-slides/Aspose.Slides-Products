---
title: Συγχώνευση αρχείων PPTX με χρήση PHP
url: /el/php-java/merger/pptx/
keywords: Συγχώνευση PPTX, Join PPTX, Combine PPTX, PowerPoint, Presentation, PHP, Aspose
description: Συγχώνευση πολλών αρχείων PPTX στην PHP.
---
...
{{% blocks/products/pf/agp/code-block title="Κώδικας PHP για συγχώνευση πολλαπλών PPTX σε μεμονωμένο αρχείο" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να συγχωνεύσετε το PPTX χρησιμοποιώντας το Aspose.Slides για PHP API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Αυτά είναι τα βήματα για να συγχωνεύσετε δύο αρχεία PPTX και να αποθηκεύσετε το αποτέλεσμα ως PPTX στην PHP." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Φορτώστε τα αρχεία PPTX που θέλετε να συγχωνεύσετε.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Αποθηκεύστε το έγγραφο PPTX που προκύπτει.
{{< /blocks/products/pf/agp/step-autogen >}}
