---
title: Συγχώνευση JPG σε PDF σε PHP
url: /el/php-java/merger/jpg-to-pdf/
keywords: JPG σε PDF, Συγχώνευση JPG σε PDF, Εγγραφή JPG σε PDF, PDF, JPG, PHP API, PHP Library
description: Συγχώνευση JPG σε PDF σε PHP. Χρησιμοποιήστε το API βιβλιοθήκης PHP για να συνδυάσετε JPG και PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Συγχώνευση JPG σε PDF σε PHP" h2="Βιβλιοθήκη PHP υψηλής ταχύτητας και πολλαπλών πλατφορμών για συγχώνευση αρχείων JPG σε PDF χρησιμοποιώντας κώδικα PHP" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Συγχώνευση JPG σε PDF σε PHP" %}}
Χρησιμοποιώντας το [**Aspose.Slides για PHP μέσω Java**](https://products.aspose.com/slides/el/php-java/), μπορείτε να συγχωνεύσετε γρήγορα JPG σε PDF με λίγες μόνο γραμμές κώδικα

{{% blocks/products/pf/agp/code-block title="Κώδικας PHP για συγχώνευση JPG σε PDF" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να συγχωνεύσετε JPG σε PDF σε PHP" >}}
