...
{{% blocks/products/pf/agp/code-block title="Κώδικας PHP για συγχώνευση πολλαπλών PPSX σε μεμονωμένο αρχείο" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να συγχωνεύσετε το PPSX χρησιμοποιώντας το Aspose.Slides για PHP API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Αυτά είναι τα βήματα για να συγχωνεύσετε δύο αρχεία PPSX και να αποθηκεύσετε το αποτέλεσμα ως PPSX στην PHP." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Φορτώστε τα αρχεία PPSX που θέλετε να συγχωνεύσετε.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Αποθηκεύστε το έγγραφο PPSX που προκύπτει.
{{< /blocks/products/pf/agp/step-autogen >}}
