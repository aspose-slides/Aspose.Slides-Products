...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <!--<h2 class="h2title">Προηγμένες δυνατότητες εξαγωγής JasperReports to Presentation</h2>

<p> </p>

<div class="col-lg-4"><em class="fa fa-file-powerpoint-o  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Δημιουργήστε αναφορές λογαριασμών και εξάγετε τις σε παρουσιάσεις του Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-bar-chart   ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Δημιουργήστε αναφορές γραφημάτων και εξάγετε τις σε παρουσιάσεις του Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-pie-chart ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Δημιουργήστε αναφορές γραφημάτων πολλαπλών αξόνων και εξάγετε σε παρουσιάσεις του Microsoft PowerPoint</p>

</div>

<div class="col-lg-4"><em class="fa fa-file-text ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Δημιουργήστε εικόνες, κείμενο, γραμμές και εξάγετε αυτές τις αναφορές στην παρουσίαση του Microsoft PowerPoint</p>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Απόκρυψη αριστερού παραθύρου μικρογραφιών διαφανειών στο δημιουργημένο PPT
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-area-chart ico-blue fa-2x col-lg-2">
