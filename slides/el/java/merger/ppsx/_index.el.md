...
title: Συγχώνευση αρχείων PPSX μέσω Java
weight: 5500
url: /el/java/merger/ppsx/ 
description: Δείγμα κώδικα Java για συνδυασμό εγγράφων PPSX σε Java Runtime Environment για εφαρμογές JSP/JSF και εφαρμογές επιφάνειας εργασίας.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Συγχώνευση μορφών PPSX σε Java" h2="Συγχώνευση εγγενών εγγράφων PPSX με χρήση API Java από την πλευρά του διακομιστή." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPSX" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να συγχωνεύσετε αρχεία PPSX χρησιμοποιώντας Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Βήματα για τη συγχώνευση αρχείων PPSX σε Java" >}}
...
Φορτώστε το πρώτο αρχείο PPSX με μια παρουσία της κλάσης Presentation.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Φορτώστε το δεύτερο έγγραφο PPSX με μια παρουσία της κλάσης Presentation.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Κάντε βρόχο σε κάθε διαφάνεια του δεύτερου αρχείου PPSX.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Συγχώνευση αρχείων PPSX - Java" offSpacer="" %}}
