---
title: Συγχώνευση αρχείων ODP μέσω Java
weight: 2500
url: /el/java/merger/odp/ 
description: Δείγμα κώδικα Java για συνδυασμό εγγράφων ODP σε Java Runtime Environment για εφαρμογές JSP/JSF και εφαρμογές επιφάνειας εργασίας.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Συγχώνευση μορφών ODP σε Java" h2="Συγχώνευση εγγενών εγγράφων ODP με χρήση API Java από την πλευρά του διακομιστή." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να συγχωνεύσετε αρχεία ODP χρησιμοποιώντας Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Βήματα για τη συγχώνευση αρχείων ODP σε Java" >}}
...
Φορτώστε το πρώτο αρχείο ODP με μια παρουσία της κλάσης Presentation.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Φορτώστε το δεύτερο έγγραφο ODP με μια παρουσία της κλάσης Presentation.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Κάντε βρόχο σε κάθε διαφάνεια του δεύτερου αρχείου ODP.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Συγχώνευση αρχείων ODP - Java" offSpacer="" %}}
