---
title: Συγχώνευση JPG σε PDF σε Java
url: /el/java/merger/jpg-to-pdf/
keywords: JPG σε PDF, Συγχώνευση JPG σε PDF, Εγγραφή JPG σε PDF, PDF, JPG, Java API, Java Library
description: Συγχώνευση JPG σε PDF σε Java. Χρησιμοποιήστε το Java Library API για να συνδυάσετε JPG και PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Συγχώνευση JPG σε PDF σε Java" h2="Βιβλιοθήκη Java υψηλής ταχύτητας και πολλαπλών πλατφορμών για τη συγχώνευση αρχείων JPG σε PDF χρησιμοποιώντας κώδικα Java" >}}

{{% blocks/products/pf/feature-page-section h2="Συγχώνευση JPG σε PDF χρησιμοποιώντας το Aspose.Slides" %}}

Το [**Aspose.Slides for Java**](https://products.aspose.com/slides/el/java/) είναι μια ισχυρή βιβλιοθήκη Java που χρησιμοποιείται για τη δημιουργία, μετατροπή, συγχώνευση και χειρισμό παρουσιάσεων, αρχείων PDF, εικόνων και άλλων αρχεία. Όταν συγχωνεύετε JPG σε PDF, συνδυάζετε αποτελεσματικά εικόνες JPG για να λάβετε ένα μόνο αρχείο PDF.
...
{{% blocks/products/pf/feature-page-section  h2="Συγχώνευση JPG σε PDF σε Java" %}}
Χρησιμοποιώντας το [**Aspose.Slides for Java**](https://products.aspose.com/slides/el/java/), μπορείτε να συγχωνεύσετε γρήγορα JPG σε PDF με λίγες μόνο γραμμές κώδικα

{{% blocks/products/pf/agp/code-block title="Κώδικας Java για τη συγχώνευση JPG σε PDF" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να συγχωνεύσετε JPG σε PDF σε Java" >}}
