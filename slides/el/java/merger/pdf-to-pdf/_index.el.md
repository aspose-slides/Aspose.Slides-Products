...
url: /el/java/merger/pdf-to-pdf/
keywords: Συγχώνευση PDF, PDF σε PDF, Εγγραφή PDF, Συνδυασμός PDF, Java API, Java Library
description: Συγχώνευση PDF σε PDF σε Java. Χρησιμοποιήστε το Java Library API για να συνδυάσετε αρχεία PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Συγχώνευση PDF σε Java" h2="Βιβλιοθήκη Java υψηλής ταχύτητας και πολλαπλών πλατφορμών για τη συγχώνευση αρχείων PDF με χρήση κώδικα Java" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Συγχώνευση PDF σε PDF σε Java" %}}
Χρησιμοποιώντας το [**Aspose.Slides for Java**](https://products.aspose.com/slides/el/java/), μπορείτε να συγχωνεύσετε γρήγορα αρχεία PDF με λίγες μόνο γραμμές κώδικα

{{% blocks/products/pf/agp/code-block title="Κώδικας Java για τη συγχώνευση PDF σε PDF" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να συγχωνεύσετε το PDF σε Java" >}}
