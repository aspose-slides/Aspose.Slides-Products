...
{{% blocks/products/pf/agp/code-block title="Τροποποίηση ενσωματωμένων ιδιοτήτων PPTX - Java" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Προσθήκη προσαρμοσμένων ιδιοτήτων στο PPTX - Java" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Τρόπος εξαγωγής μεταδεδομένων του PPTX μέσω του Java" >}}
