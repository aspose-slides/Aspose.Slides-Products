---
title: Επεξεργασία ή προβολή μεταδεδομένων αρχείων PPTM μέσω Java
weight: 3850
url: /el/java/metadata/pptm/ 
description: Δείγμα κώδικα Java για επεξεργασία ή προβολή μεταδεδομένων μορφής PPTM στο Java Runtime Environment για εφαρμογές JSP/JSF και εφαρμογές επιφάνειας εργασίας.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Εξαγωγή Μεταδεδομένων PPTM μέσω Java" h2="Δημιουργήστε τις δικές σας εφαρμογές Java για να προσθέσετε, να επεξεργαστείτε, να αφαιρέσετε ή να εξαγάγετε μεταδεδομένα από αρχεία PPTM χρησιμοποιώντας API από την πλευρά του διακομιστή." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTM" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να εξαγάγετε μεταδεδομένα PPTM χρησιμοποιώντας Java" %}}

 Για να λάβουμε μεταδεδομένα αρχείου PPTM, θα χρησιμοποιήσουμε
...
{{< blocks/products/pf/agp/feature-section-col title="Βήματα για την εξαγωγή μεταδεδομένων του PPTM μέσω Java" >}}
...
Λάβετε πληροφορίες PPTM χρησιμοποιώντας το getPresentationInfo()
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Ενημερώστε και γράψτε πληροφορίες PPTM με νέες ιδιότητες
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="Εξαγωγή μεταδεδομένων PPTM - Java" offSpacer="" %}}
