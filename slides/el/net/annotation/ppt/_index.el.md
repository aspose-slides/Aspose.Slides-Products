---
title: Καταργήστε τον σχολιασμό PPT χρησιμοποιώντας .NET
weight: 4380
url: /el/net/annotation/ppt/ 
description: Πηγαίος κώδικας C# για διαγραφή σχολιασμών μορφής PPT σε πλατφόρμες .NET Framework, .NET Core, Windows Azure, Mono ή Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Κατάργηση σχολίων και συντακτών σχολίων από το PPT σε C#" h2="Δημιουργήστε τις δικές σας εφαρμογές .NET για να χειρίζεστε σχόλια και συντάκτες σε αρχεία εγγράφων χρησιμοποιώντας API από την πλευρά του διακομιστή." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5="ODP" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides " subTitlepfName="for .NET" >}}

{{% blocks/products/pf/feature-page-section  h2="Κατάργηση σχολίων από το PPT μέσω C#" %}}
Για να αφαιρέσουμε σχολιασμούς από το αρχείο PPT, θα χρησιμοποιήσουμε το [Aspose.Slides for .NET](https://products.aspose.com/slides/el/net) API που είναι πλούσιο σε χαρακτηριστικά, ισχυρό και εύκολο στη χρήση API χειρισμού εγγράφων για πλατφόρμα C#.
{{% blocks/products/pf/agp/code-block title="Διαγραφή σχολιασμών από PPT - C#" offSpacer="true" %}}
