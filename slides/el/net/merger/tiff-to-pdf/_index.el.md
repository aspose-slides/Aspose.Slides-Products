...
url: /el/net/merger/tiff-to-pdf/
keywords: TIFF σε PDF, Συγχώνευση TIFF σε PDF, Συμμετοχή TIFF σε PDF, PDF, TIFF, C# API, .NET Library
description: Συγχώνευση TIFF σε PDF σε C#. Χρησιμοποιήστε το API βιβλιοθήκης .NET για να συνδυάσετε TIFF και PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Συγχώνευση TIFF σε PDF σε C#" h2="Ισχυρό cross-platform .NET API για συγχώνευση αρχείων TIFF σε PDF χρησιμοποιώντας κώδικα C# σε πλατφόρμες NET Framework, .NET Core, Windows Azure, Mono ή Xamarin" >}}
...
Χρησιμοποιώντας το [**Aspose.Slides για .NET**](https://products.aspose.com/slides/el/net/), μπορείτε να συγχωνεύσετε γρήγορα το TIFF σε PDF με λίγες μόνο γραμμές κώδικα

{{% blocks/products/pf/agp/code-block title="Κωδικός C# για τη συγχώνευση TIFF σε PDF" offSpacer="true" %}}
```cs
