...
url: /el/net/merger/jpg-to-pdf/
keywords: JPG σε PDF, Συγχώνευση JPG σε PDF, Συμμετοχή JPG σε PDF, PDF, JPG, C# API, .NET Library
description: Συγχώνευση JPG σε PDF σε C#. Χρησιμοποιήστε το API βιβλιοθήκης .NET για να συνδυάσετε JPG και PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Συγχώνευση JPG σε PDF σε C#" h2="Ισχυρό cross-platform .NET API για συγχώνευση αρχείων JPG σε PDF με χρήση κώδικα C# σε πλατφόρμες NET Framework, .NET Core, Windows Azure, Mono ή Xamarin" >}}
...
Χρησιμοποιώντας το [**Aspose.Slides για .NET**](https://products.aspose.com/slides/el/net/), μπορείτε να συγχωνεύσετε γρήγορα JPG σε PDF με λίγες μόνο γραμμές κώδικα

{{% blocks/products/pf/agp/code-block title="Κωδικός C# για τη συγχώνευση JPG σε PDF" offSpacer="true" %}}
```cs
