...
url: /el/net/merger/html-to-html/
keywords: Συγχώνευση HTML, HTML σε HTML, Join HTML, Combine HTML, C# API, .NET Library
description: Συγχώνευση HTML σε HTML σε C#. Χρησιμοποιήστε το API βιβλιοθήκης .NET για να συνδυάσετε αρχεία HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Συγχώνευση HTML σε C#" h2="Ισχυρό cross-platform .NET API για συγχώνευση αρχείων HTML με χρήση κώδικα C# σε πλατφόρμες NET Framework, .NET Core, Windows Azure, Mono ή Xamarin" >}}
...
Χρησιμοποιώντας το [**Aspose.Slides για .NET**](https://products.aspose.com/slides/el/net/), μπορείτε να συγχωνεύσετε γρήγορα αρχεία HTML με λίγες μόνο γραμμές κώδικα

{{% blocks/products/pf/agp/code-block title="Κωδικός C# για τη συγχώνευση HTML σε HTML" offSpacer="true" %}}
```cs
