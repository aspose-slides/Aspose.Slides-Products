...
url: /el/net/merger/pdf-to-pdf/
keywords: Συγχώνευση PDF, PDF σε PDF, Εγγραφή PDF, Συνδυασμός PDF, C# API, Βιβλιοθήκη .NET
description: Συγχώνευση PDF σε PDF σε C#. Χρησιμοποιήστε το API βιβλιοθήκης .NET για να συνδυάσετε αρχεία PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Συγχώνευση PDF σε C#" h2="Ισχυρό cross-platform .NET API για συγχώνευση αρχείων PDF με χρήση κώδικα C# σε πλατφόρμες NET Framework, .NET Core, Windows Azure, Mono ή Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Συγχώνευση PDF σε PDF χρησιμοποιώντας το Aspose.Slides" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Συγχώνευση PDF σε PDF σε C#" %}}
Χρησιμοποιώντας το [**Aspose.Slides για .NET**](https://products.aspose.com/slides/el/net/), μπορείτε να συγχωνεύσετε γρήγορα αρχεία PDF με λίγες μόνο γραμμές κώδικα

{{% blocks/products/pf/agp/code-block title="Κωδικός C# για τη συγχώνευση PDF σε PDF" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να συγχωνεύσετε PDF σε C#" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Φορτώστε τα αρχεία PDF που θέλετε να συγχωνεύσετε.
{{< /blocks/products/pf/agp/step-autogen >}}
