---
title: Προστατέψτε και κλειδώστε το έγγραφο PPT μέσω .NET
weight: 1330
url: /el/net/protect/ppt/ 
description: Πηγαίος κώδικας C# για κλείδωμα αρχείου PPT με χρήση κωδικού πρόσβασης σε πλατφόρμες .NET Framework, .NET Core, Windows Azure, Mono ή Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Κρυπτογράφηση αρχείων PPT μέσω C#" h2="Παρουσιάσεις PowerPoint με προστασία κωδικού πρόσβασης, συμπεριλαμβανομένης της μορφής PPT χρησιμοποιώντας .NET Library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να προστατέψετε το αρχείο PPT χρησιμοποιώντας C#" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Προστασία PPT μέσω C#" >}}
...
Φορτώστε το PPT με μια παρουσία παρουσίασης
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/el/net/protect/odp/" name="ODP" description="Μορφή παρουσίασης OpenDocument" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/el/net/protect/pptx/" name="PPTX" description="Ανοίξτε τη μορφή παρουσίασης XML" >}}
