---
title: Προστασία και κλείδωμα εγγράφου PPTX μέσω .NET
weight: 5000
url: /el/net/protect/pptx/ 
description: Πηγαίος κώδικας C# για κλείδωμα αρχείου PPTX με χρήση κωδικού πρόσβασης σε πλατφόρμες .NET Framework, .NET Core, Windows Azure, Mono ή Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Κρυπτογράφηση αρχείων PPTX μέσω C#" h2="Παρουσιάσεις PowerPoint με προστασία κωδικού πρόσβασης, συμπεριλαμβανομένης της μορφής PPTX, χρησιμοποιώντας .NET Library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να προστατέψετε το αρχείο PPTX χρησιμοποιώντας C#" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="Προστασία PPTX μέσω C#" >}}
...
Φορτώστε το PPTX με μια παρουσία παρουσίασης
{{< /blocks/products/pf/agp/step-autogen >}}
