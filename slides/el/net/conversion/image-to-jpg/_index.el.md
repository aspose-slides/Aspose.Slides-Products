...
title: Μετατροπή εικόνας σε JPG σε C#
weight: 200
url: /el/net/conversion/image-to-jpg/ 
keywords: Εικόνα σε JPG, Μετατροπή εικόνας σε JPG, C# API, Βιβλιοθήκη .NET, Εικόνα, JPG
description: Μετατροπή εικόνας σε JPG σε C#. Χρησιμοποιήστε το API βιβλιοθήκης .NET για να μετατρέψετε Εικόνες σε εικόνες JPG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Μετατροπή εικόνας σε JPG σε C#" h2="PowerPoint .NET API για μετατροπή εικόνων σε εικόνες JPG σε πλατφόρμες NET Framework, .NET Core, Windows Azure, Mono ή Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Μετατροπή εικόνας σε JPG σε C#" %}}

Πώς μπορώ να μετατρέψω την εικόνα σε JPG σε κώδικα;

Χρησιμοποιώντας το [**Aspose.Slides για .NET**](https://products.aspose.com/slides/el/net/), κάθε προγραμματιστής ή εφαρμογή μπορεί να μετατρέψει μια εικόνα σε εικόνα JPG με λίγες μόνο γραμμές κώδικα C# .

Ως σύγχρονο API επεξεργασίας εγγράφων, το Aspose.Slides για .NET εξάγει γρήγορα εικόνες σε δημοφιλείς μορφές σε JPG. Η βιβλιοθήκη Aspose PowerPoint σάς επιτρέπει να μετατρέπετε εικόνες σε JPG και σε πολλές άλλες μορφές εικόνας.
...
{{< blocks/products/pf/agp/feature-section-col title="Πώς να μετατρέψετε εικόνα σε JPG σε C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Οι προγραμματιστές και οι εφαρμογές μπορούν να μετατρέψουν την εικόνα σε JPG με αυτόν τον τρόπο:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Προτού εκτελέσετε τον κώδικα C# μετατροπής εικόνας σε JPG, το μηχάνημά σας πρέπει να έχει αυτές τις προϋποθέσεις:
...
{{% blocks/products/pf/agp/code-block title="Κωδικός C# για μετατροπή εικόνας σε JPG" offSpacer="" %}}
