...
weight: 10
url: /el/net/conversion/jpg-to-pdf/ 
keywords: JPG σε PDF, Μετατροπή JPG σε PDF, C# API, .NET Library
description: Μετατροπή JPG σε PDF σε C#. Χρησιμοποιήστε το API βιβλιοθήκης .NET για να μετατρέψετε εικόνες JPG JPEG σε έγγραφα PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Μετατροπή JPG σε PDF σε C#" h2="PowerPoint .NET API για μετατροπή εικόνων JPG σε έγγραφα PDF σε πλατφόρμες NET Framework, .NET Core, Windows Azure, Mono ή Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε JPG σε PDF σε C#" %}}

Πώς μπορώ να μετατρέψω JPG σε PDF μέσω προγραμματισμού;

Χρησιμοποιώντας το [**Aspose.Slides για .NET**](https://products.aspose.com/slides/el/net/), κάθε προγραμματιστής ή εφαρμογή μπορεί να μετατρέψει JPG σε μορφή PDF με λίγες μόνο γραμμές κώδικα C#.

Ως σύγχρονο API επεξεργασίας εγγράφων, το Aspose.Slides for .NET δημιουργεί γρήγορα αρχεία PDF από εικόνες JPG. Η βιβλιοθήκη Aspose PowerPoint σάς επιτρέπει να μετατρέψετε JPG σε PDF και πολλές άλλες μορφές αρχείων
...
{{< blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή JPG σε PDF σε C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Οι προγραμματιστές και οι εφαρμογές μπορούν να μετατρέψουν JPG σε PDF με αυτόν τον τρόπο:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Προτού εκτελέσετε τον κώδικα C# μετατροπής JPG σε PDF, το μηχάνημά σας πρέπει να έχει αυτές τις προϋποθέσεις:
...
{{% blocks/products/pf/agp/code-block title="Κωδικός C# για μετατροπή JPG σε PDF" offSpacer="" %}}
