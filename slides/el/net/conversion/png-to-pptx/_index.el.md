...
url: /el/net/conversion/png-to-pptx/
keywords: Μετατροπή PNG σε PPTX, PNG σε PPTX, PowerPoint, PNG, PPTX, C# API, .NET Library
description: Μετατροπή PNG σε PPTX σε C#. Χρησιμοποιήστε το API βιβλιοθήκης .NET για να μετατρέψετε εικόνες PNG σε PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Μετατροπή PNG σε PPTX σε C#" h2="Ισχυρό cross-platform .NET API για μετατροπή PNG σε PPTX με χρήση κώδικα C# σε πλατφόρμες NET Framework, .NET Core, Windows Azure, Mono ή Xamarin" >}}

{{% blocks/products/pf/feature-page-section h2="Μετατρέψτε το PNG σε PPTX χρησιμοποιώντας το Aspose.Slides" %}}

Το [**Aspose.Slides for .NET**](https://products.aspose.com/slides/el/net/) είναι μια ισχυρή βιβλιοθήκη .NET που χρησιμοποιείται για τη δημιουργία, μετατροπή και χειρισμό παρουσιάσεων PowerPoint, PDF, εγγράφων HTML, και άλλα αρχεία. Όταν μετατρέπετε το PNG σε PPTX, ουσιαστικά δημιουργείτε μια παρουσίαση PowerPoint που περιέχει διαφάνειες που βασίζονται σε εικόνες PNG.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="Μετατροπή PNG σε PPTX σε C#" %}}
Χρησιμοποιώντας το [**Aspose.Slides για .NET**](https://products.aspose.com/slides/el/net/), μπορείτε να μετατρέψετε εικόνα PNG σε παρουσίαση PowerPoint με λίγες μόνο γραμμές κώδικα:

{{% blocks/products/pf/agp/code-block title="Κωδικός C# για μετατροπή PNG σε PPTX" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να μετατρέψετε PNG σε PPTX σε C#" >}}
