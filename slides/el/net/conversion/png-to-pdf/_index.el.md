...
title: Μετατροπή PNG σε PDF σε C#
weight: 30
url: /el/net/conversion/png-to-pdf/ 
keywords: PNG σε PDF, Μετατροπή PNG σε PDF, C# API, .NET Library, PNG, PDF
description: Μετατροπή PNG σε PDF σε C#. Χρησιμοποιήστε το API βιβλιοθήκης .NET για να μετατρέψετε εικόνες PNG σε έγγραφα PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Μετατροπή PNG σε PDF σε C#" h2="PowerPoint .NET API για μετατροπή εικόνων PNG σε έγγραφα PDF σε πλατφόρμες NET Framework, .NET Core, Windows Azure, Mono ή Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="PNG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε PNG σε PDF σε C#" %}}

Πώς μπορώ να μετατρέψω το PNG σε PDF μέσω προγραμματισμού;

Χρησιμοποιώντας το [**Aspose.Slides για .NET**](https://products.aspose.com/slides/el/net/), οποιοσδήποτε προγραμματιστής ή εφαρμογή μπορεί να μετατρέψει το PNG σε μορφή PDF με λίγες μόνο γραμμές κώδικα C#.

Ως σύγχρονο API επεξεργασίας εγγράφων, το Aspose.Slides for .NET δημιουργεί γρήγορα αρχεία PDF από εικόνες PNG. Η βιβλιοθήκη Aspose PowerPoint σάς επιτρέπει να μετατρέψετε PNG σε PDF και πολλές άλλες μορφές αρχείων
...
{{< blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή PNG σε PDF σε C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Οι προγραμματιστές και οι εφαρμογές μπορούν να μετατρέψουν το PNG σε PDF με αυτόν τον τρόπο:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Προσθέστε ένα πλαίσιο εικόνας.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
Καλέστε τη μέθοδο αποθήκευσης για να αποθηκεύσετε το αρχείο ως PDF.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Προτού εκτελέσετε τον κώδικα C# μετατροπής PNG σε PDF, το μηχάνημά σας πρέπει να έχει αυτές τις προϋποθέσεις:
...
{{% blocks/products/pf/agp/code-block title="Κωδικός C# για μετατροπή PNG σε PDF" offSpacer="" %}}
