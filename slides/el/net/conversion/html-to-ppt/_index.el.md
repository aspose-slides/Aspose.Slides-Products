...
url: /el/net/conversion/html-to-ppt/
keywords: Μετατροπή HTML σε PPT, HTML σε PPT, PowerPoint, HTML, PPT, C# API, Βιβλιοθήκη .NET
description: Μετατροπή HTML σε PPT σε C#. Χρησιμοποιήστε το API βιβλιοθήκης .NET για να μετατρέψετε HTML σε PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Μετατροπή HTML σε PPT σε C#" h2="Ισχυρό cross-platform .NET API για μετατροπή HTML σε PPT με χρήση κώδικα C# σε πλατφόρμες NET Framework, .NET Core, Windows Azure, Mono ή Xamarin" >}}
...
{{% blocks/products/pf/agp/code-block title="Κωδικός C# για μετατροπή HTML σε PPT" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να μετατρέψετε HTML σε PPT σε C#" >}}
