---
title: Μετατροπή εικόνας σε PDF σε C#
weight: 30
url: /el/net/conversion/image-to-pdf/ 
keywords: Εικόνα σε PDF, Μετατροπή εικόνας σε PDF, C# API, Βιβλιοθήκη .NET, Εικόνα, JPG, PNG, PDF
description: Μετατροπή εικόνας σε PDF σε C#. Χρησιμοποιήστε το API βιβλιοθήκης .NET για να μετατρέψετε Εικόνες σε έγγραφα PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Μετατροπή εικόνας σε PDF σε C#" h2="PowerPoint .NET API για μετατροπή εικόνων σε έγγραφα PDF σε πλατφόρμες NET Framework, .NET Core, Windows Azure, Mono ή Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε εικόνα σε PDF σε C#" %}}

Πώς μπορώ να μετατρέψω την εικόνα σε PDF μέσω προγραμματισμού;

Χρησιμοποιώντας το [**Aspose.Slides για .NET**](https://products.aspose.com/slides/el/net/), κάθε προγραμματιστής ή εφαρμογή μπορεί να μετατρέψει την εικόνα σε μορφή PDF με λίγες μόνο γραμμές κώδικα C#.

Ως σύγχρονο API επεξεργασίας εγγράφων, το Aspose.Slides for .NET δημιουργεί γρήγορα αρχεία PDF από εικόνες JPG ή PNG. Η βιβλιοθήκη Aspose PowerPoint σάς επιτρέπει να μετατρέψετε την εικόνα σε PDF και πολλές άλλες μορφές αρχείων
...
{{< blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή εικόνας σε PDF σε C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Οι προγραμματιστές και οι εφαρμογές μπορούν να μετατρέψουν την εικόνα σε PDF με αυτόν τον τρόπο:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Προτού εκτελέσετε τον κώδικα C# μετατροπής εικόνας σε PDF, το μηχάνημά σας πρέπει να έχει αυτές τις προϋποθέσεις:
...
{{% blocks/products/pf/agp/code-block title="Κωδικός C# για μετατροπή εικόνας σε PDF" offSpacer="" %}}
