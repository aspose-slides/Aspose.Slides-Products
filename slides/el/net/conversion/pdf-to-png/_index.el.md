...
weight: 90
url: /el/net/conversion/pdf-to-png/ 
keywords: PDF σε PNG, Μετατροπή PDF σε PNG, C# API, .NET Library, PDF, PNG
description: Μετατροπή PDF σε PNG σε C#. Χρησιμοποιήστε το API βιβλιοθήκης .NET για να μετατρέψετε σελίδες PDF σε εικόνες PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Μετατροπή PDF σε PNG σε C#" h2="PowerPoint .NET API για μετατροπή εγγράφων PDF σε εικόνες PNG σε πλατφόρμες NET Framework, .NET Core, Windows Azure, Mono ή Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε PDF σε PNG σε C#" %}}

Πώς μπορώ να μετατρέψω PDF σε PNG σε κώδικα;

Χρησιμοποιώντας το [**Aspose.Slides για .NET**](https://products.aspose.com/slides/el/net/), κάθε προγραμματιστής ή εφαρμογή μπορεί να μετατρέψει PDF σε μορφή PNG με λίγες μόνο γραμμές κώδικα C#.

Ως σύγχρονο API επεξεργασίας εγγράφων, το Aspose.Slides for .NET εξάγει γρήγορα σελίδες PDF σε PNG. Η βιβλιοθήκη Aspose PowerPoint σάς επιτρέπει να μετατρέψετε PDF σε PNG και πολλές άλλες μορφές αρχείων
...
{{< blocks/products/pf/agp/feature-section-col title="Πώς να μετατρέψετε PDF σε PNG σε C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Οι προγραμματιστές και οι εφαρμογές μπορούν να μετατρέψουν PDF σε PNG με αυτόν τον τρόπο:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
Καλέστε τη μέθοδο αποθήκευσης για να αποθηκεύσετε τις διαφάνειες ως εικόνες PNG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Προτού εκτελέσετε τον κώδικα C# μετατροπής PDF σε PNG, το μηχάνημά σας πρέπει να έχει αυτές τις προϋποθέσεις:
...
{{% blocks/products/pf/agp/code-block title="Κωδικός C# για μετατροπή PDF σε PNG" offSpacer="" %}}
