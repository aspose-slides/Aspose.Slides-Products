---
title: Ξεκλειδώστε το έγγραφο ODP μέσω .NET
weight: 5780
url: /el/net/unlock/odp/ 
description: Πηγαίος κώδικας C# για ξεκλείδωμα αρχείου ODP που προστατεύεται με κωδικό πρόσβασης σε πλατφόρμες .NET Framework, .NET Core, Windows Azure, Mono ή Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Ξεκλείδωμα παρουσίασης ODP μέσω C#" h2="Καταργήστε την προστασία από το ODP χρησιμοποιώντας τη βιβλιοθήκη .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να ξεκλειδώσετε αρχείο ODP χρησιμοποιώντας C#" %}}

 Για να καταργήσουμε το αρχείο προστασίας ODP, θα χρησιμοποιήσουμε
...
{{< blocks/products/pf/agp/feature-section-col title="Ξεκλείδωμα ODP μέσω C#" >}}
