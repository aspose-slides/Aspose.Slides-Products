---
title: Προβολή ή επεξεργασία μεταδεδομένων αρχείων ODP χρησιμοποιώντας Python
url: /el/python-net/metadata/odp/
keywords: Επεξεργασία μεταδεδομένων ODP, Προβολή μεταδεδομένων ODP, Επεξεργασία ιδιοτήτων ODP, Προβολή ιδιοτήτων ODP
description: Πηγαίος κώδικας Python για επεξεργασία ή προβολή μεταδεδομένων μορφής ODP.
---
...
{{% blocks/products/pf/feature-page-section  h2="Τροποποίηση ιδιοτήτων ODP μέσω Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Τροποποίηση ενσωματωμένων ιδιοτήτων ODP - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="Προσθήκη προσαρμοσμένων ιδιοτήτων στο ODP - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Τρόπος εξαγωγής μεταδεδομένων του ODP μέσω του Python" >}}
