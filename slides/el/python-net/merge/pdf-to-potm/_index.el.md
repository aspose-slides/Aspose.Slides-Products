---
title: Συγχώνευση αρχείων PDF σε POTM χρησιμοποιώντας Python
url: /el/python-net/merge/pdf-to-potm/
keywords: Συγχώνευση PDF σε POTM, Join PDF σε POTM, Combine PDF σε POTM, PowerPoint, Presentation, POTM, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Συγχώνευση αρχείων PDF σε POTM χρησιμοποιώντας Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Κώδικας Python για συγχώνευση πολλαπλών PDF σε ένα αρχείο POTM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να συγχωνεύσετε το PDF στο POTM χρησιμοποιώντας το Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Αυτά είναι τα βήματα για να συγχωνεύσετε δύο αρχεία PDF και να αποθηκεύσετε το αποτέλεσμα ως POTM στην Python." >}}
