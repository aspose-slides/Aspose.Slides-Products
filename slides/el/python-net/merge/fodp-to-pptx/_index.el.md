---
title: Συγχώνευση αρχείων FODP σε PPTX χρησιμοποιώντας Python
url: /el/python-net/merge/fodp-to-pptx/
keywords: Συγχώνευση FODP σε PPTX, Join FODP σε PPTX, Combine FODP σε PPTX, PowerPoint, Presentation, PPTX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Συγχώνευση αρχείων FODP σε PPTX χρησιμοποιώντας Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Κώδικας Python για συγχώνευση πολλαπλών FODP σε ένα αρχείο PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να συγχωνεύσετε το FODP στο PPTX χρησιμοποιώντας το Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Αυτά είναι τα βήματα για να συγχωνεύσετε δύο αρχεία FODP και να αποθηκεύσετε το αποτέλεσμα ως PPTX στην Python." >}}
