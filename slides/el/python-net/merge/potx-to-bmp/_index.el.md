---
title: Συγχώνευση αρχείων POTX σε BMP χρησιμοποιώντας Python
url: /el/python-net/merge/potx-to-bmp/
keywords: Συγχώνευση POTX σε BMP, Join POTX σε BMP, Combine POTX σε BMP, PowerPoint, Presentation, BMP, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Συγχώνευση αρχείων POTX σε BMP χρησιμοποιώντας Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Κώδικας Python για συγχώνευση πολλαπλών POTX σε ένα αρχείο BMP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να συγχωνεύσετε το POTX στο BMP χρησιμοποιώντας το Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Αυτά είναι τα βήματα για να συγχωνεύσετε δύο αρχεία POTX και να αποθηκεύσετε το αποτέλεσμα ως BMP στην Python." >}}
