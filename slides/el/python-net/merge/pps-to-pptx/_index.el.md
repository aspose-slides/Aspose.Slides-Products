---
title: Συγχώνευση αρχείων PPS σε PPTX χρησιμοποιώντας Python
url: /el/python-net/merge/pps-to-pptx/
keywords: Συγχώνευση PPS σε PPTX, Join PPS σε PPTX, Combine PPS σε PPTX, PowerPoint, Presentation, PPTX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Συγχώνευση αρχείων PPS σε PPTX χρησιμοποιώντας Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Κώδικας Python για συγχώνευση πολλαπλών PPS σε ένα αρχείο PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να συγχωνεύσετε το PPS στο PPTX χρησιμοποιώντας το Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Αυτά είναι τα βήματα για να συγχωνεύσετε δύο αρχεία PPS και να αποθηκεύσετε το αποτέλεσμα ως PPTX στην Python." >}}
