---
title: Συγχώνευση αρχείων POTX σε XPS χρησιμοποιώντας Python
url: /el/python-net/merge/potx-to-xps/
keywords: Συγχώνευση POTX σε XPS, Join POTX σε XPS, Combine POTX σε XPS, PowerPoint, Presentation, XPS, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Συγχώνευση αρχείων POTX σε XPS χρησιμοποιώντας Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Κώδικας Python για συγχώνευση πολλαπλών POTX σε ένα αρχείο XPS" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να συγχωνεύσετε το POTX στο XPS χρησιμοποιώντας το Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Αυτά είναι τα βήματα για να συγχωνεύσετε δύο αρχεία POTX και να αποθηκεύσετε το αποτέλεσμα ως XPS στην Python." >}}
