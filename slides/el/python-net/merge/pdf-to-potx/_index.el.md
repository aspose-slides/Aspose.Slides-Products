...
{{% blocks/products/pf/feature-page-section  h2="Συγχώνευση αρχείων PDF σε POTX χρησιμοποιώντας Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Κώδικας Python για συγχώνευση πολλαπλών PDF σε ένα αρχείο POTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να συγχωνεύσετε το PDF στο POTX χρησιμοποιώντας το Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Αυτά είναι τα βήματα για να συγχωνεύσετε δύο αρχεία PDF και να αποθηκεύσετε το αποτέλεσμα ως POTX στην Python." >}}
