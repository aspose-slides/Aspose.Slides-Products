---
title: Συγχώνευση αρχείων POTX σε PPSX χρησιμοποιώντας Python
url: /el/python-net/merge/potx-to-ppsx/
keywords: Συγχώνευση POTX σε PPSX, Join POTX σε PPSX, Combine POTX σε PPSX, PowerPoint, Presentation, PPSX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Συγχώνευση αρχείων POTX σε PPSX χρησιμοποιώντας Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Κώδικας Python για συγχώνευση πολλαπλών POTX σε ένα αρχείο PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να συγχωνεύσετε το POTX στο PPSX χρησιμοποιώντας το Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Αυτά είναι τα βήματα για να συγχωνεύσετε δύο αρχεία POTX και να αποθηκεύσετε το αποτέλεσμα ως PPSX στην Python." >}}
