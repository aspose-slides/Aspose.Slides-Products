---
title: Συγχώνευση αρχείων PDF σε SVG χρησιμοποιώντας Python
url: /el/python-net/merge/pdf-to-svg/
keywords: Συγχώνευση PDF σε SVG, Join PDF σε SVG, Combine PDF σε SVG, PowerPoint, Presentation, SVG, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Συγχώνευση αρχείων PDF σε SVG χρησιμοποιώντας Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Κώδικας Python για συγχώνευση πολλαπλών PDF σε ένα αρχείο SVG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να συγχωνεύσετε το PDF στο SVG χρησιμοποιώντας το Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Αυτά είναι τα βήματα για να συγχωνεύσετε δύο αρχεία PDF και να αποθηκεύσετε το αποτέλεσμα ως SVG στην Python." >}}
