---
title: Συγχώνευση αρχείων PPSX χρησιμοποιώντας Python
url: /el/python-net/merge/ppsx/
keywords: Συγχώνευση PPSX, Join PPSX, Combine PPSX, PowerPoint, Presentation, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Συγχώνευση αρχείων PPSX χρησιμοποιώντας Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Κώδικας Python για συγχώνευση πολλαπλών PPSX σε ένα μόνο αρχείο" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να συγχωνεύσετε το PPSX χρησιμοποιώντας το Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Αυτά είναι τα βήματα για να συγχωνεύσετε δύο αρχεία PPSX και να αποθηκεύσετε το αποτέλεσμα ως PPSX στην Python." >}}
