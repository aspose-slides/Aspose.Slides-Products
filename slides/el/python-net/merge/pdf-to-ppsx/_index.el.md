---
title: Συγχώνευση αρχείων PDF σε PPSX χρησιμοποιώντας Python
url: /el/python-net/merge/pdf-to-ppsx/
keywords: Συγχώνευση PDF σε PPSX, Join PDF σε PPSX, Combine PDF σε PPSX, PowerPoint, Presentation, PPSX, Python, Aspose
...
{{% blocks/products/pf/feature-page-section  h2="Συγχώνευση αρχείων PDF σε PPSX χρησιμοποιώντας Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Κώδικας Python για συγχώνευση πολλαπλών PDF σε ένα αρχείο PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να συγχωνεύσετε το PDF στο PPSX χρησιμοποιώντας το Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="Αυτά είναι τα βήματα για να συγχωνεύσετε δύο αρχεία PDF και να αποθηκεύσετε το αποτέλεσμα ως PPSX στην Python." >}}
