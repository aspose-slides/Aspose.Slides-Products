...
{{% blocks/products/pf/agp/code-block title="Κείμενο αναζήτησης PPTX Παρουσίαση με χρήση Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="Τρόπος αναζήτησης κειμένου σε PPTX μέσω Python" >}}
