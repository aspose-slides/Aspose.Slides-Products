...
url: /el/cpp/conversion/html-to-pptx/
keywords: Μετατροπή HTML σε PPTX, HTML σε PPTX, PowerPoint, HTML, PPTX, C++ API, Βιβλιοθήκη C++
description: Μετατροπή HTML σε PPTX σε C++. Χρησιμοποιήστε το API βιβλιοθήκης C++ για να μετατρέψετε HTML σε PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Μετατροπή HTML σε PPTX σε C++" h2="Ισχυρό cross-platform C++ API για μετατροπή HTML σε PPTX χρησιμοποιώντας κώδικα C++" >}}
...
{{% blocks/products/pf/agp/code-block title="Κώδικας C++ για μετατροπή HTML σε PPTX" offSpacer="true" %}}
```cpp
