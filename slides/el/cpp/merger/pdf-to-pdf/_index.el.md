...
url: /el/cpp/merger/pdf-to-pdf/
keywords: Συγχώνευση PDF, PDF σε PDF, Εγγραφή PDF, Συνδυασμός PDF, C++ API, Βιβλιοθήκη C++
description: Συγχώνευση PDF σε PDF σε C++. Χρησιμοποιήστε το API βιβλιοθήκης C++ για να συνδυάσετε αρχεία PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="Συγχώνευση PDF σε C++" h2="Βιβλιοθήκη C++ υψηλής ταχύτητας και πολλαπλών πλατφορμών για συγχώνευση αρχείων PDF με χρήση κώδικα C++" >}}
...
Χρησιμοποιώντας το [**Aspose.Slides for C++**](https://products.aspose.com/slides/el/cpp/), μπορείτε να συγχωνεύσετε γρήγορα αρχεία PDF με λίγες μόνο γραμμές κώδικα

{{% blocks/products/pf/agp/code-block title="Κώδικας C++ για τη συγχώνευση PDF σε PDF" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="Πώς να συγχωνεύσετε το PDF σε C++" >}}
