...
<p class="col-lg-10">Ενσωματώστε γραφήματα Excel ως αντικείμενα OLE σε διαφάνειες</p>

</div>

<div class="col-lg-4"><em class="fa fa-print  ico-blue fa-2x col-lg-2"> </em>

<p class="col-lg-10">Διαχείριση συνδεδεμένων αντικειμένων Ole</p>
...
<p class="col-lg-10">Προσαρμοσμένη εκτύπωση παρουσιάσεων</p>
...
<h2 class="h2title">Συνεχής ενσωμάτωση νέων δυνατοτήτων</h2>

<p>Ποτέ δεν περιορίζεστε στις υπάρχουσες λειτουργίες. Οι ομάδες προϊόντων μας προσθέτουν συνεχώς όλο και περισσότερες δυνατότητες και κάθε νέα έκδοση προσφέρει περισσότερες δυνατότητες σε σύγκριση με τις παλαιότερες εκδόσεις. Μπορείτε επίσης να στείλετε αιτήματα νέων λειτουργιών εάν βρείτε ότι λείπει κάποια από τις λειτουργίες που επιθυμείτε. Εδώ είναι η λίστα με λίγες επιλογές από τις πιο πρόσφατες δυνατότητες.</p>

<ul>

<li>Ραστεροποίηση ή διανυσματοποίηση σχημάτων χωρίς κείμενο.</li>

<li>Μετατροπή εικόνων SVG σε σχήματα.</li>

<li>Αποκτήστε το προεπιλεγμένο φόντο του πίνακα.</li>

<li>Περιορισμός της πρόσβασης στο τοπικό σύστημα αρχείων κατά το άνοιγμα ενός εγγράφου.</li>

<li>Προσθέστε μετα-ετικέτα κωδικοποίησης κατά την αποθήκευση σε HTML.</li>

<li>Ρύθμιση για την αφαίρεση των χαρακτηριστικών πλάτους και ύψους της ετικέτας SVG κατά την αποθήκευση ως HTML.</li>

<li>Support for

<ul>

<li>Απαντήσεις σχολίων, Office 365 και εξωτερικά βιβλία εργασίας του Excel.</li>

<li>Το μέγεθος αντιπροσωπεύει την ιδιότητα για το γράφημα Bubble.</li>

<li>Απόκρυψη αριστερού παραθύρου μικρογραφιών διαφανειών στο PPT που δημιουργήθηκε.</li>

<li>Διαγράμματα διοχέτευσης, γραφήματα χαρτών 2D και ορισμός διαδρομής βιβλίου εργασίας εξωτερικής πηγής δεδομένων γραφήματος.</li>

<li>Λειτουργία κρυπτογράφησης OpenDocument, μετάβασης μορφοποίησης και επισήμανσης κειμένου.</li>

<li>Ρύθμιση της ιδιότητας Διαφάνεια για εφέ σκιάς.</li>

<li>Ρύθμιση σχήματος επεξήγησης για ετικέτα δεδομένων σειράς.</li>

<li>Λάβετε εφέ με παραγράφους πλαισίου κειμένου.</li>

<li>Εφέ απόδοσης σχήματος Soft Edges (EffectFormat).</li>

<li>Γράφημα συνόλου δεδομένων γραφήματος σε συγκεντρωτικό πίνακα.</li>

</ul>

</li>

<li>Εφαρμόστε τη μορφή Tiff πολλαπλών σελίδων, τις επεκτάσεις Metafile Format Plus (EMF+) και τη μορφή Strict Open XML.</li>

<li>Απόδοση σχολίων από μορφή ODP που δεν έχουν συντάκτη.</li>

<li>Υλοποιήστε τη σειριοποίηση με αυστηρή συμμόρφωση με τη μορφή ανοιχτού XML.</li>
...
{{< blocks/products/pf/slr-element name="Σημειώσεις έκδοσης" href="https://docs.aspose.com/slides/cpp/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
