---
title: Εξαγωγή κειμένου και εικόνων από έγγραφο PPT μέσω C++
weight: 2780
url: /el/cpp/parser/ppt/ 
description: Παράδειγμα κώδικα C++ για εξαγωγή κειμένου και εικόνων από αρχείο PPT σε περιβάλλον χρόνου εκτέλεσης C++ για Windows 32 bit, Windows 64 bit και Linux 64 bit.
---
