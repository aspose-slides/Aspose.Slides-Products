---
title: Προβολή ή επεξεργασία μεταδεδομένων αρχείων PPTM χρησιμοποιώντας C++
url: /el/cpp/metadata/pptm/
