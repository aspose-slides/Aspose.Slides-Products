---
title: Προβολή ή επεξεργασία μεταδεδομένων αρχείων PPSM χρησιμοποιώντας C++
url: /el/cpp/metadata/ppsm/
