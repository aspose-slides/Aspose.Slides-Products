---
title: Προβολή ή επεξεργασία μεταδεδομένων αρχείων PPT χρησιμοποιώντας C++
url: /el/cpp/metadata/ppt/
