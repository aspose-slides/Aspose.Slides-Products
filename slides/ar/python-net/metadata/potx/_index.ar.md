...
{{% blocks/products/pf/agp/code-block title="تعديل POTX الخصائص المضمنة - Python" offSpacer="true" %}}
...
{{% blocks/products/pf/agp/code-block title="إضافة خصائص مخصصة إلى POTX - Python" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية استخراج البيانات الوصفية لـ POTX عبر Python" >}}
