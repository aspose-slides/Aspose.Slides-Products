---
title: دمج ملفات ODP إلى PPSX باستخدام Python
url: /ar/python-net/merge/odp-to-ppsx/
keywords: دمج ODP إلى PPSX ، انضم إلى ODP إلى PPSX ، ادمج ODP إلى PPSX ، PowerPoint ، Presentation ، PPSX ، Python ، Aspose
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات ODP في PPSX باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة ODP في ملف واحد PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج ODP في PPSX باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من ODP وحفظ النتيجة باسم PPSX في بايثون." >}}
