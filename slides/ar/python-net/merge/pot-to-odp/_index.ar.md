---
title: دمج ملفات POT إلى ODP باستخدام Python
url: /ar/python-net/merge/pot-to-odp/
keywords: دمج POT إلى ODP ، انضم إلى POT إلى ODP ، ادمج POT إلى ODP ، PowerPoint ، Presentation ، ODP ، Python ، Aspose
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات POT في ODP باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة POT في ملف واحد ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج POT في ODP باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من POT وحفظ النتيجة باسم ODP في بايثون." >}}
