---
title: دمج ملفات POTM باستخدام بايثون
url: /ar/python-net/merge/potm/
keywords: دمج POTM ، انضمام POTM ، دمج POTM ، PowerPoint ، عرض تقديمي ، Python ، Aspose
...
{{< blocks/products/pf/feature-page-header h1="دمج ملفات POTM معًا في Python" h2="واجهة برمجة تطبيقات Python عالية السرعة ومتعددة المنصات والتي تساعد في تطوير التطبيقات مع القدرة على إنشاء ملفات Microsoft PowerPoint و OpenOffice أو دمجها أو فحصها أو تحويلها دون استخدام أي برنامج مثل Microsoft أو Open Office أو Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="دمج POTM في بايثون" %}}
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات POTM باستخدام بايثون" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة POTM في ملف واحد" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج POTM باستخدام Aspose.Slides ل Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي خطوات دمج ملفين من POTM وحفظ النتيجة باسم POTM في بايثون." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
حفظ العرض التقديمي والحصول على النتيجة كملف واحد POTM.
```
