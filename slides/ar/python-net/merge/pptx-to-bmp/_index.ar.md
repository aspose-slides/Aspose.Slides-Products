---
title: دمج ملفات PPTX إلى BMP باستخدام Python
url: /ar/python-net/merge/pptx-to-bmp/
keywords: دمج PPTX إلى BMP ، انضم إلى PPTX إلى BMP ، ادمج PPTX إلى BMP ، PowerPoint ، Presentation ، BMP ، Python ، Aspose
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات PPTX في BMP باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة PPTX في ملف واحد BMP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج PPTX في BMP باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من PPTX وحفظ النتيجة باسم BMP في بايثون." >}}
