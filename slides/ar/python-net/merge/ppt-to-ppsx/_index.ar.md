---
title: دمج ملفات PPT إلى PPSX باستخدام Python
url: /ar/python-net/merge/ppt-to-ppsx/
keywords: دمج PPT إلى PPSX ، انضم إلى PPT إلى PPSX ، ادمج PPT إلى PPSX ، PowerPoint ، Presentation ، PPSX ، Python ، Aspose
...
{{% blocks/products/pf/feature-page-section h2="دمج PPT إلى PPSX في بايثون" %}}
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات PPT في PPSX باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة PPT في ملف واحد PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج PPT في PPSX باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من PPT وحفظ النتيجة باسم PPSX في بايثون." >}}
