---
title: دمج ملفات PDF إلى PPT باستخدام Python
url: /ar/python-net/merge/pdf-to-ppt/
keywords: دمج PDF إلى PPT ، انضم إلى PDF إلى PPT ، ادمج PDF إلى PPT ، PowerPoint ، Presentation ، PPT ، Python ، Aspose
...
{{< blocks/products/pf/feature-page-header h1="دمج ملفات PDF في PPT معًا في Python" h2="واجهة برمجة تطبيقات Python عالية السرعة ومتعددة المنصات والتي تساعد في تطوير التطبيقات مع القدرة على إنشاء ملفات Microsoft PowerPoint و OpenOffice أو دمجها أو فحصها أو تحويلها دون استخدام أي برنامج مثل Microsoft أو Open Office أو Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="دمج PDF إلى PPT في بايثون" %}}
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات PDF في PPT باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة PDF في ملف واحد PPT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج PDF في PPT باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من PDF وحفظ النتيجة باسم PPT في بايثون." >}}
