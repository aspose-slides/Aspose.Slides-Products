---
title: دمج ملفات FODP إلى ODP باستخدام Python
url: /ar/python-net/merge/fodp-to-odp/
keywords: دمج FODP إلى ODP ، انضم إلى FODP إلى ODP ، ادمج FODP إلى ODP ، PowerPoint ، Presentation ، ODP ، Python ، Aspose
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات FODP في ODP باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة FODP في ملف واحد ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج FODP في ODP باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من FODP وحفظ النتيجة باسم ODP في بايثون." >}}
