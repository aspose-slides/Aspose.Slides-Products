---
title: دمج ملفات FODP إلى TIFF باستخدام Python
url: /ar/python-net/merge/fodp-to-tiff/
keywords: دمج FODP إلى TIFF ، انضم إلى FODP إلى TIFF ، ادمج FODP إلى TIFF ، PowerPoint ، Presentation ، TIFF ، Python ، Aspose
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات FODP في TIFF باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة FODP في ملف واحد TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج FODP في TIFF باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من FODP وحفظ النتيجة باسم TIFF في بايثون." >}}
