---
title: دمج ملفات PPTM إلى PPSX باستخدام Python
url: /ar/python-net/merge/pptm-to-ppsx/
keywords: دمج PPTM إلى PPSX ، انضم إلى PPTM إلى PPSX ، ادمج PPTM إلى PPSX ، PowerPoint ، Presentation ، PPSX ، Python ، Aspose
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات PPTM في PPSX باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة PPTM في ملف واحد PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج PPTM في PPSX باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من PPTM وحفظ النتيجة باسم PPSX في بايثون." >}}
