...
url: /ar/python-net/merge/pdf-to-pdf/
keywords: دمج PDF ، PDF إلى PDF ، الانضمام إلى PDF ، دمج PDF ، Python API ، مكتبة Python
description: دمج PDF في PDF في Python. استخدم واجهة برمجة تطبيقات مكتبة Python لدمج ملفات PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="دمج ملفات PDF في بايثون" h2="مكتبة Python عالية السرعة ومتعددة المنصات لدمج ملفات PDF باستخدام كود Python" >}}

{{% blocks/products/pf/feature-page-section h2="دمج PDF في PDF باستخدام Aspose.Slides" %}}

[** Aspose.Slides for Python عبر .NET **](https://products.aspose.com/slides/ar/python-net/) هي مكتبة Python قوية تُستخدم لإنشاء وتحويل ودمج ومعالجة العروض التقديمية وملفات PDF ووثائق أخرى. عندما تقوم بدمج PDF إلى PDF ، فإنك تدمج بشكل فعال صفحات من وثيقتين للحصول على ملف PDF واحد. Aspose.Slides يسمح لك بدمج ملفات PDF بطرق مختلفة. يمكنك دمج ملفات PDF بجميع أشكالها وأنماطها ونصوصها وتنسيقاتها وما إلى ذلك.
...
{{% blocks/products/pf/feature-page-section  h2="دمج PDF في PDF في Python" %}}
باستخدام [** Aspose.Slides for Python عبر .NET **](https://products.aspose.com/slides/ar/python-net/) ، يمكنك دمج ملفات PDF بسرعة ببضعة أسطر من التعليمات البرمجية

{{% blocks/products/pf/agp/code-block title="كود Python لدمج PDF إلى PDF" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج ملفات PDF في بايثون" >}}
