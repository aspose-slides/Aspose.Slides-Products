---
title: دمج ملفات ODP إلى BMP باستخدام Python
url: /ar/python-net/merge/odp-to-bmp/
keywords: دمج ODP إلى BMP ، انضم إلى ODP إلى BMP ، ادمج ODP إلى BMP ، PowerPoint ، Presentation ، BMP ، Python ، Aspose
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات ODP في BMP باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة ODP في ملف واحد BMP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج ODP في BMP باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من ODP وحفظ النتيجة باسم BMP في بايثون." >}}
