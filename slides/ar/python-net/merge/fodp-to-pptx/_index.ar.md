---
title: دمج ملفات FODP إلى PPTX باستخدام Python
url: /ar/python-net/merge/fodp-to-pptx/
keywords: دمج FODP إلى PPTX ، انضم إلى FODP إلى PPTX ، ادمج FODP إلى PPTX ، PowerPoint ، Presentation ، PPTX ، Python ، Aspose
...
{{< blocks/products/pf/feature-page-header h1="دمج ملفات FODP في PPTX معًا في Python" h2="واجهة برمجة تطبيقات Python عالية السرعة ومتعددة المنصات والتي تساعد في تطوير التطبيقات مع القدرة على إنشاء ملفات Microsoft PowerPoint و OpenOffice أو دمجها أو فحصها أو تحويلها دون استخدام أي برنامج مثل Microsoft أو Open Office أو Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="دمج FODP إلى PPTX في بايثون" %}}
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات FODP في PPTX باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة FODP في ملف واحد PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج FODP في PPTX باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من FODP وحفظ النتيجة باسم PPTX في بايثون." >}}
