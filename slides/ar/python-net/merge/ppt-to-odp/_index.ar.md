---
title: دمج ملفات PPT إلى ODP باستخدام Python
url: /ar/python-net/merge/ppt-to-odp/
keywords: دمج PPT إلى ODP ، انضم إلى PPT إلى ODP ، ادمج PPT إلى ODP ، PowerPoint ، Presentation ، ODP ، Python ، Aspose
...
{{% blocks/products/pf/feature-page-section h2="دمج PPT إلى ODP في بايثون" %}}
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات PPT في ODP باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة PPT في ملف واحد ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج PPT في ODP باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من PPT وحفظ النتيجة باسم ODP في بايثون." >}}
