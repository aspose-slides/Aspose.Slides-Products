---
title: دمج ملفات OTP إلى TIFF باستخدام Python
url: /ar/python-net/merge/otp-to-tiff/
keywords: دمج OTP إلى TIFF ، انضم إلى OTP إلى TIFF ، ادمج OTP إلى TIFF ، PowerPoint ، Presentation ، TIFF ، Python ، Aspose
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات OTP في TIFF باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة OTP في ملف واحد TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج OTP في TIFF باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من OTP وحفظ النتيجة باسم TIFF في بايثون." >}}
