---
title: دمج ملفات PPTX إلى ODP باستخدام Python
url: /ar/python-net/merge/pptx-to-odp/
keywords: دمج PPTX إلى ODP ، انضم إلى PPTX إلى ODP ، ادمج PPTX إلى ODP ، PowerPoint ، Presentation ، ODP ، Python ، Aspose
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات PPTX في ODP باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة PPTX في ملف واحد ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج PPTX في ODP باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من PPTX وحفظ النتيجة باسم ODP في بايثون." >}}
