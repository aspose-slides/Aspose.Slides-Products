---
title: دمج ملفات POT إلى PPSX باستخدام Python
url: /ar/python-net/merge/pot-to-ppsx/
keywords: دمج POT إلى PPSX ، انضم إلى POT إلى PPSX ، ادمج POT إلى PPSX ، PowerPoint ، Presentation ، PPSX ، Python ، Aspose
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات POT في PPSX باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة POT في ملف واحد PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج POT في PPSX باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من POT وحفظ النتيجة باسم PPSX في بايثون." >}}
