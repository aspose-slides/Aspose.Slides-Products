---
title: دمج ملفات PDF إلى BMP باستخدام Python
url: /ar/python-net/merge/pdf-to-bmp/
keywords: دمج PDF إلى BMP ، انضم إلى PDF إلى BMP ، ادمج PDF إلى BMP ، PowerPoint ، Presentation ، BMP ، Python ، Aspose
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات PDF في BMP باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة PDF في ملف واحد BMP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج PDF في BMP باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من PDF وحفظ النتيجة باسم BMP في بايثون." >}}
