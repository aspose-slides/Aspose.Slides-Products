---
title: دمج ملفات PDF إلى PPSX باستخدام Python
url: /ar/python-net/merge/pdf-to-ppsx/
keywords: دمج PDF إلى PPSX ، انضم إلى PDF إلى PPSX ، ادمج PDF إلى PPSX ، PowerPoint ، Presentation ، PPSX ، Python ، Aspose
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات PDF في PPSX باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة PDF في ملف واحد PPSX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج PDF في PPSX باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من PDF وحفظ النتيجة باسم PPSX في بايثون." >}}
