---
title: دمج ملفات PDF إلى PPTX باستخدام Python
url: /ar/python-net/merge/pdf-to-pptx/
keywords: دمج PDF إلى PPTX ، انضم إلى PDF إلى PPTX ، ادمج PDF إلى PPTX ، PowerPoint ، Presentation ، PPTX ، Python ، Aspose
...
{{< blocks/products/pf/feature-page-header h1="دمج ملفات PDF في PPTX معًا في Python" h2="واجهة برمجة تطبيقات Python عالية السرعة ومتعددة المنصات والتي تساعد في تطوير التطبيقات مع القدرة على إنشاء ملفات Microsoft PowerPoint و OpenOffice أو دمجها أو فحصها أو تحويلها دون استخدام أي برنامج مثل Microsoft أو Open Office أو Adobe PDF." >}}

{{% blocks/products/pf/feature-page-section h2="دمج PDF إلى PPTX في بايثون" %}}
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات PDF في PPTX باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة PDF في ملف واحد PPTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج PDF في PPTX باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من PDF وحفظ النتيجة باسم PPTX في بايثون." >}}
