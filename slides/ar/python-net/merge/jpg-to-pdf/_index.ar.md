---
title: دمج JPG في PDF في Python
url: /ar/python-net/merge/jpg-to-pdf/
keywords: JPG إلى PDF ، دمج JPG إلى PDF ، الانضمام إلى JPG إلى PDF ، PDF ، JPG ، Python API ، مكتبة Python
description: دمج JPG في PDF في Python. استخدم واجهة برمجة تطبيقات مكتبة Python لدمج JPG و PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="دمج JPG في PDF في Python" h2="مكتبة Python عالية السرعة ومتعددة المنصات لدمج ملفات JPG إلى PDF باستخدام كود Python" >}}

{{% blocks/products/pf/feature-page-section h2="دمج JPG إلى PDF باستخدام Aspose.Slides" %}}

[** Aspose.Slides for Python عبر .NET **](https://products.aspose.com/slides/ar/python-net/) هي مكتبة Python قوية تُستخدم لإنشاء وتحويل ودمج ومعالجة العروض التقديمية وملفات PDF والصور والملفات الأخرى. عندما تقوم بدمج JPG إلى PDF ، فأنت تقوم بدمج صور JPG بشكل فعال للحصول على ملف PDF واحد.
...
{{% blocks/products/pf/feature-page-section  h2="دمج JPG في PDF في Python" %}}
باستخدام [** Aspose.Slides for Python عبر .NET **](https://products.aspose.com/slides/ar/python-net/) ، يمكنك دمج JPG إلى PDF بسرعة ببضعة سطور من التعليمات البرمجية

{{% blocks/products/pf/agp/code-block title="كود Python لدمج JPG إلى PDF" offSpacer="true" %}}
```python
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج JPG إلى PDF في Python" >}}
