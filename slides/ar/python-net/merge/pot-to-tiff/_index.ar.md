---
title: دمج ملفات POT إلى TIFF باستخدام Python
url: /ar/python-net/merge/pot-to-tiff/
keywords: دمج POT إلى TIFF ، انضم إلى POT إلى TIFF ، ادمج POT إلى TIFF ، PowerPoint ، Presentation ، TIFF ، Python ، Aspose
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات POT في TIFF باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة POT في ملف واحد TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج POT في TIFF باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من POT وحفظ النتيجة باسم TIFF في بايثون." >}}
