---
title: دمج ملفات PPT إلى TIFF باستخدام Python
url: /ar/python-net/merge/ppt-to-tiff/
keywords: دمج PPT إلى TIFF ، انضم إلى PPT إلى TIFF ، ادمج PPT إلى TIFF ، PowerPoint ، Presentation ، TIFF ، Python ، Aspose
...
{{% blocks/products/pf/feature-page-section h2="دمج PPT إلى TIFF في بايثون" %}}
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات PPT في TIFF باستخدام Python" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة PPT في ملف واحد TIFF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج PPT في TIFF باستخدام Aspose.Slides for Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لدمج ملفين من PPT وحفظ النتيجة باسم TIFF في بايثون." >}}
