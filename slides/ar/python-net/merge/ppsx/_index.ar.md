---
title: دمج ملفات PPSX باستخدام بايثون
url: /ar/python-net/merge/ppsx/
keywords: دمج PPSX ، انضمام PPSX ، دمج PPSX ، PowerPoint ، عرض تقديمي ، Python ، Aspose
...
{{% blocks/products/pf/feature-page-section h2="دمج PPSX في بايثون" %}}
...
{{% blocks/products/pf/feature-page-section  h2="دمج ملفات PPSX باستخدام بايثون" %}}
لدمج عروض PowerPoint التقديمية ، ستحتاج إلى استنساخ الشرائح من عرض تقديمي إلى آخر.

{{% blocks/products/pf/agp/code-block title="كود Python لدمج عدة PPSX في ملف واحد" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج PPSX باستخدام Aspose.Slides ل Python API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي خطوات دمج ملفين من PPSX وحفظ النتيجة باسم PPSX في بايثون." >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
حفظ العرض التقديمي والحصول على النتيجة كملف واحد PPSX.
```
