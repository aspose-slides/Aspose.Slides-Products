---
title: تحويل FODP إلى PPSX في Python
weight: 150
url: /ar/python-net/conversion/fodp-to-ppsx/ 
keywords: "Convert, PowerPoint, FODP, PPSX, Presentation, Python"
description: رمز عينة لتحويل FODP إلى PPSX Python. استخدم PowerPoint Python API لتحويل ملفات FODP إلى ملفات PPSX.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل FODP إلى PPSX في Python" h2="مكتبة بايثون قوية لتحويل FODP إلى PPSX" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل FODP إلى PPSX في Python" %}}

هل تحتاج إلى تحويل ملفات FODP إلى PPSX برمجيًا؟ باستخدام [* Aspose.Slides for Python عبر .NET *](https://products.aspose.com/slides/ar/python-net/) يمكن لأي مطور تحويل FODP إلى تنسيق PPSX ببضعة أسطر فقط من كود Python.

باعتبارها واجهة برمجة تطبيقات حديثة لمعالجة العروض التقديمية ، تقوم Aspose.Slides for Python بإنشاء PPSX من FODP بسرعة. اختبر جودة تحويل FODP إلى PPSX مباشرة في [المتصفح] الخاص بك (https://products.aspose.app/slides/conversion). تسمح لك مكتبة Aspose PowerPoint PPTX بتحويل ملفات FODP إلى العديد من التنسيقات الشائعة.
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل FODP إلى PPSX في Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي خطوات تحويل ملف FODP إلى PPSX باستخدام Python." >}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الكود هذا تحويل FODP إلى PPSX Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ FODP كـ PPSX في Python" %}}
استخدم التطبيق المجاني لمشاهدة عرض توضيحي لعملية تحويل FODP إلى PPSX. 
{{% /blocks/products/pf/agp/content %}}
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        appName="conversion"
        extension=""
        sectionTitle="تطبيق مجاني لتحويل FODP إلى PPSX" 
