...
title: تحويل FODP إلى PNG في Python
weight: 90
url: /ar/python-net/conversion/fodp-to-png/ 
keywords: "Convert, PowerPoint, FODP, PNG, Presentation, Python"
description: رمز عينة لتحويل FODP إلى PNG Python. استخدم PowerPoint Python API لتحويل ملفات FODP إلى ملفات PNG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل FODP إلى PNG في Python" h2="مكتبة بايثون قوية لتحويل FODP إلى PNG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل FODP إلى PNG في Python" %}}

هل تحتاج إلى تحويل ملفات FODP إلى PNG برمجيًا؟ باستخدام [* Aspose.Slides for Python عبر .NET *](https://products.aspose.com/slides/ar/python-net/) يمكن لأي مطور تحويل FODP إلى تنسيق PNG ببضعة أسطر فقط من كود Python.

بصفتها واجهة برمجة تطبيقات حديثة لمعالجة العروض التقديمية ، تقوم Aspose.Slides for Python بإنشاء PNG من FODP بسرعة. اختبر جودة تحويل FODP إلى PNG في [المتصفح] مباشرة (https://products.aspose.app/slides/conversion/ppt-to-png). تسمح لك مكتبة Aspose PowerPoint PPTX بتحويل ملفات FODP إلى العديد من التنسيقات الشائعة.
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل FODP إلى PNG في Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي الخطوات لتحويل ملف FODP إلى PNG باستخدام Python." >}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الكود هذا تحويل FODP إلى PNG Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ FODP بصيغة PNG في Python" %}}
استخدم التطبيق المجاني لمشاهدة عرض توضيحي لعملية تحويل FODP إلى PNG. 
{{% /blocks/products/pf/agp/content %}}
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        appName="conversion"
        extension=""
        sectionTitle="تطبيق مجاني لتحويل FODP إلى PNG" 
