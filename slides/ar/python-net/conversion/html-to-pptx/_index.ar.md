---
title: تحويل HTML إلى PPTX في Python
url: /ar/python-net/conversion/html-to-pptx/
keywords: تحويل HTML إلى PPTX ، HTML إلى PPTX ، PowerPoint ، HTML ، PPTX ، Python API ، مكتبة Python
description: تحويل HTML إلى PPTX في Python. استخدم مكتبة Python API لتحويل HTML إلى PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="تحويل HTML إلى PPTX في Python" h2="واجهة برمجة تطبيقات Python القوية عبر الأنظمة الأساسية لتحويل HTML إلى PPTX باستخدام كود Python" >}}

{{% blocks/products/pf/feature-page-section h2="تحويل HTML إلى PPTX باستخدام Aspose.Slides" %}}

[** Aspose.Slides for Python عبر .NET **](https://products.aspose.com/slides/ar/python-net/) هي مكتبة Python قوية تُستخدم لإنشاء وتحويل ومعالجة عروض PowerPoint التقديمية وملفات PDF و مستندات HTML والملفات الأخرى. عندما تقوم بتحويل HTML إلى PPTX ، فأنت تقوم بشكل أساسي بنقل المحتويات في مستند HTML إلى شرائح في عرض تقديمي لـ PowerPoint.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="تحويل HTML إلى PPTX في Python" %}}
باستخدام [** Aspose.Slides for Python عبر .NET **](https://products.aspose.com/slides/ar/python-net/) ، يمكنك تحويل مستند HTML إلى عرض تقديمي في PowerPoint ببضعة سطور فقط من التعليمات البرمجية:

{{% blocks/products/pf/agp/code-block title="كود Python لتحويل HTML إلى PPTX" offSpacer="true" %}}
```py
...
{{< blocks/products/pf/feature-page-section  h2="كيفية تحويل HTML إلى PPTX في Python" >}}
