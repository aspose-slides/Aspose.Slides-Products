...
title: قم بتحويل PPSX إلى PPTX في Python
weight: 2160
url: /ar/python-net/conversion/ppsx-to-pptx/ 
keywords: "Convert, PowerPoint, PPSX, PPTX, Presentation, Python"
description: رمز عينة لتحويل PPSX إلى PPTX Python. استخدم PowerPoint Python API لتحويل ملفات PPSX إلى ملفات PPTX.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="قم بتحويل PPSX إلى PPTX في Python" h2="مكتبة بايثون قوية لتحويل PPSX إلى PPTX" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="قم بتحويل PPSX إلى PPTX في Python" %}}

هل تحتاج إلى تحويل ملفات PPSX إلى PPTX برمجيًا؟ باستخدام [* Aspose.Slides for Python عبر .NET *](https://products.aspose.com/slides/ar/python-net/) يمكن لأي مطور تحويل PPSX إلى تنسيق PPTX ببضعة أسطر فقط من كود Python.

باعتبارها واجهة برمجة تطبيقات حديثة لمعالجة العروض التقديمية ، تقوم Aspose.Slides for Python بإنشاء PPTX من PPSX بسرعة. اختبر جودة تحويل PPSX إلى PPTX مباشرة في [المتصفح] الخاص بك (https://products.aspose.app/slides/conversion). تسمح لك مكتبة Aspose PowerPoint PPTX بتحويل ملفات PPSX إلى العديد من التنسيقات الشائعة.
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل PPSX إلى PPTX في Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي خطوات تحويل ملف PPSX إلى PPTX باستخدام Python." >}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج التعليمات البرمجية هذا PPSX إلى PPTX Python Conversion" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ PPSX كـ PPTX في Python" %}}
استخدم التطبيق المجاني لمشاهدة عرض توضيحي لعملية تحويل PPSX إلى PPTX. 
{{% /blocks/products/pf/agp/content %}}
