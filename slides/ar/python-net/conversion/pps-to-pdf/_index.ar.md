...
title: تحويل PPS إلى PDF في Python
weight: 1630
url: /ar/python-net/conversion/pps-to-pdf/ 
keywords: "Convert, PowerPoint, PPS, PDF, Presentation, Python"
description: رمز عينة لتحويل PPS إلى PDF Python. استخدم PowerPoint Python API لتحويل ملفات PPS إلى ملفات PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل PPS إلى PDF في Python" h2="مكتبة بايثون قوية لتحويل PPS إلى PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-python.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل PPS إلى PDF في Python" %}}

هل تحتاج إلى تحويل ملفات PPS إلى PDF برمجيًا؟ باستخدام [* Aspose.Slides for Python عبر .NET *](https://products.aspose.com/slides/ar/python-net/) يمكن لأي مطور تحويل PPS إلى تنسيق PDF ببضعة أسطر فقط من كود Python.

باعتبارها واجهة برمجة تطبيقات حديثة لمعالجة العروض التقديمية ، تقوم Aspose.Slides for Python بإنشاء ملف PDF من PPS بسرعة. اختبر جودة تحويل PPS إلى PDF مباشرة في [المتصفح](https://products.aspose.app/slides/conversion). تسمح لك مكتبة Aspose PowerPoint PPTX بتحويل ملفات PPS إلى العديد من التنسيقات الشائعة.
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل PPS إلى PDF في Python" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي خطوات تحويل ملف PPS إلى PDF باستخدام Python." >}}
...
{{% blocks/products/pf/agp/code-block title="يُظهر نموذج الكود هذا تحويل PPS إلى PDF Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ PPS كملف PDF في Python" %}}
استخدم التطبيق المجاني لمشاهدة عرض توضيحي لعملية تحويل PPS إلى PDF. 
{{% /blocks/products/pf/agp/content %}}
