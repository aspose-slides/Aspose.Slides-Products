---
title: تحويل HTML إلى PPT في Python
url: /ar/python-net/conversion/html-to-ppt/
keywords: تحويل HTML إلى PPT ، HTML إلى PPT ، PowerPoint ، HTML ، PPT ، Python API ، مكتبة Python
description: تحويل HTML إلى PPT في Python. استخدم مكتبة Python API لتحويل HTML إلى PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="تحويل HTML إلى PPT في Python" h2="واجهة برمجة تطبيقات Python القوية عبر الأنظمة الأساسية لتحويل HTML إلى PPT باستخدام كود Python" >}}

{{% blocks/products/pf/feature-page-section h2="تحويل HTML إلى PPT باستخدام Aspose.Slides" %}}

[** Aspose.Slides for Python عبر .NET **](https://products.aspose.com/slides/ar/python-net/) هي مكتبة Python قوية تُستخدم لإنشاء وتحويل ومعالجة عروض PowerPoint التقديمية وملفات PDF و مستندات HTML والملفات الأخرى. عندما تقوم بتحويل HTML إلى PPT ، فأنت تقوم بشكل أساسي بنقل المحتويات في مستند HTML إلى شرائح في عرض تقديمي لـ PowerPoint.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="تحويل HTML إلى PPT في Python" %}}
...
{{% blocks/products/pf/agp/code-block title="كود Python لتحويل HTML إلى PPT" offSpacer="true" %}}
```py
...
{{< blocks/products/pf/feature-page-section  h2="كيفية تحويل HTML إلى PPT في Python" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ar/python-net/conversion/jpg-to-ppt/" name="JPG TO PPTX" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ar/python-net/conversion/jpg-to-pptx/" name="JPG TO PPT" >}}
