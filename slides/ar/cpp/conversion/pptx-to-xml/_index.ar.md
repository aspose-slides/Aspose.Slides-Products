---
title: تحويل PPTX إلى XML عبر تطبيق C ++
weight: 140
url: /ar/cpp/conversion/pptx-to-xml/ 
description: نموذج كود تحويل C ++ لمستند PPTX إلى تنسيق XML. استخدم رمز المثال للتحويل الدفعي من PPTX إلى XML داخل أي تطبيق C ++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل PPTX إلى XML عبر C ++" h2="تحويل PPTX عالي الأداء إلى XML باستخدام مكتبة C ++ دون الحاجة إلى تثبيت Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل PPTX إلى XML باستخدام C ++" %}}

 من أجل تحويل PPTX إلى XML ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل PPTX إلى XML عبر C ++" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري C ++ بسهولة تحويل ملف PPTX إلى XML في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/code-block title="PPTX إلى رمز مصدر تحويل XML C ++" offSpacer="" %}}
...
<!-- aboutfile Ends -->
    ...
    {{< blocks/slides-app-widget 
        appName="conversion"
        extension=""
        sectionTitle="تطبيق مجاني لتحويل PPTX إلى XML" 
