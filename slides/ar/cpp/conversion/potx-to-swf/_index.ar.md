---
title: تحويل POTX إلى SWF عبر تطبيق C ++
url: /ar/cpp/conversion/potx-to-swf/ 
description: نموذج كود تحويل C ++ لمستند POTX إلى تنسيق SWF. استخدم رمز المثال للتحويل الدفعي من POTX إلى SWF داخل أي تطبيق C ++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل POTX إلى SWF عبر C ++" h2="تحويل POTX عالي الأداء إلى SWF باستخدام مكتبة C ++ دون الحاجة إلى تثبيت Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWF" pfName="Aspose.SLIDES" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="SLIDES" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل POTX إلى SWF باستخدام C ++" %}}

لتحويل POTX إلى SWF ، سنستخدم <a href="https://products.aspose.com/slides/cpp"> Aspose.Slides for C ++ </a> API وهي واجهة برمجة تطبيقات غنية بالميزات وقوية وسهلة الاستخدام للتعامل مع المستندات وتحويلها API لمنصة C ++. يمكنك تنزيل أحدث إصدار مباشرة ، فقط افتح مدير الحزم <a href="https://www.nuget.org/packages/aspose.slides"> NuGet </a> ، وابحث عن <b> Aspose.Slides.Cpp </b> وتثبيته. يمكنك أيضًا استخدام الأمر التالي من Package Manager Console.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل POTX إلى SWF عبر C ++" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.SLIDES API يجعل من السهل على المطورين تحويل ملف POTX إلى SWF في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/code-block title="POTX إلى رمز مصدر تحويل SWF C ++" offSpacer="" %}}
