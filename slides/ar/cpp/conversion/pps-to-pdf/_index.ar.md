...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C ++ تحويل ملف PPS إلى PDF بسهولة في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/code-block title="رمز مصدر تحويل PPS إلى PDF C ++" offSpacer="" %}}
