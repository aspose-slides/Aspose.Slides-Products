...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C ++ بسهولة تحويل ملف PPTX إلى PPS في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/code-block title="PPTX إلى رمز مصدر التحويل PPS C ++" offSpacer="" %}}
