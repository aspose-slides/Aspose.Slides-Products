...
title: تحويل TIFF إلى JPEG عبر تطبيق C ++
weight: 4420
url: /ar/cpp/conversion/tiff-to-jpeg/ 
description: عينة كود تحويل C ++ لمستند TIFF إلى تنسيق JPEG. استخدم رمز المثال للتحويل الدفعي من TIFF إلى JPEG داخل أي تطبيق C ++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل TIFF إلى JPEG عبر C ++" h2="تحويل TIFF إلى JPEG عالي الأداء باستخدام مكتبة C ++ دون الحاجة إلى تثبيت Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TIFF" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل TIFF إلى JPEG باستخدام C ++" %}}

 من أجل تحويل TIFF إلى JPEG ، سنستخدم ملفات
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل TIFF إلى JPEG عبر C ++" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري C ++ بسهولة تحويل ملف TIFF إلى JPEG في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/code-block title="TIFF إلى كود مصدر تحويل JPEG C ++" offSpacer="" %}}
