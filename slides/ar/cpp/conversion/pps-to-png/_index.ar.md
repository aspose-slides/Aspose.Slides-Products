---
title: قم بتحويل PPS إلى PNG عبر تطبيق C ++
weight: 1500
url: /ar/cpp/conversion/pps-to-png/ 
description: عينة كود تحويل C ++ لمستند PPS إلى تنسيق PNG. استخدم رمز المثال لتحويل PPS إلى PNG داخل أي تطبيق C ++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="قم بتحويل PPS إلى PNG عبر C ++" h2="تحويل PPS عالي الأداء إلى PNG باستخدام مكتبة C ++ دون الحاجة إلى تثبيت Microsoft PowerPoint." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C ++ تحويل ملف PPS إلى PNG بسهولة في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/code-block title="PPS إلى رمز مصدر تحويل PNG C ++" offSpacer="" %}}
