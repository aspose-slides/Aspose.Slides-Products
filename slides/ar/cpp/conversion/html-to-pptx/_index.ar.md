---
title: تحويل HTML إلى PPTX في C++
url: /ar/cpp/conversion/html-to-pptx/
keywords: تحويل HTML إلى PPTX ، HTML إلى PPTX ، PowerPoint ، HTML ، PPTX ، C++ API ، مكتبة C++
description: تحويل HTML إلى PPTX في C++. استخدم واجهة برمجة تطبيقات مكتبة C++ لتحويل HTML إلى PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="تحويل HTML إلى PPTX في C++" h2="واجهة برمجة تطبيقات C++ قوية عبر الأنظمة الأساسية لتحويل HTML إلى PPTX باستخدام كود C++" >}}

{{% blocks/products/pf/feature-page-section h2="تحويل HTML إلى PPTX باستخدام Aspose.Slides" %}}

[** Aspose.Slides for C++ **](https://products.aspose.com/slides/ar/cpp/) هي مكتبة C++ قوية تُستخدم لإنشاء وتحويل ومعالجة عروض PowerPoint التقديمية وملفات PDF ومستندات HTML وغيرها الملفات. عندما تقوم بتحويل HTML إلى PPTX ، فأنت تقوم بشكل أساسي بنقل المحتويات في مستند HTML إلى شرائح في عرض تقديمي لـ PowerPoint.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="تحويل HTML إلى PPTX في C++" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية تحويل HTML إلى PPTX في C++" >}}
