...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C ++ بسهولة تحويل ملف PPS إلى POTX في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/code-block title="PPS إلى رمز مصدر التحويل POTX C ++" offSpacer="" %}}
