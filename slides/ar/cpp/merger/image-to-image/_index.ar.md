...
url: /ar/cpp/merger/image-to-image/
keywords: دمج الصورة ، الصورة إلى الصورة ، الانضمام إلى الصور ، الجمع بين الصور ، C++ API ، مكتبة C++
description: دمج الصورة بالصورة في C++. استخدم مكتبة C++ API لدمج الصور
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="دمج الصورة في C++" h2="مكتبة C++ عالية السرعة ومتعددة المنصات لدمج الصور باستخدام كود C++" >}}

{{% blocks/products/pf/feature-page-section h2="دمج الصورة بالصورة باستخدام Aspose.Slides" %}}

[** Aspose.Slides for C++ **](https://products.aspose.com/slides/ar/cpp/) هي مكتبة C++ قوية تُستخدم لدمج ومعالجة العروض التقديمية والصور والملفات الأخرى. عندما تدمج صورة مع صورة ، فأنت تدمج بشكل فعال صورتين للحصول على صورة واحدة.
...
{{% blocks/products/pf/agp/code-block title="كود C++ لدمج الصورة في الصورة" offSpacer="true" %}}
```cpp
