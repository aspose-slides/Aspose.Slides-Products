...
url: /ar/cpp/merger/png-to-png/
keywords: ادمج PNG و PNG و PNG و انضم إلى PNG ودمج PNG و C++ API و C++ Library
description: دمج PNG في PNG في C++. استخدم واجهة برمجة تطبيقات مكتبة C++ لدمج ملفات PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="دمج PNG في C++" h2="مكتبة C++ عالية السرعة ومتعددة المنصات لدمج صور PNG باستخدام كود C++" >}}

{{% blocks/products/pf/feature-page-section h2="ادمج PNG في PNG باستخدام Aspose.Slides" %}}

[** Aspose.Slides for C++ **](https://products.aspose.com/slides/ar/cpp/) هي مكتبة C++ قوية تُستخدم لدمج ومعالجة العروض التقديمية والصور والملفات الأخرى. عندما تقوم بدمج PNG إلى PNG ، فأنت تدمج بشكل فعال صورتين للحصول على صورة واحدة.
...
باستخدام [** Aspose.Slides for C++ **](https://products.aspose.com/slides/ar/cpp/) ، يمكنك دمج ملفات PNG بسرعة ببضعة سطور فقط من التعليمات البرمجية
