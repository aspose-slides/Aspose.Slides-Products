...
url: /ar/cpp/merger/pdf-to-pdf/
keywords: دمج PDF ، PDF إلى PDF ، الانضمام إلى PDF ، الجمع بين PDF ، C++ API ، مكتبة C++
description: دمج PDF في PDF في C++. استخدم واجهة برمجة تطبيقات مكتبة C++ لدمج ملفات PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="دمج PDF في C++" h2="مكتبة C++ عالية السرعة ومتعددة المنصات لدمج ملفات PDF باستخدام كود C++" >}}

{{% blocks/products/pf/feature-page-section h2="دمج PDF في PDF باستخدام Aspose.Slides" %}}

[** Aspose.Slides for C++ **](https://products.aspose.com/slides/ar/cpp/) هي مكتبة C++ قوية تُستخدم لإنشاء وتحويل ودمج ومعالجة العروض التقديمية وملفات PDF والمستندات الأخرى. عندما تقوم بدمج PDF إلى PDF ، فإنك تدمج بشكل فعال صفحات من وثيقتين للحصول على ملف PDF واحد. Aspose.Slides يسمح لك بدمج ملفات PDF بطرق مختلفة. يمكنك دمج ملفات PDF بجميع أشكالها وأنماطها ونصوصها وتنسيقاتها وما إلى ذلك.
...
{{% blocks/products/pf/feature-page-section  h2="دمج PDF في PDF في C++" %}}
باستخدام [** Aspose.Slides for C++ **](https://products.aspose.com/slides/ar/cpp/) ، يمكنك دمج ملفات PDF بسرعة ببضعة أسطر من التعليمات البرمجية

{{% blocks/products/pf/agp/code-block title="كود C++ لدمج PDF إلى PDF" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج ملفات PDF في C++" >}}
