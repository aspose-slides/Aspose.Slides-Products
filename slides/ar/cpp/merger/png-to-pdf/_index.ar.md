---
title: دمج PNG في PDF في C++
url: /ar/cpp/merger/png-to-pdf/
keywords: PNG إلى PDF ، دمج PNG في PDF ، الانضمام إلى PNG إلى PDF ، PDF ، PNG ، C++ API ، مكتبة C++
description: دمج PNG في PDF في C++. استخدم واجهة برمجة تطبيقات مكتبة C++ لدمج PNG و PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="دمج PNG في PDF في C++" h2="مكتبة C++ عالية السرعة ومتعددة المنصات لدمج ملفات PNG إلى ملفات PDF باستخدام كود C++" >}}

{{% blocks/products/pf/feature-page-section h2="دمج PNG إلى PDF باستخدام Aspose.Slides" %}}

[** Aspose.Slides for C++ **](https://products.aspose.com/slides/ar/cpp/) هي مكتبة C++ قوية تُستخدم لإنشاء وتحويل ودمج ومعالجة العروض التقديمية والصور والملفات الأخرى. عندما تقوم بدمج PNG إلى PDF ، فإنك تدمج صور PNG بشكل فعال للحصول على ملف PDF واحد.
...
{{% blocks/products/pf/feature-page-section  h2="دمج PNG في PDF في C++" %}}
باستخدام [** Aspose.Slides for C++ **](https://products.aspose.com/slides/ar/cpp/) ، يمكنك دمج PNG إلى PDF بسرعة ببضعة سطور من التعليمات البرمجية

{{% blocks/products/pf/agp/code-block title="كود C++ لدمج PNG في PDF" offSpacer="true" %}}
```cpp
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج PNG إلى PDF في C++" >}}
