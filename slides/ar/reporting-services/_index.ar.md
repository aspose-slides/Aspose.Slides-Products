...
description: واجهة برمجة تطبيقات PowerPoint لخدمات التقارير هي Aspose.Slides لـ SQL PPT. خدمات عرض PowerPoint لـ SQL PowerPoint.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Reporting Services PowerPoint API" h2="تصدير تقارير RDL إلى تنسيقات PowerPoint PPT و PPTX و PPS و PPSX." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/headers/aspose_slides-for-reporting-services.svg" pfName="Aspose.Slides" subTitlepfName="for Reporting Services" downloadUrl="https://downloads.aspose.com/slides/reportingservices" >}}
...
<p>
 Aspose.Slides for Reporting Services هو الحل الوحيد في السوق الذي يجعل من الممكن إنشاء عروض تقديمية بتنسيقات PowerPoint الأصلية من داخل Microsoft SQL Server Reporting Services.
</p>

<p>
 Aspose.Slides for Reporting Services تدعم جميع ميزات RDL تقريبًا مثل الجداول والمصفوفات والمخططات والصور والقوائم والتقارير الفرعية والرؤوس / التذييلات ، مما يسمح بتصدير التقارير في تنسيقات العرض التقديمي في PowerPoint بطريقة تبدو مماثلة لتلك الأصلية تصميم التقرير. تنفيذ Reporting Services SQL PPT بدون أتمتة Microsoft PowerPoint.
</p>
...
{{< blocks/products/pf/carousel-item h3="لمحة سريعة" description="نظرة عامة على Aspose.Slides لخدمات التقارير." >}}
...
{{< blocks/products/pf/carousel-item h3="منصة الاستقلال" description="يدعم المنتج Microsoft SQL Server Reporting Services." >}}
<div class="diagram1 d1-rs">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="تنسيقات الملفات المدعومة" description="Aspose.Slides for Reporting Services تدعم العروض التقديمية الأكثر استخدامًا [تنسيقات الملفات](https://docs.aspose.com/slides/reportingservices/supported-file-formats/)." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    ميزات واجهة برمجة تطبيقات خدمات التقارير المتقدمة
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     إنشاء مخططات مقارنة في تقارير RDL وتصديرها كعروض تقديمية
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     إنشاء تقارير RDL معقدة وتصديرها إلى ملفات العروض التقديمية
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     تصدير تقارير RDL المتمحورة حول البيانات مع تقارير فرعية
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     تصدير ملفات الصوت والفيديو المضمنة إلى ملفات PowerPoint
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     تصدير تقارير RDL التي تحمل تقارير فرعية إلى PowerPoint
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     تنقيط أو تحويل الأشكال بدون نص
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-share ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     تغيير لون نص الارتباط التشعبي خلال العرض التقديمي
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     دعم تشفير المستندات المفتوحة ، وأداة تمييز النص ، وانتقال التحويل التدريجي
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     دعم المخططات القمعية ومخططات الخرائط ثنائية الأبعاد
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     دعم ردود التعليقات و Office 365
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     تصدير إلى تنسيقات العرض التقديمي وعرض الشرائح
    </h2>
    <p>
     لا توفر خدمات تقارير خادم SQL (SSRS) دعمًا مضمنًا لتصدير تقارير RDL إلى عروض PowerPoint التقديمية أو عروض الشرائح. أثناء استخدام Aspose.Slides لخدمات التقارير ، يمكنك إضافة دعم لتنسيقات تصدير إضافية بسهولة.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for Reporting Services تدعم مواصفات RDL الكاملة ويمكن للفرد تخصيص التقارير الحالية باستخدام هذا الامتداد. من السهل جدًا تحديد أي مصمم تقرير RDL مفضل ثم تصدير التقارير تمامًا بنفس الطريقة التي صممها بها أحدهم.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides for Reporting Services تم تصميمه باستخدام تعليمات برمجية مُدارة لا تحتاج أبدًا إلى تثبيت Microsoft PowerPoint على الجهاز للعمل مع عروض PowerPoint التقديمية. إنه بديل مثالي لأتمتة Microsoft PowerPoint من حيث الميزات المدعومة والأمان والاستقرار وقابلية التوسع والسرعة والسعر.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="توثيق" href="https://docs.aspose.com/slides/reportingservices/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="لماذا Aspose.Slides لخدمات التقارير؟" tabId="success-stories" >}}
