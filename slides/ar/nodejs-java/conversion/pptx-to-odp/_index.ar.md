---
title: تحويل PPTX إلى ODP في Node.js
url: /ar/nodejs-java/conversion/pptx-to-odp/
keywords: PPTX إلى ODP، تحويل PPTX إلى ODP، Node.js API، مكتبة Node.js، PPTX، ODP
description: تحويل PPTX إلى ODP في Node.js. استخدم واجهة برمجة تطبيقات مكتبة Node.js لتحويل ملفات PPTX إلى ملفات ODP.
---
...
{{% blocks/products/pf/feature-page-section h2="تحويل PPTX إلى ODP في Node.js" %}}
...
باعتباره واجهة برمجة تطبيقات حديثة لمعالجة المستندات، يقوم Aspose.Slides for Node.js بتصدير ملفات PPTX إلى تنسيقات ملفات ODP بسرعة. تتيح لك مكتبة Aspose PowerPoint تحويل PPTX إلى ODP والعديد من تنسيقات الملفات الأخرى

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="تحويل PPTX إلى ODP باستخدام Node.js" %}}
لتحويل PPTX إلى ODP، ستحتاج إلى إنشاء عرض تقديمي من ملف PPTX وحفظه باسم ODP.

{{% blocks/products/pf/agp/code-block title="كود Node.js لتحويل PPTX إلى ODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية تحويل PPTX إلى ODP باستخدام Aspose.Slides for Node.js عبر Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="لتحويل PPTX إلى ODP باستخدام Aspose.Slides for Node.js عبر Java، تحتاج إلى استيراد الحزمة في ملف JavaScript الخاص بك وإنشاء مثيل لفئة العرض التقديمي. تمثل فئة العرض التقديمي مستند PowerPoint وتوفر طرقًا للوصول إلى عناصره ومعالجتها." >}}
