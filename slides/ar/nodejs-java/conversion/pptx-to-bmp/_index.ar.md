---
title: تحويل PPTX إلى BMP في Node.js
url: /ar/nodejs-java/conversion/pptx-to-bmp/
keywords: PPTX إلى BMP، تحويل PPTX إلى BMP، Node.js API، مكتبة Node.js، PPTX، BMP
description: تحويل PPTX إلى BMP في Node.js. استخدم واجهة برمجة تطبيقات مكتبة Node.js لتحويل ملفات PPTX إلى ملفات BMP.
---
...
باعتباره واجهة برمجة تطبيقات حديثة لمعالجة المستندات، يقوم Aspose.Slides for Node.js بتصدير ملفات PPTX إلى تنسيقات ملفات BMP بسرعة. تتيح لك مكتبة Aspose PowerPoint تحويل PPTX إلى BMP والعديد من تنسيقات الملفات الأخرى

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="تحويل PPTX إلى BMP باستخدام Node.js" %}}
لتحويل PPTX إلى BMP، ستحتاج إلى إنشاء عرض تقديمي من ملف PPTX وحفظه باسم BMP.

{{% blocks/products/pf/agp/code-block title="كود Node.js لتحويل PPTX إلى BMP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية تحويل PPTX إلى BMP باستخدام Aspose.Slides for Node.js عبر Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="لتحويل PPTX إلى BMP باستخدام Aspose.Slides for Node.js عبر Java، تحتاج إلى استيراد الحزمة في ملف JavaScript الخاص بك وإنشاء مثيل لفئة العرض التقديمي. تمثل فئة العرض التقديمي مستند PowerPoint وتوفر طرقًا للوصول إلى عناصره ومعالجتها." >}}
