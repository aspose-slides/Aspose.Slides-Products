---
title: تحويل PPTX إلى PDF في Node.js
url: /ar/nodejs-java/conversion/pptx-to-pdf/
keywords: PPTX إلى PDF، تحويل PPTX إلى PDF، Node.js API، مكتبة Node.js، PPTX، PDF
description: تحويل PPTX إلى PDF في Node.js. استخدم واجهة برمجة تطبيقات مكتبة Node.js لتحويل ملفات PPTX إلى ملفات PDF.
---
...
{{% blocks/products/pf/feature-page-section h2="تحويل PPTX إلى PDF في Node.js" %}}
...
باعتباره واجهة برمجة تطبيقات حديثة لمعالجة المستندات، يقوم Aspose.Slides for Node.js بتصدير ملفات PPTX إلى تنسيقات ملفات PDF بسرعة. تتيح لك مكتبة Aspose PowerPoint تحويل PPTX إلى PDF والعديد من تنسيقات الملفات الأخرى

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="تحويل PPTX إلى PDF باستخدام Node.js" %}}
لتحويل PPTX إلى PDF، ستحتاج إلى إنشاء عرض تقديمي من ملف PPTX وحفظه باسم PDF.

{{% blocks/products/pf/agp/code-block title="كود Node.js لتحويل PPTX إلى PDF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية تحويل PPTX إلى PDF باستخدام Aspose.Slides for Node.js عبر Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="لتحويل PPTX إلى PDF باستخدام Aspose.Slides for Node.js عبر Java، تحتاج إلى استيراد الحزمة في ملف JavaScript الخاص بك وإنشاء مثيل لفئة العرض التقديمي. تمثل فئة العرض التقديمي مستند PowerPoint وتوفر طرقًا للوصول إلى عناصره ومعالجتها." >}}
