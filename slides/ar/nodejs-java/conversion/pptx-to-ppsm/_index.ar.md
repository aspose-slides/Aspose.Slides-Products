---
title: تحويل PPTX إلى PPSM في Node.js
url: /ar/nodejs-java/conversion/pptx-to-ppsm/
keywords: PPTX إلى PPSM، تحويل PPTX إلى PPSM، Node.js API، مكتبة Node.js، PPTX، PPSM
description: تحويل PPTX إلى PPSM في Node.js. استخدم واجهة برمجة تطبيقات مكتبة Node.js لتحويل ملفات PPTX إلى ملفات PPSM.
---
...
باعتباره واجهة برمجة تطبيقات حديثة لمعالجة المستندات، يقوم Aspose.Slides for Node.js بتصدير ملفات PPTX إلى تنسيقات ملفات PPSM بسرعة. تتيح لك مكتبة Aspose PowerPoint تحويل PPTX إلى PPSM والعديد من تنسيقات الملفات الأخرى

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="تحويل PPTX إلى PPSM باستخدام Node.js" %}}
لتحويل PPTX إلى PPSM، ستحتاج إلى إنشاء عرض تقديمي من ملف PPTX وحفظه باسم PPSM.

{{% blocks/products/pf/agp/code-block title="كود Node.js لتحويل PPTX إلى PPSM" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية تحويل PPTX إلى PPSM باستخدام Aspose.Slides for Node.js عبر Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="لتحويل PPTX إلى PPSM باستخدام Aspose.Slides for Node.js عبر Java، تحتاج إلى استيراد الحزمة في ملف JavaScript الخاص بك وإنشاء مثيل لفئة العرض التقديمي. تمثل فئة العرض التقديمي مستند PowerPoint وتوفر طرقًا للوصول إلى عناصره ومعالجتها." >}}
