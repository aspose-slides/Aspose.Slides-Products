---
title: تحويل PPTX إلى PPT في Node.js
url: /ar/nodejs-java/conversion/pptx-to-ppt/
keywords: PPTX إلى PPT، تحويل PPTX إلى PPT، Node.js API، مكتبة Node.js، PPTX، PPT
description: تحويل PPTX إلى PPT في Node.js. استخدم واجهة برمجة تطبيقات مكتبة Node.js لتحويل ملفات PPTX إلى ملفات PPT.
---
...
باعتباره واجهة برمجة تطبيقات حديثة لمعالجة المستندات، يقوم Aspose.Slides for Node.js بتصدير ملفات PPTX إلى تنسيقات ملفات PPT بسرعة. تتيح لك مكتبة Aspose PowerPoint تحويل PPTX إلى PPT والعديد من تنسيقات الملفات الأخرى

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="تحويل PPTX إلى PPT باستخدام Node.js" %}}
لتحويل PPTX إلى PPT، ستحتاج إلى إنشاء عرض تقديمي من ملف PPTX وحفظه باسم PPT.

{{% blocks/products/pf/agp/code-block title="كود Node.js لتحويل PPTX إلى PPT" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية تحويل PPTX إلى PPT باستخدام Aspose.Slides for Node.js عبر Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="لتحويل PPTX إلى PPT باستخدام Aspose.Slides for Node.js عبر Java، تحتاج إلى استيراد الحزمة في ملف JavaScript الخاص بك وإنشاء مثيل لفئة العرض التقديمي. تمثل فئة العرض التقديمي مستند PowerPoint وتوفر طرقًا للوصول إلى عناصره ومعالجتها." >}}
