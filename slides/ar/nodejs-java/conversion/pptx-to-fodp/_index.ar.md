---
title: تحويل PPTX إلى FODP في Node.js
url: /ar/nodejs-java/conversion/pptx-to-fodp/
keywords: PPTX إلى FODP، تحويل PPTX إلى FODP، Node.js API، مكتبة Node.js، PPTX، FODP
description: تحويل PPTX إلى FODP في Node.js. استخدم واجهة برمجة تطبيقات مكتبة Node.js لتحويل ملفات PPTX إلى ملفات FODP.
---
...
باعتباره واجهة برمجة تطبيقات حديثة لمعالجة المستندات، يقوم Aspose.Slides for Node.js بتصدير ملفات PPTX إلى تنسيقات ملفات FODP بسرعة. تتيح لك مكتبة Aspose PowerPoint تحويل PPTX إلى FODP والعديد من تنسيقات الملفات الأخرى

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="تحويل PPTX إلى FODP باستخدام Node.js" %}}
لتحويل PPTX إلى FODP، ستحتاج إلى إنشاء عرض تقديمي من ملف PPTX وحفظه باسم FODP.

{{% blocks/products/pf/agp/code-block title="كود Node.js لتحويل PPTX إلى FODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية تحويل PPTX إلى FODP باستخدام Aspose.Slides for Node.js عبر Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="لتحويل PPTX إلى FODP باستخدام Aspose.Slides for Node.js عبر Java، تحتاج إلى استيراد الحزمة في ملف JavaScript الخاص بك وإنشاء مثيل لفئة العرض التقديمي. تمثل فئة العرض التقديمي مستند PowerPoint وتوفر طرقًا للوصول إلى عناصره ومعالجتها." >}}
