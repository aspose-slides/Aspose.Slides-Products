---
title: تحويل PPTX إلى HTML في Node.js
url: /ar/nodejs-java/conversion/pptx-to-html/
keywords: PPTX إلى HTML، تحويل PPTX إلى HTML، Node.js API، مكتبة Node.js، PPTX، HTML
description: تحويل PPTX إلى HTML في Node.js. استخدم واجهة برمجة تطبيقات مكتبة Node.js لتحويل ملفات PPTX إلى ملفات HTML.
---
...
{{% blocks/products/pf/feature-page-section h2="تحويل PPTX إلى HTML في Node.js" %}}
...
باعتباره واجهة برمجة تطبيقات حديثة لمعالجة المستندات، يقوم Aspose.Slides for Node.js بتصدير ملفات PPTX إلى تنسيقات ملفات HTML بسرعة. تتيح لك مكتبة Aspose PowerPoint تحويل PPTX إلى HTML والعديد من تنسيقات الملفات الأخرى

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="تحويل PPTX إلى HTML باستخدام Node.js" %}}
لتحويل PPTX إلى HTML، ستحتاج إلى إنشاء عرض تقديمي من ملف PPTX وحفظه باسم HTML.

{{% blocks/products/pf/agp/code-block title="كود Node.js لتحويل PPTX إلى HTML" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية تحويل PPTX إلى HTML باستخدام Aspose.Slides for Node.js عبر Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="لتحويل PPTX إلى HTML باستخدام Aspose.Slides for Node.js عبر Java، تحتاج إلى استيراد الحزمة في ملف JavaScript الخاص بك وإنشاء مثيل لفئة العرض التقديمي. تمثل فئة العرض التقديمي مستند PowerPoint وتوفر طرقًا للوصول إلى عناصره ومعالجتها." >}}
