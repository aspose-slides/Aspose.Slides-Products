---
title: تحويل PPTX إلى PNG في Node.js
url: /ar/nodejs-java/conversion/pptx-to-png/
keywords: PPTX إلى PNG، تحويل PPTX إلى PNG، Node.js API، مكتبة Node.js، PPTX، PNG
description: تحويل PPTX إلى PNG في Node.js. استخدم واجهة برمجة تطبيقات مكتبة Node.js لتحويل ملفات PPTX إلى ملفات PNG.
---
...
{{% blocks/products/pf/feature-page-section h2="تحويل PPTX إلى PNG في Node.js" %}}
...
باعتباره واجهة برمجة تطبيقات حديثة لمعالجة المستندات، يقوم Aspose.Slides for Node.js بتصدير ملفات PPTX إلى تنسيقات ملفات PNG بسرعة. تتيح لك مكتبة Aspose PowerPoint تحويل PPTX إلى PNG والعديد من تنسيقات الملفات الأخرى

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="تحويل PPTX إلى PNG باستخدام Node.js" %}}
لتحويل PPTX إلى PNG، ستحتاج إلى إنشاء عرض تقديمي من ملف PPTX وحفظه باسم PNG.

{{% blocks/products/pf/agp/code-block title="كود Node.js لتحويل PPTX إلى PNG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية تحويل PPTX إلى PNG باستخدام Aspose.Slides for Node.js عبر Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="لتحويل PPTX إلى PNG باستخدام Aspose.Slides for Node.js عبر Java، تحتاج إلى استيراد الحزمة في ملف JavaScript الخاص بك وإنشاء مثيل لفئة العرض التقديمي. تمثل فئة العرض التقديمي مستند PowerPoint وتوفر طرقًا للوصول إلى عناصره ومعالجتها." >}}
