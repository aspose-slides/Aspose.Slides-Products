---
title: تحويل PPTX إلى SVG في Node.js
url: /ar/nodejs-java/conversion/pptx-to-svg/
keywords: PPTX إلى SVG، تحويل PPTX إلى SVG، Node.js API، مكتبة Node.js، PPTX، SVG
description: تحويل PPTX إلى SVG في Node.js. استخدم واجهة برمجة تطبيقات مكتبة Node.js لتحويل ملفات PPTX إلى ملفات SVG.
---
...
باعتباره واجهة برمجة تطبيقات حديثة لمعالجة المستندات، يقوم Aspose.Slides for Node.js بتصدير ملفات PPTX إلى تنسيقات ملفات SVG بسرعة. تتيح لك مكتبة Aspose PowerPoint تحويل PPTX إلى SVG والعديد من تنسيقات الملفات الأخرى

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="تحويل PPTX إلى SVG باستخدام Node.js" %}}
لتحويل PPTX إلى SVG، ستحتاج إلى إنشاء عرض تقديمي من ملف PPTX وحفظه باسم SVG.

{{% blocks/products/pf/agp/code-block title="كود Node.js لتحويل PPTX إلى SVG" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية تحويل PPTX إلى SVG باستخدام Aspose.Slides for Node.js عبر Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="لتحويل PPTX إلى SVG باستخدام Aspose.Slides for Node.js عبر Java، تحتاج إلى استيراد الحزمة في ملف JavaScript الخاص بك وإنشاء مثيل لفئة العرض التقديمي. تمثل فئة العرض التقديمي مستند PowerPoint وتوفر طرقًا للوصول إلى عناصره ومعالجتها." >}}
