---
title: تحويل PPTX إلى POTX في Node.js
url: /ar/nodejs-java/conversion/pptx-to-potx/
keywords: PPTX إلى POTX، تحويل PPTX إلى POTX، Node.js API، مكتبة Node.js، PPTX، POTX
description: تحويل PPTX إلى POTX في Node.js. استخدم واجهة برمجة تطبيقات مكتبة Node.js لتحويل ملفات PPTX إلى ملفات POTX.
---
...
{{% blocks/products/pf/feature-page-section h2="تحويل PPTX إلى POTX في Node.js" %}}
...
باعتباره واجهة برمجة تطبيقات حديثة لمعالجة المستندات، يقوم Aspose.Slides for Node.js بتصدير ملفات PPTX إلى تنسيقات ملفات POTX بسرعة. تتيح لك مكتبة Aspose PowerPoint تحويل PPTX إلى POTX والعديد من تنسيقات الملفات الأخرى

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="تحويل PPTX إلى POTX باستخدام Node.js" %}}
لتحويل PPTX إلى POTX، ستحتاج إلى إنشاء عرض تقديمي من ملف PPTX وحفظه باسم POTX.

{{% blocks/products/pf/agp/code-block title="كود Node.js لتحويل PPTX إلى POTX" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية تحويل PPTX إلى POTX باستخدام Aspose.Slides for Node.js عبر Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="لتحويل PPTX إلى POTX باستخدام Aspose.Slides for Node.js عبر Java، تحتاج إلى استيراد الحزمة في ملف JavaScript الخاص بك وإنشاء مثيل لفئة العرض التقديمي. تمثل فئة العرض التقديمي مستند PowerPoint وتوفر طرقًا للوصول إلى عناصره ومعالجتها." >}}
