---
title: تحويل PPTX إلى GIF في Node.js
url: /ar/nodejs-java/conversion/pptx-to-gif/
keywords: PPTX إلى GIF، تحويل PPTX إلى GIF، Node.js API، مكتبة Node.js، PPTX، GIF
description: تحويل PPTX إلى GIF في Node.js. استخدم واجهة برمجة تطبيقات مكتبة Node.js لتحويل ملفات PPTX إلى ملفات GIF.
---
...
باعتباره واجهة برمجة تطبيقات حديثة لمعالجة المستندات، يقوم Aspose.Slides for Node.js بتصدير ملفات PPTX إلى تنسيقات ملفات GIF بسرعة. تتيح لك مكتبة Aspose PowerPoint تحويل PPTX إلى GIF والعديد من تنسيقات الملفات الأخرى

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="تحويل PPTX إلى GIF باستخدام Node.js" %}}
لتحويل PPTX إلى GIF، ستحتاج إلى إنشاء عرض تقديمي من ملف PPTX وحفظه باسم GIF.

{{% blocks/products/pf/agp/code-block title="كود Node.js لتحويل PPTX إلى GIF" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية تحويل PPTX إلى GIF باستخدام Aspose.Slides for Node.js عبر Java API" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="لتحويل PPTX إلى GIF باستخدام Aspose.Slides for Node.js عبر Java، تحتاج إلى استيراد الحزمة في ملف JavaScript الخاص بك وإنشاء مثيل لفئة العرض التقديمي. تمثل فئة العرض التقديمي مستند PowerPoint وتوفر طرقًا للوصول إلى عناصره ومعالجتها." >}}
