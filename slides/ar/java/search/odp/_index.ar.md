---
title: ابحث في مستند ODP دون فتحه عبر Java
weight: 1250
url: /ar/java/search/odp/ 
description: نموذج كود Java للبحث عن الكلمات ذات النمط في ملف ODP في Java Runtime Environment لتطبيق JSP / JSF وتطبيقات سطح المكتب.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ابحث عن تنسيقات ODP في جافا" h2="بحث عن مستندات ODP أصلي وعالي الأداء باستخدام Aspose من جانب الخادم. شرائح لـ Java APIs ، دون استخدام أي برنامج مثل Microsoft أو Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODP" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية البحث عن ملف ODP باستخدام Java" %}}
...
{{< blocks/products/pf/agp/feature-section-col title="خطوات البحث عن ملفات ODP بجافا" >}}
...
قم بتحميل ملف ODP عن طريق إنشاء كائن فئة العرض التقديمي.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="ابحث عن ملفات ODP - Java" offSpacer="" %}}
