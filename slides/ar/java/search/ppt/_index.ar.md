...
{{% blocks/products/pf/agp/code-block title="بحث عن نص PPT عرض تقديمي باستخدام Java" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية البحث عن نص بتنسيق PPT عبر Java" >}}
