---
title: تحويل JPG إلى PPTX في Java
url: /ar/java/conversion/jpg-to-pptx/
keywords: تحويل JPG إلى PPTX ، JPG إلى PPTX ، PowerPoint ، JPG ، PPTX ، Java API ، مكتبة Java
description: تحويل JPG إلى PPTX في Java. استخدم Java Library API لتحويل صور JPG إلى PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="تحويل JPG إلى PPTX في Java" h2="واجهة برمجة تطبيقات Java قوية ومتعددة المنصات لتحويل JPG إلى PPTX باستخدام كود Java" >}}

{{% blocks/products/pf/feature-page-section h2="تحويل JPG إلى PPTX باستخدام Aspose.Slides" %}}

[** Aspose.Slides for Java **](https://products.aspose.com/slides/ar/java/) هي مكتبة جافا قوية تُستخدم لإنشاء وتحويل ومعالجة عروض PowerPoint التقديمية وملفات PDF ومستندات HTML وغيرها الملفات. عندما تقوم بتحويل JPG إلى PPTX ، فأنت تقوم بشكل أساسي بإنشاء عرض PowerPoint تقديمي يحتوي على شرائح بناءً على صور JPG.

{{% /blocks/products/pf/feature-page-section %}}


{{% blocks/products/pf/feature-page-section  h2="تحويل JPG إلى PPTX في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="كود جافا لتحويل JPG إلى PPTX" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="كيفية تحويل JPG إلى PPTX في جافا" >}}
