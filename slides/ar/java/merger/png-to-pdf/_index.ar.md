---
title: دمج PNG في PDF في جافا
url: /ar/java/merger/png-to-pdf/
keywords: PNG إلى PDF ، دمج PNG في PDF ، الانضمام إلى PNG إلى PDF ، PDF ، PNG ، Java API ، مكتبة Java
description: دمج PNG في PDF في جافا. استخدم Java Library API للجمع بين PNG و PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="دمج PNG في PDF في جافا" h2="مكتبة Java عالية السرعة ومتعددة الأنظمة لدمج ملفات PNG إلى ملفات PDF باستخدام كود Java" >}}

{{% blocks/products/pf/feature-page-section h2="دمج PNG إلى PDF باستخدام Aspose.Slides" %}}

[** Aspose.Slides for Java **](https://products.aspose.com/slides/ar/java/) هي مكتبة Java قوية تُستخدم لإنشاء وتحويل ودمج ومعالجة العروض التقديمية والصور والملفات الأخرى. عندما تقوم بدمج PNG إلى PDF ، فإنك تدمج صور PNG بشكل فعال للحصول على ملف PDF واحد.
...
{{% blocks/products/pf/feature-page-section  h2="دمج PNG في PDF في جافا" %}}
باستخدام [** Aspose.Slides for Java **](https://products.aspose.com/slides/ar/java/) ، يمكنك دمج PNG إلى PDF بسرعة ببضعة سطور من التعليمات البرمجية

{{% blocks/products/pf/agp/code-block title="كود جافا لدمج PNG في PDF" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج PNG إلى PDF في Java" >}}
