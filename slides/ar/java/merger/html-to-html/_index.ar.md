---
title: دمج ملفات HTML في Java
url: /ar/java/merger/html-to-html/
keywords: دمج HTML ، HTML إلى HTML ، الانضمام إلى HTML ، الجمع بين HTML ، Java API ، مكتبة Java
description: دمج HTML إلى HTML في Java. استخدم Java Library API لدمج ملفات HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="دمج HTML في Java" h2="مكتبة Java عالية السرعة ومتعددة المنصات لدمج ملفات HTML باستخدام كود Java" >}}

{{% blocks/products/pf/feature-page-section h2="دمج HTML مع HTML باستخدام Aspose.Slides" %}}

[** Aspose.Slides for Java **](https://products.aspose.com/slides/ar/java/) هي مكتبة Java قوية تُستخدم لإنشاء وتحويل ودمج ومعالجة العروض التقديمية وملفات HTML والمستندات الأخرى . عندما تدمج HTML إلى HTML ، فأنت تدمج بشكل فعال المحتويات من وثيقتين للحصول على ملف HTML واحد. Aspose.Slides يسمح لك بدمج مستندات HTML بطرق مختلفة. يمكنك دمج HTML مع جميع نصوصها وتنسيقاتها وأنماطها وما إلى ذلك.
...
{{% blocks/products/pf/feature-page-section  h2="دمج HTML إلى HTML في Java" %}}
باستخدام [** Aspose.Slides for Java **](https://products.aspose.com/slides/ar/java/) ، يمكنك دمج ملفات HTML بسرعة ببضعة سطور من التعليمات البرمجية

{{% blocks/products/pf/agp/code-block title="كود جافا لدمج HTML إلى HTML" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج HTML في Java" >}}
