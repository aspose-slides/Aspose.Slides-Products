...
url: /ar/java/merger/pdf-to-pdf/
keywords: دمج PDF ، PDF إلى PDF ، الانضمام إلى PDF ، الجمع بين PDF ، Java API ، مكتبة Java
description: دمج PDF إلى PDF في Java. استخدم Java Library API لدمج ملفات PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="دمج PDF في جافا" h2="مكتبة Java عالية السرعة ومتعددة المنصات لدمج ملفات PDF باستخدام كود Java" >}}
...
{{% blocks/products/pf/feature-page-section  h2="دمج PDF إلى PDF في جافا" %}}
باستخدام [** Aspose.Slides for Java **](https://products.aspose.com/slides/ar/java/) ، يمكنك دمج ملفات PDF بسرعة ببضعة سطور من التعليمات البرمجية

{{% blocks/products/pf/agp/code-block title="كود جافا لدمج PDF إلى PDF" offSpacer="true" %}}
```java
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج ملفات PDF في Java" >}}
