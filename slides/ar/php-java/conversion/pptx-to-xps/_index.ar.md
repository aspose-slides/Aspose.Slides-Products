...
{{% blocks/products/pf/agp/content h2="تحويل PPTX إلى XPS في PHP" %}}

هل تحتاج إلى تحويل ملفات PPTX إلى XPS برمجيًا؟ باستخدام [* Aspose.Slides for PHP عبر Java *](https://products.aspose.com/slides/ar/php-java/) يمكن لأي مطور تحويل PPTX إلى تنسيق XPS ببضعة أسطر فقط من كود PHP .

كواجهة برمجة تطبيقات حديثة لمعالجة العروض التقديمية ، تقوم Aspose.Slides for PHP بإنشاء XPS من PPTX بسرعة. اختبر جودة التحويل من PPTX إلى XPS مباشرةً في [المتصفح](https://products.aspose.app/slides/conversion). تسمح لك مكتبة Aspose PowerPoint PPTX بتحويل ملفات PPTX إلى العديد من التنسيقات الشائعة.
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل PPTX إلى XPS في PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي خطوات تحويل ملف PPTX إلى XPS باستخدام PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل PPTX إلى XPS PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ PPTX كـ XPS في PHP" %}}
استخدم التطبيق المجاني لمشاهدة عرض توضيحي لعملية التحويل من PPTX إلى XPS. 
{{% /blocks/products/pf/agp/content %}}
