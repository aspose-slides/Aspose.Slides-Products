---
title: تحويل PPSM إلى PDF في PHP
weight: 1760
url: /ar/php-java/conversion/ppsm-to-pdf/ 
keywords: "Convert, PowerPoint, PPSM, PDF, Presentation, PHP"
description: نموذج رمز من PPSM إلى PDF تحويل PHP. استخدم PowerPoint PHP API لتحويل ملفات PPSM إلى ملفات PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل PPSM إلى PDF في PHP" h2="مكتبة PHP قوية في PowerPoint لتحويل PPSM إلى PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل PPSM إلى PDF في PHP" %}}

هل تحتاج إلى تحويل ملفات PPSM إلى PDF برمجيًا؟ باستخدام [* Aspose.Slides for PHP عبر Java *](https://products.aspose.com/slides/ar/php-java/) يمكن لأي مطور تحويل PPSM إلى تنسيق PDF ببضعة أسطر فقط من كود PHP .

كواجهة برمجة تطبيقات حديثة لمعالجة العروض التقديمية ، تقوم Aspose.Slides for PHP بإنشاء PDF من PPSM بسرعة. اختبر جودة التحويل من PPSM إلى PDF مباشرةً في [المتصفح](https://products.aspose.app/slides/conversion). تسمح لك مكتبة Aspose PowerPoint PPTX بتحويل ملفات PPSM إلى العديد من التنسيقات الشائعة.
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل PPSM إلى PDF في PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي خطوات تحويل ملف PPSM إلى PDF باستخدام PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل PPSM إلى PDF PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ PPSM كـ PDF في PHP" %}}
استخدم التطبيق المجاني لمشاهدة عرض توضيحي لعملية التحويل من PPSM إلى PDF. 
{{% /blocks/products/pf/agp/content %}}
