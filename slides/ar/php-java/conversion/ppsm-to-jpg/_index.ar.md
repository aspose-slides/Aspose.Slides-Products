---
title: تحويل PPSM إلى JPG في PHP
weight: 1730
url: /ar/php-java/conversion/ppsm-to-jpg/ 
keywords: "Convert, PowerPoint, PPSM, JPG, Presentation, PHP"
description: نموذج رمز من PPSM إلى JPG تحويل PHP. استخدم PowerPoint PHP API لتحويل ملفات PPSM إلى ملفات JPG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل PPSM إلى JPG في PHP" h2="مكتبة PHP قوية في PowerPoint لتحويل PPSM إلى JPG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-php-via-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="SVG" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل PPSM إلى JPG في PHP" %}}

هل تحتاج إلى تحويل ملفات PPSM إلى JPG برمجيًا؟ باستخدام [* Aspose.Slides for PHP عبر Java *](https://products.aspose.com/slides/ar/php-java/) يمكن لأي مطور تحويل PPSM إلى تنسيق JPG ببضعة أسطر فقط من كود PHP .

كواجهة برمجة تطبيقات حديثة لمعالجة العروض التقديمية ، تقوم Aspose.Slides for PHP بإنشاء JPG من PPSM بسرعة. اختبر جودة التحويل من PPSM إلى JPG مباشرةً في [المتصفح](https://products.aspose.app/slides/conversion/ppt-to-jpg). تسمح لك مكتبة Aspose PowerPoint PPTX بتحويل ملفات PPSM إلى العديد من التنسيقات الشائعة.
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل PPSM إلى JPG في PHP" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="هذه هي خطوات تحويل ملف PPSM إلى JPG باستخدام PHP." >}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل PPSM إلى JPG PHP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ PPSM كـ JPG في PHP" %}}
استخدم التطبيق المجاني لمشاهدة عرض توضيحي لعملية التحويل من PPSM إلى JPG. 
{{% /blocks/products/pf/agp/content %}}
