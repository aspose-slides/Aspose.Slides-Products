---
title: تحرير HTML في PHP
url: /ar/php-java/editor/html/
keywords: تحرير HTML ، تحرير PowerPoint ، HTML ، PowerPoint ، PHP API ، مكتبة PHP
description: تحرير HTML في PHP. استخدم PHP Library API لتحرير ملفات HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="تحرير HTML في PHP" h2="مكتبة PHP عالية السرعة ومتعددة الأنظمة للتحرير HTML باستخدام كود PHP" >}}

{{% blocks/products/pf/feature-page-section h2="تحرير HTML باستخدام Aspose.Slides" %}}

[** Aspose.Slides for PHP عبر Java **](https://products.aspose.com/slides/ar/php-java/) هي مكتبة PHP قوية تُستخدم لمعالجة العروض التقديمية وتحريرها. يمكنك تحرير عرض تقديمي HTML عن طريق إضافة سطر جديد من النص إليه. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="تحرير HTML في PHP" %}}
باستخدام [** Aspose.Slides for PHP via Java **](https://products.aspose.com/slides/ar/php-java/) ، يمكنك إضافة سطر جديد من النص إلى مستند HTML بمجرد بضعة أسطر من التعليمات البرمجية.

{{% blocks/products/pf/agp/code-block title="كود PHP لتحرير HTML" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية تحرير HTML في PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
قم بتحميل العرض التقديمي HTML الذي تريد تحريره.
{{< /blocks/products/pf/agp/step-autogen >}}
