---
title: تحرير FODP في PHP
url: /ar/php-java/editor/fodp/
keywords: تحرير FODP ، تحرير PowerPoint ، FODP ، PowerPoint ، PHP API ، مكتبة PHP
description: تحرير FODP في PHP. استخدم PHP Library API لتحرير ملفات FODP
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="تحرير FODP في PHP" h2="مكتبة PHP عالية السرعة ومتعددة الأنظمة للتحرير FODP باستخدام كود PHP" >}}

{{% blocks/products/pf/feature-page-section h2="تحرير FODP باستخدام Aspose.Slides" %}}

[** Aspose.Slides for PHP عبر Java **](https://products.aspose.com/slides/ar/php-java/) هي مكتبة PHP قوية تُستخدم لمعالجة العروض التقديمية وتحريرها. يمكنك تحرير عرض تقديمي FODP عن طريق إضافة سطر جديد من النص إليه. 

{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="تحرير FODP في PHP" %}}
باستخدام [** Aspose.Slides for PHP via Java **](https://products.aspose.com/slides/ar/php-java/) ، يمكنك إضافة سطر جديد من النص إلى مستند FODP بمجرد بضعة أسطر من التعليمات البرمجية.

{{% blocks/products/pf/agp/code-block title="كود PHP لتحرير FODP" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية تحرير FODP في PHP" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
قم بتحميل العرض التقديمي FODP الذي تريد تحريره.
{{< /blocks/products/pf/agp/step-autogen >}}
