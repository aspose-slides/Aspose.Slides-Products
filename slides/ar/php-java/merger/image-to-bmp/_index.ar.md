---
title: دمج الصورة في BMP في PHP
url: /ar/php-java/merger/image-to-bmp/
keywords: صورة إلى BMP ، دمج الصورة في BMP ، ضم الصورة إلى BMP ، دمج الصور ، الصورة ، BMP ، PHP API ، مكتبة PHP
description: دمج الصورة في BMP في PHP. استخدم مكتبة PHP API لدمج الصور
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="دمج الصورة في BMP في PHP" h2="مكتبة PHP عالية السرعة ومتعددة الأنظمة لدمج الصور في ملفات BMP باستخدام كود PHP" >}}

{{% blocks/products/pf/feature-page-section h2="دمج الصورة في BMP باستخدام Aspose.Slides" %}}

[** Aspose.Slides for PHP عبر Java **](https://products.aspose.com/slides/ar/php-java/) هي مكتبة PHP قوية تُستخدم لإنشاء وتحويل ودمج ومعالجة العروض التقديمية وملفات PDF و الصور والملفات الأخرى. عند دمج الصورة في BMP ، فأنت تقوم بدمج الصور بشكل فعال للحصول على ملف BMP واحد.
...
{{% blocks/products/pf/feature-page-section  h2="دمج الصورة في BMP في PHP" %}}
باستخدام [** Aspose.Slides for PHP عبر Java **](https://products.aspose.com/slides/ar/php-java/) ، يمكنك دمج الصورة في BMP بسرعة ببضعة سطور من التعليمات البرمجية

{{% blocks/products/pf/agp/code-block title="كود PHP لدمج الصورة في BMP" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج الصورة في BMP في PHP" >}}
