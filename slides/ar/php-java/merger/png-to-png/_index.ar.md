---
title: دمج صور PNG في PHP
url: /ar/php-java/merger/png-to-png/
keywords: دمج PNG و PNG و PNG وضم PNG ودمج PNG و PHP API و PHP Library
description: دمج PNG في PNG في PHP. استخدم مكتبة PHP API لدمج ملفات PNG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="دمج PNG في PHP" h2="مكتبة PHP عالية السرعة ومتعددة الأنظمة لدمج صور PNG باستخدام كود PHP" >}}

{{% blocks/products/pf/feature-page-section h2="ادمج PNG في PNG باستخدام Aspose.Slides" %}}

[** Aspose.Slides for PHP عبر Java **](https://products.aspose.com/slides/ar/php-java/) هي مكتبة PHP قوية تُستخدم لدمج ومعالجة العروض التقديمية والصور والملفات الأخرى. عندما تقوم بدمج PNG إلى PNG ، فأنت تقوم بجمع صورتين بشكل فعال للحصول على صورة واحدة.
...
{{% blocks/products/pf/feature-page-section  h2="دمج PNG في PNG في PHP" %}}
باستخدام [** Aspose.Slides for PHP عبر Java **](https://products.aspose.com/slides/ar/php-java/) ، يمكنك دمج ملفات PNG بسرعة ببضعة سطور من التعليمات البرمجية

{{% blocks/products/pf/agp/code-block title="كود PHP لدمج PNG في PNG" offSpacer="true" %}}
```php
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج PNG في PHP" >}}
