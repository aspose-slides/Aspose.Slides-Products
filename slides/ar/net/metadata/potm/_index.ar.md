---
title: عرض أو تحرير البيانات الأولية لملفات POTM عبر .NET
weight: 590
url: /ar/net/metadata/potm/ 
description: كود المصدر C# لتحرير أو عرض البيانات الوصفية بتنسيق POTM على .NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin الأنظمة الأساسية.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="استخراج البيانات الوصفية لـ POTM عبر .NET" h2="أنشئ تطبيقات .NET الخاصة بك لإضافة أو تحرير أو إزالة أو استخراج البيانات الوصفية من ملفات POTM باستخدام واجهات برمجة التطبيقات من جانب الخادم." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="كيفية استخراج البيانات الوصفية لـ POTM باستخدام C#" %}}

 من أجل استخراج البيانات الوصفية لـ POTM ، سنستخدمها
...
{{< blocks/products/pf/agp/feature-section-col title="خطوات استخراج البيانات الوصفية لـ POTM عبر C#" >}}
...
إنشاء فئة العرض التقديمي مع المسار إلى ملف POTM
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="استخراج البيانات الوصفية لـ POTM - C#" offSpacer="" %}}
