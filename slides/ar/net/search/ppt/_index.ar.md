...
{{% blocks/products/pf/agp/code-block title="بحث عن نص PPT عرض تقديمي باستخدام C#" offSpacer="true" %}}
...
{{< blocks/products/pf/feature-page-section  h2="كيفية البحث عن نص بتنسيق PPT عبر C#" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/slides/ar/net/search/pptx/" name="PPTX" >}}
