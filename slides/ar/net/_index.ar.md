...
<h2 class="h2title">تحكم كامل في PowerPoint Slide Elements</h2>

<p>Aspose.Slides for .NET يمكنه التعامل مع جميع عناصر شرائح العرض بما في ذلك مربع النص ، الجدول ، المستطيل ، القطع الناقص ، متعدد الخطوط ، الشكل التلقائي ، إطار الصورة ، إطار الصوت ، إطار الفيديو وإطار كائن OLE. توفر واجهة برمجة التطبيقات مجموعة من الفئات المصممة جيدًا والتي تمكنك من معالجة كل عنصر من هذه العناصر بشكل شامل.</p>
...
<h2 class="h2title">دعم لـ Office Open XML</h2>

<p>Office OpenXML (OOXML) هو التنسيق المستند إلى XML والذي تم تقديمه في Microsoft Office 2007.</p>

<p>PresentationML (OOXML ، PPTX) هي لغة الترميز المستخدمة بواسطة Microsoft Office PowerPoint 2007 لتخزين مستنداته. يدعم Aspose.Slides for .NET بشكل مكثف إنشاء مستندات PresentationML وقراءتها ومعالجتها وكتابتها.</p>
