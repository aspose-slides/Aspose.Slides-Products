...
url: /ar/net/conversion/png-to-ppt/
keywords: قم بتحويل PNG إلى PPT و PNG إلى PPT و PowerPoint و PNG و PPT و C# API و .NET Library
description: تحويل PNG إلى PPT في C#. استخدم .NET library API لتحويل صور PNG إلى PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="تحويل PNG إلى PPT في C#" h2="واجهة برمجة تطبيقات .NET قوية ومتعددة المنصات لتحويل PNG إلى PPT باستخدام كود C# على NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin الأنظمة الأساسية" >}}

{{% blocks/products/pf/feature-page-section h2="قم بتحويل PNG إلى PPT باستخدام Aspose.Slides" %}}

[** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) هي مكتبة .NET قوية تُستخدم لإنشاء وتحويل ومعالجة عروض PowerPoint التقديمية وملفات PDF ومستندات HTML و وغيرها من الملفات. عندما تقوم بتحويل PNG إلى PPT ، فأنت تقوم بشكل أساسي بإنشاء عرض PowerPoint تقديمي يحتوي على شرائح بناءً على صور PNG.
