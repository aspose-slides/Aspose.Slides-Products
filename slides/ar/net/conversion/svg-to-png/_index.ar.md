...
keywords: SVG إلى PNG ، تحويل SVG إلى PNG ، C# API ، مكتبة .NET
description: تحويل SVG إلى PNG في C#. استخدم .NET library API لتحويل ملفات SVG إلى ملفات PNG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل SVG إلى PNG في C#" h2="PowerPoint .NET API لتحويل ملفات صور SVG إلى PNG على الأنظمة الأساسية NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل SVG إلى PNG في C#" %}}

كيف أقوم بتحويل SVG إلى PNG في التعليمات البرمجية؟

باستخدام [** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) ، يمكن لأي مطور أو تطبيق تحويل SVG إلى PNG ببضعة أسطر من كود C#.

كواجهة برمجة تطبيقات حديثة لمعالجة المستندات ، يقوم Aspose.Slides for .NET بتصدير ملفات SVG إلى PNG بسرعة. تسمح لك مكتبة Aspose PowerPoint بتحويل SVG إلى PNG والصور بتنسيقات أخرى.
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل SVG إلى PNG في C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="يمكن للمطورين والتطبيقات تحويل SVG إلى PNG بهذه الطريقة:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 قبل تشغيل كود C# للتحويل من SVG إلى PNG ، يجب أن يكون لجهازك هذه المتطلبات الأساسية:
...
{{% blocks/products/pf/agp/code-block title="كود C# لتحويل SVG إلى PNG" offSpacer="" %}}
