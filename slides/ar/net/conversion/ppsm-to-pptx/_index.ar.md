---
title: تحويل PPSM إلى PPTX عبر C#
weight: 1540
url: /ar/net/conversion/ppsm-to-pptx/ 
description: رمز عينة لتحويل PPSM إلى PPTX C#. استخدم رمز مثال API لملفات PPSM الدفعية لتحويل PPTX داخل VB.NET أو Asp.NET أو أي تطبيق قائم على .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل PPSM إلى PPTX عبر C#" h2="تصدير ملفات PowerPoint® PPSM إلى PPTX على .NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin الأنظمة الأساسية" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPSM" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل PPSM إلى PPTX باستخدام C#" %}}

 من أجل تحويل PPSM إلى PPTX ، سنستخدم
...
{{< blocks/products/pf/agp/feature-section-col title="خطوات تحويل PPSM إلى PPTX عبر C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="يمكن لمطوري .NET تحميل وتحويل ملفات PPSM بسهولة إلى PPTX في بضعة أسطر من التعليمات البرمجية." >}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل PPSM إلى PPTX C#" offSpacer="" %}}
