---
title: تحويل الصورة إلى PDF في C#
weight: 30
url: /ar/net/conversion/image-to-pdf/ 
keywords: صورة إلى PDF ، تحويل الصورة إلى PDF ، C# API ، مكتبة .NET ، صورة ، JPG ، PNG ، PDF
description: تحويل الصورة إلى PDF في C#. استخدم .NET library API لتحويل الصور إلى مستندات PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل الصورة إلى PDF في C#" h2="PowerPoint .NET API لتحويل الصور إلى مستندات PDF على NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin الأنظمة الأساسية" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل الصورة إلى PDF في C#" %}}

كيف أقوم بتحويل الصورة إلى PDF برمجيًا؟

باستخدام [** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) ، يمكن لأي مطور أو تطبيق تحويل الصورة إلى تنسيق PDF ببضعة أسطر من كود C#.

باعتبارها واجهة برمجة تطبيقات حديثة لمعالجة المستندات ، تقوم Aspose.Slides for .NET بإنشاء ملفات PDF من صور JPG أو PNG بسرعة. تسمح لك مكتبة Aspose PowerPoint بتحويل الصورة إلى PDF والعديد من تنسيقات الملفات الأخرى
...
{{< blocks/products/pf/agp/feature-section-col title="خطوات تحويل الصورة إلى PDF في C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="يمكن للمطورين والتطبيقات تحويل الصورة إلى PDF بهذه الطريقة:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 قبل تشغيل رمز C# للتحويل من صورة إلى PDF ، يجب أن يكون لدى جهازك المتطلبات الأساسية التالية:
...
{{% blocks/products/pf/agp/code-block title="كود C# لتحويل الصورة إلى PDF" offSpacer="" %}}
