...
weight: 120
url: /ar/net/conversion/pdf-to-xml/ 
keywords: PDF إلى XML ، تحويل PDF إلى XML ، C # API ، مكتبة .NET ، PDF ، XML
description: تحويل PDF إلى XML في C #. استخدم .NET library API لتحويل صفحات PDF إلى ملفات XML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل PDF إلى XML في C #" h2="PowerPoint .NET API لتحويل مستندات PDF إلى ملفات XML على الأنظمة الأساسية .NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل PDF إلى XML في C #" %}}

كيف أقوم بتحويل PDF إلى XML في التعليمات البرمجية؟

باستخدام [** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) ، يمكن لأي مطور أو تطبيق تحويل PDF إلى ملفات XML ببضعة أسطر من كود C #.

بصفتها واجهة برمجة تطبيقات حديثة لمعالجة المستندات ، تقوم Aspose.Slides for .NET بتصدير صفحات PDF إلى XML بسرعة. تسمح لك مكتبة Aspose PowerPoint بتحويل PDF إلى XML والعديد من تنسيقات الملفات الأخرى.
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل PDF إلى XML في C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="يمكن للمطورين والتطبيقات تحويل PDF إلى XML بهذه الطريقة:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 قبل تشغيل كود C # للتحويل من PDF إلى XML ، يجب أن يكون لجهازك هذه المتطلبات الأساسية:
...
{{% blocks/products/pf/agp/code-block title="C # رمز لتحويل PDF إلى XML" offSpacer="" %}}
