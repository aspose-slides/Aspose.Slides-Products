---
title: تحويل PPTM إلى JPEG عبر C#
weight: 7860
url: /ar/net/conversion/pptm-to-jpeg/ 
description: رمز عينة لتحويل PPTM إلى JPEG C#. استخدم رمز مثال API لملفات PPTM الدفعية لتحويل JPEG داخل VB.NET أو Asp.NET أو أي تطبيق قائم على .NET.
---
...
{{< blocks/products/pf/agp/steps-block-autogen name="يمكن لمطوري .NET تحميل وتحويل ملفات PPTM إلى JPEG بسهولة في بضعة أسطر من التعليمات البرمجية." >}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الكود هذا تحويل PPTM إلى JPEG C#" offSpacer="" %}}
