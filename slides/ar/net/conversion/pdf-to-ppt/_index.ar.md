...
keywords: تحويل PDF إلى PPT ، PDF إلى PPT ، PowerPoint ، PDF ، PPT ، C# API ، مكتبة .NET
description: تحويل PDF إلى PPT في C#. استخدم .NET Library API لتحويل PDF إلى PowerPoint
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="تحويل PDF إلى PPT في C#" h2="واجهة برمجة تطبيقات .NET API قوية ومتعددة المنصات لتحويل PDF إلى PPT باستخدام كود C# على NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin الأنظمة الأساسية" >}}

{{% blocks/products/pf/feature-page-section h2="قم بتحويل ملفات PDF إلى PPT باستخدام Aspose.Slides" %}}

[** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) هي مكتبة .NET قوية تُستخدم لإنشاء وتحويل ومعالجة عروض PowerPoint التقديمية وملفات PDF ومستندات HTML و وغيرها من الملفات. عندما تقوم بتحويل PDF إلى PPT ، فأنت تقوم بشكل أساسي بنقل المحتويات الموجودة على صفحات PDF إلى شرائح في عرض تقديمي لـ PowerPoint.
...
{{< blocks/products/pf/feature-page-section  h2="كيفية تحويل PDF إلى PPT في C#" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
قم بتحميل ملف PDF الذي تريد تحويله إلى PPT.
{{< /blocks/products/pf/agp/step-autogen >}}
