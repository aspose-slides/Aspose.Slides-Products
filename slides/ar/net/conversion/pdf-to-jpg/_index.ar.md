...
weight: 70
url: /ar/net/conversion/pdf-to-jpg/ 
keywords: PDF إلى JPG ، تحويل PDF إلى JPG ، C # API ، مكتبة .NET ، PDF ، JPG
description: تحويل PDF إلى JPG في C #. استخدم .NET library API لتحويل صفحات PDF إلى صور JPG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل PDF إلى JPG في C #" h2="PowerPoint .NET API لتحويل مستندات PDF إلى صور JPG على NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin الأنظمة الأساسية" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل PDF إلى JPG في C #" %}}

كيف أقوم بتحويل PDF إلى JPG في كود؟

باستخدام [** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) ، يمكن لأي مطور أو تطبيق تحويل PDF إلى تنسيق JPG ببضعة أسطر من كود C #.

كواجهة برمجة تطبيقات حديثة لمعالجة المستندات ، يقوم Aspose.Slides for .NET بتصدير صفحات PDF إلى JPG بسرعة. تسمح لك مكتبة Aspose PowerPoint بتحويل PDF إلى JPG والعديد من تنسيقات الملفات الأخرى
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل PDF إلى JPG في C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="يمكن للمطورين والتطبيقات تحويل PDF إلى JPG بهذه الطريقة:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
قم باستدعاء طريقة الحفظ لحفظ الشرائح كصور JPG.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 قبل تشغيل كود C # للتحويل من PDF إلى JPG ، يجب أن يكون لجهازك هذه المتطلبات الأساسية:
...
{{% blocks/products/pf/agp/code-block title="كود C # لتحويل PDF إلى JPG" offSpacer="" %}}
