...
keywords: JPG إلى PDF ، تحويل JPG إلى PDF ، C# API ، مكتبة .NET
description: تحويل JPG إلى PDF في C#. استخدم .NET library API لتحويل صور JPG JPEG إلى مستندات PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل JPG إلى PDF في C#" h2="PowerPoint .NET API لتحويل صور JPG إلى مستندات PDF على أنظمة NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل JPG إلى PDF في C#" %}}

كيف أقوم بتحويل JPG إلى PDF برمجيًا؟

باستخدام [** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) ، يمكن لأي مطور أو تطبيق تحويل JPG إلى تنسيق PDF ببضعة أسطر من كود C#.

باعتبارها واجهة برمجة تطبيقات حديثة لمعالجة المستندات ، تقوم Aspose.Slides for .NET بإنشاء ملفات PDF من صور JPG بسرعة. تسمح لك مكتبة Aspose PowerPoint بتحويل JPG إلى PDF والعديد من تنسيقات الملفات الأخرى
...
{{< blocks/products/pf/agp/feature-section-col title="خطوات تحويل JPG إلى PDF في C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="يمكن للمطورين والتطبيقات تحويل JPG إلى PDF بهذه الطريقة:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 قبل تشغيل كود C# للتحويل من JPG إلى PDF ، يجب أن يكون لدى جهازك هذه المتطلبات الأساسية:
...
{{% blocks/products/pf/agp/code-block title="كود C# لتحويل JPG إلى PDF" offSpacer="" %}}
