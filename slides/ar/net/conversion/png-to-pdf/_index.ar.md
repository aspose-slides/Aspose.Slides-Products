...
keywords: PNG إلى PDF وتحويل PNG إلى PDF و C# API و .NET Library و PNG و PDF
description: تحويل PNG إلى PDF في C#. استخدم .NET library API لتحويل صور PNG إلى مستندات PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل PNG إلى PDF في C#" h2="PowerPoint .NET API لتحويل صور PNG إلى مستندات PDF على الأنظمة الأساسية NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="PNG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل PNG إلى PDF في C#" %}}

كيف أقوم بتحويل PNG إلى PDF برمجيًا؟

باستخدام [** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) ، يمكن لأي مطور أو تطبيق تحويل PNG إلى تنسيق PDF ببضعة أسطر من كود C#.

باعتبارها واجهة برمجة تطبيقات حديثة لمعالجة المستندات ، تقوم Aspose.Slides for .NET بإنشاء ملفات PDF من صور PNG بسرعة. تسمح لك مكتبة Aspose PowerPoint بتحويل PNG إلى PDF والعديد من تنسيقات الملفات الأخرى
...
{{< blocks/products/pf/agp/feature-section-col title="خطوات تحويل PNG إلى PDF في C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="يمكن للمطورين والتطبيقات تحويل PNG إلى PDF بهذه الطريقة:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 قبل تشغيل رمز C# للتحويل من PNG إلى PDF ، يجب أن تتوفر في جهازك المتطلبات الأساسية التالية:
...
{{% blocks/products/pf/agp/code-block title="كود C# لتحويل PNG إلى PDF" offSpacer="" %}}
