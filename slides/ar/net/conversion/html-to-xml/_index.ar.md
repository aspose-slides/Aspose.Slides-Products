---
title: تحويل HTML إلى XML في C #
weight: 170
url: /ar/net/conversion/html-to-xml/ 
keywords: HTML إلى XML ، تحويل HTML إلى XML ، C # API ، مكتبة .NET ، HTML ، XML
description: تحويل HTML إلى XML في C #. استخدم .NET library API لتحويل مستند HTML إلى ملف XML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل HTML إلى XML في C #" h2="PowerPoint .NET API لتحويل مستندات HTML إلى ملفات XML على الأنظمة الأساسية NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل HTML إلى XML في C #" %}}

كيف أقوم بتحويل HTML إلى XML في التعليمات البرمجية؟

باستخدام [** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) ، يمكن لأي مطور أو تطبيق تحويل HTML إلى ملفات XML ببضعة أسطر من كود C #.

كواجهة برمجة تطبيقات حديثة لمعالجة المستندات ، يقوم Aspose.Slides for .NET بتصدير المحتوى في HTML إلى XML بسرعة. تسمح لك مكتبة Aspose PowerPoint بتحويل HTML إلى XML والعديد من تنسيقات الملفات الأخرى.
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل HTML إلى XML في C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="يمكن للمطورين والتطبيقات تحويل HTML إلى XML بهذه الطريقة:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
أضف الشرائح بناءً على محتويات ملف HTML.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 قبل تشغيل كود C # للتحويل من HTML إلى XML ، يجب أن يتوافر في جهازك المتطلبات الأساسية التالية:
...
{{% blocks/products/pf/agp/code-block title="كود C # لتحويل HTML إلى XML" offSpacer="" %}}
