...
title: تحويل PDF إلى صورة في C #
weight: 80
url: /ar/net/conversion/pdf-to-image/ 
keywords: PDF إلى صورة ، تحويل PDF إلى صورة ، C # API ، مكتبة .NET ، PDF ، صورة
description: تحويل PDF إلى صورة في C #. استخدم .NET library API لتحويل صفحات PDF إلى صور
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل PDF إلى صورة في C #" h2="PowerPoint .NET API لتحويل مستندات PDF إلى صور على الأنظمة الأساسية NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل PDF إلى صورة في C #" %}}

كيف أقوم بتحويل PDF إلى صورة في كود؟

باستخدام [** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) ، يمكن لأي مطور أو تطبيق تحويل PDF إلى ملفات صور ببضعة أسطر من كود C #.

كواجهة برمجة تطبيقات حديثة لمعالجة المستندات ، يقوم Aspose.Slides for .NET بتصدير صفحات PDF إلى تنسيقات الصور بسرعة. تسمح لك مكتبة Aspose PowerPoint بتحويل PDF إلى صورة والعديد من تنسيقات الملفات الأخرى.
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل PDF إلى صورة في C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="يمكن للمطورين والتطبيقات تحويل PDF إلى صورة بهذه الطريقة:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
استدعاء طريقة الحفظ لحفظ الشرائح كصور.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 قبل تشغيل كود C # لتحويل PDF إلى صورة ، يجب أن يكون لدى جهازك هذه المتطلبات الأساسية:
...
{{% blocks/products/pf/agp/code-block title="كود C # لتحويل PDF إلى صورة" offSpacer="" %}}
