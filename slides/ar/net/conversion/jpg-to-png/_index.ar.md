...
keywords: JPG إلى PNG ، تحويل JPG إلى PNG ، C# API ، مكتبة .NET
description: تحويل JPG إلى PNG في C#. استخدم .NET library API لتحويل ملفات JPG إلى PNG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل JPG إلى PNG في C#" h2="PowerPoint .NET API لتحويل ملفات صور JPG إلى PNG على الأنظمة الأساسية NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل JPG إلى PNG في C#" %}}

كيف أقوم بتحويل JPG إلى PNG في التعليمات البرمجية؟

باستخدام [** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) ، يمكن لأي مطور أو تطبيق تحويل JPG إلى PNG ببضعة أسطر من كود C#.

بصفتها واجهة برمجة تطبيقات حديثة لمعالجة المستندات ، تقوم Aspose.Slides for .NET بتصدير ملفات JPG إلى PNG بسرعة. تسمح لك مكتبة Aspose PowerPoint بتحويل JPG إلى PNG والصور بتنسيقات أخرى.
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل JPG إلى PNG في C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="يمكن للمطورين والتطبيقات تحويل JPG إلى PNG بهذه الطريقة:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 قبل تشغيل كود C# للتحويل من JPG إلى PNG ، يجب أن يكون لدى جهازك المتطلبات الأساسية التالية:
...
{{% blocks/products/pf/agp/code-block title="كود C# لتحويل JPG إلى PNG" offSpacer="" %}}
