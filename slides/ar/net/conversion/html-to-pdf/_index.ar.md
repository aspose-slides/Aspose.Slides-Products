...
keywords: HTML إلى PDF ، تحويل HTML إلى PDF ، C# API ، مكتبة .NET ، HTML ، PDF
description: تحويل HTML إلى PDF في C#. استخدم .NET library API لتحويل صفحات HTML إلى مستندات PDF.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل HTML إلى PDF في C#" h2="PowerPoint .NET API لتحويل صفحات HTML إلى مستندات PDF على الأنظمة الأساسية .NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل HTML إلى PDF في C#" %}}

كيف أقوم بتحويل HTML إلى PDF برمجيًا؟

باستخدام [** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) ، يمكن لأي مطور أو تطبيق تحويل HTML إلى تنسيق PDF ببضعة أسطر من كود C#.

باعتبارها واجهة برمجة تطبيقات حديثة لمعالجة المستندات ، تقوم Aspose.Slides for .NET بإنشاء ملفات PDF من صفحات HTML بسرعة. تسمح لك مكتبة Aspose PowerPoint بتحويل HTML إلى PDF والعديد من تنسيقات الملفات الأخرى
...
{{< blocks/products/pf/agp/feature-section-col title="خطوات تحويل HTML إلى PDF في C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="يمكن للمطورين والتطبيقات تحويل HTML إلى PDF بهذه الطريقة:" >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
قم باستدعاء طريقة الحفظ لحفظ الملف بصيغة PDF.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 قبل تشغيل كود C# للتحويل من HTML إلى PDF ، يجب أن تتوفر في جهازك المتطلبات الأساسية التالية:
...
{{% blocks/products/pf/agp/code-block title="كود C# لتحويل HTML إلى PDF" offSpacer="" %}}
