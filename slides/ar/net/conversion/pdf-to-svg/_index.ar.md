...
weight: 100
url: /ar/net/conversion/pdf-to-svg/ 
keywords: PDF إلى SVG ، تحويل PDF إلى SVG ، C # API ، مكتبة .NET ، PDF ، SVG
description: تحويل PDF إلى SVG في C #. استخدم .NET library API لتحويل صفحات PDF إلى صور SVG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل PDF إلى SVG في C #" h2="PowerPoint .NET API لتحويل مستندات PDF إلى صور SVG على NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin الأنظمة الأساسية" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل PDF إلى SVG في C #" %}}

كيف أقوم بتحويل PDF إلى SVG في كود؟

باستخدام [** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) ، يمكن لأي مطور أو تطبيق تحويل PDF إلى تنسيق SVG ببضعة أسطر من كود C #.

بصفتها واجهة برمجة تطبيقات حديثة لمعالجة المستندات ، تقوم Aspose.Slides for .NET بتصدير صفحات PDF إلى SVG بسرعة. تسمح لك مكتبة Aspose PowerPoint بتحويل PDF إلى SVG والعديد من تنسيقات الملفات الأخرى
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل PDF إلى SVG في C #" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="يمكن للمطورين والتطبيقات تحويل PDF إلى SVG بهذه الطريقة:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 قبل تشغيل رمز تحويل PDF إلى SVG C # ، يجب أن يكون لجهازك هذه المتطلبات الأساسية:
...
{{% blocks/products/pf/agp/code-block title="كود C # لتحويل PDF إلى SVG" offSpacer="" %}}
