---
title: تحويل POT إلى BMP عبر C#
weight: 1670
url: /ar/net/conversion/pot-to-bmp/ 
description: رمز عينة لتحويل POT إلى BMP C#. استخدم رمز مثال API لملفات POT الدفعية لتحويل BMP داخل VB.NET أو Asp.NET أو أي تطبيق قائم على .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل POT إلى BMP عبر C#" h2="تصدير ملفات PowerPoint® POT إلى BMP على .NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin الأنظمة الأساسية" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POT" >}}
...
{{< blocks/products/pf/agp/steps-block-autogen name="يمكن لمطوري .NET تحميل وتحويل ملفات POT إلى BMP بسهولة في بضعة أسطر من التعليمات البرمجية." >}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الكود هذا تحويل POT إلى BMP C#" offSpacer="" %}}
