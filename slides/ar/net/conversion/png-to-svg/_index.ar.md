...
keywords: PNG إلى SVG ، وتحويل PNG إلى SVG ، و C# API ، و .NET Library
description: تحويل PNG إلى SVG في C#. استخدم .NET library API لتحويل ملفات PNG إلى ملفات SVG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل PNG إلى SVG في C#" h2="PowerPoint .NET API لتحويل ملفات صور PNG إلى SVG على الأنظمة الأساسية NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل PNG إلى SVG في C#" %}}

كيف يمكنني تحويل PNG إلى SVG في التعليمات البرمجية؟

باستخدام [** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) ، يمكن لأي مطور أو تطبيق تحويل PNG إلى SVG ببضعة أسطر من كود C#.

بصفتها واجهة برمجة تطبيقات حديثة لمعالجة المستندات ، تقوم Aspose.Slides for .NET بتصدير ملفات PNG إلى SVG بسرعة. تسمح لك مكتبة Aspose PowerPoint بتحويل PNG إلى SVG والصور بتنسيقات أخرى.
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل PNG إلى SVG في C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="يمكن للمطورين والتطبيقات تحويل PNG إلى SVG بهذه الطريقة:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 قبل تشغيل رمز C# لتحويل PNG إلى SVG ، يجب أن يكون لجهازك هذه المتطلبات الأساسية:
...
{{% blocks/products/pf/agp/code-block title="كود C# لتحويل PNG إلى SVG" offSpacer="" %}}
