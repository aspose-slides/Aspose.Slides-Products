...
keywords: PNG إلى JPG ، تحويل PNG إلى JPG ، C# API ، مكتبة .NET
description: تحويل PNG إلى JPG في C#. استخدم .NET library API لتحويل ملفات PNG إلى ملفات JPG.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل PNG إلى JPG في C#" h2="PowerPoint .NET API لتحويل ملفات صور PNG إلى JPG على الأنظمة الأساسية NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="jpg" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPT" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل PNG إلى JPG في C#" %}}

كيف يمكنني تحويل PNG إلى JPG في التعليمات البرمجية؟

باستخدام [** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) ، يمكن لأي مطور أو تطبيق تحويل PNG إلى JPG ببضعة أسطر من كود C#.

كواجهة برمجة تطبيقات حديثة لمعالجة المستندات ، يقوم Aspose.Slides for .NET بتصدير ملفات PNG إلى JPG بسرعة. تسمح لك مكتبة Aspose PowerPoint بتحويل PNG إلى JPG والصور بتنسيقات أخرى.
...
{{< blocks/products/pf/agp/feature-section-col title="كيفية تحويل PNG إلى JPG في C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="يمكن للمطورين والتطبيقات تحويل PNG إلى JPG بهذه الطريقة:" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 قبل تشغيل رمز C# لتحويل PNG إلى JPG ، يجب أن تتوفر في جهازك المتطلبات الأساسية التالية:
...
{{% blocks/products/pf/agp/code-block title="كود C# لتحويل PNG إلى JPG" offSpacer="" %}}
