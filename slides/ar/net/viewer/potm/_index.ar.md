---
title: عرض تنسيقات ملفات POTM عبر .NET
weight: 3310
url: /ar/net/viewer/potm/ 
description: التعليمات البرمجية المصدر C# لتحميل مستندات POTM وعرضها وعرضها على .NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin الأنظمة الأساسية.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="عارض ملفات POTM لـ .NET" h2="اعرض ملفات العروض التقديمية مثل POTM بدون Microsoft PowerPoint أو Office Automation" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTM" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية عرض ملف POTM باستخدام C#" %}}

 لعرض ملف POTM ، سنستخدمه
...
{{< blocks/products/pf/agp/feature-section-col title="خطوات عرض POTM عبر C#" >}}

{{< blocks/products/pf/agp/steps-block-autogen name="يُسهل Aspose.Slides على المطورين عرض ملف POTM ببضعة أسطر من التعليمات البرمجية." >}}

{{< blocks/products/pf/agp/step-autogen >}}
إنشاء كائن عرض تقديمي وتحميل ملف POTM
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
احفظ العرض التقديمي POTM بتنسيق HTML
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
عملية الاستدعاء: ابدأ بالمسار إلى HTML الناتج لتحميل محتوى POTM في المتصفح الافتراضي
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{% blocks/products/pf/agp/code-block title="C# مثال على كود لعرض ملف POTM" offSpacer="" %}}
