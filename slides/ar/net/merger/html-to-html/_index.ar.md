---
title: دمج ملفات HTML في C#
url: /ar/net/merger/html-to-html/
keywords: دمج HTML ، HTML إلى HTML ، الانضمام إلى HTML ، الجمع بين HTML ، C# API ، مكتبة .NET
description: دمج HTML مع HTML في C#. استخدم .NET library API لدمج ملفات HTML
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="دمج HTML في C#" h2="واجهة برمجة تطبيقات .NET API قوية ومتعددة الأنظمة لدمج ملفات HTML باستخدام كود C# في NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin الأنظمة الأساسية" >}}

{{% blocks/products/pf/feature-page-section h2="دمج HTML مع HTML باستخدام Aspose.Slides" %}}

[** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) هي مكتبة .NET قوية تُستخدم لإنشاء وتحويل ودمج ومعالجة العروض التقديمية وملفات HTML و مستندات أخرى. عندما تقوم بدمج HTML إلى HTML ، فإنك تدمج بشكل فعال المحتويات من وثيقتين للحصول على ملف HTML واحد. Aspose.Slides يسمح لك بدمج مستندات HTML بطرق مختلفة. يمكنك دمج HTML مع جميع نصوصها وتنسيقاتها وأنماطها وما إلى ذلك.
...
{{% blocks/products/pf/feature-page-section  h2="دمج HTML إلى HTML في C#" %}}
باستخدام [** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) ، يمكنك دمج ملفات HTML بسرعة ببضعة سطور من التعليمات البرمجية

{{% blocks/products/pf/agp/code-block title="كود C# لدمج HTML مع HTML" offSpacer="true" %}}
```cs
...
{{< blocks/products/pf/feature-page-section  h2="كيفية دمج HTML في C#" >}}
