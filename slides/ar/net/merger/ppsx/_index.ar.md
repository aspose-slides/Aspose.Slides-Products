...
title: دمج ملفات PPSX عبر .NET
weight: 6100
url: /ar/net/merger/ppsx/ 
description: كود مصدر C# لدمج مستندات PPSX على .NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin الأنظمة الأساسية.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="دمج تنسيقات PPSX في C#" h2="دمج مستندات PPSX الأصلية وعالية الأداء باستخدام Aspose.Slides من جانب الخادم لـ .NET APIs ، دون استخدام أي برنامج مثل Microsoft أو Open Office أو Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/slides/aspose_slides-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Slides" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPSX" >}}
...
قم بتحميل جميع ملفات PPSX بالمسار الكامل.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
قم باستدعاء طريقة Save () وقم بتمرير اسم الملف (المسار الكامل) والتنسيق (PPSX) كمعامل.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
يمكنك الآن فتح ملف PPSX واستخدامه في Microsoft Office أو Adobe PDF أو أي برنامج آخر متوافق.
{{< /blocks/products/pf/agp/step-autogen >}}
