...
قم بتحميل جميع ملفات PPT بالمسار الكامل.
{{< /blocks/products/pf/agp/step-autogen >}}
...
{{< blocks/products/pf/agp/step-autogen >}}
قم باستدعاء طريقة Save () وقم بتمرير اسم الملف (المسار الكامل) والتنسيق (PPT) كمعامل.
{{< /blocks/products/pf/agp/step-autogen >}}

{{< blocks/products/pf/agp/step-autogen >}}
يمكنك الآن فتح ملف PPT واستخدامه في Microsoft Office أو Adobe PDF أو أي برنامج آخر متوافق.
{{< /blocks/products/pf/agp/step-autogen >}}
