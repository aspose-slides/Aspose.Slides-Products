...
url: /ar/net/merger/jpg-to-jpg/
keywords: دمج JPG و JPEG إلى JPG والانضمام إلى JPG والجمع بين JPG و C# API و .NET Library
description: دمج JPG إلى JPG في C#. استخدم .NET library API لدمج ملفات JPG
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="دمج JPG في C#" h2="واجهة برمجة تطبيقات .NET API قوية ومتعددة الأنظمة لدمج صور JPG باستخدام كود C# في NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin الأنظمة الأساسية" >}}

{{% blocks/products/pf/feature-page-section h2="دمج JPG إلى JPG باستخدام Aspose.Slides" %}}

[** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) هي مكتبة .NET قوية تستخدم لدمج ومعالجة العروض التقديمية والصور والملفات الأخرى. عندما تقوم بدمج JPG إلى JPG ، فإنك تدمج بشكل فعال صورتين للحصول على صورة واحدة.
...
{{% blocks/products/pf/feature-page-section  h2="دمج JPG إلى JPG في C#" %}}
باستخدام [** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) ، يمكنك دمج ملفات JPG بسرعة ببضعة سطور من التعليمات البرمجية
