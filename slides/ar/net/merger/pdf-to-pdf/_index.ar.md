...
url: /ar/net/merger/pdf-to-pdf/
keywords: دمج PDF ، PDF إلى PDF ، الانضمام إلى PDF ، الجمع بين PDF ، C# API ، مكتبة .NET
description: دمج PDF في PDF في C#. استخدم .NET library API لدمج ملفات PDF
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/feature-page-wrap >}}

{{< blocks/products/pf/feature-page-header h1="دمج PDF في C#" h2="واجهة برمجة تطبيقات .NET API قوية ومتعددة الأنظمة لدمج ملفات PDF باستخدام كود C# في NET Framework أو .NET Core أو Windows Azure أو Mono أو Xamarin الأنظمة الأساسية" >}}

{{% blocks/products/pf/feature-page-section h2="دمج PDF في PDF باستخدام Aspose.Slides" %}}

[** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) هي مكتبة .NET قوية تُستخدم لإنشاء وتحويل ودمج ومعالجة العروض التقديمية وملفات PDF وغيرها مستندات. عندما تقوم بدمج PDF إلى PDF ، فإنك تدمج بشكل فعال صفحات من وثيقتين للحصول على ملف PDF واحد. Aspose.Slides يسمح لك بدمج ملفات PDF بطرق مختلفة. يمكنك دمج ملفات PDF بجميع أشكالها وأنماطها ونصوصها وتنسيقاتها وما إلى ذلك.
...
باستخدام [** Aspose.Slides for .NET **](https://products.aspose.com/slides/ar/net/) ، يمكنك دمج ملفات PDF بسرعة ببضعة سطور من التعليمات البرمجية
